...
import { a as validateSafeBinArgv, c as DEFAULT_SAFE_BINS, l as SAFE_BIN_PROFILES, n as isTrustedSafeBinPath } from "./exec-safe-bin-trust-BK4JSJnd.js";
import { _ as resolvePolicyTargetResolution, d as resolveExecutableTrustPath, f as resolveExecutionTargetCandidatePath, g as resolvePolicyTargetCandidatePath, i as matchAllowlist, m as resolveExecutionTargetTrustPath, p as resolveExecutionTargetResolution, t as buildCwdBoundHashedArgPattern, u as resolveCommandResolutionFromArgv, v as resolvePolicyTargetTrustPath, y as resolveExecWrapperTrustPlan } from "./exec-command-resolution-CJ9Vm03p.js";
import { E as unwrapDispatchWrappersForResolution, N as normalizeExecutableToken, S as resolvePowerShellInlineCommandMatch, T as resolveDispatchWrapperTrustPlan, _ as hasPosixLoginStartupBeforeInlineCommand, g as hasPosixInteractiveStartupBeforeInlineCommand, h as advancePosixInlineOptionScan, i as extractBindableShellWrapperInlineCommand, l as isShellWrapperExecutable, m as POSIX_INLINE_COMMAND_FLAGS, n as POSIX_SHELL_WRAPPERS, r as POWERSHELL_WRAPPERS, t as POSIX_PARSEABLE_SHELL_WRAPPERS, v as isDirectShellPositionalCarrierCommand, w as isDispatchWrapperExecutable, x as resolveInlineCommandMatch, y as isPowerShellInlineFileCommandFlag } from "./shell-wrapper-resolution-BddNi41x.js";
import { a as isWindowsPlatform, i as analyzeWindowsShellCommand } from "./exec-approvals-analysis-BvkQXLiO.js";
import "./exec-wrapper-resolution-Et5CIZnS.js";
import { o as detectInlineEvalArgv, u as isInterpreterLikeAllowlistPattern } from "./risks-D6ZQ78A6.js";
...
function buildScriptArgPatternFromArgv(argv, scriptPath, cwd, platform) {
	...
	return buildCwdBoundHashedArgPattern([scriptPath, ...scriptIdx !== -1 ? argv.slice(scriptIdx + 1) : []], base, platform);
}
