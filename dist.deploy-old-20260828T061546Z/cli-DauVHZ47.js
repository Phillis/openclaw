...
import { R as timestampMsToIsoString, w as parseStrictPositiveInteger, y as parseDateStringTimestampMs } from "./number-coercion-CLj0HTDM.js";
...
import { u as readFiniteNumberParam } from "./common-CI1GnPjt.js";
import { i as getMemoryCapabilityRegistration, s as listActiveMemoryPublicArtifacts } from "./memory-state-BzIc97qw.js";
import { n as retryTransientMemoryRead } from "./read-retry-oGrTS9IG.js";
...
function buildPageSnippet(page, query) {
	...
	return truncateUtf16Safe(matchingClaim?.text ?? buildSnippet(page.raw, query), WIKI_SNIPPET_MAX_CHARS);
}
