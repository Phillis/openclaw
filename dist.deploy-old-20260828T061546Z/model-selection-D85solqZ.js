...
import { i as hasLegacyAutoFallbackWithoutOrigin, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-DigoIwHb.js";
...
import { i as legacyModelKey, o as normalizeModelRef, s as normalizeProviderId } from "./model-ref-shared-D4yx0hwT.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-routing-Chr0R2hQ.js";
import { r as buildConfiguredModelCatalog, y as resolveModelAliasFromPair } from "./model-selection-shared-DbjoXfPH.js";
...
import { n as SessionWorkStartInvalidatedError } from "./lifecycle-B13mO5hL.js";
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-BxFkXXxj.js";
import { a as resolveCliRuntimeCanonicalProvider } from "./cli-backends-TpSzxqso.js";
import { a as resolveReasoningDefault, c as resolvePersistedOverrideModelRef, s as normalizeStoredOverrideModel } from "./model-selection-Cp8EGD61.js";
...
import { n as resolveStoredModelOverride, t as resolveDirectStoredModelOverride } from "./stored-model-overrides-CfaRLIWD.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-LTIDP5EY.js";
import { a as sessionModelOverrideChangesApplied, n as adoptPersistedSessionSnapshot } from "./session-snapshot-merge-B4KFr9oE.js";
import { i as resolveRuntimeNormalization, n as mergePreparedConfiguredCatalog, r as normalizeRuntimeRef, t as findSelectedCatalogEntry } from "./model-runtime-normalization-CazuNhbt.js";
import "./model-selection-directive-D36pF9RM.js";
import "./model-selection-context-B1L_QCkZ.js";
...
const sessionPersistenceRuntimeLoader = createLazyImportLoader(() => import("./session-entry-persistence-CkL9PGPW.js"));
...
async function createModelSelectionState(params) {
	...
	const configuredModelCatalog = mergePreparedConfiguredCatalog({
		configured: buildConfiguredModelCatalog({
			cfg,
			manifestPlugins
		}),
...
//#endregion
export { createModelSelectionState as n, isStaleHeartbeatAutoFallbackOverride as r, createFastTestModelSelectionState as t };
