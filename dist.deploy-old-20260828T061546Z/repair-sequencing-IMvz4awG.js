...
import { P as validateConfigObjectWithPlugins } from "./io-ClLVsBMp.js";
import { a as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, i as normalizeChatChannelId } from "./ids-Cgp0iV_A.js";
import { Bt as tableExists, Mn as executeSqliteQueryTakeFirstSync, Nn as getNodeSqliteKysely, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction, jn as executeSqliteQuerySync } from "./openclaw-state-db-kmBThqu6.js";
...
import { i as materializePluginAutoEnableCandidates, t as applyPluginAutoEnable } from "./plugin-auto-enable-CymS91e8.js";
import { g as validateSkillProposalRollback, h as validateSkillProposalRecord } from "./store-sqlite-record-B1DXrdfq.js";
import { E as hashSkillProposalContent, a as readSkillProposal, r as importLegacySkillProposal, w as readSkillProposalRollback } from "./store-BwbwrOhp.js";
import { t as removePathWithinRoot } from "./fs-safe-remove-B3egFJhN.js";
import { n as repairObsoleteGeneratedExecApprovals } from "./exec-approvals-generated-migration-KEjNHNyB.js";
import { r as githubAuthenticationSubject, t as classifyTailscaleLogin, y as ensureUserProfilesSchema } from "./user-profiles-tailscale-login-kvQH2eWv.js";
import { s as readChannelAllowFromStore } from "./pairing-store-DNjQLson.js";
import { r as maybeRepairCodexRoutes } from "./codex-route-warnings-CehDs9fI.js";
import { r as VERSION_BOUND_RUNTIME_PLUGIN_POLICY_IDS_BY_SURFACE } from "./configured-runtime-plugin-installs-Dw0dwCZZ.js";
import { d as isUpdatePackageSwapInProgress } from "./update-phase-CUQAfBmE.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-DC8-hW50.js";
import { n as maybeMigrateAuthProfileJsonStoresToSqlite, r as maybeRepairOpenAICodexAuthConfig, t as collectOpenAICodexAuthProfileStoreIdMap } from "./doctor-auth-flat-profiles-S15Dfd1h.js";
import { t as maybeRepairLegacyOAuthSidecarProfiles } from "./doctor-auth-oauth-sidecar-DkzZsbQv.js";
import { r as resolveConfigWideDoctorPluginMetadataSnapshot } from "./plugin-metadata-snapshot-scope-CJnemfbt.js";
...
import { r as maybeRepairStaleManagedNpmBundledPlugins } from "./doctor-plugin-registry-DNgxOgKe.js";
import { t as getDoctorChannelCapabilities } from "./channel-capabilities-CGZC8LPq.js";
import { n as hasAllowFromEntries, t as scanEmptyAllowlistPolicyWarnings } from "./empty-allowlist-scan-DLwmTPfD.js";
import { n as maybeRepairBundledPluginLoadPaths } from "./bundled-plugin-load-paths-D2VuTe2c.js";
import { a as collectChannelDoctorRepairMutations, s as createChannelDoctorEmptyAllowlistPolicyHooks, t as collectChannelDoctorCompatibilityMutations } from "./channel-doctor-B2kqcEsE.js";
import { n as maybeRepairContextEngineHostCompatibility } from "./context-engine-host-compat-DBifvR_k.js";
import { r as maybeRepairExecSafeBinProfiles } from "./exec-safe-bins-CF5_-eEd.js";
import { n as maybeRepairLegacyToolsBySenderKeys } from "./legacy-tools-by-sender-DBrNuddF.js";
import { n as maybeRepairOpenPolicyAllowFrom } from "./open-policy-allowfrom-MkAfHcVg.js";
import { t as cleanupLegacyPluginDependencyState } from "./plugin-dependency-cleanup-BYEKj8rh.js";
import { t as repairStaleAgentModelRefs } from "./stale-agent-model-ref-repair-DJQlzT1u.js";
import { n as maybeRepairStaleConfiguredAuthOrders } from "./stale-auth-order-ByIpXPYU.js";
import { n as repairStaleOAuthProfileShadows } from "./stale-oauth-profile-shadows-BxFUcKZh.js";
import { r as maybeRepairStalePluginConfig } from "./stale-plugin-config-6vcQ4e1r.js";
