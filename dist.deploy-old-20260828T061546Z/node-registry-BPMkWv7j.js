import { D as resolveExpiresAtMsFromDurationMs, a as addTimerTimeoutGraceMs, g as isFutureDateTimestampMs } from "./number-coercion-CLj0HTDM.js";
import { t as createSubsystemLogger } from "./subsystem-a4KzJVZG.js";
import { n as GATEWAY_CLIENT_IDS } from "./client-info-UYcIi_5g.js";
import "./node-commands-DRxP7loh.js";
...
import { a as removeConnectedNodePluginTools, i as normalizeNodePluginToolDescriptors, o as replaceConnectedNodePluginTools, t as createRegisteredNodePluginToolDescriptorMap } from "./node-plugin-tool-snapshot-PbApRkBd.js";
...
import { a as forgetNodeRunnerInventory, f as settleNodeRegistryPairingGenerationChange, l as reconcileNodeRunnerAvailability, m as NODE_INVOKE_PAIRING_CHANGED_ABORT, o as invokePublicNodeRegistry, s as isNodeRegistryPendingInvokeConnectionActive, u as registerNodeRegistryPrivateRuntime } from "./node-registry-private-CsBI1Ypg.js";
...
var NodeInvokeStreamController = class {
	...
	sendInput(invokeId, payload) {
		...
		if (this.settleIfExpired(invokeId, pending)) throw new Error("node invoke is not pending");
	...
	handleResult(params) {
		...
		if (this.settleIfExpired(params.id, pending)) return false;
	...
	handleProgress(params) {
		...
		if (this.settleIfExpired(params.invokeId, pending)) return false;
		...
		while (true) {
			...
			if (this.settleIfExpired(params.invokeId, pending)) break;
	...
	settleIfExpired(requestId, pending) {
		if (pending.deadlineAtMs === void 0 || Date.now() < pending.deadlineAtMs) return false;
...
var NodeRegistry = class {
	...
	runPendingInvokeContinuation(params) {
		...
		if (!pending?.admissionContinuation || pending.nodeId !== params.nodeId || pending.connId !== params.connId || !isNodeRegistryPendingInvokeConnectionActive({
			registry: this,
			pending,
