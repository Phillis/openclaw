...
import { D as resolveExpiresAtMsFromDurationMs, R as timestampMsToIsoString, g as isFutureDateTimestampMs, o as asDateTimestampMs, w as parseStrictPositiveInteger } from "./number-coercion-CLj0HTDM.js";
...
import { c as isReplyPayloadNonTerminalToolErrorWarning, o as getReplyPayloadTtsSupplement, r as buildTtsSupplementMediaPayload, s as isFastModeAutoProgressPayload } from "./reply-payload-BeeUJOmJ.js";
import { m as resolveChannelDraftStreamingChunking } from "./channel-outbound-DO-F9-0m.js";
...
import { a as toInternalMessageReceivedContext } from "./message-hook-mappers-BwRPfaNj.js";
import { D as toLocationContext, T as formatLocationText, u as resolveAskUserQuestionOptionIndices } from "./reply-payload-i0RzN2iF.js";
...
import { a as projectOutboundPayloadPlanForDelivery, t as createOutboundPayloadPlan } from "./payloads-BDBV7AYm.js";
import { D as selectLongerFinalText, E as resolveTranscriptBackedChannelFinalText, S as resolveChannelStreamingPreviewToolProgress, l as isPotentialTruncatedFinal, v as resolveChannelStreamingBlockEnabled } from "./streaming-B93dETXe.js";
...
import { l as formatReasoningMessage } from "./embedded-agent-utils-DlrP62Rs.js";
...
import { n as createPreviewMessageReceipt } from "./live-CIdslFJ4.js";
...
import { d as formatMediaPlaceholderText, u as formatInboundMediaUnavailableText } from "./run-channel-turn-CVly42eY.js";
...
import { o as readLatestAssistantTextByIdentity, t as appendAssistantMirrorMessageByIdentity } from "./session-transcript-runtime-DXwgc1x5.js";
...
import { a as runChannelInboundEvent, d as resolveUnmentionedGroupInboundPolicy, u as classifyChannelInboundEvent } from "./channel-inbound-BmDzyYQ4.js";
...
import "./command-surface-BP6I2uXq.js";
...
import { n as formatAudioTranscriptForAgent } from "./media-understanding-runtime-dQ2PWxoe.js";
import "./state-paths-DQKtm04E.js";
import "./text-utility-runtime-BNhX-3os.js";
import { i as normalizeAllowFrom, n as resolveTelegramDmAllow, o as resolveTelegramEffectiveDmPolicy, r as isSenderAllowed, t as expandTelegramAllowFromWithAccessGroups } from "./access-groups-DY7-iLJz.js";
import { a as resolveDefaultTelegramAccountId } from "./accounts-3yDZGxKI.js";
import { c as resolveTelegramTargetChatType, t as buildTelegramConversationId } from "./topic-conversation-Cl4csGES.js";
import { d as shouldSuppressLocalTelegramExecApprovalPrompt } from "./exec-approvals-CSr4C8-g.js";
...
import { A as hasBotMention, B as renderTelegramTextEntities, D as buildSenderName, E as buildSenderLabel, F as normalizeForwardedContext, I as resolveTelegramPrimaryMedia, K as renderTelegramHtmlText, M as hasLeadingBotCommandAddressedToOtherBot, O as extractTelegramLocation, R as resolveTelegramRichMessagePlaceholder, S as resolveTelegramStreamMode, a as buildTelegramInboundOriginTarget, b as resolveTelegramMessageThreadSpec, c as buildTelegramThreadParams, d as extractTelegramForumFlag, g as resolveTelegramForumFlag, i as buildTelegramGroupPeerId, j as hasBotMentionInText, k as getTelegramTextParts, l as buildTypingThreadParams, m as resolveTelegramBotHasTopicsEnabled, n as buildGroupLabel, o as buildTelegramParentPeer, r as buildTelegramGroupFrom, u as describeReplyTarget, w as shouldUseTelegramDmThreadSession, x as resolveTelegramReplyId, z as resolveTelegramRichMessageText } from "./helpers-BwCSYwU_.js";
import { i as resolveTelegramConversationRoute, o as resolveTelegramDirectPeerId, r as resolveTelegramConversationBaseSessionKey } from "./conversation-route-B-tTpTPs.js";
import { C as createTelegramPromptContextProjectionSequence, E as resolveTelegramPromptContextDeliverySignature, L as resolveTelegramDirectToolPolicy, O as withTelegramPromptContextSource, R as resolveTelegramGroupIngestEnabled, a as buildTelegramRichMarkdown, b as italicRichText, d as markdownToTelegramRichBlocks, i as buildTelegramRichBlocksPlan, r as TELEGRAM_RICH_TEXT_LIMIT, t as TELEGRAM_TEXT_CHUNK_LIMIT, v as boldRichText, x as paragraphBlock, y as codeRichText, z as resolveTelegramGroupPromptSettings } from "./text-chunk-limit-a65wnktU.js";
import { t as resolveTelegramAccountOwnerAgentId } from "./account-owner-CfbMzFBO.js";
import { r as resolveTelegramInlineButtons, t as appendTelegramDroppedControlFallback } from "./button-types-B8o1Tn_2.js";
import { t as canonicalizeTelegramPresentationPayload } from "./interactive-fallback-8JJe_6qe.js";
import { i as registerTelegramQuestionDelivery } from "./outbound-adapter-DgAyyO0D.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-C-fNxZTv.js";
import { n as getTopicName, o as resolveTopicNameCacheScope, s as updateTopicName } from "./topic-name-cache-Cnh2fm0W.js";
import { $ as recordTelegramGroupHistoryEntry, B as recordOutboundMessageForPromptContext, F as resolveTelegramReactionVariant, I as resolveTelegramStatusReactionEmojis, L as reportTelegramProviderDelivery, M as buildTelegramStatusReactionVariants, N as resolveTelegramAllowedReactions, P as resolveTelegramReactionEmoji, Q as mergeTelegramGroupHistoryPromptContext, R as recordSentMessage, X as isTelegramHistoryEntryAfterAmbientWatermark, Y as isTelegramChatWindowPromptContext, b as editMessageTelegram, et as retainTelegramGroupHistoryPromptContext, p as mergeTelegramPartialDeliveryError, pt as evaluateTelegramGroupBaseAccess, tt as selectTelegramGroupHistoryAfterLastSelf, y as editMessageReplyMarkupTelegram } from "./send-B3vmt1UE.js";
...
async function buildTelegramInboundContextPayload(params) {
	...
	const visiblePromptContext = mergeTelegramGroupHistoryPromptContext({
		promptContext: hasGroupHistoryContext ? retainTelegramGroupHistoryPromptContext({
...
async function flushBufferedFinalAnswer(turn, currentPayloadVisible = false) {
	...
	try {
		...
		const result = await deliverFinalAnswerText(turn, controls.payload, controls.payload.text ?? "", controls.buttons, settlement?.onPlatformSendDispatch, settlement?.bindPendingFinalDelivery);
			...
			adapter: {
				...
				resolveTurn: () => ({
					...
					replyOptions: {
						...
						shouldDeliverCommentaryPayloads: turn.streamMode === "progress" && turn.commentaryProgressEnabled ? () => turn.verboseProgressActive() : void 0,
...
const dispatchTelegramMessage = async (dispatchParams) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-BKiTWYfN.js")).defaultTelegramBotDeps;
	...
	try {
		...
		if (isDispatchSuperseded()) return { kind: "completed" };
