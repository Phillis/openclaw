import { A as MessageReceipt, N as OutboundSendDeps, P as OutboundMediaAccess, S as ChannelStatusIssue, _ as ChannelOutboundTargetMode, b as ChannelSecurityContext, c as ChannelDirectoryEntry, d as ChannelHeartbeatDeps, f as ChannelLogSink, n as ChannelAccountSnapshot, r as ChannelAccountState, u as ChannelGroupContext, v as ChannelPollContext, x as ChannelSecurityDmPolicy, y as ChannelPollResult } from "./types.core-D9YiZM0R.js";
import { C as MessagePresentationAction, D as ApprovalRequestInput, E as ReplyPayloadDeliveryPin, O as ChannelApprovalKind, S as MessagePresentation, b as ReplyPayload, j as PluginApprovalResolved, k as PluginApprovalRequest, w as MessagePresentationButton } from "./types-DpImvtmp.js";
import { Ct as ChatType, bt as ReplyToMode, gt as GroupScope, ht as DmScope, k as AgentBinding, lt as GroupToolPolicyConfig, n as OpenClawConfig, yt as MarkdownTableMode } from "./types.openclaw-DckSqIPo.js";
import { a as ExecApprovalDecision, c as ExecApprovalResolved, g as ApprovalScope, h as CommandExplanationSummary, o as ExecApprovalRequest } from "./exec-approvals-DOpNCvPj.js";
...
import { n as SecretDefaults, t as ResolverContext } from "./runtime-shared-CSD24G9h.js";
...
type ApprovalRequest$1 = ApprovalRequestInput;
//#endregion
...
//#endregion
export { ChannelLegacyStateMigrationPlan as $, chunkByNewline as A, authorizeConfigWrite as B, ChannelStatusAdapter as C, ChannelOutboundPayloadHint as D, ChannelOutboundAdapter as E, resolveChunkMode as F, ConfigWriteTargetLike as G, formatConfigWriteDeniedMessage as H, resolveTextChunkLimit as I, buildAgentSessionKey as J, SecurityAuditFinding as K, OutboundDeliveryResult as L, chunkMarkdownTextWithMode as M, chunkText as N, OutboundIdentity as O, chunkTextWithMode as P, LegacyConfigRule as Q, OutboundPayloadDeliveryOutcome as R, ChannelSecurityAdapter as S, ChannelDeliveryCapabilities as T, ConfigWriteAuthorizationResultLike as U, canBypassConfigWritePolicy as V, ConfigWriteScopeLike as W, ApprovalRequest$1 as X, resolveAgentRoute as Y, PendingApprovalView as Z, ChannelHeartbeatAdapter as _, ChannelConfigAdapter as a, ChannelResolverAdapter as b, ChannelConfiguredBindingProvider as c, ChannelDoctorAdapter as d, ChannelDoctorConfigMutation as f, ChannelGroupAdapter as g, ChannelGatewayAdapter as h, ChannelCommandAdapter as i, chunkMarkdownText as j, OutboundDeliveryFormattingOptions as k, ChannelConversationBindingSupport as l, ChannelElevatedAdapter as m, ChannelApprovalCapability as n, ChannelConfiguredBindingConversationRef as o, ChannelDoctorLegacyConfigRule as p, ResolvedAgentRoute as q, ChannelAuthAdapter as r, ChannelConfiguredBindingMatch as s, ChannelAllowlistAdapter as t, ChannelDirectoryAdapter as u, ChannelLifecycleAdapter as v, ChannelPairingAdapter as w, ChannelSecretsAdapter as x, ChannelResolveResult as y, OutboundPayloadDeliverySuppressionReason as z };