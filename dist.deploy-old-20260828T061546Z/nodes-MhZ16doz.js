...
import { a as formatNodeRunnerUpdateRequired, n as NODE_RUNNER_UPDATE_REQUIRED_ISSUE, o as parseNodeRunnerInventoryDeclaration } from "./node-runner-inventory-C6KxqRM_.js";
import { t as ErrorCodes } from "./gateway-error-details-C2IaYyht.js";
import { A as isBrowserProxyNodeInvokeCommand, j as isPrivateNodeInvokeCommand, k as isAdminOnlyNodeInvokeCommand } from "./node-commands-DRxP7loh.js";
import { _n as validateNodeSkillsUpdateParams, an as validateNodeInvokeResultParams, cn as validateNodePairListParams, dn as validateNodePendingAckParams, gn as validateNodeRenameParams, in as validateNodeInvokeProgressParams, ln as validateNodePairRejectParams, mn as validateNodePluginToolsUpdateParams, nn as validateNodeEventParams, on as validateNodeListParams, rn as validateNodeInvokeParams, sn as validateNodePairApproveParams, tn as validateNodeDescribeParams, un as validateNodePairRemoveParams } from "./src-4dv5TpeQ.js";
import { c as isForbiddenBrowserProxyMutation } from "./method-scopes-BQC2sTma.js";
import { d as errorShape, f as missingScopeErrorShape } from "./validation-errors-rELRlKfn.js";
import { p as replaceRemoteNodeSkills } from "./workspace-skill-loader-CRn-e6M4.js";
import { a as isForegroundRestrictedPluginNodeCommand, c as normalizeDeclaredNodeCommands, l as resolveNodeCommandAllowlist, o as isNodeCommandAllowed, t as DEFAULT_DANGEROUS_NODE_COMMANDS, u as resolveNodePairingCommandAllowlist } from "./node-command-policy-XnskQsTT.js";
import { a as missingSystemRunApprovalBinding, f as toSystemRunApprovalMismatchError, i as matchSystemRunApprovalBinding, n as buildSystemRunApprovalBinding, v as resolveSystemRunCommandRequest } from "./system-run-approval-binding-0Gs8JaF5.js";
import { _ as resolveNodePairingState, c as listDevicePairing, m as removePairedDeviceRole, n as getPairedDevice, s as listApprovedPairedDeviceRoles } from "./device-pairing-BIRweQsd.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, u as updatePairedNodeSessionHost } from "./remote-BHibO2zu.js";
import { a as listNodePairing, d as renamePairedNode, i as getPendingNodePairing, l as rejectNodePairing, o as projectNodePairing, t as approveNodePairing } from "./device-pairing-node-yaKle7Kn.js";
import { n as awaitWithinDeadline, t as ABSOLUTE_DEADLINE_EXPIRED } from "./absolute-deadline-D0jNXqHr.js";
import { c as isNodeRunnerSessionHost, n as collectNodeWorkerBundleStatusByNodeId, p as updateNodeRunnerInventory, r as collectNodeWorkerCapacityByNodeId, t as collectNodeRunnerIssuesByNodeId } from "./node-registry-private-CsBI1Ypg.js";
import { i as hasAuthorizedClientPluginNodeCapabilityUrl, l as pluginNodeCapabilityScopedHostUrlsConflict, u as refreshClientPluginNodeCapability } from "./plugin-node-capability-DAm53jGl.js";
import { t as parseGatewayPayload } from "./server-json-CUC0gj3q.js";
import { i as respondUnavailableOnThrow, r as respondUnavailableOnNodeInvokeErrorWithProvenance, t as respondInvalidParams } from "./nodes.helpers-C2d4BQ6I.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-VVq_wcNX.js";
import { t as EXEC_APPROVAL_RESOLVED_ENTRY_GRACE_MS } from "./exec-approval-manager-D3AEYJmr.js";
import { a as removePendingNodeAction, i as listPendingNodeActions, n as clearRemovedNodeRuntimeState, o as replacePendingNodeActionsForGeneration, r as enqueuePendingNodeAction, s as reconcileRevokedDeviceWorker, t as acknowledgePendingNodeActions } from "./node-runtime-state-D1PPZoWX.js";
...
import { i as pairedDeviceHasNonOperatorRole, n as deniesCrossDeviceManagement, o as resolveDeviceManagementAuthz, s as resolveDeviceSessionAuthz, t as emitDeviceManagementSecurityEvent } from "./device-management-security-COehpP2D.js";
import { n as getKnownNode, r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-DGajSSq2.js";
import { i as isNodePairingGenerationCurrent, n as captureNodePairingGeneration, r as captureNodePairingState } from "./device-pairing-node-state-aeQRKdBa.js";
import { a as resolveDispatchableNodeSession, i as isNodePairingWorkCurrent, n as maybeWakeNodeWithApns, o as respondPairingChanged, r as waitForNodeReconnect, s as nodeInvokePolicy, t as maybeSendNodeWakeNudge } from "./nodes.wake-BwwxAzXw.js";
import { t as applyPluginNodeInvokePolicy } from "./node-invoke-plugin-policy-6-3K4Jho.js";
import { t as resolveLocalNodeId } from "./local-id-D4GZzxZ5.js";
...
const nodeEventHandlers = { "node.event": async ({ params, respond, context, client }) => {
	...
	await respondUnavailableOnThrow(respond, async () => {
		...
		const { handleNodeEvent } = await import("./server-node-events-CZmlseC1.js");
			...
			try {
				...
				const res = await context.nodeRegistry.invoke({
					...
					isDispatchAuthorized: () => (nodeInvokeStream?.isRuntimeCurrent() ?? true) && resolveNodeInvokeRuntimeAuthorityError({
						...
						client,
						approvalAuthority: forwardedParams.approvalAuthority
					}) === void 0 && resolveDispatchAuthorization(context.getRuntimeConfig()).ok,
...
async function listNodesForClient(params) {
	...
	const issuesByNodeId = collectNodeRunnerIssuesByNodeId(params.context.nodeRegistry, params.connectedNodes);
	const workerSlotsByNodeId = collectNodeWorkerCapacityByNodeId(params.context.nodeRegistry, params.connectedNodes);
	const workerBundleByNodeId = collectNodeWorkerBundleStatusByNodeId(params.context.nodeRegistry, params.connectedNodes);
...
const nodeReadHandlers = {
	...
	"node.runnerInventory.update": async ({ params, respond, client, context }) => {
		...
		if (!connId || !pairingGeneration) {
			...
			respondRunnerInventoryRetry(respond, pendingSurface ? `node capability surface is awaiting operator approval; run \`openclaw nodes approve ${pendingSurface.requestId}\` (see \`openclaw nodes pending\`), then this node retries automatically` : "node runner inventory publication is not current; retry after pairing completes");
			return;
		}
