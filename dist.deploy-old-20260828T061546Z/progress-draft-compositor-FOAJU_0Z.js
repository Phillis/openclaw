...
import { C as resolveChannelStreamingProgressCommentary, S as resolveChannelStreamingPreviewToolProgress, T as resolveChannelStreamingSuppressDefaultToolProgressMessages, c as isChannelProgressDraftWorkToolName, f as normalizeChannelProgressDraftLineIdentity, g as resolveChannelProgressDraftMaxLines, h as resolveChannelProgressDraftMaxLineChars, n as buildChannelProgressDraftLineForEntry, o as formatChannelProgressDraftText, r as createChannelProgressDraftGate, u as mergeChannelProgressDraftLine } from "./streaming-B93dETXe.js";
import { a as sanitizeProgressStatusText, i as normalizeReasoningProgressLine, n as mergeReasoningProgressText, r as normalizeCommentaryProgressText, t as formatReasoningProgressDisplayLine } from "./progress-draft-status-text-Byjyp5X9.js";
...
//#endregion
//#region src/channels/progress-work-counter.ts
/**
...
*/
function createChannelProgressWorkCounter(params) {
	...
	return {
		...
		get elapsedSeconds() {
			return Math.max(1, Math.round((now() - startedAt) / 1e3));
		}
	};
}
//#endregion
...
//#endregion
export { createChannelProgressDraftCompositor as n, createChannelProgressWorkCounter as r, PROGRESS_STATUS_PREAMBLE_FRESH_MS as t };
