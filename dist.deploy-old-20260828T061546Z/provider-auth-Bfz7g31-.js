...
import { f as loadAuthProfileStoreForSecretsRuntime, o as findPersistedAuthProfileCredential, p as loadAuthProfileStoreWithoutExternalProfiles, r as ensureAuthProfileStore } from "./store-C6iqqcJy.js";
...
import "./models-config.providers.secrets-BIMMK2iz.js";
...
import { r as resolveStoredCredentialReadOnlyAvailability } from "./read-only-availability-BjchohHW.js";
import { b as resolveProviderEntryApiKeyProfileReference, l as profileTypeToAuthMode, m as resolveDirectProviderCredentialMode, v as resolveProviderConfig, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-6V9HXTpM.js";
import { n as resolveManagedSecretRefRuntimeProviderAuth } from "./model-auth-runtime-config-BIltN2rn.js";
import "./provider-auth-write-compat-BLaVe__4.js";
import "./provider-auth-input-BGFTRqyG.js";
import "./provider-auth-helpers-Ci8FjjB5.js";
import "./provider-api-key-auth-7b8IL7_K.js";
...
async function resolveCopilotTokenCache(params) {
	...
	const { createCorePluginStateSyncKeyedStore } = await import("./plugin-state-store-CBEuteom.js");
