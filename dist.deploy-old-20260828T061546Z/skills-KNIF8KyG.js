...
import { f as MAX_PLUGIN_STATE_ENTRIES_PER_PLUGIN, t as createCorePluginStateSyncKeyedStore } from "./plugin-state-store-WXMs6Mfy.js";
...
import { u as PROPOSAL_DRAFT_FILE } from "./store-sqlite-record-B1DXrdfq.js";
import { C as installSkillArchiveFromPath, E as validateRequestedSkillSlug, a as readLocalSkillCardContentSync, l as searchSkillsFromClawHub, p as parseRequestedClawHubSkillRef } from "./clawhub-uninstall-DZyw9ymn.js";
import { c as proposeCreateSkill, d as assertExpectedRevisionHash, f as evaluateSkillProposal, g as listSkillProposals, h as inspectSkillProposal, i as reviseSkillProposal, l as proposeUpdateSkill, m as getSkillProposalRunProgress, n as quarantineSkillProposal, p as listSkillProposalEvents, r as rejectSkillProposal, t as applySkillProposal, u as SkillProposalRevisionChangedError } from "./service-CWRf59ls.js";
...
import { r as updateSkillsFromClawHub, t as installSkillFromClawHub } from "./clawhub-BPsHCdQE.js";
import { t as buildWorkspaceSkillStatus } from "./status-C77NfbH4.js";
import { i as loadWorkspaceSkills } from "./workspace-skill-loader-CRn-e6M4.js";
...
import { i as isRealNonHeartbeatUserMessage, r as isHeartbeatUserMessage } from "./heartbeat-filter-6HwCh_sJ.js";
...
import { n as installSkill } from "./install-BiiVbCXn.js";
...
async function runSkillHistoryScanReview(params) {
	...
	try {
		...
		const { runEmbeddedAgent } = await import("./embedded-agent-fNRs635m.js");
...
async function forwardSkillWorkshopRevisionToChatSend(opts, params) {
	const { handleChatSendWithSkillWorkshopProposalRevision } = await import("./chat-send-handler-ByOwIOKk.js");
	const chatParams = {
