...
import { u as listCodexAppServerExtensionFactories } from "./loader-BcKpDiEM.js";
import "./usage-DNKCVmJi.js";
import "./registry-CWcxV14-.js";
import "./provider-request-config-ClkR7QK5.js";
import { f as joinPresentTextSegments, t as getGlobalHookRunner } from "./hook-runner-global-CDBq1X4a.js";
import "./registry-BUOAn3oY.js";
import "./reply-payload-BeeUJOmJ.js";
import "./agent-tools.before-tool-call-D89j2U3t.js";
...
import { _ as queueEmbeddedAgentMessageWithOutcome } from "./runs-eqaxGmoQ.js";
import "./tools-COMvBqlk.js";
import "./gateway-D8V0DEy4.js";
import "./tool-loop-detection-K29Fi2y0.js";
import "./hook-helpers-ClPyKMyt.js";
...
import { p as shouldLoadRequesterScopedMcpHarnessRuntime } from "./agent-bundle-mcp-manager-api-1m62vMRl.js";
import "./tool-replay-safety-mwAL5J2q.js";
import "./logger-ZAfp-Df-.js";
import "./bootstrap-files-ldv7LQkp.js";
import "./agent-end-side-effects-CpKBK0Oh.js";
import "./fs-paths-DNCksiBH.js";
import "./sandbox-7oZNAhIJ.js";
import "./nodes-utils-CYXmZviL.js";
import "./settled-turn-finalization-result-DRaTsrdI.js";
import { _ as wrapPluginSystemContextSection } from "./attempt-prompt-helpers-xOentD9b.js";
import "./prepare-auth-bvGF5XWf.js";
import "./heartbeat-tool-response-B20LLiS1.js";
import "./tools-BmQlzX_-.js";
import "./tool-schema-projection-ZrMdwk4s.js";
import "./attempt-tool-construction-plan-DvUzWxBA.js";
import "./embedded-agent-tool-media-D2in2Uoj.js";
import "./embedded-agent-tool-results-Chl9xQ-j.js";
import "./embedded-agent-message-tool-source-reply-sK3rstcH.js";
import { s as buildAgentHookContext } from "./lifecycle-hook-helpers-CA6g_0C9.js";
import "./attempt-thread-helpers-BFeqm_RQ.js";
import { n as prepareWatchedSessionsPrompt, t as buildWatchedSessionsPromptLines } from "./watched-sessions-prompt-CQ4_7B2D.js";
import "./transcript-credential-safety-CbpQd_gv.js";
import "./tool-result-middleware-BOYDy8qV.js";
import "./execution-auth-binding-CmucNoqo.js";
import "./result-fallback-classifier-Ba94zysF.js";
import "./build-BcjM0mSI.js";
import "./native-hook-relay-CmIE2Ei4.js";
...
async function loadCodexBundleMcpThreadConfig(params) {
	const { loadCodexBundleMcpThreadConfigCore: load } = await import("./codex-mcp-config-bOgbwZiT.js");
	return load(params);
}
/**
...
async function prepareHarnessNativeMcpAppPreview(params) {
	...
	const { buildMcpAppCanvasPayload, fetchMcpAppView } = await import("./mcp-ui-resource-B--by9VE.js");
...
async function materializeRequesterScopedMcpToolsForHarnessRun(params) {
	...
	const { materializeRequesterScopedMcpToolsForHarnessRunCore: materialize } = await import("./agent-bundle-mcp-harness-BxpbcwhO.js");
