...
import { c as parseAgentSessionKey, i as isCronSessionKey, r as isCronRunSessionKey } from "./session-key-utils-Di3FvABa.js";
...
import { st as sanitizeAgentRunTerminalReplyText } from "./openclaw-state-db-kmBThqu6.js";
...
import { a as mergeDeliveryContext, n as deliveryContextFromSession, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-azPdmUls.js";
import { a as isInternalMessageChannel, d as isDeliverableMessageChannel, f as isGatewayMessageChannel } from "./message-channel-BZwx7FCw.js";
...
import { I as completionRequiresMessageToolDelivery } from "./task-registry-aynazQHF.js";
import { c as isFailoverError } from "./failover-error-DVBvcQuA.js";
import { i as stripTargetTopicSuffix, n as stripOutboundTargetKindPrefix, r as stripTargetProviderPrefix } from "./channel-target-prefix-ByHwV3qn.js";
import { i as resolveConversationIdFromTargets } from "./conversation-binding-context-BeocHs-n.js";
...
import { a as formatEmbeddedAgentQueueFailureSummary, m as isEmbeddedRunAbandoned, u as isEmbeddedAgentRunActive, v as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-eqaxGmoQ.js";
import { i as isOutboundDeliveryError, o as isPlatformMessageRejectedError } from "./deliver-types-w6kiySpD.js";
import { c as getSubagentDepthFromSessionStore } from "./subagent-capabilities-Chg191Ne.js";
import { d as shouldPreserveUserFacingSessionStateForInputProvenance, o as isAgentMediatedCompletionSourceTool } from "./input-provenance-CCQsDhUy.js";
import { r as hasGeneratedMediaCompletionEvent, t as resolveRequesterStoreKey } from "./subagent-requester-store-key-B9iKefbQ.js";
import { n as sanitizeForPromptLiteral, r as wrapPromptDataBlock } from "./sanitize-for-prompt-C5q9LjmF.js";
import { t as dispatchGatewayMethodInProcess } from "./server-plugin-in-process-dispatch-BdIxABXU.js";
import { a as hasVisibleAgentPayload, i as hasIntentionalSilentAgentPayload } from "./message-visibility-B7uGWSom.js";
import "./subagent-announce.runtime.js";
import { _ as hasUnaccountedMessagingToolAggregateEvidence, a as getAgentCommandDeliveryFailure, b as resolveExplicitFinalSourceReplyDeliveryEvidence, c as hasCommittedOutboundDeliveryEvidence, g as hasPayloadOutcomeSendEvidence, l as hasCommittedSourceReplyDeliveryEvidence, m as hasMessagingToolDeliveryEvidence, o as getGatewayAgentResult } from "./delivery-evidence-JxKjzZU6.js";
import { o as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-DJ7b2f3m.js";
import { d as enqueueClaimedSessionDelivery, x as releaseSessionDeliveryClaim } from "./session-delivery-queue-storage-Ewx4waqo.js";
import { s as scheduleSessionDelivery, t as admitCorrelatedSubagentSessionDelivery } from "./subagent-completion-delivery-esPjci0g.js";
...
import { i as routeToDeliveryFields, r as routeFromConversationRef } from "./route-projection-DFMMuy1G.js";
...
function formatTaskCompletionEvent(event, mode) {
	...
	const statusLabel = truncateWithMarker(sanitizeSingleLineField(event.statusLabel, event.status), MAX_TASK_COMPLETION_STATUS_LABEL_CHARS, {
...
function isTransientAnnounceDeliveryError(error) {
	if (hasAnnounceSendEvidence(error) || isPermanentNonWriterAnnounceError(error)) return false;
...
async function sendSubagentAnnounceDirectly(params) {
	...
	try {
		...
		const completionSourceReplyDeliveryMode = requiresMessageToolDelivery ? "message_tool_only" : params.requireVisibleReply && deliveryTarget.deliver ? "automatic" : void 0;
		...
		if (directDeliveryFailure && !hasMessagingToolDelivery) return {
			delivered: false,
			path: "direct",
		...
		const requesterVisibleFinalDelivered = Boolean(directAnnounceResult && (hasMessagingToolDeliveryToSource(directAnnounceResult, deliveryTarget, { requireFinalReply: true }) || shouldDeliverAgentFinal && hasVisibleNonSilentGatewayPayload && directAnnounceResult.deliveryStatus?.status !== "suppressed"));
		const hasVisibleCompletionReply = requesterVisibleFinalDelivered || !params.requireVisibleReply && (hasMessagingToolDelivery || hasVisibleNonSilentGatewayPayload);
		...
		return {
			delivered: true,
			path: "direct",
			...params.expectsCompletionMessage && !params.requesterIsSubagent && requesterVisibleFinalDelivered ? { requesterVisibleFinalDelivered: true } : {}
		};
	} catch (err) {
...
//#endregion
export { loadRequesterSessionEntry as a, runAnnounceDeliveryWithRetry as c, formatAgentInternalEventsForPrompt as d, formatGeneratedMediaDeliveryRetryForPrompt as f, sanitizeGeneratedMediaDisplayText as h, resolveSubagentCompletionOrigin as i, collectAgentInternalEventMedia as l, mediaUrlsFromGeneratedAttachments as m, isInternalAnnounceRequesterSession as n, loadSessionEntryByKey as o, formatGeneratedAttachmentLines as p, resolveAnnounceOrigin as r, resolveSubagentAnnounceTimeoutMs as s, deliverSubagentAnnouncement as t, formatAgentInternalEventsForPlainPrompt as u };
