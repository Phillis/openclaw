...
import { M as createConditionalWarningCollector, O as createAllowlistProviderGroupPolicyWarningCollector, i as createDangerousNameMatchingMutableAllowlistWarningCollector, r as collectStandardAllowlistLists, t as buildMutableAllowEntryDetector } from "./channel-policy-RPOWSkLP.js";
...
import { m as listChannelsForTeamWithPageInfo, r as normalizeMSTeamsConversationId, t as extractMSTeamsConversationMessageId, y as resolveGraphToken } from "./inbound-Clg3k_wg.js";
import { a as parseMSTeamsConversationId, d as resolveMSTeamsChannelAllowlist, f as resolveMSTeamsTeamsConfig, i as normalizeMSTeamsUserInput, n as looksLikeMSTeamsTargetId, o as parseMSTeamsTeamChannelInput, p as resolveMSTeamsUserAllowlist, r as normalizeMSTeamsMessagingTarget, t as looksLikeMSTeamsConversationId } from "./resolve-allowlist-Cd7Hfq6b.js";
import { t as msteamsDirectoryContractPlugin } from "./directory-contract-api-BBO2otbc.js";
import { i as resolveMSTeamsRouteConfig, n as resolveMSTeamsGroupToolPolicy, r as resolveMSTeamsReplyPolicy } from "./policy-BiuWEgYg.js";
import { r as resolveMSTeamsAccount } from "./channel-config-C8JtQsBg.js";
import { i as msTeamsApprovalCapability, n as resolveMSTeamsOutboundSessionRoute, o as shouldSuppressLocalMSTeamsExecApprovalPrompt, r as isMSTeamsNativeApprovalClientEnabled, t as inferMSTeamsTargetChatType } from "./session-route-Cc9CcgtA.js";
...
const loadMSTeamsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Bz05H7jG.js"), "msTeamsChannelRuntime");
...
const msteamsPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorMSTeamsProvider } = await import("./src-BvuhnoCP.js");
