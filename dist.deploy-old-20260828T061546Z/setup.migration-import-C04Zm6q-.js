...
import { Xt as resolveOpenClawStateSqlitePath, i as closeOpenClawStateDatabaseByPath } from "./openclaw-state-db-kmBThqu6.js";
import { i as listAvailableManifestContractPlugins, o as loadManifestContractSnapshot } from "./manifest-contract-eligibility-DI1_0gqL.js";
import { g as openOpenClawAgentDatabase, l as disposeOpenClawAgentDatabaseByPath } from "./openclaw-agent-db-BEQsKM0c.js";
import { M as registerOpenClawAgentDatabase, N as unregisterOpenClawAgentDatabase } from "./openclaw-agent-db-maintenance-_0tYy-zT.js";
import { n as clearRuntimeAuthProfileStoreSnapshot } from "./store-C6iqqcJy.js";
import { n as t } from "./i18n-BQpjgFU-.js";
import { n as WizardCancelledError } from "./prompts-DLsO8MlU.js";
import { a as projectAgentModelDefaults, i as prepareAgentModelDefaults, n as applyOnboardingPrimaryModel, s as resolveOnboardingSetupTarget } from "./onboard-agent-target-CwN0HHjK.js";
...
const loadAuthChoiceModule = createLazyRuntimeModule(() => import("./auth-choice-BpksbcA1.js"));
const loadModelPickerModule = createLazyRuntimeModule(() => import("./model-picker-BNEqZVyA.js"));
async function resolveAuthChoiceModelSelectionPolicy(params) {
	...
	const [{ resolveManifestProviderAuthChoice }, { resolvePluginSetupProviderCore }] = await Promise.all([import("./provider-auth-choices-BBlMQrUH.js"), import("./setup-registry-D1db7QDn.js")]);
...
async function runSetupModelAuthStep(params) {
	...
	if (authChoiceFromPrompt) {
		const [{ ensureAuthProfileStore }, { promptAuthChoiceGrouped: promptAuthChoice, isKeepCurrentAuthChoice: isKeepCurrentChoice }, { detectAvailableSetupProviderIds }] = await Promise.all([
			...
			import("./auth-choice-prompt-CK4ocd2d.js"),
			import("./provider-setup-availability-DLA6V8sq.js")
		]);
	...
	while (true) {
		...
		if (authChoice === "custom-api-key") {
			const { promptCustomApiConfig } = await import("./onboard-custom-hKVMV-IT.js");
...
async function createPromotionConfigRuntime(config) {
	const { mutateConfigFile } = await import("./mutate-CyehQ3RQ.js");
...
const loadMigrationProviderRuntimeModule = createLazyRuntimeModule(() => import("./migration-provider-runtime-MUAq328D.js"));
const loadMigrationContextModule = createLazyRuntimeModule(() => import("./context-CGZZ1-P2.js"));
