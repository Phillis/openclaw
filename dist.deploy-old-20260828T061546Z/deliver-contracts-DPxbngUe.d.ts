import { Ht as SilentReplyConversationType, r as OpenClawConfig } from "./types.openclaw-CflOMr0r.js";
...
import { f as MessagePresentation, j as ReplyPayloadDelivery, o as LegacyInteractiveReply } from "./payload-DqmbZu1w.js";
import { nt as ExecutionIdentityAdmissionToken } from "./templating-D4gA1hJr.js";
import { t as OutboundMediaAccess } from "./load-options-BwtyeSvQ.js";
import { A as OutboundSendDeps, D as OutboundReplyFacts, k as RenderedMessageBatchPlanItem, m as ChannelMessageUnknownSendReconciliationResult } from "./types-DoOzdtUM.js";
import "./types.adapters-BTze_x-2.js";
import { n as OutboundPayloadDeliveryOutcome, r as OutboundPayloadDeliverySuppressionReason, t as OutboundDeliveryResult } from "./deliver-types-Ccj5Ek8e.js";
import { o as OutboundIdentity, s as OutboundDeliveryFormattingOptions, t as ChannelDeliveryCapabilities } from "./outbound.types-CjLqEEYw.js";
import "./openclaw-state-db.generated-CIYJwO5s.js";
import { S as PluginHookReplyPayloadSendingContext, lt as ReplyDispatchKind } from "./hook-runner-global-BT-5aVkB.js";
import { n as SessionTranscriptDeliveryMirror } from "./transcript-Cc2yBoHe.js";
import { M as resolveSendableOutboundReplyParts } from "./reply-payload-BiDTglEn.js";
