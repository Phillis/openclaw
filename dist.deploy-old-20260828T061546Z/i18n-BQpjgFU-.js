	...
	en: {
		...
		wizard: {
			...
			completion: {
				...
				profileNotWritable: "Shell completion was not changed: {profile} is not writable. Run `{command}` against a writable profile file.",
	...
	"zh-CN": {
		...
		wizard: {
			...
			completion: {
				...
				profileNotWritable: "Shell completion 未更改：{profile} 不可写。请对可写的 profile 文件运行 `{command}`。",
	...
	"zh-TW": {
		...
		wizard: {
			...
			completion: {
				...
				profileNotWritable: "Shell completion 未變更：{profile} 無法寫入。請對可寫入的 profile 檔案執行 `{command}`。",
