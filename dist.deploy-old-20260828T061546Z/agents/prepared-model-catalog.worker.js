import { c as restorePluginMetadataSnapshot } from "../plugin-metadata-snapshot-BI5GxVU3.js";
import { n as withPluginRuntimeGenerationScope } from "../generation-scope-D--dYlKj.js";
import { _ as mergeRuntimeExternalProfileReferences } from "../persisted-Bjx2XcL3.js";
import { n as overlayExternalAuthProfiles } from "../external-auth-CHgvfGCk.js";
import { n as listExternalCliSyncProviderIds } from "../external-cli-sync-CJBPPHII.js";
import { m as preserveResolvedSecretBackedCredentials, p as loadAuthProfileStoreWithoutExternalProfiles } from "../store-C6iqqcJy.js";
import { g as replaceRuntimeAuthProfileStoreSnapshots } from "../runtime-snapshots-a_60jBeK.js";
import { n as resolveRuntimeSyntheticAuthProviderRefs } from "../synthetic-auth.runtime-XcoHj0ye.js";
import { d as resolveAmbientAgentCredentialsForDiscovery, f as resolveAgentCredentialMapFromStore, p as resolveUsableAgentCredentialModes } from "../prepared-model-runtime.plugin-generation-BRpVvyDa.js";
import { vt as AuthStorage } from "../sessions-BLpYW515.js";
import { a as scopeSyntheticAuthProviderRefs } from "../prepared-model-runtime.facts-CSb2qjkX.js";
import { r as fingerprintPreparedModelCatalogGeneration } from "../prepared-model-catalog-worker-CJTl6UW0.js";
...
async function prepareWorkerGeneration(value) {
	const { prepareWorkspaceBuildGroup } = await import("../prepared-model-runtime.facts-AqWw4Ug8.js");
...
async function runPreparedModelCatalogWorkerRequest(value, request, preparedGeneration = prepareWorkerGeneration(value)) {
	try {
		...
		const { prepareAgentCatalogSource } = await import("../prepared-model-runtime.facts-AqWw4Ug8.js");
		const { prepareFullCatalogFacts } = await import("../prepared-model-runtime.full-catalog-RItgiVlP.js");
		const authStore = refreshAuthStore({
			agentDir: value.input.agentDir,
			inheritedAuthDir: value.input.inheritedAuthDir,
			authStore: value.authStore,
