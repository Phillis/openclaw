...
import { t as createAbortError$1 } from "./abort-signal-D2k14JsD.js";
import "./boundary-path-DDLrDh1C.js";
import { w as resolveStateDir } from "./paths-BBSTUjD5.js";
import { r as formatErrorMessage } from "./errors-Ccx0R-_Z.js";
import { t as OPENCLAW_CLI_ENV_VAR } from "./openclaw-exec-env-BmbZ1aqS.js";
import { n as normalizeAgentId } from "./agent-id-CeT3w4ap.js";
import { s as resolveAgentConfig } from "./agent-scope-config-CUBiGmG3.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, i as isCronSessionKey } from "./session-key-utils-Di3FvABa.js";
...
import { c as emitTrustedSecurityEvent, n as emitDiagnosticEvent } from "./diagnostic-events-BGzDm6gu.js";
import { t as createSubsystemLogger } from "./subsystem-a4KzJVZG.js";
import { i as normalizeChatChannelId } from "./ids-Cgp0iV_A.js";
import { d as PROCESS_TOOL_DISPLAY_SUMMARY, u as EXEC_TOOL_DISPLAY_SUMMARY } from "./tool-catalog-DKzjKSZr.js";
import { c as sanitizeHostExecEnvWithDiagnostics, n as isDangerousHostEnvOverrideVarName, o as normalizeHostOverrideEnvVarKey, r as isDangerousHostEnvVarName } from "./host-env-security-B_a4cpNH.js";
import { o as resolveShellEnvFallbackTimeoutMs, r as getShellPathFromLoginShell } from "./shell-env-Aw9vy7GT.js";
import { i as logWarn, r as logInfo } from "./logger-D4iLuGk3.js";
import { r as addSafeTimeoutDelayGraceMs } from "./timeouts-D2XMKe-X.js";
import { i as emitAgentEvent } from "./agent-events-CcZImb5w.js";
import { c as resolveApprovalAuditTrustPath, m as resolveExecutionTargetTrustPath } from "./exec-command-resolution-CJ9Vm03p.js";
import { F as splitShellArgs, c as isBlockedShellWrapperCommand } from "./shell-wrapper-resolution-BddNi41x.js";
...
import { f as isGatewayMessageChannel, s as isNativeApprovalChannel } from "./message-channel-BZwx7FCw.js";
import { _ as runWithGatewayIndependentRootWorkAdmission, t as GatewayDrainingError } from "./gateway-work-admission-CTDt7IQ1.js";
...
import { a as failedTextResult, n as ToolInputError } from "./common-CI1GnPjt.js";
import { n as textResult } from "./tool-results-BCM3fdVS.js";
import { h as BACKGROUND_EXEC_TASK_KIND } from "./task-registry-aynazQHF.js";
import { a as renderExecUpdateText, i as renderExecOutputText, n as appendExecTimeoutRetryGuidance, r as renderExecExitLabel } from "./bash-tools.exec-output-D1Z0C3oY.js";
import { t as renderUserFacingText } from "./user-facing-text-BAcix5i_.js";
import { D as parseExecApprovalResultText, E as isExecDeniedResultText, T as formatExecDeniedUserMessage } from "./user-copy-LZk56sIA.js";
...
import { A as truncateMiddle, D as padProcessStatus, E as deriveSessionName, O as readEnvInt, S as buildSandboxEnv, T as coerceEnv, _ as markTerminalPollObserved, a as compareProcessSessionStartOrder, b as tail, h as markBackgrounded, k as sliceLogLines, l as getFinishedSession, m as listRunningSessions, o as deleteSession, p as listFinishedSessions, s as drainSession, t as acknowledgeNotifyOnExit, u as getSession, w as clampWithDefault, y as setJobTtlMs } from "./bash-process-registry-08adq0zn.js";
...
import { o as withoutGatewayToolCallerIdentity } from "./gateway-caller-context-DNtidJOJ.js";
import { c as stripMalformedXmlArgValueSuffixFromKeys } from "./agent-tools.before-tool-call.decision-VMqO_Jh9.js";
import { a as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-C_pfENzq.js";
import { u as resolveExecApprovalsTranscriptPath } from "./exec-approvals-config-_UJgdeLU.js";
import { A as requiresExecApproval, D as maxAsk, I as normalizeExecAsk, N as resolveExecApprovalUnavailableDecisions, O as minSecurity, S as resolveDurableExecApprovalRequirement, T as commandRequiresSecurityAuditSuppressionApproval, U as resolveExecModePolicy, V as requireValidExecTarget, a as resolveExecApprovalsLocked, b as resolveAllowAlwaysPatternCoverage, c as commitExecAuthorizationLocked, g as hasNodeCommandAllowAlwaysMarker, h as hasExactCommandDurableExecApproval, i as resolveExecApprovalsFromFile, j as resolveExecApprovalAllowedDecisions, m as hasDurableExecApproval, p as createExecApprovalPolicySnapshot, x as resolveAllowAlwaysPersistenceDecision } from "./exec-approvals-PtbcLeQo.js";
import { a as loadExecApprovals, t as countObsoleteGeneratedExecApprovals } from "./exec-approvals-generated-migration-KEjNHNyB.js";
import { t as buildEnforcedShellCommand } from "./exec-approvals-analysis-BvkQXLiO.js";
import "./exec-wrapper-resolution-Et5CIZnS.js";
import { l as describeInterpreterInlineEval } from "./risks-D6ZQ78A6.js";
import { i as evaluateShellAllowlistWithAuthorization } from "./exec-approvals-allowlist-BNiuHBrn.js";
...
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-BweynCr2.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-BVSOxLTx.js";
import { i as processSchema, n as execSchema } from "./bash-tools.schemas-B7Xq1jzd.js";
import { o as prepareGitHubToolEnvironment } from "./github-tool-identity-B__a3yB4.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-DvwiJ0s1.js";
import { t as sendMessage } from "./message-dARLE1vh.js";
import { t as isApprovalNotFoundError } from "./approval-errors-Bzw_-cAg.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-Up5PqO7Z.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as buildApprovalPendingMessage, f as normalizeNotifyOutput, g as runExecProcess, h as resolveExecTarget, i as DEFAULT_PATH, l as buildExecRuntimeErrorOutcome, m as resolveApprovalRunningNoticeMs, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as ExecProcessPreflightError, r as DEFAULT_MAX_OUTPUT, s as applyShellPath, u as createApprovalSlug } from "./bash-tools.exec-runtime-CMnpBkJC.js";
import { a as resolveRegisteredExecApprovalDecision, i as registerExecApprovalRequestForHostOrThrow, n as buildExecApprovalTurnSourceContext, r as isExecApprovalRunAbortedError, t as buildExecApprovalRequesterContext } from "./bash-tools.exec-approval-request-Dvy5w04a.js";
import { c as prepareSystemRunMutableFileBinding, d as revalidateSystemRunMutableFileBinding, g as extractShellCommandFromArgv, v as resolveSystemRunCommandRequest } from "./system-run-approval-binding-0Gs8JaF5.js";
import { n as detectPolicyInlineEval } from "./policy-7EVCJmzu.js";
import { i as formatExecApprovalContinuationSourceOutput, n as buildExecApprovalContinuationFallbackPrompt, r as buildExecApprovalContinuationPrompt } from "./bash-tools.exec-approval-output-D90XjSjB.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-Dax3JT_s.js";
import { n as rejectUnsafeExecControlShellCommand, r as rejectUnsafeExecLiveStateSqliteShellCommand } from "./exec-control-command-guard-D9mRsfc0.js";
import { i as registerSecretEgressProxyRun, n as isSecretEgressProxyActive } from "./registry-AG1Awcc4.js";
import { i as validateCronStandingGrant, n as consumeCronStandingGrant, t as buildCronExecOperationBinding } from "./operator-approval-standing-grants-Cvwjm-d5.js";
...
import { i as resolveExecAutoReviewDecision, n as defaultExecAutoReviewer } from "./exec-auto-review-Biuf1fPP.js";
import { i as isExecApprovalFollowupSessionRebound, o as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-CiA8RPlH.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-VVq_wcNX.js";
import { t as createModelExecAutoReviewer } from "./exec-auto-reviewer-CXCPkwzI.js";
...
function isExecApprovalFollowupDirectDeliveryStale(params) {
	...
	try {
		...
		return isExecApprovalFollowupSessionRebound({
			expectedSessionId,
			resolvedSessionId: normalizeOptionalString(loadSessionEntryReadOnly({
...
function shouldAwaitGatewayApprovalInline(params) {
	...
	if (params.trigger === "cron") return true;
...
async function processGatewayAllowlist(params) {
	...
	if (policyRequiresAsk || durableApprovalRequiresBinding) {
		...
		if (!prepared.ok) return { deniedResult: buildGatewayExecApprovalDeniedToolResult({
	...
	const approvalAllowAlwaysPersistence = mutableFileApprovalRequiresOneShot || requiresAllowlistPlanApproval && allowAlwaysPersistence.kind === "patterns" ? ONE_SHOT_ALLOW_ALWAYS : allowAlwaysPersistence;
	...
	if (requiresAsk) {
		...
		const executableCandidates = authorizationCandidates.filter((_candidate, index) => allowlistEval.segmentSatisfiedBy[index] !== "safeBuiltins");
		const autoReviewSingleSegment = authorizationCandidates.length === 1 ? executableCandidates[0]?.sourceSegment : void 0;
		...
		const autoReviewHasExecutableBinding = authorizationCandidates.length <= MAX_GATEWAY_AUTO_REVIEW_CANDIDATES && executableCandidates.length > 0 && autoReviewEnforcedCommand !== void 0 && executableCandidates.every(({ sourceSegment }) => Boolean(sourceSegment.resolution?.policyBlocked !== true && (sourceSegment.resolution?.wrapperChain?.length ?? 0) === 0 && !isBlockedShellWrapperCommand(sourceSegment.argv) && resolveExecutionTargetTrustPath(sourceSegment.resolution, params.workdir)));
		const canAutoReviewApprovalMiss = params.autoReview === true && hostAsk !== "always" && autoReviewHasExecutableBinding && !requiresHeredocApproval && !requiresSecurityAuditSuppressionApproval;
		...
		if (canAutoReviewApprovalMiss && autoReviewEnforcedCommand) {
			...
			const pendingDecision = resolveExecAutoReviewDecision(reviewer, {
				...
				host: "gateway",
				reason: requiresInlineEvalApproval ? "strict-inline-eval" : hasGatewayAllowlistMiss({
					hostSecurity,
					analysisOk,
					allowlistSatisfied,
					durableApprovalSatisfied
...
async function executeNodeHostCommand(params) {
	...
	params.signal?.throwIfAborted();
	if (params.bypassHostApprovalFloors) return await invokeNodeSystemRunDirect({
		request: params,
		target
	});
...
function resolveExecPreparedRunEnvironment(defaults) {
	return defaults?.preparedRunEnvironment ?? prepareGitHubToolEnvironment({
...
function resolvePreparedExecEnvironment(params) {
	...
	if (params.secretEgressEnv) Object.assign(inheritedBaseEnv, params.secretEgressEnv);
	...
	if (params.storeEnv && Object.hasOwn(params.storeEnv, "OPENCLAW_CLI")) rejectedStoreKeys.add(OPENCLAW_CLI_ENV_VAR);
	...
	if (params.secretEgressEnv) Object.assign(env, params.secretEgressEnv);
	const preparedEnv = {
	...
	return {
		env,
		...Object.keys(preparedEnv).length > 0 ? { requestedEnv: {
			...requestedEnv,
			...preparedEnv
		} } : { requestedEnv }
	};
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-ByMVBlVe.js"));
...
function buildExecForegroundResult(params) {
	...
	return textResult(`${warningText}${renderExecOutputText(params.outcome.aggregated)}${retentionCapNote}`, {
		status: "completed",
...
function createExecHostResolver(defaults) {
	return (params) => {
		...
		const effectiveDefaultMode = elevatedAllowed && !defaults?.sandboxRequired ? elevatedDefaultMode : "off";
...
function createExecTool(defaults) {
	...
	let storeEnvPromise;
	const resolveStoreEnv = () => storeEnvPromise ??= import("./secret-store-BJVpHvk_.js").then((store) => store.readSecretStoreExecEnvironment({
	...
	const defaultTimeoutSec = defaults?.timeoutSec && defaults.timeoutSec > 0 ? defaults.timeoutSec : 1800;
	...
	return {
		...
		execute: async (toolCallId, args, signal, onUpdate) => {
			...
			const bypassApprovals = defaults?.bypassHostApprovalFloors === true || elevatedRequested && elevatedMode === "full" && modePolicyAllowsFullBypass && hostPolicyAllowsFullBypass;
			...
			try {
				...
				if (useSecretEgress) {
					...
					secretEgressEnv = registerSecretEgressProxyRun(defaults.operationalRunInstance, storeEnv.secretEgressBindings ?? []);
				}
...
function finishedPollResult(sessionId, finished) {
	...
	return {
		...
		execute: async (_toolCallId, args, signal, _onUpdate) => {
				...
				return {
					content: [{
						...
						text: sessions.map((s) => {
							...
							return `${s.sessionId} ${padProcessStatus(s.status, 9)} ${formatDurationCompact(s.runtimeMs) ?? "n/a"}${marker} :: ${label}`;
			...
			switch (params.action) {
				case "poll": {
					if (!scopedSession) {
						if (scopedFinished) return finishedPollResult(params.sessionId, scopedFinished);
					...
					if (pollWaitMs > 0 && !scopedSession.exited) {
						...
						while (!scopedSession.exited && scopedSession.pendingOutput.length === 0 && !scopedSession.pendingOutputDropped && Date.now() < deadline) await sleepPollInterval(Math.max(0, Math.min(250, deadline - Date.now())), signal);
					}
					if (scopedSession.exited) {
						markTerminalPollObserved(scopedSession);
						if (scopedSession.endedAt !== void 0 && isInScope(scopedSession)) return finishedPollResult(params.sessionId, scopedSession);
						resetPollRetrySuggestion(params.sessionId);
						return failText(`No session found for ${params.sessionId}`);
					}
					...
					return {
						content: [{
							type: "text",
							text: (output || "(no new output)") + aggregateOutputNote + retainedOutputNote + (buildInputWaitHint(runtime) || "\n\nProcess still running.")
						}],
						details: {
							status: "running",
							sessionId: params.sessionId,
				...
				case "log": {
					...
					const text = (slice || (scopedSession ? "(no output yet)" : "(no output recorded)")) + defaultTailNote(totalLines, window.usingDefaultTail) + retentionCapNote(record);
					return {
						content: [{
							type: "text",
							text: runtime ? text + buildInputWaitHint(runtime) : appendExecTimeoutRetryGuidance(text, record.exitReason)
						}],
						details: {
							...runtime ? {
