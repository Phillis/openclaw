...
async function runPluginUninstallCommandUnlocked(id, opts, runtime, skipPreview = false) {
	...
	const { loadInstalledPluginIndex } = await import("./installed-plugin-index-Cb4YHI7I.js");
	const { resolveInstalledPluginPackageOwnership } = await import("./installed-plugin-package-ownership-DbHurjIv.js");
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-XoanF0fH.js");
	const { buildPluginSnapshotReport } = await import("./status-tOsR5fEI.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, pluginUninstallTargetExists, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-DjLgwtS1.js");
	...
	const { commitPluginInstallRecordsWithConfig } = await import("./install-record-commit-Cj6iLNwc.js");
	const { selectInstallMutationWriteOptions } = await import("./install-persistence-DTHnNCyc.js");
	...
	if (!skipPreview) {
		...
		const { collectClawPluginUninstallWarnings } = await import("./uninstall-claw-references-CBwmU1G2.js");
