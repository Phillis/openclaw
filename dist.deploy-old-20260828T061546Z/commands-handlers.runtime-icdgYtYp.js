...
import { D as resolveExpiresAtMsFromDurationMs, M as resolveNonNegativeIntegerOption, N as resolveOptionalIntegerOption, R as timestampMsToIsoString, o as asDateTimestampMs } from "./number-coercion-CLj0HTDM.js";
...
import { r as clampInt } from "./utils-Bw16L5tB.js";
...
import { O as resolveSessionAuthProfileOverrideSource, g as resolveSessionAgentIds, h as resolveSessionAgentId } from "./agent-scope-DigoIwHb.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePathCore, o as resolveSessionStorePathCore, r as resolveDefaultSessionStorePath } from "./paths-DVAvlIOc.js";
import { $ as resetConfigOverrides, P as validateConfigObjectWithPlugins, Q as getConfigOverrides, et as setConfigOverride, ft as resolveOwnerPromptNumbers, l as readConfigFileSnapshotForWrite, s as readConfigFileSnapshot, tt as unsetConfigOverride } from "./io-ClLVsBMp.js";
...
import { d as toolPolicyRestrictsTools } from "./tool-policy-B1rvCc4B.js";
...
import { m as patchSessionEntryCore, p as loadSessionEntryReadOnly, w as resolveSessionStorePathForScope } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
import { a as normalizeChannelId, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CZjiz1Jg.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-DYpQkXDD.js";
import { c as normalizeSessionDeliveryState, d as sessionDeliveryOrigin, n as deliveryContextFromSession } from "./delivery-context.shared-azPdmUls.js";
...
import { a as normalizeStoreSessionKey, s as resolveSessionStoreEntryCore } from "./store-entry-BN3xGmHe.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { T as scanSessionTranscriptTree } from "./session-transcript-index-_z9fjL8c.js";
import { o as resolveFreshSessionTotalTokens } from "./types-gVK8DqPC.js";
import { nt as updateSessionEntry, xt as applySessionPatchProjection } from "./session-accessor-fcDZuc2H.js";
import { b as loadTranscriptEvents } from "./session-accessor.sqlite-transcript-store-CZRFPUnE.js";
import { t as extractDeliveryInfo } from "./sessions-BI8dPUCI.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-DXU5onHR.js";
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-DyWvGcd6.js";
import "./installed-plugin-index-records-CHK-Mu2-.js";
import { a as migrateSessionEntries } from "./session-manager-codec-CANcDH2n.js";
import "./session-manager-CBD-q5pC.js";
...
import { i as isCliRuntimeAliasForProvider, s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-Rrd1VaX1.js";
import { t as withPluginLifecycleLease } from "./plugin-lifecycle-lease-QVxAzcU7.js";
import { i as formatTaskStatusTitle, n as formatTaskStatus, r as formatTaskStatusDetail, t as buildTaskStatusSnapshot } from "./task-status-BrVINLTy.js";
import { t as getSessionBindingService } from "./session-binding-service-47rBLtwF.js";
import { r as matchPluginCommand, t as executePluginCommand } from "./commands-Bm2OdgpI.js";
import { i as formatFastModeCurrentStatus } from "./fast-mode-CCX0YiYh.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-DUo8QOyN.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-CHAvu2jh.js";
import { l as listTasksForSessionKeyForStatus, s as listTasksForAgentIdForStatus } from "./task-status-access-BpeKxCiz.js";
import { a as readAcpSessionMetaForEntry } from "./session-meta-CpNLCGd4.js";
import { m as replyRunRegistry } from "./reply-run-registry-Ch9Ye6re.js";
import { a as formatDoctorNonInteractiveHint, m as writeRestartSentinel, n as clearRestartSentinel, t as buildRestartSuccessContinuation } from "./restart-sentinel-DedQJXFM.js";
import { l as getFinishedSession, u as getSession } from "./bash-process-registry-08adq0zn.js";
import { t as cancelBackgroundExecSession } from "./bash-process-control-DQTdnA_w.js";
import { o as resolveReplyToMode } from "./reply-threading-Dbzi6VQA.js";
import { i as resolveBootstrapTotalMaxChars, r as resolveBootstrapMaxChars } from "./bootstrap-CPC1PIIz.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D-khMh6L.js";
import { St as classifyCompactionReason, Tt as isBenignCompactionSkipResult, bt as estimateMessageCharsCached, h as isRealConversationMessage, yt as createMessageCharEstimateCache } from "./builtin-openclaw-BruFLvIP.js";
import { a as getSpeechProvider, i as canonicalizeSpeechProviderId, s as listSpeechProviders } from "./directives-r7hZudXu.js";
import { _ as resolveTtsPrefsPath, a as getTtsMaxLength, c as isTtsEnabled, h as resolveTtsConfig, l as listTtsPersonas, o as getTtsPersona, s as isSummarizationEnabled } from "./tts-settings-BPz5yC2d.js";
import { n as redactConfigObject, r as redactConfigSnapshot, t as REDACTED_SENTINEL } from "./redact-snapshot-Cc1aNUFV.js";
import { a as revokeMessageActionTurnCapability, n as mintMessageActionTurnCapability, t as isTrustedMessageActionTurnIngress } from "./message-action-turn-capability-CLlRwpDl.js";
import { a as markCommandSessionMetadataChanged, n as handleGoalCommand } from "./commands-goal-CJciJlgD.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-cn0iy209.js";
...
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-BuQQfgcO.js";
import "./sandbox-7oZNAhIJ.js";
import { o as readSessionMessagesAsync } from "./session-transcript-readers-fCOIrclF.js";
import { w as deriveSessionTitle } from "./session-utils-list-D98WVYL8.js";
...
import { n as routeReply } from "./route-reply-aIpe57kt.js";
import { t as clearSessionQueues } from "./cleanup-CiIpHyQA.js";
import "./queue-C5hWHBtI.js";
import { _ as resolveConfigWriteTargetFromPath, g as formatConfigWriteDeniedMessage, h as canBypassConfigWritePolicy, m as authorizeConfigWrite, v as resolveExplicitConfigWriteTarget } from "./channel-config-helpers-C7An4wuC.js";
...
import { t as SKILL_AUTHORING_STANDARDS_PROMPT } from "./skill-authoring-standards-g_9HVRCX.js";
import { T as isTtsProviderConfigured, _ as setTtsProvider, c as getLastTtsAttempt, d as setLastTtsAttempt, f as setSummarizationEnabled, g as setTtsPersona, h as setTtsMaxLength, m as setTtsEnabled, t as getTtsProvider, w as getResolvedSpeechProviderConfig } from "./runtime-api-Bww67amX.js";
import { n as textToSpeech } from "./tts-CPk-KJAA.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-Bup8A0WJ.js";
import { n as agentHarnessExposesOpenClawTools, s as selectAgentHarness } from "./selection-uTriTeN_.js";
import "./commands-registry-jNlmfKbj.js";
import { n as applyCommandTextToParams } from "./command-context-rewrite-DyA5NUca.js";
import { a as rejectNonOwnerCommand, c as requireGatewayClientScope, i as matchCommandPrefix, n as commandReply, o as rejectUnauthorizedCommand, r as defineAuthorizedTextCommand, s as requireCommandFlagEnabled, t as buildDisabledCommandReply } from "./command-gates-BN6pp6B0.js";
import { a as stripMentions, o as stripStructuralPrefixes } from "./mentions-BHWGvP4S.js";
import { i as PLUGIN_COMMAND_DISPATCH, n as executePluginCommandDispatch, r as matchPluginCommandInvocation, t as createPluginCommandRuntime } from "./plugin-command-runtime-DaGKqCFO.js";
import { n as formatTimeAgo } from "./format-relative-DerIyym2.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-CCcWeviJ.js";
import { l as removeChannelAllowFromStoreEntry, n as addChannelAllowFromStoreEntry, s as readChannelAllowFromStore } from "./pairing-store-DNjQLson.js";
...
import { t as handleSystemAgentCommand } from "./commands-system-agent-BpZ8sWF7.js";
import { n as resolvePluginCapabilityConsentCliOptions, t as formatPluginCapabilityConsentLines } from "./plugin-capability-consent-BmEuLeTG.js";
import { n as resolveSkillWorkshopToolPolicyAvailability } from "./tool-policy-diagnostic-CbZOnty-.js";
import { n as parseActivationCommand } from "./group-activation-B6ER3hWD.js";
import { i as resolveActiveExplicitSteerSessionKey, n as extractExplicitGroupId, r as parseSteerMessage, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-Y8verrA6.js";
import { s as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-BaNyIk3G.js";
import { o as sessionSnapshotChangesApplied } from "./session-snapshot-merge-B4KFr9oE.js";
...
import { n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContextAsync, t as resolveConfiguredModelCompat } from "./tools-effective-inventory-9OS7ryTy.js";
import { n as formatAbortReplyText, r as stopSubagentsForRequester, t as abortSessionRunTargetWithOutcome } from "./abort-CJVbfjF8.js";
import { t as extractBtwQuestion } from "./btw-command-B-jQHunE.js";
import { r as handleModelsCommand } from "./commands-models-h5b_qhwI.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-B0tNkqr7.js";
import { t as codexChannelLoginRuntime } from "./provider-auth-login-flow-runtime-MuqIS0bu.js";
import { r as createExecTool } from "./bash-tools-COqf5pwM.js";
import { t as runBtwSideQuestion } from "./btw-Cn87SD0a.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-D7AVTG6U.js";
import { b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-CWkdSP3T.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, o as resolveRequesterSessionKey } from "./shared-lXLQVSrn.js";
import { t as buildToolsMessage } from "./status-CMUycIa3.js";
import { n as resolveCommandSurfaceChannel, t as resolveChannelAccountId } from "./channel-context-Q7L4s7fc.js";
import { d as resolvePluginCapabilityConsent, l as resolvePendingPluginCapabilityReview } from "./capability-consent-WudatxYT.js";
import { t as handleApproveCommand } from "./commands-approve-C98E-h35.js";
import { n as loadGatewayRuntimeConfigSchema } from "./runtime-schema-I9JI2U6_.js";
import { t as parseConfigValue } from "./config-value-D2VJu0bm.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-B1ZQFWi0.js";
import { n as buildStatusReply, t as buildStatusPluginsReply } from "./commands-status-BSjaKSqP.js";
import { t as listConfiguredMcpServers } from "./mcp-config-De1SycU1.js";
import { n as unsetConfiguredMcpServer, t as setConfiguredMcpServer } from "./mcp-config-mutation-BoLnQ2z9.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./registry-refresh-Hpdl6ZAz.js";
import { a as buildPluginDiagnosticsReport, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-DINEeQjY.js";
...
import { i as selectInstallMutationWriteOptions, r as resolveInstallConfigMutationPreflights } from "./install-persistence--RyplCkl.js";
import { r as resolvePluginInstallSourcePlan } from "./plugin-install-plan-Dz2XWMPo.js";
import { n as createPluginInstallLogger } from "./plugins-command-helpers-CJtcBFDQ.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-B4Yh67g7.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-BRDtXaoK.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-B6n9cV_i.js"));
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "poll") {
		...
		if (finished) {
			...
			return { text: [
				`${finished.terminalStatus === "completed" ? "⚙️" : "⚠️"} bash finished (session ${formatSessionSnippet(sessionId)}).`,
				`Exit: ${exitLabel}`,
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CPoe2Beu.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-CsmfIQIa.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-HOJtp7kE.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-DWtTGEZd.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-CRI9cm8x.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-Bey2YawM.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-BrhCWS1l.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-Cfc9dQ3y.js"));
