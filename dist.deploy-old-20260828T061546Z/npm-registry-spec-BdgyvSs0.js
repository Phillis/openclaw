...
function resolveOpenClawReleaseCohortVersion(value) {
	const trimmed = value.trim();
	const parsed = parseOpenClawReleaseVersion(trimmed);
	return parsed && isOpenClawCorrectionSemver(parsed) ? `${parsed.major}.${parsed.minor}.${parsed.patch}` : trimmed;
}
...
//#endregion
export { isPrereleaseResolutionAllowed as a, resolveNpmJsonEntries as c, isOpenClawOrgNpmSpec as i, resolveOpenClawReleaseCohortVersion as l, formatPrereleaseResolutionError as n, isPrereleaseSemverVersion as o, isExactSemverVersion as r, parseRegistryNpmSpec as s, compareOpenClawReleaseVersions as t, validateRegistryNpmSpec as u };
