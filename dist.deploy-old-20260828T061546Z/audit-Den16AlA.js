...
import { C as tryResolveLegacyCompatibilityAgentId, S as tryResolveDefaultAgentId, n as hasAgentRosterProperty, r as listAgentEntries } from "./agent-scope-config-CUBiGmG3.js";
...
import { n as copyConfigResolutionFacts, s as hasUnresolvedConfigPath } from "./resolution-facts-DIK_QG79.js";
import { o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-BK4JSJnd.js";
...
import { U as resolveExecModePolicy } from "./exec-approvals-PtbcLeQo.js";
import { a as loadExecApprovals } from "./exec-approvals-generated-migration-KEjNHNyB.js";
import { u as isInterpreterLikeAllowlistPattern } from "./risks-D6ZQ78A6.js";
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-BB5wnYEo.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-BVSOxLTx.js";
import { t as resolveExecDefaults } from "./exec-defaults-DFjm1Q5i.js";
import { r as materializeGatewayAuthSecretRefs, t as canMaterializeGatewayAuthSecretRefsWithoutExec } from "./auth-config-utils-D1Gx1IDw.js";
import { n as normalizeConfiguredTrustedSafeBinDirs, t as normalizeConfiguredSafeBins } from "./exec-safe-bin-config-DmkcFwVr.js";
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-DI2LzhtV.js";
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-ilZuswNg.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BwxsJk9R.js";
import { t as collectExecFilesystemPolicyDriftHits } from "./exec-filesystem-policy-D4lJx0hu.js";
...
const loadReadOnlyChannelPlugins = createLazyRuntimeModule(() => import("./read-only-D5OLOY1-.js"));
...
const loadPluginMetadataRegistryLoaderModule = createLazyRuntimeModule(() => import("./metadata-registry-loader-D_dDg5lA.js"));
const loadPluginAutoEnableModule = createLazyRuntimeModule(() => import("./plugin-auto-enable-BhDiezWk.js"));
const loadChannelPluginIdsModule = createLazyRuntimeModule(() => import("./channel-plugin-ids-C07SuiaL.js"));
const loadPluginRuntimeModule = createLazyRuntimeModule(() => import("./runtime-DRLPaapq.js"));
const loadGatewayProbeDeps = createLazyRuntimeModule(() => Promise.all([
	import("./call-DPYKD0iw.js"),
	import("./probe-auth-CrHEYmDC.js"),
	import("./probe-DJ_wGe7l.js")
