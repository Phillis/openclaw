...
import { a as isPathInside, l as isWithinDir } from "./path-D138yf8v.js";
import { r as root } from "./fs-safe-CmrQUApq.js";
import { i as root$1 } from "./root-impl-BbMR4leC.js";
import { c as assertNoSymlinkParents } from "./regular-file-Dwz6p59y.js";
import { c as resolveUserPath, o as resolveRequiredHomeDir } from "./home-dir-BFvskzn8.js";
...
import { C as resolveOAuthDir, S as resolveNewStateDir, b as resolveLegacyStateDirs, w as resolveStateDir } from "./paths-BBSTUjD5.js";
import { r as formatErrorMessage } from "./errors-Ccx0R-_Z.js";
import "./agent-scope-DigoIwHb.js";
import { n as normalizeAgentId } from "./agent-id-CeT3w4ap.js";
import { a as listAgentIds, b as tryResolveAmbientOwnerAgentId, f as resolveAgentWorkspaceDir, s as resolveAgentConfig } from "./agent-scope-config-CUBiGmG3.js";
import { c as parseAgentSessionKey } from "./session-key-utils-Di3FvABa.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-BH0zJUew.js";
import { a as buildAgentMainSessionKey, f as resolveAgentIdFromSessionKey, n as DEFAULT_MAIN_KEY } from "./session-key-Dbce_H9p.js";
import { t as isPerAgentSessionStoreConfig } from "./session-store-config-tR04nswt.js";
import { _ as readSessionArchiveContentSync, h as encodeSessionArchiveContent, m as decodeSessionArchiveBytes, p as SESSION_ARCHIVE_ZSTD_SUFFIX, s as isSessionArchiveArtifactName } from "./artifacts-FzMa6c2e.js";
...
import { At as boolean, Et as array, Lt as custom, Rn as string, Zn as unknown, dn as literal, fn as looseObject, wn as number } from "./schemas-CZ9Toj_c.js";
import { t as CHANNEL_IDS } from "./ids-Cgp0iV_A.js";
import { n as VERSION } from "./version-CkBmshxX.js";
import { f as resolveLegacyInstalledPluginIndexStorePath } from "./manifest-registry-DqYRJvWI.js";
import { o as OPENCLAW_SQLITE_BUSY_TIMEOUT_MS } from "./openclaw-state-db-contract-DsoDzKB9.js";
import { Mn as executeSqliteQueryTakeFirstSync, Nn as getNodeSqliteKysely, Rn as readSqliteUserVersion, Sn as repairCanonicalSqliteIndexes, St as detectOpenClawStateDatabaseSchemaMigrations, Xt as resolveOpenClawStateSqlitePath, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction, jn as executeSqliteQuerySync, kn as quoteSqliteIdentifier, m as repairOpenClawStateDatabaseSchemaIfNeeded, p as repairOpenClawStateDatabaseSchema, u as openExistingOpenClawStateDatabaseReadOnly, xt as resolveSqliteDatabaseFilePaths } from "./openclaw-state-db-kmBThqu6.js";
import { h as clearNodeSqliteKyselyCacheForDatabase, l as runSqliteDeferredTransactionSync, t as openNodeSqliteDatabase, u as runSqliteImmediateTransactionSync } from "./node-sqlite-_e3IvfT7.js";
import { a as sha256Hex, i as sha256File } from "./crypto-digest-IGAbV2KW.js";
import { t as compareOpenClawVersions } from "./version-CG_bbh3U.js";
import "./installed-plugin-index-store-7GzEHL03.js";
import { n as collectRelevantDoctorPluginIds, o as listPluginDoctorSessionStoreAgentIds, s as listPluginDoctorStateMigrationEntries } from "./doctor-contract-registry-Dbcs8AwY.js";
import { n as resolveSessionStoreCompatibilityAgentId } from "./legacy.default-agent-owner-CL_-T11Y.js";
import { a as updateConfigMachineState, n as importConfigMachineState, r as readConfigMachineState } from "./config-machine-state-DjliVw3j.js";
...
import { n as CONFIG_AUDIT_SCOPE, t as CONFIG_AUDIT_MAX_ENTRIES } from "./io.audit-sMaKpbcb.js";
import { i as resolveSharedAuthStoreOwnership, n as noteCommittedSharedAuthStoreOwnership, o as resolveSharedMainAuthAgentDir, t as SHARED_AUTH_STORE_STATE_KEY } from "./path-resolve-Bjd7UUgA.js";
import { n as createFileLockManager } from "./file-lock-BEYhVT9i.js";
import { i as isPidDefinitelyDead, t as getFileLockProcessStartTime } from "./pid-alive-BcyyC-CC.js";
import { t as isLockOwnerDefinitelyStale } from "./stale-lock-file-7k32f-I2.js";
import { s as withFileLock } from "./file-lock-DRVK2jTz.js";
import "./file-lock-CS5vu_jB.js";
import { t as asFsSafeFileLockRoot } from "./file-lock-manager-B7RCol7C.js";
import { n as acquireGatewayLock } from "./gateway-lock-G9roAjek.js";
import { b as withAgentDatabaseMaintenanceLease, i as closeOpenClawAgentDatabaseByPath, y as runOpenClawAgentWriteTransaction } from "./openclaw-agent-db-BEQsKM0c.js";
import { A as isPersistentOpenClawAgentDatabasePath, F as listOpenClawRegisteredAgentDatabases, M as registerOpenClawAgentDatabase, N as unregisterOpenClawAgentDatabase, O as OPENCLAW_AGENT_SCHEMA_SQL, f as readExistingAgentSchemaMeta, k as createOpenClawAgentDatabasePathMatcher, n as assertOpenClawAgentDatabaseOwner, o as ensureOpenClawAgentDatabaseSchema, r as migrateOpenClawAgentDatabaseForMaintenance, s as migrateOpenClawAgentDatabaseToMediaPrerequisiteSchema, t as assertOpenClawAgentDatabaseForMaintenance, u as assertOpenClawAgentSchemaContains } from "./openclaw-agent-db-maintenance-_0tYy-zT.js";
import "./openclaw-agent-db-migration-required-RkIFq1cn.js";
import { s as listSessionEntryKeysReadOnly } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
...
import { u as resolveSqliteTranscriptArchiveDirectory } from "./session-accessor.sqlite-scope-C7NrJaPh.js";
import { Ft as readSessionIdentityEvidenceBatch } from "./session-accessor-fcDZuc2H.js";
import { c as resolveSessionStoreTargets, d as resolveAgentSessionDirsFromAgentsDirSync, l as dedupeSessionStoreTargetsBySqliteTarget } from "./targets-CSCF74bk.js";
import { d as rewriteSqliteTranscriptEventRowsInTransaction, f as updateSqliteTranscriptEventJsonInTransaction } from "./session-accessor.sqlite-transcript-store-CZRFPUnE.js";
import { i as hasMeaningfulRetiredMediaCarrier, r as canonicalizePersistedUserMessageMedia } from "./media-facts-Bd6apMSF.js";
import { t as applyAssistantDeliveryDirectives } from "./transcript-assistant-delivery-ElcBJoCH.js";
import { n as replaceOutsideCodeRegions } from "./directive-tags-DqL78ij5.js";
import { _ as pluginStateDoctorEntriesInKeyRange, g as pluginStateDeleteEntriesIfUnchanged, h as getPluginStateCapacity, i as importPluginStateEntriesForDoctor, n as createPluginStateKeyedStore } from "./plugin-state-store-WXMs6Mfy.js";
import { S as readSharedAuthLegacyRowsFromDatabase, b as inspectSharedAuthLegacyRowsReadOnly, p as resolveAuthProfileDatabaseOwnerId, t as closeAuthProfileReadPool, v as SharedAuthStoreSourceInspectionError, x as inspectSharedAuthLegacySourceFile, y as hasPendingSharedAuthCleanup } from "./sqlite-BsvahKHa.js";
import { s as getMediaDir } from "./store-fXRck5jl.js";
import { a as isSafeWorkspaceAttestationFilename, b as resolveLegacyWorkspaceSourcePaths, d as LEGACY_WORKSPACE_ATTESTATION_DIRNAME, f as LEGACY_WORKSPACE_ATTESTATION_HEADER, g as WORKSPACE_DOCTOR_CLAIM_SUFFIX, l as registerWorkspaceStateAliasesInTransaction, n as WORKSPACE_LEGACY_STATE_MIGRATION_KIND, p as LEGACY_WORKSPACE_ATTESTATION_MAX_BYTES } from "./workspace-state-store-CkRZeUIP.js";
...
import { n as parseRestartSentinelEnvelope, o as writeRestartSentinelRowSync, r as readRestartSentinelRowSync } from "./restart-sentinel-store-VTCkE0nx.js";
...
import { f as mcpOAuthStoreKeyFromLegacyFileName, o as parseMcpOAuthStoreJson } from "./mcp-oauth-store--87F5Wew.js";
import { r as resolveSandboxWorkspaceLayoutPaths } from "./shared-B_Uac1bY.js";
import { a as transcriptSessionExportKey, i as safeTranscriptPathSegment, n as renderTranscriptsMarkdown, o as transcriptSessionSelector, s as ensureMeetingTranscriptsSchema, t as TranscriptsStore } from "./store-UaUKgGKU.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-cxjR1aAq.js";
import { a as updateChannelPairingStateSnapshot, c as resolveAllowFromAccountId, l as safeAccountKey, s as dedupePreserveOrder, u as getPairingAdapter } from "./pairing-store-sqlite-DIcnqB55.js";
import { n as SYSTEM_AGENT_AUDIT_SCOPE, t as SYSTEM_AGENT_AUDIT_MAX_ENTRIES } from "./audit-BSOqBbQY.js";
import { a as readSessionStoreJson5, o as safeReadDir, r as migrationFileExists, t as ensureMigrationDir } from "./state-migrations.fs-DvNQVVLQ.js";
import { C as rewriteRegistryWorktreePathsForMigration, g as hasLegacyRegistryWorktrees, s as discardLegacyRegistryWorktrees, x as listRegistryWorktreesForMigration } from "./registry-DC6q9xGA.js";
...
async function detectLegacyCommitments(params) {
	...
	if (params.doctorOnlyStateMigrations === true && !legacyMigrationSourceOrClaimMayExist(sourcePath, DOCTOR_CLAIM_SUFFIX$3)) try {
		...
		try {
			const receipt = database ? readLegacyMigrationReceiptFromDatabase(database.db, resolveLegacyMigrationSourceKey("commitments-json", sourcePath)) : null;
...
function parseTranscriptEvent$2(raw, owner) {
	try {
		return JSON.parse(raw);
	} catch (error) {
...
function forEachMediaEventBatch(params) {
	...
	let cursor;
	while (true) {
		let query = db.selectFrom(params.table).select([
			"session_id",
			"seq",
			"event_json"
		]).orderBy("session_id", "asc").orderBy("seq", "asc").limit(MEDIA_MIGRATION_ROW_BATCH_SIZE);
		const after = cursor;
	...
	forEachMediaEventBatch({
		...
		visit: (rows) => {
			...
			for (const row of rows) {
				...
				const event = parseTranscriptEvent$2(row.event_json, owner);
...
function readMediaSourceVersion(database) {
	...
	const counts = database.prepare(`SELECT
        ...
        (SELECT COALESCE(SUM(LENGTH(event_json)), 0) FROM trajectory_runtime_events) AS trajectory_bytes`).get();
	const number = (value) => typeof value === "bigint" ? Number(value) : typeof value === "number" ? value : 0;
	const count = (key) => number(isRecord(counts) ? counts[key] : void 0);
	return {
		dataVersion: number(isRecord(dataVersionRow) ? dataVersionRow.data_version : void 0),
...
function createMigrationDatabaseHandle$1(database, agentId, pathname) {
	return {
		agentId,
		db: database,
		path: pathname,
...
function migrateAgentDatabase$1(params) {
	...
	try {
		...
		if (!versionAdvanced) {
			...
			if (detected.rewrittenSessions === 0 && detected.rewrittenTrajectoryRows === 0) return {
				...detected,
		...
		const owner = createMigrationDatabaseHandle$1(database, params.agentId, params.pathname);
		return {
...
function parseArchiveContent(content, filePath) {
	...
	return (content.endsWith("\n") ? content.slice(0, -1).split("\n") : content.split("\n")).map((line, index) => {
		...
		return parseTranscriptEvent$2(line, `${filePath}:${index + 1}`);
	});
}
...
function migrateLegacyMediaPersistence(params = {}) {
	...
	for (const entry of targets) {
		...
		try {
			const result = migrateAgentDatabase$1({
				agentId: entry.agentId,
...
function resolveDoctorSessionIdentityEvidence(params) {
	...
	for (const [index, request] of params.requests.entries()) {
		...
		if (targets === void 0) {
			try {
				...
				else targets = dedupeSessionStoreTargetsBySqliteTarget(resolved.targets.length ? resolved.targets : [{
					agentId,
	...
	const evidence = readSessionIdentityEvidenceBatch(probes.map(({ agentId, sessionId, storePath }) => ({
		agentId,
		env: params.env,
		sessionId,
		storePath
	})));
	const observedByRequest = /* @__PURE__ */ new Map();
	for (const [position, observed] of evidence.entries()) {
		...
		if (previous) previous.push(observed);
		else observedByRequest.set(index, [observed]);
	}
...
function readSourceSnapshot(params) {
	...
	try {
		const rows = runOpenClawAgentWriteTransaction(({ db }) => readSharedAuthLegacyRowsFromDatabase(db), {
...
function readTargetRows(database) {
	const db = getNodeSqliteKysely(database);
	return {
		store: projectStoreRow(executeSqliteQueryTakeFirstSync(database, db.selectFrom("config_machine_state").select(["value_json", "updated_at_ms"]).where("state_key", "=", "authProfiles.store"))) ?? null,
		state: projectStateRow(executeSqliteQueryTakeFirstSync(database, db.selectFrom("config_machine_state").select(["value_json", "updated_at_ms"]).where("state_key", "=", "authProfiles.state"))) ?? null
	};
}
function projectStoreRow(row) {
	return row ? {
		store_json: row.value_json,
		updated_at: row.updated_at_ms
	} : null;
}
function projectStateRow(row) {
	return row ? {
		state_json: row.value_json,
		updated_at: row.updated_at_ms
	} : null;
}
...
function detectSharedAuthStoreMigration(params) {
	...
	return {
		sourcePath,
		hasLegacy: ownership.location === "legacy-main" || sourceRows.store !== null || sourceRows.state !== null || hasPendingSharedAuthCleanup(env, sourcePath)
	};
}
...
function parseTranscriptEvent$1(raw, owner) {
	try {
		return JSON.parse(raw);
	} catch (error) {
...
function transformArchiveContent(content, owner) {
	...
	const rewritten = lines.map((line, index) => {
		...
		const transformed = transformHistoricalTranscriptEvent(parseTranscriptEvent$1(line, `${owner}:${index + 1}`));
...
function listArchiveBatch(database, cursor) {
	...
	if (cursor.sessionId) query = query.where((eb) => eb.or([eb("session_id", ">", cursor.sessionId), eb.and([eb("session_id", "=", cursor.sessionId), eb("generation", ">", cursor.generation)])]));
	return executeSqliteQuerySync(database, query).rows.map((row) => {
		...
		const transformed = transformArchiveContent(decodeSessionArchiveBytes(bytes, encoding === "zstd"), owner);
...
function assertArchiveSourceUnchanged(database, planned) {
	const current = executeSqliteQueryTakeFirstSync(database, getNodeSqliteKysely(database).selectFrom("session_transcript_archives").select([
		"archive_blob",
		"archive_name",
		"archive_sha256",
		"encoding"
...
function rewriteArchiveRow(database, planned) {
	...
	if (executeSqliteQuerySync(database, getNodeSqliteKysely(database).updateTable("session_transcript_archives").set({
...
function migrateTranscriptDirectiveArchives(params) {
	...
	while (true) {
		...
		for (const planned of batch) {
			const rowPresent = runSqliteImmediateTransactionSync(params.database, () => rewriteArchiveRow(params.database, planned), {
				busyTimeoutMs: OPENCLAW_SQLITE_BUSY_TIMEOUT_MS,
				databaseLabel: params.pathname,
			...
			runSqliteImmediateTransactionSync(params.database, () => finalizeArchiveCursor({
...
function readMigrationCursor(database, pathname) {
	return parseMigrationCursor(executeSqliteQueryTakeFirstSync(database, getNodeSqliteKysely(database).selectFrom("schema_meta").select("app_version").where("meta_key", "=", MIGRATION_META_KEY))?.app_version, pathname);
}
function writeMigrationCursor(database, agentId, cursor) {
	const now = Date.now();
	executeSqliteQuerySync(database, getNodeSqliteKysely(database).insertInto("schema_meta").values({
		agent_id: agentId,
...
function listTranscriptSessionBatch(database, afterSessionId) {
	return executeSqliteQuerySync(database, getNodeSqliteKysely(database).selectFrom("transcript_events").select("session_id").distinct().where("session_id", ">", afterSessionId).where("event_json", "like", "%[[%").orderBy("session_id", "asc").limit(32)).rows.map((row) => row.session_id);
}
function planTranscriptSession(database, pathname, sessionId) {
	return executeSqliteQuerySync(database, getNodeSqliteKysely(database).selectFrom("transcript_events").select(["event_json", "seq"]).where("session_id", "=", sessionId).where("event_json", "like", "%[[%").orderBy("seq", "asc")).rows.map((row) => {
		const transformed = transformHistoricalTranscriptEvent(parseTranscriptEvent(row.event_json, `${pathname}:${sessionId}:${row.seq}`));
		return {
...
function assertTranscriptSessionSourceUnchanged(database, sessionId, planned) {
	const current = executeSqliteQuerySync(database, getNodeSqliteKysely(database).selectFrom("transcript_events").select(["event_json", "seq"]).where("session_id", "=", sessionId).where("event_json", "like", "%[[%").orderBy("seq", "asc")).rows;
...
function migrateAgentDatabase(params) {
	...
	try {
		...
		const transcriptSessions = cursor.phase === "transcripts" ? migrateTranscriptSessions({
			agentId: params.agentId,
			database,
			owner,
			pathname: params.pathname,
		...
		return {
			archivedTranscripts: archiveCursor.phase === "archives" ? migrateTranscriptDirectiveArchives({
				agentId: params.agentId,
				database,
				pathname: params.pathname,
				start: archiveCursor,
...
function migrateHistoricalTranscriptDirectives(params = {}) {
	const env = params.env ?? process.env;
	const changes = [];
	const warnings = [];
	const targets = resolveAgentDatabaseMigrationTargets({
...
function importAndRecordReceipt(params) {
	...
	return runOpenClawStateWriteTransaction((database) => {
		...
		if (existingReceipt && (!params.replaceRemovedReceipt || !existingReceipt.removedSource)) throw new Error("workspace migration receipt appeared concurrently; retry Doctor");
		let imported = false;
		let resolution;
		...
		if (params.parsed.kind === "setup") {
			...
			const actualFingerprint = verified && verified.workspace_path != null ? setupFingerprint({
...
function tryResolveDoctorStateMigrationAgentId(cfg) {
	...
	return agentId && listAgentIds(cfg).includes(agentId) ? agentId : void 0;
}
function tryResolveDoctorSessionMigrationAgentId(cfg) {
	return tryResolveDoctorStateMigrationAgentId(cfg) ?? (!isPerAgentSessionStoreConfig(cfg.session?.store) ? resolveSessionStoreCompatibilityAgentId(cfg) : void 0);
}
...
async function detectLegacyStateMigrations(params) {
	...
	const deferredWarnings = deferredSessions || deferredAgentDir && params.doctorOnlyStateMigrations === true ? [DEFERRED_LEGACY_OWNER_MESSAGE] : [];
	const deferredNotices = deferredAgentDir && params.doctorOnlyStateMigrations !== true ? [DEFERRED_LEGACY_OWNER_MESSAGE] : [];
	const preview = [];
...
async function migratePluginDoctorStatePlans(params) {
	...
	if (params.repairAuthority) return migrate();
	let lock;
	try {
		lock = await acquireGatewayLock({
			allowInTests: true,
...
function buildLegacyStateMigrationSteps(params) {
	...
	const doctorStateSteps = isDoctor ? [
		...
		...detected.commitments ? [ownerStep(detected.commitments, migrateLegacyCommitments)] : [],
...
async function autoMigrateLegacyState(params) {
	...
	const configuredAgentDatabaseTargets = resolveSessionStoreTargets(params.cfg, { allAgents: true }, { env }).map((target) => ({
		agentId: target.agentId,
	...
	if (transcriptDirectives.warnings.length > 0 || mediaPersistence.warnings.length > 0) return {
		migrated: stateDirResult.migrated || stateSchema.changes.length > 0 || transcriptDirectives.changes.length > 0 || mediaPersistence.changes.length > 0,
		skipped: false,
		changes: [
	...
	const legacySessionSurfaces = params.legacySessionSurfaces ?? (await import("./legacy-session-surfaces-lpP-s1qO.js")).prepareLegacySessionSurfaces({
		config: params.cfg,
		env
	});
...
//#endregion
export { runLegacyStateMigrations as a, autoMigrateLegacyStateDir as c, resetAutoMigrateLegacyTaskStateSidecarsForTest as d, migrateLegacyMediaPersistence as f, resetAutoMigrateLegacyStateForTest as i, autoMigrateLegacyTaskStateSidecars as l, migrateLegacyConfigMachineState as m, autoMigrateLegacyState as n, runPostSessionPluginDoctorStateRepairs as o, migrateLegacyAgentDir as p, detectLegacyStateMigrations as r, migrateHistoricalTranscriptDirectives as s, autoMigrateLegacyPluginDoctorState as t, resetAutoMigrateLegacyStateDirForTest as u };
