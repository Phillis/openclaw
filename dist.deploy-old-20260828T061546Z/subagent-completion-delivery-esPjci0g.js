...
import { U as bindDeliveryQueueEntry, Z as upsertBoundDeliveryQueueEntryInDatabase, h as runOpenClawStateWriteTransaction, q as loadDeliveryQueueEntryInDatabase } from "./openclaw-state-db-kmBThqu6.js";
import { g as upsertTaskRunRowInDatabase, t as bindTaskRecord } from "./task-registry.store.sqlite-uc-5B4tV.js";
import { S as getTaskById, v as publishTaskRecordAfterAtomicStore, x as findTaskByRunId } from "./task-registry-aynazQHF.js";
...
import { C as subagentRuns, c as upsertSubagentRunRowInDatabase, p as ensureDeliveryState, t as bindSubagentRunRecord } from "./subagent-registry.store.sqlite-B8QBtOEs.js";
import { t as resolveSubagentCompletionResultText } from "./subagent-completion-result-DjS7tm-S.js";
import { T as safeRemoveAttachmentsDir, g as ANNOUNCE_COMPLETION_HARD_EXPIRY_MS, s as loadPendingFinalDeliveryPayload } from "./subagent-registry-lifecycle-delivery-BqpCkd4E.js";
import { o as getDeliveryQueueEntryStatus } from "./delivery-queue-sqlite-BLVzPbnr.js";
import { _ as markSessionDeliverySettlement, a as SessionDeliveryDeferredError, b as prepareClaimedSessionDelivery, h as loadPendingSessionDelivery, i as SessionDeliveryDeadLetteredError, l as completeSessionDelivery, m as loadPendingSessionDeliveries, n as SessionDeliveryAcknowledgementFinalizeError, o as SessionDeliveryRetryChargedError, p as failSessionDelivery, r as SessionDeliveryAttemptStartError, s as SessionDeliverySafeRetryError, t as SESSION_DELIVERY_QUEUE_NAME, x as releaseSessionDeliveryClaim, y as moveSessionDeliveryToFailed } from "./session-delivery-queue-storage-Ewx4waqo.js";
...
async function settleCorrelatedSubagentDelivery(queued, outcome) {
	...
	publishCommittedRecords(subagent, projectedTask);
	if (outcome === "recovered") {
		const { resumeSubagentRun } = await import("./subagent-registry-36rPN0fA.js");
