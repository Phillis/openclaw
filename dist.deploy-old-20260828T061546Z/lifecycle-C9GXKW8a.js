...
import { N as runWithDiagnosticTraceContext, T as createDiagnosticTraceContextFromActiveScope } from "./diagnostic-events-BGzDm6gu.js";
import { t as createSubsystemLogger } from "./subsystem-a4KzJVZG.js";
import { p as loadSessionEntryReadOnly } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
import { n as deliveryContextFromSession, r as deliveryContextKey, s as normalizeDeliveryContext } from "./delivery-context.shared-azPdmUls.js";
...
import { s as copyChannelParticipantAdmissionEvidence } from "./admission-evidence-C8iAKYLB.js";
import { f as clearChannelHistoryIfEnabled } from "./history-DLKGD0Dj.js";
import { a as isPlatformMessageNotDispatchedError, n as PlatformMessageNotDispatchedError, o as isPlatformMessageRejectedError } from "./deliver-types-w6kiySpD.js";
...
import { s as applyMessageSendingHook } from "./deliver-prepare-DXM4XCVk.js";
import { n as deriveInboundMessageHookContext, r as resolveInboundReplyHookTarget } from "./message-hook-mappers-BwRPfaNj.js";
import { u as summarizeOutboundPayloadForTransport } from "./payloads-BDBV7AYm.js";
import { f as normalizeEmptyPayloadForDelivery } from "./delivery-queue-reconciliation-CUGy8Pa1.js";
import { r as suppressPendingFinalDelivery } from "./dispatch-from-config.finalize-nO3GbW7A.js";
import { i as withDispatchProcessedOutcomeSink } from "./dispatch-from-config-0imwmCWn.js";
import { n as getGatewayRecoveryRuntime } from "./server-recovery-runtime-context-Cx7vLPdb.js";
import { l as createMessageSentEmitter } from "./delivery-queue-recovery-qoOfjfCc.js";
import { l as findDeliveryIntentOwner } from "./delivery-queue-storage-BJKj2sCe.js";
import { a as dispatchInboundMessageWithRoutedChannelDispatcher } from "./dispatch-BWl66NbQ.js";
...
import { r as hasVisibleChannelTurnDispatch, t as EMPTY_CHANNEL_TURN_DISPATCH_COUNTS } from "./dispatch-result-B75usq__.js";
import { i as runWithSessionInitConflictRetry, n as withReplySystemEventSessionKey } from "./system-event-session-key-p6YUiR0j.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-Ct2HR2BF.js";
import { i as isChannelPartialDeliveryError, r as createSuppressedChannelDeliveryResult } from "./delivery-result-BB-vQ7ul.js";
import { n as isDurableInboundReplyDeliveryHandled, r as throwIfDurableInboundReplyDeliveryFailed, t as deliverInboundReplyWithMessageSendContextCore } from "./durable-delivery-BO-5S7rt.js";
				...
				dispatchResult = await runWithSessionInitConflictRetry(() => (ownership === "routed-delivery" ? dispatchInboundMessageWithRoutedChannelDispatcher : params.dispatchReplyWithBufferedBlockDispatcher)({
					...
					dispatcherOptions: {
						...
						deliver: async (payload, info) => {
							...
							} else await settleChannelDeliveryAttempt({
								attempt: {
									state: "fulfilled",
									payload: effectivePayload,
									info: directInfo,
