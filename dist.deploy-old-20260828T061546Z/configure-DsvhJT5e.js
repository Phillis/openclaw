...
import { a as listAgentIds, g as resolveDefaultAgentId, l as resolveAgentDir } from "./agent-scope-config-CUBiGmG3.js";
import { t as isSafeExecutableValue } from "./exec-safety-DtLGRBJm.js";
import { c as isValidSecretProviderAlias, i as formatExecSecretRefIdValidationMessage, o as isValidExecSecretRefId, u as resolveDefaultSecretProviderAlias } from "./ref-contract-BHWY70rN.js";
...
import { n as discoverConfigSecretTargets, t as discoverAuthProfileSecretTargets } from "./target-registry-query-DREoZp4g.js";
import "./target-registry-CGWcufp7.js";
import { n as resolveSecretRefValue, o as listSecretProviderIntegrationPresets } from "./resolve-DvvnAG2w.js";
...
import { t as createSecretsConfigIO } from "./config-io-B9LplxgR.js";
import { t as runSecretsApply } from "./apply-ZaqZIRME.js";
	...
	if (!params.providersOnly) {
		...
		while (true) {
			...
			const options = visibleCandidates.map((candidate) => ({
				...
				hint: [candidate.configFile === "auth-profile-store" ? "auth profile store" : "openclaw.json", candidate.isDerived === true ? "derived" : void 0].filter(Boolean).join(" | ")
			}));
			options.push({
