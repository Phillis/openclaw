...
import { n as getCurrentPluginMetadataSnapshot, r as installTemporaryCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-AW4B7-Km.js";
import { s as normalizeProviderId } from "./model-ref-shared-D4yx0hwT.js";
import { n as OPENAI_PROVIDER_ID } from "./openai-routing-Chr0R2hQ.js";
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, f as modelCatalogLogicalKey, g as resolveConfiguredModelPolicyAllow, i as buildModelAliasIndex, k as parseModelPolicyWildcardRef } from "./model-selection-shared-DbjoXfPH.js";
...
import { c as isNonSecretApiKeyMarker, g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, l as isOAuthApiKeyMarker } from "./model-auth-markers-Dy2BML3M.js";
import { D as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-DERww3Gm.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, c as getRuntimeAuthProfileStoreSnapshot, r as ensureAuthProfileStore } from "./store-C6iqqcJy.js";
import { u as resolveProfileUnusableUntilForDisplay } from "./usage-wmbnTa19.js";
import { s as loadPreparedModelCatalogSnapshot } from "./prepared-model-catalog-hBq_POnm.js";
...
import { n as resolveAgentHarnessOwnerPluginIds } from "./runtime-plugin-load-plan-BgcYH_wT.js";
import { t as resolveAuthProfileDisplayLabel } from "./auth-profiles-wr_j3m1O.js";
import "./profiles-FGrQtdwI.js";
import { r as getCustomProviderApiKey, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-6V9HXTpM.js";
...
import { n as resolveUtilityModelRefForAgent, t as readUtilityModelSetting } from "./utility-model-bDQ2cMC-.js";
import { n as resolveAgentHarnessRuntimeAvailability } from "./runtime-plugin-CmLsr8qG.js";
import { d as ensureFlagCompatibility, m as isRich, s as resolveModelsTargetAgent } from "./shared-ShmnGmtF.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DakHTlCd.js";
import { t as maskApiKey } from "./secret-mask-BEdLuCrN.js";
import { t as loadModelsConfig } from "./load-config-D3KD5f9l.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-B4FatTLs.js"));
...
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-CnCeJuvE.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-D6vthzLz.js");
			runtime.log("");
