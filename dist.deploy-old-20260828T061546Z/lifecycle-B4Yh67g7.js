...
import { s as resolveAcpSessionResolutionError, t as getAcpSessionManager } from "./manager-BUipT7v-.js";
...
import { l as resolveSessionStorePathForAcp } from "./session-meta-CpNLCGd4.js";
import { i as resolveAcpDispatchPolicyMessage, n as resolveAcpAgentPolicyError, r as resolveAcpDispatchPolicyError, t as isAcpEnabledByPolicy } from "./policy-Clgn_LpQ.js";
import { a as prepareAgentRunAdmission, r as createOperationalRunInstanceRef, t as closeAdmittedRunDelegatedAuthority } from "./admitted-run-context-KQIZywud.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, l as resolveThreadBindingPlacementForCurrentContext, n as formatThreadBindingSpawnDisabledError, o as resolveThreadBindingIdleTimeoutMsForChannel, r as requiresNativeThreadContextForThreadHere, t as formatThreadBindingDisabledError, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-Bjjk-DS_.js";
...
import { i as cleanupFailedAcpSpawn, r as resolveRuntimeCwdForAcpSpawn, t as resolveAcpSpawnRuntimePolicyError } from "./acp-spawn-DWO1q19K.js";
import { t as consumeChannelRunAdmission } from "./channel-run-admission-CRcERUfp.js";
import { a as resolveAcpCommandThreadId, i as resolveAcpCommandConversationId, n as resolveAcpCommandBindingContext, t as resolveAcpCommandAccountId } from "./context-CPOkvulr.js";
import { C as withAcpCommandErrorBoundary, S as resolveCommandRequestId, f as collectAcpErrorText, v as parseSpawnInput, y as parseSteerInput } from "./shared-CWkdSP3T.js";
import { t as resolveAcpTargetSessionKey } from "./targets-BiDa4MYW.js";
...
async function handleAcpSpawnAction(params, restTokens) {
	...
	try {
		...
		return commandReply(`⚠️ ACP spawn failed: ${formatErrorMessage(err)}`);
	}
