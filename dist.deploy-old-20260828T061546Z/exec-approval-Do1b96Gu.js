...
import { Ft as validateExecApprovalRequestParams, It as validateExecApprovalResolveParams, Pt as validateExecApprovalGetParams } from "./src-4dv5TpeQ.js";
import { d as errorShape } from "./validation-errors-rELRlKfn.js";
import { n as sanitizeExecApprovalDisplayTextWithStatus, r as sanitizeExecApprovalWarningText, t as sanitizeExecApprovalDisplayText } from "./exec-approval-text-sanitize-B7KSiT_n.js";
import { t as sanitizeApprovalScope } from "./approval-scope-B3MYegOV.js";
import { I as normalizeExecAsk, M as resolveExecApprovalRequestAllowedDecisions, P as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, k as normalizeExecApprovalUnavailableDecisions, z as normalizeExecSecurity } from "./exec-approvals-PtbcLeQo.js";
import { a as detectCommandCarrierArgv, s as detectInlineEvalInSegments } from "./risks-D6ZQ78A6.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-BnagRpCO.js";
import { n as buildSystemRunApprovalBinding, r as buildSystemRunApprovalEnvBinding } from "./system-run-approval-binding-0Gs8JaF5.js";
import { t as analyzeCommandForPolicy } from "./policy-7EVCJmzu.js";
import { t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-XHb-Y_TM.js";
import { t as buildCronExecOperationBinding } from "./operator-approval-standing-grants-Cvwjm-d5.js";
import { t as lookupCronRunExecSource } from "./cron-run-exec-source-BYare2tS.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-VVq_wcNX.js";
import { t as assertValidParams } from "./validation-kYFXohur.js";
import { r as InvalidApprovalIdError } from "./exec-approval-manager-D3AEYJmr.js";
import { a as handleApprovalResolve, c as registerPendingApprovalRecord, h as respondPendingApprovalLookupError, i as buildRequestedApprovalEvent, l as resolveApprovalDecisionParams, m as resolvePendingApprovalRecord, n as bindApprovalReviewerDeviceIds, o as handleApprovalWaitDecision, p as listVisiblePendingApprovalRequests, s as handlePendingApprovalRequest, t as bindApprovalRequesterMetadata } from "./approval-shared-D87k2z1-.js";
...
async function explainCommandForDisplay(command) {
	try {
		const { explainShellCommand } = await import("./extract-f3zU_wiT.js");
