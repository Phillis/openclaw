...
async function resolveInstallableChannelPlugin(params) {
	...
	const catalogEntry = (params.rawChannel ? resolveCatalogChannelEntry(params.rawChannel, nextCfg, workspaceDir) : void 0) ?? (params.channelId ? getTrustedChannelPluginCatalogEntry(params.channelId, {
		cfg: nextCfg,
		workspaceDir
	}) : void 0);
	const channelId = directChannelId ?? resolveResolvedChannelId({
