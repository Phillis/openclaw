import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{Bn as t,dr as n,nn as r}from"./control-ui-foundation-DcQugFIP.js";import{Bl as i,Er as a,Hl as o,Tr as ee,b as te,br as s,g as c,gr as l,vr as u,yr as d}from"./control-ui-core-BIRhUd0w.js";import{G as f,J as p,W as m,Z as h,rt as g}from"./lit-runtime-CFtfqA5r.js";import{$t as ne,d as re,f as ie,pn as ae}from"./control-ui-core-BVHxUJX1.js";import{Ft as oe,Ht as _,Pt as v,Wt as y,dt as b,jt as x,pt as S,zt as C}from"./control-ui-core-BRyX5NDK.js";import{Rt as w,zt as T}from"./control-ui-boot-Bl3LK1Li.js";import{Qr as E,cn as D,ei as O,en as k,hn as A,ii as j,ni as M,ri as N,sn as se,ti as P,un as F}from"./control-ui-boot-BY2RxHwD.js";import{n as I,t as L}from"./settings-workspace-BYKXh08R.js";import{n as R,t as z}from"./brand-icons-B_VdV-QH.js";function B(e,t){if(!e)return null;let n=new Date(e);return Number.isNaN(n.getTime())?null:new Intl.DateTimeFormat(t,{dateStyle:`medium`,timeZone:`UTC`}).format(n)}function V(e){return y(e===`copying`?`aboutPage.copyingCommit`:e===`copied`?`aboutPage.copiedCommit`:e===`error`?`aboutPage.copyCommitFailed`:`aboutPage.copyCommit`)}function H(e){return e===`copied`?y(`aboutPage.copiedCommit`):e===`error`?y(`aboutPage.copyCommitFailed`):``}function U(){return p`<span class="muted">${y(`aboutPage.unavailable`)}</span>`}function W(e){if(!e)return f;let t=Date.parse(e);if(!Number.isFinite(t))return f;let n=new Intl.DateTimeFormat(_.getLocale(),{dateStyle:`medium`,timeStyle:`short`}).format(new Date(t));return p`
...
//# sourceMappingURL=about-page-Cerzj6u-.js.map