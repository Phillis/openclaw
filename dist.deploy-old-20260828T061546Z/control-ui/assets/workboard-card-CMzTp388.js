import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{G as t,J as n,W as r}from"./lit-runtime-CFtfqA5r.js";import{Wt as i,zt as a}from"./control-ui-core-BRyX5NDK.js";import{n as o,t as s}from"./workboard-widget-fQKN3bgv.js";var c,l;function u(){return(u=e((()=>{r(),a(),o(),c=class extends s{async handleStatusChange(e){let t=this.readStringProp(`cardId`),n=this.cards.find(e=>e.id===t),r=e.currentTarget.value;!n||!this.statuses.includes(r)||await this.moveCard(n,r)}render(){let e=this.readStringProp(`cardId`);if(!e)return n`<p class="workboard-widget__state" role="alert">
...
//# sourceMappingURL=workboard-card-CMzTp388.js.map