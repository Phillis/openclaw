...
import { F as MODELS_PARENT_VALUE_FLAGS, P as MODELS_PARENT_BOOLEAN_FLAGS, i as getPositiveIntFlagValue, o as getVerboseFlag, r as getFlagValue, s as hasFlag } from "./argv-CCdO9MSu.js";
...
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-DKqm4ZZQ.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-ChElhCE_.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-jPEN2vLn.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-BfOoi417.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-BvyP9HTw.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-ki-ONCzE.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-BmzxUPsq.js");
			...
			const { statusCommand } = await import("./status-C9tzjH0D.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-B0Wqp2RR.js");
	...
	"gateway-health": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runGatewayHealthJsonRoute } = await import("./health-route-B5-7DDAb.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-C8PpvT_K.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-CrR3uUm6.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-3kCFHxQC.js");
