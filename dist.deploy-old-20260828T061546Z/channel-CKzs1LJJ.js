...
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-H1MQoqDw.js";
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-CbSRDP2R.js";
import { a as splitChannelApprovalCapability, i as createChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-BCnTGPBj.js";
...
import { M as createConditionalWarningCollector, h as resolveScopeToolsPolicy, k as createAllowlistProviderOpenWarningCollector, m as resolveScopeRequireMention } from "./channel-policy-RPOWSkLP.js";
...
import { a as resolveMatrixAccountConfig } from "./account-config-CpFj8tyt.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CQ-N-_Xa.js";
...
import { t as matrixPluginBase } from "./channel.setup-CSEdCzHs.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-CVCPde7i.js";
import { r as resolveMatrixRoomScopePath, t as buildMatrixRoomScopeTree } from "./rooms-Dpprwj5G.js";
import { t as resolveMatrixInboundRoute } from "./route-B4k5HUNd.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DSxHm3wE.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-HEWFjtpv.js"), "matrixChannelRuntime");
const loadMatrixDoctorModule = createLazyRuntimeModule(() => import("./doctor-D6wxm357.js"));
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-BuKVL2vd.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
