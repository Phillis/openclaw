...
import { n as isStoredCredentialCompatibleWithAuthProvider, t as isConfiguredAwsSdkAuthProfileForProvider } from "./order-BxFkXXxj.js";
import { a as NON_ENV_SECRETREF_MARKER, c as isNonSecretApiKeyMarker, n as CUSTOM_LOCAL_AUTH_MARKER, o as SECRETREF_ENV_HEADER_MARKER_PREFIX, s as isKnownEnvApiKeyMarker } from "./model-auth-markers-Dy2BML3M.js";
...
async function resolveProviderEntryApiKeyBinding(params) {
	...
	try {
		const { resolveApiKeyForProfile } = await import("./oauth-CBNXjYhX.js");
