...
import { i as resolvePluginSetupRegistry, r as resolvePluginSetupProviderCore } from "./setup-registry-DpKBzfh2.js";
...
import { f as upsertAuthProfileWithLockOrThrow, o as removeProviderAuthProfilesWithLock, r as promoteAuthProfileInOrder, u as upsertAuthProfileAfterLoginWithLockOrThrow } from "./profiles-FGrQtdwI.js";
...
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-4t6D2PIl.js";
...
import { c as updateConfig, r as loadValidConfigOrThrow, s as resolveModelsTargetAgent } from "./shared-ShmnGmtF.js";
...
import { t as refreshRunningGatewayAuthState } from "./auth-refresh-CMGq5Gsr.js";
...
async function resolveModelsAuthAgent(rawAgentId, config) {
	return resolveModelsTargetAgent(config ?? await loadValidConfigOrThrow(), rawAgentId ?? void 0, { kind: "mutation" });
}
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: params.openUrl ?? (async (url) => {
			const { openUrl } = await import("./onboard-helpers-Cwjb9WEP.js");
			await openUrl(url);
		}),
