...
import { i as listChannelPlugins, o as resolveChannelPluginRegistration, t as getChannelPlugin } from "./registry-CZjiz1Jg.js";
import { n as resolveChannelApprovalCapability } from "./plugins-DYpQkXDD.js";
import { g as runOutsideGatewayRootWorkAdmission } from "./gateway-work-admission-CTDt7IQ1.js";
import { g as setActiveCredentialDegradedOwner, o as clearActiveCredentialDegradedOwner, r as assertSecretOwnerAvailable } from "./runtime-degraded-state-D5EZZ925.js";
...
import { t as getCredentialUnavailableDiagnostics } from "./account-snapshot-fields-DPncjgDN.js";
...
import { a as isExecApprovalChannelRuntimeTerminalStartError } from "./approval-native-runtime-BWNvSF5E.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-DyEQpGva.js";
...
import { n as isChannelIngressUnavailableError } from "./ingress-unavailable-YbrNUVMv.js";
import { i as resolveChannelAccountState, t as applyChannelAccountState } from "./account-state-Bav3alE5.js";
import { n as withPluginHttpRouteRegistry } from "./http-registry-BjvSX18D.js";
import { i as formatGatewayCrashLoopManualChannelStartHint } from "./gateway-boot-lifecycle-BZEoNMfy.js";
...
function createChannelManager(opts) {
	...
	const stopChannel = async (channelId, accountId, optsLocal = {}) => {
		...
		const cfg = getRuntimeConfig();
		const knownIds = new Set(accountId ? [accountId] : [...lifecycleIds, ...plugin ? plugin.config.listAccountIds(cfg) : []]);
