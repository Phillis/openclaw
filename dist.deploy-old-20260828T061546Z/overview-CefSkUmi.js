...
import { _ as resolveGatewayPort, f as resolveConfigPath } from "./paths-BBSTUjD5.js";
...
import { p as resolveAmbientOwnerAgentId, r as listAgentEntries } from "./agent-scope-config-CUBiGmG3.js";
...
function buildAgentSummaries(cfg, defaultAgentId) {
...
async function loadSystemAgentOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-DPYKD0iw.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
