...
import { i as resolveSimpleCompletionSelectionForAgent } from "./simple-completion-runtime-RpHRaaRj.js";
...
async function defaultRun(params) {
	...
	const { prepareInternalSessionEffectsSession, removeInternalSessionEffectsSession } = await import("./internal-session-effects-bmRXq4fr.js");
	...
	try {
		const [{ SessionManager }, { runEmbeddedAgent }] = await Promise.all([import("./sessions-BIddCvEX.js"), import("./embedded-agent-fNRs635m.js")]);
