...
import { i as serializeSessionCleanupResult, n as resolveSessionCleanupAction, r as runSessionsCleanup } from "./cleanup-service-LQM2406D.js";
import { n as resolveSessionStoreTargetsOrExit } from "./session-store-targets-CpVDSTf8.js";
import { c as resolveSessionDisplayModel, i as formatSessionModelCell, n as formatSessionFlagsCell, o as toSessionDisplayRows, r as formatSessionKeyCell, t as formatSessionAgeCell } from "./sessions-table-cdN0_yGI.js";
...
function formatCleanupActionCell(action, rich) {
	...
	if (action === "archive-dashboard") return theme.warn(label);
...
function buildLabelSummaries(actionRows) {
	...
	for (const actionRow of actionRows) {
		...
		if (actionRow.action === "keep" || actionRow.action === "archive-dashboard") summary.kept += 1;
