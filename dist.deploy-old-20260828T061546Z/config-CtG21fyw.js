...
import { N as TtsConfigSchema } from "./zod-schema.core-CTdpjCBO.js";
...
import { F as resolveRealtimeVoiceAgentConsultTools, T as REALTIME_VOICE_AGENT_CONSULT_TOOL_POLICIES, w as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "./realtime-session-harness-BIfCDu_t.js";
...
const VoiceCallTailscaleConfigSchema = object({
	...
	port: number().int().positive().max(MAX_TCP_PORT).default(443),
...
const VoiceCallSessionScopeSchema = _enum([
	"per-phone",
	"per-call",
	"main"
]);
