...
import { Gt as recordOpenClawDatabaseQuarantine, Xt as resolveOpenClawStateSqlitePath, f as recordOpenClawStateDatabaseOpenFailure, o as confirmOpenClawStateDatabaseIntegrity } from "./openclaw-state-db-kmBThqu6.js";
import { s as confirmOpenClawAgentDatabaseIntegrity, v as recordOpenClawAgentDatabaseOpenFailure } from "./openclaw-agent-db-BEQsKM0c.js";
...
function runDatabaseVerifyWorker(targets, options = {}) {
	...
	return new Promise((resolve, reject) => {
		...
		const settleAfterExitAndDisconnect = () => {
			...
			settle(() => {
				if (protocolError) reject(toStructuredErrorObject(protocolError));
