...
import { g as openOpenClawAgentDatabase, i as closeOpenClawAgentDatabaseByPath, p as isOpenClawAgentDatabaseOpen } from "./openclaw-agent-db-BEQsKM0c.js";
...
import { F as setCanonicalSqliteSessionMainKey, N as isCanonicalSqliteSessionMainKeyCurrent, s as parseReadableSqliteSessionEntryRow } from "./session-accessor.sqlite-entry-store-BIW-GrsF.js";
import { r as resolveSqliteTargetFromSessionStorePath } from "./session-sqlite-target-10dvR_dO.js";
import { c as resolveSqliteScope, i as getSessionKysely, m as toDatabaseOptions } from "./session-accessor.sqlite-scope-C7NrJaPh.js";
...
import { x as listRegistryWorktreesForMigration } from "./registry-DC6q9xGA.js";
import { t as migrateLegacyMainSessionKeys } from "./legacy-main-session-migration-CedEaTdA.js";
import { l as resolveProjectRegistry } from "./project-registry-DuJO7XqH.js";
import { u as migrateOrphanedSessionKeys } from "./state-migrations.session-store-D72nZxzH.js";
...
async function runSessionStartupMigration(params) {
	...
	if (hasLegacySessionDirectories) try {
		const prepareSurfaces = params.deps?.prepareLegacySessionSurfaces ?? (await import("./legacy-session-surfaces-lpP-s1qO.js")).prepareLegacySessionSurfaces;
