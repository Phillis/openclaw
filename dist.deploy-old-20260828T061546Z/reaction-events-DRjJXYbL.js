...
import "./session-binding-runtime-Cux4NnsA.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CpFj8tyt.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-CTyQTnvd.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-B4k5HUNd.js";
import { i as resolveMatrixApprovalReactionTargetWithPersistence, o as unregisterMatrixApprovalReactionTargetsForApproval } from "./approval-reactions-Cn_6LiPJ.js";
//#region extensions/matrix/src/matrix/monitor/reaction-events.ts
const loadApprovalReactionAuth = createLazyRuntimeModule(() => import("./approval-reaction-auth-BuXh-plk.js"));
const loadExecApprovalResolver = createLazyRuntimeModule(() => import("./plugin-sdk/approval-gateway-runtime.js"));
const loadMatrixSend = createLazyRuntimeModule(() => import("./send-OX_uJ25E.js"));
