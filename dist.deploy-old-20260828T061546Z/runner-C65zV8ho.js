...
import { b as resolveModelRefFromString, i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels } from "./model-selection-shared-DbjoXfPH.js";
...
import { r as classifyMediaReferenceSource } from "./media-reference-Dvseu3P_.js";
...
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-DL8x8QI7.js";
import { t as providerSupportsCapability } from "./provider-supports-msSTK_XS.js";
import { c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-C1BdJzCZ.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-hrrxUKqA.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-CQMDOvz4.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-CyvVwyVO.js";
import { a as normalizeAttachments } from "./attachments.normalize-bAPjiGNs.js";
import { a as runCliEntry, d as selectAttachments, l as MediaAttachmentCache, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as isMediaUnderstandingSkipError } from "./runner.entries-XfI0rB9S.js";
import { r as inspectLocalAudioSelection, t as clearLocalAudioInspectionCacheForTests } from "./local-audio-DE7TZHDP.js";
...
const loadHasAvailableAuthForProvider = createLazyRuntimeNamedExport(() => import("./model-auth-D_Dk9non.js"), "hasAvailableAuthForProvider");
const loadPreparedModelCatalogApi = createLazyRuntimeModule(async () => ({
	...await import("./model-catalog-B2DbureB.js"),
	...await import("./prepared-model-catalog-CiP0KTjK.js")
}));
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-DTch0d5o.js");
