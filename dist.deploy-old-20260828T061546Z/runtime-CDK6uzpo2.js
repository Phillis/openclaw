...
import { b as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog } from "./model-selection-shared-DbjoXfPH.js";
...
import { m as patchSessionEntryCore, o as listSessionEntriesReadOnly, p as loadSessionEntryReadOnly, v as replaceSessionEntry } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
import { s as normalizeDeliveryContext } from "./delivery-context.shared-azPdmUls.js";
import { d as isSessionWorkAdmissionActive, n as beginSessionWorkAdmission, p as runExclusiveSessionLifecycleMutation } from "./session-lifecycle-admission-BtKN0pjk.js";
...
import { f as normalizeResolvedMaintenanceConfigInput } from "./disk-budget-NzkPcdhZ.js";
import { It as listSessionEntriesCore, nt as updateSessionEntry } from "./session-accessor-fcDZuc2H.js";
import { o as mediaKindFromMime } from "./constants-Mf57IYS0.js";
import { n as detectMime } from "./mime-Hm4eS2i0.js";
import { a as rollbackPluginOwnedSessionEntryLifecycle, i as rollbackAgentHarnessSessionEntryLifecycle, n as deleteSessionEntryLifecycle } from "./session-accessor.sqlite-lifecycle-wZ-pJlbP.js";
...
import { J as failFlow, W as createManagedTaskFlow, X as finishFlow, at as setFlowWaiting, it as resumeFlow, k as listTasksForFlowId, nt as requestFlowCancel } from "./task-registry-aynazQHF.js";
import "./runtime-internal-C7MuMy9Z.js";
import { _ as getTaskFlowByIdForOwner, d as getFlowTaskSummary, g as findLatestTaskFlowForOwner, p as runTaskInFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById, v as listTaskFlowsForOwner, y as resolveTaskFlowForLookupTokenForOwner } from "./task-executor-CcRsrYRm.js";
...
import { a as resolveInheritedToolPolicyForSession, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./agent-tools.policy-BuNXvHMo.js";
...
import { a as listRuntimeMusicGenerationProviders, i as generateMusic } from "./openclaw-tools-G5tkqH9U.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "./task-owner-access-C4bZGf6V.js";
import { o as resolveEffectiveSessionToolsVisibility } from "./session-visibility-D7qkCnOw.js";
...
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DgzLdXSu.js";
import { i as listWebSearchProviders, o as runWebSearch } from "./runtime-BuYDkFEi.js";
...
import { t as createRuntimeChannel } from "./runtime-channel-CXVIQtS3.js";
...
const loadAgentCommandRuntime = createLazyRuntimeModule(async () => {
	const [command, identity] = await Promise.all([import("./agent-command-DYFGtX6t.js"), import("./agent-command-execution-identity-CGcvX_IP.js")]);
	return {
		command,
		identity
	};
...
async function createSessionEntry(params) {
	const [{ createGatewaySession }, { resolveGatewaySessionStoreTarget }, { readAcpSessionMetaForEntry, upsertAcpSessionMeta }] = await Promise.all([
		import("./session-create-service-7EAWHk1d.js"),
		import("./session-utils-CpUx387S.js"),
		import("./session-meta-DI8KKyIR.js")
	]);
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("./heartbeat-runner-sNGv41M-.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRequestRuntime = createLazyRuntimeModule(() => import("./runtime-tts-request-coSlVbHf.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-CCg2fP0k.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime.js"));
const loadGatewayPluginRuntime = createLazyRuntimeModule(() => import("./server-plugins-DjDMLQW3.js"));
...
function createRuntimeLlmFacade() {
	const loadAcquireLocalService = createLazyRuntimeMethod(() => import("./provider-local-service-BcVhL2Hl.js"), (runtime) => runtime.createConfiguredProviderLocalServiceAcquirer(getRuntimeConfig));
...
function createRuntimeWorktrees() {
	const loadService = () => import("./service-uNnnbqTd.js");
	return {
...
function createRuntimeSandbox(agent) {
	...
	return {
		...
		async prepareWorkspaceAuthority(params) {
			...
			const { resolveSandboxContext } = await import("./context-B8ds0wMW.js");
