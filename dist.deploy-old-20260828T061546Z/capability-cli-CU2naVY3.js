...
import { c as providerSummaryText, t as emitJsonOrText } from "./shared-Dq9Owf7C.js";
...
const capabilityCommandGroups = [
	["model", async () => (await import("./model-DIEMKIlo.js")).registerModelCapabilityCommands],
	["image", async () => (await import("./image-DfAZMcPt.js")).registerImageCapabilityCommands],
	["audio", async () => (await import("./audio-BoiMm-iO.js")).registerAudioCapabilityCommands],
	["tts", async () => (await import("./tts-CPHHZ_Z9.js")).registerTtsCapabilityCommands],
	["video", async () => (await import("./video-B3A4vaAX.js")).registerVideoCapabilityCommands],
	["web", async () => (await import("./web-C-ji5EZE.js")).registerWebCapabilityCommands],
	["embedding", async () => (await import("./embedding-CoKKqXV_.js")).registerEmbeddingCapabilityCommands]
];
