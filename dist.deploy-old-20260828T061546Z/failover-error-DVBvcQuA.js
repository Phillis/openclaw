...
import { o as readErrorName, t as collectErrorGraphCandidates } from "./errors-Ccx0R-_Z.js";
import { t as formatCliCommand } from "./command-format-HwSAdvXB.js";
import { n as isAgentRunStaleLifecycleError } from "./agent-lifecycle-error-eMD2INV2.js";
import { m as isUnclassifiedNoBodyHttpSignal, n as classifyFailoverSignal, x as isTimeoutErrorMessage } from "./classify-DkuNrlYG.js";
...
function errorGraphHasName(err, name) {
...
function hasWorkerRunnerCoordinationFailure(err) {
	return [
...
function resolveModelFallbackError(err, context) {
	...
	if (hasGatewayDrainingFailure(err) || hasWorkerRunnerCoordinationFailure(err)) return {
		kind: "coordination",
		error: err
	};
