...
import { g as scopeKey, h as resolveScopeToolsPolicy, m as resolveScopeRequireMention } from "./channel-policy-RPOWSkLP.js";
...
import { c as resolveDiscordAccount, i as listDiscordStartupAccountIds, l as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds } from "./accounts-DWE66f3w.js";
import { t as getDiscordRuntime } from "./runtime-Dg4d9hPu.js";
import { t as parseDiscordTarget } from "./target-parsing-CcbK_-tL.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-By3GFKNK.js";
...
import { n as discordMessageActions, t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-DCJdgFe4.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupContract, t as createDiscordPluginBase } from "./shared-B-45l6BG.js";
import { c as resolveDiscordCurrentConversationIdentity, i as resolveDiscordConversationRoute, l as resolveDiscordRuntimeBindingConversationId } from "./route-resolution-C_Emp4ym.js";
import { r as openDiscordCommandDeployHashStore } from "./command-deploy-store-DFkBTViB.js";
import { t as resolveDiscordConversationBindingRoute } from "./conversation-binding-route-DOAVgt4o.js";
...
import { n as discordOutbound } from "./outbound-adapter-QdNqyhpp.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-Cvd35zRC.js")).discordApprovalNativeRuntime
		})
	});
}
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-C0dGcSsV.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-Bl1dbzM6.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-BYiyfaNk.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-DNBAEO09.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-NRKx8hFg.js"));
const loadDiscordProviderRuntime = createLazyRuntimeModule(() => import("./provider.runtime.js"));
const loadDiscordProbeRuntime = createLazyRuntimeModule(() => import("./probe.runtime-CM1jPXwS.js"));
...
const loadDiscordAuditModule = createLazyRuntimeModule(() => import("./audit-BPl1dgF2.js"));
const loadDiscordSendModule = createLazyRuntimeModule(() => import("./send-B-2CdDuQ.js"));
const loadDiscordDirectoryLiveModule = createLazyRuntimeModule(() => import("./directory-live-BFpDc3T5.js"));
//#endregion
