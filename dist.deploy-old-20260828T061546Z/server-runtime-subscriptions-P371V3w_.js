...
import { _ as onTrustedToolExecutionEvent } from "./diagnostic-events-BGzDm6gu.js";
import { t as createSubsystemLogger } from "./subsystem-a4KzJVZG.js";
import "./legacy.default-agent-owner-CL_-T11Y.js";
import { d as onAgentRuntimeEvent, l as onAgentAuditEvent } from "./agent-events-CcZImb5w.js";
import { i as clearAgentRunContext, s as getAgentRunContext } from "./agent-run-registry-t4kvUyNQ.js";
import { i as resolveStoredSessionKeyForAgentStore } from "./session-store-key-DRF7yKG5.js";
import { d as onSessionLifecycleEvent } from "./session-history-eviction-DX5U9ZnW.js";
import { r as onInternalSessionTranscriptUpdate } from "./transcript-events-Ce7n2r8A.js";
import { P as isSessionTranscriptProjectionUnavailableError, l as readSessionTranscriptBoundedMessageTailPage } from "./session-accessor-fcDZuc2H.js";
import { t as configureRuntimeActionDecisionSink } from "./runtime-action-decision-C4JNkXkP.js";
import { a as configureChannelAdmissionEvidenceCollection, i as configureChannelAdmissionDecisionSink } from "./admission-evidence-C8iAKYLB.js";
import { t as configureExecutionIdentityAdmissionSink } from "./execution-identity-admission-Tv8ni-9_.js";
import { s as isDefinitiveRunLifecycle, t as AGENT_RUN_TERMINAL_RETRY_GRACE_MS } from "./agent-run-terminal-outcome-DafVNgmX.js";
...
import { t as configureExecutionDecisionWorkSink } from "./execution-decision-work-B-G2Z43n.js";
import { a as resolveSessionSubscriptionKey, i as tryResolveSessionCompatibilityOwnerAgentId, o as resolveSessionSubscriptionKeys } from "./session-request-agent-C9E8iDY4.js";
import { i as loadGatewaySessionEntryReadOnly } from "./session-utils-store-Dmx2MxPy.js";
import "./session-utils-uVsFjoXC.js";
import { n as stripToolMessages, t as extractStoredAssistantText } from "./chat-history-text-CuXqMZU_.js";
...
import { c as removeChatAbortControllerEntry, p as markChatAbortTerminalPersistenceError } from "./chat-abort-CsMNzOPX.js";
import { i as terminalHealthFor, n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-BxqsjgLX.js";
...
import { t as createAuditEventRecorder } from "./audit-recorder-Buy5_MRu.js";
import { a as defaultPersistDigest, c as markSessionObserverRunSuperseded, d as rememberSessionObserverDormantRun, f as rememberSessionObserverRevisionFloor, i as defaultCompleteModel, l as normalizeSessionObserverModelOutput, m as synthesizeSessionObserverTerminalDigest, n as buildSessionObserverPrompt, o as defaultPrepareModel, p as sessionObserverScopeKey, r as createDormantSessionObserverRun, s as defaultReadSession, t as SESSION_OBSERVER_SYSTEM_PROMPT, u as rememberSessionObserverDisabledRun } from "./session-observer-model-CHUEX8KS.js";
import { r as resolveTaskRequesterSessionTarget, t as mapTaskSummary } from "./task-summary-wQfFTZ7S.js";
import { n as createSessionCompanionAskRuntime } from "./session-companion-ask-Cx-2DWLy.js";
...
function createSessionObserver(deps) {
	...
	const schedule = (state, run, observedAudience) => {
		...
		if (!modelStateIsCurrent(state, currentAudience) || state.inFlight || state.timer || state.terminalHealth || state.digestCount >= MAX_LIVE_DIGESTS_PER_RUN || pendingNotes(state).length < MIN_NOTES_PER_DIGEST) return;
...
function startGatewayEventSubscriptions(params) {
	...
	const agentEventHandlerLoader = createLazyPromiseLoader(() => {
		return Promise.all([import("./server-chat-22m5zawt.js"), import("./server-session-key-BgoW_NhO.js")]).then(([{ createAgentEventHandler }, { resolveSessionKeyForRun }]) => createAgentEventHandler({
	...
	const getSessionEventsModule = createLazyPromise(() => import("./server-session-events-oxx38F8W.js"), { cacheRejections: true });
	...
	const taskObserverRuntimePromise = import("./task-registry.store-BeJ7HASc.js").then((module) => {
