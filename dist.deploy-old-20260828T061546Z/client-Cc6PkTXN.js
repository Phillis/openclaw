...
import "./env-vars-D2m4hS5t.js";
import { n as LogService } from "./logger-CKG03qAR.js";
import { i as resolveMatrixAuthContext, r as resolveMatrixAuth } from "./create-client-YKlLktEB.js";
import { i as throwIfMatrixStartupAborted, t as awaitMatrixStartupWithAbort } from "./startup-abort-yDtnMgq-.js";
//#region extensions/matrix/src/matrix/client/shared.ts
const loadMatrixCreateClientDeps = createLazyRuntimeModule(() => import("./create-client-0UyvxGio.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient })));
