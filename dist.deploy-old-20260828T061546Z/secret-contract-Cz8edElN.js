...
import { i as createChannelSecretTargetRegistryEntries, s as getChannelSurface, t as collectConditionalChannelFieldAssignments, u as normalizeSecretStringValue } from "./channel-secret-basic-runtime-iUG8mZr_.js";
...
function collectRuntimeConfigAssignments(params) {
	...
	collectConditionalChannelFieldAssignments({
		...
		topLevelInheritedAccountActive: ({ account, enabled }) => enabled && !hasOwnProperty(account, "botToken") && !normalizeSecretStringValue(account.tokenFile),
