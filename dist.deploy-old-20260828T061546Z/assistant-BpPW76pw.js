...
async function runConfiguredSystemAgentText(params) {
	...
	try {
		...
		text = extractAgentRunText(route.runner === "cli" ? await (params.deps?.runCliAgent ?? (await import("./cli-runner-B_eCZ6FD.js")).runCliAgent)({
			...shared,
			preparedRunAdmission,
			executionMode: "side-question",
			cleanupCliLiveSessionOnRunEnd: true
		}) : await (params.deps?.runEmbeddedAgent ?? (await import("./embedded-agent-fNRs635m.js")).runEmbeddedAgent)({
			...shared,
			preparedRunAdmission,
			toolsAllow: [],
