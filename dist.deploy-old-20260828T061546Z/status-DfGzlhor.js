...
import { l as resolveGatewayLaunchAgentLabel, p as resolveGatewaySystemdServiceName } from "./constants-ChqKLfPp.js";
...
import { m as isWSLEnv } from "./undici-runtime-CWs3Ll9x.js";
...
import { t as formatGatewayHeapLimitReport } from "./gateway-heap-BfwKOqCU.js";
import { a as resolveGatewayRestartLogPath, o as resolveGatewaySupervisorLogPaths } from "./restart-logs-PTGgxP4T.js";
import { i as renderSystemdUnavailableHints, r as isSystemdUnavailableDetail } from "./runtime-hints-B9Y8o0pU.js";
import { a as filterDaemonEnv, d as resolveRuntimeStatusColor, f as safeDaemonEnv, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-AtIdcOsw.js";
import { r as isSystemdStartLimitHit } from "./service-runtime-E6hYEM49.js";
...
import { n as formatGatewayRestartHandoffDiagnostic } from "./restart-handoff-DdLfWceW.js";
import { n as resolvePluginVersionDriftUpdateCommand } from "./plugin-version-drift-C1vOC0Ad.js";
import { n as renderPortDiagnosticsForCli, r as resolvePortListeningAddresses, t as gatherDaemonStatus } from "./status.gather-BU8TKsum.js";
import { i as renderGatewayServiceCleanupHints } from "./inspect-Dd_Zh1yU.js";
...
function printDaemonStatus(status, opts) {
	...
	if (service.command?.reloadPending) defaultRuntime.log(warnText("Systemd reload: pending (run systemctl --user daemon-reload)"));
	...
	const serviceInspectionDetail = service.loadState.status === "unknown" ? service.loadState.detail : void 0;
	...
	if (process.platform === "linux" && (serviceInspectionDetail !== void 0 || rpc?.ok !== true) && isSystemdUnavailableDetail(systemdUnavailableDetail)) {
