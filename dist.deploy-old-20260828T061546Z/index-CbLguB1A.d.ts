import { S as TextContent, _ as SimpleStreamOptions, a as AssistantMessageEventStreamContract, c as Context, d as Model, i as AssistantMessageEvent, k as ToolResultMessage, l as ImageContent, n as Api } from "./types-DTWCh4Mv.js";
import { c as CompactionResult, s as CompactionPreparation } from "./agent-core-BkRJ6FA8.js";
import { S as ToolExecutionMode, _ as CustomMessage, b as StreamFn, c as AgentMessage, f as AgentToolResult, p as AgentToolUpdateCallback, u as AgentTool, x as ThinkingLevel } from "./types-aADBdueZ.js";
import "./types-Cc0P-Eyx.js";
import "./index-Bf1XfcnS.js";
import "./types-DpImvtmp.js";
import { d as SourceInfo } from "./types-DPz-SxBl.js";
import { n as PluginMetadataSnapshot, r as PluginMetadataSnapshotOwnerMaps } from "./plugin-metadata-snapshot.types-CtWP2XaL.js";
import "./llm-DXDoKfBx.js";
import { c as SessionEntry, n as SessionManager, o as BranchSummaryEntry, s as CompactionEntry, t as ReadonlySessionManager } from "./session-manager-9ZigNj1A.js";
import { i as OAuthLoginCallbacks$1, l as OAuthProviderInterface, r as OAuthCredentials$1, s as OAuthProviderId } from "./provider-oauth-runtime-BZ49xsx4.js";
...
declare const ReadToolContinuationSchema: Type.TUnion<[Type.TObject<{
  offset: Type.TInteger;
  limit: Type.TOptional<Type.TInteger>;
  kind: Type.TLiteral<"line">;
}>, Type.TObject<{
  cursor: Type.TInteger;
  offset: Type.TInteger;
  limit: Type.TOptional<Type.TInteger>;
  kind: Type.TLiteral<"cursor">;
}>]>;
type ReadToolContinuation = Static<typeof ReadToolContinuationSchema>;
...
//#endregion
//#region src/agents/sessions/tools/read-tool-contract.d.ts
declare const readToolInputSchema: Type.TObject<{
  path: Type.TString;
  offset: Type.TOptional<Type.TInteger>;
  limit: Type.TOptional<Type.TNumber>;
  cursor: Type.TOptional<Type.TInteger>;
  optional: Type.TOptional<Type.TLiteral<true>>;
}>;
//#endregion
...
interface ReadOperations {
  ...
  detectImageMimeType?: (absolutePath: string, buffer: Buffer) => Promise<string | null | undefined>;
}
...
declare function createReadTool(cwd: string, options?: ReadToolOptions): AgentTool<typeof readToolInputSchema>;
//#endregion
