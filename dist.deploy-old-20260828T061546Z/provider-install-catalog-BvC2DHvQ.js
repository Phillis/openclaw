...
import { u as describePluginInstallSource } from "./installed-plugin-index-Cr71VmpU.js";
import { T as normalizePluginInstallDefaultChoice, o as getOfficialExternalPluginCatalogManifest, p as listOfficialExternalProviderCatalogEntries, v as resolveOfficialExternalPluginInstall } from "./official-external-plugin-catalog-C1KgYx9P.js";
import { f as loadPluginRegistrySnapshot } from "./plugin-metadata-snapshot-BI5GxVU3.js";
import "./plugin-registry-BcpcjwxL.js";
import { n as loadOpenClawProviderIndex } from "./model-catalog-DpJeh3RG.js";
...
function resolveInstallInfoFromProviderIndex(provider) {
	...
	const defaultChoice = normalizePluginInstallDefaultChoice(install.defaultChoice) ?? (clawhubSpec ? "clawhub" : "npm");
	return {
		...clawhubSpec ? { clawhubSpec } : {},
		...npmSpec ? { npmSpec } : {},
		defaultChoice,
