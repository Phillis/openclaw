import { $n as definePluginEntry, Kt as OpenClawPluginToolContext, _n as AnyAgentTool, a as OpenClawPluginApi, qt as OpenClawPluginToolFactory } from "../../acpx-Bsv7pbza.js";
import { a as resolveBrowserConfig, d as BrowserStatus, f as BrowserTab, g as SnapshotAriaNode, h as BrowserTransport, m as BrowserTabsResult, n as ResolvedBrowserConfig, o as resolveProfile, r as ResolvedBrowserProfile, s as DEFAULT_UPLOAD_DIR, u as BrowserOpenResult } from "../../config-MskP_jm_.js";
import { n as redactCdpUrl } from "../../browser-cdp-DN_GpccS.js";
...
import { n as ensureBrowserControlAuth, r as resolveBrowserControlAuth } from "../../control-auth-8qudmgn4.js";
import { a as resolveGoogleChromeExecutableForPlatform, n as parseBrowserMajorVersion, r as readBrowserVersion, t as BrowserExecutable } from "../../sdk-setup-tools-BaagudkT.js";
import { n as trackSessionBrowserTab, r as untrackSessionBrowserTab, t as closeTrackedBrowserTabsForSessions } from "../../session-tab-registry-B36deecn.js";
import { t as movePathToTrash } from "../../trash-Xk5ha1PQ.js";
import { A as BrowserDownloadResult, C as browserPdfSave, D as BrowserBatchAbort, E as BrowserActionTabResult, O as BrowserBatchActionResult, S as browserConsoleMessages, T as BrowserActionPathResult, _ as startBrowserBridgeServer, a as installBrowserCommonMiddleware, b as BrowserServerState, c as BrowserRouteRegistrar, d as startBrowserControlServiceFromConfig, f as stopBrowserControlService, g as BrowserBridge, h as runBrowserProxyCommand, i as installBrowserAuthMiddleware, j as getBrowserProfileCapabilities, k as AnnotationItem, l as createBrowserRuntimeState, m as getBrowserControlState, n as browserHandlers, o as createBrowserRouteDispatcher, p as createBrowserControlContext, r as handleBrowserGatewayRequest, s as registerBrowserRoutes, t as createBrowserPluginService, u as stopBrowserRuntime, v as stopBrowserBridgeServer, w as BrowserActionOk, x as createBrowserTool, y as createBrowserRouteContext } from "../../plugin-service-D1iqyhrs.js";
...
declare function browserStatus(baseUrl?: string, opts?: BrowserClientProfileOptions): Promise<BrowserStatus>;
...
declare function browserProfiles(baseUrl?: string, opts?: BrowserClientTimeoutOptions): Promise<ProfileStatus[]>;
/** Start the selected browser profile. */
declare function browserStart(baseUrl?: string, opts?: BrowserClientProfileOptions): Promise<void>;
/** Stop the selected browser profile. */
declare function browserStop(baseUrl?: string, opts?: BrowserClientProfileOptions): Promise<void>;
...
declare function browserTabs(baseUrl?: string, opts?: BrowserClientProfileOptions): Promise<BrowserTabsResult>;
...
declare function browserFocusTab(baseUrl: string | undefined, targetId: string, opts?: BrowserClientProfileOptions): Promise<{
  ok: true;
  targetId?: string;
}>;
/** Close an existing browser tab. */
declare function browserCloseTab(baseUrl: string | undefined, targetId: string, opts?: BrowserClientProfileOptions): Promise<{
  ok: true;
  targetId?: string;
}>;
