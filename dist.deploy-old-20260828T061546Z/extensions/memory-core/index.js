...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-BPMvoFsl.js";
import { i as resolveMemoryToolContext, n as MEMORY_SEARCH_TOOL_CONTRACT, r as buildMemoryPromptSection, t as MEMORY_GET_TOOL_CONTRACT } from "../../memory-tool-contract-DWe2kizH.js";
...
const loadSessionBackfillGatewayRuntime = createLazyRuntimeModule(() => import("../../session-backfill-gateway.runtime-CG9bpaaf.js"));
...
const loadMemoryToolsModule = createLazyRuntimeModule(() => import("../../tools-WxEY1NAb.js"));
const loadStandingIntentsModule = createLazyRuntimeModule(() => import("../../standing-intents-R4GIMfN5.js"));
const loadStandingIntentToolModule = createLazyRuntimeModule(() => import("../../standing-intents-tool-DnQrd4oz.js"));
const loadRuntimeProviderModule = createLazyRuntimeModule(() => import("../../runtime-provider-DCiD08be.js"));
...
function createLazyMemoryRuntime(host) {
	return {
		...
		async classifyWorkspaceMemoryPaths(params) {
			const [{ classifyWorkspaceMemoryPaths }, dreamingState] = await Promise.all([import("../../workspace-path-classifier-PQxLbUSh.js"), import("../../dreaming-state-C8InVCcK.js")]);
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-DRtin363.js");
		...
		api.registerCommand({
			...
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-B5eTDtqc.js");
