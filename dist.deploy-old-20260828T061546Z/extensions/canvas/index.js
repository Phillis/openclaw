...
import { a as selectDefaultNodeFromList } from "../../nodes-utils-CYXmZviL.js";
...
import { i as CanvasToolSchema, n as isEligibleCanvasNode, t as CANVAS_PRESENT_COMMAND } from "../../node-eligibility-DpeKBzCb.js";
...
function createLazyCanvasTool(agentSessionKey) {
	const loadTool = createLazyRuntimeModule(() => import("../../tool-BKc7B6qR.js").then(({ createCanvasTool }) => createCanvasTool({ agentSessionKey })));
	return {
		label: "Canvas",
		name: "canvas",
...
var canvas_default = definePluginEntry({
	...
	register(api) {
		if (isCanvasHostEnabled(api.config)) {
			...
			const loadHttpRouteHandler = createLazyRuntimeModule(() => import("../../http-route-CJCz_lfo.js").then(({ createCanvasHttpRouteHandler }) => createCanvasHttpRouteHandler()));
		...
		api.registerNodeCliFeature(async ({ program }) => {
			const { createDefaultCanvasCliDependencies, registerNodesCanvasCommands } = await import("../../cli-DXV0vaj_.js");
