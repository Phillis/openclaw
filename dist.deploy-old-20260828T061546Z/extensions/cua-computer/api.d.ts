...
//#endregion
//#region extensions/cua-computer/src/doctor.d.ts
declare const CUA_DRIVER_ARTIFACT_CHECK_ID = "cua-computer/driver-artifacts";
type CuaDriverDoctorRegistrationHost = {
  readonly registerHealthCheck: (check: HealthCheck) => void;
};
declare function registerCuaDriverDoctorChecks(host?: CuaDriverDoctorRegistrationHost): void;
//#endregion
export { CUA_DRIVER_ARTIFACT_CHECK_ID, registerCuaDriverDoctorChecks };