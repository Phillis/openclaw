import { a as isDirectPerplexityBaseUrl, i as inferPerplexityBaseUrlFromApiKey, n as DEFAULT_PERPLEXITY_BASE_URL, r as PERPLEXITY_DIRECT_BASE_URL } from "./perplexity-web-search-provider-BwUa_uAl.js";
...
async function runPerplexitySearchApi(params) {
	...
	return withTrustedWebSearchEndpoint({
		...
		return ((await readProviderJsonResponse(res, "Perplexity Search")).results ?? []).map((entry) => ({
...
//#endregion
export { executePerplexitySearch, testing };
