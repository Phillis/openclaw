import { t as hasConfiguredChannelsForReadOnlyScope } from "./channel-presence-policy-oJ8soWzX.js";
import "./channel-plugin-ids-CD1dMDba.js";
import { r as withProgress } from "./progress-3-oJv0bD.js";
import { t as collectStatusScanOverview } from "./status.scan-overview-xces3K54.js";
import { n as scanStatusJsonWithPolicy, r as executeStatusScanFromOverview } from "./status.scan.fast-json-BZkHFGD9.js";
import { n as resolveStatusMemoryStatusSnapshot } from "./status.scan-memory-Hnrn3wPh.js";
...
async function scanStatus(opts, _runtime) {
	...
	return await withProgress({
		...
		const pluginCompatibility = opts.all ? await import("./status-tOsR5fEI.js").then(({ buildPluginCompatibilitySnapshotNotices }) => buildPluginCompatibilitySnapshotNotices({ config: overview.cfg })) : [];
		progress.tick();
