...
import { r as formatJsonConsoleLine } from "./json-console-line-C-rJUoue.js";
import { n as levelToMinLevel } from "./levels-qpAN12Fm.js";
import { a as getChildLogger, c as isFileLogLevelEnabled } from "./logger-ij8OHrrv.js";
import { c as shouldLogSubsystemToConsole, n as formatConsoleTimestamp, r as getConsoleSettings } from "./console-SZn871dT.js";
...
function createSubsystemLogger(subsystem) {
	...
	let fileChild;
	const getFileLogger = () => {
		if (fileChild?.generation !== loggingState.generation) fileChild = {
