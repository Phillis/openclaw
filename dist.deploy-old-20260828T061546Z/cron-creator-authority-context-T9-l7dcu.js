...
import { i as revokeCronCreatorAuthorityRunScope, n as createCronCreatorAuthorityRunScope, r as mintCronCreatorAuthorityGrant } from "./cron-creator-authority-grant-ByMTcCew.js";
import { AsyncLocalStorage } from "node:async_hooks";
//#region src/agents/cron-creator-authority-context.ts
function createCronCreatorAuthorityCapability(runId, callerOrigin = { kind: "unknown" }) {
	const normalizedRunId = runId.trim();
	return normalizedRunId ? createCronCreatorAuthorityRunScope(normalizedRunId, callerOrigin) : void 0;
}
...
//#endregion
export { runWithCronCreatorAuthorityCapabilityResolver as a, runWithCronCreatorAuthorityCapability as i, bindActiveOperatorTurnAuthority as n, runWithCronCreatorAuthorityResolver as o, createCronCreatorAuthorityCapability as r, shouldAdmitFreshChannelOwnerCronAuthority as s, bindActiveCronCreatorAuthorityResolver as t };
