...
import "./policy-Cj3P99a_.js";
import { a as resolveAgentHarnessOwnerPluginId, r as listRegisteredAgentHarnesses } from "./registry-CWcxV14-.js";
import { a as unwrapSecretSentinelsForProviderEgress, i as unwrapModelHeaderSentinelsForProviderEgress } from "./provider-secret-egress-C6cfX3SL.js";
import { f as resolveProviderRefOwnership } from "./providers-BY0gR-NY.js";
import { a as resolveAgentHarnessAutoSelectionHint } from "./session-runtime-compat-CuMcNwkW.js";
import { a as resolveAgentHarnessPreparedAuthSupport, i as compareHarnessSupport, o as resolveAgentHarnessPreparedRouteSupport, r as buildAgentHarnessSupportContext, t as resolveAgentHarnessAvailabilityDecision } from "./availability-DW_f7sKl.js";
...
import { n as isBuiltInOpenClawAgentHarness, t as createOpenClawAgentHarness } from "./builtin-openclaw-BruFLvIP.js";
...
import { i as EmptySettledTurnFinalizationError, t as assertSettledTurnFinalizationResult } from "./settled-turn-finalization-result-DRaTsrdI.js";
...
async function runSelectedAgentHarnessAttempt(params) {
	...
	if (internalParams.systemAgentTool && !isSystemAgentOnlyAllowlist(internalParams.toolsAllow)) throw new Error("OpenClaw host authority requires toolsAllow: [\"openclaw\"]");
	const ringZeroTools = internalParams.systemAgentTool ? [(await import("./system-agent-tool-C-a9w0lT.js")).createSystemAgentTool(internalParams.systemAgentTool)] : [];
