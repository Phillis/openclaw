...
import { f as WORKER_PROTOCOL_METHODS, h as WORKER_SESSION_TOOLS_PROTOCOL_FEATURE, i as WORKER_HEARTBEAT_INTERVAL_MS, r as WORKER_GITHUB_PUBLICATION_PROTOCOL_FEATURE, s as WORKER_PORTAL_PROTOCOL_FEATURE } from "./worker-admission-v0PuudgP.js";
import { o as WORKER_PROTOCOL_MAX_PAYLOAD_BYTES } from "./worker-protocol-primitives-Ch87u2k0.js";
import { a as isLoopbackAddress } from "./net-DeK7gO-9.js";
import { u as AUTH_RATE_LIMIT_SCOPE_WORKER_ADMISSION } from "./auth-rate-limit-C6x9QPnp.js";
...
import { Co as validateWorkerLiveEventParams, Do as validateWorkerTranscriptCommitParams, Eo as validateWorkerSessionsSpawnParams, Jn as validateRequestFrame, So as validateWorkerHeartbeatParams, To as validateWorkerSessionsSendParams, go as validateWorkerConnectRequestFrame, wo as validateWorkerPortalParams, xo as validateWorkerGitHubPublishParams } from "./src-4dv5TpeQ.js";
import { u as isWebchatClient } from "./message-channel-BZwx7FCw.js";
import { S as tryBeginGatewayRootWorkAdmission, c as isGatewayRestartDraining, o as getGatewaySuspendAdmissionPhase, v as runWithGatewayIndependentRootWorkContinuation } from "./gateway-work-admission-CTDt7IQ1.js";
import { a as WORKER_PROTOCOL_MAX_INFERENCE_PAYLOAD_BYTES, f as validateWorkerInferenceCancelParams, m as validateWorkerInferenceStartParams, r as WORKER_INFERENCE_METHODS } from "./worker-inference-BzU_LUo9.js";
import { i as upsertPresence, n as touchPresence } from "./system-presence-Ccv3L_9H.js";
import { t as rawDataByteLength } from "./ws-C3ckvj65.js";
import { s as removeRemoteNodeInfo } from "./remote-BHibO2zu.js";
import { c as recordPairedNodeDisconnection } from "./device-pairing-node-yaKle7Kn.js";
...
import { n as classifyGatewayStaleInstall, t as GATEWAY_STALE_INSTALL_CLOSE_REASON } from "./stale-install-Ddx9ofaa.js";
import "./server-utils-C3MkyEfr.js";
import { a as incrementPresenceVersion, r as getHealthVersion } from "./health-state-BzKAU1CD.js";
import { i as clearNodeWakeState } from "./node-wake-state-CLsta4Jn.js";
import "./placement-session-tool-operations-fgL8HLyL.js";
import { s as runWorkerTurnAdmissionContinuation } from "./placement-turn-claim-events-DXxC6aUk.js";
import { t as broadcastPresenceSnapshot } from "./presence-events-X4VayQ5i.js";
import { t as cleanupTalkConnection } from "./talk-session-registry-BFXYERqh.js";
import { n as refreshClientPresence } from "./client-presence-DhNa5MdO.js";
...
async function dispatchWorkerRequest(params) {
	...
	if (params.request.method === WORKER_PROTOCOL_METHODS[3] || params.request.method === WORKER_PROTOCOL_METHODS[4] || params.request.method === WORKER_PROTOCOL_METHODS[5] || params.request.method === WORKER_PROTOCOL_METHODS[6]) {
		...
		const requiredFeature = isPortal ? WORKER_PORTAL_PROTOCOL_FEATURE : isGitHubPublish ? WORKER_GITHUB_PUBLICATION_PROTOCOL_FEATURE : WORKER_SESSION_TOOLS_PROTOCOL_FEATURE;
		...
		if (!(isPortal ? validateWorkerPortalParams(params.request.params) : isSpawn ? validateWorkerSessionsSpawnParams(params.request.params) : isGitHubPublish ? validateWorkerGitHubPublishParams(params.request.params) : validateWorkerSessionsSendParams(params.request.params))) {
			params.respond(false, void 0, workerProtocolError("invalid-frame"));
			return;
		}
		const outcome = await service.executeSessionTool(params.identity, isPortal ? "portal" : isSpawn ? "sessions_spawn" : isGitHubPublish ? "github_publish" : "sessions_send", params.request.params, params.signal);
		if (outcome.ok) {
			params.respond(true, outcome.result);
			return;
		}
...
function attachWorkerWsMessageHandler(params) {
	...
	const handleMessage = async (data, admissionOpen) => {
		...
		if (parsed.method === WORKER_PROTOCOL_METHODS[0] || parsed.method === WORKER_PROTOCOL_METHODS[1] || parsed.method === WORKER_PROTOCOL_METHODS[2] || parsed.method === WORKER_PROTOCOL_METHODS[3] || parsed.method === WORKER_PROTOCOL_METHODS[4] || parsed.method === WORKER_PROTOCOL_METHODS[5] || parsed.method === WORKER_PROTOCOL_METHODS[6] || parsed.method === WORKER_INFERENCE_METHODS[0] || parsed.method === WORKER_INFERENCE_METHODS[1]) params.setLastFrameMeta({
			type: "req",
		...
		if (parsed.method === WORKER_PROTOCOL_METHODS[3] || parsed.method === WORKER_PROTOCOL_METHODS[4] || parsed.method === WORKER_PROTOCOL_METHODS[5] || parsed.method === WORKER_PROTOCOL_METHODS[6]) {
...
function attachGatewayWsMessageHandlerOnDemand(params) {
	...
	import("./message-handler-UX9OprMN.js").then(({ attachGatewayWsMessageHandler }) => {
