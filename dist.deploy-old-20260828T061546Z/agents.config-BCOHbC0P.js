...
import { C as tryResolveLegacyCompatibilityAgentId, f as resolveAgentWorkspaceDir, l as resolveAgentDir, r as listAgentEntries, y as toAgentEntriesRecord } from "./agent-scope-config-CUBiGmG3.js";
import { t as pinSurvivorWorkspaceForRosterCollapse } from "./agent-workspace-roster-transition-DoqG2wNw.js";
import { n as pinLegacyInheritedAuthOwnerForRosterTransition } from "./legacy-inherited-auth-dir-DCEipwnb.js";
...
import { i as loadAgentIdentityFromWorkspace, n as identityHasValues } from "./identity-file-B-yOqb54.js";
...
function pruneAgentConfig(cfg, agentId) {
	...
	const nextBroadcast = cfg.broadcast ? Object.fromEntries(Object.entries(cfg.broadcast).map(([peerId, value]) => [peerId, Array.isArray(value) ? value.filter((entry) => !targetsDeletedAgent(entry)) : value])) : void 0;
