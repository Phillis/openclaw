...
import "./legacy-Czf036mL.js";
import "./legacy.default-agent-owner-CL_-T11Y.js";
import { d as configIncludeOwnsAgentRoster, f as hasResolvedRosterBeforeMigrations } from "./provider-model-route-n5WsvCIn.js";
...
*/
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-BqQ5tRLi.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-B0JIUhGW.js"));
...
async function resolveDefaultSessionTranscriptsDir(agentId) {
	const { resolveSessionTranscriptsDirForAgent } = await import("./sessions-D25gRjw-.js");
