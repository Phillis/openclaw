...
async function hasActiveGatewayExecCredential(params) {
	const [{ resolveSecretInputRef }, { gatewaySecretInputPathCanWin }, secretPaths] = await Promise.all([
		...
		import("./credentials-secret-inputs-CiyK9SfL.js"),
	...
	const [{ buildGatewayProbeConnectionDetails }, edgeAuth] = await Promise.all([import("./call-DPYKD0iw.js"), import("./edge-auth-Bxlgs1iw.js")]);
