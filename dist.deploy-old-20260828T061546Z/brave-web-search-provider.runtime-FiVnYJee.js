...
import { m as readProviderJsonResponse, r as assertOkOrThrowProviderError } from "./provider-http-errors-BXG5plR9.js";
import { _ as resolvePinnedHostnameWithPolicy, c as isBlockedHostnameOrIp, u as isPrivateIpAddress } from "./ssrf-arYIaOWE.js";
...
import { S as writeCachedSearchPayload, _ as resolveSearchTimeoutSeconds, b as withSelfHostedWebSearchEndpoint, f as readCachedSearchPayload, g as resolveSearchCount, h as resolveSearchCacheTtlMs, i as buildSearchCacheKey, m as readProviderEnvValue, p as readConfiguredSecretString, u as parseWebSearchTimeFilters, v as resolveSiteName, x as withTrustedWebSearchEndpoint } from "./web-search-provider-common-Bs6XuAge.js";
import "./runtime-env-_YEv0JPQ.js";
import "./string-coerce-runtime-C8jKEm3h.js";
import { t as assertHttpUrlTargetsPrivateNetwork } from "./ssrf-policy-DrRXEpPY.js";
...
async function executeBraveSearch(args, searchConfig, options) {
	...
	const country = normalizeBraveCountry(readToolStringParam(args, "country"));
	const language = readToolStringParam(args, "language");
	const search_lang = readToolStringParam(args, "search_lang");
	const ui_lang = readToolStringParam(args, "ui_lang");
	...
	const results = response.mode === "llm-context" ? response.results.map((entry) => ({
