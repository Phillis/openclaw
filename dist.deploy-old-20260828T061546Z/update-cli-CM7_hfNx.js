...
import { E as resolveConfigIncludes } from "./redact-CWP17HFN.js";
...
import { a as GATEWAY_SERVICE_SELECTOR_ENV_KEYS, c as isGatewayServiceEnv, i as GATEWAY_SERVICE_RUNTIME_PID_ENV, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./constants-ChqKLfPp.js";
import { _ as resolveGatewayPort, n as DEFAULT_GATEWAY_PORT, t as CONFIG_PATH, v as resolveIncludeRoots } from "./paths-BBSTUjD5.js";
...
import { B as asResolvedSourceConfig, D as createPreUpdateConfigSnapshot, V as asRuntimeConfig, d as readSourceConfigBestEffort, s as readConfigFileSnapshot } from "./io-ClLVsBMp.js";
import { r as readJsonIfExists, u as writeJson } from "./json-Dx6zyhjY.js";
...
import { h as setPluginInstallRecordMapEntry, i as resolveTrustedSourceLinkedOfficialClawHubSpec, l as createPluginInstallRecordMap, m as serializePluginInstallRecordMap, o as resolveTrustedSourceLinkedOfficialNpmSpec, p as parsePluginInstallRecordMap } from "./official-external-install-records-DOxgmTy-.js";
import { o as loadInstalledPluginIndexInstallRecords } from "./manifest-registry-DqYRJvWI.js";
import { a as OPENCLAW_DATABASE_SCHEMA_DOCS_URL } from "./openclaw-state-db-contract-DsoDzKB9.js";
...
import { a as getWindowsSystem32ExePath, t as getWindowsCmdExePath } from "./windows-install-roots-BdGcwph2.js";
import { a as formatExternalSupervisorUpdateRequired, o as isGatewayExternallySupervised, r as assertGatewayServiceMutationAllowed } from "./gateway-supervision-C0L8fX98.js";
import { n as readPersistedInstalledPluginIndex, s as restorePersistedInstalledPluginIndexIfCurrent } from "./installed-plugin-index-store-7GzEHL03.js";
...
import { a as nodeVersionSatisfiesEngine, o as parseSemver } from "./runtime-guard-xF0n8O8f.js";
...
import { t as disableCurrentOpenClawUpdateLaunchdJob } from "./launchd-BmiQh1SZ.js";
import { a as resolveGatewayRestartLogPath, r as renderPosixRestartLogSetup, s as shellEscapeRestartLogValue } from "./restart-logs-PTGgxP4T.js";
import { i as terminateStaleGatewayPids, r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-g_celehk.js";
import { _ as resolveManagedGatewayServiceProcessEnv, g as resolveManagedGatewayServiceCommand } from "./systemd-fY9j-7P4.js";
import { a as readGatewayServiceState, o as resolveGatewayService } from "./service-BYLPjc81.js";
import { a as resumeScheduledTaskAutoStartAfterUpdate, c as suspendScheduledTaskAutoStartForUpdate } from "./schtasks-CCsMuBUU.js";
import { n as runDaemonInstall } from "./install-xw4hOEDu.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-CA17dLc9.js";
import { a as renderRestartDiagnostics, n as waitForGatewayHealthyRestart } from "./restart-health-XZsBlZte.js";
import { a as withPluginInstallRecords, c as writePersistedInstalledPluginIndexInstallRecordsWithLease, o as withoutPluginInstallRecords } from "./installed-plugin-index-records-CHK-Mu2-.js";
import { t as withPluginLifecycleLease } from "./plugin-lifecycle-lease-QVxAzcU7.js";
import { g as updateInstallRootsMatch, p as trimLogTail } from "./restart-sentinel-DedQJXFM.js";
import { c as writeControlPlaneUpdateRestartSentinel, i as buildControlPlaneUpdateRestartHealthPendingResult, o as markControlPlaneUpdateRestartSentinelFailure, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-CjDvg0VZ.js";
import { i as parseDevUpdateTargetEnv, t as UPDATE_DEV_TARGET_REF_ENV } from "./update-dev-target-BGSFRuDr.js";
import { n as cleanupStaleManagedServiceUpdateHandoffs } from "./update-managed-service-handoff-cleanup-B18agwDB.js";
...
import { n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV, o as installCompletion } from "./completion-runtime-BSaYDhze.js";
...
import { i as commitPluginInstallRecordsWithConfig } from "./install-record-commit-BfqdA5hk.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./registry-refresh-Hpdl6ZAz.js";
import { a as channelToNpmTag, d as resolveEffectiveUpdateChannel, i as UPDATE_EFFECTIVE_CHANNEL_ENV, l as normalizeUpdateChannel, o as formatUpdateChannelLabel, p as resolveUpdateChannelDisplay, r as EXTENDED_STABLE_TAG_UNSUPPORTED_REASON } from "./update-channels-D2-WrHya.js";
import { t as listPersistedBundledPluginLocationBridges } from "./plugins-location-bridges-B9Dc-dkq.js";
import { n as updateNpmInstalledPlugins, r as isClawHubTrustSkippedOutcome, t as syncPluginsForUpdateChannel } from "./update-BxTnzDTG.js";
import { t as createLowDiskSpaceWarning } from "./disk-space-CzASwJhY.js";
import { r as preflightOpenClawDatabaseSchemas } from "./openclaw-database-preflight-UEy2BqRj.js";
import { i as buildPostCoreHandoffEnv, r as POST_CORE_UPDATE_SOURCE_CONFIG_PATH_ENV, t as POST_CORE_UPDATE_ENV } from "./update-post-core-context-BIm4ywkD.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-BoWJND-q.js";
import { a as resolveExtendedStablePackage, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmTagVersion, s as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-iQLkkUmm.js";
import { a as resolveUpdateAvailability, i as resolveStatusRegistryUpdateChannel, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-9oItjfB_.js";
import { a as markPackagePostInstallDoctorAdvisory, c as createGlobalInstallEnv, d as resolveGlobalInstallSpec, f as resolveGlobalInstallTarget, i as resolveUpdateDoctorExecutionPolicy, l as detectGlobalInstallManagerByPresence, m as normalizePackageTagInput, o as runGlobalPackageUpdateSteps, p as resolveNpmLifecyclePolicyGate, s as canResolveRegistryVersionForPackageTarget, t as runGatewayUpdate, u as detectGlobalInstallManagerForRoot } from "./update-runner-2ESoe5eG.js";
import { n as printResult, t as createUpdateProgress } from "./progress-DIGQAEoP.js";
import { i as consumeUpdatePostInstallDoctorResult, o as createUpdatePostInstallDoctorResultPath, r as UPDATE_POST_INSTALL_DOCTOR_RESULT_PATH_ENV } from "./update-doctor-result-D3HkeqjI.js";
import { t as doctorCommand } from "./doctor-DOmMlIh7.js";
import { a as UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV, i as UPDATE_PARENT_ALLOWS_GATEWAY_SERVICE_REPAIR_ENV, o as UPDATE_PARENT_SUPPORTS_GATEWAY_RESTART_ENV, r as UPDATE_PARENT_ALLOWS_GATEWAY_ACTIVATION_ENV, s as UPDATE_POST_CORE_CONVERGENCE_ENV, t as UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV } from "./update-phase-CUQAfBmE.js";
import { t as summarizeGatewayServiceLayout } from "./service-layout-CQRBnufE.js";
import { a as validateBundleInstallRecordPayload, n as resolveBundleInstallRecordPayload, t as hasNativePackageInstallPayload } from "./plugin-payload-validation-BwU3Wtg1.js";
import { n as runPostCorePluginConvergence, t as convergenceWarningsToOutcomes } from "./post-core-plugin-convergence-CEIHV3sc.js";
...
function parseTimeoutMsOrExit(timeout) {
	...
	if (seconds === void 0 || seconds > MAX_SAFE_TIMEOUT_SECONDS) {
		if (isJsonOutputModeActive(process.argv)) throw new Error(INVALID_TIMEOUT_ERROR);
...
async function cloneGitCheckoutTransactionally(params) {
	...
	const canonicalParentDir = await fs$1.realpath(parentDir);
	const preserveDir = await pathExists$1(params.dir) && await isEmptyDir(params.dir);
	const targetDir = preserveDir ? await fs$1.realpath(params.dir) : path.join(canonicalParentDir, path.basename(params.dir));
	const stagingParent = preserveDir ? targetDir : canonicalParentDir;
	const stagingDir = await fs$1.mkdtemp(path.join(stagingParent, ".openclaw-clone-"));
	...
	try {
		...
		if (!preserveDir) try {
			...
			await fs$1.rename(stagingDir, targetDir);
			return {
				checkoutDir: targetDir,
				step: result
			};
		}
		if (!preserveDir) throw new Error(`OPENCLAW_GIT_DIR appeared while cloning: ${params.dir}. The existing path was left unchanged; move it or choose another OPENCLAW_GIT_DIR, then retry.`);
		const expectedEntries = preserveDir ? [path.basename(stagingDir)] : [];
		if ((await fs$1.readdir(targetDir)).toSorted().join("\0") !== expectedEntries.toSorted().join("\0")) throw new Error(`OPENCLAW_GIT_DIR appeared while cloning: ${params.dir}. The existing path was left unchanged; move it or choose another OPENCLAW_GIT_DIR, then retry.`);
		const entries = (await fs$1.readdir(stagingDir)).toSorted((a, b) => a === ".git" ? 1 : b === ".git" ? -1 : 0);
		const moved = [];
		let publishError;
		try {
			for (const entry of entries) {
				await fs$1.rename(path.join(stagingDir, entry), path.join(targetDir, entry));
				moved.push(entry);
			}
		} catch (error) {
		...
		if (publishError) {
			...
			for (const entry of moved.toReversed()) try {
				await fs$1.rename(path.join(targetDir, entry), path.join(stagingDir, entry));
			} catch (rollbackError) {
		...
		if (cleanupStaging) await fs$1.rm(stagingDir, {
			recursive: true,
			force: true
		});
	}
...
async function ensureGitCheckout(params) {
	...
	if (!await pathExists$1(params.dir)) return await cloneGitCheckoutTransactionally({
		dir: params.dir,
		env: gitEnv,
		timeoutMs: params.timeoutMs,
		progress: params.progress
	...
	return {
		checkoutDir: await fs$1.realpath(params.dir),
		step: null
	};
}
...
async function tryWriteCompletionCache(root, jsonMode) {
	...
	if (!await pathExists$1(binPath)) return "skipped";
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-6xLGWYEG.js");
...
const MANAGED_UPDATE_SELECTOR_ENV_KEYS = ["OPENCLAW_HOME", ...GATEWAY_SERVICE_SELECTOR_ENV_KEYS];
function applyManagedServiceSelectorEnv(params) {
	...
	for (const key of MANAGED_UPDATE_SELECTOR_ENV_KEYS) if (selectorEnv[key]?.trim()) resolved[key] = params.serviceEnv[key];
...
async function recoverInstalledLaunchAgentAfterUpdate(params) {
	...
	if (!state || state.loadState.status !== "not-loaded") return {
		attempted: false,
		recovered: false
	};
...
async function maybeStopManagedServiceBeforeMutableUpdate(params) {
	...
	const launchAgentMayRespawn = process.platform === "darwin" && serviceLoaded && await service.isEnabled?.({ env: serviceState.env }) === true;
	const handoffSupervisorMayRespawn = process.platform !== "darwin" && process.env.OPENCLAW_UPDATE_RUN_HANDOFF === "1";
	const supervisorMayRespawn = serviceLoaded && (launchAgentMayRespawn || handoffSupervisorMayRespawn);
...
async function maybeRestartService(params) {
	...
	if (params.shouldRestart) {
		...
		try {
			...
			if (params.refreshServiceEnv && params.serviceInstallEnv !== null) try {
...
async function retireStandaloneGitWrapper(params) {
	...
	for (const directory of searchDirs) {
		...
		let stat;
		try {
			stat = await fs$1.lstat(wrapperPath);
		} catch (error) {
		...
		let contents;
		try {
			contents = await fs$1.readFile(wrapperPath, "utf8");
		} catch (error) {
			return { error: `Could not inspect ${wrapperPath}: ${String(error)}` };
		}
...
async function updateGitInstall(params) {
	...
	if (params.switchToGit && updateResult.status === "ok") {
		if (!installTarget) throw new Error("global install target missing after package-to-Git preflight");
...
async function captureOwnedManagedUpdateContext(params) {
	...
	if (stopState?.stopped !== true || stopState.serviceMatchesMutationRoot !== true || !stopState.serviceEnv) return;
...
async function reportPreMutationUpdateFailure(params) {
	...
	if (params.message) defaultRuntime.error(params.message);
...
async function writePostCorePluginInstallRecordsFile(filePath, records) {
	await fs$1.writeFile(filePath, `${serializePluginInstallRecordMap(records)}\n`, "utf-8");
}
...
async function finishUpdate(params) {
	if (params.result.status !== "ok") printResult(params.result, {
		...params.opts,
		hideSteps: params.showProgress
	});
	...
	if (shouldResumePostCoreInFreshProcess) {
		const freshProcessResult = await withOwnedManagedUpdateEnv(params.ownedManagedUpdateEnv, async () => await continuePostCoreUpdateInFreshProcess({
			root: postUpdateRoot,
			channel: params.channel,
			requestedChannel: params.requestedChannel,
			opts: params.opts,
	...
	if (!pluginsUpdatedInFreshProcess) await withOwnedManagedUpdateEnv(params.ownedManagedUpdateEnv, async () => {
		await withPluginLifecycleLease({}, async () => {
			...
			try {
				...
				const completedPluginUpdate = await completePostCorePluginUpdate({
					...
					freshDoctorRequired: didCoreUpdateChangeInstall(params.result) || initialPluginUpdate.changed,
	...
	if (postCorePluginUpdate?.status === "error") {
		...
		printResult(resultWithPostUpdate, {
			...params.opts,
			hideSteps: params.showProgress
		});
		defaultRuntime.exit(1);
	...
	if (params.shouldRestart && serviceMutationAllowed) try {
		...
		const serviceLoaded = serviceState.loadState.status === "loaded";
		skipLegacyServiceRestart = knownForeignService || resultWithPostUpdate.mode === "git" && serviceState.installed && serviceLoaded && params.preManagedServiceStop?.stopped !== true && serviceMatchesUpdateRoot === false;
		if (!knownForeignService && shouldPrepareUpdatedInstallRestart({
			...
			if (refreshGatewayServiceEnv && gatewayServiceInstallEnv === null) {
				...
				const message = "Gateway service metadata refresh was skipped because systemd drop-in environment ownership could not be inspected.";
				if (params.opts.json) defaultRuntime.error(message);
				else defaultRuntime.log(theme.warn(message));
			}
		}
	...
	if (!await restoreWindowsTaskAutoStartOrExit(params.preManagedServiceStop)) return;
	if (!await withOwnedManagedUpdateEnv(params.ownedManagedUpdateEnv, async () => maybeRestartService({
	...
	if (params.installKindChanged && resultWithPostUpdate.mode !== "git") {
		const retirement = await retireStandaloneGitWrapper({ previousRoot: params.previousInstallRoot ?? params.root });
		if (retirement.error) {
...
async function runTimedFinalizePhase(params) {
		...
		const initialPluginUpdate = await withPrePluginUpdateDoctorEnv(async () => {
			...
			const doctorPreparation = await runTimedFinalizePhase({
				...
				run: async () => {
					...
					return {
						restoredConfig,
						postDoctorChannel: requestedChannel ?? postDoctorStoredChannel ?? storedChannel ?? effectiveChannel ?? "stable",
			...
			return await runTimedFinalizePhase({
				...
				phaseTimings,
				phase: "plugins",
				run: async () => await updatePluginsAfterCoreUpdate({
					root,
				...
				outcome: (result) => result.status === "error" ? "failed" : result.status === "warning" ? "warning" : "completed"
			});
		});
		return await runTimedFinalizePhase({
			finalizationStartedAt,
			...
			run: async () => await completePostCorePluginUpdate({
				root,
				pluginUpdate: initialPluginUpdate,
				freshDoctorRequired: initialPluginUpdate.changed,
				yes: opts.yes === true,
...
function readDevUpdateTargetOrExit() {
	const parsed = parseDevUpdateTargetEnv(process.env);
	if (parsed.status === "invalid") {
		defaultRuntime.error(`Invalid internal ${UPDATE_DEV_TARGET_REF_ENV} contract; expected a plain Git ref or a supported tracked-target encoding.`);
		defaultRuntime.exit(1);
		return { ok: false };
	}
...
async function updateCommandInternal(opts, recoveryState) {
	...
	if (requestedChannel === "dev") {
		...
		if (!resolvedDevTarget.ok) return;
	...
	if (handoffRoot && !updateInstallRootsMatch(handoffRoot, discoveredRoot)) {
		defaultRuntime.error(`Managed update handoff root mismatch: expected ${handoffRoot}, running from ${discoveredRoot}.`);
		defaultRuntime.exit(1);
		return;
	}
	if (opts.dryRun !== true) {
	...
	if ((requestedChannel ?? storedChannel ?? (installKind === "git" ? "dev" : resolveEffectiveUpdateChannel({
		currentVersion: VERSION,
		installKind
	}).channel)) === "extended-stable" && installKind === "git") {
		await reportPreMutationUpdateFailure({
			root,
			installKind,
			reason: "unsupported_git_channel",
	...
	const channel = requestedChannel ?? storedChannel ?? (updateInstallKind === "git" ? "dev" : resolveEffectiveUpdateChannel({
		currentVersion: VERSION,
	...
	if (channel === "extended-stable" && explicitTag || unsupportedMainTag) {
		await reportPreMutationUpdateFailure({
			root,
			installKind: updateInstallKind,
			reason: unsupportedMainTag ? "unsupported-package-target" : EXTENDED_STABLE_TAG_UNSUPPORTED_REASON,
			message: unsupportedMainTag ? "`--tag main` cannot update a package install. Run `openclaw update --channel dev` to switch to the supported Git checkout and build flow." : void 0,
			opts,
			controlPlaneUpdateSentinelMeta
		});
		return;
	...
	const finalizationPluginInstallRecords = ownedManagedUpdateContext?.pluginInstallRecords ?? preUpdatePluginInstallRecords;
	stop();
	await finishUpdate({
		result,
		root,
...
function rejectUnsupportedInheritedUpdateDryRun(command) {
	...
	handleUpdateCommandError(/* @__PURE__ */ new Error(`--dry-run is not supported for \`openclaw update ${command.name()}\`. Run \`openclaw update --dry-run\` instead.`));
	return true;
}
