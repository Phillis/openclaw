import { g as readStringValue, o as normalizeLowercaseStringOrEmpty } from "./string-coerce-CIXf7egm.js";
...
import { m as resolveOpenAICodexAuthIdentity } from "./provider-auth-Bfz7g31-.js";
import { t as buildOauthProviderAuthResult } from "./provider-auth-result-wxNttZT1.js";
import "./error-runtime-CmA1H4Zg.js";
import "./string-coerce-runtime-C8jKEm3h.js";
import { d as normalizeProviderId, m as matchesExactOrPrefix, p as cloneFirstTemplateModel } from "./provider-model-shared-CF2CrQqB.js";
import { d as findCatalogTemplate } from "./provider-catalog-shared-__IiTHyX.js";
import { a as isOpenAIApiBaseUrl, n as OPENAI_CODEX_RESPONSES_BASE_URL, o as isOpenAICodexBaseUrl } from "./base-url-BLMI6u6h.js";
import { t as OPENAI_CODEX_DEFAULT_MODEL } from "./default-models-Co1MYJBf.js";
import { n as buildOpenAIResponsesProviderHooks, r as buildOpenAISyntheticCatalogEntry, t as OPENAI_DEFAULT_RUNTIME_CONTEXT_TOKENS } from "./shared-BKZ6BMTB.js";
import { a as OPENAI_GPT_54_MINI_MODEL_ID, c as OPENAI_GPT_54_PRO_MODEL_ID, h as OPENAI_GPT_56_VARIANT_MODEL_IDS, l as OPENAI_GPT_55_MODEL_ID, o as OPENAI_GPT_54_MODEL_ID, t as OPENAI_CHATGPT_MODERN_MODEL_IDS, u as OPENAI_GPT_55_PRO_MODEL_ID } from "./model-route-contract-B2Q_03Gg.js";
import { t as loginOpenAICodexDeviceCode } from "./openai-chatgpt-device-code-B2Rn9t3-.js";
import { t as loginOpenAICodexOAuth } from "./openai-chatgpt-oauth.runtime.js";
import { t as resolveOpenAICodexThinkingProfile } from "./thinking-policy-DifTIwjx.js";
import { n as resolveOpenAIUsageAuth, t as fetchOpenAIUsage } from "./usage-D9JZHQ1d.js";
...
function resolveCodexForwardCompatModel(ctx) {
	...
	} else if (ctx.agentRuntimeId === "codex" && ctx.authProfileId === void 0 && ctx.authProfileMode === void 0 && ctx.providerConfig?.auth === void 0) {
		templateIds = OPENAI_GPT_56_VARIANT_MODEL_IDS;
		patch = {
			reasoning: true,
			input: ["text", "image"],
			thinkingLevelMap: OPENAI_CODEX_GPT_56_THINKING_LEVEL_MAP,
...
async function runOpenAICodexDeviceCode(ctx) {
	...
	try {
		...
		const identity = resolveOpenAICodexAuthIdentity({ access: creds.access });
		return buildOauthProviderAuthResult({
			providerId: PROVIDER_ID,
			defaultModel: OPENAI_CODEX_DEFAULT_MODEL,
			configPatch: buildOpenAICodexAuthConfigPatch(),
...
function buildOpenAIChatGPTAuthMethodRuns() {
	return {
...
//#endregion
export { buildOpenAICodexProviderHooks as n, buildOpenAIChatGPTAuthMethodRuns as t };
