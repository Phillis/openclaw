...
import { u as publishPreparedModelRuntimeSnapshot } from "./prepared-model-runtime-DRxNQEhr.js";
...
import { r as prepareAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-DLsmyMYu.js";
import "./provider-auth-choice-preference-BkJydP0v.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-MLudM8GS.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-DtnUA8iq.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-BBlMQrUH.js");
	...
	const { resolveDeprecatedProviderInstallCatalogEntry } = await import("./provider-install-catalog-DELn_Usw.js");
