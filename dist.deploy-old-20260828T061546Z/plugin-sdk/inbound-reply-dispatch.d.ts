import { $r as ChannelBotLoopProtectionFacts, Kr as ChannelTurnRecordOptions, Tr as recordDroppedChannelTurnHistory, Wr as ChannelTurnDroppedHistoryOptions, ci as DispatchReplyWithBufferedBlockDispatcher, ei as recordChannelBotPairLoopAndCheckSuppression } from "../agent-harness-runtime-CESurA0d.js";
import { r as OpenClawConfig } from "../types.openclaw-CflOMr0r.js";
import { i as ReplyPayload } from "../reply-payload-DrFti5n9.js";
import { m as GetReplyOptions, r as FinalizedMsgContext } from "../templating-D4gA1hJr.js";
import { f as runChannelInboundEvent, i as ChannelInboundEventRunnerParams, l as dispatchChannelInboundReply, o as InboundReplyDispatchResult, p as runPreparedInboundReply, s as PreparedInboundReply, t as AssembledInboundReply } from "../channel-inbound-DJ0K5Bna.js";
import { n as hasVisibleChannelTurnDispatch, r as resolveChannelTurnDispatchCounts, t as hasFinalChannelTurnDispatch } from "../dispatch-result-Bta2mUhC.js";
import { n as DurableInboundReplyDeliveryParams, t as DurableInboundReplyDeliveryOptions } from "../durable-delivery-BM4hRPB5.js";
import { n as deliverInboundReplyWithMessageSendContext } from "../channel-outbound-O9s6cDPK.js";
import { t as recordInboundSession } from "../session-Cx-3fvFH.js";
