import { C as IMessageActionConfig, D as CommonChannelMessagingConfig, E as ChannelReadReceiptConfig, R as ProviderCommandsConfig, S as IMessageAccountConfig, T as IMessageSendTransport, _ as TelegramGroupConfig, b as TelegramThreadBindingsConfig, ct as GroupToolPolicyBySenderConfig, d as TelegramAccountConfig, f as TelegramActionConfig, g as TelegramExecApprovalConfig, h as TelegramDirectConfig, lt as GroupToolPolicyConfig, m as TelegramCustomCommand, p as TelegramCapabilitiesConfig, u as AutoTopicLabelConfig, v as TelegramNetworkConfig, w as IMessageReactionNotificationMode, y as TelegramPreviewStreamingConfig } from "../types.openclaw-DckSqIPo.js";
import { n as ChannelConfigSchema, r as ChannelConfigUiHint } from "../types.config-BuyMFWYD.js";
import "../json-schema.types-C6Gpa9tj.js";
import "../config-contracts-Bx5GiB6F.js";
import { a as GroupPolicySchema, f as requireAllowlistAllowFrom, i as DmPolicySchema, n as ContextVisibilityModeSchema, o as MarkdownConfigSchema, p as requireOpenAllowFrom, r as DmConfigSchema, s as ReplyRuntimeConfigSchemaShape, t as BlockStreamingCoalesceSchema } from "../zod-schema.core-By0CQoSG.js";
