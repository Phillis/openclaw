...
import { Z as captureConfigOverrideApplier, c as readConfigFileSnapshotForRuntimeTransaction, g as registerConfigWriteListener, i as promoteConfigSnapshotToLastKnownGood, n as getRuntimeConfig, s as readConfigFileSnapshot } from "./io-ClLVsBMp.js";
...
import { a as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-AW4B7-Km.js";
import { p as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./legacy-Czf036mL.js";
...
import { S as assertGatewayConfigEnvSelectionUnchanged } from "./io.read-helpers-BfhrMUhR.js";
...
import { o as purgeExpiredSecretStoreEntries } from "./secret-store-DzZIiLba.js";
...
import { c as listCoreGatewayMethodNames, n as createCoreGatewayMethodDescriptors, r as isCoreGatewayMethodClassified, t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./core-descriptors-8FmEpKxY.js";
...
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-DyWvGcd6.js";
import { r as readGatewayRestartHandoffSync } from "./restart-handoff-DdLfWceW.js";
import { m as stopDiagnosticHeartbeat, p as startDiagnosticHeartbeat } from "./diagnostic-DOfHG5L4.js";
...
import { t as createAgentRuntimeApprovalAuthorityValidator } from "./agent-runtime-identity-token-Cal_zwyQ.js";
...
import { i as isControlUiPluginManagerRequest, n as isControlUiApprovalDocumentPath, r as isControlUiFocusDocumentPath } from "./control-ui-routing-rEFU7XXp.js";
import { r as prepareGatewayAgentCliShim, t as clearGatewayAgentCliShim } from "./openclaw-cli-shim-BLljw-ev.js";
import { a as getActiveSecretsRuntimeConfigSnapshot, r as clearSecretsRuntimeSnapshotState } from "./runtime-state-B9BywrOx.js";
import { t as isCoreCanvasHostEnabled } from "./config-CnZg2c4w.js";
import { n as fenceSessionSuspensionWritesForGatewayShutdown } from "./session-suspension-BzTfUhzc.js";
...
import { c as removeRemoteNodeInfoForConnection, i as recordRemoteNodeInfo, s as removeRemoteNodeInfo } from "./remote-BHibO2zu.js";
import { f as requestNodePairing, p as reusePendingNodePairingForReconnect, r as finalizeNodePairingCleanupClaim } from "./device-pairing-node-yaKle7Kn.js";
...
import { n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig } from "./startup-auth-BbAYnqAD.js";
...
import { a as sendGatewayAuthFailure, f as setDefaultSecurityHeaders, n as finishFailedGatewayHttpResponse, v as respondNotFound, y as respondPlainText } from "./http-common-Dy8Dj7pv.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-Wt672rYh.js";
import { l as canReceiveSessionEvent } from "./session-sharing-DSLYm21V.js";
...
import { n as installActiveGitHubOAuthLifecycle, t as createGitHubOAuthLifecycle } from "./github-oauth-lifecycle-DRqkUgSv.js";
...
import { n as resolveGatewayReloadPluginActivationCandidate, r as resolveGatewayStartupPluginActivationConfig, t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-DPqAt6wD.js";
...
import { t as createPresenceRecipientProjection } from "./presence-projection-BJNZiXkx.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-BzKAU1CD.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-CGEtHeTJ.js";
import { t as createControlUiSessionPullRequestSubscriptions } from "./control-ui-session-pr-subscriptions-CH2XOtHU.js";
...
import { n as handleNodeWorkerBundleTransferHttpRequest } from "./node-worker-bundle-transfer-http-BAVH8U0H.js";
import { n as handleNodeWorkspaceTransferHttpRequest } from "./node-workspace-transfer-http-ClIZZ24I.js";
...
import { t as GATEWAY_EVENTS } from "./server-methods-list-CMePMmg_.js";
...
async function startGatewayCoreRuntime(input) {
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayChannelHealthMonitor }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-P371V3w_.js"), import("./server-runtime-startup-services-CKOSJ7oA.js")]));
	...
	const { createOperatorApprovalSessionEventRuntime } = await import("./operator-approval-session-events-DWrqF48V.js");
	...
	const { execApprovalManager, questionManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, bindApprovalPublicationContext, unregisterApprovalAuthorityObserver, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-CX21oLwU.js"), import("./server-methods-kR1VCOEi.js")]);
		return {
	...
	const reloadAttachedGatewayPlugins = async (params) => {
		const [{ loadPluginLookUpTable }, { listAmbientOnlyConfiguredChannelIds }, { prepareGatewayPluginLoad }, { startPluginServices, PLUGIN_SERVICE_REPLACEMENT_STOP_TIMEOUT_MS }, { listChannelPluginConfigTargetIds, pluginConfigTargetsChanged }] = await Promise.all([
			import("./plugin-lookup-table-BhtQTuZ3.js"),
			import("./channel-presence-policy-WvLeaH1e.js"),
			loadGatewayPluginBootstrapModule(),
			import("./services-DFf-Tb-9.js"),
...
async function createGatewayChatMetadataLifecycle(params) {
	...
	const { ChatMetadataSnapshotUnavailableError, createGatewayChatMetadataRuntime } = await import("./chat-metadata-runtime-DEL-vSCD.js");
	...
	const registerRefreshListeners = async () => {
		...
		const [{ registerRuntimeAuthProfileStoreMutationListener }, { registerPreparedModelRuntimePublicationListener }, { registerSkillsChangeListener }] = await Promise.all([
			import("./runtime-snapshots-C_8vl1Ez.js"),
			import("./prepared-model-runtime-CoQq9Qra.js"),
			import("./refresh-CF3qJDRw.js")
		]);
...
async function prepareGatewayKernelRequestRuntime(params) {
	...
	const configRevisionProjector = await startupTrace.measure("gateway.config-revision-key", async () => {
		const { loadGatewayConfigRevisionProjector } = await import("./config-revision-token-hkvp4Jeu.js");
	...
	const gatewayRequestContext = await startupTrace.measure("gateway.request-context", async () => {
		const { createGatewayRequestContext } = await import("./server-request-context-2-E2QX98.js");
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-BWRO7E7k.js");
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-BwY9c4ll.js").then(({ buildGatewayCronService }) => {
		loaded = {
...
async function prepareGatewayLifecycle(params) {
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-3obolrFg.js");
	...
	const nodeDesktopService = nodeDesktopObserveAvailable && desktopSessionRegistry && nodeDesktopStreamBroker ? (await import("./node-source-ByPlikal.js")).createNodeDesktopService({
		getConfig: getRuntimeConfig,
		nodeRegistry,
	...
	const { createWatchNodeHttpRuntime } = await import("./watch-node-http-Bk6mq5cg.js");
...
async function prepareGatewayKernelState(params) {
	...
	const workerPlacementRuntime = workerEnvironmentService && workerEnvironmentStartup && nodeWorkerGatewayNamespace && workerPlacementModule ? await startupTrace.measure("worker-environments.placement-runtime", async () => workerPlacementModule.createGatewayWorkerPlacementRuntime({
		...
		persistAbandonedPartial: async ({ sessionId, sessionKey, agentId, runId }) => {
			...
			if (!text.trim()) return;
			const { persistAbortedPartials } = await import("./chat-abort-runtime-Bl6jquKh.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-DtDA929l.js");
	...
	if (bootstrap.generatedStartupAuthToken && isLoopbackHost(bindHost)) {
		const { ensureStartupLocalCliPairing } = await import("./startup-local-cli-pairing-CZzY8kp7.js");
	...
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-B918GDcR.js");
	...
	const { createChannelManager } = await import("./server-channels-BIw8Tis9.js");
...
async function prepareGatewayServerBootstrap(input) {
	...
	const startupConfigModulePromise = import("./server-startup-config-DcJVBMO9.js");
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-C8SC4SKS.js"), { cacheRejections: true });
	...
	try {
		const { cleanupRetiredManagedGitHubProfiles } = await import("./github-tool-profile-cleanup-CxZ1aGVx.js");
...
const loadGatewayModelCatalogModule = createLazyRuntimeModule(() => import("./server-model-catalog-BVoNsljB.js"));
const loadWorkerEnvironmentStartupModule = createLazyRuntimeModule(() => import("./server-worker-environment-startup-C7CBeeWm.js"));
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-B2NdFsXz.js"));
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-DfR4oou1.js"));
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-C0SLJemX.js"));
...
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-DPcfvWQt.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
const getHttpAuthUtilsModule$2 = createLazyRuntimeModule(() => import("./http-auth-utils-CMi3G3Ul.js"));
...
const getPluginNodeCapabilityAuthModule$1 = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-BIqpicyx.js"));
const getHttpAuthUtilsModule$1 = createLazyRuntimeModule(() => import("./http-auth-utils-CMi3G3Ul.js"));
const getPluginRouteRuntimeScopesModule$1 = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-Cbmb35dY.js"));
...
const getControlUiModule = createLazyRuntimeModule(() => import("./control-ui-_f072-_u.js"));
const getCanvasServeModule = createLazyRuntimeModule(() => import("./serve.runtime.js"));
const getBoardHttpModule = createLazyRuntimeModule(() => import("./board-http-DzpP16P2.js"));
const getEmbeddingsHttpModule = createLazyRuntimeModule(() => import("./embeddings-http-UPM8qWUd.js"));
const getManagedMediaAttachmentsModule = createLazyRuntimeModule(() => import("./managed-image-attachments-B5jSEOLR.js"));
const getMcpAppStandaloneModule = createLazyRuntimeModule(() => import("./mcp-app-standalone-BxgiLAU2.js"));
const getPluginIconHttpModule = createLazyRuntimeModule(() => import("./plugin-icon-http-CC7UUKZg.js"));
const getWorkspaceIconHttpModule = createLazyRuntimeModule(() => import("./workspace-icon-http-Di4yDnQf.js"));
const getChannelAvatarHttpModule = createLazyRuntimeModule(() => import("./channel-avatar-http-B41SYWdd.js"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-B5iLRAAa.js"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-BHj_XPOD.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-Cq4JJZaA.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-CziRLxLR.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-C9xENqZx.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-TY_MqQm4.js"));
const getUserProfilesHttpModule = createLazyRuntimeModule(() => import("./user-profiles-http-BSXpJ2TZ.js"));
const getDevicePairingJoinHttpModule = createLazyRuntimeModule(() => import("./device-pairing-join-http-e8-Y_5Oo.js"));
const getPluginNodeCapabilityAuthModule = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-BIqpicyx.js"));
const getHttpAuthUtilsModule = createLazyRuntimeModule(() => import("./http-auth-utils-CMi3G3Ul.js"));
const getPluginRouteRuntimeScopesModule = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-Cbmb35dY.js"));
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-BM6UVeBR.js");
...
async function createGatewayHttpTransport(params) {
	...
	const getHookDispatcher = async () => {
		const { createGatewayHookDispatcher } = await import("./hooks-C5wTin_j.js");
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-C5wTin_j.js");
	...
	const handleMcpOAuthCallbackRequest = async (req, res) => {
		const { handleMcpOAuthCallback } = await import("./mcp-oauth-callback-B_791mYy.js");
...
async function finishGatewayStartup(params) {
	...
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-BQxiB2nj.js"), import("./route-capability-BXcSN5qB.js")]));
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-DIJe4CGr.js"), { cacheRejections: true });
	...
	if (!minimalTestGateway) {
		const { startOpenClawDatabaseIntegrityVerifier } = await import("./openclaw-database-verify-CHSpvQJY.js");
		kernel.addGatewayLifetimeSidecar(startOpenClawDatabaseIntegrityVerifier({ env: process.env }));
	}
	postAttachRuntimeReturned = true;
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-BBSYiEro.js");
	...
	if (!minimalTestGateway) {
		...
		postReadyState.retainedPluginCleanupHandle = gatewayRuntimeServices.scheduleGatewayIdleTask({
			...
			run: async () => {
				const { cleanupRetainedPluginInstallGenerations } = await import("./server-retained-plugin-cleanup-D17tWAwL.js");
...
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-BCIBY8qj.js"));
