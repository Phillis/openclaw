...
import { t as formatTargetDisplay } from "./target-resolver-BS53JIwR.js";
...
function formatMessageCliText(result, opts) {
	...
	if (result.kind === "broadcast") {
		...
		return [(successful ? ok : fail)(`${successful ? "✅ Broadcast complete" : "❌ Broadcast failed"} (${okCount}/${total} succeeded, ${total - okCount} failed)`), renderTable({
