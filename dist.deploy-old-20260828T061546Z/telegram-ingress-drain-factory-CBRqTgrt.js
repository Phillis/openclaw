...
import { p as clampPositiveTimerTimeoutMs, s as asFiniteNumber, w as parseStrictPositiveInteger } from "./number-coercion-CLj0HTDM.js";
import { r as root } from "./fs-safe-CmrQUApq.js";
import { n as computeBackoff, s as sleepWithAbort } from "./src-BQ327IOM.js";
import { a as formatUncaughtError, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-Ccx0R-_Z.js";
...
import { a as createMessageReceiveContext } from "./channel-outbound-DO-F9-0m.js";
...
import { l as toPluginMessageContext, n as deriveInboundMessageHookContext, u as toPluginMessageReceivedEvent } from "./message-hook-mappers-BwRPfaNj.js";
import { T as formatLocationText } from "./reply-payload-i0RzN2iF.js";
import { t as resolveChannelGroupPolicy } from "./group-policy-1fHWm2yO.js";
import { i as saveRemoteMedia, t as MediaFetchError } from "./fetch-LdRI1MZX.js";
import { c as readAmbientTranscriptWatermark, r as getSessionEntry, y as resolveAmbientTranscriptWatermarkKey } from "./session-store-runtime-ZfR7yV2q.js";
import { o as resolveAgentRoute } from "./resolve-route-CaHBZG2x.js";
import { n as firstDefined } from "./allow-from-D4kg2zcb.js";
import { f as resolveChannelConfigWrites } from "./channel-config-helpers-C7An4wuC.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-Bjjk-DS_.js";
...
import { o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig } from "./commands-registry-jNlmfKbj.js";
import { r as matchesMentionWithExplicit, t as buildMentionRegexes } from "./mentions-BHWGvP4S.js";
import { t as createPluginCommandRuntime } from "./plugin-command-runtime-DaGKqCFO.js";
import "./error-runtime-CmA1H4Zg.js";
import "./runtime-env-_YEv0JPQ.js";
import { _ as isTelegramRateLimitError, f as isTelegramEditTargetMissingError, i as shouldRetryTelegramTransportFallback, m as isTelegramMessageNotModifiedError, o as isRecoverableTelegramNetworkError, p as isTelegramMessageHasNoTextError, r as resolveTelegramTransport, s as isRetryableTelegramApiError, t as resolveTelegramApiBase, v as isTelegramServerError, w as normalizeTelegramApiRoot, y as readTelegramRetryAfterMs } from "./fetch-CSNgL9pY.js";
...
import { d as formatMediaPlaceholderText } from "./run-channel-turn-CVly42eY.js";
import { n as implicitMentionKindWhen, r as resolveInboundMentionDecision } from "./mention-gating-Cqy7URJJ.js";
import { h as parseExecApprovalCommandText } from "./exec-approval-reply-Dax3JT_s.js";
...
import "./approval-reply-runtime-C-zKsNQV.js";
...
import { m as shouldDebounceTextInbound } from "./channel-inbound-BmDzyYQ4.js";
import { n as createChannelIngressMonitor } from "./ingress-monitor-5WsYdIbW.js";
import { c as runClaimableDedupeClaimLoop, t as createChannelReplayGuard } from "./persistent-dedupe-PhcpFwkv.js";
import { t as reportChannelRoomJoin } from "./channel-join-intro-runtime-DoWdZC1q.js";
import "./dedupe-runtime-NvRwPw5s.js";
import "./file-access-runtime-DRZWsOJC.js";
import { t as applySessionModelSelection } from "./apply-session-model-selection-BSN8SMAu.js";
...
import "./hook-runtime-CG5a-f4z.js";
import { n as formatModelsAvailableHeader } from "./commands-models-h5b_qhwI.js";
import "./command-auth-native-BCy5TIiL.js";
import "./command-primitives-runtime-BCLR7jds.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-B0tNkqr7.js";
import "./command-status-B9ZJ2q30.js";
import "./command-detection-CTDS0O5m.js";
import "./channel-inbound-debounce-D2EO5vxH.js";
import { m as resolveScopeRequireMention, u as buildChannelGroupsScopeTree } from "./channel-policy-RPOWSkLP.js";
...
import { a as normalizeDmAllowFromWithStore, i as normalizeAllowFrom, n as resolveTelegramDmAllow, o as resolveTelegramEffectiveDmPolicy, r as isSenderAllowed, t as expandTelegramAllowFromWithAccessGroups } from "./access-groups-DY7-iLJz.js";
import { t as mergeTelegramAccountConfig } from "./account-config-Bw5EPvnW.js";
import { o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-3yDZGxKI.js";
import { t as buildTelegramConversationId } from "./topic-conversation-Cl4csGES.js";
import { n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-CSr4C8-g.js";
import { t as normalizeTelegramStateAccountId } from "./state-account-id-CdS1ON70.js";
import { A as hasBotMention, C as resolveTelegramThreadSpec, D as buildSenderName, I as resolveTelegramPrimaryMedia, O as extractTelegramLocation, P as joinTelegramTextParts, T as withResolvedTelegramForumFlag, _ as resolveTelegramForumThreadId, a as buildTelegramInboundOriginTarget, b as resolveTelegramMessageThreadSpec, c as buildTelegramThreadParams, f as getCachedTelegramForumFlag, g as resolveTelegramForumFlag, h as resolveTelegramCommandAuthorization, i as buildTelegramGroupPeerId, k as getTelegramTextParts, m as resolveTelegramBotHasTopicsEnabled, p as isTelegramCommandsAllowFromConfigured, r as buildTelegramGroupFrom, t as TelegramPairingStoreReadError, v as resolveTelegramGroupAllowFromContext, w as shouldUseTelegramDmThreadSession, y as resolveTelegramMessageForumFlagHint } from "./helpers-BwCSYwU_.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-BNdZLcFm.js";
import { a as resolveTelegramTargetSession, i as resolveTelegramConversationRoute } from "./conversation-route-B-tTpTPs.js";
import { B as resolveTelegramScopedGroupConfig, R as resolveTelegramGroupIngestEnabled, T as resolveCompleteTelegramPromptContextProjectionIds, k as buildInlineKeyboard } from "./text-chunk-limit-a65wnktU.js";
import { t as resolveTelegramAccountOwnerAgentId } from "./account-owner-CfbMzFBO.js";
import { a as parseTelegramOpaqueCallbackData, c as hasTelegramApprovalCallbackPrefix, i as parseTelegramNativeCommandCallbackData, l as parseTelegramApprovalCallbackData, r as hasTelegramOpaqueCallbackPrefix, s as fitsTelegramCallbackData } from "./native-command-callback-data-BhDUR-iz.js";
import { a as parseTelegramQuestionCallbackData, i as hasTelegramQuestionCallbackPrefix } from "./button-types-B8o1Tn_2.js";
import { _ as resolveModelSelection, d as buildModelsKeyboard, g as resolveModelListCallback, h as parseModelCallbackData, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-CjVXBZWL.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-BRHFowmK.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-DGw43h4R.js";
import { a as getCachedSticker, n as cacheSticker } from "./sticker-cache-C-fNxZTv.js";
import { p as resolveTelegramMessageCacheScope } from "./sent-message-cache.legacy-state-C4DKtnhZ.js";
import { $ as recordTelegramGroupHistoryEntry, H as buildTelegramConversationContext, J as buildTelegramSelfSenderName, K as isTelegramMessageFromCurrentBot, U as buildTelegramReplyChain, V as registerTelegramOutboundGroupHistoryRecorder, W as createTelegramMessageCache, X as isTelegramHistoryEntryAfterAmbientWatermark, Z as isTelegramSelfSenderName, a as prepareTelegramPollAnswerContext, at as createTelegramClientFetch, c as findTelegramPollRegistryEntry, ct as resolveTelegramOutboundClientTimeoutFloorSeconds, dt as apiThrottler, ft as sequentialize, ht as resolveTelegramEffectiveGroupPolicy, i as isEligibleTelegramPollAnswerUpdate, it as asTelegramClientFetch, l as retireTelegramPollRegistryEntry, lt as getOrCreateAccountThrottler, mt as evaluateTelegramGroupPolicyAccess, o as recordPreparedTelegramPollAnswer, ot as resolveTelegramClientTimeoutMinimumSeconds, pt as evaluateTelegramGroupBaseAccess, q as resolveProviderObservedTelegramThreadSpec, r as getPreparedTelegramPollAnswer, s as settleTelegramPollAnswerContext, st as resolveTelegramClientTimeoutSeconds, ut as Bot$1 } from "./send-B3vmt1UE.js";
import { t as withTelegramApiErrorLogging } from "./api-logging-WkYTHJ80.js";
import { n as buildTelegramInvalidApprovalTerminalText, r as buildTelegramLegacyApprovalTerminalText, t as buildTelegramCanonicalApprovalTerminalText } from "./approval-terminal-2daVIplV.js";
import { n as buildPluginTelegramMenuCommands, r as syncTelegramMenuCommands, t as buildCappedTelegramMenuCommands } from "./bot-native-command-menu-DqM04cME.js";
import { t as defaultTelegramBotDeps } from "./bot-deps-B7uOlDjP.js";
import { C as createTelegramIngressResolver, D as telegramAllowEntries, E as resolveTelegramEventIngressAuthorization, O as isTelegramForumServiceMessage, S as resolveTelegramPromptMediaPath, T as resolveTelegramCommandIngressAuthorization, _ as runWithTelegramUpdateProcessingFrame, a as resolveTelegramUpdateId$1, b as isTelegramDmAccessAllowed, c as TelegramSpooledReplayProcessingError, d as ensureTelegramMessageProcessingResult, f as getTelegramSpooledReplayDeferredParticipant, g as runWithTelegramSpooledReplayUpdate, h as recordTelegramMessageProcessingResult, l as createTelegramSpooledReplayDeferredParticipant, m as isTelegramSpooledReplayUpdate, n as resolveTelegramMessageTurnSettings, o as telegramQueueEventId, p as getTelegramSpooledReplayLifecycle, r as openTelegramIngressQueue, s as resolveTelegramDmHistoryLimit, t as createTelegramMessageProcessor, u as createTelegramSpooledReplayParticipant, v as TELEGRAM_CHAT_ACTION_INTERVAL_MS, w as createTelegramIngressSubject, x as resolveTelegramInboundMediaUri, y as enforceTelegramDmAccess } from "./bot-message-DBttathu.js";
...
function buildTelegramLocationMessageHook(params) {
	...
	const canonical = deriveInboundMessageHookContext({
		From: isGroup ? buildTelegramGroupFrom(msg.chat.id, threadSpec) : `telegram:${msg.chat.id}`,
		To: originatingTo,
...
const loadTelegramBuiltinCommandExecutor = createLazyRuntimeModule(() => import("./bot-native-command-builtins-4dn-0oV-.js"));
const loadTelegramPluginCommandExecutor = createLazyRuntimeModule(() => import("./bot-native-command-plugins-CBkTZE_a.js"));
