...
import { s as resolveOnboardingSetupTarget } from "./onboard-agent-target-CwN0HHjK.js";
...
import { a as requestTelemetryConsent, c as writeWizardConfigFile, i as readValidSetupConfigFile, n as hasQuickstartGatewayOverrides, o as requireRiskAcknowledgement, r as readSetupConfigFileSnapshot, s as resolveQuickstartGatewayDefaults, t as formatQuickstartGatewaySummary } from "./setup.shared-C1C_TtR8.js";
import { n as showSessionMigrationWarnings, t as promptFirstOnboardingAgent } from "./onboard-first-agent-DCf2Or51.js";
import { a as runSetupModelAuthStep, i as offerLiveModelVerification, n as listSetupMigrationOptions, r as runSetupMigrationImport, t as detectSetupMigrationSources } from "./setup.migration-import-C04Zm6q-.js";
import { n as SetupMigrationTargetChangedError, t as SetupMigrationFreshnessError } from "./setup.migration-snapshot-De038w5n.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-CCWtc3i8.js";
import { t as resolveSetupWorkspaceSelection } from "./setup.workspace-up9gMVJj.js";
import { isDeepStrictEqual } from "node:util";
//#region src/wizard/setup.ts
const loadConfigLoggingModule = createLazyRuntimeModule(() => import("./logging-B0JIUhGW.js"));
...
async function runSetupWizardOnce(initialOpts, runtimeInput, prompter) {
	...
	const onboardHelpers = await import("./onboard-helpers-Cwjb9WEP.js");
	...
	const remoteOnboard = seededRemoteUrl ? await import("./onboard-remote-C0GfDnUj.js") : null;
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = remoteOnboard ?? await import("./onboard-remote-C0GfDnUj.js");
	...
	if (opts.authChoice === void 0) {
		const { inferAuthChoiceFromFlags } = await import("./auth-choice-inference-9dHKkMXk.js");
	...
	if (opts.skipChannels) await prompter.note(t("wizard.setup.skipChannels"), t("wizard.setup.channelsTitle"));
		...
		const { listChannelPlugins } = await import("./plugins-BK6XAmXj.js");
		const { createChannelSetupTransaction, setupChannels } = await import("./onboard-channels-DAroMXd6.js");
	...
	if (!usedImportFlow) {
		const { runSetupMemoryImportStep } = await import("./setup.memory-import-D_t-FBGb.js");
	...
	if (opts.skipSearch) await prompter.note(t("wizard.setup.skipSearch"), t("wizard.setup.searchTitle"));
		...
		const { runSearchSetupFlow } = await import("./search-setup-CRmju6UE.js");
	...
	if (opts.skipSkills) await prompter.note(t("wizard.setup.skipSkills"), t("wizard.setup.skillsTitle"));
		...
		const { setupSkills } = await import("./onboard-skills-BIOSbsPG.js");
	...
	if (flow !== "quickstart") {
		const { setupOfficialPluginInstalls } = await import("./setup.official-plugins-JVY98G8u.js");
		...
		const { setupAppRecommendations } = await import("./setup.app-recommendations-DOcGxI61.js");
		...
		const { setupPluginConfig } = await import("./setup.plugin-config-DjDP83Sa.js");
	...
	const { finalizeSetupWizard } = await import("./setup.finalize-CPkleJKH.js");
