...
import { l as movePathToTrash, r as root } from "./fs-safe-CmrQUApq.js";
...
import { a as listAgentIds, f as resolveAgentWorkspaceDir, l as resolveAgentDir, w as tryResolveSoleAgentId } from "./agent-scope-config-CUBiGmG3.js";
import { a as unregisterResolvedAgentDir, i as resolveRegisteredAgentIdForDir, n as normalizeAgentDirRegistryPath, r as registerResolvedAgentDir, t as isPathOwnedByAnotherRegisteredAgent } from "./agent-dir-registry-CEecLw_T.js";
...
import { xt as resolveSqliteDatabaseFilePaths } from "./openclaw-state-db-kmBThqu6.js";
...
import { o as withConfigMutationExclusive } from "./mutate-BjBakg7Z.js";
import "./config-B_0xOnKq.js";
import { t as ErrorCodes } from "./gateway-error-details-C2IaYyht.js";
import { a as validateAgentsDeleteParams, c as validateAgentsFilesSetParams, i as validateAgentsCreateParams, l as validateAgentsListParams, o as validateAgentsFilesGetParams, s as validateAgentsFilesListParams, u as validateAgentsUpdateParams } from "./src-4dv5TpeQ.js";
import { s as readAgentDeletionJournal } from "./agent-deletion-journal-C1nSMR13.js";
import { i as closeOpenClawAgentDatabaseByPath, x as assertNoOpenClawAgentDatabaseLeases } from "./openclaw-agent-db-BEQsKM0c.js";
import { B as resolveOpenClawAgentSqlitePath, F as listOpenClawRegisteredAgentDatabases, N as unregisterOpenClawAgentDatabase } from "./openclaw-agent-db-maintenance-_0tYy-zT.js";
import "./sessions-BI8dPUCI.js";
import { t as purgeAgentSessionStoreEntries } from "./cleanup-service-LQM2406D.js";
...
import { _ as isWorkspaceSetupCompleted, h as isExpectedAbsentBootstrapFile, l as WORKSPACE_BOOTSTRAP_FILENAMES, n as DEFAULT_BOOTSTRAP_FILENAME, p as ensureAgentWorkspace, r as DEFAULT_IDENTITY_FILENAME } from "./workspace-DJ__UUS2.js";
import { n as resolveAgentIdentity } from "./identity-Cc11oAxY.js";
import "./exec-approvals-PtbcLeQo.js";
import { a as claimCompletedAgentDeletion, n as AgentDeletionCommitUncertainError, r as beginAgentDeletion, t as AgentDeletionAuthorityRollbackError } from "./agent-lifecycle-registry-DPEbAZj2.js";
import { h as withAgentExecApprovalsRemoved } from "./exec-approvals-generated-migration-KEjNHNyB.js";
import { n as listAgentsForGateway } from "./session-utils-store-Dmx2MxPy.js";
import "./session-utils-uVsFjoXC.js";
import "./browser-maintenance-Cc_NRFbV.js";
import { a as mergeIdentityMarkdownContent, o as normalizeIdentityForFile, s as sanitizeAgentIdentityLine, t as createAgentIdentityConfig } from "./identity-file-B-yOqb54.js";
import { t as applyAgentConfig } from "./agents.config-BCOHbC0P.js";
...
import { i as isSharedAuthStoreOwner, n as formatSharedAuthStoreOwnerDeleteError, r as isInheritedAuthStoreOwner, t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-Cz9lIXnV.js";
import { i as updateAgentConfigEntry, n as deleteAgentConfigEntry, r as isConfiguredAgent, t as AgentConfigPreconditionError } from "./agents-config-mutations-DQAar6Ca.js";
...
const agentsHandlers = {
	"agents.list": async ({ params, respond, context, client }) => {
		...
		respond(true, listAgentsForGateway(cfg, void 0, {
			modelCatalogByAgentId: new Map(await Promise.all(listAgentIds(cfg).map(async (agentId) => [agentId, await readPreparedServerMethodModelCatalog(context, { agentId })]))),
