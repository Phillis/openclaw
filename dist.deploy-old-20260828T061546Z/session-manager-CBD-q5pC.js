...
import { f as loadSessionEntry, n as ensureSessionEntrySync, y as replaceSessionEntrySync } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
import { h as projectCanonicalSessionEntryShape } from "./store-entry-BN3xGmHe.js";
import { x as isSessionTranscriptSideAppendEntry } from "./session-transcript-index-_z9fjL8c.js";
import { c as readSessionTranscriptBoundedActiveContextCore, ct as replaceTranscriptEventsSync, dt as withTranscriptWriteTransaction, it as appendTranscriptEventSync, ot as appendTranscriptMessageSync, pt as readActiveTranscriptEntryAnchor } from "./session-accessor-fcDZuc2H.js";
import { S as loadTranscriptEventsSync } from "./session-accessor.sqlite-transcript-store-CZRFPUnE.js";
import { t as applyAssistantDeliveryDirectives } from "./transcript-assistant-delivery-ElcBJoCH.js";
import { P as buildSessionContext } from "./agent-core-DirSpnc5.js";
import { f as partitionSessionFileEntries, i as isSessionContextMetadataEntry, l as parseOpaqueLeafEntry, m as generateSessionEntryId, p as createManagedSessionId, r as isIndexedSessionEntry, s as migrateToCurrentVersion, u as parseParentLinkedOpaqueEntry } from "./session-manager-codec-CANcDH2n.js";
