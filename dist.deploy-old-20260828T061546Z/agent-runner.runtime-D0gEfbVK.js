...
import { u as resolveOpenAIRuntimeProvider } from "./openai-routing-Chr0R2hQ.js";
...
import { l as resolveCronJobsStorePath, n as loadCronJobsStore } from "./store-jPtUD1Vb.js";
...
import { b as ensureMessageToolRunOutcomeSchema } from "./openclaw-agent-db-maintenance-_0tYy-zT.js";
import { t as normalizeChatType } from "./chat-type-CG0X_HJM.js";
import "./backoff-BkMI1WEL.js";
import { f as loadSessionEntry, m as patchSessionEntryCore, p as loadSessionEntryReadOnly } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
...
import { lt as resolveProfileParticipantIdFromSessionCreation } from "./session-accessor.sqlite-entry-store-BIW-GrsF.js";
...
import { c as resolveSqliteScope, m as toDatabaseOptions } from "./session-accessor.sqlite-scope-C7NrJaPh.js";
import { c as resolveSessionPluginTraceLines, s as resolveSessionPluginStatusLines } from "./types-gVK8DqPC.js";
import { R as persistSessionResetLifecycle, at as appendTranscriptMessage, ht as getCliSessionBinding, mt as clearAllCliSessions, nt as updateSessionEntry } from "./session-accessor-fcDZuc2H.js";
...
import { D as formatTokenCount, w as resolveSessionGoalDisplayState } from "./sessions-BI8dPUCI.js";
import { i as resetRegisteredAgentHarnessSessions } from "./registry-CWcxV14-.js";
...
import { s as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-Rrd1VaX1.js";
...
import { s as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-a88lvIDJ.js";
...
import { s as logSessionTurnCreated } from "./diagnostic-DOfHG5L4.js";
...
import { n as normalizeReplyPayload } from "./normalize-reply-CamUYMRd.js";
import { m as recordReplyUsageState, p as buildReplyUsageState } from "./deliver-prepare-DXM4XCVk.js";
import { i as resolveModelCostConfig, n as formatUsd, t as estimateUsageCost } from "./usage-format-CVbhwZGU.js";
...
import { a as resolveReplyThreadingPayloads, i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-oaWL3G5l.js";
import { n as createReplyToModeFilterForChannel, o as resolveReplyToMode, t as createReplyDeliveryContext } from "./reply-threading-Dbzi6VQA.js";
import { p as isCompactionFailureError } from "./embedded-agent-helpers-NAvzsIRm.js";
import { g as readPostCompactionContext } from "./builtin-openclaw-BruFLvIP.js";
import { n as filterMessagingToolReplyPayload } from "./reply-payloads-dedupe-B2fUkkNw.js";
import { f as createAudioAsVoiceBuffer, m as createBlockReplyPipeline, p as createBlockReplyContentKey, u as requiresDurableToolResultDelivery } from "./dispatch-from-config.payloads-CSG-wPxm.js";
...
import { d as isMessagingToolSendAction } from "./tool-loop-detection-K29Fi2y0.js";
...
import { h as leaseMcpAppModelContextForTurn, s as peekSessionMcpRuntime } from "./agent-bundle-mcp-manager-api-1m62vMRl.js";
import "./agent-bundle-mcp-runtime-DlEFrKcw.js";
import { i as getMcpAppViewLease } from "./mcp-ui-resource-DAkuvpb4.js";
...
import { t as readLatestSessionUsageFromTranscriptAsync } from "./session-transcript-readers-fCOIrclF.js";
...
import { c as refreshQueuedFollowupSession, d as admitFollowupRunLifecycle, f as completeFollowupRunLifecycle, g as resolveFollowupAbortSignal, p as isFollowupRunAborted, u as FollowupRunDeferredError } from "./settings-CxUlx8Vr.js";
...
import { r as LiveSessionModelSwitchError } from "./model-fallback-runner-CuaeomrP.js";
import { c as shouldClearFailedCliSessionBinding, o as setCliSessionBinding, s as setCliSessionId, t as clearCliSession } from "./cli-session-CCYUcdz9.js";
import { i as normalizePendingFinalRecoveryPayloads, n as buildRecoverablePendingFinalDeliveryText, o as sanitizePendingFinalDeliveryText, r as normalizePendingFinalDeliveryPayloads } from "./pending-final-delivery-DJ7b2f3m.js";
import { o as transitionMainSessionRecovery } from "./main-session-recovery-state-DagFkxEX.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-aIpe57kt.js";
import { c as scheduleFollowupDrain } from "./cleanup-CiIpHyQA.js";
import { i as parkSteerCandidate, n as enqueueFollowupRun, t as resolveQueueSettings } from "./queue-C5hWHBtI.js";
import { i as createAgentPatchedSessionModelFallback } from "./session-model-patch-origin-klHCI3pg.js";
...
import { t as buildAgentRuntimeDeliveryPlan } from "./build-BcjM0mSI.js";
import { t as runEmbeddedAgent } from "./embedded-agent-uA4hl59E.js";
import { a as withBeforeAgentReplyObserver } from "./payloads-Br8_73MA.js";
import { n as consolidateLiveModelSwitchAfterRun } from "./live-model-switch-CXpbA050.js";
...
import { t as ensureSessionDiffBaseline } from "./session-diff-baseline-DFspzpqh.js";
import { n as resolveEffectiveBlockStreamingConfig } from "./block-streaming-DYYu1ngr.js";
...
import { i as resolveActiveRunQueueAction, n as createTypingSignaler, t as resolveCurrentTurnImages } from "./current-turn-images-BSUG6s1n.js";
import { i as refreshActiveGoalContext } from "./inbound-meta-CdaYvuyM.js";
import { t as settleProgressVisibilityCallbackResult } from "./progress-visibility-DVUJibF4.js";
import { a as isReplyOperationSuperseded, c as resolveRestartLifecycleError, i as isReplyOperationRestartAbort, o as isReplyOperationUserAbort, r as buildRestartLifecycleReplyText, s as resolveReplyOperationTerminationFields, t as recordReplyOperationAgentTurn } from "./reply-operation-agent-turn-state-DFYwzQZS.js";
import { t as runEmbeddedAgentEntry } from "./run-entry-CRCkAsFu.js";
...
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-TVUNem0g.js";
import { t as formatSystemTurnPrompt } from "./system-turn-prompt-CqPm0DzY.js";
import { n as resolveFollowupRunToolAuthorityFingerprint, t as createFollowupRunToolAuthorityProjector } from "./reply-tool-authority-BSgwnSZC.js";
...
import { a as resolveQueuedReplyExecutionConfig, c as resolveModelFallbackOptions, i as isBunFetchSocketError, l as resolveFallbackCandidateRun, n as buildThreadingToolContext, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveRunFastModeForFallbackCandidate, t as buildEmbeddedRunExecutionParams, u as resolveRunAuthProfile } from "./agent-runner-utils-D7AVTG6U.js";
import { n as runSessionCompactionIfNeeded, t as runMemoryFlushIfNeeded } from "./agent-runner-memory-C93Br823.js";
import { n as incrementCompactionCount } from "./session-updates-VgqA-Oq9.js";
import { i as prepareGitHubPublicationAvailability } from "./github-publication-availability-CuCM4gdY.js";
...
import { t as createMcpAppStandaloneTicket } from "./mcp-app-standalone-CiluxWjT.js";
