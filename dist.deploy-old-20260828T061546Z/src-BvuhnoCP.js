...
import { f as readProviderJsonArrayFieldResponse, m as readProviderJsonResponse } from "./provider-http-errors-BXG5plR9.js";
...
import { S as resolveChannelStreamingPreviewToolProgress, T as resolveChannelStreamingSuppressDefaultToolProgressMessages, c as isChannelProgressDraftWorkToolName, d as normalizeAgentPlanSteps, f as normalizeChannelProgressDraftLineIdentity, g as resolveChannelProgressDraftMaxLines, n as buildChannelProgressDraftLineForEntry, o as formatChannelProgressDraftText, p as resolveChannelPreviewStreamMode, r as createChannelProgressDraftGate, t as buildChannelProgressDraftLine, u as mergeChannelProgressDraftLine, v as resolveChannelStreamingBlockEnabled } from "./streaming-B93dETXe.js";
import { t as parseMediaContentLength } from "./content-length-CHOuQ9D3.js";
import { a as saveResponseMedia } from "./fetch-LdRI1MZX.js";
...
import { c as resolveInboundSupplementalSenderAllowed, d as formatMediaPlaceholderText, m as toInboundMediaFactsWithMetadata, u as formatInboundMediaUnavailableText } from "./run-channel-turn-CVly42eY.js";
...
import { c as recordChannelFeedbackEvent, l as runChannelFeedbackReflection } from "./channel-inbound-BmDzyYQ4.js";
...
import { t as createPersistentDedupeCache } from "./dedupe-runtime-NvRwPw5s.js";
...
import { i as channelStoppedPatch, n as channelBlockedPatch, r as channelReadyPatch } from "./gateway-runtime-BOxS77yr.js";
import { t as createPluginStateErrorReporter } from "./plugin-state-runtime-BlMBP7Yx.js";
...
import { i as channelIngressRoutes, n as fanInChannelIngressLifecycles, s as resolveStableChannelMessageIngress } from "./channel-ingress-runtime-BxqYlzv5.js";
...
import { $ as resolveRequestUrl, A as resolveMSTeamsPrivateQaRuntime, B as applyAuthorizationHeaderForUrl, D as loadMSTeamsSdkWithAuth, E as createMSTeamsTokenProvider, F as resolveMSTeamsSdkCloudOptions, G as isDownloadableAttachment, H as extractHtmlFromAttachment, J as isUrlAllowed, K as isLikelyImageAttachment, L as ATTACHMENT_TAG_RE, P as tryNormalizeBotFrameworkServiceUrl, Q as resolveMediaSsrfPolicy, R as GRAPH_ROOT, S as resolveMSTeamsCredentials, T as createMSTeamsExpressAdapter, U as extractInlineImageCandidates, V as encodeGraphShareId, W as isAdvertisedFileAttachment, X as resolveAttachmentFetchPolicy, Y as normalizeContentType, Z as resolveMSTeamsMediaKind, a as stripMSTeamsMentionTags, at as resolveMSTeamsRequestTimeoutMs, ct as withMSTeamsRequestDeadline, et as safeFetchWithPolicy, i as parseMSTeamsActivityTimestamp, it as createMSTeamsInboundDeadline, k as ensureUserAgentHeader, n as extractMSTeamsQuoteInfo, nt as tryBuildGraphSharesUrlForSharedLink, o as wasMSTeamsBotMentioned, q as isRedirectStatus, r as normalizeMSTeamsConversationId, rt as MSTEAMS_REQUEST_TIMEOUT_MS, t as extractMSTeamsConversationMessageId, tt as safeHostForUrl, z as IMG_SRC_RE } from "./inbound-Clg3k_wg.js";
import { c as projectStableMSTeamsGroupAllowlist, f as resolveMSTeamsTeamsConfig, l as projectStableMSTeamsTeamsConfig, p as resolveMSTeamsUserAllowlist, t as looksLikeMSTeamsConversationId, u as projectStableMSTeamsUserAllowlist } from "./resolve-allowlist-Cd7Hfq6b.js";
import { i as resolveMSTeamsRouteConfig, r as resolveMSTeamsReplyPolicy, t as resolveMSTeamsAllowlistMatch } from "./policy-BiuWEgYg.js";
import { r as msTeamsApprovalAuth, t as resolveMSTeamsRouteSessionKey } from "./thread-session-CIfzUSzJ.js";
import { i as formatUnknownError, n as formatMSTeamsDeliveryFailureGuidance, r as formatMSTeamsSendErrorHint, t as classifyMSTeamsSendError } from "./errors-wR6Jg-1j.js";
import { l as createMSTeamsPollStoreState, u as extractMSTeamsPollVote, v as createMSTeamsConversationStoreState } from "./polls-DmtubpOT.js";
import { i as createMSTeamsSsoTokenStoreFs } from "./sso-token-store-9hXwksNo.js";
import { a as claimMSTeamsApprovalCardBinding, c as readMSTeamsApprovalActionToken, o as completeMSTeamsApprovalCardBinding, s as getMSTeamsApprovalCardBinding, t as buildMSTeamsCanonicalApprovalTerminalCard, u as releaseMSTeamsApprovalCardBinding } from "./approval-card-WUXB9KN5.js";
import { C as buildFileInfoCard, T as uploadToConsentUrl, _ as getPendingUpload, a as sendMSTeamsActivityWithReference, b as getPendingUploadFs, i as deleteMSTeamsActivityWithReference, l as extractMessageId, n as renderReplyPayloadsToMessages, o as updateMSTeamsActivityWithReference, r as sendMSTeamsMessages, s as withRevokedProxyFallback, t as buildConversationReference, v as removePendingUpload, w as parseFileConsentInvoke, x as removePendingUploadFs } from "./messenger-DLk4moPc.js";
import { a as fetchThreadReplies, i as fetchChatMessageText, n as resolveMSTeamsReactionEmoji, o as formatThreadContext, r as fetchChannelMessage, s as stripHtmlFromTeamsMessage } from "./reaction-types-CfnVoy6r.js";
...
function isMSTeamsApprovalSubmit(value) {
	...
	const data = (isRecord(value.action) ? value.action : void 0)?.data;
...
async function maybeHandleMSTeamsApprovalCardSubmit(params) {
	...
	if (normalizeMSTeamsConversationId(context.activity.conversation?.id ?? "") !== normalizeMSTeamsConversationId(binding.conversationId)) {
	...
	if (!(msTeamsApprovalAuth.authorizeActorAction?.({
		cfg: deps.cfg,
		accountId: "default",
		senderId,
		action: "approve",
	...
	if (claim.kind !== "claimed") {
		ignored(claim.kind === "in-flight" ? "card token resolve already in flight" : "card token already consumed");
		return true;
	}
...
function createMSTeamsReplayContext(activity, app, serviceUrlBoundary) {
	...
	const threadActivityId = normalizedConversationType === "channel" ? extractMSTeamsConversationMessageId(rawConversationId) ?? activity.replyToId : void 0;
	...
	return {
		...
		updateActivity: async (outbound) => {
			return await updateMSTeamsActivityWithReference(app, reference, typeof outbound.id === "string" ? outbound.id : "", outbound, proactiveOptions);
		},
