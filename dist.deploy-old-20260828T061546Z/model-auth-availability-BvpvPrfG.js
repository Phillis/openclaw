...
import { r as modelMatchesProviderModelRoute } from "./provider-model-route-n5WsvCIn.js";
import { d as selectProviderModelAuthSources, f as buildProviderModelAuthDirectSource, h as toProviderModelAuthReadiness, l as resolveProviderModelRouteAuthRequirement, m as fromProviderModelAuthReadiness, o as selectOpenAIModelRouteAuth, p as buildProviderModelAuthSourcePlan, r as resolveConfiguredOpenAIAuthMode, t as createOpenAIModelRoutesResolver } from "./openai-model-routes-rndVcpg7.js";
import { r as hasUsableOAuthCredential } from "./credential-state-DJrnG0Ay.js";
import { c as resolveProfileUnusableUntil, i as isAuthCooldownBypassedForProvider, o as isProfileInCooldown } from "./usage-state-C0QBjJnZ.js";
import { a as resolveAuthProfileOrderWithMetadata, r as resolveAuthProfileEligibility, t as isConfiguredAwsSdkAuthProfileForProvider } from "./order-BxFkXXxj.js";
import { h as getRuntimeExternalCliProfileIds } from "./persisted-Bjx2XcL3.js";
import { g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, s as isKnownEnvApiKeyMarker, u as isSecretRefHeaderValueMarker } from "./model-auth-markers-Dy2BML3M.js";
import { i as resolveExternalCliAuthProfiles, n as listExternalCliSyncProviderIds } from "./external-cli-sync-CJBPPHII.js";
import { s as getRuntimeAuthProfileStoreSnapshotCore } from "./runtime-snapshots-a_60jBeK.js";
import { r as resolveProviderEnvAuthEvidence } from "./model-auth-env-C2cLUS85.js";
import { n as resolveSecretRefReadOnlyAvailability, r as resolveStoredCredentialReadOnlyAvailability, t as hasMalformedSecretInputSyntax } from "./read-only-availability-BjchohHW.js";
import { a as hasSyntheticLocalProviderAuthConfig, b as resolveProviderEntryApiKeyProfileReference, o as hasUsableCustomProviderApiKey, w as shouldPreferExplicitConfigApiKeyAuth } from "./model-auth-provider-config-6V9HXTpM.js";
import { n as resolveManagedSecretRefRuntimeProviderAuth } from "./model-auth-runtime-config-BIltN2rn.js";
...
function createModelAuthAvailabilityResolver(params) {
	...
	const unprofiledEvaluation = (provider, target) => {
		...
		if (preparedRuntimeAuthMode) return {
	...
	const evaluateModelAuth = (rawProvider, ref = {}) => {
		...
		const explicitProfileOrder = profileOrder(provider, ref.modelId, ref.preferredProfileId, ref.lockedProfileId).hasExplicitOrder;
		const materializedModelId = ref.modelId ? normalizeModelIdForProvider(provider, ref.modelId)?.toLowerCase() : void 0;
		const materialized = !modelLock && !bindingProfileId && !basePolicy.required && !explicitProfileOrder && materializedModelId ? params.preparedRuntimeAuthMaterializations?.find((fact) => normalizeProvider(fact.provider) === provider && fact.modelId === materializedModelId && routeResolution.routes.some((route) => {
