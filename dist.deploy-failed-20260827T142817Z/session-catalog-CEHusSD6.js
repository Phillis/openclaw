...
import { v as getPluginRegistryRuntime } from "./loader-CwiP0Igf.js";
...
import { _r as validateSessionsCatalogContinueParams, br as validateSessionsCatalogStartTerminalParams, gr as validateSessionsCatalogArchiveParams, vr as validateSessionsCatalogListParams, yr as validateSessionsCatalogReadParams } from "./src-Bo4ezI_n.js";
import { s as errorShape } from "./error-codes-CMSvT5-d.js";
import { p as recordSessionStateEvent } from "./session-state-events-BTZJfLLh.js";
import { a as upsertSessionUpstreamLink } from "./session-upstream-links-DH4UZcUV.js";
import { _ as createConversationBindingRecord, a as buildPluginBindingIdentity, b as unbindConversationBindingRecord, t as bindConversationNow, v as resolveConversationBindingRecord } from "./conversation-binding-Yyqz26An.js";
import { n as projectSessionActor } from "./session-utils-row-CriEgq90.js";
import { n as tryResolveSessionCompatibilityOwnerAgentId } from "./session-request-agent-BeVvXvOY.js";
import { u as hasMultipleSessionSharingIdentities } from "./user-profiles-eJiEIUE1.js";
...
function catalogStartHandler(resolveProvider, resolveCreateTarget) {
	return async (opts) => {
		...
		const { openTerminalSession, CATALOG_TERMINAL_INITIAL_SIZE } = await import("./terminal-DvKVGrOu.js");
