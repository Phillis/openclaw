...
import { a as markPluginRegistryActive, i as isPluginRegistryRetired, o as markPluginRegistryRetired } from "./registry-lifecycle-DOGws0E2.js";
...
import { a as listLoadedChannelPluginsForRegistry } from "./registry-loaded-BwPPBT4p.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-p6qq05_H.js")]);
...
//#endregion
export { getPreparedMessageToolCatalog as A, withPluginHostCleanupTimeout as B, resetPluginRuntimeStateForTest as C, stageActivePluginRegistry as D, setActivePluginRegistry as E, getPluginRunContext as F, withPluginCommandExecution as H, getPluginSessionSchedulerJobGeneration as I, makePluginSessionSchedulerJobKey as L, cleanupPluginSessionSchedulerJobs as M, clearPluginRunContext as N, withPluginRegistrationContext as O, deletePluginSessionSchedulerJob as P, registerPluginSessionSchedulerJob as R, requireActivePluginRegistry as S, restoreActivePluginRegistrySnapshot as T, getPluginCommandExecutionCount as V, getPluginRegistrationContext as _, getActivePluginChannelRegistry as a, requireActivePluginChannelRegistry as b, getActivePluginGatewayNodePolicyRegistry as c, getActivePluginRegistry as d, getActivePluginRegistryKey as f, getActivePluginSessionExtensionRegistry as g, getActivePluginRuntimeSubagentMode as h, commitStagedPluginRegistry as i, getPreparedMessageToolCatalogForRegistry as j, createEmptyPluginRegistry as k, getActivePluginHttpRouteRegistry as l, getActivePluginRegistryWorkspaceDir as m, captureActivePluginRegistrySnapshot as n, getActivePluginChannelRegistryVersion as o, getActivePluginRegistryVersion as p, clearActivePluginRegistry as r, getActivePluginGatewayCommandRegistry as s, assertDirectPluginRegistrationReplacement as t, getActivePluginHttpRouteRegistryVersion as u, listImportedRuntimePluginIds as v, resolveDirectPluginRegistrationOwner as w, requireActivePluginHttpRouteRegistry as x, recordImportedPluginId as y, setPluginRunContext as z };
