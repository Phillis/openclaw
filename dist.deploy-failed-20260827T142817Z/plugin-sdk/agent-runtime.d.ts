...
import { q as TtsProvider } from "../types.channels-D0WNvlsX.js";
...
import { C as ChannelOutboundTargetMode } from "../types.core-D43joVXt.js";
import { v as SourceReplyDeliveryMode } from "../types-Byd4mWhx.js";
import { C as AuthProfileCredential, E as OAuthCredential, T as AuthProfileStore, w as AuthProfileFailureReason } from "../types-BFl3Ao02.js";
import { b as UserTurnTranscriptRecorder, ct as InputProvenance, ft as PromptImageOrderEntry, ut as PluginHookChannelContext, v as UserTurnInput } from "../templating-CW47wETJ.js";
...
import { Zt as CliDeps, an as AdmittedRunContext, cn as admitted_run_context_d_exports, ln as RuntimePluginToolGrant, on as OperationalRunInstanceRef, un as AgentInternalEvent } from "../types-4_wTt5Pv.js";
...
import { n as findModelInCatalog, t as modelSupportsVision } from "../model-catalog-CGi0o8D0.js";
import { n as ModelCatalogSnapshot, t as ModelCatalogEntry } from "../model-catalog.types-DC-D_GgG.js";
import { i as setAgentEffectiveModelPrimary, r as resolveSessionAgentIds, t as resolveAgentEffectiveModelPrimary } from "../agent-scope-J2vKEzc7.js";
import { a as resolveAgentWorkspaceDir, i as resolveAgentDir, n as resolveAgentConfig, o as resolveDefaultAgentDir, s as resolveDefaultAgentId, t as listAgentIds } from "../agent-scope-config-m1tHy6iC.js";
import { c as resolveAckReaction, d as resolveHumanDelayConfig, f as resolveIdentityNamePrefix, l as resolveAgentIdentity } from "../ack-reactions-BljtcCxq.js";
import { c as projectOutboundPayloadPlanForJson } from "../deliver-Cx1p7Uub.js";
import { a as findNormalizedProviderValue, c as resolveThinkingDefaultWithRuntimeCatalog, i as resolveModelRefFromString, l as resolveDefaultModelForAgent, n as buildConfiguredModelCatalog, o as parseModelRef, r as buildModelAliasIndex, s as resolveThinkingDefault, t as resolveAllowedModelRef } from "../model-selection-06SPBmYn.js";
import { t as CODEX_APP_SERVER_AUTH_MARKER } from "../model-auth-markers-B5Jn1-v2.js";
import { i as SerializedDurableMessagePayloadOutcome } from "../send-B1pE60Nc.js";
