import { O as OutboundMediaAccess } from "../types.core-lr-SMiuA.js";
import { F as WebMediaResult } from "../types-lxuSJRGv.js";
import { i as PluginStateKeyedStore } from "../plugin-state-store.types-DK1KZWMb.js";
...
type HostedOutboundMediaStore = {
  prepareUrl: (params: {
    ...
    proxyUrl?: string;
    requestInit?: RequestInit; /** Validate the exact loaded bytes before capability creation or persistence. */
...
type CreateHostedOutboundMediaStoreOptions = {
  ...
  maxEntries?: number;
  maxChunkRows?: number; /** Aggregate live payload budget. Omit only when the backing owner enforces an equivalent cap. */
  maxTotalBytes?: number;
  chunkRowsPerEntryBudget?: number; /** Physical retention after logical URL expiry, used to finish already-admitted readers. */
