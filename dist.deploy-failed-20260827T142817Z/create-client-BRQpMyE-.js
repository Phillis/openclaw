...
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-BPjSL9Lm.js";
...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-D1QoBvA0.js";
import { d as writeStorageMeta, l as resolveMatrixStoragePaths, r as maybeMigrateLegacyStorage, s as repairCurrentTokenStorageMetaDeviceId } from "./storage-CViq_NW2.js";
import fs from "node:fs";
//#region extensions/matrix/src/matrix/client/config.ts
const loadMatrixAuthClientDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-C0wfsqp9.js"), import("./logging-k86NOCON.js")]).then(([sdkModule, loggingModule]) => ({
...
const loadMatrixCredentialsReadDeps = createLazyRuntimeModule(() => import("./credentials-read-B015evqM.js"));
...
const loadMatrixCreateClientRuntimeDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-C0wfsqp9.js"), import("./logging-k86NOCON.js")]).then(([sdkModule, loggingModule]) => ({
	MatrixClient: sdkModule.MatrixClient,
	ensureMatrixSdkLoggingConfigured: loggingModule.ensureMatrixSdkLoggingConfigured
})));
