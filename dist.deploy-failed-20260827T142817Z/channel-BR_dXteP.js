...
import { g as scopeKey, h as resolveScopeToolsPolicy, m as resolveScopeRequireMention } from "./channel-policy-CPq0cbRz.js";
...
import { c as resolveDiscordAccountAllowFrom, i as listEnabledDiscordAccounts, o as resolveDefaultDiscordAccountId, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-CafjbqFC.js";
import { t as getDiscordRuntime } from "./runtime-Dg4d9hPu.js";
import { t as parseDiscordTarget } from "./target-parsing-D0nvF4Pn.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-fLlrnMmq.js";
import "./channel-api-CWlbI7Qw.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-CuNnHNbt.js";
...
import { t as shouldHandleDiscordApprovalRequest } from "./approval-shared-DNB6Ke7l.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-BD-tqfDe.js";
import { t as discordMessageActions$1 } from "./channel-actions-BiyFocRM.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-tubic41F.js";
...
import { n as discordOutbound } from "./outbound-adapter-RZ--C2y2.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupContract, t as createDiscordPluginBase } from "./shared-D1Yp7rNO.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-CMENlhF-.js")).discordApprovalNativeRuntime
		})
	});
}
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CI8uK7Q2.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-COO0E7sa.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-BInFRIxM.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-gQubbDTu.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-CNiKxe52.js"));
const loadDiscordProviderRuntime = createLazyRuntimeModule(() => import("./provider.runtime.js"));
const loadDiscordProbeRuntime = createLazyRuntimeModule(() => import("./probe.runtime-CEy6Sc3f.js"));
...
const loadDiscordAuditModule = createLazyRuntimeModule(() => import("./audit-Fvb2iaVA.js"));
const loadDiscordSendModule = createLazyRuntimeModule(() => import("./send-DnV-svrO.js"));
const loadDiscordDirectoryLiveModule = createLazyRuntimeModule(() => import("./directory-live-B4OT8b-1.js"));
//#endregion
