...
import { n as applyPluginTextReplacements, r as mergePluginTextTransforms, t as resolveRuntimeTextTransforms } from "./text-transforms.runtime-B6WHs5nn.js";
import { a as unwrapSecretSentinelsForProviderEgress } from "./provider-secret-egress-Cl2Qy4wH.js";
import { d as resolveOwningPluginIdsForProviderRef, f as resolveProviderRefOwnership, p as resolveUsageHookProviderPluginContracts, r as resolveCatalogHookProviderPluginIds, s as resolveExternalAuthProfileProviderPluginIds, u as resolveOwningPluginIdsForProvider } from "./providers-63828CFG.js";
import { t as resolvePluginDiscoveryProvidersRuntime } from "./provider-discovery.runtime.js";
import { d as resolveProviderPluginsForHooks, f as resolveProviderRuntimePlugin, n as clearProviderRuntimePluginCacheForTest, o as resolveLoadedProviderRuntimePlugin, r as ensureProviderRuntimePluginHandle, u as resolveProviderHookPlugin } from "./provider-hook-runtime-Dr_msAqW.js";
...
async function resolveProviderUsageSnapshotWithPlugin(params) {
	...
	if (!harness) {
		...
		const { loadAgentRuntimePluginRegistryHandle } = await import("./runtime-plugins-DOkxXBjf.js");
		const { ensureSelectedAgentHarnessPlugin } = await import("./runtime-plugin-NYOb7ngt.js");
