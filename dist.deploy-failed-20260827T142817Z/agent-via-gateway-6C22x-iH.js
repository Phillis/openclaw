...
import { _ as randomIdempotencyKey, h as isGatewayTransportError, m as isGatewayExplicitAuthRequiredError, p as isGatewayCredentialsRequiredError, s as callGateway, v as readGatewayDispatchConfig, y as readGatewayDispatchConfigWithShellEnvFallback } from "./call-Ds1WOCDj.js";
...
async function startOneShotDiagnosticsExporters(params) {
	...
	const [{ loadOpenClawPlugins }, { startPluginServices }] = await Promise.all([import("./plugins/loader.js"), import("./services-CIfAXzEk.js")]);
...
const embeddedAgentCommandLoader = createLazyPromiseLoader(() => import("./agent-C-lAQy9s.js").then((module) => module.agentCommand), { cacheRejections: true });
const localAuditModuleLoader = createLazyPromiseLoader(() => import("./agent-local-audit-DWvE7BHn.js"), { cacheRejections: true });
const agentSessionModuleCache = createLazyPromiseLoader(() => agentSessionModuleLoader(), { cacheRejections: true });
const runtimeConfigModuleLoader = createLazyPromiseLoader(() => import("./io-cWSCQOJ1.js"), { cacheRejections: true });
