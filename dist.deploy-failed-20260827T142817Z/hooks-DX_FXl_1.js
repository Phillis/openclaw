...
import { p as resolveConfigPathCandidate } from "./paths-CqeDjSA4.js";
...
import { f as requestBodyErrorToText, s as readJsonBodyWithLimit } from "./http-body-D5I0NwSl.js";
...
function resolveEffectiveHookTargetAgentId(hooksConfig, agentId) {
	const resolvedAgentId = resolveHookTargetAgentId(hooksConfig, agentId) ?? hooksConfig.agentPolicy.defaultAgentId;
	const persistedOwner = hooksConfig.agentPolicy.globalSessionStoreOwner;
	if (persistedOwner.kind === "retired") return;
	if (persistedOwner.kind === "configured" && resolvedAgentId && resolvedAgentId !== persistedOwner.agentId) return;
...
function isHookAgentAllowed(hooksConfig, agentId) {
	...
	return effectiveAgentId !== void 0 && allowed.has(effectiveAgentId);
}
...
//#endregion
export { resolveHookIdempotencyKey as _, getHookChannelError as a, resolveHooksConfig as b, isSessionKeyAllowedByPrefix as c, normalizeHookHeaders as d, normalizeWakePayload as f, resolveHookDeliver as g, resolveHookChannel as h, getHookAgentSelectionError as i, normalizeAgentPayload as l, resolveEffectiveHookTargetAgentId as m, extractHookToken as n, getHookSessionKeyPrefixError as o, readJsonBody as p, getHookAgentPolicyError as r, isHookAgentAllowed as s, commitHooksConfigReload as t, normalizeHookDispatchSessionKey as u, resolveHookSessionKey as v, applyHookMappings as x, resolveHookTargetAgentId as y };
