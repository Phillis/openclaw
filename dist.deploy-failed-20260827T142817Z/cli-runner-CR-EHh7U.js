...
import { a as markAuthProfileFailure } from "./usage-CztrY32v.js";
...
import { a as resolveCliRuntimeOwnerFingerprint, i as resolveCliRuntimeArtifactFingerprint } from "./cli-auth-epoch-Cz3XqALv.js";
...
import { n as appendExactAssistantMessageToSessionTranscript } from "./transcript-CzAixYBD.js";
...
import { d as waitForDeferredTurnMaintenanceForSession, i as bootstrapHarnessContextEngine, l as runHarnessContextEngineMaintenance, n as runAgentEndSideEffects, s as finalizeHarnessContextEngineTurn, t as awaitAgentEndSideEffects } from "./agent-end-side-effects-D3nNsUM5.js";
...
import { a as runAgentHarnessLlmInputHook, o as runAgentHarnessLlmOutputHook, s as buildAgentHookContext } from "./lifecycle-hook-helpers-CJUVnzhF.js";
...
import { u as hashCliReseedPrompt } from "./cli-session-history.claude-fGiM6Zh3.js";
import { n as acceptsClaudeLive } from "./claude-live-session-policy-D5q03_Jx.js";
import { i as createCliFailoverError, n as getCliMessagingDeliveryEvidence, t as attachCliMessagingDeliveryEvidence } from "./delivery-evidence-DxT-O0wM.js";
import { c as CliAuthProfilePreparationError, i as loadCliSessionHistoryMessages, r as loadCliSessionContextEngineMessages, s as buildAgentHookConversationMessages, u as claudeCliSessionTranscriptHasContent } from "./session-history-CdZtXXvB.js";
...
async function settlePreparedCliRun(params) {
	...
	if (runParams.cleanupBundleMcpOnRunEnd === true) try {
		const { retireSessionMcpRuntime } = await import("./agent-bundle-mcp-tools-Bwaxjt5q.js");
