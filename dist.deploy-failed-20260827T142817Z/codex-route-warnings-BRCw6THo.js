...
import { t as AGENT_MODEL_CONFIG_KEYS } from "./configured-model-refs-0XUAFjEF.js";
import { n as collectBlockedLegacyOpenAICodexProviderPlan } from "./legacy-config-migrations.runtime.models-DeWblCIZ.js";
import { m as resolveModelExtraParamSources, p as isAgentRuntimeModelParam } from "./openai-routing-BGuHAkXI.js";
import { t as resolveModelRuntimePolicy } from "./model-runtime-policy-rNKXMHlB.js";
import { S as toOpenAIModelId, _ as readModelConfigPrimaryRef, a as isBlockedLegacyCodexModelRef, b as resolveRuntimeModelRef, c as isOpenAICodexModelRef, d as modelRefUsesCodexRuntime, f as normalizeDefaultProviderModelRef, g as readLegacyDefaultsRuntime, h as readAgentPrimaryModelRef, i as isBlockedLegacyCodexModelPair, l as isProviderlessModelRef, m as parseCodexRouteModelRef, n as asAgentRuntimePolicyConfig, o as isLegacyCodexProviderId, p as normalizeRuntimeString, r as canonicalOpenAIModelUsesCodexRuntime, s as isOpenAICodexAuthProfileRef, t as agentUsesCodexRuntimeForCompaction, v as resolveImplicitDefaultAgentModelRef, x as toCanonicalOpenAIModelRef, y as resolveRuntime } from "./codex-route-model-ref-Bw2nFxxx.js";
import { t as listMutableCodexRouteAgentEntries } from "./codex-route-agent-entries-Czj7-L1O.js";
import { _ as areOAuthCredentialsEquivalent, a as loadPersistedAuthProfileStore, c as parseLegacyCredentialEntry, o as loadPersistedSharedAuthProfileStore, v as hasMatchingOAuthIdentity } from "./persisted-BaBq9UBI.js";
import { Ot as applySessionEntryReplacements, qt as listSessionEntriesReadOnly } from "./session-accessor-CVnxp3UM.js";
import { o as resolveAllAgentSessionStoreTargetsSync } from "./targets-BzJLDErS.js";
import { n as listSqliteSessionEntriesForCanonicalRepair } from "./session-accessor.sqlite-canonical-repair--Uu8TNYz.js";
...
import { n as resolveLegacyAuthProfilesPath } from "./doctor-auth-legacy-paths-X-cjKZhe.js";
...
async function maybeRepairCodexSessionRoutes(params) {
	...
	const targets = resolveAllAgentSessionStoreTargetsSync(params.cfg, { env }).flatMap((target) => {
		...
		const sqliteEntries = params.shouldRepair ? listSessionEntriesReadOnly(sessionScope) : listSqliteSessionEntriesForCanonicalRepair(sessionScope);
...
//#endregion
export { collectDisabledCodexPluginRouteIssues as a, maybeRepairCodexSessionRoutes as i, collectCodexRuntimeCompatibilityWarnings as n, maybeRepairCodexRoutes as r, collectCodexRouteWarnings as t };
