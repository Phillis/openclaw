import { D as ResolvedTtsPersona, a as TalkProviderConfig, n as OpenClawConfig, o as OperatorScope } from "./types.openclaw-VfFCsbZD.js";
import { O as SecretRef, i as ModelMediaInputConfig, n as ModelCompatConfig, t as ModelApi } from "./types.models-i3fcfEfL.js";
import { c as PluginHookToolContext, f as PluginToolMatcher, h as PluginJsonValue, n as PluginHookBeforeToolCallEvent, t as PluginSubagentRequesterContext, x as PluginHookBeforeToolCallResult } from "./subagent-requester-context-BTUaxNjP.js";
import { b as SessionsCompanionAskResult, d as SessionCreatedActor, f as SessionCreatedVia, t as ChannelId, v as CronScheduledToolPolicy, x as SessionsCompanionStateResult, y as SessionObserverDigest } from "./channel-id.types-Baik2yF6.js";
import { F as ChannelAccountSnapshot, Jt as InputProvenance, Rt as MediaUnderstandingProvider, X as ChannelThreadingToolContext, _t as ExecApprovalDecision, ot as PluginApprovalRequest, st as PluginApprovalRequestPayload, tn as AgentPlanStep, yt as ExecApprovalRequestPayload$1 } from "./types.adapters-BCj_O1Hf.js";
import { O as RuntimeEnv, T as ModelCatalogStatus } from "./manifest-registry-dA0dB5pr.js";
import { r as AuthProfileStore } from "./types-BNlO1Crw.js";
import { a as CronRunStatus, c as CronRuntimeAuthority, i as CronPayload, n as CronJobCreate, o as CronStoredJob, r as CronJobPatch, s as CronToolsAllowProvenance, t as CronJob } from "./types-CodlKHkU.js";
import { r as WizardPrompter } from "./setup-wizard-types-C8q0VIYa.js";
import { i as VideoGenerationProvider, s as MediaNormalizationEntry } from "./types-bp3YMYHb.js";
