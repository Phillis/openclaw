...
import { a as getActiveSecretsRuntimeConfigSnapshot, o as getActiveSecretsRuntimeEnvState } from "./runtime-state-CGaTBGZ5.js";
import { s as getPairedDevice } from "./device-pairing-CFVs8foo.js";
import { i as createDeviceWorkerRuntime, n as bindDeviceWorkerAvailability, r as bindDeviceWorkerReconciliation, t as DEVICE_WORKER_PROVIDER_ID } from "./device-provider-qXBtzPgH.js";
...
const loadWorkerInferenceRuntimeModule = createLazyRuntimeModule(() => import("./inference-runtime-C2Ikviwq.js"));
async function loadGatewayWorkerEnvironmentStartupState() {
	const [{ createWorkerEnvironmentStore }, { createWorkerSessionPlacementStore }] = await Promise.all([import("./store-rfdPvUJO.js"), import("./placement-store-CUFqnzTh.js")]);
...
async function createGatewayWorkerEnvironmentRuntime(params) {
	...
	const [{ createWorkerEnvironmentService }, { createWorkerLiveEventReceiver }, { createWorkerSessionPlacementGate }, { createWorkerTranscriptCommitter }, { createWorkerTunnelManager }, { createNodeWorkerTunnelManager }, { createNodeWorkspaceTransferService }, { createNodeWorkspaceTransferHttpCallback }, { createWorkerSessionToolExecutor }, { resolveWorkerProvider }] = await Promise.all([
		import("./service-CxEzhU3i.js"),
		import("./live-events-CmPN-6Su.js"),
		import("./placement-worker-gate-DsHLmvor.js"),
		import("./transcript-commit-DLpTD955.js"),
		import("./tunnel-DA22lo12.js"),
		import("./node-worker-tunnel-AQG-57Ka.js"),
		import("./node-workspace-transfer-service-CIjpwkGE.js"),
		import("./node-workspace-transfer-http-BGCD9MxW.js"),
		import("./worker-session-tool-executor-B2Vppk52.js"),
