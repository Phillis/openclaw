...
import { Ct as assertOpenClawStateDatabaseOwner, Tt as resolveDatabasePath, xt as registerOpenClawStateDatabaseLifecycleListener } from "./openclaw-state-db-CXrhNigN.js";
...
function initializeCachedClawInstallSchemaVersions(options = {}) {
	...
	if (snapshotsByPath.has(path)) return;
	try {
