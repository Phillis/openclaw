...
import { m as shortenHomePath, t as CONFIG_DIR } from "./utils-DEqefz4f.js";
...
import { S as isSkillsMachineOutput } from "./argv-CgA2urTO.js";
import { r as stripAnsi, t as sanitizeForLog } from "./ansi-DjDeieuH.js";
import { l as resolveAgentIdByWorkspacePath } from "./agent-scope-BizOtGGz.js";
...
import { n as isImmutableGitCommitRef, r as parseGitPluginSpec } from "./git-install-BA_Sui8g.js";
...
import { s as withInstallWorkspace } from "./install-source-utils-DqwMuR5d.js";
...
import { c as searchSkillsFromClawHub, g as installExtractedSkillRoot, h as untrackClawHubSkill, l as readVerifiedClawHubSkillSourceUrl, m as readTrackedClawHubSkillSlugs, o as resolveClawHubSkillVerificationTarget, r as updateSkillsFromClawHub, t as installSkillFromClawHub, y as validateRequestedSkillSlug } from "./clawhub-BbF6b2MA.js";
import { i as CLAWHUB_SKILLS_SH_TRUST_LABEL, l as fetchClawHubSkillVerification, o as fetchClawHubSkillCard, t as CLAWHUB_TRUST_ERROR_CODE } from "./clawhub-install-trust-CfEKfDHW.js";
import { n as resolveSkillStatusEntry } from "./status-BFrBUUAi.js";
import { i as readSkillProposalDraftFile, r as readSkillProposalDraftDirectory } from "./proposal-draft-B5pE2cuJ.js";
import { a as proposeUpdateSkill, c as reviseSkillProposal, f as inspectSkillProposal, i as proposeCreateSkill, n as applySkillProposal, o as quarantineSkillProposal, p as listSkillProposals, s as rejectSkillProposal } from "./service-D01ZPgBg.js";
...
async function loadSkillsStatusReport(options) {
	...
	const { buildWorkspaceSkillStatus } = await import("./status-C7xyCu2i.js");
...
async function runSkillProposalApply(resolved, proposalId) {
	const { callGateway, isGatewayCredentialsRequiredError, isGatewayTransportError } = await import("./call-n89JPEIA.js");
	try {
		await callGateway({
			config: resolved.config,
			method: "health",
		...
		const { acquireGatewayLock } = await import("./gateway-lock-Dnv0pbd7.js");
		let lock;
		try {
