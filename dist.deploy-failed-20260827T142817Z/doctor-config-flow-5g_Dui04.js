...
import { J as resolveNormalizedProviderModelMaxTokens, ct as containsAuthoredInclude, lt as isSingleTopLevelIncludeMigration, ot as applyChannelDoctorCompatibilityMigrations, st as classifyOtelGrpcMigrationOwnership } from "./io-D1h6pxaD.js";
...
import { i as getBundledChannelSetupPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-ZTUPeZJP.js";
import { r as collectConfiguredModelRefs } from "./configured-model-refs-0XUAFjEF.js";
import { _ as selectedCanonicalModelRefsForRuntimePolicy, d as migrateLegacyWebSearchConfig, f as migrateLegacyXSearchConfig, g as modelEntryWithRuntimePolicy, h as migrateLegacyRuntimeModelRef, l as stripRetiredTuningKnobs, m as listLegacyRuntimeModelProviderAliases, p as legacyRuntimeModelAliasRequiresRuntimePolicy, u as migrateLegacyWebFetchConfig, v as hasOwnKey } from "./legacy-4i8HeDsv.js";
import { r as isLegacyModelsAddCodexMetadataModel } from "./legacy-config-migrations.runtime.models-DeWblCIZ.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { r as retainLegacyDefaultAgentId } from "./legacy.default-agent-owner-D8ws5hED.js";
import { a as isBlockedLegacyCodexModelRef } from "./codex-route-model-ref-Bw2nFxxx.js";
...
import { r as normalizeTalkSection } from "./talk-Cew9ka2y.js";
...
import { n as discoverConfigSecretTargets } from "./target-registry-query-DdLmxb5J.js";
import "./target-registry-fN14Szwn.js";
import { s as callGateway } from "./call-Ds1WOCDj.js";
import { a as runPluginSetupConfigMigrations } from "./setup-registry-CN-wV6fv.js";
...
import { a as noteOpencodeProviderOverrides, c as stripUnknownConfigKeys, i as noteMcpOriginWarning, n as noteImplicitFallbackClobberWarnings, o as noteSandboxOriginProxyWarning } from "./doctor-config-analysis-DoeFLIm_.js";
...
import { n as cronCodexRuntimePolicyTargetKey } from "./store-migration-C5iUQK4N.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { createDoctorPluginMetadataSnapshotScope } = await import("./plugin-metadata-snapshot-scope-DdxX4e39.js");
	...
	const { collectBlockedLegacyOpenAICodexProviderPlan } = await import("./legacy-config-migrations.runtime.models-EzdreQF6.js");
	...
	if (preflight.cronCodexRuntimePolicyTargets?.length) {
		const { repairCronCodexRuntimePolicies } = await import("./runtime-policy-migration-93m3AwUh.js");
	...
	const { prepareRetiredPhoneControlCleanup } = await import("./doctor-retired-phone-control-DMn8vs_Q.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-CEdeTO0T.js");
	applyConfigMutation(runWithCurrentPluginMetadata(state.candidate, () => applyPluginAutoEnable({
		config: state.candidate,
		env: process.env
	})), { fixHint: `Run "${doctorFixCommand}" to apply these changes.` });
	if (!shouldRepair) {
		const { repairStaleAgentModelRefs } = await import("./stale-agent-model-ref-repair-BS5pFbp6.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DDm849pj.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-De8QWB0s.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-CWWNAtdS.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-Xo0GcM1o.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-DsMaIVTO.js");
	...
	if (configuredOpencodePluginIds.length > 0) {
		const { resolveEnabledProviderPluginIds } = await import("./providers-DM3eHb4p.js");
