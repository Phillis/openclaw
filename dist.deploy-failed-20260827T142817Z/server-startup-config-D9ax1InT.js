...
import { f as readConfigFileSnapshotWithPluginMetadata, z as applyConfigOverrides } from "./io-D1h6pxaD.js";
import { i as tryGetLegacyDefaultAgentId, r as retainLegacyDefaultAgentId, t as inheritLegacyDefaultAgentId } from "./legacy.default-agent-owner-D8ws5hED.js";
...
import { n as materializeLegacyDefaultAgentRoles } from "./legacy.roster-C_J5B3wB.js";
import { t as createInvalidConfigError } from "./io.invalid-config-Ghwrjj2j.js";
import { n as isPluginPackagingRuntimeOutputInvalidConfigSnapshot } from "./recovery-policy-CsUZ07YX.js";
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-BpxSuajq.js";
...
import { c as hasLegacyAuthProfileSourcesForStartup } from "./legacy-source-diagnostic-oIpndhGF.js";
import { a as prepareSecretsRuntimeFastPathSnapshot, n as collectCandidateAgentDirs } from "./runtime-fast-path-CWleA27y.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-CAomcfJT.js";
import { a as classifySecretResolutionErrorDegradations, c as isRetryableSecretDegradationReason, d as listSecretResolutionErrorOwners, f as redactSecretDegradationReason, t as SECRET_DEGRADATION_RETRY_HINT } from "./runtime-degraded-state-DqIBoQI-.js";
import { t as resolveAuthProfileSecretOwnerId } from "./runtime-auth-profile-owner-Ca614aTH.js";
import { c as getActiveSecretsRuntimeSnapshotRevisionState, f as graftActiveSecretsRuntimeAuthState, g as hasSameSecretReloadContract, l as getActiveSecretsRuntimeSnapshotState, m as hasCurrentAuthStoreCredentialsRevision, p as hasActiveSecretsRuntimeSnapshotLineage, t as activateSecretsRuntimeSnapshotState } from "./runtime-state-CGaTBGZ5.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-CBMSFO8H.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = createLazyPromise(() => import("./runtime-C5u6SU5w.js"), { cacheRejections: true });
	const loadAuthProfiles = createLazyPromise(() => import("./auth-profiles-CPoNaf6_.js"), { cacheRejections: true });
