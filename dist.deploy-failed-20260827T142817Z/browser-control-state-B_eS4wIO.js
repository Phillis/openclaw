...
import { x as BrowserProfileUnavailableError } from "./tmp-openclaw-dir-DoieXIgG.js";
import "./config-BdAtrEnx.js";
import { d as markBrowserRuntimeStopping, r as beginProfileTransition, s as isBrowserRuntimeRunning } from "./server-context.lifecycle-Dk77BE8P.js";
import { a as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context--fS_iZqr.js";
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-CmX9wnld.js";
...
async function stopBrowserRuntimeInternal(params, finalizeGlobalAdapters) {
	...
	if (finalizeGlobalAdapters) try {
		const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-BdWSsDnH.js");
