...
async function runPluginUninstallCommandUnlocked(id, opts, runtime, skipPreview = false) {
	...
	const { loadInstalledPluginIndex } = await import("./installed-plugin-index-YFhdVit4.js");
	const { resolveInstalledPluginPackageOwnership } = await import("./installed-plugin-package-ownership-C5qVzLfp.js");
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-CxRM7dwK.js");
	const { buildPluginSnapshotReport } = await import("./status-DjY69rYW.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, pluginUninstallTargetExists, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-B4pvKvLo.js");
	...
	const { commitPluginInstallRecordsWithConfig } = await import("./install-record-commit-D6TP1hTK.js");
	const { selectInstallMutationWriteOptions } = await import("./install-persistence-PdkAy9tZ.js");
	...
	if (!skipPreview) {
		...
		const { collectClawPluginUninstallWarnings } = await import("./uninstall-claw-references-CbbACokc.js");
