import { $ as ChatType, A as TtsMode, B as MemorySearchResult, D as ResolvedTtsPersona, F as SafeBinProfileFixture, G as DmScope, I as MentionPatternsPolicyConfig, J as IdentityConfig, L as QueueMode, N as GroupToolPolicyConfig, O as TtsAutoMode, P as ToolLoopDetectionConfig, Q as SessionScope, R as MemoryCitationsMode, S as ChannelImplicitMentionsConfig, U as ContextVisibilityMode, Y as MarkdownTableMode$1, et as FastMode, i as McpCodexToolApprovalMode, j as TtsProvider, k as TtsConfig, n as OpenClawConfig, o as OperatorScope, q as HumanDelayConfig, t as ConfigFileSnapshot, ut as SilentReplyConversationType, z as MemorySearchManager } from "./types.openclaw-VfFCsbZD.js";
import { D as SecretInput, E as SandboxDockerSettings, S as AgentModelConfig, T as AgentToolModelConfig, a as ModelProviderAuthMode, b as Usage, d as AssistantMessageEventStreamContract, f as Context, g as SimpleStreamOptions, h as Model, i as ModelMediaInputConfig, l as Api, n as ModelCompatConfig, o as ModelProviderConfig, p as ImageContent, r as ModelDefinitionConfig, t as ModelApi, u as AssistantMessage } from "./types.models-i3fcfEfL.js";
import { t as FailoverReason } from "./signal-DTFr3i_8.js";
import { A as PluginTrustedToolPolicyRegistration, B as MusicGenerationProvider, C as PluginSessionExtensionRegistration, Ct as TalkBrain, D as PluginSessionTurnUnscheduleByTagParams, E as PluginSessionTurnScheduleParams, Et as TalkTransport, F as TtsDirectiveParseResult, G as ImageGenerationNormalization, H as GeneratedImageAsset, I as GeneratedMusicAsset, K as ImageGenerationOutputFormat, L as MusicGenerationIgnoredOverride, M as SpeechProviderConfig, N as SpeechVoiceOption, O as PluginSessionTurnUnscheduleByTagResult, P as TtsDirectiveOverrides, Q as ImageGenerationResolution, R as MusicGenerationNormalization, S as PluginSessionAttachmentResult, St as LogLevel, T as PluginSessionSchedulerJobRegistration, Tt as TalkMode, U as ImageGenerationBackground, V as MusicGenerationSourceImage, W as ImageGenerationIgnoredOverride, X as ImageGenerationQuality, Y as ImageGenerationProviderOptions, _ as PluginRunContextGetParams, _t as PreparedAgentRunAdmission, a as MediaUnderstandingProviderPlugin$1, at as SessionCatalogHost, b as PluginSessionActionRegistration, c as RealtimeVoiceProviderPlugin$1, ct as SessionsCatalogReadParams, d as VideoGenerationProviderPlugin$1, dt as SecretInputMode, et as ImageGenerationSourceImage, f as WorkerProvider$1, ft as ModelCatalogEntry, g as PluginControlUiDescriptor, gt as OperationalRunInstanceRef, h as PluginAgentEventSubscriptionRegistration, ht as AdmittedRunContext, i as ImageGenerationProviderPlugin$1, it as NodePluginToolDescriptor, j as SpeechModelOverridePolicy, k as PluginToolMetadataRegistration, l as SpeechProviderPlugin$1, lt as SessionsCatalogReadResult, m as PluginAgentEventEmitResult, mt as ProviderCatalogOutcome, nt as onAgentEvent, o as MusicGenerationProviderPlugin$1, ot as SessionsCatalogArchiveParams, p as PluginAgentEventEmitParams, pt as ModelCatalogSnapshot, q as ImageGenerationProvider, r as GatewayRequestHandlers, rt as CronCreatorAuthorityRunScope, s as RealtimeTranscriptionProviderPlugin$1, st as SessionsCatalogContinueParams, t as GatewayRequestHandler, tt as OpenClawPluginNodeHostCommand, u as TranscriptSourceProvider$1, ut as SpawnResult, v as PluginRunContextPatch, vt as RuntimePluginToolGrant, w as PluginSessionSchedulerJobHandle, wt as TalkEventType, x as PluginSessionAttachmentParams, y as PluginRuntimeLifecycleRegistration, yt as AgentInternalEvent, z as MusicGenerationOutputFormat } from "./types-BqCPJyXZ.js";
import { A as ThinkingCatalogEntry, C as ReplyDispatchBeforeDeliverOptions, D as ReplyFollowupAdmissionBarrierTimeoutPolicy, E as ReplyDispatcher, M as DiagnosticTraceContext, O as ReasoningLevel, S as ReplyDispatchBeforeDeliver, T as ReplyDispatchRuntimeInfo, _ as PluginConversationBindingRequestParams, a as PluginHookRegistration$1, b as PluginApprovalResolution, d as PluginHookToolRequesterContext, f as PluginToolMatcher, g as PluginConversationBinding, h as PluginJsonValue, i as PluginHookName, j as VerboseLevel, k as ThinkLevel, l as PluginHookToolInputKind, m as PluginNextTurnInjectionEnqueueResult, o as PluginHookRegistrationOptions, p as PluginNextTurnInjection, r as PluginHookHandlerMap, u as PluginHookToolKind, v as PluginConversationBindingRequestResult, w as ReplyDispatchKind, x as PluginHookBeforeToolCallResult, y as PluginConversationBindingResolvedEvent$1 } from "./subagent-requester-context-BTUaxNjP.js";
import { _ as ChannelRouteRef, c as SessionPluginJsonValue, g as DeliveryContext, h as SourceReplyDeliveryMode, i as GroupKeyResolution, l as SessionSystemPromptReport, n as ChatChannelId, o as SessionContextBudgetStatus, r as CliSessionBinding, s as SessionEntry, t as ChannelId$1, u as SessionToolOverrides, v as CronScheduledToolPolicy } from "./channel-id.types-Baik2yF6.js";
import { a as SkillSnapshot, i as SkillEligibilityContext, n as resolveAgentWorkspaceDir, o as SkillTelemetrySource, r as ExplicitSkillSelection, s as SkillUsagePath, t as resolveAgentDir } from "./routing-CvdfqTTf.js";
import { $ as ConversationReadInvocationOrigin, $t as MediaKind, A as chunkTextWithMode, At as SessionTranscriptContext, Bt as MediaUnderstandingOutput, C as ChannelOutboundAdapter, Ct as ExecTarget, D as chunkMarkdownText, Dt as MentionSource, E as chunkByNewline, Et as InboundSourceModality, F as ChannelAccountSnapshot, Ft as CommandTurnKind, Gt as TaskSuggestionDeliveryMode, Ht as BlockReplyContext, It as PluginHookChannelContext, Jt as InputProvenance, Kt as TurnAdoptionLifecycle, Lt as MediaUnderstandingDecision, M as resolveTextChunkLimit, Mt as HistoryEntry, Nt as HistoryMediaEntry, O as chunkMarkdownTextWithMode, Ot as MsgContext, Pt as CommandTurnContext, Qt as PromptImageOrderEntry, Rt as MediaUnderstandingProvider, St as ExecSecurity, Tt as FinalizedRuntimeMsgContext, U as ChannelMessageActionAdapter, Ut as GetReplyOptions, Vt as InboundEventKind, Wt as PartialReplyPayload, Xt as MediaFact, Yt as LegacyMediaContextKey, an as MessagePresentation, at as resolveAgentRoute, bt as ExecAsk, dn as TranscriptTurnAdmission, en as mediaKindFromMime, fn as TranscriptTurnBoundary, gn as AgentToolUpdateCallback, hn as AgentToolResult, ht as OutboundMediaReadFile, it as buildAgentSessionKey, j as resolveChunkMode, jt as SupplementalContextFacts, k as chunkText, kt as OriginatingChannelType, mn as AgentTool, nn as ReplyMediaAttachment, nt as OutboundPayloadDeliverySuppressionReason, on as ModelPickerAction, pn as AgentMessage, qt as UserTurnTranscriptRecorder, rn as ReplyPayload, un as TranscriptEntryAnchor, ut as MessageReceipt, wt as FinalizedMsgContext, xt as ExecMode, yn as StreamFn, zt as StructuredExtractionInput } from "./types.adapters-BCj_O1Hf.js";
import { D as UnifiedModelCatalogKind, E as UnifiedModelCatalogEntry, O as RuntimeEnv$1, _ as PluginManifestContracts, a as PluginOrigin$1, b as PluginManifestDashboardDataBinding, f as PluginBundleFormat, h as PluginFormat, i as PluginDependencyStatus, m as PluginDiagnostic, p as PluginConfigUiHint, t as PluginManifestRecord, v as PluginManifestDashboard, w as PluginKind, x as PluginManifestMcpServer, y as PluginManifestDashboardActionVerb } from "./manifest-registry-dA0dB5pr.js";
import { i as JsonSchemaObject, n as ChannelConfigSchema, r as ChannelConfigUiHint } from "./types.config-C6_VK-8V.js";
import { n as PluginMetadataSnapshotOwnerMaps, r as PluginCompatCode, t as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-Dkqz1xCL.js";
import { i as ConfigWriteAfterWrite, n as resolveStateDir, r as ConfigReplaceResult } from "./config-ZGzkQBpH.js";
import { a as OutboundDeliveryQueuePolicy, d as fetchRemoteMedia, f as readRemoteMediaBuffer, g as saveMediaBuffer, i as DurableFinalDeliveryRequirements, m as saveResponseMedia, n as resizeToJpeg, p as saveRemoteMedia, r as DeliverOutboundPayloadsParams, t as getImageMetadata, v as SessionManager, y as ResolvedSessionMaintenanceConfigInput } from "./media-services-CCiq3Bcu.js";
import { i as OAuthCredential$1, n as AuthProfileCredential, r as AuthProfileStore, t as ApiKeyCredential$1 } from "./types-BNlO1Crw.js";
import { c as CronRuntimeAuthority } from "./types-CodlKHkU.js";
import { r as WizardPrompter } from "./setup-wizard-types-C8q0VIYa.js";
import { n as ChannelPlugin$3 } from "./types.public-C3sFjEH3.js";
import { a as VideoGenerationResolution, i as VideoGenerationProvider, n as VideoGenerationIgnoredOverride, o as VideoGenerationSourceAsset, r as VideoGenerationNormalization, t as GeneratedVideoAsset } from "./types-bp3YMYHb.js";
import { r as SsrFPolicy } from "./ssrf-CIroieCz.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-D1YmERTY.js";
import { a as UpsertChannelPairingRequestForAccount, i as RemoveChannelAllowFromStoreEntryForAccount, n as buildPairingReply, o as InboundLastRouteUpdate, r as ReadChannelAllowFromStoreForAccount, s as RecordInboundSession$1 } from "./pairing-store-DAkBs14E.js";
import { n as SessionBindingRecord } from "./session-binding.types-DdT2ZV2T.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./config-contracts-D1HPlN31.js";
import { n as PluginStateKeyedStore, r as PluginStateSyncKeyedStore, t as OpenKeyedStoreOptions } from "./plugin-state-store.types-Bw8X6IMk.js";
import { n as ProviderModelRouteRuntimePolicy, r as ProviderRouteOverridePresence, t as ProviderModelRouteAuthRequirement } from "./provider-model-types-Bhrp8vcF.js";
...
declare function createScopedPairingAccess(params: {
  ...
  channel: ChannelId$1; /** Channel account id normalized once before store operations. */
  accountId: string;
}): {
  ...
  readStoreForDmPolicy: (provider: ChannelId$1, accountId: string) => Promise<string[]>; /** Upsert a pairing request with the scoped channel/account injected. */
...
declare function createChannelPairingController(params: {
  ...
  channel: ChannelId$1; /** Channel account id normalized before pairing store access. */
  accountId: string;
...
type ProviderAuthContext = {
  ...
  workspaceDir?: string;
  prompter: WizardPrompter;
  runtime: RuntimeEnv$1; /** Cancels browser callbacks, device polling, and other app-owned auth work. */
  signal?: AbortSignal;
  /**
...
//#endregion
export { createDedupeCache as $, PluginLogger as A, readToolStringParam as At, resolveChannelContextVisibilityMode as B, ProviderNormalizeResolvedModelContext as C, FallbackAttempt as Ct, OpenClawPluginService as D, readReactionParams as Dt, OpenClawPluginSecurityAuditContext as E, readNumberParam as Et, chunkTextForOutbound as F, buildTokenChannelStatusSummary as G, createChannelPairingController as H, readJsonFileWithFallback as I, resolveConfiguredFromCredentialStatuses as J, createDefaultChannelRuntimeState as K, writeJsonFileAtomically as L, isRequestBodyLimitError as M, __exportAll as Mt, readRequestBodyWithLimit as N, OpenClawPluginServiceContext as O, readStringArrayParam as Ot, requestBodyErrorToText as P, buildChannelConfigSchema as Q, evaluateSupplementalContextVisibility as R, ProviderThinkingProfile as S, normalizeAgentId as St, OpenClawPluginSecurityAuditCollector as T, createActionGate as Tt, buildBaseAccountStatusSnapshot as U, keepHttpServerTaskAlive as V, buildProbeChannelStatusSummary as W, formatPairingApproveHint as X, PAIRING_APPROVED_MESSAGE as Y, clearAccountEntryFields as Z, WebSearchProviderPlugin as _, extensionForMime as _t, GenerateImageParams as a, resolveCapabilityModelCandidates as at, ProviderWrapStreamFnContext as b, DEFAULT_ACCOUNT_ID as bt, OPENAI_DEFAULT_IMAGE_MODEL as c, PluginRuntime as ct, parseGenerationModelRef as d, createReplyPrefixContext as dt, AllowlistMatch as et, getImageGenerationProvider as f, resolveInboundMentionDecision as ft, OpenClawPluginApi as g, detectMime as gt, setFeishuRuntime as h, emptyPluginConfigSchema as ht, RuntimeLogger as i, buildNoCapabilityModelConfiguredMessage as it, DEFAULT_WEBHOOK_MAX_BODY_BYTES as j, jsonResult as jt, PluginInteractiveRegistration as k, readStringOrNumberParam as kt, resolveApiKeyForProvider as l, InboundMediaFacts as lt, RuntimeEnv as m, isFailoverError as mt, OpenClawPluginDefinition as n, resolveAgentModelFallbackValues as nt, GenerateImageRuntimeResult as o, throwCapabilityGenerationFailure as ot, listImageGenerationProviders as p, describeFailoverError as pt, projectCredentialSnapshotFields as q, OpenClawPluginConfigSchema as r, resolveAgentModelPrimaryValue as rt, WebMediaResult as s, getProviderEnvVars as st, definePluginEntry as t, resolveAllowlistMatchSimple as tt, normalizeGooglePreviewModelId as u, createChannelReplyPipeline as ut, OpenClawPluginToolContext as v, getFileExtension as vt, ProviderCatalogContext as w, AnyAgentTool as wt, ProviderDefaultThinkingPolicyContext as x, normalizeAccountId as xt, OpenClawPluginToolFactory as y, getSessionEntry as yt, filterSupplementalContextItems as z };