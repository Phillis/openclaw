...
import { d as normalizeStringEntriesLower, u as normalizeStringEntries } from "./string-normalization-e_fvmxMf.js";
...
import { $ as resolveChannelPromptCapabilities } from "./agent-tools.before-tool-call-aNXucund.js";
import { t as resolveAccountEntry } from "./account-lookup-gtl3eJfy.js";
import { i as buildBootstrapInjectionStats } from "./bootstrap-budget-BjndRqg9.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-CY5sQygn.js";
...
function resolveChannelCapabilities(params) {
	...
	const channelConfig = cfg.channels?.[channel] ?? cfg[channel];
	if (!channelConfig) return;
	const normalizedAccountId = normalizeAccountId(params.accountId);
	const accounts = channelConfig.accounts;
	return normalizeCapabilities((accounts && typeof accounts === "object" ? resolveAccountEntry(accounts, normalizedAccountId) : void 0)?.capabilities) ?? normalizeCapabilities(channelConfig.capabilities);
}
//#endregion
