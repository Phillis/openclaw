...
import { g as collectUnregisteredConfiguredMemoryEmbeddingProviders, h as collectRegisteredEmbeddingProviderIds } from "./gateway-startup-plugin-ids-6UecoKl9.js";
import { E as setActivePluginRegistry, d as getActivePluginRegistry, k as createEmptyPluginRegistry } from "./runtime-CTbL314X.js";
import "./loader-CwiP0Igf.js";
import { r as listAmbientOnlyConfiguredChannelIds } from "./channel-presence-policy-rQR9R6qg.js";
import "./channel-plugin-ids-oAuJj65R.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-C_nDqw7p.js";
import { f as initSubagentRegistry } from "./subagent-registry-DU4QcZuY.js";
import { r as resolveGatewayStartupPluginActivationConfig } from "./plugin-activation-runtime-config-CyDRyLIH.js";
import { n as listGatewayMethods } from "./server-methods-list-CXr75eou.js";
...
async function runGatewayStartupMaintenance(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-BUNMNBkj.js");
			startupTasks.push(runStartupSessionMigration({
				cfg: params.cfgAtStart,
				env: process.env,
				log: params.log
			}));
			const { migrateLegacyDevicePairingStore } = await import("./device-pairing-migration-DQoXr5Dh.js");
			const { migrateLegacyNodePairingStore } = await import("./node-pairing-migration-CoDRrXTJ.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-CV8VpKyS.js");
