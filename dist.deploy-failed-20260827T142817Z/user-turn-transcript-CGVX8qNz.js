...
import { rt as readActiveTranscriptEntryAnchor, w as persistSessionTranscriptTurn } from "./session-accessor-CVnxp3UM.js";
...
function createUserTurnTranscriptRecorder(params) {
	...
	const handlePersistenceError = (error) => {
		...
		import("./globals-BRC9hA7h.js").then(({ logVerbose }) => {
