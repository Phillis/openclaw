...
import { n as buildApiKeyCredential } from "../../provider-auth-helpers-c1dAduEh.js";
...
import "../../secret-input-runtime-CMzEsCm3.js";
...
import { r as resolveThinkingProfile } from "../../provider-policy-api-Cgy-KxN3.js";
...
import { a as shouldUseSyntheticOllamaAuth, i as resolveOllamaRuntimeBaseUrl, n as isLocalOllamaBaseUrl, r as resolveOllamaDiscoveryResult, t as OLLAMA_PROVIDER_ID } from "../../discovery-shared-zdJhs5gC.js";
import { c as OLLAMA_MODELS_COMMAND, d as OLLAMA_NODE_INFERENCE_DEFAULT_PLATFORMS, f as ollamaNodeInferenceToolDefinition, l as OLLAMA_NODE_INFERENCE_CAPABILITY, s as OLLAMA_CHAT_COMMAND, u as OLLAMA_NODE_INFERENCE_COMMANDS } from "../../node-inference-contract-D_QZr1oG.js";
import { c as orderPreferredOllamaModelIds, i as findAvailableOllamaModelName } from "../../setup-model-selection-piFJP2rg.js";
import { r as resolveConfiguredOllamaProviderConfig, t as createConfiguredOllamaCompatStreamWrapper } from "../../stream-compat-D1a8zQCG.js";
import "../../stream-contract-CaPxW4Jp.js";
import { t as createLazyOllamaWebSearchProvider } from "../../web-search-provider-registration-DUOPEyX1.js";
import { createHash } from "node:crypto";
//#region extensions/ollama/src/node-inference-registration.ts
const loadOllamaNodeInference = createLazyRuntimeModule(() => import("../../node-inference-CupQAI55.js"));
...
const loadOllamaStreamRuntime = createLazyRuntimeModule(() => import("../../stream.runtime-gsdAXQ1g.js"));
...
const loadOllamaSetup = createLazyRuntimeModule(() => import("../../setup.runtime-BwAk-n-O.js"));
const loadOllamaEmbeddingProvider = createLazyRuntimeModule(() => import("../../embedding-provider.runtime-BTDAq5G9.js"));
const loadOllamaMemoryEmbeddingProviderAdapter = createLazyRuntimeModule(async () => (await import("../../memory-embedding-adapter-BT3HDVJ6.js")).ollamaMemoryEmbeddingProviderAdapter);
const loadOllamaMediaUnderstandingProvider = createLazyRuntimeModule(async () => (await import("../../media-understanding-provider-CMeyNK4v.js")).ollamaMediaUnderstandingProvider);
