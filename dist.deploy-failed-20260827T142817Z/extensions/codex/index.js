...
import { n as canonicalPathFromExistingAncestor, s as pathExists } from "../../absolute-path-BseY-yOe.js";
...
import { d as resolveAgentWorkspaceDir, f as resolveDefaultAgentDir, p as resolveDefaultAgentId, s as resolveAgentConfig } from "../../agent-scope-config-BdXMWufB.js";
...
import { b as updateAuthProfileStoreWithLock, p as loadAuthProfileStoreWithoutExternalProfiles } from "../../store-DOJuehrg.js";
import { _ as readToolStringParam } from "../../common-BGOZLJ2_.js";
import { t as jsonResult } from "../../tool-results-BCM3fdVS.js";
import { n as buildApiKeyCredential, t as applyAuthProfileConfig } from "../../provider-auth-helpers-c1dAduEh.js";
...
import { K as loadExecApprovals } from "../../exec-approvals-EA-WQccl.js";
...
import { h as resolveTranscriptSessionKeyBySessionId, m as resolveStorePath, r as getSessionEntry } from "../../session-store-runtime-NOuoTqlj.js";
import { d as buildOpenAICodexCredentialExtra, h as resolveOpenAICodexImportProfileName, m as resolveOpenAICodexAuthIdentity } from "../../provider-auth-DVDSRG1v.js";
...
import { a as closeCodexStartupClientBestEffort, d as unsubscribeCodexThreadBestEffort, h as isCodexNotificationForTurn, o as interruptCodexTurnAndWaitBestEffort, p as getCodexAppServerTurnRouter, u as retireUnsafeCodexTurnClientBestEffort } from "../../attempt-client-cleanup-D36eX-vm.js";
import { s as isAssistantCommentaryCompletionNotification } from "../../event-projector-usage-yGE22DCR.js";
import { C as mergeCodexThreadConfigs, D as isOpenAiCuratedMarketplace, T as ensureCodexPluginActivation, f as resolveCodexAppServerRequestModelSelection, k as pluginReadParams, u as CODEX_NATIVE_PERSONALITY_NONE, x as buildDisabledAppsConfigPatch } from "../../thread-lifecycle-v3XjduGr.js";
import { u as readVisibleSessionTranscriptMessageEntries } from "../../session-transcript-runtime-DS57FWaj.js";
import { a as assertCodexThreadStartResponse } from "../../protocol-validators-DQMpwHD0.js";
import { l as projectBoundedCodexVisibleSessionHistory } from "../../transcript-mirror-XHgv98Y1.js";
import { n as describeControlFailure, t as CODEX_CONTROL_METHODS } from "../../capabilities-BDRGDsaU.js";
import { r as formatCodexDisplayText } from "../../command-formatters-DNP4mC33.js";
import "../../incognito-session-DoO9V_or.js";
import { t as resolveCodexAppServerForModelProvider } from "../../app-server-policy-Bg2AsLzl.js";
...
import { i as withCodexAppServerJsonClient, r as requestCodexAppServerJson } from "../../request-BOfm7FyN.js";
import { n as resolveLivePluginConfigObject, r as resolvePluginConfigObject } from "../../plugin-config-runtime-D7ikroCS.js";
...
import { a as withCachedMigrationConfigRuntime, n as copyMemoryMigrationFileItem, o as writeMigrationReport, r as copyMigrationFileItem, t as archiveMigrationItem } from "../../migration-runtime-BnpyKt6m.js";
import { n as readJsonFileWithFallback } from "../../json-store-DqPFYx4j.js";
import { n as registerCodexCliMetadata } from "../../cli-metadata-BdxH66lR.js";
import { t as createCodexAppServerAgentHarness } from "../../harness-YOnwUD0i.js";
import { t as buildCodexMediaUnderstandingProvider } from "../../media-understanding-provider-6QfLDZlr.js";
...
import { f as trackCodexConversationActiveTurn, m as canMutateCodexHost, p as CODEX_NATIVE_EXECUTION_AUTH_ERROR, t as discoverCodexMarketplacePlugins } from "../../plugin-marketplace-discovery-Dbpqx-fM.js";
...
import { d as resumeCodexCliSessionOnNode, l as listCodexCliSessionsOnNode, o as createCodexCliSessionNodeHostCommands, s as createCodexCliSessionNodeInvokePolicies, t as codexControlRequest, u as resolveCodexCliSessionForBindingOnNode } from "../../command-rpc-2huAeqYo.js";
import { i as createCodexSessionCatalogNodeInvokePolicies, n as createCodexSessionCatalogControl, o as assertCodexArchiveDescendantsUnowned, r as createCodexSessionCatalogNodeHostCommands, t as codexSessionCatalogRuntime } from "../../session-catalog-DC3gEH2Z.js";
...
function createLazyCodexAppServerBindingStore(state) {
	let resolved;
	const store = () => resolved ??= import("../../session-binding-CU068Uuv.js").then(({ createCodexAppServerBindingStore }) => createCodexAppServerBindingStore(state));
	return {
...
async function loadDefaultCodexSubcommandHandler() {
	const { handleCodexSubcommand } = await import("../../command-handlers-DmEICBgs.js");
...
const loadCodexWebSearchRuntime = createLazyRuntimeModule(() => import("../../web-search-provider.runtime-DgkBooih.js"));
...
var codex_default = definePluginEntry({
	...
	register(api) {
		...
		api.on("after_compaction", async (event, ctx) => {
			...
			const { sessionBindingIdentity } = await import("../../session-binding-CU068Uuv.js");
			const identity = sessionBindingIdentity({
				sessionId,
		...
		api.on("session_end", async (event, ctx) => {
			...
			const config = resolveCurrentConfig();
			const [{ sessionBindingIdentity }, { retireCodexAppServerSessionGeneration }] = await Promise.all([import("../../session-binding-CU068Uuv.js"), import("../../session-retirement-CAa1Ko51.js")]);
