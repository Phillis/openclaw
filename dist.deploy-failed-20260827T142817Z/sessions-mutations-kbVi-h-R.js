...
import { j as patchPluginSessionExtension } from "./loader-CwiP0Igf.js";
...
import { Tt as SessionLabelOwnerIndex, jt as applySessionEntryCanonicalReplacements, vn as isInternalSessionEffectsKey } from "./session-accessor-CVnxp3UM.js";
import { K as interruptSessionWorkAdmissions, R as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS, X as runExclusiveSessionLifecycleMutation, m as resolveMissingAgentHarnessSessionError, q as isCompetingSessionWorkAdmissionActive } from "./agent-harness-session-key-D5rklW6u.js";
import { Xr as validateSessionsPatchParams, Yr as validateSessionsPatchManyParams, Zr as validateSessionsPluginPatchParams, ti as validateSessionsResetParams } from "./src-Bo4ezI_n.js";
import { s as errorShape } from "./error-codes-CMSvT5-d.js";
import { b as waitForReplyRunEndBySessionId, c as isReplyRunActiveForSessionId, n as abortReplyRunBySessionId, p as replyRunRegistry } from "./reply-run-registry-CeOg3aTN.js";
import { D as waitForEmbeddedAgentRunEnd, d as isEmbeddedAgentRunInProgress, n as abortEmbeddedAgentRun } from "./runs-DdjJNEQM.js";
import { t as SESSION_LIFECYCLE_CHANGED_ERROR_REASON } from "./lifecycle-D1Tz6qOi.js";
import { a as resolveSessionModelRef } from "./placement-session-runtime-Bg1IJ7s4.js";
import { n as projectSessionPatchResult } from "./session-utils-model-B0LBQVk2.js";
import { N as resolveGatewaySessionStoreTargetWithStore, O as resolveCanonicalGatewaySessionStoreKey, g as disableCronJobsBoundToSessions, k as resolveCanonicalSessionEntryFromStoreKeys } from "./session-utils-row-CriEgq90.js";
...
import { o as hasPendingFollowupQueueWork } from "./state-BobUNKkR.js";
...
import { p as waitForChatAbortControllerRemoval } from "./chat-abort-BBAKYOB6.js";
...
import { t as persistStickyModelSelectionBestEffort } from "./sticky-model-selection-C-ZWt-mq.js";
import { t as SessionMutationAuthorizationChangedError, v as gatewayClientSessionCreator } from "./session-sharing-QTh4cZeN.js";
import { n as emitSessionsChanged } from "./session-change-event-BanWv5Vf.js";
import { i as hasGatewaySessionAbortOwner, r as createChatAbortOps, t as abortChatRunsForSessionKeyWithPartials } from "./chat-abort-runtime-CpinoOzx.js";
...
import { d as resolveSessionWorkerPlacementPatchError, l as requireSessionKey, p as sessionLog, r as isAgentMainSessionKey, s as loadSessionsRuntimeModule } from "./sessions-shared-DhClIVMH.js";
import { t as projectSessionsPatchEntry } from "./sessions-patch-vkcbbb-Z.js";
import { n as ensureSessionGroupRegistered } from "./session-groups-BktgbFN5.js";
import { t as appendSessionAudit } from "./session-audit-DwihzAkg.js";
