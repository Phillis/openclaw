...
import { Q as ConfigMutationConflictError, l as readConfigFileSnapshot } from "./io-D1h6pxaD.js";
...
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-Cg-hXt3q.js";
...
import { r as resolveLocalControlUiProbeLinks } from "./control-ui-links-DfRqI0QP.js";
import { r as resolveManifestProviderAuthChoices } from "./provider-auth-choices-Be8yPp6p.js";
import { h as waitForGatewayReachable, l as normalizeGatewayTokenInput, n as applyWizardMetadata, s as handleReset, t as DEFAULT_WORKSPACE } from "./onboard-helpers-DQoIxFmS.js";
...
import { i as resolveProviderMatch } from "./provider-auth-choice-helpers-BJGFEWWU.js";
...
import { o as normalizeTokenProviderInput } from "./provider-auth-input-CWiCDyqF.js";
...
import { r as formatAuthChoiceChoicesForCli } from "./auth-choice-options-B21giTzj.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-Clhabj86.js";
import { t as resolvePluginProviders } from "./provider-auth-choice.runtime-moQA7qEv.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-BK76HCS6.js";
import { n as validateGatewayWebSocketUrl } from "./onboard-remote-BCoHMneM.js";
import { n as isOnboardFlow, t as isNodeManagerChoice } from "./onboard-types-Du2Y9b-2.js";
import { n as applySkipBootstrapConfig, r as resolveOnboardingWorkspaceConflict, t as applyLocalSetupWorkspaceConfig } from "./onboard-config-DU6S3CQE.js";
import { t as runGuidedOnboarding } from "./onboard-guided-DKKoPpCo.js";
...
import { u as withSetupMigrationTargetLock } from "./setup.migration-snapshot-DhN9_LNX.js";
import { n as runInteractiveSetup } from "./onboard-interactive-DBOV6ph4.js";
import { t as inferAuthChoiceFromFlags } from "./auth-choice-inference-BsSfhstJ.js";
import { n as resolveNonInteractiveApiKey, t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-DmIG99Ea.js";
...
async function commitNonInteractiveOnboardConfig(params) {
	const { writeWizardConfigFile } = await import("./setup.shared-BmVj-Htu.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-D8ns1kG_.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BYXGT9MA.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CgFdtOE3.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-740swsOf.js");
...
async function setupWizardCommand(opts, runtime = defaultRuntime) {
	...
	if (normalizedOpts.agentName !== void 0) {
		const { validateFirstOnboardingAgentName } = await import("./onboard-agent-BC30vRBi.js");
