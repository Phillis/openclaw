...
import { l as normalizeGatewayTokenInput, m as validateGatewayPasswordInput } from "./onboard-helpers-DQoIxFmS.js";
...
import { a as validateDottedDecimalIPv4Input, i as maybeAddTailnetOriginToControlUiAllowedOrigins, n as TAILSCALE_EXPOSURE_OPTIONS } from "./gateway-config-prompts.shared-B6nsIs8C.js";
...
async function configureGatewayForSetup(opts) {
	...
	if (authMode === "token") {
		...
		if ((quickstartTokenRef ? "ref" : flow === "quickstart" && opts.secretInputMode !== "ref" ? "plaintext" : await resolveSecretInputModeForEnvSelection({
			prompter,
	...
	if (authMode === "password") {
		...
		let password = flow === "quickstart" ? quickstartGateway.password : existingPasswordRef ?? void 0;
