...
import { i as resolveConfigScopedRuntimeCacheValue, t as PluginLruCache } from "./plugin-cache-primitives-Q46IVR5c.js";
import { n as resolvePluginControlPlaneFingerprint } from "./plugin-control-plane-context-Dp6B1Phu.js";
...
import { _ as resolveProviderConfigApiOwnerHint } from "./gateway-startup-plugin-ids-6UecoKl9.js";
...
import { b as getPluginRuntimeGenerationRegistry } from "./hook-runner-global-BNCkTxOs.js";
import { n as getLoadedRuntimePluginRegistry } from "./active-runtime-registry-DA-5LJYr.js";
import { n as resolvePluginProvidersCore, t as isPluginProvidersLoadInFlight } from "./providers.runtime-CAakL3j-.js";
...
function resolveProviderPluginsForHooks(params) {
	...
	if (generationRegistry) {
		...
		return plugins.filter((plugin) => (!onlyPluginIds || onlyPluginIds.has(plugin.pluginId)) && (!params.providerRefs?.length || params.providerRefs.some((providerRef) => matchesProviderPluginRef(plugin, providerRef))));
	}
	const env = params.env ?? process.env;
...
//#endregion
export { resolveModelWorkspaceDir as _, prepareProviderExtraParams as a, resolveProviderExtraParamsForTransport as c, resolveProviderPluginsForHooks as d, resolveProviderRuntimePlugin as f, resolveModelPluginMetadataSnapshot as g, wrapProviderStreamFn as h, getModelProviderRuntimePluginHandle as i, resolveProviderFollowupFallbackRoute as l, wrapProviderSimpleCompletionStreamFn as m, clearProviderRuntimePluginCacheForTest as n, resolveLoadedProviderRuntimePlugin as o, resolveProviderRuntimePluginHandle as p, ensureProviderRuntimePluginHandle as r, resolveProviderAuthProfileId as s, attachModelProviderRuntimePluginHandle as t, resolveProviderHookPlugin as u };
