...
import { d as readConfigFileSnapshotForWrite, s as readBestEffortConfig } from "./io-D1h6pxaD.js";
...
import { a as readActiveGatewayLockPort, i as readActiveGatewayLockIdentity, r as isSameGatewayLockIdentity } from "./gateway-lock-EiOnxvh_.js";
import { a as restartSystemdService, p as findInstalledSystemdGatewayScope, s as stopSystemdService } from "./systemd-DPnIQILH.js";
import { i as resolveOpenClawWrapperPath, t as OPENCLAW_WRAPPER_ENV_KEY } from "./program-args-C4pvyUF9.js";
import { t as buildGatewayInstallPlan } from "./daemon-install-helpers-tW602Xtl.js";
...
import { f as resolveLaunchAgentLabel, t as assertNoSystemLaunchDaemonOwnership } from "./launchd-system-OPhPIEKB.js";
import { g as launchAgentPlistExists, p as formatLaunchAgentGuiSessionError, s as repairLaunchAgentBootstrap } from "./launchd-CHv0VO6s.js";
import { n as mergeGatewayServiceEnv } from "./gateway-service-probe-hosts-DUpYpH7x.js";
import { i as terminateStaleGatewayPids } from "./restart-stale-pids-C2sCOjHx.js";
import { a as resolveGatewayService, n as formatGatewayServiceStartRepairIssues } from "./service-CJsmassN.js";
import { n as formatGatewayPidList, r as signalVerifiedGatewayPidSync, t as findVerifiedGatewayListenerPidsOnPortSync } from "./gateway-processes-DdfQ_p-o.js";
import { h as createNullWriter, l as renderGatewayServiceStartHints, m as createDaemonActionContext, s as parsePortFromArgs } from "./shared-Cauz4p0y.js";
import { t as mergeInstallInvocationEnv } from "./install-B86jlKY6.js";
import { n as isRestartEnabled } from "./commands.flags-CZN5Wwe1.js";
import { c as callGatewayCli } from "./call-Ds1WOCDj.js";
import { n as probeGateway } from "./probe-CkJu-Lqo.js";
import { a as writeGatewayRestartIntentSync, t as clearGatewayRestartIntentSync } from "./restart-intent-KHLytUfT.js";
import { l as resolveGatewayRestartDeferralTimeoutMs } from "./restart-B3HJgSVH.js";
import { n as NON_INTERACTIVE_GATEWAY_STOP_MESSAGE, r as isTerminalInteractive } from "./terminal-interactivity-Bmck99HR.js";
import { a as appendGatewayLifecycleAudit, i as runServiceUninstall, n as runServiceStart, o as createGatewayLifecycleMutationAudit, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-CnOr4QOl.js";
import { a as renderRestartDiagnostics, i as renderGatewayPortHealthDiagnostics, n as waitForGatewayHealthyRestart, o as DEFAULT_RESTART_HEALTH_ATTEMPTS, r as waitForGatewayHealthyListener } from "./restart-health-Cj0Gkguj.js";
