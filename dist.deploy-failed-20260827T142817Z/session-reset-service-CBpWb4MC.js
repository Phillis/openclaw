...
import { _n as sessionEntryForkedFromParent, ct as rebindCliSessionReseedReceiptsForReset, gn as buildSessionCreationStamp, it as clearAllCliSessions } from "./session-accessor-CVnxp3UM.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { n as deleteSessionEntryLifecycle, r as resetSessionEntryLifecycle } from "./session-accessor.sqlite-lifecycle-DM-jpNkz.js";
import { G as hasOnlySessionLifecycleMutationKindActive, J as isSessionLifecycleMutationActive, K as interruptSessionWorkAdmissions, R as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS, X as runExclusiveSessionLifecycleMutation, m as resolveMissingAgentHarnessSessionError } from "./agent-harness-session-key-D5rklW6u.js";
import { s as errorShape } from "./error-codes-CMSvT5-d.js";
import { t as getAcpSessionManager } from "./manager-BjA1b1Vp.js";
import { a as handleSessionStateSessionDeleted, o as handleSessionStateSessionReset, u as recordSessionCreated } from "./session-state-events-BTZJfLLh.js";
...
import { c as writeAcpSessionMetaForMigration, r as readAcpSessionMeta, s as upsertAcpSessionMeta } from "./session-meta-BrtiZ04k.js";
...
import { M as resolveGatewaySessionStoreTarget, T as loadGatewaySessionEntry } from "./session-utils-row-CriEgq90.js";
...
import { n as clearBootstrapSnapshotOnSessionBoundary, t as clearBootstrapSnapshot } from "./bootstrap-cache-e0hDlz1i.js";
...
import { r as stopSubagentsForRequester } from "./abort-CJm75NX3.js";
...
import { n as hasSessionAutoResetListeners, r as isSessionAutoResetReason, t as emitSessionAutoResetHook } from "./session-auto-reset-DJUJLFSu.js";
import { n as runPluginHostCleanup } from "./host-hook-cleanup-DyFoq--L.js";
...
async function ensureSessionRuntimeCleanup(params) {
	const [embeddedAgent, mcpTools, { clearFinishedSessionsForScopes }] = await Promise.all([
		import("./embedded-agent-FeUdPibX.js"),
		import("./agent-bundle-mcp-tools-Bwaxjt5q.js"),
...
async function performGatewaySessionReset(params) {
	...
	const workerPlacementContext = params.workerPlacementContext ?? (await import("./session-worker-placement-context-DzWI2UVe.js")).resolveSessionWorkerPlacementContext();
