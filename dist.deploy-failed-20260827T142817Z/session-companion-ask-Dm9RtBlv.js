...
import { i as resolveSimpleCompletionSelectionForAgent } from "./simple-completion-runtime-A9GJIIpB.js";
...
async function defaultRun(params) {
	...
	const { prepareInternalSessionEffectsSession, removeInternalSessionEffectsSession } = await import("./internal-session-effects-B2gdbNjF.js");
	...
	try {
		const [{ SessionManager }, { runEmbeddedAgent }] = await Promise.all([import("./sessions-CJGdwBn5.js"), import("./embedded-agent-FeUdPibX.js")]);
