...
import { o as getOfficialExternalPluginCatalogManifest, p as listOfficialExternalProviderCatalogEntries } from "./official-external-plugin-catalog-DlrV8XyO.js";
import { i as shouldLogVerbose, r as logVerbose } from "./globals-CAwGc4B6.js";
import { n as runExec } from "./exec-BL80Wdzl.js";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-DJWHSR2r.js";
import { c as mergeModelProviderRequestOverrides, m as sanitizeConfiguredProviderRequest, p as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-BK7CLYaF.js";
...
import { i as normalizeMediaReferenceSource, o as resolveInboundMediaReference, r as classifyMediaReferenceSource } from "./media-reference-BuvK4U0u.js";
import { r as readRemoteMediaBuffer, t as MediaFetchError } from "./fetch-CLYC5ZpH.js";
...
import { r as resolveOfficialExternalPluginRepairHint } from "./official-external-plugin-repair-hints-j_OVh0S0.js";
import { t as describeImageWithModel } from "./image-runtime-CYuu4eVp.js";
import { a as DEFAULT_TIMEOUT_SECONDS, l as getMediaUnderstandingProvider, n as DEFAULT_MAX_BYTES, o as DEFAULT_VIDEO_MAX_BASE64_BYTES, s as MIN_AUDIO_FILE_BYTES, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-DswYbkvd.js";
import { t as assertRuntimeMediaRequestSecretOwnerAvailable } from "./runtime-media-secret-owner-xJvrDBVt.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-BPPWpfQ1.js";
...
import { a as extractImageContentFromSource } from "./input-files-C8v3Mf63.js";
...
const loadModelAuth = createLazyRuntimeModule(async () => await import("./model-auth-q0YP1OW6.js"));
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-C5pvkx-n.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
