...
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-contributions-Dt1rr-bF.js";
...
import { n as resolveSecretRefValue } from "./resolve-D0oi7G5Z.js";
...
import { f as pruneTerminalOperatorApprovals, n as closeOrphanedOperatorApprovals } from "./operator-approval-store-CDAeuc7d.js";
...
import { j as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-EA-WQccl.js";
import { c as getActiveSecretsRuntimeSnapshotRevisionState, l as getActiveSecretsRuntimeSnapshotState, o as getActiveSecretsRuntimeEnvState } from "./runtime-state-CGaTBGZ5.js";
import { t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-Cm2vBQyn.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-AFz8ustk.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-_pjvVPDW.js";
import { f as formatExecApprovalExpiresIn } from "./exec-approval-reply-BdhhJCfN.js";
...
import { a as buildTypedApprovalPendingReplyPayload, i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, o as buildTypedPluginApprovalPendingReplyPayload } from "./approval-renderers-BSOxaOLZ.js";
import { d as listDevicePairing, l as hasEffectivePairedDeviceRole } from "./device-pairing-CFVs8foo.js";
import { t as diffConfigPaths } from "./config-diff-i67fSCq8.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-C1eSRqp3.js";
import { g as resolveApnsRelayConfigFromEnv, i as clearApnsRegistrationIfCurrent, l as loadApnsRegistrations } from "./push-apns-store-BZ2NS8-f.js";
import { t as resolveApprovalSessionAudienceWithFallback } from "./approval-session-audience-B59z_jGl.js";
import { t as SYSTEM_AGENT_APPROVAL_DECISIONS } from "./system-agent-approvals-BczGX_94.js";
import { a as sendApnsPluginApprovalAlert, c as resolveApnsAuthConfigFromEnv, i as sendApnsExecApprovalResolvedWake, o as sendApnsPluginApprovalResolvedWake, r as sendApnsExecApprovalAlert, s as shouldClearStoredApnsRegistration } from "./push-apns-DAt0Ha7N.js";
import { n as ExecApprovalManager } from "./exec-approval-manager-CPQWh2Yj.js";
import { t as QuestionManager } from "./question-manager-DqQa8y-S.js";
import { t as publishAppliedApprovalResolution } from "./approval-publication-Kl8H6DXv.js";
...
async function activateSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, options) {
	const runtime = await import("./runtime-C5u6SU5w.js");
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = createLazyPromise(() => import("./exec-approval-Db3mfm60.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: execApprovalIosPushDelivery
	})), { cacheRejections: true });
	const questionManager = new QuestionManager();
	const loadQuestionHandlers = createLazyPromise(() => import("./question-YJn5Hfzk.js").then(({ createQuestionHandlers }) => createQuestionHandlers(questionManager)), { cacheRejections: true });
	...
	const loadPluginApprovalHandlers = createLazyPromise(() => import("./plugin-approval-B9J9JvoU.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: pluginApprovalIosPushDelivery
	})), { cacheRejections: true });
	const loadApprovalHandlers = createLazyPromise(() => import("./approval-hFolt4ug.js").then(({ createApprovalHandlers }) => createApprovalHandlers({
		execApprovalManager,
	...
	const loadSecretsHandlers = createLazyPromise(() => import("./secrets-BeslQHmR.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
