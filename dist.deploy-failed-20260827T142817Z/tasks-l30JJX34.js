...
import { da as validateTasksCancelParams, fa as validateTasksGetParams, ma as validateTasksRecoveryParams, pa as validateTasksListParams } from "./src-Bo4ezI_n.js";
import { s as errorShape } from "./error-codes-CMSvT5-d.js";
import { w as listTaskRecordPage, x as getTaskById } from "./task-registry-CV6EhTBX.js";
...
import { i as retrySubagentCompletionDelivery, n as dismissSubagentCompletionDelivery } from "./subagent-completion-delivery-ClRf4tJs.js";
...
const tasksHandlers = {
	...
	"tasks.dismiss": async ({ params, respond }) => {
		...
		const { discardSubagentTerminalDelivery } = await import("./subagent-registry-CCzLJbcn.js");
		const results = [];
		for (const taskId of params.taskIds) {
