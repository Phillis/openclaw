...
async function runDoctorHealthFlow(runtime, options = {}) {
	...
	const { createDoctorPrompter } = await import("./doctor-prompter-Dlf5vjtI.js");
	...
	const { maybeOfferUpdateBeforeDoctor } = await import("./doctor-update-BB9sUOPp.js");
	...
	const { noteStartupOptimizationHints } = await import("./doctor-platform-notes-DzZOOSEG.js");
	await maybeRepairUiProtocolFreshness(effectiveRuntime, prompter);
	noteSourceInstallIssues(root);
	await noteStalePluginRuntimeSymlinks(root);
	noteStartupOptimizationHints();
	const { loadAndMaybeMigrateDoctorConfig } = await import("./doctor-config-flow-5g_Dui04.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-DIm72VY-.js");
