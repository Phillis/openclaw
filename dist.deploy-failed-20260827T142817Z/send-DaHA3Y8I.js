...
import { a as fromBuffer, t as APEv2Parser } from "./APEv2Parser-KORAmI0u.js";
...
import { r as hasID3v1Header } from "./ID3v1Parser-BfyNgYDc.js";
import { createHash } from "node:crypto";
import { fileTypeFromBuffer } from "file-type";
//#region extensions/matrix/src/matrix/send/client.ts
const loadMatrixSendClientRuntime = createLazyRuntimeModule(() => import("./client-bootstrap-B4asTxD3.js"));
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-VsNbJbse.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-rsa1OPZk.js")).APEv2Parser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CRjZu8ww.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BBNB9MTA.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-jnIokr7t.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-Dz7B-rea.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CSY2j-Jy.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-BBJFIzyd.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-Bxw9rkqe.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DXG9OBYN.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-mXNnPXw2.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BkAlz5UW.js")).WaveParser;
	}
};
//#endregion
