...
import { i as root$1 } from "./root-impl-YIsYOvqy.js";
import { c as assertNoSymlinkParents } from "./regular-file-CXw3t-8J.js";
...
import { a as listAgentIds, b as tryResolveLegacyCompatibilityAgentId, d as resolveAgentWorkspaceDir, s as resolveAgentConfig } from "./agent-scope-config-BdXMWufB.js";
...
import { i as isPerAgentSessionStoreConfig } from "./session-store-owner-BGbniDph.js";
...
import { c as resolveLegacyInstalledPluginIndexStorePath } from "./installed-plugin-index-record-reader-DArXGVRI.js";
import { f as clearNodeSqliteKyselyCacheForDatabase, l as runSqliteDeferredTransactionSync, t as openNodeSqliteDatabase, u as runSqliteImmediateTransactionSync } from "./node-sqlite-sCL6pEgr.js";
import { _ as getNodeSqliteKysely, f as OPENCLAW_SQLITE_BUSY_TIMEOUT_MS, g as executeSqliteQueryTakeFirstSync, h as executeSqliteQuerySync, o as readSqliteUserVersion, r as resolveOpenClawStateSqlitePath } from "./openclaw-state-db.paths-D5QeoU_L.js";
import { D as detectOpenClawStateDatabaseSchemaMigrations, Mt as tableExists, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction, m as repairOpenClawStateDatabaseSchemaIfNeeded, p as repairOpenClawStateDatabaseSchema, pn as repairCanonicalSqliteIndexes } from "./openclaw-state-db-CXrhNigN.js";
...
import "./installed-plugin-index-store-BIcBJeAh.js";
import { n as collectRelevantDoctorPluginIds, o as listPluginDoctorSessionStoreAgentIds, s as listPluginDoctorStateMigrationEntries } from "./doctor-contract-registry-DydVIuPK.js";
import { n as resolveSessionStoreCompatibilityAgentId } from "./legacy.default-agent-owner-D8ws5hED.js";
import { n as readConfigMachineState, r as updateConfigMachineState, t as importConfigMachineState } from "./config-machine-state-Da8Lk82e.js";
...
import { t as createSqliteAuditRecordStore } from "./sqlite-audit-record-store-qYxNnuLf.js";
import { n as CONFIG_AUDIT_SCOPE, t as CONFIG_AUDIT_MAX_ENTRIES } from "./io.audit-CQ4YEkdI.js";
import { n as createFileLockManager } from "./file-lock-keX9WGUw.js";
...
import { n as acquireGatewayLock } from "./gateway-lock-EiOnxvh_.js";
import { c as resolveSharedMainAuthAgentDir, n as noteCommittedSharedAuthStoreOwnership, o as resolveSharedAuthStoreOwnership, t as SHARED_AUTH_STORE_STATE_KEY } from "./path-resolve-DH_naXF5.js";
import { i as closeOpenClawAgentDatabaseByPath, v as runOpenClawAgentWriteTransaction } from "./openclaw-agent-db-CyHApqW_.js";
import { E as listOpenClawRegisteredAgentDatabases, S as isPersistentOpenClawAgentDatabasePath, T as unregisterOpenClawAgentDatabase, b as OPENCLAW_AGENT_SCHEMA_SQL, n as assertOpenClawAgentDatabaseOwner, o as ensureOpenClawAgentDatabaseSchema, s as migrateOpenClawAgentDatabaseToMediaPrerequisiteSchema, u as assertOpenClawAgentSchemaContains, w as registerOpenClawAgentDatabase, x as createOpenClawAgentDatabasePathMatcher } from "./openclaw-agent-db-maintenance-1xIPEKIN.js";
import "./openclaw-agent-db-migration-required-RkIFq1cn.js";
import { p as resolveAuthProfileDatabaseOwnerId, t as closeAuthProfileReadPool } from "./sqlite-R6lp3fio.js";
import { h as getPluginStateCapacity, i as importPluginStateEntriesForDoctor, n as createPluginStateKeyedStore } from "./plugin-state-store-3qJxZb8E.js";
import { Jt as listSessionEntryKeysReadOnly } from "./session-accessor-CVnxp3UM.js";
import { t as getChannelPlugin } from "./registry-CWrpiLCs.js";
import { c as resolveSessionStoreTargets, d as resolveAgentSessionDirsFromAgentsDirSync } from "./targets-BzJLDErS.js";
...
import { d as rewriteSqliteTranscriptEventRowsInTransaction } from "./session-accessor.sqlite-transcript-store-DmssQj1u.js";
...
import { a as isSafeWorkspaceAttestationFilename, d as resolveWorkspaceStateIdentity, l as registerWorkspaceStateAliasesInTransaction, n as WORKSPACE_LEGACY_STATE_MIGRATION_KIND } from "./workspace-state-store-UQmL7k4K.js";
import { n as LEGACY_WORKSPACE_ATTESTATION_HEADER, o as WORKSPACE_DOCTOR_CLAIM_SUFFIX, r as LEGACY_WORKSPACE_ATTESTATION_MAX_BYTES, t as LEGACY_WORKSPACE_ATTESTATION_DIRNAME, u as resolveLegacyWorkspaceSourcePaths } from "./workspace-legacy-state-DZx3hw9m.js";
import { n as SYSTEM_AGENT_AUDIT_SCOPE, t as SYSTEM_AGENT_AUDIT_MAX_ENTRIES } from "./audit-DPaGSfB4.js";
...
import { n as parseRestartSentinelEnvelope, o as writeRestartSentinelRowSync, r as readRestartSentinelRowSync } from "./restart-sentinel-store-BN3C3WhT.js";
import { f as mcpOAuthStoreKeyFromLegacyFileName, o as parseMcpOAuthStoreJson } from "./mcp-oauth-store-Bo-TrnIS.js";
import { r as resolveSandboxWorkspaceLayoutPaths } from "./shared-CiBmkGZf.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-C-WC19Mc.js";
import { a as transcriptSessionExportKey, i as safeTranscriptPathSegment, n as renderTranscriptsMarkdown, o as transcriptSessionSelector, s as ensureMeetingTranscriptsSchema, t as TranscriptsStore } from "./store-D87LWrJL.js";
import { C as rewriteRegistryWorktreePathsForMigration, g as hasLegacyRegistryWorktrees, s as discardLegacyRegistryWorktrees, x as listRegistryWorktreesForMigration } from "./registry-C0l4nYnM.js";
import { a as updateChannelPairingStateSnapshot, c as resolveAllowFromAccountId, l as safeAccountKey, s as dedupePreserveOrder, u as getPairingAdapter } from "./pairing-store-sqlite-CS-nPbLY.js";
import { a as readSessionStoreJson5, n as existsDir, o as safeReadDir, r as migrationFileExists, t as ensureMigrationDir } from "./state-migrations.fs-CwpmjiYn.js";
import { t as migrateLegacyMainSessionKeys } from "./legacy-main-session-migration-cgQgjBNn.js";
import { c as managedImageRecordToRow, l as managedImageRecordsEqual, s as managedImageRecordFromRow, t as MANAGED_OUTGOING_ORIGINALS_SUBDIR } from "./managed-image-record-store-KkaoRbJz.js";
import { n as normalizeVoiceWakeRoutingConfig } from "./voicewake-routing-BU2lwIfz.js";
import { n as LEGACY_NODE_HOST_CONFIG_FILE, r as NODE_HOST_CONFIG_KEY, t as LEGACY_NODE_HOST_CONFIG_CLAIM_SUFFIX } from "./config-Cc9hY0kv.js";
import { _ as migrateLegacyDeviceAuth, a as assertLegacyMigrationSourceUnchanged, c as legacyMigrationPathMayExist, d as readLegacyMigrationSourceSnapshot, f as readLegacyMigrationSourceSnapshotSync, g as detectLegacyDeviceAuth, h as detectLegacyDeviceIdentity, i as LegacyMigrationSourceClaim, l as legacyMigrationSourceOrClaimMayExist, m as restoreLegacyMigrationSourceClaims, n as migrateLegacyExecApprovals, o as claimAndRemoveLegacyMigrationSource, p as resolveLegacyMigrationRelativePath, r as migrateLegacyDeviceIdentity, s as claimLegacyMigrationSourceClaims, t as detectLegacyExecApprovals, u as legacyMigrationSourceSnapshotsMatch, v as withLegacyMigrationStateLock } from "./state-migrations.exec-approvals-CxjTKxPk.js";
import { a as recordLegacyMigrationRun, i as recordLegacyMigrationReceipt, n as readLegacyMigrationReceipt, o as recordLegacyMigrationSource, r as readLegacyMigrationReceiptFromDatabase, s as resolveLegacyMigrationSourceKey, t as markLegacyMigrationSourceRemoved } from "./state-migrations.receipts-BeM1W-qr.js";
import { c as repairGatewayAgentMediaMigrationStartupFailures } from "./gateway-boot-lifecycle-DGPgfovT.js";
import { c as recordsAfterLegacyAuditRawCheckpoint, d as prepareLegacyAuditRecords, f as serializePreparedAuditRecords, g as legacyAuditSourceGenerationKey, l as restoreInterruptedAuditRecoveryArchive, m as hasLegacyAuditRawCheckpointCapacity, n as finalizeLegacyAuditRecoveryArchive, o as readLegacyAuditSourceSnapshot, p as detectLegacyAuditLogs, r as findPreviousLegacyAuditRawCheckpoint, s as recordLegacyAuditRawCheckpoint, t as withLegacyAuditMigrationLease, u as scrubLegacyAuditRecoveryArchive } from "./state-migrations.audit-coordination-C9GWURiQ.js";
import { a as isLegacyControlUiDeviceAuthMigrationInput, t as CONTROL_UI_DEVICE_AUTH_MIGRATION_STATE_KEY } from "./control-ui-device-auth-migration-DnKtXL1d.js";
import { d as normalizeApnsNodeId, m as normalizeCanonicalApnsRegistration, n as apnsRegistrationFromRow, o as isValidApnsNodeId, r as apnsRegistrationToRow, u as normalizeApnsEnvironment } from "./push-apns-store-BZ2NS8-f.js";
import { _ as selectNewerSessionEntry, a as isAmbiguousSharedStoreKey, c as mergeSessionStoreAliasPlans, d as normalizeSessionEntry, f as pickLatestLegacyDirectEntry, g as saveSessionStoreStrict, h as resolveStaleLegacySessionFile, i as emptyDirOrMissing, l as migrateLegacyAcpSessionMetadata, m as resolveSessionStoreOwnership, n as canonicalizeSessionStore, o as isLegacyDefaultMainAliasKey, p as removeDirIfEmpty, r as distinctSessionStoreAliasWarning, s as listLegacySessionKeys, t as aliasedSessionStoreMigrationWarning, u as migrateOrphanedSessionKeys, v as unresolvedSessionStoreIdentityWarning } from "./state-migrations.session-store-CkL1BN9r.js";
import { a as PLUGIN_STATE_SQLITE_SIDECAR_SUFFIXES, c as hasPendingSqliteSidecarArchive, d as migrateLegacyDeliveryQueues, f as migrateLegacyTaskStateSidecars, g as resolveLegacyTaskRunsSidecarPath, h as resolveLegacyPluginStateSidecarPath, l as listLegacyDeliveryQueueDeliveredMarkers, m as resolveLegacyFlowRunsSidecarPath, n as migrateLegacyPluginStateSidecar, o as TASK_STATE_SQLITE_SIDECAR_SUFFIXES, p as resolveLegacyDeliveryQueuePath, r as preflightLegacyInstalledPluginIndexMigration, s as archiveLegacyImportSource, t as migrateLegacyInstalledPluginIndex, u as listLegacyDeliveryQueueFiles } from "./state-migrations.plugin-state-Bsfmg7KL.js";
import { c as isValidWebPushEndpoint, g as webPushVapidKeyPairToRow, h as webPushSubscriptionsEqual, l as isValidWebPushKey, m as webPushSubscriptionToRow, n as WEB_PUSH_VAPID_KEY_ID, o as hashWebPushEndpoint, p as webPushSubscriptionFromRow, r as createWebPushVapidKeyPair } from "./push-web-store-D5iyml6w.js";
...
async function autoMigrateLegacyState(params) {
	...
	const legacySessionSurfaces = params.legacySessionSurfaces ?? (await import("./legacy-session-surfaces-BcAQSliP.js")).prepareLegacySessionSurfaces({
		config: params.cfg,
		env
	});
