...
import { i as closeOpenClawStateDatabaseByPath } from "./openclaw-state-db-CXrhNigN.js";
import { i as listAvailableManifestContractPlugins, o as loadManifestContractSnapshot } from "./manifest-contract-eligibility-DppTp7ET.js";
import { g as openOpenClawAgentDatabase, l as disposeOpenClawAgentDatabaseByPath } from "./openclaw-agent-db-CyHApqW_.js";
import { T as unregisterOpenClawAgentDatabase, w as registerOpenClawAgentDatabase } from "./openclaw-agent-db-maintenance-1xIPEKIN.js";
import { n as clearRuntimeAuthProfileStoreSnapshot } from "./store-DOJuehrg.js";
import { r as resolveOnboardingAgentTarget, t as applyOnboardingPrimaryModel } from "./onboard-agent-target-RTxUCH5n.js";
...
import { o as writeMigrationReport } from "./migration-runtime-BnpyKt6m.js";
...
const loadAuthChoiceModule = createLazyRuntimeModule(() => import("./auth-choice-V07-KoVh.js"));
const loadModelPickerModule = createLazyRuntimeModule(() => import("./model-picker-C5iDV_M1.js"));
async function resolveAuthChoiceModelSelectionPolicy(params) {
	...
	const [{ resolveManifestProviderAuthChoice }, { resolvePluginSetupProviderCore }] = await Promise.all([import("./provider-auth-choices-D_M8NhVP.js"), import("./setup-registry-t2aHKCex.js")]);
...
async function runSetupModelAuthStep(params) {
	...
	if (authChoiceFromPrompt) {
		const [{ ensureAuthProfileStore }, { promptAuthChoiceGrouped: promptAuthChoice, isKeepCurrentAuthChoice: isKeepCurrentChoice }, { detectAvailableSetupProviderIds }] = await Promise.all([
			...
			import("./auth-choice-prompt-CFzpTPfJ.js"),
			import("./provider-setup-availability-D50mAIO2.js")
		]);
	...
	while (true) {
		...
		if (authChoice === "custom-api-key") {
			const { promptCustomApiConfig } = await import("./onboard-custom-CCfd_1Y3.js");
...
async function createPromotionConfigRuntime(config) {
	const { mutateConfigFile } = await import("./mutate-DLKlqTPQ.js");
...
const loadMigrationProviderRuntimeModule = createLazyRuntimeModule(() => import("./migration-provider-runtime-BoRZVSJH.js"));
const loadMigrationContextModule = createLazyRuntimeModule(() => import("./context-CNw3wGIy.js"));
