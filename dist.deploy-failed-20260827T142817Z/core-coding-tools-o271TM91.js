...
import { n as openRootFileFollowingParents } from "./boundary-file-read-BoOq_oud.js";
...
import { n as toRelativeSandboxPath, t as resolvePathFromInput } from "./path-policy-fuudDMle.js";
import { l as rewrapToolWithBeforeToolCallHook, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-aNXucund.js";
import { B as withFileMutationQueues, D as createReadTool, H as hasOnlyCrlfLineEndings, U as normalizeToLF, V as decodeUtf8File, W as restoreLineEndings, z as withFileMutationQueue } from "./sessions-CfDirsu7.js";
import { g as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-B8EtrfM_.js";
import { S as isToolWrappedWithBeforeToolCallHook, d as copyAgentToolMetadata } from "./gateway-Cl3WHu5g.js";
import { c as resolveReadOnlyWorkspaceSkillMounts } from "./workspace-mounts-BsoH3efL.js";
import { t as applyExecPolicyLayer } from "./exec-policy-tn35_vey.js";
import { n as mergeGatewayAgentCliPath } from "./openclaw-cli-shim-Bxxlmk9C.js";
import { t as wrapToolWithAbortSignal } from "./agent-tools.abort-7L6PDrUh.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-ZlXMj4QB.js";
import { a as createSandboxedReadTool, f as withMemoryWriteProvenance, i as createSandboxedEditTool, l as wrapToolWorkspaceRootGuard, n as createHostWorkspaceWriteTool, o as createSandboxedWriteTool, r as createOpenClawReadTool, s as wrapReadToolWithSkillContent, t as createHostWorkspaceEditTool, u as wrapToolWorkspaceRootGuardWithOptions } from "./agent-tools.read-C6k6yLAW.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-md5t1l9z.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-F-bJ388b.js";
...
const bashToolsModuleLoader$1 = createLazyImportLoader(() => import("./bash-tools-D5xapws6.js"));
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-D5xapws6.js"));
