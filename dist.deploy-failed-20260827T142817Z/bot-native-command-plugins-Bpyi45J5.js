...
import { b as resolveTelegramMessageThreadSpec, c as buildTelegramThreadParams, d as extractTelegramForumFlag, g as resolveTelegramForumFlag, r as buildTelegramGroupFrom, s as buildTelegramRoutingTarget } from "./helpers-C3wiEYox.js";
import { c as buildInlineKeyboard } from "./prompt-context-projection-B85u-zfc.js";
import { $ as recordSentMessage } from "./send-OfWBMNtf.js";
import { t as withTelegramApiErrorLogging } from "./api-logging-Dde_MbF1.js";
import { n as prepareTelegramCommandDispatch } from "./bot-native-command-dispatch-DhHmp-pp.js";
...
async function executeTelegramPluginCommand(params) {
	...
	const from = dispatch.isGroup ? buildTelegramGroupFrom(dispatch.chatId, dispatch.threadSpec.id) : `telegram:${dispatch.chatId}`;
