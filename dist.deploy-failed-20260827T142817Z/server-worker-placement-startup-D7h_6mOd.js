...
import { n as resolveManifestActivationPluginIds } from "./activation-planner-Bajkq1wM.js";
...
import { Qt as loadSessionEntry, gt as normalizeUsage, mt as hasNonzeroUsage, tt as withTranscriptWriteTransaction } from "./session-accessor-CVnxp3UM.js";
import { h as onSessionIdentityMutation, m as emitSessionLifecycleEvent } from "./session-accessor.sqlite-lifecycle-DM-jpNkz.js";
import { $ as runExclusiveSessionStoreWrite, K as interruptSessionWorkAdmissions, R as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS, X as runExclusiveSessionLifecycleMutation } from "./agent-harness-session-key-D5rklW6u.js";
...
import { I as convertToLlm } from "./agent-core-r8cobJ0S.js";
...
import { n as measureAgentRuntimeIdentityTokenBytes, r as mintAgentRuntimeIdentityToken } from "./agent-runtime-identity-token-IUBMoTIB.js";
import { t as resolveConversationCapabilityProfile } from "./conversation-capability-profile-Bery-vw5.js";
import { t as createPreprovisionedSshSandboxBackend } from "./ssh-backend-DVQ-nxjR.js";
...
import { C as mergeUsageIntoAccumulator, a as buildUsageAgentMetaFields, x as createUsageAccumulator, y as resolveReportedModelRef } from "./helpers-Y7aoqheu.js";
...
import { a as isDeviceWorkerAvailable } from "./device-provider-qXBtzPgH.js";
...
import { t as ActiveTurnClaimError } from "./placement-turn-claims-sXO_BKVd.js";
...
const loadPlacementSessionEvidenceRuntime = createLazyRuntimeModule(async () => {
	const [sessionUtils, sessionAccessor] = await Promise.all([import("./session-utils-Dm9CWkB8.js"), import("./session-accessor-Dthyfbtw.js")]);
	return {
...
const loadWorkerPlacementSessionRuntimeModule = createLazyRuntimeModule(async () => {
	const [placementSessionRuntime, { managedWorktrees }, sessionUtils] = await Promise.all([
		import("./placement-session-runtime-BmcLv0PW.js"),
		import("./service-D7sGCZg1.js"),
