...
import { a as resolveAgentHarnessOwnerPluginId, n as getRegisteredAgentHarness, r as listRegisteredAgentHarnesses } from "./registry-RzPPae7_.js";
import { a as unwrapSecretSentinelsForProviderEgress, i as unwrapModelHeaderSentinelsForProviderEgress } from "./provider-secret-egress-Cl2Qy4wH.js";
import { f as resolveProviderRefOwnership } from "./providers-63828CFG.js";
import { i as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-CAkySZhG.js";
import { t as resolveAgentHarnessAutoSelectionHint } from "./auto-selection-Br-mlD8Y.js";
import { c as compareHarnessSupport, l as resolveAgentHarnessPreparedAuthSupport, s as buildAgentHarnessSupportContext, u as resolveAgentHarnessPreparedRouteSupport } from "./thinking-runtime-CvHDRR81.js";
...
import { n as isBuiltInOpenClawAgentHarness, t as createOpenClawAgentHarness } from "./builtin-openclaw-DTeM8adv.js";
...
import { i as EmptySettledTurnFinalizationError, t as assertSettledTurnFinalizationResult } from "./settled-turn-finalization-result-BWIM2nfh.js";
...
async function runSelectedAgentHarnessAttempt(params) {
	...
	if (internalParams.systemAgentTool && !isSystemAgentOnlyAllowlist(internalParams.toolsAllow)) throw new Error("OpenClaw host authority requires toolsAllow: [\"openclaw\"]");
	const ringZeroTools = internalParams.systemAgentTool ? [(await import("./system-agent-tool-DXSQgcHL.js")).createSystemAgentTool(internalParams.systemAgentTool)] : [];
