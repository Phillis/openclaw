...
import { c as readSessionTranscriptBoundedMessageTailPage, x as isSessionTranscriptProjectionUnavailableError } from "./session-accessor-CVnxp3UM.js";
import { g as onSessionLifecycleEvent } from "./session-accessor.sqlite-lifecycle-DM-jpNkz.js";
...
import "./prepared-model-runtime-BNByaYVk.js";
import { t as configureExecutionIdentityAdmissionSink } from "./execution-identity-admission-qTUfCaTZ.js";
...
import { r as stripToolMessages, t as extractStoredAssistantText } from "./chat-history-text-Bi-5yBsM.js";
...
import { f as markChatAbortTerminalPersistenceError, s as removeChatAbortControllerEntry } from "./chat-abort-BBAKYOB6.js";
...
import { i as terminalHealthFor, n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-CPROeCDP.js";
...
function startGatewayEventSubscriptions(params) {
	...
	const agentEventHandlerLoader = createLazyPromiseLoader(() => {
		return Promise.all([import("./server-chat-BjCZr0nZ.js"), import("./server-session-key-keAJaIGM.js")]).then(([{ createAgentEventHandler }, { resolveSessionKeyForRun }]) => createAgentEventHandler({
	...
	const getSessionEventsModule = createLazyPromise(() => import("./server-session-events-DXxVxzP1.js"), { cacheRejections: true });
	...
	const taskObserverRuntimePromise = import("./task-registry.store-Dp2Jys0M.js").then((module) => {
