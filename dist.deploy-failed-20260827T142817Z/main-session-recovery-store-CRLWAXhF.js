...
import { Ot as applySessionEntryReplacements } from "./session-accessor-CVnxp3UM.js";
import { a as transitionMainSessionRecovery, n as isMainRestartRecoveryCandidate, r as isMainSessionRecoveryPending } from "./main-session-recovery-state-BkgEXAzo.js";
import { a as scheduleMainSessionRecoveryMutation, i as retryMainSessionRecoveryMutation } from "./main-session-recovery-lifecycle-5u5u8crU.js";
...
function scheduleMainSessionRecoveryOwnerRelease(lease, onDeferredSuccess) {
	scheduleMainSessionRecoveryMutation({
		...
		onSuccess: onDeferredSuccess ?? (async (pending) => {
			if (pending) {
				const { scheduleMainSessionRecoveryPendingTarget } = await import("./main-session-recovery-owner-release-DZNcTZ0a.js");
