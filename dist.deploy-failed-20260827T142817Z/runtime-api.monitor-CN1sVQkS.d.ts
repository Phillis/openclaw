import { B as buildChannelInboundEventContext, G as ChannelIngressContextBinding, K as ResolvedChannelMessageIngress, U as NativeCommandSpec, W as SessionBindingRecord, o as PluginCommandContext, s as PluginCommandResult, v as ChannelIngressQueue } from "./types-DYqBZyXL.js";
import { H as ReplyToMode, h as DiscordAccountConfig, n as OpenClawConfig, v as DiscordGuildEntry, y as DiscordIntentsConfig } from "./types.openclaw-Djf9z9fV.js";
import { ft as resolveAgentRoute, ut as ChannelRuntimeSurface } from "./setup-wizard-types-BJbOEFA2.js";
import { E as RuntimeEnv$1 } from "./manifest-registry-CHpEok17.js";
import { h as InboundEventKind, l as HistoryEntry } from "./templating-B3rf5Xpv.js";
import { n as ChannelIngressMonitorLifecycle, t as ChannelIngressMonitorDeliveryResult } from "./channel-outbound-qWHa8XwZ.js";
import { M as GatewayPresenceUpdate, P as ChannelType, _ as GatewayPresenceUpdateData, a as Command, b as GatewayVoiceStateUpdateData, d as Guild, f as User, h as DiscordCommandDeployHashStore, i as Plugin, j as APIGatewayBotInfo, k as APIMessage, n as MessageCreateListener, r as Client, t as DiscordMessageDispatchData, v as GatewayReceivePayload, x as APIVoiceState, y as GatewaySendPayload } from "./discord-cCABK3Ro.js";
import { p as ThreadBindingManager } from "./thread-bindings-C9Gyjrix.js";
import { t as MediaPlaceholderTextFact } from "./reply-reference-C3oec0nh.js";
