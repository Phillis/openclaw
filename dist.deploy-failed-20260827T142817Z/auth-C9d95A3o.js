...
import { i as resolvePluginSetupRegistry, r as resolvePluginSetupProviderCore } from "./setup-registry-CN-wV6fv.js";
...
import { n as clearAuthProfileCooldown } from "./usage-CztrY32v.js";
...
import { o as removeProviderAuthProfilesWithLock, r as promoteAuthProfileInOrder, u as upsertAuthProfileWithLockOrThrow } from "./profiles-DfGTvDcU.js";
...
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-BJGFEWWU.js";
...
import { a as resolveKnownAgentId, l as updateConfig, r as loadValidConfigOrThrow } from "./shared-B-IYMANI.js";
import { r as repairCodexRuntimePluginInstallForModelSelection } from "./codex-runtime-plugin-install-By0XJNsa.js";
import { n as repairCopilotRuntimePluginInstallForModelSelection } from "./copilot-runtime-plugin-install-DAyZqJYM.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: params.openUrl ?? (async (url) => {
			const { openUrl } = await import("./onboard-helpers-DG0mt_gD.js");
			await openUrl(url);
		}),
