...
import { b as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog } from "./model-selection-shared-DT9x3Cg2.js";
...
import { c as resolveThinkingProfile } from "./thinking-KBBrAmGh.js";
...
import { $t as loadSessionEntryReadOnly, K as updateSessionEntry, Pt as listSessionEntriesCore, en as patchSessionEntryCore, in as replaceSessionEntry, qt as listSessionEntriesReadOnly } from "./session-accessor-CVnxp3UM.js";
import { a as rollbackPluginOwnedSessionEntryLifecycle, i as rollbackAgentHarnessSessionEntryLifecycle, n as deleteSessionEntryLifecycle } from "./session-accessor.sqlite-lifecycle-DM-jpNkz.js";
import { X as runExclusiveSessionLifecycleMutation, Y as isSessionWorkAdmissionActive, w as normalizeResolvedMaintenanceConfigInput, z as beginSessionWorkAdmission } from "./agent-harness-session-key-D5rklW6u.js";
...
import { o as resolveEffectiveAgentRuntime, t as concretizeAgentRuntime } from "./thinking-runtime-CvHDRR81.js";
...
import { B as createManagedTaskFlow, K as finishFlow, O as listTasksForFlowId, Q as requestFlowCancel, W as failFlow, et as resumeFlow, tt as setFlowWaiting } from "./task-registry-CV6EhTBX.js";
import "./runtime-internal-CbPNKBWW.js";
import { _ as getTaskFlowByIdForOwner, d as getFlowTaskSummary, g as findLatestTaskFlowForOwner, p as runTaskInFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById, v as listTaskFlowsForOwner, y as resolveTaskFlowForLookupTokenForOwner } from "./task-executor-CupwMNYy.js";
...
import { a as resolveInheritedToolPolicyForSession, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./agent-tools.policy-D3C_cMAq.js";
import { n as loadWebMedia } from "./web-media-CJi3g5iH.js";
import { z as normalizeExecTarget } from "./exec-approvals-EA-WQccl.js";
import { n as generateMusic, r as listRuntimeMusicGenerationProviders } from "./openclaw-tools-mwvSTuhZ.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "./task-owner-access-CkokYcSR.js";
import { o as resolveEffectiveSessionToolsVisibility } from "./session-visibility-ZrDMRxJ9.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CvMujUVK.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-D9NfRp-D.js";
import { i as listWebSearchProviders, o as runWebSearch } from "./runtime-CPtjiOKD.js";
...
import { t as createRuntimeChannel } from "./runtime-channel-CGXFI-li.js";
...
async function createSessionEntry(params) {
	const [{ createGatewaySession }, { resolveGatewaySessionStoreTarget }, { readAcpSessionMetaForEntry, upsertAcpSessionMeta }] = await Promise.all([
		import("./session-create-service-DHDk9opK.js"),
		import("./session-utils-Dm9CWkB8.js"),
		import("./session-meta-VhNYsQdl.js")
	]);
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("./heartbeat-runner-wu5W7BxK.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRequestRuntime = createLazyRuntimeModule(() => import("./runtime-tts-request-CC8c98Qt.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-1r6vNBWj.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime.js"));
const loadGatewayPluginRuntime = createLazyRuntimeModule(() => import("./server-plugins-DeJeGH38.js"));
...
function createRuntimeLlmFacade() {
	const loadAcquireLocalService = createLazyRuntimeMethod(() => import("./provider-local-service-AYJpUIxL.js"), (runtime) => runtime.createConfiguredProviderLocalServiceAcquirer(getRuntimeConfig));
...
function createRuntimeWorktrees() {
	const loadService = () => import("./service-D7sGCZg1.js");
	return {
...
function createRuntimeSandbox(agent) {
	...
	return {
		...
		async prepareWorkspaceAuthority(params) {
			...
			const { resolveSandboxContext } = await import("./context-CLIxrDlY.js");
