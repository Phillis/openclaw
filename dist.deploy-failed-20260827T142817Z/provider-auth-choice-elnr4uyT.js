...
import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-Be8yPp6p.js";
import { n as openUrl } from "./browser-open-DTXTf0UR.js";
import { t as isRemoteEnvironment } from "./remote-env-CEqMOcgu.js";
import { n as t } from "./i18n-BzsUVhtU.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-BJGFEWWU.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-c1dAduEh.js";
import { r as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-C6MrhGt6.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-zYBwO5JL.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-DDKnMLDY.js");
