...
import { i as getBundledChannelSetupPlugin } from "./bundled-ZTUPeZJP.js";
...
import { a as normalizeChannelId, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CWrpiLCs.js";
import "./plugins-2lW9dSyY.js";
import { r as parseOptionalDelimitedEntries } from "./helpers-C-WC19Mc.js";
import { s as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-DKfRvbZ6.js";
...
import { n as resolveChannelSetupCliOptionMetadata } from "./cli-add-options-CfgUvM3k.js";
import { n as requireValidConfigFileSnapshot } from "./config-validation-Dz7Ic7mK.js";
import { t as normalizeExternalChannelSetupConfig } from "./config-compatibility-pPylkS2n.js";
import { c as shouldUseWizard } from "./shared-DSQg0p47.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-BRbKmCrJ.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-BN2qE8ec.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-BNkdRVrg.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-DhhRGw99.js").then(({ listRawChannelPluginCatalogEntries }) => listRawChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		...
		const { resolveInitialWizardChannel, runChannelsAddWizardFlow } = await import("./add-wizard-DW7V8_e7.js");
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-shF9VpRF.js");
