...
import { g as supportsClaudeNativeXhighEffort, o as resolveClaudeFable5ModelIdentity, p as supportsClaudeAdaptiveThinking } from "./src-88rHSicm.js";
...
function buildFoundryImageDefaultPatch(params) {
	...
	return { agents: { defaults: { mediaModels: { image: { primary: `${PROVIDER_ID}/${params.modelId}` } } } } };
}
