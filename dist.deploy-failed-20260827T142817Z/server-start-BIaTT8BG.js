...
import { B as captureConfigOverrideApplier, l as readConfigFileSnapshot, o as promoteConfigSnapshotToLastKnownGood, r as getRuntimeConfig, u as readConfigFileSnapshotForRuntimeTransaction, v as registerConfigWriteListener } from "./io-D1h6pxaD.js";
...
import { x as assertOpenClawStateWriteAllowedAtPath } from "./openclaw-state-db-CXrhNigN.js";
import { r as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-B1YRfQOc.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-DqufLoUx.js";
import { t as completePluginMetadataSnapshot } from "./plugin-metadata-snapshot-BfWhFzZN.js";
...
import { c as listCoreGatewayMethodNames, n as createCoreGatewayMethodDescriptors, r as isCoreGatewayMethodClassified, t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./core-descriptors-CrDEzuuq.js";
...
import { f as setGatewaySigusr1RestartPolicy, p as setPreRestartDeferralCheck } from "./restart-B3HJgSVH.js";
import { r as readGatewayRestartHandoffSync } from "./restart-handoff-1yy1YLaY.js";
...
import { m as stopDiagnosticHeartbeat, p as startDiagnosticHeartbeat } from "./diagnostic-DO3P5TXi.js";
...
import { t as createAgentRuntimeApprovalAuthorityValidator } from "./agent-runtime-identity-token-IUBMoTIB.js";
...
import "./server-plugins-CITNSJGn.js";
...
import { a as getActiveSecretsRuntimeConfigSnapshot, r as clearSecretsRuntimeSnapshotState } from "./runtime-state-CGaTBGZ5.js";
import { n as fenceSessionSuspensionWritesForGatewayShutdown } from "./session-suspension-C6jpx3Y4.js";
...
import { d as listDevicePairing, p as onEffectiveOperatorDevicePaired, y as resolveEffectiveOperatorDeviceIdentity } from "./device-pairing-CFVs8foo.js";
import { f as requestNodePairing, p as reusePendingNodePairingForReconnect, r as finalizeNodePairingCleanupClaim } from "./device-pairing-node-DQim5ZRE.js";
import { c as removeRemoteNodeInfoForConnection, i as recordRemoteNodeInfo, s as removeRemoteNodeInfo } from "./remote-DxaHmq2z.js";
...
import { n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig } from "./startup-auth-CBMSFO8H.js";
...
import { a as sendGatewayAuthFailure, f as setDefaultSecurityHeaders, r as finishFailedGatewayHttpResponse } from "./http-common-CJ1Ivcyn.js";
...
import { c as canReceiveSessionEvent } from "./session-sharing-QTh4cZeN.js";
...
import { n as resolveGatewayReloadPluginActivationCandidate, r as resolveGatewayStartupPluginActivationConfig, t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-CyDRyLIH.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-XZDQrS9y.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-Bo4J9MrF.js";
import { t as createControlUiSessionPullRequestSubscriptions } from "./control-ui-session-pr-subscriptions-BfO8yact.js";
...
import { n as applyGatewayLaneConcurrency, r as resolveGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-B29yWrXt.js";
...
import { n as handleNodeWorkspaceTransferHttpRequest } from "./node-workspace-transfer-http-C2IFOm0I.js";
...
import { t as GATEWAY_EVENTS } from "./server-methods-list-CXr75eou.js";
...
async function startGatewayCoreRuntime(input) {
	...
	const taskAndSkillsResident = residentRegistry.register({
		...
		stop: async () => {
			...
			const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-CZhXLMbV.js");
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-CHh-ZOcr.js"), import("./server-runtime-startup-services-C7rNX3Su.js")]));
	...
	const { createOperatorApprovalSessionEventRuntime } = await import("./operator-approval-session-events-B3T5wFAt.js");
	...
	const { execApprovalManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, bindApprovalPublicationContext, unregisterApprovalAuthorityObserver, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-KpWBQ7Lc.js"), import("./server-methods-C_s9GXs1.js")]);
		return {
	...
	const reloadAttachedGatewayPlugins = async (params) => {
		const [{ loadPluginLookUpTable }, { listAmbientOnlyConfiguredChannelIds }, { prepareGatewayPluginLoad }, { startPluginServices }, { listChannelPluginConfigTargetIds, pluginConfigTargetsChanged }] = await Promise.all([
			import("./plugin-lookup-table-CMzlOXZD.js"),
			import("./channel-presence-policy-BusLl1Ao.js"),
			loadGatewayPluginBootstrapModule(),
			import("./services-CIfAXzEk.js"),
...
async function createGatewayChatMetadataLifecycle(params) {
	...
	const { ChatMetadataSnapshotUnavailableError, createGatewayChatMetadataRuntime } = await import("./chat-metadata-runtime-CxFwq9xh.js");
	const runtime = createGatewayChatMetadataRuntime({
		...
		...params.minimalTestGateway ? {
			beforeRefresh: async () => {
				const { refreshPreparedModelRuntimeSnapshots } = await import("./prepared-model-runtime-gcw_X21_.js");
	...
	const registerRefreshListeners = async () => {
		...
		const [{ registerRuntimeAuthProfileStoreMutationListener }, { registerPreparedModelRuntimePublicationListener }, { registerSkillsChangeListener }] = await Promise.all([
			import("./runtime-snapshots-BGYS2-Mn.js"),
			import("./prepared-model-runtime-gcw_X21_.js"),
			import("./refresh-C_5wxc9o.js")
		]);
...
async function attachInitialGatewayLifetimeSidecars(params) {
	...
	params.sidecars.push({ stop: async () => {
		const { flushPendingSessionsChangedEvents } = await import("./session-change-event-e-euKvUN.js");
...
async function prepareGatewayKernelRequestRuntime(params) {
	...
	const gatewayRequestContext = await startupTrace.measure("gateway.request-context", async () => {
		const { createGatewayRequestContext } = await import("./server-request-context-fnycKfwj.js");
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-WwgAcCwG.js");
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-DgjWY8e4.js").then(({ buildGatewayCronService }) => {
		loaded = {
...
async function prepareGatewayLifecycle(params) {
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-CT965F8Q.js");
	...
	const nodeDesktopService = desktopSessionRegistry && nodeDesktopStreamBroker ? (await import("./node-source-IlVd0hpJ.js")).createNodeDesktopService({
		getConfig: getRuntimeConfig,
		nodeRegistry,
	...
	const { createWatchNodeHttpRuntime } = await import("./watch-node-http-Upw0QRUw.js");
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-R1Z9NtJJ.js");
...
async function prepareGatewayKernelState(params) {
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-BN4vdv4s.js");
	...
	if (bootstrap.generatedStartupAuthToken && isLoopbackHost(bindHost)) {
		const { ensureStartupLocalCliPairing } = await import("./startup-local-cli-pairing-C08pdttP.js");
	...
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-CQ29KvlO.js");
	...
	const { createChannelManager } = await import("./server-channels-6WjJhVmY.js");
...
async function prepareGatewayServerBootstrap(input) {
	...
	const [{ OPENCLAW_DATABASE_SCHEMA_DOCS_URL, OpenClawDatabaseSchemaPreflightError, preflightOpenClawDatabaseSchemas }, agentDatabase, stateDatabase] = await Promise.all([
		import("./openclaw-database-preflight-mPpLkVfk.js"),
		import("./openclaw-agent-db-BSfLPEC3.js"),
		import("./openclaw-state-db-75OP6lbb.js")
	]);
	...
	const startupConfigModulePromise = import("./server-startup-config-C90nVoNc.js");
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-_ld0xyHB.js"), { cacheRejections: true });
	...
	const { claimControlUiDeviceAuthMigration, completeControlUiDeviceAuthMigration, importPendingControlUiDeviceAuthMigration, isLegacyControlUiDeviceAuthMigrationInput, readControlUiDeviceAuthMigrationState, recoverControlUiDeviceAuthMigrationClaim, releaseControlUiDeviceAuthMigrationClaim } = await import("./control-ui-device-auth-migration-By2t08r3.js");
...
const loadGatewayModelCatalogModule = createLazyRuntimeModule(() => import("./server-model-catalog-9XEwPmxm.js"));
const loadWorkerEnvironmentStartupModule = createLazyRuntimeModule(() => import("./server-worker-environment-startup-BvLgjAKy.js"));
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-D7h_6mOd.js"));
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-CnCY_kFY.js"));
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-CV8VpKyS.js"));
...
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-CwVZjRLh.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-DE769byk.js");
...
const getHttpAuthUtilsModule$2 = createLazyRuntimeModule(() => import("./http-auth-utils-BPd0t7JY.js"));
...
const getPluginNodeCapabilityAuthModule$1 = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-CswjpSQ_.js"));
const getHttpAuthUtilsModule$1 = createLazyRuntimeModule(() => import("./http-auth-utils-BPd0t7JY.js"));
const getPluginRouteRuntimeScopesModule$1 = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-BqhMqQzM.js"));
...
const getControlUiModule = createLazyRuntimeModule(() => import("./control-ui-DsZEe8fw.js"));
const getCanvasServeModule = createLazyRuntimeModule(() => import("./serve.runtime.js"));
const getBoardHttpModule = createLazyRuntimeModule(() => import("./board-http-gr1sE-V9.js"));
const getEmbeddingsHttpModule = createLazyRuntimeModule(() => import("./embeddings-http-DIl-Y-pO.js"));
const getManagedMediaAttachmentsModule = createLazyRuntimeModule(() => import("./managed-image-attachments-XlItAIeG.js"));
const getMcpAppStandaloneModule = createLazyRuntimeModule(() => import("./mcp-app-standalone-Cnjh3xvK.js"));
const getPluginIconHttpModule = createLazyRuntimeModule(() => import("./plugin-icon-http-DPzz_4Id.js"));
const getWorkspaceIconHttpModule = createLazyRuntimeModule(() => import("./workspace-icon-http-CuYfzeAO.js"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-Bc6Y55xQ.js"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-DX2BmwhK.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-Bgis22jW.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-K9zSZyk1.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-cuh62aA_.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-BllhH-IM.js"));
const getUserProfilesHttpModule = createLazyRuntimeModule(() => import("./user-profiles-http-C9a5iKRC.js"));
const getDevicePairingJoinHttpModule = createLazyRuntimeModule(() => import("./device-pairing-join-http-CMz-8jH8.js"));
const getPluginNodeCapabilityAuthModule = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-CswjpSQ_.js"));
const getHttpAuthUtilsModule = createLazyRuntimeModule(() => import("./http-auth-utils-BPd0t7JY.js"));
const getPluginRouteRuntimeScopesModule = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-BqhMqQzM.js"));
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-DoH_t9sx.js");
...
async function createGatewayHttpTransport(params) {
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-MZTd4bf5.js");
	...
	const handleMcpOAuthCallbackRequest = async (req, res) => {
		const { handleMcpOAuthCallback } = await import("./mcp-oauth-callback-BRnZLdBx.js");
...
async function finishGatewayStartup(params) {
	...
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-GnrUA46_.js"), import("./route-capability-CCISCYmy.js")]));
	...
	const databaseIntegrityResident = residentRegistry.register({
		...
		start: async () => {
			if (minimalTestGateway) return;
			const { startOpenClawDatabaseIntegrityVerifier } = await import("./openclaw-database-verify-bZFkjddF.js");
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-CYh2bzo2.js"), { cacheRejections: true });
	...
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-DKKuZzwG.js");
		...
		residentRegistry.register({
			...
			start: () => {
				postReadyState.retainedPluginCleanupHandle = gatewayRuntimeServices.scheduleGatewayIdleTask({
					...
					run: async () => {
						const { cleanupRetainedPluginInstallGenerations } = await import("./server-retained-plugin-cleanup-D7rJZtbq.js");
...
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-CEA6VDYV.js"));
