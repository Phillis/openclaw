...
import { i as rejectDurableDelivery, n as failDurableDelivery, o as suppressDurableDelivery, r as markDurableDeliveryQueued, t as completeDurableDelivery } from "./delivery-completion-BK_xYNQa.js";
import { d as toPluginMessageSentEvent, l as toPluginMessageContext, o as toInternalMessageSentContext, t as buildCanonicalSentMessageHookContext } from "./message-hook-mappers-DgmmEqq7.js";
import { a as runOutboundDeliveryCommitHooks, i as isOutboundDeliveryResultArray, n as reconcileUnknownQueuedDelivery, o as buildPayloadSummary, t as buildUnknownSendContext } from "./delivery-queue-reconciliation-CORnTSAf.js";
...
import { n as resolveOutboundChannelMessageAdapter } from "./channel-resolution-DsNf7m1q.js";
import { S as claimDeliveryPlatformSendAttempt, a as failDelivery, c as failPendingDelivery, d as loadPendingDeliveries, f as loadPendingDelivery, g as markDeliveryPlatformSendAttemptStarted, h as markDeliveryPlatformOutcomeUnknown, k as acceptedPreparedOutboundEntries, o as failDeliveryAfterPlatformSend, s as failDeliveryBeforePlatformSend, t as ackDelivery, v as moveToFailed, y as reserveDeliveryAttempt } from "./delivery-queue-storage-DVtu0eWu.js";
import { c as createDeliveryQueueMediaRetention, s as cancelDeliveryQueueMediaRetention } from "./delivery-queue-media-staging-N2a2dlUZ.js";
import { r as releaseSpoolArtifacts, t as collectEntrySpoolPaths } from "./delivery-queue-media-spool-ByExwA5K.js";
...
async function recoverPendingDeliveries(opts) {
	const { migrateLegacyPendingOutboundDeliveries } = await import("./delivery-queue-migration-B0EEcivF.js");
