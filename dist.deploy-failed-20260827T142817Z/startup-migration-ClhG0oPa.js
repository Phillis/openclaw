...
import { g as openOpenClawAgentDatabase, i as closeOpenClawAgentDatabaseByPath, p as isOpenClawAgentDatabaseOpen } from "./openclaw-agent-db-CyHApqW_.js";
import { K as setCanonicalSqliteSessionMainKey, o as resolveAllAgentSessionStoreTargetsSync, u as resolveAgentSessionDirs } from "./targets-BzJLDErS.js";
...
import { u as migrateOrphanedSessionKeys } from "./state-migrations.session-store-CkL1BN9r.js";
...
async function runSessionStartupMigration(params) {
	...
	if (hasLegacySessionDirectories) try {
		const prepareSurfaces = params.deps?.prepareLegacySessionSurfaces ?? (await import("./legacy-session-surfaces-BcAQSliP.js")).prepareLegacySessionSurfaces;
