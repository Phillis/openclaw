...
async function resolveExecBaseConfig(opts) {
	...
	const { createConfigIO, getRuntimeConfig } = await import("./io-cWSCQOJ1.js");
...
async function agentExecCommand(positionalMessage, opts, runtime, deps = {}) {
	...
	try {
		...
		configIo = await import("./io-cWSCQOJ1.js");
		...
		if (isExecutionIdentityCollectionEnabled(runConfig)) try {
			stopLocalAuditWriter = (await import("./agent-local-audit-DWvE7BHn.js")).startAgentLocalAuditWriter({ stateDir });
		} catch {}
		const [{ withAuthProfileStoreAgentDir, withEnvOnlyAuthProfileStore }, { withHostExecInheritedEnvOmitted }, { listKnownProviderAuthEnvVarNames }, runAgent] = await Promise.all([
			import("./auth-profiles-CPoNaf6_.js"),
			import("./host-env-security-B23eCvGK.js"),
			import("./provider-env-vars-C3SeQ3Vb.js"),
			deps.runAgent ? Promise.resolve(deps.runAgent) : import("./agent-C-lAQy9s.js").then((module) => module.agentCommand)
		]);
