...
import { r as clampInt } from "./utils-DEqefz4f.js";
...
import { C as resolveSessionAuthProfileOverrideSource, g as resolveSessionAgentIds, h as resolveSessionAgentId } from "./agent-scope-BizOtGGz.js";
import { l as resolveAgentDir, s as resolveAgentConfig } from "./agent-scope-config-BdXMWufB.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePathCore, o as resolveSessionStorePathCore, r as resolveDefaultSessionStorePath } from "./paths-B2oibYbs.js";
import { H as resetConfigOverrides, N as validateConfigObjectWithPlugins, U as setConfigOverride, V as getConfigOverrides, W as unsetConfigOverride, d as readConfigFileSnapshotForWrite, dt as resolveOwnerPromptNumbers, l as readConfigFileSnapshot } from "./io-D1h6pxaD.js";
...
import { c as resolveContextConfigProviderForRuntime } from "./openai-routing-BGuHAkXI.js";
...
import { d as scheduleGatewaySigusr1Restart, m as triggerOpenClawRestart } from "./restart-B3HJgSVH.js";
import { t as normalizeChatType } from "./chat-type-CG0X_HJM.js";
import "./installed-plugin-index-records-ClSyB6F3.js";
import { c as normalizeSessionDeliveryState, d as sessionDeliveryOrigin, n as deliveryContextFromSession } from "./delivery-context.shared-D-qPZITK.js";
import { $t as loadSessionEntryReadOnly, K as updateSessionEntry, en as patchSessionEntryCore, hn as resolveSessionStorePathForScope, yt as applySessionPatchProjection } from "./session-accessor-CVnxp3UM.js";
import { a as normalizeChannelId, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CWrpiLCs.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-2lW9dSyY.js";
...
import { a as normalizeStoreSessionKey, s as resolveSessionStoreEntryCore } from "./store-entry-BgSA4iwU.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { x as scanSessionTranscriptTree } from "./session-transcript-index-U6HbS8-N.js";
...
import { t as extractDeliveryInfo } from "./delivery-info-D2PmR_rM.js";
import { a as migrateSessionEntries } from "./session-manager-codec-DXlXWhl0.js";
import "./session-manager-BUfxqRpP.js";
...
import { i as isCliRuntimeAliasForProvider, s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-CAkySZhG.js";
import { n as resolveManualCompactionCliTarget } from "./session-runtime-compat-VbLZXcDR.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-JK92-aeX.js";
import { a as isNativeCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-CRxhzdEY.js";
import { t as getSessionBindingService } from "./session-binding-service-DyztGgRo.js";
import { r as matchPluginCommand, t as executePluginCommand } from "./commands-BrmrXjIj.js";
import { i as formatFastModeCurrentStatus } from "./fast-mode-CCX0YiYh.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-BuLdwnA4.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-B6I7wGLB.js";
import { c as listTasksForAgentIdForStatus, u as listTasksForSessionKeyForStatus } from "./task-status-access-DOvKrdar.js";
import { a as readAcpSessionMetaForEntry } from "./session-meta-BrtiZ04k.js";
...
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync, a as formatEmbeddedAgentQueueFailureSummary, l as isEmbeddedAgentRunActive } from "./runs-DdjJNEQM.js";
import { t as formatTokenCount } from "./token-format-D942KbWN.js";
import "./sessions-B_ifzq5W.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-CzAixYBD.js";
import { c as readSessionMessagesAsync } from "./session-transcript-readers-DWnTgCXL.js";
import { n as formatUsd } from "./usage-format-CbM1Z9YQ.js";
import { P as deriveSessionTitle } from "./session-utils-row-CriEgq90.js";
...
import { o as resolveReplyToMode } from "./reply-threading-nuXO6xfm.js";
...
import { _ as isRealConversationMessage, _t as createMessageCharEstimateCache, vt as estimateMessageCharsCached } from "./builtin-openclaw-DTeM8adv.js";
import { d as getSession, l as getFinishedSession } from "./bash-process-registry-rM437CTr.js";
import { t as cancelBackgroundExecSession } from "./bash-process-control-BlFHIe-s.js";
import { a as formatDoctorNonInteractiveHint, n as clearRestartSentinel, p as writeRestartSentinel, t as buildRestartSuccessContinuation } from "./restart-sentinel-BMlog4T5.js";
import { i as getSpeechProvider, o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-DzjGFYEk.js";
import { _ as resolveTtsPrefsPath, a as getTtsMaxLength, c as isTtsEnabled, h as resolveTtsConfig, l as listTtsPersonas, o as getTtsPersona, s as isSummarizationEnabled } from "./tts-settings-C4v4j5N-.js";
import { a as revokeMessageActionTurnCapability, n as mintMessageActionTurnCapability, t as isTrustedMessageActionTurnIngress } from "./message-action-turn-capability-BEevnYXM.js";
import { a as markCommandSessionMetadataChanged, n as handleGoalCommand } from "./commands-goal-CogDHQTf.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-C8z3qpDj.js";
...
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-BjndRqg9.js";
...
import { n as redactConfigObject, r as redactConfigSnapshot, t as REDACTED_SENTINEL } from "./redact-snapshot-DuN7qyYL.js";
import { n as resolveCurrentOpenClawCliInvocation } from "./openclaw-cli-invocation-B9R05uXF.js";
import { n as routeReply } from "./route-reply-Czqd7ZQ_.js";
...
import { C as getResolvedSpeechProviderConfig, _ as setTtsProvider, c as getLastTtsAttempt, d as setLastTtsAttempt, f as setSummarizationEnabled, g as setTtsPersona, h as setTtsMaxLength, m as setTtsEnabled, t as getTtsProvider, w as isTtsProviderConfigured } from "./runtime-api-Bw3X0kRb.js";
import { n as textToSpeech } from "./tts-C3n_GppM.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-BrC6a8yX.js";
import { c as selectAgentHarness, n as agentHarnessExposesOpenClawTools } from "./selection-BtKGm7U7.js";
import "./commands-registry-4K2cL52k.js";
import { n as applyCommandTextToParams } from "./command-context-rewrite-DyA5NUca.js";
import { a as rejectNonOwnerCommand, c as requireGatewayClientScope, i as matchCommandPrefix, n as commandReply, o as rejectUnauthorizedCommand, r as defineAuthorizedTextCommand, s as requireCommandFlagEnabled, t as buildDisabledCommandReply } from "./command-gates-BJ_TboV4.js";
import { a as stripMentions, o as stripStructuralPrefixes } from "./mentions-s5oG2OK5.js";
import { i as PLUGIN_COMMAND_DISPATCH, n as executePluginCommandDispatch, r as matchPluginCommandInvocation, t as createPluginCommandRuntime } from "./plugin-command-runtime-DYGayFls.js";
...
import { n as formatAbortReplyText, r as stopSubagentsForRequester, t as abortSessionRunTargetWithOutcome } from "./abort-CJm75NX3.js";
...
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-BFZq9V4n.js";
import { l as removeChannelAllowFromStoreEntry, n as addChannelAllowFromStoreEntry, s as readChannelAllowFromStore } from "./pairing-store-BmIXp5gX.js";
import { a as isBenignCompactionSkipResult, n as classifyCompactionReason } from "./compact-reasons-D69aGDYv.js";
import { t as buildConfigSchemaCore } from "./schema-BT17pjzs.js";
import { n as formatNonClawHubInstallWarning, t as NON_CLAWHUB_INSTALL_FORCE_FLAG } from "./install-provenance-C3hHeUzH.js";
import { t as handleSystemAgentCommand } from "./commands-system-agent-BGej99Lo.js";
import { n as resolveSkillWorkshopToolPolicyAvailability } from "./tool-policy-diagnostic-B0_1fKrb.js";
import { n as parseActivationCommand } from "./group-activation-B6ER3hWD.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-C0mu4jjI.js";
...
import { a as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-dA8eNdfr.js";
import { n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContextAsync, t as resolveConfiguredModelCompat } from "./tools-effective-inventory-82sWrZTH.js";
import { t as extractBtwQuestion } from "./btw-command-4532C3Gk.js";
import { r as handleModelsCommand } from "./commands-models-BLPnwW8S.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-Dsorg_GP.js";
import { t as codexChannelLoginRuntime } from "./provider-auth-login-flow-runtime-4tflrvve.js";
import { r as createExecTool } from "./bash-tools-B3pip43q.js";
import { t as runBtwSideQuestion } from "./btw-V3Obzu0j.js";
import { a as loadCostUsageSummary, n as loadSessionCostSummary } from "./session-cost-usage-CYfyWt9n.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-BE-HcilZ.js";
import { b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-BXSqs7KV.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, o as resolveRequesterSessionKey } from "./shared-DQRlann8.js";
import { t as buildToolsMessage } from "./status-HdNOAD4v.js";
import { n as resolveCommandSurfaceChannel, t as resolveChannelAccountId } from "./channel-context-CPJbX-gk.js";
import { t as handleApproveCommand } from "./commands-approve-DXtS8Z4p.js";
import { t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CX3Pu7By.js";
import { t as parseConfigValue } from "./config-value-D2VJu0bm.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-04mcoZWU.js";
import { n as buildStatusReply, t as buildStatusPluginsReply } from "./commands-status-m5IfPgVl.js";
...
import { n as refreshPluginRegistryAfterConfigMutation } from "./registry-refresh-CgP_GGZG.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-Dlx02Gb7.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-BHu5PcKv.js";
import { i as selectInstallMutationWriteOptions, r as resolveInstallConfigMutationPreflights } from "./install-persistence-DKmD6mTc.js";
import { r as resolvePluginInstallSourcePlan } from "./plugin-install-plan-B-J0xtIN.js";
import { n as createPluginInstallLogger } from "./plugins-command-helpers-ByNnTh23.js";
import { t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-error-codes-OgrR1N6P.js";
import "./clawhub-C3AI80rJ.js";
import { i as installManagedPluginSource } from "./management-service-CGS8N1BN.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-C5btb4VT.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-BioLMcb_.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-CfBaifdd.js"));
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CL5GPv9v.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-DghY9qwH.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-B4MzCcFz.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-CuGKB8Xo.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-pfb8LGfC.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-Chw15CqY.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-BnumX2Rx.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-BaiWVnGt.js"));
