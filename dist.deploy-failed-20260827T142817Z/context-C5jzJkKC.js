...
import { f as isSameSsrFPolicy } from "./ssrf-UFPP-fbI.js";
...
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, m as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-BV2vwVv3.js";
import { C as SANDBOX_DOCKER_CREATE_ARGS_EPOCH, b as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, v as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-B8EtrfM_.js";
import { n as isToolAllowed } from "./tool-policy-qVmQ4P1r.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-l_EuSzmS.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DwfYu5UM.js";
import { a as computeSandboxBrowserConfigHash, t as resolveDockerEnvPolicyEpoch } from "./sanitize-env-vars-Cs0Tdu9P.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-BL_poExk.js";
import { C as updateRegistry, S as updateBrowserRegistry, _ as readBrowserRegistry, f as readDockerContainerEnvVar, l as formatDockerDaemonUnavailableError, m as readDockerPort, p as readDockerContainerLabel, r as dockerContainerState, s as execDocker, t as buildSandboxCreateArgs, u as isDockerDaemonUnavailable, v as readRegisteredSandboxRuntimeIds } from "./docker-OaJzvWRJ.js";
...
import { i as slugifySessionKey, n as resolveSandboxAgentId, r as resolveSandboxWorkspaceLayoutPaths, t as buildSandboxContainerName } from "./shared-CiBmkGZf.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-K0PUWhhE.js";
import { g as assertSshSandboxSecretOwnerAvailable } from "./ssh-backend-DVQ-nxjR.js";
import { i as startBrowserBridgeServer, l as requireSandboxBackendFactory, n as stopCachedBrowserBridge, r as stopCachedBrowserBridgesForContainer, s as getSandboxBackendWorkdirResolver, t as BROWSER_BRIDGES } from "./browser-bridges-BTDT8AHg.js";
import { t as createSandboxFsBridge } from "./fs-bridge-WPcm-FoR.js";
import { n as toSandboxProvisioningError } from "./provisioning-error-Cyiculil.js";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [syncWorkspaceSkills, { getRemoteSkillEligibility }, { resolveNodeExecEligibility }] = await Promise.all([
			...
			import("./remote-Bh473EdE.js"),
			import("./exec-defaults-B0UMzgz_.js")
		]);
...
async function resolveProvisionedSandboxContext(params, resolved) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-CftMJL-f.js")).maybePruneSandboxes(cfg);
