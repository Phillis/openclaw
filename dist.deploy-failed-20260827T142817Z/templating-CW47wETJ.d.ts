...
import { A as TextChunkMode, S as ReplyToMode, c as ChannelStreamingCommandTextMode, d as ChannelStreamingProgressConfig, h as DmScope, i as BlockStreamingCoalesceConfig, k as StreamingMode } from "./types.base-DUfwpzwr.js";
...
import { b as SessionCreatedVia, c as SessionEntry, h as SessionRestartRecoveryState, i as InternalSessionEntry, v as SourceReplyDeliveryMode, y as SessionCreatedActor } from "./types-Byd4mWhx.js";
import { t as InboundEventKind } from "./kind-CC2t750M.js";
import { c as MediaUnderstandingDecision, k as MediaUnderstandingOutput } from "./types-BFl3Ao02.js";
...
import { t as StreamingCompatEntry } from "./streaming-config-readers-RwT0X-Qa.js";
...
type UserTurnInput = {
  ...
  timestamp?: number;
  idempotencyKey?: string; /** Durable transcript message reference used to render and hydrate replies. */
  replyToId?: string; /** Bounded display fallback for replies whose target is outside loaded history. */
  replyToPreview?: {
    text: string;
