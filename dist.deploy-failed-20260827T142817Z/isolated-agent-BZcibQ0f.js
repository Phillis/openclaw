...
import { C as resolveSessionAuthProfileOverrideSource, _ as resolveSubagentModelConfigSelectionResult } from "./agent-scope-BizOtGGz.js";
...
import { S as findModelInCatalog, _ as resolveConfiguredModelRef, f as normalizeModelSelection, g as resolveConfiguredModelPolicyAllow, v as resolveHooksGmailModel } from "./model-selection-shared-DT9x3Cg2.js";
...
import { D as isDetachedCronSessionTarget, R as resolveCronScheduledToolPolicy } from "./row-codec-DhVyr5Q_.js";
import "./config-CW-q_d35.js";
import { dt as deriveContextPromptTokens, mt as hasNonzeroUsage, pt as deriveSessionTotalTokens } from "./session-accessor-CVnxp3UM.js";
import { a as isAgentHarnessSessionKey, n as AGENT_HARNESS_SESSION_ID_LOCKED_MESSAGE, r as AGENT_HARNESS_SESSION_KEY_RESERVED_MESSAGE, z as beginSessionWorkAdmission } from "./agent-harness-session-key-D5rklW6u.js";
import { b as setSessionRuntimeModel } from "./restart-recovery-state-DDUaUjgV.js";
...
import { s as loadProviderScopedThinkingCatalog, u as loadResolvedPublishedModelCatalogOwner } from "./prepared-model-catalog-BFweRhks.js";
import { n as resolveAllowedModelRefCore, t as getModelRefStatus } from "./model-selection-resolve-D-mL09va.js";
import { i as normalizeThinkingCatalogProviders, n as hasResolvedThinkingCatalogEntry, o as resolveEffectiveAgentRuntime } from "./thinking-runtime-CvHDRR81.js";
...
import { s as hasCommittedMessagingToolDeliveryEvidence, x as hasAcceptedSessionSpawn } from "./delivery-evidence-B9g3AV3B.js";
import { n as resolveCronStyleNow } from "./current-time-D-I8cLSc.js";
import { o as resolveCronAbortReasonText } from "./execution-errors-CtPvpxmu.js";
import { t as removeCronRunContinuationSessionIfIdle } from "./cron-run-continuation-cleanup-BwVsJm7t.js";
import { n as resolveSourceDeliveryOutcome } from "./source-delivery-plan-D2h5X9CM.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-B3rQW6jp.js";
import { i as mergeCronRunDiagnostics, n as createCronRunDiagnosticsFromError, t as createCronRunDiagnosticsFromAgentResult } from "./run-diagnostics-BnFhlkSb.js";
import { n as resolveCronJobEffectiveAgentId, r as tryResolveCronDefaultAgentId } from "./agent-id-C6YEx4KT.js";
import { n as getActiveCronTaskRunId } from "./task-runs-C2V5hS00.js";
import { n as projectChatDisplayMessages } from "./chat-display-projection-B0E44yqM.js";
import { n as resolveCronSession, t as loadCronSessionEntryLatest } from "./session-BJpJqJcN.js";
import { c as loadCronDeliveryRuntime, l as resolveCronDeliveryContext, n as resolveCronPreflightCandidates, o as buildCronDeliveryTrace, s as createCronToolsAllowPreflightDiagnostics, u as resolveCronChannelOutputPolicy } from "./run-fallback-policy-DvuyPaAu.js";
import { a as markCronSessionPreRun, c as resolveCronLifecycleRevisionIdentity, f as resolveCronPayloadOutcome, i as createPersistCronSessionEntry, n as adoptCronRunSessionMetadata, o as persistCronSkillsSnapshotIfChanged, r as createCronRunContinuationSession, s as projectCronOwnershipFields, t as CronSessionLifecycleClaimError } from "./run-session-state-Dztfe044.js";
import { t as cleanupCronRunSessionAfterRun } from "./session-cleanup-Ch3Wvzqn.js";
...
async function finalizeCronRun(params) {
	...
	if (hasNonzeroUsage(usage)) {
		const { estimateUsageCost, resolveModelCostConfig } = await import("./usage-format-B5juRanH.js");
