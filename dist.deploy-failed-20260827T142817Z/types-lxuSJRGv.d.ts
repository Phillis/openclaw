import { D as ConversationReadInvocationOrigin, O as OutboundMediaAccess, T as ChannelThreadingToolContext, k as OutboundMediaReadFile, m as ChannelMessageActionAdapter, n as ChannelAccountSnapshot } from "./types.core-lr-SMiuA.js";
import { T as ThinkingLevel, d as Model, j as Usage, l as ImageContent, n as Api, r as AssistantMessage } from "./types-Cm3n7XMD.js";
import { b as StreamFn, c as AgentMessage, f as AgentToolResult, u as AgentTool } from "./types-DKu1Bc4Q.js";
import { l as ModelRegistry$1, u as AuthStorage } from "./index-D4zZ2xWk.js";
import { C as ReplyPayloadDelivery, S as ModelPickerAction, _ as ReplyPayload, a as TaskSuggestionDeliveryMode, c as TranscriptEntryAnchor, d as AgentPlanStep, f as LegacyMediaContextKey, g as ReplyMediaAttachment, l as TranscriptTurnAdmission, m as PromptImageOrderEntry, n as GetReplyOptions, o as TurnAdoptionLifecycle, p as MediaFact, r as PartialReplyPayload, s as UserTurnTranscriptRecorder, t as BlockReplyContext, u as TranscriptTurnBoundary, v as LegacyInteractiveReply, y as MessagePresentation } from "./types-B6SpuL0v.js";
import { A as TtsAutoMode, B as FastMode, M as TtsMode, P as TtsProvider, R as QueueMode, _t as ReplyToMode, at as SilentReplyConversationType, b as ChannelImplicitMentionsConfig, bt as ChatType, c as OperatorScope, ct as ToolLoopDetectionConfig, dt as ContextVisibilityMode, ht as IdentityConfig, i as McpCodexToolApprovalMode, j as TtsConfig, k as ResolvedTtsPersona, lt as MemoryCitationsMode, mt as HumanDelayConfig, n as OpenClawConfig, pt as DmScope, s as TalkProviderConfig, st as GroupToolPolicyConfig, t as ConfigFileSnapshot, ut as SafeBinProfileFixture, yt as SessionScope } from "./types.openclaw-CNftZ6Ix.js";
import { _ as SessionCreatedActor, a as SessionEntry, c as SessionToolOverrides, d as CronScheduledToolPolicy, g as SourceReplyDeliveryMode, i as SessionContextBudgetStatus, n as GroupKeyResolution, o as SessionPluginJsonValue, s as SessionSystemPromptReport, t as CliSessionBinding, v as SessionCreatedVia } from "./types-DMfmNky0.js";
import { _ as MediaUnderstandingOutput, a as MsgContext, c as SupplementalContextFacts, d as CommandTurnContext, f as CommandTurnKind, g as StructuredExtractionInput, h as MediaUnderstandingProvider, i as MentionSource, l as HistoryEntry, m as MediaUnderstandingDecision, n as FinalizedRuntimeMsgContext, o as OriginatingChannelType, p as PluginHookChannelContext, r as InboundSourceModality, s as SessionTranscriptContext, t as FinalizedMsgContext, u as HistoryMediaEntry, v as InboundEventKind } from "./templating-B2HrX1Lb.js";
import { n as SecretRef, t as SecretInput } from "./types.secrets-G6HDh4-9.js";
import { a as ModelMediaInputConfig, f as AgentModelConfig, i as ModelDefinitionConfig, n as ModelApi, o as ModelProviderAuthMode, r as ModelCompatConfig, s as ModelProviderConfig } from "./types.models-Dfmf90bZ.js";
import { n as MemoryExtraPath, o as MemorySearchManager, s as MemorySearchResult } from "./types-DjvKORHD.js";
import { i as OAuthCredential, n as AuthProfileCredential, r as AuthProfileStore, t as ApiKeyCredential } from "./types-DdMsFybn.js";
...
import { B as PluginApprovalRequestPayload, E as ChannelOutboundAdapter, F as buildAgentSessionKey, I as resolveAgentRoute, T as ChannelDeliveryCapabilities, z as PluginApprovalRequest$1 } from "./types.adapters-B3FSaDSt.js";
import { D as UnifiedModelCatalogEntry, O as UnifiedModelCatalogKind, _ as PluginManifestDashboardActionVerb, a as PluginOrigin$1, d as PluginBundleFormat, f as PluginConfigUiHint, g as PluginManifestDashboard, h as PluginManifestContracts, i as PluginDependencyStatus, m as PluginFormat, p as PluginDiagnostic, t as PluginManifestRecord, v as PluginManifestDashboardDataBinding, w as PluginKind, y as PluginManifestMcpServer } from "./manifest-registry-2CBAZ6tk.js";
...
import { _ as OutboundSendDeps, a as chunkMarkdownTextWithMode, c as resolveChunkMode, d as OutboundPayloadDeliveryOutcome, f as OutboundPayloadDeliverySuppressionReason, h as MessageReceipt, i as chunkMarkdownText, l as resolveTextChunkLimit, n as OutboundDeliveryFormattingOptions, o as chunkText, r as chunkByNewline, s as chunkTextWithMode, t as OutboundIdentity, u as OutboundDeliveryResult } from "./identity-types-KDBq_YS3.js";
import { n as WizardPrompter, t as ChannelPlugin$3 } from "./types.plugin-Bmqj6gl7.js";
...
import { A as RealtimeVoiceProviderId, B as TalkBrain, C as RealtimeVoiceBrowserSession, D as RealtimeVoiceProviderCapabilities, G as TalkEventType, K as TalkMode, O as RealtimeVoiceProviderConfig, j as RealtimeVoiceProviderResolveConfigContext, k as RealtimeVoiceProviderConfiguredContext, o as TranscriptSourceProvider$2, q as TalkTransport, w as RealtimeVoiceBrowserSessionCreateRequest, x as RealtimeVoiceBridgeCreateRequest, y as RealtimeVoiceBridge } from "./provider-types-DIZT6Dex.js";
import { B as ReplyDispatchKind, F as PluginConversationBindingResolvedEvent$1, G as ThinkLevel, H as ReplyDispatcher, I as PluginApprovalResolution, J as DiagnosticTraceContext, K as ThinkingCatalogEntry, L as PluginHookBeforeToolCallResult, M as PluginConversationBinding, N as PluginConversationBindingRequestParams, P as PluginConversationBindingRequestResult, R as ReplyDispatchBeforeDeliver, U as ReplyFollowupAdmissionBarrierTimeoutPolicy, V as ReplyDispatchRuntimeInfo, W as ReasoningLevel, _ as PluginToolMatcher, a as PluginHookRegistration$1, b as PluginJsonValue, d as PluginHookToolContext, f as PluginHookToolInputKind, i as PluginHookName, m as PluginHookToolRequesterContext, n as PluginHookBeforeToolCallEvent, o as PluginHookRegistrationOptions, p as PluginHookToolKind, q as VerboseLevel, r as PluginHookHandlerMap, v as PluginNextTurnInjection, y as PluginNextTurnInjectionEnqueueResult, z as ReplyDispatchBeforeDeliverOptions } from "./hook-types-Ap6ctfh9.js";
import { b as SkillTelemetrySource, c as SandboxBackendExecSpec, f as SandboxBackendWorkdirValidation, h as SandboxFsBridge, n as SandboxContext, p as SandboxBackendWorkdirValidator, v as ExplicitSkillSelection, x as SkillUsagePath, y as SkillSnapshot } from "./types-MS2pZkCP2.js";
import { c as SilentReplyPromptMode, d as TrustedSubagentCompletionHandoff, f as ScheduledToolPolicyContext, l as CronCreatorAuthorityGrant, p as AnyAgentTool, s as PromptMode, t as CronCreatorAuthorityCapability, u as RuntimePluginToolGrant } from "./cron-creator-authority-context-DAum5N8q.js";
...
import { i as PluginCompatCode, n as PluginMetadataSnapshot, t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-BrgZTxRQ.js";
import { i as ConfigWriteAfterWrite, n as ConfigReplaceResult, t as resolveStateDir } from "./config-C7FyWyXj.js";
import { g as ResolvedSessionMaintenanceConfigInput, h as onSessionTranscriptUpdate, n as SessionManager } from "./session-manager-B7xs4kTa.js";
...
import { x as completeSimple } from "./llm-Bvo0Cbre.js";
import { a as ProviderCatalogOutcome, i as ModelCatalogSnapshot, r as ModelCatalogEntry } from "./model-selection-C3yS-lrH.js";
import { a as CronJobCreate, c as CronRunStatus, i as CronJob, l as CronStoredJob, o as CronJobPatch, s as CronPayload, u as CronToolsAllowProvenance } from "./store-CLHEhH_X.js";
import { n as OpenClawStateDatabaseOptions, t as OpenClawStateDatabase } from "./openclaw-state-db-contract-Cc1OsFbo.js";
import { o as runCommandWithTimeout, s as SpawnResult } from "./exec-ayCQTx2b.js";
import { A as SessionApprovalReplay, C as SessionsCatalogReadResult, D as WorkerInferenceModelRef, E as RequestFrame, O as WorkerInferenceOptions, S as SessionsCatalogReadParams, T as ErrorShape, _ as AgentsListResult, a as WizardAnswer, b as SessionsCatalogArchiveParams, c as PortalSummary, d as NodePluginToolDescriptor, f as NodeSkillDescriptor, g as SystemAgentWizardCancel, h as SystemAgentChatQuestion, i as WorkerTranscriptMessage, k as ApprovalPresentation, l as Snapshot, m as WorkerEnvironmentState, n as WorkerConnectParams, o as WizardStep$1, p as ScopeUpgradeResult, r as WorkerTranscriptCommitParams, s as PortalOpenResult, t as WorkerAdmissionHandshake, u as SessionPlacementDiskSpace, v as AgentWaitParams, w as ConnectParams, x as SessionsCatalogContinueParams, y as SessionCatalogHost } from "./index-BOCfAT1k.js";
import { a as QueuedReplyPayloadSendingHook, c as DeliveryMirror, d as PluginSubagentRequesterContext, i as QueuedRenderedMessageBatchPlan, l as DurableDeliveryCompletion, o as OutboundSessionContext, s as PreparedOutboundBatch, t as MessageSentEvent, u as DeliveryQueueCompletionRetention } from "./message-sent-hook-C_0x-XGC.js";
import { n as PinnedDispatcherPolicy, r as SsrFPolicy, t as LookupFn } from "./ssrf-DMQl3JA2.js";
import { l as ImageGenerationProvider } from "./types-B-aS5WAb.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-QsZ9pkNo.js";
import { c as VideoGenerationProvider } from "./types-CvCiRlSW.js";
import { a as EmbeddingProviderCreateOptions, c as EmbeddingProviderRuntime, i as EmbeddingProviderCallOptions$1, n as EmbeddingProvider$1, r as EmbeddingProviderAdapter, s as EmbeddingProviderIndexIdentity } from "./embedding-providers-D1rksQnW.js";
import { n as resolveAgentDir, r as resolveAgentWorkspaceDir } from "./sessions-B0DQ_ChK.js";
import { b as MemoryMultimodalSettings, r as MemoryChunk, v as EmbeddingInput } from "./internal-BbmcUcvv.js";
import { t as resolveSessionStorePathCore } from "./paths-Bf-grF6E.js";
import { a as retryAsync, r as RetryOptions } from "./index-BTQfvEv9.js";
...
import { i as OAuthLoginCallbacks, r as OAuthCredentials } from "./provider-oauth-runtime-DamE_Zlc.js";
import { c as InboundImplicitMentionKind, g as resolveInboundMentionDecision, h as implicitMentionKindWhen, i as MatchesMentionWithExplicit, r as MatchesMentionPatterns, t as BuildMentionRegexes, u as InboundMentionFacts } from "./mentions.types-CJ6SytBo.js";
import { n as ShouldHandleTextCommandsParams, t as CommandNormalizeOptions } from "./commands-registry.types-BP8N7lIL.js";
import { t as convertMarkdownTables } from "./tables-BdlTasHh.js";
import { i as UpsertChannelPairingRequestForAccount, n as ReadChannelAllowFromStoreForAccount, r as RemoveChannelAllowFromStoreEntryForAccount, t as buildPairingReply } from "./pairing-messages-BrBDw_vq.js";
import { n as recordChannelActivity, t as getChannelActivity } from "./channel-activity-BmLouy1g.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-DvnrlAyp.js";
import { i as PairLoopGuardConfig } from "./pair-loop-guard-runtime-DaIT2ns3.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-Bo_5ddbx.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-N8DagHsn.js";
import { o as ProviderUsageSnapshot } from "./provider-usage.types-CSw7pG9h.js";
import { t as ProviderAuthEvidence } from "./provider-env-vars-CkP8f8Dv.js";
import { t as enqueueSystemEvent } from "./system-events-BtMIdPhX.js";
import { n as GenerateImageRuntimeResult, t as GenerateImageParams } from "./runtime-types-9sigVf9N.js";
import { n as GenerateVideoRuntimeResult, t as GenerateVideoParams } from "./runtime-types-CI_O3Sif.js";
import { a as PluginStateSyncKeyedStore, i as PluginStateKeyedStore, t as OpenKeyedStoreOptions } from "./plugin-state-store.types-DK1KZWMb.js";
import { i as ProviderModelRouteRuntimePolicy, l as ProviderRouteOverridePresence, t as ProviderModelRouteAuthRequirement } from "./provider-model-types-Cq4wYSiK.js";
...
declare function prepareSimpleCompletionModelForAgent(params: {
  ...
  preferredProfile?: string;
  allowMissingApiKeyModes?: ReadonlyArray<AllowedMissingApiKeyMode>;
  allowBundledStaticCatalogFallback?: boolean; /** @deprecated no-op; kept for plugin-SDK source compatibility, remove at next SDK-breaking window. */
...
//#endregion
export { ProviderThinkingProfile as $, SpeechProviderResolveTalkConfigContext as $n, MemoryEmbeddingProviderAdapter as $t, WebSearchCredentialResolutionSource as A, listRegisteredMemoryEmbeddingProviders as An, CliBackendExecutionMode as At, completeWithPreparedSimpleCompletionModel as B, SpeechProviderPlugin$1 as Bn, CliBackendPreparedExecution as Bt, OpenBlobStoreOptions as C, clearMemoryPluginState as Cn, SkillWorkshopRunOptions as Cr, UnifiedModelCatalogProviderPlugin as Ct, WebFetchCredentialResolutionSource as D, listMemoryEmbeddingProviders as Dn, HookContext as Dr, PluginRuntime as Dt, PluginBlobStore as E, getMemoryEmbeddingProvider as En, BeforeToolCallFailureDisposition as Er, SessionCatalogProvider as Et, WebMediaResult as F, DetachedTaskLifecycleRuntime as Fn, CliBackendParseJsonlEvent as Ft, ResolvedProviderAuth as G, SpeechModelOverridePolicy as Gn, CliBackendThinkingLevel as Gt, prepareSimpleCompletionModelForAgent as H, SpeechDirectiveTokenParseContext as Hn, CliBackendResolveExecutionArgsContext as Ht, DEFAULT_CONTEXT_TOKENS as I, TaskRecord as In, CliBackendParseJsonlEventContext as It, resolveEnvApiKey as J, SpeechProviderId as Jn, ProcessToolDefaults as Jt, requireApiKey as K, SpeechProviderConfig as Kn, CliBackendToolAvailability as Kt, RunEmbeddedAgentParams as L, ImageGenerationProviderPlugin$1 as Ln, CliBackendParsedJsonlEvent as Lt, WebSearchProviderSetupContext as M, resolveMemorySearchConfig as Mn, CliBackendLiveSessionRequirement as Mt, WebSearchProviderToolDefinition as N, DEFAULT_AGENT_COMPACTION_RESERVE_TOKENS_FLOOR as Nn, CliBackendNativeToolMode as Nt, WebFetchProviderPlugin as O, listRegisteredMemoryEmbeddingProviderAdapters as On, ToolOutcomeObserver as Or, CliBackendAuthEpochMode as Ot, WebSearchProviderToolExecutionContext as P, DetachedTaskFinalizeParams as Pn, CliBackendNormalizeConfigContext as Pt, upsertAuthProfileWithLockOrThrow as Q, SpeechProviderResolveConfigContext as Qn, MemoryEmbeddingProvider as Qt, ConversationRecallContext as R, RealtimeTranscriptionProviderPlugin$1 as Rn, CliBackendPlugin$1 as Rt, ResolvedProviderRuntimeAuth as S, postJsonWithRetry as Sn, OperationalRunInstanceRef as Sr, UnifiedModelCatalogProviderContext as St, PluginBlobEntryInfo as T, registerMemoryCapability as Tn, AgentHarnessHostCapabilities as Tr, PluginRegistry as Tt, ModelAuthMode as U, SpeechDirectiveTokenParseResult as Un, CliBackendRuntimeArtifactPolicy as Ut, prepareSimpleCompletionModel as V, VideoGenerationProviderPlugin$1 as Vn, CliBackendResolveExecutionArgs as Vt, resolveApiKeyForProviderCore as W, SpeechListVoicesRequest as Wn, CliBackendSideQuestionToolMode as Wt, upsertAuthProfile as X, SpeechProviderPrepareSynthesisContext as Xn, MemoryEmbeddingBatchChunk as Xt, registerRuntimeAuthProfileStoreMutationListener as Y, SpeechProviderOverrides as Yn, MemoryCorpusSearchResult as Yt, upsertAuthProfileWithLock as Z, SpeechProviderPreparedSynthesis as Zn, MemoryEmbeddingBatchOptions as Zt, RuntimeLogger as _, enforceEmbeddingMaxInputTokens as _n, OpenClawPluginNodeHostCommandIo as _r, ProviderRuntimeModel as _t, OpenClawPluginGatewayRuntimeScopeSurface as a, MemoryFlushPlan as an, SpeechTelephonySynthesisRequest as ar, ProviderAuthMethod as at, TtsConfigResolutionContext as b, buildBatchHeaders as bn, McpCodexToolAnnotations as br, ProviderCatalogResult as bt, MigrationDetection as c, RegisteredMemorySearchManager as cn, TtsDirectiveParseResult as cr, ProviderPluginWizardSetup as ct, MigrationProviderContext as d, fetchRemoteEmbeddingVectors as dn, RealtimeTranscriptionProviderId as dr, ProviderReasoningOutputMode as dt, MemoryEmbeddingProviderCallOptions as en, SpeechProviderResolveTalkOverridesContext as er, ProviderWrapStreamFnContext as et, MigrationProviderPlugin as f, RemoteEmbeddingClient as fn, RealtimeTranscriptionProviderResolveConfigContext as fr, ProviderReplayPolicy as ft, PluginRuntimeCore as g, resolveRemoteEmbeddingBearerClient as gn, spawnTerminalPty as gr, PreparedModelRuntimeSnapshot as gt, AgentHarnessTaskRuntimeScope as h, RemoteEmbeddingProviderId as hn, RealtimeTranscriptionSessionCreateRequest as hr, ProviderToolSchemaDiagnostic as ht, ProviderPlugin as i, MemoryEmbeddingProviderRuntime as in, SpeechSynthesisTarget as ir, ProviderAuthContext as it, WebSearchProviderPlugin as j, registerMemoryEmbeddingProvider as jn, CliBackendJsonlUsage as jt, WebFetchProviderToolDefinition as k, clearMemoryEmbeddingProviders as kn, DiagnosticEventInput as kr, CliBackendConfig as kt, MigrationItem as l, buildRemoteBaseUrlPolicy as ln, RealtimeTranscriptionProviderConfig as lr, ProviderSystemPromptContribution as lt, DelegationCapability as m, resolveRemoteEmbeddingClient as mn, RealtimeTranscriptionSessionCallbacks as mr, ProviderSanitizeReplayHistoryContext as mt, OpenClawPluginConfigSchema as n, MemoryEmbeddingProviderCreateResult as nn, SpeechSynthesisStreamRequest as nr, ProviderPreparedRuntimeAuth as nt, MigrationApplyResult as o, MemoryPluginRuntime as on, SpeechVoiceOption as or, ProviderAuthMethodNonInteractiveContext as ot, MigrationSummary as p, createRemoteEmbeddingProvider as pn, RealtimeTranscriptionSession as pr, ProviderReplayPolicyContext as pt, resolveAwsSdkEnvVarName as q, SpeechProviderConfiguredContext as qn, CliBackendToolAvailabilityEnforcement as qt, OpenClawPluginApi as r, MemoryEmbeddingProviderIndexIdentity as rn, SpeechSynthesisStreamResult as rr, ProviderResolveDynamicModelContext as rt, MigrationConfigRuntime as s, MemoryPromptSectionBuilder as sn, TtsDirectiveOverrides as sr, ProviderAuthResult as st, OpenClawPluginDefinition as t, MemoryEmbeddingProviderCreateOptions as tn, SpeechSynthesisRequest as tr, ProviderPrepareDynamicModelContext as tt, MigrationPlan as u, withRemoteHttpResponse as un, RealtimeTranscriptionProviderConfiguredContext as ur, ProviderNormalizeToolSchemasContext as ut, ResolvedTtsConfig as v, uploadBatchJsonlFile as vn, SystemAgentOperation as vr, ProviderAugmentModelCatalogContext as vt, PluginBlobEntry as w, listMemoryCorpusSupplements as wn, AgentInternalEvent as wr, PluginHttpRouteRegistration as wt, resolveEffectiveTtsConfig as x, normalizeBatchBaseUrl as xn, AdmittedRunContext as xr, ProviderPluginCatalog as xt, ResolvedTtsModelOverrides as y, BatchHttpClientConfig as yn, SecretInputMode as yr, ProviderCatalogContext as yt, ExecToolDefaults as z, RealtimeVoiceProviderPlugin$1 as zn, CliBackendPrepareExecutionContext as zt };