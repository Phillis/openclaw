...
import { d as resolveAgentWorkspaceDir, f as resolveDefaultAgentDir, p as resolveDefaultAgentId } from "./agent-scope-config-BdXMWufB.js";
import { r as getRuntimeConfig, t as projectConfigOntoRuntimeSourceSnapshot } from "./io-D1h6pxaD.js";
...
import { n as resolveInstalledManifestRegistryIndexFingerprint } from "./manifest-registry-installed-FCmk8v-i.js";
import { a as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-poyRjWh_.js";
import { k as resolveCatalogOwnedModelCompat, p as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-DT9x3Cg2.js";
...
import { c as getRuntimeConfigSourceSnapshot, u as hashRuntimeConfigValue } from "./runtime-snapshot-Dp7mvsA3.js";
...
import { c as isNonSecretApiKeyMarker, d as resolveEnvSecretRefHeaderValueMarker, f as resolveNonEnvSecretRefApiKeyMarker, p as resolveNonEnvSecretRefHeaderValueMarker } from "./model-auth-markers-DJWHSR2r.js";
import { d as resolveOwningPluginIdsForProviderRef } from "./providers-63828CFG.js";
import { m as normalizeProviderConfigWithPlugin, n as applyProviderNativeStreamingUsageCompatWithPlugin, w as resolveProviderConfigApiKeyWithPlugin } from "./provider-runtime-DStPs6cE.js";
import { r as ensureAuthProfileStore } from "./store-DOJuehrg.js";
import { d as PLUGIN_MODEL_CATALOG_GENERATED_BY, f as repairPluginModelCatalogTransportMetadata, i as isGeneratedPluginModelCatalog, l as replacePersistedPluginModelCatalogs, n as encodePluginModelCatalogRelativePath, o as loadPersistedPluginModelCatalogs, s as loadPersistedPluginModelCatalogsReadOnly, t as decodePluginModelCatalogRelativePathPluginId, u as resolvePluginModelCatalogOwnerPluginId } from "./plugin-model-catalog-D6SwPimH.js";
import { a as runProviderCatalog, i as resolveRuntimePluginDiscoveryProviders, n as normalizePluginDiscoveryResult, o as runProviderStaticCatalog, r as prepareProviderStaticCatalog, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-DATDyD7M.js";
import { a as normalizeConfiguredProviderApiKey, c as resolveApiKeyFromProfiles, l as resolveMissingProviderApiKey, o as normalizeHeaderValues, r as createProviderAuthResolver, s as normalizeResolvedEnvApiKey, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-CRqA8KOR.js";
...
function normalizeProviderConfigPolicy(providerKey, provider, manifestRegistry) {
...
function resolveProviderConfigApiKeyPolicy(providerKey, provider, manifestRegistry) {
...
function normalizeProviders(params) {
	...
	for (const [key, provider] of Object.entries(providers)) {
		...
		const providerSpecificNormalized = normalizeProviderSpecificConfig(normalizedKey, normalizedProvider, params.manifestRegistry);
...
async function resolveProvidersForModelsJsonWithDeps(params, deps) {
	...
	return mergeProviders({
		implicit: await (deps?.resolveImplicitProviders ?? resolveImplicitProviders)({
			...
			...params.onProviderCatalogOutcome ? { onProviderCatalogOutcome: params.onProviderCatalogOutcome } : {}
		}),
		explicit: explicitProviders
	});
}
...
async function planOpenClawModelsJsonWithDeps(params, deps) {
	...
	const providerPolicyManifestRegistry = params.pluginMetadataSnapshot?.pluginIds === void 0 ? params.pluginMetadataSnapshot?.manifestRegistry : void 0;
...
async function buildModelsJsonFingerprint(params) {
	...
	return stableStringify({
		...
		pluginMetadataSnapshotPluginIds: params.pluginMetadataSnapshot?.pluginIds === void 0 ? null : params.pluginMetadataSnapshot.pluginIds.toSorted(),
