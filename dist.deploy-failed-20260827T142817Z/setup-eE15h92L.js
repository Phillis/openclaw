...
import { Q as ConfigMutationConflictError } from "./io-D1h6pxaD.js";
...
import { r as resolveOnboardingAgentTarget } from "./onboard-agent-target-RTxUCH5n.js";
import { n as t } from "./i18n-BzsUVhtU.js";
import { c as formatPluginCompatibilityNotice, r as buildPluginCompatibilitySnapshotNotices } from "./status-Dlx02Gb7.js";
...
import { a as requireRiskAcknowledgement, i as readValidSetupConfigFile, n as hasQuickstartGatewayOverrides, o as resolveQuickstartGatewayDefaults, r as readSetupConfigFileSnapshot, s as writeWizardConfigFile, t as formatQuickstartGatewaySummary } from "./setup.shared-81PCw8JC.js";
import { n as showSessionMigrationWarnings, t as promptFirstOnboardingAgent } from "./onboard-first-agent-y5NcW5Sw.js";
import { a as runSetupModelAuthStep, i as offerLiveModelVerification, n as listSetupMigrationOptions, r as runSetupMigrationImport, t as detectSetupMigrationSources } from "./setup.migration-import-DP8blVXn.js";
...
const loadConfigLoggingModule = createLazyRuntimeModule(() => import("./logging-CvvD_dWV.js"));
...
async function runSetupWizardOnce(opts, runtimeInput, prompter) {
	...
	const onboardHelpers = await import("./onboard-helpers-DG0mt_gD.js");
	...
	const remoteOnboard = seededRemoteUrl ? await import("./onboard-remote-CPUd_sEh.js") : null;
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = remoteOnboard ?? await import("./onboard-remote-CPUd_sEh.js");
	...
	if (opts.skipChannels) await prompter.note(t("wizard.setup.skipChannels"), t("wizard.setup.channelsTitle"));
		...
		const { listChannelPlugins } = await import("./plugins-TUqIkg04.js");
		const { setupChannels } = await import("./onboard-channels-BN2qE8ec.js");
	...
	if (opts.skipSkills) await prompter.note(t("wizard.setup.skipSkills"), t("wizard.setup.skillsTitle"));
		...
		const { setupSkills } = await import("./onboard-skills-KdGdmS4d.js");
	...
	if (flow !== "quickstart") {
		const { setupOfficialPluginInstalls } = await import("./setup.official-plugins-BIU82n0Y.js");
		...
		const { setupAppRecommendations } = await import("./setup.app-recommendations-DoDompoZ.js");
		...
		const { setupPluginConfig } = await import("./setup.plugin-config-BV1jHuyo.js");
	...
	const { finalizeSetupWizard } = await import("./setup.finalize-D73pfEnh.js");
