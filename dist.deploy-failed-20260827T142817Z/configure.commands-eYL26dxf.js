...
import { _ as resolveGatewayPort, t as CONFIG_PATH } from "./paths-CqeDjSA4.js";
...
import { d as isSecretRef, p as isValidEnvSecretRefId } from "./types.secrets-BrIfhxSG.js";
...
import { y as isNonFatalSystemdInstallProbeError } from "./systemd-DPnIQILH.js";
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-tW602Xtl.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CHOL1Kuf.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-D6zGEImS.js";
import { a as findTailscaleBinary } from "./tailscale-BTNUtOR0.js";
import { t as randomToken } from "./random-token-B1woZa_H.js";
import { a as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CJsmassN.js";
import { o as formatPortRangeHint } from "./error-format-BAHQH0iA.js";
import { t as parsePort } from "./parse-port-BMBBPvn5.js";
import { r as resolveGatewayProbeAuthSafeWithSecretInputs } from "./probe-auth-Hwntf26y.js";
import { r as resolveLocalControlUiProbeLinks, t as resolveAdvertisedControlUiLinks } from "./control-ui-links-DfRqI0QP.js";
import { t as formatWindowsGatewayFirewallGuidance } from "./windows-gateway-firewall-diagnostics-OaczVGsd.js";
...
import { f as probeGatewayReachable, h as waitForGatewayReachable, l as normalizeGatewayTokenInput, m as validateGatewayPasswordInput, n as applyWizardMetadata, o as guardCancel, p as summarizeExistingConfig, t as DEFAULT_WORKSPACE } from "./onboard-helpers-DQoIxFmS.js";
import { n as ensureOnboardingAgentWorkspace, r as resolveOnboardingAgentTarget } from "./onboard-agent-target-RTxUCH5n.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-B4h548_W.js";
...
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-SGKb09Jv.js";
import { i as applyAuthChoice } from "./auth-choice-DQbK1p8O.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-iFc91pKa.js";
import { i as setupChannels } from "./onboard-channels-Bq4c2662.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-DttHHsJP.js";
import { s as writeWizardConfigFile } from "./setup.shared-81PCw8JC.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B-fip6kU.js";
import { n as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-C_4tc_Ek.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DZkrZUcg.js";
import { t as promptCustomApiConfig } from "./onboard-custom-k3C_8Mb0.js";
import { a as validateDottedDecimalIPv4Input, i as maybeAddTailnetOriginToControlUiAllowedOrigins, n as TAILSCALE_EXPOSURE_OPTIONS, r as TAILSCALE_MISSING_BIN_NOTE_LINES, t as TAILSCALE_DOCS_LINES } from "./gateway-config-prompts.shared-B6nsIs8C.js";
import { r as formatHealthCheckFailure } from "./health-format-pjiYpvZn.js";
import { a as healthCommand } from "./health-TScPfFW1.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BCoHMneM.js";
import { t as setupSkills } from "./onboard-skills-BChO0R_m.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-BV1jHuyo.js"));
...
async function runGatewayHealthCheck(params) {
	...
	if (probeMode === "remote") {
		...
		if (remoteProbeAuth.warning) {
			...
			if (!hasResolvedRemoteAuth) return false;
		}
		({token, password} = remoteProbeAuth.auth);
	} else {
		const [configuredToken, configuredPassword] = await Promise.all([resolveGatewaySecretInputForWizard({
			cfg: params.cfg,
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-CkzcBWqG.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, runSearchSetupFlow } = await import("./search-setup-9ikdPtfr.js");
...
async function runConfigureWizard(opts, runtime = defaultRuntime) {
	try {
		...
		if (shouldPromptGatewayRunMode && mode === "remote") {
			...
			if (selectedSections?.includes("health")) outro(await runGatewayHealthCheck({
				cfg: remoteConfig,
				runtime,
				port: resolveGatewayPort(remoteConfig)
			}) ? "Remote gateway configured and health check completed." : "Remote gateway configured; health check skipped.");
