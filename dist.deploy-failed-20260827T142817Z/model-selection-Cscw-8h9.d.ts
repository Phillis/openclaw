import { a as ModelCompatConfig, et as MarkdownTableMode, g as Message, h as ImageContent, i as ModelApi, n as OpenClawConfig, nt as SessionMaintenanceMode, s as ModelMediaInputConfig, x as TextContent } from "./types.openclaw-CpYrAZv3.js";
import { C as ChannelId, f as HookExternalContentSource, v as CronScheduledToolPolicy } from "./types-CkKOeDuP.js";
import { cn as CustomMessage, en as TranscriptEntryAnchor, rn as AgentMessage, sn as BashExecutionMessage } from "./setup-wizard-types-DUwZ9UvR.js";
import { D as ModelCatalogStatus } from "./manifest-registry-BJDg-GrV.js";
