import { gn as TelegramNetworkConfig } from "./types.openclaw-D9FrGbix.js";
...
type TelegramIngressWorkerMessage = {
  ...
  errorCode?: number; /** Actual server-directed flood wait currently being honored by the worker. */
  retryAfterMs?: number;
  finishedAt: number;
} | {
  type: "spooled";
