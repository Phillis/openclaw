import { i as OpenClawConfig, p as PluginInstallRecord } from "./types.openclaw-D9FrGbix.js";
import { Lt as EmbeddedAgentRunResult, U as resolveCliBackendLiveSessionRequirement, b as ProviderAuthResult, l as AgentHarnessAuthBindingFingerprintParams, r as ProviderPlugin, v as AgentHarnessRuntimeArtifactBinding, z as RunCliAgentParams } from "./host-capability-types-BzWjoGQ2.js";
import { f as RuntimeEnv, o as PluginOrigin, s as OpenClawPackageBuild } from "./manifest-registry-DXEb65Gx.js";
import { n as InstalledPluginIndexRefreshReason } from "./installed-plugin-index-types-aLS4IDXJ.js";
import { n as PluginMetadataRegistryView, r as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-BMcWFrCD.js";
import { t as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-DjiVTt0p.js";
import { G as ConfigMutationResult, Y as TransformConfigFileWithRetryParams, dt as readConfigFileSnapshot } from "./config-CI0ls3E6.js";
import { i as AuthProfileStore } from "./types-DnhOPMR4.js";
import { O as WizardPrompter } from "./types.public-DHic20VT.js";
import { a as resolveApiKeyForProviderCore, o as ResolvedProviderAuth } from "./provider-model-types-Dnc_WtAe.js";
import { a as ensureAuthProfileStore, c as AuthProfileDatabase, o as loadAuthProfileStoreForRuntime, s as updateAuthProfileStoreWithLock } from "./usage-DphY_ie8.js";
import { n as AgentExecutionAuthBinding, r as OpaqueRuntimeOwnerKind, t as runEmbeddedAgent } from "./embedded-agent-DFSkd9L6.js";
import { d as PluginLoadOptions } from "./loader-CJnoaaWB.js";
