 ...
 */
type PluginDiagnosticCode = "channel-setup-failure" | "dashboard-declaration-invalid" | "plugin-verification" | "workspace-scope-omitted";
...
type PluginManifest = {
  ...
  setup?: PluginManifestSetup; /** Doctor contract surfaces available without loading the plugin artifact. */
  doctorContract?: PluginManifestDoctorContract; /** Static ownership metadata for doctor session-route state repairs. */
  sessionRouteStateOwners?: DoctorSessionRouteStateOwner[]; /** Cheap QA runner metadata exposed before plugin runtime loads. */
...
type PluginPackageChannelDoctorCapabilities = {
  dmAllowFromMode?: "topOnly" | "topOrNested" | "nestedOnly"; /** Whether dmPolicy="open" requires an explicit "*" in allowFrom. Defaults to true. */
...
type PluginCandidate = {
  idHint: string; /** Discovery-owned identity for one entry in a multi-entry package pack. */
...
//#endregion
export { PluginManifestProviderRequestProvider as C, ModelCatalogStatus as D, JsonSchemaObject as E, UnifiedModelCatalogEntry as O, PluginManifestProviderEndpoint as S, ChannelConfigSchema as T, PluginManifestContracts as _, PluginDependencyStatus as a, PluginManifestDashboardDataBinding as b, PluginPackageChannel as c, ChannelSetupAdapter as d, RuntimeEnv as f, PluginFormat as g, PluginDiagnostic as h, PluginDiscoveryResult as i, UnifiedModelCatalogKind as k, PluginPackageInstall as l, PluginConfigUiHint as m, PluginManifestRegistry as n, PluginOrigin as o, PluginBundleFormat as p, PluginCandidate as r, OpenClawPackageBuild as s, PluginManifestRecord as t, ChannelOwnedSetupContract as u, PluginManifestDashboard as v, PluginKind as w, PluginManifestMcpServer as x, PluginManifestDashboardActionVerb as y };