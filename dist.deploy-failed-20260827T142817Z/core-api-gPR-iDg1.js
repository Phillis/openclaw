...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-CJe40hw8.js";
import { D as parseBrowserErrorPayload, X as withTimeout } from "./tmp-openclaw-dir-DoieXIgG.js";
import "./control-auth-DrorZF1h.js";
import "./chrome-DgWaWA9a.js";
import "./trash-Dl_zOrVI.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context--fS_iZqr.js";
import "./sdk-setup-tools-Dlma8XjO.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-CmX9wnld.js";
import "./routes-Bu56rgmh.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-By-olNLK.js";
import { s as stopBrowserBridgeRuntime, t as createBrowserControlContext } from "./browser-control-state-B_eS4wIO.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-D_w-wtfv.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-CujVavEK.js"), import("./routes-SdyIha_8.js")]);
