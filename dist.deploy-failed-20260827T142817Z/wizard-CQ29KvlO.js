...
import { Ga as validateWizardStartParams, Ka as validateWizardStatusParams, Ua as validateWizardCancelParams, Wa as validateWizardNextParams } from "./src-Bo4ezI_n.js";
...
import { a as whenAdmittedWizardSessionSettled, r as createAdmittedWizardSession, t as SETUP_ADMISSION_BUSY_MESSAGE } from "./setup-admission-BWx5aUeI.js";
import { randomUUID } from "node:crypto";
//#region src/gateway/server-methods/wizard.ts
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-ieUn8wIp.js");
	return runSetupWizard(...args);
};
const runDefaultChannelSetupWizard = async (...args) => {
	const { runChannelsSetupWizard } = await import("./add-wizard-DW7V8_e7.js");
