...
import { l as OpenAICompletionsCompat, m as ThinkingLevelMap, t as AnthropicMessagesCompat, u as OpenAIResponsesCompat } from "./types-GU_0Dtwq.js";
...
type SecretDefaults = {
  ...
  exec?: string; /** Default provider alias for shared-store SecretRefs. */
  store?: string;
};
...
//#endregion
export { DiscoveryConfig as $, ChannelDeliveryStreamingConfig as $a, SkillConfig as $i, IMessageActionConfig as $n, SecretInput as $o, AgentConfig as $r, WhatsAppAckReactionConfig as $t, ModelProviderConfig as A, AgentCompactionIdentifierPolicy as Aa, MediaUnderstandingScopeConfig as Ai, SlackReactionNotificationMode as An, SessionSendPolicyConfig as Ao, DiscordVoiceRealtimeBootstrapContextFile as Ar, MessageSendersAccessGroup as As, MdnsDiscoveryConfig as At, McpServerCodexConfig as B, AgentImageQualityPreference as Ba, ToolPolicyConfig as Bi, SignalReactionNotificationMode as Bn, SandboxDockerSettings as Bo, BrowserSnapshotDefaults as Br, DesktopHostConfig as Bt, ModelApi as C, MemoryCitationsMode as Ca, LinkToolsConfig as Ci, SlackCapabilitiesConfig as Cn, SessionMaintenanceMode as Co, DiscordThreadBindingsConfig as Cr, AcpConfig as Cs, GatewayRemoteConfig as Ct, ModelImageInputConfig as D, MemorySearchManager as Da, MediaUnderstandingCapabilityConfig as Di, SlackDmConfig as Dn, SessionRotationConfig as Do, DiscordVoiceAutoJoinConfig as Dr, AccessGroupConfig as Ds, GatewayTlsConfig as Dt, ModelDefinitionConfig as E, MemoryExtraPath as Ea, MediaUnderstandingCapability as Ei, SlackConfig as En, SessionResetMode as Eo, DiscordVoiceAllowedChannelConfig as Er, AcpStreamConfig as Es, GatewayTerminalConfig as Et, ModelsConfigInput as F, AgentCompactionQualityGuardConfig as Fa, SessionsToolsVisibility as Fi, SlackThreadConfig as Fn, StreamingMode as Fo, ChannelHeartbeatVisibilityConfig as Fr, TalkProviderConfig as Ft, HookMappingConfig as G, AgentThinkingLevel as Ga, parseToolsBySenderTypedKey as Gi, MSTeamsReplyStyle as Gn, EnvSecretProviderConfig as Go, ApprovalsConfig as Gr, CloudWorkersConfig as Gt, McpServerToolFilterConfig as H, AgentModelListConfig as Ha, ToolSearchConfig as Hi, MSTeamsChannelConfig as Hn, SandboxSshSettings as Ho, BrowserTabCleanupConfig as Hr, CronFailureAlertConfig as Ht, SupportedThinkingFormat as I, AgentContextInjection as Ia, SwarmConfig as Ii, SignalAccountConfig as In, TextChunkMode as Io, ChannelBotLoopProtectionConfig as Ir, TalkRealtimeConfig as It, HookSessionMode as J, SubagentDelegationMode as Ja, ConfiguredProviderRequest as Ji, MSTeamsWebhookConfig as Jn, FileSecretProviderMode as Jo, ExecApprovalForwardingMode as Jr, ChannelsConfig as Jt, HookMappingMatch as K, EmbeddedAgentExecutionContract as Ka, SsrFPolicyConfig as Ki, MSTeamsSsoConfig as Kn, ExecSecretProviderConfig as Ko, ExecApprovalForwardTarget as Kr, ChannelDefaultsConfig as Kt, isModelThinkingFormat as L, AgentContextLimitsConfig as La, TOOLS_BY_SENDER_KEY_TYPES as Li, SignalConfig as Ln, TypingMode as Lo, BrowserConfig as Lr, WideAreaDiscoveryConfig as Lt, ModelProviderDeclarationConfig as M, AgentCompactionMidTurnPrecheckConfig as Ma, MediaUnderstandingScopeRule as Mi, SlackSlashCommandConfig as Mn, SessionSendPolicyRule as Mo, DiscordVoiceRealtimeConsultPolicy as Mr, ResolvedTalkConfig as Mt, ModelProviderLocalServiceConfig as N, AgentCompactionMode as Na, MessageToolsConfig as Ni, SlackStreamingMode as Nn, SessionSharingConfig as No, DiscordVoiceRealtimeToolPolicy as Nr, TalkConfig as Nt, ModelMediaInputConfig as O, MemorySearchResult as Oa, MediaUnderstandingConfig as Oi, SlackExecApprovalConfig as On, SessionScope as Oo, DiscordVoiceConfig as Or, AccessGroupsConfig as Os, GatewayToolsConfig as Ot, ModelsConfig as P, AgentCompactionPostIndexSyncMode as Pa, SessionsSpawnToolsConfig as Pi, SlackStreamingProgressConfig as Pn, SessionThreadBindingsConfig as Po, ChannelHealthMonitorConfig as Pr, TalkConfigResponse as Pt, InternalHooksConfig as Q, BlockStreamingCoalesceConfig as Qa, SafeBinProfileFixture as Qi, IMessageAccountConfig as Qn, PluginIntegrationSecretProviderConfig as Qo, AgentBindingMatch as Qr, WhatsAppAccountConfig as Qt, McpCodexToolApprovalMode as R, AgentContextPruningConfig as Ra, ToolAllowDenyPolicyConfig as Ri, SignalGroupConfig as Rn, AgentModelConfig as Ro, BrowserExtensionRelayConfig as Rr, OperatorScope as Rt, MODEL_THINKING_FORMATS as S, QueueModeByProvider as Sa, LinkModelConfig as Si, SlackActionConfig as Sn, SessionMaintenanceConfig as So, DiscordStreamMode as Sr, ChatType as Ss, GatewayReloadMode as St, ModelCompatConfig as T, MemorySearchConfig as Ta, MediaUnderstandingAttachmentsConfig as Ti, SlackChannelStreamingConfig as Tn, SessionResetConfig as To, DiscordVoiceAgentSessionConfig as Tr, AcpRuntimeConfig as Ts, GatewayTailscaleMode as Tt, HookConfig as U, AgentModelPolicyConfig as Ua, ToolsBySenderKeyType as Ui, MSTeamsCloudName as Un, DEFAULT_SECRET_PROVIDER_ALIAS as Uo, AuthConfig as Ur, CronFailureDestinationConfig as Ut, McpServerConfig as V, AgentModelEntryConfig as Va, ToolProfileId as Vi, SignalTransportConfig as Vn, SandboxPruneSettings as Vo, BrowserSsrFPolicyConfig as Vr, CronConfig as Vt, HookInstallRecord as W, AgentStartupContextConfig as Wa, ToolsConfig as Wi, MSTeamsConfig as Wn, ENV_SECRET_REF_ID_RE as Wo, AuthProfileConfig as Wr, CloudWorkerProfileConfig as Wt, HooksGmailConfig as X, AuditConfig as Xa, ConfiguredProviderRequestProxy as Xi, IrcConfig as Xn, LEGACY_SECRETREF_ENV_MARKER_PREFIX as Xo, AgentAcpBinding as Xr, ExtensionChannelConfig as Xt, HooksConfig as Y, AgentElevatedAllowFromConfig as Ya, ConfiguredProviderRequestAuth as Yi, IrcAccountConfig as Yn, LEGACY_DOUBLE_UNDERSCORE_ENV_MARKER_PREFIX as Yo, NativeExecApprovalEnableMode as Yr, ExtensionAccountConfig as Yt, HooksGmailTailscaleMode as Z, BlockStreamingChunkConfig as Za, ConfiguredProviderRequestTls as Zi, ChannelImplicitMentionsConfig as Zn, ManualExecSecretProviderConfig as Zo, AgentBinding as Zr, ExtensionNestedPolicyConfig as Zt, NodeHostBrowserProxyConfig as _, NativeCommandsSetting as _a, CodeModeConfig as _i, TelegramPreviewStreamingConfig as _n, MarkdownTableMode as _o, DiscordIntentsConfig as _r, normalizeSecretInputString as _s, GatewayNodesConfig as _t, OpenClawConfigInput as a, SkillsWorkshopConfig as aa, LoopGovernorAlertChannel as ai, AutoTopicLabelConfig as an, ChannelStreamingProgressConfig as ao, GoogleChatDmConfig as ar, SecretsConfig as as, GatewayConfig as at, DiscoveryToggleConfig as b, StatusReactionsConfig as ba, GroupToolPolicyBySenderConfig as bi, TelegramTopicConfig as bn, ReplyToMode as bo, DiscordReactionNotificationMode as br, resolveSecretInputRef as bs, GatewayPushConfig as bt, SecurityAuditSuppression as c, CommandAllowFrom as ca, TtsAutoMode as ci, TelegramCapabilitiesConfig as cn, DiagnosticsConfig as co, DiscordActionConfig as cr, assertSecretInputResolved as cs, GatewayHttpChatCompletionsImagesConfig as ct, SurfaceConfigEntry as d, GroupChatConfig as da, TtsModelOverrideConfig as di, TelegramDirectConfig as dn, DmScope as do, DiscordChannelStreamingConfig as dr, hasConfiguredSecretInput as ds, GatewayHttpResponsesConfig as dt, SkillsConfig as ea, AgentEntryConfig as ei, WhatsAppActionConfig as en, ChannelPreviewStreamingConfig as eo, IMessageConfig as er, SecretInputStringResolution as es, GatewayAuthConfig as et, PluginEntryConfig as f, InboundDebounceByProvider as fa, TtsPersonaConfig as fi, TelegramExecApprovalConfig as fn, GroupPolicy as fo, DiscordConfig as fr, isLegacySecretRefEnvMarker as fs, GatewayHttpResponsesFilesConfig as ft, PluginsLoadConfig as g, MessagesConfig as ga, AgentToolsConfig as gi, TelegramNetworkConfig as gn, MarkdownConfig as go, DiscordGuildEntry as gr, normalizeResolvedSecretInputString as gs, GatewayNodePairingConfig as gt, PluginsConfig as h, MentionPatternsPolicyConfig as ha, TtsProviderConfigMap as hi, TelegramInlineButtonsScope as hn, LoggingConfig as ho, DiscordGuildChannelConfig as hr, isValidEnvSecretRefId as hs, GatewayHttpSecurityHeadersConfig as ht, OpenClawConfig as i, SkillsWorkshopAutonomousMode as ia, AgentsConfig as ii, WhatsAppReactionLevel as in, ChannelStreamingPreviewConfig as io, GoogleChatConfig as ir, SecretRefSource as is, GatewayCliAgentsConfig as it, ModelProviderConfigInput as j, AgentCompactionMemoryFlushConfig as ja, MediaUnderstandingScopeMatch as ji, SlackRelayConfig as jn, SessionSendPolicyMatch as jo, DiscordVoiceRealtimeConfig as jr, SilentReplyConversationType as js, MdnsDiscoveryMode as jt, ModelProviderAuthMode as k, AgentCompactionConfig as ka, MediaUnderstandingModelConfig as ki, SlackExecApprovalTarget as kn, SessionSendPolicyAction as ko, DiscordVoiceMode as kr, DiscordChannelAudienceAccessGroup as ks, GatewayTrustedProxyConfig as kt, SecurityConfig as l, CommandsConfig as la, TtsConfig as li, TelegramConfig as ln, DiagnosticsOtelConfig as lo, DiscordAgentComponentsConfig as lr, coerceSecretRef as ls, GatewayHttpConfig as lt, PluginSlotsConfig as m, MentionPatternsMode as ma, TtsProvider as mi, TelegramGroupConfig as mn, IdentityConfig as mo, DiscordExecApprovalConfig as mr, isUnresolvedSecretInputError as ms, GatewayHttpResponsesPdfConfig as mt, ConfigValidationIssue as n, SkillsLimitsConfig as na, AgentRuntimeAcpConfig as ni, WhatsAppDirectConfig as nn, ChannelStreamingCommandTextMode as no, IMessageSendTransport as nr, SecretProviderConfig as ns, GatewayAuthRateLimitConfig as nt, ResolvedSourceConfig as o, BroadcastConfig as oa, LoopGovernorConfig as oi, TelegramAccountConfig as on, ContextVisibilityMode as oo, GoogleChatGroupConfig as or, StoreSecretProviderConfig as os, GatewayControlUiConfig as ot, PluginInstallRecord as p, InboundDebounceConfig as pa, TtsPersonaFallbackPolicy as pi, TelegramExecApprovalTarget as pn, HumanDelayConfig as po, DiscordDmConfig as pr, isSecretRef as ps, GatewayHttpResponsesImagesConfig as pt, HookMappingTransform as q, OptionalBootstrapFileName as qa, ConfiguredModelProviderRequest as qi, MSTeamsTeamConfig as qn, FileSecretProviderConfig as qo, ExecApprovalForwardingConfig as qr, ChannelModelByChannelConfig as qt, LegacyConfigIssue as r, SkillsLoadConfig as ra, AgentRuntimeConfig as ri, WhatsAppGroupConfig as rn, ChannelStreamingConfig as ro, GoogleChatAccountConfig as rr, SecretRef as rs, GatewayBindMode as rt, RuntimeConfig as s, BroadcastStrategy as sa, ResolvedTtsPersona as si, TelegramActionConfig as sn, DiagnosticsCacheTraceConfig as so, DiscordAccountConfig as sr, UnresolvedSecretInputError as ss, GatewayHttpChatCompletionsConfig as st, ConfigFileSnapshot as t, SkillsInstallConfig as ta, AgentRouteBinding as ti, WhatsAppConfig as tn, ChannelStreamingBlockConfig as to, IMessageReactionNotificationMode as tr, SecretInputStringResolutionMode as ts, GatewayAuthMode as tt, SourceConfig as u, DmConfig as ua, TtsMode as ui, TelegramCustomCommand as un, DmPolicy as uo, DiscordAutoPresenceConfig as ur, collectEnvSecretRefIds as us, GatewayHttpEndpointsConfig as ut, NodeHostConfig as v, ProviderCommandsConfig as va, ExecToolConfig as vi, TelegramStreamingMode as vn, OutboundRetryConfig as vo, DiscordMentionAliasesConfig as vr, parseEnvTemplateSecretRef as vs, GatewayPushApnsConfig as vt, ModelCatalogRefreshConfig as w, MemoryConfig as wa, MediaToolsConfig as wi, SlackChannelConfig as wn, SessionResetByTypeConfig as wo, DiscordThreadConfig as wr, AcpDispatchConfig as ws, GatewayTailscaleConfig as wt, MODEL_APIS as x, QueueDropPolicy as xa, GroupToolPolicyConfig as xi, SlackAccountConfig as xn, SessionConfig as xo, DiscordSlashCommandConfig as xr, resolveSecretInputString as xs, GatewayReloadConfig as xt, BedrockDiscoveryConfig as y, QueueConfig as ya, FsToolsConfig as yi, TelegramThreadBindingsConfig as yn, ReplyMode as yo, DiscordPluralKitConfig as yr, parseLegacySecretRefEnvMarker as ys, GatewayPushApnsRelayConfig as yt, McpConfig as z, AgentDefaultsConfig as za, ToolLoopDetectionConfig as zi, SignalReactionLevel as zn, SandboxBrowserSettings as zo, BrowserProfileConfig as zr, DesktopConfig as zt };