...
import { a as listAgentIds, d as resolveAgentWorkspaceDir, l as resolveAgentDir, p as resolveDefaultAgentId, s as resolveAgentConfig, t as AgentSelectionRequiredError } from "./agent-scope-config-BdXMWufB.js";
...
import { y as resolveClawHubBaseUrl } from "./clawhub-client-4V78ChLt.js";
...
import { f as MAX_PLUGIN_STATE_ENTRIES_PER_PLUGIN, t as createCorePluginStateSyncKeyedStore } from "./plugin-state-store-3qJxZb8E.js";
import { Yt as listSessionTranscriptInstances } from "./session-accessor-CVnxp3UM.js";
import { k as readTranscriptStatsSync } from "./session-accessor.sqlite-transcript-store-DmssQj1u.js";
import { Ai as validateSkillsUploadChunkParams, Ci as validateSkillsProposalsListParams, Di as validateSkillsStatusParams, Ei as validateSkillsSkillCardParams, Oi as validateSkillsUpdateParams, Si as validateSkillsProposalUpdateParams, Ti as validateSkillsSecurityVerdictsParams, _i as validateSkillsProposalEvaluateParams, a_ as validateSkillsProposalHistoryStatusParams, bi as validateSkillsProposalRequestRevisionParams, di as validateSkillsCuratorActionParams, ey as buildClawHubTrustErrorDetails, fi as validateSkillsCuratorStatusParams, gi as validateSkillsProposalCreateParams, hi as validateSkillsProposalActionParams, i_ as validateSkillsProposalHistoryScanParams, ji as validateSkillsUploadCommitParams, ki as validateSkillsUploadBeginParams, mi as validateSkillsInstallParams, pi as validateSkillsDetailParams, ui as validateSkillsBinsParams, vi as validateSkillsProposalEventsListParams, wi as validateSkillsSearchParams, xi as validateSkillsProposalReviseParams, yi as validateSkillsProposalInspectParams } from "./src-Bo4ezI_n.js";
...
import { a as restoreCuratedSkill, i as pinCuratedSkill, o as unpinCuratedSkill, r as getSkillCuratorStatus } from "./curator-D9TTWTLb.js";
...
import { _ as installSkillArchiveFromPath, c as searchSkillsFromClawHub, f as parseRequestedClawHubSkillRef, i as readLocalSkillCardContentSync, r as updateSkillsFromClawHub, t as installSkillFromClawHub, y as validateRequestedSkillSlug } from "./clawhub-BbF6b2MA.js";
import { r as fetchExactClawHubSkillSecurityVerdicts, s as fetchClawHubSkillDetail } from "./clawhub-install-trust-CfEKfDHW.js";
import { t as buildWorkspaceSkillStatus } from "./status-BFrBUUAi.js";
import { r as loadWorkspaceSkills } from "./workspace-skill-loader-Cv5Ol3Y8.js";
import { a as proposeUpdateSkill, c as reviseSkillProposal, d as getSkillProposalRunProgress, f as inspectSkillProposal, i as proposeCreateSkill, l as evaluateSkillProposal, n as applySkillProposal, o as quarantineSkillProposal, p as listSkillProposals, s as rejectSkillProposal, u as listSkillProposalEvents } from "./service-D01ZPgBg.js";
import { i as isRealNonHeartbeatUserMessage, r as isHeartbeatUserMessage } from "./heartbeat-filter-DUq7gxRL.js";
...
import { n as installSkill } from "./install-BRMRPUpy.js";
...
async function runSkillHistoryScanReview(params) {
	...
	try {
		...
		const { runEmbeddedAgent } = await import("./embedded-agent-FeUdPibX.js");
...
async function forwardSkillWorkshopRevisionToChatSend(opts, params) {
	const { handleChatSend } = await import("./chat-send-handler-DPzSVCoX.js");
	const chatParams = {
