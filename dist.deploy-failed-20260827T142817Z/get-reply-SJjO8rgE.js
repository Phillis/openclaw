...
import { dt as resolveOwnerPromptNumbers, r as getRuntimeConfig } from "./io-D1h6pxaD.js";
...
import { n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-KBBrAmGh.js";
...
import { i as resetRegisteredAgentHarnessSessions } from "./registry-RzPPae7_.js";
import { t as getGlobalHookRunner, v as fireAndForgetHook } from "./hook-runner-global-BNCkTxOs.js";
...
import { N as commitReplySessionInitialization, P as loadReplySessionInitializationSnapshot, Qt as loadSessionEntry, _n as sessionEntryForkedFromParent, at as getCliSessionBinding, gn as buildSessionCreationStamp, hn as resolveSessionStorePathForScope, it as clearAllCliSessions } from "./session-accessor-CVnxp3UM.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-CWrpiLCs.js";
...
import { ct as deriveSessionMetaPatch, tt as conversationIdentityFromMsgContext } from "./targets-BzJLDErS.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { $ as runExclusiveSessionStoreWrite, D as resolveMaintenanceConfigFromInput, K as interruptSessionWorkAdmissions, X as runExclusiveSessionLifecycleMutation, l as resolveAgentHarnessSessionContextError } from "./agent-harness-session-key-D5rklW6u.js";
import { a as enqueueSystemEvent, m as selectAgentSystemEvents, t as consumeSelectedSystemEventEntries, u as peekSystemEventEntries } from "./system-events-B0eLVp5j.js";
import { d as DEFAULT_RESET_TRIGGERS } from "./restart-recovery-state-DDUaUjgV.js";
...
import { n as hasResolvedThinkingCatalogEntry, o as resolveEffectiveAgentRuntime } from "./thinking-runtime-CvHDRR81.js";
...
import { _ as isWorkspaceBootstrapPending, m as ensureAgentWorkspace } from "./workspace-BV2vwVv3.js";
import { g as registerMainSessionGroupWatch, n as classifySessionStateActor, t as acknowledgeSessionStateNotices, u as recordSessionCreated, y as decodeSessionStateNoticeContextKey } from "./session-state-events-BTZJfLLh.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-B6I7wGLB.js";
import { t as hasControlCommand } from "./command-detection-omLfCeJF.js";
import { n as isInternalSourceReplyChannel, r as isSyntheticSourceReplyTurn, t as isExplicitSourceReplyCommand } from "./source-reply-delivery-mode-BkG8TWNz.js";
...
import { a as isSessionWorkStartInvalidatedError, o as resolveSessionLifecycleTimestamps, r as hasTerminalMainSessionTranscriptNewerThanRegistry, s as resolveSessionWorkStartError } from "./lifecycle-D1Tz6qOi.js";
...
import { n as normalizeQueueDropPolicy, r as normalizeQueueMode } from "./settings-D1Q5_Hy4.js";
import { i as getExistingFollowupQueue } from "./state-BobUNKkR.js";
...
import { c as isReasoningTagProvider, ft as buildInboundMediaNoteProjection, lt as appendChannelPromptContext } from "./builtin-openclaw-DTeM8adv.js";
...
import { i as toInternalMessagePreprocessedContext, n as deriveInboundMessageHookContext, s as toInternalMessageTranscribedContext } from "./message-hook-mappers-DgmmEqq7.js";
...
import { z as normalizeExecTarget } from "./exec-approvals-EA-WQccl.js";
...
import { a as admitReplyTurn, l as resolveSilentReplySettings, n as createReplySessionEntryHandle, r as createReplyTimingTracker } from "./session-entry-handle-CjXWLFlU.js";
import { s as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-CogDHQTf.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, d as stageRemoteInboundMediaIfNeeded, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, p as getPreparedReplyDispatchRuntime, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as resolveSessionResetCommand } from "./typing-policy-CZoFPAAG.js";
...
import { i as resolveTurnModelOverride, t as resolveSessionStableReplyMode } from "./session-stable-reply-mode-C0fsxgzr.js";
import { n as resolveRoutedDeliveryThreadId, t as isSlackDirectRoutedThreadTurn } from "./routed-delivery-thread-DWXYMN2w.js";
...
import { l as retireSessionMcpRuntime } from "./agent-bundle-mcp-manager-api-Qkb7NsgF.js";
...
import { a as createUserTurnTranscriptRecorder, c as resolvePersistedUserTurnText } from "./user-turn-transcript-CGVX8qNz.js";
...
import { a as resolveParentForkDecision, r as forkSessionFromParent } from "./session-fork-Bb60vAkd.js";
import { n as projectConversationToolNames } from "./conversation-tool-policy-pipeline-DzgtfKoT.js";
import { u as collectTextContentBlocks } from "./embedded-agent-tool-results-BIgvsn9M.js";
import { l as buildFullBootstrapPromptLines, u as buildLimitedBootstrapPromptLines } from "./system-prompt-params-BCFUhFnY.js";
...
import { b as updateAmbientTranscriptWatermark } from "./session-store-runtime-NOuoTqlj.js";
...
import { n as createCronCreatorAuthorityCapability, o as shouldAdmitFreshChannelOwnerCronAuthority, r as runWithCronCreatorAuthorityCapability } from "./cron-creator-authority-context-BG0LP5g5.js";
import "./cli-session-DnYAqWoO.js";
...
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-A9GJIIpB.js";
import { n as resolveUtilityModelRefForAgent } from "./utility-model-RqQh0nLk.js";
import { t as resolveChannelModelOverride } from "./model-overrides-qOU4__9Z.js";
import { i as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-BXVFKxE4.js";
...
import { n as shouldHandleTextCommands } from "./commands-text-routing-Ct_OFmuE.js";
...
import { t as clearSessionResetRuntimeState } from "./session-reset-cleanup-Dx8CTKYh.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-B3rQW6jp.js";
import { t as emitSessionAutoResetHook } from "./session-auto-reset-DJUJLFSu.js";
import { t as ensureSessionDiffBaseline } from "./session-diff-baseline-Dbd5_Vn-.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-vOoPnQkD.js";
...
import { t as resolveBlockStreamingChunking } from "./block-streaming-BQKjC8z-.js";
import { t as buildCommandContext } from "./commands-context-B4cEskPu.js";
import { n as resolveModelRuntimeDirective } from "./directive-handling.model-runtime-htmCDMCg.js";
import { _ as maybeHandleUnexpectedNativeDirectiveArguments, f as formatModelSelectionScopeAck, v as resolveModelSelectionFromDirective } from "./directive-handling.shared-CMw4U78E.js";
import { t as resolveContextTokens } from "./model-selection-context-CFqs84Sr.js";
import { n as createModelSelectionState, t as createFastTestModelSelectionState } from "./model-selection-DhoHhJu9.js";
...
import { a as resolveSkillCommandInvocation, i as listReservedChatSlashCommandNames, o as resolveSkillReferenceInvocations, r as hasSkillReferenceCandidate } from "./chat-commands-dA8eNdfr.js";
import { n as resolvePreparedReplyQueueState, t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-C2Bb7ocF.js";
import { i as resolveActiveRunQueueAction, r as resolveTypingMode, t as resolveCurrentTurnImages } from "./current-turn-images-C2ZouMUA.js";
import { t as buildChannelSummary } from "./channel-summary-CoovQ_PJ.js";
import { a as resolveInboundUserContextPromptJoiner, n as buildInboundUserContextPrefix, r as formatActiveGoalContext, t as buildInboundMetaSystemPrompt } from "./inbound-meta-BMbSIxg6.js";
import { n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContextAsync } from "./tools-effective-inventory-82sWrZTH.js";
import { n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-CPROeCDP.js";
import { t as PROGRESS_STATUS_PREAMBLE_FRESH_MS } from "./progress-draft-compositor-Bq9iBTeM.js";
import { a as sanitizeProgressStatusText } from "./progress-draft-status-text-DHLH_p9V.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-DmIJbEfC.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-B3UekIhe.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-CthGLWu0.js"));
const abortCutoffRuntimeLoader = createLazyImportLoader(() => import("./abort-cutoff.runtime.js"));
const commandsRuntimeLoader$1 = createLazyImportLoader(() => import("./commands.runtime-B3gOZJVB.js"));
...
const commandsRuntimeLoader = createLazyImportLoader(() => import("./commands.runtime-B3gOZJVB.js"));
const skillCommandsRuntimeLoader = createLazyImportLoader(() => import("./chat-commands.runtime.js"));
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-CG-lxHVE.js"));
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent.runtime-6llka5Yl.js"));
...
const sessionAccessorRuntimeLoader = createLazyImportLoader(() => import("./session-accessor-Dthyfbtw.js"));
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-Cqaq7StI.js"), { cacheRejections: true }).load;
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-Dthyfbtw.js");
