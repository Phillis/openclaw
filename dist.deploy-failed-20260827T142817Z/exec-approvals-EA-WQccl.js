...
import { n as isGeneratedHashedArgPattern } from "./exec-command-resolution-B9td7pT8.js";
...
import { c as resolveExecApprovalsPath, i as generateToken, l as resolveExecApprovalsSocketPath, o as normalizeExecApprovalsInternal, r as createFailClosedExecApprovalsFallback, s as resolveExecApprovalsDisplayPath } from "./exec-approvals-config-moZwurok.js";
...
async function withAgentExecApprovalsRemoved(agentId, commit) {
	...
	const removedPolicyEntries = Object.entries(snapshot.file.agents ?? {}).filter(([policyKey]) => normalizeAgentId(policyKey) === key);
