...
import { r as clearActivePluginRegistry } from "./runtime-CTbL314X.js";
import { t as disposeRegisteredAgentHarnesses } from "./registry-RzPPae7_.js";
import { p as closePluginStateDatabase } from "./plugin-state-store-3qJxZb8E.js";
import { i as listChannelPlugins } from "./registry-CWrpiLCs.js";
import "./plugins-2lW9dSyY.js";
import { a as disposeAcpSessionManagerInstance, t as getAcpSessionManager } from "./manager-BjA1b1Vp.js";
...
import { i as isChatAbortControllerEntryAbortable, s as removeChatAbortControllerEntry, t as abortChatRunById } from "./chat-abort-BBAKYOB6.js";
import { n as createChatAbortMarker } from "./server-chat-state-DD3o03aT.js";
import { n as abortQueuedChatTurns } from "./chat-queued-turns-DfdXgRLi.js";
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-DHrQ5Qk2.js";
import { n as clearSessionTypingState } from "./session-typing-state-CGBbZuG8.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-CBpWb4MC.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./agent-bundle-lsp-runtime-B1oO4-s0.js");
	await disposeAllBundleLspRuntimes();
}
async function drainRetainedEmbeddingProvidersOnDemand() {
	const { drainRetainedOpenAiEmbeddingProviders } = await import("./embeddings-http-DIl-Y-pO.js");
	await drainRetainedOpenAiEmbeddingProviders();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-B62DxX_3.js");
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-BMoW_QNv.js");
			...
			await shutdownStep("provider-transport-dispatchers", async () => {
