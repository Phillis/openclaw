...
import { ln as upsertSessionEntryCore } from "./session-accessor-CVnxp3UM.js";
import { a as normalizeChannelId } from "./registry-CWrpiLCs.js";
import "./plugins-2lW9dSyY.js";
import { l as resolveAgentHarnessSessionContextError } from "./agent-harness-session-key-D5rklW6u.js";
import { a as enqueueSystemEvent, h as withSystemEventOwner } from "./system-events-B0eLVp5j.js";
import { mn as validateNodePresenceActivityPayload } from "./src-Bo4ezI_n.js";
import { i as deleteMediaBuffer } from "./store-BNwuZ4Nd.js";
...
import { E as updatePairedDevicePresence } from "./device-pairing-CFVs8foo.js";
...
import { o as parseMessageWithAttachments, s as persistInboundImagesForTranscript, t as INLINE_IMAGE_DURABLE_OMISSION_MARKER } from "./chat-attachments-ekRmvZxY.js";
import { t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-B7-Wq5M9.js";
import { h as registerApnsRegistration, t as ApnsRegistrationPairingChangedError } from "./push-apns-store-BZ2NS8-f.js";
import "./push-apns-DAt0Ha7N.js";
...
const handleNodeEvent = async (ctx, nodeId, evt, opts) => {
	...
	switch (evt.event) {
		case "voice.transcript": {
			...
			const { storePath, entry, canonicalKey } = loadGatewaySessionEntry(sessionKeyRaw.length > 0 ? sessionKeyRaw : rawMainKey);
		...
		case "notifications.changed": {
			...
			const { canonicalKey: sessionKey, entry } = loadGatewaySessionEntry(sessionKeyRaw);
		...
		case "exec.denied": {
			...
			const { canonicalKey: sessionKey } = loadGatewaySessionEntry(sessionKeyRaw);
			const cfg = getRuntimeConfig();
