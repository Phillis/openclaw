...
import { r as assertOkOrThrowProviderError, u as readProviderBinaryResponse } from "./provider-http-errors-BH2HGv8j.js";
import { d as resolveProviderRequestHeaders } from "./provider-request-config-BK7CLYaF.js";
import { a as isDebugProxyGlobalFetchPatchInstalled, t as captureHttpExchange } from "./runtime-CkaYA4eF.js";
...
async function openaiTTS(params) {
	...
	try {
		...
		return Buffer.from(await readProviderBinaryResponse(response, "OpenAI TTS API error", "audio", {
			maxBytes,
