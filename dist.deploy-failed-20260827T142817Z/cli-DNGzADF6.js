...
import { n as matrixSetupAdapter } from "./setup-core-BoJ47j6q.js";
import { t as withResolvedActionClient } from "./client-BZ2xBx5g.js";
import { i as resolveMatrixAuthContext } from "./create-client-BRQpMyE-.js";
import "./client-zoe2sXpF.js";
import "./runtime-api-Cn0Au9DW.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-Dm_YMVFT.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-C5hkhhY6.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-Dtq8SwPm.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DRLTEI-N.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-dwrrKEg8.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-C6HtefQe.js"));
