...
import { i as isApprovalMethod } from "./method-scopes-rPUXjV_D.js";
...
import { t as classifyApprovalRequestChannelRoute } from "./approval-request-account-binding-C1onsPqE.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = (gatewayRuntime?.routeCoordinator.createReporter ?? createApprovalNativeRouteReporter)({
		...
		requestGateway: async (method, params) => {
			...
			const { callGatewayLeastPrivilege } = await import("./call-n89JPEIA.js");
