...
import { N as runWithSessionTranscriptReadFence } from "./session-accessor.sqlite-transcript-store-DmssQj1u.js";
import { h as consumeRunSkillUsage } from "./agent-tools.before-tool-call-aNXucund.js";
import "./sessions-CfDirsu7.js";
import { t as SessionManager } from "./session-manager-BUfxqRpP.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-564f415a.js";
import { d as isGatewayDraining, r as enqueueCommandInLane } from "./command-queue-CqN2qr5o.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat-xESS3bi6.js";
import { t as log$1 } from "./logger-XkrUQwkD.js";
import { t as buildContextEngineRuntimeSettings } from "./runtime-settings-y-IuGDoh.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as resolveRuntimeTranscriptReadTarget } from "./transcript-runtime-state-CWV9RKmB.js";
import { f as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt-prompt-helpers-gLglSwD1.js";
import { T as findActiveSessionTask } from "./media-generation-task-status-D6EJYgfA.js";
import { v as runWithPreparedMemoryPromptSection } from "./memory-state-D3ZEdbjS.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-CkokYcSR.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-CJUVnzhF.js";
...
async function runCoreAgentEndSideEffects(params) {
	...
	try {
		const { scheduleSkillExperienceReview } = await import("./experience-review-default-jt9lGg5s.js");
