...
import { d as redactToolPayloadTextWithConfig, o as redactSensitiveFieldValueWithConfig, r as isSensitiveFieldKey } from "./redact-Cl7lwBnl.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BNCkTxOs.js";
import "./session-accessor-CVnxp3UM.js";
import { u as publishTranscriptUpdate } from "./session-accessor.sqlite-lifecycle-DM-jpNkz.js";
...
import { Ct as takeRuntimeUserTurnTranscriptRecorder, St as takeRuntimeUserTurnTranscriptContext, xt as attachRuntimeUserTurnTranscriptRecorder } from "./sessions-CfDirsu7.js";
import { a as sanitizeToolCallInputs, r as makeMissingToolResult } from "./ai-transport-runtime-host-CbbOK2Ws.js";
...
import { i as applyInputProvenanceToUserMessage } from "./input-provenance-BA6fPshG.js";
import { f as truncateToolResultMessage, t as projectAgentHarnessTranscriptMessageForDisplay, x as formatContextLimitTruncationNotice } from "./transcript-visibility-IIw97hqq.js";
import { i as resolveLiveToolResultMaxChars, t as DEFAULT_MAX_LIVE_TOOL_RESULT_CHARS } from "./tool-result-limits-DISobJ_J.js";
import { i as setRawSessionAppendMessage, r as getRawSessionAppendMessage } from "./transcript-runtime-state-CWV9RKmB.js";
import { l as restorePreparedUserTurnOperationalMetaForRuntime, o as mergePreparedUserTurnMessageForRuntime } from "./user-turn-transcript-CGVX8qNz.js";
...
function installSessionToolResultGuard(sessionManager, opts) {
	...
	const appendMessageAndCacheTranscriptSeq = (message, options) => {
		...
		const { entryId, anchor } = originalAppendWithTranscriptAnchor(message, options);
	...
	*/
	...
	const guardedAppend = (message, callerOptions) => {
		...
		const { anchor, entryId: result, messageSeq, sessionTarget } = appendMessageAndCacheTranscriptSeq(finalMessage, { invalidateSerializedPrefixCache: callerInvalidatesCache || transformedMessage !== nextMessage || finalWrite.changed });
		if (sessionTarget) publishTranscriptUpdate(sessionTarget, {
