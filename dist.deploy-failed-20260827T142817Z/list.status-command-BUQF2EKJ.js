...
import { n as installTemporaryCurrentPluginMetadataSnapshot, t as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-B1YRfQOc.js";
import { s as normalizeProviderId } from "./model-ref-shared-poyRjWh_.js";
import { E as parseModelPolicyWildcardRef, _ as resolveConfiguredModelRef, b as resolveModelRefFromString, d as modelCatalogLogicalKey, g as resolveConfiguredModelPolicyAllow, i as buildModelAliasIndex } from "./model-selection-shared-DT9x3Cg2.js";
...
import { c as isNonSecretApiKeyMarker, g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, l as isOAuthApiKeyMarker } from "./model-auth-markers-DJWHSR2r.js";
import { A as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-DStPs6cE.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, c as getRuntimeAuthProfileStoreSnapshot, r as ensureAuthProfileStore } from "./store-DOJuehrg.js";
...
import { n as resolveAgentHarnessOwnerPluginIds } from "./runtime-plugin-load-plan-B6zJFbSL.js";
import { o as loadPreparedModelCatalogSnapshot } from "./prepared-model-catalog-BFweRhks.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-DybBsKKK.js";
import "./profiles-DfGTvDcU.js";
import { r as getCustomProviderApiKey, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-CUFUPomY.js";
...
import { n as resolveAgentHarnessRuntimeAvailability } from "./runtime-plugin-BVWviD3T.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-C_-ciQa1.js";
import { n as resolveUtilityModelRefForAgent, t as readUtilityModelSetting } from "./utility-model-RqQh0nLk.js";
import { a as resolveKnownAgentId, d as ensureFlagCompatibility, m as isRich } from "./shared-B-IYMANI.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BG8_no8n.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-BfpbCdnP.js"));
...
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-C-HutdTT.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-BJbLJ8VA.js");
			runtime.log("");
