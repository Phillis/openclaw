...
import { l as generatePkceVerifierChallenge } from "./provider-auth-DVDSRG1v.js";
	...
	return new Promise((resolve, reject) => {
		...
		const server = createServer((req, res) => {
			try {
				...
				if (error) {
					const description = normalizeOptionalString(requestUrl.searchParams.get("error_description"));
