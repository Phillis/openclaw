...
import { a as loadPersistedAuthProfileStore } from "./persisted-BaBq9UBI.js";
import { n as resolvePluginProvidersCore } from "./providers.runtime-CAakL3j-.js";
import { c as readCodexCliCredentialsCached, l as readGeminiCliCredentialsCached, o as readClaudeCliCredentialsCached, s as readCodexCliActiveApiKey } from "./external-cli-sync-nInVHMn1.js";
import { b as updateAuthProfileStoreWithLock, d as loadAuthProfileStoreForRuntime } from "./store-DOJuehrg.js";
import "./sessions-CfDirsu7.js";
import { t as SessionManager } from "./session-manager-BUfxqRpP.js";
import { a as resolveCliBackendLiveSessionRequirement, i as resolveCliBackendConfig } from "./cli-backends-B_2M8BON.js";
import { t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-CAkySZhG.js";
import { t as loadAgentRuntimePluginRegistryHandle } from "./runtime-plugins-CotwbLmq.js";
import { d as normalizeAuthProfileCredential } from "./profiles-DfGTvDcU.js";
...
import { a as probeLocalCommand } from "./overview-ClhxVBNB.js";
...
import { n as resolveManifestProviderAuthChoice, r as resolveManifestProviderAuthChoices } from "./provider-auth-choices-Be8yPp6p.js";
import { n as loadAuthoredSetupConfig } from "./onboarding-welcome-YBnpO-hy.js";
import { a as resolveSystemAgentVerifiedInferenceRoute, n as createSystemAgentVerifiedInferenceBinding, r as hasCurrentSystemAgentOwnerPluginArtifacts, t as captureSystemAgentOwnerPluginArtifacts } from "./verified-inference-G4rRrE4u.js";
import { t as CliExecutionAuthProfileError } from "./cli-execution-auth-eUIyKp-l.js";
import { i as sameDefaultInferenceRoute, n as projectInferenceRoute, r as resolveSystemAgentConfiguredRouteFromConfig } from "./inference-route-BdB9LAmv.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-BdPrWkjL.js";
import { t as applyAutoLocalModelLean } from "./local-model-lean-auto-BPUF8q0b.js";
import { i as appendSystemAgentAuditEntry } from "./audit-DPaGSfB4.js";
import { i as createSystemAgentModelSelectionUpdater, r as createQuickstartNotePrompter, t as applySystemAgentModelSelection } from "./setup-apply-GWohqK0_.js";
...
import { a as runProviderPluginAuthMethodUnpersisted, n as applyProviderPluginAuthMethodResultConfig } from "./provider-auth-choice-elnr4uyT.js";
...
async function resolveSetupInferenceWorkspace(params) {
	...
	const { DEFAULT_WORKSPACE } = await import("./onboard-helpers-DG0mt_gD.js");
	return {
...
async function cleanupSetupInferenceTempDir(params) {
	try {
		(params.deps.disposeOpenClawAgentDatabaseByPath ?? (await import("./openclaw-agent-db-BSfLPEC3.js")).disposeOpenClawAgentDatabaseByPath)(path.join(params.tempDir, "agent", "openclaw-agent.sqlite"));
	} catch {
...
async function isCodexInstallRecordPersisted(record, deps) {
	try {
		const currentInstallRecords = await (deps.readPersistedInstalledPluginIndexInstallRecords ?? (await import("./installed-plugin-index-records-CxRM7dwK.js")).readPersistedInstalledPluginIndexInstallRecords)();
...
async function clearUnownedCodexInstallCaches(deps) {
	try {
		(deps.clearLoadInstalledPluginIndexInstallRecordsCache ?? (await import("./installed-plugin-index-records-CxRM7dwK.js")).clearLoadInstalledPluginIndexInstallRecordsCache)();
	} catch {
	...
	try {
		await (deps.invalidatePluginRuntimeDiscoveryAfterConfigMutation ?? (await import("./registry-refresh-D799YyWZ.js")).invalidatePluginRuntimeDiscoveryAfterConfigMutation)({ logger: setupInferenceLog });
	} catch {
...
async function reloadCodexRegistryAfterActivation(params) {
	...
	try {
		await (params.deps.refreshPluginRegistryAfterConfigMutation ?? (await import("./registry-refresh-D799YyWZ.js")).refreshPluginRegistryAfterConfigMutation)({
			config: sourceConfig,
	...
	try {
		(params.deps.ensurePluginRegistryLoaded ?? (await import("./runtime-registry-loader-Dx1dVBse.js")).ensurePluginRegistryLoaded)({
			scope: "all",
...
async function runSetupInferenceTest(params) {
	...
	try {
		...
		let result;
		if (plan.runner === "cli") result = await (deps.runCliAgent ?? (await import("./cli-runner-CWH3UUi_.js")).runCliAgent)({
		...
		else result = await (deps.runEmbeddedAgent ?? (await import("./embedded-agent-FeUdPibX.js")).runEmbeddedAgent)({
			preparedRunAdmission,
			sessionId,
			sessionKey,
			sessionManager,
...
async function persistActivatedSetupInference(input) {
	...
	const { stripPendingPluginInstallRecords } = await import("./install-record-commit-D6TP1hTK.js");
	...
	const transformConfig = deps.transformConfigWithPendingPluginInstalls ?? (await import("./install-record-commit-D6TP1hTK.js")).transformConfigWithPendingPluginInstalls;
...
async function activateSetupInferenceUnredacted(params, codexCliApiKey) {
	...
	try {
		...
		if (params.kind === "codex-cli") {
			...
			const ensured = await (deps.ensureCodexRuntimePlugin ?? (await import("./codex-runtime-plugin-install-zYBwO5JL.js")).ensureCodexRuntimePluginForModelSelection)({
			...
			const refreshPluginRegistry = deps.refreshPluginRegistryAfterConfigMutation ?? (await import("./registry-refresh-D799YyWZ.js")).refreshPluginRegistryAfterConfigMutation;
