...
import { a as parseSystemAgentOperation, n as describeSystemAgentPersistentOperation, s as isInvalidConfigSetOperation } from "./operations-CCgw0hU4.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-DtkopFMy.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
