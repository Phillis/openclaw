...
import { t as isValidAgentId } from "./agent-id-Db0rqw_J.js";
import { c as parseAgentSessionKey } from "./session-key-utils-D8x_bjrd.js";
import { t as isIncognitoSessionKey } from "./incognito-session-key-BwpD1Lwd.js";
import { r as getRuntimeConfig } from "./io-D1h6pxaD.js";
import { a as emitInternalDiagnosticEvent, f as isDiagnosticsEnabled, t as areDiagnosticsEnabledForProcess, u as getInternalDiagnosticEventSequence } from "./diagnostic-events-Djn4AVRp.js";
import { t as createSubsystemLogger } from "./subsystem-CDLhGl2-.js";
import { l as resolveCronJobsStorePath, r as loadCronJobsStoreSync } from "./store-Ce3SZg1h.js";
...
import { _ as loadLatestAssistantText } from "./session-accessor.sqlite-transcript-store-DmssQj1u.js";
import { t as runAbortableTimeout } from "./with-timeout-BD839_Nk.js";
...
import { a as logMessageQueuedWithBacklogPolicy, n as getLastDiagnosticActivityAt, o as markDiagnosticActivity, s as resetDiagnosticActivityForTest, t as diagnosticLogger } from "./diagnostic-runtime-9hKw1z8y.js";
import { a as resetDiagnosticStabilityRecorderForTest, c as stopDiagnosticStabilityRecorder, s as startDiagnosticStabilityRecorder } from "./diagnostic-stability-BfRs7P_B.js";
import { c as writeDiagnosticMemoryPressureBundleSync, o as resetDiagnosticStabilityBundleForTest, r as installDiagnosticStabilityFatalHook, s as uninstallDiagnosticStabilityFatalHook } from "./diagnostic-stability-bundle-QH_iL0Qw.js";
import { n as getRecentDiagnosticPhases, r as resetDiagnosticPhasesForTest, t as getCurrentDiagnosticPhase } from "./diagnostic-phase-0F5NnA9C.js";
...
function startDiagnosticHeartbeat(config, opts) {
	...
	heartbeatInterval = setInterval(() => {
		...
		for (const [, state] of diagnosticSessionStates) {
			...
			const repeatedRequestAttention = state.state === "processing" && (activity.repeatedRequestNoProgressAgeMs ?? 0) > stuckSessionWarnMs;
			if (state.state === "processing" && ageMs > stuckSessionWarnMs || repeatedRequestAttention || idleQueuedRecoverableStall) {
				const attentionAgeMs = idleQueuedRecoverableStall ? activity.lastProgressAgeMs ?? ageMs : Math.max(ageMs, activity.repeatedRequestNoProgressAgeMs ?? 0);
