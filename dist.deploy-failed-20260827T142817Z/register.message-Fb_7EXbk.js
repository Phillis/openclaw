...
import { d as resolveDiscoverableScopedChannelPluginIds, l as resolveConfiguredChannelPluginIds } from "./channel-presence-policy-rQR9R6qg.js";
...
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-BNCkTxOs.js";
...
import { n as CHANNEL_TARGET_DESCRIPTION, t as CHANNEL_TARGETS_DESCRIPTION } from "./channel-target-CGYH-kbP.js";
...
async function messageCommand(opts, deps, runtime) {
	...
	const { formatMessageCliText } = await import("./message-format-CFxggS7s.js");
