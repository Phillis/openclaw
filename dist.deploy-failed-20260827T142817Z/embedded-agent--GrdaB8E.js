...
import { O as isIncognitoOpenClawAgentSqlitePath } from "./openclaw-agent-db-maintenance-1xIPEKIN.js";
import { S as revokeRuntimeAuthMaterializations, b as recordRuntimeAuthMaterialization } from "./runtime-snapshots-0_SaNWbX.js";
...
import { c as resolveContextEngine, l as resolveContextEngineOwnerPluginId } from "./registry-DOMV71ew.js";
...
import { K as updateSessionEntry, O as resolveSessionTranscriptRuntimeTarget, Pt as listSessionEntriesCore, Qt as loadSessionEntry, Y as appendTranscriptMessage, dt as deriveContextPromptTokens, gt as normalizeUsage } from "./session-accessor-CVnxp3UM.js";
...
import { p as resolveProviderRuntimePluginHandle, s as resolveProviderAuthProfileId, t as attachModelProviderRuntimePluginHandle } from "./provider-hook-runtime-Dr_msAqW.js";
import { b as prepareProviderRuntimeAuth } from "./provider-runtime-DStPs6cE.js";
...
import { a as markAuthProfileFailure, d as resolveProfilesUnavailableReason, o as markInlineProviderApiKeyFailure } from "./usage-CztrY32v.js";
...
import { l as hasOnlyAssistantReasoningContent } from "./ai-transport-runtime-host-CbbOK2Ws.js";
...
import { n as acquireReadOnlyPreparedModelRuntime, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-BNByaYVk.js";
import { a as resolveCandidateThinkingLevel, l as resolveAgentHarnessPreparedAuthSupport, u as resolveAgentHarnessPreparedRouteSupport } from "./thinking-runtime-CvHDRR81.js";
import "./auth-profiles-DybBsKKK.js";
import { n as markAuthProfileSuccess } from "./profiles-DfGTvDcU.js";
import { s as isConfigBackedInlineProviderApiKey } from "./model-auth-provider-config-CUFUPomY.js";
import { i as getApiKeyForModelCore, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-B7VlMZMb.js";
import { n as resolveThinkingDefault } from "./model-thinking-default-CJJQK-S8.js";
...
import { x as resolveCompactionTimeoutMs, y as compactContextEngineWithSafetyTimeout } from "./diagnostic-DO3P5TXi.js";
import { C as setActiveEmbeddedRun, r as clearActiveEmbeddedRun, u as isEmbeddedAgentRunHandleActive, v as resolveActiveEmbeddedRunHandleSessionId, w as supersedeEmbeddedAgentRunByRunId, y as resolveActiveEmbeddedRunHandleSessionIdBySessionFile } from "./runs-DdjJNEQM.js";
...
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-CS2VH7C-.js";
...
import { l as retireSessionMcpRuntime, u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-manager-api-Qkb7NsgF.js";
...
import { l as truncateOversizedToolResultsInActiveTarget, s as sessionLikelyHasOversizedToolResults } from "./transcript-visibility-IIw97hqq.js";
import { o as runAgentCleanupStep, r as resolveSettledTurnFinalizationText } from "./settled-turn-finalization-result-BWIM2nfh.js";
...
import { b as listActiveProcessSessionReferences, f as resolveContextEngineCapabilities, m as resolveCompactionContextTokenBudget, p as buildEmbeddedCompactionRuntimeContext, r as forgetPromptBuildDrainCacheForRun } from "./attempt-prompt-helpers-gLglSwD1.js";
import { t as resolveProcessToolScopeKey } from "./bash-process-scope-Bmw8_ghL.js";
import { n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-D74a7V0k.js";
import { d as waitForDeferredTurnMaintenanceForSession, u as runContextEngineMaintenance } from "./agent-end-side-effects-D3nNsUM5.js";
import { E as settleRequesterAfterSessionSpawns } from "./subagent-registry-DU4QcZuY.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-9Zisrbl5.js";
import { t as ensureContextEnginesInitialized } from "./init-B8eIQLGE.js";
...
import { t as createTrajectoryRuntimeRecorder } from "./runtime-C1LQ4QI2.js";
import { _ as buildApiErrorObservationFields, y as shouldSuppressRawErrorConsoleSuffix } from "./model-fallback-attempt-BVsIYD_3.js";
import { n as resolveDelegationCapability } from "./agent-tools-BkxVdpcN.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-Mtb_s-wH.js";
import { n as shouldUseTransientCooldownProbeSlot, r as LiveSessionModelSwitchError } from "./model-fallback-runner-7lOT1PJ9.js";
import { a as resolveSessionKeyForRequestCore, o as resolveStoredSessionKeyForSessionId } from "./session-usTovb5_.js";
import { i as resolveSessionSuspensionTarget, o as suspendSession, r as resolveSessionSuspensionReason } from "./session-suspension-C6jpx3Y4.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-CVttd5qX.js";
import { r as resolveModelAsync, t as createEmptyAgentDiscoveryStores } from "./model-BoOus0uf.js";
import { t as materializePreparedRuntimeModel } from "./materialize-model-BwpyFizB.js";
import { a as selectContextEngineForTranscriptHost, i as createContextEngineLogicalTurnLease, n as drainPendingContextEngineTurnsBeforeRun } from "./context-engine-turn-attempt-Do33ugHk.js";
import { c as selectAgentHarness, l as selectAgentHarnessForPreparedModelProviders, o as runAgentHarnessAttempt, s as runAgentHarnessSettledTurnFinalization, t as agentHarnessBuildsOpenClawTools } from "./selection-BtKGm7U7.js";
...
import { i as mergeAttemptToolMediaPayloads, r as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-DL3rSGAU.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-DerVfk-b.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-CC5f_clM.js";
import { n as maybeCompactAgentHarnessSession, r as isRecoverableNativeHarnessBindingFailure, t as resolveContextEngineCompactionSuccessor } from "./compaction-successor-CWxjfvm8.js";
import { i as resolveCredentialScopedAuthAttemptModelDecision, n as hasPreparedAuthAttemptModelMetadata, r as providerUsesCredentialScopedModelMetadata, t as createPreparedRuntimeModelMaterializer } from "./credential-scoped-model-BehkTMq1.js";
...
import { a as resolveHookModelSelection, i as resolveEmbeddedRuntimeModelPolicy, n as createNativeModelOwnedRuntimeModel, o as resolveNativeModelOwnedHarnessId, r as resolveAgentHarnessRunAdmissionError, t as buildBeforeModelResolveAttachments } from "./setup-B6pwcNCC.js";
import { r as readSourceReplyDeliveryRuntime } from "./source-reply-delivery-runtime-D3ljIhoI.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-DvwDFd-a.js";
...
async function retireDispatchSessionMcpRuntime(params) {
	try {
		const { retireSessionMcpRuntime, retireSessionMcpRuntimeForSessionKey } = await import("./agent-bundle-mcp-tools-Bwaxjt5q.js");
