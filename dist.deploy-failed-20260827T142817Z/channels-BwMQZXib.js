...
import { r as createMessageActionDiscoveryContext, u as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-Cc7TIbvb.js";
...
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-B6MnhQY0.js";
...
import { i as prepareChannelAccountRemoval, n as channelLabel, r as applyPreparedChannelAccountRemoval, t as channelsAddCommand } from "./add-BCVI18g_.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidChannelConfig } from "./shared-DSQg0p47.js";
import { t as channelsListCommand } from "./list-DKHaHEmu.js";
import { t as channelsStatusCommand } from "./status-DkZnlJsv.js";
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-CqD74b__.js");
