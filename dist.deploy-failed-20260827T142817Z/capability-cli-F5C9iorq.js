...
import { _ as randomIdempotencyKey, s as callGateway } from "./call-Ds1WOCDj.js";
...
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-BhpnS-Rv.js";
import { n as normalizeSpeechProviderId } from "./provider-registry-core-DL1pv3pg.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-DzjGFYEk.js";
import { _ as resolveTtsPrefsPath, h as resolveTtsConfig, l as listTtsPersonas, o as getTtsPersona } from "./tts-settings-C4v4j5N-.js";
...
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-eAY4iFyX.js";
import { r as listRegisteredMemoryEmbeddingProviderAdapters } from "./memory-embedding-provider-runtime-BFWEUWM-.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CvMujUVK.js";
import { t as buildExplicitSessionIdSessionKey } from "./session-usTovb5_.js";
import { t as runWithImageModelFallback } from "./model-fallback-image-Cs6eKU3a.js";
import { o as fetchWithTimeoutGuarded, p as resolveProviderHttpRequestConfig } from "./shared-CzcciRDF.js";
import { c as buildMediaUnderstandingRegistry } from "./defaults.constants-DswYbkvd.js";
import { h as getTtsCommandSecretTargetIds, i as getCapabilityWebFetchCommandSecretTargets, l as getMemoryEmbeddingCommandSecretTargetIds, o as getCapabilityWebSearchCommandSecretTargets, u as getModelsCommandSecretTargetIds } from "./command-secret-targets-BkKupp6y.js";
import { _ as setTtsProvider, g as setTtsPersona, l as listSpeechVoices, m as setTtsEnabled, s as resolveExplicitTtsOverrides, t as getTtsProvider } from "./runtime-api-Bw3X0kRb.js";
...
import { i as listWebSearchProviders, n as isWebSearchProviderConfigured, o as runWebSearch } from "./runtime-CPtjiOKD.js";
...
import { i as resolveWebFetchDefinition, n as isWebFetchProviderConfigured, r as listWebFetchProviders } from "./runtime-lvFOU4m3.js";
...
import { c as transcribeAudioFile, i as describeVideoFile, o as prepareImageDescriptionInput, r as describePreparedImageWithModel, t as describeImageFile } from "./runtime-czoBD2_M.js";
...
import { r as createEmbeddingProvider } from "./memory-core-bundled-runtime-DUIoq7qR.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-BUQF2EKJ.js");
...
function registerModelCapabilityCommands(capability) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-C9d95A3o.js");
