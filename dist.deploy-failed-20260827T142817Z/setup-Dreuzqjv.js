...
import { _ as toAgentEntriesRecord, b as tryResolveLegacyCompatibilityAgentId, h as resolveSoleAgentId, r as listAgentEntries, u as resolveAgentEntry } from "./agent-scope-config-BdXMWufB.js";
import "./legacy-4i8HeDsv.js";
...
import { r as hasResolvedRosterBeforeMigrations, t as configIncludeOwnsAgentRoster } from "./agent-roster-provenance-DMVAWWCV.js";
...
*/
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-DO4zlPVY.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-CvvD_dWV.js"));
...
async function resolveDefaultSessionTranscriptsDir(agentId) {
	const { resolveSessionTranscriptsDirForAgent } = await import("./sessions-9oIZxr9w.js");
