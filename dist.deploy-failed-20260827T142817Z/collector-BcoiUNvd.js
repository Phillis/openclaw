...
import { b as tryResolveLegacyCompatibilityAgentId, r as listAgentEntries } from "./agent-scope-config-BdXMWufB.js";
...
import { l as toPublicPluginVerificationDiagnostic, o as listActiveDegradedPlugins, r as degradedPluginMatchesRoot } from "./runtime-degraded-state-BGAUzsaR.js";
...
import { s as redactChannelStatusSummaryBaseUrl } from "./account-snapshot-fields-BFfRc-QZ.js";
import { i as resolveChannelAccountEnabled, r as resolveChannelAccountConfigured } from "./account-summary-Dbo8XU-g.js";
import { t as listReadOnlyChannelPluginsForConfig } from "./read-only-CrbyxaJh.js";
import { t as inspectChannelAccount } from "./account-inspection-HRXyolGv.js";
import { t as buildChannelAccountSnapshotFromAccount } from "./status-BqLyphSi.js";
...
import { n as buildContextEngineHealthSummary, t as buildDeliveryQueueHealthSummary } from "./delivery-queue-DM1Pw-eX.js";
...
async function buildHealthSessionSummary(storePath, agentId) {
	const { listSessionEntriesReadOnly } = await import("./session-accessor-Dthyfbtw.js");
	const { isTransientSqliteError } = await import("./unhandled-rejections-BLz0rxi2.js");
	let listed;
	try {
