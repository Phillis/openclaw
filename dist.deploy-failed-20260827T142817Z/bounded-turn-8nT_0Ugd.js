...
import { l as isCodexAppServerStartSelectionChangedError, ut as isJsonObject } from "./shared-client-C76WIHv0.js";
import { o as createDeferred } from "./extension-shared-BCgJMXly.js";
import { _ as readCodexNotificationTurnId, a as closeCodexStartupClientBestEffort, o as interruptCodexTurnAndWaitBestEffort, t as CODEX_APP_SERVER_INTERRUPT_TIMEOUT_MS } from "./attempt-client-cleanup-D36eX-vm.js";
import { b as isTerminalTurnStatus, n as normalizeCodexResponseTokenUsage, x as readCodexNotificationItem, y as isRetryableErrorNotification } from "./event-projector-usage-yGE22DCR.js";
import { C as mergeCodexThreadConfigs, a as attestCodexRestrictedToolSurfaceMcpServersDisabled, c as readCodexInheritedMcpServerNames, i as assertCodexRestrictedToolSurfaceHasNoManagedHooks, o as buildCodexRingZeroThreadConfigPatch, s as buildCodexRuntimeThreadConfig } from "./thread-lifecycle-v3XjduGr.js";
...
import { r as readModelListResult } from "./models-DA0c_YQP.js";
...
async function runBoundedCodexAppServerTurnInWorkspace(params, appServer, workspace, selectionAttempt = 0, timing) {
	...
	}) : await import("./shared-client-TnwHWGhS.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
		startOptions,
		timeoutMs,
		...authSelection,
		authRequirement: params.authRequirement,
