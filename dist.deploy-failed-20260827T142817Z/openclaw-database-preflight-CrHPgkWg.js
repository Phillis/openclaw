...
import { f as clearNodeSqliteKyselyCacheForDatabase, r as resolveImmutableSqliteFileUri, t as openNodeSqliteDatabase } from "./node-sqlite-sCL6pEgr.js";
import { _ as getNodeSqliteKysely, a as describeRunningOpenClawBuild, d as OPENCLAW_DATABASE_SCHEMA_DOCS_URL, f as OPENCLAW_SQLITE_BUSY_TIMEOUT_MS, h as executeSqliteQuerySync, o as readSqliteUserVersion, r as resolveOpenClawStateSqlitePath } from "./openclaw-state-db.paths-D5QeoU_L.js";
import { At as OPENCLAW_STATE_SCHEMA_SQL, C as inspectOpenClawStateOwnershipFromDatabase, Ct as assertOpenClawStateDatabaseOwner, Dt as STATE_PERSISTENT_SCHEMA_COMPATIBILITY, Et as OPENCLAW_STATE_MAINTENANCE_SCHEMA_COMPATIBILITY, Ot as getOpenClawStateRuntimeSchema, St as assertOpenClawStateDatabaseForMaintenance, _n as collectSqliteSchemaIssues, kt as isOpenClawStateStartupRepairableSchemaIssue } from "./openclaw-state-db-CXrhNigN.js";
import { r as assertSqliteIntegrity } from "./sqlite-strict-BaSF4bDz.js";
import { t as assertOpenClawAgentDatabaseForMaintenance } from "./openclaw-agent-db-maintenance-1xIPEKIN.js";
