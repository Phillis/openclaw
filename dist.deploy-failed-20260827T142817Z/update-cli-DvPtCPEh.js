...
import { w as hasErrnoCode, x as resolveConfigIncludes } from "./redact-Cl7lwBnl.js";
...
import { l as pathExists$1 } from "./utils-DEqefz4f.js";
import { r as resolveConfigEnvVars } from "./env-substitution-Co3_FGCX.js";
import { d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName, i as GATEWAY_SERVICE_RUNTIME_PID_ENV } from "./constants-B4HhnyPv.js";
import { _ as resolveGatewayPort, n as DEFAULT_GATEWAY_PORT, t as CONFIG_PATH, v as resolveIncludeRoots } from "./paths-CqeDjSA4.js";
...
import { E as createPreUpdateConfigSnapshot, G as asResolvedSourceConfig, K as asRuntimeConfig, l as readConfigFileSnapshot, p as readSourceConfigBestEffort, tt as parseConfigJson5 } from "./io-D1h6pxaD.js";
import { r as readJsonIfExists, u as writeJson } from "./json-BE1X9L-o.js";
...
import { c as serializePluginInstallRecordMap, l as setPluginInstallRecordMapEntry, r as createPluginInstallRecordMap, s as parsePluginInstallRecordMap } from "./plugin-install-record-map-B3dUHyOF.js";
import { n as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-DArXGVRI.js";
import { d as OPENCLAW_DATABASE_SCHEMA_DOCS_URL } from "./openclaw-state-db.paths-D5QeoU_L.js";
import { a as getWindowsSystem32ExePath, t as getWindowsCmdExePath } from "./windows-install-roots-BdGcwph2.js";
import { a as formatExternalSupervisorUpdateRequired, o as isGatewayExternallySupervised, r as assertGatewayServiceMutationAllowed } from "./gateway-supervision-Cr5lTl_D.js";
import { a as nodeVersionSatisfiesEngine, o as parseSemver } from "./runtime-guard-CBEVEZk3.js";
import { i as resolveTrustedSourceLinkedOfficialClawHubSpec, o as resolveTrustedSourceLinkedOfficialNpmSpec } from "./official-external-install-records-DVEW9fKA.js";
import { c as restorePersistedInstalledPluginIndexIfCurrent, r as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-BIcBJeAh.js";
...
import { n as mutateConfigFileWithRetry } from "./mutate-xf8UM8H3.js";
...
import "./daemon-cli-DMEU76k-.js";
import { r as resolveGatewayTaskScriptPath } from "./paths-BX2ryH6I.js";
...
import { f as resolveLaunchAgentLabel, o as renderSystemLaunchDaemonOwnershipShellProbe } from "./launchd-system-OPhPIEKB.js";
import { t as disableCurrentOpenClawUpdateLaunchdJob } from "./launchd-CHv0VO6s.js";
import { a as resolveGatewayRestartLogPath, r as renderPosixRestartLogSetup, s as shellEscapeRestartLogValue } from "./restart-logs-BwAq4Xj9.js";
import { i as terminateStaleGatewayPids, r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-C2sCOjHx.js";
import { a as resolveGatewayService, i as readGatewayServiceState } from "./service-CJsmassN.js";
import { a as resumeScheduledTaskAutoStartAfterUpdate, c as suspendScheduledTaskAutoStartForUpdate } from "./schtasks-Bl45FlL4.js";
import { n as runDaemonInstall } from "./install-B86jlKY6.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-BC4A48Wz.js";
import { a as renderRestartDiagnostics, n as waitForGatewayHealthyRestart } from "./restart-health-Cj0Gkguj.js";
import { a as withPluginInstallRecords, c as writePersistedInstalledPluginIndexInstallRecordsWithLease, o as withoutPluginInstallRecords } from "./installed-plugin-index-records-ClSyB6F3.js";
import { n as stylePromptMessage } from "./prompt-style-BQVvtDcR.js";
import { f as trimLogTail, h as updateInstallRootsMatch } from "./restart-sentinel-BMlog4T5.js";
...
import { a as installCompletion, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-BnLiFzei.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-C_1PLcc5.js";
...
import { i as commitPluginInstallRecordsWithConfig } from "./install-record-commit-BX4LGZp9.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./registry-refresh-CgP_GGZG.js";
import { a as channelToNpmTag, d as resolveEffectiveUpdateChannel, i as UPDATE_EFFECTIVE_CHANNEL_ENV, l as normalizeUpdateChannel, o as formatUpdateChannelLabel, p as resolveUpdateChannelDisplay, r as EXTENDED_STABLE_TAG_UNSUPPORTED_REASON } from "./update-channels-Dv2OGOSa.js";
import { t as listPersistedBundledPluginLocationBridges } from "./plugins-location-bridges-CQ6dTB1Q.js";
import { n as updateNpmInstalledPlugins, r as isClawHubTrustSkippedOutcome, t as syncPluginsForUpdateChannel } from "./update-zOf2Wmxw.js";
import { t as createLowDiskSpaceWarning } from "./disk-space-CzASwJhY.js";
import { r as preflightOpenClawDatabaseSchemas } from "./openclaw-database-preflight-CrHPgkWg.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-Dl4NSL9y.js";
import { a as resolveExtendedStablePackage, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmTagVersion, s as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-Du5TJ6YP.js";
import { a as resolveUpdateAvailability, i as resolveStatusRegistryUpdateChannel, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-C_PVk1PL.js";
import { a as resolveUpdateDoctorExecutionPolicy, c as createGlobalInstallEnv, d as globalInstallArgs, f as resolveGlobalInstallSpec, h as normalizePackageTagInput, i as runGlobalPackageUpdateSteps, l as detectGlobalInstallManagerByPresence, m as resolvePnpmGlobalDirFromGlobalRoot, o as canResolveRegistryVersionForPackageTarget, p as resolveGlobalInstallTarget, r as markPackagePostInstallDoctorAdvisory, s as cleanupGlobalRenameDirs, t as runGatewayUpdate, u as detectGlobalInstallManagerForRoot } from "./update-runner-kA6JAwYr.js";
import { c as writeControlPlaneUpdateRestartSentinel, i as buildControlPlaneUpdateRestartHealthPendingResult, o as markControlPlaneUpdateRestartSentinelFailure, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-DZSQPWsH.js";
import { i as parseDevUpdateTargetEnv, t as UPDATE_DEV_TARGET_REF_ENV } from "./update-dev-target-CgOB-zhY.js";
import { n as cleanupStaleManagedServiceUpdateHandoffs } from "./update-managed-service-handoff-cleanup-B18agwDB.js";
import { n as printResult, t as createUpdateProgress } from "./progress-BvBicsLD.js";
...
import { a as validateBundleInstallRecordPayload, n as resolveBundleInstallRecordPayload, t as hasNativePackageInstallPayload } from "./plugin-payload-validation-CqDRZuMY.js";
import { n as runPostCorePluginConvergence, t as convergenceWarningsToOutcomes } from "./post-core-plugin-convergence-zMFmG9dY.js";
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-Dkvclcdo.js");
...
function applyManagedServiceSelectorEnv(params) {
	...
	for (const key of MANAGED_SERVICE_SELECTOR_ENV_KEYS) if (selectorEnv[key]?.trim()) resolved[key] = params.serviceEnv[key];
...
async function maybeStopManagedServiceBeforeMutableUpdate(params) {
	...
	const launchAgentMayRespawn = process.platform === "darwin" && serviceState.loaded && await service.isEnabled?.({ env: serviceState.env }) === true;
	const handoffSupervisorMayRespawn = process.platform !== "darwin" && process.env.OPENCLAW_UPDATE_RUN_HANDOFF === "1";
	const supervisorMayRespawn = serviceState.loaded && (launchAgentMayRespawn || handoffSupervisorMayRespawn);
