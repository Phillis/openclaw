...
import { c as prunePlaybackTranscodeCache, r as cleanOldMedia } from "./store-BNwuZ4Nd.js";
...
import { u as pruneExpiredDeliveryQueueTombstones } from "./delivery-queue-sqlite-CLvxFObU.js";
import { n as pruneOrphanedDeliveryQueueMedia } from "./delivery-queue-media-spool-ByExwA5K.js";
import { a as withSkillCollectionReviewClaim, i as isSkillCollectionReviewDue, o as MAX_RECONCILED_SKILL_BYTES, t as listWritableSkillCollection } from "./collection-reconcile-BAtbEwXQ.js";
import { s as removeChatAbortControllerEntry, t as abortChatRunById } from "./chat-abort-BBAKYOB6.js";
import { t as chatAbortMarkerTimestampMs } from "./server-chat-state-DD3o03aT.js";
import { c as resolveWorktreeCleanupLimits, i as WORKTREE_GC_INTERVAL_MS, s as managedWorktrees } from "./service-BRAKemfS.js";
import { r as HEALTH_REFRESH_INTERVAL_MS, s as TICK_INTERVAL_MS, t as DEDUPE_MAX } from "./server-constants-DKuFNbQH.js";
import { c as pruneExpiredDevicePairSetupCompletions } from "./device-bootstrap-DCaGQVSG.js";
import { n as hasRegisteredChatRunForSessionKey } from "./session-active-runs-CRkuFZp3.js";
import "./server-shared-C-7Ahu3n.js";
import { t as createManagedWorktreeOwnerProtection } from "./owner-protection-6r7pXAuR.js";
...
import { s as setBroadcastHealthUpdate } from "./health-state-XZDQrS9y.js";
...
function startGatewayMaintenanceTimers(params) {
	...
	const runManagedOutgoingMediaGc = params.runManagedOutgoingMediaGc ?? (async () => {
		const { cleanupManagedOutgoingMediaRecords } = await import("./managed-image-attachments-XlItAIeG.js");
