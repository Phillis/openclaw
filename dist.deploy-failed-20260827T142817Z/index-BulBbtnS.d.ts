...
declare const GATEWAY_SUSPEND_MODE_LEGACY = "legacy-auto-expire/v1";
declare const GATEWAY_SUSPEND_MODE_DURABLE = "handoff-durable-hold/v1";
declare const GatewaySuspendModeSchema: Type.TUnion<[Type.TLiteral<"legacy-auto-expire/v1">, Type.TLiteral<"handoff-durable-hold/v1">]>;
...
declare const GatewaySuspendPrepareParamsSchema: Type.TObject<{
  requestId: Type.TString;
  suspensionId: Type.TOptional<Type.TString>;
  gatewayInstanceId: Type.TOptional<Type.TString>;
  gatewayPid: Type.TInteger;
  launchdRunCount: Type.TInteger;
  suspendMode: Type.TOptional<Type.TUnion<[Type.TLiteral<"legacy-auto-expire/v1">, Type.TLiteral<"handoff-durable-hold/v1">]>>;
}>;
...
declare const GatewaySuspendPrepareReadyResultSchema: Type.TObject<{
  ...
  launchdRunCount: Type.TInteger;
  expiresAtMs: Type.TInteger;
  suspendMode: Type.TUnion<[Type.TLiteral<"legacy-auto-expire/v1">, Type.TLiteral<"handoff-durable-hold/v1">]>;
  activeCount: Type.TInteger;
  blockers: Type.TArray<Type.TObject<{
    kind: Type.TUnion<[Type.TLiteral<"queue">, Type.TLiteral<"reply">, Type.TLiteral<"embedded-run">, Type.TLiteral<"background-exec">, Type.TLiteral<"cron-run">, Type.TLiteral<"task">, Type.TLiteral<"root-request">, Type.TLiteral<"session-admission">, Type.TLiteral<"session-mutation">, Type.TLiteral<"chat-run">, Type.TLiteral<"queued-turn">, Type.TLiteral<"terminal-persistence">, Type.TLiteral<"terminal-session">]>;
    count: Type.TInteger;
...
declare const GatewaySuspendActiveStatusParamsSchema: Type.TObject<{
  suspensionId: Type.TString;
  gatewayInstanceId: Type.TString;
  suspendMode: Type.TOptional<Type.TUnion<[Type.TLiteral<"legacy-auto-expire/v1">, Type.TLiteral<"handoff-durable-hold/v1">]>>;
}>;
declare const GatewaySuspendReleaseStatusParamsSchema: Type.TObject<{
  releaseRequestId: Type.TString;
  releaseAuthoritySha256: Type.TString;
  suspendMode: Type.TLiteral<"handoff-durable-hold/v1">;
}>;
declare const GatewaySuspendStatusParamsSchema: Type.TUnion<[Type.TObject<{
  suspensionId: Type.TString;
  gatewayInstanceId: Type.TString;
  suspendMode: Type.TOptional<Type.TUnion<[Type.TLiteral<"legacy-auto-expire/v1">, Type.TLiteral<"handoff-durable-hold/v1">]>>;
}>, Type.TObject<{
...
declare const GatewaySuspendReleaseCommittedReceiptSchema: Type.TObject<{
  status: Type.TLiteral<"release_committed">;
  schema: Type.TLiteral<"openclaw-gateway-suspend-release/v1">;
  releaseRequestId: Type.TString;
  releaseAuthoritySha256: Type.TString;
  suspendRequestId: Type.TString;
  suspensionId: Type.TString;
  gatewayInstanceId: Type.TString;
  gatewayPid: Type.TInteger;
  launchdRunCount: Type.TInteger;
  suspendMode: Type.TLiteral<"handoff-durable-hold/v1">;
  resumeBeforeMs: Type.TInteger;
  committedAtMs: Type.TInteger;
  requiredAdmissionReopened: Type.TLiteral<true>;
  requiredSchedulerReopened: Type.TLiteral<true>;
  nonReusable: Type.TLiteral<true>;
}>;
declare const GatewaySuspendReleaseCompletedReceiptSchema: Type.TObject<{
  status: Type.TLiteral<"release_completed">;
  completedAtMs: Type.TInteger;
  admissionReopened: Type.TLiteral<true>;
  schedulerReopened: Type.TLiteral<true>;
  schema: Type.TLiteral<"openclaw-gateway-suspend-release/v1">;
  releaseRequestId: Type.TString;
  releaseAuthoritySha256: Type.TString;
  suspendRequestId: Type.TString;
...
declare const GatewaySuspendReleaseReceiptSchema: Type.TUnion<[Type.TObject<{
  status: Type.TLiteral<"release_committed">;
  schema: Type.TLiteral<"openclaw-gateway-suspend-release/v1">;
  releaseRequestId: Type.TString;
  releaseAuthoritySha256: Type.TString;
...
declare const GatewaySuspendReleaseRecoveryNeededResultSchema: Type.TObject<{
  status: Type.TLiteral<"release_recovery_needed">;
  retryAfterMs: Type.TInteger;
  releaseReceipt: Type.TObject<{
    status: Type.TLiteral<"release_committed">;
    schema: Type.TLiteral<"openclaw-gateway-suspend-release/v1">;
    releaseRequestId: Type.TString;
    releaseAuthoritySha256: Type.TString;
...
declare const GatewaySuspendLegacyResumeParamsSchema: Type.TObject<{
  suspensionId: Type.TString;
  gatewayInstanceId: Type.TString;
  resumeBeforeMs: Type.TInteger;
  suspendMode: Type.TOptional<Type.TLiteral<"legacy-auto-expire/v1">>;
}>;
declare const GatewaySuspendDurableResumeParamsSchema: Type.TObject<{
  suspensionId: Type.TString;
  gatewayInstanceId: Type.TString;
  resumeBeforeMs: Type.TInteger;
  suspendMode: Type.TLiteral<"handoff-durable-hold/v1">;
...
declare const GatewaySuspendResumeParamsSchema: Type.TUnion<[Type.TObject<{
  suspensionId: Type.TString;
  gatewayInstanceId: Type.TString;
  resumeBeforeMs: Type.TInteger;
  suspendMode: Type.TOptional<Type.TLiteral<"legacy-auto-expire/v1">>;
...
declare const GatewaySuspendLegacyResumeResultSchema: Type.TObject<{
  ok: Type.TLiteral<true>;
  status: Type.TLiteral<"running">;
  resumed: Type.TBoolean;
  gatewayInstanceId: Type.TString;
  suspendMode: Type.TLiteral<"legacy-auto-expire/v1">;
}>;
declare const GatewaySuspendDurableResumeResultSchema: Type.TObject<{
  ok: Type.TLiteral<true>;
  status: Type.TLiteral<"running">;
  resumed: Type.TBoolean;
  gatewayInstanceId: Type.TString;
...
declare const GatewaySuspendResumeResultSchema: Type.TUnion<[Type.TObject<{
  ok: Type.TLiteral<true>;
  status: Type.TLiteral<"running">;
  resumed: Type.TBoolean;
  gatewayInstanceId: Type.TString;
...
type GatewaySuspendMode = Static<typeof GatewaySuspendModeSchema>;
type GatewaySuspendReleaseCommittedReceipt = Static<typeof GatewaySuspendReleaseCommittedReceiptSchema>;
type GatewaySuspendReleaseCompletedReceipt = Static<typeof GatewaySuspendReleaseCompletedReceiptSchema>;
type GatewaySuspendReleaseReceipt = Static<typeof GatewaySuspendReleaseReceiptSchema>;
type GatewaySuspendReleaseStatusParams = Static<typeof GatewaySuspendReleaseStatusParamsSchema>;
...
declare const validateGatewaySuspendPrepareParams: ProtocolValidator<{
  ...
  suspendMode?: "legacy-auto-expire/v1" | "handoff-durable-hold/v1" | undefined;
  requestId: string;
  gatewayPid: number;
...
declare const validateGatewaySuspendResumeParams: ProtocolValidator<{
  suspendMode?: "legacy-auto-expire/v1" | undefined;
  suspensionId: string;
  gatewayInstanceId: string;
...
declare const validateExecutionIdentityContextV1: ProtocolValidator<{
  ...
  ingress: {
    ...
    kind: "api" | "subagent" | "channel" | "plugin" | "system" | "local-cli" | "gateway-client" | "schedule" | "webhook" | "task" | "acp" | "worker" | "recovery";
    state: "unknown" | "unsupported" | "present" | "absent";
    boundary: string;
  };
  invoker: {
...
declare const validateSessionVisibilitySetParams: ProtocolValidator<{
  agentId?: string | undefined;
  sessionKey: string;
  visibility: "read-only" | "shared" | "suggest" | "draft";
}>;
...
declare const validateSessionsCreateParams: ProtocolValidator<{
  ...
  visibility?: "read-only" | "shared" | "suggest" | "draft" | undefined;
  attachments?: {
    type?: string | undefined;
    mimeType?: string | undefined;
    fileName?: string | undefined;
...
declare const validateSessionsSendReconcileResult: ProtocolValidator<{
  ...
  runId: string;
  key: string;
  status: "active" | "not_found" | "applied";
}>;
...
declare const validateTalkClientSteerParams: ProtocolValidator<{
  mode?: "status" | "steer" | "followup" | "cancel" | undefined;
  sessionKey: string;
  text: string;
}>;
...
//#endregion
export { validateConfigApplyParams as $, UiFocusCommandSchema as $A, ModelsProbeTargetResultSchema as $C, ProjectsRegisterParams as $D, SessionCatalogTranscriptItemSchema as $E, validateTerminalCloseParams as $M, BoardChangedEvent as $O, AgentKindSchema as $S, AgentParamsSchema as $T, CronScratchSetResultSchema as $_, validateWorkerConnectRequestFrame as $a, TalkSpeakParamsSchema as $b, PluginControlUiDescriptor as $c, SessionDiscussionInfoResultSchema as $d, QuestionOption as $f, EnvironmentsListResultSchema as $g, DevicePairSetupStatusParams as $h, validateTalkClientToolCallResult as $i, ApprovalAllowedReasonSchema as $j, BoardWidgetMaterializedPutParams as $k, TerminalEventSchema as $l, GatewaySuspendReleaseCommittedReceiptSchema as $m, validateSecretsResolveResult as $n, WORKER_SESSION_TOOL_MAX_TEXT_LENGTH as $o, NodePairApproveParams as $p, validateSessionsObserverVisibilityParams as $r, WorkerTranscriptCommitParamsSchema as $s, validateLogsTailParams as $t, TaskSuggestionsDismissResultSchema as $u, ConfigSchemaParamsSchema as $v, SkillsProposalsListResultSchema as $w, AuditRunIdentityUnsupportedV1Schema as $x, ChannelsStartParamsSchema as $y, validateBoardEventParams as A, ErrorShapeSchema as AA, AgentsUpdateParamsSchema as AC, MigrationsMemoryPlanParamsSchema as AD, ChatSendSessionKeyString as AE, DeniedApprovalSnapshotSchema as AM, ClawHubTrustErrorDetails as AN, SessionSuggestionsListResultSchema as AO, ArtifactsDownloadResult as AS, ToolsCatalogResult as AT, CronScratchGetParams as A_, validateUsersLinkEmailParams as Aa, TalkConfigResult as Ab, WizardStep as Ac, SessionSharingActionSchema as Ad, SecretsResolveParamsSchema as Af, ExecApprovalsNodeSetParams as Ag, DesktopObserveResultSchema as Ah, validateSkillsSecurityVerdictsParams as Ai, WorkerInferenceOptions as Aj, BoardTabSchema as Ak, PluginsUiDescriptorsParams as Al, NodeSkillDescriptorSchema as Am, validatePluginsSetEnabledParams as An, WorktreesGcResultSchema as Ao, WebPushTestParams as Ap, validateSessionsCompactionRestoreParams as Ar, WorkerLiveEventResponseFrame as As, validateDevicePairSetupCodeParams as At, TasksListResult as Au, SystemAgentWizardCancel as Av, SkillsProposalEvaluateResult as Aw, UsersPrefsSetResult as Ax, CommandsListParams as Ay, validateChannelsPairingDismissParams as B, ResponseFrame as BA, ModelsAuthLogoutParams as BC, ProjectRecentSchema as BD, SessionCatalogCapabilitiesSchema as BE, PluginApprovalSeverity as BM, SessionTypingResultSchema as BO, AgentsWorkspaceEntry as BS, ToolsEffectiveResult as BT, CronGetParamsSchema as B_, validateUsersSetDisplayNameResult as Ba, TalkSessionCloseParams as Bb, PortalListResult as Bc, SessionSharingRole as Bd, SecretsStoreSetParams as Bf, EnvironmentSummary as Bg, DevicePairRemoveParamsSchema as Bh, validateSystemAgentSetupAuthStartParams as Bi, WorkerInferenceTerminalParams as Bj, BoardWidgetAppViewResult as Bk, PluginApprovalResolveParams as Bl, GatewaySuspendDurableResumeParamsSchema as Bm, validateProjectsRegisterParams as Bn, WorktreesRestoreParamsSchema as Bo, NodeEventResult as Bp, validateSessionsFilesListParams as Br, WorkerSessionsSendParams as Bs, validateExecApprovalResolveParams as Bt, TaskSuggestionResolutionSchema as Bu, SystemChangesListResult as Bv, SkillsProposalRecordResult as Bw, UsersSetDisplayNameParams as Bx, ChannelsPairingApproveResultSchema as By, validateArtifactsGetParams as C, WizardNotFoundErrorDetailsSchema as CA, AgentsFilesSetResult as CC, validateMigrationsMemoryPlanParams as CD, MessageActionParamsSchema as CE, ApprovalSnapshot as CM, SystemAgentInferenceUnavailableErrorDetails as CN, SessionSuggestionsAddParams as CO, AuditActivityOutboundMessageV1Schema as CS, ToolCatalogEntrySchema as CT, CronGetParams as C_, validateTtsSpeakParams as Ca, TalkClientToolCallParamsSchema as Cb, WizardStartParamsSchema as Cc, SessionMemberRemoveParamsSchema as Cd, SecretStoreEntry as Cf, ExecApprovalRequestParamsSchema as Cg, FsListDirResult as Ch, validateSkillsProposalEventsListParams as Ci, WorkerInferenceContext as Cj, BoardSizeSchema as Ck, PluginsSessionActionResult as Cl, NodePresenceAlivePayload as Cm, validatePluginApprovalResolveParams as Cn, WorktreesBranchesResult as Co, QuestionWaitAnswerResultSchema as Cp, validateSessionsCatalogListParams as Cr, WorkerLiveEventErrorDetailsSchema as Cs, validateDesktopObserveParams as Ct, TasksCancelResultSchema as Cu, SystemAgentSetupDetectParamsSchema as Cv, SkillsProposalActionParamsSchema as Cw, UsersListResultSchema as Cx, COMMAND_CHOICE_LABEL_MAX_LENGTH as Cy, validateAuditRunInspectParams as D, ConnectParams as DA, AgentsListResult as DC, MigrationProtocolSchemas as DD, WakeParams as DE, CancelledApprovalSnapshot as DM, readSystemAgentInferenceUnavailableErrorDetails as DN, SessionSuggestionsListParams as DO, ArtifactSummarySchema as DS, ToolCatalogProfileSchema as DT, CronRunLogEntry as D_, validateUpdateRunParams as Da, TalkClientTranscriptParamsSchema as Db, WizardStatusParamsSchema as Dc, SessionMembersListResult as Dd, SecretsReloadParamsSchema as Df, ExecApprovalsGetParamsSchema as Dg, DesktopObserveParams as Dh, validateSkillsProposalUpdateParams as Di, WorkerInferenceEventParams as Dj, BoardTabCreateOpSchema as Dk, PluginsSetEnabledParamsSchema as Dl, NodeRenameParams as Dm, validatePluginsSearchParams as Dn, WorktreesGcParams as Do, PushTestResultSchema as Dp, validateSessionsCompactParams as Dr, WorkerLiveEventParamsSchema as Ds, validateDevicePairRejectParams as Dt, TasksGetResultSchema as Du, SystemAgentSetupVerifyParamsSchema as Dv, SkillsProposalCreateParamsSchema as Dw, UsersPrefsGetResultSchema as Dx, COMMAND_NAME_MAX_LENGTH as Dy, validateAuditListParams as E, missingScopeErrorShape as EA, AgentsListParamsSchema as EC, MemoryMigrationProviderPlan as ED, SendParamsSchema as EE, ApprovalTerminalReasonSchema as EM, buildSystemAgentSessionInvalidatedErrorDetails as EN, SessionSuggestionsAddResultSchema as EO, ArtifactSummary as ES, ToolCatalogProfile as ET, CronRemoveParams as E_, validateUpdateHoldResult as Ea, TalkClientTranscriptParams as Eb, WizardStatusParams as Ec, SessionMembersListParamsSchema as Ed, SecretStoreSecretEntrySchema as Ef, ExecApprovalsGetParams as Eg, DesktopLaunchParamsSchema as Eh, validateSkillsProposalReviseParams as Ei, WorkerInferenceEventFrame as Ej, BoardTab as Ek, PluginsSetEnabledParams as El, NodePresenceAliveReasonSchema as Em, validatePluginsRefreshParams as En, WorktreesCreateParamsSchema as Eo, PushTestResult as Ep, validateSessionsCleanupParams as Er, WorkerLiveEventParams as Es, validateDevicePairListParams as Et, TasksGetResult as Eu, SystemAgentSetupVerifyParams as Ev, SkillsProposalCreateParams as Ew, UsersPrefsGetResult as Ex, COMMAND_LIST_MAX_ITEMS as Ey, validateBoardWidgetContent as F, GatewayFrameSchema as FA, GatewayAgentRuntime as FC, ProjectCheckout as FD, SecretInputSchema as FE, PendingApprovalSnapshot as FM, SessionTypingEvent as FO, ArtifactsGetResultSchema as FS, ToolsEffectiveGroupSchema as FT, CronUpdateParams as F_, validateUsersSelfParams as Fa, TalkModeParamsSchema as Fb, PortalCloseParamsSchema as Fc, SessionVisibilitySetParams as Fd, SecretsStoreListParamsSchema as Ff, ExecApprovalsSetParamsSchema as Fg, DevicePairListParams as Fh, validateSkillsUploadChunkParams as Fi, WorkerInferenceStartResponseFrame as Fj, BoardUpdateParamsSchema as Fk, PluginsUninstallParamsSchema as Fl, GATEWAY_SUSPEND_MODE_DURABLE as Fm, validatePortalCloseParams as Fn, WorktreesRemoveParams as Fo, WebPushVapidPublicKeyParamsSchema as Fp, validateSessionsDeleteParams as Fr, WorkerProtocolCloseReason as Fs, validateEnvironmentsDestroyParams as Ft, TasksRecoveryResultSchema as Fu, SystemChangeKindSchema as Fv, SkillsProposalEventsListResultSchema as Fw, UsersSelfResultSchema as Fx, TalkSessionAcknowledgeMarkParamsSchema as Fy, validateChatAbortParams as G, TickEventSchema as GA, ModelsListParamsSchema as GC, ProjectsAddParams as GD, SessionCatalogLocator as GE, SessionApprovalReplaySchema as GM, BOARD_CRON_JOB_ID_MAX_LENGTH as GO, AgentsWorkspaceGetParamsSchema as GS, ToolsInvokeResult as GT, CronRemoveParamsSchema as G_, validateWebPushTestParams as Ga, TalkSessionCreateResultSchema as Gb, PortalOpenResultSchema as Gc, SessionsViewerPresenceSetParams as Gd, QuestionGetParams as Gf, EnvironmentsCreateResultSchema as Gg, DevicePairSetupCodeParams as Gh, validateSystemInfoResult as Gi, validateWorkerInferenceTerminalOutcome as Gj, BoardWidgetDeclaredSchema as Gk, TerminalAttachParamsSchema as Gl, GatewaySuspendModeSchema as Gm, validateQuestionListParams as Gn, WORKER_PROTOCOL_FEATURES as Go, NodeInvokeParamsSchema as Gp, validateSessionsGroupsListParams as Gr, WorkerSessionsSpawnParamsSchema as Gs, validateExecApprovalsSetParams as Gt, TaskSuggestionsAcceptResultSchema as Gu, ConfigGetParamsSchema as Gv, SkillsProposalRequestRevisionResultSchema as Gw, AuditEventSchema as Gx, ChannelsPairingListParams as Gy, validateChannelsStartParams as H, ShutdownEvent as HA, ModelsAuthStatusParams as HC, ProjectRecordSchema as HD, SessionCatalogDescriptorSchema as HE, SessionApprovalEvent as HM, SessionClassificationSchema as HO, AgentsWorkspaceFile as HS, ToolsInvokeErrorSchema as HT, CronJobStateSchema as H_, validateWebLoginStartParams as Ha, TalkSessionCreateParams as Hb, PortalOpenParams as Hc, SessionVisibility as Hd, Question as Hf, EnvironmentsCreateParams as Hg, DevicePairRenameParamsSchema as Hh, validateSystemAgentSetupVerifyParams as Hi, validateWorkerInferenceEventFrame as Hj, BoardWidgetContent as Hk, TerminalAckResult as Hl, GatewaySuspendLegacyResumeParamsSchema as Hm, validateProjectsSearchRemoteParams as Hn, WORKER_HEARTBEAT_INTERVAL_MS as Ho, NodeInvokeInputEvent as Hp, validateSessionsFilesSetParams as Hr, WorkerSessionsSendResponseFrame as Hs, validateExecApprovalsNodeGetParams as Ht, TaskSuggestionsAcceptParams as Hu, ConfigApplyParams as Hv, SkillsProposalRequestRevisionParams as Hw, UsersSetDisplayNameResult as Hx, ChannelsPairingDismissParamsSchema as Hy, validateBoardWidgetGrantParams as I, HelloOk as IA, ModelCatalogProviderOutcome as IC, ProjectCheckoutSchema as ID, SecretRefSchema as IE, PendingApprovalSnapshotSchema as IM, SessionTypingEventSchema as IO, ArtifactsListParams as IS, ToolsEffectiveNotice as IT, CronAddParamsSchema as I_, validateUsersSelfResult as Ia, TalkSessionAppendAudioParams as Ib, PortalCloseResult as Ic, SessionVisibilitySetParamsSchema as Id, SecretsStoreListResult as If, ExecApprovalsSnapshot as Ig, DevicePairListParamsSchema as Ih, validateSkillsUploadCommitParams as Ii, WorkerInferenceStartResponseFrameSchema as Ij, BoardViewTicketSchema as Ik, PluginsUninstallResult as Il, GATEWAY_SUSPEND_MODE_LEGACY as Im, validatePortalListParams as In, WorktreesRemoveParamsSchema as Io, NodeDescribeParams as Ip, validateSessionsDescribeParams as Ir, WorkerProviderReplayState as Is, validateEnvironmentsListParams as It, TaskSuggestion as Iu, SystemChangeSource as Iv, SkillsProposalInspectParams as Iw, UsersSetAvatarParams as Ix, ChannelsPairingAccount as Iy, validateChatMessageGetParams as J, UiCommandParams as JA, ModelsProbeParams as JC, ProjectsAddResultSchema as JD, SessionCatalogPullRequestSummarySchema as JE, TerminalApprovalSnapshot as JM, BOARD_WIDGET_TOOL_MAX_LENGTH as JO, AgentsWorkspaceListParams as JS, AgentEventSchema as JT, CronRunsParamsSchema as J_, validateWizardCancelParams as Ja, TalkSessionSteerParams as Jb, PluginCatalogClawHubInstallSchema as Jc, SessionsViewerPresenceSetResultSchema as Jd, QuestionGetResultSchema as Jf, EnvironmentsDestroyResult as Jg, DevicePairSetupCodeResultSchema as Jh, validateTalkClientCreateParams as Ji, validateApprovalResolveResult as Jj, BoardWidgetGrantParams as Jk, TerminalCloseParams as Jl, GatewaySuspendPrepareParamsSchema as Jm, validateQuestionWaitAnswerParams as Jn, WORKER_PROTOCOL_MAX_METHOD_LENGTH as Jo, NodeInvokeRequestEventSchema as Jp, validateSessionsGroupsPutParams as Jr, WorkerTranscriptCommitErrorReason as Js, validateFsListDirResult as Jt, TaskSuggestionsCreateResult as Ju, ConfigSchemaLookupParams as Jv, SkillsProposalUpdateParams as Jw, AuditListResult as Jx, ChannelsPairingListResultSchema as Jy, validateChatHistoryParams as K, UiClosePaneCommandSchema as KA, ModelsListResult as KC, ProjectsAddParamsSchema as KD, SessionCatalogLocatorSchema as KE, SystemAgentApprovalPresentation as KM, BOARD_CRON_TRIGGER_PREFIX as KO, AgentsWorkspaceGetResult as KS, ToolsInvokeResultSchema as KT, CronRunLogEntrySchema as K_, validateWebPushUnsubscribeParams as Ka, TalkSessionOkResult as Kb, PortalSummary as Kc, SessionsViewerPresenceSetParamsSchema as Kd, QuestionGetParamsSchema as Kf, EnvironmentsDestroyParams as Kg, DevicePairSetupCodeParamsSchema as Kh, validateTalkCatalogParams as Ki, validateApprovalGetResult as Kj, BoardWidgetGeneratedIdentity as Kk, TerminalAttachResult as Kl, GatewaySuspendPrepareBusyResultSchema as Km, validateQuestionRequestParams as Kn, WORKER_PROTOCOL_MAX_FEATURES as Ko, NodeInvokeProgressParams as Kp, validateSessionsGroupsListResult as Kr, WorkerSessionsSpawnResponseFrame as Ks, validateExecutionIdentityContextV1 as Kt, TaskSuggestionsCreateParams as Ku, ConfigPatchParams as Kv, SkillsProposalReviseParams as Kw, AuditListParams as Kx, ChannelsPairingListParamsSchema as Ky, validateBoardWidgetPutParams as L, HelloOkSchema as LA, ModelCatalogProviderOutcomeSchema as LC, ProjectRecent as LD, SessionLabelString as LE, PendingSessionApprovalEventSchema as LM, SessionTypingParams as LO, ArtifactsListParamsSchema as LS, ToolsEffectiveNoticeSchema as LT, CronAddResultSchema as L_, validateUsersSetAvatarParams as La, TalkSessionAppendAudioParamsSchema as Lb, PortalCloseResultSchema as Lc, SessionVisibilitySetResult as Ld, SecretsStoreListResultSchema as Lf, ExecApprovalsSnapshotSchema as Lg, DevicePairRejectParams as Lh, validateSystemAgentChatHistoryParams as Li, WorkerInferenceStartResult as Lj, BoardWidget as Lk, PluginsUninstallResultSchema as Ll, GatewaySuspendActiveStatusParamsSchema as Lm, validatePortalOpenParams as Ln, WorktreesRemoveResult as Lo, NodeDescribeParamsSchema as Lp, validateSessionsDiffParams as Lr, WorkerProviderReplayStateSchema as Ls, validateEnvironmentsStatusParams as Lt, TaskSuggestionEvent as Lu, SystemChangeSourceSchema as Lv, SkillsProposalInspectParamsSchema as Lw, UsersSetAvatarParamsSchema as Lx, ChannelsPairingApproveParams as Ly, validateBoardPromptAuthorizeParams as M, EventFrameSchema as MA, AgentsUpdateResultSchema as MC, PROJECTS_LIST_DEFAULT_LIMIT as MD, GatewayClientModeSchema as ME, ExecApprovalPresentationSchema as MM, isClawHubTrustErrorCode as MN, SessionSuggestionsResolveParamsSchema as MO, ArtifactsGetParams as MS, ToolsEffectiveEntry as MT, CronScratchSetParams as M_, validateUsersListParams as Ma, TalkEvent as Mb, PortalChangedEvent as Mc, SessionSharingEventSchema as Md, SecretsResolveResultSchema as Mf, ExecApprovalsNodeSnapshot as Mg, DesktopSourceSchema as Mh, validateSkillsStatusParams as Mi, WorkerInferenceStartParams as Mj, BoardTabsReorderOpSchema as Mk, PluginsUiDescriptorsResult as Ml, NodeSkillsUpdateParamsSchema as Mm, validatePluginsUiDescriptorsResult as Mn, WorktreesListParamsSchema as Mo, WebPushUnsubscribeParams as Mp, validateSessionsCompanionResetParams as Mr, WorkerLiveEventResult as Ms, validateDeviceTokenRevokeParams as Mt, TasksRecoveryParams as Mu, SystemChangeEntry as Mv, SkillsProposalEventsListParams as Mw, UsersSelfParams as Mx, CommandsListResult as My, validateBoardUpdateParams as N, GATEWAY_SERVER_CAPS as NA, AuthProbeStatus as NC, PROJECTS_LIST_MAX_CHECKOUTS_PER_PROJECT as ND, InputProvenanceSchema as NE, ExpiredApprovalSnapshot as NM, readClawHubTrustErrorDetails as NN, SessionSuggestionsResolveResult as NO, ArtifactsGetParamsSchema as NS, ToolsEffectiveEntrySchema as NT, CronScratchSetResult as N_, validateUsersPrefsGetParams as Na, TalkEventSchema as Nb, PortalChangedEventSchema as Nc, SessionSharingIdentity as Nd, SecretsStoreDeleteParams as Nf, ExecApprovalsNodeSnapshotSchema as Ng, DevicePairApproveParams as Nh, validateSkillsUpdateParams as Ni, WorkerInferenceStartRequestFrame as Nj, BoardTicketEventParamsSchema as Nk, PluginsUiDescriptorsResultSchema as Nl, HooksStatusParams as Nm, validatePluginsUninstallParams as Nn, WorktreesListResult as No, WebPushUnsubscribeParamsSchema as Np, validateSessionsCompanionStateParams as Nr, WorkerLiveEventResultSchema as Ns, validateDeviceTokenRotateParams as Nt, TasksRecoveryParamsSchema as Nu, SystemChangeEntrySchema as Nv, SkillsProposalEventsListParamsSchema as Nw, UsersSelfParamsSchema as Nx, CommandsListResultSchema as Ny, validateBoardActionParams as O, ConnectParamsSchema as OA, AgentsListResultSchema as OC, MigrationsMemoryApplyParamsSchema as OD, WakeParamsSchema as OE, CancelledApprovalSnapshotSchema as OM, readSystemAgentSessionInvalidatedErrorDetails as ON, SessionSuggestionsListParamsSchema as OO, ArtifactsDownloadParams as OS, ToolsCatalogParams as OT, CronRunParams as O_, validateUpdateStatusParams as Oa, TalkConfigParams as Ob, WizardStatusResult as Oc, SessionMembersListResultSchema as Od, SecretsResolveAssignmentSchema as Of, ExecApprovalsNodeGetParams as Og, DesktopObserveParamsSchema as Oh, validateSkillsProposalsListParams as Oi, WorkerInferenceModelRef as Oj, BoardTabDeleteOpSchema as Ok, PluginsSetEnabledResult as Ol, NodeRenameParamsSchema as Om, validatePluginsSessionActionParams as On, WorktreesGcParamsSchema as Oo, WebPushSubscribeParams as Op, validateSessionsCompactionBranchParams as Or, WorkerLiveEventRequestFrame as Os, validateDevicePairRemoveParams as Ot, TasksListParams as Ou, SystemAgentSetupVerifyResult as Ov, SkillsProposalEvaluateParams as Ow, UsersPrefsSetParams as Ox, CommandEntry as Oy, validateBoardWidgetAppViewParams as P, GatewayFrame as PA, AuthProbeStatusSchema as PC, PROJECTS_LIST_MAX_IDENTITY_PROBES as PD, NonEmptyString as PE, ExpiredApprovalSnapshotSchema as PM, SessionSuggestionsResolveResultSchema as PO, ArtifactsGetResult as PS, ToolsEffectiveGroup as PT, CronStatusParams as P_, validateUsersPrefsSetParams as Pa, TalkModeParams as Pb, PortalCloseParams as Pc, SessionSharingIdentitySchema as Pd, SecretsStoreDeleteParamsSchema as Pf, ExecApprovalsSetParams as Pg, DevicePairApproveParamsSchema as Ph, validateSkillsUploadBeginParams as Pi, WorkerInferenceStartRequestFrameSchema as Pj, BoardUpdateParams as Pk, PluginsUninstallParams as Pl, HooksStatusParamsSchema as Pm, validatePollParams as Pn, WorktreesListResultSchema as Po, WebPushVapidPublicKeyParams as Pp, validateSessionsCreateParams as Pr, WorkerLiveEventSchema as Ps, validateEnvironmentsCreateParams as Pt, TasksRecoveryResult as Pu, SystemChangeKind as Pv, SkillsProposalEventsListResult as Pw, UsersSelfResult as Px, TalkSessionAcknowledgeMarkParams as Py, validateCommandsListParams as Q, UiCommandSchema as QA, ModelsProbeTargetResult as QC, ProjectsListResultSchema as QD, SessionCatalogTranscriptItem as QE, validateTerminalAttachParams as QM, BoardCanvasDocumentSourceSchema as QO, AgentKind as QS, AgentIdentityResultSchema as QT, CronScratchSetParamsSchema as Q_, validateWorkerAdmissionHandshake as Qa, TalkSpeakParams as Qb, PluginCatalogOfficialInstallSchema as Qc, SessionDiscussionInfoResult as Qd, QuestionListResultSchema as Qf, EnvironmentsListResult as Qg, DevicePairSetupDeliveryUncertainEventSchema as Qh, validateTalkClientToolCallParams as Qi, ApprovalAllowDecisionSchema as Qj, BoardWidgetMaterializedContent as Qk, TerminalEvent as Ql, GatewaySuspendReleaseCommittedReceipt as Qm, validateSecretsResolveParams as Qn, WORKER_SESSION_TOOLS_PROTOCOL_FEATURE as Qo, NodeListParamsSchema as Qp, validateSessionsMessagesUnsubscribeParams as Qr, WorkerTranscriptCommitParams as Qs, validateHooksStatusParams as Qt, TaskSuggestionsDismissResult as Qu, ConfigSchemaParams as Qv, SkillsProposalsListResult as Qw, AuditRunIdentityUnknownV1Schema as Qx, ChannelsStartParams as Qy, validateChannelsLogoutParams as R, RequestFrame as RA, ModelChoice as RC, ProjectRecentFolderSchema as RD, SessionCatalog as RE, PluginApprovalPresentation as RM, SessionTypingParamsSchema as RO, ArtifactsListResult as RS, ToolsEffectiveParams as RT, CronDeclarativeAddResultSchema as R_, validateUsersSetAvatarResult as Ra, TalkSessionCancelOutputParams as Rb, PortalListParams as Rc, SessionVisibilitySetResultSchema as Rd, SecretsStoreMutationResult as Rf, EnvironmentStatus as Rg, DevicePairRejectParamsSchema as Rh, validateSystemAgentChatParams as Ri, WorkerInferenceTerminalFrame as Rj, BoardWidgetAppViewParams as Rk, PluginApprovalRequestParams as Rl, GatewaySuspendBlocker as Rm, validateProjectsAddParams as Rn, WorktreesRemoveResultSchema as Ro, NodeEventParams as Rp, validateSessionsDispatchParams as Rr, WorkerSessionToolResult as Rs, validateExecApprovalGetParams as Rt, TaskSuggestionEventSchema as Ru, SystemChangesListParams as Rv, SkillsProposalInspectResult as Rw, UsersSetAvatarResult as Rx, ChannelsPairingApproveParamsSchema as Ry, validateArtifactsDownloadParams as S, UserPrefsLimitExceededErrorDetailsSchema as SA, AgentsFilesSetParamsSchema as SC, validateMigrationsMemoryApplyParams as SD, MessageActionParams as SE, ApprovalResolveResultSchema as SM, SystemAgentErrorDetailCodes as SN, SessionSuggestionStateSchema as SO, AuditActivityOutboundMessageV1 as SS, ToolCatalogEntry as ST, CronDeclarativeAddResult as S_, validateToolsInvokeParams as Sa, TalkClientToolCallParams as Sb, WizardStartParams as Sc, SessionMemberRemoveParams as Sd, isCloudWorkerPlacementState as Sf, ExecApprovalRequestParams as Sg, FsListDirParamsSchema as Sh, validateSkillsProposalEvaluateParams as Si, WorkerInferenceCancelResult as Sj, BoardSetChatDockCommandSchema as Sk, PluginsSessionActionParamsSchema as Sl, NodePresenceActivityPayloadSchema as Sm, validatePluginApprovalRequestParams as Sn, WorktreesBranchesParamsSchema as So, QuestionWaitAnswerResult as Sp, validateSessionsCatalogContinueParams as Sr, WorkerLiveEventErrorDetails as Ss, validateDesktopLaunchParams as St, TasksCancelResult as Su, SystemAgentSetupDetectParams as Sv, SkillsProposalActionParams as Sw, UsersListResult as Sx, COMMAND_ARG_NAME_MAX_LENGTH as Sy, validateAuditActivityListParams as T, errorShape as TA, AgentsListParams as TC, MemoryMigrationItem as TD, PollParamsSchema as TE, ApprovalTerminalReason as TM, buildSystemAgentInferenceUnavailableErrorDetails as TN, SessionSuggestionsAddResult as TO, AuditActivityToolActionV1Schema as TS, ToolCatalogGroupSchema as TT, CronListParams as T_, validateUpdateHoldParams as Ta, TalkClientToolCallResultSchema as Tb, WizardStartResultSchema as Tc, SessionMembersListParams as Td, SecretStoreEnvEntrySchema as Tf, ExecApprovalResolveParamsSchema as Tg, DesktopLaunchParams as Th, validateSkillsProposalRequestRevisionParams as Ti, WorkerInferenceErrorShape as Tj, BoardSnapshotSchema as Tk, PluginsSessionActionSuccessResultSchema as Tl, NodePresenceAliveReason as Tm, validatePluginsListParams as Tn, WorktreesCreateParams as To, PushTestParamsSchema as Tp, validateSessionsCatalogStartTerminalParams as Tr, WorkerLiveEventErrorShapeSchema as Ts, validateDevicePairApproveParams as Tt, TasksGetParamsSchema as Tu, SystemAgentSetupDetectResultSchema as Tv, SkillsProposalApplyResultSchema as Tw, UsersPrefsGetParamsSchema as Tx, COMMAND_DESCRIPTION_MAX_LENGTH as Ty, validateChannelsStatusParams as U, ShutdownEventSchema as UA, ModelsAuthStatusParamsSchema as UC, ProjectSummary as UD, SessionCatalogHost as UE, SessionApprovalEventSchema as UM, SessionPeerKind as UO, AgentsWorkspaceFileSchema as US, ToolsInvokeParams as UT, CronListParamsSchema as U_, validateWebLoginWaitParams as Ua, TalkSessionCreateParamsSchema as Ub, PortalOpenParamsSchema as Uc, SessionVisibilitySchema as Ud, QuestionAnswers as Uf, EnvironmentsCreateParamsSchema as Ug, DevicePairRequestedEventSchema as Uh, validateSystemChangesListParams as Ui, validateWorkerInferenceStartParams as Uj, BoardWidgetContentSchema as Uk, TerminalAckResultSchema as Ul, GatewaySuspendLegacyResumeResultSchema as Um, validatePushTestParams as Un, WORKER_LAUNCH_V2_PROTOCOL_FEATURE as Uo, NodeInvokeInputEventSchema as Up, validateSessionsForkParams as Ur, WorkerSessionsSendResponseFrameSchema as Us, validateExecApprovalsNodeSetParams as Ut, TaskSuggestionsAcceptParamsSchema as Uu, ConfigApplyParamsSchema as Uv, SkillsProposalRequestRevisionParamsSchema as Uw, UsersSetDisplayNameResultSchema as Ux, ChannelsPairingDismissResult as Uy, validateChannelsPairingListParams as V, ResponseFrameSchema as VA, ModelsAuthLogoutParamsSchema as VC, ProjectRecord as VD, SessionCatalogDescriptor as VE, PluginApprovalSeveritySchema as VM, SessionClassification as VO, AgentsWorkspaceEntrySchema as VS, ToolsEffectiveResultSchema as VT, CronJobSchema as V_, validateWakeParams as Va, TalkSessionCloseParamsSchema as Vb, PortalListResultSchema as Vc, SessionSharingRoleSchema as Vd, SecretsStoreSetParamsSchema as Vf, EnvironmentSummarySchema as Vg, DevicePairRenameParams as Vh, validateSystemAgentSetupDetectParams as Vi, validateWorkerInferenceCancelParams as Vj, BoardWidgetAppViewResultSchema as Vk, PluginApprovalResolveParamsSchema as Vl, GatewaySuspendDurableResumeResultSchema as Vm, validateProjectsRemoveParams as Vn, WORKER_EXECUTION_CONTEXT_PROTOCOL_FEATURE as Vo, NodeEventResultSchema as Vp, validateSessionsFilesRevealParams as Vr, WorkerSessionsSendParamsSchema as Vs, validateExecApprovalsGetParams as Vt, TaskSuggestionSchema as Vu, SystemChangesListResultSchema as Vv, SkillsProposalRecordResultSchema as Vw, UsersSetDisplayNameParamsSchema as Vx, ChannelsPairingDismissParams as Vy, validateChannelsStopParams as W, TickEvent as WA, ModelsListParams as WC, ProjectSummarySchema as WD, SessionCatalogHostSchema as WE, SessionApprovalReplay as WM, SessionPeerKindSchema as WO, AgentsWorkspaceGetParams as WS, ToolsInvokeParamsSchema as WT, CronPacingSchema as W_, validateWebPushSubscribeParams as Wa, TalkSessionCreateResult as Wb, PortalOpenResult as Wc, SESSION_VIEWER_PRESENCE_MAX_KEYS as Wd, QuestionAnswersSchema as Wf, EnvironmentsCreateResult as Wg, DevicePairResolvedEventSchema as Wh, validateSystemInfoParams as Wi, validateWorkerInferenceTerminalFrame as Wj, BoardWidgetDeclared as Wk, TerminalAttachParams as Wl, GatewaySuspendMode as Wm, validateQuestionGetParams as Wn, WORKER_LIVE_EVENT_PROTOCOL_FEATURE as Wo, NodeInvokeParams as Wp, validateSessionsGroupsDeleteParams as Wr, WorkerSessionsSpawnParams as Ws, validateExecApprovalsNodeSnapshot as Wt, TaskSuggestionsAcceptResult as Wu, ConfigGetParams as Wv, SkillsProposalRequestRevisionResult as Ww, AuditEvent as Wx, ChannelsPairingDismissResultSchema as Wy, validateChatSendParams as X, UiCommandResult as XA, ModelsProbeResult as XC, ProjectsListParamsSchema as XD, SessionCatalogSession as XE, TerminalSessionApprovalEventSchema as XM, BoardActionParamsSchema as XO, AgentsWorkspaceListResult as XS, AgentIdentityParamsSchema as XT, CronScratchGetResultSchema as X_, validateWizardStartParams as Xa, TalkSessionSubmitToolResultParams as Xb, PluginCatalogEntrySchema as Xc, SessionDiscussionInfoParams as Xd, QuestionListParamsSchema as Xf, EnvironmentsListParams as Xg, DevicePairSetupCompletedEventSchema as Xh, validateTalkClientMutationResult as Xi, AllowedApprovalSnapshotSchema as Xj, BoardWidgetHeightModeSchema as Xk, TerminalDataEvent as Xl, GatewaySuspendPrepareResult as Xm, validateScopeUpgradeRequest as Xn, WORKER_PROVIDER_REPLAY_MAX_DATA_BYTES as Xo, NodeInvokeResultParamsSchema as Xp, validateSessionsListParams as Xr, WorkerTranscriptCommitErrorShape as Xs, validateGatewaySuspendResumeParams as Xt, TaskSuggestionsDismissParams as Xu, ConfigSchemaLookupResult as Xv, SkillsProposalsListParams as Xw, AuditRunIdentityAmbiguousV1Schema as Xx, ChannelsLogoutParams as Xy, validateChatMetadataParams as Y, UiCommandParamsSchema as YA, ModelsProbeParamsSchema as YC, ProjectsListParams as YD, SessionCatalogSchema as YE, TerminalApprovalSnapshotSchema as YM, BoardActionParams as YO, AgentsWorkspaceListParamsSchema as YS, AgentIdentityParams as YT, CronScratchGetParamsSchema as Y_, validateWizardNextParams as Ya, TalkSessionSteerParamsSchema as Yb, PluginCatalogEntry as Yc, SessionDiscussionInfo as Yd, QuestionListParams as Yf, EnvironmentsDestroyResultSchema as Yg, DevicePairSetupCompletedEvent as Yh, validateTalkClientCreateResult as Yi, AllowedApprovalSnapshot as Yj, BoardWidgetGrantParamsSchema as Yk, TerminalCloseParamsSchema as Yl, GatewaySuspendPrepareReadyResultSchema as Ym, validateRequestFrame as Yn, WORKER_PROTOCOL_METHODS as Yo, NodeInvokeResultParams as Yp, validateSessionsGroupsRenameParams as Yr, WorkerTranscriptCommitErrorReasonSchema as Ys, validateGatewaySuspendPrepareParams as Yt, TaskSuggestionsCreateResultSchema as Yu, ConfigSchemaLookupParamsSchema as Yv, SkillsProposalUpdateParamsSchema as Yw, AuditListResultSchema as Yx, ChannelsPairingRequest as Yy, validateChatToolTitlesParams as Z, UiCommandResultSchema as ZA, ModelsProbeResultSchema as ZC, ProjectsListResult as ZD, SessionCatalogSessionSchema as ZE, isWellFormedApprovalId as ZM, BoardCanvasDocumentSource as ZO, AgentsWorkspaceListResultSchema as ZS, AgentIdentityResult as ZT, CronScratchSchema as Z_, validateWizardStatusParams as Za, TalkSessionSubmitToolResultParamsSchema as Zb, PluginCatalogInstallActionSchema as Zc, SessionDiscussionInfoParamsSchema as Zd, QuestionListResult as Zf, EnvironmentsListParamsSchema as Zg, DevicePairSetupDeliveryUncertainEvent as Zh, validateTalkClientSteerParams as Zi, ApprovalAllowDecision as Zj, BoardWidgetHtmlContentSchema as Zk, TerminalDataEventSchema as Zl, GatewaySuspendPrepareResultSchema as Zm, validateScopeUpgradeWait as Zn, WORKER_RPC_SET_VERSION as Zo, NodeListParams as Zp, validateSessionsMessagesSubscribeParams as Zr, WorkerTranscriptCommitErrorShapeSchema as Zs, validateGatewaySuspendStatusParams as Zt, TaskSuggestionsDismissParamsSchema as Zu, ConfigSchemaLookupResultSchema as Zv, SkillsProposalsListParamsSchema as Zw, AuditRunIdentityPresentV1Schema as Zx, ChannelsLogoutParamsSchema as Zy, validateAgentsWorkspaceListParams as _, GatewayErrorDetailsSchema as _A, AgentsFilesListParams as _C, SessionsCatalogReadResultSchema as _D, ConversationTurnParamsSchema as _E, ApprovalPresentation as _M, UserPrefsLimitExceededErrorDetails as _N, SessionSuggestionEventSchema as _O, AuditActivityInboundMessageV1Schema as _S, SkillsUploadBeginParamsSchema as _T, WorkerEnvironmentStateSchema as __, validateTasksGetParams as _a, TalkClientCreateResultSchema as _b, WizardCancelParamsSchema as _c, SessionMember as _d, SessionsReclaimParams as _f, ScopeUpgradeResultSchema as _g, GatewaySuspendTaskBlocker as _h, validateSkillsCuratorStatusParams as _i, WorkerInferenceCancelParams as _j, BoardOp as _k, PluginsSearchParamsSchema as _l, NodePluginToolDescriptor as _m, validateNodePendingEnqueueParams as _n, WorktreeRecord as _o, QuestionSchema as _p, validateSessionVisibilitySetParams as _r, WorkerHeartbeatResponseFrame as _s, validateCronScratchGetParams as _t, TerminalUploadResultSchema as _u, SystemAgentSetupActivateResultSchema as _v, SkillsDetailParamsSchema as _w, UsersLinkEmailParamsSchema as _x, UpdateStatusResultSchema as _y, PROTOCOL_VERSION as a, BoardWidgetPluginKindSchema as aA, AgentsCreateResult as aC, SessionsCatalogContinueParamsSchema as aD, ConversationListParamsSchema as aE, ApprovalDeniedReasonSchema as aM, ProtocolValidator as aN, ProjectsRemoveResult as aO, AuditRunInspectResultSchema as aS, SkillsSecurityVerdictsParamsSchema as aT, WorkerDesktopAppIdSchema as a_, validateTalkSessionAppendAudioParams as aa, ChannelsStopParamsSchema as ab, WorkerTranscriptCommitResultSchema as ac, SYSTEM_PRESENCE_LEGACY_CLEAR_LAST_INPUT_SECONDS as ad, SessionDiscussionState as af, DeviceTokenRotateParams as ag, GatewaySuspendReleaseStatusParams as ah, validateSessionsRecoverParams as ai, SkillsProposalHistoryScanParamsSchema as aj, BoardCommandSchema as ak, PluginsInstallParamsSchema as al, NodePairRemoveParams as am, validateNodeDescribeParams as an, validateWorkerLiveEventParams as ao, QuestionRequestQuestion as ap, validateSendParams as ar, WorkerAdmissionHandshake as as, validateConfigSetParams as at, TerminalListResultSchema as au, SystemAgentChatHistoryResultSchema as av, SkillsBinsParamsSchema as aw, TtsSpeakResultSchema as ax, UpdateAvailableSchema as ay, validateApprovalPresentation as b, ProjectCloneErrorDetailsSchema as bA, AgentsFilesListResultSchema as bC, SessionsCatalogStartTerminalResult as bD, ConversationTurnResult as bE, ApprovalResolveParamsSchema as bM, readMissingScopeError as bN, SessionSuggestionSchema as bO, AuditActivityListResult as bS, SkillsUploadCommitParams as bT, CronAddParams as b_, validateToolsCatalogParams as ba, TalkClientSteerParams as bb, WizardNextResult as bc, SessionMemberMutationResult as bd, SessionsReclaimResultSchema as bf, ExecApprovalGetParams as bg, FsDirEntrySchema as bh, validateSkillsProposalActionParams as bi, WorkerInferenceCancelResponseFrame as bj, BoardPromptAuthorizeParams as bk, PluginsSessionActionFailureResultSchema as bl, NodePluginToolsUpdateParamsSchema as bm, validateNodeRenameParams as bn, WorktreeRepositoryStatusSchema as bo, QuestionWaitAnswerParams as bp, validateSessionsBranchesSwitchParams as br, WorkerHelloOk as bs, validateCronUpdateParams as bt, TasksCancelParams as bu, SystemAgentSetupAuthStartResult as bv, SkillsInstallParams as bw, UsersListParams as bx, COMMAND_ARG_CHOICES_MAX_ITEMS as by, validateAgentWaitParams as c, BoardWidgetPutContent as cA, AgentsDeleteParamsSchema as cC, SessionsCatalogHostEvent as cD, ConversationSendParams as cE, ApprovalGetParamsSchema as cM, ErrorCode as cN, ProjectsSearchRemoteParamsSchema as cO, ExecutionIdentityContextV1 as cS, SkillsSkillCardParams as cT, WorkerDesktopLaunchResult as c_, validateTalkSessionCreateParams as ca, TalkCatalogParams as cb, WORKER_PROTOCOL_MAX_FRAME_ID_LENGTH as cc, SystemInfoParamsSchema as cd, SessionPlacementDiskSpace as cf, DeviceTokenRotateResultSchema as cg, GatewaySuspendResumeParamsSchema as ch, validateSessionsRewindParams as ci, SkillsProposalHistoryStatusParams as cj, BoardDataReadParamsSchema as ck, PluginsListParams as cl, NodePendingAckParamsSchema as cm, validateNodeInvokeProgressParams as cn, validateWorkerTranscriptCommitParams as co, QuestionRequestResultSchema as cp, validateSessionDiscussionOpenParams as cr, WorkerAdmissionResponseFrameSchema as cs, validateConversationSendParams as ct, TerminalOpenResult as cu, SystemAgentChatParams as cv, SkillsCuratorActionParams as cw, WebLoginWaitParams as cx, UpdateHoldResult as cy, validateAgentsFilesGetParams as d, BoardWidgetPutParamsSchema as dA, AgentsFileEntry as dC, SessionsCatalogListParamsSchema as dD, ConversationSendResultSchema as dE, ApprovalHistoryParams as dM, GatewayErrorDetails as dN, RemoteProject as dO, PrincipalRefV1Schema as dS, SkillsSkillCardResultSchema as dT, WorkerDesktopObserveParamsSchema as d_, validateTalkSpeakParams as da, TalkCatalogResultSchema as db, WORKER_PUBLIC_INGRESS_PATH as dc, PresenceEntry as dd, SessionPlacementSchema as df, ScopeUpgradeRegistration as dg, GatewaySuspendStatusParams as dh, validateSessionsSendReconcileParams as di, validateSkillsProposalHistoryStatusParams as dj, BoardFocusTabCommandSchema as dk, PluginsListResultSchema as dl, NodePendingDrainResult as dm, validateNodePairApproveParams as dn, validateWorktreesGcParams as do, QuestionResolveParams as dp, validateSessionMemberRemoveParams as dr, WorkerConnectRequestFrameSchema as ds, validateCronAddParams as dt, TerminalResizeParamsSchema as du, SystemAgentChatQuestionSchema as dv, SkillsCuratorActionResultSchema as dw, USER_PREFS_PROFILE_KEY_LIMIT as dx, UpdateRunParamsSchema as dy, BoardWidgetMcpAppContentSchema as eA, AgentOwnershipSchema as eC, SessionsCatalogArchiveParams as eD, AgentWaitParams as eE, ApprovalCancelledReasonSchema as eM, validateTerminalInputParams as eN, ProjectsRegisterParamsSchema as eO, AuditRunIdentityV1 as eS, SkillsSearchParams as eT, EnvironmentsStatusParams as e_, validateTalkClientTranscriptParams as ea, ChannelsStatusParams as eb, WorkerTranscriptCommitRequestFrame as ec, TaskSuggestionsListParams as ed, SessionDiscussionInfoSchema as ef, DevicePairSetupStatusParamsSchema as eg, GatewaySuspendReleaseCompletedReceipt as eh, validateSessionsPatchManyParams as ei, UiNavigateCommandSchema as ej, BoardChangedEventSchema as ek, PluginControlUiDescriptorSchema as el, NodePairApproveParamsSchema as em, validateMessageActionParams as en, validateWorkerDesktopLaunchParams as eo, QuestionOptionSchema as ep, validateSecretsStoreDeleteParams as er, WORKER_TRANSCRIPT_COMMIT_PROTOCOL_FEATURE as es, validateConfigGetParams as et, TerminalExitEvent as eu, CronStatusParamsSchema as ev, SkillProposalEvaluation as ew, TalkSpeakResult as ex, ConfigSchemaResponse as ey, validateAgentsFilesListParams as f, BoardWidgetPutResult as fA, AgentsFileEntrySchema as fC, SessionsCatalogListResult as fD, ConversationTurnCancelParams as fE, ApprovalHistoryParamsSchema as fM, McpAppViewExpiredErrorDetails as fN, RemoteProjectSchema as fO, AuditActivityAgentRunV1 as fS, SkillsStatusParams as fT, WorkerDesktopObserveResult as f_, validateTaskSuggestionsAcceptParams as fa, TalkClientCloseParams as fb, WorkerAdmissionFailureReasonSchema as fc, PresenceEntrySchema as fd, SessionPlacementStateSchema as ff, ScopeUpgradeRegistrationSchema as fg, GatewaySuspendStatusParamsSchema as fh, validateSessionsSendReconcileResult as fi, WORKER_INFERENCE_MAX_CONTEXT_MESSAGES as fj, BoardGetParams as fk, PluginsRefreshParams as fl, NodePendingDrainResultSchema as fm, validateNodePairListParams as fn, validateWorktreesListParams as fo, QuestionResolveParamsSchema as fp, validateSessionMembersListParams as fr, WorkerErrorShape as fs, validateCronGetParams as ft, TerminalSessionInfo as fu, SystemAgentChatResult as fv, SkillsCuratorStatusParams as fw, USER_PREFS_VALUE_BYTES as fx, UpdateScheduleState as fy, validateAgentsWorkspaceGetParams as g, BoardWidgetSchema as gA, AgentsFilesGetResultSchema as gC, SessionsCatalogReadResult as gD, ConversationTurnParams as gE, ApprovalKindSchema as gM, UnknownAgentIdErrorDetails as gN, SessionSuggestionEvent as gO, AuditActivityInboundMessageV1 as gS, SkillsUploadBeginParams as gT, WorkerEnvironmentState as g_, validateTasksCancelParams as ga, TalkClientCreateResult as gb, WizardCancelParams as gc, StateVersionSchema as gd, SessionsDispatchResultSchema as gf, ScopeUpgradeResult as gg, GatewaySuspendStatusRunningResultSchema as gh, validateSkillsCuratorActionParams as gi, WORKER_PROTOCOL_MAX_INFERENCE_PAYLOAD_BYTES as gj, BoardMcpAppDescriptorSchema as gk, PluginsSearchParams as gl, NodePendingEnqueueResultSchema as gm, validateNodePendingDrainParams as gn, WorktreeBranchSchema as go, QuestionResolvedEventSchema as gp, validateSessionTypingParams as gr, WorkerHeartbeatRequestFrameSchema as gs, validateCronRunsParams as gt, TerminalUploadResult as gu, SystemAgentSetupActivateResult as gv, SkillsDetailParams as gw, UsersLinkEmailParams as gx, UpdateStatusResult as gy, validateAgentsUpdateParams as h, BoardWidgetResizeOpSchema as hA, AgentsFilesGetResult as hC, SessionsCatalogReadParamsSchema as hD, ConversationTurnCancelResultSchema as hE, ApprovalKind as hM, ProjectCloneFailureCause as hN, SessionSuggestionActionSchema as hO, AuditActivityEventV1Schema as hS, SkillsUpdateParamsSchema as hT, WorkerEnvironmentMetadataSchema as h_, validateTaskSuggestionsListParams as ha, TalkClientCreateParamsSchema as hb, WizardAnswerSchema as hc, StateVersion as hd, SessionsDispatchResult as hf, ScopeUpgradeRequestSchema as hg, GatewaySuspendStatusResultSchema as hh, validateSkillsBinsParams as hi, WORKER_INFERENCE_PROTOCOL_FEATURE as hj, BoardMcpAppDescriptor as hk, PluginsRefreshResultSchema as hl, NodePendingEnqueueResult as hm, validateNodePendingAckParams as hn, WorktreeBranch as ho, QuestionResolvedEvent as hp, validateSessionSuggestionsResolveParams as hr, WorkerHeartbeatRequestFrame as hs, validateCronRunParams as ht, TerminalUploadParamsSchema as hu, SystemAgentSetupActivateParamsSchema as hv, SkillsCuratorStatusResultSchema as hw, UserProfileSchema as hx, UpdateStatusParamsSchema as hy, MIN_PROBE_PROTOCOL_VERSION as i, BoardWidgetPluginContentSchema as iA, AgentsCreateParamsSchema as iC, SessionsCatalogContinueParams as iD, ConversationListParams as iE, ApprovalDecisionSchema as iM, validateTerminalUploadResult as iN, ProjectsRemoveParamsSchema as iO, AuditRunInspectResult as iS, SkillsSecurityVerdictsParams as iT, WorkerDesktopAppId as i_, validateTalkSessionAcknowledgeMarkParams as ia, ChannelsStopParams as ib, WorkerTranscriptCommitResult as ic, SYSTEM_PRESENCE_CLEAR_LAST_INPUT_TAG as id, SessionDiscussionOpenResultSchema as if, DeviceTokenRevokeParamsSchema as ig, GatewaySuspendReleaseRecoveryNeededResultSchema as ih, validateSessionsReclaimParams as ii, SkillsProposalHistoryScanParams as ij, BoardCommandEventSchema as ik, PluginsInstallParams as il, NodePairRejectParamsSchema as im, validateModelsProbeParams as in, validateWorkerHeartbeatParams as io, QuestionRequestParamsSchema as ip, validateSecretsStoreSetParams as ir, WorkerAdmissionFailureReason as is, validateConfigSchemaParams as it, TerminalListResult as iu, SystemAgentChatHistoryResult as iv, SkillsBinsParams as iw, TtsSpeakResult as ix, UpdateAvailable as iy, validateBoardGetParams as j, EventFrame as jA, AgentsUpdateResult as jC, MigrationsMemoryPlanResult as jD, GatewayClientIdSchema as jE, ExecApprovalPresentation as jM, buildClawHubTrustErrorDetails as jN, SessionSuggestionsResolveParams as jO, ArtifactsDownloadResultSchema as jS, ToolsCatalogResultSchema as jT, CronScratchGetResult as j_, validateUsersLinkEmailResult as ja, TalkConfigResultSchema as jb, WizardStepSchema as jc, SessionSharingEvent as jd, SecretsResolveResult as jf, ExecApprovalsNodeSetParamsSchema as jg, DesktopSource as jh, validateSkillsSkillCardParams as ji, WorkerInferenceOptionsSchema as jj, BoardTabUpdateOpSchema as jk, PluginsUiDescriptorsParamsSchema as jl, NodeSkillsUpdateParams as jm, validatePluginsUiDescriptorsParams as jn, WorktreesListParams as jo, WebPushTestParamsSchema as jp, validateSessionsCompanionAskParams as jr, WorkerLiveEventResponseFrameSchema as js, validateDevicePairSetupStatusParams as jt, TasksListResultSchema as ju, SystemAgentWizardCancelSchema as jv, SkillsProposalEvaluateResultSchema as jw, UsersPrefsSetResultSchema as jx, CommandsListParamsSchema as jy, validateBoardDataReadParams as k, ErrorShape as kA, AgentsUpdateParams as kC, MigrationsMemoryApplyResult as kD, CHAT_SEND_SESSION_KEY_MAX_LENGTH as kE, DeniedApprovalSnapshot as kM, ClawHubTrustErrorCodes as kN, SessionSuggestionsListResult as kO, ArtifactsDownloadParamsSchema as kS, ToolsCatalogParamsSchema as kT, CronRunsParams as k_, validateUpdateStatusResult as ka, TalkConfigParamsSchema as kb, WizardStatusResultSchema as kc, SessionSharingAction as kd, SecretsResolveParams as kf, ExecApprovalsNodeGetParamsSchema as kg, DesktopObserveResult as kh, validateSkillsSearchParams as ki, WorkerInferenceModelRefSchema as kj, BoardTabIdSchema as kk, PluginsSetEnabledResultSchema as kl, NodeSkillDescriptor as km, validatePluginsSessionActionResult as kn, WorktreesGcResult as ko, WebPushSubscribeParamsSchema as kp, validateSessionsCompactionListParams as kr, WorkerLiveEventRequestFrameSchema as ks, validateDevicePairRenameParams as kt, TasksListParamsSchema as ku, SystemAgentSetupVerifyResultSchema as kv, SkillsProposalEvaluateParamsSchema as kw, UsersPrefsSetParamsSchema as kx, CommandEntrySchema as ky, validateAgentsCreateParams as l, BoardWidgetPutContentSchema as lA, AgentsDeleteResult as lC, SessionsCatalogHostEventSchema as lD, ConversationSendParamsSchema as lE, ApprovalGetResult as lM, ErrorCodes as lN, ProjectsSearchRemoteResult as lO, ExecutionIdentityContextV1Schema as lS, SkillsSkillCardParamsSchema as lT, WorkerDesktopLaunchResultSchema as l_, validateTalkSessionSteerParams as la, TalkCatalogParamsSchema as lb, WORKER_PROTOCOL_MAX_IDENTIFIER_LENGTH as lc, SystemInfoResult as ld, SessionPlacementDiskSpaceSchema as lf, ScopeUpgradeApprovedSchema as lg, GatewaySuspendResumeResult as lh, validateSessionsSearchParams as li, SkillsProposalHistoryStatusParamsSchema as lj, BoardEventParams as lk, PluginsListParamsSchema as ll, NodePendingDrainParams as lm, validateNodeInvokeResultParams as ln, validateWorktreesBranchesParams as lo, QuestionRequestedEvent as lp, validateSessionDiscussionOpenResult as lr, WorkerConnectParams as ls, validateConversationTurnCancelParams as lt, TerminalOpenResultSchema as lu, SystemAgentChatParamsSchema as lv, SkillsCuratorActionParamsSchema as lw, WebLoginWaitParamsSchema as lx, UpdateHoldResultSchema as ly, validateAgentsListParams as m, BoardWidgetRemoveOpSchema as mA, AgentsFilesGetParamsSchema as mC, SessionsCatalogReadParams as mD, ConversationTurnCancelResult as mE, ApprovalHistoryResultSchema as mM, ProjectCloneErrorDetails as mN, SessionSuggestionAction as mO, AuditActivityEventV1 as mS, SkillsUpdateParams as mT, WorkerEnvironmentMetadata as m_, validateTaskSuggestionsDismissParams as ma, TalkClientCreateParams as mb, WizardAnswer as mc, SnapshotSchema as md, SessionsDispatchParamsSchema as mf, ScopeUpgradeRequest as mg, GatewaySuspendStatusResult as mh, validateSessionsViewerPresenceSetParams as mi, WORKER_INFERENCE_METHODS as mj, BoardLegacyEventParamsSchema as mk, PluginsRefreshResult as ml, NodePendingEnqueueParamsSchema as mm, validateNodePairRemoveParams as mn, validateWorktreesRestoreParams as mo, QuestionResolveResultSchema as mp, validateSessionSuggestionsListParams as mr, WorkerHeartbeatParamsSchema as ms, validateCronRemoveParams as mt, TerminalUploadParams as mu, SystemAgentSetupActivateParams as mv, SkillsCuratorStatusResult as mw, UserProfileAvatarMimeSchema as mx, UpdateStatusParams as my, MIN_CLIENT_PROTOCOL_VERSION as n, BoardWidgetMoveOpSchema as nA, AgentSummarySchema as nC, SessionsCatalogArchiveResult as nD, ConversationListItem as nE, ApprovalChannelReviewerSchema as nM, validateTerminalResizeParams as nN, ProjectsRegisterResultSchema as nO, AuditRunInspectParams as nS, SkillsSearchResult as nT, EnvironmentsStatusResult as n_, validateTalkConfigResult as na, ChannelsStatusResult as nb, WorkerTranscriptCommitResponseFrame as nc, TaskSuggestionsListResult as nd, SessionDiscussionOpenParamsSchema as nf, DevicePairSetupStatusResultSchema as ng, GatewaySuspendReleaseReceipt as nh, validateSessionsPluginPatchParams as ni, UiSidebarCommandSchema as nj, BoardCommand as nk, PluginSearchPackageSchema as nl, NodePairListParamsSchema as nm, validateModelsAuthStatusParams as nn, validateWorkerDesktopObserveParams as no, QuestionRecordSchema as np, validateSecretsStoreListResult as nr, WORKER_TRANSCRIPT_MAX_CONTENT_PARTS as ns, validateConfigSchemaLookupParams as nt, TerminalInputParams as nu, SystemAgentChatHistoryParams as nv, SkillProposalLifecycleEvent as nw, TtsSpeakParams as nx, ConfigSetParams as ny, validateAgentIdentityParams as o, BoardWidgetPluginPropsSchema as oA, AgentsCreateResultSchema as oC, SessionsCatalogContinueResult as oD, ConversationListResult as oE, ApprovalExpiredReasonSchema as oM, ValidationError as oN, ProjectsRemoveResultSchema as oO, DecisionReceiptV1 as oS, SkillsSecurityVerdictsResult as oT, WorkerDesktopLaunchParams as o_, validateTalkSessionCancelOutputParams as oa, TalkAgentControlResult as ob, WorkerTranscriptMessage as oc, validateSystemEventParams as od, SessionDiscussionStateSchema as of, DeviceTokenRotateParamsSchema as og, GatewaySuspendReleaseStatusParamsSchema as oh, validateSessionsResetParams as oi, SkillsProposalHistoryScanResult as oj, BoardCronActionParamsSchema as ok, PluginsInstallResult as ol, NodePairRemoveParamsSchema as om, validateNodeEventParams as on, validateWorkerSessionsSendParams as oo, QuestionRequestQuestionSchema as op, validateSessionDiscussionInfoParams as or, WorkerAdmissionHandshakeSchema as os, validateConnectParams as ot, TerminalOpenParams as ou, SystemAgentChatHistoryTurn as ov, SkillsBinsResult as ow, WebLoginStartParams as ox, UpdateHoldParams as oy, validateAgentsFilesSetParams as p, BoardWidgetPutResultSchema as pA, AgentsFilesGetParams as pC, SessionsCatalogListResultSchema as pD, ConversationTurnCancelParamsSchema as pE, ApprovalHistoryResult as pM, MissingScopeErrorDetails as pN, SessionSuggestion as pO, AuditActivityAgentRunV1Schema as pS, SkillsStatusParamsSchema as pT, WorkerDesktopObserveResultSchema as p_, validateTaskSuggestionsCreateParams as pa, TalkClientCloseParamsSchema as pb, WorkerProtocolCloseReasonSchema as pc, Snapshot as pd, SessionsDispatchParams as pf, ScopeUpgradeRejectedSchema as pg, GatewaySuspendStatusReadyResultSchema as ph, validateSessionsUsageParams as pi, WORKER_INFERENCE_MAX_OUTPUT_TOKENS as pj, BoardGetParamsSchema as pk, PluginsRefreshParamsSchema as pl, NodePendingEnqueueParams as pm, validateNodePairRejectParams as pn, validateWorktreesRemoveParams as po, QuestionResolveResult as pp, validateSessionSuggestionsAddParams as pr, WorkerHeartbeatParams as ps, validateCronListParams as pt, TerminalSessionInfoSchema as pu, SystemAgentChatResultSchema as pv, SkillsCuratorStatusParamsSchema as pw, UserProfile as px, UpdateScheduleStateSchema as py, validateChatInjectParams as q, UiCommand as qA, ModelsListResultSchema as qC, ProjectsAddResult as qD, SessionCatalogPullRequestSummary as qE, SystemAgentApprovalPresentationSchema as qM, BOARD_DATA_BINDING_ID_MAX_LENGTH as qO, AgentsWorkspaceGetResultSchema as qS, AgentEvent as qT, CronRunParamsSchema as q_, validateWebPushVapidPublicKeyParams as qa, TalkSessionOkResultSchema as qb, PortalSummarySchema as qc, SessionsViewerPresenceSetResult as qd, QuestionGetResult as qf, EnvironmentsDestroyParamsSchema as qg, DevicePairSetupCodeResult as qh, validateTalkClientCloseParams as qi, validateApprovalHistoryResult as qj, BoardWidgetGeneratedIdentitySchema as qk, TerminalAttachResultSchema as ql, GatewaySuspendPrepareParams as qm, validateQuestionResolveParams as qn, WORKER_PROTOCOL_MAX_FEATURE_LENGTH as qo, NodeInvokeProgressParamsSchema as qp, validateSessionsGroupsMutationResult as qr, WorkerSessionsSpawnResponseFrameSchema as qs, validateFsListDirParams as qt, TaskSuggestionsCreateParamsSchema as qu, ConfigPatchParamsSchema as qv, SkillsProposalReviseParamsSchema as qw, AuditListParamsSchema as qx, ChannelsPairingListResult as qy, MIN_NODE_PROTOCOL_VERSION as r, BoardWidgetNameSchema as rA, AgentsCreateParams as rC, SessionsCatalogArchiveResultSchema as rD, ConversationListItemSchema as rE, ApprovalDecision as rM, validateTerminalUploadParams as rN, ProjectsRemoveParams as rO, AuditRunInspectParamsSchema as rS, SkillsSearchResultSchema as rT, EnvironmentsStatusResultSchema as r_, validateTalkModeParams as ra, ChannelsStatusResultSchema as rb, WorkerTranscriptCommitResponseFrameSchema as rc, TaskSuggestionsListResultSchema as rd, SessionDiscussionOpenResult as rf, DeviceTokenRevokeParams as rg, GatewaySuspendReleaseReceiptSchema as rh, validateSessionsPreviewParams as ri, UiSplitCommandSchema as rj, BoardCommandEvent as rk, PluginSearchResultEntrySchema as rl, NodePairRejectParams as rm, validateModelsListParams as rn, validateWorkerDesktopObserveResult as ro, QuestionRequestParams as rp, validateSecretsStoreMutationResult as rr, WORKER_TRANSCRIPT_MAX_JSON_DEPTH as rs, validateConfigSchemaLookupResult as rt, TerminalInputParamsSchema as ru, SystemAgentChatHistoryParamsSchema as rv, SkillProposalLifecycleEventSchema as rw, TtsSpeakParamsSchema as rx, ConfigSetParamsSchema as ry, validateAgentParams as s, BoardWidgetPresentationSchema as sA, AgentsDeleteParams as sC, SessionsCatalogContinueResultSchema as sD, ConversationListResultSchema as sE, ApprovalGetParams as sM, formatValidationErrors as sN, ProjectsSearchRemoteParams as sO, DecisionReceiptV1Schema as sS, SkillsSecurityVerdictsResultSchema as sT, WorkerDesktopLaunchParamsSchema as s_, validateTalkSessionCloseParams as sa, TalkAgentControlResultSchema as sb, WorkerTranscriptMessageSchema as sc, SystemInfoParams as sd, SessionPlacement as sf, DeviceTokenRotateResult as sg, GatewaySuspendResumeParams as sh, validateSessionsResolveParams as si, SkillsProposalHistoryScanResultSchema as sj, BoardDataReadParams as sk, PluginsInstallResultSchema as sl, NodePendingAckParams as sm, validateNodeInvokeParams as sn, validateWorkerSessionsSpawnParams as so, QuestionRequestResult as sp, validateSessionDiscussionInfoResult as sr, WorkerAdmissionResponseFrame as ss, validateConversationListParams as st, TerminalOpenParamsSchema as su, SystemAgentChatHistoryTurnSchema as sv, SkillsBinsResultSchema as sw, WebLoginStartParamsSchema as sx, UpdateHoldParamsSchema as sy, SessionsPatchResult as t, BoardWidgetMcpAppPutContentSchema as tA, AgentSummary as tC, SessionsCatalogArchiveParamsSchema as tD, AgentWaitParamsSchema as tE, ApprovalChannelReviewer as tM, validateTerminalOpenParams as tN, ProjectsRegisterResult as tO, AuditRunIdentityV1Schema as tS, SkillsSearchParamsSchema as tT, EnvironmentsStatusParamsSchema as t_, validateTalkConfigParams as ta, ChannelsStatusParamsSchema as tb, WorkerTranscriptCommitRequestFrameSchema as tc, TaskSuggestionsListParamsSchema as td, SessionDiscussionOpenParams as tf, DevicePairSetupStatusResult as tg, GatewaySuspendReleaseCompletedReceiptSchema as th, validateSessionsPatchParams as ti, UiPanelCommandSchema as tj, BoardChatDockSchema as tk, PluginJsonValueSchema as tl, NodePairListParams as tm, validateModelsAuthLogoutParams as tn, validateWorkerDesktopLaunchResult as to, QuestionRecord as tp, validateSecretsStoreListParams as tr, WORKER_TRANSCRIPT_MAX_BATCH_MESSAGES as ts, validateConfigPatchParams as tt, TerminalExitEventSchema as tu, CronUpdateParamsSchema as tv, SkillProposalEvaluationSchema as tw, TalkSpeakResultSchema as tx, ConfigSchemaResponseSchema as ty, validateAgentsDeleteParams as u, BoardWidgetPutParams as uA, AgentsDeleteResultSchema as uC, SessionsCatalogListParams as uD, ConversationSendResult as uE, ApprovalGetResultSchema as uM, GatewayErrorDetailCodes as uN, ProjectsSearchRemoteResultSchema as uO, PrincipalRefV1 as uS, SkillsSkillCardResult as uT, WorkerDesktopObserveParams as u_, validateTalkSessionSubmitToolResultParams as ua, TalkCatalogResult as ub, WORKER_PROTOCOL_MAX_PAYLOAD_BYTES as uc, SystemInfoResultSchema as ud, SessionPlacementProtocolSchemas as uf, ScopeUpgradeExpiredSchema as ug, GatewaySuspendResumeResultSchema as uh, validateSessionsSendParams as ui, validateSkillsProposalHistoryScanParams as uj, BoardEventParamsSchema as uk, PluginsListResult as ul, NodePendingDrainParamsSchema as um, validateNodeListParams as un, validateWorktreesCreateParams as uo, QuestionRequestedEventSchema as up, validateSessionMemberAddParams as ur, WorkerConnectRequestFrame as us, validateConversationTurnParams as ut, TerminalResizeParams as uu, SystemAgentChatQuestion as uv, SkillsCuratorActionResult as uw, USER_PREFS_ENTRY_LIMIT as ux, UpdateRunParams as uy, validateApprovalGetParams as v, McpAppViewExpiredErrorDetailsSchema as vA, AgentsFilesListParamsSchema as vC, SessionsCatalogStartTerminalParams as vD, ConversationTurnReply as vE, ApprovalPresentationSchema as vM, WizardNotFoundErrorDetails as vN, SessionSuggestionResolution as vO, AuditActivityListParams as vS, SkillsUploadChunkParams as vT, WorkerTunnelStatus as v_, validateTasksListParams as va, TalkClientMutationResult as vb, WizardNextParams as vc, SessionMemberAddParams as vd, SessionsReclaimParamsSchema as vf, ScopeUpgradeWait as vg, GatewaySuspendTaskBlockerSchema as vh, validateSkillsDetailParams as vi, WorkerInferenceCancelRequestFrame as vj, BoardOpSchema as vk, PluginsSearchResult as vl, NodePluginToolDescriptorSchema as vm, validateNodePluginToolsUpdateParams as vn, WorktreeRecordSchema as vo, QuestionStatus as vp, validateSessionsAbortParams as vr, WorkerHeartbeatResponseFrameSchema as vs, validateCronScratchSetParams as vt, TaskSummary as vu, SystemAgentSetupAuthStartParams as vv, SkillsDetailResult as vw, UsersLinkEmailResult as vx, COMMAND_ALIAS_MAX_ITEMS as vy, validateArtifactsListParams as w, buildMissingScopeErrorDetails as wA, AgentsFilesSetResultSchema as wC, MAX_MEMORY_MIGRATION_ITEMS as wD, PollParams as wE, ApprovalSnapshotSchema as wM, SystemAgentSessionInvalidatedErrorDetails as wN, SessionSuggestionsAddParamsSchema as wO, AuditActivityToolActionV1 as wS, ToolCatalogGroup as wT, CronJob as w_, validateUiCommandParams as wa, TalkClientToolCallResult as wb, WizardStartResult as wc, SessionMemberSchema as wd, SecretStoreEntrySchema as wf, ExecApprovalResolveParams as wg, FsListDirResultSchema as wh, validateSkillsProposalInspectParams as wi, WorkerInferenceErrorReason as wj, BoardSnapshot as wk, PluginsSessionActionResultSchema as wl, NodePresenceAlivePayloadSchema as wm, validatePluginsInstallParams as wn, WorktreesBranchesResultSchema as wo, PushTestParams as wp, validateSessionsCatalogReadParams as wr, WorkerLiveEventErrorShape as ws, validateDesktopObserveResult as wt, TasksGetParams as wu, SystemAgentSetupDetectResult as wv, SkillsProposalApplyResult as ww, UsersPrefsGetParams as wx, COMMAND_CHOICE_VALUE_MAX_LENGTH as wy, validateApprovalResolveParams as x, UnknownAgentIdErrorDetailsSchema as xA, AgentsFilesSetParams as xC, SessionsCatalogStartTerminalResultSchema as xD, ConversationTurnResultSchema as xE, ApprovalResolveResult as xM, readMissingScopeErrorDetails as xN, SessionSuggestionState as xO, AuditActivityListResultSchema as xS, SkillsUploadCommitParamsSchema as xT, CronAddResult as x_, validateToolsEffectiveParams as xa, TalkClientSteerParamsSchema as xb, WizardNextResultSchema as xc, SessionMemberMutationResultSchema as xd, SessionPlacementState as xf, ExecApprovalGetParamsSchema as xg, FsListDirParams as xh, validateSkillsProposalCreateParams as xi, WorkerInferenceCancelResponseFrameSchema as xj, BoardPromptAuthorizeParamsSchema as xk, PluginsSessionActionParams as xl, NodePresenceActivityPayload as xm, validateNodeSkillsUpdateParams as xn, WorktreesBranchesParams as xo, QuestionWaitAnswerParamsSchema as xp, validateSessionsCatalogArchiveParams as xr, WorkerLiveEvent as xs, validateDecisionReceiptV1 as xt, TasksCancelParamsSchema as xu, SystemAgentSetupAuthStartResultSchema as xv, SkillsInstallParamsSchema as xw, UsersListParamsSchema as xx, COMMAND_ARG_DESCRIPTION_MAX_LENGTH as xy, validateApprovalHistoryParams as y, MissingScopeErrorDetailsSchema as yA, AgentsFilesListResult as yC, SessionsCatalogStartTerminalParamsSchema as yD, ConversationTurnReplySchema as yE, ApprovalResolveParams as yM, isMcpAppViewExpiredError as yN, SessionSuggestionResolutionSchema as yO, AuditActivityListParamsSchema as yS, SkillsUploadChunkParamsSchema as yT, WorkerTunnelStatusSchema as y_, validateTasksRecoveryParams as ya, TalkClientMutationResultSchema as yb, WizardNextParamsSchema as yc, SessionMemberAddParamsSchema as yd, SessionsReclaimResult as yf, ScopeUpgradeWaitSchema as yg, FsDirEntry as yh, validateSkillsInstallParams as yi, WorkerInferenceCancelRequestFrameSchema as yj, BoardPluginActionParamsSchema as yk, PluginsSearchResultSchema as yl, NodePluginToolsUpdateParams as ym, validateNodePresenceActivityPayload as yn, WorktreeRepositoryStatus as yo, QuestionStatusSchema as yp, validateSessionsBranchesListParams as yr, WorkerHeartbeatResult as ys, validateCronStatusParams as yt, TaskSummarySchema as yu, SystemAgentSetupAuthStartParamsSchema as yv, SkillsDetailResultSchema as yw, UsersLinkEmailResultSchema as yx, COMMAND_ARGS_MAX_ITEMS as yy, validateChannelsPairingApproveParams as z, RequestFrameSchema as zA, ModelChoiceSchema as zC, ProjectRecentProjectSchema as zD, SessionCatalogCapabilities as zE, PluginApprovalPresentationSchema as zM, SessionTypingResult as zO, ArtifactsListResultSchema as zS, ToolsEffectiveParamsSchema as zT, CronDeliverySchema as z_, validateUsersSetDisplayNameParams as za, TalkSessionCancelOutputParamsSchema as zb, PortalListParamsSchema as zc, SESSION_VISIBILITY_VALUES as zd, SecretsStoreMutationResultSchema as zf, EnvironmentStatusSchema as zg, DevicePairRemoveParams as zh, validateSystemAgentSetupActivateParams as zi, WorkerInferenceTerminalOutcome as zj, BoardWidgetAppViewParamsSchema as zk, PluginApprovalRequestParamsSchema as zl, GatewaySuspendBlockerSchema as zm, validateProjectsListParams as zn, WorktreesRestoreParams as zo, NodeEventParamsSchema as zp, validateSessionsFilesGetParams as zr, WorkerSessionToolResultSchema as zs, validateExecApprovalRequestParams as zt, TaskSuggestionResolution as zu, SystemChangesListParamsSchema as zv, SkillsProposalInspectResultSchema as zw, UsersSetAvatarResultSchema as zx, ChannelsPairingApproveResult as zy };