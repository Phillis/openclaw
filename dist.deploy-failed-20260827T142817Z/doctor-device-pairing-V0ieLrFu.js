...
import { i as loadDeviceAuthTokens } from "./device-auth-store-B8KH3MFv.js";
...
import { d as listDevicePairing, u as listApprovedPairedDeviceRoles, w as summarizeDeviceTokens } from "./device-pairing-CFVs8foo.js";
...
async function collectLegacyPairingStoreIssues(cfg) {
	...
	const { listLegacyDevicePairingStoreFiles } = await import("./device-pairing-migration-DQoXr5Dh.js");
