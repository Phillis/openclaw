...
import { i as loadSystemAgentOverview, n as formatSystemAgentOverview } from "../overview-ClhxVBNB.js";
import { a as resolveSystemAgentVerifiedInferenceRoute } from "../verified-inference-G4rRrE4u.js";
import { a as parseSystemAgentOperation, i as isPersistentSystemAgentOperation, t as executeSystemAgentOperation } from "../operations-CCgw0hU4.js";
...
import { n as resolveSystemAgentOperation } from "../dialogue-DqAPDbkR.js";
...
async function runSystemAgent(opts, runtime = defaultRuntime) {
	...
	const runInteractiveTui = boundOpts.runInteractiveTui ?? (await import("../tui-backend-vfo5zBmT.js")).runSystemAgentTui;
	boundOpts.onReady?.();
