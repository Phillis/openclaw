...
import { u as resolveAgentEntry } from "../agent-scope-config-BdXMWufB.js";
import { t as createCorePluginStateSyncKeyedStore } from "../plugin-state-store-3qJxZb8E.js";
import { H as resolveExecModePolicy } from "../exec-approvals-EA-WQccl.js";
import { a as parseSystemAgentOperation, i as isPersistentSystemAgentOperation, r as formatSystemAgentPersistentPlan, t as executeSystemAgentOperation } from "../operations-CCgw0hU4.js";
import { t as classifySystemAgentApprovalText } from "../operator-approval-DQUXzKQy.js";
...
function parsePendingOperation(value) {
	...
	switch (operation.kind) {
		...
		case "plugin-install":
			...
			break;
		case "create-agent":
			if (!hasExactKeys(operation, ["kind", "agentId"], ["workspace", "model"]) || !hasNonEmptyString(operation.agentId) || !hasOptionalString(operation, "workspace") || !hasOptionalString(operation, "model")) return null;
			break;
		case "gateway-start":
		case "gateway-stop":
