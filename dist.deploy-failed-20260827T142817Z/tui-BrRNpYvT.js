...
import { s as registerUncaughtExceptionHandler } from "./unhandled-rejections-ELdqUxS7.js";
import { t as modelKey } from "./model-key-CMdQNkZf.js";
import { h as resolveSessionAgentId, l as resolveAgentIdByWorkspacePath } from "./agent-scope-BizOtGGz.js";
import { n as normalizeAgentId } from "./agent-id-Db0rqw_J.js";
import { b as tryResolveLegacyCompatibilityAgentId, p as resolveDefaultAgentId, y as tryResolveDefaultAgentId } from "./agent-scope-config-BdXMWufB.js";
...
import { o as setConsoleSubsystemFilter } from "./console-Dqa67THW.js";
...
import { r as listThinkingLevelLabels, t as formatThinkingLevels } from "./thinking-KBBrAmGh.js";
...
import { h as isAuthErrorMessage, t as classifyFailoverReason } from "./classify-DbL6Dp79.js";
import { n as shouldForwardModelCommandToServer } from "./commands-registry.data-DFNdfIjj.js";
import { n as listChatCommands, r as listChatCommandsForConfig } from "./commands-registry-list-STpLcy8l.js";
...
import "./usage-format-CbM1Z9YQ.js";
import "./embedded-agent-helpers-djcKKwhg.js";
import { o as resolveToolDisplay, t as formatToolDetail } from "./tool-display-DNnLx8TW.js";
...
async function withEmbeddedTuiStateLock(run, deps = {}) {
	const { acquireEmbeddedStateLock, createEmbeddedStateSignalBridge } = await import("./embedded-state-lock-y2IDPdHi.js");
...
async function runTuiUnlocked(opts) {
	...
	if (opts.backend) client = opts.backend;
		...
		const { EmbeddedTuiBackend } = await import("./embedded-backend-CwnrcoN1.js");
		client = new EmbeddedTuiBackend();
	} else {
		const { GatewayChatClient } = await import("./gateway-chat-Dyb6ajfi.js");
