...
import { r as getRuntimeConfig, v as registerConfigWriteListener } from "./io-D1h6pxaD.js";
...
import { yt as applySessionPatchProjection } from "./session-accessor-CVnxp3UM.js";
import "./message-channel-T4W5YOto.js";
import { G as setEmbeddedPluginApprovalBroker, U as EmbeddedPluginApprovalBroker, W as clearEmbeddedPluginApprovalBroker, q as setEmbeddedMode } from "./agent-tools.before-tool-call-aNXucund.js";
...
import { u as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-BNByaYVk.js";
import { n as resolveThinkingDefault } from "./model-thinking-default-CJJQK-S8.js";
import { t as buildAllowedModelSet } from "./model-selection-BhpnS-Rv.js";
...
import { i as resolveTextCommand } from "./commands-registry-normalize-BuLdwnA4.js";
import { m as resolveActiveEmbeddedRunSessionId } from "./run-state-BxqT1sw2.js";
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-DdjJNEQM.js";
...
import { t as getSessionDefaults } from "./session-utils-model-B0LBQVk2.js";
import { E as loadGatewaySessionEntryReadOnly, N as resolveGatewaySessionStoreTargetWithStore, O as resolveCanonicalGatewaySessionStoreKey, T as loadGatewaySessionEntry, w as listAgentsForGateway } from "./session-utils-row-CriEgq90.js";
import { t as ensureContextWindowCacheLoaded } from "./context-BCVmjNPU.js";
import { t as resolveQueueSettingsCore } from "./settings-D1Q5_Hy4.js";
import { A as waitForQueueDebounce, D as previewQueueSummaryPrompt, S as buildCollectPrompt, b as applyQueueDropPolicy } from "./state-BobUNKkR.js";
import { i as buildGatewaySessionInfo, r as listSessionsFromStoreAsync } from "./session-utils-list-Bh24bUSo.js";
import "./session-utils-rhyq5EVD.js";
import { i as parseGoalCommand, t as executeSessionGoalCommand } from "./commands-goal-CogDHQTf.js";
...
import { a as isChatStopCommandText } from "./chat-abort-BBAKYOB6.js";
...
import { c as performGatewaySessionReset } from "./session-reset-service-CBpWb4MC.js";
...
import { t as loadGatewayModelCatalog } from "./server-model-catalog-BGvXttki.js";
import { t as createDefaultDeps } from "./deps-24ucZA7X.js";
import { u as resolveEffectiveChatHistoryMaxChars } from "./chat-display-projection-B0E44yqM.js";
import { a as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES, i as readChatHistoryPage, o as enforceChatHistoryFinalBudget, r as enrichChatHistoryCompactionMarkers, s as replaceOversizedChatHistoryMessages } from "./chat-DK-lgjZl.js";
import { o as isAgentLifecycleYieldedWaiting } from "./session-lifecycle-state-zNqFUBsn.js";
import { n as createGatewaySession } from "./session-create-service-MEWuvilG.js";
import { t as projectSessionsPatchEntry } from "./sessions-patch-vkcbbb-Z.js";
import { t as resolveLocalRunShutdownGraceMs } from "./local-run-shutdown-BQKagb2W.js";
import { u as formatTuiErrorMessage } from "./tui-formatters-BQGaJ79N.js";
...
var EmbeddedTuiBackend = class {
	...
	start() {
		...
		this.ready = (async () => {
			const { runSessionStartupMigration } = await import("./startup-migration-BuXw4MyF.js");
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw--uAVe2Or.js");
