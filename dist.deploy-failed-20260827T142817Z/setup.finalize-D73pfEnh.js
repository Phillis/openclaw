...
import { x as isSystemdUserServiceAvailable } from "./systemd-DPnIQILH.js";
...
import { a as resolveGatewayService, n as formatGatewayServiceStartRepairIssues, o as startGatewayService, t as describeGatewayServiceRestart } from "./service-CJsmassN.js";
import { x as runTui } from "./tui-BrRNpYvT.js";
...
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-BV2vwVv3.js";
import { f as probeGatewayReachable, h as waitForGatewayReachable, r as buildOnboardingControlUiUrl } from "./onboard-helpers-DQoIxFmS.js";
...
import { i as hasAuthProfileForProvider } from "./model-config.helpers-C11w7_Lb.js";
import { r as listConfiguredWebSearchProviders } from "./runtime-CPtjiOKD.js";
import { a as installCompletion, i as formatCompletionReloadCommand, l as resolveCompletionProfileHint } from "./completion-runtime-BnLiFzei.js";
...
import { i as waitForControlUiDocument, r as resolveControlUiHandoffTarget } from "./control-ui-handoff-DqoZSw57.js";
...
async function startSessionGatewayForOnboarding(params) {
	...
	try {
		const { startGatewayServer } = await import("./server-DDnrSHFR.js");
...
const loadSearchSetupModule = createLazyRuntimeModule(() => import("./search-setup-9ikdPtfr.js"));
...
async function finalizeSetupWizard(options) {
	...
	try {
		...
		const [{ resolveDefaultModelAuthStatus, resolveDefaultModelCatalogFacts }, { loadPreparedModelCatalogSnapshot }] = await Promise.all([import("./auth-choice-V07-KoVh.js"), import("./prepared-model-catalog-DmTX1q65.js")]);
