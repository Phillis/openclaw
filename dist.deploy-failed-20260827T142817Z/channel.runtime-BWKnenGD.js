...
import "./accounts-C4DQsmL2.js";
import "./runtime-api-DAR13vmn.js";
import { r as getMe, t as ZaloApiError } from "./api-C4BLvBDG.js";
import { t as resolveZaloProxyFetch } from "./proxy-DDXQ-2zE.js";
import { t as sendMessageZalo } from "./send-CKfU35k0.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-pQPo0ktB.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-zfLmiGWd.js");
