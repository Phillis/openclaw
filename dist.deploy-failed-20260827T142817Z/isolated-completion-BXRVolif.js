...
import { x as withPluginRuntimeGenerationScope } from "./hook-runner-global-BNCkTxOs.js";
import { r as ensureAuthProfileStore } from "./store-DOJuehrg.js";
import { i as resolveCliBackendConfig, o as resolveCliRuntimeCanonicalProvider } from "./cli-backends-B_2M8BON.js";
...
import { i as preparedAgentRuntimeProfileAttemptHasCandidate, n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-D74a7V0k.js";
import { i as resolveModelWithRegistry } from "./model-BoOus0uf.js";
import { n as prepareSimpleCompletionModel } from "./simple-completion-runtime-A9GJIIpB.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-CC5f_clM.js";
import { r as scopeAuthProfileStoreToPreparedPlan } from "./resolve-auth-CXzQN75G.js";
...
async function resolveHarness(runtime) {
	if (runtime === "openclaw") {
		const { createOpenClawAgentHarness } = await import("./builtin-openclaw-CWoDO2YK.js");
