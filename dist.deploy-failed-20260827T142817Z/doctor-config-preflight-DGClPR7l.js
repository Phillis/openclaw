...
import { _ as recoverConfigFromLastKnownGood, a as preserveConfigSnapshotAsClobbered, f as readConfigFileSnapshotWithPluginMetadata, g as recoverConfigFromJsonRootSuffix, l as readConfigFileSnapshot, tt as parseConfigJson5 } from "./io-D1h6pxaD.js";
...
import { n as cloneEnvWithPlatformSemantics } from "./config-env-vars-BITg3hPR.js";
...
import { a as formatPluginVerificationDiagnostic, c as setActiveDegradedPlugins, t as buildDegradedPluginsFromVerificationFailures } from "./runtime-degraded-state-BGAUzsaR.js";
import { t as note } from "./note-D7f3pYFE.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-DoeFLIm_.js";
import { t as migrateLegacyConfig } from "./legacy-config-migrate-CPsRDmLT.js";
import { t as addDoctorLegacyIssues } from "./legacy-config-issues-ALk0zKqs.js";
import { n as createDoctorPluginMetadataSnapshotScope, t as completeDoctorPluginMetadataSnapshot } from "./plugin-metadata-snapshot-scope-ppkK70NK.js";
...
const loadInstalledPluginIndexStore = createLazyRuntimeModule(() => import("./installed-plugin-index-store-eC71YFDh.js"));
...
async function planStartupPluginVerification(params) {
	const { planStartupPluginConvergence } = await measureDoctorConfigPreflightStep("plugin-plan-import", () => import("./startup-plugin-convergence-plan-BIvM2bpK.js"), params.measure);
...
async function runStartupUpgradeConvergence(params) {
	...
	const { runPostCorePluginConvergence } = await measureDoctorConfigPreflightStep("plugin-convergence-import", () => import("./post-core-plugin-convergence-Ca8LCQtU.js"), params.measure);
...
async function refreshStartupPluginQuarantine(params) {
	...
	const { runActivePluginPayloadSmokeCheck } = await measureDoctorConfigPreflightStep("plugin-payload-verification-import", () => import("./active-plugin-payload-validation-DBy-jPAq.js"), params.measure);
...
const loadDoctorStateMigrations = createLazyRuntimeModule(() => import("./doctor-state-migrations-D_nuZZMd.js"));
const loadLegacyCronRepair = createLazyRuntimeModule(() => import("./legacy-repair-DPfsRvf1.js"));
...
async function runDoctorConfigPreflight(options = {}) {
	...
	let migrationCheckpoint = gatewayStartupCheckpointRequired || options.requireStateMigrationCheckpoint === true ? await measurePreflightStep("startup-checkpoint-import", () => import("./startup-migration-checkpoint-DXCPYpMC.js")) : void 0;
	let stateMigrations;
	...
	try {
		if (migrationCheckpoint && !skipPristineStartupStateMigrations) {
			const { planPristineStartupStateMigrations } = await measurePreflightStep("pristine-state-plan-import", () => import("./pristine-startup-state-daBs7Y3V.js"));
