...
import { $ as AUTO_MANAGED_CONFIG_META_PATHS, I as collectUnsupportedSecretRefPolicyIssues, M as validateConfigObjectRawWithPlugins, l as readConfigFileSnapshot } from "./io-D1h6pxaD.js";
...
import { a as isPluginIntegrationSecretProviderConfig, n as resolveSecretRefValue, s as resolveSecretProviderIntegrationConfig } from "./resolve-D0oi7G5Z.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-query-DdLmxb5J.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CX3Pu7By.js";
...
async function createRuntimeModelRefResolver() {
	const [agentScope, modelSelection] = await Promise.all([import("./agent-scope-B7ocz6pI.js"), import("./model-selection-CACl5c-f.js")]);
	const preparedByAgent = /* @__PURE__ */ new Map();
	let modelModules;
	const loadModelModules = () => modelModules ??= Promise.all([import("./model-DtFmxdxN.js"), import("./prepared-model-catalog-DmTX1q65.js")]);
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", collectOption, []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-BUU5dxJd.js");
