...
import { c as normalizeOptionalLowercaseString, l as normalizeOptionalString, o as normalizeLowercaseStringOrEmpty, t as hasNonEmptyString } from "./string-coerce-CIXf7egm.js";
...
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./permissions-DHG-s8_A.js";
import { f as resolveConfigPath, w as resolveStateDir } from "./paths-CqeDjSA4.js";
import { t as formatCliCommand } from "./command-format-Dr_cCOb_.js";
import "./agent-scope-BizOtGGz.js";
import { n as hasAgentRosterProperty, r as listAgentEntries, y as tryResolveDefaultAgentId } from "./agent-scope-config-BdXMWufB.js";
...
import { c as resolvePluginControlPlaneWorkspace } from "./plugin-registry-snapshot-CiUpn9fa.js";
import { o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-B5GpYcAk.js";
...
import { H as resolveExecModePolicy, K as loadExecApprovals } from "./exec-approvals-EA-WQccl.js";
import { u as isInterpreterLikeAllowlistPattern } from "./risks-CsMxFHRL.js";
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-C3dsDuHN.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-F-bJ388b.js";
import { t as resolveExecDefaults } from "./exec-defaults-BaiESr_l.js";
import { r as materializeGatewayAuthSecretRefs, t as canMaterializeGatewayAuthSecretRefsWithoutExec } from "./auth-config-utils-CR-W-aWE.js";
import { n as normalizeConfiguredTrustedSafeBinDirs, t as normalizeConfiguredSafeBins } from "./exec-safe-bin-config-DXKgjJHQ.js";
import { o as readControlUiDeviceAuthMigrationState } from "./control-ui-device-auth-migration-DnKtXL1d.js";
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-Bv2r7TNj.js";
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-Dk0pnFUX.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-rvinAW4j.js";
import { t as collectExecFilesystemPolicyDriftHits } from "./exec-filesystem-policy-CNVOgWoo.js";
...
const loadReadOnlyChannelPlugins = createLazyRuntimeModule(() => import("./read-only-Cdsva2o0.js"));
...
const loadPluginMetadataRegistryLoaderModule = createLazyRuntimeModule(() => import("./metadata-registry-loader-DwuTSqxj.js"));
const loadPluginAutoEnableModule = createLazyRuntimeModule(() => import("./plugin-auto-enable-CEdeTO0T.js"));
const loadChannelPluginIdsModule = createLazyRuntimeModule(() => import("./channel-plugin-ids-Bnmf6jAV.js"));
const loadPluginRuntimeModule = createLazyRuntimeModule(() => import("./runtime-lbl6cKvn.js"));
const loadGatewayProbeDeps = createLazyRuntimeModule(() => Promise.all([
	import("./call-n89JPEIA.js"),
	import("./probe-auth-DhORi-rs.js"),
	import("./probe-HPXjS9_s.js")
...
function collectAgentRosterFindings(cfg) {
	...
	if (defaultCount === expectedDefaultCount) return [];
	return [{
		checkId: "config.agent_roster.invalid_default_count",
		severity: "warn",
		title: "Agent roster has an invalid default selection",
		detail: expectedDefaultCount === 0 ? `Expected no agents.entries default=true entries with agents.ownership=explicit, found ${defaultCount}.` : `Expected exactly one agents.entries default=true entry, found ${defaultCount}.`,
