import { m as mergeRuntimeExternalProfileReferences } from "../persisted-BaBq9UBI.js";
import { g as replaceRuntimeAuthProfileStoreSnapshots } from "../runtime-snapshots-0_SaNWbX.js";
import { x as withPluginRuntimeGenerationScope } from "../hook-runner-global-BNCkTxOs.js";
import { n as overlayExternalAuthProfiles } from "../external-auth-BI_6Rz-P.js";
import { r as listExternalCliSyncProviderIds } from "../external-cli-sync-nInVHMn1.js";
import { m as preserveResolvedSecretBackedCredentials, p as loadAuthProfileStoreWithoutExternalProfiles } from "../store-DOJuehrg.js";
import { f as resolveAmbientAgentCredentialsForDiscovery, m as resolveUsableAgentCredentialModes, p as resolveAgentCredentialMapFromStore } from "../prepared-model-runtime.facts-Bz0xgyUJ.js";
import { gt as AuthStorage } from "../sessions-CfDirsu7.js";
import { r as fingerprintPreparedModelCatalogGeneration } from "../prepared-model-catalog-worker-1IbOK6Qx.js";
...
async function prepareWorkerGeneration(value) {
	const { prepareWorkspaceBuildGroup } = await import("../prepared-model-runtime.facts-BesNZTD5.js");
...
async function runPreparedModelCatalogWorkerRequest(value, request, preparedGeneration = prepareWorkerGeneration(value)) {
	try {
		...
		const { prepareAgentCatalogSource, prepareFullCatalogFacts } = await import("../prepared-model-runtime.facts-BesNZTD5.js");
		const authStore = refreshAuthStore({
			agentDir: value.input.agentDir,
			inheritedAuthDir: value.input.inheritedAuthDir,
			authStore: value.authStore,
