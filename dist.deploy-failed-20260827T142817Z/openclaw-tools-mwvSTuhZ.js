...
import { g as resolveSessionAgentIds, h as resolveSessionAgentId, o as resolveAgentEffectiveModelPrimary } from "./agent-scope-BizOtGGz.js";
import { n as normalizeAgentId } from "./agent-id-Db0rqw_J.js";
import { a as listAgentIds, d as resolveAgentWorkspaceDir, l as resolveAgentDir, r as listAgentEntries, s as resolveAgentConfig } from "./agent-scope-config-BdXMWufB.js";
...
import { dt as hasInboundMetadataSentinel, ft as stripInboundMetadata } from "./openclaw-state-db-CXrhNigN.js";
...
import { t as loadBundledPluginPublicArtifactModuleFromCandidatesSync } from "./public-surface-loader-DBY_bHmV.js";
...
import { a as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-DppTp7ET.js";
...
import { m as mergeSsrFPolicies, t as SsrFBlockedError } from "./ssrf-UFPP-fbI.js";
...
import { A as getPreparedMessageToolCatalog, d as getActivePluginRegistry } from "./runtime-CTbL314X.js";
import { D as listMediaGenerationProviderModels, O as synthesizeMediaGenerationCatalogEntries } from "./loader-CwiP0Igf.js";
...
import { S as selectApplicableRuntimeConfig } from "./runtime-snapshot-Dp7mvsA3.js";
...
import { i as GatewayTransportError } from "./call-Ds1WOCDj.js";
...
import { o as getModelProviderRequestTransport } from "./provider-request-config-BK7CLYaF.js";
import { a as unwrapSecretSentinelsForProviderEgress } from "./provider-secret-egress-Cl2Qy4wH.js";
...
import { d as sessionDeliveryOrigin, n as deliveryContextFromSession, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-D-qPZITK.js";
...
import { n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-DK-npY9b.js";
import { r as resolveAgentMainSessionKey } from "./main-session-er-Gn_t_.js";
import { $t as loadSessionEntryReadOnly, It as patchSessionEntryWithKey, Qt as loadSessionEntry, Rt as resolveSessionEntryCandidateTarget, at as getCliSessionBinding, pn as runWithoutOwnedSessionTranscriptWrites } from "./session-accessor-CVnxp3UM.js";
import { i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CWrpiLCs.js";
...
import { U as getCurrentSessionWorkAdmissionRelease, W as getSessionWorkAdmissionRelease } from "./agent-harness-session-key-D5rklW6u.js";
import { K as isEmbeddedMode, Y as listAllChannelSupportedActions, Z as listChannelSupportedActions, g as hasRunWorkspaceSkillUsage, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-aNXucund.js";
import { Ao as PortalSummarySchema, Do as PortalListResultSchema, Jg as UiCommandResultSchema, Td as ConversationTurnResultSchema, To as PortalCloseResultSchema, bd as ConversationSendResultSchema, qv as SESSION_AGENT_ATTENTION_ICON_IDS, vd as ConversationListResultSchema } from "./src-Bo4ezI_n.js";
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-DStPs6cE.js";
import { r as resolvePluginCapabilityProvider, t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-CmN5L8jb.js";
import { c as getPreparedPluginRuntimeLoadContext } from "./prepared-model-runtime.facts-Bz0xgyUJ.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-Df_qhWv_.js";
import { r as resolveProviderTransportSsrFPolicy } from "./provider-transport-fetch-D26O1fd7.js";
import { c as getImageMetadata } from "./image-ops-CuoBGLvn.js";
import { Y as formatFullOutputFooter, mt as writePrivateTempFile, st as getModelRegistryRuntime } from "./sessions-CfDirsu7.js";
import { a as bindModelLlmRuntime, t as complete } from "./stream-BVM8PFBd.js";
...
import { i as normalizeMediaReferenceSource, r as classifyMediaReferenceSource } from "./media-reference-BuvK4U0u.js";
import { o as resolveBundledStaticCatalogModel, t as bundledStaticCatalogProviderUsesRuntimeAugment } from "./model.static-catalog-puRJUJrg.js";
...
import { n as resolveImageFallbackDefaultProvider, t as resolveImageFallbackCandidates } from "./model-fallback-candidates-CRHh8KMu.js";
import { t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-BNByaYVk.js";
...
import { r as getCustomProviderApiKey } from "./model-auth-provider-config-CUFUPomY.js";
import { c as createRuntimeProviderAuthLookup, i as getApiKeyForModelCore, l as hasRuntimeAvailableProviderAuth, r as applySecretRefHeaderSentinels, s as resolveApiKeyForProviderCore } from "./model-auth-B7VlMZMb.js";
import { r as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-CJJQK-S8.js";
import "./model-selection-BhpnS-Rv.js";
import "./workspace-BV2vwVv3.js";
import { c as listSessionStateEventsSince, i as getSessionStateVersions, r as getSessionStateVersion } from "./session-state-events-BTZJfLLh.js";
import { E as listTaskRecordsUnsorted } from "./task-registry-CV6EhTBX.js";
import { et as isTerminalTaskStatus } from "./task-registry-activity-Yc53RcW7.js";
import { s as stripPlainTextToolCallBlocks } from "./src-Rlms7fwG.js";
import { n as formatTaskStatusDetail, o as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-JK92-aeX.js";
import "./runtime-internal-CbPNKBWW.js";
import { t as cancelDetachedTaskRunById } from "./task-executor-CupwMNYy.js";
import { d as clearGeneratedMediaTaskActivity, f as registerGeneratedMediaTaskActivity } from "./task-status-access-DOvKrdar.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-564f415a.js";
import { t as resolveRequiredCompletionDeliveryFailureTerminalResult } from "./task-completion-contract-BJW3TUQJ.js";
import { _ as getSessionGoal, b as updateSessionGoalStatus, h as createSessionGoal, p as MODEL_UPDATABLE_SESSION_GOAL_STATUSES } from "./sessions-B_ifzq5W.js";
import { v as capArrayByJsonBytes } from "./session-transcript-readers-DWnTgCXL.js";
import { i as resolveSessionModelIdentityRef } from "./placement-session-runtime-Bg1IJ7s4.js";
import { s as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-XIK3os_w.js";
import { P as deriveSessionTitle, c as readSessionTitleFieldsFromTranscriptAsync } from "./session-utils-row-CriEgq90.js";
...
import { u as stripUnsupportedCitationControlMarkers } from "./payloads-D57nRTdF.js";
import { n as loadWebMedia, r as loadWebMediaRaw } from "./web-media-CJi3g5iH.js";
import { i as normalizeInboundPathRoots } from "./inbound-path-policy-DQ5Rksw7.js";
import { r as getDefaultLocalRootsCore } from "./local-media-access-DtoZyOsB.js";
import { S as isToolWrappedWithBeforeToolCallHook, i as resolveMessageActionAgentRuntimeIdentityToken, m as setToolTerminalPresentation, n as readGatewayCallOptions, r as resolveGatewayOptions, s as createGatewayToolCallerWrapper, t as callGatewayTool } from "./gateway-Cl3WHu5g.js";
import { t as normalizeConversationReadInvocationOrigin } from "./conversation-read-origin-E3olMOwo.js";
import { a as resolvePluginTools, o as setPluginToolMeta } from "./tools-uoGjdHqF.js";
...
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, s as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-Cc7TIbvb.js";
import { t as resolveSkillWorkshopConfig } from "./config-Cjp42tXL.js";
import { K as stripProposalFrontmatterForSkill } from "./store-BAGUKOT2.js";
import { c as readSkillProposalTargetTreeSha256 } from "./proposal-draft-B5pE2cuJ.js";
import { a as proposeUpdateSkill, c as reviseSkillProposal, f as inspectSkillProposal, i as proposeCreateSkill, l as evaluateSkillProposal, m as resolvePendingSkillProposal, n as applySkillProposal, o as quarantineSkillProposal, p as listSkillProposals, r as composeSkillBodyPatch, s as rejectSkillProposal, t as SkillProposalStaleTargetError } from "./service-D01ZPgBg.js";
import { i as readWritableWorkspaceSkill } from "./workspace-skill-read-ByhDy2OM.js";
import { r as resolveMessageActionTurnCapability } from "./message-action-turn-capability-BEevnYXM.js";
import { t as CHANNEL_MESSAGE_ACTION_NAMES } from "./message-action-names-CwcoVsCP.js";
import { a as resolveAllowedMessageActions, s as shouldApplyCrossContextMarker } from "./outbound-policy-jV_rW6pr.js";
...
import { a as screenSnapshotTempPath, c as cameraTempPath, d as resolveCameraClipTarget, f as resolveCameraSnapTargets, h as mediaPathMatchesFormat, i as screenSnapshotFormatForPath, l as parseCameraClipPayload, m as writeCameraPayloadToFile, n as parseScreenSnapshotPayload, o as writeScreenRecordToFile, p as writeCameraClipPayloadToFile, r as screenRecordTempPath, s as writeScreenSnapshotToFile, t as parseScreenRecordPayload, u as parseCameraSnapPayload } from "./nodes-screen-CHA7u8wP.js";
import { s as resolveActionDeliveryTargetAlias } from "./channel-target-CGYH-kbP.js";
import { a as optionalPositiveIntegerSchema, i as optionalNonNegativeIntegerSchema, n as channelTargetsSchema, o as optionalStringEnum, r as optionalFiniteNumberSchema, s as stringEnum, t as channelTargetSchema } from "./typebox-Byt2OP2j.js";
import { i as gatewayCallOptionSchemaProperties, t as createCronTool } from "./cron-tool-BmEAeEgo.js";
import { i as resolveEligibleNodeFromList, n as resolveAgentNode, r as resolveAgentNodeId, t as listNodes } from "./nodes-utils-D1m1kKFp.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CkokYcSR.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, t as createAgentToAgentPolicy } from "./session-visibility-ZrDMRxJ9.js";
import { _ as getInProcessGatewayToolContext, a as resolveSessionToolAccess, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, h as callInProcessGatewayTool, i as resolveSandboxedSessionToolContext, l as resolveInternalSessionKey, m as callAgentToolGatewayRequest, n as deriveChannel, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveCurrentSessionClientAlias, t as classifySessionListKind, u as resolveMainSessionAlias, v as hasInProcessGatewayToolContext } from "./sessions-helpers-Clt3G0tu.js";
import { c as listControlledSubagentRuns, l as resolveSubagentController, o as MAX_RECENT_MINUTES } from "./subagent-control-ChNTtKmT.js";
import { t as buildSubagentList } from "./subagent-list-DyuqLnoq.js";
import { O as createStructuredOutputTool, l as getSubagentRunByRunId, v as recordSwarmStructuredOutput } from "./subagent-registry-DU4QcZuY.js";
import { r as stripToolMessages } from "./chat-history-text-Bi-5yBsM.js";
import { t as resolveSwarmConfig } from "./swarm-config-DqpqlTRZ.js";
import { t as createCanvasDocument } from "./documents-B0ziK7eZ.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-lubtJzc2.js";
import { n as abortable } from "./abortable-DUrt_uFK.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-lO7JhHVk.js";
import { _ as parseJsonMessageParam, g as parseInteractiveParam } from "./source-reply-mirror-CJ3ZCuoC.js";
import { o as extractEmbeddedAssistantText } from "./embedded-agent-utils-BD59s5tV.js";
import { t as registerProviderStreamForModel } from "./provider-stream-DFoLArnM.js";
import { a as loadRequesterSessionEntry, f as formatGeneratedAttachmentLines, m as sanitizeGeneratedMediaDisplayText, p as mediaUrlsFromGeneratedAttachments, r as resolveAnnounceOrigin, t as deliverSubagentAnnouncement, u as formatAgentInternalEventsForPrompt } from "./subagent-announce-delivery-CYN_XkJo.js";
import { u as wrapToolWorkspaceRootGuardWithOptions } from "./agent-tools.read-C6k6yLAW.js";
import { r as listConnectedNodePluginTools } from "./node-plugin-tool-snapshot-CtaKhxdi.js";
import { t as resolveAgentRuntimeToolConfig } from "./tool-runtime-config-mtitX84t.js";
import { a as hasProviderAuthForTool, c as resolveOpenAiImageMediaCandidate, n as coerceToolModelConfig, o as hasToolModelConfig$1, r as hasAuthForProvider, s as resolveDefaultModelRef, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-C11w7_Lb.js";
import { t as isCoreCanvasHostEnabled } from "./config-CiLYPNJ4.js";
import { r as normalizeBoardWidgetDeclared } from "./board-capabilities-D21FluIN.js";
...
import { a as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-CGaTBGZ5.js";
import { t as resolveTranscriptsConfig } from "./config-UoehNruw.js";
import { a as resolveCapabilityModelCandidates, d as findCapabilityProviderById, f as resolveCapabilityModelRefForProviders, i as recordCapabilityCandidateFailure, n as buildNoCapabilityModelConfiguredMessage, r as normalizeDurationToClosestMax, t as buildMediaGenerationNormalizationMetadata, u as throwCapabilityGenerationFailure } from "./runtime-shared-UeI5U13d.js";
import { n as normalizeMediaProviderId } from "./provider-id-DSbuCFIb.js";
import { t as createAgentsWaitTool } from "./agents-wait-tool-DUwKB2-c.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-Mtb_s-wH.js";
import { _ as resolveSubagentAllowedTargetIds } from "./subagent-spawn-ownership-BZuv8Ato.js";
import { n as listRuntimeImageGenerationProviders, r as resolveImageGenerationMaxInputImages, t as generateImage } from "./runtime-CvMujUVK.js";
import { a as listMusicGenerationProviders, n as getMusicGenerationProvider, s as parseGenerationModelRef } from "./registry-DMBLhkfE.js";
import { n as hasMediaNormalizationEntry } from "./geometry-normalization-xIQxseLj.js";
import { n as resolveChannelInboundAttachmentRootsForChannel } from "./channel-inbound-roots-E49RyguK.js";
import { t as runWithImageModelFallback } from "./model-fallback-image-Cs6eKU3a.js";
import { i as readResponseBodySnippet, n as isMinimaxVlmProvider } from "./minimax-vlm-Df7AZNQV.js";
import { c as postJsonRequest, m as resolveProviderHttpRequestConfigWithOriginTrust } from "./shared-CzcciRDF.js";
import { a as resolveConfiguredImageModelRefs, i as hasImageReasoningOnlyResponse, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, t as coerceImageAssistantText } from "./image-tool.helpers-C03Tpx0c.js";
import { t as removeCronRunContinuationSessionIfIdle } from "./cron-run-continuation-cleanup-BwVsJm7t.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-Deci6uHt.js";
import { n as resolveMessageBroadcastAccountPlan, r as validateExplicitMessageAccountSelection } from "./message-account-selection-vLhcbd7g.js";
import { r as sourceDeliveryTargetsMatch } from "./source-delivery-plan-D2h5X9CM.js";
import { i as resolveDocumentMediaModel, n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-BM9x5Lhb.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-CYuu4eVp.js";
import { a as DEFAULT_TIMEOUT_SECONDS, c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-DswYbkvd.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-xJvrDBVt.js";
import { c as resolveTimeoutMs } from "./resolve-BPPWpfQ1.js";
import "./media-understanding-BvzVs9aF.js";
import { n as runtimeWebSecretOwnerId } from "./runtime-web-tools-AFz8ustk.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-DSogQgBi.js";
import { t as resolveEnabledBundledManifestContractPlugins } from "./bundled-manifest-contract-plugins-BLRA67d7.js";
import { f as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-BkKupp6y.js";
import { t as resolveMessageSecretScope } from "./message-secret-scope-BI5om_KV.js";
import { i as SHARED_POLL_CREATION_PARAM_NAMES, n as runMessageAction, r as POLL_CREATION_PARAM_DEFS, t as getToolResult } from "./message-action-runner-6zl24zic.js";
...
import { t as extractPdfContent } from "./pdf-extract-ChxGBGsO.js";
import { t as triggerSessionPatchHook } from "./session-patch-hooks-n9kdawSd.js";
import { t as applyModelOverrideWithAuthProfileCompatibility } from "./auth-profile-preservation-CkLTF0wv.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-C_-ciQa1.js";
import { a as runWithScopedSessionAccess, i as resolveSessionToolTargetAgentId, r as createSessionsSendTool, t as createSessionsSpawnTool } from "./sessions-spawn-tool-DqOUo7Qi.js";
import { r as withAgentSessionModelPatchOrigin } from "./session-model-patch-origin-B3Xoh1S9.js";
import { n as reconcileSkillCollection, o as MAX_RECONCILED_SKILL_BYTES, r as restoreLatestSkillCollectionBackup } from "./collection-reconcile-BAtbEwXQ.js";
import { t as SKILL_AUTHORING_STANDARDS_PROMPT } from "./skill-authoring-standards-CFsbOHC8.js";
import { r as resolveTerminalSpawnPlan, t as buildTerminalEnv } from "./launch-CSUsAkPo.js";
import { i as waitForTerminalOpenDeadline, n as TerminalOpenDeadlineError, r as createTerminalOpenDeadline } from "./open-deadline-BWa5FcsK.js";
import { n as createTranscriptsTool } from "./transcripts-tool-BcSsPWg5.js";
import { n as textToSpeech } from "./tts-C3n_GppM.js";
import { n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-D9NfRp-D.js";
...
import { n as resolveWebSearchToolRuntimeContext, t as resolveWebFetchToolRuntimeContext } from "./web-tool-runtime-context-s451-Qj4.js";
import { o as runWebSearch } from "./runtime-CPtjiOKD.js";
import "./web-search-provider-common-DJdWjQ0_.js";
...
function createRequesterYieldCallback(params) {
	...
	return async () => {
		const { markRequesterTurnYielded } = await import("./subagent-registry-CCzLJbcn.js");
...
async function loadImageWebMediaRuntime() {
	return await import("./web-media-BikEvN3M.js");
}
const resolveModelAsyncDefault = async (...args) => {
	const { resolveModelAsync } = await import("./model-DtFmxdxN.js");
...
function createPdfTool(options) {
	...
	return {
		...
		name: "pdf",
		description,
		...options?.modelHasVision ? { catalogMode: "direct-only" } : {},
...
async function lookupTaskByRunIdForChildSession(runId, childSessionKey) {
	const { findTaskByRunIdForChildSessionForStatus } = await import("./task-status-access-B2xHgXMS.js");
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-BY7LFE9q.js"));
