...
import { t as applyAgentBindings } from "./agents.bindings-BokYbc_Y.js";
...
async function loadOnboardChannels() {
	return await import("./onboard-channels-BN2qE8ec.js");
}
...
async function resolveInitialWizardChannel(raw, cfg) {
	...
	const [{ listActiveChannelSetupPlugins }, { resolveChannelSetupEntries }] = await Promise.all([import("./setup-registry-Ch7wtSyh.js"), import("./discovery-shF9VpRF.js")]);
...
async function runChannelsAddWizardFlow(params) {
	...
	const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-Daq19s1K.js"), loadOnboardChannels()]);
