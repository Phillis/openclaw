...
import { P as isDevicesMachineOutput } from "./argv-CgA2urTO.js";
...
function registerDevicesCli(program) {
	...
	devicesCallOpts(devices.command("join-code").description("Mint a single-use node onboarding URL").action(async (opts) => {
