...
import { U as bindDeliveryQueueEntry, Z as upsertBoundDeliveryQueueEntryInDatabase, h as runOpenClawStateWriteTransaction, q as loadDeliveryQueueEntryInDatabase } from "./openclaw-state-db-CXrhNigN.js";
import { b as findTaskByRunId, v as publishTaskRecordAfterAtomicStore, x as getTaskById } from "./task-registry-CV6EhTBX.js";
import { p as upsertTaskRunRowInDatabase, t as bindTaskRecord } from "./task-registry.store.sqlite-odgTKgwv.js";
import "./runtime-internal-CbPNKBWW.js";
import { S as subagentRuns, c as upsertSubagentRunRowInDatabase, p as ensureDeliveryState, t as bindSubagentRunRecord } from "./subagent-registry.store.sqlite-tyC5wssk.js";
...
import { L as resolveSubagentCompletionResultText, T as safeRemoveAttachmentsDir, g as ANNOUNCE_COMPLETION_HARD_EXPIRY_MS, s as loadPendingFinalDeliveryPayload } from "./subagent-registry-lifecycle-delivery-BU4QbfU0.js";
import { a as getDeliveryQueueEntryStatus } from "./delivery-queue-sqlite-CLvxFObU.js";
import { _ as markSessionDeliverySettlement, a as SessionDeliveryDeferredError, b as releaseSessionDeliveryClaim, h as loadPendingSessionDelivery, i as SessionDeliveryDeadLetteredError, l as completeSessionDelivery, m as loadPendingSessionDeliveries, n as SessionDeliveryAcknowledgementFinalizeError, o as SessionDeliveryRetryChargedError, p as failSessionDelivery, r as SessionDeliveryAttemptStartError, s as SessionDeliverySafeRetryError, t as SESSION_DELIVERY_QUEUE_NAME, v as moveSessionDeliveryToFailed, y as prepareClaimedSessionDelivery } from "./session-delivery-queue-storage-DTH6mnb7.js";
...
async function settleCorrelatedSubagentDelivery(queued, outcome) {
	...
	publishCommittedRecords(subagent, projectedTask);
	if (outcome === "recovered") {
		const { resumeSubagentRun } = await import("./subagent-registry-CCzLJbcn.js");
