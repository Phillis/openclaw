...
import { f as resetPublishedConfigRuntimeEnv, p as ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS_ENV } from "./config-env-vars-BITg3hPR.js";
...
import { t as enforceGatewayRunFutureConfigGuard } from "./future-config-guard-C_VfZGjc.js";
...
async function pinGatewayRunRuntimePaths() {
	const [{ pinRuntimePaths }, { pinConfigDir }] = await Promise.all([import("./paths-C39JGP_F.js"), import("./utils-eenn1bKU.js")]);
...
async function isSameGatewayRunConfigSnapshot(expected, current, options = {}) {
	const { hashRuntimeConfigValue } = await import("./runtime-snapshot-B5O3N-FL.js");
...
async function guardGatewayRunSelectedConfig(params) {
	...
	const [path, { applyConfigEnvVars, isConfigRuntimeEnvVarAllowed }, { loadGlobalRuntimeDotEnvFiles }, { normalizeEnv }, { normalizeStateDirEnv, resolveStateDir }, { resolveConfigDir }, { collectEnvSecretRefIds }, { clearMissingManagedServiceEnvKeys, readManagedSystemdServiceEnvKeysFromEnvironment }] = await Promise.all([
		import("node:path"),
		import("./config-env-vars-Da0KIRVt.js"),
		import("./dotenv-global-DaNEVroG.js"),
		import("./env-CiF4Z0yF.js"),
		import("./paths-C39JGP_F.js"),
		import("./utils-eenn1bKU.js"),
		import("./types.secrets-vXm6qYq1.js"),
		import("./service-managed-env-Dgwjkui-.js")
	]);
...
async function prepareGatewayRunBootstrap(params) {
	...
	const { planPristineStartupConfigMigrations, planPristineStartupStateMigrations } = await import("./pristine-startup-state-daBs7Y3V.js");
