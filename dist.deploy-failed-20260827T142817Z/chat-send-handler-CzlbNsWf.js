...
import { a as measureDiagnosticsTimelineSpan, n as emitDiagnosticsTimelineEvent, o as measureDiagnosticsTimelineSpanSync } from "./diagnostics-timeline-DwkG9AHk.js";
...
import { i as loadOrCreateProcessDeviceIdentity } from "./device-identity-BTcjEaGA.js";
...
import { r as hasGlobalHooks, t as getGlobalHookRunner } from "./hook-runner-global-BNCkTxOs.js";
...
import { o as resolveSessionRoutingContract, r as resolveAgentMainSessionKey, t as SESSION_ROUTING_CHANGED_ERROR_REASON } from "./main-session-er-Gn_t_.js";
import { $t as loadSessionEntryReadOnly, Jt as listSessionEntryKeysReadOnly, K as updateSessionEntry, en as patchSessionEntryCore, ln as upsertSessionEntryCore, o as readSessionTranscriptActivePathEntryRelation, t as readSessionTranscriptWatermark } from "./session-accessor-CVnxp3UM.js";
import { c as isOperatorUiClient, i as isGatewayCliClient, l as isWebchatClient, n as isBrowserOperatorUiClient, t as isBrowserCopilotClient } from "./message-channel-T4W5YOto.js";
import { a as resolveGroupSessionKey } from "./store-entry-shape-BcuqmtLR.js";
import { X as runExclusiveSessionLifecycleMutation, a as isAgentHarnessSessionKey, m as resolveMissingAgentHarnessSessionError, z as beginSessionWorkAdmission } from "./agent-harness-session-key-D5rklW6u.js";
import { a as hasRestartRecoveryTerminalRun, t as buildRestartRecoveryClaimCleanupPatch } from "./restart-recovery-state-DDUaUjgV.js";
import { n as estimateBase64DecodedBytes } from "./base64-KcXAb-1x.js";
import "./channel-outbound-aGOT1sXi.js";
import { G as validateChatSendParams } from "./src-Bo4ezI_n.js";
import { l as formatValidationErrors, s as errorShape } from "./error-codes-CMSvT5-d.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES } from "./store-BNwuZ4Nd.js";
import { a as parseInboundMediaUri } from "./media-reference-BuvK4U0u.js";
import { c as createAgentRunRestartAbortError } from "./run-termination-B0y7ra5H.js";
import { i as sanitizeAssistantVisibleTextWithProfile } from "./assistant-visible-text-CdBeRVUX.js";
import { t as getSessionBindingService } from "./session-binding-service-DyztGgRo.js";
import { d as isPluginOwnedSessionBindingRecord } from "./conversation-binding-Yyqz26An.js";
import { a as shouldComputeCommandAuthorized } from "./command-detection-omLfCeJF.js";
import { n as resolveAgentTimeoutMs } from "./timeout-CRSytcvC.js";
import { A as isReplyRunAbortableForSignal, D as beginReplyMessageInjectionTarget, E as abortReplyMessageInjectionTarget, O as recordAcceptedReplyMessageInjectionTarget, p as replyRunRegistry } from "./reply-run-registry-CeOg3aTN.js";
import { a as logMessageReceived, r as logMessageProcessed } from "./diagnostic-DO3P5TXi.js";
import { f as listActiveEmbeddedRunSessionIds } from "./run-state-BxqT1sw2.js";
import "./sessions-B_ifzq5W.js";
import { s as resolveSessionWorkStartError } from "./lifecycle-D1Tz6qOi.js";
import { n as resolveSessionResetType, t as resolveChannelResetConfig } from "./reset-CM_wuiRx.js";
...
import { o as readSessionMessageByIdAsync } from "./session-transcript-readers-DWnTgCXL.js";
import { a as resolveSessionModelRef } from "./placement-session-runtime-Bg1IJ7s4.js";
import { r as resolveGatewayModelSupportsImages } from "./session-utils-model-B0LBQVk2.js";
import { T as loadGatewaySessionEntry, j as resolveDeletedAgentIdFromSessionKey } from "./session-utils-row-CriEgq90.js";
...
import { n as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-Beya70q2.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-DtoZyOsB.js";
import { i as dispatchInboundMessageWithProjectedDispatcher, l as emitInboundMessageAuditTerminal, s as emitMessageReceivedHooks } from "./dispatch-1KPs2NUZ.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-BovEJvO2.js";
import { t as ensureSandboxWorkspaceForSession } from "./context-C5jzJkKC.js";
import { a as createUserTurnTranscriptRecorder, i as buildRunUserTurnIdempotencyKey } from "./user-turn-transcript-CGVX8qNz.js";
import { n as resolveSendPolicy } from "./send-policy-0X7wFmNT.js";
import { n as resolveSessionEntryResetFreshness } from "./entry-freshness-CdfFyJHm.js";
import { t as resolveQueueSettings } from "./queue-Fl99cnBb.js";
...
import { a as isChatStopCommandText, d as updateChatRunProvider, l as resolveChatRunExpiresAtMs, o as registerChatAbortController } from "./chat-abort-BBAKYOB6.js";
...
import { a as attachManagedOutgoingMediaToMessage } from "./managed-image-attachments-DuhxlWnt.js";
import { n as resolveChatAttachmentMaxBytes } from "./chat-attachment-policy-DrGl1Ors.js";
import { a as logAttachmentFailure, c as stripImageMediaMarkers, n as MediaOffloadError, o as parseMessageWithAttachments, r as UnsupportedAttachmentError, s as persistInboundImagesForTranscript, t as INLINE_IMAGE_DURABLE_OMISSION_MARKER } from "./chat-attachments-ekRmvZxY.js";
import { t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-B7-Wq5M9.js";
import { i as maybeGenerateDashboardSessionTitle, r as isDashboardSessionTitleCandidate, t as buildDashboardSessionTitleSource } from "./dashboard-session-title-COLl4QjV.js";
import { i as persistGatewaySessionLifecycleEvent } from "./session-lifecycle-state-zNqFUBsn.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-cUcd_IHs.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-DRFOPkFa.js";
...
async function resolveDurableChatClaim(params) {
	...
	if (isAdoptedRestartRecoveryClaim(entry, params.clientRunId) && entry.status === "running" && entry.abortedLastRun === true) {
		...
		try {
			const { retryRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-R1Z9NtJJ.js");
