...
import { g as resolveSystemAgentTargetAgentId, r as listAgentEntries } from "./agent-scope-config-BdXMWufB.js";
...
async function loadSystemAgentOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-n89JPEIA.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
