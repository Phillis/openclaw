...
import { l as publishPreparedModelRuntimeSnapshot } from "./prepared-model-runtime-BNByaYVk.js";
...
import { r as prepareAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-elnr4uyT.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-CS2VH7C-.js";
import "./provider-auth-choice-preference-iFc91pKa.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-C9pEahKj.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-D8V8P4wB.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-D_M8NhVP.js");
	...
	const { resolveDeprecatedProviderInstallCatalogEntry } = await import("./provider-install-catalog-B2l02FIg.js");
