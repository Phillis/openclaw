...
import { n as coerceToolModelConfig } from "./model-config.helpers-C11w7_Lb.js";
import { n as isMinimaxVlmProvider } from "./minimax-vlm-Df7AZNQV.js";
...
function hasImageReasoningOnlyResponse(message) {
	if (extractEmbeddedAssistantText(message).trim() || !Array.isArray(message.content)) return false;
	let checkedBlocks = 0;
