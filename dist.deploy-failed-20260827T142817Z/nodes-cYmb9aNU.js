...
import { c as isForbiddenBrowserProxyMutation } from "./method-scopes-rPUXjV_D.js";
...
import { l as replaceRemoteNodeSkills } from "./workspace-skill-loader-Cv5Ol3Y8.js";
import { a as isForegroundRestrictedPluginNodeCommand, c as normalizeDeclaredNodeCommands, l as resolveNodeCommandAllowlist, o as isNodeCommandAllowed, t as DEFAULT_DANGEROUS_NODE_COMMANDS, u as resolveNodePairingCommandAllowlist } from "./node-command-policy-17xabuuj.js";
...
import { _ as removePairedDeviceRole, d as listDevicePairing, s as getPairedDevice, u as listApprovedPairedDeviceRoles, x as resolveNodePairingState } from "./device-pairing-CFVs8foo.js";
import { a as listNodePairing, d as renamePairedNode, i as getPendingNodePairing, l as rejectNodePairing, o as projectNodePairing, t as approveNodePairing } from "./device-pairing-node-DQim5ZRE.js";
...
import { t as EXEC_APPROVAL_RESOLVED_ENTRY_GRACE_MS } from "./exec-approval-manager-CPQWh2Yj.js";
import { a as removePendingNodeAction, i as listPendingNodeActions, n as clearRemovedNodeRuntimeState, o as replacePendingNodeActionsForGeneration, r as enqueuePendingNodeAction, s as reconcileRevokedDeviceWorker, t as acknowledgePendingNodeActions } from "./node-runtime-state-CL59gLDX.js";
...
import { n as getKnownNode, r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-D5oNgWCL.js";
import { i as isNodePairingGenerationCurrent, n as captureNodePairingGeneration, r as captureNodePairingState } from "./device-pairing-node-state-BDYAK1fe.js";
import { a as resolveDispatchableNodeSession, i as isNodePairingWorkCurrent, n as maybeWakeNodeWithApns, o as respondPairingChanged, r as waitForNodeReconnect, s as nodeInvokePolicy, t as maybeSendNodeWakeNudge } from "./nodes.wake-CRf0tdP1.js";
import { t as applyPluginNodeInvokePolicy } from "./node-invoke-plugin-policy-B9ABVfux.js";
...
const nodeEventHandlers = { "node.event": async ({ params, respond, context, client }) => {
	...
	await respondUnavailableOnThrow(respond, async () => {
		...
		const { handleNodeEvent } = await import("./server-node-events-BWh7wNV4.js");
