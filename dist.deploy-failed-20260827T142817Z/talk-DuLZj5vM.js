...
import { b as tryResolveLegacyCompatibilityAgentId, d as resolveAgentWorkspaceDir, p as resolveDefaultAgentId, t as AgentSelectionRequiredError } from "./agent-scope-config-BdXMWufB.js";
...
import { C as resolveSupportedVoiceModelRefs, b as getVoiceProviderConfig, x as providerMatchesId } from "./loader-CwiP0Igf.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-Cew9ka2y.js";
...
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-Cg-hXt3q.js";
import { t as ErrorCodes } from "./gateway-error-details-BWo6Le6w.js";
import { t as canonicalizeBase64 } from "./base64-KcXAb-1x.js";
import { A as flushClientVoiceSessionWrites, C as appendRelayVoiceTranscript, D as closeStaleClientVoiceSessions, E as closeRelayVoiceSessionRecord, F as VOICE_TRANSCRIPT_QUEUE_POLICY, I as normalizeVoiceTranscriptText, L as BoundedSerialQueue, M as resolveClientVoiceAgentSessionId, N as resolveClientVoiceSessionOrigin, O as createOrResumeClientVoiceSession, P as resolveOpenClientVoiceSessionId, R as authorizeClientVoiceConfirmation, S as appendClientVoiceTranscript, T as closeClientVoiceSession, j as registerClientVoiceConsultRun, k as ensureClientVoiceAgentSessionEntry, w as assertClientVoiceSessionOpen, z as bindAuthorizedClientVoiceConfirmation } from "./agent-tools.before-tool-call-aNXucund.js";
...
import { d as readSessionPreviewItemsFromTranscript } from "./session-transcript-readers-DWnTgCXL.js";
...
import { S as withSpeakerSelectionFallbackCompat, h as resolveTtsConfig, x as withSpeakerSelectionCompat } from "./tts-settings-C4v4j5N-.js";
import { n as redactConfigObject } from "./redact-snapshot-DuN7qyYL.js";
import { C as getResolvedSpeechProviderConfig, b as CODE_HEAVY_SPOKEN_FALLBACK, v as synthesizeSpeech, x as isCodeHeavySpeechText } from "./runtime-api-Bw3X0kRb.js";
import "./tts-C3n_GppM.js";
import { o as registerChatAbortController, t as abortChatRunById } from "./chat-abort-BBAKYOB6.js";
import { t as createPluginRuntime } from "./runtime-CmoGFmKA.js";
import { t as formatForLog } from "./ws-log-DAJ6wT2O.js";
import { n as getRealtimeTranscriptionProvider, r as listRealtimeTranscriptionProviders, t as canonicalizeRealtimeTranscriptionProviderId } from "./provider-registry-B5rSwyCR.js";
import { n as resolveRealtimeBootstrapContextInstructions } from "./realtime-bootstrap-context-ClLWew69.js";
...
import { a as rememberUnifiedTalkSession, i as registerTalkConnectionCleanup, n as forgetUnifiedTalkSession, o as requireUnifiedTalkSessionConn, r as getUnifiedTalkSession } from "./talk-session-registry-DBqdIYnk.js";
...
const loadTalkAgentExecution = createLazyRuntimeModule(async () => {
	const [embeddedAgent, admission] = await Promise.all([import("./embedded-agent-FeUdPibX.js"), import("./admitted-run-context-DN1fM-I2.js")]);
	return {
