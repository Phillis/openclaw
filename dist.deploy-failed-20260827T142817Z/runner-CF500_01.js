...
import { b as resolveModelRefFromString, i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels } from "./model-selection-shared-DT9x3Cg2.js";
...
import { r as classifyMediaReferenceSource } from "./media-reference-BuvK4U0u.js";
...
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-Df7AZNQV.js";
import { t as providerSupportsCapability } from "./provider-supports-msSTK_XS.js";
import { c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-DswYbkvd.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-xJvrDBVt.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-BPPWpfQ1.js";
...
import { a as runCliEntry, d as selectAttachments, l as MediaAttachmentCache, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as isMediaUnderstandingSkipError } from "./runner.entries-C4rqSTz3.js";
...
const loadHasAvailableAuthForProvider = createLazyRuntimeNamedExport(() => import("./model-auth-q0YP1OW6.js"), "hasAvailableAuthForProvider");
const loadPreparedModelCatalogApi = createLazyRuntimeModule(async () => ({
	...await import("./model-catalog-BbhSMw6J.js"),
	...await import("./prepared-model-catalog-DmTX1q65.js")
}));
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-C5pvkx-n.js");
