import { o as optionalStringEnum, s as stringEnum } from "./typebox-Byt2OP2j.js";
...
const processSchema = Type.Object({
	action: stringEnum(PROCESS_TOOL_ACTIONS, { description: "Process action (list|poll|log|write|send-keys|submit|paste|kill|clear|remove)" }),
