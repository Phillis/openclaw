...
import { R as resolveSessionTranscriptActiveLeafEntryId, sn as resolveSessionKeyBySessionId, x as isSessionTranscriptProjectionUnavailableError } from "./session-accessor-CVnxp3UM.js";
import { z as beginSessionWorkAdmission } from "./agent-harness-session-key-D5rklW6u.js";
import { H as validateChatInjectParams, K as validateChatToolTitlesParams, U as validateChatMessageGetParams, V as validateChatHistoryParams, W as validateChatMetadataParams } from "./src-Bo4ezI_n.js";
...
import { E as loadGatewaySessionEntryReadOnly, T as loadGatewaySessionEntry, v as resolveCurrentUserProfileDisplay, w as listAgentsForGateway } from "./session-utils-row-CriEgq90.js";
import { n as tryResolveSessionCompatibilityOwnerAgentId } from "./session-request-agent-BeVvXvOY.js";
import { i as buildGatewaySessionInfo } from "./session-utils-list-Bh24bUSo.js";
...
import { r as boundInFlightRunSnapshotForChatHistory, u as resolveInFlightRunSnapshot } from "./chat-abort-BBAKYOB6.js";
...
import { a as resolveClaudeCliBindingSessionId } from "./cli-session-history.claude-fGiM6Zh3.js";
import { n as resolveChatHistoryWithCliSessionImports } from "./cli-session-history-CVIY1TF-.js";
import { c as augmentChatHistoryWithCanvasBlocks, i as projectRecentChatDisplayMessages, n as projectChatDisplayMessages, o as dropPreSessionStartAnnouncePairs, s as isHeartbeatHistoryTurnBoundaryMessage, t as projectChatDisplayMessage, u as resolveEffectiveChatHistoryMaxChars } from "./chat-display-projection-B0E44yqM.js";
import { r as resolveGatewayChatCronCreatorAuthorityAdmission, t as createAgentTurnService } from "./agent-turn-service-CdZDfJAc.js";
import { i as resolveVisibleActiveSessionRunState } from "./session-active-runs-CRkuFZp3.js";
import { P as normalizeOptionalChatText, s as appendAssistantTranscriptMessage, w as scheduleChatHistoryManagedMediaCleanup } from "./chat-abort-runtime-CpinoOzx.js";
import { t as assertValidParams } from "./validation-CsGeElrb.js";
import { i as validateChatSelectedAgent, o as resolveGlobalAwareNodeChatDeliveryKeys, r as resolveRequestedChatAgentId, s as sendGlobalAwareNodeChatPayload, t as handleChatSend } from "./chat-send-handler-CzlbNsWf.js";
import { a as prepareSessionWorkspaceIcon } from "./workspace-icon-http-BO5PKQJj.js";
import { t as resolveAgentIdOrRespondError } from "./agent-id-shared-uNTkOYt3.js";
import { i as resolveSessionHistoryTailReadOptions } from "./session-history-state-LnOy2Yn_.js";
...
const chatHandlers = {
	...
	"chat.toolTitles": async ({ params, respond, context }) => {
		...
		const { generateToolCallTitles } = await import("./chat-tool-titles-C82Ho5aa.js");
