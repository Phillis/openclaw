...
import { l as clearLoadInstalledPluginIndexInstallRecordsCache, n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-DArXGVRI.js";
import { b as requireActivePluginChannelRegistry } from "./runtime-CTbL314X.js";
...
import { f as setGatewaySigusr1RestartPolicy, l as resolveGatewayRestartDeferralTimeoutMs, r as deferGatewayRestartUntilIdle } from "./restart-B3HJgSVH.js";
...
import { d as rejectPendingPreparedModelRuntimeReplacement, s as markPreparedModelRuntimeSnapshotsStale, u as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-BNByaYVk.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { i as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-CnkAjgoP.js";
import { d as getActiveEmbeddedRunCount } from "./run-state-BxqT1sw2.js";
import { i as refreshContextWindowCache } from "./context-BCVmjNPU.js";
...
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-B2gi0nAB.js";
...
import { r as resetDirectoryCache } from "./target-resolver-BFP5nrOT.js";
import { n as disposeAllSessionMcpRuntimes } from "./agent-bundle-mcp-manager-api-Qkb7NsgF.js";
import "./agent-bundle-mcp-tools-B0z92taC.js";
import { c as getActiveSecretsRuntimeSnapshotRevisionState, g as hasSameSecretReloadContract, l as getActiveSecretsRuntimeSnapshotState, p as hasActiveSecretsRuntimeSnapshotLineage, r as clearSecretsRuntimeSnapshotState, x as setSecretsRuntimeSourceSnapshotIfCurrent, y as restoreSecretsRuntimeSourceSnapshotIfLineageCurrent } from "./runtime-state-CGaTBGZ5.js";
import { b as resolveHooksConfig, t as commitHooksConfigReload } from "./hooks-DX_FXl_1.js";
...
import { i as listPluginInstallWholeRecordPaths, n as isNoopGatewayReloadPlan, r as listPluginInstallTimestampMetadataPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-C1eSRqp3.js";
...
import { t as buildGatewayCronService } from "./server-cron-foYpHztu.js";
import { t as invalidateConfigGetResponseCache } from "./config-get-response-CmFqGu-x.js";
...
import { i as startGatewayCronWithLogging } from "./server-runtime-services-DeCjtjvy.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-3kvPgEyy.js";
import { r as publishRuntimeSecretsStateTransition } from "./server-startup-config-D9ax1InT.js";
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				...
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-B62DxX_3.js"), import("./gmail-watcher-lifecycle-DKokSwoY.js")]);
...
async function restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, options) {
	if (!(await import("./runtime-C5u6SU5w.js")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, { runtimeSourceConfig: options?.runtimeSourceConfig })) return false;
	options?.onActivated?.();
	return true;
}
...
function startManagedGatewayConfigReloader(params) {
	...
	const { applyHotReload, acceptRestartConfig, beginGatewayRestartLifecycle, pauseGatewayRestartForConfigCandidate, publishAppliedConfigHash, publishAcceptedRestartTarget, publishDeferredAppliedConfigHash, recordAcceptedRestartTarget, requestGatewayRestart, restoreConservativeRestartDebt, stopRestartRetries } = createGatewayReloadHandlers({
		...
		assertRestartReady: () => import("./openclaw-database-preflight-mPpLkVfk.js").then(({ assertOpenClawDatabasesReadyForRestart }) => assertOpenClawDatabasesReadyForRestart({ env: process.env })),
		restartRecoveryAvailable,
