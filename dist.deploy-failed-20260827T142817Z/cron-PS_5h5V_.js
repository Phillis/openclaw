...
import { _ as loadCronQuarantinedJobs, l as resolveCronJobsStorePath } from "./store-Ce3SZg1h.js";
...
import { n as resolveCronDeliveryPlan } from "./delivery-plan-CgTsLdtN.js";
import { i as resolveCodexMcpToolOverridesForAgent } from "./bundle-mcp-codex-vZRsCV_N.js";
import { t as note } from "./note-D7f3pYFE.js";
import { r as normalizeStoredCronJobs } from "./store-migration-C5iUQK4N.js";
import { c as formatScheduledToolPolicyAdvisory, d as countStaleDreamingJobs, l as formatUnresolvedCommandPromptAdvisory, o as formatIncompleteInheritedAuthorityAdvisory, r as loadLegacyCronRepairState, s as formatLegacyIssuePreview, t as applyLegacyCronStoreRepair, u as formatUnresolvedShellPromptAdvisory } from "./legacy-repair-BfhKHidk.js";
...
async function maybeRepairLegacyCronStore(params) {
	...
	const incompleteInheritedAuthorityAdvisory = formatIncompleteInheritedAuthorityAdvisory(rawJobs.filter((job) => {
		...
		const agentId = typeof job.agentId === "string" && job.agentId.trim() ? job.agentId.trim() : resolveDefaultAgentId(params.cfg);
