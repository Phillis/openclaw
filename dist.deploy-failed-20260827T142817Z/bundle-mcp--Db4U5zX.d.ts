import { bt as ChatType, n as OpenClawConfig, st as GroupToolPolicyConfig } from "./types.openclaw-CNftZ6Ix.js";
import { c as SessionToolOverrides } from "./types-DMfmNky0.js";
import { t as InputProvenance } from "./input-provenance-DbhpF_8r.js";
import { n as PluginManifestRegistry } from "./manifest-registry-2CBAZ6tk.js";
import { i as SandboxToolPolicy, y as SkillSnapshot } from "./types-MS2pZkCP2.js";
import { d as TrustedSubagentCompletionHandoff, f as ScheduledToolPolicyContext, p as AnyAgentTool, s as PromptMode, u as RuntimePluginToolGrant } from "./cron-creator-authority-context-DAum5N8q.js";
...
type ScheduledStaticHarnessMcpTools = {
  /** Final executable static MCP tools for this scheduled turn. */tools: AnyAgentTool[]; /** Bounded model/operator warning when configured servers or final policy were incomplete. */
...
declare function materializeStaticMcpToolsForScheduledHarnessRunCore(params: Omit<MaterializeRequesterScopedMcpToolsForHarnessRunParams, "requesterSenderId" | "agentAccountId" | "messageChannel"> & {
  toolOverrides?: Pick<SessionToolOverrides, "mcpServers" | "mcpToolsDeny">; /** Exact established Codex yolo predicate; no other profile bypasses approval metadata. */
  autoApproveCodexAppServerApprovals?: boolean; /** Mutation-only probes retire their isolated runtime after the snapshot. */
  retireSessionRuntimeAfterDispose?: boolean;
}): Promise<ScheduledStaticHarnessMcpTools>;
//#endregion
export { ResolvedConversationCapabilityProfile as n, materializeStaticMcpToolsForScheduledHarnessRunCore as t };