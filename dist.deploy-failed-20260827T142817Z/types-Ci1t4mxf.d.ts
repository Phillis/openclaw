import { $ as IdentityConfig, C as ToolResultMessage, D as TalkProviderConfig, E as McpCodexToolApprovalMode, F as TtsProvider, G as MemorySearchResult, H as QueueMode, J as ContextVisibilityMode, L as GroupToolPolicyConfig, M as TtsAutoMode, N as TtsConfig, O as OperatorScope, P as TtsMode, Q as HumanDelayConfig, R as ToolLoopDetectionConfig, T as UserMessage, U as MemoryCitationsMode, V as MentionPatternsPolicyConfig, W as MemorySearchManager, X as DmScope, _ as Model, a as ModelCompatConfig, at as AgentModelConfig, b as StreamOptions, c as ModelProviderAuthMode, ct as SecretRef, d as Api, f as AssistantMessage, ft as SilentReplyConversationType, h as ImageContent, i as ModelApi, it as ChatType, j as ResolvedTtsPersona, k as ChannelImplicitMentionsConfig, l as ModelProviderConfig, m as Context, n as OpenClawConfig, o as ModelDefinitionConfig, ot as SandboxDockerSettings, p as AssistantMessageEventStreamContract, pt as FastMode, rt as SessionScope, s as ModelMediaInputConfig, st as SecretInput, t as ConfigFileSnapshot, tt as ReplyToMode, v as SimpleStreamOptions, w as Usage, x as TextContent, z as SafeBinProfileFixture } from "./types.openclaw-CpYrAZv3.js";
import { C as ChannelId$1, _ as ChannelRouteRef, a as SessionEntry, b as SessionsCompanionAskResult, c as SessionSystemPromptReport, d as SessionCreatedVia, g as Skill, h as DeliveryContext, i as SessionContextBudgetStatus, l as SessionToolOverrides, m as SourceReplyDeliveryMode, n as GroupKeyResolution, o as SessionPluginJsonValue, t as CliSessionBinding, u as SessionCreatedActor, v as CronScheduledToolPolicy, w as ChatChannelId, x as SessionsCompanionStateResult, y as SessionObserverDigest } from "./types-CkKOeDuP.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-BcBUJdmW.js";
import { _ as CronRuntimeAuthority, a as resolveAgentDir, c as CronJobCreate, d as CronRunStatus, f as CronStoredJob, g as ProviderCatalogOutcome, h as ModelCatalogSnapshot, i as SessionManager, l as CronJobPatch, m as ModelCatalogEntry, o as resolveAgentWorkspaceDir, p as CronToolsAllowProvenance, r as SessionTranscriptDeliveryMirror, s as CronJob, t as ResolveMarkdownTableMode, u as CronPayload, v as ResolvedSessionMaintenanceConfigInput, y as FailoverReason } from "./model-selection-Cscw-8h9.js";
import { a as StructuredExtractionInput, c as MediaUnderstandingOutput, i as MediaUnderstandingProvider, r as MediaUnderstandingDecision } from "./types-HlI7RkaS.js";
import { $ as ConversationReadInvocationOrigin, $t as ReplyPayloadDelivery, A as chunkMarkdownTextWithMode, At as HistoryMediaEntry, Bt as UserTurnTranscriptRecorder, C as ChannelPairingAdapter, Ct as InboundSourceModality, D as OutboundDeliveryFormattingOptions, Dt as SessionTranscriptContext, E as OutboundIdentity, Et as OriginatingChannelType, Ft as BlockReplyContext, Gt as MediaKind, Ht as LegacyMediaContextKey, It as GetReplyOptions, Jt as ReplyMediaAttachment, Kt as mediaKindFromMime, L as ChannelAccountSnapshot, Lt as PartialReplyPayload, M as chunkTextWithMode, Mt as CommandTurnKind, N as resolveChunkMode, Nt as PluginHookChannelContext, O as chunkByNewline, Ot as SupplementalContextFacts, P as resolveTextChunkLimit, Pt as InboundEventKind, Qt as ModelPickerAction, Rt as TaskSuggestionDeliveryMode, St as FinalizedRuntimeMsgContext, T as ChannelOutboundAdapter, Tt as MsgContext, Ut as MediaFact, Vt as InputProvenance, W as ChannelMessageActionAdapter, Wt as PromptImageOrderEntry, X as ChannelThreadingToolContext, Xt as LegacyInteractiveReply, Yt as ReplyPayload$1, Zt as MessagePresentation, _t as ExecAsk, an as AgentToolResult, at as PluginApprovalRequest$1, bt as ExecTarget, ct as WizardPrompter, dt as RenderedMessageBatchPlanItem, en as TranscriptEntryAnchor, et as OutboundDeliveryResult, ft as OutboundMediaAccess, gt as ExecApprovalRequestPayload$1, ht as ExecApprovalDecision, in as AgentTool, it as resolveAgentRoute, j as chunkText, jt as CommandTurnContext, k as chunkMarkdownText, kt as HistoryEntry, ln as StreamFn, mt as OutboundSendDeps, nn as TranscriptTurnBoundary, nt as OutboundPayloadDeliverySuppressionReason, on as AgentToolUpdateCallback, ot as PluginApprovalRequestPayload, pt as OutboundMediaReadFile, qt as AgentPlanStep, rn as AgentMessage, rt as buildAgentSessionKey, tn as TranscriptTurnAdmission, tt as OutboundPayloadDeliveryOutcome, ut as MessageReceipt, vt as ExecMode, w as ChannelDeliveryCapabilities, wt as MentionSource, xt as FinalizedMsgContext, yt as ExecSecurity, zt as TurnAdoptionLifecycle } from "./setup-wizard-types-DUwZ9UvR.js";
import { C as PluginKind, E as JsonSchemaObject, O as UnifiedModelCatalogEntry, _ as PluginManifestDashboard, a as PluginOrigin$1, b as PluginManifestMcpServer, f as PluginBundleFormat, g as PluginManifestContracts, h as PluginFormat, i as PluginDependencyStatus, j as RuntimeEnv, k as UnifiedModelCatalogKind, m as PluginDiagnostic, p as PluginConfigUiHint, t as PluginManifestRecord, v as PluginManifestDashboardActionVerb, y as PluginManifestDashboardDataBinding } from "./manifest-registry-BJDg-GrV.js";
import { n as PluginMetadataSnapshotOwnerMaps, r as PluginCompatCode, t as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-D4szEoOb.js";
import { n as ConfigReplaceResult, r as ConfigWriteAfterWrite, t as resolveStateDir } from "./config-BX3EEHIo.js";
import { i as OAuthCredential$1, n as AuthProfileCredential, r as AuthProfileStore, t as ApiKeyCredential$1 } from "./types-CNLVqgGq.js";
import { n as ChannelPlugin$3 } from "./types.public-0NqXTVIR.js";
import { i as SsrFPolicy, n as PinnedDispatcherPolicy, t as LookupFn } from "./ssrf-CX7egwMk.js";
import { a as ImageGenerationOutputFormat, c as ImageGenerationQuality, i as ImageGenerationNormalization, l as ImageGenerationResolution, n as ImageGenerationBackground, o as ImageGenerationProvider, r as ImageGenerationIgnoredOverride, s as ImageGenerationProviderOptions, t as GeneratedImageAsset, u as ImageGenerationSourceImage } from "./types-BRg76nSh.js";
import { a as MusicGenerationProvider, i as MusicGenerationOutputFormat, n as MusicGenerationIgnoredOverride, o as MusicGenerationSourceImage, r as MusicGenerationNormalization, t as GeneratedMusicAsset } from "./types-B-W_-4_Y.js";
import { a as VideoGenerationResolution, i as VideoGenerationProvider, n as VideoGenerationIgnoredOverride, o as VideoGenerationSourceAsset, r as VideoGenerationNormalization, t as GeneratedVideoAsset } from "./types-Bv3iYFiC.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-B3PbEfcF.js";
...
//#endregion
export { SpeechProviderPlugin$1 as $, createChannelReplyPipeline as A, VideoContent as B, ProviderReplayPolicyContext as C, PluginHttpRouteRegistration as D, ProviderRuntimeModel as E, isNumericTargetId as F, MemoryEmbeddingProviderAdapter as G, CliBackendPreparedExecution as H, sendPayloadWithChunkedTextAndMedia as I, emptyPluginConfigSchema as J, MemoryEmbeddingProviderCreateOptions as K, ProviderContext as L, ReplyPayload as M, deliverFormattedTextWithAttachments as N, PluginRegistry as O, deliverTextOrMediaReply as P, RealtimeVoiceProviderPlugin$1 as Q, ProviderModel as R, ProviderReplayPolicy as S, ProviderToolSchemaDiagnostic as T, CliBackendToolAvailability as U, CliBackendPlugin$1 as V, MemoryEmbeddingProvider as W, GatewayRequestHandlerOptions as X, redactSensitiveText as Y, RealtimeTranscriptionProviderPlugin$1 as Z, ProviderAuthContext as _, isValidDiagnosticTraceFlags as _t, OpenClawPluginGatewayRuntimeScopeSurface as a, readToolStringParam as at, ProviderReasoningOutputMode as b, TalkEvent as bt, OpenClawPluginServiceContext as c, DiagnosticEventPayload as ct, WebSearchProviderPlugin as d, onDiagnosticEvent as dt, TtsDirectiveOverrides as et, ProviderDefaultThinkingPolicyContext as f, DiagnosticTraceContext as ft, ProviderResolveDynamicModelContext as g, isValidDiagnosticSpanId as gt, ProviderWrapStreamFnContext as h, formatDiagnosticTraceparent as ht, ProviderPlugin as i, AnyAgentTool as it, OutboundReplyPayload as j, PluginRuntime as k, PluginLogger as l, DiagnosticEventPrivateData as lt, ProviderFailoverErrorContext as m, createDiagnosticTraceContext as mt, OpenClawPluginConfigSchema as n, RealtimeVoiceProviderConfig as nt, OpenClawPluginHttpRouteHandler as o, jsonResult as ot, ProviderThinkingProfile as p, createChildDiagnosticTraceContext as pt, EmbeddingInput as q, OpenClawPluginApi as r, RealtimeTranscriptionProviderConfig as rt, OpenClawPluginService as s, DiagnosticEventMetadata as st, OpenClawPluginDefinition as t, TtsDirectiveParseResult as tt, OpenClawPluginToolContext as u, emitDiagnosticEvent as ut, ProviderAuthResult as v, isValidDiagnosticTraceId as vt, ProviderSanitizeReplayHistoryContext as w, ProviderReasoningOutputModeContext as x, __exportAll as xt, ProviderNormalizeToolSchemasContext as y, parseDiagnosticTraceparent as yt, ProviderStreamOptions as z };