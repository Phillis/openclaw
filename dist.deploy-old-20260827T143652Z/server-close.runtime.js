...
import { r as clearActivePluginRegistry } from "./runtime-g0R28Sy0.js";
import { t as disposeRegisteredAgentHarnesses } from "./registry-GCsrA8Io.js";
import { p as closePluginStateDatabase } from "./plugin-state-store-D5dGBXer.js";
import { i as listChannelPlugins } from "./registry-B3yYjPW1.js";
import "./plugins-cwOWOggC.js";
import { a as disposeAcpSessionManagerInstance, t as getAcpSessionManager } from "./manager-DX5avEWt.js";
...
import { i as isChatAbortControllerEntryAbortable, s as removeChatAbortControllerEntry, t as abortChatRunById } from "./chat-abort-Cm7ik-5J.js";
...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-tuWSAYTY.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./agent-bundle-lsp-runtime-V8KxQUgt.js");
	await disposeAllBundleLspRuntimes();
}
async function drainRetainedEmbeddingProvidersOnDemand() {
	const { drainRetainedOpenAiEmbeddingProviders } = await import("./embeddings-http-Bpgmu8R0.js");
	await drainRetainedOpenAiEmbeddingProviders();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-BmZKkMQz.js");
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-C3tarifq.js");
