...
import { H as resetConfigOverrides, N as validateConfigObjectWithPlugins, U as setConfigOverride, V as getConfigOverrides, W as unsetConfigOverride, d as readConfigFileSnapshotForWrite, dt as resolveOwnerPromptNumbers, l as readConfigFileSnapshot } from "./io-CeQckj5v.js";
...
import { a as getActivePluginChannelRegistry } from "./runtime-g0R28Sy0.js";
...
import { a as transformConfigFileWithRetry } from "./mutate-DOUWd6so.js";
...
import { d as scheduleGatewaySigusr1Restart, m as triggerOpenClawRestart } from "./restart-DHXBMqqF.js";
...
import { $t as loadSessionEntryReadOnly, K as updateSessionEntry, en as patchSessionEntryCore, hn as resolveSessionStorePathForScope, yt as applySessionPatchProjection } from "./session-accessor-Bi6bzKQE.js";
import { a as normalizeChannelId, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-B3yYjPW1.js";
...
import { a as normalizeStoreSessionKey, s as resolveSessionStoreEntryCore } from "./store-entry-iif-1PcC.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { x as scanSessionTranscriptTree } from "./session-transcript-index-Bfc_6ADm.js";
...
import { a as migrateSessionEntries } from "./session-manager-codec-CpsgMjY3.js";
import "./session-manager-CmaH_Zw4.js";
...
import { i as isCliRuntimeAliasForProvider, s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-DoD-DaGs.js";
import { n as resolveManualCompactionCliTarget } from "./session-runtime-compat-B5omAB7u.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-BKh-iCi1.js";
...
import { r as matchPluginCommand, t as executePluginCommand } from "./commands-BxEXaQv_.js";
...
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-D5Rxkh8H.js";
import { c as listTasksForAgentIdForStatus, u as listTasksForSessionKeyForStatus } from "./task-status-access-DQT3wrnW.js";
...
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync, a as formatEmbeddedAgentQueueFailureSummary, l as isEmbeddedAgentRunActive } from "./runs-CS8YarJf.js";
import { t as formatTokenCount } from "./token-format-D942KbWN.js";
import "./sessions-D-jhKYGW.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-DcKMk0pM.js";
import { c as readSessionMessagesAsync } from "./session-transcript-readers-CJcK7eRo.js";
import { n as formatUsd } from "./usage-format-Dr1DjctD.js";
import { P as deriveSessionTitle } from "./session-utils-row-CB3Fore5.js";
...
import { _ as isRealConversationMessage, _t as createMessageCharEstimateCache, vt as estimateMessageCharsCached } from "./builtin-openclaw-FyAH3ReK.js";
...
import { a as formatDoctorNonInteractiveHint, n as clearRestartSentinel, p as writeRestartSentinel, t as buildRestartSuccessContinuation } from "./restart-sentinel-CWrwiMK_.js";
import { i as getSpeechProvider, o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-DlYdAAS-.js";
import { _ as resolveTtsPrefsPath, a as getTtsMaxLength, c as isTtsEnabled, h as resolveTtsConfig, l as listTtsPersonas, o as getTtsPersona, s as isSummarizationEnabled } from "./tts-settings-oG9oyjFI.js";
...
import { a as markCommandSessionMetadataChanged, n as handleGoalCommand } from "./commands-goal-BpMMSkvE.js";
...
import { l as resolveInternalSessionKey, u as resolveMainSessionAlias } from "./sessions-helpers-DoiD7CEo.js";
...
import { n as routeReply } from "./route-reply-DHHrK9GT.js";
import { t as clearSessionQueues } from "./cleanup-Ceen02hT.js";
import "./queue-DwgCT7Tx.js";
...
import { C as getResolvedSpeechProviderConfig, _ as setTtsProvider, c as getLastTtsAttempt, d as setLastTtsAttempt, f as setSummarizationEnabled, g as setTtsPersona, h as setTtsMaxLength, m as setTtsEnabled, t as getTtsProvider, w as isTtsProviderConfigured } from "./runtime-api-Bl-e-uE6.js";
import { n as textToSpeech } from "./tts-D0461XUk.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-CIlWiwXe.js";
import { c as selectAgentHarness, n as agentHarnessExposesOpenClawTools } from "./selection-DW5A2v-w.js";
...
import { i as PLUGIN_COMMAND_DISPATCH, n as executePluginCommandDispatch, r as matchPluginCommandInvocation, t as createPluginCommandRuntime } from "./plugin-command-runtime-Bh468OL_.js";
...
import { n as formatAbortReplyText, r as stopSubagentsForRequester, t as abortSessionRunTargetWithOutcome } from "./abort-CJJRE-1T.js";
...
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DNjb86Id.js";
import { l as removeChannelAllowFromStoreEntry, n as addChannelAllowFromStoreEntry, s as readChannelAllowFromStore } from "./pairing-store-L1ejw2gC.js";
...
import { n as formatNonClawHubInstallWarning, t as NON_CLAWHUB_INSTALL_FORCE_FLAG } from "./install-provenance-5w7YB8TZ.js";
import { t as handleSystemAgentCommand } from "./commands-system-agent-BGej99Lo.js";
import { n as resolveSkillWorkshopToolPolicyAvailability } from "./tool-policy-diagnostic-DeVSkAs5.js";
...
import { a as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-DFUizwTs.js";
import { n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContextAsync, t as resolveConfiguredModelCompat } from "./tools-effective-inventory-BGKSdpHU.js";
import { t as extractBtwQuestion } from "./btw-command-BGrjN64N.js";
import { r as handleModelsCommand } from "./commands-models-DA8R_1pr.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-TcvWUXXO.js";
import { t as codexChannelLoginRuntime } from "./provider-auth-login-flow-runtime-7Aw9lKPJ.js";
import { r as createExecTool } from "./bash-tools-G7u0FPco.js";
import { t as runBtwSideQuestion } from "./btw-BEUmEYsm.js";
import { a as loadCostUsageSummary, n as loadSessionCostSummary } from "./session-cost-usage-B4-lSLxY.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-DCZ-Dg-9.js";
import { b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-EfAebPpG.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, o as resolveRequesterSessionKey } from "./shared-CDVqqxdi.js";
import { t as buildToolsMessage } from "./status-5BY8hr8H.js";
import { n as resolveCommandSurfaceChannel, t as resolveChannelAccountId } from "./channel-context-LXnNxAGp.js";
import { t as handleApproveCommand } from "./commands-approve-Dlzo4xBK.js";
...
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-CvkDxzWA.js";
import { n as buildStatusReply, t as buildStatusPluginsReply } from "./commands-status-BuqqpjRj.js";
import { t as listConfiguredMcpServers } from "./mcp-config-DG4EnHtZ.js";
import { n as unsetConfiguredMcpServer, t as setConfiguredMcpServer } from "./mcp-config-mutation--6sUans-.js";
...
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-B5sf_ql3.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-quqdCrH2.js";
import { i as selectInstallMutationWriteOptions, r as resolveInstallConfigMutationPreflights } from "./install-persistence-fKw2c7NA.js";
import { r as resolvePluginInstallSourcePlan } from "./plugin-install-plan-BPxWVsBf.js";
import { n as createPluginInstallLogger } from "./plugins-command-helpers-Ck_Lz7c8.js";
import { t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-error-codes-OgrR1N6P.js";
import "./clawhub-CmnpDbJM.js";
import { i as installManagedPluginSource } from "./management-service-CI5arjGp.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-BKhTz_wy.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-CcA9FJGL.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-65JHK3vn.js"));
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CrBRzRMQ.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-CcAHyYhO.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-BO0LdeQ2.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-CT1qr3Gt.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-mHqPOozW.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-Ca_k-sUu.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-D-H-EqLg.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-BZovMoJS.js"));
