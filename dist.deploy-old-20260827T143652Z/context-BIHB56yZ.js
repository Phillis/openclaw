...
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, m as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-CiE104ur.js";
...
import { a as computeSandboxBrowserConfigHash, t as resolveDockerEnvPolicyEpoch } from "./sanitize-env-vars-usKvNdJt.js";
...
import { i as slugifySessionKey, n as resolveSandboxAgentId, r as resolveSandboxWorkspaceLayoutPaths, t as buildSandboxContainerName } from "./shared-Ca08a7jf.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-K0PUWhhE.js";
import { g as assertSshSandboxSecretOwnerAvailable } from "./ssh-backend-CEwI-fcE.js";
import { i as startBrowserBridgeServer, l as requireSandboxBackendFactory, n as stopCachedBrowserBridge, r as stopCachedBrowserBridgesForContainer, s as getSandboxBackendWorkdirResolver, t as BROWSER_BRIDGES } from "./browser-bridges-CXdYXPTh.js";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [syncWorkspaceSkills, { getRemoteSkillEligibility }, { resolveNodeExecEligibility }] = await Promise.all([
			...
			import("./remote-CG3K8RoH.js"),
			import("./exec-defaults-BRO5NgyY.js")
		]);
...
async function resolveProvisionedSandboxContext(params, resolved) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-gsN1kB_z.js")).maybePruneSandboxes(cfg);
