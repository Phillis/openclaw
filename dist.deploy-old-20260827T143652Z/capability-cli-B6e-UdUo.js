...
import { b as updateAuthProfileStoreWithLock, d as loadAuthProfileStoreForRuntime } from "./store-2zwMbXSG.js";
...
import { s as resolveApiKeyForProviderCore } from "./model-auth-Dv8Z8nNS.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-CMo6Emvk.js";
import { n as normalizeSpeechProviderId } from "./provider-registry-core-DL1pv3pg.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-DlYdAAS-.js";
...
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-lu5yQFl9.js";
import { r as listRegisteredMemoryEmbeddingProviderAdapters } from "./memory-embedding-provider-runtime-DhdVX9jH.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-DEASLl57.js";
...
import { c as buildMediaUnderstandingRegistry } from "./defaults.constants-B2xBnbcf.js";
import { h as getTtsCommandSecretTargetIds, i as getCapabilityWebFetchCommandSecretTargets, l as getMemoryEmbeddingCommandSecretTargetIds, o as getCapabilityWebSearchCommandSecretTargets, u as getModelsCommandSecretTargetIds } from "./command-secret-targets-BFmcuBAX.js";
import { _ as setTtsProvider, g as setTtsPersona, l as listSpeechVoices, m as setTtsEnabled, s as resolveExplicitTtsOverrides, t as getTtsProvider } from "./runtime-api-Bl-e-uE6.js";
import { n as textToSpeech } from "./tts-D0461XUk.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CABPV7uF.js";
import { i as listWebSearchProviders, n as isWebSearchProviderConfigured, o as runWebSearch } from "./runtime-BBAKqoHG.js";
...
import { i as resolveWebFetchDefinition, n as isWebFetchProviderConfigured, r as listWebFetchProviders } from "./runtime-BpX6YvQz.js";
...
import { c as transcribeAudioFile, i as describeVideoFile, o as prepareImageDescriptionInput, r as describePreparedImageWithModel, t as describeImageFile } from "./runtime-Ji2acYe5.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-DLDuWN1e.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-FbL1iggb.js");
...
function registerModelCapabilityCommands(capability) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-CiNo2q1b.js");
