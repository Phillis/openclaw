...
import { a as parseSystemAgentOperation, n as describeSystemAgentPersistentOperation, s as isInvalidConfigSetOperation } from "./operations-nR44JMF_.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-DbloRiBd.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
