...
import { n as isPreparedModelCatalogFull } from "./prepared-model-runtime.facts-B3rCoKug.js";
import { i as getPreparedModelFullCatalogAuth } from "./prepared-model-catalog-worker-DMev8Ty5.js";
import { c as prepareModelRuntimeSnapshot, i as getPreparedModelRuntimeSnapshot, n as acquireReadOnlyPreparedModelRuntime, p as preparedModelRuntimeConfigsMatch, r as activateStandalonePreparedModelRuntime, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-BIRJocb0.js";
import { n as prepareScopedReadOnlyModelCatalog, t as prepareScopedReadOnlyLiveModelCatalog } from "./prepared-model-runtime.scoped-catalog-B2FAz9_s.js";
import { i as normalizeThinkingCatalogProviders, n as hasResolvedThinkingCatalogEntry } from "./thinking-runtime-F3zRbZ0D.js";
...
async function loadProviderScopedThinkingCatalog(params) {
	const { loadManifestModelCatalog } = await import("./model-catalog-DShfYXIs.js");
...
async function loadPreparedModelCatalogSnapshot(params = {}) {
	...
	return (params.allowPublishedConfigReplacement ? await loadPublishedPreparedModelCatalogOwnerSnapshot(params) : await loadPreparedModelCatalogOwnerSnapshot(params)).modelCatalog;
}
