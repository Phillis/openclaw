 ...
 */
declare function enableProviderPluginInConfig<TConfig extends ProviderEnableConfigCarrier>(/** Provider setup config object to update without channel normalization. */

cfg: TConfig, /** Provider plugin id to enable and allowlist. */

pluginId: string): PluginEnableResult<TConfig>;
//#endregion
export { enableProviderPluginInConfig as t };