...
import { n as clearRuntimeAuthProfileStoreSnapshot } from "./store-2zwMbXSG.js";
...
const loadAuthChoiceModule = createLazyRuntimeModule(() => import("./auth-choice-CxY5lLor.js"));
const loadModelPickerModule = createLazyRuntimeModule(() => import("./model-picker-DzUqppbw.js"));
...
async function runSetupModelAuthStep(params) {
	...
	while (true) {
		...
		if (authChoice === "custom-api-key") {
			const { promptCustomApiConfig } = await import("./onboard-custom-xAGDYomW.js");
...
const loadMigrationProviderRuntimeModule = createLazyRuntimeModule(() => import("./migration-provider-runtime-DyP9bPLk.js"));
