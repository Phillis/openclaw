...
import { x as runTui } from "./tui-BDze6mpN.js";
...
import { i as hasAuthProfileForProvider } from "./model-config.helpers-DYkjBJH5.js";
import { r as listConfiguredWebSearchProviders } from "./runtime-BBAKqoHG.js";
...
async function startSessionGatewayForOnboarding(params) {
	...
	try {
		const { startGatewayServer } = await import("./server-wAIx4_CB.js");
...
const loadSearchSetupModule = createLazyRuntimeModule(() => import("./search-setup-D2xhd1jr.js"));
...
async function finalizeSetupWizard(options) {
	...
	try {
		...
		const [{ resolveDefaultModelAuthStatus, resolveDefaultModelCatalogFacts }, { loadPreparedModelCatalogSnapshot }] = await Promise.all([import("./auth-choice-CxY5lLor.js"), import("./prepared-model-catalog-DGTgNwqR.js")]);
