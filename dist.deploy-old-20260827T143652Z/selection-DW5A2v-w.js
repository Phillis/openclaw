...
import { i as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-DoD-DaGs.js";
import { t as resolveAgentHarnessAutoSelectionHint } from "./auto-selection-Br-mlD8Y.js";
import { c as compareHarnessSupport, l as resolveAgentHarnessPreparedAuthSupport, s as buildAgentHarnessSupportContext, u as resolveAgentHarnessPreparedRouteSupport } from "./thinking-runtime-F3zRbZ0D.js";
...
import { n as isBuiltInOpenClawAgentHarness, t as createOpenClawAgentHarness } from "./builtin-openclaw-FyAH3ReK.js";
...
import { i as EmptySettledTurnFinalizationError, t as assertSettledTurnFinalizationResult } from "./settled-turn-finalization-result-CMMztFBa.js";
...
async function runSelectedAgentHarnessAttempt(params) {
	...
	if (internalParams.systemAgentTool && !isSystemAgentOnlyAllowlist(internalParams.toolsAllow)) throw new Error("OpenClaw host authority requires toolsAllow: [\"openclaw\"]");
	const ringZeroTools = internalParams.systemAgentTool ? [(await import("./system-agent-tool-D_1p418T.js")).createSystemAgentTool(internalParams.systemAgentTool)] : [];
