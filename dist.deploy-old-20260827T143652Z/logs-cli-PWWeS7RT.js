...
import { f as resolveRedactOptions, s as redactSensitiveLines } from "./redact-Cl7lwBnl.js";
...
import { i as formatTimestamp } from "./json-console-line-DT9WEeLV.js";
...
import { a as buildGatewayConnectionDetails, h as isGatewayTransportError } from "./call-D4XcT41c.js";
import { n as projectGatewayConnectionDetailsForDiagnostics } from "./connection-details-BsRSnf71.js";
...
async function emitGatewayError(err, opts, mode, rich, emitJsonLine, errorLine) {
	...
	const details = projectGatewayConnectionDetailsForDiagnostics(buildGatewayConnectionDetails({ url: opts.url }));
	if (mode === "json") {
		if (!emitJsonLine({
			type: "error",
			message,
