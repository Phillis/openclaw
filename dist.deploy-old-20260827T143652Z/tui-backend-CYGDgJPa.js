...
import { o as resolveSystemAgentVerifiedInferenceState } from "./verified-inference-CcE6I3BD.js";
import { t as executeSystemAgentOperation } from "./operations-nR44JMF_.js";
...
import { t as SystemAgentChatEngine } from "./chat-engine-R8WRBL1s.js";
...
async function runSetupHandoff(handoff, opts, runtime) {
	...
	await (opts.runChannelsAdd ?? (await import("./add-D17ugktx.js")).channelsAddCommand)(handoff.channel ? { channel: handoff.channel } : {}, runtime, {
		hasFlags: false,
...
async function runSystemAgentTui(opts, runtime) {
	...
	for (;;) {
		...
		const runTui = boundOpts.runTui ?? (await import("./tui-BO4Q9oYD.js")).runTui;
		try {
			await runTui({
				local: true,
...
async function requireTuiVerifiedInference(opts) {
	...
	try {
		...
		if (verified) {
			...
			const [{ getPreparedModelCatalogSnapshot }, { resolveThinkingDefault }] = await Promise.all([import("./prepared-model-catalog-DGTgNwqR.js"), import("./model-thinking-default-B2XhNHdp.js")]);
