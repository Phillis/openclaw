...
import { i as resolvePluginSetupRegistry, r as resolvePluginSetupProviderCore } from "./setup-registry-DxR0jJ50.js";
...
import { n as clearAuthProfileCooldown } from "./usage-B18_XzAh.js";
...
import { o as removeProviderAuthProfilesWithLock, r as promoteAuthProfileInOrder, u as upsertAuthProfileWithLockOrThrow } from "./profiles-C-iqv9vt.js";
import "./workspace-CiE104ur.js";
import { n as stylePromptMessage } from "./prompt-style-BQVvtDcR.js";
import { t as isRemoteEnvironment } from "./remote-env-CEqMOcgu.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-XpVDMGbE.js";
...
import { a as resolveKnownAgentId, l as updateConfig, r as loadValidConfigOrThrow } from "./shared-BmUAvHoe.js";
import { r as repairCodexRuntimePluginInstallForModelSelection } from "./codex-runtime-plugin-install-B12xkK7A.js";
import { n as repairCopilotRuntimePluginInstallForModelSelection } from "./copilot-runtime-plugin-install-B3Q4FlF5.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: params.openUrl ?? (async (url) => {
			const { openUrl } = await import("./onboard-helpers-B2IyzQ1N.js");
			await openUrl(url);
		}),
