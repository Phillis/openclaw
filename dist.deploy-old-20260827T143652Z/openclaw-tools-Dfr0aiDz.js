...
import { dt as stripInboundMetadata, ut as hasInboundMetadataSentinel } from "./openclaw-state-db-DlCMR4eQ.js";
...
import { a as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-D6JF4H4-.js";
...
import { A as getPreparedMessageToolCatalog, d as getActivePluginRegistry } from "./runtime-g0R28Sy0.js";
import { D as listMediaGenerationProviderModels, O as synthesizeMediaGenerationCatalogEntries } from "./loader-DNWV84an.js";
...
import { i as GatewayTransportError } from "./call-D4XcT41c.js";
...
import { o as getModelProviderRequestTransport } from "./provider-request-config-DRrgUN7e.js";
...
import { $t as loadSessionEntryReadOnly, It as patchSessionEntryWithKey, Qt as loadSessionEntry, Rt as resolveSessionEntryCandidateTarget, at as getCliSessionBinding, pn as runWithoutOwnedSessionTranscriptWrites } from "./session-accessor-Bi6bzKQE.js";
import { i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-B3yYjPW1.js";
...
import { U as getCurrentSessionWorkAdmissionRelease, W as getSessionWorkAdmissionRelease } from "./agent-harness-session-key-BMj1lPtX.js";
import { K as isEmbeddedMode, Y as listAllChannelSupportedActions, Z as listChannelSupportedActions, g as hasRunWorkspaceSkillUsage, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-C_MzhwYQ.js";
...
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-D4zJxL0d.js";
import { r as resolvePluginCapabilityProvider, t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BthPmmHE.js";
import { c as getPreparedPluginRuntimeLoadContext } from "./prepared-model-runtime.facts-B3rCoKug.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-Df_qhWv_.js";
import { r as resolveProviderTransportSsrFPolicy } from "./provider-transport-fetch-Ckuk8E02.js";
import { c as getImageMetadata } from "./image-ops-CuoBGLvn.js";
import { Y as formatFullOutputFooter, mt as writePrivateTempFile, st as getModelRegistryRuntime } from "./sessions-DVC_3nXc.js";
import { a as bindModelLlmRuntime, t as complete } from "./stream-DUxdKJ02.js";
...
import { d as saveMediaBuffer, i as deleteMediaBuffer } from "./store-CNsqBmYb.js";
import { i as normalizeMediaReferenceSource, r as classifyMediaReferenceSource } from "./media-reference-BeABx1cr.js";
import { o as resolveBundledStaticCatalogModel, t as bundledStaticCatalogProviderUsesRuntimeAugment } from "./model.static-catalog-ClfVWjD2.js";
import { o as requireApiKey } from "./model-auth-runtime-shared-C48YoQY0.js";
import { i as loadPreparedModelCatalog } from "./prepared-model-catalog-lswR6K7d.js";
...
import { t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-BIRJocb0.js";
...
import { r as getCustomProviderApiKey } from "./model-auth-provider-config-BoRNjJxC.js";
import { c as createRuntimeProviderAuthLookup, i as getApiKeyForModelCore, l as hasRuntimeAvailableProviderAuth, r as applySecretRefHeaderSentinels, s as resolveApiKeyForProviderCore } from "./model-auth-Dv8Z8nNS.js";
...
import { c as listSessionStateEventsSince, i as getSessionStateVersions, r as getSessionStateVersion } from "./session-state-events-C74I5OQg.js";
import { E as listTaskRecordsUnsorted } from "./task-registry-DrR4kwK-.js";
import { et as isTerminalTaskStatus } from "./task-registry-activity-CRGhk-1D.js";
import { s as stripPlainTextToolCallBlocks } from "./src-Rlms7fwG.js";
import { n as formatTaskStatusDetail, o as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-BKh-iCi1.js";
import "./runtime-internal-JVnCI_tz.js";
import { t as cancelDetachedTaskRunById } from "./task-executor-C_bCFvCs.js";
import { d as clearGeneratedMediaTaskActivity, f as registerGeneratedMediaTaskActivity } from "./task-status-access-DQT3wrnW.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-CSvDMf1K.js";
import { t as resolveRequiredCompletionDeliveryFailureTerminalResult } from "./task-completion-contract-BJW3TUQJ.js";
import { _ as getSessionGoal, b as updateSessionGoalStatus, h as createSessionGoal, p as MODEL_UPDATABLE_SESSION_GOAL_STATUSES } from "./sessions-D-jhKYGW.js";
import { v as capArrayByJsonBytes } from "./session-transcript-readers-CJcK7eRo.js";
import { i as resolveSessionModelIdentityRef } from "./placement-session-runtime-CnsNIn7H.js";
import { s as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-CnYv36nn.js";
import { P as deriveSessionTitle, c as readSessionTitleFieldsFromTranscriptAsync } from "./session-utils-row-CB3Fore5.js";
...
import { n as loadWebMedia, r as loadWebMediaRaw } from "./web-media-Dk8VJTPc.js";
...
import { S as isToolWrappedWithBeforeToolCallHook, i as resolveMessageActionAgentRuntimeIdentityToken, m as setToolTerminalPresentation, n as readGatewayCallOptions, r as resolveGatewayOptions, s as createGatewayToolCallerWrapper, t as callGatewayTool } from "./gateway-IJRNg5Ul.js";
import { t as normalizeConversationReadInvocationOrigin } from "./conversation-read-origin-E3olMOwo.js";
import { a as resolvePluginTools, o as setPluginToolMeta } from "./tools-tey_1PC-.js";
...
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, s as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BKLI5Kq9.js";
import { t as resolveSkillWorkshopConfig } from "./config-Cjp42tXL.js";
import { K as stripProposalFrontmatterForSkill } from "./store-B2Ee7vWz.js";
import { c as readSkillProposalTargetTreeSha256 } from "./proposal-draft-CjHlAtkv.js";
import { a as proposeUpdateSkill, c as reviseSkillProposal, f as inspectSkillProposal, i as proposeCreateSkill, l as evaluateSkillProposal, m as resolvePendingSkillProposal, n as applySkillProposal, o as quarantineSkillProposal, p as listSkillProposals, r as composeSkillBodyPatch, s as rejectSkillProposal, t as SkillProposalStaleTargetError } from "./service-DLIuaV-6.js";
import { i as readWritableWorkspaceSkill } from "./workspace-skill-read-qxU-3GeX.js";
...
import { a as resolveAllowedMessageActions, s as shouldApplyCrossContextMarker } from "./outbound-policy-27cK4DQD.js";
...
import { a as screenSnapshotTempPath, c as cameraTempPath, d as resolveCameraClipTarget, f as resolveCameraSnapTargets, h as mediaPathMatchesFormat, i as screenSnapshotFormatForPath, l as parseCameraClipPayload, m as writeCameraPayloadToFile, n as parseScreenSnapshotPayload, o as writeScreenRecordToFile, p as writeCameraClipPayloadToFile, r as screenRecordTempPath, s as writeScreenSnapshotToFile, t as parseScreenRecordPayload, u as parseCameraSnapPayload } from "./nodes-screen-CLaPtzVW.js";
import { s as resolveActionDeliveryTargetAlias } from "./channel-target-CcCiXRbC.js";
import { a as optionalPositiveIntegerSchema, i as optionalNonNegativeIntegerSchema, n as channelTargetsSchema, o as optionalStringEnum, r as optionalFiniteNumberSchema, s as stringEnum, t as channelTargetSchema } from "./typebox-BXRXV_Ve.js";
import { i as gatewayCallOptionSchemaProperties, t as createCronTool } from "./cron-tool-DXTCVur6.js";
import { i as resolveEligibleNodeFromList, n as resolveAgentNode, r as resolveAgentNodeId, t as listNodes } from "./nodes-utils-Cg_2WHHU.js";
...
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-CSyQeVBK.js";
import { n as abortable } from "./abortable-DUrt_uFK.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-DkfKmiZP.js";
import { _ as parseJsonMessageParam, g as parseInteractiveParam } from "./source-reply-mirror-F_ntpYtq.js";
import { o as extractEmbeddedAssistantText } from "./embedded-agent-utils-c5haLV7t.js";
import { t as registerProviderStreamForModel } from "./provider-stream-BFEARmwd.js";
import { a as loadRequesterSessionEntry, f as formatGeneratedAttachmentLines, m as sanitizeGeneratedMediaDisplayText, p as mediaUrlsFromGeneratedAttachments, r as resolveAnnounceOrigin, t as deliverSubagentAnnouncement, u as formatAgentInternalEventsForPrompt } from "./subagent-announce-delivery-CLJYMf5M.js";
import { u as wrapToolWorkspaceRootGuardWithOptions } from "./agent-tools.read-DmQSuo3o.js";
import { r as listConnectedNodePluginTools } from "./node-plugin-tool-snapshot-CtaKhxdi.js";
import { t as resolveAgentRuntimeToolConfig } from "./tool-runtime-config-BGeyMulU.js";
import { a as hasProviderAuthForTool, c as resolveOpenAiImageMediaCandidate, n as coerceToolModelConfig, o as hasToolModelConfig$1, r as hasAuthForProvider, s as resolveDefaultModelRef, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-DYkjBJH5.js";
...
import { a as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-BVazrsUD.js";
import { t as resolveTranscriptsConfig } from "./config-UoehNruw.js";
import { a as resolveCapabilityModelCandidates, d as findCapabilityProviderById, f as resolveCapabilityModelRefForProviders, i as recordCapabilityCandidateFailure, n as buildNoCapabilityModelConfiguredMessage, r as normalizeDurationToClosestMax, t as buildMediaGenerationNormalizationMetadata, u as throwCapabilityGenerationFailure } from "./runtime-shared-DE1lp4EM.js";
import { n as normalizeMediaProviderId } from "./provider-id-DSbuCFIb.js";
import { t as createAgentsWaitTool } from "./agents-wait-tool-DQ0MvHfP.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-Mtb_s-wH.js";
import { _ as resolveSubagentAllowedTargetIds } from "./subagent-spawn-ownership-DrVAQtiI.js";
import { n as listRuntimeImageGenerationProviders, r as resolveImageGenerationMaxInputImages, t as generateImage } from "./runtime-DEASLl57.js";
import { a as listMusicGenerationProviders, n as getMusicGenerationProvider, s as parseGenerationModelRef } from "./registry-BwWBiKmZ.js";
import { n as hasMediaNormalizationEntry } from "./geometry-normalization-Fq4-s3Vq.js";
import { n as resolveChannelInboundAttachmentRootsForChannel } from "./channel-inbound-roots-E49RyguK.js";
import { t as runWithImageModelFallback } from "./model-fallback-image-BA3ZJwLU.js";
import { i as readResponseBodySnippet, n as isMinimaxVlmProvider } from "./minimax-vlm-DW5Mieub.js";
import { c as postJsonRequest, m as resolveProviderHttpRequestConfigWithOriginTrust } from "./shared-BEAvjECH.js";
import { a as resolveConfiguredImageModelRefs, i as hasImageReasoningOnlyResponse, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, t as coerceImageAssistantText } from "./image-tool.helpers-YbGtoyEn.js";
import { t as removeCronRunContinuationSessionIfIdle } from "./cron-run-continuation-cleanup-CtVa1PC1.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-Bf-ic8nE.js";
import { n as resolveMessageBroadcastAccountPlan, r as validateExplicitMessageAccountSelection } from "./message-account-selection-CcvDN_PR.js";
import { r as sourceDeliveryTargetsMatch } from "./source-delivery-plan-D53JVwm5.js";
import { i as resolveDocumentMediaModel, n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-BSchnCIL.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-vSAja5v-.js";
import { a as DEFAULT_TIMEOUT_SECONDS, c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-B2xBnbcf.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-xJvrDBVt.js";
import { c as resolveTimeoutMs } from "./resolve-DkKfLQ8n.js";
import "./media-understanding-BHtdVlkB.js";
import { n as runtimeWebSecretOwnerId } from "./runtime-web-tools-CgikF9aq.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-B0LkX-fw.js";
import { t as resolveEnabledBundledManifestContractPlugins } from "./bundled-manifest-contract-plugins-DR3fjs6c.js";
import { f as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-BFmcuBAX.js";
import { t as resolveMessageSecretScope } from "./message-secret-scope-BI5om_KV.js";
import { i as SHARED_POLL_CREATION_PARAM_NAMES, n as runMessageAction, r as POLL_CREATION_PARAM_DEFS, t as getToolResult } from "./message-action-runner-DIG6_wy9.js";
...
import { t as extractPdfContent } from "./pdf-extract-CUDoVnTk.js";
import { t as triggerSessionPatchHook } from "./session-patch-hooks-CuzKhV90.js";
import { t as applyModelOverrideWithAuthProfileCompatibility } from "./auth-profile-preservation-C5lGCLWm.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-BIpiPL3j.js";
import { a as runWithScopedSessionAccess, i as resolveSessionToolTargetAgentId, r as createSessionsSendTool, t as createSessionsSpawnTool } from "./sessions-spawn-tool-C3qtEekj.js";
import { r as withAgentSessionModelPatchOrigin } from "./session-model-patch-origin-QhYZUKaz.js";
import { n as reconcileSkillCollection, o as MAX_RECONCILED_SKILL_BYTES, r as restoreLatestSkillCollectionBackup } from "./collection-reconcile-Bb1abTiF.js";
...
import { n as createTranscriptsTool } from "./transcripts-tool-BF3lU4Ut.js";
import { n as textToSpeech } from "./tts-D0461XUk.js";
import { n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-CABPV7uF.js";
...
import { n as resolveWebSearchToolRuntimeContext, t as resolveWebFetchToolRuntimeContext } from "./web-tool-runtime-context-ByfjRegH.js";
import { o as runWebSearch } from "./runtime-BBAKqoHG.js";
import "./web-search-provider-common-BU-TfdKe.js";
...
function createRequesterYieldCallback(params) {
	...
	return async () => {
		const { markRequesterTurnYielded } = await import("./subagent-registry-DlEQRaPt.js");
...
async function loadImageWebMediaRuntime() {
	return await import("./web-media-DgjmcUn-.js");
}
const resolveModelAsyncDefault = async (...args) => {
	const { resolveModelAsync } = await import("./model-Ctc13JMv.js");
...
async function lookupTaskByRunIdForChildSession(runId, childSessionKey) {
	const { findTaskByRunIdForChildSessionForStatus } = await import("./task-status-access-MUBAzX3Q.js");
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-d3k3DEx2.js"));
