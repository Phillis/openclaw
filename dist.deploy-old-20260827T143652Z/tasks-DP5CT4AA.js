...
import { w as listTaskRecordPage, x as getTaskById } from "./task-registry-DrR4kwK-.js";
...
import { i as retrySubagentCompletionDelivery, n as dismissSubagentCompletionDelivery } from "./subagent-completion-delivery-s-G8kBsp.js";
...
const tasksHandlers = {
	...
	"tasks.dismiss": async ({ params, respond }) => {
		...
		const { discardSubagentTerminalDelivery } = await import("./subagent-registry-DlEQRaPt.js");
		const results = [];
		for (const taskId of params.taskIds) {
