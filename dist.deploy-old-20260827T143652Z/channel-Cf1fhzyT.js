...
import { a as checkZcaAuthenticated, c as resolveZalouserAccountSync, i as writeQrDataUrlToTempFile, o as listZalouserAccountIds, r as zalouserSetupContract, s as resolveDefaultZalouserAccountId, t as createZalouserSetupWizardProxy } from "./setup-core-BhRoyl_r.js";
...
const loadZalouserChannelRuntime$1 = createLazyRuntimeModule(() => import("./channel.runtime-CaZWoR-l.js"));
...
const loadZalouserChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-CaZWoR-l.js"));
const zalouserSetupWizardProxy = createZalouserSetupWizardProxy(async () => (await import("./setup-surface-DHaDmic6.js")).zalouserSetupWizard);
	...
	base: {
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				const { monitorZalouserProvider } = await import("./monitor-CXnjX0oy.js");
