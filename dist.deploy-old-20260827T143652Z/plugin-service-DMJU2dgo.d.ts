import { D as OpenClawPluginService, wt as AnyAgentTool } from "./plugin-entry-BvodcAaE.js";
import { r as GatewayRequestHandlers } from "./types-WpPwqCDX.js";
import { f as BrowserTab, l as BrowserGraphicsDiagnostics, m as BrowserTransport, n as ResolvedBrowserConfig, r as ResolvedBrowserProfile, t as ManagedBrowserHeadlessSource, u as BrowserOpenResult } from "./config-CuUAQuKO.js";
import { t as BrowserExecutable } from "./sdk-setup-tools-DeIcctYZ.js";
...
type BrowserProfileCapabilities = {
  ...
  isRemote: boolean; /** Browser process reads paths from the same filesystem as OpenClaw. */
  browserFilesystemLocal: boolean; /** Profile uses the Chrome DevTools MCP server (existing-session driver). */
...
type ExtensionRelayHandle = {
  port: number;
  token: string;
  allowLegacyAuth: boolean; /** Process-only Basic credential for OpenClaw's own CDP client. Never persisted or printed. */
