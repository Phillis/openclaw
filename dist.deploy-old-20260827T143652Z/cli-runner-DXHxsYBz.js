...
import { en as patchSessionEntryCore } from "./session-accessor-Bi6bzKQE.js";
import { d as loadAuthProfileStoreForRuntime } from "./store-2zwMbXSG.js";
import { a as markAuthProfileFailure } from "./usage-B18_XzAh.js";
...
import { a as resolveCliRuntimeOwnerFingerprint, i as resolveCliRuntimeArtifactFingerprint } from "./cli-auth-epoch-yI9pdzGX.js";
import { c as isFailoverError, d as isTimeoutError, i as coerceToFailoverError, u as isSignalTimeoutReason } from "./failover-error-EKvoWJQa.js";
import { n as appendExactAssistantMessageToSessionTranscript } from "./transcript-DcKMk0pM.js";
...
import { d as waitForDeferredTurnMaintenanceForSession, i as bootstrapHarnessContextEngine, l as runHarnessContextEngineMaintenance, n as runAgentEndSideEffects, s as finalizeHarnessContextEngineTurn, t as awaitAgentEndSideEffects } from "./agent-end-side-effects-Ic4K8Doi.js";
import { b as resolveExplicitFinalSourceReplyDeliveryEvidence } from "./delivery-evidence-B9g3AV3B.js";
...
import { a as runAgentHarnessLlmInputHook, o as runAgentHarnessLlmOutputHook, s as buildAgentHookContext } from "./lifecycle-hook-helpers-BIigCxgL.js";
...
import { u as hashCliReseedPrompt } from "./cli-session-history.claude-Bji3khcL.js";
import { n as acceptsClaudeLive } from "./claude-live-session-policy-D5q03_Jx.js";
import { i as createCliFailoverError, n as getCliMessagingDeliveryEvidence, t as attachCliMessagingDeliveryEvidence } from "./delivery-evidence-DExFAnSS.js";
import { c as CliAuthProfilePreparationError, i as loadCliSessionHistoryMessages, r as loadCliSessionContextEngineMessages, s as buildAgentHookConversationMessages, u as claudeCliSessionTranscriptHasContent } from "./session-history-CL8yoNW1.js";
...
async function settlePreparedCliRun(params) {
	...
	if (runParams.cleanupCliLiveSessionOnRunEnd === true) try {
		const { closeClaudeSession } = await import("./claude-live-registry-CPuYd36Y.js");
		await closeClaudeSession(context, "restart");
	} catch (error) {
		recordCleanupError(error);
	}
	if (runParams.cleanupBundleMcpOnRunEnd === true) try {
		const { retireSessionMcpRuntime } = await import("./agent-bundle-mcp-tools-mt_SBcZe.js");
