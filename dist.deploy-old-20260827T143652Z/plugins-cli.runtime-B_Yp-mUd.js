...
const loadPluginsStatus = createModuleLoader(() => import("./status-DSmvDcwx.js"));
const loadPluginSlotSelection = createModuleLoader(() => import("./slot-selection-CZeXOwBA.js"));
...
async function runPluginMarketplaceRefreshCommand(opts) {
	...
	const { clearManagedPluginOfficialCatalogCache } = await import("./management-service-BI5MSkY2.js");
