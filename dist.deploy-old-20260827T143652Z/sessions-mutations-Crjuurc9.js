...
import { j as patchPluginSessionExtension } from "./loader-DNWV84an.js";
...
import { Tt as SessionLabelOwnerIndex, jt as applySessionEntryCanonicalReplacements, vn as isInternalSessionEffectsKey } from "./session-accessor-Bi6bzKQE.js";
import { K as interruptSessionWorkAdmissions, R as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS, X as runExclusiveSessionLifecycleMutation, m as resolveMissingAgentHarnessSessionError, q as isCompetingSessionWorkAdmissionActive } from "./agent-harness-session-key-BMj1lPtX.js";
...
import { D as waitForEmbeddedAgentRunEnd, d as isEmbeddedAgentRunInProgress, n as abortEmbeddedAgentRun } from "./runs-CS8YarJf.js";
...
import { n as projectSessionPatchResult } from "./session-utils-model-Cs1tFKI6.js";
import { N as resolveGatewaySessionStoreTargetWithStore, O as resolveCanonicalGatewaySessionStoreKey, g as disableCronJobsBoundToSessions, k as resolveCanonicalSessionEntryFromStoreKeys } from "./session-utils-row-CB3Fore5.js";
...
import { p as waitForChatAbortControllerRemoval } from "./chat-abort-Cm7ik-5J.js";
...
import { t as SessionMutationAuthorizationChangedError, v as gatewayClientSessionCreator } from "./session-sharing-B-QpnXEG.js";
import { n as emitSessionsChanged } from "./session-change-event-DHrQ1n_G.js";
import { i as hasGatewaySessionAbortOwner, r as createChatAbortOps, t as abortChatRunsForSessionKeyWithPartials } from "./chat-abort-runtime-D4kc6F0N.js";
...
import { d as resolveSessionWorkerPlacementPatchError, l as requireSessionKey, p as sessionLog, r as isAgentMainSessionKey, s as loadSessionsRuntimeModule } from "./sessions-shared-DCZ73m-J.js";
import { t as projectSessionsPatchEntry } from "./sessions-patch-CKDwTVLY.js";
import { n as ensureSessionGroupRegistered } from "./session-groups-BgNyXgWV.js";
import { t as appendSessionAudit } from "./session-audit-8HIgFyO_.js";
