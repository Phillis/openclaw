...
import { a as listAgentIds, d as resolveAgentWorkspaceDir, l as resolveAgentDir, p as resolveDefaultAgentId } from "./agent-scope-config-BdXMWufB.js";
...
import { n as externalCliDiscoveryForProviderAuth, r as externalCliDiscoveryForProviders } from "./external-cli-discovery-DM5kEN0f.js";
import { t as createModelAuthAvailabilityResolver } from "./model-auth-availability-Dyvw2mjU.js";
import { a as hasAvailableAuthForProvider, c as createRuntimeProviderAuthLookup, l as hasRuntimeAvailableProviderAuth } from "./model-auth-Dv8Z8nNS.js";
...
async function buildCurrentProviderAuthStateSnapshot(cfg, options = {}) {
	...
	for (const agentId of listAgentIds(cfg)) {
		...
		const { loadPreparedModelCatalogOwnerSnapshot } = await import("./prepared-model-catalog-DGTgNwqR.js");
