...
import { n as createChannelApproverDmTargetResolver, r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-N_oyD4DW.js";
import { n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-DQn-E3bv.js";
...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-NQZ48Kwo.js";
...
import { g as scopeKey, h as resolveScopeToolsPolicy, m as resolveScopeRequireMention } from "./channel-policy-DlGVx39H.js";
...
import { c as resolveDiscordAccountAllowFrom, i as listEnabledDiscordAccounts, o as resolveDefaultDiscordAccountId, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-B99sjC_p.js";
import { t as getDiscordRuntime } from "./runtime-Dg4d9hPu.js";
import { t as parseDiscordTarget } from "./target-parsing-BCrLMCew.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-CFs0Glog.js";
import "./channel-api-CWlbI7Qw.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-2qf9cpbr.js";
import { u as withAbortTimeout } from "./timeouts-BTHN67kZ.js";
import { i as shouldSuppressLocalDiscordExecApprovalPrompt, n as isDiscordExecApprovalApprover, r as isDiscordExecApprovalClientEnabled, t as getDiscordExecApprovalApprovers } from "./exec-approvals-DdberbEE.js";
import { t as shouldHandleDiscordApprovalRequest } from "./approval-shared-Cxg1tEJR.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-CGiXR42_.js";
import { t as discordMessageActions$1 } from "./channel-actions-D2WRIphs.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-CT3fAIh9.js";
import { r as openDiscordCommandDeployHashStore } from "./command-deploy-store-DFkBTViB.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-B4IZ_2j2.js";
import { n as discordOutbound } from "./outbound-adapter-C9xS6WiQ.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupContract, t as createDiscordPluginBase } from "./shared-CfYXVo4u.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-BayBUkaD.js")).discordApprovalNativeRuntime
		})
	});
}
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BU0RaoYo.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-CtKoZIC3.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-C-M3ivc5.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-DC2ZCR3c.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-CjD5FTPq.js"));
const loadDiscordProviderRuntime = createLazyRuntimeModule(() => import("./provider.runtime.js"));
const loadDiscordProbeRuntime = createLazyRuntimeModule(() => import("./probe.runtime-CldSdmHn.js"));
...
const loadDiscordAuditModule = createLazyRuntimeModule(() => import("./audit-BB3EwsUr.js"));
const loadDiscordSendModule = createLazyRuntimeModule(() => import("./send-CX3WdC8x.js"));
const loadDiscordDirectoryLiveModule = createLazyRuntimeModule(() => import("./directory-live-D_Y2qZis.js"));
//#endregion
