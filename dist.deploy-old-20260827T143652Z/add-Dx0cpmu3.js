...
import { c as shouldUseWizard } from "./shared-CZGTSdKU.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CsXd1oui.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-BdT43qEq.js"));
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		...
		const { resolveInitialWizardChannel, runChannelsAddWizardFlow } = await import("./add-wizard-DApZkDQk.js");
