...
import { R as resolveSessionTranscriptActiveLeafEntryId, sn as resolveSessionKeyBySessionId, x as isSessionTranscriptProjectionUnavailableError } from "./session-accessor-Bi6bzKQE.js";
...
import { E as loadGatewaySessionEntryReadOnly, T as loadGatewaySessionEntry, v as resolveCurrentUserProfileDisplay, w as listAgentsForGateway } from "./session-utils-row-CB3Fore5.js";
import { n as tryResolveSessionCompatibilityOwnerAgentId } from "./session-request-agent-BeVvXvOY.js";
import { i as buildGatewaySessionInfo } from "./session-utils-list-DQ6H7aPd.js";
...
import { r as boundInFlightRunSnapshotForChatHistory, u as resolveInFlightRunSnapshot } from "./chat-abort-Cm7ik-5J.js";
...
import { a as resolveClaudeCliBindingSessionId } from "./cli-session-history.claude-Bji3khcL.js";
import { n as resolveChatHistoryWithCliSessionImports } from "./cli-session-history-CLdyuOkb.js";
import { c as augmentChatHistoryWithCanvasBlocks, i as projectRecentChatDisplayMessages, n as projectChatDisplayMessages, o as dropPreSessionStartAnnouncePairs, s as isHeartbeatHistoryTurnBoundaryMessage, t as projectChatDisplayMessage, u as resolveEffectiveChatHistoryMaxChars } from "./chat-display-projection-CHZEyvHW.js";
import { r as resolveGatewayChatCronCreatorAuthorityAdmission, t as createAgentTurnService } from "./agent-turn-service-CivZuHPA.js";
import { i as resolveVisibleActiveSessionRunState } from "./session-active-runs-DKnYoEyq.js";
import { P as normalizeOptionalChatText, s as appendAssistantTranscriptMessage, w as scheduleChatHistoryManagedMediaCleanup } from "./chat-abort-runtime-D4kc6F0N.js";
import { t as assertValidParams } from "./validation-CsGeElrb.js";
import { i as validateChatSelectedAgent, o as resolveGlobalAwareNodeChatDeliveryKeys, r as resolveRequestedChatAgentId, s as sendGlobalAwareNodeChatPayload, t as handleChatSend } from "./chat-send-handler-8-IJ9Sou.js";
import { a as prepareSessionWorkspaceIcon } from "./workspace-icon-http-D-sRRCQL.js";
import { t as resolveAgentIdOrRespondError } from "./agent-id-shared-uNTkOYt3.js";
import { i as resolveSessionHistoryTailReadOptions } from "./session-history-state-Bc5mIzrw.js";
...
const chatHandlers = {
	...
	"chat.toolTitles": async ({ params, respond, context }) => {
		...
		const { generateToolCallTitles } = await import("./chat-tool-titles-WfW2pkHf.js");
