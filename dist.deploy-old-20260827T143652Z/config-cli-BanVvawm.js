...
import { H as isConfigSetJsonParseOnly, V as isConfigMachineOutput } from "./argv-CgA2urTO.js";
...
import { b as tryResolveLegacyCompatibilityAgentId, i as listAgentEntriesWithSource, n as hasAgentRosterProperty, r as listAgentEntries } from "./agent-scope-config-BdXMWufB.js";
import { $ as AUTO_MANAGED_CONFIG_META_PATHS, I as collectUnsupportedSecretRefPolicyIssues, M as validateConfigObjectRawWithPlugins, l as readConfigFileSnapshot } from "./io-CeQckj5v.js";
...
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-BSy9FczT.js";
...
import { a as isPluginIntegrationSecretProviderConfig, n as resolveSecretRefValue, s as resolveSecretProviderIntegrationConfig } from "./resolve-DLWDJoF2.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-query-Cu36BxFQ.js";
import "./target-registry-UxdnmGQF.js";
import { a as success, n as info, o as warn, t as danger } from "./globals-CAwGc4B6.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CX-ZzfJ5.js";
...
async function createRuntimeModelRefResolver() {
	const [agentScope, modelSelection] = await Promise.all([import("./agent-scope-B7ocz6pI.js"), import("./model-selection-CZ8Mp5_N.js")]);
	const preparedByAgent = /* @__PURE__ */ new Map();
	let modelModules;
	const loadModelModules = () => modelModules ??= Promise.all([import("./model-Ctc13JMv.js"), import("./prepared-model-catalog-DGTgNwqR.js")]);
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", collectOption, []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-CF0yPh13.js");
