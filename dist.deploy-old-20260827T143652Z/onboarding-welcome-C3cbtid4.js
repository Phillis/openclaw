...
import { t as formatSystemAgentOnboardingWelcome } from "./overview-DHobpgIW.js";
...
async function buildOnboardingWelcome(params) {
	...
	const localSetup = params.localRecovery === true && overview.config.exists && overview.config.valid && authoredConfig !== void 0 && authoredConfig?.gateway?.mode !== "remote" ? (await import("./local-onboarding-state-DL3bC6f_.js")).readLocalOnboardingStateForConfig(overview.config.path, authoredConfig) : void 0;
