...
import { s as setBroadcastHealthUpdate } from "./health-state-BMJaisHV.js";
...
function startGatewayMaintenanceTimers(params) {
	...
	const runManagedOutgoingMediaGc = params.runManagedOutgoingMediaGc ?? (async () => {
		const { cleanupManagedOutgoingMediaRecords } = await import("./managed-image-attachments-yEI3vxza.js");
