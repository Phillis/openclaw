...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-T_vsCyv2.js";
...
import { t as describeImageFile } from "./runtime-Ji2acYe5.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-CC-6r2GM.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-ebyds70u.js");
