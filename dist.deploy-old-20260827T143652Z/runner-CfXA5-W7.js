...
import { c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-B2xBnbcf.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-xJvrDBVt.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-DkKfLQ8n.js";
...
import { a as runCliEntry, d as selectAttachments, l as MediaAttachmentCache, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as isMediaUnderstandingSkipError } from "./runner.entries-DMoYx1XN.js";
...
const loadHasAvailableAuthForProvider = createLazyRuntimeNamedExport(() => import("./model-auth-CPHWyuQW.js"), "hasAvailableAuthForProvider");
const loadPreparedModelCatalogApi = createLazyRuntimeModule(async () => ({
	...await import("./model-catalog-DShfYXIs.js"),
	...await import("./prepared-model-catalog-DGTgNwqR.js")
}));
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-B8mtMtru.js");
