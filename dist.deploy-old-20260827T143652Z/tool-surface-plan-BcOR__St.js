...
import { R as getAgentToolExecutionContext } from "./agent-core-DYvUJPB3.js";
...
import { _ as isDirectVisibleCatalogTool, c as ToolSearchRuntime, d as addClientToolsToToolCatalog, f as applyToolCatalogCompaction, h as compactToolSearchCatalogEntry, i as applyToolSchemaDirectoryCatalog, l as formatToolSearchControlResult, n as applyToolSearchCatalog, s as resolveToolSearchConfig } from "./tool-search-6StV_VPD.js";
import { A as prepareSource, C as MAX_HEADLESS_WALL_CLOCK_MS, D as createCodeModeApiFilesForRun, E as codeModeFailureMessage, F as resolveCodeModeHeadlessConfig, I as toToolSearchConfig, L as codeModeReplayIdForToolCall, M as readPositiveInteger, N as readRunId, O as enforceSnapshotPayloadLimits, P as resolveCodeModeConfig, S as DEFAULT_HEADLESS_WALL_CLOCK_MS, T as codeModeFailureCode, _ as takeTerminalCodeModeRunResult, b as waitForPendingBridgeSettlement, c as pendingBridgeStatesForSettlement, d as removeExpiredRuns, f as reserveActiveRunSlot, g as storeSnapshotState, h as snapshotState, i as createPendingBridgeStates, j as readCode, k as isCodeModeEngagedForModel, l as pendingToolCalls, m as settledBridgeRequestsInCompletionOrder, n as cancelPendingBridgeStates, o as disposeCodeModeRun, p as resumingRunIds, r as codeModeWaitingReason, s as pendingBridgeRequestsReplaySafe, t as activeRuns, u as recordTerminalCodeModeRunResult, v as takeUndeliveredCodeModeRunOutput, w as boundOutputToLimit, x as CODE_MODE_WORKER_WATCHDOG_GRACE_MS, y as telemetry } from "./code-mode-state-wmIn2YdC.js";
...
async function settleCodeModeResult(params) {
	...
	recordTerminalCodeModeRunResult(activeRunId, terminalResult, params.config.snapshotTtlSeconds);
...
async function runWait(params) {
	...
	if (!state) {
		const terminal = takeTerminalCodeModeRunResult(params.runId);
