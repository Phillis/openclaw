...
import { v as getPluginRegistryRuntime } from "./loader-DNWV84an.js";
...
import { n as projectSessionActor } from "./session-utils-row-CB3Fore5.js";
...
function catalogStartHandler(resolveProvider, resolveCreateTarget) {
	return async (opts) => {
		...
		const { openTerminalSession, CATALOG_TERMINAL_INITIAL_SIZE } = await import("./terminal-Cx1hNQfw.js");
