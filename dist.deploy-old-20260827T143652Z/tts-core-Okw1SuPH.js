...
function loadDefaultSummarizeTextDeps() {
	return defaultSummarizeTextDepsPromise ??= Promise.all([import("./simple-completion-runtime-DDn5DIze.js"), import("./model-auth-CPHWyuQW.js")]).then(([completionRuntime, { requireApiKey }]) => ({
