...
import { n as overlayExternalAuthProfiles } from "../external-auth-RQnwVMea.js";
import { r as listExternalCliSyncProviderIds } from "../external-cli-sync-CU9M9_mw.js";
import { m as preserveResolvedSecretBackedCredentials, p as loadAuthProfileStoreWithoutExternalProfiles } from "../store-2zwMbXSG.js";
import { f as resolveAmbientAgentCredentialsForDiscovery, m as resolveUsableAgentCredentialModes, p as resolveAgentCredentialMapFromStore } from "../prepared-model-runtime.facts-B3rCoKug.js";
import { gt as AuthStorage } from "../sessions-DVC_3nXc.js";
import { r as fingerprintPreparedModelCatalogGeneration } from "../prepared-model-catalog-worker-DMev8Ty5.js";
...
async function prepareWorkerGeneration(value) {
	const { prepareWorkspaceBuildGroup } = await import("../prepared-model-runtime.facts-DUPI6jTo.js");
...
async function runPreparedModelCatalogWorkerRequest(value, request, preparedGeneration = prepareWorkerGeneration(value)) {
	try {
		...
		const { prepareAgentCatalogSource, prepareFullCatalogFacts } = await import("../prepared-model-runtime.facts-DUPI6jTo.js");
		const authStore = refreshAuthStore({
			agentDir: value.input.agentDir,
			inheritedAuthDir: value.input.inheritedAuthDir,
			authStore: value.authStore,
