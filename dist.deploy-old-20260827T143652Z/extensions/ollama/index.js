...
import { n as buildApiKeyCredential } from "../../provider-auth-helpers-BNebJAKh.js";
...
import { r as resolveThinkingProfile } from "../../provider-policy-api-0BxD-w2s.js";
...
import { a as shouldUseSyntheticOllamaAuth, i as resolveOllamaRuntimeBaseUrl, n as isLocalOllamaBaseUrl, r as resolveOllamaDiscoveryResult, t as OLLAMA_PROVIDER_ID } from "../../discovery-shared-CtQLcYmU.js";
...
import { c as orderPreferredOllamaModelIds, i as findAvailableOllamaModelName } from "../../setup-model-selection-KCLSWlKn.js";
import { r as resolveConfiguredOllamaProviderConfig, t as createConfiguredOllamaCompatStreamWrapper } from "../../stream-compat-D7W_cGHP.js";
import "../../stream-contract-CaPxW4Jp.js";
import { t as createLazyOllamaWebSearchProvider } from "../../web-search-provider-registration-B5GpSmOU.js";
import { createHash } from "node:crypto";
//#region extensions/ollama/src/node-inference-registration.ts
const loadOllamaNodeInference = createLazyRuntimeModule(() => import("../../node-inference-CknkHFYg.js"));
...
const loadOllamaStreamRuntime = createLazyRuntimeModule(() => import("../../stream.runtime-Bt8UxRWb.js"));
...
const loadOllamaSetup = createLazyRuntimeModule(() => import("../../setup.runtime-BBnSkvfj.js"));
const loadOllamaEmbeddingProvider = createLazyRuntimeModule(() => import("../../embedding-provider.runtime-DfQlbxCJ.js"));
const loadOllamaMemoryEmbeddingProviderAdapter = createLazyRuntimeModule(async () => (await import("../../memory-embedding-adapter-BwY4ZHjD.js")).ollamaMemoryEmbeddingProviderAdapter);
const loadOllamaMediaUnderstandingProvider = createLazyRuntimeModule(async () => (await import("../../media-understanding-provider-72IaM5Yr.js")).ollamaMediaUnderstandingProvider);
