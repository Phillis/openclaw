...
import { b as updateAuthProfileStoreWithLock, p as loadAuthProfileStoreWithoutExternalProfiles } from "../../store-2zwMbXSG.js";
import { _ as readToolStringParam } from "../../common-BGOZLJ2_.js";
import { t as jsonResult } from "../../tool-results-BCM3fdVS.js";
import { n as buildApiKeyCredential, t as applyAuthProfileConfig } from "../../provider-auth-helpers-BNebJAKh.js";
...
import { d as buildOpenAICodexCredentialExtra, h as resolveOpenAICodexImportProfileName, m as resolveOpenAICodexAuthIdentity } from "../../provider-auth-CZW5iaiY.js";
...
import { a as closeCodexStartupClientBestEffort, d as unsubscribeCodexThreadBestEffort, h as isCodexNotificationForTurn, o as interruptCodexTurnAndWaitBestEffort, p as getCodexAppServerTurnRouter, u as retireUnsafeCodexTurnClientBestEffort } from "../../attempt-client-cleanup-CkbyvOpN.js";
import { s as isAssistantCommentaryCompletionNotification } from "../../event-projector-usage-8baZc843.js";
import { C as mergeCodexThreadConfigs, D as isOpenAiCuratedMarketplace, T as ensureCodexPluginActivation, f as resolveCodexAppServerRequestModelSelection, k as pluginReadParams, u as CODEX_NATIVE_PERSONALITY_NONE, x as buildDisabledAppsConfigPatch } from "../../thread-lifecycle-CWQ_B05h.js";
...
import { l as projectBoundedCodexVisibleSessionHistory } from "../../transcript-mirror-pCbfAPp4.js";
import { n as describeControlFailure, t as CODEX_CONTROL_METHODS } from "../../capabilities-BbZiceud.js";
import { r as formatCodexDisplayText } from "../../command-formatters-CoGMIjeC.js";
import "../../incognito-session-DoO9V_or.js";
import { t as resolveCodexAppServerForModelProvider } from "../../app-server-policy-zqAoixGQ.js";
...
import { i as withCodexAppServerJsonClient, r as requestCodexAppServerJson } from "../../request-Cdaua2yT.js";
import { n as resolveLivePluginConfigObject, r as resolvePluginConfigObject } from "../../plugin-config-runtime-D7ikroCS.js";
import "../../config-mutation-DtKr1BIj.js";
...
import { n as registerCodexCliMetadata } from "../../cli-metadata-BdIS-wzP.js";
import { t as createCodexAppServerAgentHarness } from "../../harness-CdzBM7mF.js";
import { t as buildCodexMediaUnderstandingProvider } from "../../media-understanding-provider-Bf_1XEBK.js";
...
import { f as trackCodexConversationActiveTurn, m as canMutateCodexHost, p as CODEX_NATIVE_EXECUTION_AUTH_ERROR, t as discoverCodexMarketplacePlugins } from "../../plugin-marketplace-discovery-DoUocMwO.js";
...
import { d as resumeCodexCliSessionOnNode, l as listCodexCliSessionsOnNode, o as createCodexCliSessionNodeHostCommands, s as createCodexCliSessionNodeInvokePolicies, t as codexControlRequest, u as resolveCodexCliSessionForBindingOnNode } from "../../command-rpc-DlNBEirW.js";
import { i as createCodexSessionCatalogNodeInvokePolicies, n as createCodexSessionCatalogControl, o as assertCodexArchiveDescendantsUnowned, r as createCodexSessionCatalogNodeHostCommands, t as codexSessionCatalogRuntime } from "../../session-catalog-BZhBL7On.js";
...
function createLazyCodexAppServerBindingStore(state) {
	let resolved;
	const store = () => resolved ??= import("../../session-binding-DlhdfFiB.js").then(({ createCodexAppServerBindingStore }) => createCodexAppServerBindingStore(state));
	return {
...
async function loadDefaultCodexSubcommandHandler() {
	const { handleCodexSubcommand } = await import("../../command-handlers-BBhWZheO.js");
...
const loadCodexWebSearchRuntime = createLazyRuntimeModule(() => import("../../web-search-provider.runtime-Cm3T08RP.js"));
...
var codex_default = definePluginEntry({
	...
	register(api) {
		...
		api.on("after_compaction", async (event, ctx) => {
			...
			const { sessionBindingIdentity } = await import("../../session-binding-DlhdfFiB.js");
			const identity = sessionBindingIdentity({
				sessionId,
		...
		api.on("session_end", async (event, ctx) => {
			...
			const config = resolveCurrentConfig();
			const [{ sessionBindingIdentity }, { retireCodexAppServerSessionGeneration }] = await Promise.all([import("../../session-binding-DlhdfFiB.js"), import("../../session-retirement-DeFMYzv9.js")]);
