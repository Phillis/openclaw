...
import { n as DEFAULT_AGENT_COMPACTION_RESERVE_TOKENS_FLOOR } from "../../openclaw-runtime-JkCLFcTm.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-B20HI8SA.js";
...
const loadSessionBackfillGatewayRuntime = createLazyRuntimeModule(() => import("../../session-backfill-gateway.runtime-C8NYAFNQ.js"));
...
const loadMemoryToolsModule = createLazyRuntimeModule(() => import("../../tools-CU4rcMQm.js"));
const loadStandingIntentsModule = createLazyRuntimeModule(() => import("../../standing-intents-PjEukdlk.js"));
const loadStandingIntentToolModule = createLazyRuntimeModule(() => import("../../standing-intents-tool-DFkgDnb9.js"));
const loadRuntimeProviderModule = createLazyRuntimeModule(() => import("../../runtime-provider-BPpJA8u3.js"));
...
var memory_core_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCommand({
			...
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-Btwh1lnU.js");
