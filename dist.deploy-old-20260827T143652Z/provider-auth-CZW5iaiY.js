...
import "./external-cli-sync-CU9M9_mw.js";
import { f as loadAuthProfileStoreForSecretsRuntime, o as findPersistedAuthProfileCredential, p as loadAuthProfileStoreWithoutExternalProfiles, r as ensureAuthProfileStore } from "./store-2zwMbXSG.js";
...
import "./models-config.providers.secrets-BBB9hlEz.js";
...
import { b as resolveProviderEntryApiKeyProfileReference, l as profileTypeToAuthMode, m as resolveDirectProviderCredentialMode, v as resolveProviderConfig, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-BoRNjJxC.js";
import { n as resolveManagedSecretRefRuntimeProviderAuth } from "./model-auth-runtime-config-BDqYorw0.js";
import "./provider-auth-helpers-BNebJAKh.js";
import "./provider-auth-input-CWTavMIA.js";
import "./provider-api-key-auth-syVQpOuL.js";
...
async function resolveCopilotTokenCache(params) {
	...
	const { createCorePluginStateSyncKeyedStore } = await import("./plugin-state-store-C5zDfs2a.js");
