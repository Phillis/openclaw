...
import { Lt as EmbeddedAgentRunResult, U as resolveCliBackendLiveSessionRequirement, b as ProviderAuthResult, l as AgentHarnessAuthBindingFingerprintParams, r as ProviderPlugin, v as AgentHarnessRuntimeArtifactBinding, z as RunCliAgentParams } from "./host-capability-types-CSKZWJAm.js";
import { f as RuntimeEnv, o as PluginOrigin, s as OpenClawPackageBuild } from "./manifest-registry-DsWy3jGA.js";
import { n as InstalledPluginIndexRefreshReason } from "./installed-plugin-index-types-FxZBxK7R.js";
import { n as PluginMetadataRegistryView, r as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-5OAiSPBb.js";
import { t as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-DNQabFdk.js";
import { G as ConfigMutationResult, Y as TransformConfigFileWithRetryParams, dt as readConfigFileSnapshot } from "./config-DiNLUfeX.js";
...
import { a as ensureAuthProfileStore, c as AuthProfileDatabase, o as loadAuthProfileStoreForRuntime, s as updateAuthProfileStoreWithLock } from "./usage-BcXLFbyC.js";
import { n as AgentExecutionAuthBinding, r as OpaqueRuntimeOwnerKind, t as runEmbeddedAgent } from "./embedded-agent-runner-BgCYNbi3.js";
import { d as PluginLoadOptions } from "./loader-Cj0mtXhQ.js";
import { n as InstalledPluginIndexStoreOptions } from "./installed-plugin-index-store-CiOsM0p6.js";
