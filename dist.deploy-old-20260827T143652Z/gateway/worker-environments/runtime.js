...
import { c as resolveNpmJsonEntries, r as isExactSemverVersion } from "../../npm-registry-spec-D3pNhy09.js";
import { t as resolveSecretRefString } from "../../resolve-DLWDJoF2.js";
import { r as runCommandWithTimeout } from "../../exec-BL80Wdzl.js";
import { qa as validateWorkerAdmissionHandshake } from "../../src-Bo4ezI_n.js";
import "../../worker-admission-R0mXKdG7.js";
import { i as normalizeScpRemotePath } from "../../scp-host-3FoHUz1i.js";
import { a as hashWorkerBundleManifest, i as WORKER_BUNDLE_MANIFEST_VERSION, r as comparePaths, t as collectWorkerBundleManifest } from "../../bundle-staging-DcGgN-po.js";
import { a as workerSshCommandOptions, i as runWorkerSshCandidates, n as prepareWorkerSsh, o as workerSshOptions, s as workerSshRemoteCommand } from "../../ssh-DfcMAYGe.js";
...
async function bootstrapWorker(request, dependencies) {
	...
	try {
		...
		if (artifact.install === "bundle") {
			const transfer = await runWorkerSshCandidates(prepared, timeoutMs, (port, remainingTimeoutMs) => runCommand([
				"scp",
