...
import { r as createMessageActionDiscoveryContext, u as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-BKLI5Kq9.js";
...
import { s as getChannelsCommandSecretTargetIds } from "./command-secret-targets-BFmcuBAX.js";
import { t as createClackPrompter } from "./clack-prompter-9tEHHVYQ.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-CRepfWqx.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-Bc4602Jh.js";
import { n as resolveLogFile } from "./log-tail-DQ4CGQW8.js";
import { t as parseLogLine } from "./parse-log-line-ftS74lJQ.js";
import { n as requireValidConfigFileSnapshot } from "./config-validation-DQ3LvziX.js";
import { i as prepareChannelAccountRemoval, n as channelLabel, r as applyPreparedChannelAccountRemoval, t as channelsAddCommand } from "./add-Dx0cpmu3.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidChannelConfig } from "./shared-CZGTSdKU.js";
import { t as channelsListCommand } from "./list-CpTlEZA0.js";
import { t as channelsStatusCommand } from "./status-C7PBvFEa.js";
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-x24tSp8F.js");
