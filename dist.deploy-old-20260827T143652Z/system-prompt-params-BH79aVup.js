...
import { a as isSubagentSessionKey, l as parseCronRunScopeSuffix, n as isAcpSessionKey } from "./session-key-utils-D8x_bjrd.js";
import { dt as resolveOwnerPromptNumbers, ut as resolveOwnerDisplaySetting } from "./io-CeQckj5v.js";
import { t as CHANNEL_IDS } from "./ids-BDKYF0d6.js";
import { n as findGitRoot } from "./git-commit-Dfaqxo9-.js";
...
import { r as listDeliverableMessageChannels } from "./message-channel-normalize-rAbqRXlG.js";
import "./message-channel-T4W5YOto.js";
import { u as isOpenClawMainPromptSurface } from "./command-registration-df_ISQhO.js";
...
import { i as buildTtsSystemPromptHint } from "./tts-settings-oG9oyjFI.js";
import { i as isKnownNativeApprovalPromptChannel, r as hasNativeApprovalPromptRuntimeCapability } from "./native-approval-prompt-CA2Y3Tta.js";
import { a as getMemoryRuntime, t as buildMemoryPromptSection } from "./memory-state-DhEOmKyi.js";
import { t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-Bz_9VqrX.js";
import { h as splitCuratedMarkdownEntries } from "./internal-DP_IIQo9.js";
...
import "./engine-storage-B4MQuPW0.js";
import { i as buildSkillWorkshopPromptSection, t as buildWatchedSessionsPromptLines } from "./watched-sessions-prompt-CkKJr35X.js";
...
function buildAgentSystemPrompt(params) {
	...
	const lines = [cacheStablePromptPrefix(hashStablePromptInput({
		...
		const lines = [
			...
			...renderOpenClawToolWorkflowHints && (availableTools.has("sessions_search") || availableTools.has("sessions_list")) ? ["Asked about another chat/group/session not in context: check `sessions_list`/`sessions_search` before claiming no access."] : [],
			"",
			...
			...hasOpenClaw ? ["Gateway restart, config, channels, plugins, agents, models/providers, updates: ask `openclaw`. Never restart the Gateway through shell commands or write your own config."] : ["Config read: `gateway` (`config.get|config.schema.lookup`). Write/restart unavailable; ask human."],
			"",
			...skillsSection,
