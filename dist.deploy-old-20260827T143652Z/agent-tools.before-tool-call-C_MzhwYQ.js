...
import { A as getPluginSessionExtensionStateSync } from "./loader-DNWV84an.js";
...
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-tey_1PC-.js";
...
async function deliverClientVoiceMutationDigest(record, config, signal) {
	...
	const { sendDurableMessageBatchCore } = await import("./runtime-CoFLMf90.js");
