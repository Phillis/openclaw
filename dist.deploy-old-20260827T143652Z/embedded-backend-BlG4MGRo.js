...
import { i as agentSessionKeysMatchByRequestKey } from "./session-key-D8GLfPr_.js";
import { r as getRuntimeConfig, v as registerConfigWriteListener } from "./io-CeQckj5v.js";
import { r as buildConfiguredModelCatalog } from "./model-selection-shared-BSy9FczT.js";
...
import { yt as applySessionPatchProjection } from "./session-accessor-Bi6bzKQE.js";
import "./message-channel-T4W5YOto.js";
import { G as setEmbeddedPluginApprovalBroker, U as EmbeddedPluginApprovalBroker, W as clearEmbeddedPluginApprovalBroker, q as setEmbeddedMode } from "./agent-tools.before-tool-call-C_MzhwYQ.js";
...
import { u as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-BIRJocb0.js";
import { n as resolveThinkingDefault } from "./model-thinking-default-B9IHGxZs.js";
import { t as buildAllowedModelSet } from "./model-selection-CMo6Emvk.js";
import { i as buildAgentRunTerminalOutcomeFromLifecycleEvent, o as classifyAgentRunTerminalOutcome, t as AGENT_RUN_TERMINAL_RETRY_GRACE_MS } from "./agent-run-terminal-outcome-D3lKKt7D.js";
import { i as resolveTextCommand } from "./commands-registry-normalize-7tyOPIdR.js";
import { m as resolveActiveEmbeddedRunSessionId } from "./run-state-BxqT1sw2.js";
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-CS8YarJf.js";
...
import { t as getSessionDefaults } from "./session-utils-model-Cs1tFKI6.js";
import { E as loadGatewaySessionEntryReadOnly, N as resolveGatewaySessionStoreTargetWithStore, O as resolveCanonicalGatewaySessionStoreKey, T as loadGatewaySessionEntry, w as listAgentsForGateway } from "./session-utils-row-CB3Fore5.js";
import { t as ensureContextWindowCacheLoaded } from "./context-Dryq28I6.js";
import { t as resolveQueueSettingsCore } from "./settings-BzdeB7do.js";
import { A as waitForQueueDebounce, D as previewQueueSummaryPrompt, S as buildCollectPrompt, b as applyQueueDropPolicy } from "./state-Ba38Yboy.js";
import { i as buildGatewaySessionInfo, r as listSessionsFromStoreAsync } from "./session-utils-list-DQ6H7aPd.js";
import "./session-utils-DZT0oaJU.js";
import { i as parseGoalCommand, t as executeSessionGoalCommand } from "./commands-goal-BpMMSkvE.js";
...
import { a as isChatStopCommandText } from "./chat-abort-Cm7ik-5J.js";
import { d as resolveAssistantLiveChatInput, f as resolveMergedAssistantText, l as normalizeLiveAssistantBufferedText, p as shouldSuppressAssistantEventForLiveChat, u as projectLiveAssistantBufferedText } from "./server-chat-state-DD3o03aT.js";
import { c as performGatewaySessionReset } from "./session-reset-service-tuWSAYTY.js";
import { r as agentCommandFromIngress } from "./agent-command-ej-Gvag6.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-DKuFNbQH.js";
import { t as loadGatewayModelCatalog } from "./server-model-catalog-Dn3WmMFm.js";
import { t as createDefaultDeps } from "./deps-DbFiGwEJ.js";
import { u as resolveEffectiveChatHistoryMaxChars } from "./chat-display-projection-CHZEyvHW.js";
import { a as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES, i as readChatHistoryPage, o as enforceChatHistoryFinalBudget, r as enrichChatHistoryCompactionMarkers, s as replaceOversizedChatHistoryMessages } from "./chat-DBGKQ8xP.js";
import { o as isAgentLifecycleYieldedWaiting } from "./session-lifecycle-state-D9fduxZz.js";
import { n as createGatewaySession } from "./session-create-service-BZ4Qzo_v.js";
import { t as projectSessionsPatchEntry } from "./sessions-patch-CKDwTVLY.js";
import { t as resolveLocalRunShutdownGraceMs } from "./local-run-shutdown-BQKagb2W.js";
import { u as formatTuiErrorMessage } from "./tui-formatters-CMJ6H9lW.js";
...
var EmbeddedTuiBackend = class {
	...
	start() {
		...
		this.ready = (async () => {
			const { runSessionStartupMigration } = await import("./startup-migration-D_8IHM4G.js");
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-DBVAwDCY.js");
