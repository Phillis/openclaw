...
import { f as setGatewaySigusr1RestartPolicy, l as resolveGatewayRestartDeferralTimeoutMs, r as deferGatewayRestartUntilIdle } from "./restart-DHXBMqqF.js";
...
import { d as rejectPendingPreparedModelRuntimeReplacement, s as markPreparedModelRuntimeSnapshotsStale, u as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-BIRJocb0.js";
...
import { i as refreshContextWindowCache } from "./context-Dryq28I6.js";
...
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-Cc7cSqyy.js";
...
import { t as buildGatewayCronService } from "./server-cron-CCdZZGe-.js";
...
import { i as startGatewayCronWithLogging } from "./server-runtime-services-yUM2vr3j.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-3kvPgEyy.js";
import { r as publishRuntimeSecretsStateTransition } from "./server-startup-config-CCc3Pv-m.js";
...
async function restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, options) {
	if (!(await import("./runtime-DP8l8f_u.js")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, { runtimeSourceConfig: options?.runtimeSourceConfig })) return false;
	options?.onActivated?.();
	return true;
}
