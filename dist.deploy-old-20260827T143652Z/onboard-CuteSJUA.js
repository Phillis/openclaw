...
import { i as resolveProviderMatch } from "./provider-auth-choice-helpers-XpVDMGbE.js";
...
import { t as resolvePluginProviders } from "./provider-auth-choice.runtime-xZiWxeSw.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-tEO7mMAH.js";
...
import { n as runInteractiveSetup } from "./onboard-interactive-BR-YcBP-.js";
import { t as inferAuthChoiceFromFlags } from "./auth-choice-inference-BqyvYKPE.js";
import { n as resolveNonInteractiveApiKey, t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-Gq_LyfHS.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-wuli7A00.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-B3MrRMrh.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-nD_whnO5.js");
