...
import { a as prepareConfiguredRuntimeFactsBatch, i as prepareAgentCatalogSource, l as createPreparedInboundRegistryLoader, m as resolveUsableAgentCredentialModes, o as prepareFullCatalogFacts, s as prepareWorkspaceBuildGroup, t as fingerprintPreparedRuntimeFacts, u as preparedModelRuntimeWorkspaceFactsKey } from "./prepared-model-runtime.facts-B3rCoKug.js";
import { gt as AuthStorage } from "./sessions-DVC_3nXc.js";
import { i as resolveSelectedAgentHarnessRuntime, t as requiresAgentHarnessPluginSelection } from "./runtime-plugin-load-plan-DMDmAYeH.js";
import { n as createPreparedModelCatalogWorkerInput, t as createPreparedModelCatalogWorker } from "./prepared-model-catalog-worker-DMev8Ty5.js";
...
function invalidateForAuthMutation(event) {
	...
	for (const owner of invalidatedOwners) {
		...
		const clearPending = () => {
			if (owner.pending === pending) owner.pending = void 0;
		};
