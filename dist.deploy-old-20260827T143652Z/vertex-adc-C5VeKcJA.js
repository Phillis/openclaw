...
import { a as readSecretFileSync } from "./secret-file-CSNlJNCL.js";
...
async function resolveGoogleVertexAccessTokenViaGoogleAuth(adcConfig) {
	if (!cachedGoogleAuthClient) cachedGoogleAuthClient = { promise: import("./src-B-xVi0vS.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)).then(({ GoogleAuth }) => {
