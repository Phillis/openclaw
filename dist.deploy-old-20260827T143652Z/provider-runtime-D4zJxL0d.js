...
import { n as applyPluginTextReplacements, r as mergePluginTextTransforms, t as resolveRuntimeTextTransforms } from "./text-transforms.runtime-C3pgI4wL.js";
...
import { d as resolveProviderPluginsForHooks, f as resolveProviderRuntimePlugin, n as clearProviderRuntimePluginCacheForTest, o as resolveLoadedProviderRuntimePlugin, r as ensureProviderRuntimePluginHandle, u as resolveProviderHookPlugin } from "./provider-hook-runtime-JxH2LVjO.js";
...
async function resolveProviderUsageSnapshotWithPlugin(params) {
	...
	if (!harness) {
		...
		const { loadAgentRuntimePluginRegistryHandle } = await import("./runtime-plugins-cK3EvPpk.js");
		const { ensureSelectedAgentHarnessPlugin } = await import("./runtime-plugin-D0OzRBzP.js");
