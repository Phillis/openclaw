...
import { u as publishTranscriptUpdate } from "./session-accessor.sqlite-lifecycle-Cv8qGX3X.js";
import { N as runWithSessionTranscriptReadFence } from "./session-accessor.sqlite-transcript-store-E-m-_aAq.js";
import { h as consumeRunSkillUsage } from "./agent-tools.before-tool-call-C_MzhwYQ.js";
import "./sessions-DVC_3nXc.js";
import { t as SessionManager } from "./session-manager-CmaH_Zw4.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-CSvDMf1K.js";
...
import { n as rewriteTranscriptEntriesInSessionManager, t as resolveRuntimeTranscriptReadTarget } from "./transcript-runtime-state-IocHFyyU.js";
import { f as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt-prompt-helpers-Bqx2yDKm.js";
import { T as findActiveSessionTask } from "./media-generation-task-status-Diff0p0O.js";
import { v as runWithPreparedMemoryPromptSection } from "./memory-state-DhEOmKyi.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-Bd6ECkjz.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-BIigCxgL.js";
...
async function runCoreAgentEndSideEffects(params) {
	...
	try {
		const { scheduleSkillExperienceReview } = await import("./experience-review-default-DAG6qHre.js");
