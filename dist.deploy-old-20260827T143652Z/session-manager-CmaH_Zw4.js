...
import { J as appendTranscriptEventSync, Q as replaceTranscriptEventsSync, Qt as loadSessionEntry, Ut as ensureSessionEntrySync, X as appendTranscriptMessageSync, an as replaceSessionEntrySync, rt as readActiveTranscriptEntryAnchor, tt as withTranscriptWriteTransaction } from "./session-accessor-Bi6bzKQE.js";
import { n as projectCanonicalSessionEntryShape } from "./store-entry-shape-BgAn-BWO.js";
import { _ as isSessionTranscriptSideAppendEntry } from "./session-transcript-index-Bfc_6ADm.js";
import { x as loadTranscriptEventsSync } from "./session-accessor.sqlite-transcript-store-E-m-_aAq.js";
import { O as buildSessionContext } from "./agent-core-DYvUJPB3.js";
import { f as partitionSessionFileEntries, i as isSessionContextMetadataEntry, l as parseOpaqueLeafEntry, m as generateSessionEntryId, p as createManagedSessionId, r as isIndexedSessionEntry, s as migrateToCurrentVersion, u as parseParentLinkedOpaqueEntry } from "./session-manager-codec-CpsgMjY3.js";
