...
import { f as readConfigFileSnapshotWithPluginMetadata, z as applyConfigOverrides } from "./io-CeQckj5v.js";
...
import { c as hasLegacyAuthProfileSourcesForStartup } from "./legacy-source-diagnostic-rVpdYvZu.js";
import { a as prepareSecretsRuntimeFastPathSnapshot, n as collectCandidateAgentDirs } from "./runtime-fast-path-O2v9pYOi.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = createLazyPromise(() => import("./runtime-DP8l8f_u.js"), { cacheRejections: true });
	const loadAuthProfiles = createLazyPromise(() => import("./auth-profiles-B4TRkjM7.js"), { cacheRejections: true });
