...
import { S as findModelInCatalog, _ as resolveConfiguredModelRef, f as normalizeModelSelection, g as resolveConfiguredModelPolicyAllow, v as resolveHooksGmailModel } from "./model-selection-shared-BSy9FczT.js";
...
import { D as isDetachedCronSessionTarget, R as resolveCronScheduledToolPolicy } from "./row-codec-BXU8Ei5n.js";
import "./config-Dl8DJbzM.js";
import { dt as deriveContextPromptTokens, mt as hasNonzeroUsage, pt as deriveSessionTotalTokens } from "./session-accessor-Bi6bzKQE.js";
import { a as isAgentHarnessSessionKey, n as AGENT_HARNESS_SESSION_ID_LOCKED_MESSAGE, r as AGENT_HARNESS_SESSION_KEY_RESERVED_MESSAGE, z as beginSessionWorkAdmission } from "./agent-harness-session-key-BMj1lPtX.js";
...
import { s as loadProviderScopedThinkingCatalog, u as loadResolvedPublishedModelCatalogOwner } from "./prepared-model-catalog-lswR6K7d.js";
import { n as resolveAllowedModelRefCore, t as getModelRefStatus } from "./model-selection-resolve-Csj_jVLX.js";
import { i as normalizeThinkingCatalogProviders, n as hasResolvedThinkingCatalogEntry, o as resolveEffectiveAgentRuntime } from "./thinking-runtime-F3zRbZ0D.js";
import { i as resolveSessionRuntimeOverrideForProvider } from "./session-runtime-compat-B5omAB7u.js";
...
import { o as resolveCronAbortReasonText } from "./execution-errors-CEAOqO7v.js";
import { t as removeCronRunContinuationSessionIfIdle } from "./cron-run-continuation-cleanup-CtVa1PC1.js";
import { n as resolveSourceDeliveryOutcome } from "./source-delivery-plan-D53JVwm5.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-B3rQW6jp.js";
import { i as mergeCronRunDiagnostics, n as createCronRunDiagnosticsFromError, t as createCronRunDiagnosticsFromAgentResult } from "./run-diagnostics-6Nuqo5uy.js";
import { n as resolveCronJobEffectiveAgentId, r as tryResolveCronDefaultAgentId } from "./agent-id-C6YEx4KT.js";
import { n as getActiveCronTaskRunId } from "./task-runs-DXG1HNfo.js";
import { n as projectChatDisplayMessages } from "./chat-display-projection-CHZEyvHW.js";
import { n as resolveCronSession, t as loadCronSessionEntryLatest } from "./session-DG3Q0V2O.js";
import { c as loadCronDeliveryRuntime, l as resolveCronDeliveryContext, n as resolveCronPreflightCandidates, o as buildCronDeliveryTrace, s as createCronToolsAllowPreflightDiagnostics, u as resolveCronChannelOutputPolicy } from "./run-fallback-policy-CFa4oGCN.js";
import { a as markCronSessionPreRun, c as resolveCronLifecycleRevisionIdentity, f as resolveCronPayloadOutcome, i as createPersistCronSessionEntry, n as adoptCronRunSessionMetadata, o as persistCronSkillsSnapshotIfChanged, r as createCronRunContinuationSession, s as projectCronOwnershipFields, t as CronSessionLifecycleClaimError } from "./run-session-state-LIADNFmz.js";
import { t as cleanupCronRunSessionAfterRun } from "./session-cleanup-CAxSwMyY.js";
...
async function finalizeCronRun(params) {
	...
	if (hasNonzeroUsage(usage)) {
		const { estimateUsageCost, resolveModelCostConfig } = await import("./usage-format-CQ53b74o.js");
