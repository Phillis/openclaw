...
import { o as resolveEffectiveAgentRuntime, t as concretizeAgentRuntime } from "./thinking-runtime-F3zRbZ0D.js";
...
import { B as createManagedTaskFlow, K as finishFlow, O as listTasksForFlowId, Q as requestFlowCancel, W as failFlow, et as resumeFlow, tt as setFlowWaiting } from "./task-registry-DrR4kwK-.js";
import "./runtime-internal-JVnCI_tz.js";
import { _ as getTaskFlowByIdForOwner, d as getFlowTaskSummary, g as findLatestTaskFlowForOwner, p as runTaskInFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById, v as listTaskFlowsForOwner, y as resolveTaskFlowForLookupTokenForOwner } from "./task-executor-C_bCFvCs.js";
...
import { n as generateMusic, r as listRuntimeMusicGenerationProviders } from "./openclaw-tools-Dfr0aiDz.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "./task-owner-access-Bd6ECkjz.js";
...
import { i as listWebSearchProviders, o as runWebSearch } from "./runtime-BBAKqoHG.js";
...
import { t as createRuntimeChannel } from "./runtime-channel-DvvvrImO.js";
...
async function createSessionEntry(params) {
	const [{ createGatewaySession }, { resolveGatewaySessionStoreTarget }, { readAcpSessionMetaForEntry, upsertAcpSessionMeta }] = await Promise.all([
		import("./session-create-service-DxrrBjgz.js"),
		import("./session-utils-DNhfOL1X.js"),
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("./heartbeat-runner-w2qBKVR8.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRequestRuntime = createLazyRuntimeModule(() => import("./runtime-tts-request-Blyl0M-8.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-DcwgVuAq.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime.js"));
const loadGatewayPluginRuntime = createLazyRuntimeModule(() => import("./server-plugins-CZYXJLtE.js"));
