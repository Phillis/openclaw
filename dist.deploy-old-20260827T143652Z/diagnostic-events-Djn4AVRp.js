...
const CORE_MODEL_REQUEST_STARTED_METADATA_KEY = "coreModelRequestStarted";
const coreModelRequestStartedEvents = /* @__PURE__ */ new WeakSet();
function markCoreModelRequestStartedDiagnosticEvent(event) {
	coreModelRequestStartedEvents.add(event);
	return event;
}
function consumeCoreModelRequestStartedDiagnosticEvent(event) {
...
function emitDiagnosticEventWithTrust(event, trusted, options = {}) {
	...
	const metadata = {
		...
		...options.coreModelRequestStarted === true ? { [CORE_MODEL_REQUEST_STARTED_METADATA_KEY]: true } : {},
...
//#endregion
export { isValidDiagnosticTraceFlags as A, hasInternalDiagnosticEventListeners as B, createChildDiagnosticTraceContext as C, freezeDiagnosticTraceContext as D, formatDiagnosticTraceparent as E, markCoreSemanticRunProgressDiagnosticEvent as F, markHostPluginUsageDiagnosticEvent as I, markTrustedOtelDiagnosticListener as L, parseDiagnosticTraceparent as M, runWithDiagnosticTraceContext as N, getActiveDiagnosticTraceContext as O, CORE_SEMANTIC_RUN_PROGRESS_METADATA_KEY as P, CORE_MODEL_REQUEST_STARTED_METADATA_KEY as R, registerDiagnosticTracePropagationBridge as S, createDiagnosticTraceContextFromActiveScope as T, onTrustedToolExecutionEvent as _, emitInternalDiagnosticEvent as a, waitForDiagnosticEventsDrained as b, emitTrustedSecurityEvent as c, hasPendingInternalDiagnosticEvent as d, isDiagnosticsEnabled as f, onTrustedInternalDiagnosticEvent as g, onInternalDiagnosticEvent as h, emitFailoverEvent as i, isValidDiagnosticTraceId as j, isValidDiagnosticSpanId as k, emitTrustedSkillUsedDiagnosticEvent as l, onDiagnosticEvent as m, emitDiagnosticEvent as n, emitTrustedDiagnosticEvent as o, isInternalDiagnosticEventMetadata as p, emitDiagnosticEventWithTrustedTraceContext as r, emitTrustedDiagnosticEventWithPrivateData as s, areDiagnosticsEnabledForProcess as t, getInternalDiagnosticEventSequence as u, resetDiagnosticEventsForTest as v, createDiagnosticTraceContext as w, formatPropagatedDiagnosticTraceparent as x, setDiagnosticsEnabledForProcess as y, markCoreModelRequestStartedDiagnosticEvent as z };
