...
import { r as listThinkingLevelLabels, t as formatThinkingLevels } from "./thinking-dphnnN-M.js";
...
import { n as shouldForwardModelCommandToServer } from "./commands-registry.data-i3bR6Fdo.js";
import { n as listChatCommands, r as listChatCommandsForConfig } from "./commands-registry-list-D_Ueow0d.js";
...
import "./usage-format-Dr1DjctD.js";
...
async function runTuiUnlocked(opts) {
	...
	if (opts.backend) client = opts.backend;
		...
		const { EmbeddedTuiBackend } = await import("./embedded-backend-BlG4MGRo.js");
		client = new EmbeddedTuiBackend();
	} else {
		const { GatewayChatClient } = await import("./gateway-chat-7frK1cfh.js");
