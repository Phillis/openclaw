...
import { x as withPluginRuntimeGenerationScope } from "./hook-runner-global-IYtayVps.js";
import { r as ensureAuthProfileStore } from "./store-2zwMbXSG.js";
import { i as resolveCliBackendConfig, o as resolveCliRuntimeCanonicalProvider } from "./cli-backends-C12K7TVt.js";
...
import { i as preparedAgentRuntimeProfileAttemptHasCandidate, n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-GozlON-Q.js";
import { i as resolveModelWithRegistry } from "./model-BsbKjtEM.js";
import { n as prepareSimpleCompletionModel } from "./simple-completion-runtime-CaHEMuty.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-BiOgaQLy.js";
import { r as scopeAuthProfileStoreToPreparedPlan } from "./resolve-auth-DqRqAIhp.js";
...
async function resolveHarness(runtime) {
	if (runtime === "openclaw") {
		const { createOpenClawAgentHarness } = await import("./builtin-openclaw-BeuB-xOu.js");
