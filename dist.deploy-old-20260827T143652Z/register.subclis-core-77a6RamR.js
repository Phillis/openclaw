...
const pluginCliLoader = createLazyImportLoader(() => import("./cli-B5pHiGhp.js"));
...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-8oZkSwPG.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-DDWCxS-8.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-BLUte00p.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["promos"],
			loadModule: () => import("./promos-cli-DrCn6hC7.js"),
			exportName: "registerPromosCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-B6e-UdUo.js"),
	...
	]),
	{
		...
		register: async (program, argv) => {
			await (await import("./nodes-cli-Bn--2ZOs.js")).registerNodesCli(program, argv);
		}
	},
	...defineImportedProgramCommandGroupSpecs([
		{
		...
		{
			commandNames: ["node"],
			loadModule: () => import("./node-cli-CDaEq9fu.js"),
			exportName: "registerNodeCli"
		},
		{
			commandNames: ["connect"],
			loadModule: () => import("./connect-cli-BpiopXby.js"),
			exportName: "registerConnectCli"
		},
		{
			commandNames: ["worker"],
			loadModule: () => import("./worker-cli-DbKwslVb.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-DXBZ9huE.js"),
			exportName: "registerTuiCli"
		},
		{
			commandNames: ["resume"],
			loadModule: () => import("./resume-cli-6Fcd_DYI.js"),
		...
		{
			commandNames: ["hooks"],
			loadModule: () => import("./hooks-cli-dSdj03O-.js"),
		...
		{
			commandNames: ["qr"],
			loadModule: () => import("./qr-cli-C6uzU_XE.js"),
			exportName: "registerQrCli"
		},
		{
			commandNames: ["clawbot"],
			loadModule: () => import("./clawbot-cli-B2Md1Qxz.js"),
	...
	},
	{
		...
		register: async (program, argv) => {
			await registerSubCliWithPluginCommands(program, argv, async () => {
				(await import("./plugins-cli-pTE_2mFn.js")).registerPluginsCli(program);
			}, "after");
		}
	},
	{
		...
		register: async (program, argv, context) => {
			await (await import("./channels-cli-Df0FHSRS.js")).registerChannelsCli(program, argv, { includeSetupOptions: context.purpose === "completion" });
		}
	},
	...defineImportedProgramCommandGroupSpecs([
		{
			commandNames: ["directory"],
			loadModule: () => import("./directory-cli-HmUF_K-D.js"),
			exportName: "registerDirectoryCli"
		},
		{
			commandNames: ["security"],
			loadModule: () => import("./security-cli-CPLtWEnr.js"),
			exportName: "registerSecurityCli"
		},
		{
			commandNames: ["secrets"],
			loadModule: () => import("./secrets-cli-a0g1Y5Pn.js"),
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-3hMDQE5l.js"),
