...
import { l as rewrapToolWithBeforeToolCallHook, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-C_MzhwYQ.js";
import { B as withFileMutationQueues, D as createReadTool, H as hasOnlyCrlfLineEndings, U as normalizeToLF, V as decodeUtf8File, W as restoreLineEndings, z as withFileMutationQueue } from "./sessions-DVC_3nXc.js";
import { g as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-B8EtrfM_.js";
import { S as isToolWrappedWithBeforeToolCallHook, d as copyAgentToolMetadata } from "./gateway-IJRNg5Ul.js";
...
import { t as wrapToolWithAbortSignal } from "./agent-tools.abort-BJ8SMbbD.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-D1HfEOON.js";
import { a as createSandboxedReadTool, f as withMemoryWriteProvenance, i as createSandboxedEditTool, l as wrapToolWorkspaceRootGuard, n as createHostWorkspaceWriteTool, o as createSandboxedWriteTool, r as createOpenClawReadTool, s as wrapReadToolWithSkillContent, t as createHostWorkspaceEditTool, u as wrapToolWorkspaceRootGuardWithOptions } from "./agent-tools.read-DmQSuo3o.js";
...
const bashToolsModuleLoader$1 = createLazyImportLoader(() => import("./bash-tools-B4rc0wa7.js"));
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-B4rc0wa7.js"));
