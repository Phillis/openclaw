import { D as Tool, S as TextContent, _ as SimpleStreamOptions, d as Model, i as AssistantMessageEvent, k as ToolResultMessage, l as ImageContent, r as AssistantMessage, u as Message, y as StreamFn$1 } from "./types-Cm3n7XMD.js";
...
interface InternalToolBatchCall {
...
interface ToolLoopIntervention {
...
interface AgentLoopConfig extends SimpleStreamOptions {
  ...
  beforeToolBatch?: (context: InternalBeforeToolBatchContext, signal?: AbortSignal) => Promise<InternalBeforeToolBatchResult | undefined>;
...
type AgentEvent = {
  ...
  toolName: string;
  result: unknown;
  isError: boolean; /** False when resolution, preparation, validation, policy, or queued steering prevented execution. */
