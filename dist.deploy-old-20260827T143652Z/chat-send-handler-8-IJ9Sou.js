...
import { r as hasGlobalHooks, t as getGlobalHookRunner } from "./hook-runner-global-IYtayVps.js";
...
import { K as updateSessionEntry, en as patchSessionEntryCore, o as readSessionTranscriptActivePathEntryRelation, t as readSessionTranscriptWatermark } from "./session-accessor-Bi6bzKQE.js";
...
import { a as isAgentHarnessSessionKey, m as resolveMissingAgentHarnessSessionError, z as beginSessionWorkAdmission } from "./agent-harness-session-key-BMj1lPtX.js";
import { a as hasRestartRecoveryTerminalRun, t as buildRestartRecoveryClaimCleanupPatch } from "./restart-recovery-state-BoowPFT5.js";
...
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES } from "./store-CNsqBmYb.js";
import { a as parseInboundMediaUri } from "./media-reference-BeABx1cr.js";
...
import { d as isPluginOwnedSessionBindingRecord } from "./conversation-binding-BC9B3heN.js";
import { a as shouldComputeCommandAuthorized } from "./command-detection-B7xJbmAG.js";
...
import { a as logMessageReceived, r as logMessageProcessed } from "./diagnostic-CV4vi0UN.js";
...
import { n as resolveSessionResetType, t as resolveChannelResetConfig } from "./reset-CXwXEKFS.js";
...
import { o as readSessionMessageByIdAsync } from "./session-transcript-readers-CJcK7eRo.js";
import { a as resolveSessionModelRef } from "./placement-session-runtime-CnsNIn7H.js";
import { r as resolveGatewayModelSupportsImages } from "./session-utils-model-Cs1tFKI6.js";
import { T as loadGatewaySessionEntry, j as resolveDeletedAgentIdFromSessionKey } from "./session-utils-row-CB3Fore5.js";
...
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-x5uqWCfl.js";
import { i as dispatchInboundMessageWithProjectedDispatcher, l as emitInboundMessageAuditTerminal, s as emitMessageReceivedHooks } from "./dispatch-CWUC7Pme.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-B3hMecBl.js";
...
import { n as resolveSessionEntryResetFreshness } from "./entry-freshness-CCIdiTfD.js";
import { t as resolveQueueSettings } from "./queue-DwgCT7Tx.js";
...
import { a as isChatStopCommandText, d as updateChatRunProvider, l as resolveChatRunExpiresAtMs, o as registerChatAbortController } from "./chat-abort-Cm7ik-5J.js";
...
import { n as buildInboundUserContextPrefix } from "./inbound-meta-Dq4tuBAW.js";
...
import { a as attachManagedOutgoingMediaToMessage } from "./managed-image-attachments-7o4Hs5xR.js";
import { n as resolveChatAttachmentMaxBytes } from "./chat-attachment-policy-DrGl1Ors.js";
import { a as logAttachmentFailure, c as stripImageMediaMarkers, n as MediaOffloadError, o as parseMessageWithAttachments, r as UnsupportedAttachmentError, s as persistInboundImagesForTranscript, t as INLINE_IMAGE_DURABLE_OMISSION_MARKER } from "./chat-attachments-Cn8hTqfK.js";
import { t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-B7-Wq5M9.js";
import { i as maybeGenerateDashboardSessionTitle, r as isDashboardSessionTitleCandidate, t as buildDashboardSessionTitleSource } from "./dashboard-session-title-DxtfiKkS.js";
import { i as persistGatewaySessionLifecycleEvent } from "./session-lifecycle-state-D9fduxZz.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CRph4W92.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-AirdV13Z.js";
...
async function resolveDurableChatClaim(params) {
	...
	if (isAdoptedRestartRecoveryClaim(entry, params.clientRunId) && entry.status === "running" && entry.abortedLastRun === true) {
		...
		try {
			const { retryRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-rE6FxaZP.js");
