...
import { c as loadDeliveryQueueEntries, h as upsertDeliveryQueueEntry, l as loadDeliveryQueueEntry, m as updateDeliveryQueueEntry, o as getDeliveryQueueEntryStatus, t as completeDeliveryQueueEntry, u as moveDeliveryQueueEntryToFailed } from "./delivery-queue-sqlite-YQvmsrNF.js";
...
async function mergeSessionDeliveryPreparedMediaBlocks(id, mediaUrl, blocks, stateDir) {
	let retained = blocks;
	updateDeliveryQueueEntry(SESSION_DELIVERY_QUEUE_NAME, id, stateDir, (entry) => {
		const queued = entry;
		if (queued.kind !== "agentTurn") return queued;
