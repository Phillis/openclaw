...
async function runConfiguredSystemAgentText(params) {
	...
	try {
		...
		text = extractAgentRunText(route.runner === "cli" ? await (params.deps?.runCliAgent ?? (await import("./cli-runner-M-g8dvU1.js")).runCliAgent)({
			...shared,
			preparedRunAdmission,
			executionMode: "side-question",
			cleanupCliLiveSessionOnRunEnd: true
		}) : await (params.deps?.runEmbeddedAgent ?? (await import("./embedded-agent-DjHmTlnD.js")).runEmbeddedAgent)({
			...shared,
			preparedRunAdmission,
			toolsAllow: [],
