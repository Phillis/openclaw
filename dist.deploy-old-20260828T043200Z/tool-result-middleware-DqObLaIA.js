...
import { d as isMessagingToolSendAction, p as isPluginNativeMessagingTool } from "./tool-loop-detection-BBBu2KgN.js";
import { o as readEmbeddedMessageDeliveryFact } from "./embedded-agent-message-delivery-Dwtqwdl4.js";
import { r as isDeliveredMessagingToolResult, t as hasPluginMessagingDeliveryId } from "./embedded-agent-message-tool-source-reply-DORszAlv.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-EkLzN-CF.js");
