...
import { n as getCurrentPluginMetadataSnapshot, r as installTemporaryCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CKAJM6x9.js";
import { s as normalizeProviderId } from "./model-ref-shared-D4yx0hwT.js";
import { n as OPENAI_PROVIDER_ID } from "./openai-routing-mOc2UICM.js";
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, f as modelCatalogLogicalKey, g as resolveConfiguredModelPolicyAllow, i as buildModelAliasIndex, k as parseModelPolicyWildcardRef } from "./model-selection-shared-I5TmV9jL.js";
...
import { c as shouldEnableShellEnvFallback, n as getShellEnvAppliedKeys } from "./shell-env-Aw9vy7GT.js";
...
import { c as isNonSecretApiKeyMarker, g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, l as isOAuthApiKeyMarker } from "./model-auth-markers-CYmICvL9.js";
import { D as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-XSAeyFFJ.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, c as getRuntimeAuthProfileStoreSnapshot, r as ensureAuthProfileStore } from "./store-C0UG5FOx.js";
import { u as resolveProfileUnusableUntilForDisplay } from "./usage-6-myLAu1.js";
import { s as loadPreparedModelCatalogSnapshot } from "./prepared-model-catalog-U3rYWrrQ.js";
...
import { n as resolveAgentHarnessOwnerPluginIds } from "./runtime-plugin-load-plan-DBGXY5LT.js";
import { t as resolveAuthProfileDisplayLabel } from "./auth-profiles-zge5bJtu.js";
import "./profiles-B9i8Wh87.js";
import { r as getCustomProviderApiKey, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-DW3Bgqni.js";
...
import { n as resolveUtilityModelRefForAgent, t as readUtilityModelSetting } from "./utility-model-DDmd0Hw9.js";
import { n as resolveAgentHarnessRuntimeAvailability } from "./runtime-plugin-Gs3Etsvo.js";
import { d as ensureFlagCompatibility, m as isRich, s as resolveModelsTargetAgent } from "./shared-BOd9kz9I.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BeyzSB-j.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-CfVq1nOU.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-fJsOMfFV.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./terminal-core/table.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-BzQpiUfQ.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	const resolveCodexRuntimeAvailability = (provider) => {
		...
		const pending = (async () => {
			const { runPluginPayloadSmokeCheckForManifestRecords } = await import("./plugin-payload-validation-dl9fFIuN.js");
	...
	try {
		...
		const catalog = await loadPreparedModelCatalogSnapshot({
			config: cfg,
			agentId: workspaceAgentId,
			providerDiscoveryProviderIds: [.../* @__PURE__ */ new Set([
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-E-ZuKt_c.js");
			runtime.log("");
