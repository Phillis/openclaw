...
import { c as isSqliteLockError, d as normalizeSqliteNonNegativeInteger } from "./node-sqlite-_e3IvfT7.js";
...
function configureSqliteWalMaintenance(db, options = {}) {
	...
	if (timerIntervalMs > 0) {
		timer = setInterval(() => {
			if (tripwireDatabasePath && splitBrainDetectionEnabled) try {
