...
import { a as buildChannelConfigSchema, c as buildMultiAccountChannelSchema, t as AllowFromListSchema } from "./config-schema-ikPYPY3Q.js";
...
import { v as sendPayloadWithChunkedTextAndMedia } from "./reply-payload-i0RzN2iF.js";
import { a as createScopedChannelConfigAdapter, d as mapAllowFromEntries, s as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-C7An4wuC.js";
...
import { d as stripTargetKindPrefix, i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-wiAGUTYa.js";
...
import { d as createDefaultChannelRuntimeState, m as standardDmPolicyOpenIssue, o as buildTokenChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CopMHs_f.js";
import "./channel-status-Bt34VDhN.js";
import { i as coerceStatusIssueAccountId, u as readStatusIssueFields } from "./extension-shared-BO-DUGkx.js";
import "./channel-config-schema-DeVmAx-r.js";
import "./channel-actions-AIJ6nLei.js";
import "./channel-core-D0k0Lcs9.js";
import { F as createOpenProviderGroupPolicyWarningCollector, M as createConditionalWarningCollector, v as buildOpenGroupPolicyRestrictSendersWarning, y as buildOpenGroupPolicyWarning } from "./channel-policy-BG3-cCKG.js";
...
import { i as resolveZaloAccount, n as listZaloAccountIds, r as resolveDefaultZaloAccountId, t as inspectZaloAccount } from "./accounts-GafVFMJs.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Cz8edElN.js";
import { i as zaloSetupContract, t as createZaloSetupWizardProxy } from "./setup-core-Bt10A4Bg.js";
...
const zaloAccountSchema = object({
...
const ZaloConfigSchema = buildMultiAccountChannelSchema(zaloAccountSchema.extend({ historyLimit: number().int().min(0).optional() }), {
...
const loadZaloChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-CJJtYepr.js"));
const zaloSetupWizard = createZaloSetupWizardProxy(async () => (await import("./setup-surface-sqzdnI6F.js")).zaloSetupWizard);
