...
import { a as maybeResolveIdLikeTarget } from "./target-resolver-C54g4nxf.js";
...
import { n as cancelTerminalSourceReplyDelivery, o as mirrorDeliveredSourceReplyToTranscript, s as reconcileTerminalSourceReplyDelivery, t as beginTerminalSourceReplyDelivery } from "./source-reply-mirror-czTtsKe4.js";
import { d as resolveAttachmentMediaPolicy, o as hydrateAttachmentParamsForAction, t as dispatchChannelMessageAction } from "./message-action-dispatch-Bt1r28hX.js";
		...
		await withMessageOperationRoute({
			...
			work: async ({ cfg, channel, canonicalPoll, accountId, dedupeKey, authorize }) => {
				try {
					...
					let payload;
					if (canonicalPoll) {
						const { runMessageAction } = await import("./message-action-runner-BGCTS3_l.js");
