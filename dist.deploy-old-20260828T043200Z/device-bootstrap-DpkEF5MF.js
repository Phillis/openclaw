...
import { An as executeSqliteQuerySync, Bt as tableHasColumn, M as ensureDevicePairSetupBootstrapSchema, Mn as getNodeSqliteKysely, N as ensureDevicePairSetupCompletionSchema, R as ensureWorkerEnvironmentNodeEnrollmentSchema, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction, jn as executeSqliteQueryTakeFirstSync, zt as tableExists } from "./openclaw-state-db-CeAO_dqo.js";
import { t as safeEqualSecret } from "./secret-equal-DRsL8lKD.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-C-STNejO.js";
import { a as normalizeDevicePublicKeyBase64Url } from "./device-identity-UxfYyiX_.js";
...
function consumeDeviceBootstrapTokenWithSetupCompletionInTransaction(params) {
	...
	return runOpenClawStateWriteTransaction(({ db }) => {
		...
		if (completion) {
			if (record.profile?.purpose === "cloud-worker") bindCloudWorkerSetupCompletion({
				db,
				completion
			});
...
//#endregion
export { CLOUD_WORKER_PAIRING_SETUP_BOOTSTRAP_PROFILE as A, normalizeDeviceBootstrapProfile as B, loadPairedDevicePairingStoreRecordFromDatabase as C, updatePairedDevicePresenceInTransaction as D, updatePairedDeviceNodeSurfaceInTransaction as E, VOICE_NODE_PAIRING_SETUP_BOOTSTRAP_PROFILE as F, resolvePairingSetupAccess as G, resolveBootstrapProfileScopesForRoles as H, deviceBootstrapProfilesEqual as I, isMobilePairingSetupBootstrapProfile as L, FULL_ACCESS_PAIRING_SETUP_BOOTSTRAP_PROFILE as M, NODE_PAIRING_SETUP_BOOTSTRAP_PROFILE as N, nextApnsRegistrationVersion as O, PAIRING_SETUP_BOOTSTRAP_PROFILE as P, isNodePairingSetupBootstrapProfile as R, loadPairedDevicePairingStoreRecord as S, readDevicePairingStoreStateFromDatabase as T, resolveDeviceProfileRoleScopes as U, resolveBootstrapProfileScopesForRole as V, resolveDeviceProfileScopes as W, verifyPairingToken as _, getBoundDeviceBootstrapContext as a, resolvePairingPaths as b, issueDevicePairSetupBootstrapToken as c, redeemDeviceBootstrapTokenProfile as d, restoreGenericDeviceBootstrapToken as f, generatePairingToken as g, verifyDeviceBootstrapToken as h, ensureDevicePairSetupBootstrapToken as i, CONTROL_UI_OWNER_BOOTSTRAP_PROFILE as j, BOOTSTRAP_HANDOFF_OPERATOR_SCOPES as k, pruneExpiredDevicePairSetupCompletions as l, revokeDeviceBootstrapTokensForDevice as m, confirmDevicePairSetupCompletionDelivery as n, getBoundDeviceBootstrapProfile as o, revokeDeviceBootstrapToken as p, consumeDeviceBootstrapTokenWithSetupCompletion as r, issueDeviceBootstrapToken as s, clearDeviceBootstrapTokens as t, readDevicePairSetupCompletion as u, coercePairingStateRecord as v, persistDevicePairingStoreState as w, loadDevicePairingStoreState as x, pruneExpiredPending as y, isVoiceNodePairingSetupBootstrapProfile as z };
