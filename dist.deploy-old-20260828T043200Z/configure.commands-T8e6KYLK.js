...
import { o as resolvePluginContributionOwners } from "./plugin-registry-contributions-BBST5Lo5.js";
...
import { o as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-BR9ZQQM7.js";
...
import { a as guardCancel, d as summarizeExistingConfig, f as validateGatewayPasswordInput, n as applyWizardMetadata, p as waitForGatewayReachable, s as normalizeGatewayTokenInput, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-BkujwgEw.js";
import { c as resolveSystemAgentOnboardingTarget, n as applyOnboardingPrimaryModel, o as resolveOnboardingAgentTarget, r as ensureOnboardingAgentWorkspace, t as applyAgentModelDefaults } from "./onboard-agent-target--5lBUg6J.js";
...
import { i as applyAuthChoice } from "./auth-choice-98h1Cp6V.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-DCD_dIHf.js";
import { c as writeWizardConfigFile } from "./setup.shared-Bl7UavWq.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DMCOP1FF.js";
...
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BjM03-uz.js";
import { t as setupSkills } from "./onboard-skills-DpGjlQwR.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-O_7h-DUp.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-D8w2XkL-.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, runSearchSetupFlow } = await import("./search-setup-BC294Q6C.js");
