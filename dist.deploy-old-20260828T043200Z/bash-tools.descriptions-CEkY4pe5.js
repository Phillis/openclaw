import { i as resolveExecApprovalsFromFile } from "./exec-approvals-B5vSSaiI.js";
...
function describeExecTool(params) {
	...
	if (process.platform !== "win32") return `${base} Quote arguments containing shell metacharacters, including URL query strings with \`?\` or \`&\`.`;
	const lines = [base];
