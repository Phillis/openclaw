...
import { _ as isDefaultAgentRuntimeId, d as resolveSelectedOpenAIRuntimeProvider, y as normalizeOptionalAgentRuntimeId } from "./openai-routing-mOc2UICM.js";
import { d as listModelAliasCandidates, i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels } from "./model-selection-shared-I5TmV9jL.js";
import "./defaults-CdX9UGcX.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { E as drainPluginNextTurnInjectionContext, R as buildPluginAgentTurnPrepareContext } from "./loader-D0AfkRZe.js";
import { t as deriveContextPromptTokens } from "./usage-DNKCVmJi.js";
import { f as joinPresentTextSegments } from "./hook-runner-global-CWpWIBkz.js";
import { a as resolveCandidateThinkingLevel } from "./thinking-runtime-1slENmfx.js";
import { n as resolveBoundAgentIdForSession } from "./plugin-command-execution-rQrOAcen.js";
import { E as deriveSessionName, a as compareProcessSessionStartOrder, m as listRunningSessions } from "./bash-process-registry-08adq0zn.js";
import { n as resolveEffectiveToolFsWorkspaceOnly } from "./tool-fs-policy-DwrFWb3k.js";
import { a as buildActiveMusicGenerationTaskPromptContextForSession, i as buildActiveImageGenerationTaskPromptContextForSession, o as buildActiveVideoGenerationTaskPromptContextForSession } from "./media-generation-task-status-BciEsE_o.js";
...
import { t as agentRuntimeAuthPlanMatchesTarget } from "./prepare-auth-Bc5sTa5K.js";
import { t as readAgentModelContextTokens } from "./model-context-tokens-Cy1KpVE9.js";
...
function resolveEmbeddedCompactionThinkingLevel(params) {
	...
	const requestedLevel = configuredLevel === "inherit" ? params.inheritedLevel : configuredLevel ?? "low";
...
//#endregion
export { wrapPluginSystemContextSection as _, prependSystemPromptAddition as a, resolvePromptBuildHookResult as c, resolveContextEngineCapabilities as d, buildEmbeddedCompactionRuntimeContext as f, resolveEmbeddedCompactionThinkingLevel as g, resolveEmbeddedCompactionTarget as h, mergeOrphanedTrailingUserPrompt as i, resolvePromptModeForSession as l, resolveCompactionHarnessRuntime as m, buildAfterTurnRuntimeContextFromUsage as n, resolveAttemptFsWorkspaceOnly as o, resolveCompactionContextTokenBudget as p, forgetPromptBuildDrainCacheForRun as r, resolveAttemptMediaTaskSystemPromptAddition as s, buildAfterTurnRuntimeContext as t, shouldWarnOnOrphanedUserRepair as u, listActiveProcessSessionReferences as v };
