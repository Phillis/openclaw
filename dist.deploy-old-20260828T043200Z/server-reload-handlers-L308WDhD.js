...
import { x as getRuntimeConfigWriteApplication } from "./io-DlN5njvP.js";
...
import { o as loadInstalledPluginIndexInstallRecords, s as loadInstalledPluginIndexInstallRecordsSync } from "./manifest-registry-DRErrq38.js";
...
import { S as requireActivePluginChannelRegistry } from "./runtime-DMlUh4Cg.js";
...
import { p as setGatewaySigusr1RestartPolicy, r as deferGatewayRestartUntilIdle, u as resolveGatewayRestartDeferralTimeoutMs } from "./restart-BmO3Nggw.js";
import "./installed-plugin-index-records-CyommlnD.js";
import { c as markPreparedModelRuntimeSnapshotsStale, d as refreshPreparedModelRuntimeSnapshots, f as rejectPendingPreparedModelRuntimeReplacement, i as advancePreparedModelRuntimeConfig } from "./prepared-model-runtime-afzKiwqZ.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { i as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-Di0Tgn4T.js";
...
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-CnB90N_1.js";
...
import { l as resetSkillSnapshotConfigFingerprintCache } from "./workspace-skill-loader-BIyN38wj.js";
import { r as resetDirectoryCache } from "./target-resolver-C54g4nxf.js";
...
import { i as refreshContextWindowCache } from "./context-Bj-w-uhp.js";
import { c as getActiveSecretsRuntimeSnapshotRevisionState, g as hasSameSecretReloadContract, l as getActiveSecretsRuntimeSnapshotState, p as hasActiveSecretsRuntimeSnapshotLineage, r as clearSecretsRuntimeSnapshotState, x as setSecretsRuntimeSourceSnapshotIfCurrent, y as restoreSecretsRuntimeSourceSnapshotIfLineageCurrent } from "./runtime-state-LhRdbFR1.js";
import { t as commitHooksConfigReload, y as resolveHooksConfig } from "./hooks-DlIfwGMP.js";
import { n as diffGatewayReloadPaths, t as diffConfigPaths } from "./config-diff-DoHIoE3G.js";
import { i as listPluginInstallWholeRecordPaths, n as isNoopGatewayReloadPlan, r as listPluginInstallTimestampMetadataPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-fBV5Mc8b.js";
...
import { t as buildGatewayCronService } from "./server-cron-BmP28AQQ.js";
import { t as invalidateConfigGetResponseCache } from "./config-get-response-CoRPyKz9.js";
...
import { i as startGatewayCronWithLogging } from "./server-runtime-services-DbwKQMA1.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-CgpcZU0v.js";
import { r as publishRuntimeSecretsStateTransition } from "./server-startup-config-Dd3J-k4e.js";
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				...
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-BktAKPyL.js"), import("./gmail-watcher-lifecycle-DAJrKye2.js")]);
...
async function restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, options) {
	if (!(await import("./runtime-Cbbi8NFj.js")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, { runtimeSourceConfig: options?.runtimeSourceConfig })) return false;
	options?.onActivated?.();
	return true;
}
...
function startManagedGatewayConfigReloader(params) {
	...
	const { applyHotReload, acceptRestartConfig, beginGatewayRestartLifecycle, pauseGatewayRestartForConfigCandidate, publishAppliedConfigHash, publishAcceptedRestartTarget, publishDeferredAppliedConfigHash, recordAcceptedRestartTarget, requestGatewayRestart, restoreConservativeRestartDebt, stopRestartRetries } = createGatewayReloadHandlers({
		...
		assertRestartReady: () => import("./openclaw-database-preflight-tC-_YWa7.js").then(({ assertOpenClawDatabasesReadyForRestart }) => assertOpenClawDatabasesReadyForRestart({ env: process.env })),
		restartRecoveryAvailable,
