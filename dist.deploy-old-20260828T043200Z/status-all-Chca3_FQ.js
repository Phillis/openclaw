...
import { t as formatConfigIssueLine } from "./issue-format-I3BIXbd4.js";
import "./config-B2bSneS2.js";
import { _ as resolveGatewayRequiredListenHosts, h as resolveGatewayBindHost } from "./net-DeK7gO-9.js";
import { a as resolveGatewayRestartLogPath, i as resolveGatewayLogPaths, o as resolveGatewaySupervisorLogPaths } from "./restart-logs-PTGgxP4T.js";
import { a as isExpectedGatewayListeners, i as isDualStackLoopbackGatewayListeners, n as classifyPortListener, r as formatPortDiagnostics } from "./ports-format-FOKK5FaA.js";
import { n as inspectPortUsage } from "./ports-inspect-8eZVwL-B.js";
import "./ports-8zXv4rN7.js";
import { n as readLastGatewayErrorLine, t as readGatewayLogTailLines } from "./diagnostics-BAKcur8h.js";
import { o as classifyOAuthRefreshFailureReason } from "./oauth-refresh-failure-tik1XWlI.js";
import { f as summarizeRestartSentinel, u as readRestartSentinelReadOnly } from "./restart-sentinel-BabYlCrz.js";
import { t as buildWorkspaceSkillStatus } from "./status-CFSwEllv.js";
import "./exec-approvals-B5vSSaiI.js";
import { s as loadExecApprovalsReadOnly } from "./exec-approvals-generated-migration-DfpexxOF.js";
...
import { n as buildPluginCompatibilityNotices } from "./status-DoE4_lNj.js";
import { t as formatPluginCompatibilityNotice } from "./status-compatibility-DdQ1VWdc.js";
import { n as resolveStatusAllConnectionDetails } from "./status.gateway-connection-ClVBG1w9.js";
import { t as formatTelemetryExporterSummary } from "./telemetry-exporter-summary-BzbrNr8-.js";
import { f as redactStatusSecrets } from "./format-DzOpGxRr.js";
import { d as buildStatusOverviewSurfaceFromOverview, i as resolveStatusGatewayHealthSafe, n as resolveStatusGatewayDiagnosticsSafe, s as resolveStatusServiceSummaries } from "./status-runtime-shared-CRkpabcE.js";
import { a as statusAgentsTableColumns, c as formatUpdateRestartStatusValue, i as buildStatusChannelDetailSections, l as buildStatusAllOverviewRows, n as appendStatusSectionHeading, o as statusOverviewTableColumns, r as buildStatusAgentTableRows, s as formatUpdateRestartActionLines, t as appendStatusReportSections } from "./text-report-Bl6lKiZM.js";
import { a as formatStatusConfigDiagnosticEntries } from "./status.format-DEAHfflZ.js";
import { n as resolveStatusSummaryFromOverview, t as collectStatusScanOverview } from "./status.scan-overview-DIjDDo5V.js";
import { n as statusChannelsTableColumns, t as buildStatusChannelsTableRows } from "./channels-table-DxFNivs3.js";
import { t as resolveNodeOnlyGatewayInfo } from "./status.node-mode--TukcgnE.js";
...
async function appendStatusAllDiagnosis(params) {
	...
	}
	{
		...
		emitCheck(params.tailscaleMode === "off" ? `Tailscale exposure: off · daemon ${backend}${params.tailscale.dnsName ? ` · ${params.tailscale.dnsName}` : ""}` : `Tailscale exposure: ${params.tailscaleMode} · daemon ${backend}${params.tailscale.dnsName ? ` · ${params.tailscale.dnsName}` : ""}`, params.tailscaleMode === "off" || okBackend && hasDns ? "ok" : "warn");
	...
	if (!params.nodeOnlyGateway && params.exporterDiagnostics) if (params.exporterDiagnostics.ok) {
	...
	if (!params.nodeOnlyGateway && params.deliveryDiagnostics?.ok) if (isDeliveryDiagnosticsLike(params.deliveryDiagnostics.value)) {
