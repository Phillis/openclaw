...
function isConfigValidationFailedError(error) {
	return error instanceof Error && "code" in error && error.code === CONFIG_VALIDATION_FAILED_CODE;
}
...
//#endregion
export { isConfigValidationFailedError as n, createConfigValidationFailedError as t };
