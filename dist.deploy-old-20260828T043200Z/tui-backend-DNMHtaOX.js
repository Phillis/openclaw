...
import { t as executeSystemAgentOperation } from "./operations-CCkoW4hg.js";
...
import { t as SystemAgentChatEngine } from "./chat-engine-DoHto_Pc.js";
...
async function runSystemAgentTui(opts, runtime) {
	...
	for (;;) {
		...
		const runTui = boundOpts.runTui ?? (await import("./tui-Cc6OljHQ.js")).runTui;
		try {
			await runTui({
				local: true,
