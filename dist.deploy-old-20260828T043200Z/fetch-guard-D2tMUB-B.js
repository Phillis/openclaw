...
import { n as createHttp1EnvHttpProxyAgent, r as createHttp1ProxyAgent, t as createHttp1Agent, u as resolveUndiciAutoSelectFamilyConnectOptions } from "./undici-runtime-CWs3Ll9x.js";
import { _ as resolvePinnedHostnameWithPolicy, a as createPinnedDispatcher, i as closeDispatcher, n as assertHostnameAllowedWithPolicy, p as matchesHostnameAllowlist, t as SsrFBlockedError, v as resolveSsrFPolicyForUrl } from "./ssrf-arYIaOWE.js";
import "./pinned-dispatcher-pool-C9XaAjYV.js";
import { i as isMockedFetch, n as fetchWithRuntimeDispatcher } from "./runtime-fetch-Blw1Z7ZX.js";
import { o as globalUndiciStreamTimeoutMs } from "./undici-global-dispatcher-BGWyxhnx.js";
...
async function captureGuardedFetchExchange(params) {
	...
	const { captureHttpExchange, isDebugProxyGlobalFetchPatchInstalled } = await import("./runtime-CDq4Tvk4.js");
...
async function fetchWithSsrFGuardInternal(params) {
	...
	while (true) {
		...
		try {
			...
			response = shouldUseRuntimeFetch ? await fetchWithRuntimeDispatcher(parsedUrl.toString(), init) : await defaultFetch(parsedUrl.toString(), init);
...
//#endregion
export { retainSafeHeadersForCrossOriginRedirectHeaders as a, withTrustedExplicitProxyGuardedFetchMode as c, fetchWithSsrFGuard as i, retainSafeHeadersForCrossOriginRedirect$1 as l, GuardedFetchRedirectError as n, withStrictGuardedFetchMode as o, fetchConfiguredLocalOriginWithSsrFGuard as r, withTrustedEnvProxyGuardedFetchMode as s, GUARDED_FETCH_MODE as t };
