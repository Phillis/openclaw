import { t as hasConfiguredChannelsForReadOnlyScope } from "./channel-presence-policy-Cy9fjmLX.js";
import "./channel-plugin-ids-BdzaxZ-5.js";
import { r as withProgress } from "./progress-3-oJv0bD.js";
import { t as collectStatusScanOverview } from "./status.scan-overview-DIjDDo5V.js";
import { n as scanStatusJsonWithPolicy, r as executeStatusScanFromOverview } from "./status.scan.fast-json-D7aJfTAE.js";
import { n as resolveStatusMemoryStatusSnapshot } from "./status.scan-memory-DD7PC2do.js";
...
async function scanStatus(opts, _runtime) {
	...
	return await withProgress({
		...
		const pluginCompatibility = opts.all ? await import("./status-0EKylA5g.js").then(({ buildPluginCompatibilitySnapshotNotices }) => buildPluginCompatibilitySnapshotNotices({ config: overview.cfg })) : [];
		progress.tick();
