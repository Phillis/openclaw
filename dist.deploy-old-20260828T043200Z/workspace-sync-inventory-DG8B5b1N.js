...
import { i as workerSshCommandOptions } from "./ssh-CVu3Gyx7.js";
import { D as MAX_WORKSPACE_INVENTORY_ENTRIES, E as MAX_WORKSPACE_GIT_CANDIDATES, T as isDerivedWorkspacePath, g as gitFileMode, t as isPortableRootContainedSymlink } from "./workspace-actual-manifest-DIThIqhg.js";
...
async function readWorkspaceTransferPaths(filePath) {
	...
	for await (const entry of readBoundedGitPathCandidates(filePath)) paths.add(entry);
	return paths;
}
...
//#endregion
export { workspaceInventoryError as a, runWorkspaceInventoryCommandToFile as i, filterExistingGitTransferList as n, readWorkspaceTransferPaths as r, createWorkspaceGitTransferList as t };
