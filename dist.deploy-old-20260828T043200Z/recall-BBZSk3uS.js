...
import { a as normalizeActiveMemoryFastMode } from "./config-m5pMvIYo.js";
import { o as getModelRef } from "./query-cRyvVu4H.js";
import { d as scheduleMemorySearchCleanupAfterTimeout, f as setCachedResult, h as toSingleLineLogValue, i as getCachedResult, l as resetCircuitBreaker, m as toSingleLineErrorMessage, n as buildCircuitBreakerKey, o as isCircuitBreakerOpen, p as shouldCacheResult, s as recordCircuitBreakerTimeout, t as buildCacheKey, u as resolveActiveRecallForRun } from "./recall-state-B7Hr2caU.js";
import { i as resolveCanonicalSessionKeyFromSessionId, n as buildPluginStatusLine, r as persistPluginStatusLines, t as buildPersistedDebugSummary } from "./session-C6F3f81E.js";
import { a as watchTerminalMemorySearchResult } from "./transcript-watch-fx81WH1V.js";
import { n as buildSubagentRecallResult, r as buildTimeoutRecallResult, s as readPartialTimeoutData } from "./transcript-result-Dk6JLwg9.js";
import { t as runRecallSubagent } from "./recall-run-DAB3zII2.js";
...
async function maybeResolveActiveRecall(params) {
	...
	return await resolveActiveRecallForRun(`${runId}:${buildCacheKey({
		agentId: params.agentId,
		sessionKey: params.sessionKey,
		sessionId: params.sessionId,
		query: params.query,
	...
	})}`, (onTimeoutCleanup) => resolveActiveRecall({
		...recallParams,
		onTimeoutCleanup
	}));
}
