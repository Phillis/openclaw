...
import { C as voiceProviderSupportsModel, S as resolveVoiceProviderCandidates, b as resolveSupportedVoiceModelRefs, x as resolveVoiceModelRefs, y as resolvePrimaryVoiceProviderCandidate } from "./loader-D0AfkRZe.js";
...
import { a as getReplyPayloadMetadata, p as markReplyPayloadAsTtsSupplement } from "./reply-payload-BeeUJOmJ.js";
import { i as transcodeAudioBuffer } from "./media-services-B8MVUzbz.js";
...
async function maybeApplyTtsToPayloadCore(params, persistTtsAudio) {
	...
	if (autoMode === "off" && !explicitTts) return params.payload;
