...
import { At as boolean, Et as array, Rn as string, Tn as object, Xn as union, Zn as unknown, wn as number } from "./schemas-CZ9Toj_c.js";
import { i as logWarn } from "./logger-D4iLuGk3.js";
import { i as emitAgentEvent, u as onAgentEvent } from "./agent-events-CcZImb5w.js";
...
import { s as toOpenAiChatCompletionsUsage } from "./usage-DNKCVmJi.js";
import "./stream-message-shared-Cyrn1UHN.js";
import { r as isClientToolNameConflictError } from "./agent-tool-definition-adapter-DWr4Yi_A.js";
import { a as extractImageContentFromSource, n as DEFAULT_INPUT_IMAGE_MIMES, o as normalizeMimeList, r as DEFAULT_INPUT_TIMEOUT_MS, t as DEFAULT_INPUT_IMAGE_MAX_BYTES } from "./input-files-BYrqCFUr.js";
...
import { a as authorizeOpenAiCompatibleHttpModelOverride, g as resolveOpenAiCompatibleHttpSenderIsOwner, h as resolveOpenAiCompatibleHttpOperatorScopes } from "./http-auth-utils-CrQlRW6b.js";
import { h as writeDone, l as sendMissingScopeForbidden, m as watchClientDisconnect, o as sendInvalidRequest, p as setSseHeaders, r as parseGatewayJsonRequest, s as sendJson } from "./http-common-m4pDgMA2.js";
import { t as authorizeGatewaySessionCreation } from "./operator-role-policy-Bvt-UeJ1.js";
import { a as isGatewaySessionKeyOverrideError, c as isUnknownGatewayAgentError, d as resolveGatewayRequestContext, f as resolveOpenAiCompatModelOverride, i as isAgentSelectionRequiredError, o as isInvalidGatewayModelError, r as authorizeOpenAiCompatibleHttpSession } from "./http-utils-BKAf5kRa.js";
import { t as handleGatewayPostJsonEndpoint } from "./http-endpoint-helpers-aBy7m95-.js";
import { a as resolveOpenAiCompatError, c as normalizeInputHostnameAllowlist, d as isReplaceableAssistantStreamEvent, f as resolveAssistantStreamDeltaText, i as isFailedOpenAiAgentRun, l as IMAGE_ONLY_USER_MESSAGE, n as resolveUnsatisfiedToolChoiceMessage, o as validateOpenAiSamplingParams, p as resolveAssistantStreamSnapshotText, r as toolChoiceConstraintPrompt, s as resolveAgentRunUsage, t as isToolChoiceConstraintSatisfied, u as buildAgentMessageFromConversationEntries } from "./openai-tool-choice-ChcFX3NE.js";
...
async function handleOpenAiHttpRequest(req, res, opts) {
	...
	const creationAuth = authorizeGatewaySessionCreation({
		...
		...senderIsOwner && !handled.requestAuth.authenticatedUserProfile ? { actor: { kind: "system" } } : { profileId: handled.requestAuth.authenticatedUserProfile?.profileId },
		agentId
	});
	if (creationAuth) {
	...
	if (!stream) {
		...
		try {
			...
			if (isFailedOpenAiAgentRun(result)) throw new Error("agent run failed");
			...
			if (stopReason === "tool_calls" && pendingToolCalls && pendingToolCalls.length > 0) {
				sendJson(res, 200, {
					...
					choices: [{
						...
						message: {
							role: "assistant",
							content: resolveAgentResponseCommentary(result),
