...
import { a as workerSshOptions, i as workerSshCommandOptions, o as workerSshRemoteCommand, r as runWorkerSshCandidates, t as prepareWorkerSsh } from "./ssh-CVu3Gyx7.js";
import { A as MAX_WORKSPACE_MANIFEST_BYTES, _ as parseWorkerWorkspaceManifest, d as withWorkspaceHashMemo, h as MAX_RECONCILIATION_TOTAL_BYTES, i as MAX_WORKSPACE_HASH_MEMO_BYTES, m as MAX_RECONCILIATION_FILE_BYTES, o as createWorkspaceReconcileMetrics, p as MAX_RECONCILIATION_ENTRIES, s as measureLocalWorkspaceReconciliation, w as DERIVED_WORKSPACE_RSYNC_EXCLUDES, y as serializeWorkerWorkspaceManifest } from "./workspace-actual-manifest-DIThIqhg.js";
import { a as recoverWorkerWorkspaceReconciliation, c as changedPaths, i as parseAcceptedWorkspaceSettlement, n as AcceptedWorkspacePublicationIndeterminateError, o as assertWorkspaceMatchesManifest, r as isAcceptedWorkspacePublicationIndeterminateError, s as assertWorkspaceResultStable, t as applyStagedWorkerWorkspace, u as manifestNodes } from "./workspace-reconcile-Ca4yuu6w.js";
import { d as workerWorkspaceResultStaging, f as workerWorkspaceTransferPaths } from "./workspace-result-staging-C1c-gG8N.js";
import { a as REMOTE_GIT_WORKSPACE_RETRY_RESET_JS, i as REMOTE_WORKSPACE_ACCEPTED_TRANSACTION_JS, n as REMOTE_WORKSPACE_MANIFEST_JS, r as REMOTE_WORKSPACE_SETUP_SCRIPT, t as REMOTE_GIT_WORKSPACE_SETUP_SCRIPT } from "./workspace-sync-scripts-5YsdfQ0E.js";
...
import { _ as workerWorkspaceRsyncRemoteCommand, a as parseRemoteWorkspaceSetup, c as resolveRemoteWorkspaceManifest, d as stableWorkerPathComponent, f as validateWorkspaceSyncRequest, g as workerWorkspaceRsyncReceiverEntryPath, h as workerWorkspaceCommandSucceeded, i as parseManifestRef, l as resolveWorkerWorkspaceGitAuthor, m as workerAcceptedWorkspaceRsyncReceiverPath, n as captureRemoteWorkspaceManifest, o as probeWorkspaceGitMode, r as createWorkerWorkspaceRsyncReceiverPathFactory, s as readTransferredManifest, t as WORKER_WORKSPACE_RSYNC_DESTINATION, u as runBoundedInboundRsync, v as workerWorkspaceSshArgv, y as workspaceSyncError } from "./workspace-sync-helpers-Ba8iUX3R.js";
import { i as runWorkspaceInventoryCommandToFile, n as filterExistingGitTransferList, t as createWorkspaceGitTransferList } from "./workspace-sync-inventory-DG8B5b1N.js";
	...
	return {
		...
		start(argv, options) {
			...
			child.stdout.on("data", (chunk) => {
				if (readySettled || exitEventResult !== void 0) return;
...
function createWorkerWorkspaceActions(options) {
	...
	const runWorkspaceCommand = async (command) => {
		...
		return await runWorkerSshCandidates(prepared, remainingCommandTimeoutMs(), async (port, remainingTimeoutMs) => await runTask(workerWorkspaceSshArgv(prepared, command.argv, port), commandOptions(remainingTimeoutMs)));
	};
...
function createWorkerTunnelManager(options = {}) {
	...
	async function start(request) {
		...
		if (current) {
			...
			if (request.ownerEpoch === current.ownerEpoch) return await current.initialization;
		}
		const entry = {
			environmentId: request.environmentId,
	...
	async function stopAll() {
		...
		entries.clear();
		for (const entry of current) entry.abortController.abort(/* @__PURE__ */ new Error("Worker tunnel manager stopped"));
