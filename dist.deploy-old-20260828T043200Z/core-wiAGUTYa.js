...
import "./typebox-C6o7T1Lp.js";
import "./delegate-BrP4b8vk.js";
...
async function ensureConfiguredAcpBindingReady(params) {
	return (await import("./persistent-bindings.lifecycle-BXOEjnsq.js")).ensureConfiguredAcpBindingReadyCore(params);
}
