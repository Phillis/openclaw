...
import { d as assertValidLaunchAgentLabel, f as resolveLaunchAgentLabel, h as isLaunchctlNotLoaded, i as isSystemLaunchDaemonOwnershipError, m as formatLaunchctlResultDetail, n as formatSystemLaunchDaemonOwnershipSummary, p as execLaunchctl, r as inspectSystemLaunchDaemonOwnership, t as assertNoSystemLaunchDaemonOwnership, u as readLaunchAgentProgramArgumentsFromFile } from "./launchd-system-4KAEGLKr.js";
...
import { a as resolveLaunchAgentEnvWrapperPath, c as rewriteLaunchAgentPlistForRestart, i as resolveLaunchAgentEnvFilePath, l as writeLaunchAgentPlist, n as readExistingLaunchAgentPlist, o as resolveLaunchAgentPlistPath, r as readLaunchAgentProgramArguments, s as resolveLaunchAgentPlistPathForLabel, t as publishLaunchAgentPlist } from "./launchd-service-files-B8DZVvug.js";
...
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-g_celehk.js";
import { n as scheduleDetachedLaunchdRestartHandoff, t as scheduleDetachedLaunchdMaintenancePark } from "./launchd-restart-handoff-z-BP1LKf.js";
...
async function readLaunchAgentRuntime(env, opts) {
	...
	if (probe.state === "unknown") {
		...
		return {
			status: "unknown",
			detail: probe.detail,
			...plistExists ? missingGuiSession ? { missingGuiSession: true } : {} : { missingUnit: true }
		};
	}
...
//#endregion
export { parseLaunchAgentEnabled as _, parkCurrentLaunchAgentForMaintenance as a, restartLaunchAgent as c, stageLaunchAgent as d, uninstallLaunchAgent as f, launchAgentPlistExists as g, isLaunchAgentLoaded as h, parseLaunchctlListOpenClawUpdateJobs as i, startLaunchAgent as l, isLaunchAgentEnabled as m, disableOpenClawUpdateLaunchdJob as n, stopLaunchAgent as o, formatLaunchAgentGuiSessionError as p, findStaleOpenClawUpdateLaunchdJobs as r, repairLaunchAgentBootstrap as s, disableCurrentOpenClawUpdateLaunchdJob as t, installLaunchAgent as u, parseLaunchctlPrint as v, readLaunchAgentRuntime as y };
