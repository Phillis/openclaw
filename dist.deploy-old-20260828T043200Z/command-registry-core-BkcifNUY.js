...
import { a as defineImportedCommandGroupSpec, i as buildCommandGroupEntries, o as defineImportedProgramCommandGroupSpecs } from "./register.subclis-core-BbC8YuZK.js";
...
const coreEntrySpecs = [
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([
		{
			...
			loadModule: () => import("./register.setup-VJIdkVaL.js"),
			exportName: "registerSetupCommand"
		},
		{
			commandNames: ["onboard"],
			loadModule: () => import("./register.onboard-CvJPZSC3.js"),
		...
		},
		{
			...
			loadModule: () => import("./register.maintenance-DirBA0b7.js"),
	...
	defineImportedCommandGroupSpec(["agent"], () => import("./register.agent-turn-umUL06gg.js"), (mod, { program, ctx }) => {
		mod.registerAgentTurnCommand(program, { agentChannelOptions: ctx.agentChannelOptions });
	}),
	defineImportedCommandGroupSpec(["agents"], () => import("./register.agent-Be_-87a0.js"), (mod, { program }) => {
	...
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([{
		...
		loadModule: () => import("./register.status-health-sessions-CqiCr3IM.js"),
