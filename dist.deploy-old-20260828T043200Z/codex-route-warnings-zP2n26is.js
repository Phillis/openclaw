...
import { g as migrateLegacyRuntimeModelRef } from "./legacy-C3aoLO5V.js";
import { i as rewriteKnownModelRefs, n as collectBlockedLegacyOpenAICodexProviderPlan } from "./legacy-config-migrations.runtime.models-B0IK-Bzp.js";
import { m as resolveModelExtraParamSources, p as isAgentRuntimeModelParam } from "./openai-routing-mOc2UICM.js";
import { t as resolveModelRuntimePolicy } from "./model-runtime-policy-CbU9a7ui.js";
import { S as toOpenAIModelId, _ as readModelConfigPrimaryRef, a as isBlockedLegacyCodexModelRef, b as resolveRuntimeModelRef, c as isOpenAICodexModelRef, d as modelRefUsesCodexRuntime, f as normalizeDefaultProviderModelRef, g as readLegacyDefaultsRuntime, h as readAgentPrimaryModelRef, i as isBlockedLegacyCodexModelPair, l as isProviderlessModelRef, m as parseCodexRouteModelRef, n as asAgentRuntimePolicyConfig, o as isLegacyCodexProviderId, p as normalizeRuntimeString, r as canonicalOpenAIModelUsesCodexRuntime, s as isOpenAICodexAuthProfileRef, t as agentUsesCodexRuntimeForCompaction, v as resolveImplicitDefaultAgentModelRef, x as toCanonicalOpenAIModelRef, y as resolveRuntime } from "./codex-route-model-ref-Du1KAbLA.js";
import { t as listMutableCodexRouteAgentEntries } from "./codex-route-agent-entries-D1gMHnMO.js";
import { At as applySessionEntryReplacements, J as scanDoctorSessionEntriesStrict, W as iterateDoctorSessionKeyBatches, Y as scanDoctorSessionEntriesTolerant } from "./session-accessor-B-FKZX9M.js";
...
import { S as hasMatchingOAuthIdentity, a as loadPersistedAuthProfileStore, c as parseLegacyCredentialEntry, o as loadPersistedSharedAuthProfileStore, x as areOAuthCredentialsEquivalent } from "./persisted-DGErf7Xt.js";
...
import { n as resolveLegacyAuthProfilesPath } from "./doctor-auth-legacy-paths-DBxVw4c8.js";
...
function resolveKnownModelRefMigrationTarget(cfg, ref) {
	if (isBlockedLegacyCodexModelRef({
		modelRef: ref,
		blockedModelIdentities: new Set(collectBlockedLegacyOpenAICodexProviderPlan(cfg).blockedModelIdentities)
	})) return;
	const migrated = rewriteKnownModelRefs(migrateLegacyRuntimeModelRef(ref)?.ref ?? toCanonicalOpenAIModelRef(ref) ?? ref, "model", []).value;
