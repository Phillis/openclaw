...
import { a as resolveSharedAuthStorePath, r as resolveOAuthRefreshLockPath } from "./path-resolve-CCojuy8M.js";
import { s as withFileLock } from "./file-lock-DRVK2jTz.js";
import "./file-lock-CS5vu_jB.js";
import "./config-B2bSneS2.js";
import { a as resolveTokenExpiryState, n as evaluateStoredCredentialEligibility, r as hasUsableOAuthCredential } from "./credential-state-DJrnG0Ay.js";
import { A as shouldMirrorRefreshedOAuthCredential, C as isSafeToAdoptBootstrapOAuthIdentity, E as shouldBootstrapFromExternalCliCredential, F as OAUTH_REFRESH_CALL_TIMEOUT_MS, I as OAUTH_REFRESH_LOCK_OPTIONS, O as shouldReplaceStoredOAuthCredential, R as authProfilesLog, S as hasMatchingOAuthIdentity, j as CLAUDE_CLI_PROFILE_ID, w as isSafeToAdoptMainStoreOAuthIdentity, x as areOAuthCredentialsEquivalent } from "./persisted-DGErf7Xt.js";
import { r as readExternalCliBootstrapCredential } from "./external-cli-sync-8w5l6WKw.js";
import { m as resolveAuthProfileDatabasePath } from "./sqlite-fgcxOC8G.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, b as updateAuthProfileStoreWithLock, f as loadAuthProfileStoreForSecretsRuntime, h as resolvePersistedAuthProfileOwnerAgentDir, p as loadAuthProfileStoreWithoutExternalProfiles } from "./store-C0UG5FOx.js";
import { _ as setRuntimeAuthProfileStoreSnapshot, f as hasRuntimeAuthProfileStoreSnapshot, s as getRuntimeAuthProfileStoreSnapshotCore } from "./runtime-snapshots-ChaCVIEN.js";
...
import { n as getOAuthApiKey, r as getOAuthProviders, s as OAuthProviderConfiguredUnavailableError } from "./oauth-BKQY7qvz.js";
import { c as findActiveDegradedSecretOwner, n as SecretSurfaceUnavailableError } from "./runtime-degraded-state-D5EZZ925.js";
import { t as resolveAuthProfileSecretOwnerId } from "./runtime-auth-profile-owner-ClGkgfRG.js";
import { t as assertNoOAuthSecretRefPolicyViolations } from "./policy-CFZG9pTv.js";
import { t as clearLastGoodProfileWithLock } from "./profiles-B9i8Wh87.js";
...
async function resolveApiKeyForProfile(params) {
	...
	try {
		...
		if (isRefreshTokenReusedError(surfacedCause)) {
			...
			if (clearedLastGood) refreshedStore = loadAuthProfileStoreForSecretsRuntime(params.agentDir);
		}
