...
import { S as tryResolveDefaultAgentId, a as listAgentIds, f as resolveAgentWorkspaceDir, l as resolveAgentDir } from "./agent-scope-config-CUBiGmG3.js";
...
import { a as resolveManifestOwnerBasePolicyBlock } from "./manifest-owner-policy-D8q1qLbp.js";
...
import { C as resolveMemoryDreamingPluginConfig, S as resolveMemoryDreamingConfig } from "./dreaming-14k0XOwK.js";
import { n as loadTrustedExternalProviderPolicyArtifacts, t as listTrustedExternalProviderPolicyOwners } from "./provider-public-artifacts-qUJeTQDG.js";
import { t as isConfiguredAwsSdkAuthProfileForProvider } from "./order-C7dw_-HZ.js";
import { n as hasAuthProfileStoreSourceForProvider, t as hasAnyAuthProfileStoreSource } from "./source-check-CdyIgAMR.js";
...
import { a as getActiveMemorySearchManagerCore, o as resolveActiveMemoryBackendConfig } from "./memory-runtime-CNbmHt4g.js";
...
import "./secret-D4Owcz2C.js";
import { i as getMissingLocalMemoryEmbeddingProviderMessage, n as auditShortTermPromotionArtifacts, o as repairDreamingArtifacts, s as repairShortTermPromotionArtifacts, t as auditDreamingArtifacts } from "./memory-core-bundled-runtime-BrqblrAV.js";
import { i as maybeRepairWorkspaceMemoryHealth, o as noteWorkspaceMemoryHealth } from "./doctor-workspace-BI-_hVyt.js";
...
async function noteMemorySearchHealthForAgent(cfg, scope, opts) {
	...
	if (provider === "local") {
		...
		const installedOwners = listTrustedExternalProviderPolicyOwners(provider, loadPluginManifestRegistryForPluginRegistry({
			config: cfg,
			env,
		...
		const policyArtifacts = eligibleOwners.length > 0 ? loadTrustedExternalProviderPolicyArtifacts(eligibleOwners) : null;
		let installedOwner;
...
function resolvePrimaryMemoryProviderEnvVar(provider) {
	...
	return (authProviderId ? getProviderEnvVars(authProviderId)[0] : void 0) ?? `${provider.toUpperCase()}_API_KEY`;
}
