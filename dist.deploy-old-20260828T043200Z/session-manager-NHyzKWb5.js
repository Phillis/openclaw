...
import { f as loadSessionEntry, n as ensureSessionEntrySync, y as replaceSessionEntrySync } from "./session-accessor.sqlite-entry-CNdoUuFZ.js";
import { h as projectCanonicalSessionEntryShape } from "./store-entry-CwpzgKGD.js";
import { x as isSessionTranscriptSideAppendEntry } from "./session-transcript-index-DtVCy6vi.js";
import { c as readSessionTranscriptBoundedActiveContextCore, ct as replaceTranscriptEventsSync, dt as withTranscriptWriteTransaction, it as appendTranscriptEventSync, ot as appendTranscriptMessageSync, pt as readActiveTranscriptEntryAnchor } from "./session-accessor-B-FKZX9M.js";
import { S as loadTranscriptEventsSync } from "./session-accessor.sqlite-transcript-store-Bx_F0DmJ.js";
import { t as applyAssistantDeliveryDirectives } from "./transcript-assistant-delivery-ElcBJoCH.js";
import { P as buildSessionContext } from "./agent-core-CK8RXNcu.js";
import { f as partitionSessionFileEntries, i as isSessionContextMetadataEntry, l as parseOpaqueLeafEntry, m as generateSessionEntryId, p as createManagedSessionId, r as isIndexedSessionEntry, s as migrateToCurrentVersion, u as parseParentLinkedOpaqueEntry } from "./session-manager-codec-BQhwecUx.js";
