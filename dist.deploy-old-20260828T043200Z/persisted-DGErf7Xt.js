...
import { c as readPersistedAuthProfileStateRaw, d as readPersistedSharedAuthProfileStoreRaw, l as readPersistedAuthProfileStoreRaw, u as readPersistedSharedAuthProfileStateRaw } from "./sqlite-fgcxOC8G.js";
...
function normalizeUsageStatsEntry(raw) {
	...
	const stats = {
		...
		cooldownReason,
		cooldownClassification: cooldownClassification === "wham_token_expired" && cooldownReason === "auth" || cooldownClassification === "wham_account_dead" && cooldownReason === "auth_permanent" ? cooldownClassification : void 0,
...
function mergeAuthProfileStores(base, override, options) {
	if (Object.keys(override.profiles).length === 0 && !override.order && !override.lastGood && !override.usageStats && override.runtimePersistedProfileIds === void 0 && override.runtimeLocalProfileIds === void 0 && override.runtimeInheritsMainState === void 0 && override.runtimeExternalProfileIds === void 0 && override.runtimeExternalProfileIdsAuthoritative !== true && getRuntimeExternalCliProfileIds(override).length === 0) return base;
...
function loadPersistedSharedAuthProfileStore(env) {
	...
	return {
		...store,
		...mergeAuthProfileState(coerceAuthProfileState(raw), coerceAuthProfileState(readPersistedSharedAuthProfileStateRaw(env)))
	};
}
//#endregion
export { shouldMirrorRefreshedOAuthCredential as A, isSafeToAdoptBootstrapOAuthIdentity as C, shouldPersistRuntimeExternalOAuthProfile as D, shouldBootstrapFromExternalCliCredential as E, OAUTH_REFRESH_CALL_TIMEOUT_MS as F, OAUTH_REFRESH_LOCK_OPTIONS as I, OPENAI_CODEX_DEFAULT_PROFILE_ID as L, CODEX_CLI_PROFILE_ID as M, EXTERNAL_CLI_SYNC_TTL_MS as N, shouldReplaceStoredOAuthCredential as O, MINIMAX_CLI_PROFILE_ID as P, authProfilesLog as R, hasMatchingOAuthIdentity as S, overlayRuntimeExternalOAuthProfiles as T, mergeRuntimeExternalProfileReferences as _, loadPersistedAuthProfileStore as a, setRuntimeLocalProfileIds as b, parseLegacyCredentialEntry as c, loadPersistedAuthProfileState as d, mergeAuthProfileState as f, getRuntimeLocalProfileIds as g, getRuntimeExternalCliProfileIds as h, coercePersistedAuthProfileStore as i, CLAUDE_CLI_PROFILE_ID as j, isSafeToCopyOAuthIdentity as k, buildPersistedAuthProfileState as l, isLegacyOAuthRef as m, buildPersistedAuthProfileSecretsStore as n, loadPersistedSharedAuthProfileStore as o, LEGACY_OAUTH_REF_PROVIDER as p, coerceLegacyAuthStore as r, mergeAuthProfileStores as s, applyLegacyAuthStore as t, coerceAuthProfileState as u, removeRuntimeExternalProfileReferences as v, isSafeToAdoptMainStoreOAuthIdentity as w, areOAuthCredentialsEquivalent as x, setRuntimeExternalCliProfileIds as y, cloneAuthProfileStore as z };
