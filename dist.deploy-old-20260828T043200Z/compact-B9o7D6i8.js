...
import { g as resolveSessionAgentIds, h as resolveSessionAgentId, m as resolveRunModelFallbacksOverride } from "./agent-scope-DigoIwHb.js";
import { f as resolveAgentWorkspaceDir, l as resolveAgentDir } from "./agent-scope-config-CUBiGmG3.js";
import { c as parseAgentSessionKey } from "./session-key-utils-Di3FvABa.js";
import { D as freezeDiagnosticTraceContext, O as getActiveDiagnosticTraceContext, w as createDiagnosticTraceContext } from "./diagnostic-events-BGzDm6gu.js";
...
import { _ as isDefaultAgentRuntimeId, i as isOpenAIProvider, y as normalizeOptionalAgentRuntimeId } from "./openai-routing-mOc2UICM.js";
...
import { i as wrapStreamFnTextTransforms } from "./text-transforms.runtime-CSYnzMVW.js";
...
import { Q as resolveChannelMessageToolHints, Z as listChannelSupportedActions, et as resolveChannelReactionGuidance } from "./agent-tools.before-tool-call-DoS1-Lb6.js";
import { L as transformProviderSystemPrompt, _ as prepareProviderRuntimeAuth, k as resolveProviderTextTransforms } from "./provider-runtime-XSAeyFFJ.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, r as ensureAuthProfileStore } from "./store-C0UG5FOx.js";
import { n as extractModelCompat } from "./provider-model-compat-VkF92U2_.js";
import { a as agentSessionAutomaticCompaction, lt as getModelRegistryRuntime, n as createAgentSessionForEmbeddedRunner } from "./sessions-PHTfe5gZ.js";
import { x as estimateTokens } from "./agent-core-CK8RXNcu.js";
import { r as detectRuntimeShell } from "./shell-utils-DAgUwgg-.js";
import { s as sanitizeToolUseResultPairingForModel } from "./ai-transport-runtime-host-BOc97x0_.js";
...
import { l as prepareModelRuntimeSnapshot, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-afzKiwqZ.js";
import { n as applyLocalNoAuthHeaderOverride, o as resolveModelAuthMode, t as applyAuthHeaderOverride } from "./model-auth-e0nL7cI2.js";
import { r as resolveOpenClawReferencePaths } from "./docs-path-CIMgdwYZ.js";
import { a as describeFailoverError, i as coerceToFailoverError } from "./failover-error-DVBvcQuA.js";
import { a as createDiagnosticEmbeddedRunOwner, d as markDiagnosticEmbeddedRunStarted, i as closeDiagnosticEmbeddedRunOwner } from "./diagnostic-run-activity-CxbnPTtN.js";
import { b as compactWithSafetyTimeout, x as resolveCompactionTimeoutMs } from "./diagnostic-DrSh1mZf.js";
import { n as resolveSessionPermissionExecMode } from "./session-permission-exec-mode-DQOi_XmP.js";
import { t as pickFallbackThinkingLevel } from "./embedded-agent-helpers-B7K3_Rpy.js";
import { Ct as formatUnknownCompactionReasonDetail, Et as resolveCompactionFailureReason, St as classifyCompactionReason, _ as consumeCompactionSafeguardCancelReason, a as buildEmbeddedMessageActionDiscoveryInput, at as validateReplayTurns, c as collectAllowedToolNames, ct as getHistoryLimitFromSessionKey, d as applySystemPromptToSession, f as buildEmbeddedSystemPrompt, h as isRealConversationMessage, it as sanitizeSessionHistory, l as collectRegisteredToolNames, lt as limitHistoryTurns, m as hasMeaningfulConversationContent, nt as logRuntimeToolSchemaQuarantine, o as prepareAgentMemoryPrompt, p as buildEmbeddedExtensionFactories, s as isReasoningTagProvider, st as hasPersistedMedia, tt as flushPendingToolResultsAfterIdle, u as toSessionToolAllowlist, v as setCompactionSafeguardCancelReason, y as createPreparedEmbeddedAgentSettingsManager } from "./builtin-openclaw-OzMxJ-hX.js";
...
import { n as createBundleMcpToolRuntime } from "./agent-bundle-mcp-materialize-VGxGQrwu.js";
...
import { a as resolveBootstrapContextForRun, i as makeBootstrapWarn, s as resolveContextInjectionMode } from "./bootstrap-files-DFqvwZvt.js";
...
import { t as applyExtraParamsToAgent } from "./extra-params-DztvRYf4.js";
...
import { g as resolveEmbeddedCompactionThinkingLevel, h as resolveEmbeddedCompactionTarget, l as resolvePromptModeForSession, m as resolveCompactionHarnessRuntime, p as resolveCompactionContextTokenBudget, v as listActiveProcessSessionReferences } from "./attempt-prompt-helpers-7ku-2qy7.js";
import { t as resolveProcessToolScopeKey } from "./bash-process-scope-Bmw8_ghL.js";
import { r as prepareAgentRuntimeAuth } from "./prepare-auth-Bc5sTa5K.js";
...
import { r as resolveAttemptSpawnWorkspaceDir } from "./attempt-thread-helpers-CPCBkjyt.js";
import { a as resolveEmbeddedAgentStreamFn, i as resolveEmbeddedAgentBaseStreamFn, r as resolveEmbeddedAgentApiKey, t as wrapStreamFnWithDiagnosticModelCallEvents } from "./attempt.model-diagnostic-events-DBOZFgG9.js";
import { n as resolveSystemPromptRepoRoot, o as resolveAgentPromptSurfaceForSessionKey } from "./system-prompt-params-Jl5q1r24.js";
...
import { s as prepareEmbeddedSessionActiveProjectKeys } from "./session-prompt-state-CJQDP6Z0.js";
...
import { n as collectRuntimeChannelCapabilities } from "./system-prompt-report-B-RrT2o7.js";
...
import { c as selectAgentHarnessForPreparedModelProviders, s as selectAgentHarness } from "./selection-D5-yzRi5.js";
import { a as resolveReusableRuntimeModelAuth, r as providerUsesCredentialScopedModelMetadata } from "./credential-scoped-model-CtZKLOa1.js";
import { n as resolvePreparedRuntimeModelAuth, t as resolvePreparedRuntimeAuthAttempts } from "./resolve-auth-BtbMS_IR.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-Gs3Etsvo.js";
import { a as resolveCompactionCheckpointTranscriptPosition, i as readSessionLeafStateFromTranscriptAsync, o as resolveSessionCompactionCheckpointReason, t as createFileBackedCompactionCheckpointStore } from "./session-compaction-checkpoints-DxUGwHnR.js";
...
async function attemptServerEndpointCompaction(params) {
	...
	try {
		...
		captureOpenAIResponsesCompaction(replacement, compacted.item, compacted.historyMode === "retained-users" ? "retained-users" : replacement.content.length, compacted.model, compacted.replayMetadata);
...
async function buildPreparedCompactionRuntime(prepared) {
	...
	const mode = params.execOverrides?.mode ? {
		...
		auto: "workspace",
		full: "full"
	}[params.execOverrides.mode] : params.permissionMode ?? params.sessionEntry?.permissionMode;
...
async function compactNativeCliSession(params) {
	...
	const { runCliAgent } = await import("./cli-runner-M-g8dvU1.js");
