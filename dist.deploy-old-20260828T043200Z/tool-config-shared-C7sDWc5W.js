...
import { d as postTrustedWebToolsJson } from "./web-search-provider-common-Kid931Nb.js";
...
async function requestXaiResponsesTool(params, parseResponse) {
	return await postTrustedWebToolsJson({
		...
		errorLabel: "xAI"
	}, async (response) => parseResponse(await readProviderJsonObjectResponse(response, params.errorLabel)));
}
...
//#endregion
export { extractXaiWebSearchContent as a, requireXaiResponseTextCitationsAndInline as c, XAI_RESPONSES_ENDPOINT as i, resolveXaiResponsesEndpoint as l, resolveNormalizedXaiToolModel as n, requestXaiResponsesTool as o, resolvePositiveIntegerToolConfig as r, requireXaiResponseTextAndCitations as s, coerceXaiToolConfig as t };
