...
import { $ as resetConfigOverrides, P as validateConfigObjectWithPlugins, Q as getConfigOverrides, et as setConfigOverride, ft as resolveOwnerPromptNumbers, l as readConfigFileSnapshotForWrite, s as readConfigFileSnapshot, tt as unsetConfigOverride } from "./io-DlN5njvP.js";
...
import { a as getActivePluginChannelRegistry } from "./runtime-DMlUh4Cg.js";
...
import { a as transformConfigFileWithRetry } from "./mutate-C_fsUarr.js";
...
import { m as patchSessionEntryCore, p as loadSessionEntryReadOnly, w as resolveSessionStorePathForScope } from "./session-accessor.sqlite-entry-CNdoUuFZ.js";
import { a as normalizeChannelId, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CL5HFEAI.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-CmLI4MOi.js";
...
import { a as normalizeStoreSessionKey, s as resolveSessionStoreEntryCore } from "./store-entry-CwpzgKGD.js";
...
import { nt as updateSessionEntry, xt as applySessionPatchProjection } from "./session-accessor-B-FKZX9M.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-DIvtCZB2.js";
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-BmO3Nggw.js";
...
import { n as resolveManualCompactionCliTarget } from "./session-runtime-compat-BJ6CDpbR.js";
...
import { r as matchPluginCommand, t as executePluginCommand } from "./commands-0DS-dW7v.js";
...
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-Ar62impf.js";
import { l as listTasksForSessionKeyForStatus, s as listTasksForAgentIdForStatus } from "./task-status-access-ezgdFwfY.js";
...
import { a as formatDoctorNonInteractiveHint, m as writeRestartSentinel, n as clearRestartSentinel, t as buildRestartSuccessContinuation } from "./restart-sentinel-BabYlCrz.js";
...
import { St as classifyCompactionReason, Tt as isBenignCompactionSkipResult, bt as estimateMessageCharsCached, h as isRealConversationMessage, yt as createMessageCharEstimateCache } from "./builtin-openclaw-OzMxJ-hX.js";
import { a as getSpeechProvider, i as canonicalizeSpeechProviderId, s as listSpeechProviders } from "./directives-l4MbKCoB.js";
import { _ as resolveTtsPrefsPath, a as getTtsMaxLength, c as isTtsEnabled, h as resolveTtsConfig, l as listTtsPersonas, o as getTtsPersona, s as isSummarizationEnabled } from "./tts-settings-D7jdmVcz.js";
...
import { a as markCommandSessionMetadataChanged, n as handleGoalCommand } from "./commands-goal-Crbaa5Bn.js";
...
import { n as routeReply } from "./route-reply-B1UpL4ft.js";
...
import { T as isTtsProviderConfigured, _ as setTtsProvider, c as getLastTtsAttempt, d as setLastTtsAttempt, f as setSummarizationEnabled, g as setTtsPersona, h as setTtsMaxLength, m as setTtsEnabled, t as getTtsProvider, w as getResolvedSpeechProviderConfig } from "./runtime-api-BaMkpvkC.js";
import { n as textToSpeech } from "./tts-DNxFkuxh.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-B-RrT2o7.js";
import { n as agentHarnessExposesOpenClawTools, s as selectAgentHarness } from "./selection-D5-yzRi5.js";
...
import { i as PLUGIN_COMMAND_DISPATCH, n as executePluginCommandDispatch, r as matchPluginCommandInvocation, t as createPluginCommandRuntime } from "./plugin-command-runtime-BBx11vij.js";
...
import { l as removeChannelAllowFromStoreEntry, n as addChannelAllowFromStoreEntry, s as readChannelAllowFromStore } from "./pairing-store-CHm2POOL.js";
import { t as buildConfigSchemaCore } from "./schema-DoXi-GPm.js";
import { n as formatNonClawHubInstallWarning, t as NON_CLAWHUB_INSTALL_FORCE_FLAG } from "./install-provenance-BsWbYkyF.js";
...
import { n as resolveSkillWorkshopToolPolicyAvailability } from "./tool-policy-diagnostic-Vwrvl_-h.js";
import { n as parseActivationCommand } from "./group-activation-B6ER3hWD.js";
import { i as resolveActiveExplicitSteerSessionKey, n as extractExplicitGroupId, r as parseSteerMessage, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CcgXtT1S.js";
import { s as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-Dcfrq91n.js";
...
import { n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContextAsync, t as resolveConfiguredModelCompat } from "./tools-effective-inventory-DoXHNqUS.js";
import { n as formatAbortReplyText, r as stopSubagentsForRequester, t as abortSessionRunTargetWithOutcome } from "./abort-Dq5wq9cm.js";
import { t as extractBtwQuestion } from "./btw-command-BdMc96Xy.js";
import { r as handleModelsCommand } from "./commands-models-V05NGgfu.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-CNeLQ9fK.js";
import { t as codexChannelLoginRuntime } from "./provider-auth-login-flow-runtime-CyY-MidG.js";
import { r as createExecTool } from "./bash-tools-7V2gUqJK.js";
import { t as runBtwSideQuestion } from "./btw-qIP3GtLQ.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-aqH36DGc.js";
import { b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-BWtz6OJW.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, o as resolveRequesterSessionKey } from "./shared-CgosfNEM.js";
import { t as buildToolsMessage } from "./status-CGfpopKj.js";
import { n as resolveCommandSurfaceChannel, t as resolveChannelAccountId } from "./channel-context-C0RSvo_2.js";
import { d as resolvePluginCapabilityConsent, l as resolvePendingPluginCapabilityReview } from "./capability-consent-D7GK9qgb.js";
import { t as handleApproveCommand } from "./commands-approve-DEeDBCws.js";
import { n as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CQE83rKG.js";
import { t as parseConfigValue } from "./config-value-D2VJu0bm.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-CPDk0XBs.js";
import { n as buildStatusReply, t as buildStatusPluginsReply } from "./commands-status-C5Sytn2p.js";
import { t as listConfiguredMcpServers } from "./mcp-config-BmE1Up1i.js";
import { n as unsetConfiguredMcpServer, t as setConfiguredMcpServer } from "./mcp-config-mutation-Drmw10uS.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./registry-refresh-DHzKSPNn.js";
import { a as buildPluginDiagnosticsReport, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-DoE4_lNj.js";
import { t as formatPluginCompatibilityNotice } from "./status-compatibility-DdQ1VWdc.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-Bbp1ZTBU.js";
import { i as selectInstallMutationWriteOptions, r as resolveInstallConfigMutationPreflights } from "./install-persistence-Z_XgQg-r.js";
import { r as resolvePluginInstallSourcePlan } from "./plugin-install-plan-DCG94b9A.js";
import { n as createPluginInstallLogger } from "./plugins-command-helpers-PfTrp4W5.js";
import { t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-error-codes-Bqqw9uh0.js";
import "./clawhub-D1lt_CwW.js";
import { i as installManagedPluginSource } from "./management-service-CVHPZ3Kq.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-HTmvDaou.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-CV2wV2fs.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-DsepRV44.js"));
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-BLFuAmwC.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-OAjESY1V.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-BYPf6_Us.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-DyyfUmA8.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-D-67O3ki.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-bynuNSBR.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-Cf-2oG5h.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-oIOTOD9-.js"));
