import { Co as ensureAuthProfileStore, Fo as removeProviderAuthProfilesWithLock, Go as DEFAULT_OAUTH_REFRESH_MARGIN_MS, Hn as readCodexCliCredentialsCached, Io as upsertAuthProfile, Is as ProviderAuthContext, Ko as hasUsableOAuthCredential, Lo as upsertAuthProfileWithLock, Ls as ProviderAuthMethod, Po as suggestOAuthProfileIdForLegacyDefault, Ro as listProfilesForProvider, Tu as SecretInputMode, Vs as ProviderPluginWizardSetup, _o as omitEnvKeysCaseInsensitive, go as listKnownProviderAuthEnvVarNames, ho as resolveEnvApiKey, jo as updateAuthProfileStoreWithLock, wo as ensureAuthProfileStoreForLocalUpdate, zs as ProviderAuthResult } from "../agent-harness-runtime-D3DJE4wK.js";
import { r as OpenClawConfig } from "../types.openclaw-Cjm06lg9.js";
import { l as coerceSecretRef, n as SecretInput, o as SecretRef, u as hasConfiguredSecretInput } from "../types.secrets-BrR1WS-r.js";
import "../types-CL_qQaPo.js";
import "../types-336a6ztO.js";
import "../config-C5ZMVTaL.js";
import { C as AuthProfileCredential, E as OAuthCredential, T as AuthProfileStore } from "../types-DY2Fz8pS.js";
...
import { s as OAuthCredentials } from "../model-catalog-XuC1CoX4.js";
import { a as isNonSecretApiKeyMarker, i as isKnownEnvApiKeyMarker, n as CUSTOM_LOCAL_AUTH_MARKER, o as resolveNonEnvSecretRefApiKeyMarker, r as MINIMAX_OAUTH_MARKER, s as resolveOAuthApiKeyMarker } from "../model-auth-markers-DT9cUGpZ.js";
import { i as resolveDefaultSecretProviderAlias, n as normalizeSecretInput, t as normalizeOptionalSecretInput } from "../normalize-secret-input-BzpuIsPh.js";
...
declare function updateAuthProfileStoreWithLockCompat(params: Parameters<typeof updateAuthProfileStoreWithLock>[0]): Promise<AuthProfileStore | null>;
 ...
 */
declare function readClaudeCliCredentialsCached(options?: ClaudeCliCredentialReadOptions): ClaudeCliCredential | null;
//#endregion
...
/** @deprecated GitHub Copilot provider-owned helper; do not use from third-party plugins. */
declare function deriveCopilotApiBaseUrlFromToken(
