import { _c as normalizePluginNodeCapabilityScopedUrl, dc as NodeSession, fc as DEFAULT_PLUGIN_NODE_CAPABILITY_TTL_MS, gc as mintPluginNodeCapabilityToken, hc as buildPluginNodeCapabilityScopedHostUrl, lc as RespondFn, mc as PLUGIN_NODE_CAPABILITY_PATH_PREFIX, oc as GatewayRequestHandlerOptions, pc as NormalizedPluginNodeCapabilityUrl, sc as GatewayRequestHandlers, vc as ResolvedGatewayAuth, yc as resolveGatewayAuth } from "../agent-harness-runtime-D3DJE4wK.js";
import { m as GatewayTailscaleConfig, p as GatewayAuthConfig, r as OpenClawConfig } from "../types.openclaw-Cjm06lg9.js";
import { r as ChannelAccountSnapshot } from "../types.core-CECrTHHY.js";
import { st as ErrorCodes, tt as errorShape } from "../index-DHJKv4R9.js";
import { t as isLoopbackHost } from "../net-C6Td5n3t.js";
import { i as GatewayClientStartable, n as GatewayClientOptions, r as GatewayClientStartReadinessOptions, t as GatewayClient } from "../client-CG7Y8enA.js";
import { a as isGatewayTransportError, i as isGatewayClientRequestError, n as callGatewayFromCli, r as GatewayRpcOpts, t as addGatewayClientOptions } from "../gateway-rpc-Dzj-uARv.js";
