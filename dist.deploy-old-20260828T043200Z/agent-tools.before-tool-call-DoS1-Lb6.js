...
import { C as createChildDiagnosticTraceContext, D as freezeDiagnosticTraceContext, _ as onTrustedToolExecutionEvent, c as emitTrustedSecurityEvent, g as onTrustedInternalDiagnosticEvent, l as emitTrustedSkillUsedDiagnosticEvent, o as emitTrustedDiagnosticEvent, s as emitTrustedDiagnosticEventWithPrivateData } from "./diagnostic-events-BGzDm6gu.js";
import { t as createSubsystemLogger } from "./subsystem-a4KzJVZG.js";
import { Et as array, Rn as string, Zn as unknown, dn as literal, fn as looseObject, wn as number, yt as _enum } from "./schemas-CZ9Toj_c.js";
...
import { D as getPluginSessionExtensionStateSync } from "./loader-D0AfkRZe.js";
...
import { i as listChannelPlugins, t as getChannelPlugin } from "./registry-CL5HFEAI.js";
...
import { at as appendTranscriptMessage } from "./session-accessor-B-FKZX9M.js";
import { _ as createPluginToolMatcherScope, b as pluginToolMatcherCoversTool, g as getGlobalHookRunnerRegistry, t as getGlobalHookRunner, u as cloneHookIsolationValue, y as normalizePluginToolMatcher } from "./hook-runner-global-CWpWIBkz.js";
...
import { a as getCodeModeExecBeforeHookMetadata, d as reconcileCodeModeExecBeforeHookParams, o as getCodeModeExecBeforeHookMetadataForToolKind, u as normalizeCodeModeExecBeforeHookParams } from "./code-mode-control-tools-BA6DDloF.js";
import { a as protectNetworkToolExecutionError, d as resolveToolResultFailureKind, i as isTrustedToolExecutionPreflightError, l as registerTrustedToolNoStartError, n as formatToolExecutionErrorMessage, u as resolveToolExecutionErrorKind } from "./tool-result-error-CnEQjVCq.js";
import { m as resolveAgentRunAbortLifecycleFields } from "./run-termination-hzmbXtwI.js";
import { t as extractApplyPatchTargetPaths } from "./apply-patch-paths-CfNbHU7U.js";
import { C as getBeforeToolCallHookContext, S as getBeforeToolCallDiagnosticOptions, _ as BEFORE_TOOL_CALL_DIAGNOSTIC_OPTIONS, b as BEFORE_TOOL_CALL_WRAPPED, d as copyBeforeToolCallWrapperMetadata, g as setChannelAgentToolMeta, h as getChannelAgentToolMeta, i as withGatewayToolApprovalOwner, p as getToolTerminalPresentation, r as getGatewayToolCallerIdentity, u as copyAgentToolMetadata, v as BEFORE_TOOL_CALL_HOOK_CONTEXT, w as getBeforeToolCallSourceTool, x as clearBeforeToolCallWrappedMarker, y as BEFORE_TOOL_CALL_SOURCE_TOOL } from "./gateway-caller-context-D1DYQtHE.js";
import { i as diagnosticHttpStatusCode, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-qnHBNuqn.js";
...
import { n as resolveSkillTelemetrySource, r as resolveSkillTelemetrySourceValue } from "./source-0ivX3dtK.js";
import { n as recordGenericToolActionDecision, o as normalizeFileToolPathParam, r as runWithGenericToolActionDecision } from "./agent-tools.before-tool-call.decision-brX8VCIr.js";
import { a as listMessageActionDiscoveryChannels, c as resolveCurrentChannelMessageToolDiscoveryAdapter, l as resolveMessageActionDiscoveryChannelId, r as createMessageActionDiscoveryContext, u as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-BKb237RL.js";
import { n as channelPluginHasNativeApprovalPromptUi, t as NATIVE_APPROVAL_PROMPT_RUNTIME_CAPABILITY } from "./native-approval-prompt-Mhk2Tyaa.js";
import { t as sanitizeApprovalScope } from "./approval-scope-B3MYegOV.js";
import { n as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS, r as MAX_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-DzVTK3Ht.js";
import { t as resolveCanonicalPluginApprovalRequestAllowedDecisions } from "./plugin-approval-canonical-decisions-D5YYHwBx.js";
import { i as resolveApprovalInitiatingSurfaceState, n as describeNativePluginApprovalClientSetup } from "./exec-approval-surface-fC5vQsVW.js";
import { t as resolveSkillWorkshopConfig } from "./config-Cjp42tXL.js";
import { _ as resolvePendingSkillProposal } from "./service-D0J-IAQ1.js";
...
import { n as hashToolCall } from "./tool-loop-detection-BBBu2KgN.js";
...
function resolveToolTerminalPresentation(params) {
	try {
		const text = getToolTerminalPresentation(getBeforeToolCallSourceTool(params.tool) ?? params.tool)?.(params.toolParams, params.result)?.text.trim();
		if (!text) return;
...
async function deliverClientVoiceMutationDigest(record, config, signal) {
	...
	const { sendDurableMessageBatchCore } = await import("./runtime-CjePCZ0X.js");
...
function readInternalToolExecutionValidation(value) {
	...
	if (marker !== true || typeof toolCallId !== "string" || typeof validate !== "function") return;
	return {
		toolCallId,
		validate: async (params) => {
			await Reflect.apply(validate, void 0, [params]);
		}
	};
}
//#endregion
...
function wrapToolWithBeforeToolCallHook(tool, ctx, options = {}) {
	...
	const wrappedTool = {
		...
		execute: async (toolCallId, params, signal, onUpdate, ...executionArgs) => {
			...
			const internalValidation = onUpdateValidation ?? readInternalToolExecutionValidation(executionArgs.at(-1));
			const forwardedOnUpdate = onUpdateValidation ? void 0 : onUpdate;
			if (!onUpdateValidation && internalValidation) executionArgs.pop();
			...
			try {
				...
				if (internalValidation?.toolCallId === toolCallId) await internalValidation.validate(executeParams);
