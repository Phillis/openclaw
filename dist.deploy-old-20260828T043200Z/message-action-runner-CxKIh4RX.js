...
import { r as shouldAttemptTtsPayload } from "./tts-config-Kyl4Y1K0.js";
...
import { r as isInternalNonDeliveryChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-constants-2zSoJXQC.js";
...
import { t as parseInlineDirectives } from "./directive-tags-DqL78ij5.js";
...
import { _ as readToolStringParam, h as readStringArrayParam, p as readPositiveIntegerParam, y as readSnakeCaseParamRaw } from "./common-CI1GnPjt.js";
import { s as stripPlainTextToolCallBlocks } from "./src-CXf6rX-C.js";
import { n as getRuntimeVisibleChannelPlugin } from "./runtime-visible-channels-JSQRMn4T.js";
import { d as normalizeLegacyInteractiveReply, f as normalizeMessagePresentation, n as hasLegacyInteractiveReplyBlocks, o as hasReplyPayloadContent, r as hasMessagePresentationBlocks, v as renderMessagePresentationFallbackText } from "./payload-C7E4iMOo.js";
import { a as resolveResponsePrefixTemplate } from "./normalize-reply-uJ4oFasT.js";
import { n as throwIfAborted } from "./deliver-prepare-C7KxLRYR.js";
import { n as resolveAgentIdentity, o as resolveResponsePrefix } from "./identity-Cc11oAxY.js";
...
import { a as normalizeTargetForProvider } from "./target-normalization-e3x27MfE.js";
import { i as resolveChannelTarget } from "./target-resolver-C54g4nxf.js";
import { i as missingMessageActionTargetError, n as invalidMessageActionTargetError } from "./target-errors-CmkAS9Ko.js";
import { i as enforceMessageActionAllowlist, n as buildCrossContextDecoration, o as resolveEffectiveMessageToolsConfig, r as enforceCrossContextPolicy, s as shouldApplyCrossContextMarker, t as applyCrossContextDecoration } from "./outbound-policy-DV9-S_yt.js";
import { t as hasPotentialPluginActionParam } from "./message-action-param-keys-B9A0lF2Z.js";
import { a as actionHasTarget, i as actionHasResourceReference, o as actionRequiresTarget, r as applyTargetToParams, s as resolveActionDeliveryTargetAlias } from "./channel-target-7t_7pXOl.js";
import { a as isDeliveredCurrentSourceReplyAction, i as isDeliveredCurrentSourceReply, n as cancelTerminalSourceReplyDelivery, r as isCurrentSourceReplyActionName, s as reconcileTerminalSourceReplyDelivery, t as beginTerminalSourceReplyDelivery } from "./source-reply-mirror-czTtsKe4.js";
import { t as readBooleanParam } from "./boolean-param-AuSHeYDH.js";
import { a as collectAttachmentSources, c as normalizeSandboxMediaParams, d as resolveAttachmentMediaPolicy, f as resolveExtraActionMediaSourceParamKeys, i as collectActionMediaSourceHints, l as parseInteractiveParam, n as prepareExternalMessageActionTargetForResolution, o as hydrateAttachmentParamsForAction, r as shouldDeferExternalMessageActionTargetResolution, s as normalizeSandboxMediaList, t as dispatchChannelMessageAction, u as parseJsonMessageParam } from "./message-action-dispatch-Bt1r28hX.js";
import { r as resolvePollMaxSelections } from "./polls-C-v11_tu.js";
import { n as listConfiguredMessageChannels, r as resolveMessageChannelSelection } from "./channel-selection-BRB1TsMb.js";
import { n as sendPoll, r as resolveOutboundMessageGatewayOptions, t as sendMessage } from "./message-BFCs5k2E.js";
import { r as validateExplicitMessageAccountSelection } from "./message-account-selection-BTn_GTYc.js";
import { n as ensureOutboundSessionEntry, r as resolveOutboundSessionRoute } from "./outbound-session-B9AYez4r.js";
import { t as extractToolPayload } from "./tool-payload-BEBkV_7x.js";
import { t as shouldUseInternalSourceReplySink } from "./internal-source-reply-CsjhwqFZ.js";
import { n as resolveMessageSendOutcome } from "./message-action-contracts-KstK3BGE.js";
	...
	const poll = await executePollAction({
		...
		resolveCorePoll: () => {
			...
			return {
				to,
				question,
				content: readToolStringParam(params, "message", { allowEmpty: true }) ?? void 0,
				options,
...
function normalizeMessageActionInput(params) {
	...
	if (actionRequiresTarget(action) && (!actionHasTarget(action, normalizedArgs, { channel: inferredChannel }) || hasResourceReference && !hasCanonicalTarget && !params.allowResourceOnly)) throw missingMessageActionTargetError(action);
...
async function executeMessageSend(ctx) {
	...
	if (gatewayPluginAction) {
		...
		return annotateSourceDelivery(withSendNormalization$1(gatewayPluginAction, sendPayload.normalization), {
			cfg,
			actionParams: params,
			channel,
			accountId,
	...
	if (coreDeliveryStatus !== "failed" && coreDeliveryStatus !== "suppressed") await commitOutboundSessionRoute();
...
const loadInternalSourceReplyPersistence = createLazyRuntimeModule(() => import("./internal-source-reply-persistence-CNzFwcoQ.js"));
		...
		for (const target of rawTargets) {
			...
			try {
				...
				results.push({
					channel: targetChannel,
					to: resolved.to,
					...resolveMessageSendOutcome(sendResult.kind === "send" ? sendResult.sendResult : void 0, "Broadcast"),
...
async function handleInternalSourceReplySendAction(input, params) {
	...
	if (!dryRun && requestedMediaCount > 0) {
		const workspaceDir = input.workspaceDir ?? input.mediaAccess?.workspaceDir ?? (agentId ? resolveAgentWorkspaceDir(input.cfg, agentId) : void 0);
		...
		if (resolveSendableOutboundReplyParts(sourceReplyPayload).mediaUrls.length !== requestedMediaCount) throw new Error("Current-source media could not be staged. Use an accessible URL, a file inside the agent workspace, or the buffer field.");
	}
...
//#endregion
export { projectGatewayQueuedDeliveryResult as a, SHARED_POLL_CREATION_PARAM_NAMES as i, runMessageAction as n, POLL_CREATION_PARAM_DEFS as r, getToolResult as t };
