...
const CORE_GATEWAY_HANDLER_MODULES = {
	agent: () => import("./agent-C8mnDVHw.js").then((module) => module.agentHandlers),
	...
	artifacts: () => import("./artifacts-BQM-jhUq.js").then((module) => module.artifactsHandlers),
	board: () => import("./board-D8QR2CHb.js").then((module) => module.boardHandlers),
	...
	attach: () => import("./attach-CjM-V76t.js").then((module) => module.attachHandlers),
	...
	chat: () => import("./chat-v1h6LCxM.js").then((module) => module.chatHandlers),
	commands: () => import("./commands-DDtTfH_B.js").then((module) => module.commandsHandlers),
	config: () => import("./config-DImeXoCQ.js").then((module) => module.configHandlers),
	conversations: () => import("./conversations-C9gCT6Gt.js").then((module) => module.conversationHandlers),
	connect: () => import("./connect-DtNTeZSr.js").then((module) => module.connectHandlers),
	"control-ui": () => import("./control-ui-4vgYT5GL.js").then((module) => module.controlUiHandlers),
	...
	health: () => import("./health-CWc0yW1o.js").then((module) => module.healthHandlers),
	...
	"models-probe": () => import("./models-probe-CAvHu2mB.js").then((module) => module.modelsProbeHandlers),
	"native-hook-relay": () => import("./native-hook-relay-CECU3HPR.js").then((module) => module.nativeHookRelayHandlers),
	"nodes-pending": () => import("./nodes.pending-work-BtETbleL.js").then((module) => module.nodePendingWorkHandlers),
	nodes: () => import("./nodes-D41U4CeY.js").then((module) => module.nodeHandlers),
	...
	restart: () => import("./restart-Bgzlh7WC.js").then((module) => module.restartHandlers),
	suspend: () => import("./suspend-DoSCNYFt.js").then((module) => module.suspendHandlers),
	...
	"sessions-abort": () => import("./sessions-abort-BGBPE8yU.js").then((module) => module.sessionAbortHandlers),
	"sessions-compact": () => import("./sessions-compact-CRGVviEm.js").then((module) => module.sessionCompactHandlers),
	"sessions-compaction-checkpoints": () => import("./sessions-compaction-checkpoints-C8wceICD.js").then((module) => module.sessionCheckpointHandlers),
	"sessions-compaction-queries": () => import("./sessions-compaction-queries-WlY90kyc.js").then((module) => module.sessionCheckpointQueryHandlers),
	"sessions-create": () => import("./sessions-create-C0YB-N_K.js").then((module) => module.sessionCreateHandlers),
	"sessions-recover": () => import("./sessions-recover-C6ExebpG.js").then((module) => module.sessionRecoverHandlers),
	"sessions-delete": () => import("./sessions-delete-B4nfVLvU.js").then((module) => module.sessionDeleteHandlers),
	"sessions-dispatch": () => import("./sessions-dispatch-CGbKGvaR.js").then((module) => module.sessionDispatchHandlers),
	"sessions-groups": () => import("./sessions-groups-C6nMgGrt.js").then((module) => module.sessionGroupHandlers),
	"sessions-messaging": () => import("./sessions-messaging-BCkClZtI.js").then((module) => module.sessionMessagingHandlers),
	"sessions-mutations": () => import("./sessions-mutations-J5UR8yV5.js").then((module) => module.sessionMutationHandlers),
	"sessions-read": () => import("./sessions-read-DyBj6ESW.js").then((module) => module.sessionReadHandlers),
	"sessions-rewind": () => import("./sessions-rewind-Dx4-BelH.js").then((module) => module.sessionRewindHandlers),
	"sessions-sharing": () => import("./sessions-sharing-48cEl_xL.js").then((module) => module.sessionSharingHandlers),
	"sessions-subscriptions": () => import("./sessions-subscriptions-8bso0bjB.js").then((module) => module.sessionSubscriptionHandlers),
	"sessions-suggestions": () => import("./sessions-suggestions-Bm8t7vBX.js").then((module) => module.sessionSuggestionHandlers),
	"session-catalog": () => import("./session-catalog-tF8L-0F-.js").then((module) => module.sessionCatalogHandlers),
	"session-discussion": () => import("./session-discussion-CCfm-3_E.js").then((module) => module.sessionDiscussionHandlers),
	"session-observer-rpc": () => import("./session-observer-rpc-ClAjENXm.js").then((module) => module.sessionObserverHandlers),
	"session-companion-rpc": () => import("./session-companion-rpc-HlemLrIR.js").then((module) => module.sessionCompanionHandlers),
	"hooks-status": () => import("./hooks-status-DNdyT3Ev.js").then((module) => module.hooksStatusHandlers),
	skills: () => import("./skills-BaEwV5Nd.js").then((module) => module.skillsHandlers),
	system: () => import("./system-ru2tR3AP.js").then((module) => module.systemHandlers),
	talk: () => import("./talk-B_Mq2ML1.js").then((module) => module.talkHandlers),
	tasks: () => import("./tasks-BqJoRvFt.js").then((module) => module.tasksHandlers),
	"task-suggestions": () => import("./task-suggestions-DWSNxfLM.js").then((module) => module.taskSuggestionsHandlers),
	...
	"tools-effective": () => import("./tools-effective-uqMQzCdf.js").then((module) => module.toolsEffectiveHandlers),
	"tools-invoke": () => import("./tools-invoke-0woJE-s-.js").then((module) => module.toolsInvokeHandlers),
	...
	update: () => import("./update-CeoJOFYs.js").then((module) => module.updateHandlers),
	...
	"system-agent": () => import("./system-agent-knM5Pc7T.js").then((module) => module.systemAgentHandlers),
	"system-changes": () => import("./system-changes-ZiB4Zqov.js").then((module) => module.systemChangesHandlers),
	wizard: () => import("./wizard-BAr0KUVm.js").then((module) => module.wizardHandlers)
};
