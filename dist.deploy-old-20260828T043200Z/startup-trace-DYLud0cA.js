...
import { r as resolveProfileStateDir, t as isValidProfileName } from "./profile-utils-lNHXbJo0.js";
import { a as GATEWAY_SERVICE_SELECTOR_ENV_KEYS, c as isGatewayServiceEnv, l as resolveGatewayLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./constants-ChqKLfPp.js";
import { n as consumeRootOptionToken } from "./cli-root-options-CpQG4BXe.js";
import { f as isSimpleCommandHelpInvocation, n as getCommandPathWithRootOptions } from "./argv-CCdO9MSu.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-DXuFeGZ6.js";
import { a as scanCliRootOptions, i as takeCliRootOptionValue } from "./container-target-DeeG-3q9.js";
...
function applyCliProfileEnv(params) {
	...
	if (!retainedStateDir || switchesInheritedProfileState) env.OPENCLAW_STATE_DIR = stateDir;
	if (!inheritedManagedServiceSelectors && (!existingConfigPath || replacesInheritedProfileConfig)) env.OPENCLAW_CONFIG_PATH = path.join(stateDir, "openclaw.json");
...
function createGatewayDispatchStartupTrace(argv, source) {
	...
	let pendingMessages = [];
	const timelineModule = hasDiagnosticsTimelinePath(process$1.env) ? import("./diagnostics-timeline-Cmlzzf8z.js").catch(() => null) : null;
