...
import { i as registerSessionBindingAdapter, o as unregisterSessionBindingAdapter } from "./session-binding-service-B0hkzhLM.js";
...
import "./thread-bindings-session-runtime-DEAA9_lS.js";
import { n as readJsonFileWithFallback } from "./json-store-BMxA9fKZ.js";
import { t as getMatrixRuntime } from "./runtime-Drg4hYqm.js";
import { a as listBindingsForAccount, c as resolveEffectiveBindingExpiry, d as setMatrixThreadBindingManagerEntry, l as setBindingRecord, m as toSessionBindingRecord, o as removeBindingRecord, p as toMatrixBindingTargetKind, r as getMatrixThreadBindingManagerEntry, s as resolveBindingKey, t as deleteMatrixThreadBindingManagerEntry } from "./thread-bindings-shared-C60gODTa.js";
import { T as resolveMatrixSqliteStateKey, w as resolveMatrixSqliteStateEnv } from "./crypto-state-store-vlKMG4Bz.js";
import { c as resolveMatrixStateFilePath, t as claimCurrentTokenStorageState } from "./storage-BK4Ps55K.js";
import { r as sendMessageMatrix } from "./send-D7XTIiEI.js";
	...
	const sessionBindingAdapter = {
		...
		bind: async (input) => {
			...
			const record = {
				...
				targetSessionKey,
				agentId: normalizeOptionalString(input.metadata?.agentId) ?? resolveSessionAgentId({
					config: params.cfg,
