...
import { l as withConsoleSubsystemsSuppressed } from "./console-SZn871dT.js";
import { r as readJsonIfExists, u as writeJson } from "./json-Dx6zyhjY.js";
import "./json-files-E5e5TtK3.js";
import { Yt as resolveOpenClawStateSqlitePath, i as closeOpenClawStateDatabaseByPath } from "./openclaw-state-db-CeAO_dqo.js";
import { i as listAvailableManifestContractPlugins, o as loadManifestContractSnapshot } from "./manifest-contract-eligibility-CZWL79I8.js";
import { g as openOpenClawAgentDatabase, l as disposeOpenClawAgentDatabaseByPath } from "./openclaw-agent-db-CM8nAOgX.js";
import { M as registerOpenClawAgentDatabase, N as unregisterOpenClawAgentDatabase } from "./openclaw-agent-db-maintenance-DDqVWNe-.js";
import { n as clearRuntimeAuthProfileStoreSnapshot } from "./store-C0UG5FOx.js";
import { n as t } from "./i18n-BQpjgFU-.js";
import { n as WizardCancelledError } from "./prompts-DLsO8MlU.js";
import { a as projectAgentModelDefaults, i as prepareAgentModelDefaults, n as applyOnboardingPrimaryModel, s as resolveOnboardingSetupTarget } from "./onboard-agent-target--5lBUg6J.js";
import { y as summarizeMigrationItems } from "./migration-q6QzXKht.js";
import { o as writeMigrationReport } from "./migration-runtime-BzWF47av.js";
...
const loadAuthChoiceModule = createLazyRuntimeModule(() => import("./auth-choice-dbQChxdE.js"));
const loadModelPickerModule = createLazyRuntimeModule(() => import("./model-picker-BOGUjy7n.js"));
async function resolveAuthChoiceModelSelectionPolicy(params) {
	...
	const [{ resolveManifestProviderAuthChoice }, { resolvePluginSetupProviderCore }] = await Promise.all([import("./provider-auth-choices-Db9OVFzY.js"), import("./setup-registry-Di_3VeBT.js")]);
...
async function runSetupModelAuthStep(params) {
	...
	const resolveTarget = (config) => resolveOnboardingSetupTarget(config, params.pendingAgent);
	if (authChoiceFromPrompt) {
		const [{ ensureAuthProfileStore }, { promptAuthChoiceGrouped: promptAuthChoice, isKeepCurrentAuthChoice: isKeepCurrentChoice }, { detectAvailableSetupProviderIds }] = await Promise.all([
			...
			import("./auth-choice-prompt-Ds_uC_Po.js"),
			import("./provider-setup-availability-C0_JYppn.js")
		]);
	...
	while (true) {
		...
		if (authChoice === "custom-api-key") {
			const { promptCustomApiConfig } = await import("./onboard-custom-smg52Fov.js");
...
async function createPromotionConfigRuntime(config) {
	const { mutateConfigFile } = await import("./mutate-DGt2HreK.js");
...
const loadMigrationProviderRuntimeModule = createLazyRuntimeModule(() => import("./migration-provider-runtime-DBlVvW1W.js"));
const loadMigrationContextModule = createLazyRuntimeModule(() => import("./context-G-Mb989M.js"));
const loadConfigPathsModule = createLazyRuntimeModule(() => import("./paths-DHUSIAJh.js"));
...
async function runSetupMigrationImport(params) {
	const [{ applyLocalSetupWorkspaceConfig, applySkipBootstrapConfig }, { createMigrationLogger, buildMigrationReportDir }, { assertApplySucceeded, assertConflictFreePlan, formatMigrationPreview, formatMigrationResult }, { resolveStateDir }, onboardHelpers] = await Promise.all([
		...
		loadMigrationContextModule(),
		import("./output-CkWtOc3J.js"),
		loadConfigPathsModule(),
		import("./onboard-helpers-kk_BLYXI.js")
	]);
