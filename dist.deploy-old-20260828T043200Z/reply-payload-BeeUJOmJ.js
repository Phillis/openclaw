...
const REPLY_MEDIA_FAILURE_WARNING = "⚠️ Media failed. Try sending a smaller supported file or a different format.";
...
const isReplyPayloadTerminalContent = (payload) => payload.isReasoning !== true && payload.isCommentary !== true && !isReplyPayloadStatusNotice(payload) && !isReplyPayloadTtsSupplement(payload);
//#endregion
export { setReplyPayloadMetadata as _, getReplyPayloadMetadata as a, isReplyPayloadNonTerminalToolErrorWarning as c, isReplyPayloadTtsSupplement as d, markCommandReplyForDelivery as f, readPairingQrReplyChannelData as g, readAskUserQuestionId as h, copyReplyPayloadMetadata as i, isReplyPayloadStatusNotice as l, markReplyPayloadForSourceSuppressionDelivery as m, appendReplyMediaFailureWarning as n, getReplyPayloadTtsSupplement as o, markReplyPayloadAsTtsSupplement as p, buildTtsSupplementMediaPayload as r, isFastModeAutoProgressPayload as s, FAST_MODE_AUTO_PROGRESS_KIND as t, isReplyPayloadTerminalContent as u };
