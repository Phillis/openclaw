...
import { l as hasConfiguredSecretInput, s as coerceSecretRef } from "./types.secrets-Bre8L6Ts.js";
...
import { c as isNonSecretApiKeyMarker, g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, s as isKnownEnvApiKeyMarker } from "./model-auth-markers-CYmICvL9.js";
import { c as resolveUsageProviderId, o as providerUsageLabel } from "./provider-usage.shared-BBSavFhT.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, h as resolvePersistedAuthProfileOwnerAgentDir } from "./store-C0UG5FOx.js";
...
import { i as removeAuthProfilesAcrossOwnerStores, o as removeProviderAuthProfilesWithLock } from "./profiles-B9i8Wh87.js";
...
import { n as abortChatRunsForProvider } from "./chat-abort-BpfXA9KF.js";
...
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BeyzSB-j.js";
import { i as getProviderUsageRuntimeSnapshot, r as readProviderUsageStaleWhileRevalidate, t as clearModelAuthStatusUsageCache } from "./models-auth-status-usage-cache-CgJRjSjH.js";
import { d as refreshActiveProviderAuthRuntimeSnapshot } from "./runtime-BKIB2wy8.js";
import { n as resolveModelAuthAgentScope, t as modelAuthAgentScopeError } from "./model-auth-agent-scope-C5O6dxmt.js";
import { t as resolveModelProviderCapabilities } from "./model-provider-capabilities-pF445y_u.js";
...
function mapProvider(prov, usageByProvider, expectsOAuthSet, apiKeys, logoutProfileIds, configBoundProfileIds, externalCliProfileIds) {
...
const modelsAuthStatusHandlers = {
	...
	"models.authStatus": async ({ params, respond, context }) => {
		...
		try {
			...
			respond(true, {
				ts: now,
				providers: authHealth.providers.map((prov) => mapProvider(prov, usageByProvider, configured.expectsOAuth, apiKeys, logoutProfileIds, configBoundProfileIds, externalCliProfileIds)),
