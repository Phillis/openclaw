...
import { i as passesManifestOwnerBasePolicy, n as isActivatedManifestOwner, r as isBundledManifestOwner, t as hasExplicitManifestOwnerTrust } from "./manifest-owner-policy-D8q1qLbp.js";
import { l as normalizeStaticProviderModelId, t as createStaticProviderModelIdNormalizer } from "./model-ref-shared-D4yx0hwT.js";
...
import { d as resolveOwningPluginIdsForProviderRef, n as resolveBundledProviderCompatPluginIds, t as resolveActivatableProviderOwnerPluginIds } from "./providers-BoUulJbF.js";
import { i as resolveRuntimePluginDiscoveryProviders, n as normalizePluginDiscoveryResult, o as runProviderStaticCatalog } from "./provider-discovery-nclfrL6H.js";
...
function completeProviderStaticCatalogModel(model, providerConfig) {
	return {
		...model,
		...
		cost: model.cost ?? normalizeStaticCatalogCost(void 0),
...
let bundledStaticCatalogStatesByOwner = /* @__PURE__ */ new WeakMap();
const defaultBundledStaticCatalogConfig = {};
function clearBundledStaticCatalogStates() {
	bundledStaticCatalogStatesByOwner = /* @__PURE__ */ new WeakMap();
}
...
function bundledStaticCatalogProviderUsesRuntimeAugment(params) {
	...
	return resolveBundledStaticCatalogState(catalogParams, resolveBundledStaticCatalogMetadataSnapshot(catalogParams)).plugins.some((plugin) => {
...
async function loadBundledProviderStaticCatalogModels(params) {
	...
	for (const catalogProvider of providers) {
		...
		for (const [providerIdRaw, providerConfig] of Object.entries(normalized)) {
			...
			if (!provider || !Array.isArray(providerConfig.models) || providerConfig.models.length === 0) continue;
			const models = modelsByProvider.get(provider) ?? [];
			models.push(...buildInlineProviderModels({ [provider]: providerConfig }, { providerMetadataOwners: params.providerMetadataOwners }).map((model) => completeProviderStaticCatalogModel(model, providerConfig)));
