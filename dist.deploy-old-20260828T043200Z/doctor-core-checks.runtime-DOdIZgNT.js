...
import { i as collectExplicitAllowlist } from "./tool-policy-B1rvCc4B.js";
...
import { a as buildGatewayProbeConnectionDetails, o as callGateway, p as isGatewayCredentialsRequiredError } from "./call-Bwn2P4nz.js";
...
import { i as getPluginToolMeta, s as setPluginToolMeta } from "./tools-DL5ef4Om.js";
...
import { n as formatLocalAudioSelection, r as inspectLocalAudioSelection } from "./local-audio-DE7TZHDP.js";
...
import { c as gatewayConnectErrorWasRateLimited, r as GATEWAY_HEALTH_RATE_LIMITED_MESSAGE } from "./gateway-health-auth-diagnostic-zBd_uqKD.js";
...
function formatGatewayHealthDiagnostic(value) {
	return scrubDoctorErrorMessage(sanitizeTerminalText(redactSensitiveUrlLikeString(value instanceof Error ? value.message : String(value))));
}
...
async function collectGatewayHealthFindings(ctx) {
	...
	try {
		...
		return projectDoctorSecretRuntimeDegradations(await callGateway({
			method: "status",
...
async function collectProviderCatalogProjectionFindings(cfg, workspaceDir) {
	const { runProviderStaticCatalog } = await import("./provider-discovery-DXlFqTnC.js");
