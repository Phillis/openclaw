...
import { b as resolveModelRefFromString, i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels } from "./model-selection-shared-I5TmV9jL.js";
...
import { r as classifyMediaReferenceSource } from "./media-reference-Q4z-WfN-.js";
...
import { c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-CG3XZviH.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-hrrxUKqA.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-9tTBkwqj.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-DnDqJ2qU.js";
import { a as normalizeAttachments } from "./attachments.normalize-bAPjiGNs.js";
import { a as runCliEntry, d as selectAttachments, l as MediaAttachmentCache, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as isMediaUnderstandingSkipError } from "./runner.entries-BdFbwPcl.js";
...
const loadHasAvailableAuthForProvider = createLazyRuntimeNamedExport(() => import("./model-auth-BHj2hZ87.js"), "hasAvailableAuthForProvider");
const loadPreparedModelCatalogApi = createLazyRuntimeModule(async () => ({
	...await import("./model-catalog-voDZx4Qf.js"),
	...await import("./prepared-model-catalog-D82wKRHO.js")
}));
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-D_wnGn7H.js");
