...
import { X as applyConfigOverrides, u as readConfigFileSnapshotWithPluginMetadata } from "./io-DlN5njvP.js";
import { a as measureDiagnosticsTimelineSpan } from "./diagnostics-timeline-DhDccUEp.js";
import { i as tryGetLegacyDefaultAgentId, r as retainLegacyDefaultAgentId, t as inheritLegacyDefaultAgentId } from "./legacy.default-agent-owner-CL_-T11Y.js";
import { n as copyConfigResolutionFacts, r as copyConfigResolutionFactsExcept, s as hasUnresolvedConfigPath } from "./resolution-facts-DIK_QG79.js";
import { n as materializeLegacyDefaultAgentRoles } from "./legacy.roster-DTfT89zD.js";
...
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-DFVYIaNz.js";
...
import { s as hasLegacyAuthProfileSourcesForStartup } from "./legacy-source-diagnostic-DC_Q2Uc-.js";
...
import { c as getActiveSecretsRuntimeSnapshotRevisionState, f as graftActiveSecretsRuntimeAuthState, g as hasSameSecretReloadContract, l as getActiveSecretsRuntimeSnapshotState, m as hasCurrentAuthStoreCredentialsRevision, p as hasActiveSecretsRuntimeSnapshotLineage, t as activateSecretsRuntimeSnapshotState } from "./runtime-state-LhRdbFR1.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-DfKBaOpt.js";
import { a as collectCandidateAgentDirs, c as prepareSecretsRuntimeFastPathSnapshot, r as registerProviderAuthRuntimeSnapshotActivationOwner } from "./runtime-provider-auth-activation-IKAohYtB.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = createLazyPromise(() => import("./runtime-Cbbi8NFj.js"), { cacheRejections: true });
	const loadAuthProfiles = createLazyPromise(() => import("./auth-profiles-DgV55Au6.js"), { cacheRejections: true });
