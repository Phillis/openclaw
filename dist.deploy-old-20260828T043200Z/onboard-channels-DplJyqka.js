...
import { f as resolveAgentWorkspaceDir, p as resolveAmbientOwnerAgentId } from "./agent-scope-config-CUBiGmG3.js";
...
import { i as getBundledChannelSetupPlugin } from "./bundled-BTOeOZSs.js";
import { n as formatChannelSelectionLine, s as listChatChannels, t as formatChannelPrimerLine } from "./registry-DbgR8dhg.js";
import { r as enablePluginWithCapabilityConsent } from "./enable-DgqKtqMD.js";
import { t as formatDocsLink } from "./links-ClIwBcy4.js";
import { t as isChannelConfigured } from "./channel-configured-sspT-iuP.js";
...
import { n as t, r as wizardT } from "./i18n-BQpjgFU-.js";
...
import { s as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-ChQBLW6h.js";
import { E as resolveAccountIdForConfigure, N as splitSetupEntries, k as runSingleChannelSecretStep, w as promptResolvedAllowFrom } from "./setup-wizard-helpers-JxuPdtZE.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-BS_FbAcf.js";
import { n as listActiveChannelSetupPlugins, r as listChannelSetupPlugins, t as getChannelSetupPlugin } from "./setup-registry-CZplM0_h.js";
import { r as listTrustedChannelPluginCatalogEntries, t as getTrustedChannelPluginCatalogEntry } from "./trusted-catalog-xRGlZeFw.js";
import { n as loadChannelSetupPluginRegistrySnapshotForChannel, t as ensureChannelSetupPluginInstalled } from "./plugin-install-PSqcwzsA.js";
import { t as normalizeExternalChannelSetupConfig } from "./config-compatibility-CUzPHPPV.js";
import { i as shouldShowChannelInSetup, r as resolveChannelSetupEntries } from "./discovery-l2yQOBMN.js";
...
function resolveChannelSetupWorkspaceDir(cfg) {
	return resolveAgentWorkspaceDir(cfg, resolveAmbientOwnerAgentId(cfg, void 0, {
...
function createChannelSetupTransaction(params) {
	const hooks = /* @__PURE__ */ new Map();
	const runPostWriteHooks = async (cfg) => {
...
async function setupChannels(cfg, runtime, prompter, options) {
	...
	const enableChannelPluginForSetup = async (channel) => await withPluginLifecycleLease({}, async () => {
		...
		next = result.config;
		if (result.enabled) await loadScopedChannelPlugin(channel);
		return result;
	});
	...
	const applySetupResult = async (channel, result) => {
		...
		try {
			...
			await prompter.note(`Status unavailable (${detail}).\nRetry: ${formatCliCommand(`openclaw channels status --channel ${channel}`)}`, t("wizard.channels.statusTitle"));
		}
	};
...
//#endregion
export { noteChannelStatus as a, setupChannels as i, createChannelSetupTransaction as n, runCollectedChannelOnboardingPostWriteHooks as r, createChannelOnboardingPostWriteHook as t };
