...
import { O as patchPluginSessionExtension } from "./loader-D0AfkRZe.js";
...
import { A as isInternalSessionEffectsKey } from "./session-accessor.sqlite-entry-CNdoUuFZ.js";
import { c as interruptSessionWorkAdmissions, l as isCompetingSessionWorkAdmissionActive, p as runExclusiveSessionLifecycleMutation, t as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS } from "./session-lifecycle-admission-1qqb7Ac0.js";
import { Dt as SessionLabelOwnerIndex, Nt as applySessionEntryCanonicalReplacements } from "./session-accessor-B-FKZX9M.js";
import { t as assignSessionOwner } from "./session-accessor.sqlite-owner-BOhIqO5V.js";
...
import { A as waitForEmbeddedAgentRunEnd, f as isEmbeddedAgentRunInProgress, n as abortEmbeddedAgentRun } from "./runs-DpT-JSmi.js";
...
import { n as projectSessionPatchResult } from "./session-utils-model-jI_nhKzG.js";
import { c as projectAssignableSessionOwner, l as projectSessionActor, v as disableCronJobsBoundToSessions } from "./session-utils-list-Bb0Qg6y4.js";
...
import { f as resolveGatewaySessionStoreTargetWithStore, o as resolveCanonicalGatewaySessionStoreKey, s as resolveCanonicalSessionEntryFromStoreKeys } from "./session-utils-store-DtQnSTMm.js";
...
import { m as waitForChatAbortControllerRemoval } from "./chat-abort-BpfXA9KF.js";
import { n as resolveStickyModelSelectionScope, t as persistStickyModelSelectionBestEffort } from "./sticky-model-selection-DCTX-Xwn.js";
import { a as resolveCreatorSandbox, d as gatewayClientSessionCreator, t as authorizeGatewaySessionCreation } from "./operator-role-policy-Bvt-UeJ1.js";
import { g as resolveSessionSharingTarget, r as authorizeIncognitoSessionTarget, t as SessionMutationAuthorizationChangedError, u as createSessionListEntryFilter } from "./session-sharing-C4OmHGYo.js";
...
import { i as hasGatewaySessionAbortOwner, r as createChatAbortOps, t as abortChatRunsForSessionKeyWithPartials } from "./chat-abort-runtime-CFeUmiR7.js";
...
import { c as requireSessionKey, f as sessionLog, n as isAgentMainSessionKey, o as loadSessionsRuntimeModule, u as resolveSessionWorkerPlacementPatchError } from "./sessions-shared-BYADMHw6.js";
