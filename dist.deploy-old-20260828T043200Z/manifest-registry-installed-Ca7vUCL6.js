...
import { d as recordPluginCandidateInstallOwner, i as normalizePluginDependencySpecs, s as tracePluginLifecyclePhase } from "./discovery-KmR2BWJK.js";
...
import { a as getPackageManifestMetadata, c as normalizeManifestChannelCommandDefaults, i as DEFAULT_PLUGIN_ENTRY_CANDIDATES } from "./manifest-DFeZvDdx.js";
import { h as hashStableJson, m as hashJson, v as extractPluginInstallRecordsFromInstalledPluginIndex } from "./installed-plugin-index-B1BZ_yR8.js";
...
import { r as resolveChannelSetupFieldCliAttributeName } from "./setup-contract-CIbR6uxD.js";
...
function resolveInstalledManifestRegistryIndexFingerprint(index) {
	...
	const fingerprint = hashStableJson({
		...
		plugins: index.plugins.map(({ doctorContractFile: _doctorContractFile, packageBuild, ...plugin }) => ({
			...plugin,
			...packageBuild ? { packageBuild: packageBuild.bundledDist === void 0 ? {} : { bundledDist: packageBuild.bundledDist } } : {}
		}))
	});
