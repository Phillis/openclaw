...
import { C as parseStrictNonNegativeInteger, f as asSafeIntegerInRange, t as MAX_DATE_TIMESTAMP_MS, w as parseStrictPositiveInteger } from "./number-coercion-CLj0HTDM.js";
...
function normalizeCronStaggerMs(raw) {
	...
	return asSafeIntegerInRange(Math.max(0, Math.floor(numeric)), { max: MAX_DATE_TIMESTAMP_MS });
}
...
//#endregion
export { parseAbsoluteTimeMs as a, resolveDefaultCronStaggerMs as i, normalizeCronStaggerMs as n, resolveCronStaggerMs as r, isSystemOwnedCronPayloadKind as t };
