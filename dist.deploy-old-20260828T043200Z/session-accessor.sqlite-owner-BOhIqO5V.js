...
import { An as executeSqliteQuerySync, Rt as ensureColumn, jn as executeSqliteQueryTakeFirstSync } from "./openclaw-state-db-CeAO_dqo.js";
import { g as openOpenClawAgentDatabase, y as runOpenClawAgentWriteTransaction } from "./openclaw-agent-db-CM8nAOgX.js";
import { T as FIRST_USE_ADDITIVE_AGENT_COLUMN_DEFINITIONS } from "./openclaw-agent-db-maintenance-DDqVWNe-.js";
import { $ as publishSessionEntryCacheInvalidation, B as copySessionNodeArtifactsForRepair, C as ensureTranscriptGenerationInTransaction, H as deleteSessionMembersForRepair, I as bindSessionWindowEntryProjection, M as canonicalSessionKeyMigrationRequiredError, nt as parseSessionEntryJson, ut as hasSqliteSessionOwnerColumns, z as collectSessionStateIdsForEntry } from "./session-accessor.sqlite-entry-store-DmHR081P.js";
import { a as normalizeStoreSessionKey } from "./store-entry-CwpzgKGD.js";
import { c as resolveSqliteScope, i as getSessionKysely, l as resolveSqliteStoreScope, m as toDatabaseOptions, p as runExclusiveSqliteSessionWrite } from "./session-accessor.sqlite-scope-DPR8rGGl.js";
import { d as readSessionGenerationIdsForKeys } from "./session-accessor.sqlite-lifecycle-state-DAt_gV_K.js";
import { c as reconcileSessionTranscriptIndexInTransaction, i as deleteSessionTranscriptIndexInTransaction } from "./session-transcript-index-DtVCy6vi.js";
