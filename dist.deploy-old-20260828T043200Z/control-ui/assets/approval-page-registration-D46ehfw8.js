import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{Fn as t,dr as n}from"./control-ui-foundation-CpgWxUPv.js";import{Bl as r,Hl as i}from"./control-ui-core-CRuVhLK8.js";import{G as a,J as o,W as s,Z as c,at as l,rt as u}from"./lit-runtime-Do8XtDrr.js";import{Rt as d,Ut as f,Wt as p,_n as m,d as h,f as g,hn as _,zt as v}from"./control-ui-core-DIpzf9xz.js";import{Ht as y,Wt as b,zt as x}from"./control-ui-core-CaFfHsws.js";import{Rt as S,_t as C,ht as w,mt as T,zt as E}from"./control-ui-boot-DNM39D8f.js";import"./approval-Dpr9VMH2.js";function D(e){return e instanceof f?(t(e.details)?e.details.reason:void 0)===`APPROVAL_NOT_FOUND`||e.gatewayCode===`APPROVAL_NOT_FOUND`||e.gatewayCode===`INVALID_REQUEST`:!1}function O(e){return new Intl.DateTimeFormat(y.getLocale(),{dateStyle:`medium`,timeStyle:`short`}).format(new Date(e))}function k(e){switch(e){case`allow-once`:return b(`execApproval.allowOnce`);case`allow-always`:return b(`execApproval.alwaysAllow`);case`deny`:return b(`execApproval.deny`)}return e}function A(e,t){return e.applied?t===`deny`?e.approval.status===`denied`:e.approval.status===`allowed`&&e.approval.decision===t:!0}function j(e,t){return t?o`<div class="approval-page__meta-row">
        <dt>${e}</dt>
...
//# sourceMappingURL=approval-page-registration-D46ehfw8.js.map