const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./applied-history.runtime-aKq0c8ry.js","./rolldown-runtime-DkW27tQK.js","./lit-runtime-Do8XtDrr.js","./control-ui-foundation-CpgWxUPv.js","./control-ui-core-CRuVhLK8.js","./control-ui-core-DIpzf9xz.js","./control-ui-core-CaFfHsws.js","./gateway-runtime-BxjbnGPZ.js","./control-ui-core-DwR-GjOr.css","./control-ui-boot-DgIw8vqw.js","./control-ui-boot-DNM39D8f.js","./control-ui-boot-gfE6fZcA.js","./config-runtime-C4gfjhZc.js","./control-ui-boot-B8CA2xde.js","./control-ui-boot-dq1iwUKF.js","./control-ui-boot-Djp0mIwb.js","./control-ui-boot-DjbXGR28.js","./control-ui-boot-DcleirNX.js","./control-ui-boot-Dbm4LqGA.css","./markdown-runtime-BcrsAQtF.js","./control-ui-boot-UMByFVtr.js","./control-ui-boot-CUdzPdvP.js","./control-ui-boot-C-9p5jtt.js","./control-ui-boot-CzOqHnZU.js","./control-ui-boot-jRIu-l9i.js"])))=>i.map(i=>d[i]);
import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{Gr as t,Pi as n,Wr as r,an as i,at as a,dr as o,jn as s,nt as c}from"./control-ui-foundation-CpgWxUPv.js";import{$a as l,Bc as u,Bl as d,Bs as f,Er as p,Hl as m,Mo as h,Tr as g,Ul as _,Vc as v,Vl as ee,Vs as te,Wc as ne,Yc as re,ao as ie,b as ae,fl as oe,g as se,ro as ce,vo as le,yo as ue,zs as de}from"./control-ui-core-CRuVhLK8.js";import{C as fe,E as pe,G as y,J as b,O as me,W as x,Z as he,_ as ge,a as _e,at as S,b as ve,et as ye,lt as be,s as C,w as xe}from"./lit-runtime-Do8XtDrr.js";import{F as Se,In as Ce,R as we,d as Te,f as Ee,kn as De}from"./control-ui-core-DIpzf9xz.js";import{Dt as Oe,Ft as w,J as ke,Ot as T,Pt as E,Wt as D,X as Ae,jt as O,zt as k}from"./control-ui-core-CaFfHsws.js";import{F as je,I as Me,L as Ne,Rt as Pe,zt as Fe}from"./control-ui-boot-DNM39D8f.js";import{n as Ie,r as Le}from"./gateway-runtime-BxjbnGPZ.js";import{Aa as Re,ja as ze}from"./control-ui-boot-DgIw8vqw.js";import{n as Be,t as Ve}from"./hub-tabs-D5BEPkx-.js";import{i as He,n as Ue,r as We,t as Ge}from"./plugins-hub-header-DQYy-LFk.js";import{a as Ke,i as qe,n as Je,r as Ye,t as Xe}from"./history-scan-page-controller-DJue5rJP.js";import{a as Ze,c as Qe,f as $e,i as et,l as A,n as j,o as tt,p as M,s as N,t as nt}from"./proposals-3SbJcLp3.js";function P(e,t){return Ie(e,t,`operator.admin`)}function rt(e){return{canEvaluate:P(e,`skills.proposals.evaluate`),canApply:P(e,`skills.proposals.apply`),canRevise:P(e,`skills.proposals.requestRevision`),canReject:P(e,`skills.proposals.reject`),canScanHistory:P(e,`skills.proposals.historyScan`)}}function F(){return(F=e((()=>{Le()})))()}function it(e){let t=s(s(e.skills)?.workshop);return s(t?.autonomous)?.mode!==`off`}function at(e,t,n,r){let i=v(e?.state.configSnapshot);return i?{enabled:it(i),busy:t,canUpdate:r,error:n}:null}async function ot(e,t,n=()=>!0){let r={raw:{skills:{workshop:{autonomous:{mode:t?`auto`:`off`}}}},note:t?`Enable Skill Workshop self-learning`:`Disable Skill Workshop self-learning`},i=await e.patch(r);if(!n())return null;if(!i&&e.state.lastError?.includes(I)){if(await e.refresh(),!n())return null;if(e.state.lastError)return e.state.lastError;if(i=await e.patch(r),!n())return null}return i?(await e.refresh(),n(),null):e.state.lastError??D(`skillWorkshop.selfLearning.updateError`)}function st(e,t){return e?b`
    <label
...
//# sourceMappingURL=skill-workshop-page-BLFcJZs6.js.map