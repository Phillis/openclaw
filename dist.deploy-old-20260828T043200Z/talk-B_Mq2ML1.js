...
import { _ as getVoiceProviderConfig, b as resolveSupportedVoiceModelRefs, v as providerMatchesId } from "./loader-D0AfkRZe.js";
...
import { A as flushClientVoiceSessionWrites, C as appendRelayVoiceTranscript, D as closeStaleClientVoiceSessions, E as closeRelayVoiceSessionRecord, F as VOICE_TRANSCRIPT_QUEUE_POLICY, I as normalizeVoiceTranscriptText, L as BoundedSerialQueue, M as resolveClientVoiceAgentSessionId, N as resolveClientVoiceSessionOrigin, O as createOrResumeClientVoiceSession, P as resolveOpenClientVoiceSessionId, R as authorizeClientVoiceConfirmation, S as appendClientVoiceTranscript, T as closeClientVoiceSession, j as registerClientVoiceConsultRun, k as ensureClientVoiceAgentSessionEntry, w as assertClientVoiceSessionOpen, z as bindAuthorizedClientVoiceConfirmation } from "./agent-tools.before-tool-call-DoS1-Lb6.js";
...
import { S as withSpeakerSelectionFallbackCompat, h as resolveTtsConfig, x as withSpeakerSelectionCompat } from "./tts-settings-D7jdmVcz.js";
import { n as redactConfigObject } from "./redact-snapshot-Cc1aNUFV.js";
import { l as readSessionPreviewItemsFromTranscript } from "./session-transcript-readers-CgCxlOAj.js";
import { C as getUserPreferences } from "./user-profiles-tailscale-login-D_fNUJ0L.js";
...
import { S as isCodeHeavySpeechText, w as getResolvedSpeechProviderConfig, x as CODE_HEAVY_SPOKEN_FALLBACK, y as synthesizeTalkSpeech } from "./runtime-api-BaMkpvkC.js";
import "./tts-DNxFkuxh.js";
import { s as registerChatAbortController, t as abortChatRunById } from "./chat-abort-BpfXA9KF.js";
import { t as createPluginRuntime } from "./runtime-DaQkPbJc2.js";
import { t as formatForLog } from "./ws-log-CjO1AAG7.js";
import { n as getRealtimeTranscriptionProvider, r as listRealtimeTranscriptionProviders, t as canonicalizeRealtimeTranscriptionProviderId } from "./provider-registry-CjoWtHiH.js";
import { n as resolveRealtimeBootstrapContextInstructions } from "./realtime-bootstrap-context-MCPPD9WP.js";
...
import { n as handleChatSendWithRuntimeTools, t as handleChatSend } from "./chat-send-handler-BYL7V6ZJ.js";
...
import { a as rememberUnifiedTalkSession, i as registerTalkConnectionCleanup, n as forgetUnifiedTalkSession, o as requireUnifiedTalkSessionConn, r as getUnifiedTalkSession } from "./talk-session-registry-DUt3Vk4e.js";
...
const loadTalkAgentExecution = createLazyRuntimeModule(async () => {
	const [embeddedAgent, admission] = await Promise.all([import("./embedded-agent-DjHmTlnD.js"), import("./admitted-run-context-BWSMtoE-.js")]);
	return {
