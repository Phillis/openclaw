...
import { An as executeSqliteQuerySync, Mn as getNodeSqliteKysely, Nn as iterateSqliteQuerySync, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction, jn as executeSqliteQueryTakeFirstSync } from "./openclaw-state-db-CeAO_dqo.js";
...
import { o as isLegacyCodexProviderId } from "./codex-route-model-ref-Du1KAbLA.js";
...
import { g as openOpenClawAgentDatabase, i as closeOpenClawAgentDatabaseByPath, p as isOpenClawAgentDatabaseOpen, y as runOpenClawAgentWriteTransaction } from "./openclaw-agent-db-CM8nAOgX.js";
...
import { $ as publishSessionEntryCacheInvalidation, B as copySessionNodeArtifactsForRepair, F as setCanonicalSqliteSessionMainKey, H as deleteSessionMembersForRepair, z as collectSessionStateIdsForEntry } from "./session-accessor.sqlite-entry-store-DmHR081P.js";
import { g as stripRuntimeOnlySessionSkillsFields, o as resolveDeliveryProvenCanonicalSessionKey } from "./store-entry-CwpzgKGD.js";
import { u as resolveSqliteTranscriptArchiveDirectory } from "./session-accessor.sqlite-scope-DPR8rGGl.js";
import { s as writeTranscriptArchive } from "./session-accessor.sqlite-archive-CVw8YIdK.js";
import { C as mergeSessionTranscriptVisiblePathWithOpaqueAppendPath, O as selectSessionTranscriptTreePathNodes, S as mergeSessionTranscriptTreePaths, T as scanSessionTranscriptTree, b as isSessionTranscriptLeafControl } from "./session-transcript-index-DtVCy6vi.js";
import { G as rewriteDoctorSessionEntries, K as listCanonicalSessionRepairFacts, Y as scanDoctorSessionEntriesTolerant, kt as applySessionEntryLifecycleMutation, q as loadCanonicalSessionRepairEntries } from "./session-accessor-B-FKZX9M.js";
import { a as listSqliteSessionGenerationIdsForCanonicalRepair, c as rehomeSqliteSessionDeliveryReferencesForCanonicalRepairBatch, i as ensureSqliteTranscriptGenerationsForCanonicalRepair, n as replaceSessionOwnerInTransaction, r as copySqliteSessionOwnedStateForCanonicalRepair, s as rehomeSqliteSessionDeliveryReferencesForCanonicalRepair } from "./session-accessor.sqlite-owner-BOhIqO5V.js";
...
import { n as normalizeLegacySessionEntryDelivery } from "./state-migrations.legacy-session-store-Csnm-Sku.js";
...
import { d as resolveTargetSqlitePath, r as listExistingAgentDatabaseTargets } from "./doctor-session-sqlite-readers-Do6ZLR_w.js";
import { o as runPostSessionPluginDoctorStateRepairs } from "./state-migrations.doctor-BGPRm6E0.js";
...
async function noteSessionSqliteMigrationHealth(params) {
	const { runDoctorSessionSqlite } = await import("./doctor-session-sqlite-DrcqMdmM.js");
	...
	const runSessionSqlite = async (maintenanceAuthority) => {
		...
		const { migrateLegacyMainSessionKeys } = await import("./legacy-main-session-migration-C6vgxtAg.js");
