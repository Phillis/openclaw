...
import { d as isSecretRef, h as normalizeSecretInputString } from "./types.secrets-Bre8L6Ts.js";
import { t as formatSystemAgentOnboardingWelcome } from "./overview-CQu7oloB.js";
...
async function buildOnboardingWelcome(params) {
	...
	const localSetup = params.localRecovery === true && overview.config.exists && overview.config.valid && authoredConfig !== void 0 && authoredConfig?.gateway?.mode !== "remote" ? (await import("./local-onboarding-state-BKaH097l.js")).readLocalOnboardingStateForConfig(overview.config.path, authoredConfig) : void 0;
	...
	const { DEFAULT_WORKSPACE } = await import("./onboard-helpers-kk_BLYXI.js");
