...
import { l as readMcpOAuthStoreReadOnly, p as operatorMcpOAuthIdentity } from "./mcp-oauth-store-BSuWhVNF.js";
import { i as completeMcpOAuthAuthorization, o as countMcpOAuthPrincipals, s as readMcpOAuthCredentialsStatus, t as clearMcpOAuthCredentials, u as startMcpOAuthAuthorization } from "./mcp-oauth-eWr2mvUU.js";
import { t as createSessionMcpRuntime } from "./agent-bundle-mcp-runtime-CFf6ZaYl.js";
...
import { i as updateConfiguredMcpServerTools, n as unsetConfiguredMcpServer, r as updateConfiguredMcpServer, t as setConfiguredMcpServer } from "./mcp-config-mutation-Drmw10uS.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_CAPS, GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			...
			import("./client-eCT68FPi.js"),
			import("./client-start-readiness-grqUg7wf.js"),
			import("./method-scopes-78HXSTPo.js"),
