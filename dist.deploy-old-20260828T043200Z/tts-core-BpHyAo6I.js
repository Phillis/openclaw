...
function loadDefaultSummarizeTextDeps() {
	return defaultSummarizeTextDepsPromise ??= Promise.all([import("./simple-completion-runtime-DmqSBwOq.js"), import("./model-auth-BHj2hZ87.js")]).then(([completionRuntime, { requireApiKey }]) => ({
