...
import { c as interruptSessionWorkAdmissions, l as isCompetingSessionWorkAdmissionActive, n as beginSessionWorkAdmission } from "./session-lifecycle-admission-1qqb7Ac0.js";
...
import { nt as updateSessionEntry, o as readSessionTranscriptActivePathEntryRelation, t as readSessionTranscriptWatermark } from "./session-accessor-B-FKZX9M.js";
...
import { a as isAgentHarnessSessionKey, m as resolveMissingAgentHarnessSessionError } from "./agent-harness-session-key-Bf-Q9dw5.js";
...
import { r as hasGlobalHooks, t as getGlobalHookRunner } from "./hook-runner-global-CWpWIBkz.js";
...
import { a as parseInboundMediaUri } from "./media-reference-Q4z-WfN-.js";
...
import { d as isPluginOwnedSessionBindingRecord } from "./conversation-binding-BabhLvmP.js";
import { a as shouldComputeCommandAuthorized } from "./command-detection-DGnhlUuH.js";
...
import { a as logMessageReceived, r as logMessageProcessed } from "./diagnostic-DrSh1mZf.js";
...
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-fA_3dacW.js";
...
import { a as emitInboundMessageAuditTerminal, n as emitMessageReceivedHooks } from "./dispatch-from-config-C7CkWC7g.js";
...
import { a as createUserTurnTranscriptRecorder, i as buildRunUserTurnIdempotencyKey } from "./user-turn-transcript-CyFoZBC6.js";
import { S as projectChatDisplayMessage, i as readSessionMessageByIdAsync } from "./session-transcript-readers-CgCxlOAj.js";
...
import { r as resolveGatewayModelSupportsImages } from "./session-utils-model-jI_nhKzG.js";
...
import { l as resolveDeletedAgentIdFromSessionKey, r as loadGatewaySessionEntry } from "./session-utils-store-DtQnSTMm.js";
...
import { i as dispatchInboundMessageWithProjectedDispatcher } from "./dispatch-uB8tng5d.js";
import { a as isChatStopCommandText, f as updateChatRunProvider, s as registerChatAbortController, u as resolveChatRunExpiresAtMs } from "./chat-abort-BpfXA9KF.js";
...
import { t as createChannelReplyPipeline } from "./reply-pipeline-DfejO9p2.js";
import { n as buildInboundUserContextPrefix } from "./inbound-meta-WvdYDMHc.js";
...
import { a as resolveCreatorSandbox, t as authorizeGatewaySessionCreation, u as gatewayClientSenderFields } from "./operator-role-policy-Bvt-UeJ1.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-DBrqVR0N.js";
import { n as resolveChatAttachmentMaxBytes } from "./chat-attachment-policy-BsshswU5.js";
import { c as persistInboundImagesForTranscript, i as discardPreparedInboundMedia, l as stripImageMediaMarkers, n as MediaOffloadError, o as logAttachmentFailure, r as UnsupportedAttachmentError, s as parseMessageWithAttachments, t as INLINE_IMAGE_DURABLE_OMISSION_MARKER } from "./chat-attachments-CtArkGi3.js";
import { a as persistGatewaySessionLifecycleEvent, r as deriveGatewaySessionLifecycleSnapshot } from "./session-event-payload-Cf_KowSS.js";
...
import { i as attachManagedOutgoingMediaToMessage } from "./managed-image-attachments-5NOsW2iy.js";
import { t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BA7mKleS.js";
import { i as maybeGenerateDashboardSessionTitle, r as isDashboardSessionTitleCandidate, t as buildDashboardSessionTitleSource } from "./dashboard-session-title-wKKJH5Bw.js";
import { r as resolveInboundReplyToolAuthorityOverlay } from "./reply-tool-authority-B8CUU6X3.js";
...
import { r as parseProjectGitUrl, t as materializeProjectClone } from "./project-clone-w0GmZyEq.js";
import { c as resolveProjectDirectory } from "./project-registry-CPtTZbcF.js";
import { r as hasActiveAgentRuntimeAuthority } from "./agent-runtime-authority-DnVI97Gp.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-BFHS9dB5.js";
...
async function resolveDurableChatClaim(params) {
	...
	if (isAdoptedRestartRecoveryClaim(entry, params.clientRunId) && entry.status === "running" && entry.abortedLastRun === true) {
		...
		try {
			const { retryRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-CnLuU0Z-.js");
