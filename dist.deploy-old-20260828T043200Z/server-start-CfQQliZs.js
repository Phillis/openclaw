...
import { n as isTruthyEnvValue, r as logAcceptedEnvOption } from "./env-ChWDbSFK.js";
...
import { c as isNixMode, l as normalizeStateDirEnv, w as resolveStateDir } from "./paths-BBSTUjD5.js";
import { r as formatErrorMessage } from "./errors-Ccx0R-_Z.js";
import { Z as captureConfigOverrideApplier, c as readConfigFileSnapshotForRuntimeTransaction, g as registerConfigWriteListener, i as promoteConfigSnapshotToLastKnownGood, n as getRuntimeConfig, s as readConfigFileSnapshot } from "./io-DlN5njvP.js";
import { r as applyLoggingConfig } from "./logger-ij8OHrrv.js";
import { N as runWithDiagnosticTraceContext, f as isDiagnosticsEnabled, w as createDiagnosticTraceContext, y as setDiagnosticsEnabledForProcess } from "./diagnostic-events-BGzDm6gu.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-a4KzJVZG.js";
import { n as registerPluginMetadataProcessMemoLifecycleClear, t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-DQWVBcP_.js";
import { l as resolveRuntimeServiceVersion } from "./version-CkBmshxX.js";
import { S as assertOpenClawStateWriteAllowedAtPath, Yt as resolveOpenClawStateSqlitePath } from "./openclaw-state-db-CeAO_dqo.js";
...
import { a as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CKAJM6x9.js";
import { p as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./legacy-C3aoLO5V.js";
import { d as prepareConfigRuntimeEnv, l as initializePublishedConfigRuntimeEnv, r as collectConfigRuntimeEnvOwnership } from "./config-env-vars-C_yEEhJa.js";
import { S as assertGatewayConfigEnvSelectionUnchanged } from "./io.read-helpers-YVBmmwxJ.js";
import { n as copyConfigResolutionFacts, r as copyConfigResolutionFactsExcept } from "./resolution-facts-DIK_QG79.js";
import { C as setAppliedRuntimeConfigSnapshot, c as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-Cv5MaU8U.js";
...
import { i as listLoadedChannelPlugins, n as getLoadedChannelPluginEntryById } from "./registry-loaded-Dbglb2uR.js";
...
import { t as GatewayLockError } from "./gateway-lock-G9roAjek.js";
import { o as purgeExpiredSecretStoreEntries } from "./secret-store-CxIqAOaM.js";
import { t as isContainerEnvironment } from "./container-environment-CNsJSTpY.js";
import { g as resolveGatewayListenHosts, o as isLoopbackHost, r as isLocalDirectRequest } from "./net-DeK7gO-9.js";
import { f as buildRateLimitIdentityKey, p as createAuthRateLimiter, s as AUTH_RATE_LIMIT_SCOPE_NODE_REAPPROVAL, u as AUTH_RATE_LIMIT_SCOPE_WORKER_ADMISSION } from "./auth-rate-limit-C6x9QPnp.js";
import { a as prepareGatewayIngressAttribution, i as markGatewayIngressTransport, n as PROXY_ATTRIBUTION_REQUIRED_REASON, o as readPreparedGatewayIngressAttribution, r as createGatewayUnattributableProxyReporter, t as PROXY_ATTRIBUTION_GUIDANCE } from "./ingress-attribution-CVTrlUeM.js";
...
import { c as listCoreGatewayMethodNames, n as createCoreGatewayMethodDescriptors, r as isCoreGatewayMethodClassified, t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./core-descriptors-By5XY4Wa.js";
import "./method-scopes-BTnJZEGh.js";
import { c as resolveSystemMainSessionTarget } from "./main-session-CPkeRwvL.js";
import { t as isBrowserCopilotClient } from "./message-channel-BZwx7FCw.js";
import { a as getActiveGatewayRootWorkCount, c as isGatewayRestartDraining, o as getGatewaySuspendAdmissionPhase, u as isGatewayWorkAdmissionClosed } from "./gateway-work-admission-CTDt7IQ1.js";
import { a as enqueueSystemEvent, h as withSystemEventOwner } from "./system-events-BVZAS_Ok.js";
import "./sessions-CdrF1uzY.js";
import { i as tryLoadActivatedBundledPluginPublicSurfaceModule } from "./facade-runtime-brsAGrxF.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-BmO3Nggw.js";
import { r as readGatewayRestartHandoffSync } from "./restart-handoff-Cn-vtimu.js";
import { m as stopDiagnosticHeartbeat, p as startDiagnosticHeartbeat } from "./diagnostic-DrSh1mZf.js";
import { g as resolveActiveEmbeddedRunSessionId, p as getActiveEmbeddedRunCount } from "./run-state-CmAt4u6E.js";
...
import { s as getTotalQueueSize, u as isGatewayDraining } from "./command-queue-CBS1Vl32.js";
import { t as createAgentRuntimeApprovalAuthorityValidator } from "./agent-runtime-identity-token-BLnwLnqH.js";
...
import { a as parseControlUiResourcePath, o as parseControlUiUserAvatarPath } from "./control-ui-contract-CgrOMhfo.js";
...
import { i as isControlUiPluginManagerRequest, n as isControlUiApprovalDocumentPath, r as isControlUiFocusDocumentPath } from "./control-ui-routing-CrqNOcfB.js";
import { r as prepareGatewayAgentCliShim, t as clearGatewayAgentCliShim } from "./openclaw-cli-shim-BLljw-ev.js";
import { a as getActiveSecretsRuntimeConfigSnapshot, r as clearSecretsRuntimeSnapshotState } from "./runtime-state-LhRdbFR1.js";
...
import { a as createSessionMessageSubscriberRegistry, i as createSessionEventSubscriberRegistry, r as createChatRunState } from "./server-chat-state-BuGrMjm1.js";
import { d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-DGYy4fPv.js";
import { i as upsertPresence } from "./system-presence-Ccv3L_9H.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Bw07juFU.js";
import { c as resolveControlUiRootSync, i as isPackageProvenControlUiRootSync, n as ensureControlUiAssetsBuilt, r as isControlUiStartupAssetsReady, s as resolveControlUiRootOverrideSync } from "./control-ui-assets-D92--EZN.js";
import { c as removeRemoteNodeInfoForConnection, i as recordRemoteNodeInfo, s as removeRemoteNodeInfo } from "./remote-8jZL04gz.js";
import { f as requestNodePairing, p as reusePendingNodePairingForReconnect, r as finalizeNodePairingCleanupClaim } from "./device-pairing-node-DrrXxGrx.js";
...
import { c as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-DAm53jGl.js";
import { n as logWs, r as summarizeAgentEventForWsLog } from "./ws-log-CjO1AAG7.js";
import { n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig } from "./startup-auth-DfKBaOpt.js";
import { u as revokeAttachGrantsForSession } from "./mcp-grant-store-CMltwqdc.js";
...
import { a as sendGatewayAuthFailure, f as setDefaultSecurityHeaders, n as finishFailedGatewayHttpResponse, v as respondNotFound, y as respondPlainText } from "./http-common-m4pDgMA2.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-Wt672rYh.js";
import { l as canReceiveSessionEvent } from "./session-sharing-C4OmHGYo.js";
import { n as queuePluginSessionsChanged } from "./gateway-events-BIgYHxyk.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-DhH5lN5I.js";
import { n as installActiveGitHubOAuthLifecycle, t as createGitHubOAuthLifecycle } from "./github-oauth-lifecycle-DzXTeK4S.js";
import { a as classifyNodeWorkerBundleTransferPath, i as classifyMcpAppStandalonePath, o as classifyNodeWorkspaceTransferPath, r as classifyGatewayProbePath, s as classifyWorkerGatewayPath } from "./gateway-http-route-contracts-ByqHS7gV.js";
import { n as parseDevicePairingJoinRequestPath } from "./join-code-B_OfdZ-j.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-Dm6d1Xmk.js";
import { t as isTerminalConfigEnabled } from "./enabled-BSjeiWpO.js";
import { n as resolveGatewayReloadPluginActivationCandidate, r as resolveGatewayStartupPluginActivationConfig, t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-DGt4bJQw.js";
...
import { n as GATEWAY_EVENT_NODE_RUNNER_INVENTORY_CHANGED, t as GATEWAY_EVENT_DEVICE_PAIR_CHANGED } from "./events-CcYyn8LU.js";
import { t as createPresenceRecipientProjection } from "./presence-projection-Cw-k1V1b.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-DU1bpQDq.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-WSekhXHE.js";
import { t as createControlUiSessionPullRequestSubscriptions } from "./control-ui-session-pr-subscriptions-DcW5lXb7.js";
...
import { n as applyGatewayLaneConcurrency, r as resolveGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-BQTe9zVU.js";
import { t as createNoopHeartbeatRunner } from "./server-runtime-service-shared-iwns63ly.js";
import { t as recordClientPresenceActivity } from "./client-presence-DhNa5MdO.js";
...
import { t as createGatewayStartupTrace } from "./server-startup-trace-Dgjmizj1.js";
import { i as runWithGatewayHttpWorkAdmission, o as writeGatewayUpgradeServiceUnavailable, r as shouldEnforceGatewayAuthForPluginPath, t as isPluginAuthenticatedRoutePath } from "./route-auth-BC1gUNLU.js";
import { n as handleNodeWorkerBundleTransferHttpRequest } from "./node-worker-bundle-transfer-http-B2GMNVOF.js";
import { n as handleNodeWorkspaceTransferHttpRequest } from "./node-workspace-transfer-http-S1aVjE9T.js";
import { i as markPublicWorkerIngress, t as GATEWAY_WS_CONNECTION_KIND_PROPERTY } from "./ws-types-099MIJxx.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-5hFVeF9S.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-Qp7lA6qR.js";
...
const listGatewayStartupChannelPlugins$1 = () => listLoadedChannelPlugins();
...
async function startGatewayCoreRuntime(input) {
	...
	const secretEgressProxy = cfgAtStart.secrets?.egressProxy?.enabled === true ? await import("./runtime-C0yxRVCW.js").then((egressRuntime) => egressRuntime.startGatewaySecretEgressProxy({
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayChannelHealthMonitor }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-FPxf8OLr.js"), import("./server-runtime-startup-services-CKOSJ7oA.js")]));
	...
	const { createOperatorApprovalSessionEventRuntime } = await import("./operator-approval-session-events-C33HfLnY.js");
	...
	const { execApprovalManager, questionManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, bindApprovalPublicationContext, unregisterApprovalAuthorityObserver, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-AgOenngL.js"), import("./server-methods-BV_r7IsE.js")]);
		return {
	...
	const buildAttachedGatewayMethodRegistry = (nextPluginRegistry) => {
		...
		return createGatewayMethodRegistry([
			...createCoreGatewayMethodDescriptors(coreDescriptorHandlers).filter((descriptor) => (workerEnvironmentService || descriptor.name !== "environments.create" && descriptor.name !== "environments.destroy") && (workerPlacementDispatchAvailable || descriptor.name !== "sessions.dispatch") && (workerPlacementControlAvailable || descriptor.name !== "sessions.reclaim" && descriptor.name !== "sessions.move") && (desktopObserveAvailable || descriptor.name !== "desktop.observe") && (workerDesktopObserveAvailable || descriptor.name !== "desktop.launch" && descriptor.name !== "worker.desktop.observe" && descriptor.name !== "worker.desktop.launch")),
	...
	const refreshAttachedGatewayDiscovery = async (nextPluginRegistry, claim) => {
		...
		try {
			...
			await kernel.swapBonjourStop(null)?.().catch((err) => {
			...
			if (!await claim.waitForUnblocked() || !claim.publish(() => kernel.swapBonjourStop(stopNextDiscovery))) await stopNextDiscovery?.();
		} catch (err) {
	...
	const reloadAttachedGatewayPlugins = async (params) => {
		const [{ loadPluginLookUpTable }, { listAmbientOnlyConfiguredChannelIds }, { prepareGatewayPluginLoad }, { startPluginServices, PLUGIN_SERVICE_REPLACEMENT_STOP_TIMEOUT_MS }, { listChannelPluginConfigTargetIds, pluginConfigTargetsChanged }] = await Promise.all([
			import("./plugin-lookup-table-BnJpM2Et.js"),
			import("./channel-presence-policy-Bez6Mcnl.js"),
			loadGatewayPluginBootstrapModule(),
			import("./services-CbYGN3lO.js"),
		...
		const nextStartupChannelIds = new Set(nextPluginLookUpTable.manifestRegistry.plugins.flatMap(({ id, channels }) => nextStartupPluginIds.has(id) ? channels.length > 0 ? channels : [id] : []));
		const channelsToStopBeforeReplace = /* @__PURE__ */ new Set();
		for (const [channelId, targetIds] of beforeChannelTargets) if (!nextStartupChannelIds.has(channelId) || pluginConfigTargetsChanged(targetIds, params.changedPaths)) channelsToStopBeforeReplace.add(channelId);
		...
		try {
			...
			}) || !loaded) return cancelledReload(listAttachedChannelConfigTargets().keys());
			await refreshAttachedGatewayDiscovery(loaded.pluginRegistry, replacement.claim);
			if (!await replacement.claim.waitForUnblocked()) return cancelledReload(listAttachedChannelConfigTargets().keys());
		...
		for (const [channelId, targetIds] of afterChannelTargets) if (!beforeChannelIds.has(channelId) || pluginConfigTargetsChanged(targetIds, params.changedPaths)) restartChannels.add(channelId);
		return {
			restartChannels,
...
async function createGatewayChatMetadataLifecycle(params) {
	...
	const { ChatMetadataSnapshotUnavailableError, createGatewayChatMetadataRuntime } = await import("./chat-metadata-runtime-Bfj-BT1V.js");
	const runtime = createGatewayChatMetadataRuntime({
		...
		...params.minimalTestGateway ? {
			beforeRefresh: async () => {
				const { refreshPreparedModelRuntimeSnapshots } = await import("./prepared-model-runtime-BH9aCf3S.js");
	...
	const registerRefreshListeners = async () => {
		...
		const [{ registerRuntimeAuthProfileStoreMutationListener }, { registerPreparedModelRuntimePublicationListener }, { registerSkillsChangeListener }] = await Promise.all([
			import("./runtime-snapshots-70-AjgT4.js"),
			import("./prepared-model-runtime-BH9aCf3S.js"),
			import("./refresh-BXxnnXZs.js")
		]);
...
async function prepareGatewayKernelRequestRuntime(params) {
	...
	const configRevisionProjector = await startupTrace.measure("gateway.config-revision-key", async () => {
		const { loadGatewayConfigRevisionProjector } = await import("./config-revision-token-9hvWXlyg.js");
	...
	const gatewayRequestContext = await startupTrace.measure("gateway.request-context", async () => {
		const { createGatewayRequestContext } = await import("./server-request-context-CB-i_m2r.js");
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-D4kUdKAb.js");
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-BEZgE-fT.js").then(({ buildGatewayCronService }) => {
		loaded = {
...
async function prepareGatewayLifecycle(params) {
	...
	const { minimalTestGateway, transportBridge, sessionMessageSubscribers, isConnectionActive, clients, broadcast, cfgAtStart, pluginRuntime, authRateLimiter, nodeReapprovalCoordinator, channelManager, deps, initialHooksConfig, initialHookClientIpConfig, runtimeStateRef, gatewayInstanceRuntimeRef, startupState, readinessEventLoopHealth, browserAuthRateLimiter, chatRunState, chatAbortControllers, chatQueuedTurns, removeChatRun, agentRunSeq, listActiveGatewayMethods, broadcastToConnIds, getBufferedAmount, sessionEventSubscribers, watchNodeRequestHandler, defaultWorkspaceDir, activeTaskCount, desktopSessionRegistry, nodeDesktopStreamBroker, nodeDesktopObserveAvailable, bindDeviceNodeControl, bindWorkerNodeDesktopControl, workerPlacementRuntime, lifecycle } = runtime;
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-L0tKGZSe.js");
	...
	const nodeDesktopService = nodeDesktopObserveAvailable && desktopSessionRegistry && nodeDesktopStreamBroker ? (await import("./node-source-8zz86G6N.js")).createNodeDesktopService({
		getConfig: getRuntimeConfig,
		nodeRegistry,
	...
	const { createWatchNodeHttpRuntime } = await import("./watch-node-http-Iax_Epq9.js");
	...
	const { TerminalSessionManager, DEFAULT_TERMINAL_DETACH_SECONDS } = await import("./session-manager-tZT8z7TO.js");
	...
	const closeOnStartupFailure = async () => {
		await runGatewayShutdownSteps({
			steps: [
				{
					name: "close prelude fence",
					run: beginClosePrelude
				},
				{
...
function createGatewayBroadcaster(params) {
	...
	const indexedClients = params.clients instanceof GatewayClientRegistry ? params.clients : void 0;
	const broadcastInternal = (event, payload, opts, targetConnIds, explicitPluginScope) => {
		...
		for (const c of recipients) {
			if (c.invalidated === true || c.socket.readyState !== 1) continue;
			if (targetConnIds && !indexedClients && !targetConnIds.has(c.connId)) continue;
			...
			if ((event === "session.typing" || (isBrowserCopilotClient(c.connect.client) || hasGatewayClientCap(c.connect.caps, GATEWAY_CLIENT_CAPS.SESSION_SCOPED_EVENTS)) && isSessionSubscriptionEvent) && !(isTargeted && sessionSubscriptionVerified)) {
	...
	const getBufferedAmount = (connId) => {
		if (indexedClients) return indexedClients.getByConnectionId(connId)?.socket.bufferedAmount;
...
function isControlUiAssetManifestPath(value) {
	...
	return normalized === value && !path.posix.isAbsolute(normalized) && !normalized.endsWith("/") && !normalized.split("/").some((segment) => segment === "" || segment === "." || segment === "..");
}
function parseControlUiAssetManifest(value) {
	...
	if (assets.toSorted((left, right) => left.path.localeCompare(right.path)).some((entry, index) => entry.path !== assets[index]?.path)) return null;
...
const CONTROL_UI_STAGING_MAX_AGE_MS = 3600 * 1e3;
...
async function readManifestFile(manifestPath, operation) {
	try {
		throwIfCancelled(operation);
		const stats = await fs$1.lstat(manifestPath);
		if (stats.isSymbolicLink() || !stats.isFile() || stats.size > CONTROL_UI_MANIFEST_MAX_BYTES) return null;
		const contents = await fs$1.readFile(manifestPath, {
			encoding: "utf8",
...
async function readCachedGeneration(cacheRealPath, entry, operation) {
	if (!entry.isDirectory() || entry.isSymbolicLink() || !CONTROL_UI_GENERATION_PATTERN.test(entry.name)) return null;
	const directory = path.join(cacheRealPath, entry.name);
	try {
		throwIfCancelled(operation);
		const realPath = await fs$1.realpath(directory);
		if (!isWithinDir(cacheRealPath, realPath)) return null;
		const manifest = await readManifestFile(path.join(realPath, CONTROL_UI_ASSET_MANIFEST_FILENAME), operation);
		if (!manifest || manifest.generation !== entry.name) return null;
		for (const asset of manifest.assets) {
			throwIfCancelled(operation);
			const assetPath = path.join(realPath, asset.path);
			const stats = await fs$1.lstat(assetPath);
			if (stats.isSymbolicLink() || !stats.isFile() || stats.size !== asset.size || createHash("sha256").update(await fs$1.readFile(assetPath, { signal: operation?.signal })).digest("hex") !== asset.sha256) return null;
		}
		return {
			...
			manifest,
			modifiedAtMs: (await fs$1.stat(realPath)).mtimeMs,
			realPath
		};
	} catch {
		throwIfCancelled(operation);
...
async function loadCachedGenerations(cacheDir, operation) {
	let cacheRealPath;
	let entries;
	try {
		throwIfCancelled(operation);
	...
	return generations.toSorted((left, right) => right.modifiedAtMs - left.modifiedAtMs || left.generation.localeCompare(right.generation));
}
async function readCurrentManifest(root, operation) {
...
async function readVerifiedAsset(params) {
	...
	try {
		...
		if (!openedStats.isFile() || currentStats.isSymbolicLink() || !currentStats.isFile() || currentRealPath !== expectedRealPath || currentStats.dev !== openedStats.dev || currentStats.ino !== openedStats.ino || contents.byteLength !== params.entry.size || createHash("sha256").update(contents).digest("hex") !== params.entry.sha256) throw new Error(`Control UI asset changed while being retained: ${params.entry.path}`);
		throwIfCancelled(params.operation);
		return contents;
	} finally {
		await handle.close();
...
async function publishGeneration(params) {
	...
	if ((await loadCachedGenerations(params.cacheDir, params.operation)).some((entry) => entry.generation === params.manifest.generation)) {
	...
	try {
		...
		for (const entry of params.manifest.assets) {
			...
			await fs$1.writeFile(destination, contents, {
				mode: 384,
		...
		try {
			...
			if (!(await loadCachedGenerations(params.cacheDir, params.operation)).some((entry) => entry.generation === params.manifest.generation)) throw error;
		}
		await fs$1.utimes(target, /* @__PURE__ */ new Date(), /* @__PURE__ */ new Date());
	} finally {
...
async function pruneRetainedGenerations(params) {
	const generations = (await loadCachedGenerations(params.cacheDir, params.operation)).toSorted((left, right) => {
		if (left.generation === params.currentGeneration) return -1;
		if (right.generation === params.currentGeneration) return 1;
		return right.modifiedAtMs - left.modifiedAtMs || left.generation.localeCompare(right.generation);
	});
	const retained = /* @__PURE__ */ new Set();
	let retainedBytes = 0;
	for (const generation of generations) if (retained.size < params.maxGenerations && retainedBytes + generation.bytes <= params.maxBytes) {
	...
	for (const entry of entries) {
		...
		const staleStaging = CONTROL_UI_STAGING_PATTERN.test(entry.name) && params.now - (await fs$1.lstat(path.join(params.cacheDir, entry.name))).mtimeMs >= CONTROL_UI_STAGING_MAX_AGE_MS;
		if ((!generation || retained.has(entry.name)) && !staleStaging) continue;
		const target = path.join(params.cacheDir, entry.name);
		const stats = await fs$1.lstat(target).catch(() => null);
	...
	return {
		prepare(operation) {
			preparing ??= (async () => {
				...
				if (manifestBytes <= CONTROL_UI_RETAINED_ASSET_MAX_BYTES) await publishGeneration({
					cacheDir,
					manifest,
					operation,
					root
...
function createGatewayControlUiRootLifecycle(params) {
	...
	const prepareRetention = (isStopped, signal) => {
		if (state?.kind !== "bundled" || !state.retainedAssets) return Promise.resolve();
		retentionPromise ??= state.retainedAssets.prepare({
	...
	const start = (isStopped, signal) => {
		if (isStopped() || signal.aborted) return Promise.resolve();
		if (state?.kind !== "preparing") return prepareRetention(isStopped, signal);
...
async function prepareGatewayKernelState(params) {
	...
	const { pluginBootstrap, gatewayPluginConfigAtStart, workerEnvironmentStartup, startupTrace, cfgAtStart, resolvedStartupAuthOverride, startupTailscaleOverride, ambientAutostartSuppressedChannelIds, minimalTestGateway, pluginGatewayContext } = bootstrap;
	const pluginRuntime = {
	...
	const nodeDesktopStreamBroker = nodeDesktopObserveAvailable || shouldStartWorkerEnvironmentService ? (await startupTrace.measure("node-desktop.runtime-import", () => import("./node-stream-broker-BFq_Xa8W.js"))).createNodeDesktopStreamBroker() : void 0;
	const hostDesktopService = hostDesktopConfig && hostDesktopEnabled && desktopSessionRegistry ? (await startupTrace.measure("host-desktop.runtime-import", () => import("./host-source-BRwvqaCU.js"))).createHostDesktopService({
	...
	const { workerEnvironmentService, workerLiveEvents, nodeWorkerGatewayNamespace, bindDeviceNodeControl, bindWorkerNodeDesktopControl, bindNodeWorkspaceBindingResolver, bindGitHubPublication, handleNodeWorkerBundleTransferRequest, handleNodeWorkspaceTransferRequest } = workerEnvironmentRuntime;
	...
	const workerPlacementRuntime = workerEnvironmentService && workerEnvironmentStartup && nodeWorkerGatewayNamespace && workerPlacementModule ? await startupTrace.measure("worker-environments.placement-runtime", async () => workerPlacementModule.createGatewayWorkerPlacementRuntime({
		...
		persistAbandonedPartial: async ({ sessionId, sessionKey, agentId, runId }) => {
			...
			if (!text.trim()) return;
			const { persistAbortedPartials } = await import("./chat-abort-runtime-CRQr_Ira.js");
	...
	if (githubPublicationRuntime) bindGitHubPublication?.(githubPublicationRuntime.coordinator);
	...
	if (bootstrap.generatedStartupAuthToken && isLoopbackHost(bindHost)) {
		const { ensureStartupLocalCliPairing } = await import("./startup-local-cli-pairing-BnaJM4rb.js");
	...
	const { createTerminalLaunchPolicy } = await import("./launch-DUwGLdUn.js");
	const terminalLaunchPolicy = createTerminalLaunchPolicy(cfgAtStart);
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-BAr0KUVm.js");
	...
	const { createChannelManager } = await import("./server-channels-CD1cYnnX.js");
	...
	const { clients, broadcast, broadcastToConnIds, broadcastPluginEvent, getBufferedAmount, agentRunSeq, dedupe, chatRunState, addChatRun, removeChatRun, chatAbortControllers, chatQueuedTurns, toolEventRecipients, sessionEventSubscribers, sessionMessageSubscribers, isConnectionActive } = connectionState;
	return {
		...bootstrap,
		pluginRuntime,
...
async function prepareGatewayServerBootstrap(input) {
	...
	const [{ OPENCLAW_DATABASE_SCHEMA_DOCS_URL, OpenClawDatabaseSchemaPreflightError, preflightOpenClawDatabaseSchemas }, agentDatabase, stateDatabase] = await Promise.all([
		import("./openclaw-database-preflight-tC-_YWa7.js"),
		import("./openclaw-agent-db-SfW2bbhN.js"),
		import("./openclaw-state-db-C9brod-n.js")
	]);
	...
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-DnbECfDD.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-DLVVFU4h.js");
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-DuxKgUe4.js"), { cacheRejections: true });
	...
	try {
		const { cleanupRetiredManagedGitHubProfiles } = await import("./github-tool-profile-cleanup-DJJPGDVK.js");
...
const loadGatewayModelCatalogModule = createLazyRuntimeModule(() => import("./server-model-catalog-Bm4TkPGj.js"));
const loadWorkerEnvironmentStartupModule = createLazyRuntimeModule(() => import("./server-worker-environment-startup-Ps0s5Dr_.js"));
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-BsEN3HVm.js"));
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-CVBvSsNs.js"));
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-P1yPdLAG.js"));
...
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-CVTNndQP.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
function handlePortalProxyUpgrade(params) {
	...
	connectPortalTarget(target.target).then((targetSocket) => {
		...
		if (!socket.destroyed) if (target.target.kind === "worker") respondUpgradeWaiting(socket, targetPort);
		else socket.destroy();
	});
}
//#endregion
...
const getHttpAuthUtilsModule$2 = createLazyRuntimeModule(() => import("./http-auth-utils-DJurfx3S.js"));
...
const getPluginNodeCapabilityAuthModule$1 = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-CMUNy-O_.js"));
const getHttpAuthUtilsModule$1 = createLazyRuntimeModule(() => import("./http-auth-utils-DJurfx3S.js"));
const getPluginRouteRuntimeScopesModule$1 = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-m77ABG7n.js"));
	...
	httpServer.on("upgrade", (req, socket, head) => {
		...
		runWithDiagnosticTraceContext(createDiagnosticTraceContext(), async () => {
			...
			if (requestPath === "/desktop/observe") {
				...
				const { handleDesktopObserveUpgrade } = await import("./observe-bridge-Bgx0jLjl.js");
...
const getControlUiModule = createLazyRuntimeModule(() => import("./control-ui-BFOrNcAu.js"));
const getCanvasServeModule = createLazyRuntimeModule(() => import("./serve.runtime.js"));
const getBoardHttpModule = createLazyRuntimeModule(() => import("./board-http-CUhH4pD5.js"));
const getEmbeddingsHttpModule = createLazyRuntimeModule(() => import("./embeddings-http-CjuNrEiD.js"));
const getManagedMediaAttachmentsModule = createLazyRuntimeModule(() => import("./managed-image-attachments-DAGyYr8W.js"));
const getMcpAppStandaloneModule = createLazyRuntimeModule(() => import("./mcp-app-standalone-BHURmjhq.js"));
const getPluginIconHttpModule = createLazyRuntimeModule(() => import("./plugin-icon-http-BftIqS5L.js"));
const getWorkspaceIconHttpModule = createLazyRuntimeModule(() => import("./workspace-icon-http-BGXIq_j_.js"));
const getChannelAvatarHttpModule = createLazyRuntimeModule(() => import("./channel-avatar-http-CBcsTvpB.js"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-Dyq57UNe.js"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-d7T2BZjm.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-B_vrzc_h.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-Ds9XG0iW.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-dGVlz1qM.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-COHnwiZx.js"));
const getUserProfilesHttpModule = createLazyRuntimeModule(() => import("./user-profiles-http-bsYxPn88.js"));
const getDevicePairingJoinHttpModule = createLazyRuntimeModule(() => import("./device-pairing-join-http-Bp1aJUfq.js"));
const getPluginNodeCapabilityAuthModule = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-CMUNy-O_.js"));
const getHttpAuthUtilsModule = createLazyRuntimeModule(() => import("./http-auth-utils-DJurfx3S.js"));
const getPluginRouteRuntimeScopesModule = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-m77ABG7n.js"));
...
function createGatewayHttpServer(opts) {
	...
	async function handleRequest(req, res) {
		...
		try {
			...
			addRequestStage(controlUiEnabled && [
				"pluginIcon",
				"catalogIcon",
				"linkFavicon"
			].some((route) => parseControlUiResourcePath(route, scopedRequestPath, controlUiRouteBasePath).matched), async () => (await getPluginIconHttpModule()).handlePluginIconHttpRequest(req, res, controlUiRouteOptions));
			addRequestStage(controlUiEnabled && parseControlUiResourcePath("workspaceIcon", scopedRequestPath, controlUiRouteBasePath).matched, async () => (await getWorkspaceIconHttpModule()).handleWorkspaceIconHttpRequest(req, res, controlUiRouteOptions));
			addRequestStage(controlUiEnabled && parseControlUiResourcePath("channelAvatar", scopedRequestPath, controlUiRouteBasePath).matched, async () => (await getChannelAvatarHttpModule()).handleChannelAvatarHttpRequest(req, res, controlUiRouteOptions));
			addRequestStage(controlUiEnabled, async () => (await getControlUiModule()).handleControlUiAssistantMediaRequest(req, res, {
				...controlUiRouteOptions,
				agentId: resolveAssistantIdentity({ cfg: configSnapshot }).agentId
			}));
			addRequestStage(controlUiEnabled, async () => (await getControlUiModule()).handleControlUiAvatarRequest(req, res, controlUiRouteOptions));
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-kss2gBUP.js");
...
async function createGatewayHttpTransport(params) {
	...
	const getHookDispatcher = async () => {
		const { createGatewayHookDispatcher } = await import("./hooks-CnldEvc9.js");
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-CnldEvc9.js");
	...
	const handleMcpOAuthCallbackRequest = async (req, res) => {
		const { handleMcpOAuthCallback } = await import("./mcp-oauth-callback-CD0SZcsG.js");
...
async function finishGatewayStartup(params) {
	...
	const { minimalTestGateway, deps, runtimeState, kernel, startupTrace, broadcast, broadcastToConnIds, clients, sharedGatewaySessionGenerationState, workerEnvironmentService, workerPlacementRuntime, terminalLaunchPolicy, terminalSessions, startChannel, stopChannel, getAttachedGatewayMethodRegistry, lifecycle, startupState, pluginRuntime, resolvePluginGatewayContext, gatewayTls, bindHost, getResolvedAuth, authRateLimiter, browserAuthRateLimiter, nodeReapprovalCoordinator, preauthHandshakeTimeoutMs, isGatewayStartupPending, attachedGatewayExtraHandlers, startListening, loadStartupPluginsModule, gatewayPluginConfigAtStart, startupActivationSourceConfig, defaultWorkspaceDir, coreGatewayMethodNames, pluginHostServices, baseMethods, startupPluginIds, pluginManifestRecords, pluginMetadataSnapshot, pluginLookUpTable, ambientEnvTriggers, replaceAttachedPluginRuntime, refreshAttachedGatewayDiscovery, wss, httpBindHosts, startChannels, broadcastPluginEvent, controlUiBasePath, controlUiRootLifecycle, sidecarStartup, workerLiveEvents, earlyRuntime, cfgAtStart, preauthConnectionBudget, releaseStartupAccountStarts, cronReconciliation, postReadyState, cronStartState, prepareReloadCandidate, startupLastGoodSnapshot, startupInternalWriteHash, configSnapshot, channelManager, activateRuntimeSecrets, applyFixedGatewayOverlays, resolveSharedGatewaySessionGenerationForConfig, stopRegisteredGatewayLifetimeSidecars, stopRegisteredPostReadySidecars, registerPostReadySidecars, registerGatewayLifetimeSidecars, chatMetadataLifecycle, gatewayRequestContext, gatewayInstanceRuntime, getPluginMetadataSnapshot } = runtime;
	const startupPluginRuntimeClaim = kernel.pluginRuntimeGeneration.currentClaim();
	const unregisterGatewayLifetimeSidecar = (sidecar) => {
		kernel.setGatewayLifetimeSidecars(runtimeState.gatewayLifetimeSidecars.filter((registered) => registered !== sidecar));
	};
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-BK9q-0kP.js"), import("./route-capability-BXcSN5qB.js")]));
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-DfPttvVu.js"), { cacheRejections: true });
	...
	const { createGatewayServerActiveWorkInspectors } = await import("./server-active-work-DKTtAId5.js");
	const postAttachHandles = await startupTrace.measure("runtime.post-attach", () => loadGatewayStartupPostAttachModule().then(({ startGatewayPostAttachRuntime }) => startGatewayPostAttachRuntime({
		minimalTestGateway,
		cfgAtStart,
		getConfig: getRuntimeConfig,
		bindHost,
	...
	if (!minimalTestGateway) {
		const { startOpenClawDatabaseIntegrityVerifier } = await import("./openclaw-database-verify-MBC46eji.js");
		kernel.addGatewayLifetimeSidecar(startOpenClawDatabaseIntegrityVerifier({ env: process.env }));
	}
	postAttachRuntimeReturned = true;
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-L308WDhD.js");
	...
	if (!minimalTestGateway) {
		...
		postReadyState.retainedPluginCleanupHandle = gatewayRuntimeServices.scheduleGatewayIdleTask({
			...
			run: async () => {
				const { cleanupRetainedPluginInstallGenerations } = await import("./server-retained-plugin-cleanup-DMDvg18D.js");
...
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-DtDMwaGI.js"));
...
async function startGatewayServerCore(port = 18789, opts = {}) {
	...
	let startupSettled;
	const { beginClosePrelude, closeOnStartupFailure, createCloseHandler, sealAndJoinRegisteredSidecarStops, runClosePrelude, stopRegisteredGatewayLifetimeSidecars, stopRegisteredPostReadySidecars, terminalSessions, shutdownRuntime } = gatewayKernel;
	try {
		const transport = await createGatewayHttpTransport({
			...
			...!gatewayKernel.minimalTestGateway && gatewayKernel.tailscaleMode !== "off" ? { prepareManagedTailscaleIngress: async (backend) => {
				const { startGatewayTailscaleExposure } = await import("./server-tailscale-Ros_TIq5.js");
