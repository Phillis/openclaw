...
async function collectTriageBundle(skipExport) {
	...
	try {
		...
		const [{ writeDiagnosticSupportExport }, { gatherDaemonStatus }] = await Promise.all([import("./diagnostic-support-export-BOHYkFBD.js"), import("./status.gather-QTbimqHu.js")]);
		return {
			kind: "available",
...
async function triageCommand(runtime, options = {}) {
	const { collectDoctorFindings } = await import("./doctor-lint-GGjrqyNX.js");
	...
	const { agentExecCommand } = await import("./agent-exec-U8BAfYdl.js");
