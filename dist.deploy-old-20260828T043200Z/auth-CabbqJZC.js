...
import { i as resolvePluginSetupRegistry, r as resolvePluginSetupProviderCore } from "./setup-registry-CHJgnlrg.js";
...
import { f as upsertAuthProfileWithLockOrThrow, o as removeProviderAuthProfilesWithLock, r as promoteAuthProfileInOrder, u as upsertAuthProfileAfterLoginWithLockOrThrow } from "./profiles-B9i8Wh87.js";
...
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-CEEA2BzH.js";
...
import { c as updateConfig, r as loadValidConfigOrThrow, s as resolveModelsTargetAgent } from "./shared-BOd9kz9I.js";
...
import { t as refreshRunningGatewayAuthState } from "./auth-refresh-CRpvu2nA.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: params.openUrl ?? (async (url) => {
			const { openUrl } = await import("./onboard-helpers-kk_BLYXI.js");
			await openUrl(url);
		}),
