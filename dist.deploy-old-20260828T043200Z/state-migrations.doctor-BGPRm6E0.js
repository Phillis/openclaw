...
import { f as resolveLegacyInstalledPluginIndexStorePath } from "./manifest-registry-DRErrq38.js";
import { o as OPENCLAW_SQLITE_BUSY_TIMEOUT_MS } from "./openclaw-state-db-contract-C1w8kMxr.js";
import { An as executeSqliteQuerySync, Ln as readSqliteUserVersion, Mn as getNodeSqliteKysely, On as quoteSqliteIdentifier, Yt as resolveOpenClawStateSqlitePath, bt as resolveSqliteDatabaseFilePaths, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction, jn as executeSqliteQueryTakeFirstSync, m as repairOpenClawStateDatabaseSchemaIfNeeded, p as repairOpenClawStateDatabaseSchema, u as openExistingOpenClawStateDatabaseReadOnly, xn as repairCanonicalSqliteIndexes, xt as detectOpenClawStateDatabaseSchemaMigrations } from "./openclaw-state-db-CeAO_dqo.js";
...
import { n as collectRelevantDoctorPluginIds, o as listPluginDoctorSessionStoreAgentIds, s as listPluginDoctorStateMigrationEntries } from "./doctor-contract-registry-f9Q7T1FE.js";
import { n as resolveSessionStoreCompatibilityAgentId } from "./legacy.default-agent-owner-CL_-T11Y.js";
import { a as updateConfigMachineState, n as importConfigMachineState, r as readConfigMachineState } from "./config-machine-state-FNVGu8mV.js";
...
import { i as resolveSharedAuthStoreOwnership, n as noteCommittedSharedAuthStoreOwnership, o as resolveSharedMainAuthAgentDir, t as SHARED_AUTH_STORE_STATE_KEY } from "./path-resolve-CCojuy8M.js";
...
import { u as resolveSqliteTranscriptArchiveDirectory } from "./session-accessor.sqlite-scope-DPR8rGGl.js";
import { Ft as readSessionIdentityEvidenceBatch } from "./session-accessor-B-FKZX9M.js";
import { c as resolveSessionStoreTargets, d as resolveAgentSessionDirsFromAgentsDirSync, l as dedupeSessionStoreTargetsBySqliteTarget } from "./targets-Bo3OPXck.js";
import { d as rewriteSqliteTranscriptEventRowsInTransaction, f as updateSqliteTranscriptEventJsonInTransaction } from "./session-accessor.sqlite-transcript-store-Bx_F0DmJ.js";
...
import { _ as pluginStateDoctorEntriesInKeyRange, g as pluginStateDeleteEntriesIfUnchanged, h as getPluginStateCapacity, i as importPluginStateEntriesForDoctor, n as createPluginStateKeyedStore } from "./plugin-state-store-TmxGb72e.js";
import { S as readSharedAuthLegacyRowsFromDatabase, b as inspectSharedAuthLegacyRowsReadOnly, p as resolveAuthProfileDatabaseOwnerId, t as closeAuthProfileReadPool, v as SharedAuthStoreSourceInspectionError, x as inspectSharedAuthLegacySourceFile, y as hasPendingSharedAuthCleanup } from "./sqlite-fgcxOC8G.js";
import { s as getMediaDir } from "./store-B6ILpvye.js";
import { a as isSafeWorkspaceAttestationFilename, b as resolveLegacyWorkspaceSourcePaths, d as LEGACY_WORKSPACE_ATTESTATION_DIRNAME, f as LEGACY_WORKSPACE_ATTESTATION_HEADER, g as WORKSPACE_DOCTOR_CLAIM_SUFFIX, l as registerWorkspaceStateAliasesInTransaction, n as WORKSPACE_LEGACY_STATE_MIGRATION_KIND, p as LEGACY_WORKSPACE_ATTESTATION_MAX_BYTES } from "./workspace-state-store-CKubv1mM.js";
...
import { n as parseRestartSentinelEnvelope, o as writeRestartSentinelRowSync, r as readRestartSentinelRowSync } from "./restart-sentinel-store-57wnYfI8.js";
...
import { f as mcpOAuthStoreKeyFromLegacyFileName, o as parseMcpOAuthStoreJson } from "./mcp-oauth-store-BSuWhVNF.js";
import { r as resolveSandboxWorkspaceLayoutPaths } from "./shared-BYKW6NFa.js";
import { a as transcriptSessionExportKey, i as safeTranscriptPathSegment, n as renderTranscriptsMarkdown, o as transcriptSessionSelector, s as ensureMeetingTranscriptsSchema, t as TranscriptsStore } from "./store-D9_zQ2BB.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-cxjR1aAq.js";
import { a as updateChannelPairingStateSnapshot, c as resolveAllowFromAccountId, l as safeAccountKey, s as dedupePreserveOrder, u as getPairingAdapter } from "./pairing-store-sqlite-DBAcvU8G.js";
import { n as SYSTEM_AGENT_AUDIT_SCOPE, t as SYSTEM_AGENT_AUDIT_MAX_ENTRIES } from "./audit-C7t95Ufg.js";
...
import { C as rewriteRegistryWorktreePathsForMigration, g as hasLegacyRegistryWorktrees, s as discardLegacyRegistryWorktrees, x as listRegistryWorktreesForMigration } from "./registry-C-YbfNzS.js";
...
async function autoMigrateLegacyState(params) {
	...
	const legacySessionSurfaces = params.legacySessionSurfaces ?? (await import("./legacy-session-surfaces-6eDuZmqQ.js")).prepareLegacySessionSurfaces({
		config: params.cfg,
		env
	});
