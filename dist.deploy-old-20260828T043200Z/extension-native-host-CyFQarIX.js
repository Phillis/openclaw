...
async function validateNativeManifest(params) {
	...
	if (!isPathInside(path.resolve(params.stateDir ?? resolveStateDir(), "browser", "native-messaging"), launcherPath)) throw new Error("launcher is outside the managed root");
