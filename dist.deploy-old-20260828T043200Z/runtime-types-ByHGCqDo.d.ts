import { Bt as AccessGroupConfig, H as ChannelImplicitMentionsConfig, r as OpenClawConfig } from "./types.openclaw-Cjm06lg9.js";
...
//#endregion
export { ChannelIngressQueueRecord as $, InboundMentionDecision as A, IdentifierAuthentication as B, ChannelIngressEventInput as C, ChannelIngressStateInput as D, ChannelIngressState as E, ResolveInboundMentionDecisionParams as F, DEFAULT_INGRESS_RETRY_DEAD_LETTER_MIN_AGE_MS as G, CreateChannelIngressDrainOptions as H, implicitMentionKindWhen as I, ChannelIngressQueue as J, DEFAULT_INGRESS_RETRY_MAX_ATTEMPTS as K, resolveInboundMentionDecision as L, InboundMentionPolicy as M, ResolveInboundMentionDecisionFlatParams as N, IngressReasonCode as O, ResolveInboundMentionDecisionNestedParams as P, ChannelIngressQueuePruneOptions as Q, ResolvedChannelImplicitMentions as R, ChannelIngressDecision as S, ChannelIngressPolicyInput as T, DEFAULT_INGRESS_ADOPTION_STALL_MS as U, ChannelIngressDrain as V, createChannelIngressDrain as W, ChannelIngressQueueClaimRef as X, ChannelIngressQueueClaim as Y, ChannelIngressQueueCorruptClaim as Z, ResolveChannelMessageIngressParams as _, ChannelIngressContextBinding as a, StableChannelIngressIdentityParams as b, ChannelIngressIdentityDescriptor as c, ChannelIngressResolver as d, CreateChannelIngressQueueOptions as et, ChannelIngressResolverMessageParams as f, CreateChannelIngressResolverParams as g, ChannelMessageIngressCommandInput as h, ChannelIngressConfigInput as i, InboundMentionFacts as j, InboundImplicitMentionKind as k, ChannelIngressIdentityField as l, ChannelIngressRouteDescriptor as m, ChannelIngressCommandAccess as n, ChannelIngressEventPresetInput as o, ChannelIngressRouteAccess as p, bindIngressLifecycleToReplyOptions as q, ChannelIngressCommandPresetInput as r, ChannelIngressIdentityAlias as s, ChannelIngressAccessGroupMembershipResolver as t, ChannelIngressIdentitySubjectInput as u, ResolveStableChannelMessageIngressParams as v, ChannelIngressIdentifierKind as w, AccessGroupMembershipFact as x, ResolvedChannelMessageIngress as y, resolveChannelImplicitMentions as z };