...
import { a as listAgentIds, f as resolveAgentWorkspaceDir, w as tryResolveSoleAgentId } from "./agent-scope-config-CUBiGmG3.js";
import { c as parseAgentSessionKey } from "./session-key-utils-Di3FvABa.js";
import { n as normalizeAccountId } from "./account-id-BH0zJUew.js";
import { P as validateConfigObjectWithPlugins } from "./io-DlN5njvP.js";
import { a as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, i as normalizeChatChannelId } from "./ids-Cgp0iV_A.js";
import { An as executeSqliteQuerySync, Mn as getNodeSqliteKysely, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction, jn as executeSqliteQueryTakeFirstSync, zt as tableExists } from "./openclaw-state-db-CeAO_dqo.js";
...
import { i as materializePluginAutoEnableCandidates, t as applyPluginAutoEnable } from "./plugin-auto-enable-59wfJI6V.js";
import { g as validateSkillProposalRollback, h as validateSkillProposalRecord } from "./store-sqlite-record-CsO0xTyk.js";
import { E as hashSkillProposalContent, a as readSkillProposal, r as importLegacySkillProposal, w as readSkillProposalRollback } from "./store-B2Qbdth0.js";
import { t as removePathWithinRoot } from "./fs-safe-remove-B3egFJhN.js";
import { n as repairObsoleteGeneratedExecApprovals } from "./exec-approvals-generated-migration-DfpexxOF.js";
import { r as githubAuthenticationSubject, t as classifyTailscaleLogin, y as ensureUserProfilesSchema } from "./user-profiles-tailscale-login-D_fNUJ0L.js";
import { s as readChannelAllowFromStore } from "./pairing-store-CHm2POOL.js";
import { r as maybeRepairCodexRoutes } from "./codex-route-warnings-zP2n26is.js";
import { r as VERSION_BOUND_RUNTIME_PLUGIN_POLICY_IDS_BY_SURFACE } from "./configured-runtime-plugin-installs-BDsuC35X.js";
import { d as isUpdatePackageSwapInProgress } from "./update-phase-CUQAfBmE.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-DDxh45JE.js";
import { n as maybeMigrateAuthProfileJsonStoresToSqlite, r as maybeRepairOpenAICodexAuthConfig, t as collectOpenAICodexAuthProfileStoreIdMap } from "./doctor-auth-flat-profiles-CsqSUxHn.js";
import { t as maybeRepairLegacyOAuthSidecarProfiles } from "./doctor-auth-oauth-sidecar-Dic2-ryp.js";
import { r as resolveConfigWideDoctorPluginMetadataSnapshot } from "./plugin-metadata-snapshot-scope-Ck4_nI-n.js";
import { n as maybeRepairPluginOpenClawHostLinks } from "./doctor-plugin-host-links-B49TOy9N.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-CqSBOMKz.js";
import { r as maybeRepairStaleManagedNpmBundledPlugins } from "./doctor-plugin-registry-DlDVDprr.js";
import { t as getDoctorChannelCapabilities } from "./channel-capabilities-CAT4v_Qb.js";
import { n as hasAllowFromEntries, t as scanEmptyAllowlistPolicyWarnings } from "./empty-allowlist-scan-WtBX01Cy.js";
import { n as maybeRepairBundledPluginLoadPaths } from "./bundled-plugin-load-paths-D2VuTe2c.js";
import { a as collectChannelDoctorRepairMutations, s as createChannelDoctorEmptyAllowlistPolicyHooks, t as collectChannelDoctorCompatibilityMutations } from "./channel-doctor-DQJvulMC.js";
import { n as maybeRepairContextEngineHostCompatibility } from "./context-engine-host-compat-0v8g-uka.js";
import { r as maybeRepairExecSafeBinProfiles } from "./exec-safe-bins-CF5_-eEd.js";
import { n as maybeRepairLegacyToolsBySenderKeys } from "./legacy-tools-by-sender-WckrxOq3.js";
import { n as maybeRepairOpenPolicyAllowFrom } from "./open-policy-allowfrom-Df5vlPnp.js";
import { t as cleanupLegacyPluginDependencyState } from "./plugin-dependency-cleanup-BYEKj8rh.js";
import { t as repairStaleAgentModelRefs } from "./stale-agent-model-ref-repair-DKN7gX-9.js";
import { n as maybeRepairStaleConfiguredAuthOrders } from "./stale-auth-order-w4Fzk73W.js";
import { n as repairStaleOAuthProfileShadows } from "./stale-oauth-profile-shadows-D-58KS3w.js";
import { r as maybeRepairStalePluginConfig } from "./stale-plugin-config-BOqesv3p.js";
import { n as maybeRepairStaleSubagentAllowlists } from "./stale-subagent-allowlist-l-lE43XK.js";
