import { a as toStringifiedError, i as toErrorObject } from "./error-coercion-CKFmnpjH.js";
import { F as resolveTimerTimeoutMs, a as addTimerTimeoutGraceMs, m as clampTimerTimeoutMs } from "./number-coercion-CLj0HTDM.js";
...
import { n as registerManagedProxyBrowserCdpBypass } from "./proxy-lifecycle-CWeKQeAq.js";
...
import { r as BrowserCdpEndpointBlockedError } from "./tmp-openclaw-dir-DE5M5B-m.js";
...
//#endregion
export { usesFastLoopbackCdpProbeClass as A, DEFAULT_BROWSER_ACTION_TIMEOUT_MS as B, CHROME_LAUNCH_READY_WINDOW_MS as C, PLAYWRIGHT_TARGET_INFO_TIMEOUT_MS as D, CHROME_STOP_TIMEOUT_MS as E, stripCdpUrlCredentials as F, DEFAULT_BROWSER_LOCAL_LAUNCH_TIMEOUT_MS as G, DEFAULT_BROWSER_DOWNLOAD_TIMEOUT_MS as H, withTimeout as I, DEFAULT_OPENCLAW_BROWSER_COLOR as J, DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS as K, BROWSER_TAB_UNREACHABLE_RETIRE_MS as L, withManagedProxyForCdpUrl as M, withNoProxyForCdpUrl as N, PROFILE_ATTACH_RETRY_TIMEOUT_MS as O, getHeadersWithAuth as P, DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS as R, CHROME_BOOTSTRAP_PREFS_TIMEOUT_MS as S, CHROME_STDERR_HINT_MAX_CHARS as T, DEFAULT_BROWSER_EVALUATE_ENABLED as U, DEFAULT_BROWSER_DEFAULT_PROFILE_NAME as V, DEFAULT_BROWSER_LOCAL_CDP_READY_TIMEOUT_MS as W, DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME as X, DEFAULT_OPENCLAW_BROWSER_ENABLED as Y, withCdpSocket as _, fetchJson as a, CDP_JSON_NEW_TIMEOUT_MS as b, isWebSocketUrl as c, resolveCdpTabOwnership as d, scopeCdpPolicyToConfiguredEndpoint as f, openCdpWebSocket as g, resolveBrowserRateLimitMessage as h, fetchCdpChecked as i, assertManagedProxyAllowsCdpUrl as j, resolveCdpReachabilityTimeouts as k, normalizeCdpHttpBaseForJsonEndpoints as l, withExactHostnamePolicy as m, assertCdpEndpointAllowed as n, fetchOk as o, isCdpHostnameTrustedByPolicy as p, DEFAULT_BROWSER_SNAPSHOT_TIMEOUT_MS as q, closeTrackedCdpTarget as r, isDirectCdpWebSocketEndpoint as s, appendCdpPath as t, redactCdpErrorText as u, normalizeBrowserTimerDelayMs as v, CHROME_MCP_ATTACH_READY_WINDOW_MS as w, CHROME_BOOTSTRAP_EXIT_TIMEOUT_MS as x, getPlaywrightCore as y, DEFAULT_AI_SNAPSHOT_MAX_CHARS as z };
