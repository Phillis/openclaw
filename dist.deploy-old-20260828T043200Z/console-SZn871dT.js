...
import { i as formatTimestamp, r as formatJsonConsoleLine } from "./json-console-line-C-rJUoue.js";
import { r as normalizeLogLevel } from "./levels-qpAN12Fm.js";
import { l as readLoggerConfig, o as getLogger, v as resolveEnvLogLevelOverride } from "./logger-ij8OHrrv.js";
...
function getConsoleSettings() {
	...
	loggingState.cachedConsoleSettings = resolveConsoleSettings();
...
function writeFormattedConsoleOutput(params) {
	...
	const jsonMeta = consoleStyle === "json" && params.level === "trace" && params.caller ? { stack: stripAnsi(captureConsoleTraceStack(params.formatted, params.caller)) } : void 0;
	try {
		...
		else if (consoleStyle === "json") (params.level === "trace" ? params.traceWrite : params.write).call(console, line);
		else if (!timestamp && params.args.length === 0) params.write.apply(console, params.args);
