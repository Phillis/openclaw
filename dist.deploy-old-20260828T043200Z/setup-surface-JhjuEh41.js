...
import { g as MarkdownConfigSchema, u as GroupPolicySchema } from "./zod-schema.core-CTdpjCBO.js";
...
import { t as applyAccountNameToChannelSection } from "./setup-helpers-ChQBLW6h.js";
import { k as runSingleChannelSecretStep, x as patchTopLevelChannelConfigSection } from "./setup-wizard-helpers-JxuPdtZE.js";
...
import { a as resolveBuzzPublicKey, f as parseBuzzTarget, i as resolveBuzzAccount, n as decodeBuzzPrivateKey, s as BUZZ_CHANNEL_ID_PATTERN } from "./types-CwQqI1bE.js";
import { i as generateSecretKey, o as nip19_exports } from "./esm-DvxIBjlD.js";
import { a as parseBuzzRoomMembershipEvent, c as parseBuzzAuthTag, l as openBuzzRelaySubscription, s as connectAuthenticatedBuzzRelaySession, t as BUZZ_ROOM_MEMBERSHIP_KIND, u as queryBuzzRelaySnapshot } from "./room-membership-BpQI1A-P.js";
...
const BuzzConfigSchema = buildChannelConfigSchema(object({
	...
	historyLimit: number().int().min(0).max(20).optional(),
