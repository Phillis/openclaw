...
import { t as isReplayUnsafeAssistantError } from "./retry-DET1SLJy.js";
...
import { S as matchesFormatErrorPattern, _ as isBillingErrorMessage, a as isContextOverflowError, b as isRateLimitErrorMessage, c as isReasoningConstraintErrorMessage, d as isExactUnknownNoDetailsError, g as isAuthErrorMessage, l as inferSignalStatus, n as classifyFailoverSignal, o as isContextOverflowErrorFromTables, s as isLikelyContextOverflowError, t as classifyFailoverReason, u as isBilling429MessageForProvider, x as isTimeoutErrorMessage, y as isProviderCompletedErrorFinishReasonMessage } from "./classify-DkuNrlYG.js";
import { t as extractFailoverSignalDetails } from "./signal-details-CG2lfr-u.js";
import { a as sanitizeToolCallIdsForCloudCodeAssist, i as rewriteToolResultIds } from "./tool-call-id-DJVgVJu5.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-DSTTabjp.js";
import "./thinking-CNREPJ80.js";
import { T as formatExecDeniedUserMessage, c as formatTransportErrorCopy, d as isLikelyHttpErrorText, f as isRawApiErrorPayload, o as formatBillingErrorMessage, p as isStreamingJsonParseError, s as formatDiskSpaceErrorCopy, t as AUTH_INVALID_TOKEN_USER_TEXT, u as isInvalidStreamingEventOrderError, y as renderRateLimitOrOverloadedCopy } from "./user-copy-LZk56sIA.js";
import { o as stripThoughtSignatures } from "./bootstrap-CPC1PIIz.js";
import { t as formatSandboxToolPolicyBlockedMessage } from "./runtime-status-Jg1T3gN6.js";
...
function formatAssistantErrorText(msg, opts) {
	...
	if (isTimeoutErrorMessage(raw)) return SYNTHESIZED_TIMEOUT_ERROR_TEXT;
...
//#endregion
export { isFailoverAssistantError as _, normalizeOpenAIResponsesToolCallIds as a, SYNTHESIZED_TIMEOUT_ERROR_TEXT as c, classifyProviderRuntimeFailureKind as d, extractObservedOverflowTokenCount as f, isBillingAssistantError as g, isAuthAssistantError as h, downgradeOpenAIReasoningBlocks as i, formatAssistantErrorText as l, classifyAssistantFailoverReason as m, sanitizeSessionMessagesImages as n, isGoogleModelApi as o, isCompactionFailureError as p, downgradeOpenAIFunctionCallReasoningPairs as r, GENERIC_ASSISTANT_ERROR_TEXT as s, pickFallbackThinkingLevel as t, formatUserFacingAssistantErrorText as u, isRateLimitAssistantError as v };
