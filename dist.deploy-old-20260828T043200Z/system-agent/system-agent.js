...
import { i as loadSystemAgentOverview, n as formatSystemAgentOverview } from "../overview-CQu7oloB.js";
import { a as parseSystemAgentOperation, i as isPersistentSystemAgentOperation, t as executeSystemAgentOperation } from "../operations-CCkoW4hg.js";
import { r as withProgress } from "../progress-3-oJv0bD.js";
import { t as SystemAgentInferenceUnavailableError } from "../inference-error-MxT_vZPs.js";
import { a as resolveSystemAgentVerifiedInferenceRoute } from "../verified-inference-D699BYSI.js";
import { n as resolveSystemAgentOperation } from "../dialogue-CNrNbGbe.js";
...
async function runSystemAgent(opts, runtime = defaultRuntime) {
	...
	const runInteractiveTui = boundOpts.runInteractiveTui ?? (await import("../tui-backend-DNMHtaOX.js")).runSystemAgentTui;
	boundOpts.onReady?.();
