 ...
 */
declare function oauthSuccessHtml(
 ...
 */
declare function oauthErrorHtml(
...
declare function generateBase64UrlOAuthState(): string;
/**
 ...
 */
declare function parseOAuthAuthorizationInput(
...
declare function resolveOAuthTokenLifetimeMs(
...
declare function resolveOAuthTokenExpiresAt(
/** Provider `expires_in` value in seconds. */
...
declare function throwIfOAuthLoginAborted(
...
declare function withOAuthLoginAbort<T>(
...
//#endregion
export { withOAuthLoginAbort as S, oauthSuccessHtml as _, OAuthPrompt as a, resolveOAuthTokenLifetimeMs as b, OAuthProviderInfo as c, OAuthSelectPrompt as d, buildOAuthRequestSignal as f, oauthErrorHtml as g, generatePKCE as h, OAuthLoginCallbacks as i, OAuthProviderInterface as l, generateBase64UrlOAuthState as m, OAuthAuthorizationInput as n, OAuthProvider as o, createOAuthLoginCancelledError as p, OAuthCredentials as r, OAuthProviderId as s, OAuthAuthInfo as t, OAuthSelectOption as u, parseOAuthAuthorizationInput as v, throwIfOAuthLoginAborted as x, resolveOAuthTokenExpiresAt as y };