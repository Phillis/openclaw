...
import { f as resolveAgentWorkspaceDir, g as resolveDefaultAgentId, h as resolveDefaultAgentDir, l as resolveAgentDir } from "./agent-scope-config-CUBiGmG3.js";
...
import { u as publishPreparedModelRuntimeSnapshot } from "./prepared-model-runtime-afzKiwqZ.js";
...
import { r as prepareAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-DmAuFIdl.js";
import "./provider-auth-choice-preference-DCD_dIHf.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-Z_9y429I.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-3AOCxPEd.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-Db9OVFzY.js");
	...
	const { resolveDeprecatedProviderInstallCatalogEntry } = await import("./provider-install-catalog-r_EXk3M8.js");
