...
import { J as DEFAULT_OPENCLAW_BROWSER_COLOR, U as DEFAULT_BROWSER_EVALUATE_ENABLED, X as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, z as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "../../cdp.helpers-geYy1F8f.js";
...
import { n as resolveBrowserControlAuth, t as ensureBrowserControlAuth } from "../../control-auth-_STA_Sab.js";
import { H as readBrowserVersion, V as parseBrowserMajorVersion, W as resolveGoogleChromeExecutableForPlatform } from "../../chrome-DjHNxomb.js";
import { t as movePathToTrash } from "../../trash-CmvqpBj1.js";
import { t as createBrowserRouteContext } from "../../server-context-CWeEXVWZ.js";
import { _ as browserStatus, a as untrackSessionBrowserTab, b as browserTabAction, c as browserDeleteProfile, f as browserOpenTab, g as browserStart, h as browserSnapshot, i as trackSessionBrowserTab, l as browserDoctor, m as browserResetProfile, o as browserCloseTab, p as browserProfiles, s as browserCreateProfile, t as closeTrackedBrowserTabsForSessions, u as browserFocusTab, v as browserStop, x as browserTabs } from "../../session-tab-registry-CNRMEZ8f.js";
import { i as createBrowserTool, n as browserHandlers, r as handleBrowserGatewayRequest, t as createBrowserPluginService } from "../../plugin-service-BQLanvxI.js";
import { a as browserConsoleMessages, c as browserArmDialog, d as browserNavigate, f as browserScreenshotAction, l as browserArmFileChooser, n as startBrowserBridgeServer, o as browserPdfSave, r as stopBrowserBridgeServer, s as browserAct, t as runBrowserProxyCommand } from "../../core-api-CYJl4aCp.js";
import { t as registerBrowserRoutes } from "../../routes-DIECR32v.js";
import { n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware } from "../../server-middleware-D8V5qpi4.js";
import { c as stopBrowserRuntime, o as createBrowserRuntimeState, r as getBrowserControlState, t as createBrowserControlContext } from "../../browser-control-state-BTWAc1BW.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "../../dispatcher-PWXLT6sP.js";
import { c as normalizeBrowserFormFieldValue, s as normalizeBrowserFormField } from "../../snapshot-urls-DVqktkQ3.js";
import { n as stopBrowserControlService, t as startBrowserControlServiceFromConfig } from "../../control-service-DxUXYGC6.js";
import { n as closePlaywrightBrowserConnection } from "../../pw-session-B3UdriXd.js";
