...
import { C as parseStrictNonNegativeInteger, F as resolveTimerTimeoutMs, f as asSafeIntegerInRange } from "../../number-coercion-CLj0HTDM.js";
...
import { f as resolveAgentWorkspaceDir, g as resolveDefaultAgentId, h as resolveDefaultAgentDir, s as resolveAgentConfig } from "../../agent-scope-config-CUBiGmG3.js";
...
import { p as loadAuthProfileStoreWithoutExternalProfiles } from "../../store-C0UG5FOx.js";
...
import { a as isModelSelectionLocked, r as ModelSelectionLockedError } from "../../model-overrides-BcLzAaaZ.js";
import { h as resolveTranscriptSessionKeyBySessionId, m as resolveStorePath, r as getSessionEntry } from "../../session-store-runtime-BNwfvw44.js";
import { d as buildOpenAICodexCredentialExtra, h as resolveOpenAICodexImportProfileName, m as resolveOpenAICodexAuthIdentity } from "../../provider-auth-DI4TAoBi.js";
import { n as updateAuthProfileStoreWithLockCompat } from "../../provider-auth-write-compat-BVWrJFNm.js";
import { n as buildApiKeyCredential, t as applyAuthProfileConfig } from "../../provider-auth-helpers-DW8KYD7F.js";
import { t as buildOauthProviderAuthResult } from "../../provider-auth-result-wxNttZT1.js";
...
import { u as readVisibleSessionTranscriptMessageEntries } from "../../session-transcript-runtime-C9OhVQD-.js";
import { t as definePluginEntry } from "../../plugin-entry-BIDZMa3K.js";
import "../../core-wiAGUTYa.js";
import { n as resolveLivePluginConfigObject, r as resolvePluginConfigObject } from "../../plugin-config-runtime-C2UoeqsI.js";
...
import { a as withCachedMigrationConfigRuntime, n as copyMemoryMigrationFileItem, o as writeMigrationReport, r as copyMigrationFileItem, t as archiveMigrationItem } from "../../migration-runtime-BzWF47av.js";
import { n as readJsonFileWithFallback } from "../../json-store-BMxA9fKZ.js";
import { n as registerCodexCliMetadata } from "../../cli-metadata-BNHAffA-.js";
import { n as createCodexAppServerNativeCompaction, t as createCodexAppServerAgentHarness } from "../../harness-ClvhgzAf.js";
import { D as readCodexRequirementsToml, _ as CODEX_PLUGINS_MARKETPLACE_NAME, c as assertCodexAppServerConnectionSecurity, h as readCodexPluginConfig, i as resolveCodexAppServerRuntimeOptions, j as resolveOpenClawExecPolicyForCodexAppServer, n as codexSandboxPolicyForTurn, s as resolveCodexSupervisionAppServerRuntimeOptions, t as codexAppServerStartOptionsKey, x as canUseCodexModelBackedApprovalsReviewerForModel } from "../../config-DPdRNnmw.js";
import { A as createCodexDesktopGenerationService, C as withLeasedCodexAppServerClientStartSelectionRetry, Dt as isJsonObject, G as isCodexAppServerIndeterminateRequestCancellationError, X as isUnsupportedCodexAppServerVersionError, at as isCodexAppServerLiveThreadClaimed, bt as resolveCodexAppServerFallbackApiKeyCacheKey, c as getLeasedSharedCodexAppServerClient, gt as resolveCodexAppServerAuthAccountCacheKey, h as releaseLeasedSharedCodexAppServerClient, it as isCodexAppServerClientRuntimeLive, m as releaseCodexAppServerClientLease, o as clearSharedCodexAppServerClientIfCurrentAndWait, q as isCodexAppServerOverloadError, rt as hasCodexAppServerLiveThread, st as releaseCodexAppServerLiveThread, tt as consumeCodexAppServerLiveThread, v as retainSharedCodexAppServerClientByInstanceId, vt as resolveCodexAppServerAuthProfileIdForAgent, wt as CODEX_INTERACTIVE_THREAD_SOURCE_KINDS, x as retireSharedCodexAppServerClientsBeforeDesktopGeneration } from "../../shared-client-Cp-LIPgq.js";
import { i as setManagedCodexPluginRoot } from "../../managed-binary-CMUbtKyF.js";
...
import { _ as sessionBindingIdentity, l as isCodexAppServerNativeAuthProfile, r as assertCodexBindingMayBeReplaced, u as normalizeCodexAppServerBindingModelProvider } from "../../session-binding-Dpje0hJR.js";
import { a as closeCodexStartupClientBestEffort, c as isCodexAppServerUnsafeSubscriptionError, d as unsubscribeCodexThreadBestEffort, h as isCodexNotificationForTurn, o as interruptCodexTurnAndWaitBestEffort, p as getCodexAppServerTurnRouter, u as retireUnsafeCodexTurnClientBestEffort } from "../../attempt-client-cleanup-DqoQNIj5.js";
import { s as isAssistantCommentaryCompletionNotification } from "../../event-projector-usage-DQJtbAk8.js";
import { r as assertCodexThreadAcceptsDirectInput, s as assertCodexThreadStartResponse, t as CodexThreadDirectInputError } from "../../protocol-validators-CpTKO3aJ.js";
import { o as defaultCodexAppInventoryCache, r as buildCodexPluginAppCacheKey } from "../../plugin-app-cache-key-DL7WXQFm.js";
import { B as resolveCodexAppServerRequestModelSelection, Et as pluginReadParams, G as CODEX_MANAGED_THREAD_MAX_ENTRIES, K as CODEX_MANAGED_THREAD_NAMESPACE, L as buildCodexProjectDocThreadConfig, R as CODEX_NATIVE_PERSONALITY_NONE, St as ensureCodexPluginActivation, bt as mergeCodexThreadConfigs, q as createCodexManagedThreadStore, vt as buildDisabledAppsConfigPatch, wt as isOpenAiCuratedMarketplace } from "../../thread-lifecycle-CmWNcBq6.js";
import "../../incognito-session-KJUXvrtm.js";
import { a as withCodexAppServerJsonClient, i as requestCodexAppServerJson, o as resolveCodexNativeExecutionBlock, s as resolveCodexNativeSandboxBlock } from "../../request-rX38wt30.js";
import { t as resumeCodexAppServerThread } from "../../thread-resume-C91pdg-8.js";
import { a as rollbackCodexAppServerBindingSubscription, c as withExclusiveCodexAppServerThread, i as retireCodexConversationThreadBinding, n as releaseCodexAppServerBindingSubscription, r as retainCodexAppServerBindingSubscription, s as withCodexConversationThreadActivity, t as isSameCodexAppServerThreadOwner } from "../../thread-ownership-BFQpNiZ3.js";
import { d as projectBoundedCodexVisibleSessionHistory } from "../../transcript-mirror-DOc2kOvx.js";
import { t as buildCodexMediaUnderstandingProvider } from "../../media-understanding-provider-BI1GNNRc.js";
import { n as describeControlFailure, t as CODEX_CONTROL_METHODS } from "../../capabilities-CYq3Ssip.js";
import { r as formatCodexDisplayText } from "../../command-formatters-DEjV-cBi.js";
import { a as resolveCodexAppServerForModelProvider, i as resolveCodexSessionPermissionCwd, n as applyCodexSessionPermissionPolicy, t as CODEX_SESSION_PERMISSION_EXEC_MODES } from "../../session-permission-policy-w02p2pcp.js";
import { f as trackCodexConversationActiveTurn, g as canMutateCodexHost, h as CODEX_NATIVE_EXECUTION_AUTH_ERROR, t as discoverCodexMarketplacePlugins } from "../../plugin-marketplace-discovery-B2luFPMQ.js";
import { a as readCodexConversationBindingDataRecord, i as readCodexConversationBindingData, n as createCodexConversationBindingData, o as resolveCodexDefaultWorkspaceDir } from "../../conversation-binding-data-DnmF-CZM.js";
import { n as resolveCodexBindingAppServerConnection } from "../../binding-connection-Dy3n6Z4c.js";
import { a as listCodexCliSessionsOnNode, n as createCodexCliSessionNodeHostCommands, o as resolveCodexCliSessionForBindingOnNode, r as createCodexCliSessionNodeInvokePolicies, s as resumeCodexCliSessionOnNode } from "../../node-cli-sessions-Cct0Vw_b.js";
import { t as codexControlRequest } from "../../command-rpc-DuyHZSnr.js";
import { i as createCodexSessionCatalogNodeHostCommands, n as createCodexSessionCatalogNodeInvokePolicies, o as assertCodexArchiveDescendantsUnowned, r as createCodexSessionCatalogControl, t as codexSessionCatalogRuntime } from "../../session-catalog-D0z4f5l6.js";
...
function createLazyCodexAppServerBindingStore(state, managedThreadState) {
	let resolved;
	const store = () => resolved ??= import("../../session-binding-bnj4GDZl.js").then(({ createCodexAppServerBindingStore }) => createCodexAppServerBindingStore(state));
...
async function loadDefaultCodexSubcommandHandler() {
	const { handleCodexSubcommand } = await import("../../command-handlers-D8dJ8kVQ.js");
...
async function resolveConversationAppServerRuntime(params) {
	...
	const agentId = source?.agentId ?? params.agentId ?? (params.config ? resolveSessionAgentIds({
...
function codexConversationSandboxOrPermissions(runtime, sandbox) {
	...
	const config = buildCodexProjectDocThreadConfig(mergeCodexThreadConfigs(networkProxy?.configPatch, disabledApps));
	return networkProxy ? { config } : {
		sandbox,
		config
	};
}
async function writeThreadBindingFromResponse(params, resolved, response, requestOptions) {
	let retained = false;
	let sameOwner = false;
	try {
		...
		if (retained && !sameOwner || !hasCodexAppServerLiveThread(resolved.client, response.thread.id)) await rollbackCodexAppServerBindingSubscription(resolved.client, response.thread.id, retained);
		throw error;
	}
}
...
async function bindThread(params, threadId) {
	assertCodexBindingMayBeReplaced(await params.bindingStore.read(params.identity), "binding a conversation-bound Codex thread");
...
async function prepareConversationBinding(params, options = {}) {
	...
	await params.bindingStore.withLease(identity, async () => {
		...
		else await bindThread(bindingParams);
...
function createCodexNodeExecServerCommand() {
	...
	return {
		...
		handle: async (paramsJSON, io, context) => {
			...
			let unsubscribe;
			try {
				const { runCodexNodeExecServer } = await import("../../node-exec-server.runtime-CMhZLHha.js");
...
function createCodexNodeExecServerInvokePolicy() {
	return {
		...
		handle: async (context) => {
			if (!context.approvals || context.risk?.level !== "high") return {
				ok: false,
			...
			if ((await context.approvals.request({
...
const loadCodexWebSearchRuntime = createLazyRuntimeModule(() => import("../../web-search-provider.runtime-PLtOl2Rd.js"));
...
var codex_default = definePluginEntry({
	...
	register(api) {
		...
		api.on("after_compaction", async (event, ctx) => {
			...
			const { sessionBindingIdentity } = await import("../../session-binding-bnj4GDZl.js");
			const identity = sessionBindingIdentity({
				sessionId,
		...
		api.on("session_end", async (event, ctx) => {
			...
			const config = resolveCurrentConfig();
			const [{ sessionBindingIdentity }, { retireCodexAppServerSessionGeneration }] = await Promise.all([import("../../session-binding-bnj4GDZl.js"), import("../../session-retirement-YLZtN-ZX.js")]);
