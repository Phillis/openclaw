...
import { g as resolveManagedGatewayServiceCommand } from "./systemd-fY9j-7P4.js";
import { a as readEmbeddedGatewayToken } from "./service-audit-B3pvtc0O.js";
...
import { n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, v as installDaemonServiceAndEmit } from "./shared-AtIdcOsw.js";
...
async function runDaemonInstall(opts) {
	...
	const existingManagedCommand = resolveManagedGatewayServiceCommand(await service.readCommand(process.env).catch(() => null));
