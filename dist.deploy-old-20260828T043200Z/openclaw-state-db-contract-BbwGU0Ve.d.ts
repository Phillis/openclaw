...
type OpenClawStateDatabaseSchemaMigration = {
  kind: "agent-databases-composite-primary-key" | "audit-events-v2" | "commitments-retirement-v7" | "worker-placement-execution-mode-v8" | "agent-databases-relative-paths-v9" | "state-table-retirement-v10" | "state-table-retirement-v11" | "singleton-state-foldin-v12" | "state-consolidation-v13" | "operator-approvals-system-agent" | "session-watch-cursor-provenance-v4" | "strict-tables-v3";
  path: string;
};
//#endregion
