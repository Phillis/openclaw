...
import { t as addGatewayClientOptions } from "./gateway-rpc-4LDXqcsd.js";
...
import { n as resolveBrowserLazySubcommand } from "./cli-output-mode-gjNkcUO8.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-CSFm0Q_2.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [command("cookie-sync", "Sync allowlisted macOS browser cookies to a managed profile")],
		register: async (args) => {
			(await import("./browser-cli-cookie-sync-TWePe_GY.js")).registerBrowserCookieSyncCommand(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-BTOIJ6HI.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-D0CS2SJa.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-B9YQ8Ccn.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-qp2zaSg_.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-CJ4Je0NJ.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [command("extension", "Chrome extension install, status, and pairing")],
		register: async (args) => {
			(await import("./browser-cli-extension-0BU3i8_v.js")).registerBrowserExtensionCommands(args.browser, args.parentOpts, args.pluginRoot);
		}
	}
];
