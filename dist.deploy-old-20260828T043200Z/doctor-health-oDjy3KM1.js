...
async function runDoctorHealthFlow(runtime, options = {}) {
	...
	const { createDoctorPrompter } = await import("./doctor-prompter-BZ3U0QA3.js");
	...
	const { maybeOfferUpdateBeforeDoctor } = await import("./doctor-update-gvrf-K8m.js");
	...
	const { noteStartupOptimizationHints } = await import("./doctor-platform-notes-B9ZJAqQ0.js");
	await maybeRepairUiProtocolFreshness(effectiveRuntime, prompter);
	noteSourceInstallIssues(root);
	await noteStalePluginRuntimeSymlinks(root);
	noteStartupOptimizationHints();
	const { loadAndMaybeMigrateDoctorConfig } = await import("./doctor-config-flow-CZHIHOzi.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-CIe8PJMX.js");
