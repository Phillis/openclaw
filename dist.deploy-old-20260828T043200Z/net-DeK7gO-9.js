...
import { f as isLoopbackIpAddress, g as normalizeIpAddress, h as isRfc8215LocalUseNat64Ipv6Address, i as isCanonicalDottedDecimalIPv4, p as isPrivateOrLoopbackIpAddress, s as isIpInCidr } from "./ip-Bc6HA4HC.js";
...
import { n as pickPrimaryTailnetIPv4 } from "./tailnet-D4cLJASY.js";
...
function hasForwardedRequestHeaders(req) {
	...
	return Object.keys(headers).some((header) => {
		...
		return normalized === "forwarded" || normalized === "x-real-ip" || normalized.startsWith("x-forwarded-");
	});
}
