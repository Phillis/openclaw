...
import { l as isSecureWebSocketUrl } from "./net-DeK7gO-9.js";
...
import "./onboard-helpers-BkujwgEw.js";
...
import { n as buildGatewayDiscoveryTarget, t as buildGatewayDiscoveryLabel } from "./gateway-discovery-targets-BJk6YcYa.js";
...
async function promptRemoteGatewayConfig(cfg, prompter, options) {
	...
	const edgeAuth = edgeAuthOriginUrl && gatewayOriginScope(url) === gatewayOriginScope(edgeAuthOriginUrl) ? cfg.gateway?.remote?.edgeAuth : void 0;
	return {
		...cfg,
		gateway: {
			...cfg.gateway,
