...
import { ft as resolveOwnerPromptNumbers, n as getRuntimeConfig } from "./io-DlN5njvP.js";
...
import { c as resolveContextConfigProviderForRuntime } from "./openai-routing-mOc2UICM.js";
...
import { E as sessionEntryForkedFromParent, f as loadSessionEntry, w as resolveSessionStorePathForScope } from "./session-accessor.sqlite-entry-CNdoUuFZ.js";
...
import { _ as runExclusiveSessionStoreWrite, b as resolveGroupSessionKey, c as interruptSessionWorkAdmissions, p as runExclusiveSessionLifecycleMutation } from "./session-lifecycle-admission-1qqb7Ac0.js";
import { G as conversationIdentityFromMsgContext, K as conversationRouteContextFromMsgContext, gt as deriveSessionMetaPatch, lt as resolveProfileParticipantIdFromSessionCreation, st as buildSessionCreationStamp } from "./session-accessor.sqlite-entry-store-DmHR081P.js";
...
import { t as DEFAULT_RESET_TRIGGERS } from "./types-BEJRKmOU.js";
import { h as resolveMaintenanceConfigFromInput } from "./disk-budget-DJbD0obL.js";
import { I as commitReplySessionInitialization, L as loadReplySessionInitializationSnapshot, ht as getCliSessionBinding, mt as clearAllCliSessions } from "./session-accessor-B-FKZX9M.js";
import { l as resolveAgentHarnessSessionContextError } from "./agent-harness-session-key-Bf-Q9dw5.js";
import { a as hasStagedMediaFacts, s as isImageMediaFact, u as normalizeMediaFacts } from "./media-facts-Bd6apMSF.js";
import { g as registerMainSessionGroupWatch, n as classifySessionStateActor, t as acknowledgeSessionStateNotices, u as recordSessionCreated, y as decodeSessionStateNoticeContextKey } from "./session-state-events-BkuyPMaw.js";
...
import { a as isSessionWorkStartInvalidatedError, o as resolveSessionLifecycleTimestamps, r as hasTerminalMainSessionTranscriptNewerThanRegistry, s as resolveSessionWorkStartError } from "./lifecycle-DzPMUp4j.js";
...
import { n as hasResolvedThinkingCatalogEntry, o as resolveEffectiveAgentRuntime } from "./thinking-runtime-1slENmfx.js";
import { g as isWorkspaceBootstrapPending, p as ensureAgentWorkspace } from "./workspace-CYdcs93J.js";
...
import { r as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-Bs5EBLjZ.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-Ar62impf.js";
import { t as hasControlCommand } from "./command-detection-DGnhlUuH.js";
import { i as isSyntheticSourceReplyTurn, r as isInternalSourceReplyChannel, t as isDirectedSourceReplyTurn } from "./source-reply-delivery-mode-D2wHV4wY.js";
...
import { i as toInternalMessagePreprocessedContext, n as deriveInboundMessageHookContext, s as toInternalMessageTranscribedContext } from "./message-hook-mappers-B-Cf5qbE.js";
...
import { dt as appendChannelPromptContext, mt as buildInboundMediaNoteProjection, s as isReasoningTagProvider } from "./builtin-openclaw-OzMxJ-hX.js";
...
import { a as admitReplyTurn, l as resolveSilentReplySettings, n as createReplySessionEntryHandle, r as createReplyTimingTracker } from "./session-entry-handle-DUZJUUU0.js";
import { s as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-Crbaa5Bn.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, d as stageRemoteInboundMediaIfNeeded, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, p as getPreparedReplyDispatchRuntime, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as resolveSessionResetCommand } from "./typing-policy-DG4dWV39.js";
...
import { i as resolveTurnModelOverride, t as resolveSessionStableReplyMode } from "./session-stable-reply-mode-CrrbDnXa.js";
import { n as resolveRoutedDeliveryThreadId, t as isSlackDirectRoutedThreadTurn } from "./routed-delivery-thread-CqIyovBc.js";
import { D as resolveBootstrapMode } from "./media-generation-task-status-BciEsE_o.js";
...
import { a as createUserTurnTranscriptRecorder, s as resolvePersistedUserTurnText } from "./user-turn-transcript-CyFoZBC6.js";
...
import { a as resolveParentForkDecision, r as forkSessionFromParent } from "./session-fork-CJqxCAWA.js";
import { t as resolveFastModeState } from "./fast-mode-Dd78Dxbu.js";
import { M as normalizeQueueDropPolicy, N as normalizeQueueMode, a as getExistingFollowupQueue } from "./settings-Cpt08fNP.js";
import { t as recordSessionParticipantBestEffort } from "./session-participant-recording-C_ZhqhdH.js";
import { n as projectConversationToolNames } from "./conversation-tool-policy-pipeline-BITK7kk9.js";
import { u as collectTextContentBlocks } from "./embedded-agent-tool-results-Chl9xQ-j.js";
import { l as buildFullBootstrapPromptLines, u as buildLimitedBootstrapPromptLines } from "./system-prompt-params-Jl5q1r24.js";
...
import { b as updateAmbientTranscriptWatermark } from "./session-store-runtime-BNwfvw44.js";
...
import { i as runWithCronCreatorAuthorityCapability, r as createCronCreatorAuthorityCapability, s as shouldAdmitFreshChannelOwnerCronAuthority } from "./cron-creator-authority-context-hXifa_42.js";
import "./cli-session-JwnBWNOs.js";
import { o as sanitizePendingFinalDeliveryText, t as PENDING_FINAL_DELIVERY_CLEAR_PATCH } from "./pending-final-delivery-BQjvFtab.js";
import { t as resolveQueueSettings } from "./queue-CrNP_exY.js";
...
import { i as resolveActiveExplicitSteerSessionKey, n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CcgXtT1S.js";
import { a as hasSkillReferenceCandidate, i as expandExplicitSkillReferences, o as listReservedChatSlashCommandNames, r as expandBundleCommandPromptTemplate, s as resolveSkillCommandInvocation } from "./chat-commands-Dcfrq91n.js";
import { t as resolveBlockStreamingChunking } from "./block-streaming-v0Ecz2D8.js";
import { t as buildCommandContext } from "./commands-context-D7ffdvKU.js";
import { n as resolveStickyModelSelectionScope } from "./sticky-model-selection-DCTX-Xwn.js";
import { n as resolveModelRuntimeDirective } from "./directive-handling.model-runtime-DYF8pz-8.js";
import { _ as maybeHandleUnexpectedNativeDirectiveArguments, f as formatModelSelectionScopeAck, v as resolveModelSelectionFromDirective } from "./directive-handling.shared-Bo0Dp_Nm.js";
import { n as resolveSessionAuthSelection } from "./session-override-D54oq15q.js";
import { n as createModelSelectionState, r as isStaleHeartbeatAutoFallbackOverride, t as createFastTestModelSelectionState } from "./model-selection-C8hROHtt.js";
import { t as resolveContextTokens } from "./model-selection-context-3oNr6hE9.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-DWDN-dyX.js";
...
import { i as resolveActiveRunQueueAction, r as resolveTypingMode, t as resolveCurrentTurnImages } from "./current-turn-images-C6oiJLmi.js";
import { t as buildChannelSummary } from "./channel-summary-BWnFkobw.js";
import { a as resolveInboundUserContextPromptJoiner, n as buildInboundUserContextPrefix, r as formatActiveGoalContext, t as buildInboundMetaSystemPrompt } from "./inbound-meta-WvdYDMHc.js";
import { n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContextAsync } from "./tools-effective-inventory-DoXHNqUS.js";
import { n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-Cq4zHmJv.js";
import { t as PROGRESS_STATUS_PREAMBLE_FRESH_MS } from "./progress-draft-compositor-DrPt0ftL.js";
import { a as sanitizeProgressStatusText } from "./progress-draft-status-text-YRJVSpIw.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-qFybcCBn.js";
import { t as emitSessionAutoResetHook } from "./session-auto-reset-Cb1X1lJp.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-WydR0onI.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-C5zTLUw2.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-DuYAVUCX.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-DuMWIorw.js"));
const abortCutoffRuntimeLoader = createLazyImportLoader(() => import("./abort-cutoff.runtime.js"));
const commandsRuntimeLoader$1 = createLazyImportLoader(() => import("./commands.runtime-ClXbVldo.js"));
...
async function handleInlineActions(params) {
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const dependencies = params.skillToolDispatchDependencies ?? await import("./openclaw-tools-B8p3AhJF.js");
...
const commandsRuntimeLoader = createLazyImportLoader(() => import("./commands.runtime-ClXbVldo.js"));
const skillCommandsRuntimeLoader = createLazyImportLoader(() => import("./chat-commands.runtime.js"));
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-4G1D4hXk.js"));
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent.runtime-CCcvyW8q.js"));
...
async function runPreparedReply(params) {
	...
	const { acquireAgentRunPreparedModelRuntime } = await import("./prepared-model-runtime-BH9aCf3S.js");
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-CjePCZ0X.js"), { cacheRejections: true }).load;
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, 300).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-BwigPrR8.js");
