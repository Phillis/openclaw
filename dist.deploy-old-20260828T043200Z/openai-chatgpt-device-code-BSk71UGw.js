import { T as positiveSecondsToSafeMilliseconds, k as resolveExpiresAtMsFromDurationSeconds } from "./number-coercion-CLj0HTDM.js";
...
import { p as resolveOpenAICodexAccessTokenExpiry } from "./provider-auth-DI4TAoBi.js";
...
async function exchangeOpenAICodexDeviceCode(params) {
	...
	return {
		access,
		refresh,
		expires: resolveExpiresAtMsFromDurationSeconds(body?.expires_in) ?? resolveOpenAICodexAccessTokenExpiry(access) ?? Date.now()
	};
}
