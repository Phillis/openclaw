import { A as DmScope, F as ReplyToMode, P as MarkdownTableMode, R as ChatType, _ as GroupToolPolicyConfig, j as GroupScope, k as DmPolicy, l as AgentBinding, n as OpenClawConfig, r as PluginInstallRecord, t as ConfigFileSnapshot, z as FastMode } from "./types.openclaw-CZEJqSSW.js";
import { _ as StreamFn$1, m as Message, p as ImageContent, v as TextContent, x as Tool } from "./types.models-DQnz5K9u.js";
import { C as PluginManifestProviderEndpoint, N as RuntimeEnv, a as PluginManifestRegistry, d as PluginPackageInstall, f as ChannelOwnedSetupContract, g as PluginDiagnostic, i as PluginManifestRecord, l as OpenClawPackageBuild, n as ResolverContext, o as PluginDiscoveryResult, p as ChannelSetupAdapter, r as SecretDefaults, t as SecretTargetRegistryEntry, u as PluginPackageChannel, w as PluginManifestProviderRequestProvider } from "./target-registry-types-Ny7UXMrh.js";
import "./types-BL7F42yR.js";
import { i as MediaUnderstandingOutput, t as MediaUnderstandingDecision } from "./types-dbGB0D22.js";
import { a as InternalSessionEntry, dt as SessionCreatedVia, it as SessionRestartRecoveryState, lt as SessionRunStatus, mt as ApprovalScopeSchema, s as SessionEntry, st as SourceReplyDeliveryMode, t as ChannelId, ut as SessionCreatedActor } from "./channel-id.types-CSuowlIu.js";
...
//#endregion
export { ChannelMentionAdapter as $, LegacyInteractiveReply as $t, ChannelOutboundContext as A, TurnAdoptionLifecycle as At, OutboundDeliveryResult as B, HistoryMediaEntry as Bt, ChannelResolverAdapter as C, ConfigReplaceResult as Cn, OriginatingChannelType as Ct, ChannelPairingAdapter as D, PluginMetadataSnapshotOwnerMaps as Dn, GetReplyOptions as Dt, ChannelStatusAdapter as E, PluginMetadataSnapshot as En, BlockReplyContext as Et, chunkMarkdownTextWithMode as F, TranscriptTurnBoundary as Ft, resolveAgentRoute as G, LegacyMediaContextKey as Gt, OutboundPayloadDeliverySuppressionReason as H, CommandTurnKind as Ht, chunkText as I, AgentPlanStep as It, ChannelAgentPromptAdapter as J, MediaKind as Jt, LegacyConfigRule as K, MediaFact as Kt, chunkTextWithMode as L, ExecutionIdentityAdmissionFacts as Lt, OutboundDeliveryFormattingOptions as M, UserTurnTranscriptRecorder as Mt, chunkByNewline as N, TranscriptEntryAnchor as Nt, ChannelDeliveryCapabilities as O, PluginCompatCode as On, PartialReplyPayload as Ot, chunkMarkdownText as P, TranscriptTurnAdmission as Pt, ChannelLogSink as Q, ReplyPayload as Qt, resolveChunkMode as R, ExecutionIdentityAdmissionToken as Rt, ChannelResolveResult as S, resolveStateDir as Sn, MsgContext as St, ChannelSecurityAdapter as T, PluginMetadataRegistryView as Tn, SupplementalContextFacts as Tt, SecurityAuditFinding as U, InputProvenance as Ut, OutboundPayloadDeliveryOutcome as V, CommandTurnContext as Vt, buildAgentSessionKey as W, PluginHookChannelContext as Wt, ChannelAgentToolFactory as X, InboundEventKind as Xt, ChannelAgentTool as Y, mediaKindFromMime as Yt, ChannelCapabilities as Z, ReplyMediaAttachment as Zt, ChannelGatewayContext as _, AgentToolUpdateCallback as _n, OutboundMediaReadFile as _t, ChannelApprovalCapability as a, PluginApprovalRequestPayload as an, ChannelStreamingAdapter as at, ChannelLifecycleAdapter as b, StreamFn as bn, InboundSourceModality as bt, ChannelConfigAdapter as c, ExecAsk as cn, ChannelLegacyStateMigrationPlan as ct, ChannelDirectoryAdapter as d, ExecTarget as dn, ChannelMessageSendTextContext as dt, MessagePresentation as en, ChannelMessageActionAdapter as et, ChannelDoctorAdapter as f, ApprovalScope as fn, MessageReceipt as ft, ChannelGatewayAdapter as g, AgentToolResult as gn, OutboundMediaAccess as gt, ChannelElevatedAdapter as h, AgentTool as hn, OutboundSendDeps as ht, ChannelAllowlistAdapter as i, PluginApprovalRequest as in, ChannelOutboundTargetMode as it, OutboundIdentity as j, UserTurnInput as jt, ChannelOutboundAdapter as k, TaskSuggestionDeliveryMode as kt, ChannelConfiguredBindingProvider as l, ExecMode as ln, ConversationReadInvocationOrigin as lt, ChannelDoctorLegacyConfigRule as m, AgentMessage as mn, RenderedMessageBatchPlanItem as mt, ChannelSetupWizardAdapter as n, ReplyPayloadDelivery as nn, ChannelMessagingAdapter as nt, ChannelAuthAdapter as o, ExecApprovalDecision as on, ChannelThreadingAdapter as ot, ChannelDoctorConfigMutation as p, CompactionResult as pn, OutboundReplyFacts as pt, ChannelAccountSnapshot as q, PromptImageOrderEntry as qt, WizardPrompter as r, ChannelApprovalKind as rn, ChannelMeta as rt, ChannelCommandAdapter as s, ExecApprovalRequestPayload as sn, ChannelThreadingToolContext as st, ChannelSetupWizard as t, MessagePresentationAction as tn, ChannelMessageActionContext as tt, ChannelConversationBindingSupport as u, ExecSecurity as un, ChannelMessageAdapterShape as ut, ChannelGroupAdapter as v, BashExecutionMessage as vn, FinalizedMsgContext as vt, ChannelSecretsAdapter as w, ConfigWriteAfterWrite as wn, SessionTranscriptContext as wt, ChannelResolveKind as x, ToolExecutionMode as xn, MentionSource as xt, ChannelHeartbeatAdapter as y, CustomMessage as yn, FinalizedRuntimeMsgContext as yt, resolveTextChunkLimit as z, HistoryEntry as zt };