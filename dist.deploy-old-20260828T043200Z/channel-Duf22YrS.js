...
import { m as listChannelsForTeamWithPageInfo, r as normalizeMSTeamsConversationId, t as extractMSTeamsConversationMessageId, y as resolveGraphToken } from "./inbound-5byP9f5_.js";
import { a as parseMSTeamsConversationId, d as resolveMSTeamsChannelAllowlist, f as resolveMSTeamsTeamsConfig, i as normalizeMSTeamsUserInput, n as looksLikeMSTeamsTargetId, o as parseMSTeamsTeamChannelInput, p as resolveMSTeamsUserAllowlist, r as normalizeMSTeamsMessagingTarget, t as looksLikeMSTeamsConversationId } from "./resolve-allowlist-BNvqk5oA.js";
import { t as msteamsDirectoryContractPlugin } from "./directory-contract-api-DWRGmDBu.js";
import { i as resolveMSTeamsRouteConfig, n as resolveMSTeamsGroupToolPolicy, r as resolveMSTeamsReplyPolicy } from "./policy-BuF0wyio.js";
import { r as resolveMSTeamsAccount } from "./channel-config-Be-TsfQY.js";
import { i as msTeamsApprovalCapability, n as resolveMSTeamsOutboundSessionRoute, o as shouldSuppressLocalMSTeamsExecApprovalPrompt, r as isMSTeamsNativeApprovalClientEnabled, t as inferMSTeamsTargetChatType } from "./session-route-BrUG_peJ.js";
...
const loadMSTeamsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BgF4WYA4.js"), "msTeamsChannelRuntime");
...
const msteamsPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorMSTeamsProvider } = await import("./src-BTS3YWqb.js");
