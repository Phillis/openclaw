...
import { An as executeSqliteQuerySync, F as ensureGitHubPublicationSchema, Mn as getNodeSqliteKysely, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction, zt as tableExists } from "./openclaw-state-db-CeAO_dqo.js";
...
import { n as resolveManifestActivationPluginIds } from "./activation-planner-DIJbll4w.js";
...
import { _ as runExclusiveSessionStoreWrite, c as interruptSessionWorkAdmissions, d as isSessionWorkAdmissionActive, m as startSessionWorkAdmissionInterruption, p as runExclusiveSessionLifecycleMutation, t as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS } from "./session-lifecycle-admission-1qqb7Ac0.js";
import { l as emitSessionLifecycleEvent, u as onSessionIdentityMutation } from "./session-history-eviction-6hHpt56d.js";
import { m as registerSessionMaintenancePreserveKeysProvider } from "./types-BEJRKmOU.js";
import { dt as withTranscriptWriteTransaction } from "./session-accessor-B-FKZX9M.js";
...
import { H as convertToLlm } from "./agent-core-CK8RXNcu.js";
...
import { n as measureAgentRuntimeIdentityTokenBytes, r as mintAgentRuntimeIdentityToken } from "./agent-runtime-identity-token-BLnwLnqH.js";
import { t as resolveConversationCapabilityProfile } from "./conversation-capability-profile-BWn7VYWB.js";
import { t as createPreprovisionedSshSandboxBackend } from "./ssh-backend-DEoOHhAa.js";
import { t as createSandboxFsBridge } from "./fs-bridge-C7GxVqmf.js";
...
import { s as hasPendingFollowupQueueWork } from "./settings-Cpt08fNP.js";
...
import { C as mergeUsageIntoAccumulator, a as buildUsageAgentMetaFields, x as createUsageAccumulator, y as resolveReportedModelRef } from "./helpers-B90C6K_y.js";
import { l as resolveConfiguredGitHubToolIdentity } from "./github-tool-identity-C15aB8z0.js";
...
import { r as resolveGitCoauthorAttribution } from "./git-coauthor-attribution-CKvab3EN.js";
...
import { a as resolveGitHubPublicationWorktreeOwner, i as prepareGitHubPublicationAvailability, n as matchesCurrentGitHubPublicationIdentity, r as prepareCurrentGitHubPublicationIdentity, t as currentGitHubPublicationConfig } from "./github-publication-availability-8t5yYnWI.js";
...
import { o as isCurrentWorkerWorkspacePendingResultOwner, t as ActiveTurnClaimError } from "./placement-turn-claims-8UGBsWbo.js";
...
const loadPlacementSessionEvidenceRuntime = createLazyRuntimeModule(async () => {
	const [sessionTargetsReadAvailability, sessionAccessor] = await Promise.all([import("./targets-read-availability-BH6CkXuw.js"), import("./session-accessor-BwigPrR8.js")]);
	return {
...
const loadWorkerPlacementSessionRuntimeModule = createLazyRuntimeModule(async () => {
	const [placementSessionRuntime, { managedWorktrees }, sessionUtils] = await Promise.all([
		import("./placement-session-runtime-BL4aVWMn.js"),
		import("./service-BRv7gOhe.js"),
