...
import { d as onSessionLifecycleEvent } from "./session-history-eviction-6hHpt56d.js";
import { r as onInternalSessionTranscriptUpdate } from "./transcript-events-Ce7n2r8A.js";
import { P as isSessionTranscriptProjectionUnavailableError, l as readSessionTranscriptBoundedMessageTailPage } from "./session-accessor-B-FKZX9M.js";
...
import { n as stripToolMessages, t as extractStoredAssistantText } from "./chat-history-text-CRd84wDl.js";
...
import { c as removeChatAbortControllerEntry, p as markChatAbortTerminalPersistenceError } from "./chat-abort-BpfXA9KF.js";
import { i as terminalHealthFor, n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-Cq4zHmJv.js";
...
import { a as defaultPersistDigest, c as markSessionObserverRunSuperseded, d as rememberSessionObserverDormantRun, f as rememberSessionObserverRevisionFloor, i as defaultCompleteModel, l as normalizeSessionObserverModelOutput, m as synthesizeSessionObserverTerminalDigest, n as buildSessionObserverPrompt, o as defaultPrepareModel, p as sessionObserverScopeKey, r as createDormantSessionObserverRun, s as defaultReadSession, t as SESSION_OBSERVER_SYSTEM_PROMPT, u as rememberSessionObserverDisabledRun } from "./session-observer-model-DwZiS-9d.js";
import { r as resolveTaskRequesterSessionTarget, t as mapTaskSummary } from "./task-summary-Cdf2Lrj1.js";
import { n as createSessionCompanionAskRuntime } from "./session-companion-ask-CJLOhVHI.js";
...
function startGatewayEventSubscriptions(params) {
	...
	const agentEventHandlerLoader = createLazyPromiseLoader(() => {
		return Promise.all([import("./server-chat-BshvIKab.js"), import("./server-session-key-BcrwbAfs.js")]).then(([{ createAgentEventHandler }, { resolveSessionKeyForRun }]) => createAgentEventHandler({
	...
	const getSessionEventsModule = createLazyPromise(() => import("./server-session-events-CuXQR75M.js"), { cacheRejections: true });
	...
	const taskObserverRuntimePromise = import("./task-registry.store-CCwCrF_P.js").then((module) => {
