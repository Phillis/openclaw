...
import { N as normalizeExecutableToken, d as resolveShellWrapperTransportArgv, l as isShellWrapperExecutable, t as POSIX_PARSEABLE_SHELL_WRAPPERS } from "./shell-wrapper-resolution-BddNi41x.js";
import { t as markToolDecisionRecorded } from "./agent-tools.before-tool-call.decision-brX8VCIr.js";
import { t as callGatewayTool } from "./gateway-aj3xYAQy.js";
import { t as isApprovalNotFoundError } from "./approval-errors-Bzw_-cAg.js";
import { n as DEFAULT_APPROVAL_TIMEOUT_MS, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS } from "./bash-tools.exec-runtime-CtHTfHJ7.js";
...
async function buildHostApprovalDecisionParams(params) {
	...
	return {
		...
		toolCallId: params.toolCallId,
		requireDeliveryRoute: params.requireDeliveryRoute,
		suppressDelivery: params.suppressDelivery === true || params.trigger === "cron" && params.host !== "gateway" ? true : void 0,
		deliverToApprovalClientsOnly: params.trigger === "cron" && params.host === "gateway" ? true : void 0,
		approvalReviewerDeviceIds: params.approvalReviewerDeviceIds,
