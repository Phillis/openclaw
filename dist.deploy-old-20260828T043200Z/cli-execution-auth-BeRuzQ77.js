...
function resolveCliExecutionAuthProfileId(params) {
	...
	if (selectedAuthProfileId && nativeAuthProfileIds?.includes(selectedAuthProfileId)) return;
	...
	if (cliProfileId) return nativeAuthProfileIds?.includes(cliProfileId) ? void 0 : cliProfileId;
