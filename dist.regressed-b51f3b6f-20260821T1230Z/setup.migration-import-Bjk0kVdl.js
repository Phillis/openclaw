...
import { i as closeOpenClawStateDatabaseByPath } from "./openclaw-state-db-DlCMR4eQ.js";
import { i as listAvailableManifestContractPlugins, o as loadManifestContractSnapshot } from "./manifest-contract-eligibility-D6JF4H4-.js";
import { g as openOpenClawAgentDatabase, l as disposeOpenClawAgentDatabaseByPath } from "./openclaw-agent-db-lxLIE6rA.js";
import { T as unregisterOpenClawAgentDatabase, w as registerOpenClawAgentDatabase } from "./openclaw-agent-db-maintenance-B1somIwL.js";
import { n as clearRuntimeAuthProfileStoreSnapshot } from "./store-BfXdFfLh.js";
import { r as resolveOnboardingAgentTarget, t as applyOnboardingPrimaryModel } from "./onboard-agent-target-CMWQlqye.js";
...
const loadAuthChoiceModule = createLazyRuntimeModule(() => import("./auth-choice-foyMI1yy.js"));
const loadModelPickerModule = createLazyRuntimeModule(() => import("./model-picker-DR6kvd5u.js"));
async function resolveAuthChoiceModelSelectionPolicy(params) {
	...
	const [{ resolveManifestProviderAuthChoice }, { resolvePluginSetupProviderCore }] = await Promise.all([import("./provider-auth-choices-DYNUuHVD.js"), import("./setup-registry-BwD_0gLt.js")]);
...
async function runSetupModelAuthStep(params) {
	...
	if (authChoiceFromPrompt) {
		const [{ ensureAuthProfileStore }, { promptAuthChoiceGrouped: promptAuthChoice, isKeepCurrentAuthChoice: isKeepCurrentChoice }, { detectAvailableSetupProviderIds }] = await Promise.all([
			...
			import("./provider-setup-availability-Lka6Ewhn.js")
		]);
	...
	while (true) {
		...
		if (authChoice === "custom-api-key") {
			const { promptCustomApiConfig } = await import("./onboard-custom-D9st6wCW.js");
...
async function createPromotionConfigRuntime(config) {
	const { mutateConfigFile } = await import("./mutate-WSqmQ4js.js");
...
const loadMigrationProviderRuntimeModule = createLazyRuntimeModule(() => import("./migration-provider-runtime-o4tZIsrq.js"));
const loadMigrationContextModule = createLazyRuntimeModule(() => import("./context-7a0rKInG.js"));
...
async function runSetupMigrationImport(params) {
	const [{ applyLocalSetupWorkspaceConfig, applySkipBootstrapConfig }, { createMigrationLogger, buildMigrationReportDir }, { assertApplySucceeded, assertConflictFreePlan, formatMigrationPreview, formatMigrationResult }, { resolveStateDir }, onboardHelpers] = await Promise.all([
		...
		loadConfigPathsModule(),
		import("./onboard-helpers-B2IyzQ1N.js")
	]);
