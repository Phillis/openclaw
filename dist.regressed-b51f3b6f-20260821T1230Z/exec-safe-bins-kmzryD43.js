...
import { i as listAgentEntriesWithSource } from "./agent-scope-config-BdXMWufB.js";
import { n as isTrustedSafeBinPath, o as listRiskyConfiguredSafeBins, s as normalizeSafeBinName, t as getTrustedSafeBinDirs } from "./exec-safe-bin-trust-B5GpYcAk.js";
import { l as resolveCommandResolutionFromArgv } from "./exec-command-resolution-B9td7pT8.js";
...
function maybeRepairExecSafeBinProfiles(cfg) {
	...
	for (const scope of collectExecSafeBinScopes(next)) {
		...
		const profileHolder = asNullableRecord(scope.exec.safeBinProfiles) ?? (scope.exec.safeBinProfiles = {});
