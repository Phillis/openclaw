...
import { f as setGatewaySigusr1RestartPolicy, l as resolveGatewayRestartDeferralTimeoutMs, r as deferGatewayRestartUntilIdle } from "./restart-C1WD2IDG.js";
...
import { d as rejectPendingPreparedModelRuntimeReplacement, s as markPreparedModelRuntimeSnapshotsStale, u as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-WYGCGgEu.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { i as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-DXrBgfJx.js";
import { d as getActiveEmbeddedRunCount } from "./run-state-BxqT1sw2.js";
import { i as refreshContextWindowCache } from "./context-CNweD5GV.js";
...
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-CFdHrhXp.js";
...
import { t as buildGatewayCronService } from "./server-cron-DkA3qc3M.js";
...
import { i as startGatewayCronWithLogging } from "./server-runtime-services-BKzHkxyG.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-3kvPgEyy.js";
import { r as publishRuntimeSecretsStateTransition } from "./server-startup-config-DWZfKana.js";
...
async function activateSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, options) {
	const runtime = await import("./runtime-Dtf9kmyc.js");
...
async function restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, options) {
	if (!(await import("./runtime-Dtf9kmyc.js")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, { runtimeSourceConfig: options?.runtimeSourceConfig })) return false;
	options?.onActivated?.();
	return true;
}
