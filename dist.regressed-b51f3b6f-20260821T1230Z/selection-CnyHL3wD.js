...
import { i as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-d6PeqVdc.js";
import { t as resolveAgentHarnessAutoSelectionHint } from "./auto-selection-Br-mlD8Y.js";
import { c as compareHarnessSupport, l as resolveAgentHarnessPreparedAuthSupport, s as buildAgentHarnessSupportContext, u as resolveAgentHarnessPreparedRouteSupport } from "./thinking-runtime-B4nRkQcs.js";
...
import { n as isBuiltInOpenClawAgentHarness, t as createOpenClawAgentHarness } from "./builtin-openclaw-D0Q1zhXV.js";
...
import { i as EmptySettledTurnFinalizationError, t as assertSettledTurnFinalizationResult } from "./settled-turn-finalization-result-Ytw0EfkW.js";
...
async function runSelectedAgentHarnessAttempt(params) {
	...
	if (internalParams.systemAgentTool && !isSystemAgentOnlyAllowlist(internalParams.toolsAllow)) throw new Error("OpenClaw host authority requires toolsAllow: [\"openclaw\"]");
	const ringZeroTools = internalParams.systemAgentTool ? [(await import("./system-agent-tool-BziIOELE.js")).createSystemAgentTool(internalParams.systemAgentTool)] : [];
