...
import { E as readSessionEntryRow, N as writeSessionEntry, k as readSessionIdentitySnapshot } from "./targets-DxP0vsft.js";
import { t as collectSessionEntryLookupKeys } from "./store-entry-iif-1PcC.js";
import { n as parseSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { a as normalizeSqliteSessionKey, f as runExclusiveSqliteSessionWrite, i as getSessionKysely, p as toDatabaseOptions, r as formatSqliteSessionReferenceForScope, s as resolveSqliteScope } from "./session-accessor.sqlite-scope-kI2NyJDH.js";
import { x as scanSessionTranscriptTree } from "./session-transcript-index-Bfc_6ADm.js";
import { p as emitCommittedSessionIdentityDiff } from "./session-accessor.sqlite-lifecycle-Cv8qGX3X.js";
import { n as appendTranscriptEventsInTransaction, o as readTranscriptIdentityByEventId, p as createSessionTranscriptHeader, x as loadTranscriptEventsSync } from "./session-accessor.sqlite-transcript-store-E-m-_aAq.js";
import { C as readFileRangeAsync, x as streamSessionTranscriptLines } from "./session-accessor.sqlite-canonical-repair-DPsLdhK1.js";
import "./restart-recovery-state-BoowPFT5.js";
import { a as migrateSessionEntries } from "./session-manager-codec-CzrVxg5c.js";
