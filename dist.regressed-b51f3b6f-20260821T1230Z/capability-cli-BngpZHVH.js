...
import { a as listAgentIds, g as resolveSystemAgentTargetAgentId, l as resolveAgentDir, p as resolveDefaultAgentId } from "./agent-scope-config-BdXMWufB.js";
...
import { i as assertProviderBinaryResponseContent, n as assertOkOrThrowHttpError } from "./provider-http-errors-BH2HGv8j.js";
...
import { _ as randomIdempotencyKey, s as callGateway } from "./call-D4XcT41c.js";
...
import { b as updateAuthProfileStoreWithLock, d as loadAuthProfileStoreForRuntime } from "./store-BfXdFfLh.js";
...
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-Adc4uFq_.js";
import { n as normalizeSpeechProviderId } from "./provider-registry-core-DL1pv3pg.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-CiMcVFmr.js";
import { _ as resolveTtsPrefsPath, h as resolveTtsConfig, l as listTtsPersonas, o as getTtsPersona } from "./tts-settings-oG9oyjFI.js";
...
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-Bzkgig4S.js";
import { r as listRegisteredMemoryEmbeddingProviderAdapters } from "./memory-embedding-provider-runtime-Cquw8bki.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BJ-rB8yM.js";
import { t as buildExplicitSessionIdSessionKey } from "./session-ZkoOjfGu.js";
import { t as runWithImageModelFallback } from "./model-fallback-image-D0AzITBf.js";
import { o as fetchWithTimeoutGuarded, p as resolveProviderHttpRequestConfig } from "./shared-BEAvjECH.js";
import { c as buildMediaUnderstandingRegistry } from "./defaults.constants-BTkiooBF.js";
import { h as getTtsCommandSecretTargetIds, i as getCapabilityWebFetchCommandSecretTargets, l as getMemoryEmbeddingCommandSecretTargetIds, o as getCapabilityWebSearchCommandSecretTargets, u as getModelsCommandSecretTargetIds } from "./command-secret-targets-BoGsPJpC.js";
import { _ as setTtsProvider, g as setTtsPersona, l as listSpeechVoices, m as setTtsEnabled, s as resolveExplicitTtsOverrides, t as getTtsProvider } from "./runtime-api-Cer8lA4l.js";
import { n as textToSpeech } from "./tts-6U7zcHmD.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BQml8t3O.js";
import { i as listWebSearchProviders, n as isWebSearchProviderConfigured, o as runWebSearch } from "./runtime-CkaBr6Zj.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-Ccm4D6NF.js";
import { r as inspectLocalAudioSelection } from "./local-audio-sn4mvYpW.js";
import { i as resolveWebFetchDefinition, n as isWebFetchProviderConfigured, r as listWebFetchProviders } from "./runtime-BxoMItU4.js";
...
import { c as transcribeAudioFile, i as describeVideoFile, o as prepareImageDescriptionInput, r as describePreparedImageWithModel, t as describeImageFile } from "./runtime-BeIMnfXD.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-CQvOoHHp.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-CJ2ASpTh.js";
import { r as createEmbeddingProvider } from "./memory-core-bundled-runtime--7MS93Y-.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-Cu2caKzI.js");
...
function registerModelCapabilityCommands(capability) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-DoejRfhz.js");
