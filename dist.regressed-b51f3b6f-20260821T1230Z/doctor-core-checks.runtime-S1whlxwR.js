...
import { a as listAgentIds, d as resolveAgentWorkspaceDir, l as resolveAgentDir, r as listAgentEntries, x as tryResolveSoleAgentId } from "./agent-scope-config-BdXMWufB.js";
import { g as normalizeToolPolicyName, i as collectExplicitAllowlist } from "./tool-policy-CWmnHLY1.js";
...
import { o as buildGatewayProbeConnectionDetails } from "./call-D4XcT41c.js";
...
import { r as resolveEffectiveToolPolicy } from "./agent-tools.policy-BjBsVONt.js";
import { i as getPluginToolMeta, o as setPluginToolMeta } from "./tools-cCwmXcan.js";
...
import { a as shouldCreateBundleMcpRuntimeForAttempt } from "./attempt-tool-construction-plan-D_uFFO7I.js";
...
import { n as formatLocalAudioSelection, r as inspectLocalAudioSelection } from "./local-audio-sn4mvYpW.js";
...
import { l as gatewayProbeResultSawGateway, r as GATEWAY_HEALTH_RATE_LIMITED_MESSAGE, u as gatewayProbeResultWasRateLimited } from "./gateway-health-auth-diagnostic-BO2Wc3Dv.js";
...
function detectUnavailableSkills(cfg, workspaceDir) {
	return collectUnavailableAgentSkills(buildWorkspaceSkillStatus(workspaceDir, {
		config: cfg,
...
async function collectGatewayHealthFindings(ctx) {
	...
	if (gatewayProbeResultWasRateLimited(probe)) return [{
		checkId: "core/doctor/gateway-health",
		severity: "warning",
...
async function collectProviderCatalogProjectionFindings(cfg, workspaceDir) {
	const { runProviderStaticCatalog } = await import("./provider-discovery-CFgbKh0w.js");
