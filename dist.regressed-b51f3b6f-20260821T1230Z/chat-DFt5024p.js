...
import { E as loadGatewaySessionEntryReadOnly, T as loadGatewaySessionEntry, v as resolveCurrentUserProfileDisplay, w as listAgentsForGateway } from "./session-utils-row-CJRrMBuq.js";
import { n as tryResolveSessionCompatibilityOwnerAgentId } from "./session-request-agent-BeVvXvOY.js";
import { i as buildGatewaySessionInfo } from "./session-utils-list-9Nb5BMah.js";
...
import { n as resolveChatHistoryWithCliSessionImports } from "./cli-session-history-DM0K7Jmq.js";
...
import { r as resolveGatewayChatCronCreatorAuthorityAdmission, t as createAgentTurnService } from "./agent-turn-service-DPgTQiis.js";
import { i as resolveVisibleActiveSessionRunState } from "./session-active-runs-DKnYoEyq.js";
import { P as normalizeOptionalChatText, s as appendAssistantTranscriptMessage, w as scheduleChatHistoryManagedMediaCleanup } from "./chat-abort-runtime-CpyQgKpt.js";
import { t as assertValidParams } from "./validation-CsGeElrb.js";
import { i as validateChatSelectedAgent, o as resolveGlobalAwareNodeChatDeliveryKeys, r as resolveRequestedChatAgentId, s as sendGlobalAwareNodeChatPayload, t as handleChatSend } from "./chat-send-handler-BuHdpzSF.js";
import { a as prepareSessionWorkspaceIcon } from "./workspace-icon-http-nh_MtOwh.js";
import { t as resolveAgentIdOrRespondError } from "./agent-id-shared-uNTkOYt3.js";
import { i as resolveSessionHistoryTailReadOptions } from "./session-history-state-CkuleJcK.js";
...
const chatHandlers = {
	...
	"chat.toolTitles": async ({ params, respond, context }) => {
		...
		const { generateToolCallTitles } = await import("./chat-tool-titles-Gl7iQKXu.js");
