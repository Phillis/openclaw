...
import { _ as saveDelegatedTokens, g as resolveMSTeamsCredentials, m as hasConfiguredMSTeamsCredentials } from "./graph-users-Be2H6G8X.js";
import { d as resolveMSTeamsChannelAllowlist, p as resolveMSTeamsUserAllowlist, s as parseMSTeamsTeamEntry } from "./resolve-allowlist-Cmq0GTae.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				let oauthModule;
				try {
					oauthModule = await import("./oauth-UL_l5Dno.js");
				} catch (err) {
