...
import { i as isApprovalMethod } from "./method-scopes-DRTuNy7j.js";
...
import { t as classifyApprovalRequestChannelRoute } from "./approval-request-account-binding-DaAFUqxc.js";
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-B8VG9B7u.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = (gatewayRuntime?.routeCoordinator.createReporter ?? createApprovalNativeRouteReporter)({
		...
		requestGateway: async (method, params) => {
			...
			const { callGatewayLeastPrivilege } = await import("./call-DrX49UA-.js");
