...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-UUh1etbS.js";
import { D as parseBrowserErrorPayload, X as withTimeout } from "./tmp-openclaw-dir-DEhTWXIG.js";
import "./control-auth-BPAeQxJp.js";
import "./chrome-C03Trt69.js";
import "./trash-BKDrzQ8d.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-C2rqVjpc.js";
import "./sdk-setup-tools-oeKFNkNS.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-BHFmz3Y-.js";
import "./routes-qhnSVLah.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-sbXKOBe5.js";
import { s as stopBrowserBridgeRuntime, t as createBrowserControlContext } from "./browser-control-state-C6fSVOZ3.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-Dm9DVDrL.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-CstxLQ3W.js"), import("./routes-DwQhNS4Q.js")]);
