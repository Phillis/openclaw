...
import { a as resolveCliBackendLiveSessionRequirement, i as resolveCliBackendConfig } from "./cli-backends-CwAHe8lo.js";
import { t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-d6PeqVdc.js";
import { t as loadAgentRuntimePluginRegistryHandle } from "./runtime-plugins-BHwS2xx_.js";
import { d as normalizeAuthProfileCredential } from "./profiles-DNBe9hAz.js";
...
import { a as resolveSystemAgentVerifiedInferenceRoute, n as createSystemAgentVerifiedInferenceBinding, r as hasCurrentSystemAgentOwnerPluginArtifacts, t as captureSystemAgentOwnerPluginArtifacts } from "./verified-inference-ByFu4AcK.js";
import { t as CliExecutionAuthProfileError } from "./cli-execution-auth-B9B7hwHV.js";
import { i as sameDefaultInferenceRoute, n as projectInferenceRoute, r as resolveSystemAgentConfiguredRouteFromConfig } from "./inference-route-DG8GbPrH.js";
...
import { i as createSystemAgentModelSelectionUpdater, r as createQuickstartNotePrompter, t as applySystemAgentModelSelection } from "./setup-apply-Bf0iCETD.js";
...
import { a as runProviderPluginAuthMethodUnpersisted, n as applyProviderPluginAuthMethodResultConfig } from "./provider-auth-choice-D-xjwtEF.js";
...
async function reloadCodexRegistryAfterActivation(params) {
	...
	try {
		(params.deps.ensurePluginRegistryLoaded ?? (await import("./runtime-registry-loader-By5yeK5l.js")).ensurePluginRegistryLoaded)({
			scope: "all",
...
async function runSetupInferenceTest(params) {
	...
	try {
		...
		let result;
		if (plan.runner === "cli") result = await (deps.runCliAgent ?? (await import("./cli-runner-ODsPxryM.js")).runCliAgent)({
		...
		else result = await (deps.runEmbeddedAgent ?? (await import("./embedded-agent-DPCuWBmW.js")).runEmbeddedAgent)({
			preparedRunAdmission,
			sessionId,
			sessionKey,
			sessionManager,
