import { c as normalizeOptionalLowercaseString, l as normalizeOptionalString, o as normalizeLowercaseStringOrEmpty, p as normalizeStringifiedOptionalString, r as lowercasePreservingWhitespace } from "./string-coerce-CIXf7egm.js";
...
import { d as resolveAgentWorkspaceDir, p as resolveDefaultAgentId, r as listAgentEntries } from "./agent-scope-config-BdXMWufB.js";
...
function resolveMemoryDreamingPluginId(cfg) {
	const configuredSlot = normalizeOptionalString(asNullableRecord(asNullableRecord(asNullableRecord(cfg)?.plugins)?.slots)?.memory);
