...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-BiPnM-6w.js";
...
import { t as describeImageFile } from "./runtime-BeIMnfXD.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BtoaBQ43.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-Bv7nS7FJ.js");
