...
import { i as resolveMatrixAuthContext, r as resolveMatrixAuth } from "./create-client-BsrnJ0Vu.js";
...
const loadMatrixCreateClientDeps = createLazyRuntimeModule(() => import("./create-client-DoxmjRji.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient })));
