...
import { g as createPluginGatewayMethodDescriptors, h as createGatewayMethodRegistry, m as createGatewayMethodDescriptorsFromHandlers } from "./loader-lwogLCXu.js";
...
import { f as resolveSessionMutationAuthorization, t as SessionMutationAuthorizationChangedError } from "./session-sharing-_cS5K0AT.js";
...
const CORE_GATEWAY_HANDLER_MODULES = {
	agent: () => import("./agent-CqC_okpb.js").then((module) => module.agentHandlers),
	"agent-identity": () => import("./agent-identity-CY44xJjN.js").then((module) => module.agentIdentityHandlers),
	agents: () => import("./agents-50H_nE-K.js").then((module) => module.agentsHandlers),
	"agents-workspace": () => import("./agents-workspace-C8gYaPIS.js").then((module) => module.agentsWorkspaceHandlers),
	artifacts: () => import("./artifacts-BusGjW_I.js").then((module) => module.artifactsHandlers),
	board: () => import("./board-DliFqRZj.js").then((module) => module.boardHandlers),
	...
	attach: () => import("./attach-DrMR7xDN.js").then((module) => module.attachHandlers),
	...
	chat: () => import("./chat-BVJnVBRU.js").then((module) => module.chatHandlers),
	commands: () => import("./commands-BQ2dI384.js").then((module) => module.commandsHandlers),
	config: () => import("./config-D90_AYfF.js").then((module) => module.configHandlers),
	conversations: () => import("./conversations-mvYnJeW7.js").then((module) => module.conversationHandlers),
	connect: () => import("./connect-DQkIlbDI.js").then((module) => module.connectHandlers),
	"control-ui": () => import("./control-ui-DXsAN3MU.js").then((module) => module.controlUiHandlers),
	cron: () => import("./cron-B1av9sLs.js").then((module) => module.cronHandlers),
	...
	doctor: () => import("./doctor-D0We79rN.js").then((module) => module.doctorHandlers),
	...
	health: () => import("./health-BH5A9aAO.js").then((module) => module.healthHandlers),
	logs: () => import("./logs-BV6PkS5O.js").then((module) => module.logsHandlers),
	"memory-search": () => import("./memory-search-CKN3PTDm.js").then((module) => module.memorySearchHandlers),
	terminal: () => import("./terminal-CnKvDs5K.js").then((module) => module.terminalHandlers),
	"ui-command": () => import("./ui-command-BHR4RYi3.js").then((module) => module.uiCommandHandlers),
	"models-auth-status": () => import("./models-auth-status-BCNKQHKi.js").then((module) => module.modelsAuthStatusHandlers),
	models: () => import("./models-CwGbsUVm.js").then((module) => module.modelsHandlers),
	"models-probe": () => import("./models-probe-CgDhszaW.js").then((module) => module.modelsProbeHandlers),
	"native-hook-relay": () => import("./native-hook-relay-Bylih5Jr.js").then((module) => module.nativeHookRelayHandlers),
	"nodes-pending": () => import("./nodes.pending-work-oKcCEHGK.js").then((module) => module.nodePendingWorkHandlers),
	nodes: () => import("./nodes-CL6yICg-.js").then((module) => module.nodeHandlers),
	"plugin-host-hooks": () => import("./plugin-host-hooks-Dz4r6eE6.js").then((module) => module.pluginHostHookHandlers),
	plugins: () => import("./plugins-DtqJ3cSs.js").then((module) => module.pluginsHandlers),
	projects: () => import("./projects-CX-w1_Ir.js").then((module) => module.projectsHandlers),
	portals: () => import("./portals-BxZtO403.js").then((module) => module.portalHandlers),
	migrations: () => import("./migrations-DM31hy3u.js").then((module) => module.migrationsHandlers),
	push: () => import("./push-CUzRsnw8.js").then((module) => module.pushHandlers),
	restart: () => import("./restart-DDaWCu2Z.js").then((module) => module.restartHandlers),
	suspend: () => import("./suspend-DkNLRpvM.js").then((module) => module.suspendHandlers),
	send: () => import("./send-B75IXDU8.js").then((module) => module.sendHandlers),
	"sessions-files": () => import("./sessions-files-CG76OPFD.js").then((module) => module.sessionsFilesHandlers),
	"sessions-diff": () => import("./sessions-diff-CrNx_3Fq.js").then((module) => module.sessionsDiffHandlers),
	"sessions-abort": () => import("./sessions-abort-BM9SOeqp.js").then((module) => module.sessionAbortHandlers),
	"sessions-compact": () => import("./sessions-compact-B9j7XxsQ.js").then((module) => module.sessionCompactHandlers),
	"sessions-compaction-checkpoints": () => import("./sessions-compaction-checkpoints-DW0WPqa-.js").then((module) => module.sessionCheckpointHandlers),
	"sessions-compaction-queries": () => import("./sessions-compaction-queries-CHiYArlO.js").then((module) => module.sessionCheckpointQueryHandlers),
	"sessions-create": () => import("./sessions-create-Bg3Wwhai.js").then((module) => module.sessionCreateHandlers),
	"sessions-recover": () => import("./sessions-recover-3CgE-n64.js").then((module) => module.sessionRecoverHandlers),
	"sessions-delete": () => import("./sessions-delete-Ca7peHen.js").then((module) => module.sessionDeleteHandlers),
	"sessions-dispatch": () => import("./sessions-dispatch-sUk6_HOj.js").then((module) => module.sessionDispatchHandlers),
	"sessions-groups": () => import("./sessions-groups-BeITFTE8.js").then((module) => module.sessionGroupHandlers),
	"sessions-messaging": () => import("./sessions-messaging-E_xt1jOM.js").then((module) => module.sessionMessagingHandlers),
	"sessions-mutations": () => import("./sessions-mutations-5SDOmFra.js").then((module) => module.sessionMutationHandlers),
	"sessions-read": () => import("./sessions-read-ChvsvB9M.js").then((module) => module.sessionReadHandlers),
	"sessions-rewind": () => import("./sessions-rewind-BCIo6RFn.js").then((module) => module.sessionRewindHandlers),
	"sessions-sharing": () => import("./sessions-sharing-DCMBTGFe.js").then((module) => module.sessionSharingHandlers),
	"sessions-subscriptions": () => import("./sessions-subscriptions-Bf0sQgiO.js").then((module) => module.sessionSubscriptionHandlers),
	"sessions-suggestions": () => import("./sessions-suggestions-DUQuf7Bc.js").then((module) => module.sessionSuggestionHandlers),
	"session-catalog": () => import("./session-catalog-CjsxM1TT.js").then((module) => module.sessionCatalogHandlers),
	"session-discussion": () => import("./session-discussion-B_IAeQeK.js").then((module) => module.sessionDiscussionHandlers),
	"session-observer-rpc": () => import("./session-observer-rpc-Bxaf2ZP4.js").then((module) => module.sessionObserverHandlers),
	"session-companion-rpc": () => import("./session-companion-rpc-Cy03viRq.js").then((module) => module.sessionCompanionHandlers),
	"hooks-status": () => import("./hooks-status-DV3wT_SY.js").then((module) => module.hooksStatusHandlers),
	skills: () => import("./skills-BuzZuN_s.js").then((module) => module.skillsHandlers),
	system: () => import("./system-O2eiP8qJ.js").then((module) => module.systemHandlers),
	talk: () => import("./talk-kUhlyiIg.js").then((module) => module.talkHandlers),
	tasks: () => import("./tasks-DYZfEctp.js").then((module) => module.tasksHandlers),
	"task-suggestions": () => import("./task-suggestions-CcDImA6-.js").then((module) => module.taskSuggestionsHandlers),
	"tools-catalog": () => import("./tools-catalog-CK04OVcB.js").then((module) => module.toolsCatalogHandlers),
	"tools-effective": () => import("./tools-effective-Ccyfj-tS.js").then((module) => module.toolsEffectiveHandlers),
	"tools-invoke": () => import("./tools-invoke-CQcz5Ypp.js").then((module) => module.toolsInvokeHandlers),
	"mcp-app": () => import("./mcp-app-C7r45ZmW.js").then((module) => module.mcpAppHandlers),
	tts: () => import("./tts-CEI24iKc.js").then((module) => module.ttsHandlers),
	update: () => import("./update-C0H-fRd7.js").then((module) => module.updateHandlers),
	usage: () => import("./usage-BDeYnzkx.js").then((module) => module.usageHandlers),
	...
	"system-agent": () => import("./system-agent-Cvt2WiFG.js").then((module) => module.systemAgentHandlers),
	"system-changes": () => import("./system-changes-GbDi9zJY.js").then((module) => module.systemChangesHandlers),
	wizard: () => import("./wizard-BR7-WIn9.js").then((module) => module.wizardHandlers)
};
