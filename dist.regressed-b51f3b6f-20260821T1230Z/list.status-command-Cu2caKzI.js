...
import { c as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-BizOtGGz.js";
...
import { n as installTemporaryCurrentPluginMetadataSnapshot, t as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-DwABKB-T.js";
import { s as normalizeProviderId } from "./model-ref-shared-poyRjWh_.js";
import { E as parseModelPolicyWildcardRef, _ as resolveConfiguredModelRef, b as resolveModelRefFromString, d as modelCatalogLogicalKey, g as resolveConfiguredModelPolicyAllow, i as buildModelAliasIndex } from "./model-selection-shared-BSy9FczT.js";
import { n as OPENAI_PROVIDER_ID } from "./openai-routing-BGuHAkXI.js";
...
import { c as shouldEnableShellEnvFallback, n as getShellEnvAppliedKeys } from "./shell-env-hxMHzmqv.js";
...
import { c as isNonSecretApiKeyMarker, g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, l as isOAuthApiKeyMarker } from "./model-auth-markers-B67UeNMn.js";
import { A as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-DLDa-mVy.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, c as getRuntimeAuthProfileStoreSnapshot, r as ensureAuthProfileStore } from "./store-BfXdFfLh.js";
...
import { s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-d6PeqVdc.js";
import { n as resolveAgentHarnessOwnerPluginIds } from "./runtime-plugin-load-plan-DViSJH2y.js";
import { o as loadPreparedModelCatalogSnapshot } from "./prepared-model-catalog-BcJkNkF9.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-C5SvE-Ih.js";
import "./profiles-DNBe9hAz.js";
import { r as getCustomProviderApiKey, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-Dg58X7Zu.js";
import { t as createModelAuthAvailabilityResolver } from "./model-auth-availability-wtnpLK6-.js";
...
import { n as resolveAgentHarnessRuntimeAvailability } from "./runtime-plugin-lSbMQSv7.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-BIpiPL3j.js";
import { n as resolveUtilityModelRefForAgent, t as readUtilityModelSetting } from "./utility-model-B-61PZ5i.js";
import { a as resolveKnownAgentId, d as ensureFlagCompatibility, m as isRich } from "./shared-LTsvgBex.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CAyNyL2w.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-DnPa438K.js"));
...
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-Dq6CXsdg.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	const resolveCodexRuntimeAvailability = (provider) => {
		...
		const pending = (async () => {
			const { runPluginPayloadSmokeCheckForManifestRecords } = await import("./plugin-payload-validation-Bl9SZd-8.js");
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-DrqW6l0V.js");
			runtime.log("");
