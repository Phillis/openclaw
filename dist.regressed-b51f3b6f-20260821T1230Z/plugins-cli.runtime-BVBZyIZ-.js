...
const loadPluginsStatus = createModuleLoader(() => import("./status-BF5ZNtDQ.js"));
const loadPluginSlotSelection = createModuleLoader(() => import("./slot-selection-J9-An3G4.js"));
...
async function runPluginMarketplaceRefreshCommand(opts) {
	...
	const { clearManagedPluginOfficialCatalogCache } = await import("./management-service-jBGRJh6-.js");
