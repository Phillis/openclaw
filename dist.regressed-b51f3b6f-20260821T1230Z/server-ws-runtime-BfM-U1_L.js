...
import { a as incrementPresenceVersion, r as getHealthVersion } from "./health-state-DMGbWfAx.js";
...
function attachGatewayWsMessageHandlerOnDemand(params) {
	...
	import("./message-handler-DWyeA-pb.js").then(({ attachGatewayWsMessageHandler }) => {
