...
import { r as registerNativeHookRelay } from "./native-hook-relay-XDvT-D3t.js";
import "./exec-approvals-runtime-DVqaMbUB.js";
import { A as readCodexPluginConfig, E as shouldAutoApproveCodexAppServerApprovals, I as resolveCodexModelBackedReviewerPolicyContext, O as isCodexRemoteExecPlacementSandbox, P as canUseCodexModelBackedApprovalsReviewerForModel, R as resolveOpenClawExecPolicyForCodexAppServer, _ as sessionBindingIdentity, b as resolveCodexAppServerHomeScope, k as isCodexSandboxExecServerEnabled } from "./session-binding-BAiZ3oKm.js";
import { F as isCodexAppServerIndeterminateRequestCancellationError, M as isCodexAppServerApprovalRequest, Q as readRecentCodexRateLimits, W as ensureCodexAppServerClientRuntime, _ as withLeasedCodexAppServerClientStartSelectionRetry, at as resolveCodexAppServerPreparedAuthHandoff, s as getLeasedSharedCodexAppServerClient, u as releaseCodexAppServerClientLease, ut as isJsonObject } from "./shared-client-CGMoSzql.js";
import { d as unsubscribeCodexThreadBestEffort, h as isCodexNotificationForTurn, s as isCodexAlreadyTerminalInterruptError, u as retireUnsafeCodexTurnClientBestEffort } from "./attempt-client-cleanup-CftmRejN.js";
import { C as mergeCodexThreadConfigs, U as resolveCodexWebSearchPlan, W as filterCodexDynamicTools, Y as resolveCodexDynamicToolsLoading, _ as buildCodexPluginAppsConfigPatchFromPolicyContext, d as resolveCodexAppServerModelProvider, f as resolveCodexAppServerRequestModelSelection, g as readCodexSupportedReasoningEfforts, h as resolveReasoningEffort, m as resolveCodexBindingModelProviderFallback, s as buildCodexRuntimeThreadConfig, u as CODEX_NATIVE_PERSONALITY_NONE } from "./thread-lifecycle-OESCwT17.js";
import { A as buildCodexNativeHookRelayDisabledConfig, B as resolveDynamicToolCallTimeoutMs, D as CODEX_NATIVE_HOOK_RELAY_EVENTS, E as CodexNativeToolLifecycleProjector, I as handleDynamicToolCallWithTimeout, K as resolveCodexToolAbortTerminalReason, M as emitCodexNativePreToolUseFailureDiagnostic, S as shouldRequireCodexSandboxExecServerEnvironment, a as emitDynamicToolStartedDiagnostic, b as resolveCodexSandboxEnvironmentSelection, d as releaseCodexSandboxExecServerEnvironment, i as emitDynamicToolErrorDiagnostic, k as buildCodexNativeHookRelayConfig, l as resolveCodexProviderWebSearchSupportForClient, o as emitDynamicToolTerminalDiagnostic, r as handleCodexAppServerElicitationRequest, s as handleCodexAppServerApprovalRequest, t as createCodexDynamicToolBridge, u as ensureCodexSandboxExecServerEnvironment, v as resolveCodexExternalSandboxPolicyForOpenClawSandbox, w as filterToolsForVisionInputs, x as shouldEnableCodexAppServerNativeToolSurface, y as resolveCodexMessageToolProvider } from "./dynamic-tools-DrcIztsh.js";
import { l as readCodexTurn, o as assertCodexTurnStartResponse, r as assertCodexThreadForkResponse, s as readCodexDynamicToolCallParams } from "./protocol-validators-DQMpwHD0.js";
import { n as formatCodexUsageLimitErrorMessage } from "./rate-limits-C6660woR.js";
import { t as resolveCodexAppServerForModelProvider } from "./app-server-policy-EugZH-6m.js";
import { n as resolveCodexBindingAppServerConnection, t as requireCodexSupervisionModelSelection } from "./binding-connection-p3Q9FY9R.js";
import { n as resolveCodexNativeExecutionBlock } from "./sandbox-guard-COwIqSSf.js";
...
async function runCodexAppServerSideQuestion(params, options) {
	...
	const nativeToolSurfaceEnabled = shouldEnableCodexAppServerNativeToolSurface(sideRunParams, params.sandbox ?? void 0, { sandboxExecServerEnabled });
