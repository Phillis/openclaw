...
import { i as classifyOpenAIBaseUrl, n as OPENAI_CODEX_RESPONSES_BASE_URL, o as isOpenAICodexBaseUrl, t as OPENAI_API_BASE_URL } from "./base-url-DivcnZZH.js";
import { _ as isOpenAIDualRouteModelId, b as normalizeOpenAIModelRouteId, v as isOpenAIPlatformOnlyRouteModelId, y as isOpenAISubscriptionOnlyRouteModelId } from "./model-route-contract-B2Q_03Gg.js";
...
function isResponseModelEquivalent(params) {
	return params.provider.trim().toLowerCase() === OPENAI_PROVIDER_ID && params.requestedModelId === "gpt-5.6" && params.responseModelId === "gpt-5.6-sol";
}
...
//#endregion
export { resolveAuthoredOpenAIProviderConfig as a, projectConfiguredModelRow as i, normalizeConfig as n, resolveModelRoutes as o, normalizeModelCatalogId as r, resolveThinkingProfile as s, isResponseModelEquivalent as t };
