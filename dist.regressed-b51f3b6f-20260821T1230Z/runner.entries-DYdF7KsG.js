...
import { t as buildRandomTempFilePath } from "./temp-download-DlDeGU0G.js";
import { o as getOfficialExternalPluginCatalogManifest, p as listOfficialExternalProviderCatalogEntries } from "./official-external-plugin-catalog-CDrgEY7c.js";
import { i as shouldLogVerbose, r as logVerbose } from "./globals-CAwGc4B6.js";
import { n as runExec } from "./exec-BL80Wdzl.js";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-B67UeNMn.js";
import { c as mergeModelProviderRequestOverrides, m as sanitizeConfiguredProviderRequest, p as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-DRrgUN7e.js";
import { d as normalizeMimeType } from "./mime-Hm4eS2i0.js";
import { c as runFfmpeg } from "./media-services-BMidrwE0.js";
import { r as assertSecretOwnerAvailable } from "./runtime-degraded-state-DqIBoQI-.js";
import { i as normalizeMediaReferenceSource, o as resolveInboundMediaReference, r as classifyMediaReferenceSource } from "./media-reference-BeABx1cr.js";
import { r as readRemoteMediaBuffer, t as MediaFetchError } from "./fetch-Tlt0XWLM.js";
...
import { r as resolveOfficialExternalPluginRepairHint } from "./official-external-plugin-repair-hints-0Oy-rmMy.js";
import { t as describeImageWithModel } from "./image-runtime-Bjvl3Oyo.js";
import { a as DEFAULT_TIMEOUT_SECONDS, l as getMediaUnderstandingProvider, n as DEFAULT_MAX_BYTES, o as DEFAULT_VIDEO_MAX_BASE64_BYTES, s as MIN_AUDIO_FILE_BYTES, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-BTkiooBF.js";
import { t as assertRuntimeMediaRequestSecretOwnerAvailable } from "./runtime-media-secret-owner-xJvrDBVt.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-II6CtamH.js";
...
import { a as extractImageContentFromSource } from "./input-files-uwbMv1cN.js";
import { i as normalizeAttachmentPath, n as isImageAttachment, r as isVideoAttachment, t as isAudioAttachment } from "./attachments.normalize-Bo4XFKe5.js";
import "./temp-path-ChKDkme1.js";
import { a as resolveRequestedLocalAudioBackend, i as recordLocalAudioBackendObservation } from "./local-audio-sn4mvYpW.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BRHV-HIc.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-SiDxAIza.js";
...
var MediaAttachmentCache = class {
	...
	async getPath(params) {
		...
		if (entry.tempPath) {
			if (params.maxBytes && entry.bufferResult && entry.bufferResult.size > params.maxBytes) throw new MediaUnderstandingSkipError("maxBytes", `Attachment ${params.attachmentIndex + 1} exceeds maxBytes ${params.maxBytes}`);
			return {
				path: entry.tempPath,
...
const loadModelAuth = createLazyRuntimeModule(async () => await import("./model-auth-DotpFjV2.js"));
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-CXzRVIJP.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
