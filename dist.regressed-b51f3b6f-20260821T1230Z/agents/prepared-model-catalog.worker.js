import { m as mergeRuntimeExternalProfileReferences } from "../persisted-tYYP9V51.js";
import { g as replaceRuntimeAuthProfileStoreSnapshots } from "../runtime-snapshots-CJ87Vu4S.js";
import { x as withPluginRuntimeGenerationScope } from "../hook-runner-global-IYtayVps.js";
import { n as overlayExternalAuthProfiles } from "../external-auth-C6KRpwjX.js";
import { r as listExternalCliSyncProviderIds } from "../external-cli-sync-CU9M9_mw.js";
import { m as preserveResolvedSecretBackedCredentials, p as loadAuthProfileStoreWithoutExternalProfiles } from "../store-BfXdFfLh.js";
import { f as resolveAmbientAgentCredentialsForDiscovery, m as resolveUsableAgentCredentialModes, p as resolveAgentCredentialMapFromStore } from "../prepared-model-runtime.facts-B4cEu5oN.js";
import { gt as AuthStorage } from "../sessions-DNOIAOJW.js";
import { r as fingerprintPreparedModelCatalogGeneration } from "../prepared-model-catalog-worker-Drd3B2pL.js";
...
async function prepareWorkerGeneration(value) {
	const { prepareWorkspaceBuildGroup } = await import("../prepared-model-runtime.facts-BPmDSDn1.js");
...
async function runPreparedModelCatalogWorkerRequest(value, request, preparedGeneration = prepareWorkerGeneration(value)) {
	try {
		...
		const { prepareAgentCatalogSource, prepareFullCatalogFacts } = await import("../prepared-model-runtime.facts-BPmDSDn1.js");
		const authStore = refreshAuthStore({
			agentDir: value.input.agentDir,
			inheritedAuthDir: value.input.inheritedAuthDir,
			authStore: value.authStore,
