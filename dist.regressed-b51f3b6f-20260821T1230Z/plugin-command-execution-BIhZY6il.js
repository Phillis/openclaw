...
import { H as withPluginCommandExecution } from "./runtime-g0R28Sy0.js";
...
import { i as canExposeSenderIsOwner, o as isTrustedReservedCommandOwner, t as isReservedCommandName } from "./command-registration-df_ISQhO.js";
import { t as resolveConversationBindingContext } from "./conversation-binding-context-CogOVF3s.js";
import { c as detachPluginConversationBinding, l as getCurrentPluginConversationBinding, m as requestPluginConversationBinding } from "./conversation-binding-BC9B3heN.js";
...
function resolveBoundAgentIdForSession(params) {
	if (!normalizeOptionalString(params.agentId) && !normalizeOptionalString(params.sessionKey)) return;
