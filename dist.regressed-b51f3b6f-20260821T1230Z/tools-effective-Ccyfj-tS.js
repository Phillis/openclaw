...
import { o as getActivePluginChannelRegistryVersion, p as getActivePluginRegistryVersion } from "./runtime-g0R28Sy0.js";
...
import { ga as validateToolsEffectiveParams } from "./src-BlUKtAtD.js";
...
import { s as peekSessionMcpRuntime } from "./agent-bundle-mcp-manager-api---RxFpSz.js";
import { n as resolveSessionMcpConfigSummary } from "./agent-bundle-mcp-runtime-config-tbNGVEfV.js";
...
import { n as getConnectedNodePluginToolsVersion } from "./node-plugin-tool-snapshot-CtaKhxdi.js";
import { a as resolveEffectiveToolRawDescription, i as resolveEffectiveToolLabel, o as summarizeEffectiveToolDescription, r as disambiguateEffectiveToolLabels } from "./tools-effective-inventory-build-SOD97hA1.js";
import { i as buildEffectiveToolInventoryGroups, n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContextAsync } from "./tools-effective-inventory-BbcasG5j.js";
...
function resolveTrustedToolsEffectiveContext(params) {
	const loaded = loadGatewaySessionEntryReadOnly(params.sessionKey, params.requestedAgentId ? { agentId: params.requestedAgentId } : void 0);
	if (!loaded.entry) {
