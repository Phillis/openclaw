...
import { c as optionalNumber, d as readOptionalGitHubString, n as GITHUB_API_ORIGIN, o as fetchGitHubJson, p as resolveGitHubApiCredentialScope, t as ControlUiGitHubError } from "./control-ui-github-api-DiLldJZ0.js";
...
async function fetchParentRepo(owner, repo, fetchImpl, token) {
	...
	const parentLogin = readOptionalGitHubString(isRecord(value.parent.owner) ? value.parent.owner : {}, "login");
