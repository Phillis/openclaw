...
import { o as resolveEffectiveAgentRuntime, t as concretizeAgentRuntime } from "./thinking-runtime-B4nRkQcs.js";
...
import { B as createManagedTaskFlow, K as finishFlow, O as listTasksForFlowId, Q as requestFlowCancel, W as failFlow, et as resumeFlow, tt as setFlowWaiting } from "./task-registry-8pMJUb3L.js";
import "./runtime-internal-PbSlUl9p.js";
import { _ as getTaskFlowByIdForOwner, d as getFlowTaskSummary, g as findLatestTaskFlowForOwner, p as runTaskInFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById, v as listTaskFlowsForOwner, y as resolveTaskFlowForLookupTokenForOwner } from "./task-executor-7o95zk6d.js";
...
import { n as generateMusic, r as listRuntimeMusicGenerationProviders } from "./openclaw-tools-DGkE1wbc.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "./task-owner-access-CbjgontX.js";
...
import { i as listWebSearchProviders, o as runWebSearch } from "./runtime-CkaBr6Zj.js";
...
import { t as createRuntimeChannel } from "./runtime-channel-CvBCEKFW.js";
...
async function createSessionEntry(params) {
	const [{ createGatewaySession }, { resolveGatewaySessionStoreTarget }, { readAcpSessionMetaForEntry, upsertAcpSessionMeta }] = await Promise.all([
		import("./session-create-service-DyxwomNj.js"),
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("./heartbeat-runner-BKVuxVmu.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRequestRuntime = createLazyRuntimeModule(() => import("./runtime-tts-request-8a-gELip.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-CPsU9zYM.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime.js"));
const loadGatewayPluginRuntime = createLazyRuntimeModule(() => import("./server-plugins--M6Zlm2x.js"));
