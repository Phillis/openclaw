...
import { x as runTui } from "./tui-BQtatzMO.js";
...
import { i as hasAuthProfileForProvider } from "./model-config.helpers-DX3j2MFK.js";
import { r as listConfiguredWebSearchProviders } from "./runtime-CkaBr6Zj.js";
...
async function startSessionGatewayForOnboarding(params) {
	...
	try {
		const { startGatewayServer } = await import("./server-UhyFIRwD.js");
...
const loadSearchSetupModule = createLazyRuntimeModule(() => import("./search-setup-DZLLQDOT.js"));
...
async function finalizeSetupWizard(options) {
	...
	try {
		...
		const [{ resolveDefaultModelAuthStatus, resolveDefaultModelCatalogFacts }, { loadPreparedModelCatalogSnapshot }] = await Promise.all([import("./auth-choice-foyMI1yy.js"), import("./prepared-model-catalog-DcxNkklg.js")]);
