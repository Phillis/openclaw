...
import { f as createChannelMessageAdapterFromOutbound, m as bindIngressLifecycleToReplyOptions } from "./channel-outbound-DhlIXa0y.js";
		...
		start: async () => {
			const bus = await startNostrBus({
				...
				onMessage: async (senderPubkey, text, reply, meta, lifecycle) => {
					...
					const { dispatchInboundDirectDm } = await import("./inbound-direct-dm-runtime-DlKHpeor.js");
