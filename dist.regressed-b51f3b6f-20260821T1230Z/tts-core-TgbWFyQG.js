...
function loadDefaultSummarizeTextDeps() {
	return defaultSummarizeTextDepsPromise ??= Promise.all([import("./simple-completion-runtime-D5XkLb5Y.js"), import("./model-auth-DotpFjV2.js")]).then(([completionRuntime, { requireApiKey }]) => ({
