...
import { G as setEmbeddedPluginApprovalBroker, U as EmbeddedPluginApprovalBroker, W as clearEmbeddedPluginApprovalBroker, q as setEmbeddedMode } from "./agent-tools.before-tool-call-BzRsADjV.js";
...
import { u as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-WYGCGgEu.js";
import { n as resolveThinkingDefault } from "./model-thinking-default-B9IHGxZs.js";
import { t as buildAllowedModelSet } from "./model-selection-Adc4uFq_.js";
...
import { t as getSessionDefaults } from "./session-utils-model-DEBeKe9h.js";
import { E as loadGatewaySessionEntryReadOnly, N as resolveGatewaySessionStoreTargetWithStore, O as resolveCanonicalGatewaySessionStoreKey, T as loadGatewaySessionEntry, w as listAgentsForGateway } from "./session-utils-row-CJRrMBuq.js";
import { t as ensureContextWindowCacheLoaded } from "./context-CNweD5GV.js";
...
import { i as buildGatewaySessionInfo, r as listSessionsFromStoreAsync } from "./session-utils-list-9Nb5BMah.js";
...
import { c as performGatewaySessionReset } from "./session-reset-service-BS0JDdeQ.js";
...
import { t as loadGatewayModelCatalog } from "./server-model-catalog-CJL_VHrs.js";
...
import { a as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES, i as readChatHistoryPage, o as enforceChatHistoryFinalBudget, r as enrichChatHistoryCompactionMarkers, s as replaceOversizedChatHistoryMessages } from "./chat-DFt5024p.js";
import { o as isAgentLifecycleYieldedWaiting } from "./session-lifecycle-state-BwwlVbLe.js";
import { n as createGatewaySession } from "./session-create-service-CjkelTEF.js";
import { t as projectSessionsPatchEntry } from "./sessions-patch-Bwhq5n7S.js";
import { t as resolveLocalRunShutdownGraceMs } from "./local-run-shutdown-BQKagb2W.js";
import { u as formatTuiErrorMessage } from "./tui-formatters-D98cnXCW.js";
...
var EmbeddedTuiBackend = class {
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-BnWaXe41.js");
