import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{K as t,W as n,Y as r,_ as i,a,b as o,ct as s,o as c}from"./lit-runtime-2JvyKfXq.js";import{vr as l,yr as u}from"./control-ui-core-Dn23l6dj.js";import{t as d}from"./web-awesome-tabs-c7nhE1sH.js";function f(e){let t=e.getRootNode();return t instanceof ShadowRoot?t.activeElement??document.activeElement:document.activeElement}function p(){let e=document.activeElement;for(;e instanceof HTMLElement&&e.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e}function m(e,t){let n=e.getRootNode();return t===document.body||t===document.documentElement||n instanceof ShadowRoot&&t===n.host}function h(e,t,n){if(!(e instanceof HTMLElement))return;let r=_.get(e)!==t;_.set(e,t),!(!r&&!n)&&queueMicrotask(()=>{e.isConnected&&(e.closest(`wa-tab-group`)?.updateComplete??Promise.resolve()).then(()=>{if(!e.isConnected)return;e.scrollIntoView?.({block:`nearest`,inline:`nearest`});let t=f(e);n&&m(e,t)&&e.focus({preventScroll:!0})})})}function g(e){let n=n=>r`
    <button
      slot=${n?`nav`:t}
...
//# sourceMappingURL=panel-tab-strip-EPO2TRzp.js.map