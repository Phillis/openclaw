...
import { n as isPreparedModelCatalogFull } from "./prepared-model-runtime.facts-B4cEu5oN.js";
import { i as getPreparedModelFullCatalogAuth } from "./prepared-model-catalog-worker-Drd3B2pL.js";
import { c as prepareModelRuntimeSnapshot, i as getPreparedModelRuntimeSnapshot, n as acquireReadOnlyPreparedModelRuntime, p as preparedModelRuntimeConfigsMatch, r as activateStandalonePreparedModelRuntime, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-WYGCGgEu.js";
import { n as prepareScopedReadOnlyModelCatalog, t as prepareScopedReadOnlyLiveModelCatalog } from "./prepared-model-runtime.scoped-catalog-hC5Sq8jB.js";
import { i as normalizeThinkingCatalogProviders, n as hasResolvedThinkingCatalogEntry } from "./thinking-runtime-B4nRkQcs.js";
...
async function loadProviderScopedThinkingCatalog(params) {
	const { loadManifestModelCatalog } = await import("./model-catalog-CHKoyY52.js");
