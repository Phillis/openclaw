...
import { h as consumeRunSkillUsage } from "./agent-tools.before-tool-call-BzRsADjV.js";
import "./sessions-DNOIAOJW.js";
import { t as SessionManager } from "./session-manager-BPvKNeAi.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-BBNFSklY.js";
...
import { f as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt-prompt-helpers-u9zLew6I.js";
import { T as findActiveSessionTask } from "./media-generation-task-status-BX1S8T5Q.js";
import { v as runWithPreparedMemoryPromptSection } from "./memory-state-DhEOmKyi.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-CbjgontX.js";
...
async function runCoreAgentEndSideEffects(params) {
	...
	try {
		const { scheduleSkillExperienceReview } = await import("./experience-review-default-DuGKGxCb.js");
