...
import { d as formatIcaclsResetCommand, u as createIcaclsResetCommand } from "./permissions-DHG-s8_A.js";
...
import { r as listAgentEntries, y as tryResolveDefaultAgentId } from "./agent-scope-config-BdXMWufB.js";
...
import { p as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-BoGsPJpC.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as runSecurityAuditCore } from "./audit-DKFrT6wB.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-B-jficic.js");
