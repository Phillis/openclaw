...
import { i as resolveCliBackendConfig, o as resolveCliRuntimeCanonicalProvider } from "./cli-backends-CwAHe8lo.js";
...
import { i as preparedAgentRuntimeProfileAttemptHasCandidate, n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-CZBgaENR.js";
import { i as resolveModelWithRegistry } from "./model-XD8eqVN2.js";
import { n as prepareSimpleCompletionModel } from "./simple-completion-runtime-Ccm4D6NF.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-Dt_gQvNO.js";
import { r as scopeAuthProfileStoreToPreparedPlan } from "./resolve-auth-D_nZRWWO.js";
...
async function resolveHarness(runtime) {
	if (runtime === "openclaw") {
		const { createOpenClawAgentHarness } = await import("./builtin-openclaw-CclXVplD.js");
