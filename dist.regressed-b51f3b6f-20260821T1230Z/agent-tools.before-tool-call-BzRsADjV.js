...
import { A as getPluginSessionExtensionStateSync } from "./loader-lwogLCXu.js";
...
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-cCwmXcan.js";
...
async function deliverClientVoiceMutationDigest(record, config, signal) {
	...
	const { sendDurableMessageBatchCore } = await import("./runtime-C56iWhmP.js");
