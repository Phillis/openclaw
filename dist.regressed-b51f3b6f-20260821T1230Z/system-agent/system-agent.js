...
import { a as resolveSystemAgentVerifiedInferenceRoute } from "../verified-inference-ByFu4AcK.js";
import { a as parseSystemAgentOperation, i as isPersistentSystemAgentOperation, t as executeSystemAgentOperation } from "../operations-DMW4CIQ1.js";
...
import { n as resolveSystemAgentOperation } from "../dialogue-DZe4RKV8.js";
...
async function runSystemAgent(opts, runtime = defaultRuntime) {
	...
	const runInteractiveTui = boundOpts.runInteractiveTui ?? (await import("../tui-backend-DC8WrAgN.js")).runSystemAgentTui;
	boundOpts.onReady?.();
