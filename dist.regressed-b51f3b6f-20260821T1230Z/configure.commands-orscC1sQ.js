...
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-DvFpv9jN.js";
...
import { i as applyAuthChoice } from "./auth-choice-Cs6juH3x.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-Mrxqvxuo.js";
import { i as setupChannels } from "./onboard-channels-Ch7qW_Pj.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-BA2gY7VV.js";
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-CTrZeU98.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, runSearchSetupFlow } = await import("./search-setup-DZLLQDOT.js");
