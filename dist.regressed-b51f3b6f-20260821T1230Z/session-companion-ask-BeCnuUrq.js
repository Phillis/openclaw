...
import { i as resolveSimpleCompletionSelectionForAgent } from "./simple-completion-runtime-Ccm4D6NF.js";
...
async function defaultRun(params) {
	...
	try {
		const [{ SessionManager }, { runEmbeddedAgent }] = await Promise.all([import("./sessions-CVAWwup6.js"), import("./embedded-agent-DPCuWBmW.js")]);
