...
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-paz6-Hb1.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-r-vLYUFp.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-36faP931.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-B7--86oH.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-Cu2caKzI.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-CheGuRmE.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-NG_hEwOz.js");
			...
			const { statusCommand } = await import("./status-OJ9gRjLz.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-CdPEexAY.js");
