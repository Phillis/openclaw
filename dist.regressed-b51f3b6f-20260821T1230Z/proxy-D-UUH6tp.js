...
import { i as resolveProviderRequestPolicy } from "./provider-attribution-iFUXefU9.js";
import { f as resolveProviderRequestPolicyConfig } from "./provider-request-config-DRrgUN7e.js";
import { i as streamSimple } from "./stream-CgPJAnrX.js";
import { t as log$1 } from "./logger-XkrUQwkD.js";
import { C as applyAnthropicEphemeralCacheControlMarkers, N as mapThinkingLevelToReasoningEffort, P as streamWithPayloadPatch, h as normalizeOpenAICompatibleReasoningPayload, w as resolveAnthropicEphemeralCacheControl } from "./provider-stream-shared-DK1q32kU.js";
import { a as patchCodexNativeWebSearchPayload, o as resolveCodexNativeSearchActivation } from "./codex-native-web-search-core-B2HC1py1.js";
import { n as createOpenAIResponsesTransportStreamFn } from "./openai-transport-stream-O-qDrcjQ.js";
...
function filterCodeModePayloadHookResult(payload, nextPayload, visibleToolNames, allowedHostedToolTypes) {
		...
		if ((params.codeModeToolSurfaceEnabled === true || codeModeSurfaceFromOptions || isCodeModeEnabled(params.config)) && codeModeVisibleToolNames) {
			...
			const codeModeOptions = {
				...
				onPayload: (payload) => {
					...
					if (isPromiseLike(nextPayload)) return Promise.resolve(nextPayload).then((resolvedPayload) => filterCodeModePayloadHookResult(payload, resolvedPayload, codeModeVisibleToolNames, allowedHostedToolTypes));
					return filterCodeModePayloadHookResult(payload, nextPayload, codeModeVisibleToolNames, allowedHostedToolTypes);
				}
			};
