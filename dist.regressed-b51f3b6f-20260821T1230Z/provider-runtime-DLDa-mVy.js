...
import { n as applyPluginTextReplacements, r as mergePluginTextTransforms, t as resolveRuntimeTextTransforms } from "./text-transforms.runtime-CS02CQ-k.js";
...
import { d as resolveProviderPluginsForHooks, f as resolveProviderRuntimePlugin, n as clearProviderRuntimePluginCacheForTest, o as resolveLoadedProviderRuntimePlugin, r as ensureProviderRuntimePluginHandle, u as resolveProviderHookPlugin } from "./provider-hook-runtime-CooYOIsw.js";
...
async function resolveProviderUsageSnapshotWithPlugin(params) {
	...
	if (!harness) {
		...
		const { loadAgentRuntimePluginRegistryHandle } = await import("./runtime-plugins-Cus0kvsl.js");
		const { ensureSelectedAgentHarnessPlugin } = await import("./runtime-plugin-CxQnOQtw.js");
