...
import { C as resolveSupportedVoiceModelRefs, b as getVoiceProviderConfig, x as providerMatchesId } from "./loader-lwogLCXu.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-C4-s9E1x.js";
...
import { A as flushClientVoiceSessionWrites, C as appendRelayVoiceTranscript, D as closeStaleClientVoiceSessions, E as closeRelayVoiceSessionRecord, F as VOICE_TRANSCRIPT_QUEUE_POLICY, I as normalizeVoiceTranscriptText, L as BoundedSerialQueue, M as resolveClientVoiceAgentSessionId, N as resolveClientVoiceSessionOrigin, O as createOrResumeClientVoiceSession, P as resolveOpenClientVoiceSessionId, R as authorizeClientVoiceConfirmation, S as appendClientVoiceTranscript, T as closeClientVoiceSession, j as registerClientVoiceConsultRun, k as ensureClientVoiceAgentSessionEntry, w as assertClientVoiceSessionOpen, z as bindAuthorizedClientVoiceConfirmation } from "./agent-tools.before-tool-call-BzRsADjV.js";
...
import { d as readSessionPreviewItemsFromTranscript } from "./session-transcript-readers-CJcK7eRo.js";
import { t as resolveRequestedSessionAgentId } from "./session-request-agent-BeVvXvOY.js";
import { i as getSpeechProvider, o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-CiMcVFmr.js";
import { S as withSpeakerSelectionFallbackCompat, h as resolveTtsConfig, x as withSpeakerSelectionCompat } from "./tts-settings-oG9oyjFI.js";
import { n as redactConfigObject } from "./redact-snapshot-DuN7qyYL.js";
import { C as getResolvedSpeechProviderConfig, b as CODE_HEAVY_SPOKEN_FALLBACK, v as synthesizeSpeech, x as isCodeHeavySpeechText } from "./runtime-api-Cer8lA4l.js";
import "./tts-6U7zcHmD.js";
import { o as registerChatAbortController, t as abortChatRunById } from "./chat-abort-Cm7ik-5J.js";
import { t as createPluginRuntime } from "./runtime-Bo6RRla6.js";
import { t as formatForLog } from "./ws-log-DAJ6wT2O.js";
import { n as getRealtimeTranscriptionProvider, r as listRealtimeTranscriptionProviders, t as canonicalizeRealtimeTranscriptionProviderId } from "./provider-registry-C227sabD.js";
import { n as resolveRealtimeBootstrapContextInstructions } from "./realtime-bootstrap-context-WEW5iLu7.js";
...
import { t as handleChatSend } from "./chat-send-handler-BuHdpzSF.js";
...
import { a as rememberUnifiedTalkSession, i as registerTalkConnectionCleanup, n as forgetUnifiedTalkSession, o as requireUnifiedTalkSessionConn, r as getUnifiedTalkSession } from "./talk-session-registry-x9YkVNCk.js";
...
const loadTalkAgentExecution = createLazyRuntimeModule(async () => {
	const [embeddedAgent, admission] = await Promise.all([import("./embedded-agent-DPCuWBmW.js"), import("./admitted-run-context-DN1fM-I2.js")]);
	return {
