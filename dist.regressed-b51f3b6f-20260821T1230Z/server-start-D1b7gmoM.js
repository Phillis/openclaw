...
import { f as setGatewaySigusr1RestartPolicy, p as setPreRestartDeferralCheck } from "./restart-C1WD2IDG.js";
...
import "./server-plugins-DRwCKlxn.js";
...
import { c as canReceiveSessionEvent } from "./session-sharing-_cS5K0AT.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-DMGbWfAx.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-CjkrzfO_.js";
import { t as createControlUiSessionPullRequestSubscriptions } from "./control-ui-session-pr-subscriptions-BppzPUsD.js";
...
async function startGatewayCoreRuntime(input) {
	...
	const taskAndSkillsResident = residentRegistry.register({
		...
		stop: async () => {
			...
			const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-Be7cpyjP.js");
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-DIi-auEH.js"), import("./server-runtime-startup-services-C7rNX3Su.js")]));
	...
	const { execApprovalManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, bindApprovalPublicationContext, unregisterApprovalAuthorityObserver, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-DTuhLgy2.js"), import("./server-methods-CeHtxhzP.js")]);
		return {
...
async function createGatewayChatMetadataLifecycle(params) {
	...
	const { ChatMetadataSnapshotUnavailableError, createGatewayChatMetadataRuntime } = await import("./chat-metadata-runtime-CRBZBcUH.js");
	const runtime = createGatewayChatMetadataRuntime({
		...
		...params.minimalTestGateway ? {
			beforeRefresh: async () => {
				const { refreshPreparedModelRuntimeSnapshots } = await import("./prepared-model-runtime-IylVwWXe.js");
	...
	const registerRefreshListeners = async () => {
		...
		const [{ registerRuntimeAuthProfileStoreMutationListener }, { registerPreparedModelRuntimePublicationListener }, { registerSkillsChangeListener }] = await Promise.all([
			...
			import("./prepared-model-runtime-IylVwWXe.js"),
...
async function attachInitialGatewayLifetimeSidecars(params) {
	...
	params.sidecars.push({ stop: async () => {
		const { flushPendingSessionsChangedEvents } = await import("./session-change-event-B856ENJE.js");
...
async function prepareGatewayKernelRequestRuntime(params) {
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-sYqrt_Yl.js");
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-dgVh5-5d.js").then(({ buildGatewayCronService }) => {
		loaded = {
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-Csuhv8k8.js");
...
async function prepareGatewayKernelState(params) {
	...
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-BR7-WIn9.js");
...
async function prepareGatewayServerBootstrap(input) {
	...
	const startupConfigModulePromise = import("./server-startup-config-CF0e0Y8Z.js");
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-D3JHJB8I.js"), { cacheRejections: true });
...
const loadGatewayModelCatalogModule = createLazyRuntimeModule(() => import("./server-model-catalog-CI7CSBqW.js"));
const loadWorkerEnvironmentStartupModule = createLazyRuntimeModule(() => import("./server-worker-environment-startup-B3Pg1Ut2.js"));
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-9g7pXVy4.js"));
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-eN2DsY9y.js"));
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-PFTJ7Auo.js"));
...
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-CFijGCW2.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
const getControlUiModule = createLazyRuntimeModule(() => import("./control-ui-BQD3SwZg.js"));
...
const getEmbeddingsHttpModule = createLazyRuntimeModule(() => import("./embeddings-http-DchnafK9.js"));
const getManagedMediaAttachmentsModule = createLazyRuntimeModule(() => import("./managed-image-attachments-0VVOD2tK.js"));
const getMcpAppStandaloneModule = createLazyRuntimeModule(() => import("./mcp-app-standalone-BGA0cT66.js"));
const getPluginIconHttpModule = createLazyRuntimeModule(() => import("./plugin-icon-http-q1YsUEBx.js"));
const getWorkspaceIconHttpModule = createLazyRuntimeModule(() => import("./workspace-icon-http-DRH0Tw4V.js"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-B6SwZ1v2.js"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-D3Uia2uf.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-BdJNSlSq.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-DpCxnjC6.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-DSYszjpU.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-ChvcdWc2.js"));
const getUserProfilesHttpModule = createLazyRuntimeModule(() => import("./user-profiles-http-CWi3aE1U.js"));
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-DSCAQ3Z7.js");
...
async function finishGatewayStartup(params) {
	...
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-BfM-U1_L.js"), import("./route-capability-CCISCYmy.js")]));
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-B6nH8HSF.js"), { cacheRejections: true });
	...
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-BRuAIwiI.js");
...
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-E8UnP-u-.js"));
