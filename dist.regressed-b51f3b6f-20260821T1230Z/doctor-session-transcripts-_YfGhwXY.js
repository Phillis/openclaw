...
import { o as isLegacyCodexProviderId } from "./codex-route-model-ref-0uJOp6W2.js";
import { g as openOpenClawAgentDatabase, i as closeOpenClawAgentDatabaseByPath, p as isOpenClawAgentDatabaseOpen, v as runOpenClawAgentWriteTransaction } from "./openclaw-agent-db-lxLIE6rA.js";
import { _ as parseSqliteSessionEntryRecord } from "./openclaw-agent-db-maintenance-B1somIwL.js";
...
import { Dt as applySessionEntryLifecycleMutation } from "./session-accessor-Bi6bzKQE.js";
import { K as setCanonicalSqliteSessionMainKey, Q as deleteSessionMembersForRepair, X as collectSessionStateIdsForEntry, Z as copySessionNodeArtifactsForRepair, a as resolveAllAgentSessionStoreCandidateTargetsSync, it as trackSessionEntryCacheWrite, nt as publishSessionEntryCacheInvalidation, o as resolveAllAgentSessionStoreTargetsSync, u as resolveAgentSessionDirs } from "./targets-DxP0vsft.js";
import { o as resolveDeliveryProvenCanonicalSessionKey } from "./store-entry-iif-1PcC.js";
import { l as resolveSqliteTranscriptArchiveDirectory } from "./session-accessor.sqlite-scope-kI2NyJDH.js";
import { g as isSessionTranscriptLeafControl, v as mergeSessionTranscriptTreePaths, w as selectSessionTranscriptTreePathNodes, x as scanSessionTranscriptTree, y as mergeSessionTranscriptVisiblePathWithOpaqueAppendPath } from "./session-transcript-index-Bfc_6ADm.js";
import { i as writeTranscriptArchive } from "./session-accessor.sqlite-delete-snapshot-xtZPG_Ot.js";
import { y as loadTranscriptEvents } from "./session-accessor.sqlite-transcript-store-E-m-_aAq.js";
import { a as rehomeSqliteSessionDeliveryReferencesForCanonicalRepair, o as rehomeSqliteSessionDeliveryReferencesForCanonicalRepairBatch, r as listSqliteSessionGenerationIdsForCanonicalRepair, s as listSqliteSessionEntriesWithCanonicalOwnerEvidence, t as copySqliteSessionOwnedStateForCanonicalRepair } from "./session-accessor.sqlite-canonical-repair-DPsLdhK1.js";
...
import { f as resolveTargetSqlitePath } from "./doctor-session-sqlite-readers-DVw-c3UJ.js";
...
async function noteSessionSqliteMigrationHealth(params) {
	const { runDoctorSessionSqlite } = await import("./doctor-session-sqlite-DF8bvayd.js");
	...
	const runSessionSqlite = async () => {
		...
		const { migrateLegacyMainSessionKeys } = await import("./legacy-main-session-migration-f8i4qyJw.js");
