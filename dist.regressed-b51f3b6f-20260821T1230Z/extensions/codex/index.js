...
import { c as readCodexCliCredentialsCached } from "../../external-cli-sync-CU9M9_mw.js";
import { b as updateAuthProfileStoreWithLock, p as loadAuthProfileStoreWithoutExternalProfiles } from "../../store-BfXdFfLh.js";
import { _ as readToolStringParam } from "../../common-BGOZLJ2_.js";
import { t as jsonResult } from "../../tool-results-BCM3fdVS.js";
import { n as buildApiKeyCredential, t as applyAuthProfileConfig } from "../../provider-auth-helpers-BIC1B3Gn.js";
...
import { h as resolveTranscriptSessionKeyBySessionId, m as resolveStorePath, r as getSessionEntry } from "../../session-store-runtime-BsqwEEwm.js";
import { d as buildOpenAICodexCredentialExtra, h as resolveOpenAICodexImportProfileName, m as resolveOpenAICodexAuthIdentity } from "../../provider-auth-DKsH0m9K.js";
...
import { a as closeCodexStartupClientBestEffort, d as unsubscribeCodexThreadBestEffort, h as isCodexNotificationForTurn, o as interruptCodexTurnAndWaitBestEffort, p as getCodexAppServerTurnRouter, u as retireUnsafeCodexTurnClientBestEffort } from "../../attempt-client-cleanup-CftmRejN.js";
import { s as isAssistantCommentaryCompletionNotification } from "../../event-projector-usage-KcJ-8PWT.js";
import { C as mergeCodexThreadConfigs, D as isOpenAiCuratedMarketplace, T as ensureCodexPluginActivation, f as resolveCodexAppServerRequestModelSelection, k as pluginReadParams, u as CODEX_NATIVE_PERSONALITY_NONE, x as buildDisabledAppsConfigPatch } from "../../thread-lifecycle-OESCwT17.js";
import { u as readVisibleSessionTranscriptMessageEntries } from "../../session-transcript-runtime-BrQue-7k.js";
import { a as assertCodexThreadStartResponse } from "../../protocol-validators-DQMpwHD0.js";
import { l as projectBoundedCodexVisibleSessionHistory } from "../../transcript-mirror-CQ42qDZX.js";
import { n as describeControlFailure, t as CODEX_CONTROL_METHODS } from "../../capabilities-_VRCr2y_.js";
import { r as formatCodexDisplayText } from "../../command-formatters-C_inNcKe.js";
import "../../incognito-session-DoO9V_or.js";
import { t as resolveCodexAppServerForModelProvider } from "../../app-server-policy-EugZH-6m.js";
...
import { t as resumeCodexAppServerThread } from "../../thread-resume-k0mtmhN8.js";
import { i as withCodexAppServerJsonClient, r as requestCodexAppServerJson } from "../../request-BZ4vTnbm.js";
...
import { n as registerCodexCliMetadata } from "../../cli-metadata-B41Khd6d.js";
import { t as createCodexAppServerAgentHarness } from "../../harness-BBxl-w9t.js";
import { t as buildCodexMediaUnderstandingProvider } from "../../media-understanding-provider-CV0LqlIq.js";
...
import { f as trackCodexConversationActiveTurn, m as canMutateCodexHost, p as CODEX_NATIVE_EXECUTION_AUTH_ERROR, t as discoverCodexMarketplacePlugins } from "../../plugin-marketplace-discovery-DeIyfjmi.js";
...
import { d as resumeCodexCliSessionOnNode, l as listCodexCliSessionsOnNode, o as createCodexCliSessionNodeHostCommands, s as createCodexCliSessionNodeInvokePolicies, t as codexControlRequest, u as resolveCodexCliSessionForBindingOnNode } from "../../command-rpc-DXpcyd3o.js";
import { i as createCodexSessionCatalogNodeInvokePolicies, n as createCodexSessionCatalogControl, o as assertCodexArchiveDescendantsUnowned, r as createCodexSessionCatalogNodeHostCommands, t as codexSessionCatalogRuntime } from "../../session-catalog-BacYlm2S.js";
...
function createLazyCodexAppServerBindingStore(state) {
	let resolved;
	const store = () => resolved ??= import("../../session-binding-Bn1o3rwJ.js").then(({ createCodexAppServerBindingStore }) => createCodexAppServerBindingStore(state));
	return {
...
async function loadDefaultCodexSubcommandHandler() {
	const { handleCodexSubcommand } = await import("../../command-handlers-DFlO1LmI.js");
...
const loadCodexWebSearchRuntime = createLazyRuntimeModule(() => import("../../web-search-provider.runtime-BKxbK7x5.js"));
...
var codex_default = definePluginEntry({
	...
	register(api) {
		...
		api.on("after_compaction", async (event, ctx) => {
			...
			const { sessionBindingIdentity } = await import("../../session-binding-Bn1o3rwJ.js");
			const identity = sessionBindingIdentity({
				sessionId,
		...
		api.on("session_end", async (event, ctx) => {
			...
			const config = resolveCurrentConfig();
			const [{ sessionBindingIdentity }, { retireCodexAppServerSessionGeneration }] = await Promise.all([import("../../session-binding-Bn1o3rwJ.js"), import("../../session-retirement-BvQhMQBI.js")]);
