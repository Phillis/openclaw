...
import { c as readSessionTranscriptBoundedMessageTailPage, x as isSessionTranscriptProjectionUnavailableError } from "./session-accessor-Bi6bzKQE.js";
import { g as onSessionLifecycleEvent } from "./session-accessor.sqlite-lifecycle-Cv8qGX3X.js";
...
import "./prepared-model-runtime-WYGCGgEu.js";
...
import { r as stripToolMessages, t as extractStoredAssistantText } from "./chat-history-text-k473u80J.js";
...
import { f as markChatAbortTerminalPersistenceError, s as removeChatAbortControllerEntry } from "./chat-abort-Cm7ik-5J.js";
...
import { i as terminalHealthFor, n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-D5wEFVAJ.js";
...
import { t as createAuditEventRecorder } from "./audit-recorder-CJhrtkh2.js";
import { a as defaultPersistDigest, c as isTerminalLifecycleEvent, d as rememberSessionObserverDisabledRun, f as rememberSessionObserverDormantRun, h as synthesizeSessionObserverTerminalDigest, i as defaultCompleteModel, l as markSessionObserverRunSuperseded, m as sessionObserverScopeKey, n as buildSessionObserverPrompt, o as defaultPrepareModel, p as rememberSessionObserverRevisionFloor, r as createDormantSessionObserverRun, s as defaultReadSession, t as SESSION_OBSERVER_SYSTEM_PROMPT, u as normalizeSessionObserverModelOutput } from "./session-observer-model-BJlbVgXS.js";
import { t as mapTaskSummary } from "./task-summary-DsTqTPcR.js";
import { n as createSessionCompanionAskRuntime } from "./session-companion-ask-BeCnuUrq.js";
...
function startGatewayEventSubscriptions(params) {
	...
	const agentEventHandlerLoader = createLazyPromiseLoader(() => {
		return Promise.all([import("./server-chat-CKMMLWe2.js"), import("./server-session-key-CYt1veKK.js")]).then(([{ createAgentEventHandler }, { resolveSessionKeyForRun }]) => createAgentEventHandler({
	...
	const getSessionEventsModule = createLazyPromise(() => import("./server-session-events-gxWrTk4b.js"), { cacheRejections: true });
	...
	const taskObserverRuntimePromise = import("./task-registry.store-wQXc_Ah0.js").then((module) => {
