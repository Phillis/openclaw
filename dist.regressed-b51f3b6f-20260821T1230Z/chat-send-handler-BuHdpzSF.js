...
import { a as shouldComputeCommandAuthorized } from "./command-detection-99lQj46G.js";
...
import { r as resolveGatewayModelSupportsImages } from "./session-utils-model-DEBeKe9h.js";
import { T as loadGatewaySessionEntry, j as resolveDeletedAgentIdFromSessionKey } from "./session-utils-row-CJRrMBuq.js";
...
import { i as dispatchInboundMessageWithProjectedDispatcher, l as emitInboundMessageAuditTerminal, s as emitMessageReceivedHooks } from "./dispatch-Ca4xJfeT.js";
...
import { t as resolveQueueSettings } from "./queue-BJiyBphu.js";
...
import { n as buildInboundUserContextPrefix } from "./inbound-meta-DJdojE5P.js";
...
import { a as attachManagedOutgoingMediaToMessage } from "./managed-image-attachments-B3MM0RFH.js";
...
import { i as maybeGenerateDashboardSessionTitle, r as isDashboardSessionTitleCandidate, t as buildDashboardSessionTitleSource } from "./dashboard-session-title-BL77EU5u.js";
import { i as persistGatewaySessionLifecycleEvent } from "./session-lifecycle-state-BwwlVbLe.js";
...
async function resolveDurableChatClaim(params) {
	...
	if (isAdoptedRestartRecoveryClaim(entry, params.clientRunId) && entry.status === "running" && entry.abortedLastRun === true) {
		...
		try {
			const { retryRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-Csuhv8k8.js");
