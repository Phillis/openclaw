...
import { i as openRootFileSync, t as canUseRootFileOpen } from "./root-file-Chr9dJBe.js";
...
import { f as resolveConfigPath, v as resolveIncludeRoots } from "./paths-CqeDjSA4.js";
import { r as redactRegisteredSecretValues } from "./secret-redaction-registry-gIFE-2_j.js";
...
function redactSensitiveFieldValueWithOptions(key, value, options, path = [key]) {
	...
	const redacted = options.patterns?.length || couldMatchDefaultRedactPatterns(exactRedacted) ? redactText(exactRedacted, resolved.patterns, {
		redactFormBodies: resolved.redactFormBodies,
		redactStructuredAuthHeaders: resolved.redactStructuredAuthHeaders
	}) : exactRedacted;
...
//#endregion
export { testRegexWithBoundedInput as A, extensionUsesSkippedScannerPath as C, compileConfigRegexes as D, isMissingPathError as E, compileSafeRegex as O, parseJsonWithJson5Fallback as S, isErrno as T, createConfigIncludeResolutionSession as _, redactSensitiveFieldValue as a, resolveConfigIncludeWritePath as b, redactSensitiveText as c, redactToolPayloadTextWithConfig as d, resolveRedactOptions as f, INCLUDE_KEY as g, ConfigIncludeError as h, redactSecrets as i, compileSafeRegexDetailed as k, redactToolDetail as l, CircularIncludeError as m, getDefaultRedactPatterns as n, redactSensitiveFieldValueWithConfig as o, readLoggingConfig as p, isSensitiveFieldKey as r, redactSensitiveLines as s, computeSensitiveRedactionBitmap as t, redactToolPayloadText as u, hashConfigIncludeRaw as v, hasErrnoCode as w, resolveConfigIncludes as x, readConfigIncludeFileWithGuards as y };
