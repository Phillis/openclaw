...
import { c as formatPluginCompatibilityNotice, r as buildPluginCompatibilitySnapshotNotices } from "./status-D395eT4R.js";
...
import { a as runSetupModelAuthStep, i as offerLiveModelVerification, n as listSetupMigrationOptions, r as runSetupMigrationImport, t as detectSetupMigrationSources } from "./setup.migration-import-Bjk0kVdl.js";
...
async function runSetupWizardOnce(opts, runtimeInput, prompter) {
	...
	if (opts.skipChannels) await prompter.note(t("wizard.setup.skipChannels"), t("wizard.setup.channelsTitle"));
		...
		const { setupChannels } = await import("./onboard-channels-Dlggg57y.js");
	...
	if (flow !== "quickstart") {
		...
		const { setupAppRecommendations } = await import("./setup.app-recommendations-Dyj4T7k3.js");
	...
	const { finalizeSetupWizard } = await import("./setup.finalize-BwfNaw1h.js");
