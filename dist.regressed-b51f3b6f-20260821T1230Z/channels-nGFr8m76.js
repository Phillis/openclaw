...
import { s as getChannelsCommandSecretTargetIds } from "./command-secret-targets-BoGsPJpC.js";
...
import { i as prepareChannelAccountRemoval, n as channelLabel, r as applyPreparedChannelAccountRemoval, t as channelsAddCommand } from "./add-CzgsGrUA.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidChannelConfig } from "./shared-C4IRKaDP.js";
import { t as channelsListCommand } from "./list-D5vchPr_.js";
import { t as channelsStatusCommand } from "./status-iD7LmPcn.js";
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-DRhh5tm4.js");
