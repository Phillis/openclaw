...
import { w as listTaskRecordPage, x as getTaskById } from "./task-registry-8pMJUb3L.js";
...
import { i as retrySubagentCompletionDelivery, n as dismissSubagentCompletionDelivery } from "./subagent-completion-delivery-DKT2BOW0.js";
...
const tasksHandlers = {
	...
	"tasks.dismiss": async ({ params, respond }) => {
		...
		const { discardSubagentTerminalDelivery } = await import("./subagent-registry-BeTV-3wU.js");
		const results = [];
		for (const taskId of params.taskIds) {
