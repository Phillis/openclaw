...
import { r as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-CVIoH-T0.js";
...
async function doctorCommand(runtime, options) {
	if (options?.stateSqlite) {
		...
		const { runDoctorStateSqliteCompact } = await import("./doctor-state-sqlite-compact-D_qp-hJ6.js");
	...
	await (await import("./doctor-health-DsudERCz.js")).runDoctorHealthFlow(runtime, options);
}
