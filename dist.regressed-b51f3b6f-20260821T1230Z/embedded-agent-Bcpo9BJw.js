...
import { g as resolveSessionAgentIds, h as resolveSessionAgentId, m as resolveRunModelFallbacksOverride, r as hasConfiguredModelFallbacks } from "./agent-scope-BizOtGGz.js";
...
import { D as freezeDiagnosticTraceContext, n as emitDiagnosticEvent, t as areDiagnosticsEnabledForProcess } from "./diagnostic-events-Djn4AVRp.js";
...
import { c as resolveContextConfigProviderForRuntime, d as resolveSelectedOpenAIRuntimeProvider, i as isOpenAIProvider, n as OPENAI_PROVIDER_ID, y as normalizeOptionalAgentRuntimeId } from "./openai-routing-BGuHAkXI.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CdX9UGcX.js";
import { n as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-BV6-k_Y4.js";
import { w as resolveDefaultModelForAgent } from "./codex-route-model-ref-0uJOp6W2.js";
import { l as providerModelRouteAcceptsAuthMode, s as modelMatchesProviderModelRoute, v as resolveProviderModelRoutes } from "./openai-model-routes-lYZ0ONoM.js";
import { c as resolveSafeTimeoutDelayMs } from "./timeouts-D2XMKe-X.js";
import { g as withAgentRunLifecycleGeneration, n as captureAgentRunLifecycleGeneration, o as emitAgentEventIfCurrent, s as getAgentEventLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent, u as onAgentEvent } from "./agent-events-Cmj8toCy.js";
import { C as retainQueuedAgentRunContext, _ as registerAgentRunContext, c as getAgentRunContext, r as claimAgentRunContext } from "./agent-run-registry-cxavoLf6.js";
...
import { r as classifyRateLimitWindow, t as isReplayUnsafeAssistantError } from "./retry-BCpTPHX5.js";
...
import { S as revokeRuntimeAuthMaterializations, b as recordRuntimeAuthMaterialization } from "./runtime-snapshots-CJ87Vu4S.js";
import { r as resolveSubscriptionAuthModeForProfiles } from "./profile-list-BA-END0g.js";
...
import { a as unwrapSecretSentinelsForProviderEgress, t as protectPreparedProviderRuntimeAuth } from "./provider-secret-egress-BZ7aTRBx.js";
import { c as resolveContextEngine, l as resolveContextEngineOwnerPluginId } from "./registry-BcgtD5p6.js";
import { t as getGlobalHookRunner, x as withPluginRuntimeGenerationScope } from "./hook-runner-global-IYtayVps.js";
import { i as copyReplyPayloadMetadata, p as markReplyPayloadForSourceSuppressionDelivery, t as FAST_MODE_AUTO_PROGRESS_KIND } from "./reply-payload-DVcGHORx.js";
import { n as normalizeMessageChannel } from "./message-channel-core-BDhVfGhd.js";
import { K as updateSessionEntry, O as resolveSessionTranscriptRuntimeTarget, Pt as listSessionEntriesCore, Qt as loadSessionEntry, Y as appendTranscriptMessage, dt as deriveContextPromptTokens, gt as normalizeUsage } from "./session-accessor-Bi6bzKQE.js";
import "./message-channel-normalize-rAbqRXlG.js";
import { o as isMarkdownCapableMessageChannel } from "./message-channel-T4W5YOto.js";
...
import { p as resolveProviderRuntimePluginHandle, s as resolveProviderAuthProfileId, t as attachModelProviderRuntimePluginHandle } from "./provider-hook-runtime-CooYOIsw.js";
import { b as prepareProviderRuntimeAuth } from "./provider-runtime-DLDa-mVy.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, r as ensureAuthProfileStore } from "./store-BfXdFfLh.js";
...
import { a as markAuthProfileFailure, d as resolveProfilesUnavailableReason, o as markInlineProviderApiKeyFailure } from "./usage-BN1_P7wk.js";
import "./sessions-DNOIAOJW.js";
import { C as parseImageSizeError, S as parseImageDimensionError, b as isTimeoutErrorMessage, f as isGenericUnknownStreamErrorMessage, i as isFailoverErrorMessage, s as isLikelyContextOverflowError, t as classifyFailoverReason } from "./classify-DbL6Dp79.js";
import { l as hasOnlyAssistantReasoningContent } from "./ai-transport-runtime-host-DluYWi0I.js";
...
import { n as isToolResultError } from "./tool-result-error-BPVRZjCB.js";
import { t as MissingProviderAuthError } from "./model-auth-runtime-shared-C48YoQY0.js";
import { r as resolveModelCandidateChain } from "./model-fallback-candidates-DmGjEPso.js";
import { n as acquireReadOnlyPreparedModelRuntime, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-WYGCGgEu.js";
import { a as resolveCandidateThinkingLevel, l as resolveAgentHarnessPreparedAuthSupport, u as resolveAgentHarnessPreparedRouteSupport } from "./thinking-runtime-B4nRkQcs.js";
import "./auth-profiles-C5SvE-Ih.js";
import { n as markAuthProfileSuccess } from "./profiles-DNBe9hAz.js";
import { s as isConfigBackedInlineProviderApiKey } from "./model-auth-provider-config-Dg58X7Zu.js";
import { i as getApiKeyForModelCore, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-Dah4Ay9K.js";
...
import { a as describeFailoverError, f as resolveFailoverReasonFromError, i as coerceToFailoverError, p as resolveFailoverStatus, t as FailoverError } from "./failover-error-EKvoWJQa.js";
import { u as projectAgentRunAttemptTerminal } from "./agent-run-terminal-outcome-D3lKKt7D.js";
import { s as createAgentRunDirectAbortError } from "./run-termination-B0y7ra5H.js";
import { m as renderAuthProfileFailoverCopy, o as formatBillingErrorMessage } from "./user-copy-B4A_rZVy.js";
...
import { t as DEFAULT_AGENT_TIMEOUT_MS } from "./timeout-CRSytcvC.js";
import { x as resolveCompactionTimeoutMs, y as compactContextEngineWithSafetyTimeout } from "./diagnostic-CV4vi0UN.js";
import { C as setActiveEmbeddedRun, r as clearActiveEmbeddedRun, u as isEmbeddedAgentRunHandleActive, v as resolveActiveEmbeddedRunHandleSessionId, w as supersedeEmbeddedAgentRunByRunId, y as resolveActiveEmbeddedRunHandleSessionIdBySessionFile } from "./runs-CS8YarJf.js";
...
import { l as isMainSessionRestartRecoveryInputProvenance } from "./input-provenance-BA6fPshG.js";
import { _ as isRateLimitAssistantError, c as formatAssistantErrorText, d as extractObservedOverflowTokenCount, f as isCompactionFailureError, g as isFailoverAssistantError, h as isBillingAssistantError, m as isAuthAssistantError, p as classifyAssistantFailoverReason, t as pickFallbackThinkingLevel } from "./embedded-agent-helpers-kQU3aKSw.js";
import { $ as emitAgentActivityEvent, A as resolveRunLivenessState, B as isCurrentAttemptReplaySafe, C as getProviderPromptState, D as hasYieldContinuationEvidence, E as YIELD_DIAGNOSTIC_TEXT, F as resolveSettledToolTerminalContinuationInstruction, G as isEmbeddedRunTerminalAbort, H as prepareEmbeddedAttemptPromptExecution, I as shouldRetrySilentErrorAssistantTurn, J as resolveEmbeddedRunAttemptTerminalOutcome, K as isEmbeddedRunTerminalInterrupted, L as shouldTreatEmptyAssistantReplyAsSilent, M as shouldRetryMissingAssistantTurn, N as resolveEmptyResponseRetryInstruction, O as resolveIncompleteTurnPayloadText, P as resolveReasoningOnlyRetryInstruction, Q as createToolTerminalObserver, R as isStrictAgenticExecutionContractActive, S as clearProviderPromptState, T as createMcpAttemptCarryover, V as applyResolvedToolPromptFinalizer, X as createEmbeddedRunReplayState, Y as resolveEmbeddedRunAttemptTerminalState, Z as observeReplayMetadata, a as resolveAgentRunSessionTarget, gt as formatEmbeddedRunStageSummary, ht as createEmbeddedRunStageTracker, i as applyAgentRunSessionTargetIdentity, j as resolveSilentToolResultReplyPayload, k as resolveReplayInvalidFlag, mt as createEmbeddedRunStageSummaryEmitter, nt as resolveAttemptWorkspaceSandbox, pt as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, q as isEmbeddedRunTerminalTimeout, r as measureEmbeddedAgentPreparation, w as markLastProviderPromptContextRejected, z as hasAttemptTerminalState } from "./builtin-openclaw-D0Q1zhXV.js";
import { o as getCommandLaneSnapshot, r as enqueueCommandInLane } from "./command-queue-CqN2qr5o.js";
import { l as withGatewayToolCallerIdentity, o as createAdmittedGatewayToolCallerIdentity } from "./gateway-O0XoIBU1.js";
...
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-BFi0qrsP.js";
...
import { l as retireSessionMcpRuntime, u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-manager-api---RxFpSz.js";
import "./agent-bundle-mcp-tools-B8SXI7iq.js";
import { t as log$3 } from "./logger-XkrUQwkD.js";
import { d as waitForDeferredTurnMaintenanceForSession, f as buildContextEngineRuntimeSettings, u as runContextEngineMaintenance } from "./agent-end-side-effects-r6-v7Aaz.js";
import { n as resolveSandboxContext } from "./context-BIHB56yZ.js";
import { l as truncateOversizedToolResultsInActiveTarget, s as sessionLikelyHasOversizedToolResults } from "./transcript-visibility-CSlRT9cQ.js";
import { o as runAgentCleanupStep, r as resolveSettledTurnFinalizationText } from "./settled-turn-finalization-result-Ytw0EfkW.js";
...
import { _ as buildApiErrorObservationFields, y as shouldSuppressRawErrorConsoleSuffix } from "./model-fallback-attempt-D3nTbYoL.js";
import { n as resolveDelegationCapability } from "./agent-tools-otVG6Kqt.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-Mtb_s-wH.js";
import { n as shouldUseTransientCooldownProbeSlot, r as LiveSessionModelSwitchError } from "./model-fallback-runner-DLRsGagf.js";
import { a as resolveSessionKeyForRequestCore, o as resolveStoredSessionKeyForSessionId } from "./session-ZkoOjfGu.js";
import { i as resolveSessionSuspensionTarget, o as suspendSession, r as resolveSessionSuspensionReason } from "./session-suspension-BtiFbEPP.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-CVttd5qX.js";
import { r as resolveModelAsync, t as createEmptyAgentDiscoveryStores } from "./model-XD8eqVN2.js";
import { t as materializePreparedRuntimeModel } from "./materialize-model-BwpyFizB.js";
import { a as selectContextEngineForTranscriptHost, i as createContextEngineLogicalTurnLease, n as drainPendingContextEngineTurnsBeforeRun } from "./context-engine-turn-attempt-Cm5kF1qa.js";
import { c as selectAgentHarness, l as selectAgentHarnessForPreparedModelProviders, o as runAgentHarnessAttempt, s as runAgentHarnessSettledTurnFinalization, t as agentHarnessBuildsOpenClawTools } from "./selection-CnyHL3wD.js";
import { n as readChannelSourceTurnId, r as readChannelSourceTurnSameThreadRequired } from "./source-turn-id-BnVTXtrn.js";
import { n as buildAgentRuntimePlan } from "./build-rov4bnOD.js";
import { i as mergeAttemptToolMediaPayloads, r as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-NI6V6kGv.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-DerVfk-b.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-Dt_gQvNO.js";
import { n as maybeCompactAgentHarnessSession, r as isRecoverableNativeHarnessBindingFailure, t as resolveContextEngineCompactionSuccessor } from "./compaction-successor-DjbOOjbP.js";
import { i as resolveCredentialScopedAuthAttemptModelDecision, n as hasPreparedAuthAttemptModelMetadata, r as providerUsesCredentialScopedModelMetadata, t as createPreparedRuntimeModelMaterializer } from "./credential-scoped-model-YTLKE0bm.js";
import { i as withSessionPlacementTurnAdmission, n as resolveSessionPlacementSandbox } from "./session-placement-admission-CG0soa0B.js";
import { t as DEFERRED_CONTEXT_ENGINE_COMPACTION_REASON } from "./compact-reasons-D69aGDYv.js";
import { a as compactionCheckpointStore, c as resolveCompactionRuntimeSelection, d as resolveProjectKey, i as resolveTieredModel, l as asCompactionHookRunner, n as compactNativeCliSession, o as persistCompactionCheckpoint, s as prepareCompactionHarnessAuth, u as runPostCompactionSideEffects } from "./compact-C85mdpS2.js";
import { i as runBeforeAgentReplyForTurn, n as resolveAuthProfileFailureReason, r as buildHandledBeforeAgentReplyPayloads, t as buildEmbeddedRunPayloads } from "./payloads-7Vvhoda6.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-BrDfJg6S.js";
import { r as stripOpenClawMcpToolPrefix } from "./tool-policy-DbdtO-eX.js";
import { a as resizeExecApprovalContinuationPrompt } from "./bash-tools.exec-approval-output-CMOkHvfh.js";
import { a as resolveHookModelSelection, i as resolveEmbeddedRuntimeModelPolicy, n as createNativeModelOwnedRuntimeModel, o as resolveNativeModelOwnedHarnessId, r as resolveAgentHarnessRunAdmissionError, t as buildBeforeModelResolveAttachments } from "./setup-DY4jpG0U.js";
import { r as readSourceReplyDeliveryRuntime } from "./source-reply-delivery-runtime-D3ljIhoI.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-l66kDCAk.js";
...
async function compactEmbeddedAgentSessionImpl(inputParams) {
	...
	const run = async () => {
		...
		try {
			return await compactResolvedContextEngine(preparedParams, contextEngine, agentDir, resolvedWorkspaceDir, lease.snapshot, () => {
...
async function compactResolvedContextEngine(params, contextEngine, agentDir, resolvedWorkspaceDir, preparedModelRuntime, releaseContextEngineOwnership) {
	...
	if (lockedNativeHarness) return harnessResult ? {
		...harnessResult,
...
async function retireDispatchSessionMcpRuntime(params) {
	try {
		const { retireSessionMcpRuntime, retireSessionMcpRuntimeForSessionKey } = await import("./agent-bundle-mcp-tools-_olmP0y_.js");
...
async function handleEmbeddedAssistantFailure(input) {
	...
	const outcome = await handleAssistantFailover({
		...
		failoverReason: assistantFailoverReason,
		harnessOwnsTransport: input.pluginHarnessOwnsTransport,
		allowSameModelIdleTimeoutRetry: timedOut && idleTimedOut && !timedOutDuringCompaction && !input.fallbackConfigured && input.canRestartForLiveSwitch && input.sameModelIdleTimeoutRetries < 1,
		assistantProfileFailureReason,
...
async function dispatchEmbeddedRunAttempt(input) {
	...
	const attemptParams = {
		...
		agentHarnessEpoch: runtime.agentHarnessEpoch,
...
async function claimAgentSessionWriter(params) {
	...
	const claimed = await updateSessionEntry({
		...
		return { activeWriterRunId: params.runId };
	}, { skipMaintenance: true });
...
async function recoverEmbeddedRunAttempt(input) {
	...
	const retry = (updates) => ({
		...
		sameModelIdleTimeoutRetries: updates?.sameModelIdleTimeoutRetries ?? input.sameModelIdleTimeoutRetries,
	...
	if (!currentAttemptReplaySafe) return {
		action: "proceed",
	...
	if (timedOut && !timedOutByRunBudget && !timedOutDuringCompaction && !timedOutDuringToolExecution && !externalAbort && !signalOwnedInterruption && !attempt.codexAppServerFailure && attempt.promptTimeoutOutcome?.replayInvalid !== true && normalizedAttempt.canRestartForLiveSwitch && !hasAttemptTerminalState(attempt) && shouldRetryMissingAssistantTurn({
		payloadCount: 0,
		aborted,
		promptError,
		timedOut,
		...
		attempt
	}) && input.sameModelIdleTimeoutRetries < 1) {
		runInput.laneController.throwIfAborted();
		sessionPromptState.suppressNextUserMessagePersistence = sessionPromptState.activePrompt.persisted;
		input.traceAttempts.push({
			provider: preparedRuntime.provider,
		...
		log$3.warn(`no-output prompt timeout for ${preparedRuntime.provider}/${preparedRuntime.modelId}; retrying same model once retry=${input.sameModelIdleTimeoutRetries + 1}/1 runId=${params.runId} sessionId=${params.sessionId}`);
		return retry({
...
//#endregion
//#region src/agents/embedded-agent-runner/run/fallback-telemetry.ts
const fallbackTelemetryReasonSet = /* @__PURE__ */ new Set([
	"auth",
	"auth_permanent",
	"format",
	"rate_limit",
...
function resolveFallbackTelemetryReason(value) {
	return value && fallbackTelemetryReasonSet.has(value) ? value : null;
}
//#endregion
...
function resolveEmbeddedRunEffectiveModel(params) {
	...
	const agentContextTokens = resolveAgentConfig(params.runParams.config ?? {}, sessionAgentId)?.contextTokens;
...
async function resolveEmbeddedRunModelSetup(params) {
	...
	const hookSelection = await resolveHookModelSelection({
		...
		modelSelectionLocked: runParams.modelSelectionLocked,
		boundHarnessRuntime: runParams.modelSelectionLocked && runParams.agentHarnessEpoch?.trim() ? runParams.agentHarnessId ?? runParams.agentHarnessRuntimeOverride : void 0,
		config: runParams.config,
		hookRunner: params.hookRunner,
		hookContext: params.hookContext
	});
	const modelSelectionChangedByHook = hookSelection.provider !== params.provider || hookSelection.modelId !== params.modelId;
	const thinkingLevelChangedByHook = hookSelection.thinkingLevelOverride !== void 0;
	if (hookSelection.thinkingLevelOverride !== void 0) runParams.thinkLevel = hookSelection.thinkingLevelOverride;
	if (hookSelection.fastModeOverride !== void 0) runParams.fastMode = hookSelection.fastModeOverride;
...
async function prepareEmbeddedRunRuntime(input) {
	...
	const { requestedModelId, requestedProvider, requestedModel, fallbackUsed, modelSelectionChangedByHook, thinkingLevelChangedByHook, requestStreamTransportOverrides, expectedHarnessArtifact, nativeModelOwnedHarnessId, nativeModelOwned, modelConfigProvider, model, authStorage, modelRegistry } = modelSetup;
	...
	const initialThinkLevel = modelSelectionChangedByHook || thinkingLevelChangedByHook ? resolveCandidateThinkingLevel({
		cfg: params.config,
		provider,
		modelId,
	...
	const endpointClass = resolveProviderEndpoint(effectiveModel.baseUrl, compatibleMetadataSnapshot?.owners).endpointClass;
	const providerOwner = [
		"default",
		"invalid",
		"local",
		"custom"
	].includes(endpointClass) ? void 0 : endpointClass;
...
function createEmbeddedRunSessionPromptState(input) {
	...
	return {
		...
		continueFromCurrentTranscript: () => activateInternalPrompt(MID_TURN_PRECHECK_CONTINUATION_PROMPT),
...
function resolveOpaqueHarnessMaterialization(input, credential) {
	if (!input.pluginHarnessOwnsAuthBootstrap || input.apiKeyInfo || hasInlineCredentialMaterial(credential) || !isModelApi(input.modelApi)) return;
...
async function runPreparedEmbeddedLoop(input) {
	...
	const resolveRuntimeFallbackReason = () => {
		return resolveFallbackTelemetryReason(traceAttempts.findLast((attempt) => attempt.result === "fallback_model" && typeof attempt.reason === "string")?.reason ?? lastRetryFailoverReason);
	};
...
async function runEmbeddedAgentInternal(paramsInput) {
	...
	return enqueueSession(async () => {
		...
		return enqueueGlobal(async () => {
			...
			const preparedModelRuntimeLease = await withEmbeddedRunLaneProgressHeartbeat(noteLaneTaskProgress, () => params.preparedModelRuntimeMode === "isolated-read-only" ? acquireReadOnlyPreparedModelRuntime(preparedInput) : acquireAgentRunPreparedModelRuntime(preparedInput, {
				retainIdleRunOwner,
				catalogMode: "static"
			}));
