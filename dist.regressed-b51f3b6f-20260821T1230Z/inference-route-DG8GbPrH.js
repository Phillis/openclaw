...
import { _ as toAgentEntriesRecord, g as resolveSystemAgentTargetAgentId, r as listAgentEntries } from "./agent-scope-config-BdXMWufB.js";
...
async function resolveSystemAgentConfiguredRouteFromConfig(runConfig, requestedAgentId, deps = {}) {
	const [agentScope, modelSelection, modelRuntimeAliases, simpleCompletion, harnessPolicy] = await Promise.all([
		...
		import("./model-selection-BGyFP5MQ.js"),
		import("./model-runtime-aliases-DhbFomGU.js"),
		import("./simple-completion-runtime-D5XkLb5Y.js"),
		import("./policy-BXzS5qsy.js")
	]);
...
async function projectInferenceRoute(config, requestedAgentId, deps = {}) {
	const { resolveProviderIdForAuth } = await import("./provider-auth-aliases-DnLiLd92.js");
