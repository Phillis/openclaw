...
import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-_X1FPu-e.js";
...
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-B7ZROGei.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BIC1B3Gn.js";
import { r as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-Fc8DRSVR.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-BWdYXYvl.js");
		...
		if (codexInstall.installed) {
			const { offerPostInstallMigrations } = await import("./setup.post-install-migration-Dtp1H35K.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-DmYzd7eU.js");
