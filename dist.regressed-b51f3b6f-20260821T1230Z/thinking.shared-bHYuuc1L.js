...
function resolveThinkingDefaultForModelCore(params) {
	return (params.catalog?.find((entry) => entry.provider === params.provider && entry.id === params.model))?.reasoning ? "low" : "off";
}
