...
import { H as resolveExecModePolicy, K as loadExecApprovals } from "./exec-approvals-DkNiV-ux.js";
...
import { r as materializeGatewayAuthSecretRefs, t as canMaterializeGatewayAuthSecretRefsWithoutExec } from "./auth-config-utils-DespIC0A.js";
import { n as normalizeConfiguredTrustedSafeBinDirs, t as normalizeConfiguredSafeBins } from "./exec-safe-bin-config-DXKgjJHQ.js";
import { o as readControlUiDeviceAuthMigrationState } from "./control-ui-device-auth-migration-9nZJw2eo.js";
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-Bv2r7TNj.js";
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-CEJjFxu0.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-Bsacf61T.js";
...
const loadReadOnlyChannelPlugins = createLazyRuntimeModule(() => import("./read-only-CLmWIRvW.js"));
...
const loadPluginMetadataRegistryLoaderModule = createLazyRuntimeModule(() => import("./metadata-registry-loader-COl3TArQ.js"));
const loadPluginAutoEnableModule = createLazyRuntimeModule(() => import("./plugin-auto-enable-oIm11A37.js"));
const loadChannelPluginIdsModule = createLazyRuntimeModule(() => import("./channel-plugin-ids-Dp2vkB3r.js"));
const loadPluginRuntimeModule = createLazyRuntimeModule(() => import("./runtime-DRcYVNay.js"));
const loadGatewayProbeDeps = createLazyRuntimeModule(() => Promise.all([
	import("./call-DrX49UA-.js"),
	import("./probe-auth-quHZid1R.js"),
	import("./probe-BAEt3XlW.js")
