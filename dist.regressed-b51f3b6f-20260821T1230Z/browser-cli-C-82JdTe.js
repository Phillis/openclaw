...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-V2wZu7Ms.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [command("cookie-sync", "Sync allowlisted macOS browser cookies to a managed profile")],
		register: async (args) => {
			(await import("./browser-cli-cookie-sync-Hj_gkwre.js")).registerBrowserCookieSyncCommand(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-D19ZGHN5.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-CBRQLRsl.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-ClmNlSyo.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-JENXqoGU.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-DSey_vfO.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [command("extension", "Chrome extension install, status, and pairing")],
		register: async (args) => {
			(await import("./browser-cli-extension-DnN_HGGL.js")).registerBrowserExtensionCommands(args.browser, args.parentOpts, args.pluginRoot);
		}
	}
];
