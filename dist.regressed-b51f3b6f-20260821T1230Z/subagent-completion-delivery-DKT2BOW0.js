...
import { H as bindDeliveryQueueEntry, K as loadDeliveryQueueEntryInDatabase, X as upsertBoundDeliveryQueueEntryInDatabase, h as runOpenClawStateWriteTransaction } from "./openclaw-state-db-DlCMR4eQ.js";
import { b as findTaskByRunId, v as publishTaskRecordAfterAtomicStore, x as getTaskById } from "./task-registry-8pMJUb3L.js";
import { p as upsertTaskRunRowInDatabase, t as bindTaskRecord } from "./task-registry.store.sqlite-DF7-e6ST.js";
import "./runtime-internal-PbSlUl9p.js";
import { S as subagentRuns, c as upsertSubagentRunRowInDatabase, p as ensureDeliveryState, t as bindSubagentRunRecord } from "./subagent-registry.store.sqlite-okpdNwYx.js";
import { a as getErrnoCode, c as resolveDeliveryRecoveryDeadlineMs, n as createDeliveryRecoveryCoordinator, o as isDeliveryRecoveryRetryEligible, r as createEmptyDeliveryRecoverySummary, t as computeBackoffMs } from "./delivery-recovery.shared-BBO0H6XC.js";
import { L as resolveSubagentCompletionResultText, T as safeRemoveAttachmentsDir, g as ANNOUNCE_COMPLETION_HARD_EXPIRY_MS, s as loadPendingFinalDeliveryPayload } from "./subagent-registry-lifecycle-delivery-ARAD0SRG.js";
import { a as getDeliveryQueueEntryStatus } from "./delivery-queue-sqlite-CW1nsWu_.js";
import { _ as markSessionDeliverySettlement, a as SessionDeliveryDeferredError, b as releaseSessionDeliveryClaim, h as loadPendingSessionDelivery, i as SessionDeliveryDeadLetteredError, l as completeSessionDelivery, m as loadPendingSessionDeliveries, n as SessionDeliveryAcknowledgementFinalizeError, o as SessionDeliveryRetryChargedError, p as failSessionDelivery, r as SessionDeliveryAttemptStartError, s as SessionDeliverySafeRetryError, t as SESSION_DELIVERY_QUEUE_NAME, v as moveSessionDeliveryToFailed, y as prepareClaimedSessionDelivery } from "./session-delivery-queue-storage-D6w_XE9_.js";
...
async function settleCorrelatedSubagentDelivery(queued, outcome) {
	...
	publishCommittedRecords(subagent, projectedTask);
	if (outcome === "recovered") {
		const { resumeSubagentRun } = await import("./subagent-registry-BeTV-3wU.js");
