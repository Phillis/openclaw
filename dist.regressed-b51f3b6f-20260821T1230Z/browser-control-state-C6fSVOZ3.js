...
import { x as BrowserProfileUnavailableError } from "./tmp-openclaw-dir-DEhTWXIG.js";
import "./config-B8NE56GF.js";
import { d as markBrowserRuntimeStopping, r as beginProfileTransition, s as isBrowserRuntimeRunning } from "./server-context.lifecycle-DHjN2YTj.js";
import { a as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context-C2rqVjpc.js";
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-BHFmz3Y-.js";
...
async function stopBrowserRuntimeInternal(params, finalizeGlobalAdapters) {
	...
	if (finalizeGlobalAdapters) try {
		const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-BH6-FkJy.js");
