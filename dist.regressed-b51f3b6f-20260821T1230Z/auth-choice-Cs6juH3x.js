...
import { l as publishPreparedModelRuntimeSnapshot } from "./prepared-model-runtime-WYGCGgEu.js";
...
import { r as prepareAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-D-xjwtEF.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-BFi0qrsP.js";
import "./provider-auth-choice-preference-Mrxqvxuo.js";
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-uV9dI-qY.js");
