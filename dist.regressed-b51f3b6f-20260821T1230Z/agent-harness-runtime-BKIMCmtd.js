...
import { d as listCodexAppServerExtensionFactories } from "./loader-lwogLCXu.js";
import "./registry-GCsrA8Io.js";
import "./provider-request-config-DRrgUN7e.js";
import "./registry-BcgtD5p6.js";
import { g as joinPresentTextSegments, t as getGlobalHookRunner } from "./hook-runner-global-IYtayVps.js";
import "./reply-payload-DVcGHORx.js";
import "./session-accessor-Bi6bzKQE.js";
import "./agent-tools.before-tool-call-BzRsADjV.js";
...
import { g as queueEmbeddedAgentMessageWithOutcome } from "./runs-CS8YarJf.js";
import "./gateway-O0XoIBU1.js";
import "./tools-cCwmXcan.js";
import "./tool-mutation-D4StAzyF.js";
import "./embedded-agent-messaging-DuLq2wI6.js";
import "./hook-helpers-B9fJlULF.js";
...
import "./bootstrap-files-DQdZlI4U.js";
import "./agent-end-side-effects-r6-v7Aaz.js";
import "./fs-bridge-TWeIQFlK.js";
import "./sandbox-DncyGHry.js";
import "./nodes-utils-DYTIeeDl.js";
import "./settled-turn-finalization-result-Ytw0EfkW.js";
import { v as wrapPluginSystemContextSection } from "./attempt-prompt-helpers-u9zLew6I.js";
import "./heartbeat-tool-response-CyHYyyCM.js";
import "./tools-CGECsagn.js";
import "./tool-schema-projection-ZrMdwk4s.js";
import "./attempt-tool-construction-plan-D_uFFO7I.js";
import "./embedded-agent-tool-media-C07_WYB-.js";
import "./embedded-agent-tool-results-BIgvsn9M.js";
import "./embedded-agent-message-tool-source-reply-VM7sJo0s.js";
import { s as buildAgentHookContext } from "./lifecycle-hook-helpers-BIigCxgL.js";
import "./attempt-thread-helpers-C0Wm7-vX.js";
import { n as prepareWatchedSessionsPrompt, t as buildWatchedSessionsPromptLines } from "./watched-sessions-prompt-DtidNWPc.js";
import "./transcript-credential-safety-CbpQd_gv.js";
import "./tool-result-middleware-BgNE3Q6o.js";
import "./result-fallback-classifier-D8qWB51S.js";
import "./build-rov4bnOD.js";
import "./native-hook-relay-XDvT-D3t.js";
...
async function loadCodexBundleMcpThreadConfig(params) {
	const { loadCodexBundleMcpThreadConfigCore: load } = await import("./codex-mcp-config-6CpB6JVg.js");
	return load(params);
}
/**
...
async function prepareHarnessNativeMcpAppPreview(params) {
	...
	const { buildMcpAppCanvasPayload, fetchMcpAppView } = await import("./mcp-ui-resource-BeuGt5j4.js");
...
async function materializeRequesterScopedMcpToolsForHarnessRun(params) {
	...
	const { materializeRequesterScopedMcpToolsForHarnessRunCore: materialize } = await import("./agent-bundle-mcp-harness-41a531S1.js");
