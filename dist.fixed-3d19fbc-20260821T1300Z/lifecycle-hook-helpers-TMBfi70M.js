...
import { n as buildAgentHookContextIdentityFields } from "./hook-agent-context-D6EJ_Q3z.js";
...
const deferredAgentEndHooks = /* @__PURE__ */ new Map();
...
function resolveAgentEndRunId(params) {
	return params.event.runId ?? params.ctx.runId;
}
function bufferDeferredAgentEndHook(params) {
...
function runAgentHarnessAgentEndHook(params) {
	if (bufferDeferredAgentEndHook(params)) return;
