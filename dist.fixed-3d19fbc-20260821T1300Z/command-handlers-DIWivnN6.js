...
import { u as resolveProfileUnusableUntilForDisplay } from "./usage-Cj2wt9Ks.js";
import { r as resolvePersistedSessionRuntimeId } from "./session-runtime-compat-DNLW-mvy.js";
...
import { M as CODEX_PLUGINS_MARKETPLACE_NAME, _ as sessionBindingIdentity, i as bindingStoreKey, m as reclaimCurrentCodexSessionGeneration, o as createCodexSessionGenerationSupersededError, r as assertCodexBindingMayBeReplaced, u as normalizeCodexAppServerBindingModelProvider, x as resolveCodexAppServerRuntimeOptions, z as isCodexFastServiceTier } from "./session-binding-BpH4J33R.js";
import { U as consumeCodexAppServerLiveThread, d as releaseLeasedSharedCodexAppServerClient, et as resolveCodexAppServerAuthAccountCacheKey, nt as resolveCodexAppServerAuthProfileIdForAgent, rt as resolveCodexAppServerFallbackApiKeyCacheKey, s as getLeasedSharedCodexAppServerClient, ut as isJsonObject } from "./shared-client-fWU6PNZb.js";
import "./text-utility-runtime-BSdEoze8.js";
import { E as refreshCodexPluginRuntimeState, O as isOpenAiCuratedMarketplaceName } from "./thread-lifecycle-C6hJgTs0.js";
import { i as assertCodexThreadResumeResponse } from "./protocol-validators-DQMpwHD0.js";
import { s as summarizeCodexAccountUsage } from "./rate-limits-CiiXaSRg.js";
import { t as CODEX_CONTROL_METHODS } from "./capabilities-CQCaXeG3.js";
import { a as formatComputerUseStatus, c as formatSkills, i as formatCodexStatus, l as formatThreads, n as formatAccount, o as formatList, r as formatCodexDisplayText, s as formatModels, t as buildHelp } from "./command-formatters-CHrdGNjO.js";
import "./incognito-session-ciRDvbn4.js";
import { i as defaultCodexAppInventoryCache, r as buildCodexPluginAppCacheKey } from "./plugin-app-cache-key-woCyhZVi.js";
import { n as resolveCodexBindingAppServerConnection } from "./binding-connection-6mA45ibB.js";
import { n as resolveCodexNativeExecutionBlock, r as resolveCodexNativeSandboxBlock } from "./sandbox-guard-COdvM8Fk.js";
import { i as readCodexComputerUseStatus, r as installCodexComputerUse, t as defaultCodexPluginMetadataCache } from "./plugin-metadata-cache-FAzzOjq_.js";
import "./model-session-runtime-C3eetqHx.js";
import { t as listAllCodexAppServerModels } from "./models-ZL7GCGE7.js";
import { a as rollbackCodexAppServerBindingSubscription, i as retireCodexConversationThreadBinding, n as releaseCodexAppServerBindingSubscription, o as withCodexConversationThreadActivity, r as retainCodexAppServerBindingSubscription, s as withExclusiveCodexAppServerThread, t as isSameCodexAppServerThreadOwner } from "./thread-ownership-DQ1Zt4t6.js";
import { a as parseCodexPermissionsModeArg, c as setCodexConversationModel, d as stopCodexConversationTurn, i as parseCodexFastModeArg, l as setCodexConversationPermissions, m as canMutateCodexHost, n as parseCodexPluginMarketplaceId, o as readCodexConversationActiveTurn, p as CODEX_NATIVE_EXECUTION_AUTH_ERROR, r as formatPermissionsMode, s as setCodexConversationFastMode, t as discoverCodexMarketplacePlugins, u as steerCodexConversationTurn } from "./plugin-marketplace-discovery-BxSdqXzh.js";
import { i as readCodexConversationBindingData, n as createCodexConversationBindingData, o as resolveCodexDefaultWorkspaceDir, t as createCodexCliNodeConversationBindingData } from "./conversation-binding-data-B5PuOlFt.js";
import { c as formatCodexCliSessions, i as safeCodexControlRequest, n as readCodexStatusProbes, r as requestOptions, t as codexControlRequest } from "./command-rpc-DpupuFui.js";
...
async function resumeThread(deps, ctx, pluginConfig, args) {
	...
	return await withExclusiveCodexAppServerThread({
		...
		run: async () => await deps.bindingStore.withLease(identity, async () => {
			...
			const commitResumedThread = async (value, client) => {
				...
				const sameOwner = client ? isSameCodexAppServerThreadOwner(bindingBeforeCommit, {
				...
				try {
					if (client) {
						retained = await retainCodexAppServerBindingSubscription(client, effectiveThreadId, sameOwner ? await consumeCodexAppServerLiveThread(client, effectiveThreadId) : void 0);
					...
					if (client && !sameOwner) await rollbackCodexAppServerBindingSubscription(client, effectiveThreadId, retained);
					throw error;
				}
			...
			if (!committedResponse) await commitResumedThread(response);
			return `Attached this OpenClaw session to Codex thread ${formatCodexDisplayText(normalizedThreadId)}.`;
		})
	});
}
...
async function setConversationModel(deps, ctx, pluginConfig, args) {
	...
	if (!normalized) {
		...
		const selectedModel = currentSession && currentSession.sessionId === ctx.sessionId ? currentSession.modelOverride : void 0;
		const binding = await deps.bindingStore.read(target.identity);
	...
	return await deps.setCodexConversationModel({
		...
		agentDir: target.agentDir,
		config: ctx.config,
		...ctx.sessionId && ctx.sessionKey ? { session: {
