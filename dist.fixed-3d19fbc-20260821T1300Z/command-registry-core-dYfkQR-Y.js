...
import { a as defineImportedCommandGroupSpec, i as buildCommandGroupEntries, o as defineImportedProgramCommandGroupSpecs } from "./register.subclis-core-DXNu89Hh.js";
...
const coreEntrySpecs = [
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([
		{
			...
			loadModule: () => import("./register.setup-ITpf4hz0.js"),
			exportName: "registerSetupCommand"
		},
		{
			commandNames: ["onboard"],
			loadModule: () => import("./register.onboard-AHd3l8Q2.js"),
		...
		},
		{
			...
			loadModule: () => import("./register.maintenance-BOYgtSqz.js"),
	...
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([{
		commandNames: ["mcp"],
		loadModule: () => import("./mcp-cli-CtsWyMoy.js"),
	...
	defineImportedCommandGroupSpec(["agent"], () => import("./register.agent-turn-B1NZYeEj.js"), (mod, { program, ctx }) => {
	...
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([{
		...
		loadModule: () => import("./register.status-health-sessions-Ds0yg62m.js"),
