...
import { v as getPluginRegistryRuntime } from "./loader-BIAS8vL1.js";
...
import { p as recordSessionStateEvent } from "./session-state-events-DTKQ6kKc.js";
import { a as upsertSessionUpstreamLink } from "./session-upstream-links-i-TvS0qu.js";
import { _ as createConversationBindingRecord, a as buildPluginBindingIdentity, b as unbindConversationBindingRecord, t as bindConversationNow, v as resolveConversationBindingRecord } from "./conversation-binding-BvCkFpTC.js";
import { n as projectSessionActor } from "./session-utils-row-xwseApeF.js";
import { n as tryResolveSessionCompatibilityOwnerAgentId } from "./session-request-agent-D8DcCzQX.js";
import { u as hasMultipleSessionSharingIdentities } from "./user-profiles-BhIW_Pod.js";
...
function catalogStartHandler(resolveProvider, resolveCreateTarget) {
	return async (opts) => {
		...
		const { openTerminalSession, CATALOG_TERMINAL_INITIAL_SIZE } = await import("./terminal-dsx0JeNI.js");
