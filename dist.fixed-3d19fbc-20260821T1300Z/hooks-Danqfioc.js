...
function createGatewayHooksRequestHandler(params) {
	...
	const loadIsolatedAgentModule = () => isolatedAgentModulePromise ??= import("./isolated-agent-C12eAxck.js");
