...
import { a as listAgentIds, b as tryResolveLegacyCompatibilityAgentId, t as AgentSelectionRequiredError, x as tryResolveSoleAgentId } from "./agent-scope-config-CsnnOL14.js";
...
import { _ as randomIdempotencyKey, h as isGatewayTransportError, m as isGatewayExplicitAuthRequiredError, p as isGatewayCredentialsRequiredError, s as callGateway, v as readGatewayDispatchConfig, y as readGatewayDispatchConfigWithShellEnvFallback } from "./call-CZ1eu88h.js";
...
import { n as createEmbeddedStateSignalBridge } from "./embedded-state-lock-BTnirnZr.js";
...
async function startOneShotDiagnosticsExporters(params) {
	...
	const [{ loadOpenClawPlugins }, { startPluginServices }] = await Promise.all([import("./plugins/loader.js"), import("./services-VeqUXS5v.js")]);
...
const embeddedAgentCommandLoader = createLazyPromiseLoader(() => import("./agent-DfZ6G-mu.js").then((module) => module.agentCommand), { cacheRejections: true });
const localAuditModuleLoader = createLazyPromiseLoader(() => import("./agent-local-audit-B9V68QLc.js"), { cacheRejections: true });
const agentSessionModuleCache = createLazyPromiseLoader(() => agentSessionModuleLoader(), { cacheRejections: true });
const runtimeConfigModuleLoader = createLazyPromiseLoader(() => import("./io-CdPYG-9e.js"), { cacheRejections: true });
const embeddedStateLockModuleLoader = createLazyPromiseLoader(() => import("./embedded-state-lock-DWKjt36u.js"), { cacheRejections: true });
