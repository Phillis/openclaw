...
import { t as detectSkillWorkshopToolPolicyDiagnostic } from "./tool-policy-diagnostic-Cy8Nvyxf.js";
...
async function collectWorkspaceSuggestionNotesWithRuntime(workspaceDir) {
	const { collectWorkspaceBackupTip } = await import("./doctor-state-integrity-D1mYEVuh.js");
...
const bootstrapSizeCheck = {
	...
	async detect(ctx) {
		...
		const { resolveBootstrapMaxChars, resolveBootstrapTotalMaxChars } = await import("./embedded-agent-helpers-CCurOHgf.js");
