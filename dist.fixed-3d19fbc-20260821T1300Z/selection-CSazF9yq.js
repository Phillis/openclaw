...
import { a as resolveAgentHarnessOwnerPluginId, n as getRegisteredAgentHarness, r as listRegisteredAgentHarnesses } from "./registry-BG-SOVGv.js";
import { a as unwrapSecretSentinelsForProviderEgress, i as unwrapModelHeaderSentinelsForProviderEgress } from "./provider-secret-egress-NmAMmdEt.js";
import { f as resolveProviderRefOwnership } from "./providers-CEVEnHVm.js";
...
import { c as compareHarnessSupport, l as resolveAgentHarnessPreparedAuthSupport, s as buildAgentHarnessSupportContext, u as resolveAgentHarnessPreparedRouteSupport } from "./thinking-runtime-_QT_qncS.js";
import { _ as MissingAgentHarnessError, b as recordAgentHarnessPreflightOwner, h as AgentHarnessPreflightError } from "./failover-error-DKFCUqL9.js";
import { l as normalizeAgentRunAttemptTerminal, u as projectAgentRunAttemptTerminal } from "./agent-run-terminal-outcome-CpRY9lPn.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DlGUtpYV.js";
import { n as isBuiltInOpenClawAgentHarness, t as createOpenClawAgentHarness } from "./builtin-openclaw-BGUR8SQC.js";
import { i as resolveGroupToolPolicy } from "./agent-tools.policy-Ba4icL7P.js";
...
import { i as EmptySettledTurnFinalizationError, t as assertSettledTurnFinalizationResult } from "./settled-turn-finalization-result-DJ-XWS4f.js";
...
import { t as createAgentHarnessHostCapabilities } from "./host-capability-DxhOeMh0.js";
...
async function runSelectedAgentHarnessAttempt(params) {
	...
	if (internalParams.systemAgentTool && !isSystemAgentOnlyAllowlist(internalParams.toolsAllow)) throw new Error("OpenClaw host authority requires toolsAllow: [\"openclaw\"]");
	const ringZeroTools = internalParams.systemAgentTool ? [(await import("./system-agent-tool-CSc7tesx.js")).createSystemAgentTool(internalParams.systemAgentTool)] : [];
