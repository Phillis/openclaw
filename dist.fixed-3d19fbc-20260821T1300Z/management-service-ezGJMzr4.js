...
import { T as collectChangedPaths, d as readConfigFileSnapshotForWrite } from "./io-BTBpQ7uO.js";
...
import { _ as resolveOfficialExternalPluginId, f as listOfficialExternalPluginCatalogEntries, m as loadConfiguredHostedOfficialExternalPluginCatalogEntries, o as getOfficialExternalPluginCatalogManifest, v as resolveOfficialExternalPluginInstall, y as resolveOfficialExternalPluginLabel } from "./official-external-plugin-catalog-BEMBT-Dn.js";
import { i as resolveTrustedSourceLinkedOfficialClawHubSpec, n as resolveTrustedOfficialClawHubPackageName, o as resolveTrustedSourceLinkedOfficialNpmSpec } from "./official-external-install-records-BB1DFCD4.js";
import { c as resolvePluginControlPlaneWorkspace, s as appendPluginControlPlaneWorkspaceDiagnostic } from "./plugin-registry-snapshot-CxbzdC9E.js";
import { n as resolveInstalledPluginPackageOwnership } from "./installed-plugin-package-ownership-PaAV_6Ek.js";
import { i as loadPluginMetadataSnapshot, s as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-DciqS8td.js";
...
import { t as buildNpmResolutionFields } from "./install-source-utils-DyDPgWM7.js";
import { a as withPluginInstallRecords, o as withoutPluginInstallRecords, r as removePluginInstallRecordFromRecords } from "./installed-plugin-index-records-1BeSqHzt.js";
...
import { a as planPluginUninstall, n as applyPluginUninstallDirectoryRemoval, o as pluginUninstallTargetExists, r as formatUninstallActionLabels } from "./uninstall-DyFfFHQ5.js";
...
import { t as applySlotSelectionForPlugin } from "./slot-selection-DPo4MrLX.js";
import { i as selectInstallMutationWriteOptions, r as resolveInstallConfigMutationPreflights, t as persistPluginInstall } from "./install-persistence-BkwbUaqu.js";
import { i as installPluginFromNpmPackArchive, n as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-BtauIEia.js";
...
import { t as collectClawPluginUninstallWarnings } from "./uninstall-claw-references-BAuL_ZNz.js";
...
async function listManagedPlugins(params) {
	...
	const diagnostics = appendPluginControlPlaneWorkspaceDiagnostic(metadata.diagnostics, workspace);
...
async function installManagedPluginSource(params) {
	...
	const complete = async (installResult, completed) => {
		...
		const cleanupOnPersistenceFailure = request.source === "local" && request.link ? false : params.cleanupOnPersistenceFailure ?? true;
...
//#endregion
export { listManagedPlugins as a, setManagedPluginEnabled as c, installManagedPluginSource as i, uninstallManagedPlugin as l, clearManagedPluginOfficialCatalogCache as n, resolveManagedPluginIconUrl as o, installManagedPlugin as r, resolveManagedSetupCatalogIconUrl as s, ManagedPluginLifecycleError as t };
