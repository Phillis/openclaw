...
import { C as createChildDiagnosticTraceContext, M as parseDiagnosticTraceparent, N as runWithDiagnosticTraceContext, c as emitTrustedSecurityEvent, w as createDiagnosticTraceContext } from "./diagnostic-events-Djn4AVRp.js";
import { c as resolveRuntimeServiceBuildId, l as resolveRuntimeServiceVersion } from "./version-o4XN9fka.js";
import { n as sha256Base64Url, o as sha256HexPrefixCore } from "./crypto-digest-PR8Utwzg.js";
import { c as getActivePluginGatewayNodePolicyRegistry } from "./runtime-LV4GwzTm.js";
import { c as WRITE_SCOPE, r as PAIRING_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-Dw7Gu2cA.js";
import { i as runUtf8CommandWithTimeout } from "./exec-Cmwsxh9J.js";
import { a as isLoopbackAddress, i as isLocalishHost, m as resolveClientIp, n as hasForwardedRequestHeaders, r as isLocalDirectRequest, s as isPrivateOrLoopbackAddress, u as isTrustedProxyAddress } from "./net-BRYQcUG8.js";
import { o as AUTH_RATE_LIMIT_SCOPE_NODE_PAIRING } from "./auth-rate-limit-Bw_B6Pm2.js";
import { n as isGatewayHostBrowserOrigin, r as normalizeChromeExtensionOrigin, t as checkBrowserOrigin } from "./origin-check-DudmUihq.js";
import { t as withSerializedRateLimitAttempt } from "./rate-limit-attempt-serialization-DPdAzsUS.js";
import "./auth-BjIfKFX2.js";
import { a as hasGatewayClientCap, n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-yubNQC1L.js";
import { h as resolveDeviceAuthConnectErrorDetailCode, i as buildPairingConnectErrorMessage, m as resolveAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-Do3cAiyu.js";
import { t as ErrorCodes } from "./gateway-error-details-BWo6Le6w.js";
import "./version-CwNT1gaY.js";
import { a as normalizeDevicePublicKeyBase64Url, t as deriveDeviceIdFromPublicKey } from "./device-identity-C2_6nSqN.js";
...
import { _ as tryBeginGatewayRootWorkAdmission, a as getGatewaySuspendAdmissionPhase, m as runWithGatewayIndependentRootWorkAdmission, o as isGatewayRestartDraining } from "./gateway-work-admission-BNrqZgKC.js";
import { c as isOperatorUiClient, i as isGatewayCliClient, l as isWebchatClient, n as isBrowserOperatorUiClient, r as isEphemeralGatewayClient, t as isBrowserCopilotClient } from "./message-channel-C3nRvjrX.js";
import { Wn as validateRequestFrame, om as GATEWAY_SERVER_CAPS, tt as validateConnectParams } from "./src-BlUKtAtD.js";
import { l as formatValidationErrors, s as errorShape } from "./error-codes-CMSvT5-d.js";
import { c as getUserProfileDisplay, g as classifyTailscaleLogin, i as ensureProfileForTailscaleIdentity, n as adoptTailscaleProfileAvatar, r as ensureProfileForEmail, u as hasMultipleSessionSharingIdentities } from "./user-profiles-BhIW_Pod.js";
import { i as verifyAgentRuntimeIdentityToken } from "./agent-runtime-identity-token-DNvL9Jxl.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-GbDYVJY3.js";
import { i as TALK_PTT_COMMANDS, n as IOS_WATCH_RELAY_COMMANDS, r as PLATFORM_DEFAULTS, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-CcECn3d6.js";
...
import { n as serializeEventPayload } from "./node-registry-CNnSJj8B.js";
...
import { D as BOOTSTRAP_HANDOFF_OPERATOR_SCOPES, F as isNodePairingSetupBootstrapProfile, I as isVoiceNodePairingSetupBootstrapProfile, N as deviceBootstrapProfilesEqual, O as CONTROL_UI_OWNER_BOOTSTRAP_PROFILE, P as isMobilePairingSetupBootstrapProfile, R as resolveBootstrapProfileScopesForRole, a as getDeviceBootstrapTokenProfile, d as restoreGenericDeviceBootstrapToken, i as getBoundDeviceBootstrapProfile, m as verifyDeviceBootstrapToken, u as redeemDeviceBootstrapTokenProfile, z as resolveBootstrapProfileScopesForRoles } from "./device-bootstrap-B0GG6gmu.js";
import { D as verifyDeviceToken, T as updatePairedDeviceMetadata, a as ensureDeviceToken, d as listDevicePairing, f as listEffectivePairedDeviceRoles, l as hasEffectivePairedDeviceRole, m as pruneSupersededSilentPairedDevices, r as approveDevicePairing, s as getPairedDevice, t as approveBootstrapDevicePairing, u as listApprovedPairedDeviceRoles, v as requestDevicePairing, y as resolveEffectiveOperatorDeviceIdentity } from "./device-pairing-CobL1ZXN.js";
import { f as requestNodePairing, n as beginNodePairingConnect, r as finalizeNodePairingCleanupClaim, s as recordPairedNodeConnection, t as approveNodePairing, u as releaseNodePairingCleanupClaim } from "./device-pairing-node-CIHQQGFC.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./remote-D4mAcbRT.js";
import { d as resolvePluginNodeCapabilityExpiresAtMs, o as indexPluginNodeCapabilitySurfaces, p as setClientPluginNodeCapability, r as buildPluginNodeCapabilityScopedHostUrl, s as mintPluginNodeCapabilityToken } from "./plugin-node-capability-SDRFZFm7.js";
import { n as logWs, t as formatForLog } from "./ws-log-ByzETCsI.js";
import { n as listControlUiPluginTabs, r as listControlUiPluginWidgetKinds } from "./control-ui-plugin-tabs-DHrJo-KY.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-BWx0sDdz.js";
import { n as allowedSessionVisibilities } from "./session-sharing-YSn98RD0.js";
import { t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-DYAtPB9Y.js";
import { r as resolveChatAttachmentPolicy } from "./chat-attachment-policy-DrGl1Ors.js";
import { r as prepareGatewayLocalUserIngress, t as attachGatewayLocalUserIngress } from "./local-user-ingress-Oe_iiso6.js";
import { n as parseGatewayRole, r as roleCanSkipDeviceIdentity } from "./role-policy-CY0IAwu_.js";
import { n as loadVoiceWakeConfig } from "./server-utils-DSzqMhGv.js";
import { r as canReadDetailedUpdateMetadata } from "./events-TB-ePJT1.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-Bbs5FPDZ.js";
import { n as clearRemovedNodeRuntimeState, s as reconcileRevokedDeviceWorker } from "./node-runtime-state-wCDwMHq6.js";
import { t as captureAuthenticatedNodePairingState } from "./device-pairing-node-state-DbmGP3Gb.js";
import { t as resolveLocalNodeId } from "./local-id-fSNPzy_y.js";
...
import { a as confirmSetupHandoffDelivery, c as resolveDeviceSignaturePayloadVersion, d as resolveUnauthorizedHandshakeContext, f as shouldAllowSilentLocalPairing, g as resolveConnectAuthState, h as resolveConnectAuthDecision, i as broadcastSetupHandoffDeliveryUncertain, l as resolveHandshakeBrowserSecurityContext, m as shouldSkipLocalBackendSelfPairing, n as resolveEffectiveComputerUseDescriptor, o as consumeSetupHandoff, p as shouldPreserveLocalCliSharedAuthScopes, r as broadcastSetupHandoffCompletion, s as isNativeAppUiClient, t as reconcileNodePairingOnConnect, u as resolvePairingLocality } from "./node-connect-reconcile-CQKNSaci.js";
	...
	const dispatch = async (parsed, client) => {
		...
		const executeRequest = async () => {
			...
			try {
				...
				respondWithAuthority(false, void 0, errorShape(ErrorCodes.UNAVAILABLE, formatForLog(err)));
			} finally {
	...
	if (device && devicePublicKey) {
		...
		const requirePairing = async (reason, existingPairedDevice = null) => {
			...
			const pairing = await requestDevicePairing({
				...
				silent: reason === "scope-upgrade" && !allowSetupCodeHandoffBootstrapPairing && !allowControlUiOwnerBootstrapPairing ? false : allowSilentLocalPairing || allowSilentTrustedCidrsNodePairing || allowSetupCodeHandoffBootstrapPairing || allowControlUiOperatorBootstrapPairing
			});
			const trustedProxyAutoApproveScopes = allowTrustedProxyDeviceAutoApproval && (pairing.request.isRepair !== true || isTrustedProxySameKeyUpgrade) ? applyConnectionScopeCap({
...
async function sendGatewayHello(context, state, pluginSurfaceUrls, authenticatedUserProfileId) {
	...
	const { resolvedAuth, role, scopes, device, devicePublicKey, hasTokenAuth, hasPasswordAuth, bootstrapTokenCandidate, authResult, authMethod, sessionSharedGatewaySessionGeneration, issuedBootstrapProfile, handoffBootstrapProfile, deviceToken, bootstrapDeviceTokens, controlUiDeviceAuthMigrationPending } = state;
...
async function attachAuthenticatedGatewayConnect(context, state) {
	...
	const authenticatedUserIsTailscaleProvider = Boolean(authResult.tailscaleIdentity && classifyTailscaleLogin(authResult.tailscaleIdentity.login).kind === "provider");
	...
	state.scopes = scopes;
	connectParams.scopes = scopes;
	if (authenticatedUserId && effectiveScopes.addedIdentityScopes.length > 0) logGateway.warn(`security audit: identity scope grant elevated connection identity=${formatForLog(authenticatedUserId)} addedScopes=${effectiveScopes.addedIdentityScopes.join(",")} conn=${connId}`);
	if (isClosed()) {
		await releasePendingNodePairingCleanup();
	...
	if (authenticatedUserId) try {
		const profile = authResult.tailscaleIdentity ? ensureProfileForTailscaleIdentity(authResult.tailscaleIdentity) : ensureProfileForEmail(authenticatedUserId);
	...
	const internal = isLocalClient || isTrustedApprovalRuntime || trustedAgentRuntimeIdentity ? {
	...
	const currentAuthenticatedPresenceUser = () => buildAuthenticatedPresenceUser({
		authenticatedUserId,
	...
	if (tailscaleProfileId && !authenticatedUserProfile?.hasAvatar && tailscaleProfilePic) runDetachedConnectWork(async () => {
		...
		if (isClosed() || !presenceKey) return;
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleIncomingMessage = async (data) => {
		...
		if (!admission) {
			if (!isGatewayRestartDraining() && getGatewaySuspendAdmissionPhase() === "prepared" && isPreparedControlConnect(data)) {
				await handleMessage(data);
				return;
			}
