import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{T as t,w as n}from"./control-ui-foundation-D1iiKpDl.js";import{Cl as r,Tl as i,bl as a,dl as o,ir as s,nr as c,rr as l,sl as u,xl as d}from"./control-ui-core-DnVVqkNx.js";import{K as f,Q as p,W as m,Y as h,nt as g}from"./lit-runtime-2JvyKfXq.js";import{c as ee,s as te,wn as ne,zt as re}from"./control-ui-foundation-CI97c0ac.js";import{I as ie,L as _,gr as v,mr as y,rr as b,vr as x,yr as S}from"./control-ui-core-Gyba8RbL.js";import{i as C,o as w,t as T}from"./control-ui-core-CKyI-Ttl.js";import{f as E,h as D,m as O,u as k}from"./control-ui-shared-bbu7Jty7.js";import{a as A,n as j,o as M,s as N,t as P,v as F}from"./lobster-pet-CQ0XaPhd.js";import{n as I,t as ae}from"./settings-workspace-BZ-JIQvf.js";import{c as L,h as R,s as z,t as B,u as V}from"./settings-ui-CZ6uR3w3.js";import{n as H,t as U}from"./brand-icons-CZoCFz2-.js";var W=e((()=>{}));function G(e,t){if(!e)return null;let n=new Date(e);return Number.isNaN(n.getTime())?null:new Intl.DateTimeFormat(t,{dateStyle:`medium`,timeZone:`UTC`}).format(n)}function K(e){return w(e===`copying`?`aboutPage.copyingCommit`:e===`copied`?`aboutPage.copiedCommit`:e===`error`?`aboutPage.copyCommitFailed`:`aboutPage.copyCommit`)}function q(e){return e===`copied`?w(`aboutPage.copiedCommit`):e===`error`?w(`aboutPage.copyCommitFailed`):``}function J(){return h`<span class="muted">${w(`aboutPage.unavailable`)}</span>`}function oe(e){if(!e)return f;let t=Date.parse(e);return Number.isFinite(t)?h`
...
//# sourceMappingURL=about-page-Dpc6yWIi.js.map