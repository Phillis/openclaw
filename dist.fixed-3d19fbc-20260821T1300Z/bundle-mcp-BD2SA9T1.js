...
import { n as matchRootFileOpenFailure } from "./root-file-CdmcBz8_.js";
...
import { l as resolveEffectivePluginActivationState, s as normalizePluginsConfig } from "./config-state-DLiU5GYQ.js";
import { c as normalizeBundlePathList, i as CURSOR_BUNDLE_MANIFEST_RELATIVE_PATH, n as CLAUDE_BUNDLE_MANIFEST_RELATIVE_PATH, r as CODEX_BUNDLE_MANIFEST_RELATIVE_PATH, s as mergeBundlePathLists, t as AGENT_BUNDLE_MANIFEST_RELATIVE_PATH } from "./bundle-manifest-eqczE9U_.js";
import { n as resolveActivePluginInstallRoots } from "./install-root-context-BK8PKHqw.js";
import { t as encodePluginInstallDirName } from "./install-paths-Bp_9OgEZ.js";
...
function isValidAgentCommand(command, rootDir) {
	...
	if (command.startsWith("./")) return command.length > 2 && isPathWithin(rootDir, path.resolve(rootDir, command));
