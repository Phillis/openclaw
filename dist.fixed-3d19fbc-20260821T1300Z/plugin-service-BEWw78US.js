...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-D2wE2SmJ.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BCHCtfe8.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-BnRmb6xi.js");
