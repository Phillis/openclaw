...
import { g as getActivePluginSessionExtensionRegistry, l as getActivePluginHttpRouteRegistry } from "./runtime-LV4GwzTm.js";
...
import { C as isBrowserProxyNodeInvokeCommand, S as isAdminOnlyNodeInvokeCommand } from "./node-commands-DemsbVYQ.js";
import { a as isDynamicOperatorGatewayMethod, i as isCoreNodeGatewayMethod, l as resolveCoreOperatorGatewayMethodScope, p as resolveReservedGatewayMethodScope, r as isCoreGatewayMethodClassified } from "./core-descriptors-x7tVv8yG.js";
...
const SESSIONS_PATCH_RETIRED_COMPATIBILITY_FIELDS = /* @__PURE__ */ new Set(["icon"]);
...
function resolveSessionsPatchRequiredScope(params) {
	...
	return Object.keys(params).every((key) => SESSIONS_PATCH_WRITE_SCOPE_ENVELOPE_FIELDS.has(key) || SESSIONS_PATCH_WRITE_SCOPE_MUTATIONS.has(key) || SESSIONS_PATCH_RETIRED_COMPATIBILITY_FIELDS.has(key)) ? "operator.write" : "operator.admin";
}
...
function resolveSessionsCreateRequiredScope(params) {
	if (!isRecord(params)) return "operator.write";
	if (params.incognito === true || typeof params.key === "string" && isIncognitoSessionKey(params.key) || typeof params.parentSessionKey === "string" && isIncognitoSessionKey(params.parentSessionKey) || Object.hasOwn(params, "execNode")) return "operator.admin";
