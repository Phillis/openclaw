...
import { D as resolveExpiresAtMsFromDurationMs, k as resolveExpiresAtMsFromDurationSeconds, o as asDateTimestampMs } from "./number-coercion-oCkfUEEq.js";
import { r as withTimeout } from "./timing-DpgMro2Q.js";
import { a as readSecretFileSync } from "./secret-file-CA3Rh4Yx.js";
...
async function resolveGoogleVertexAccessTokenViaGoogleAuth(adcConfig) {
	if (!cachedGoogleAuthClient) cachedGoogleAuthClient = { promise: import("./src-BujGvSvY.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)).then(({ GoogleAuth }) => {
