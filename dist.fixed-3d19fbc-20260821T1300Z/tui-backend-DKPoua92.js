...
import { t as executeSystemAgentOperation } from "./operations-CqBuFQx5.js";
...
import { t as SystemAgentChatEngine } from "./chat-engine-DSSUOWub.js";
...
async function runSystemAgentTui(opts, runtime) {
	...
	for (;;) {
		...
		const runTui = boundOpts.runTui ?? (await import("./tui-CY1HWFQf.js")).runTui;
		try {
			await runTui({
				local: true,
