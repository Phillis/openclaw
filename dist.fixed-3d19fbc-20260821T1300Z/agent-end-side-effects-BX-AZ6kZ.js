...
import { N as runWithSessionTranscriptReadFence } from "./session-accessor.sqlite-transcript-store-Cgnm_AHf.js";
import { h as consumeRunSkillUsage } from "./agent-tools.before-tool-call-BcJc3ySa.js";
import "./sessions-BHNzcBA2.js";
import { t as SessionManager } from "./session-manager-2mjIFFdj.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-hktdtw0h.js";
import { d as isGatewayDraining, r as enqueueCommandInLane } from "./command-queue-B992TXUy.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat-xESS3bi6.js";
import { t as log$1 } from "./logger-BQ2aebRn.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as resolveRuntimeTranscriptReadTarget } from "./transcript-runtime-state-DcottE4u.js";
import { f as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt-prompt-helpers-YK9kMZLg.js";
import { T as findActiveSessionTask } from "./media-generation-task-status-DJifrWQl.js";
import { v as runWithPreparedMemoryPromptSection } from "./memory-state-B3yoTCWD.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-msbvwnEU.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-TMBfi70M.js";
...
async function runCoreAgentEndSideEffects(params) {
	...
	try {
		const { scheduleSkillExperienceReview } = await import("./experience-review-default-CcZ0-1LK.js");
