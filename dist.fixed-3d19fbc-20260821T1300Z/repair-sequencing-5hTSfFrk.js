...
import { a as listAgentIds, b as tryResolveLegacyCompatibilityAgentId, d as resolveAgentWorkspaceDir, x as tryResolveSoleAgentId } from "./agent-scope-config-CsnnOL14.js";
import { c as parseAgentSessionKey } from "./session-key-utils-D8x_bjrd.js";
import { n as normalizeAccountId } from "./account-id-BRqK6RmF.js";
import { N as validateConfigObjectWithPlugins } from "./io-BTBpQ7uO.js";
import { a as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, i as normalizeChatChannelId } from "./ids-CvoHNWoD.js";
...
import { d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction, jt as tableExists } from "./openclaw-state-db-BciZ4rHE.js";
import "./legacy.default-agent-owner-0YGX8Nyg.js";
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-DciqS8td.js";
...
import { i as materializePluginAutoEnableCandidates, t as applyPluginAutoEnable } from "./plugin-auto-enable-DqCmhXre.js";
import { d as resolveWorkspaceStateIdentity } from "./workspace-state-store-CdlAG1ee.js";
import { a as ensureUserProfilesSchema, g as classifyTailscaleLogin } from "./user-profiles-BhIW_Pod.js";
import { C as readSkillProposalRollback, L as hashSkillProposalContent, M as validateSkillProposalRecord, N as validateSkillProposalRollback, a as readSkillProposal, n as importLegacySkillProposal } from "./store-B-ZL-1gP.js";
...
import { r as maybeRepairCodexRoutes } from "./codex-route-warnings-8JeVeNAr.js";
import { r as VERSION_BOUND_RUNTIME_PLUGIN_POLICY_IDS_BY_SURFACE } from "./configured-runtime-plugin-installs-ES_ABE-w.js";
import { d as isUpdatePackageSwapInProgress } from "./update-phase-C-2HsrA5.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-LqX0NWOH.js";
import { n as maybeMigrateAuthProfileJsonStoresToSqlite, r as maybeRepairOpenAICodexAuthConfig, t as collectOpenAICodexAuthProfileStoreIdMap } from "./doctor-auth-flat-profiles-BiWBJpy5.js";
import { t as maybeRepairLegacyOAuthSidecarProfiles } from "./doctor-auth-oauth-sidecar-ezGZB2px.js";
import { r as resolveConfigWideDoctorPluginMetadataSnapshot } from "./plugin-metadata-snapshot-scope-BcAGslRg.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-6JkP_7_l.js";
import { o as maybeRepairPluginOpenClawHostLinks, r as maybeRepairStaleManagedNpmBundledPlugins } from "./doctor-plugin-registry-D_xu1STJ.js";
import { t as getDoctorChannelCapabilities } from "./channel-capabilities-C_lHcGi3.js";
import { n as hasAllowFromEntries, t as scanEmptyAllowlistPolicyWarnings } from "./empty-allowlist-scan-CwegW5LI.js";
import { n as maybeRepairBundledPluginLoadPaths } from "./bundled-plugin-load-paths-BErXm7I-.js";
import { a as collectChannelDoctorRepairMutations, s as createChannelDoctorEmptyAllowlistPolicyHooks, t as collectChannelDoctorCompatibilityMutations } from "./channel-doctor-C1gSWHOS.js";
import { n as maybeRepairContextEngineHostCompatibility } from "./context-engine-host-compat-Csx0fOpT.js";
import { r as maybeRepairExecSafeBinProfiles } from "./exec-safe-bins-pAhcVax3.js";
import { n as maybeRepairLegacyToolsBySenderKeys } from "./legacy-tools-by-sender-DXp6P75o.js";
import { n as maybeRepairOpenPolicyAllowFrom } from "./open-policy-allowfrom-CqgaIY-V.js";
import { t as cleanupLegacyPluginDependencyState } from "./plugin-dependency-cleanup-NvRlTReq.js";
import { t as repairStaleAgentModelRefs } from "./stale-agent-model-ref-repair-LYQTgfN5.js";
import { n as maybeRepairStaleConfiguredAuthOrders } from "./stale-auth-order-CvIL2Eqx.js";
import { n as repairStaleOAuthProfileShadows } from "./stale-oauth-profile-shadows-CTm8Aulx.js";
import { r as maybeRepairStalePluginConfig } from "./stale-plugin-config-D_GwknUJ.js";
import { n as maybeRepairStaleSubagentAllowlists } from "./stale-subagent-allowlist-ecmRLl3o.js";
