...
import { n as isTruthyEnvValue, r as logAcceptedEnvOption } from "./env-uyT2Z2BT.js";
...
import { B as captureConfigOverrideApplier, l as readConfigFileSnapshot, o as promoteConfigSnapshotToLastKnownGood, r as getRuntimeConfig, u as readConfigFileSnapshotForRuntimeTransaction, v as registerConfigWriteListener } from "./io-BTBpQ7uO.js";
...
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-DNgaGOch.js";
...
import { r as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CmmO-xmS.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-DqufLoUx.js";
import { t as completePluginMetadataSnapshot } from "./plugin-metadata-snapshot-DciqS8td.js";
...
import { i as listLoadedChannelPlugins, n as getLoadedChannelPluginEntryById } from "./registry-loaded-W2ggd3eH.js";
import { d as prepareConfigRuntimeEnv, l as initializePublishedConfigRuntimeEnv, r as collectConfigRuntimeEnvOwnership } from "./config-env-vars-C1wvGC4M.js";
import { n as assertGatewayConfigEnvSelectionUnchanged } from "./gateway-env-selection-Dax41wNj.js";
import { C as setAppliedRuntimeConfigSnapshot, c as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-DIuCzlel.js";
...
import { t as GatewayLockError } from "./gateway-lock-Bs6SwFpn.js";
...
import { n as authorizeHttpGatewayConnect } from "./auth-BjIfKFX2.js";
...
import { a as normalizeDevicePublicKeyBase64Url } from "./device-identity-C2_6nSqN.js";
...
import { a as getGatewaySuspendAdmissionPhase, c as isGatewayWorkAdmissionClosed, i as getActiveGatewayRootWorkCount, o as isGatewayRestartDraining } from "./gateway-work-admission-BNrqZgKC.js";
import { f as setGatewaySigusr1RestartPolicy, p as setPreRestartDeferralCheck } from "./restart-B6DDQcym.js";
import { r as readGatewayRestartHandoffSync } from "./restart-handoff-DjNQCbd_.js";
import { c as resolveSystemMainSessionTarget } from "./main-session-Dth0X5B9.js";
import { t as isBrowserCopilotClient } from "./message-channel-C3nRvjrX.js";
import { i as tryLoadActivatedBundledPluginPublicSurfaceModule } from "./facade-runtime-Tnp-oiQo.js";
...
import { m as stopDiagnosticHeartbeat, p as startDiagnosticHeartbeat } from "./diagnostic-CM9bZ9kv.js";
import { d as getActiveEmbeddedRunCount, m as resolveActiveEmbeddedRunSessionId } from "./run-state-B57mLF-g.js";
import "./sessions-Bh837xaa.js";
import { t as canonicalizeUserProfileAvatarPath } from "./user-profiles-http-path-BFesDPdu.js";
import { c as getActiveBackgroundExecSessionCount } from "./bash-process-registry-CQvVr20S.js";
...
import { c as getTotalQueueSize, d as isGatewayDraining } from "./command-queue-B992TXUy.js";
import { t as createAgentRuntimeApprovalAuthorityValidator } from "./agent-runtime-identity-token-DNvL9Jxl.js";
...
import "./server-plugins-Bbifqd1i.js";
...
import { r as prepareGatewayAgentCliShim, t as clearGatewayAgentCliShim } from "./openclaw-cli-shim-Dc7sNoEw.js";
import { t as isCoreCanvasHostEnabled } from "./config-DbspHgKh.js";
import { a as getActiveSecretsRuntimeConfigSnapshot, r as clearSecretsRuntimeSnapshotState } from "./runtime-state-CR1A1dve.js";
import { n as fenceSessionSuspensionWritesForGatewayShutdown } from "./session-suspension-Cy8QugFr.js";
...
import { d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-DSPmkLD0.js";
...
import { t as ensureOpenClawCliOnPath } from "./path-env-Cv6_3nYc.js";
import { c as resolveControlUiRootSync, i as isPackageProvenControlUiRootSync, n as ensureControlUiAssetsBuilt, r as isControlUiStartupAssetsReady, s as resolveControlUiRootOverrideSync } from "./control-ui-assets-C_hWeKEY.js";
import { d as listDevicePairing, p as onEffectiveOperatorDevicePaired, y as resolveEffectiveOperatorDeviceIdentity } from "./device-pairing-CobL1ZXN.js";
import { f as requestNodePairing, p as reusePendingNodePairingForReconnect, r as finalizeNodePairingCleanupClaim } from "./device-pairing-node-CIHQQGFC.js";
import { c as removeRemoteNodeInfoForConnection, i as recordRemoteNodeInfo, s as removeRemoteNodeInfo } from "./remote-D4mAcbRT.js";
import { c as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-SDRFZFm7.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-ByzETCsI.js";
import { n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig } from "./startup-auth-D7m_4qUl.js";
import { t as createDefaultDeps } from "./deps-CUaUGGvL.js";
import { u as revokeAttachGrantsForSession } from "./mcp-grant-store-CTsCCtYU.js";
...
import { a as sendGatewayAuthFailure, f as setDefaultSecurityHeaders, r as finishFailedGatewayHttpResponse } from "./http-common-Bn4bbTny.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-BWx0sDdz.js";
import { n as queuePluginSessionsChanged } from "./gateway-events-D-98OSCb.js";
import { c as canReceiveSessionEvent } from "./session-sharing-YSn98RD0.js";
...
import { n as resolveGatewayReloadPluginActivationCandidate, r as resolveGatewayStartupPluginActivationConfig, t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-D9jm6gtQ.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-Bbs5FPDZ.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-BUoYkRx-.js";
import { t as createControlUiSessionPullRequestSubscriptions } from "./control-ui-session-pr-subscriptions-Cdm7K29q.js";
...
import { n as applyGatewayLaneConcurrency, r as resolveGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-DktzAUvC.js";
...
import { t as createGatewayStartupTrace } from "./server-startup-trace-OgraONQb.js";
import { a as writeGatewayUpgradeServiceUnavailable, n as shouldEnforceGatewayAuthForPluginPath, r as runWithGatewayHttpWorkAdmission } from "./route-auth-CdR_hSiY.js";
import { n as handleNodeWorkspaceTransferHttpRequest } from "./node-workspace-transfer-http-Bn37tfYK.js";
...
import { t as GATEWAY_EVENTS } from "./server-methods-list-gOu1Abty.js";
...
async function startGatewayCoreRuntime(input) {
	...
	const secretEgressProxy = cfgAtStart.secrets?.egressProxy?.enabled === true ? await import("./runtime-BXWvsFji.js").then((egressRuntime) => egressRuntime.startGatewaySecretEgressProxy(cfgAtStart.secrets?.egressProxy?.bypassHosts ? { bypassHosts: cfgAtStart.secrets.egressProxy.bypassHosts } : {})) : void 0;
	...
	const taskAndSkillsResident = residentRegistry.register({
		...
		stop: async () => {
			...
			const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-C6-sWLD5.js");
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-BHzB_XIK.js"), import("./server-runtime-startup-services-BE3bpiAt.js")]));
	...
	const { createOperatorApprovalSessionEventRuntime } = await import("./operator-approval-session-events-BXYqcCxx.js");
	...
	const { execApprovalManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, bindApprovalPublicationContext, unregisterApprovalAuthorityObserver, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-BIbfqogN.js"), import("./server-methods-ChhK2_HO.js")]);
		return {
	...
	const reloadAttachedGatewayPlugins = async (params) => {
		const [{ loadPluginLookUpTable }, { listAmbientOnlyConfiguredChannelIds }, { prepareGatewayPluginLoad }, { startPluginServices }, { listChannelPluginConfigTargetIds, pluginConfigTargetsChanged }] = await Promise.all([
			import("./plugin-lookup-table-b2B9VhE1.js"),
			import("./channel-presence-policy-DK72JZF3.js"),
			loadGatewayPluginBootstrapModule(),
			import("./services-VeqUXS5v.js"),
...
async function createGatewayChatMetadataLifecycle(params) {
	...
	const { ChatMetadataSnapshotUnavailableError, createGatewayChatMetadataRuntime } = await import("./chat-metadata-runtime-CS5EAjpu.js");
	const runtime = createGatewayChatMetadataRuntime({
		...
		...params.minimalTestGateway ? {
			beforeRefresh: async () => {
				const { refreshPreparedModelRuntimeSnapshots } = await import("./prepared-model-runtime-BMqrIvOC.js");
	...
	const registerRefreshListeners = async () => {
		...
		const [{ registerRuntimeAuthProfileStoreMutationListener }, { registerPreparedModelRuntimePublicationListener }, { registerSkillsChangeListener }] = await Promise.all([
			import("./runtime-snapshots-BHZH6o8z.js"),
			import("./prepared-model-runtime-BMqrIvOC.js"),
			import("./refresh-CrODEUr7.js")
		]);
...
async function attachInitialGatewayLifetimeSidecars(params) {
	...
	params.sidecars.push({ stop: async () => {
		const { flushPendingSessionsChangedEvents } = await import("./session-change-event-Cvf8VDZb.js");
...
async function prepareGatewayKernelRequestRuntime(params) {
	...
	const gatewayRequestContext = await startupTrace.measure("gateway.request-context", async () => {
		const { createGatewayRequestContext } = await import("./server-request-context-sYUdTC8q.js");
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-BCgbCvOD.js");
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-BILePyoX.js").then(({ buildGatewayCronService }) => {
		loaded = {
...
async function prepareGatewayLifecycle(params) {
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-DwVWAvjw.js");
	...
	const nodeDesktopService = desktopSessionRegistry && nodeDesktopStreamBroker ? (await import("./node-source-v6TO8IqE.js")).createNodeDesktopService({
		getConfig: getRuntimeConfig,
		nodeRegistry,
	...
	const { createWatchNodeHttpRuntime } = await import("./watch-node-http-DR48ih_g.js");
	...
	const { TerminalSessionManager, DEFAULT_TERMINAL_DETACH_SECONDS } = await import("./session-manager-hkCE58u7.js");
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-D0SIPcqa.js");
...
async function prepareGatewayKernelState(params) {
	...
	const hostDesktopService = hostDesktopConfig && hostDesktopEnabled && desktopSessionRegistry ? (await startupTrace.measure("host-desktop.runtime-import", () => import("./host-source-CgO_gn3i.js"))).createHostDesktopService({
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-L2qUV7tV.js");
	...
	if (bootstrap.generatedStartupAuthToken && isLoopbackHost(bindHost)) {
		const { ensureStartupLocalCliPairing } = await import("./startup-local-cli-pairing-Bzy1mwJV.js");
	...
	const { createTerminalLaunchPolicy } = await import("./launch-Duir0Mre.js");
	const terminalLaunchPolicy = createTerminalLaunchPolicy(cfgAtStart);
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-DzxF-MMa.js");
	...
	const { createChannelManager } = await import("./server-channels-CxzCGI39.js");
...
async function prepareGatewayServerBootstrap(input) {
	...
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-TWiJSsxJ.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-C6M9Qc-Q.js");
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-BYuWqz7x.js"), { cacheRejections: true });
	...
	const { claimControlUiDeviceAuthMigration, completeControlUiDeviceAuthMigration, importPendingControlUiDeviceAuthMigration, isLegacyControlUiDeviceAuthMigrationInput, readControlUiDeviceAuthMigrationState, recoverControlUiDeviceAuthMigrationClaim, releaseControlUiDeviceAuthMigrationClaim } = await import("./control-ui-device-auth-migration--LJYOyo-.js");
...
const loadGatewayModelCatalogModule = createLazyRuntimeModule(() => import("./server-model-catalog-DI2qco4H.js"));
const loadWorkerEnvironmentStartupModule = createLazyRuntimeModule(() => import("./server-worker-environment-startup-D8wxsBmA.js"));
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-59Bl8UHe.js"));
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-BtPhxnCW.js"));
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-CSrt3T28.js"));
...
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-Cd8KCN3X.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-B8_G8xdv.js");
...
const getHttpAuthUtilsModule$2 = createLazyRuntimeModule(() => import("./http-auth-utils-DB1UpDee.js"));
...
const getPluginNodeCapabilityAuthModule$1 = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-CWn5hhg1.js"));
const getHttpAuthUtilsModule$1 = createLazyRuntimeModule(() => import("./http-auth-utils-DB1UpDee.js"));
const getPluginRouteRuntimeScopesModule$1 = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-Dh1Nwp35.js"));
...
const getControlUiModule = createLazyRuntimeModule(() => import("./control-ui-CiosQlr2.js"));
const getCanvasServeModule = createLazyRuntimeModule(() => import("./serve.runtime.js"));
const getBoardHttpModule = createLazyRuntimeModule(() => import("./board-http-CCOa8k3e.js"));
const getEmbeddingsHttpModule = createLazyRuntimeModule(() => import("./embeddings-http-D8FgfpOc.js"));
const getManagedMediaAttachmentsModule = createLazyRuntimeModule(() => import("./managed-image-attachments-DXjnH12h.js"));
const getMcpAppStandaloneModule = createLazyRuntimeModule(() => import("./mcp-app-standalone-B59cnA9s.js"));
const getPluginIconHttpModule = createLazyRuntimeModule(() => import("./plugin-icon-http-Bz2U8JrT.js"));
const getWorkspaceIconHttpModule = createLazyRuntimeModule(() => import("./workspace-icon-http-DPI7uI57.js"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-BVQXI6v6.js"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-CENd0wfq.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-CdmMVerC.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-fzSpwVKe.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-BHIyLsgI.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-D2WXdLJe.js"));
const getUserProfilesHttpModule = createLazyRuntimeModule(() => import("./user-profiles-http-D5Caotaw.js"));
const getDevicePairingJoinHttpModule = createLazyRuntimeModule(() => import("./device-pairing-join-http-CdbfW6_9.js"));
const getPluginNodeCapabilityAuthModule = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-CWn5hhg1.js"));
const getHttpAuthUtilsModule = createLazyRuntimeModule(() => import("./http-auth-utils-DB1UpDee.js"));
const getPluginRouteRuntimeScopesModule = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-Dh1Nwp35.js"));
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-Cr-IeB5K.js");
...
async function createGatewayHttpTransport(params) {
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-Danqfioc.js");
	...
	const handleMcpOAuthCallbackRequest = async (req, res) => {
		const { handleMcpOAuthCallback } = await import("./mcp-oauth-callback-DNyDk4KZ.js");
...
async function finishGatewayStartup(params) {
	...
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-Mw7d2nwX.js"), import("./route-capability-CCISCYmy.js")]));
	...
	const databaseIntegrityResident = residentRegistry.register({
		...
		start: async () => {
			if (minimalTestGateway) return;
			const { startOpenClawDatabaseIntegrityVerifier } = await import("./openclaw-database-verify-B9YTmgfX.js");
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-qP9p6iNK.js"), { cacheRejections: true });
	...
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-Dw3Dkz_o.js");
		...
		residentRegistry.register({
			...
			start: () => {
				postReadyState.retainedPluginCleanupHandle = gatewayRuntimeServices.scheduleGatewayIdleTask({
					...
					run: async () => {
						const { cleanupRetainedPluginInstallGenerations } = await import("./server-retained-plugin-cleanup-N1WCoPSc.js");
...
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-BsftMZ9U.js"));
