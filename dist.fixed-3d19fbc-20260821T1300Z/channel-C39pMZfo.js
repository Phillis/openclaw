...
import { f as createChannelMessageAdapterFromOutbound, m as bindIngressLifecycleToReplyOptions } from "./channel-outbound-CP6yKwU3.js";
		...
		start: async () => {
			const bus = await startNostrBus({
				...
				onMessage: async (senderPubkey, text, reply, meta, lifecycle) => {
					...
					const { dispatchInboundDirectDm } = await import("./inbound-direct-dm-runtime-DI8QzX0h.js");
