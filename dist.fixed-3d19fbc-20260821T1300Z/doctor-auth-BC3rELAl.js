...
import { a as listAgentIds, f as resolveDefaultAgentDir, l as resolveAgentDir, y as tryResolveDefaultAgentId } from "./agent-scope-config-CsnnOL14.js";
import { i as resolveAuthStorePathForDisplay, o as resolveSharedAuthStoreOwnership } from "./path-resolve-DES5vxlU.js";
import "./persisted-B895D0I1.js";
import { r as ensureAuthProfileStore } from "./store-DZy8rsrA.js";
import { r as hasLocalAuthProfileStoreSource, t as hasAnyAuthProfileStoreSource } from "./source-check-BjQgT_Mf.js";
import { u as resolveProfileUnusableUntilForDisplay } from "./usage-Cj2wt9Ks.js";
import { i as classifyOAuthRefreshFailure, n as buildAuthProfileUnusableHint, r as buildOAuthRefreshFailureLoginCommand, s as formatOAuthRefreshFailureLoginCommandMarkdown } from "./oauth-refresh-failure-DXvwptD4.js";
import "./auth-profiles-TorfVJYv.js";
import { i as formatAuthDoctorHint, n as resolveApiKeyForProfile } from "./oauth-DhVoKHWf.js";
...
function noteSharedAuthStoreStatus(env = process.env) {
	if (resolveSharedAuthStoreOwnership(env).location !== "legacy-main") return;
	note("Shared auth profiles still live in the main agent database. Run `openclaw doctor --fix` to move them into shared SQLite state and make the main agent deletable.", "Shared auth store");
}
...
//#endregion
export { collectAuthProfileHealthFindings, noteAuthProfileHealth, noteLegacyCodexProviderOverride, noteSharedAuthStoreStatus };
