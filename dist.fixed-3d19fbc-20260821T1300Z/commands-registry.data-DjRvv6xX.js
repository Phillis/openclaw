...
import { o as getActivePluginChannelRegistryVersionFromState } from "./registry-lookup-DLP3NSyt.js";
import { i as listLoadedChannelPlugins } from "./registry-loaded-W2ggd3eH.js";
import { a as listThinkingLevels } from "./thinking-D9bT8eOf.js";
import { l as resolveFastModeModelAutoOnSeconds, t as formatFastModeAutoLabel } from "./fast-mode-CCX0YiYh.js";
...
function buildBuiltinChatCommands(params = {}) {
	...
	const commands = [
		...
		defineBuiltinCommand("model", "Show or set the model; direct owner/admin selections request a default update.", "options", "essential", { args: [defineCommandArgument("model", "Model id; add -s to change only this session")] }),
