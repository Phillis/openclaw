...
import { _ as tryBeginGatewayRootWorkAdmission, h as runWithGatewayIndependentRootWorkContinuation } from "./gateway-work-admission-BNrqZgKC.js";
import { l as isWebchatClient } from "./message-channel-C3nRvjrX.js";
...
import { c as recordPairedNodeDisconnection } from "./device-pairing-node-CIHQQGFC.js";
import { s as removeRemoteNodeInfo } from "./remote-D4mAcbRT.js";
...
import { a as incrementPresenceVersion, r as getHealthVersion } from "./health-state-Bbs5FPDZ.js";
...
import { t as cleanupTalkConnection } from "./talk-session-registry-BeOPVuuU.js";
import { i as WS_HANDSHAKE_PHASES, o as takePublicWorkerIngress } from "./ws-types-DrkOhGsT.js";
import "./placement-session-tool-operations-DeruCwAH.js";
...
function attachGatewayWsMessageHandlerOnDemand(params) {
	...
	import("./message-handler-BLvLnuBi.js").then(({ attachGatewayWsMessageHandler }) => {
