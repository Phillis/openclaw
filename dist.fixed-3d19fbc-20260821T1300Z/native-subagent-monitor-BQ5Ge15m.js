...
import { o as asDateTimestampMs, s as asFiniteNumber } from "./number-coercion-oCkfUEEq.js";
import { t as asNonArrayRecord, u as readStringField } from "./record-coerce-DItp3I4t.js";
import { a as redactSensitiveFieldValue, u as redactToolPayloadText } from "./redact-DP7p9QfH.js";
...
import { a as migrateSessionEntries, d as parseSessionEntries, t as buildSessionContext } from "./session-manager-codec-CBbtVKV-.js";
import { t as runAgentHarnessAfterToolCallHook } from "./hook-helpers-yf-1HkL_.js";
import { t as formatToolAggregate } from "./tool-meta-BqjtVe4I.js";
import { t as log } from "./logger-BQ2aebRn.js";
import { h as resolveTranscriptSessionKeyBySessionId, r as getSessionEntry } from "./session-store-runtime-De3jWY_Z.js";
import "./number-runtime-CoAPZzJY.js";
import "./string-coerce-runtime-D9ocX9lc.js";
import { o as formatToolProgressOutput, s as inferToolMetaFromArgs, t as TOOL_PROGRESS_OUTPUT_MAX_CHARS } from "./agent-harness-runtime-DrXbITHA.js";
import { H as claimCodexAppServerLiveThread, J as releaseCodexAppServerLiveThread, Y as retainCodexAppServerLiveThread, ut as isJsonObject } from "./shared-client-fWU6PNZb.js";
import "./text-utility-runtime-BSdEoze8.js";
import "./logging-core-ClEDRBwn.js";
import { A as shouldSynthesizeToolProgressForItem, C as isSideEffectingNativeToolItem, D as itemTitle, E as itemStatus, I as readNonEmptyString, L as readNonEmptyStringArray, N as readHookOutputEntries, P as readItem, S as isNonSuccessItemStatus, T as itemName, k as shouldRecordNativeToolTranscript, w as itemKind, x as isMutatingNativeToolItem, y as auditNativeToolTerminalStatus, z as readNullableString$1 } from "./attempt-client-cleanup-Bh556tF7.js";
import { n as sanitizeCodexHistoryImagePayloads } from "./image-payload-sanitizer-CU0iwcQa.js";
import { t as resolveCodexLocalRuntimeAttribution } from "./local-runtime-attribution-DPk90pCh.js";
import "./agent-sessions-CXAExPAG.js";
import { s as readSessionTranscriptEvents } from "./session-transcript-runtime-CcyNX9RF.js";
import { t as readCodexSessionTranscriptEventsBeforeAdmission } from "./codex-session-transcript-runtime-CSEw5E2l.js";
import { t as attachCodexMirrorIdentity } from "./upstream-prompt-provenance-ClRBije0.js";
import { n as deliverAgentHarnessTaskCompletion, r as isDurableAgentHarnessCompletionDelivery, t as createAgentHarnessTaskRuntime } from "./agent-harness-task-runtime-B9XpmlrA.js";
	...
	handleGuardianReview(method, params) {
		...
		this.emitAgentEvent({
			...
			data: {
				...
				reviewId: readStringField(params, "reviewId"),
				targetItemId: readNullableString$1(params, "targetItemId"),
				decisionSource: readStringField(params, "decisionSource"),
				status: review ? readStringField(review, "status") : void 0,
				riskLevel: review ? readStringField(review, "riskLevel") : void 0,
				userAuthorization: review ? readStringField(review, "userAuthorization") : void 0,
...
var Monitor = class {
	...
	dispose() {
		...
		for (const state of this.parentStates.values()) state.owners.clear();
	...
	async handleNotification(notification) {
		...
		if (childState && !childState.terminal) this.emitChildTaskActivity(notification, childState.childThreadId);
	...
	emitChildTaskActivity(notification, childThreadId) {
		const params = isJsonObject(notification.params) ? notification.params : void 0;
		if (!params) return;
		const runId = codexNativeSubagentRunId(childThreadId);
		...
		if (notification.method === "item/started" || notification.method === "item/completed") {
			...
			if (state && parentThreadId) {
				...
				for (const childThreadId of childThreadIds) accepted = Boolean(isCompletedSpawnAgentTool ? this.registerDirectSpawnChild(state, turnId, {
					parentThreadId,
					childThreadId
				}, owner) : this.registerChildThread(parentThreadId, childThreadId)) && accepted;
				if (!accepted) return;
			}
			return state;
		}
	...
	drainPendingDirectSpawnEvidence(state, owner, turnId) {
		...
		for (const evidence of pending) if (evidence.parentThreadId === state.parentThreadId) this.registerChildThread(state.parentThreadId, evidence.childThreadId, {
			...evidence.agentPath === void 0 ? {} : { agentPath: evidence.agentPath },
...
//#endregion
export { CodexToolProgressProjection as a, isCodexCommandBearingToolCall as c, sanitizeCodexToolResponse as d, readCodexMirroredSessionHistoryMessages as i, resolveCodexToolProgressDetailMode as l, CodexEventProjection as n, shouldEmitTranscriptToolProgress as o, CodexToolTranscriptProjection as r, inferCodexDynamicToolMeta as s, codexNativeSubagentMonitorRuntime as t, sanitizeCodexToolArguments as u };
