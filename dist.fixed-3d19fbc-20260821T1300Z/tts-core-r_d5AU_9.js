...
function loadDefaultSummarizeTextDeps() {
	return defaultSummarizeTextDepsPromise ??= Promise.all([import("./simple-completion-runtime-DyZZ_-C7.js"), import("./model-auth-DVmCDIZL.js")]).then(([completionRuntime, { requireApiKey }]) => ({
