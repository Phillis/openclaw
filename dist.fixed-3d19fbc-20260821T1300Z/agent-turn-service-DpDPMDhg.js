...
import { a as readErrorName } from "./errors-CqPTYU6G.js";
...
import { L as normalizeCronScheduledToolPolicy } from "./row-codec-RY4IJt5w.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-yubNQC1L.js";
import { t as ErrorCodes } from "./gateway-error-details-BWo6Le6w.js";
import { l as AGENT_SESSION_RESET_COMMAND_RE } from "./method-scopes-CEKLLcTa.js";
...
import { a as mergeDeliveryContext, c as normalizeSessionDeliveryState, d as sessionDeliveryOrigin, f as sessionDeliveryRoute, n as deliveryContextFromSession, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-B3qeEQhR.js";
import { i as resolveExplicitAgentSessionKey, r as resolveAgentMainSessionKey } from "./main-session-Dth0X5B9.js";
import { r as resolveSessionStoreKey } from "./session-store-key-Cc0gbvo8.js";
import { Lt as resolveSessionEntryAccessTarget, Ot as applySessionEntryReplacements, at as getCliSessionBinding, gn as buildSessionCreationStamp, it as clearAllCliSessions, tn as patchSessionEntryTarget } from "./session-accessor-CIiPoGwM.js";
import { n as isGatewayMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-BhvdDSLi.js";
import "./message-channel-C3nRvjrX.js";
import { k as readTranscriptStatsSync } from "./session-accessor.sqlite-transcript-store-Cgnm_AHf.js";
import { D as resolveMaintenanceConfigFromInput, Q as consumeSessionWorkAdmissionHandoff, l as resolveAgentHarnessSessionContextError, t as AGENT_HARNESS_MODEL_RUN_FORBIDDEN_MESSAGE, u as resolveAgentHarnessSessionIdMismatchError, z as beginSessionWorkAdmission } from "./agent-harness-session-key-BpWapmwX.js";
import { c as resolveRestartRecoveryChannelAuthority, p as mergeSessionEntry } from "./restart-recovery-state-YPGO30LK.js";
...
import { o as parseExecutionIdentityAdmissionToken } from "./execution-identity-admission-0VwmKVHN.js";
import { n as isExecutionIdentityCollectionEnabled } from "./audit-config-BKFiXlHH.js";
import { i as getAdmittedRunDelegatedAuthority, n as createExecutionIdentityRecoveryAdmission, r as createOperationalRunInstanceRef } from "./admitted-run-context-Dl2hrF3z.js";
import { d as isTimeoutError } from "./failover-error-DKFCUqL9.js";
import { u as recordSessionCreated } from "./session-state-events-DTKQ6kKc.js";
import { b as findTaskByRunId, z as mapAgentRunTerminalOutcomeToTaskStatus } from "./task-registry-1cqXcWjA.js";
import { f as normalizeAgentRunTimeoutPhase, n as buildAgentRunTerminalOutcome, o as classifyAgentRunTerminalOutcome } from "./agent-run-terminal-outcome-CpRY9lPn.js";
import { c as createAgentRunRestartAbortError, f as isAgentRunRestartAbortReason, i as AGENT_RUN_RESTART_ABORT_STOP_REASON } from "./run-termination-0Y8XLbCX.js";
...
import { S as retainEmbeddedAgentRunAbortabilityForRunId, c as isEmbeddedAgentRunAbortableForRunId, i as clearEmbeddedAgentRunAbortabilityForRunId } from "./runs-CQbSP9aq.js";
import "./sessions-Bh837xaa.js";
import { c as resolveTerminalMainSessionTranscriptRegistryCheck, i as hasTerminalMainSessionTranscriptNewerThanRegistrySync, o as resolveSessionLifecycleTimestamps, s as resolveSessionWorkStartError } from "./lifecycle-4IbI4BFl.js";
import { a as resolveSessionResetPolicy, i as evaluateSessionFreshness, n as resolveSessionResetType, t as resolveChannelResetConfig } from "./reset-1TbI4IQQ.js";
...
import { s as resolveTrustedGroupId } from "./agent-tools.policy-Ba4icL7P.js";
...
import { a as resolveExactSubagentCompletionEvent } from "./requester-tool-policy-CA6pDi8g.js";
...
import { u as consumeSubagentCompletionToolHandoff } from "./server-plugins-Bbifqd1i.js";
...
import { t as hasProviderOwnedSession } from "./entry-freshness-DpEQSBNK.js";
import "./cli-session-DjK4b9bd.js";
import { r as resolveExistingSessionKeyForRequest } from "./session-ChRzjWPw.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-CprOztD-.js";
...
import { a as releaseMainSessionRecoveryOwner, n as commitMainSessionRecovery } from "./main-session-recovery-store-DTu6q_37.js";
import { a as setChannelSourceTurnSameThreadRequired, i as setChannelSourceTurnId } from "./source-turn-id-BDtD1rRG.js";
import { c as resolveAgentRunExpiresAtMs, d as updateChatRunProvider, o as registerChatAbortController } from "./chat-abort-9K8jqLDL.js";
import { r as resolveChatRunOwnerAgentId } from "./chat-run-owner-CmA2Q2CD.js";
import { a as emitGatewaySessionEndPluginHook, c as performGatewaySessionReset, o as emitGatewaySessionStartPluginHook } from "./session-reset-service-8JDBg6tW.js";
import { a as attachAgentCommandAdmissionFacts, n as agentCommandFromGatewayIngress } from "./agent-command-DEWNhr6J.js";
...
import { r as buildExecApprovalContinuationPrompt } from "./bash-tools.exec-approval-output-hi2p5PU0.js";
import { t as formatForLog } from "./ws-log-ByzETCsI.js";
import "./agent-COGV7JNE.js";
...
import { _ as gatewayClientSenderFields, i as authorizeResolvedSessionMutation } from "./session-sharing-YSn98RD0.js";
import { n as emitSessionsChanged } from "./session-change-event-XKNRoRWi.js";
import { I as setGatewayDedupeEntry, L as waitForAgentJob } from "./chat-abort-runtime-Coi0Aqat.js";
import { t as resolveAgentRunSessionCreation } from "./session-creation-provenance-CX5dCIoC.js";
import { t as handleChatAbortRequest } from "./chat-abort-handler-CK-lekey.js";
import { r as resolveVoiceWakeRouteByTrigger, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-DYAtPB9Y.js";
import { n as resolveChatAttachmentMaxBytes } from "./chat-attachment-policy-DrGl1Ors.js";
import { a as logAttachmentFailure, n as MediaOffloadError, o as parseMessageWithAttachments } from "./chat-attachments-BhBYBo3A.js";
import { t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-B7-Wq5M9.js";
import { t as resolveScheduledToolPolicyContext } from "./scheduled-tool-policy-d3EFqVDG.js";
import { n as getGatewayLocalUserIngress } from "./local-user-ingress-Oe_iiso6.js";
...
async function registerPluginSubagentRunFromGateway(params) {
	...
	const { adoptPausedSubagentRunForFollowUp, registerSubagentRun } = await import("./subagent-registry-DvKfrTah.js");
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./subagent-registry-runtime-DPgJ-1Wn.js");
}
/**
