...
import { b as hasSessionActiveAutoModelFallback, x as hasSessionAutoModelFallbackProvenance } from "./agent-scope-D9GLFAyB.js";
...
import { l as toPublicPluginVerificationDiagnostic, o as listActiveDegradedPlugins } from "./runtime-degraded-state-D2KYvUdx.js";
import { s as resolveSystemMainSessionKey } from "./main-session-Dth0X5B9.js";
import { Zt as loadExactSessionEntryReadOnly, qt as listSessionEntriesReadOnly } from "./session-accessor-CIiPoGwM.js";
import { g as resolveFreshSessionTotalTokens, y as resolveSessionTotalTokens } from "./restart-recovery-state-YPGO30LK.js";
...
import { d as peekSystemEvents } from "./system-events-DecgSLEt.js";
...
import { t as hasResolvableHeartbeatOwnerRoute } from "./targets-UyKqZNKy.js";
import { n as resolveHeartbeatSessionKey } from "./heartbeat-runner-session-CoYXSYw9.js";
//#region src/status/summary.ts
const RECENT_SESSION_LIMIT = 10;
const channelSummaryModuleLoader = createLazyImportLoader(() => import("./channel-summary-CPJJ64ZY.js"));
const channelPluginIdsModuleLoader = createLazyImportLoader(() => import("./channel-plugin-ids-DQa7NuQe.js"));
const linkChannelModuleLoader = createLazyImportLoader(() => import("./link-channel-vc7Ogg3u.js"));
const taskRegistryMaintenanceModuleLoader = createLazyImportLoader(() => import("./task-registry.maintenance-C6-sWLD5.js"));
const staticModelCatalogResolverLoader = createLazyImportLoader(async () => {
	const modelCatalog = await import("./model.static-catalog-D_E7Iz4o.js");
	return {
...
async function getStatusSummary(options = {}) {
	...
	const hostDesktopStatus = options.hostDesktopStatus ?? (await (await import("./host-source-CgO_gn3i.js")).inspectHostDesktop({ config: cfg.desktop?.host })).status;
	const summary = {
