...
import { y as formatMemoryDreamingDay } from "./dreaming-N16HL0CK.js";
...
import { r as updateDeepDreamsFile } from "./dreaming-dreams-file-B65M6zpb.js";
...
async function replaceDreamingMarkdownFile(filePath, content) {
	...
	await replaceFileAtomic({
		filePath,
		content,
		dirMode: (await fs.stat(directoryPath)).mode & 4095,
		mode: 384,
