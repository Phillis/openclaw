...
import { d as formatIcaclsResetCommand, u as createIcaclsResetCommand } from "./permissions-CaeiXnMq.js";
...
import { r as listAgentEntries, y as tryResolveDefaultAgentId } from "./agent-scope-config-CsnnOL14.js";
import { r as LEGACY_IMPLICIT_AGENT_ID } from "./session-key-D8GLfPr_.js";
import { b as createConfigIO, r as getRuntimeConfig } from "./io-BTBpQ7uO.js";
...
import { p as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-JklITWYj.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as runSecurityAuditCore } from "./audit-DXCSxwAB.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-wd2JuI_x.js");
