...
import { _ as toAgentEntriesRecord, g as resolveSystemAgentTargetAgentId, r as listAgentEntries } from "./agent-scope-config-CsnnOL14.js";
...
async function resolveSystemAgentConfiguredRouteFromConfig(runConfig, requestedAgentId, deps = {}) {
	const [agentScope, modelSelection, modelRuntimeAliases, simpleCompletion, harnessPolicy] = await Promise.all([
		...
		import("./model-selection-oGawnPze.js"),
		import("./model-runtime-aliases-C24UnWwF.js"),
		import("./simple-completion-runtime-DyZZ_-C7.js"),
		import("./policy-Cc6SEz31.js")
	]);
...
async function projectInferenceRoute(config, requestedAgentId, deps = {}) {
	const { resolveProviderIdForAuth } = await import("./provider-auth-aliases-Dnc0qvqf.js");
