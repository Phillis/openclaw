...
import { c as startSessionDeliveryRuntime, o as schedulePendingSessionDeliveries } from "./subagent-completion-delivery-BB6UkavY.js";
import "./embedded-agent--FS7CHhs.js";
import { f as resolveHeartbeatAgents } from "./heartbeat-runner-session-CoYXSYw9.js";
import { t as startHeartbeatRunner } from "./heartbeat-runner-DXheZqP2.js";
...
function startPendingSessionDeliveryRuntime(params) {
	...
	const timer = setTimeout(() => {
		runWithGatewayIndependentRootWorkAdmission(async () => {
			const { deliverQueuedSessionDelivery, recoverPendingRestartContinuationDeliveries, settleQueuedSessionDelivery } = await import("./server-restart-sentinel-UQLe0VhW.js");
			if (stopped) return;
