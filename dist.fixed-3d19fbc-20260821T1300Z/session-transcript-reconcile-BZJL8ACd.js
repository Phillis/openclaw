...
import { f as runExclusiveSqliteSessionWrite, p as toDatabaseOptions, u as resolveSqliteTranscriptReadScope } from "./session-accessor.sqlite-scope-kLvPv-zX.js";
import { c as claimPreparedSessionTranscriptProjectionInTransaction, i as listSessionsNeedingTranscriptIndexReconcile, l as deletePreparedSessionTranscriptProjectionChunkInTransaction, o as sessionTranscriptIndexNeedsReconcile, s as appendPreparedSessionTranscriptProjectionChunkInTransaction, t as deleteOrphanedTranscriptIndexRowsInTransaction, u as finalizePreparedSessionTranscriptProjectionInTransaction } from "./session-transcript-index-B7GQuTh4.js";
...
async function waitForSessionTranscriptProjection(scope) {
	...
	while (isSessionTranscriptIndexReconcileRunning(databaseOptions) && sessionTranscriptIndexNeedsReconcile(database.db, resolved.sessionId)) await setTimeout(PROJECTION_READY_POLL_MS);
}
//#endregion
