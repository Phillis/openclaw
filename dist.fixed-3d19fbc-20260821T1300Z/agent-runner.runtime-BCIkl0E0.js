...
import { c as resolveContextConfigProviderForRuntime, m as resolveModelExtraParamSources, u as resolveOpenAIRuntimeProvider } from "./openai-routing-BC0q3X-J.js";
...
import { b as resolveMergedModelProviderModels, y as resolveMergedModelProviderConfig } from "./openai-model-routes-oiuFxnRn.js";
...
import { l as resolveCronJobsStorePath, n as loadCronJobsStore } from "./store-DPYCi6M7.js";
import "./config-CfeGo4K4.js";
import { r as logVerbose } from "./globals-DD_xHyf6.js";
import { t as GatewayDrainingError } from "./gateway-work-admission-BNrqZgKC.js";
...
import { _ as resolveSessionPluginStatusLines, g as resolveFreshSessionTotalTokens, i as hasRestartRecoverySourceClaim, v as resolveSessionPluginTraceLines } from "./restart-recovery-state-YPGO30LK.js";
import { r as isIngressAdoptionLostError } from "./ingress-drain-SxsnEN8i.js";
import "./backoff-BkMI1WEL.js";
import { a as formatRawAssistantErrorForUi } from "./assistant-error-format-DYl5XHJg.js";
import { a as classifyOAuthRefreshFailureError } from "./oauth-refresh-failure-DXvwptD4.js";
import { a as isContextOverflowError, p as isTransientHttpError, s as isLikelyContextOverflowError, t as classifyFailoverReason } from "./classify-kl1ByQTv.js";
import { i as resolveCliBackendConfig } from "./cli-backends-BqBcI5I1.js";
import { i as isCliRuntimeAliasForProvider, s as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-BoIMzL8U.js";
import { a as resolveCandidateThinkingLevel, o as resolveEffectiveAgentRuntime } from "./thinking-runtime-_QT_qncS.js";
import { i as resolveSessionRuntimeOverrideForProvider, r as resolvePersistedSessionRuntimeId } from "./session-runtime-compat-DNLW-mvy.js";
import { u as estimateMessagesTokens } from "./compaction-planning-n3bfEaLv.js";
...
import { s as resolvePersistedOverrideModelRef } from "./model-selection-BEGvRdL1.js";
import { s as prepareSystemAgentRunAdmission } from "./admitted-run-context-Dl2hrF3z.js";
import { c as isFailoverError, f as resolveFailoverReasonFromError, s as findCliTimeoutError } from "./failover-error-DKFCUqL9.js";
import { a as enqueueSystemEvent } from "./system-events-DecgSLEt.js";
import { c as createAgentRunRestartAbortError, f as isAgentRunRestartAbortReason, h as resolveAgentRunErrorLifecycleFields, i as AGENT_RUN_RESTART_ABORT_STOP_REASON, m as resolveAgentRunAbortLifecycleFields } from "./run-termination-0Y8XLbCX.js";
import { c as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-DkdYrwAv.js";
import { n as sanitizeUserFacingText, t as renderUserFacingText } from "./user-facing-text-DAYCAcGX.js";
import { _ as renderControlUiAgentFailureCopy, a as PROVIDER_CONVERSATION_STATE_ERROR_USER_MESSAGE, b as renderRateLimitReplyCopy, h as renderBillingReplyCopy, y as renderRateLimitOrOverloadedCopy } from "./user-copy-BKvImQfV.js";
import { c as resolveFastModeForElapsed, n as formatFastModeAutoProgressText } from "./fast-mode-CCX0YiYh.js";
import { o as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-Bjf468vR.js";
import { i as getGeneratedMediaTaskIdsForSessionKey, o as hasNewGeneratedMediaTaskForSessionKey } from "./task-status-access-DsWf7lJY.js";
import { F as runAfterReplyOperationClear, f as markReplyOperationGlobalLaneWaitProgress, p as replyRunRegistry } from "./reply-run-registry-Bzalc5xR.js";
import { s as logSessionTurnCreated } from "./diagnostic-CM9bZ9kv.js";
...
import { v as resolveSessionGoalDisplayState } from "./sessions-Bh837xaa.js";
import { c as readSessionMessagesAsync, r as readLatestSessionUsageFromTranscriptAsync } from "./session-transcript-readers-BIeuEaZ3.js";
import { a as resolveSessionModelRef } from "./placement-session-runtime-D3R4yOqT.js";
import { i as resolveModelCostConfig, n as formatUsd, t as estimateUsageCost } from "./usage-format-DVlX8Bjz.js";
...
import { d as completeFollowupRunLifecycle, f as isFollowupRunAborted, h as resolveFollowupAbortSignal, l as FollowupRunDeferredError, s as refreshQueuedFollowupSession, u as admitFollowupRunLifecycle } from "./state-DyigdfFK.js";
...
import { a as resolveReplyThreadingPayloads, i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-BJCslyOZ.js";
import { n as createReplyToModeFilterForChannel, o as resolveReplyToMode, t as createReplyDeliveryContext } from "./reply-threading-C4pm9mxI.js";
import { f as isCompactionFailureError } from "./embedded-agent-helpers-DHqB9zvZ.js";
...
import { v as readPostCompactionContext } from "./builtin-openclaw-BGUR8SQC.js";
import { n as filterMessagingToolReplyPayload } from "./reply-payloads-dedupe-xj32fEwW.js";
...
import { i as normalizePendingFinalRecoveryPayloads, n as buildRecoverablePendingFinalDeliveryText, o as sanitizePendingFinalDeliveryText, r as normalizePendingFinalDeliveryPayloads } from "./pending-final-delivery-Cm1ujhWY.js";
import { a as transitionMainSessionRecovery } from "./main-session-recovery-state-Ct2CBK87.js";
import { t as CommandLaneClearedError } from "./command-queue-B992TXUy.js";
import { h as recordReplyUsageState, m as buildReplyUsageState } from "./deliver-prepare-CQFJGt2b.js";
import { f as createAudioAsVoiceBuffer, m as createBlockReplyPipeline, p as createBlockReplyContentKey, u as requiresDurableToolResultDelivery } from "./dispatch-from-config.payloads-DC2-8ygJ.js";
...
import { m as leaseMcpAppModelContextForTurn, s as peekSessionMcpRuntime } from "./agent-bundle-mcp-manager-api-gNVONHel.js";
import "./agent-bundle-mcp-runtime-DONis5Fm.js";
import { i as getMcpAppViewLease } from "./mcp-ui-resource-BebvjVEz.js";
...
import { _ as resolveMemoryFlushPlan } from "./memory-state-B3yoTCWD.js";
...
import { f as hasCompletedSourceReplyDeliveryEvidence, l as hasCommittedSourceReplyDeliveryEvidence, p as hasCompletedTerminalDeliveryEvidence, v as hasVisibleCommittedMessagingToolDeliveryEvidence, y as hasVisibleOutboundDeliveryEvidence } from "./delivery-evidence-CEFyQPkI.js";
import { n as resolveSendPolicy } from "./send-policy-BbXuTHCZ.js";
import { r as LiveSessionModelSwitchError } from "./model-fallback-runner-BswjSwzJ.js";
import { a as setCliSessionBinding, o as setCliSessionId, s as shouldClearFailedCliSessionBinding, t as clearCliSession } from "./cli-session-DjK4b9bd.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-3zhzj640.js";
import { c as scheduleFollowupDrain } from "./cleanup-CfiPPrwM.js";
import { i as parkSteerCandidate, n as enqueueFollowupRun, t as resolveQueueSettings } from "./queue-C4ZdTJvS.js";
import { i as createAgentPatchedSessionModelFallback } from "./session-model-patch-origin-CLtcGA6d.js";
import { n as resolveEffectiveReplyRoute } from "./effective-reply-route-BwRZMEaz.js";
...
import { n as readChannelSourceTurnId, t as buildChannelSourceTurnId } from "./source-turn-id-BDtD1rRG.js";
import { n as hasDeliberateSilentTerminalReply } from "./result-fallback-classifier-CdKCxys7.js";
import { t as buildAgentRuntimeDeliveryPlan } from "./build-C8BcMI5u.js";
import { r as mergeSessionSnapshotChanges } from "./session-snapshot-merge-Bi3PsSDQ.js";
import { n as consolidateLiveModelSwitchAfterRun } from "./live-model-switch-BKx9pkp7.js";
import { t as runEmbeddedAgentEntry } from "./run-entry-DuwzvE59.js";
import { r as withLocalSessionPlacementTurnAdmission } from "./session-placement-admission-CG0soa0B.js";
import { a as isBenignCompactionSkipResult } from "./compact-reasons-BFLpmLqK.js";
import { t as runEmbeddedAgent } from "./embedded-agent--FS7CHhs.js";
import { a as withBeforeAgentReplyObserver } from "./payloads-DEmmA8-C.js";
...
import { n as resolveEffectiveBlockStreamingConfig } from "./block-streaming-CD-wYXT_.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-D0jv5eyG.js";
import { i as resolveActiveRunQueueAction, n as createTypingSignaler, t as resolveCurrentTurnImages } from "./current-turn-images-CXFkLbO0.js";
import { i as refreshActiveGoalContext } from "./inbound-meta-CJvlKDCp.js";
...
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-D0kxZSCW.js";
...
import { a as isReplyOperationSuperseded, i as isReplyOperationRestartAbort, o as isReplyOperationUserAbort, r as buildRestartLifecycleReplyText, s as resolveRestartLifecycleError, t as recordReplyOperationAgentTurn } from "./reply-operation-agent-turn-state-0tcKdAE2.js";
import { t as emitAgentRunStatusEvent } from "./agent-run-status-events-CsJwJqrA.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveModelFallbackOptions, i as isBunFetchSocketError, l as resolveFallbackCandidateRun, n as buildThreadingToolContext, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveRunFastModeForFallbackCandidate, t as buildEmbeddedRunExecutionParams, u as resolveRunAuthProfile } from "./agent-runner-utils-Dgu4m9ld.js";
import { n as prepareChannelRunAdmission } from "./channel-run-admission-ZIQJKqJg.js";
...
import { t as createMcpAppStandaloneTicket } from "./mcp-app-standalone-CXG21b0J.js";
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent-eyEW4bm0.js"));
