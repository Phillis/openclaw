...
import { n as applyPluginTextReplacements, r as mergePluginTextTransforms, t as resolveRuntimeTextTransforms } from "./text-transforms.runtime-hXZMAIOV.js";
import { a as unwrapSecretSentinelsForProviderEgress } from "./provider-secret-egress-NmAMmdEt.js";
import { d as resolveOwningPluginIdsForProviderRef, f as resolveProviderRefOwnership, p as resolveUsageHookProviderPluginContracts, r as resolveCatalogHookProviderPluginIds, s as resolveExternalAuthProfileProviderPluginIds, u as resolveOwningPluginIdsForProvider } from "./providers-CEVEnHVm.js";
import { t as resolvePluginDiscoveryProvidersRuntime } from "./provider-discovery.runtime.js";
import { d as resolveProviderPluginsForHooks, f as resolveProviderRuntimePlugin, n as clearProviderRuntimePluginCacheForTest, o as resolveLoadedProviderRuntimePlugin, r as ensureProviderRuntimePluginHandle, u as resolveProviderHookPlugin } from "./provider-hook-runtime-Cl2YZAgZ.js";
...
async function resolveProviderUsageSnapshotWithPlugin(params) {
	...
	if (!harness) {
		...
		const { loadAgentRuntimePluginRegistryHandle } = await import("./runtime-plugins-C9_8LQjt.js");
		const { ensureSelectedAgentHarnessPlugin } = await import("./runtime-plugin-CspSgP3w.js");
