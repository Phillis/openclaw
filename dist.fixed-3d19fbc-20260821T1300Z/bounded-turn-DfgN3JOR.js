...
import { l as isCodexAppServerStartSelectionChangedError, ut as isJsonObject } from "./shared-client-fWU6PNZb.js";
import { o as createDeferred } from "./extension-shared-D4oakjAV.js";
import { _ as readCodexNotificationTurnId, a as closeCodexStartupClientBestEffort, o as interruptCodexTurnAndWaitBestEffort, t as CODEX_APP_SERVER_INTERRUPT_TIMEOUT_MS } from "./attempt-client-cleanup-Bh556tF7.js";
import { b as isTerminalTurnStatus, n as normalizeCodexResponseTokenUsage, x as readCodexNotificationItem, y as isRetryableErrorNotification } from "./event-projector-usage-j_jCqvsI.js";
import { C as mergeCodexThreadConfigs, a as attestCodexRestrictedToolSurfaceMcpServersDisabled, c as readCodexInheritedMcpServerNames, i as assertCodexRestrictedToolSurfaceHasNoManagedHooks, o as buildCodexRingZeroThreadConfigPatch, s as buildCodexRuntimeThreadConfig } from "./thread-lifecycle-C6hJgTs0.js";
...
import { r as readModelListResult } from "./models-ZL7GCGE7.js";
...
async function runBoundedCodexAppServerTurnInWorkspace(params, appServer, workspace, selectionAttempt = 0, timing) {
	...
	}) : await import("./shared-client-D6ROmsMf.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
		startOptions,
		timeoutMs,
		...authSelection,
		authRequirement: params.authRequirement,
