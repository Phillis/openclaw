...
import "./accounts-DHPwZeYV.js";
import "./runtime-api-BlLsi41o.js";
import { r as getMe, t as ZaloApiError } from "./api-jUY4Yv4p.js";
import { t as resolveZaloProxyFetch } from "./proxy-IauFGfu_.js";
import { t as sendMessageZalo } from "./send-C9wc0nPc.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Dz7oVTXq.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CiDWFn5U.js");
