...
import { x as filterPublicNodeCommands } from "./node-commands-DemsbVYQ.js";
import { l as hasEffectivePairedDeviceRole } from "./device-pairing-CobL1ZXN.js";
import { _ as sameNodePermissionSurface, g as sameNodeApprovalSurfaceSet } from "./device-pairing-node-CIHQQGFC.js";
...
function buildEffectiveKnownNode(entry) {
	...
	return {
		...
		commands: filterPublicNodeCommands(live ? uniqueSortedStrings(live.commands) : uniqueSortedStrings(nodePairing?.commands)),
