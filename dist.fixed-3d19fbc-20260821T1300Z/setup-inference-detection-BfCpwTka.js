...
import { s as detectAmbientInferenceBackends, t as resolveSetupInferenceCandidateBrandId } from "./setup-inference-brand-BWwA3QI-.js";
...
var SetupInferenceDetectionTimeoutError = class extends Error {
	constructor(timeoutMs) {
		super(`Checking this Gateway for AI access timed out after ${timeoutMs / 1e3}s. The Gateway may be busy — try again.`);
