...
import { a as readErrorName, t as collectErrorGraphCandidates } from "./errors-CqPTYU6G.js";
...
import { b as isTimeoutErrorMessage, m as isUnclassifiedNoBodyHttpSignal, n as classifyFailoverSignal } from "./classify-kl1ByQTv.js";
...
function hasWorkerRunnerUnavailableFailure(err) {
...
function resolveModelFallbackError(err, context) {
	...
	if (hasGatewayDrainingFailure(err) || hasWorkerRunnerUnavailableFailure(err)) return {
		kind: "coordination",
		error: err
	};
