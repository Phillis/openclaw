...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-B77U8y22.js";
import { D as parseBrowserErrorPayload, X as withTimeout } from "./tmp-openclaw-dir-83g4L6aU.js";
import "./control-auth-BAyl0OXc.js";
import "./chrome-xp91vC5K.js";
import "./trash-VaI2WnTU.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-BN9IlCvZ.js";
import "./sdk-setup-tools-Cfx-Zqw6.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-Cn74yUgL.js";
import "./routes-COqePVRf.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-EbImUOBk.js";
import { s as stopBrowserBridgeRuntime, t as createBrowserControlContext } from "./browser-control-state-DHefTFgn.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-CDOl0rrP.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-CKlrXUjf.js"), import("./routes-BZ9IDPeU.js")]);
