...
import { a as parseBrowserTabToolBinding, n as BrowserToolSchema, r as describeBrowserTool, t as BrowserToolOutputSchema } from "./browser-tool.schema-BGs18Fhw.js";
...
function registerBrowserPlugin(api) {
	...
	api.registerCli(async ({ program }) => {
		const { registerBrowserCli } = await import("./browser-cli-Cnn2nmO3.js");
	...
	api.registerHttpRoute({
		...
		handleUpgrade: async (req, socket, head) => {
			const { handleGatewayExtensionUpgrade } = await import("./gateway-relay-route-BjfjD75w.js");
