...
import { n as getCachedPluginModuleLoader, s as clearNativeRequireJavaScriptModuleCache, t as createPluginModuleLoaderCache } from "./plugin-module-loader-cache-O65paH_z.js";
import { n as registerPluginMetadataProcessMemoLifecycleClear } from "./plugin-metadata-lifecycle-DQWVBcP_.js";
import { l as coerceDoctorSessionRouteStateOwners } from "./manifest-xccewnq4.js";
import { s as normalizePluginsConfig } from "./config-state-DLiU5GYQ.js";
import { d as resolvePluginDoctorContractArtifactPath } from "./installed-plugin-index-uuE4SyLf.js";
import { n as loadPluginManifestRegistryForPluginRegistry } from "./plugin-registry-contributions-CyOFsuOI.js";
...
function clearPluginDoctorContractRegistryLoaderState() {
	pluginDoctorContractRegistryLoaderState.moduleLoaders.clear();
	for (const [modulePath, rootDir] of pluginDoctorContractRegistryLoaderState.moduleRoots) clearNativeRequireJavaScriptModuleCache(modulePath, { dependencyRoot: rootDir });
