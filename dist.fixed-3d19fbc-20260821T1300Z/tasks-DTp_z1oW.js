...
import { w as listTaskRecordPage, x as getTaskById } from "./task-registry-1cqXcWjA.js";
...
import { i as retrySubagentCompletionDelivery, n as dismissSubagentCompletionDelivery } from "./subagent-completion-delivery-BB6UkavY.js";
...
const tasksHandlers = {
	...
	"tasks.dismiss": async ({ params, respond }) => {
		...
		const { discardSubagentTerminalDelivery } = await import("./subagent-registry-DvKfrTah.js");
		const results = [];
		for (const taskId of params.taskIds) {
