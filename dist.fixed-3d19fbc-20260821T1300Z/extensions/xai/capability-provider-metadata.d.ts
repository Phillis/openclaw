import { ft as RealtimeTranscriptionProviderConfig, lt as RealtimeVoiceProviderConfiguredContext, mt as RealtimeTranscriptionProviderResolveConfigContext, pt as RealtimeTranscriptionProviderConfiguredContext, st as RealtimeVoiceBridgeCreateRequest, ut as RealtimeVoiceProviderResolveConfigContext } from "../../types-CbXjz50O.js";
import { i as VideoGenerationProviderConfiguredContext, n as VideoGenerationModelCapabilitiesContext } from "../../video-generation-CPTNQvcn.js";
...
declare function createXaiRealtimeTranscriptionProviderMetadata(): {
  ...
  resolveConfig: ({
    rawConfig
  }: RealtimeTranscriptionProviderResolveConfigContext) => XaiRealtimeTranscriptionProviderConfig;
  isConfigured: ({
    providerConfig,
    cfg
  }: RealtimeTranscriptionProviderConfiguredContext) => boolean;
};
declare function createXaiRealtimeVoiceProviderMetadata(): {
  ...
  isConfigured: ({
    providerConfig,
    cfg
  }: RealtimeVoiceProviderConfiguredContext) => boolean;
};
