...
import { t as executeProviderOperationWithRetry } from "../../operation-retry-FfG-sjdW.js";
import { g as waitProviderOperationPollInterval, h as resolveProviderOperationTimeoutMs, n as createProviderOperationDeadline } from "../../shared-DEePW_9S.js";
import "../../response-limit-runtime-FwiZOLuO.js";
import "../../string-coerce-runtime-D9ocX9lc.js";
import "../../ssrf-runtime-D3OHU1vE.js";
import { a as resolveApiKeyForProvider } from "../../provider-auth-runtime-zf48LPN6.js";
import "../../provider-http-D7FntVgP.js";
import "../../media-generation-runtime-C74FTpN9.js";
import { n as resolveGoogleGenerativeAiApiOrigin } from "../../provider-policy-BnEdDFlj.js";
import { a as GOOGLE_VIDEO_ALLOWED_DURATION_SECONDS, l as createGoogleVideoGenerationProviderMetadata, o as GOOGLE_VIDEO_MAX_DURATION_SECONDS, s as GOOGLE_VIDEO_MIN_DURATION_SECONDS } from "../../generation-provider-metadata-DbukU2hB.js";
...
import "../../api-TRfhHL5Y.js";
import { t as canonicalizeGoogleProviderBase64 } from "../../base64-BOdkpV7S.js";
import { t as createGoogleGenAI } from "../../google-genai-runtime-AqTjmEQ_.js";
	...
	return await executeProviderOperationWithRetry({
		...
		operation: async () => {
			...
			try {
				...
				try {
					if (!response.ok) {
						const text = new TextDecoder().decode(await readResponseWithLimit(response, GOOGLE_VIDEO_OPERATION_RESPONSE_MAX_BYTES, { onOverflow: ({ maxBytes }) => /* @__PURE__ */ new Error(`Google video operation response exceeds ${maxBytes} bytes`) }));
						let detail = text;
						if (text) try {
					...
					return await readProviderJsonResponse(response, "Google video operation response", { maxBytes: GOOGLE_VIDEO_OPERATION_RESPONSE_MAX_BYTES });
				} finally {
					await release();
				}
			} finally {
