...
import { D as SecretInput, r as ModelDefinitionConfig, s as ModelProviderDeclarationConfig } from "../../types.models-i3fcfEfL.js";
import { dt as SecretInputMode } from "../../types-WpPwqCDX.js";
import { O as RuntimeEnv } from "../../manifest-registry-CCZunLSs.js";
import { r as WizardPrompter } from "../../setup-wizard-types-YKNWBZ_O.js";
import { t as LookupFn } from "../../ssrf-CIroieCz.js";
import { _ as OLLAMA_DEFAULT_COST, b as resolveOllamaSetupDefaultBaseUrl, d as resolveOllamaCompatNumCtxEnabled, f as shouldInjectOllamaCompatNumCtx, g as OLLAMA_DEFAULT_CONTEXT_WINDOW, h as OLLAMA_DEFAULT_BASE_URL, l as createConfiguredOllamaCompatStreamWrapper, p as wrapOllamaCompatNumCtx, r as buildOllamaChatRequest, u as isOllamaCompatProvider, v as OLLAMA_DEFAULT_MAX_TOKENS, y as OLLAMA_DEFAULT_MODEL } from "../../stream-api-DlnuLvWz.js";
...
declare namespace setup_runtime_d_exports {
  export { buildOllamaProvider, checkOllamaCloudAuth, configureOllamaNonInteractive$1 as configureOllamaNonInteractive, ensureOllamaModelPulled$1 as ensureOllamaModelPulled, promptAndConfigureOllama$1 as promptAndConfigureOllama, resolveOllamaSetupDefaultBaseUrl };
}
