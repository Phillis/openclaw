...
import { n as buildApiKeyCredential } from "../../provider-auth-helpers-CsfMAtQg.js";
...
import { r as resolveThinkingProfile } from "../../provider-policy-api-rlW1Ek5E.js";
...
import { a as shouldUseSyntheticOllamaAuth, i as resolveOllamaRuntimeBaseUrl, n as isLocalOllamaBaseUrl, r as resolveOllamaDiscoveryResult, t as OLLAMA_PROVIDER_ID } from "../../discovery-shared-BqMOJDbT.js";
import { c as OLLAMA_MODELS_COMMAND, d as OLLAMA_NODE_INFERENCE_DEFAULT_PLATFORMS, f as ollamaNodeInferenceToolDefinition, l as OLLAMA_NODE_INFERENCE_CAPABILITY, s as OLLAMA_CHAT_COMMAND, u as OLLAMA_NODE_INFERENCE_COMMANDS } from "../../node-inference-contract-C0NCYYcx.js";
import { c as orderPreferredOllamaModelIds, i as findAvailableOllamaModelName } from "../../setup-model-selection-DfGdHQIg.js";
import { r as resolveConfiguredOllamaProviderConfig, t as createConfiguredOllamaCompatStreamWrapper } from "../../stream-compat-DLqJLz3N.js";
import "../../stream-contract-CaPxW4Jp.js";
import { t as createLazyOllamaWebSearchProvider } from "../../web-search-provider-registration-CinHoPpm.js";
import { createHash } from "node:crypto";
//#region extensions/ollama/src/node-inference-registration.ts
const loadOllamaNodeInference = createLazyRuntimeModule(() => import("../../node-inference-DTGbxFW_.js"));
...
const loadOllamaStreamRuntime = createLazyRuntimeModule(() => import("../../stream.runtime-WyRnDScG.js"));
...
const loadOllamaSetup = createLazyRuntimeModule(() => import("../../setup.runtime-D3V0c4-L.js"));
const loadOllamaEmbeddingProvider = createLazyRuntimeModule(() => import("../../embedding-provider.runtime-CLIIl59e.js"));
const loadOllamaMemoryEmbeddingProviderAdapter = createLazyRuntimeModule(async () => (await import("../../memory-embedding-adapter-QT5wX5Hj.js")).ollamaMemoryEmbeddingProviderAdapter);
const loadOllamaMediaUnderstandingProvider = createLazyRuntimeModule(async () => (await import("../../media-understanding-provider-DDz9-POc.js")).ollamaMediaUnderstandingProvider);
...
async function checkWsl2CrashLoopRiskLazily(api) {
	try {
		...
		const { checkWsl2CrashLoopRisk } = await import("../../wsl2-crash-loop-check-3I3RM7XN.js");
