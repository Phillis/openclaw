...
import { D as resolveMemoryRemDreamingConfig } from "../../dreaming-N16HL0CK.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-BZC6dyz4.js";
...
const loadSessionBackfillGatewayRuntime = createLazyRuntimeModule(() => import("../../session-backfill-gateway.runtime-Dmi3-Qsr.js"));
...
const loadMemoryToolsModule = createLazyRuntimeModule(() => import("../../tools-BSis9uQy.js"));
const loadStandingIntentsModule = createLazyRuntimeModule(() => import("../../standing-intents-Ei563bPv.js"));
const loadStandingIntentToolModule = createLazyRuntimeModule(() => import("../../standing-intents-tool-D_1MT7Fz.js"));
const loadRuntimeProviderModule = createLazyRuntimeModule(() => import("../../runtime-provider-DwHHoQt3.js"));
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-DkLPWwNi.js");
		...
		api.registerCommand({
			...
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-5PeH6KE7.js");
