...
function resolveApprovalForwardAccountIds(params) {
	const forwarding = "command" in params.request.request ? params.cfg.approvals?.exec : params.cfg.approvals?.plugin;
...
//#endregion
export { resolveApprovalRequestChannelAccountId as a, resolveApprovalRequestAccountId as i, doesApprovalRequestMatchChannelAccount as n, resolvePersistedApprovalRequestSessionEntry as o, doesApprovalRequestSelectChannelAccount as r, classifyApprovalRequestChannelRoute as t };
