...
import { D as resolveExpiresAtMsFromDurationMs, R as timestampMsToIsoString } from "./number-coercion-oCkfUEEq.js";
...
import { a as isPathInside, m as safeStatSync, p as safeRealpathSync } from "./path-CYL8StfC.js";
import { d as recordPluginCandidateInstallOwner, f as recordPluginInstallOwnerLookup, m as resolvePluginInstallOwnerLookup, n as discoverOpenClawPlugins, o as isPluginLifecycleTraceEnabled, p as resolvePluginCandidateInstallOwner, u as isPluginCandidateInstallOwnerAmbiguous } from "./discovery-BLo8sY07.js";
...
import { t as resolveRealpathOrAbsolute } from "./boundary-path-BPbNzRAg.js";
import { r as formatErrorMessage } from "./errors-CqPTYU6G.js";
import { a as sanitizeCommandDescriptorDescription, i as normalizeCommandDescriptorName } from "./command-descriptor-utils-CvAGY4Az.js";
...
import { n as getCachedPluginModuleLoader, o as installOpenClawPluginSdkNativeResolver, t as createPluginModuleLoaderCache, u as toSafeImportPath } from "./plugin-module-loader-cache-O65paH_z.js";
import "./path-safety-CUWW7ipw.js";
import { n as resolveOpenClawDevSourceRoot, t as isBundledPluginInsideDevSourceRoot } from "./dev-source-root-CW9FkGZK.js";
import { c as resolvePluginRuntimeModulePathWithDiagnostics, t as buildPluginLoaderAliasMap } from "./sdk-alias-Bm4-C4ID.js";
...
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-BTFPUFBt.js";
import { c as resolveEffectiveEnableState, d as resolveMemorySlotDecision, l as resolveEffectivePluginActivationState, n as createPluginActivationSource, s as normalizePluginsConfig, t as applyTestPluginDefaults } from "./config-state-DLiU5GYQ.js";
...
import { _ as getPluginCompatRecord, c as collectPluginManifestCompatCodes, v as extractPluginInstallRecordsFromInstalledPluginIndex } from "./installed-plugin-index-uuE4SyLf.js";
import { a as isPluginManifestInstallOwnerAmbiguous, n as loadPluginManifestRegistryCore, o as resolvePluginManifestInstallOwner } from "./manifest-registry-BR2zb0j_.js";
import { r as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-CDDyVBh4.js";
import { _ as getNodeSqliteKysely, g as executeSqliteQueryTakeFirstSync, h as executeSqliteQuerySync, r as resolveOpenClawStateSqlitePath } from "./openclaw-state-db.paths-gKE3myqW.js";
import { t as isPromiseLike } from "./promise-like-D7-l5Fsp.js";
import { Lt as normalizeSqliteNumber, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction } from "./openclaw-state-db-BciZ4rHE.js";
import { r as resolvePluginDiscoveryContext, t as fingerprintPluginDiscoveryContext } from "./plugin-control-plane-context-7rdLh1wQ.js";
import { a as createPluginIdScopeSet, c as normalizePluginIdScope, l as serializePluginIdScope, t as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CmmO-xmS.js";
import { l as normalizeChannelMeta } from "./bundled-lDYhdxhX.js";
import { t as unwrapDefaultModuleExport } from "./module-export-DsZgGIbX.js";
import { a as resolveManifestOwnerBasePolicyBlock, t as hasExplicitManifestOwnerTrust } from "./manifest-owner-policy-DHFjJfjG.js";
import { y as normalizeOptionalAgentRuntimeId } from "./openai-routing-BC0q3X-J.js";
import { b as getCoreEmbeddingProvider } from "./gateway-startup-plugin-ids-CydfvKhz.js";
import { _ as hasInvalidLifecycleStartTimestamp, i as emitAgentEvent } from "./agent-events-Cmj8toCy.js";
import { i as isPluginRegistryRetired, n as isPluginRecordLifecycleEpochActive, r as isPluginRegistryActivated, s as revokePluginRecordLifecycleEpoch, t as activatePluginRecordLifecycleEpoch } from "./registry-lifecycle-DOGws0E2.js";
import { D as stageActivePluginRegistry, F as getPluginRunContext, I as getPluginSessionSchedulerJobGeneration, M as cleanupPluginSessionSchedulerJobs, N as clearPluginRunContext, O as withPluginRegistrationContext, P as deletePluginSessionSchedulerJob, R as registerPluginSessionSchedulerJob, T as restoreActivePluginRegistrySnapshot, d as getActivePluginRegistry, f as getActivePluginRegistryKey, g as getActivePluginSessionExtensionRegistry, i as commitStagedPluginRegistry, k as createEmptyPluginRegistry, n as captureActivePluginRegistrySnapshot, y as recordImportedPluginId, z as setPluginRunContext } from "./runtime-LV4GwzTm.js";
import { t as isPluginJsonValue } from "./host-hook-json-CRVrIqU9.js";
import { s as listChatChannels } from "./registry-BAJij-wJ.js";
import { i as withPluginRuntimePluginScope, r as withPluginRuntimePluginIdScope } from "./gateway-request-scope-BULcX9xX.js";
import { C as resolveMemoryDreamingPluginConfig, S as resolveMemoryDreamingConfig, l as DEFAULT_MEMORY_DREAMING_PLUGIN_ID } from "./dreaming-N16HL0CK.js";
import { o as createConfigRuntimeEnv } from "./config-env-vars-C1wvGC4M.js";
import "./env-vars-DOg189uj.js";
import { n as ok, t as err } from "./result-BQGgYouL.js";
import { l as isOperatorScope, t as ADMIN_SCOPE } from "./operator-scopes-Dw7Gu2cA.js";
import { a as NODE_EXEC_APPROVALS_COMMANDS, d as NODE_SYSTEM_NOTIFY_COMMAND, f as NODE_SYSTEM_RUN_COMMANDS, h as NODE_WORKER_PRIVATE_COMMANDS, w as isPrivateNodeInvokeCommand } from "./node-commands-DemsbVYQ.js";
import { f as normalizePluginGatewayMethodScope } from "./core-descriptors-x7tVv8yG.js";
...
import { n as resolveCanonicalDistRuntimeSource, r as resolvePluginRuntimeArtifact, t as clearPluginRuntimeArtifactResolutionMemo } from "./plugin-runtime-artifact-resolution-CnZ8RXPb.js";
import { t as quoteCliArg } from "./quote-cli-arg-BriMa9wW.js";
import { c as validateOptionalPluginStoreTtlMs, d as validatePluginStorePositiveInteger, l as validatePluginStoreKey, n as createPluginStateKeyedStore, r as createPluginStateSyncKeyedStore, s as serializePluginStoreJson, u as validatePluginStoreNamespace } from "./plugin-state-store-CzLOWNPC.js";
import { n as activateContextEngineRegistrations, s as registerContextEngineInRegistry } from "./registry-DBRW150B.js";
import { a as resetGlobalHookRunner, c as createPluginToolMatcherScope, d as pluginToolMatcherCoversTool, i as initializeGlobalHookRunner, n as getGlobalPluginRegistry, u as normalizePluginToolMatcher } from "./hook-runner-global-BgVsqem2.js";
import { n as normalizeMessageChannel } from "./message-channel-core-3kHPdlzP.js";
import { a as formatPluginVerificationDiagnostic, i as findActiveDegradedPlugin, n as clearActiveDegradedPlugin, r as degradedPluginMatchesRoot } from "./runtime-degraded-state-D2KYvUdx.js";
...
import { t as resolvePathFromInput } from "./path-policy-B83zOsl0.js";
import { n as resolveWorkspaceRoot } from "./workspace-dir-Di8rIzwA.js";
import { Bt as updateResolvedSessionEntry, Lt as resolveSessionEntryAccessTarget, hn as resolveSessionStorePathForScope } from "./session-accessor-CIiPoGwM.js";
...
import { a as isAgentHarnessSessionKey, o as isAgentHarnessSessionKeyOwnedBy } from "./agent-harness-session-key-BpWapmwX.js";
import { u as normalizeSessionEntrySlotKey } from "./restart-recovery-state-YPGO30LK.js";
import { t as extractDeliveryInfo } from "./delivery-info-D3wyNvfQ.js";
import { i as readRecordValue } from "./safe-record-CjQoFebO.js";
import { r as copyProviderCatalogResultEntries, t as copyProviderCatalogModels } from "./provider-catalog-result-D99kby53.js";
import { r as registerPluginInteractiveHandlerInRegistry } from "./interactive-registry-1coQOk-N.js";
import { n as normalizePluginHttpPath, t as findPluginHttpRouteRegistrationConflicts } from "./http-route-overlap-BiEmB859.js";
import { r as registerPluginCommandInRegistry, t as isReservedCommandName } from "./command-registration-C98jrNmA.js";
import { a as isPluginHookName, i as isPluginHookAgentTrigger, n as isConversationHookName, o as isPromptInjectionHookName, r as isDeprecatedPluginHookName, t as DEPRECATED_PLUGIN_HOOKS } from "./types-DQ1qMLz0.js";
import { n as validateWorkerProviderContract } from "./worker-provider-registry-D6BKW0-J.js";
import "./with-timeout-BolVqLUB.js";
import { c as prepareHostChannelContextAdmissionEvidence, f as registerChannelAdmissionEvidenceOwner, t as bindHostChannelContextAdmissionEvidence } from "./admission-evidence-UgNy_kxM.js";
import { n as createChannelIngressDrain } from "./ingress-drain-SxsnEN8i.js";
import { t as createChannelIngressQueue } from "./ingress-queue-DWDm8mi7.js";
import { t as isBundleCapabilitySupported } from "./bundle-capability-support-B86S0fqh.js";
import { n as inspectBundleMcpRuntimeSupport } from "./bundle-mcp-BD2SA9T1.js";
import "./src-BlUKtAtD.js";
import { a as resolveSetupChannelRegistration, i as resolveBundledRuntimeChannelRegistration, n as loadBundledRuntimeChannelPlugin, o as shouldLoadChannelPluginInSetupRuntime, r as mergeSetupRuntimeChannelPlugin, t as channelPluginIdBelongsToManifest } from "./loader-channel-setup-Db27e2B0.js";
...
const loadSendMessage = createLazyRuntimeModule(() => import("./message-De5qUE8e.js").then((module) => module.sendMessage));
const loadGetChannelPlugin = createLazyRuntimeModule(() => import("./plugins-BwEgyRHo.js").then((module) => module.getChannelPlugin));
...
function formatDeprecatedTypedHookDiagnostic(hookName) {
	if (!isDeprecatedPluginHookName(hookName)) return;
...
//#endregion
export { getPluginSessionExtensionStateSync as A, resolveSupportedVoiceModelRefs as C, listMediaGenerationProviderModels as D, voiceProviderSupportsModel as E, activatePluginRegistry as F, clearPluginRegistryLoadCache as I, isPluginRegistryLoadInFlight as L, projectPluginSessionExtensionsSync as M, readCanonicalCronListPage as N, synthesizeMediaGenerationCatalogEntries as O, resolveCronListPageNextOffset as P, resolvePluginRegistryLoadCacheKey as R, resolvePrimaryVoiceProviderCandidate as S, resolveVoiceProviderCandidates as T, findUndeclaredPluginToolNames as _, resolveRuntimePluginRegistry as a, getVoiceProviderConfig as b, CORE_BOARD_DATA_BINDING_IDS as c, listCodexAppServerExtensionFactories as d, getAgentToolResultMiddlewareMatcherScope as f, createPluginGatewayMethodDescriptors as g, createGatewayMethodRegistry as h, resolveCompatibleRuntimePluginRegistry as i, patchPluginSessionExtension as j, drainPluginNextTurnInjectionContext as k, loadOpenClawPluginCliRegistry as l, createGatewayMethodDescriptorsFromHandlers as m, loadPluginRegistryHandle as n, loadOpenClawPlugins as o, listAgentToolResultMiddlewares as p, getRuntimePluginRegistryForLoadOptions as r, loadOpenClawPluginsWithInternalOverrides as s, loadAndActivateRootPluginRegistry as t, createHostChannelInboundEventContextBuilder as u, getPluginRegistryRuntime as v, resolveVoiceModelRefs as w, providerMatchesId as x, projectProviderCatalogResultToUnifiedTextRows as y, buildPluginAgentTurnPrepareContext as z };
