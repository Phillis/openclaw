...
import { n as loadStaticManifestCatalogRowsForList, r as resolveManifestCatalogCoverageForList, t as loadManifestCatalogRowsForList } from "./list.manifest-catalog-BmxEnP-x.js";
//#region src/commands/models/list.scoped-catalog.ts
/** Dependency-light model catalog snapshots for default model-list views. */
const persistedCatalogModuleLoader = createLazyImportLoader(() => import("./list.persisted-catalog-CUeCouPm.js"));
const preparedScopedCatalogModuleLoader = createLazyImportLoader(() => import("./prepared-model-runtime.scoped-catalog--_v3aXxr.js"));
