...
import { d as resolveAgentWorkspaceDir, l as resolveAgentDir, p as resolveDefaultAgentId } from "./agent-scope-config-CsnnOL14.js";
...
import { n as installTemporaryCurrentPluginMetadataSnapshot, t as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CmmO-xmS.js";
import { s as normalizeProviderId } from "./model-ref-shared-poyRjWh_.js";
import { E as parseModelPolicyWildcardRef, _ as resolveConfiguredModelRef, b as resolveModelRefFromString, d as modelCatalogLogicalKey, g as resolveConfiguredModelPolicyAllow, i as buildModelAliasIndex } from "./model-selection-shared-0DI3vxkL.js";
import { n as OPENAI_PROVIDER_ID } from "./openai-routing-BC0q3X-J.js";
...
import { y as resolveMergedModelProviderConfig } from "./openai-model-routes-oiuFxnRn.js";
import { c as shouldEnableShellEnvFallback, n as getShellEnvAppliedKeys } from "./shell-env-Ckmdu1KV.js";
...
import { c as isNonSecretApiKeyMarker, g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, l as isOAuthApiKeyMarker } from "./model-auth-markers-DzAepWRR.js";
import { A as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-Bq7-AfnG.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, c as getRuntimeAuthProfileStoreSnapshot, r as ensureAuthProfileStore } from "./store-DZy8rsrA.js";
...
import { n as buildAuthProfileUnusableHint } from "./oauth-refresh-failure-DXvwptD4.js";
import "./paths-VbbHRpeN.js";
import { s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-BoIMzL8U.js";
import { n as resolveAgentHarnessOwnerPluginIds } from "./runtime-plugin-load-plan-BNIibCSY.js";
import { o as loadPreparedModelCatalogSnapshot } from "./prepared-model-catalog-DFpNDAcU.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-TorfVJYv.js";
import "./profiles-CaIWIvwD.js";
import { r as getCustomProviderApiKey, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-CwVoY8Rs.js";
import { t as createModelAuthAvailabilityResolver } from "./model-auth-availability-BgB_8p23.js";
...
import { n as resolveAgentHarnessRuntimeAvailability } from "./runtime-plugin-CJ0GKn_5.js";
...
import { a as resolveKnownAgentId, d as ensureFlagCompatibility, m as isRich } from "./shared-Dc7Dqsc7.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Dp65CGl2.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-DEtbQq95.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-DFl0T8IE.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./terminal-core/table.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-C-HKUP1J.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	const resolveCodexRuntimeAvailability = (provider) => {
		...
		const pending = (async () => {
			const { runPluginPayloadSmokeCheckForManifestRecords } = await import("./plugin-payload-validation-D2nS0SoW.js");
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-DQ-ZyfCE.js");
			runtime.log("");
