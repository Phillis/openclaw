...
import { _ as resolveGatewayPort, o as isDefaultStateDir, w as resolveStateDir } from "./paths-CqeDjSA4.js";
...
import { Q as ConfigMutationConflictError, l as readConfigFileSnapshot } from "./io-BTBpQ7uO.js";
import { p as isValidEnvSecretRefId, v as resolveSecretInputRef } from "./types.secrets-BrIfhxSG.js";
...
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-CDcCLLxH.js";
...
import { r as resolveLocalControlUiProbeLinks } from "./control-ui-links--NOqSGLU.js";
import { r as resolveManifestProviderAuthChoices } from "./provider-auth-choices-Cf_X4oEk.js";
import { h as waitForGatewayReachable, l as normalizeGatewayTokenInput, n as applyWizardMetadata, s as handleReset, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CPYqMvEB.js";
...
import { i as resolveProviderMatch } from "./provider-auth-choice-helpers-B-PbVckh.js";
...
import { o as normalizeTokenProviderInput } from "./provider-auth-input-CjTtR15n.js";
...
import { r as formatAuthChoiceChoicesForCli } from "./auth-choice-options-CgFBBcQc.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-DtIMf-Xt.js";
import { t as resolvePluginProviders } from "./provider-auth-choice.runtime-CiHLLhRH.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-DW5b6V1w.js";
import { n as validateGatewayWebSocketUrl } from "./onboard-remote-BgmqrJYc.js";
import { n as isOnboardFlow, t as isNodeManagerChoice } from "./onboard-types-Du2Y9b-2.js";
import { n as applySkipBootstrapConfig, r as resolveOnboardingWorkspaceConflict, t as applyLocalSetupWorkspaceConfig } from "./onboard-config-DayD6rmg.js";
import { t as runGuidedOnboarding } from "./onboard-guided-CV0yip7Z.js";
...
import { u as withSetupMigrationTargetLock } from "./setup.migration-snapshot-DKF7ycaB.js";
import { n as runInteractiveSetup } from "./onboard-interactive-DW6oLxSM.js";
import { t as inferAuthChoiceFromFlags } from "./auth-choice-inference-CtlX81m1.js";
import { n as resolveNonInteractiveApiKey, t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-C_gJWSRb.js";
...
async function commitNonInteractiveOnboardConfig(params) {
	const { writeWizardConfigFile } = await import("./setup.shared-fjK1_Wf3.js");
...
async function collectGatewayHealthFailureDiagnostics() {
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-BgCohGwQ.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-D9eCV1a5.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-2byrzgRK.js");
	...
	const { ensureOnboardingAgent } = await import("./onboard-agent-PMRkxb-H.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Bij21eky.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-CYLPPYs6.js");
...
async function setupWizardCommand(opts, runtime = defaultRuntime) {
	...
	if (normalizedOpts.agentName !== void 0) {
		const { validateFirstOnboardingAgentName } = await import("./onboard-agent-PMRkxb-H.js");
