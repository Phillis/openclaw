...
import { n as matrixSetupAdapter } from "./setup-core-k3slpyju.js";
import { t as withResolvedActionClient } from "./client-7PIqS6BQ.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-b_lfd-KS.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-Dn-1MUhO.js"));
