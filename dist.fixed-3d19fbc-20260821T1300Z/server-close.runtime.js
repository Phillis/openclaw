...
import { r as clearActivePluginRegistry } from "./runtime-LV4GwzTm.js";
import { t as disposeRegisteredAgentHarnesses } from "./registry-BG-SOVGv.js";
import { p as closePluginStateDatabase } from "./plugin-state-store-CzLOWNPC.js";
import { i as listChannelPlugins } from "./registry-BQt6AaEH.js";
import "./plugins-BItc4cFS.js";
import { a as disposeAcpSessionManagerInstance, t as getAcpSessionManager } from "./manager-B-UAXDlg.js";
...
import { i as isChatAbortControllerEntryAbortable, s as removeChatAbortControllerEntry, t as abortChatRunById } from "./chat-abort-9K8jqLDL.js";
...
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-DSPmkLD0.js";
import { n as clearSessionTypingState } from "./session-typing-state-CGBbZuG8.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-8JDBg6tW.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./agent-bundle-lsp-runtime-1-Vxu5MO.js");
	await disposeAllBundleLspRuntimes();
}
async function drainRetainedEmbeddingProvidersOnDemand() {
	const { drainRetainedOpenAiEmbeddingProviders } = await import("./embeddings-http-D8FgfpOc.js");
	await drainRetainedOpenAiEmbeddingProviders();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-B-9bPGFe.js");
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-DeyTIYdf.js");
