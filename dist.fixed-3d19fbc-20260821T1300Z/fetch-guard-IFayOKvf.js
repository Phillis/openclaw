...
import { n as createHttp1EnvHttpProxyAgent, r as createHttp1ProxyAgent, t as createHttp1Agent, u as resolveUndiciAutoSelectFamilyConnectOptions } from "./undici-runtime-D3K4ZfcZ.js";
import { _ as resolvePinnedHostnameWithPolicy, a as createPinnedDispatcher, i as closeDispatcher, n as assertHostnameAllowedWithPolicy, p as matchesHostnameAllowlist, t as SsrFBlockedError, v as resolveSsrFPolicyForUrl } from "./ssrf-CQ4RdJXm.js";
import "./pinned-dispatcher-pool-BoPYEtrW.js";
import { i as isMockedFetch, n as fetchWithRuntimeDispatcher } from "./runtime-fetch-DiYW5v-w.js";
import { o as globalUndiciStreamTimeoutMs } from "./undici-global-dispatcher-Bf4HTYfs.js";
...
async function captureGuardedFetchExchange(params) {
	...
	const { captureHttpExchange, isDebugProxyGlobalFetchPatchInstalled } = await import("./runtime-DkNcew_6.js");
...
async function fetchWithSsrFGuardInternal(params) {
	...
	while (true) {
		...
		let dispatcherLease;
		let activeResponse;
		const releaseDispatcher = async () => await (dispatcherLease ? dispatcherLease.release() : closeDispatcher(dispatcher));
		...
		try {
			...
			if (canUseTrustedEnvProxy) dispatcher = createHttp1EnvHttpProxyAgent(void 0, timeoutMs);
				...
				if (params.dispatcherPool && mode === GUARDED_FETCH_MODE.STRICT && dispatcherPolicy === void 0) {
					...
					if (!dispatcherLease) dispatcher = createPinnedDispatcher(pinned, void 0, policyForUrl, timeoutMs);
					else dispatcher = dispatcherLease.dispatcher;
			...
			await activeResponse?.body?.cancel().catch(() => void 0);
