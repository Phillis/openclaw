...
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-vrZOqJ0H.js";
...
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-Dd8j_3-D.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-BSqeBQRn.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-CpXXjSXS.js");
			...
			const { statusCommand } = await import("./status-BlG6TLR_.js");
