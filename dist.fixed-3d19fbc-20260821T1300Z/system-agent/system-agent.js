...
import { a as parseSystemAgentOperation, i as isPersistentSystemAgentOperation, t as executeSystemAgentOperation } from "../operations-CqBuFQx5.js";
...
import { n as resolveSystemAgentOperation } from "../dialogue-B_Ebupl3.js";
...
async function runSystemAgent(opts, runtime = defaultRuntime) {
	...
	const runInteractiveTui = boundOpts.runInteractiveTui ?? (await import("../tui-backend-DKPoua92.js")).runSystemAgentTui;
	boundOpts.onReady?.();
