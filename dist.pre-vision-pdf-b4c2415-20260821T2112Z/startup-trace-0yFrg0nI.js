...
import { f as isSimpleCommandHelpInvocation, n as getCommandPathWithRootOptions } from "./argv-CgA2urTO.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-CtNEO_uG.js";
import { a as scanCliRootOptions, i as takeCliRootOptionValue } from "./container-target-CmkzL0zt.js";
...
function createGatewayDispatchStartupTrace(argv, source) {
	...
	let pendingMessages = [];
	const timelineModule = hasDiagnosticsTimelinePath(process$1.env) ? import("./diagnostics-timeline-9VUV8PQd.js").catch(() => null) : null;
