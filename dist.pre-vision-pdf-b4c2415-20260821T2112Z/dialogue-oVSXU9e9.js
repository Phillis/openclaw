...
import { a as parseSystemAgentOperation, n as describeSystemAgentPersistentOperation, s as isInvalidConfigSetOperation } from "./operations-C5bGSw_S.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-GMaU-pUZ.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
