...
import { n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-B3yYjPW1.js";
import "./plugins-cwOWOggC.js";
import "./model-selection-Dg63KcCa.js";
import { t as getChatCommands } from "./commands-registry.data-i3bR6Fdo.js";
...
import "./commands-text-routing-BxDpdnEG.js";
...
function toNativeCommandSpec(command, provider, options) {
	const spec = {
...
function resolveNativeNames(command, provider, options) {
	return [resolveNativeName(command, provider, options), ...command.nativeAliases ?? []].filter((name) => Boolean(name));
}
