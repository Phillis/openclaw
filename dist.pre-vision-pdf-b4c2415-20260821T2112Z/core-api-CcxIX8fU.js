...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-Cj5bkhGy.js";
import { D as parseBrowserErrorPayload, X as withTimeout } from "./tmp-openclaw-dir-D8YnNVMn.js";
import "./control-auth-DSOCl2eu.js";
import "./chrome-UWiRrGDG.js";
import "./trash-hF76IokJ.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-BZjR3GMX.js";
import "./sdk-setup-tools-B8uego0s.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-j-_aWq7o.js";
import "./routes-DPAVTh_0.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-C49J9C1j.js";
import { s as stopBrowserBridgeRuntime, t as createBrowserControlContext } from "./browser-control-state-B8K8CIAv.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-C0TRBjv_.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-CCG2QrUt.js"), import("./routes-D4W4hmeH.js")]);
