...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute } from "./core-BEnl4KjI.js";
...
import { h as resolveScopeToolsPolicy, m as resolveScopeRequireMention } from "./channel-policy-DlGVx39H.js";
import { a as createEmptyChannelResult } from "./channel-send-result-BFAnsv6z.js";
import { a as checkZcaAuthenticated, c as resolveZalouserAccountSync, i as writeQrDataUrlToTempFile, o as listZalouserAccountIds, r as zalouserSetupContract, s as resolveDefaultZalouserAccountId, t as createZalouserSetupWizardProxy } from "./setup-core-BmwCXOYR.js";
...
const loadZalouserChannelRuntime$1 = createLazyRuntimeModule(() => import("./channel.runtime-C4e1m04m.js"));
...
const loadZalouserChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-C4e1m04m.js"));
const zalouserSetupWizardProxy = createZalouserSetupWizardProxy(async () => (await import("./setup-surface-Cou9-hwr.js")).zalouserSetupWizard);
	...
	base: {
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				const { monitorZalouserProvider } = await import("./monitor-CLsdtGus.js");
