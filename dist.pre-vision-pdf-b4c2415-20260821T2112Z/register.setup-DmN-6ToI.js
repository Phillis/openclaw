...
import { a as resolveTailscaleResetOnExitFlag, i as resolveInstallDaemonFlag, n as registerOnboardAuthOptions, o as validateOnboardAuthOptionValues, t as pickOnboardAuthOptionValues } from "./register.onboard-UtFROF2i.js";
...
async function runOnboardingEntry(options, commandRuntime, runtime) {
	if (options.baseline) {
		...
		const { setupCommand } = await import("./setup-CN1StPWM.js");
		await setupCommand({
