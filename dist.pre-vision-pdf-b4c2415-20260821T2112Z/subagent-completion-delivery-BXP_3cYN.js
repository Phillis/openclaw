...
import { b as findTaskByRunId, v as publishTaskRecordAfterAtomicStore, x as getTaskById } from "./task-registry-D0u4Dzrj.js";
...
import { L as resolveSubagentCompletionResultText, T as safeRemoveAttachmentsDir, g as ANNOUNCE_COMPLETION_HARD_EXPIRY_MS, s as loadPendingFinalDeliveryPayload } from "./subagent-registry-lifecycle-delivery-DekTaqCR.js";
...
async function settleCorrelatedSubagentDelivery(queued, outcome) {
	...
	publishCommittedRecords(subagent, projectedTask);
	if (outcome === "recovered") {
		const { resumeSubagentRun } = await import("./subagent-registry-DTbY2QEQ.js");
