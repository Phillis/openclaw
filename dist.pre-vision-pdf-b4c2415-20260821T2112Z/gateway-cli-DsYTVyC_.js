...
import { t as addGatewayServiceCommands } from "./register-service-commands-hQxbHvzF.js";
...
import { t as addGatewayRunCommand } from "./run-command-Dahf5McK.js";
...
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-Cak4Gv9x.js"));
...
function registerGatewayCli(program, deps = {}) {
	...
	gateway.command("auth-token").description("Reveal the configured shared Gateway token").option("--show", "Print the token to an interactive terminal", false).action(async (opts) => {
		await runGatewayCommand(async () => {
			...
			const { gatewayAuthTokenCommand } = await import("./gateway-auth-token-BlSMc6Q9.js");
