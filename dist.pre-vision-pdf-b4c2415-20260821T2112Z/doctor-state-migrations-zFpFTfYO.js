...
import { c as resolveLegacyInstalledPluginIndexStorePath } from "./installed-plugin-index-record-reader-PWJi_KhT.js";
...
import { _ as getNodeSqliteKysely, f as OPENCLAW_SQLITE_BUSY_TIMEOUT_MS, g as executeSqliteQueryTakeFirstSync, h as executeSqliteQuerySync, o as readSqliteUserVersion, r as resolveOpenClawStateSqlitePath } from "./openclaw-state-db.paths-DmtKty-F.js";
import { D as detectOpenClawStateDatabaseSchemaMigrations, d as openOpenClawStateDatabase, fn as repairCanonicalSqliteIndexes, h as runOpenClawStateWriteTransaction, jt as tableExists, m as repairOpenClawStateDatabaseSchemaIfNeeded, p as repairOpenClawStateDatabaseSchema } from "./openclaw-state-db-DlCMR4eQ.js";
...
import "./installed-plugin-index-store-CVIoH-T0.js";
import { n as collectRelevantDoctorPluginIds, o as listPluginDoctorSessionStoreAgentIds, s as listPluginDoctorStateMigrationEntries } from "./doctor-contract-registry-RRCWrGfZ.js";
import { n as resolveSessionStoreCompatibilityAgentId } from "./legacy.default-agent-owner-D8ws5hED.js";
import { n as readConfigMachineState, r as updateConfigMachineState, t as importConfigMachineState } from "./config-machine-state-DtXnQEX3.js";
...
import { n as CONFIG_AUDIT_SCOPE, t as CONFIG_AUDIT_MAX_ENTRIES } from "./io.audit-BpOif9wN.js";
...
import { c as resolveSharedMainAuthAgentDir, n as noteCommittedSharedAuthStoreOwnership, o as resolveSharedAuthStoreOwnership, t as SHARED_AUTH_STORE_STATE_KEY } from "./path-resolve-CttHagpC.js";
import { i as closeOpenClawAgentDatabaseByPath, v as runOpenClawAgentWriteTransaction } from "./openclaw-agent-db-lxLIE6rA.js";
import { E as listOpenClawRegisteredAgentDatabases, S as isPersistentOpenClawAgentDatabasePath, T as unregisterOpenClawAgentDatabase, b as OPENCLAW_AGENT_SCHEMA_SQL, n as assertOpenClawAgentDatabaseOwner, o as ensureOpenClawAgentDatabaseSchema, s as migrateOpenClawAgentDatabaseToMediaPrerequisiteSchema, u as assertOpenClawAgentSchemaContains, w as registerOpenClawAgentDatabase, x as createOpenClawAgentDatabasePathMatcher } from "./openclaw-agent-db-maintenance-B1somIwL.js";
import "./openclaw-agent-db-migration-required-RkIFq1cn.js";
import { p as resolveAuthProfileDatabaseOwnerId, t as closeAuthProfileReadPool } from "./sqlite-CtUje688.js";
import { h as getPluginStateCapacity, i as importPluginStateEntriesForDoctor, n as createPluginStateKeyedStore } from "./plugin-state-store-D5dGBXer.js";
import { Jt as listSessionEntryKeysReadOnly } from "./session-accessor-Bi6bzKQE.js";
import { t as getChannelPlugin } from "./registry-B3yYjPW1.js";
import { c as resolveSessionStoreTargets, d as resolveAgentSessionDirsFromAgentsDirSync } from "./targets-DxP0vsft.js";
import { r as resolveSqliteTargetFromSessionStorePath } from "./session-sqlite-target-DH7-Rfwr.js";
import { l as resolveSqliteTranscriptArchiveDirectory } from "./session-accessor.sqlite-scope-kI2NyJDH.js";
import { d as rewriteSqliteTranscriptEventRowsInTransaction } from "./session-accessor.sqlite-transcript-store-E-m-_aAq.js";
...
import { a as isSafeWorkspaceAttestationFilename, d as resolveWorkspaceStateIdentity, l as registerWorkspaceStateAliasesInTransaction, n as WORKSPACE_LEGACY_STATE_MIGRATION_KIND } from "./workspace-state-store-jYrit6Rg.js";
import { n as LEGACY_WORKSPACE_ATTESTATION_HEADER, o as WORKSPACE_DOCTOR_CLAIM_SUFFIX, r as LEGACY_WORKSPACE_ATTESTATION_MAX_BYTES, t as LEGACY_WORKSPACE_ATTESTATION_DIRNAME, u as resolveLegacyWorkspaceSourcePaths } from "./workspace-legacy-state-i2unYb2K.js";
import { n as SYSTEM_AGENT_AUDIT_SCOPE, t as SYSTEM_AGENT_AUDIT_MAX_ENTRIES } from "./audit-axLAZUro.js";
...
import { n as parseRestartSentinelEnvelope, o as writeRestartSentinelRowSync, r as readRestartSentinelRowSync } from "./restart-sentinel-store-BRdpiy-K.js";
import { f as mcpOAuthStoreKeyFromLegacyFileName, o as parseMcpOAuthStoreJson } from "./mcp-oauth-store-B9ty9rCA.js";
import { r as resolveSandboxWorkspaceLayoutPaths } from "./shared-Ca08a7jf.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-C-WC19Mc.js";
import { a as transcriptSessionExportKey, i as safeTranscriptPathSegment, n as renderTranscriptsMarkdown, o as transcriptSessionSelector, s as ensureMeetingTranscriptsSchema, t as TranscriptsStore } from "./store-Bp9vPpHI.js";
import { C as rewriteRegistryWorktreePathsForMigration, g as hasLegacyRegistryWorktrees, s as discardLegacyRegistryWorktrees, x as listRegistryWorktreesForMigration } from "./registry-DAA0mvyN.js";
import { a as updateChannelPairingStateSnapshot, c as resolveAllowFromAccountId, l as safeAccountKey, s as dedupePreserveOrder, u as getPairingAdapter } from "./pairing-store-sqlite-DgwyCQso.js";
...
import { c as managedImageRecordToRow, l as managedImageRecordsEqual, s as managedImageRecordFromRow, t as MANAGED_OUTGOING_ORIGINALS_SUBDIR } from "./managed-image-record-store-DOItyWTY.js";
import { n as normalizeVoiceWakeRoutingConfig } from "./voicewake-routing-Dz70NBC0.js";
import { n as LEGACY_NODE_HOST_CONFIG_FILE, r as NODE_HOST_CONFIG_KEY, t as LEGACY_NODE_HOST_CONFIG_CLAIM_SUFFIX } from "./config-BWm1RSBz.js";
import { _ as migrateLegacyDeviceAuth, a as assertLegacyMigrationSourceUnchanged, c as legacyMigrationPathMayExist, d as readLegacyMigrationSourceSnapshot, f as readLegacyMigrationSourceSnapshotSync, g as detectLegacyDeviceAuth, h as detectLegacyDeviceIdentity, i as LegacyMigrationSourceClaim, l as legacyMigrationSourceOrClaimMayExist, m as restoreLegacyMigrationSourceClaims, n as migrateLegacyExecApprovals, o as claimAndRemoveLegacyMigrationSource, p as resolveLegacyMigrationRelativePath, r as migrateLegacyDeviceIdentity, s as claimLegacyMigrationSourceClaims, t as detectLegacyExecApprovals, u as legacyMigrationSourceSnapshotsMatch, v as withLegacyMigrationStateLock } from "./state-migrations.exec-approvals-Dk7RHB0U.js";
import { a as recordLegacyMigrationRun, i as recordLegacyMigrationReceipt, n as readLegacyMigrationReceipt, o as recordLegacyMigrationSource, r as readLegacyMigrationReceiptFromDatabase, s as resolveLegacyMigrationSourceKey, t as markLegacyMigrationSourceRemoved } from "./state-migrations.receipts-BDVbV8P2.js";
import { c as repairGatewayAgentMediaMigrationStartupFailures } from "./gateway-boot-lifecycle-_xaa0ZpV.js";
import { c as recordsAfterLegacyAuditRawCheckpoint, d as prepareLegacyAuditRecords, f as serializePreparedAuditRecords, g as legacyAuditSourceGenerationKey, l as restoreInterruptedAuditRecoveryArchive, m as hasLegacyAuditRawCheckpointCapacity, n as finalizeLegacyAuditRecoveryArchive, o as readLegacyAuditSourceSnapshot, p as detectLegacyAuditLogs, r as findPreviousLegacyAuditRawCheckpoint, s as recordLegacyAuditRawCheckpoint, t as withLegacyAuditMigrationLease, u as scrubLegacyAuditRecoveryArchive } from "./state-migrations.audit-coordination-DdDIyk6L.js";
import { a as isLegacyControlUiDeviceAuthMigrationInput, t as CONTROL_UI_DEVICE_AUTH_MIGRATION_STATE_KEY } from "./control-ui-device-auth-migration-9nZJw2eo.js";
import { d as normalizeApnsNodeId, m as normalizeCanonicalApnsRegistration, n as apnsRegistrationFromRow, o as isValidApnsNodeId, r as apnsRegistrationToRow, u as normalizeApnsEnvironment } from "./push-apns-store-D50lavae.js";
import { _ as selectNewerSessionEntry, a as isAmbiguousSharedStoreKey, c as mergeSessionStoreAliasPlans, d as normalizeSessionEntry, f as pickLatestLegacyDirectEntry, g as saveSessionStoreStrict, h as resolveStaleLegacySessionFile, i as emptyDirOrMissing, l as migrateLegacyAcpSessionMetadata, m as resolveSessionStoreOwnership, n as canonicalizeSessionStore, o as isLegacyDefaultMainAliasKey, p as removeDirIfEmpty, r as distinctSessionStoreAliasWarning, s as listLegacySessionKeys, t as aliasedSessionStoreMigrationWarning, u as migrateOrphanedSessionKeys, v as unresolvedSessionStoreIdentityWarning } from "./state-migrations.session-store-DcjWHSEP.js";
import { a as PLUGIN_STATE_SQLITE_SIDECAR_SUFFIXES, c as hasPendingSqliteSidecarArchive, d as migrateLegacyDeliveryQueues, f as migrateLegacyTaskStateSidecars, g as resolveLegacyTaskRunsSidecarPath, h as resolveLegacyPluginStateSidecarPath, l as listLegacyDeliveryQueueDeliveredMarkers, m as resolveLegacyFlowRunsSidecarPath, n as migrateLegacyPluginStateSidecar, o as TASK_STATE_SQLITE_SIDECAR_SUFFIXES, p as resolveLegacyDeliveryQueuePath, r as preflightLegacyInstalledPluginIndexMigration, s as archiveLegacyImportSource, t as migrateLegacyInstalledPluginIndex, u as listLegacyDeliveryQueueFiles } from "./state-migrations.plugin-state-Ru5iU6Py.js";
import { c as isValidWebPushEndpoint, g as webPushVapidKeyPairToRow, h as webPushSubscriptionsEqual, l as isValidWebPushKey, m as webPushSubscriptionToRow, n as WEB_PUSH_VAPID_KEY_ID, o as hashWebPushEndpoint, p as webPushSubscriptionFromRow, r as createWebPushVapidKeyPair } from "./push-web-store-BMMu9-sW.js";
...
async function autoMigrateLegacyState(params) {
	...
	const legacySessionSurfaces = params.legacySessionSurfaces ?? (await import("./legacy-session-surfaces-DW7EJQe-.js")).prepareLegacySessionSurfaces({
		config: params.cfg,
		env
	});
