...
import { a as parseBrowserTabToolBinding, n as BrowserToolSchema, r as describeBrowserTool, t as BrowserToolOutputSchema } from "./browser-tool.schema-B9msxQvK.js";
...
function registerBrowserPlugin(api) {
	...
	api.registerCli(async ({ program }) => {
		const { registerBrowserCli } = await import("./browser-cli-BGswnOfT.js");
	...
	api.registerHttpRoute({
		...
		handleUpgrade: async (req, socket, head) => {
			const { handleGatewayExtensionUpgrade } = await import("./gateway-relay-route-YxQIyEkw.js");
