...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-DJzIouu3.js";
...
const loadSessionBackfillGatewayRuntime = createLazyRuntimeModule(() => import("../../session-backfill-gateway.runtime-CA-43c7Z.js"));
...
const loadMemoryToolsModule = createLazyRuntimeModule(() => import("../../tools-DI7on2om.js"));
const loadStandingIntentsModule = createLazyRuntimeModule(() => import("../../standing-intents-PjEukdlk.js"));
const loadStandingIntentToolModule = createLazyRuntimeModule(() => import("../../standing-intents-tool-LyKtVgrO.js"));
const loadRuntimeProviderModule = createLazyRuntimeModule(() => import("../../runtime-provider-CmShtcjR.js"));
...
var memory_core_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCommand({
			...
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-CUF-uAyR.js");
