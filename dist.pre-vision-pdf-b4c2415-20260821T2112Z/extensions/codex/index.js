...
import { a as closeCodexStartupClientBestEffort, d as unsubscribeCodexThreadBestEffort, h as isCodexNotificationForTurn, o as interruptCodexTurnAndWaitBestEffort, p as getCodexAppServerTurnRouter, u as retireUnsafeCodexTurnClientBestEffort } from "../../attempt-client-cleanup-CqdivHIZ.js";
import { s as isAssistantCommentaryCompletionNotification } from "../../event-projector-usage-DL2HZUaX.js";
import { C as mergeCodexThreadConfigs, D as isOpenAiCuratedMarketplace, T as ensureCodexPluginActivation, f as resolveCodexAppServerRequestModelSelection, k as pluginReadParams, u as CODEX_NATIVE_PERSONALITY_NONE, x as buildDisabledAppsConfigPatch } from "../../thread-lifecycle-DvLvp9A6.js";
...
import { l as projectBoundedCodexVisibleSessionHistory } from "../../transcript-mirror-BqCkRJQk.js";
...
import { t as resolveCodexAppServerForModelProvider } from "../../app-server-policy-Br9IMbRJ.js";
...
import { t as resumeCodexAppServerThread } from "../../thread-resume-N1Fdyl9q.js";
...
import { n as registerCodexCliMetadata } from "../../cli-metadata-CIZn3U57.js";
import { t as createCodexAppServerAgentHarness } from "../../harness-DnSZwaNk.js";
...
import { f as trackCodexConversationActiveTurn, m as canMutateCodexHost, p as CODEX_NATIVE_EXECUTION_AUTH_ERROR, t as discoverCodexMarketplacePlugins } from "../../plugin-marketplace-discovery-C1sZYAPd.js";
...
import { d as resumeCodexCliSessionOnNode, l as listCodexCliSessionsOnNode, o as createCodexCliSessionNodeHostCommands, s as createCodexCliSessionNodeInvokePolicies, t as codexControlRequest, u as resolveCodexCliSessionForBindingOnNode } from "../../command-rpc-DEFM5K_g.js";
import { i as createCodexSessionCatalogNodeInvokePolicies, n as createCodexSessionCatalogControl, o as assertCodexArchiveDescendantsUnowned, r as createCodexSessionCatalogNodeHostCommands, t as codexSessionCatalogRuntime } from "../../session-catalog-lENy0-4c.js";
...
function createLazyCodexAppServerBindingStore(state) {
	let resolved;
	const store = () => resolved ??= import("../../session-binding-DaeE7VPY.js").then(({ createCodexAppServerBindingStore }) => createCodexAppServerBindingStore(state));
	return {
...
async function loadDefaultCodexSubcommandHandler() {
	const { handleCodexSubcommand } = await import("../../command-handlers-DCpYdtfA.js");
...
const loadCodexWebSearchRuntime = createLazyRuntimeModule(() => import("../../web-search-provider.runtime-iJlTu3mf.js"));
...
var codex_default = definePluginEntry({
	...
	register(api) {
		...
		api.on("after_compaction", async (event, ctx) => {
			...
			const { sessionBindingIdentity } = await import("../../session-binding-DaeE7VPY.js");
			const identity = sessionBindingIdentity({
				sessionId,
		...
		api.on("session_end", async (event, ctx) => {
			...
			const config = resolveCurrentConfig();
			const [{ sessionBindingIdentity }, { retireCodexAppServerSessionGeneration }] = await Promise.all([import("../../session-binding-DaeE7VPY.js"), import("../../session-retirement-DE9ZPjvl.js")]);
