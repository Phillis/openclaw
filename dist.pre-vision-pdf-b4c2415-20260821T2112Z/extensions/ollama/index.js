...
import { n as buildApiKeyCredential } from "../../provider-auth-helpers-wvIT0e4l.js";
...
import { r as resolveThinkingProfile } from "../../provider-policy-api-CPYeDl__.js";
...
import { a as shouldUseSyntheticOllamaAuth, i as resolveOllamaRuntimeBaseUrl, n as isLocalOllamaBaseUrl, r as resolveOllamaDiscoveryResult, t as OLLAMA_PROVIDER_ID } from "../../discovery-shared-DmNtuPcd.js";
...
import { c as orderPreferredOllamaModelIds, i as findAvailableOllamaModelName } from "../../setup-model-selection-i9MLh05b.js";
import { r as resolveConfiguredOllamaProviderConfig, t as createConfiguredOllamaCompatStreamWrapper } from "../../stream-compat-Dayg7emO.js";
import "../../stream-contract-CaPxW4Jp.js";
import { t as createLazyOllamaWebSearchProvider } from "../../web-search-provider-registration-Dwq4Fvv4.js";
import { createHash } from "node:crypto";
//#region extensions/ollama/src/node-inference-registration.ts
const loadOllamaNodeInference = createLazyRuntimeModule(() => import("../../node-inference-B1Do5vmo.js"));
...
const loadOllamaStreamRuntime = createLazyRuntimeModule(() => import("../../stream.runtime-Bioy1-Nq.js"));
...
const loadOllamaSetup = createLazyRuntimeModule(() => import("../../setup.runtime-DUO7ibwA.js"));
const loadOllamaEmbeddingProvider = createLazyRuntimeModule(() => import("../../embedding-provider.runtime-BRhTuG5H.js"));
const loadOllamaMemoryEmbeddingProviderAdapter = createLazyRuntimeModule(async () => (await import("../../memory-embedding-adapter-BZoyEkcT.js")).ollamaMemoryEmbeddingProviderAdapter);
const loadOllamaMediaUnderstandingProvider = createLazyRuntimeModule(async () => (await import("../../media-understanding-provider-BbJG8AuP.js")).ollamaMediaUnderstandingProvider);
