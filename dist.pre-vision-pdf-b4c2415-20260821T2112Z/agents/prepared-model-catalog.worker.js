...
import { n as overlayExternalAuthProfiles } from "../external-auth-DYbQhYfq.js";
import { r as listExternalCliSyncProviderIds } from "../external-cli-sync-CU9M9_mw.js";
import { m as preserveResolvedSecretBackedCredentials, p as loadAuthProfileStoreWithoutExternalProfiles } from "../store-BH6qiWJF.js";
import { f as resolveAmbientAgentCredentialsForDiscovery, m as resolveUsableAgentCredentialModes, p as resolveAgentCredentialMapFromStore } from "../prepared-model-runtime.facts-BrYzuXKg.js";
import { gt as AuthStorage } from "../sessions-BIUamgQ4.js";
import { r as fingerprintPreparedModelCatalogGeneration } from "../prepared-model-catalog-worker-B3ekHnv8.js";
...
async function prepareWorkerGeneration(value) {
	const { prepareWorkspaceBuildGroup } = await import("../prepared-model-runtime.facts-Caxi4WYj.js");
...
async function runPreparedModelCatalogWorkerRequest(value, request, preparedGeneration = prepareWorkerGeneration(value)) {
	try {
		...
		const { prepareAgentCatalogSource, prepareFullCatalogFacts } = await import("../prepared-model-runtime.facts-Caxi4WYj.js");
		const authStore = refreshAuthStore({
			agentDir: value.input.agentDir,
			inheritedAuthDir: value.input.inheritedAuthDir,
			authStore: value.authStore,
