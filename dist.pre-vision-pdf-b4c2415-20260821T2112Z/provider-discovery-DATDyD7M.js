...
import { i as copyProviderCatalogResultProjection, n as copyProviderCatalogOutcomes } from "./provider-catalog-result-D99kby53.js";
...
async function runProviderCatalog(params) {
	...
	for (const outcome of copyProviderCatalogOutcomes(result)) params.reportCatalogOutcome?.(outcome);
	return result;
}
