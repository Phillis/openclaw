...
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-ChTHtBPD.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-BtdGICbt.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-DFHtTjHW.js");
			...
			const { statusCommand } = await import("./status-yq7Qif95.js");
