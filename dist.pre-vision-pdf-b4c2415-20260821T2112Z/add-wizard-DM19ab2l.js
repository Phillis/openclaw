...
import { t as applyAgentBindings } from "./agents.bindings-laCM4ySw.js";
...
async function loadOnboardChannels() {
	return await import("./onboard-channels-ktAa3lY4.js");
}
...
async function resolveInitialWizardChannel(raw, cfg) {
	...
	const [{ listActiveChannelSetupPlugins }, { resolveChannelSetupEntries }] = await Promise.all([import("./setup-registry-DgcYKyl8.js"), import("./discovery-DcIaJWX1.js")]);
...
async function runChannelsAddWizardFlow(params) {
	...
	const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-BlDN1tWE.js"), loadOnboardChannels()]);
