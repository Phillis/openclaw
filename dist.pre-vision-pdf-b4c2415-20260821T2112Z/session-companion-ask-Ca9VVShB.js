...
import { i as resolveSimpleCompletionSelectionForAgent } from "./simple-completion-runtime-Dzj22N2_.js";
...
async function defaultRun(params) {
	...
	const { prepareInternalSessionEffectsSession, removeInternalSessionEffectsSession } = await import("./internal-session-effects-BROK0fCI.js");
	...
	try {
		const [{ SessionManager }, { runEmbeddedAgent }] = await Promise.all([import("./sessions-Xlz6uLSg.js"), import("./embedded-agent-BG39LAbd.js")]);
