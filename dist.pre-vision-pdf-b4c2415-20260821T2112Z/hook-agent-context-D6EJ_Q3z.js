...
import { u as parseRawSessionConversationRef } from "./session-key-utils-D8x_bjrd.js";
...
function buildAgentHookContextLineageFields(params) {
	...
	const internalHandoff = trustedHandoff?.kind === "subagent-completion" && trustedHandoff.targetSessionKey === sessionKey && trustedHandoff.targetSessionId === sessionId ? {
		kind: trustedHandoff.kind,
		sourceSessionKey: trustedHandoff.sourceSessionKey,
		...trustedHandoff.sourceSessionId ? { sourceSessionId: trustedHandoff.sourceSessionId } : {}
	} : void 0;
	const sessionLineage = spawnedBySessionKey || internalHandoff ? {
...
//#endregion
export { buildAgentHookContextIdentityFields as n, buildAgentHookContextLineageFields as r, buildAgentHookContextChannelFields as t };
