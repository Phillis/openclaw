...
const CORE_GATEWAY_HANDLER_MODULES = {
	agent: () => import("./agent-B2rTSo-C.js").then((module) => module.agentHandlers),
	...
	artifacts: () => import("./artifacts-7_BPwnt8.js").then((module) => module.artifactsHandlers),
	board: () => import("./board-DiIzbpUX.js").then((module) => module.boardHandlers),
	...
	attach: () => import("./attach-DoAo-vVI.js").then((module) => module.attachHandlers),
	...
	chat: () => import("./chat-CxsGi5fn.js").then((module) => module.chatHandlers),
	commands: () => import("./commands-CJlRJQEJ.js").then((module) => module.commandsHandlers),
	config: () => import("./config-BcBQoX9d.js").then((module) => module.configHandlers),
	...
	health: () => import("./health-CrbqmWMW.js").then((module) => module.healthHandlers),
	...
	"models-probe": () => import("./models-probe-TgVu-BM3.js").then((module) => module.modelsProbeHandlers),
	...
	nodes: () => import("./nodes-BLYEqRdY.js").then((module) => module.nodeHandlers),
	...
	restart: () => import("./restart-C-3usFSj.js").then((module) => module.restartHandlers),
	suspend: () => import("./suspend-B920dCUa.js").then((module) => module.suspendHandlers),
	...
	"sessions-abort": () => import("./sessions-abort-BjcConSx.js").then((module) => module.sessionAbortHandlers),
	"sessions-compact": () => import("./sessions-compact-C7qbvbrA.js").then((module) => module.sessionCompactHandlers),
	"sessions-compaction-checkpoints": () => import("./sessions-compaction-checkpoints-DNjTBhQY.js").then((module) => module.sessionCheckpointHandlers),
	"sessions-compaction-queries": () => import("./sessions-compaction-queries-BjjvpsZC.js").then((module) => module.sessionCheckpointQueryHandlers),
	"sessions-create": () => import("./sessions-create-Cg9rWYkh.js").then((module) => module.sessionCreateHandlers),
	"sessions-recover": () => import("./sessions-recover-Ba00Abmd.js").then((module) => module.sessionRecoverHandlers),
	"sessions-delete": () => import("./sessions-delete-Cv5-abmn.js").then((module) => module.sessionDeleteHandlers),
	"sessions-dispatch": () => import("./sessions-dispatch-BvsBj80w.js").then((module) => module.sessionDispatchHandlers),
	"sessions-groups": () => import("./sessions-groups-DT5-xOIS.js").then((module) => module.sessionGroupHandlers),
	"sessions-messaging": () => import("./sessions-messaging-CATetaMm.js").then((module) => module.sessionMessagingHandlers),
	"sessions-mutations": () => import("./sessions-mutations-Cp_SfO60.js").then((module) => module.sessionMutationHandlers),
	"sessions-read": () => import("./sessions-read-CLHoRdCw.js").then((module) => module.sessionReadHandlers),
	"sessions-rewind": () => import("./sessions-rewind-lRxU_Y16.js").then((module) => module.sessionRewindHandlers),
	"sessions-sharing": () => import("./sessions-sharing-BDr_Jz5U.js").then((module) => module.sessionSharingHandlers),
	"sessions-subscriptions": () => import("./sessions-subscriptions-IhchOsyV.js").then((module) => module.sessionSubscriptionHandlers),
	"sessions-suggestions": () => import("./sessions-suggestions-B6oqTvMq.js").then((module) => module.sessionSuggestionHandlers),
	"session-catalog": () => import("./session-catalog-BIIJyNQu.js").then((module) => module.sessionCatalogHandlers),
	"session-discussion": () => import("./session-discussion-2YmWMAqH.js").then((module) => module.sessionDiscussionHandlers),
	"session-observer-rpc": () => import("./session-observer-rpc-Bxaf2ZP4.js").then((module) => module.sessionObserverHandlers),
	"session-companion-rpc": () => import("./session-companion-rpc-v09-QiR8.js").then((module) => module.sessionCompanionHandlers),
	"hooks-status": () => import("./hooks-status-DV3wT_SY.js").then((module) => module.hooksStatusHandlers),
	skills: () => import("./skills-hgltRs6K.js").then((module) => module.skillsHandlers),
	system: () => import("./system-CylMCFGB.js").then((module) => module.systemHandlers),
	talk: () => import("./talk-D8b_j7z4.js").then((module) => module.talkHandlers),
	tasks: () => import("./tasks-B0lLwfs1.js").then((module) => module.tasksHandlers),
	"task-suggestions": () => import("./task-suggestions-BLHiic3s.js").then((module) => module.taskSuggestionsHandlers),
	"tools-catalog": () => import("./tools-catalog-BB58rEWe.js").then((module) => module.toolsCatalogHandlers),
	"tools-effective": () => import("./tools-effective-DCDyEUlC.js").then((module) => module.toolsEffectiveHandlers),
	"tools-invoke": () => import("./tools-invoke-B0UCpOWM.js").then((module) => module.toolsInvokeHandlers),
	...
	update: () => import("./update-D3IUc6eC.js").then((module) => module.updateHandlers),
	...
	"system-agent": () => import("./system-agent-BQoiqg50.js").then((module) => module.systemAgentHandlers),
	"system-changes": () => import("./system-changes-GbDi9zJY.js").then((module) => module.systemChangesHandlers),
	wizard: () => import("./wizard-BkaWhd4l.js").then((module) => module.wizardHandlers)
};
