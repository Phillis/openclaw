...
import { n as matrixSetupAdapter } from "./setup-core-BarXtknI.js";
import { t as withResolvedActionClient } from "./client-VJbM_wpG.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-CrvJjsmc.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-BIFBQzLt.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-BiHyjNtp.js"));
