...
import { A as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-Drkiu7-F.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, c as getRuntimeAuthProfileStoreSnapshot, r as ensureAuthProfileStore } from "./store-BH6qiWJF.js";
...
import { o as loadPreparedModelCatalogSnapshot } from "./prepared-model-catalog-DhM2CKIW.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-6l2OWljU.js";
import "./profiles-DTzgjRzO.js";
import { r as getCustomProviderApiKey, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-CpggQEC3.js";
import { t as createModelAuthAvailabilityResolver } from "./model-auth-availability-Bs__tgu7.js";
...
import { n as resolveAgentHarnessRuntimeAvailability } from "./runtime-plugin-Cwp3tDCy.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-BIpiPL3j.js";
import { n as resolveUtilityModelRefForAgent, t as readUtilityModelSetting } from "./utility-model-D0-bKPJW.js";
import { a as resolveKnownAgentId, d as ensureFlagCompatibility, m as isRich } from "./shared-ZcviBTsk.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DBA-TWCD.js";
import { t as maskApiKey } from "./secret-mask-BEdLuCrN.js";
import { t as loadModelsConfig } from "./load-config-BwOaQxAP.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-CDqwRuVK.js"));
...
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-SgMtyIpQ.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-D_mgd22t.js");
			runtime.log("");
