...
import { n as isImmutableGitCommitRef, r as parseGitPluginSpec } from "./git-install-C9WVvj3s.js";
...
import { c as searchSkillsFromClawHub, g as installExtractedSkillRoot, h as untrackClawHubSkill, l as readVerifiedClawHubSkillSourceUrl, m as readTrackedClawHubSkillSlugs, o as resolveClawHubSkillVerificationTarget, r as updateSkillsFromClawHub, t as installSkillFromClawHub, y as validateRequestedSkillSlug } from "./clawhub-DU4Rfpsl.js";
...
import { n as resolveSkillStatusEntry } from "./status-B6UMGB3b.js";
import { i as readSkillProposalDraftFile, r as readSkillProposalDraftDirectory } from "./proposal-draft-CjHlAtkv.js";
import { a as proposeUpdateSkill, c as reviseSkillProposal, f as inspectSkillProposal, i as proposeCreateSkill, n as applySkillProposal, o as quarantineSkillProposal, p as listSkillProposals, s as rejectSkillProposal } from "./service-DLIuaV-6.js";
...
async function loadSkillsStatusReport(options) {
	...
	const { buildWorkspaceSkillStatus } = await import("./status-B-caqbDP.js");
...
async function runSkillProposalApply(resolved, proposalId) {
	const { callGateway, isGatewayCredentialsRequiredError, isGatewayTransportError } = await import("./call-DrX49UA-.js");
	try {
		await callGateway({
			config: resolved.config,
			method: "health",
