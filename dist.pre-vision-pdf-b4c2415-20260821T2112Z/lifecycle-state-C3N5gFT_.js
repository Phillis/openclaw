...
import { l as resolveAgentDir, r as listAgentEntries } from "./agent-scope-config-BdXMWufB.js";
...
import { h as applyDefaultCronToolsAllow } from "./store-wIlCggOZ.js";
import { I as createTrustedCronScheduledToolPolicy, _ as normalizeCronJobCreate } from "./row-codec-BXU8Ei5n.js";
...
import { c as readWorkspaceStateSnapshot, i as deleteWorkspaceState, s as prepareWorkspaceStateDeletion } from "./workspace-state-store-jYrit6Rg.js";
...
import { c as readClawPackageRefs, d as updateClawPackageRefStatus, s as readClawInstallRecords, u as updateClawInstallRecordStatus } from "./provenance-DpehGKC7.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-CWfwuctv.js";
import { n as deleteAgentConfigEntry, t as AgentConfigPreconditionError } from "./agents-config-mutations-BUil7xAn.js";
import { C as digestClawMcpServer, E as readClawMcpServerRefs, O as reconcileClawMcpServerRefs, S as deleteClawMcpServerRef, T as planClawMcpServerRemoval, t as parseClawMarkdown, v as CLAW_OUTPUT_STABILITY, x as clawMcpRemovalSelector } from "./reader-DVmzn48R.js";
import { t as runPluginUninstallCommand } from "./plugins-uninstall-command-DzsmxfOs.js";
import { r as resolvePluginInstallRequestContext } from "./plugin-install-config-policy-C7KEW015.js";
...
async function applyClawRemovePlan(plan, options = {}) {
	...
	if (!options.commitConfig || options.purgeSessions) await (options.purgeSessions ?? (await import("./cleanup-service-DrU8_oLA.js")).purgeAgentSessionStoreEntries)(configBeforeDelete, agentId);
