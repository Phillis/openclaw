...
import { G as setEmbeddedPluginApprovalBroker, U as EmbeddedPluginApprovalBroker, W as clearEmbeddedPluginApprovalBroker, q as setEmbeddedMode } from "./agent-tools.before-tool-call-CztciPqk.js";
...
import { u as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-CzaIYeTz.js";
import { n as resolveThinkingDefault } from "./model-thinking-default-B9IHGxZs.js";
import { t as buildAllowedModelSet } from "./model-selection-Dg63KcCa.js";
...
import { t as getSessionDefaults } from "./session-utils-model-BWlY14VD.js";
import { E as loadGatewaySessionEntryReadOnly, N as resolveGatewaySessionStoreTargetWithStore, O as resolveCanonicalGatewaySessionStoreKey, T as loadGatewaySessionEntry, w as listAgentsForGateway } from "./session-utils-row-pCr636Wc.js";
import { t as ensureContextWindowCacheLoaded } from "./context-DCjX8f9I.js";
...
import { i as buildGatewaySessionInfo, r as listSessionsFromStoreAsync } from "./session-utils-list-B0UK93uu.js";
...
import { c as performGatewaySessionReset } from "./session-reset-service-Dq_lYg0f.js";
import { r as agentCommandFromIngress } from "./agent-command-CSGvv2Un.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-DKuFNbQH.js";
import { t as loadGatewayModelCatalog } from "./server-model-catalog-Dp8MCeRf.js";
...
import { a as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES, i as readChatHistoryPage, o as enforceChatHistoryFinalBudget, r as enrichChatHistoryCompactionMarkers, s as replaceOversizedChatHistoryMessages } from "./chat-Bi3O8yqo.js";
import { o as isAgentLifecycleYieldedWaiting } from "./session-lifecycle-state-DzLIsG_S.js";
import { n as createGatewaySession } from "./session-create-service-FcHYinCe.js";
import { t as projectSessionsPatchEntry } from "./sessions-patch-DRQzkg9C.js";
import { t as resolveLocalRunShutdownGraceMs } from "./local-run-shutdown-BQKagb2W.js";
import { u as formatTuiErrorMessage } from "./tui-formatters-C3G2p4oU.js";
...
var EmbeddedTuiBackend = class {
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-CvUqEu3_.js");
