...
import { a as disposeAcpSessionManagerInstance, t as getAcpSessionManager } from "./manager-B2-qGF04.js";
...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-Dq_lYg0f.js";
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-P3CLInCU.js");
