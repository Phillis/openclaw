...
import { t as measureCliCommandStartup } from "./command-startup-timing-BGe2zpWb.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-ByOzX1EI.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-AHLnBFRr.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-cpjE5W7u.js");
	if (params.argv) {
