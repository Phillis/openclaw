...
import { c as shouldUseWizard } from "./shared-CsIQXA3R.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CfMKTYR5.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-ktAa3lY4.js"));
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		...
		const { resolveInitialWizardChannel, runChannelsAddWizardFlow } = await import("./add-wizard-DM19ab2l.js");
