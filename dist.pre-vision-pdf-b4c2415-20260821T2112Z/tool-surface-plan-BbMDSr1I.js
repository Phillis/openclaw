...
import { R as getAgentToolExecutionContext } from "./agent-core-DQuUeVYe.js";
...
function codeModeCatalogIndexFooter(included, total) {
	...
	return omitted > 0 ? `${omitted} additional OpenClaw/plugin tools omitted from this prompt index. Use ALL_TOOLS or tools.search inside exec to find them.` : "Use exact ids with tools.callValue; use ALL_TOOLS/tools.search if ambiguous.";
}
