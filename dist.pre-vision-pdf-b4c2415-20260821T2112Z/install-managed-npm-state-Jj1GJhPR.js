...
import { c as emitTrustedSecurityEvent } from "./diagnostic-events-Djn4AVRp.js";
import { n as readJson, r as readJsonIfExists, u as writeJson } from "./json-BE1X9L-o.js";
import "./json-files-C6dF5uZO.js";
import { o as resolvePackageExtensionEntries } from "./manifest-BmA-DH7w.js";
import { l as validateRegistryNpmSpec, s as parseRegistryNpmSpec } from "./npm-registry-spec-D3pNhy09.js";
import { c as resolvePluginNpmGenerationProjectDirPrefix, r as resolveDefaultPluginExtensionsDir, s as resolvePluginNpmGenerationProjectDir, u as resolvePluginNpmProjectDir } from "./install-paths-BYSW9x3z.js";
...
import { a as createSafeNpmInstallArgs, i as resolvePackageDirInstallTransaction, o as createSafeNpmInstallEnv, r as requestDeferredPackageDirInstall } from "./install-package-dir-CBvlaFS_.js";
import { o as relinkOpenClawPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link-OdEF4u-i.js";
...
//#endregion
export { repairManagedNpmRootOpenClawPeer as $, resolveEffectiveInstallMode as A, attachPluginInstallOwnerMigrations as B, ensureInstallTargetAvailableForMode as C, installPluginDirectoryIntoExtensions as D, hasPackageRuntimeDependencies as E, validateOpenClawPackageInstallCompatibility as F, resolvePluginInstallOwnerMigrations as G, copyPluginInstallTransactionRequest as H, emitPluginAuditSecurityEvent as I, settlePluginInstallTransactions as J, resolvePluginInstallTransaction as K, emitPluginInstallSecurityEvent as L, runInstallSourceScan as M, sourceFamilyForInstallPolicyKind as N, loadPluginInstallRuntime as O, sourceFamilyForInstallPolicySource as P, readOpenClawManagedNpmRootOverrides as Q, pluginAuditOutcomeForReason as R, emitSuccessfulPluginInstallSecurityEvent as S, formatUnresolvedOpenClawPeerLinkError as T, isPluginInstallCommitDeferred as U, attachPluginInstallTransaction as V, requestDeferredPluginInstall as W, readManagedNpmRootInstalledDependency as X, listMissingRequiredPlatformPackages as Y, readManagedNpmRootPeerDependencySnapshot as Z, resolveRequiredPlatformPackageNames as _, formatManagedNpmProjectQuarantineArtifacts as a, buildDirectoryInstallResult as b, listManagedNpmRootPackageNames as c, removeEmptyDirectoryIfPresent as d, resolveManagedNpmRootDependencySpec as et, resolveManagedNpmGenerationUseForInstall as f, resolveManagedNpmRootPackageDir as g, resolveManagedNpmRootForInstall as h, createManagedNpmPluginInstallRollbackSnapshot as i, resolvePreparedDirectoryInstallTarget as j, readOptionalPackageManifest as k, listNewManagedNpmRootPackageDirs as l, resolveManagedNpmRootDependencySpecForInstall as m, cleanupManagedNpmPluginInstallRollbackSnapshot as n, upsertManagedNpmRootDependency as nt, formatNpmCommandFailureOutput as o, resolveManagedNpmInstallRoot as p, resolvePluginInstallTransactionSink as q, cleanupManagedNpmRootPreparedDependency as r, isManagedNpmProjectCorruptionInstallFailure as s, classifyNpmManagedOverrideCompatibilityError as t, syncManagedNpmRootPeerDependencies as tt, quarantineManagedNpmProjectRebuildArtifacts as u, rollbackManagedNpmPluginInstall as v, ensureOpenClawExtensions as w, defaultLogger as x, rollbackManagedNpmRootPreparedDependency as y, PLUGIN_INSTALL_ERROR_CODE as z };
