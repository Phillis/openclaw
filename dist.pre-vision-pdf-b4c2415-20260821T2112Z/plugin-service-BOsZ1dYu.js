...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-y631yGCG.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BmHbx1rZ.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-VnkdvOf9.js");
