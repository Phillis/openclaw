...
import { t as handleChatSend } from "./chat-send-handler-OqdK-mKj.js";
...
const loadTalkAgentExecution = createLazyRuntimeModule(async () => {
	const [embeddedAgent, admission] = await Promise.all([import("./embedded-agent-BG39LAbd.js"), import("./admitted-run-context-DN1fM-I2.js")]);
	return {
