...
import { d as resolveAgentWorkspaceDir, f as resolveDefaultAgentDir, l as resolveAgentDir, p as resolveDefaultAgentId } from "./agent-scope-config-BdXMWufB.js";
import { w as resolveDefaultModelForAgent } from "./codex-route-model-ref-0uJOp6W2.js";
import { o as canonicalizeProviderModelId } from "./openai-model-routes-lYZ0ONoM.js";
import { r as ensureAuthProfileStore } from "./store-BH6qiWJF.js";
import { l as publishPreparedModelRuntimeSnapshot } from "./prepared-model-runtime-CzaIYeTz.js";
...
import { r as prepareAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-D30Pd9cz.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-BUqiC9yU.js";
import "./provider-auth-choice-preference-CcslvCSh.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-Cq16BYkU.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-CAxfz_Ts.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-DYNUuHVD.js");
	...
	const { resolveDeprecatedProviderInstallCatalogEntry } = await import("./provider-install-catalog-BX2L7gAT.js");
