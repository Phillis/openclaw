...
import { f as createChannelMessageAdapterFromOutbound, m as bindIngressLifecycleToReplyOptions } from "./channel-outbound-CEvoxZOx.js";
...
import { s as DEFAULT_RELAYS } from "./setup-adapter-BVUylmsI.js";
import { a as resolveDefaultNostrAccountId, c as validatePrivateKey, i as listNostrAccountIds, n as nostrSetupContract, o as resolveNostrAccount, r as nostrSetupWizard, s as normalizePubkey } from "./setup-surface-C75y34rz.js";
		...
		start: async () => {
			const bus = await startNostrBus({
				...
				onMessage: async (senderPubkey, text, reply, meta, lifecycle) => {
					...
					const { dispatchInboundDirectDm } = await import("./inbound-direct-dm-runtime-DNUBqtJ0.js");
