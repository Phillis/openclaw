import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{T as t,w as n}from"./control-ui-foundation-D1iiKpDl.js";import{Cl as r,Tl as i}from"./control-ui-core-BusOdfLw.js";import{K as a,Q as o,W as s,Y as c,it as l,nt as u}from"./lit-runtime-2JvyKfXq.js";import{c as d,s as f,vn as p,yn as m}from"./control-ui-foundation-CI97c0ac.js";import{$n as h,Cr as g,I as _,L as v,Qn as y,Tr as b,bn as x,xn as S}from"./control-ui-core-DV5aqR_x.js";import{i as C,o as w,t as T}from"./control-ui-core-DZ85uRNh.js";import{i as E,n as D,t as O}from"./approval-result-validators-B_OZaaKG.js";var k=e((()=>{}));function A(e){return e instanceof x?(m(e.details)?e.details.reason:void 0)===`APPROVAL_NOT_FOUND`||e.gatewayCode===`APPROVAL_NOT_FOUND`||e.gatewayCode===`INVALID_REQUEST`:!1}function j(e){return new Intl.DateTimeFormat(C.getLocale(),{dateStyle:`medium`,timeStyle:`short`}).format(new Date(e))}function M(e){switch(e){case`allow-once`:return w(`execApproval.allowOnce`);case`allow-always`:return w(`execApproval.alwaysAllow`);case`deny`:return w(`execApproval.deny`)}return e}function N(e,t){return e.applied?t===`deny`?e.approval.status===`denied`:e.approval.status===`allowed`&&e.approval.decision===t:!0}function P(e,t){return t?c`<div class="approval-page__meta-row">
        <dt>${e}</dt>
...
//# sourceMappingURL=approval-page-registration-Sm0zJ7OQ.js.map