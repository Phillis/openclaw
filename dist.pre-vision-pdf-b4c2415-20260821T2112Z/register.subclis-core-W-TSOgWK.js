...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-C5U_eiYw.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-DsYTVyC_.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-y7zaIPMn.js"),
		...
		},
		{
			...
			loadModule: () => import("./capability-cli-C1XSO24q.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["worker"],
			loadModule: () => import("./worker-cli-CLL0iP1h.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-CYxAWZ6p.js"),
			exportName: "registerTuiCli"
		},
		{
			commandNames: ["resume"],
			loadModule: () => import("./resume-cli-CY_N8DK-.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-CHKICMF1.js"),
