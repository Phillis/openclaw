...
import { h as consumeRunSkillUsage } from "./agent-tools.before-tool-call-CztciPqk.js";
import "./sessions-BIUamgQ4.js";
import { t as SessionManager } from "./session-manager-Clz4xunQ.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-_1OlJzyh.js";
...
import { n as rewriteTranscriptEntriesInSessionManager, t as resolveRuntimeTranscriptReadTarget } from "./transcript-runtime-state-DezLV4NN.js";
import { f as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt-prompt-helpers-tVo4n4Bi.js";
import { T as findActiveSessionTask } from "./media-generation-task-status-BRH09xsw.js";
import { v as runWithPreparedMemoryPromptSection } from "./memory-state-DhEOmKyi.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-DeYkPY_5.js";
...
async function runCoreAgentEndSideEffects(params) {
	...
	try {
		const { scheduleSkillExperienceReview } = await import("./experience-review-default-QTVKHKU2.js");
