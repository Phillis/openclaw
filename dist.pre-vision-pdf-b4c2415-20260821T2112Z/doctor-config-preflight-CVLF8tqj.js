...
import { _ as recoverConfigFromLastKnownGood, a as preserveConfigSnapshotAsClobbered, f as readConfigFileSnapshotWithPluginMetadata, g as recoverConfigFromJsonRootSuffix, l as readConfigFileSnapshot, tt as parseConfigJson5 } from "./io-CeQckj5v.js";
...
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-DulL0xR1.js";
import { t as migrateLegacyConfig } from "./legacy-config-migrate-9_qkVa_5.js";
import { t as addDoctorLegacyIssues } from "./legacy-config-issues-BvEvWjsG.js";
import { n as createDoctorPluginMetadataSnapshotScope, t as completeDoctorPluginMetadataSnapshot } from "./plugin-metadata-snapshot-scope-CNDLsTbr.js";
...
const loadInstalledPluginIndexStore = createLazyRuntimeModule(() => import("./installed-plugin-index-store-XgK4bdQO.js"));
...
async function planStartupPluginVerification(params) {
	const { planStartupPluginConvergence } = await measureDoctorConfigPreflightStep("plugin-plan-import", () => import("./startup-plugin-convergence-plan-6jrpP7w3.js"), params.measure);
...
async function runStartupUpgradeConvergence(params) {
	...
	const { runPostCorePluginConvergence } = await measureDoctorConfigPreflightStep("plugin-convergence-import", () => import("./post-core-plugin-convergence-DUhF2dSy.js"), params.measure);
...
async function refreshStartupPluginQuarantine(params) {
	...
	const { runActivePluginPayloadSmokeCheck } = await measureDoctorConfigPreflightStep("plugin-payload-verification-import", () => import("./active-plugin-payload-validation-D7cgUsWu.js"), params.measure);
...
const loadDoctorStateMigrations = createLazyRuntimeModule(() => import("./doctor-state-migrations-zFpFTfYO.js"));
const loadLegacyCronRepair = createLazyRuntimeModule(() => import("./legacy-repair-BrmsuAD9.js"));
...
async function runDoctorConfigPreflight(options = {}) {
	...
	let migrationCheckpoint = gatewayStartupCheckpointRequired || options.requireStateMigrationCheckpoint === true ? await measurePreflightStep("startup-checkpoint-import", () => import("./startup-migration-checkpoint-CFJxkdTr.js")) : void 0;
	let stateMigrations;
	...
	try {
		if (migrationCheckpoint && !skipPristineStartupStateMigrations) {
			const { planPristineStartupStateMigrations } = await measurePreflightStep("pristine-state-plan-import", () => import("./pristine-startup-state-C4pB-5Gz.js"));
