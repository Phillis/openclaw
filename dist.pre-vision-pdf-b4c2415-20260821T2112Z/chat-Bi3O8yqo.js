...
import { E as loadGatewaySessionEntryReadOnly, T as loadGatewaySessionEntry, v as resolveCurrentUserProfileDisplay, w as listAgentsForGateway } from "./session-utils-row-pCr636Wc.js";
import { n as tryResolveSessionCompatibilityOwnerAgentId } from "./session-request-agent-BeVvXvOY.js";
import { i as buildGatewaySessionInfo } from "./session-utils-list-B0UK93uu.js";
...
import { n as resolveChatHistoryWithCliSessionImports } from "./cli-session-history-CvexZa3N.js";
...
import { r as resolveGatewayChatCronCreatorAuthorityAdmission, t as createAgentTurnService } from "./agent-turn-service-CFUpECgp.js";
import { i as resolveVisibleActiveSessionRunState } from "./session-active-runs-DKnYoEyq.js";
import { P as normalizeOptionalChatText, s as appendAssistantTranscriptMessage, w as scheduleChatHistoryManagedMediaCleanup } from "./chat-abort-runtime-C7yti7zc.js";
import { t as assertValidParams } from "./validation-CsGeElrb.js";
import { i as validateChatSelectedAgent, o as resolveGlobalAwareNodeChatDeliveryKeys, r as resolveRequestedChatAgentId, s as sendGlobalAwareNodeChatPayload, t as handleChatSend } from "./chat-send-handler-OqdK-mKj.js";
import { a as prepareSessionWorkspaceIcon } from "./workspace-icon-http-K-gUdutP.js";
import { t as resolveAgentIdOrRespondError } from "./agent-id-shared-uNTkOYt3.js";
import { i as resolveSessionHistoryTailReadOptions } from "./session-history-state-Bt6QTO2q.js";
...
const chatHandlers = {
	...
	"chat.toolTitles": async ({ params, respond, context }) => {
		...
		const { generateToolCallTitles } = await import("./chat-tool-titles-IPEXHD-k.js");
