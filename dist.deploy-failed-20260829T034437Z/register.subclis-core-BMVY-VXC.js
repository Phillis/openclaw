...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-BTK4uyqv.js");
...
const entrySpecs = [
	...defineImportedSubCliGroups([
		...
		[
			["gateway"],
			() => import("./gateway-cli-BDp5uepT.js"),
			"registerGatewayCli"
		],
		[
			["daemon"],
	...
	]),
	{
		...
		register: async (program, argv) => {
			await (await import("./capability-cli-0zUSnwzk.js")).registerCapabilityCli(program, argv);
		}
	},
	...defineImportedSubCliGroups([[
	...
	...defineImportedSubCliGroups([
		...
		[
			...
			() => import("./tui-cli-Dsl7s-j2.js"),
			"registerTuiCli"
		],
		[
			["resume"],
			() => import("./resume-cli-CnaSNMpg.js"),
			"registerResumeCli"
		],
		[
			["cron", "automations"],
