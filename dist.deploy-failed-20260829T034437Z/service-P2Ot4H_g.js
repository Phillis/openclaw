...
async function containsSnapshotGitMarker(checkoutRoot, snapshotPaths) {
	...
	if (!snapshotPaths) {
		...
		visiblePaths.push(...splitNullBuffer(await requireGitBuffer(checkoutRoot, [
			"ls-files",
			"-z",
			"--cached",
			"--others",
...
var ManagedWorktreeService = class {
	...
	*/
	...
	async rebindLiveRepository(record) {
