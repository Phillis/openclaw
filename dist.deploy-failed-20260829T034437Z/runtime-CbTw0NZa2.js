...
import { a as getChildLogger, c as isFileLogLevelEnabled } from "./logger-ij8OHrrv.js";
...
import { b as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog } from "./model-selection-shared-I5TmV9jL.js";
...
import { r as replaceConfigFile, t as mutateConfigFile } from "./mutate-C_fsUarr.js";
...
import { m as patchSessionEntryCore, o as listSessionEntriesReadOnly, p as loadSessionEntryReadOnly, v as replaceSessionEntry } from "./session-accessor.sqlite-entry-CNdoUuFZ.js";
import { s as normalizeDeliveryContext } from "./delivery-context.shared-azPdmUls.js";
import { d as isSessionWorkAdmissionActive, n as beginSessionWorkAdmission, p as runExclusiveSessionLifecycleMutation } from "./session-lifecycle-admission-1qqb7Ac0.js";
import { i as onSessionTranscriptUpdate } from "./transcript-events-Ce7n2r8A.js";
import { f as normalizeResolvedMaintenanceConfigInput } from "./disk-budget-DJbD0obL.js";
import { It as listSessionEntriesCore, nt as updateSessionEntry } from "./session-accessor-B-FKZX9M.js";
import { o as mediaKindFromMime } from "./constants-Mf57IYS0.js";
import { n as detectMime } from "./mime-Hm4eS2i0.js";
import { a as rollbackPluginOwnedSessionEntryLifecycle, i as rollbackAgentHarnessSessionEntryLifecycle, n as deleteSessionEntryLifecycle } from "./session-accessor.sqlite-lifecycle-DeUgE0mJ.js";
...
import { c as getImageMetadata, p as resizeToJpeg } from "./image-ops-CNJmjS8j.js";
import "./media-services-B8MVUzbz.js";
import { c as resolveThinkingProfile } from "./thinking-CNREPJ80.js";
import { o as resolveEffectiveAgentRuntime, t as concretizeAgentRuntime } from "./thinking-runtime-1slENmfx.js";
...
import { J as failFlow, W as createManagedTaskFlow, X as finishFlow, at as setFlowWaiting, it as resumeFlow, k as listTasksForFlowId, nt as requestFlowCancel } from "./task-registry-DzN8snH1.js";
import "./runtime-internal-KZAce0-2.js";
import { _ as getTaskFlowByIdForOwner, d as getFlowTaskSummary, g as findLatestTaskFlowForOwner, p as runTaskInFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById, v as listTaskFlowsForOwner, y as resolveTaskFlowForLookupTokenForOwner } from "./task-executor-D9EdhKj2.js";
...
import { a as resolveInheritedToolPolicyForSession, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./agent-tools.policy-DrNOM40T.js";
...
import { a as listRuntimeMusicGenerationProviders, i as generateMusic } from "./openclaw-tools-Cx1wv4od.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "./task-owner-access-D_litxx5.js";
import { o as resolveEffectiveSessionToolsVisibility } from "./session-visibility-BvdtJ7Em.js";
import { n as resolveSessionModelRef } from "./session-model-ref-BtF53_Cz.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-N7S5E3pj.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DBPY-VlF.js";
import { i as listWebSearchProviders, o as runWebSearch } from "./runtime-DfPJqKDi.js";
import { t as RequestScopedSubagentRuntimeError } from "./error-runtime-CmA1H4Zg.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-DxbVzdBl.js";
import { t as createRuntimeChannel } from "./runtime-channel-CCNEwTiP.js";
...
const loadAgentCommandRuntime = createLazyRuntimeModule(async () => {
	const [command, identity] = await Promise.all([import("./agent-command-DkWrBVVZ.js"), import("./agent-command-execution-identity-DOkXFjc9.js")]);
	return {
		command,
		identity
	};
...
async function createSessionEntry(params) {
	const [{ createGatewaySession }, { resolveGatewaySessionStoreTarget }, { readAcpSessionMetaForEntry, upsertAcpSessionMeta }] = await Promise.all([
		import("./session-create-service-DVxEOI6f.js"),
		import("./session-utils-DNyPW-uo.js"),
		import("./session-meta-BLJJYlX9.js")
	]);
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("./heartbeat-runner-dsGIuxFs.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRequestRuntime = createLazyRuntimeModule(() => import("./runtime-tts-request-D_SrsYEf.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-CteK7oJt.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime.js"));
const loadGatewayPluginRuntime = createLazyRuntimeModule(() => import("./server-plugins-Ol7JPJve.js"));
...
function createRuntimeLlmFacade() {
	const loadAcquireLocalService = createLazyRuntimeMethod(() => import("./provider-local-service-mjATAvJB.js"), (runtime) => runtime.createConfiguredProviderLocalServiceAcquirer(getRuntimeConfig));
...
function createRuntimeWorktrees() {
	const loadService = () => import("./service-BRv7gOhe.js");
	return {
		async resolveCheckoutRoot(params) {
			const { findGitCheckoutRoot } = await import("./git-JyHrC5Zv.js");
			return findGitCheckoutRoot(params.path) ?? void 0;
		},
		async hasSelfContainedCheckoutMetadata(params) {
			const { hasSelfContainedGitMetadata } = await import("./git-JyHrC5Zv.js");
...
function createRuntimeSandbox(agent) {
	...
	return {
		...
		async prepareWorkspaceAuthority(params) {
			...
			const { resolveSandboxContext } = await import("./context-CvZtKa6c.js");
