...
import { c as isForbiddenBrowserProxyMutation } from "./method-scopes-BTnJZEGh.js";
import { d as errorShape, f as missingScopeErrorShape } from "./validation-errors-rELRlKfn.js";
import { p as replaceRemoteNodeSkills } from "./workspace-skill-loader-BIyN38wj.js";
import { a as isForegroundRestrictedPluginNodeCommand, c as normalizeDeclaredNodeCommands, l as resolveNodeCommandAllowlist, o as isNodeCommandAllowed, t as DEFAULT_DANGEROUS_NODE_COMMANDS, u as resolveNodePairingCommandAllowlist } from "./node-command-policy-BuNOLSoA.js";
...
import { _ as resolveNodePairingState, c as listDevicePairing, m as removePairedDeviceRole, n as getPairedDevice, s as listApprovedPairedDeviceRoles } from "./device-pairing-Li5h-3GZ.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, u as updatePairedNodeSessionHost } from "./remote-8jZL04gz.js";
import { a as listNodePairing, d as renamePairedNode, i as getPendingNodePairing, l as rejectNodePairing, o as projectNodePairing, t as approveNodePairing } from "./device-pairing-node-DrrXxGrx.js";
...
import { t as EXEC_APPROVAL_RESOLVED_ENTRY_GRACE_MS } from "./exec-approval-manager-C7EGM_Qr.js";
import { a as removePendingNodeAction, i as listPendingNodeActions, n as clearRemovedNodeRuntimeState, o as replacePendingNodeActionsForGeneration, r as enqueuePendingNodeAction, s as reconcileRevokedDeviceWorker, t as acknowledgePendingNodeActions } from "./node-runtime-state-CDZI6iNZ.js";
...
import { n as getKnownNode, r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-CWUESPqp.js";
import { i as isNodePairingGenerationCurrent, n as captureNodePairingGeneration, r as captureNodePairingState } from "./device-pairing-node-state-c2A4ZWZx.js";
import { a as resolveDispatchableNodeSession, i as isNodePairingWorkCurrent, n as maybeWakeNodeWithApns, o as respondPairingChanged, r as waitForNodeReconnect, s as nodeInvokePolicy, t as maybeSendNodeWakeNudge } from "./nodes.wake-C5bCJBWM.js";
...
const nodeEventHandlers = { "node.event": async ({ params, respond, context, client }) => {
	...
	await respondUnavailableOnThrow(respond, async () => {
		...
		const { handleNodeEvent } = await import("./server-node-events-B1qLhi4e.js");
