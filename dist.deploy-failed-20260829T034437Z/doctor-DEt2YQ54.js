...
async function doctorCommand(runtime, options) {
	if (options?.stateSqlite) {
		...
		const { runDoctorStateSqliteCompact } = await import("./doctor-state-sqlite-compact-DvonBymh.js");
	...
	await (await import("./doctor-health-BqcjDTcJ.js")).runDoctorHealthFlow(runtime, options);
}
