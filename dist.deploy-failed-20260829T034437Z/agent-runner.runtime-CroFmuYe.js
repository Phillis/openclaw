...
import { S as parseStrictInteger, f as asSafeIntegerInRange, l as asNonNegativeFiniteNumber, s as asFiniteNumber } from "./number-coercion-CLj0HTDM.js";
...
import { E as resolveSessionModelOverrideRouteResolution, O as resolveSessionAuthProfileOverrideSource, a as markAutoFallbackPrimaryProbe, f as resolveAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, r as hasConfiguredModelFallbacks, t as clearAutoFallbackPrimaryProbeSelection, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-DigoIwHb.js";
...
import { a as isSilentReplyPrefixText, c as stripLeadingSilentToken, n as SILENT_REPLY_TOKEN, o as isSilentReplyText, s as startsWithSilentToken } from "./tokens-DbQz-n_m.js";
...
import { u as resolveOpenAIRuntimeProvider } from "./openai-routing-mOc2UICM.js";
import { b as resolveModelRefFromString } from "./model-selection-shared-I5TmV9jL.js";
...
import { g as withAgentRunLifecycleGeneration, i as emitAgentEvent, n as captureAgentRunLifecycleGeneration, u as onAgentEvent } from "./agent-events-CcZImb5w.js";
import { h as registerAgentRunContext, i as clearAgentRunContext } from "./agent-run-registry-t4kvUyNQ.js";
import { i as getPluginRuntimeGatewayRequestScope, t as bindGatewayContextResolver } from "./gateway-request-scope-B19X7f09.js";
import { t as resolveAgentHarnessPolicy } from "./policy-23u__u-R.js";
import { l as resolveCronJobsStorePath, n as loadCronJobsStore } from "./store-pLPqGtqL.js";
...
import { b as ensureMessageToolRunOutcomeSchema } from "./openclaw-agent-db-maintenance-DDqVWNe-.js";
import { t as normalizeChatType } from "./chat-type-CG0X_HJM.js";
import "./backoff-BkMI1WEL.js";
import { f as loadSessionEntry, m as patchSessionEntryCore, p as loadSessionEntryReadOnly } from "./session-accessor.sqlite-entry-CNdoUuFZ.js";
import { s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-azPdmUls.js";
import { a as isInternalMessageChannel, h as resolveMessageChannel, o as isMarkdownCapableMessageChannel } from "./message-channel-BZwx7FCw.js";
import { b as resolveGroupSessionKey } from "./session-lifecycle-admission-1qqb7Ac0.js";
import { lt as resolveProfileParticipantIdFromSessionCreation } from "./session-accessor.sqlite-entry-store-DmHR081P.js";
...
import { c as resolveSessionPluginTraceLines, s as resolveSessionPluginStatusLines } from "./types-BEJRKmOU.js";
import { R as persistSessionResetLifecycle, at as appendTranscriptMessage, ht as getCliSessionBinding, mt as clearAllCliSessions, nt as updateSessionEntry } from "./session-accessor-B-FKZX9M.js";
import { i as hasRestartRecoverySourceClaim } from "./restart-recovery-state-6FYlAu33.js";
...
import { D as formatTokenCount, w as resolveSessionGoalDisplayState } from "./sessions-CdrF1uzY.js";
import { i as resetRegisteredAgentHarnessSessions } from "./registry-lPXwErEe.js";
import { _ as setReplyPayloadMetadata, a as getReplyPayloadMetadata, i as copyReplyPayloadMetadata, l as isReplyPayloadStatusNotice, m as markReplyPayloadForSourceSuppressionDelivery, n as appendReplyMediaFailureWarning, t as FAST_MODE_AUTO_PROGRESS_KIND, u as isReplyPayloadTerminalContent } from "./reply-payload-BeeUJOmJ.js";
import { u as readChannelContextGatewayContextResolver } from "./admission-evidence-C8iAKYLB.js";
import { r as isIngressAdoptionLostError } from "./ingress-drain-ypsN4E6P.js";
import { a as formatRawAssistantErrorForUi } from "./assistant-error-format-DYl5XHJg.js";
import { a as classifyOAuthRefreshFailureError, i as classifyOAuthRefreshFailure } from "./oauth-refresh-failure-tik1XWlI.js";
import { a as isContextOverflowError, p as isTransientHttpError, s as isLikelyContextOverflowError, t as classifyFailoverReason } from "./classify-DkuNrlYG.js";
...
import { s as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-CGiGCCsY.js";
import { a as resolveCandidateThinkingLevel } from "./thinking-runtime-1slENmfx.js";
import { o as resolveModelAuthMode } from "./model-auth-e0nL7cI2.js";
import { c as resolvePersistedOverrideModelRef } from "./model-selection-DHDS-v4K.js";
import { t as isCliProvider } from "./model-selection-cli-C9Ha9V5X.js";
import { c as isFailoverError, f as resolveFailoverReasonFromError, s as findCliTimeoutError } from "./failover-error-DVBvcQuA.js";
import { c as createAgentRunRestartAbortError, f as isAgentRunRestartAbortReason, h as resolveAgentRunErrorLifecycleFields, i as AGENT_RUN_RESTART_ABORT_STOP_REASON, m as resolveAgentRunAbortLifecycleFields } from "./run-termination-hzmbXtwI.js";
import { c as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-BMBDlrGB.js";
import { r as sanitizeUserFacingText, t as renderUserFacingText } from "./user-facing-text-BcBNmELa.js";
import { _ as renderControlUiAgentFailureCopy, a as PROVIDER_CONVERSATION_STATE_ERROR_USER_MESSAGE, b as renderRateLimitReplyCopy, h as renderBillingReplyCopy, y as renderRateLimitOrOverloadedCopy } from "./user-copy-LZk56sIA.js";
import { c as resolveFastModeForElapsed, n as formatFastModeAutoProgressText } from "./fast-mode-CCX0YiYh.js";
import { s as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-HlYcrSdl.js";
import { a as hasNewGeneratedMediaTaskForSessionKey, r as getGeneratedMediaTaskIdsForSessionKey } from "./task-status-access-RjhQa8uZ.js";
import { D as finalizeReplyMessageInjectionAttempt, E as beginReplyMessageInjectionTarget, I as runAfterReplyOperationClear, N as markReplyOperationExecutionStarted, k as hasReplyOperationExecutionStarted, m as replyRunRegistry, p as markReplyOperationGlobalLaneWaitProgress } from "./reply-run-registry-Ch9Ye6re.js";
import { s as logSessionTurnCreated } from "./diagnostic-DrSh1mZf.js";
import { a as withLocalSessionPlacementTurnAdmission } from "./session-placement-admission-CIMNOxmd.js";
...
import { n as normalizeReplyPayload } from "./normalize-reply-uJ4oFasT.js";
import { m as recordReplyUsageState, p as buildReplyUsageState } from "./deliver-prepare-C7KxLRYR.js";
...
import { a as resolveReplyThreadingPayloads, i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-DY0W7APw.js";
import { n as createReplyToModeFilterForChannel, o as resolveReplyToMode, t as createReplyDeliveryContext } from "./reply-threading-BfuU1A_u.js";
import { p as isCompactionFailureError } from "./embedded-agent-helpers-B7K3_Rpy.js";
import { g as readPostCompactionContext } from "./builtin-openclaw-BE5rrEpZ.js";
import { n as filterMessagingToolReplyPayload } from "./reply-payloads-dedupe-CgpfYpkv.js";
import { f as createAudioAsVoiceBuffer, m as createBlockReplyPipeline, p as createBlockReplyContentKey, u as requiresDurableToolResultDelivery } from "./dispatch-from-config.payloads-BuGJhSSH.js";
...
import { d as isMessagingToolSendAction } from "./tool-loop-detection-BBBu2KgN.js";
...
import { a as admitReplyTurn, i as isReplyProfilerEnabled, n as createReplySessionEntryHandle, o as resolveReplyTurnKind, r as createReplyTimingTracker, t as ReplySessionGenerationInvalidatedError } from "./session-entry-handle-DUZJUUU0.js";
import { _ as resolveExternalRunFailureTextForConversation, a as createReplyRestartRecoveryClaimController, c as buildAuthProfileFailoverFailureText, d as buildKnownAgentRunFailureReplyPayload, f as buildPreflightCompactionFailureText, g as markAgentRunFailureReplyPayload, h as isVerboseFailureDetailEnabled, i as resolveTurnCommentaryProgressOwner, l as buildEmptyInteractiveReplyPayload, m as isNonDirectConversationContext, o as isDuplicateRestartRecoverySource, p as buildTerminalAgentRunFailureReplyPayload, r as shouldBridgeCliPreambleEvents, s as retireTerminalRestartRecoverySourceClaim, t as REPLY_ADMISSION_TICKET, u as buildExternalRunFailureReply, v as resolveReplyFailoverFacts } from "./reply-admission-ticket-CEk8twcK.js";
import { n as bindQueueDispositionToRunState, r as resolveReplyOperationRunState } from "./reply-operation-run-state-CL0NGjUt.js";
import { n as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-CqIyovBc.js";
import { d as shouldPreserveUserFacingSessionStateForInputProvenance } from "./input-provenance-CCQsDhUy.js";
import { i as buildGenericCliContextEngineHostSupport } from "./host-compat-xESS3bi6.js";
import { h as leaseMcpAppModelContextForTurn, s as peekSessionMcpRuntime } from "./agent-bundle-mcp-manager-api-DUhEi3qH.js";
import "./agent-bundle-mcp-runtime-CFf6ZaYl.js";
import { i as getMcpAppViewLease } from "./mcp-ui-resource-HelDUE7Q.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BuQQfgcO.js";
import { n as clearBootstrapSnapshotOnSessionBoundary } from "./bootstrap-cache-B5sBKdmh.js";
import { a as isModelSelectionLocked, n as MODEL_SELECTION_LOCKED_RESET_MESSAGE, r as ModelSelectionLockedError } from "./model-overrides-BcLzAaaZ.js";
import { t as readLatestSessionUsageFromTranscriptAsync } from "./session-transcript-readers-CgCxlOAj.js";
...
import { c as refreshQueuedFollowupSession, d as admitFollowupRunLifecycle, f as completeFollowupRunLifecycle, g as resolveFollowupAbortSignal, p as isFollowupRunAborted, u as FollowupRunDeferredError } from "./settings-Cpt08fNP.js";
...
import { f as hasCompletedSourceReplyDeliveryEvidence, l as hasCommittedSourceReplyDeliveryEvidence, p as hasCompletedTerminalDeliveryEvidence, v as hasVisibleCommittedMessagingToolDeliveryEvidence, y as hasVisibleOutboundDeliveryEvidence } from "./delivery-evidence-JxKjzZU6.js";
import { r as LiveSessionModelSwitchError } from "./model-fallback-runner-CT0oRKYv.js";
import { c as shouldClearFailedCliSessionBinding, o as setCliSessionBinding, s as setCliSessionId, t as clearCliSession } from "./cli-session-JwnBWNOs.js";
import { i as normalizePendingFinalRecoveryPayloads, n as buildRecoverablePendingFinalDeliveryText, o as sanitizePendingFinalDeliveryText, r as normalizePendingFinalDeliveryPayloads } from "./pending-final-delivery-BQjvFtab.js";
...
import { c as scheduleFollowupDrain } from "./cleanup-BNML21Fq.js";
import { i as parkSteerCandidate, n as enqueueFollowupRun, t as resolveQueueSettings } from "./queue-CrNP_exY.js";
import { i as createAgentPatchedSessionModelFallback } from "./session-model-patch-origin-B8wn1eht.js";
...
import { n as readChannelSourceTurnId, t as buildChannelSourceTurnId } from "./source-turn-id-qBM1Md8V.js";
import { n as hasDeliberateSilentTerminalReply, r as hasIntentionalTerminalCompletion } from "./result-fallback-classifier-Ba94zysF.js";
import { t as buildAgentRuntimeDeliveryPlan } from "./build-B7ysSS0v.js";
import { t as runEmbeddedAgent } from "./embedded-agent-_ah8V7hs.js";
import { a as withBeforeAgentReplyObserver } from "./payloads-CfSfmESE.js";
import { n as consolidateLiveModelSwitchAfterRun } from "./live-model-switch-CT0MjbtH.js";
...
import { t as ensureSessionDiffBaseline } from "./session-diff-baseline-CBeER5-P.js";
import { n as resolveEffectiveBlockStreamingConfig } from "./block-streaming-v0Ecz2D8.js";
import { r as mergeSessionSnapshotChanges } from "./session-snapshot-merge-B4KFr9oE.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-Bmv2zHLu.js";
import { i as resolveActiveRunQueueAction, n as createTypingSignaler, t as resolveCurrentTurnImages } from "./current-turn-images-C6oiJLmi.js";
import { i as refreshActiveGoalContext } from "./inbound-meta-Cwme9Zg0.js";
import { t as settleProgressVisibilityCallbackResult } from "./progress-visibility-DVUJibF4.js";
import { a as isReplyOperationSuperseded, c as resolveRestartLifecycleError, i as isReplyOperationRestartAbort, o as isReplyOperationUserAbort, r as buildRestartLifecycleReplyText, s as resolveReplyOperationTerminationFields, t as recordReplyOperationAgentTurn } from "./reply-operation-agent-turn-state-DnjWfkqf.js";
import { t as runEmbeddedAgentEntry } from "./run-entry-CsLd-Ozl.js";
import { n as runCliAgent } from "./cli-runner-C6EEiGf6.js";
import { n as prepareGitCoauthorAttribution } from "./git-coauthor-attribution-CKvab3EN.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-DBrqVR0N.js";
import { t as formatSystemTurnPrompt } from "./system-turn-prompt-CqPm0DzY.js";
import { n as resolveFollowupRunToolAuthorityFingerprint, t as createFollowupRunToolAuthorityProjector } from "./reply-tool-authority-B8CUU6X3.js";
...
import { a as resolveQueuedReplyExecutionConfig, c as resolveModelFallbackOptions, i as isBunFetchSocketError, l as resolveFallbackCandidateRun, n as buildThreadingToolContext, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveRunFastModeForFallbackCandidate, t as buildEmbeddedRunExecutionParams, u as resolveRunAuthProfile } from "./agent-runner-utils-Dvr4SdYi.js";
import { n as runSessionCompactionIfNeeded, t as runMemoryFlushIfNeeded } from "./agent-runner-memory-C3ghercG.js";
import { n as incrementCompactionCount } from "./session-updates-DSmIoeOu.js";
import { i as prepareGitHubPublicationAvailability } from "./github-publication-availability-8t5yYnWI.js";
import { n as prepareChannelRunAdmission } from "./channel-run-admission-CRcERUfp.js";
import { t as getMcpAppChannelOrigin } from "./mcp-app-channel-origin-CN4qXU72.js";
import { t as createMcpAppStandaloneTicket } from "./mcp-app-standalone-BEwWPCxa.js";
...
function hasSuccessfulTerminalSourceReplyDelivery(params) {
	const sentTerminalBlock = params.directlySentBlockPayloads?.some((payload) => isReplyPayloadTerminalContent(payload) && normalizeReplyPayload(payload, { applyChannelTransforms: false }) !== null);
...
async function handleAgentExecutionError(params) {
	...
	const externalRunFailureCandidate = !isBilling && !(isRateLimit && !isOverloaded) && !rateLimitOrOverloadedCopy && !isContextOverflow ? buildExternalRunFailureReply({
		message,
		error: err
	}, {
	...
	const externalRunFailureReply = !params.shouldSurfaceToControlUi || externalRunFailureCandidate?.presentation ? externalRunFailureCandidate : void 0;
	const userVisibleFallbackText = resolveExternalRunFailureTextForConversation({
		...
		}) : rateLimitOrOverloadedCopy ? rateLimitOrOverloadedCopy : isContextOverflow ? "⚠️ Context overflow — prompt too large for this model. Try a shorter message or a larger-context model." : externalRunFailureReply?.text ?? (params.shouldSurfaceToControlUi ? renderControlUiAgentFailureCopy(userFacingMessage) : turn.isHeartbeat ? "⚠️ Heartbeat check failed before it could produce an update. The main chat session remains available." : "⚠️ Something went wrong while processing your request. Please try again, or use /new to start a fresh session."),
		sessionCtx: turn.sessionCtx,
		isGenericRunnerFailure: externalRunFailureReply?.isGenericRunnerFailure ?? false,
		cfg: turn.followupRun.run.config
	});
	const abortLifecycleFields = resolveAgentRunErrorLifecycleFields(err, turn.replyOperation?.abortSignal.aborted === true ? turn.replyOperation.abortSignal : turn.opts?.abortSignal?.aborted === true ? turn.opts.abortSignal : void 0);
...
async function runCliFallbackCandidate(params) {
	...
	const selectedModelEntry = turn.followupRun.run.thinkingCatalog?.find((entry) => normalizeProviderId(entry.provider) === normalizedProvider && entry.id === params.model);
...
async function runAgentFallbackCandidates(params) {
	...
	let githubPublicationAvailability;
	params.timing.logMilestoneIfSlow({
		runId: params.runId,
		sessionId: turn.followupRun.run.sessionId,
		sessionKey: turn.sessionKey,
	...
	return params.timing.measure("model_fallback", () => runEmbeddedAgentEntry({
		...
		runCandidate: async (provider, model, runOptions) => {
			...
			const candidate = await runEmbeddedFallbackCandidate({
				...common,
				githubPublicationAvailable: await (githubPublicationAvailability ??= turn.sessionKey && params.effectiveRun.agentId ? prepareGitHubPublicationAvailability({
					sessionId: turn.followupRun.run.sessionId,
					sessionKey: turn.sessionKey,
...
//#endregion
//#region src/auto-reply/reply/agent-runner-message-tool-outcome.ts
const messageToolOutcomeLog = createSubsystemLogger("auto-reply/message-tool-outcome");
function recordMessageToolOnlyRunOutcome(params, result) {
	...
	const runStatus = outcome?.kind === "aborted" || outcome?.kind === "settled" && outcome.abortReason ? "aborted" : !outcome || outcome.kind === "rejected" || outcome.status === "failed" ? "errored" : "completed";
...
async function executeAgentTurnInternalWithRetryState(params, commitTerminalOutcome, overloadRetryState, commitMcpAppModelContext, preparedRunAdmission, admittedRunContext) {
	...
	while (true) try {
		...
		if (isAgentRunRestartAbortReason(err)) throw err;
...
async function executeAgentTurnInternal(params, commitTerminalOutcome, commitMcpAppModelContext) {
	...
	try {
		return await executeAgentTurnInternalWithRetryState(params, commitTerminalOutcome, overloadRetryState, commitMcpAppModelContext, preparedRunAdmission, admittedRunContext);
	} finally {
...
async function executeAgentTurn(params) {
	...
	try {
		...
		const terminalOutcome = result.outcome.kind === "aborted" || result.outcome.kind === "settled" && result.outcome.abortReason ? void 0 : result.outcome.kind === "rejected" || result.outcome.status === "failed" ? "failed" : "completed";
		if (terminalOutcome) executionParams.opts?.onAgentRunTerminalOutcome?.(terminalOutcome);
		recordMessageToolOnlyRunOutcome(executionParams, result);
		return result;
	} catch (error) {
		executionParams.opts?.onAgentRunTerminalOutcome?.("failed");
		recordMessageToolOnlyRunOutcome(executionParams, void 0);
		throw error;
	}
}
//#endregion
...
async function completeReplyAgentRun(input) {
	...
	const { autoCompactionCount, contextTokensUsed, modelUsed, promptTokens, providerUsed, runResult, verboseEnabled } = accounting;
...
async function buildReplyPayloads(params) {
	...
	const isDirectlySentBlockPayload = (payload) => {
		...
		if (!params.directlySentBlockKeys?.has(contentKey)) return false;
		const assistantMessageIndex = getReplyPayloadMetadata(payload)?.assistantMessageIndex;
		return assistantMessageIndex === void 0 || !params.directlySentBlockPayloads?.length || params.directlySentBlockPayloads.some((sentPayload) => getReplyPayloadMetadata(sentPayload)?.assistantMessageIndex === assistantMessageIndex && createBlockReplyContentKey(sentPayload) === contentKey);
	};
...
//#endregion
//#region src/auto-reply/reply/sessions-yield-acknowledgment.ts
function buildSessionsYieldAcknowledgmentPayload(params) {
	const text = params.yieldAcknowledgment?.trim();
	if (!params.yielded || !text || !params.isInteractive || params.isHeartbeat === true || params.silentExpected === true || params.isSubagentSession || params.hasExplicitSilentReply || params.hasVisibleMessageDelivery) return;
...
async function prepareReplyAgentPayloads(state) {
	...
	const isInteractive = followupRun.currentInboundEventKind !== "room_event" && (followupRun.run.inputProvenance?.kind === void 0 || followupRun.run.inputProvenance.kind === "external_user");
	const yieldAcknowledgmentPayload = terminalFailurePayload ? void 0 : buildSessionsYieldAcknowledgmentPayload({
	...
	const fallbackNoticeChatType = fallbackNoticeChanged ? normalizeChatType(sessionCtx.ChatType) : void 0;
	const shouldDeliverFallbackNotice = fallbackNoticeChatType !== "group" && fallbackNoticeChatType !== "channel";
	let fallbackNoticeText = null;
	if (fallbackNoticeChanged && fallbackTransition.fallbackTransitioned) {
		...
		if (shouldDeliverFallbackNotice) fallbackNoticeText = buildFallbackNotice({
			selectedProvider,
			selectedModel,
			activeProvider: providerUsed,
			activeModel: modelUsed,
	...
	if (fallbackNoticeChanged && fallbackTransition.fallbackCleared) {
		...
		if (shouldDeliverFallbackNotice) fallbackNoticeText = buildFallbackClearedNotice({
			selectedProvider,
			selectedModel,
			previousActiveModel: fallbackTransition.previousState.activeModel
		});
	...
	if (payloadArray.length === 0 && fallbackNoticePayloads.length === 0 && !shouldDeliverTerminalFailure && !yieldAcknowledgmentPayload && (!emptyInteractiveReplyPayload || hasSpecificFallbackFailure)) {
	...
	const hasTerminalReplyPayload = replyPayloads.some((payload) => isReplyPayloadTerminalContent(payload) && normalizeReplyPayload(payload, { applyChannelTransforms: false }) !== null);
...
function resolveFollowupDeliveryDecision(params) {
	...
	const fallbackPayload = accounting.terminalFailurePayload ? isInteractive && !hasCompletedTerminalDeliveryEvidence(result) ? sourcePolicy.sourceReplyDeliveryMode === "message_tool_only" ? markReplyPayloadForSourceSuppressionDelivery(accounting.terminalFailurePayload) : accounting.terminalFailurePayload : void 0 : buildSessionsYieldAcknowledgmentPayload({
	...
	if (!payloads.some((payload) => isReplyPayloadTerminalContent(payload) && (sourcePolicy.sourceReplyDeliveryMode !== "message_tool_only" || getReplyPayloadMetadata(payload)?.deliverDespiteSourceReplySuppression === true)) && fallbackPayload) payloads = [...payloads, ...resolveFollowupDeliveryPayloads({
		...deliveryContext,
...
async function sendFollowupPayloads(params) {
	...
	if (queuedPayloads.length > 0) await deliverQueuedBatch?.({
...
async function executeFollowupTurn(params) {
	...
	const progressOpts = {
		...
		onCommandOutput: sourceOpts?.onCommandOutput ? (output) => enqueueProgressResult(async () => {
			...
			return (await settleProgressVisibilityCallbackResult(sourceOpts.onCommandOutput(output))).visible;
		}) : void 0,
...
async function executePreparedReplyAgentRun(context) {
	...
	const runOutcome = await withBeforeAgentReplyObserver({
		...
		const gitCoauthorAttribution = prepareGitCoauthorAttribution({
			agentId: followupRun.run.agentId,
			config: cfg,
			currentProfileId: resolveProfileParticipantIdFromSessionCreation(sessionCtx.SessionCreation),
			sessionKey,
			storePath
		});
		const agentTurnOpts = gitCoauthorAttribution ? {
			...opts,
			gitCoauthorAttribution
		} : opts;
		return traceAgentPhase("reply.run_agent_turn", () => executeAgentTurn({
			commandBody,
	...
	recordReplyOperationAgentTurn(resolveReplyOperationRunState(opts), operationSuperseded ? "superseded" : runOutcome.outcome.kind === "rejected" ? "failed" : runOutcome.outcome.kind === "aborted" || runOutcome.outcome.abortReason ? "cancelled" : runOutcome.outcome.status, replyOperation);
	activeSessionEntry = getActiveSessionEntry();
	activeIsNewSession = getActiveIsNewSession();
...
async function runActiveReplySteer(params) {
	...
	try {
		...
		const finalization = await finalizeReplyMessageInjectionAttempt({
			attempt: beginReplyMessageInjectionTarget(injectionTarget, followupRun.prompt, {
				steeringMode: "all",
		...
		if (finalization.aborted) {
			...
			logVerbose(`queue: active session ${steerSessionId} aborted exact steered target without replay (${transcriptCommitUnconfirmed ? finalization.outcome.result?.errorMessage ?? "transcript commitment unconfirmed" : `adoption lost: ${formatErrorMessage(finalization.adoptionError)}`})`);
			typing.cleanup();
			return "handled";
		}
...
async function runReplyAgent(params) {
	const { commandBody, transcriptCommandBody, followupRun, queueKey, resolvedQueue, shouldSteer, shouldFollowup, queueAdmissionState = "empty", isActive, isRunActive, opts, typing, sessionEntry, sessionStore, sessionKey, runtimePolicySessionKey, storePath, defaultModel, resolvedVerboseLevel, toolProgressDetail, isNewSession, blockStreamingEnabled, blockReplyChunking, resolvedBlockStreamingBreak, sessionCtx, shouldInjectGroupIntro, typingMode, resetTriggered, replyThreadingOverride, replyOperation: providedReplyOperation } = params;
	...
	if (effectiveShouldSteer && isActive && !shouldQueueAuthorityMismatch && messageInjectionDisposition === "none") {
	...
	try {
		...
		recordReplyOperationAgentTurn(replyOperationRunState, isReplyOperationSuperseded(replyOperation) ? "superseded" : replyOperation.result?.kind === "aborted" ? "cancelled" : "failed", replyOperation);
