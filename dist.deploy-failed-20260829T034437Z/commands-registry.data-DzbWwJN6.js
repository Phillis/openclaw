...
import { a as listThinkingLevels } from "./thinking-CNREPJ80.js";
...
function buildBuiltinChatCommands(params = {}) {
	...
	const commands = [
		...
		defineBuiltinCommand("model", "Show or set the model; use -s, -a, or -g to choose scope.", "options", "essential", { args: [defineCommandArgument("model", "Model id; add -s for session, -a for agent, or -g for global scope")] }),
