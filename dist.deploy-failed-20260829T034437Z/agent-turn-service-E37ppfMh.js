...
import { l as AGENT_SESSION_RESET_COMMAND_RE } from "./method-scopes-BTnJZEGh.js";
...
import { h as patchSessionEntryTarget } from "./session-accessor.sqlite-entry-CNdoUuFZ.js";
...
import { g as consumeSessionWorkAdmissionHandoff, n as beginSessionWorkAdmission } from "./session-lifecycle-admission-1qqb7Ac0.js";
...
import { r as mergeSessionEntry } from "./types-BEJRKmOU.js";
import { h as resolveMaintenanceConfigFromInput } from "./disk-budget-DJbD0obL.js";
import { At as applySessionEntryReplacements, ht as getCliSessionBinding, mt as clearAllCliSessions, zt as resolveSessionEntryAccessTarget } from "./session-accessor-B-FKZX9M.js";
import { c as resolveRestartRecoveryChannelAuthority } from "./restart-recovery-state-6FYlAu33.js";
import { l as resolveAgentHarnessSessionContextError, t as AGENT_HARNESS_MODEL_RUN_FORBIDDEN_MESSAGE, u as resolveAgentHarnessSessionIdMismatchError } from "./agent-harness-session-key-Bf-Q9dw5.js";
import { A as readTranscriptStatsSync } from "./session-accessor.sqlite-transcript-store-Bx_F0DmJ.js";
import { u as recordSessionCreated } from "./session-state-events-BkuyPMaw.js";
import "./sessions-CdrF1uzY.js";
import { c as resolveTerminalMainSessionTranscriptRegistryCheck, i as hasTerminalMainSessionTranscriptNewerThanRegistrySync, o as resolveSessionLifecycleTimestamps, s as resolveSessionWorkStartError } from "./lifecycle-DzPMUp4j.js";
...
import { i as deleteMediaBuffer } from "./store-B6ILpvye.js";
import { s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-CGiGCCsY.js";
import { o as resolveEffectiveAgentRuntime } from "./thinking-runtime-1slENmfx.js";
import { s as loadPublishedGatewayReplyDispatchRuntime } from "./prepared-model-runtime-afzKiwqZ.js";
...
import { n as bindTaskRunExecution } from "./task-registry.store.sqlite-7NOoQ9mC.js";
import { t as bindTaskFlowExecution } from "./task-flow-registry.store.sqlite-BzofymYG.js";
import { x as findTaskByRunId, z as mapAgentRunTerminalOutcomeToTaskStatus } from "./task-registry-DzN8snH1.js";
...
import { E as retainEmbeddedAgentRunAbortabilityForRunId, i as clearEmbeddedAgentRunAbortabilityForRunId, l as isEmbeddedAgentRunAbortableForRunId } from "./runs-DpT-JSmi.js";
import { s as resolveTrustedGroupId } from "./agent-tools.policy-DrNOM40T.js";
...
import { a as consumeAgentRuntimeExecutionLineage, s as readAgentRuntimeExecutionLineage } from "./agent-runtime-identity-token-BLnwLnqH.js";
...
import { a as resolveExactSubagentCompletionEvent } from "./requester-tool-policy-BwKWjHQX.js";
import { a as createUserTurnTranscriptRecorder, i as buildRunUserTurnIdempotencyKey } from "./user-turn-transcript-CyFoZBC6.js";
import { o as consumeSubagentCompletionToolHandoff } from "./server-plugin-in-process-dispatch-Bm928Qlf.js";
...
import { r as resolveExistingSessionKeyForRequest } from "./session-_LoaZdn1.js";
...
import { r as runWithCanonicalSkillWorkspace } from "./autonomous-apply-ByotIeJv.js";
...
import { a as releaseMainSessionRecoveryOwner, n as commitMainSessionRecovery } from "./main-session-recovery-store-BMIYe3ml.js";
import { a as setChannelSourceTurnSameThreadRequired, i as setChannelSourceTurnId } from "./source-turn-id-qBM1Md8V.js";
import { f as updateChatRunProvider, l as resolveAgentRunExpiresAtMs, s as registerChatAbortController } from "./chat-abort-BpfXA9KF.js";
...
import { a as attachAgentCommandAdmissionFacts, i as withAgentCommandExecutionIdentitySpawnFacts, o as attachAgentCommandRecoveryAdmissionFacts } from "./agent-command-execution-identity-D_mHSoTL.js";
import { n as agentCommandFromGatewayIngress } from "./agent-command-iuozXiiI.js";
...
import { i as authorizeResolvedSessionMutation } from "./session-sharing-C4OmHGYo.js";
...
import { c as persistInboundImagesForTranscript, i as discardPreparedInboundMedia, n as MediaOffloadError, o as logAttachmentFailure, s as parseMessageWithAttachments, t as INLINE_IMAGE_DURABLE_OMISSION_MARKER } from "./chat-attachments-CtArkGi3.js";
import { t as errorShapeFromError } from "./error-shape-AdXc5KWe.js";
import { a as emitGatewaySessionStartPluginHook, i as emitGatewaySessionEndPluginHook, s as performGatewaySessionReset } from "./session-reset-service-B2w7CM1t.js";
import { n as emitSessionsChanged } from "./session-change-event-BVVK9xuQ.js";
import { F as setGatewayDedupeEntry, I as waitForAgentJob } from "./chat-abort-runtime-Du-GXdMW.js";
import { t as resolveAgentRunSessionCreation } from "./session-creation-provenance-B9w3HHXu.js";
import { t as handleChatAbortRequest } from "./chat-abort-handler-C8_e4d78.js";
import { r as resolveVoiceWakeRouteByTrigger, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BzSb0erJ.js";
...
async function registerPluginSubagentRunFromGateway(params) {
	...
	const { adoptPausedSubagentRunForFollowUp, registerSubagentRun } = await import("./subagent-registry-XilIqabO.js");
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./subagent-registry-runtime-D_3Fsty1.js");
}
/**
