...
import { t as isConfiguredChannel } from "./channel-selection-BRB1TsMb.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-cxjR1aAq.js";
import { i as resolveChannelAccountEnabled } from "./account-summary-D29QDdia.js";
...
function resolveMessageBroadcastAccountPlan(params) {
	...
	if (!accountId) return;
	const candidatePlugins = listRuntimeVisibleChannelPlugins().filter((plugin) => isPotentialConfiguredMessageChannel({
		cfg: params.cfg,
		plugin
	}));
