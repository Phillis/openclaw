...
import { a as require_type, i as require_es_define_property, n as require_get_intrinsic, r as require_call_bind_apply_helpers, t as require_form_data } from "./form_data-Bo2jt1G1.js";
...
//#endregion
//#region node_modules/@microsoft/teams.api/dist/models/search/search-invoke-value.js
var require_search_invoke_value = /* @__PURE__ */ __commonJSMin((() => {}));
//#endregion
//#region node_modules/@microsoft/teams.api/dist/models/search/search-response.js
var require_search_response = /* @__PURE__ */ __commonJSMin((() => {}));
//#endregion
//#region node_modules/@microsoft/teams.api/dist/models/search/index.js
var require_search$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var searchInvokeValue = require_search_invoke_value();
	var searchResponse = require_search_response();
	Object.keys(searchInvokeValue).forEach(function(k) {
		if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function() {
				return searchInvokeValue[k];
			}
		});
	});
	Object.keys(searchResponse).forEach(function(k) {
		if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function() {
				return searchResponse[k];
			}
		});
	});
}));
//#endregion
//#region node_modules/@microsoft/teams.api/dist/models/channel-data/app-info.js
var require_app_info = /* @__PURE__ */ __commonJSMin((() => {}));
//#endregion
...
var require_channel_data = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.keys(appInfo).forEach(function(k) {
		if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function() {
				return appInfo[k];
...
//#endregion
//#region node_modules/@microsoft/teams.api/dist/models/html-widget/html-widget-payload.js
var require_html_widget_payload = /* @__PURE__ */ __commonJSMin((() => {}));
//#endregion
//#region node_modules/@microsoft/teams.api/dist/models/html-widget/call-tool-request.js
var require_call_tool_request = /* @__PURE__ */ __commonJSMin((() => {}));
//#endregion
//#region node_modules/@microsoft/teams.api/dist/models/html-widget/call-tool-result.js
var require_call_tool_result = /* @__PURE__ */ __commonJSMin((() => {}));
//#endregion
//#region node_modules/@microsoft/teams.api/dist/models/html-widget/update-model-context.js
var require_update_model_context = /* @__PURE__ */ __commonJSMin((() => {}));
//#endregion
//#region node_modules/@microsoft/teams.api/dist/models/html-widget/index.js
var require_html_widget$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var htmlWidgetPayload = require_html_widget_payload();
	var callToolRequest = require_call_tool_request();
	var callToolResult = require_call_tool_result();
	var updateModelContext = require_update_model_context();
	Object.keys(htmlWidgetPayload).forEach(function(k) {
		if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function() {
				return htmlWidgetPayload[k];
			}
		});
	});
	Object.keys(callToolRequest).forEach(function(k) {
		if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function() {
				return callToolRequest[k];
			}
		});
	});
	Object.keys(callToolResult).forEach(function(k) {
		if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function() {
				return callToolResult[k];
			}
		});
	});
	Object.keys(updateModelContext).forEach(function(k) {
		if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function() {
				return updateModelContext[k];
			}
		});
	});
}));
...
var require_models = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var htmlWidget = require_html_widget$1();
	Object.keys(token).forEach(function(k) {
		if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function() {
	...
	Object.keys(htmlWidget).forEach(function(k) {
		if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function() {
				return htmlWidget[k];
...
//#endregion
//#region node_modules/@microsoft/teams.api/dist/activities/invoke/search.js
var require_search = /* @__PURE__ */ __commonJSMin((() => {}));
//#endregion
...
//#endregion
//#region node_modules/@microsoft/teams.api/dist/activities/invoke/html-widget/call-tool.js
var require_call_tool = /* @__PURE__ */ __commonJSMin((() => {}));
//#endregion
//#region node_modules/@microsoft/teams.api/dist/activities/invoke/html-widget/index.js
var require_html_widget = /* @__PURE__ */ __commonJSMin(((exports) => {
	var callTool = require_call_tool();
	Object.keys(callTool).forEach(function(k) {
		if (k !== "default" && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function() {
				return callTool[k];
...
var require_invoke = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var htmlWidget = require_html_widget();
