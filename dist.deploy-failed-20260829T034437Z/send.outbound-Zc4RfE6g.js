...
import { at as createThread, it as createChannelMessage } from "./discord-Cr3IyWY2.js";
import { C as resolveDiscordSendEmbeds, S as resolveDiscordSendComponents, T as parseAndResolveChannelRecipient, a as normalizeDiscordPollInput, b as createDiscordMessageNonce, c as normalizeStickerIds, f as sendDiscordMedia, l as resolveChannelId, n as buildDiscordTextChunks, p as sendDiscordText, t as buildDiscordSendError, u as resolveDiscordChannel, w as resolveDiscordSuppressEmbeds, x as resolveDiscordMessageFlags, y as buildDiscordMessageRequest } from "./send.shared-BHDfKfNT.js";
import { r as rewriteDiscordKnownMentions } from "./mentions-6W2EaW04.js";
import { n as createReusableDiscordReplyReference } from "./chunk-PxafPPwy.js";
import { n as createDiscordSendReceiptFromResults, r as createDiscordSendResult } from "./send.receipt-C5_060Xu.js";
import { l as createDiscordClient } from "./send.permissions-_uPaFgjs.js";
...
async function resolveDiscordSendTarget(to, opts) {
	...
	const { channelId } = await resolveChannelId(rest, await parseAndResolveChannelRecipient(to, cfg, account.accountId), request);
	return {
		rest,
		request,
		channelId,
...
async function sendMessageDiscord(to, text, opts) {
	...
	const { channelId } = await resolveChannelId(rest, await parseAndResolveChannelRecipient(to, cfg, accountInfo.accountId), request);
