...
import { C as createChildDiagnosticTraceContext, D as freezeDiagnosticTraceContext, N as runWithDiagnosticTraceContext, T as createDiagnosticTraceContextFromActiveScope, V as hasInternalDiagnosticEventListeners, o as emitTrustedDiagnosticEvent, s as emitTrustedDiagnosticEventWithPrivateData, t as areDiagnosticsEnabledForProcess } from "./diagnostic-events-BGzDm6gu.js";
import { t as createSubsystemLogger } from "./subsystem-a4KzJVZG.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DbQz-n_m.js";
import { g as withAgentRunLifecycleGeneration, n as captureAgentRunLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-CcZImb5w.js";
import { m as patchSessionEntryCore } from "./session-accessor.sqlite-entry-CNdoUuFZ.js";
import "./session-accessor-B-FKZX9M.js";
import { n as appendExactAssistantMessageToSessionTranscript } from "./transcript-DIvtCZB2.js";
import { d as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-CWpWIBkz.js";
import { _ as setReplyPayloadMetadata } from "./reply-payload-BeeUJOmJ.js";
import { d as loadAuthProfileStoreForRuntime } from "./store-C0UG5FOx.js";
import { a as markAuthProfileFailure } from "./usage-6-myLAu1.js";
...
import { c as isFailoverError, d as isTimeoutError, i as coerceToFailoverError, u as isSignalTimeoutReason } from "./failover-error-DVBvcQuA.js";
...
import { d as waitForDeferredTurnMaintenanceForSession, i as bootstrapHarnessContextEngine, l as runHarnessContextEngineMaintenance, n as runAgentEndSideEffects, s as finalizeHarnessContextEngineTurn, t as awaitAgentEndSideEffects } from "./agent-end-side-effects-C663wuG9.js";
...
import { a as runAgentHarnessLlmInputHook, o as runAgentHarnessLlmOutputHook, s as buildAgentHookContext } from "./lifecycle-hook-helpers-D2leHcq2.js";
import { b as resolveExplicitFinalSourceReplyDeliveryEvidence } from "./delivery-evidence-JxKjzZU6.js";
import { r as isCliSessionInvalidatingFailoverReason } from "./cli-session-JwnBWNOs.js";
...
import { a as resolveCliRuntimeOwnerFingerprint, i as resolveCliRuntimeArtifactFingerprint } from "./cli-auth-epoch-C9qi3_04.js";
import { i as formatCliBackendOutputDigest, r as cliBackendLog } from "./log-BPUOmteF.js";
import { h as hashCliReseedPrompt } from "./cli-session-history.claude--plzwyp1.js";
import { l as createCliFailoverError, t as acceptsCliLiveSession } from "./cli-live-session-registry-CgQndG47.js";
import { n as getCliMessagingDeliveryEvidence, t as attachCliMessagingDeliveryEvidence } from "./delivery-evidence-Cmz7UHq4.js";
import { c as CliAuthProfilePreparationError, i as loadCliSessionHistoryMessages, r as loadCliSessionContextEngineMessages, s as buildAgentHookConversationMessages, u as claudeCliSessionTranscriptHasContent } from "./session-history-CAKshf3M.js";
...
async function settlePreparedCliRun(params) {
	...
	if (runParams.cleanupCliLiveSessionOnRunEnd === true) try {
		const { closeCliLiveSession } = await import("./cli-live-session-registry-BPpBgDip.js");
		await closeCliLiveSession(context, "restart");
	} catch (error) {
		recordCleanupError(error);
	}
	if (runParams.cleanupBundleMcpOnRunEnd === true) try {
		const { retireSessionMcpRuntime } = await import("./agent-bundle-mcp-tools-DVMGaqLt.js");
...
function buildCliRunResult(params) {
	...
	const payloadsWithToolMedia = mergeAttemptToolMediaPayloads({
		payloads: sourceReplyMirror.payloads.length > 0 ? sourceReplyMirror.payloads : sourceReplyMirror.delivered ? void 0 : text ? [assistantTranscriptOwned ? setReplyPayloadMetadata({ text }, {
			assistantTranscriptOwned: true,
			...assistantTranscriptIdempotencyKey ? { assistantTranscriptIdempotencyKey } : {}
		}) : { text }] : runParams.allowEmptyAssistantReplyAsSilent === true ? [{ text: SILENT_REPLY_TOKEN }] : void 0,
	...
	const cliSessionBindingCleared = terminalInterruption !== void 0 || sessionBindingDisabled || unflushedCliSessionId !== void 0;
	...
	const agentSessionId = terminalInterruption || unflushedCliSessionId ? "" : sessionBindingDisabled ? runParams.sessionId ?? "" : effectiveCliSessionId ?? runParams.sessionId ?? "";
