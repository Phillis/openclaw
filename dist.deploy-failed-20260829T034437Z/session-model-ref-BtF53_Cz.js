...
import { _ as resolveConfiguredModelRef, l as inferUniqueProviderFromConfiguredModels } from "./model-selection-shared-I5TmV9jL.js";
...
function resolveSessionModelRef(cfg, entry, agentId, options) {
	...
	if (normalizedOverride.providerOverride && normalizedOverride.modelOverride) {
		const allowPluginNormalization = entry?.modelOverrideRouteResolution === "resolved" ? false : options?.allowPluginNormalization;
