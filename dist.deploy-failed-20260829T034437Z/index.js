#!/usr/bin/env node
import { a as formatUncaughtError } from "./errors-Ccx0R-_Z.js";
import { a as isExpectedCliError, n as formatCliFailureLines, r as formatCliJsonFailure } from "./failure-output-CdUzE2dC.js";
import { r as isJsonOutputModeActive } from "./json-output-mode-XMIkPNjr.js";
import { n as runCliWithExitFinalization } from "./one-shot-exit-CvLNCpcm.js";
...
import { n as isBenignUncaughtExceptionError, o as isUncaughtExceptionHandled, t as installUnhandledRejectionHandler } from "./unhandled-rejections-BjziovQ7.js";
...
if (!isMain) ({applyTemplate, createDefaultDeps, deriveSessionKey, describePortOwner, ensureBinary, ensurePortAvailable, getReplyFromConfig, handlePortError, loadConfig, loadSessionStore, monitorWebChannel, normalizeE164, PortInUseError, promptYesNo, resolveSessionKey, resolveStorePath, runCommandWithTimeout, runExec, saveSessionStore, waitForever} = await import("./library-QIKh3Ymn.js"));
if (isMain && !handledRootVersion) {
	const { defaultRuntime, restoreRuntimeTerminalState } = await import("./runtime-BO0y5md7.js");
