...
import { d as recordRemoteSkillNodeInfo, f as removeRemoteNodeSkills, i as loadWorkspaceSkills, m as setRemoteSkillConnectionReconciler } from "./workspace-skill-loader-BIyN38wj.js";
import { E as updatePairedDeviceNodeSurfaceInTransaction } from "./device-bootstrap-DpkEF5MF.js";
import { b as withPairedDeviceRecords, g as resolveNodePairingGeneration } from "./device-pairing-Li5h-3GZ.js";
import { a as listNodePairing } from "./device-pairing-node-DrrXxGrx.js";
	...
	return await withPairedDeviceRecords(params.baseDir, () => {
		return {
			value: updatePairedDeviceNodeSurfaceInTransaction(params.nodeId, params.baseDir, (device) => {
				...
				if (!device?.nodeSurface || params.isCurrent?.() === false || params.expectedPairingGeneration.nodeId !== device.deviceId || generation?.key !== params.expectedPairingGeneration.key) return {
					value: false,
					persist: false
				};
				return {
