...
import { i as resolveProviderPolicySurface, r as resolveBundledProviderPolicySurface } from "./provider-public-artifacts-qUJeTQDG.js";
...
import { n as applyPluginTextReplacements, r as mergePluginTextTransforms, t as resolveRuntimeTextTransforms } from "./text-transforms.runtime-CSYnzMVW.js";
...
import { d as resolveOwningPluginIdsForProviderRef, f as resolveProviderRefOwnership, p as resolveUsageHookProviderPluginContracts, r as resolveCatalogHookProviderPluginIds, s as resolveExternalAuthProfileProviderPluginIds, u as resolveOwningPluginIdsForProvider } from "./providers-BoUulJbF.js";
import { t as resolvePluginDiscoveryProvidersRuntime } from "./provider-discovery.runtime.js";
import { a as resolveLoadedProviderRuntimePlugin, d as resolveProviderRuntimePlugin, l as resolveProviderHookPlugin, n as ensureProviderRuntimePluginHandle, u as resolveProviderPluginsForHooks } from "./provider-hook-runtime-C6OwLIWh.js";
...
async function resolveProviderUsageSnapshotWithPlugin(params) {
	...
	if (!harness) {
		...
		const { loadAgentRuntimePluginRegistryHandle } = await import("./runtime-plugins-DWlWmnDo.js");
		const { ensureSelectedAgentHarnessPlugin } = await import("./runtime-plugin-Cs5QJTyz.js");
