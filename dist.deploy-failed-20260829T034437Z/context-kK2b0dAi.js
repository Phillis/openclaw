...
import { a as DEFAULT_SOUL_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, p as ensureAgentWorkspace, r as DEFAULT_IDENTITY_FILENAME, s as DEFAULT_USER_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-CYdcs93J.js";
...
import { a as computeSandboxBrowserConfigHash, t as resolveDockerEnvPolicyEpoch } from "./sanitize-env-vars-DrKKX-jQ.js";
...
import { i as slugifySessionKey, n as resolveSandboxAgentId, r as resolveSandboxWorkspaceLayoutPaths, t as buildSandboxContainerName } from "./shared-BYKW6NFa.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-mQNQ9PEh.js";
import { _ as assertSshSandboxSecretOwnerAvailable } from "./ssh-backend-DEoOHhAa.js";
import { i as startBrowserBridgeServer, l as requireSandboxBackendFactory, n as stopCachedBrowserBridge, r as stopCachedBrowserBridgesForContainer, s as getSandboxBackendWorkdirResolver, t as BROWSER_BRIDGES } from "./browser-bridges-DS9Ipg9y.js";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [syncWorkspaceSkills, { getRemoteSkillEligibility }, { resolveNodeExecEligibility }] = await Promise.all([
			...
			import("./remote-BtWGGhYF.js"),
			import("./exec-defaults-DU1uSKxu.js")
		]);
...
async function resolveProvisionedSandboxContext(params, resolved) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-DvhKEN2C.js")).maybePruneSandboxes(cfg);
