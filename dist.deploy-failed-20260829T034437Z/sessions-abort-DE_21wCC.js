...
import { vr as validateSessionsAbortParams } from "./src-4dv5TpeQ.js";
import { a as resolveStoredSessionOwnerAgentId, i as resolveStoredSessionKeyForAgentStore, n as resolveSessionStoreAgentId, r as resolveSessionStoreKey } from "./session-store-key-DRF7yKG5.js";
...
import { S as resolveActiveEmbeddedRunOwnerByRunId, n as abortEmbeddedAgentRun } from "./runs-DpT-JSmi.js";
...
import { F as setGatewayDedupeEntry } from "./chat-abort-runtime-Du-GXdMW.js";
...
import { n as handleChatAbortRequestWithLifecycle } from "./chat-abort-handler-C8_e4d78.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-BNPEQzdh.js";
import { c as requireSessionKey } from "./sessions-shared-Cz1Xn6wW.js";
import { t as resolveWorkerSessionTarget } from "./session-target-CDU2PE2V.js";
...
const sessionAbortHandlers = { "sessions.abort": async ({ req, params, respond, context, client, isWebchatConnect }) => {
	...
	const embeddedRunMatchesSession = Boolean(embeddedRun && resolveSessionKeyAgentId(embeddedRun.sessionKey, cfg) === normalizeAgentId(targetAgentId) && (embeddedRun.sessionKey === key || embeddedRun.sessionKey === canonicalKey || sessionEntry?.sessionId === embeddedRun.sessionId));
