...
import { x as GATEWAY_CONFIG_SELECTION_ENV_KEYS } from "./io.read-helpers-YVBmmwxJ.js";
import { t as getGatewayRunRuntimeHooks } from "./runtime-hooks-Dp2OHV46.js";
import { i as resolveUpgradeConfigSnapshot, n as isUpgradeConfigRepairResult } from "./automatic-upgrade-config-repair-DcWEHSUA.js";
...
async function prepareGatewayRunBootstrap(params) {
	...
	const { planPristineStartupConfigMigrations, planPristineStartupStateMigrations } = await import("./pristine-startup-state-DG6BFU-e.js");
