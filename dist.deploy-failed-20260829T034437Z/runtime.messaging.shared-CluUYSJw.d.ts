import { N as RetryConfig } from "./runtime-api-IAhSVA75.js";
import { n as OpenClawConfig } from "./types.openclaw-DRR8P0H2.js";
import "./config-contracts-BoWM1_J1.js";
import { F as ChannelMessageActionContext, U as MessageReceipt } from "./channel-contract-Pji552cX.js";
import { r as PluginStateKeyedStore } from "./plugin-state-store.types-aSCieMta.js";
...
declare class BaseInteraction {
   ...
   */
  editDeferredPlaceholderIfUnanswered(payload: MessagePayload): Promise<boolean>;
...
type DiscordCommand = Command | CommandWithSubcommands;
...
declare abstract class CommandWithSubcommands extends BaseCommand {
...
//#endregion
export { APIMessage as $, Modal as A, RequestClient as B, DiscordTimeoutTarget as C, Plugin as D, Client as E, User as F, APIVoiceState as G, GatewayReceivePayload as H, MessagePayloadObject as I, APIGuildScheduledEventRecurrenceRule as J, APIGuildScheduledEvent as K, TopLevelComponents as L, ComponentData as M, ComponentParserResult as N, Command as O, Guild as P, APIEmbed as Q, Embed as R, DiscordThreadList as S, MessageCreateListener as T, GatewaySendPayload as U, GatewayPresenceUpdateData as V, GatewayVoiceStateUpdateData as W, GuildScheduledEventPrivacyLevel as X, GuildScheduledEventEntityType as Y, APIAllowedMentions as Z, DiscordSearchQuery as _, DiscordChannelPermissionSet as a, APIEmoji as at, DiscordStickerUpload as b, DiscordMessageQuery as c, DiscordReactOpts as d, APIGuildMember as et, DiscordReactionRuntimeContext as f, DiscordRuntimeAccountContext as g, DiscordRoleChange as h, DiscordChannelMove as i, ChannelType as it, TextDisplay as j, Label as k, DiscordModerationTarget as l, DiscordReactionUser as m, DiscordChannelCreate as n, GatewayPresenceUpdate as nt, DiscordEmojiUpload as o, APIRole as ot, DiscordReactionSummary as p, APIGuildScheduledEventEntityMetadata as q, DiscordChannelEdit as r, APIChannel as rt, DiscordMessageEdit as s, Snowflake as st, DiscordMessagingActionOptions as t, APIGatewayBotInfo as tt, DiscordPermissionsSummary as u, DiscordSendError as v, DiscordMessageDispatchData as w, DiscordThreadCreate as x, DiscordSendResult as y, DiscordCommandDeployHashStore as z };