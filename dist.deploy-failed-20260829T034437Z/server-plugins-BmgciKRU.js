...
import { r as getInProcessGatewayRequestContext, t as dispatchGatewayMethodInProcess } from "./server-plugin-in-process-dispatch-Bm928Qlf.js";
	...
	return {
		...
		runtime: {
			dispatchReplyFromConfig: async (params) => {
				const { dispatchReplyFromConfig } = await import("./dispatch-from-config-DxA_uXTO.js");
