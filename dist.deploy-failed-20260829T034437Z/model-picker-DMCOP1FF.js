...
import { a as resolveAgentModelPrimaryValue, i as resolveAgentModelFallbackValues, n as normalizeAgentModelRefForConfig, t as normalizeAgentModelMapForConfig } from "./model-input-ILUprkGk.js";
import "./agent-scope-DigoIwHb.js";
import { E as computeModelPolicyAllowlist, h as resolveDefaultAgentDir, s as resolveAgentConfig } from "./agent-scope-config-CUBiGmG3.js";
import { s as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-CeAk9iRD.js";
import { o as normalizeModelRef, r as formatLiteralProviderPrefixedModelRef, s as normalizeProviderId$1 } from "./model-ref-shared-D4yx0hwT.js";
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog } from "./model-selection-shared-I5TmV9jL.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CdX9UGcX.js";
import { n as openAIModelCatalogRoutePolicy } from "./openai-model-routes-Bxpy3ufg.js";
...
import { n as canonicalizePreparedModelCatalogProvider } from "./model-catalog-BCGmKLlL.js";
import { s as loadPreparedModelCatalogSnapshot } from "./prepared-model-catalog-U3rYWrrQ.js";
import { n as createModelPickerVisibleProviderPredicate } from "./model-runtime-aliases-CGiGCCsY.js";
import "./model-selection-DHDS-v4K.js";
import { n as createProviderAuthChecker } from "./model-provider-auth-Di0Tgn4T.js";
import { n as t } from "./i18n-BQpjgFU-.js";
import { p as formatTokenK } from "./shared-BOd9kz9I.js";
import { n as resolveLogicalVisibleModelCatalog, t as resolveLogicalModelCatalogEntryState } from "./model-catalog-visibility-B2fKQqua.js";
import { n as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-Dx-pXqzI.js";
//#region src/flows/model-picker.provider-catalog.ts
function filterProviderSnapshot(snapshot, provider) {
	...
	return {
		...
		...snapshot.staticEntries ? { staticEntries: snapshot.staticEntries.filter(matchesProvider) } : {}
	};
}
...
async function loadPreferredProviderPickerCatalog(params) {
	...
	const providerFilter = canonicalizePreparedModelCatalogProvider(requestedProvider, resolvePluginMetadataSnapshot({
		config: params.cfg,
		env,
		...params.workspaceDir ? { workspaceDir: params.workspaceDir } : {}
	}));
	return filterProviderSnapshot(await loadPreparedModelCatalogSnapshot({
		config: params.cfg,
...
function loadPickerModelCatalog(cfg, opts = {}) {
	...
	if (opts.preferredProvider) {
		if (opts.preferLiveProviderCatalog) return loadPreferredProviderPickerCatalog({
			...
			if (providerCatalog.entries.length > 0) return providerCatalog;
...
async function promptDefaultModel(params) {
	...
	const resolveCachedLiteralPrefixProviders = async () => {
		if (!literalPrefixProvidersCache) literalPrefixProvidersCache = await resolveLiteralPrefixProviderIds({
			...
			workspaceDir: params.workspaceDir,
			env: params.env,
			...providerScopedCatalog && preferredProvider ? { providerRefs: [preferredProvider] } : {}
		});
	...
	if (includeProviderPluginSetups && params.agentDir && !providerScopedCatalog) options.push(...await resolveProviderPluginSetupOptions({
		cfg,
		workspaceDir: params.workspaceDir,
		env: params.env
	}));
