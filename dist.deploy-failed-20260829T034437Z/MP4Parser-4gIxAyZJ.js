...
import { C as UINT64_BE, D as lib_exports, E as Uint8ArrayType, O as textDecode, T as UINT8, _ as UINT16_BE, d as INT32_BE, g as StringType, h as INT8, l as INT16_BE, o as makeUnexpectedFileContentError, r as FieldDecodingError, t as BasicParser, u as INT24_BE, x as UINT32_BE, y as UINT24_BE } from "./BasicParser-Ce0bn6Mo.js";
...
import { a as getBit, d as uint8ArrayToHex } from "./Util-BgxYFDuK.js";
import { t as Genres } from "./ID3v1Parser-Cqgsck_t.js";
	...
	*/
	parseSoundSampleDescription(sampleDescription) {
		...
		if (description && description.length >= SoundSampleDescriptionVersion.len) {
			...
			if (version.version === 0 || version.version === 1) if (description.length >= offset + SoundSampleDescriptionV0.len) ssd.description = SoundSampleDescriptionV0.get(description, offset);
			else debug(`Warning: sound-sample-description too short: ${description.length} bytes`);
