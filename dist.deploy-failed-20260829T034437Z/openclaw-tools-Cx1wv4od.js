...
import { dt as stripInboundMetadata, ut as hasInboundMetadataSentinel } from "./openclaw-state-db-CeAO_dqo.js";
...
import { n as isPluginMetadataSnapshotCompatible, s as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-CeAk9iRD.js";
...
import { a as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-CZWL79I8.js";
...
import { M as getPreparedMessageToolCatalog, d as getActivePluginRegistry, p as getActivePluginRegistryVersion } from "./runtime-DMlUh4Cg.js";
import { T as synthesizeMediaGenerationCatalogEntries, w as listMediaGenerationProviderModels } from "./loader-D0AfkRZe.js";
...
import { i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CL5HFEAI.js";
...
import { o as getSessionWorkAdmissionRelease } from "./session-lifecycle-admission-1qqb7Ac0.js";
...
import { Bt as resolveSessionEntryCandidateTarget, Rt as patchSessionEntryWithKey, ht as getCliSessionBinding } from "./session-accessor-B-FKZX9M.js";
import { n as extnameFromAnyPath } from "./file-name-D1nUHSBH.js";
import { a as imageMimeFromFormat } from "./mime-Hm4eS2i0.js";
import { c as listSessionStateEventsSince, i as getSessionStateVersions, r as getSessionStateVersion } from "./session-state-events-BkuyPMaw.js";
import { C as getSessionGoal, E as updateSessionGoalStatus, x as createSessionGoal, y as MODEL_UPDATABLE_SESSION_GOAL_STATUSES } from "./sessions-CdrF1uzY.js";
...
import { o as getModelProviderRequestTransport } from "./provider-request-config-BAUXM8KH.js";
import { a as unwrapSecretSentinelsForProviderEgress } from "./provider-secret-egress-BXpRqyF7.js";
...
import { K as isEmbeddedMode, Y as listAllChannelSupportedActions, Z as listChannelSupportedActions, g as hasRunWorkspaceSkillUsage, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-DoS1-Lb6.js";
import { i as getPluginRuntimeLoadContext } from "./load-context-Cj6rxf47.js";
import { h as normalizeProviderTransportWithPlugin } from "./provider-runtime-XSAeyFFJ.js";
import { l as loadPublishedPreparedModelCatalog } from "./prepared-model-catalog-U3rYWrrQ.js";
import { r as resolveProviderTransportSsrFPolicy } from "./provider-transport-fetch-BDjjVdoJ.js";
...
import { $ as formatFullOutputFooter, gt as writePrivateTempFile, lt as getModelRegistryRuntime } from "./sessions-PHTfe5gZ.js";
import { a as bindModelLlmRuntime, t as complete } from "./stream-CXbsApnu.js";
...
import { f as saveMediaBuffer, i as deleteMediaBuffer } from "./store-B6ILpvye.js";
import { i as normalizeMediaReferenceSource, r as classifyMediaReferenceSource } from "./media-reference-Q4z-WfN-.js";
import { t as bundledStaticCatalogProviderUsesRuntimeAugment } from "./model.static-catalog-BYYtvCmS.js";
import "./workspace-CYdcs93J.js";
import "./agent-id-DC26pYcR.js";
import { n as resolveImageFallbackDefaultProvider, t as resolveImageFallbackCandidates } from "./model-fallback-candidates-Gs96s0BQ.js";
import { r as resolvePluginCapabilityProvider, t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-2izPQWsN.js";
import { o as requireApiKey } from "./model-auth-runtime-shared-C48YoQY0.js";
import { r as resolveWidgetPresenters } from "./runtime-plugins-7tauRyL1.js";
...
import { r as getCustomProviderApiKey } from "./model-auth-provider-config-DW3Bgqni.js";
import { c as createRuntimeProviderAuthLookup, i as getApiKeyForModelCore, l as hasRuntimeAvailableProviderAuth, r as applySecretRefHeaderSentinels, s as resolveApiKeyForProviderCore } from "./model-auth-e0nL7cI2.js";
...
import { D as listTaskRecordsUnsorted } from "./task-registry-DzN8snH1.js";
import { s as stripPlainTextToolCallBlocks } from "./src-CXf6rX-C.js";
import { c as sanitizeTaskStatusText, i as formatTaskStatusTitle, n as formatTaskStatus, r as formatTaskStatusDetail } from "./task-status-DUVcvxzX.js";
import "./runtime-internal-KZAce0-2.js";
import { t as cancelDetachedTaskRunById } from "./task-executor-D9EdhKj2.js";
import { d as registerGeneratedMediaTaskActivity, u as clearGeneratedMediaTaskActivity } from "./task-status-access-RjhQa8uZ.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-DD1wDy8n.js";
...
import { u as isReplyDispatchDeliveryError } from "./reply-dispatcher-DRSctPVt.js";
...
import { r as getDefaultLocalRootsCore } from "./local-media-access-fA_3dacW.js";
...
import { d as stripUnsupportedCitationControlMarkers } from "./payloads-BNOW0uoZ.js";
import { T as isToolWrappedWithBeforeToolCallHook, l as bindAssembledAgentToolActionDescriptor, m as setToolTerminalPresentation, n as createGatewayToolCallerWrapper, r as getGatewayToolCallerIdentity } from "./gateway-caller-context-D1DYQtHE.js";
import { t as normalizeConversationReadInvocationOrigin } from "./conversation-read-origin-E3olMOwo.js";
import { o as resolvePluginTools, s as setPluginToolMeta } from "./tools-DL5ef4Om.js";
...
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, s as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BKb237RL.js";
import { t as resolveSkillWorkshopConfig } from "./config-Cjp42tXL.js";
import { M as restoreWorkspaceSkillMutation, O as prepareWorkspaceSkillMutation, S as applyWorkspaceSkillMutation, u as PROPOSAL_DRAFT_FILE, y as SKILL_WORKSHOP_ROLLBACK_SCHEMA } from "./store-sqlite-record-CsO0xTyk.js";
...
import { t as buildWorkspaceSkillStatus } from "./status-CFSwEllv.js";
...
import { i as resolveMessageActionAgentRuntimeIdentityToken, n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-aj3xYAQy.js";
...
import { a as resolveAllowedMessageActions } from "./outbound-policy-DV9-S_yt.js";
...
import { a as projectMcpCallToolResult, o as setMcpCodeModeGuestResultFromAgentResult } from "./agent-bundle-mcp-materialize-VGxGQrwu.js";
...
import { a as screenSnapshotTempPath, c as parseCameraSnapPayload, d as writeBase64ToFile, f as writeCameraClipPayloadToFile, i as screenSnapshotFormatForPath, l as resolveCameraClipTarget, m as mediaPathMatchesFormat, n as parseScreenSnapshotPayload, o as cameraTempPath, p as writeCameraPayloadToFile, r as screenRecordTempPath, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as resolveCameraSnapTargets } from "./nodes-screen-qR9sh2i2.js";
import { n as resolveAgentNode, r as resolveAgentNodeId, t as listNodes } from "./nodes-utils-Cjfuq3J0.js";
import { o as actionRequiresTarget, s as resolveActionDeliveryTargetAlias } from "./channel-target-7t_7pXOl.js";
import { a as optionalPositiveIntegerSchema, i as optionalNonNegativeIntegerSchema, n as channelTargetsSchema, o as optionalStringEnum, r as optionalFiniteNumberSchema, s as stringEnum, t as channelTargetSchema } from "./typebox-C6o7T1Lp.js";
import { i as gatewayCallOptionSchemaProperties, t as createCronTool } from "./cron-tool-nNZ7-Jy3.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-D_litxx5.js";
import { i as createSessionVisibilityRowChecker } from "./session-visibility-BvdtJ7Em.js";
import { S as hasInProcessGatewayToolContext, _ as shouldResolveSessionIdInput, a as formatSessionToolAccessDenial, c as resolveSessionToolAccess, d as resolveCurrentSessionClientAlias, f as resolveDisplaySessionKey, g as resolveVisibleSessionReference, h as resolveSessionReference, i as resolveSessionToolContext, l as runSessionToolActionWithConflictReceipt, m as resolveMainSessionAlias, n as classifySessionListKind, o as recordSessionToolActionFact, p as resolveInternalSessionKey, r as deriveChannel, t as SESSION_LIST_KINDS, v as callAgentToolGatewayRequest, x as getInProcessGatewayToolContext, y as callInProcessGatewayTool } from "./sessions-helpers-Cr-lJimL.js";
import { s as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-kfj2Ed2f.js";
import { c as listControlledSubagentRuns, l as resolveSubagentController, o as MAX_RECENT_MINUTES } from "./subagent-control-BX8c2zdO.js";
import { t as buildSubagentList } from "./subagent-list-BHKw6Jay.js";
import { k as createStructuredOutputTool, u as getSubagentRunByRunId, y as recordSwarmStructuredOutput } from "./subagent-registry-BNIH9OE4.js";
import { g as capArrayByJsonBytes } from "./session-transcript-readers-CgCxlOAj.js";
import { t as resolveSessionModelIdentityRef } from "./session-model-ref-BtF53_Cz.js";
import { d as readSessionTitleFieldsFromTranscriptAsync, w as deriveSessionTitle } from "./session-utils-list-Bb0Qg6y4.js";
import { n as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-DpSZkV-h.js";
import "./session-utils-BTR52tOf.js";
import { n as stripToolMessages } from "./chat-history-text-CRd84wDl.js";
import { t as resolveSwarmConfig } from "./swarm-config-Df_H07Y6.js";
import { t as createCanvasDocument } from "./documents-CrnqL8aM.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-AYmGWXzM.js";
...
import { o as extractEmbeddedAssistantText } from "./embedded-agent-utils-91E_Bwfx.js";
import { t as registerProviderStreamForModel } from "./provider-stream-Bl3TAdrB.js";
import { a as loadRequesterSessionEntry, d as formatAgentInternalEventsForPrompt, h as sanitizeGeneratedMediaDisplayText, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, r as resolveAnnounceOrigin, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-C-_bJihR.js";
...
import { f as wrapToolWorkspaceRootGuardWithOptions } from "./agent-tools.read-B0kEbcx5.js";
import { n as bindActiveOperatorTurnAuthority } from "./cron-creator-authority-context-hXifa_42.js";
import { r as listConnectedNodePluginTools } from "./node-plugin-tool-snapshot-PbApRkBd.js";
import { t as resolveAgentRuntimeToolConfig } from "./tool-runtime-config-DLS-I75P.js";
import { a as hasProviderAuthForTool, c as resolveOpenAiImageMediaCandidate, n as coerceToolModelConfig, o as hasToolModelConfig$1, r as hasAuthForProvider, s as resolveDefaultModelRef, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-b8rS9qvd.js";
...
import { t as createAgentsWaitTool } from "./agents-wait-tool-MiYhsFQn.js";
import { n as createTranscriptsTool } from "./transcripts-tool-wlcI34nx.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-L32y-3ZS.js";
import { y as resolveSubagentAllowedTargetIds } from "./subagent-spawn-ownership-SGFI9TM9.js";
import { n as listRuntimeImageGenerationProviders, r as resolveImageGenerationMaxInputImages, t as generateImage } from "./runtime-N7S5E3pj.js";
import { a as listMusicGenerationProviders, n as getMusicGenerationProvider, s as parseGenerationModelRef } from "./registry-CcMLsGwl.js";
import { n as hasMediaNormalizationEntry } from "./geometry-normalization-HeviYyBt.js";
import { n as resolveChannelInboundAttachmentRootsForChannel } from "./channel-inbound-roots-DL8x8QI7.js";
import { t as runWithImageModelFallback } from "./model-fallback-image-DqX9fp7v.js";
import { t as removeCronRunContinuationSessionIfIdle } from "./cron-run-continuation-cleanup-YBF4Qqez.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-BRB1TsMb.js";
import { n as resolveMessageBroadcastAccountPlan, r as validateExplicitMessageAccountSelection } from "./message-account-selection-BTn_GTYc.js";
import { r as sourceDeliveryTargetsMatch } from "./source-delivery-plan-B9uf2pUf.js";
import { i as resolveDocumentMediaModel, n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-C3AahYb0.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-CleqRgm3.js";
import { a as DEFAULT_TIMEOUT_SECONDS, c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-CG3XZviH.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-hrrxUKqA.js";
import { c as resolveTimeoutMs } from "./resolve-9tTBkwqj.js";
import "./media-understanding-BZzGeoPt.js";
import { c as postJsonRequest, m as resolveProviderHttpRequestConfigWithOriginTrust } from "./shared-uZXUsfMB.js";
import { i as readResponseBodySnippet, n as isMinimaxVlmProvider } from "./minimax-vlm-DnDqJ2qU.js";
import { a as resolveConfiguredImageModelRefs, i as hasImageReasoningOnlyResponse, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, t as coerceImageAssistantText } from "./image-tool.helpers-Br9BbcA2.js";
import { n as sortPluginEntriesForAutoDetect } from "./plugin-entry-order-DxrT0ucv.js";
import { n as runtimeWebSecretOwnerId } from "./runtime-web-tools-d0xKlyvI.js";
...
import { f as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-DLC-aqND.js";
import { t as resolveMessageSecretScope } from "./message-secret-scope-Duxe5usd.js";
import { a as projectGatewayQueuedDeliveryResult, i as SHARED_POLL_CREATION_PARAM_NAMES, n as runMessageAction, r as POLL_CREATION_PARAM_DEFS, t as getToolResult } from "./message-action-runner-CxKIh4RX.js";
...
import { t as extractPdfContent } from "./pdf-extract-BsyFBtKA.js";
import { n as resolveModelAsync } from "./model-mZvi1Kcu.js";
import { a as createSessionsSendTool, c as createPortalTool, o as resolveSessionToolTargetAgentId, s as runWithScopedSessionAccess, t as createSessionsSpawnTool } from "./sessions-spawn-tool-CmKIGkAe.js";
import { t as triggerSessionPatchHook } from "./session-patch-hooks-DVEd4mKI.js";
...
import { r as withAgentSessionModelPatchOrigin } from "./session-model-patch-origin-B8wn1eht.js";
...
import { r as recordSkillCollectionReviewHistory, t as listSkillCollectionReviewOutcomes } from "./collection-review-state-B1qe-PAk.js";
import { n as clearSkillUsageForRemovedSkills } from "./curator-CCqMkag9.js";
import { a as resolveRegisteredExecApprovalDecision, i as registerExecApprovalRequestForHostOrThrow } from "./bash-tools.exec-approval-request-DyW6N06v.js";
import { t as resolveExecDefaults } from "./exec-defaults-LNnaxz9o.js";
import { n as textToSpeech } from "./tts-DNxFkuxh.js";
import { n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-DBPY-VlF.js";
...
import { n as resolveWebSearchToolRuntimeContext, t as resolveWebFetchToolRuntimeContext } from "./web-tool-runtime-context-Cv38CWgQ.js";
import { o as runWebSearch } from "./runtime-DfPJqKDi.js";
import "./web-search-provider-common-Kid931Nb.js";
...
const loadMessageActionRunner = createLazyRuntimeModule(() => import("./message-action-runner-BGCTS3_l.js"));
...
function createRequesterYieldCallback(params) {
	...
	return async () => {
		...
		const { markRequesterTurnYielded } = await import("./subagent-registry-XilIqabO.js");
...
async function loadMediaToolReferences(params) {
	...
	for (const rawInput of params.inputs) {
		...
		if (reference.isDataUrl) {
			const { decodeDataUrl } = await import("./image-tool.helpers-PYV-qJrm.js");
			params.signal?.throwIfAborted();
			media = decodeDataUrl(resolvedInput, { maxBytes: params.maxBytes });
		} else {
			const { loadWebMedia } = await import("./web-media-CSgkxL9N.js");
			params.signal?.throwIfAborted();
...
async function loadImageWebMediaRuntime() {
	return await import("./web-media-CSgkxL9N.js");
}
const resolveModelAsyncDefault = async (...args) => {
	const { resolveModelAsync } = await import("./model-CyYzjwpn.js");
...
function createTerminalTool(opts = {}) {
	return {
		...
		execute: async (toolCallId, rawArgs, signal) => {
			...
			if (!execSession) {
				const { loadGatewaySessionEntryReadOnly } = await import("./session-utils-store-_7pL_Fgh.js");
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-DCyfbWI0.js"));
