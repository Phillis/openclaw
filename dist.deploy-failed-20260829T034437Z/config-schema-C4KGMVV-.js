...
import { An as preprocess, At as boolean, Et as array, Nn as record, Rn as string, Tn as object, Xn as union, Zn as unknown, dn as literal, wc as NEVER, wn as number, yt as _enum } from "./schemas-CZ9Toj_c.js";
import { n as ZodIssueCode } from "./compat-BJw8yvyp.js";
import { B as requireOpenAllowFrom, N as TtsConfigSchema, b as ProviderCommandsSchema, z as requireAllowlistAllowFrom } from "./zod-schema.core-CTdpjCBO.js";
...
const DiscordAccountSchemaBase = object({
...
function normalizeShippedDiscordDmAliases(value) {
	...
	if (!dm || dm.policy === void 0 && dm.allowFrom === void 0) return updated;
	const { policy: _policy, allowFrom: _allowFrom, ...retainedDm } = dm;
	const { dm: _dm, ...rest } = updated;
	return Object.keys(retainedDm).length > 0 ? {
		...rest,
		dm: retainedDm
	} : rest;
}
const DiscordAccountSchema = preprocess(normalizeShippedDiscordDmAliases, DiscordAccountSchemaBase);
const DiscordChannelConfigSchema = buildChannelConfigSchema(preprocess(normalizeShippedDiscordDmAliases, DiscordAccountSchemaBase.extend({
