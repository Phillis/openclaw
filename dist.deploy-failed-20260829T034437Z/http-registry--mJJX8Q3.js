...
import { C as requireActivePluginHttpRouteRegistry } from "./runtime-DMlUh4Cg.js";
...
function registerPluginHttpRoute(params) {
	...
	if (scope?.leases.some((lease) => !lease.isActive())) return rejectRegistration("plugin service HTTP route lease is no longer active");
