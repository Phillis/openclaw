...
import { t as FAILOVER_REASONS$1 } from "./failover-reasons-Mjd0tFtT.js";
...
const INCOMPLETE_ASSISTANT_STREAM_RE = /^[\w -]*stream ended (?:before (?:message_?stop|(?:a )?terminal (?:finish reason|response event|event))|without a terminal finish reason)[.!]?$/i;
...
function resolveProviderRuntimeHooks() {
	...
	try {
		const runtime = requireProviderRuntime("../../plugins/provider-runtime.js");
		const classify = isRecord(runtime) ? runtime.classifyProviderFailoverSignalWithPlugin : null;
		if (typeof classify !== "function") {
			cachedProviderRuntimeHooks = null;
			return cachedProviderRuntimeHooks;
		}
		cachedProviderRuntimeHooks = { classifyProviderFailoverSignalWithPlugin: (params) => {
			const result = classify(params);
			return result === null || result === void 0 || isFailoverReason(result) ? result : void 0;
		} };
	} catch {
		cachedProviderRuntimeHooks = null;
	}
...
//#endregion
export { parseImageDimensionError as C, matchesFormatErrorPattern as S, isBillingErrorMessage as _, isContextOverflowError as a, isRateLimitErrorMessage as b, isReasoningConstraintErrorMessage as c, isExactUnknownNoDetailsError as d, isGenericUnknownStreamErrorMessage as f, isAuthErrorMessage as g, INCOMPLETE_ASSISTANT_STREAM_RE as h, isFailoverErrorMessage as i, inferSignalStatus as l, isUnclassifiedNoBodyHttpSignal as m, classifyFailoverSignal as n, isContextOverflowErrorFromTables as o, isTransientHttpError as p, isCloudCodeAssistFormatError as r, isLikelyContextOverflowError as s, classifyFailoverReason as t, isBilling429MessageForProvider as u, isPeriodicUsageLimitErrorMessage as v, parseImageSizeError as w, isTimeoutErrorMessage as x, isProviderCompletedErrorFinishReasonMessage as y };
