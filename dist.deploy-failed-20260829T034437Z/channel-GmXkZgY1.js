...
import { M as createConditionalWarningCollector, O as createAllowlistProviderGroupPolicyWarningCollector, i as createDangerousNameMatchingMutableAllowlistWarningCollector, r as collectStandardAllowlistLists, t as buildMutableAllowEntryDetector } from "./channel-policy-BG3-cCKG.js";
...
import { m as listChannelsForTeamWithPageInfo, r as normalizeMSTeamsConversationId, t as extractMSTeamsConversationMessageId, y as resolveGraphToken } from "./inbound-CrUCZmPL.js";
import { a as parseMSTeamsConversationId, d as resolveMSTeamsChannelAllowlist, f as resolveMSTeamsTeamsConfig, i as normalizeMSTeamsUserInput, n as looksLikeMSTeamsTargetId, o as parseMSTeamsTeamChannelInput, p as resolveMSTeamsUserAllowlist, r as normalizeMSTeamsMessagingTarget, t as looksLikeMSTeamsConversationId } from "./resolve-allowlist-BwaUYROy.js";
import { t as msteamsDirectoryContractPlugin } from "./directory-contract-api-B1FEaan1.js";
import { i as resolveMSTeamsRouteConfig, n as resolveMSTeamsGroupToolPolicy, r as resolveMSTeamsReplyPolicy } from "./policy-DJ5aPrxF.js";
import { r as resolveMSTeamsAccount } from "./channel-config-DjH7xpcf.js";
import { i as msTeamsApprovalCapability, n as resolveMSTeamsOutboundSessionRoute, o as shouldSuppressLocalMSTeamsExecApprovalPrompt, r as isMSTeamsNativeApprovalClientEnabled, t as inferMSTeamsTargetChatType } from "./session-route-DI9iU7kO.js";
...
const loadMSTeamsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DDsXhhdr.js"), "msTeamsChannelRuntime");
...
const msteamsPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorMSTeamsProvider } = await import("./src-XcA_Qsur.js");
