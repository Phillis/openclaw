import { y as StreamFn } from "./types-DTWCh4Mv.js";
import "./index-DspOpKBe.js";
import { b as StreamFn$1 } from "./types-aADBdueZ.js";
import "./index-Bf1XfcnS.js";
import { jn as ProviderWrapStreamFnContext$1 } from "./types-CiLdD6DO.js";
...
((streamFn: StreamFn$1 | undefined) => StreamFn$1 | undefined) | null | undefined | false;
/** Compose stream wrapper factories from left to right around a base stream function. */
declare function composeProviderStreamWrappers(
...
...wrappers: ProviderStreamWrapperFactory[]): StreamFn$1 | undefined;
/**
 ...
 */
declare function createPlainTextToolCallCompatWrapper(
...
declare function defaultToolStreamExtraParams(
...
declare function createPayloadPatchStreamWrapper(
...
baseStreamFn: StreamFn$1 | undefined, patchPayload: (params: {
  ...
  model: Parameters<StreamFn$1>[0];
  /** Stream context passed by the runtime. */
  context: Parameters<StreamFn$1>[1];
