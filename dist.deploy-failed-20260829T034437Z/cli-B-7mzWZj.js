...
import { n as matrixSetupAdapter } from "./setup-core-CFbn90HX.js";
import { t as withResolvedActionClient } from "./client-DheLVVKf.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-eoBmkHup.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-CcoZausS.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-CGbDH9Rz.js"));
