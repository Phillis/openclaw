...
import { a as parseSystemAgentOperation, n as describeSystemAgentPersistentOperation, s as isInvalidConfigSetOperation } from "./operations-D076P5ja.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-BU1z2fm8.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
