...
async function runConfiguredSystemAgentText(params) {
	...
	try {
		...
		text = extractAgentRunText(route.runner === "cli" ? await (params.deps?.runCliAgent ?? (await import("./cli-runner-CCQXLSf9.js")).runCliAgent)({
			...shared,
			preparedRunAdmission,
			executionMode: "side-question",
			cleanupCliLiveSessionOnRunEnd: true
		}) : await (params.deps?.runEmbeddedAgent ?? (await import("./embedded-agent-ClAd_F7t.js")).runEmbeddedAgent)({
			...shared,
			preparedRunAdmission,
			toolsAllow: [],
