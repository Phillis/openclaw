...
import { h as applyDefaultCronToolsAllow } from "./store-pLPqGtqL.js";
import { I as createTrustedCronScheduledToolPolicy, _ as normalizeCronJobCreate } from "./row-codec-LoN9q1nV.js";
import "./config-B2bSneS2.js";
import { s as readAgentDeletionJournal } from "./agent-deletion-journal-BpQsagX8.js";
import { i as closeOpenClawAgentDatabaseByPath } from "./openclaw-agent-db-CM8nAOgX.js";
import { B as resolveOpenClawAgentSqlitePath, P as unregisterOpenClawAgentDatabases } from "./openclaw-agent-db-maintenance-DDqVWNe-.js";
...
import { c as readWorkspaceStateSnapshot, i as deleteWorkspaceState, s as prepareWorkspaceStateDeletion, v as prepareLegacyWorkspaceStateReset, y as removeLegacyWorkspaceStateForReset } from "./workspace-state-store-CKubv1mM.js";
import { n as DEFAULT_BOOTSTRAP_FILENAME, x as resolveWorkspaceBootstrapStatus } from "./workspace-CYdcs93J.js";
import { t as withPluginLifecycleLease } from "./plugin-lifecycle-lease-BZTAJyJS.js";
import { l as digestClawAgentConfig, n as deleteCachedClawInstallSchemaVersion } from "./provenance-runtime-read-BoVQ1rr5.js";
import { r as planClawHubSkillUninstall, t as applyClawHubSkillUninstall } from "./clawhub-uninstall-DlSCFUnc.js";
...
import { r as beginAgentDeletion } from "./agent-lifecycle-registry-D1dm9wFG.js";
import { h as withAgentExecApprovalsRemoved } from "./exec-approvals-generated-migration-DfpexxOF.js";
import { i as moveToTrash } from "./cleanup-utils-BFaP5a7r.js";
import { t as resolveCronJobConfigRevision } from "./config-revision-gFmtIhTN.js";
import { a as pruneAgentConfig } from "./agents.config-b213TBEZ.js";
import { t as listConfiguredMcpServers } from "./mcp-config-BmE1Up1i.js";
import { a as withClawMcpLifecycleLease, n as unsetConfiguredMcpServer } from "./mcp-config-mutation-Drmw10uS.js";
...
import { c as readClawPackageRefs, d as updateClawPackageRefStatus, s as readClawInstallRecords, u as updateClawInstallRecordStatus } from "./provenance-C6SGNjzS.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-Bu_MnzQL.js";
import { n as deleteAgentConfigEntry, t as AgentConfigPreconditionError } from "./agents-config-mutations-CvTSn3X8.js";
import { C as digestClawMcpServer, D as readClawMcpServerRefsByName, E as readClawMcpServerRefs, O as reconcileClawMcpServerRefs, S as deleteClawMcpServerRef, T as planClawMcpServerRemoval, t as parseClawMarkdown, v as CLAW_OUTPUT_STABILITY, x as clawMcpRemovalSelector } from "./reader-CTUbyYA8.js";
import { t as runPluginUninstallCommand } from "./plugins-uninstall-command-mepmdx5F.js";
import { r as resolvePluginInstallRequestContext } from "./plugin-install-config-policy-DoVUd4dh.js";
...
async function applyClawRemovePlan(plan, options = {}) {
	...
	if (!options.commitConfig || options.purgeSessions) await (options.purgeSessions ?? (await import("./cleanup-service-zFNmkrB6.js")).purgeAgentSessionStoreEntries)(configBeforeDelete, agentId);
