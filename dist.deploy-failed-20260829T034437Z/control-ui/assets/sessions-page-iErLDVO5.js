const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./input-dialog-DhuROdtE.js","./rolldown-runtime-DkW27tQK.js","./control-ui-core-e-KoKC_B.js","./control-ui-foundation-CWAqQ-cL.js","./lit-runtime-Dak9t-fA.js","./control-ui-core-B9umaA0V.js","./control-ui-core-JdzsptKd.js","./gateway-runtime-CFwduryT.js","./control-ui-core-DwR-GjOr.css"])))=>i.map(i=>d[i]);
import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{Bi as t,Gr as n,Li as r,Wr as i,dr as a,wn as o,xn as s}from"./control-ui-foundation-CWAqQ-cL.js";import{$a as c,An as l,Bi as u,Bl as d,Bs as f,Do as p,Dr as m,Er as h,Gc as g,Hi as _,Hl as v,Jo as y,K as ee,Kc as b,Lo as x,Nr as te,Oc as S,Or as C,To as w,Tr as T,Ul as ne,Vs as re,Wc as ie,Yc as E,Yo as ae,ao as oe,b as se,bc as ce,do as le,eo as ue,f as de,g as D,gr as fe,h as pe,ir as me,jn as he,nl as O,no as ge,o as _e,q as ve,qc as ye,rl as be,ro as k,sl as A,to as xe,uo as j,vo as Se,yo as Ce,z as we,zs as M}from"./control-ui-core-e-KoKC_B.js";import{G as N,J as P,W as Te,Z as Ee,at as De,rt as F}from"./lit-runtime-Dak9t-fA.js";import{$t as Oe,Lt as ke,Rt as Ae,d as je,f as Me,fn as Ne,pn as Pe,vt as Fe,yt as Ie}from"./control-ui-core-B9umaA0V.js";import{Ft as Le,Pt as I,Wt as L,j as Re,jt as ze,zt as Be}from"./control-ui-core-JdzsptKd.js";import{F as Ve,I as He,L as Ue,Rt as We,z as Ge,zt as Ke}from"./control-ui-boot-DHCezebr.js";import{a as R,r as qe}from"./gateway-runtime-CFwduryT.js";import{Bl as Je,Cu as Ye,D as Xe,Gl as Ze,Go as Qe,Hc as $e,Hr as et,Ko as tt,Ll as nt,Mo as rt,No as it,Ul as at,Vc as ot,Vr as st,Wl as z,a as ct,ao as lt,as as ut,cc as dt,dn as ft,en as pt,es as mt,fn as B,g as ht,io as gt,is as _t,n as vt,ns as yt,rs as bt,sn as xt,tn as St,ts as Ct,un as wt,v as Tt,x as V,y as Et,zl as Dt}from"./control-ui-boot-ZLjE-rT7.js";import{n as Ot,t as kt}from"./transcript-search-B7ykoH84.js";import{n as H,t as At}from"./confirm-dialog-DbFNToZ0.js";import{t as jt}from"./web-awesome-popover-Dv02Y95O.js";import{n as Mt,r as Nt}from"./worktree-preservation-BeqoIU6I.js";import{d as Pt,t as Ft}from"./workboard-7sc-23Pz.js";import{n as It,t as Lt}from"./settings-workspace-jKK7KP46.js";import{n as Rt,t as zt}from"./gateway-page-controller-CBwUmyVb.js";import{o as Bt,s as Vt}from"./presenter-BYvp7Zkx.js";import{n as Ht,t as Ut}from"./agent-scope-control-CNz5txAo.js";import{n as Wt,t as Gt}from"./sessions-hub-header-oaLOx-Xy.js";function Kt(e){return[...new Set((e?.sessions??[]).map(e=>O(e.key)?.agentId).filter(e=>!!e))]}function qt(e,t){return Object.fromEntries(Kt(e).map(e=>[e,t(e)]).filter(e=>!!e[1]))}function Jt(){return(Jt=e((()=>{E()})))()}function Yt(e,t){let n=(e?.sessions??[]).map(e=>e.category?.trim()).filter(e=>!!e);return[...new Set([...t,...n.toSorted((e,t)=>e.localeCompare(t))])]}async function Xt(e){if(!e.sessions||e.knownCategories.includes(e.name))return`completed`;try{return await e.sessions.groupsPut([...e.sessions.state.groups??[],e.name])===`completed`&&e.isCurrent()?`completed`:`stale`}catch(t){return e.isCurrent()?(e.onError(M(t)),`failed`):`stale`}}function Zt(){return(Zt=e((()=>{re()})))()}function Qt(){return at(ne()?.getItem(U))}function $t(e){try{ne()?.setItem(U,e)}catch{}}var U;function en(){return(en=e((()=>{Je(),U=`openclaw:sessions:group-by`})))()}function W(e,t){return Object.hasOwn(e,t)?e[t]??null:null}function tn(e,t){let n=Xe(e,t),r=ht(e.thinkingDefault??(n?t?.thinkingDefault:void 0)),i=e.thinkingLevels?.length?e.thinkingLevels:n&&t?.thinkingLevels?.length?t.thinkingLevels:(e.thinkingOptions?.length?e.thinkingOptions:n&&t?.thinkingOptions?.length?t.thinkingOptions:Pn).map(e=>({id:V(e),label:e}));return[{value:``,label:r},...i.map(e=>({value:V(e.id),label:Tt(e.id,e.label)}))]}function G(e,t){return!t||e.some(e=>e.value===t)?[...e]:[...e,{value:t,label:Tt(t)}]}function K(e,t=!1){return e.map(e=>({value:e,label:L(e===``?`sessionsView.inherit`:t&&e===`off`?`sessionsView.offExplicit`:`sessionsView.${e}`)}))}function nn(e){return L(zn[e]??`sessionsView.statusUnknown`)}function rn(e){let t=w(e),n=e.hasActiveRun===!1&&(!e.status||e.status===`running`),r=e.status===`queued`?L(`sessionsView.statusQueued`):t?L(`sessionsView.statusLive`):n?L(`sessionsView.statusIdle`):e.status?nn(e.status):L(`sessionsView.statusUnknown`),i=e.status===`queued`?`warn`:t||e.status===`done`?`ok`:n||!e.status?`muted`:`danger`,a=`${L(`sessionsView.status`)}: ${r}`;return P`
...
//# sourceMappingURL=sessions-page-iErLDVO5.js.map