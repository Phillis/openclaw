import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{dr as t}from"./control-ui-foundation-CWAqQ-cL.js";import{Bl as n,Er as r,Hl as i,Qn as a,Tr as o,Yn as s,b as c,g as l}from"./control-ui-core-e-KoKC_B.js";import{G as u,J as d,W as f,Z as p,at as m,rt as h}from"./lit-runtime-Dak9t-fA.js";import{d as g,f as _}from"./control-ui-core-B9umaA0V.js";import{Ct as v,Wt as y,zt as b}from"./control-ui-core-JdzsptKd.js";import{Rt as x,zt as S}from"./control-ui-boot-DHCezebr.js";import{a as C,r as w}from"./gateway-runtime-CFwduryT.js";import{i as T,r as E,t as D}from"./custodian-surface-DJcuN_nL.js";function O(e){switch(e){case`system-agent`:return y(`custodian.history.sources.systemAgent`);case`doctor`:return y(`custodian.history.sources.doctor`);case`config-rpc`:return y(`custodian.history.sources.settings`);case`external`:return y(`custodian.history.sources.manualEdit`);case`cli`:return y(`custodian.history.sources.cli`);case`plugin-install`:return y(`custodian.history.sources.pluginInstall`);case`unknown`:return y(`custodian.history.sources.unknown`)}return e}function k(e){return d`
...
//# sourceMappingURL=custodian-page-CTG2kRrG.js.map