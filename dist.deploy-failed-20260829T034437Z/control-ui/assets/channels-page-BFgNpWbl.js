import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{In as t,dr as n,jn as r}from"./control-ui-foundation-CWAqQ-cL.js";import{$n as i,Bl as a,Bs as o,Er as s,Fs as c,Hl as l,Jn as u,Qn as d,Tr as f,Vs as p,Zn as m,_i as h,b as g,er as ee,g as _,hi as te,nr as ne,p as re,zs as v}from"./control-ui-core-e-KoKC_B.js";import{G as y,J as b,W as x,Z as ie,rt as S}from"./lit-runtime-Dak9t-fA.js";import{$t as ae,F as oe,Ft as C,K as se,Nt as ce,R as le,Rt as ue,d as de,f as fe,fn as pe,gt as me,mt as he,pn as ge}from"./control-ui-core-B9umaA0V.js";import{Ct as _e,Ft as ve,Ht as ye,J as be,Ot as w,Pt as T,Wt as E,q as xe,zt as D}from"./control-ui-core-JdzsptKd.js";import{Rt as Se,zt as Ce}from"./control-ui-boot-DHCezebr.js";import{$t as we,en as O,fn as k,fs as Te,in as A,ps as Ee,sn as De,tn as Oe,un as j}from"./control-ui-boot-ZLjE-rT7.js";import{n as ke,t as Ae}from"./confirm-dialog-DbFNToZ0.js";import{i as M,n as je,r as N,t as Me}from"./channel-picker-BnrZZO2_.js";import{n as Ne,t as Pe}from"./select-picker-CDQ-ou9m.js";import{n as Fe,t as Ie}from"./wizard-step-controls-BUDacmaP.js";import{n as Le,t as Re}from"./settings-workspace-jKK7KP46.js";import{n as ze,t as Be}from"./gateway-page-controller-CBwUmyVb.js";import{c as Ve,l as He,n as Ue,o as We,t as Ge,u as Ke}from"./config-form-CIAxoaNI.js";async function qe(e,t){let n=new AbortController,r=setTimeout(()=>n.abort(new DOMException(`Nostr profile request timed out after 30 seconds`,`TimeoutError`)),Qe);try{let r=await fetch(e,{...t,signal:n.signal}),i=null;try{i=await r.json()}catch(e){if(n.signal.aborted)throw n.signal.reason??e}return{data:i,response:r}}finally{clearTimeout(r)}}function Je(e){if(!Array.isArray(e))return{};let t={};for(let n of e){if(typeof n!=`string`)continue;let[e,...r]=n.split(`:`);if(!e||r.length===0)continue;let i=e.trim(),a=r.join(`:`).trim();i&&a&&(t[i]=o(a))}return t}function Ye(e,t=``){return`/api/channels/nostr/${encodeURIComponent(e)}/profile${t}`}async function Xe(e){return await qe(Ye(e.accountId),{method:`PUT`,headers:{"Content-Type":`application/json`,...e.headers},body:JSON.stringify(e.values)})}async function Ze(e){return await qe(Ye(e.accountId,`/import`),{method:`POST`,headers:{"Content-Type":`application/json`,...e.headers},body:JSON.stringify({autoMerge:!0})})}var Qe;function P(){return(P=e((()=>{p(),Qe=3e4})))()}function $e(e){let{values:t,original:n}=e;return t.name!==n.name||t.displayName!==n.displayName||t.about!==n.about||t.picture!==n.picture||t.banner!==n.banner||t.website!==n.website||t.nip05!==n.nip05||t.lud16!==n.lud16}function et(e){let{state:t,callbacks:n,accountId:r}=e,i=$e(t),a=(e,r,i={})=>{let{type:a=`text`,placeholder:o,maxLength:s,help:c}=i,l=t.values[e]??``,u=t.fieldErrors[e],d=`nostr-profile-${e}`,f=a===`textarea`?b`
            <textarea
              id="${d}"
...
//# sourceMappingURL=channels-page-BFgNpWbl.js.map