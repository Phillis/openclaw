    ...
    <section class="sw-history ${t?.hasScanned?`is-compact`:``}">
      ...
      <div class="sw-history__copy">
        ...
        ${t?.hasScanned?i`
            ...
            `:r}
        ${e.state.error?i`<div class="sw-history__error" role="alert">${e.state.error}</div>`:r}
      </div>
