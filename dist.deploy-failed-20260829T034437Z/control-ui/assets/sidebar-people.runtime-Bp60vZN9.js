import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{Pi as t}from"./control-ui-foundation-CWAqQ-cL.js";import{$a as n,Jc as r,Jo as i,Qo as a,Yc as o,Zc as s,cl as c,nl as l,ro as u,sl as d,to as f,z as p}from"./control-ui-core-e-KoKC_B.js";import{G as m,J as h,K as g,W as _,h as v,m as y}from"./lit-runtime-Dak9t-fA.js";import{M as b,j as ee,vt as x,yt as S}from"./control-ui-core-B9umaA0V.js";import{$ as C,Ft as w,Ht as T,Pt as E,Wt as D,et as O,tt as k,zt as A}from"./control-ui-core-JdzsptKd.js";import{Lc as j,Pc as M,Sc as N,bc as P,cs as F,ds as I,us as L,xc as R,yc as z}from"./control-ui-boot-ZLjE-rT7.js";import{n as B,r as V,t as H}from"./portaled-hovercard-BaYuU0uf.js";function U(e){let t=[{agentId:e.sessionsAgentId,result:e.sessionsResult},...Object.entries(e.sessionResultsByAgent).map(([e,t])=>({agentId:e,result:t}))].flatMap(({agentId:e,result:t})=>e?(t?.sessions??[]).map(t=>({row:t,agentId:l(t.key)?.agentId??t.agentId??e})):[]),n=Object.entries(e.childSessionRowsByParent).flatMap(([t,n])=>{let r=l(t)?.agentId??e.sessionsAgentId;return r&&e.loadedChildSessionKeys.has(t)?n.map(e=>({row:e,agentId:l(e.key)?.agentId??e.agentId??r})):[]});return[...t,...n]}function W(e,n,i){let a=l(e)?.agentId??t(n);return`${a}\u0000${r({agentsList:{defaultId:a,mainKey:i.mainKey,scope:i.globalScope?`global`:`agent`}},l(e)||e.toLowerCase()===`global`?e:`agent:${a}:${e}`)}`}function G(e,t){let n=e.filter(e=>e!==void 0);return n.length?t===`first`?Math.min(...n):Math.max(...n):void 0}function K(e){let t=new Date(e);return h`<time
...
//# sourceMappingURL=sidebar-people.runtime-Bp60vZN9.js.map