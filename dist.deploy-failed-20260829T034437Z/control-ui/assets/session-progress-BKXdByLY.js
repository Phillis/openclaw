import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{dr as t}from"./control-ui-foundation-CWAqQ-cL.js";import{Bl as n,Hl as r}from"./control-ui-core-e-KoKC_B.js";import{J as i,W as a,Z as o,at as s}from"./lit-runtime-Dak9t-fA.js";import{d as c,f as l}from"./control-ui-core-B9umaA0V.js";import{Wt as u,zt as d}from"./control-ui-core-JdzsptKd.js";import{Rt as f,zt as p}from"./control-ui-boot-DHCezebr.js";import{Jr as m,Kr as h,Yr as g,qr as _}from"./control-ui-boot-ZLjE-rT7.js";function v(e){let t=e?.props?.sessionKey;return typeof t==`string`&&t.trim()?t.trim():void 0}var y,b;function x(){return(x=e((()=>{p(),a(),o(),l(),h(),d(),r(),m(),y=class extends n{constructor(...e){super(...e),this.sessionKey=``,this.active=!0,this.targetSessionKey=``,this.retryLoad=()=>{!this.store||!this.targetSessionKey||this.store.load(this.targetSessionKey).catch(()=>void 0)}}connectedCallback(){super.connectedCallback(),this.syncStore()}willUpdate(){this.syncStore()}disconnectedCallback(){this.releaseStore(),super.disconnectedCallback()}render(){let e=this.store?.getError(this.targetSessionKey);if(e)return i`<div
...
//# sourceMappingURL=session-progress-BKXdByLY.js.map