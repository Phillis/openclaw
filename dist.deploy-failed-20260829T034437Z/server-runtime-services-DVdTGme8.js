...
import { c as startSessionDeliveryRuntime, o as schedulePendingSessionDeliveries } from "./subagent-completion-delivery-D0JLJvTT.js";
import "./embedded-agent-_ah8V7hs.js";
import { n as runHeartbeatOnce, t as startHeartbeatRunner } from "./heartbeat-runner-BC5uticW.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-WSekhXHE.js";
import { r as assertQueuedConversationDeliveryAttemptAuthorized } from "./conversation-route-ownership-BoZ4hbAB.js";
...
function startPendingSessionDeliveryRuntime(params) {
	...
	const timer = setTimeout(() => {
		runWithGatewayIndependentRootWorkAdmission(async () => {
			const { deliverQueuedSessionDelivery, recoverPendingRestartContinuationDeliveries, settleQueuedSessionDelivery } = await import("./server-restart-sentinel-Blu-YZ4P.js");
			if (stopped) return;
