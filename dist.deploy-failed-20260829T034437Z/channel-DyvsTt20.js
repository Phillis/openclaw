...
import { f as createChannelMessageAdapterFromOutbound, g as bindIngressLifecycleToReplyOptions, h as createChannelIngressError } from "./channel-outbound-vVeKbh9E.js";
		...
		start: async () => {
			const bus = await startNostrBus({
				...
				onMessage: async (senderPubkey, text, reply, meta, lifecycle) => {
					...
					const { dispatchInboundDirectDm } = await import("./inbound-direct-dm-runtime-Sxrsr5HE.js");
