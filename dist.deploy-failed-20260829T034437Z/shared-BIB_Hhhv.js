...
import { T as looksLikeSessionId, m as resolveMainSessionAlias, p as resolveInternalSessionKey } from "./sessions-helpers-Cr-lJimL.js";
import { r as resolveSubagentTargetFromRuns, t as formatRunLabel } from "./subagents-utils-BtOb4AWK.js";
import { n as buildSubagentRunReadIndex } from "./subagent-registry-read-kfj2Ed2f.js";
...
function extractSubagentMessageText(message) {
	...
	const text = extractTextFromChatContent(role === "assistant" ? extractStoredAssistantText(message) : message.content);
	return text ? {
		role,
		text
	} : null;
