...
import { n as POSIX_SHELL_WRAPPERS, x as resolveInlineCommandMatch } from "./shell-wrapper-resolution-BddNi41x.js";
import { d as resolveSystemdServiceName, m as resolveSystemdUserUnitPath, y as execSystemctlUser } from "./systemd-scope-Dt6qzIxA.js";
import { n as collectInlineManagedServiceEnvKeys, o as hasInlineEnvironmentSource, r as collectInlineServiceEnvKeys, s as isEnvironmentFileOnlySource, u as readEnvironmentValueSource } from "./service-managed-env-D38lJbxp.js";
import { c as resolveSystemNodePath, d as SERVICE_PROXY_ENV_KEYS, i as resolveBunRuntimeInfo, l as isNonMinimalServicePathEntry, m as getMinimalServicePathPartsFromEnv, n as isVersionManagedNodePath, t as isSystemNodePath, u as normalizeServicePathEntry } from "./runtime-paths-BWwciIgl.js";
import "./launchd-DLjWImVd.js";
import { n as parseKeyValueOutput } from "./service-mutation-DyzHamq7.js";
...
async function auditGatewayRuntime(env, command, issues, platform) {
	...
	if (isBunRuntime(execPath)) {
		if (!(await resolveBunRuntimeInfo(execPath)).supported) issues.push({
			code: SERVICE_AUDIT_CODES.gatewayRuntimeBun,
			message: "Gateway service uses an unsupported Bun runtime; Bun 1.4+ with WAL-reset-safe node:sqlite is required.",
			detail: execPath,
			level: "recommended"
		});
		return;
