...
import { f as resolveAgentWorkspaceDir, m as resolveConfiguredAgentId, s as resolveAgentConfig } from "./agent-scope-config-CUBiGmG3.js";
import { c as parseAgentSessionKey } from "./session-key-utils-Di3FvABa.js";
import { a as buildAgentMainSessionKey, f as resolveAgentIdFromSessionKey, u as normalizeMainKey } from "./session-key-Dbce_H9p.js";
...
import { s as getSandboxBackendWorkdirResolver } from "./browser-bridges-DS9Ipg9y.js";
import { t as buildSandboxFsMounts } from "./fs-paths-DNCksiBH.js";
import { i as removeSandboxContainer, n as listSandboxContainers, r as removeSandboxBrowserContainer, t as listSandboxBrowsers } from "./sandbox-BUq3Yn9r.js";
...
async function sandboxExplainCommand(opts, runtime) {
	...
	const sessionEntry = loadSessionEntryReadOnly({
		agentId: resolvedAgentId,
		sessionKey,
		storePath: resolveSessionStorePathCore(cfg.session?.store, { agentId: resolvedAgentId })
	});
...
function displayContainers(containers, runtime) {
	displayItems(containers, {
		...
		renderItem: (container, rt) => {
			...
			rt.log(`    ${container.configLabelKind ?? "Image"}:   ${container.image} ${container.imageMatch ? "✓" : "⚠️  mismatch"}`);
