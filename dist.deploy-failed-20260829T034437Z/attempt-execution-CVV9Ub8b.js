...
import { i as emitAgentEvent, r as emitAgentAuditEvent } from "./agent-events-CcZImb5w.js";
import { f as loadSessionEntry } from "./session-accessor.sqlite-entry-CNdoUuFZ.js";
import "./message-channel-BZwx7FCw.js";
import { b as persistSessionTranscriptTurn, ht as getCliSessionBinding } from "./session-accessor-B-FKZX9M.js";
...
import { r as formatAcpErrorChain } from "./errors-MW5Rkd8s.js";
import "./errors-Dc9hBElG.js";
import "./manager.turn-timeout-D74Z444b.js";
...
import { G as timestampOptsFromConfig, W as injectTimestamp } from "./builtin-openclaw-BE5rrEpZ.js";
...
import { i as isTrustedSubagentCompletionHandoffForRun, r as isSubagentAnnounceCompletionHandoff, t as hasVerifiedRequesterCompletionHandoff } from "./requester-tool-policy-BwKWjHQX.js";
...
import { r as resolveConversationToolPolicies } from "./conversation-tool-policy-pipeline-BITK7kk9.js";
import { c as shouldClearFailedCliSessionBinding, i as resolveCliSessionClearReason } from "./cli-session-JwnBWNOs.js";
import "./selection-DM2xsMhx.js";
import { a as setChannelSourceTurnSameThreadRequired, i as setChannelSourceTurnId, n as readChannelSourceTurnId, r as readChannelSourceTurnSameThreadRequired } from "./source-turn-id-qBM1Md8V.js";
import { t as runEmbeddedAgent } from "./embedded-agent-_ah8V7hs.js";
import { t as resolveCliRuntimeToolsAllow } from "./tool-policy-COQqFoPs.js";
import { a as resizeExecApprovalContinuationPrompt } from "./bash-tools.exec-approval-output-D90XjSjB.js";
import { n as cliBackendAcceptsAuthProfileForwarding, r as resolveCliExecutionAuthProfileId } from "./cli-execution-auth-BeRuzQ77.js";
import "./run-context-DRGbu7Ov.js";
import { s as hasCliLiveSession } from "./cli-live-session-registry-CgQndG47.js";
import { l as buildClaudeCliFallbackContextPrelude, p as resolveFallbackRetryPrompt, u as claudeCliSessionTranscriptHasContent } from "./session-history-CAKshf3M.js";
...
import { t as appendGitCoauthorContext } from "./git-coauthor-attribution-CKvab3EN.js";
import { i as persistCliSessionForkSuccessorInStore, n as consumeCliSessionForkInStore, o as restoreCliSessionForkInStore, t as clearCliSessionInStore } from "./session-store-Bkmui-g4.js";
...
function runAgentAttempt(params) {
	...
	if (!isRawModelRun && isCliExecutionProvider) {
		...
		const cliPersistencePrompt = params.opts.gitCoauthorAttribution ? cliTranscriptPrompt ?? cliPrompt : cliTranscriptPrompt;
	...
	const embeddedModelPrompt = appendGitCoauthorContext(effectivePrompt, params.opts.gitCoauthorAttribution);
