...
import { r as normalizeAtHashSlug } from "./string-normalization-e_fvmxMf.js";
...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-DFFxee2-.js";
import "./conversation-runtime-BCniVCys.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-LKsNZKOu.js";
...
import { g as scopeKey, h as resolveScopeToolsPolicy, m as resolveScopeRequireMention } from "./channel-policy-BG3-cCKG.js";
...
import { c as resolveDiscordAccount, i as listDiscordStartupAccountIds, l as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds } from "./accounts-Ce_-CVy_.js";
import { t as getDiscordRuntime } from "./runtime-Dg4d9hPu.js";
import { t as parseDiscordTarget } from "./target-parsing-CEpBARoV.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-D9d5uIAj.js";
import { u as withAbortTimeout } from "./timeouts-DfTLdOJX.js";
...
import { t as shouldHandleDiscordApprovalRequest } from "./approval-shared-D82XWcta.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-DitZo-mk.js";
import { n as discordMessageActions, t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-DPJcMIIn.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupContract, t as createDiscordPluginBase } from "./shared-BBoDcpTr.js";
import { c as resolveDiscordCurrentConversationIdentity, i as resolveDiscordConversationRoute, l as resolveDiscordRuntimeBindingConversationId } from "./route-resolution-CHBtqhrB.js";
import { r as openDiscordCommandDeployHashStore } from "./command-deploy-store-DFkBTViB.js";
import { t as resolveDiscordConversationBindingRoute } from "./conversation-binding-route-CzNOoF02.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-anF7waSJ.js";
import { n as discordOutbound } from "./outbound-adapter-BVYbOovA.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-CcuBQssi.js")).discordApprovalNativeRuntime
		})
	});
}
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-DuM7z4OM.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-B6VcR5Ge.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-Dp7NEakj.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-BLzPleHN.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-Dt5M2D12.js"));
const loadDiscordProviderRuntime = createLazyRuntimeModule(() => import("./provider.runtime.js"));
const loadDiscordProbeRuntime = createLazyRuntimeModule(() => import("./probe.runtime-CnVfcDyi.js"));
...
const loadDiscordAuditModule = createLazyRuntimeModule(() => import("./audit-C6Aew6ra.js"));
const loadDiscordSendModule = createLazyRuntimeModule(() => import("./send-DwznEMlt.js"));
const loadDiscordDirectoryLiveModule = createLazyRuntimeModule(() => import("./directory-live-Ik8pDMdH.js"));
//#endregion
