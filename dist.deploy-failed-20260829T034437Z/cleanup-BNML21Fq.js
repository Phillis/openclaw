...
import { n as channelRouteDedupeKey, t as channelRouteCompactKey } from "./channel-route-BK4VTSuz.js";
...
import { n as combineChannelAdmissionEvidence, r as compareChannelAdmissionParticipants } from "./admission-evidence-C8iAKYLB.js";
import { r as runOutsidePreparedModelRuntimePluginGenerationScope } from "./prepared-model-runtime-generation-scope-o4umnoSw.js";
import { n as clearCommandLane } from "./command-queue-CBS1Vl32.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-DGXg8pTm.js";
import { a as createUserTurnTranscriptRecorder, n as buildPersistedUserTurnMediaInputsFromFields } from "./user-turn-transcript-CyFoZBC6.js";
import { C as buildCollectPrompt, D as hasCrossChannelItems, E as drainNextQueueItem, O as previewQueueSummaryPrompt, S as beginQueueDrain, T as drainCollectQueueStep, _ as retireFollowupRunCancellation, d as admitFollowupRunLifecycle, f as completeFollowupRunLifecycle, i as clearFollowupQueue, j as waitForQueueDebounce, k as removeQueuedItemsByRef, l as trimSummaryElisionsToCap, m as isFollowupRunDeferredError, p as isFollowupRunAborted, r as FOLLOWUP_QUEUES } from "./settings-Cpt08fNP.js";
import { t as resolveEmbeddedSessionLane } from "./lanes-CVttd5qX.js";
import { t as isRoutableChannel } from "./route-reply-B1UpL4ft.js";
...
function requiresIndividualCollectDrain(item) {
	return item.disableCollectBatching === true || item.run.skillWorkshopProposalRevision !== void 0 || hasRuntimeOnlyFollowupMetadata(item);
}
...
function scheduleFollowupDrain(key, runFollowup) {
	...
	runWithGatewayIndependentRootWorkContinuation(() => runOutsidePreparedModelRuntimePluginGenerationScope(drainQueuedFollowups)).catch((err) => {
		queue.draining = false;
