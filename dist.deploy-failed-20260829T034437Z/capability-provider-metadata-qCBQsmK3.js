...
import { i as isProviderAuthProfileConfigured, r as isProviderApiKeyConfigured } from "./provider-auth-DI4TAoBi.js";
import "./string-coerce-runtime-C8jKEm3h.js";
import "./secret-input-bJBlHnFk.js";
import { o as XAI_IMAGE_MODELS, r as XAI_DEFAULT_IMAGE_MODEL } from "./model-definitions-C0Hkobsg.js";
import { g as hasXaiRealtimeApiKeyInput, i as XAI_REALTIME_DEFAULT_MODEL, m as XAI_REALTIME_VOICES, v as normalizeXaiRealtimeProviderConfig } from "./realtime-voice-config-Q8aUq8-_.js";
...
function createXaiRealtimeVoiceProviderMetadata() {
	return {
		...
		isConfigured: ({ providerConfig, cfg, agentId }) => hasXaiRealtimeApiKeyInput(normalizeXaiRealtimeProviderConfig(providerConfig).apiKey, cfg, agentId)
	};
}
