...
import { _ as scopeLegacySessionKeyToAgent, c as classifySessionKeyShape, f as resolveAgentIdFromSessionKey, l as isUnscopedSessionKeySentinel } from "./session-key-Dbce_H9p.js";
import { n as resolveEffectiveAgentSkillFilter } from "./agent-filter-BQrGxhsA.js";
import { l as readConfigFileSnapshotForWrite, n as getRuntimeConfig } from "./io-DlN5njvP.js";
...
import { a as normalizeConfiguredProviderCatalogModelId, o as normalizeModelRef, s as normalizeProviderId } from "./model-ref-shared-D4yx0hwT.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-routing-mOc2UICM.js";
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, w as prepareModelRunCapabilities, y as resolveModelAliasFromPair } from "./model-selection-shared-I5TmV9jL.js";
...
import { g as withAgentRunLifecycleGeneration, i as emitAgentEvent, n as captureAgentRunLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-CcZImb5w.js";
...
import { d as sessionDeliveryOrigin, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-azPdmUls.js";
import { d as isDeliverableMessageChannel, h as resolveMessageChannel } from "./message-channel-BZwx7FCw.js";
...
import { c as isValidAgentHarnessSessionStoreEntry, l as resolveAgentHarnessSessionContextError, t as AGENT_HARNESS_MODEL_RUN_FORBIDDEN_MESSAGE } from "./agent-harness-session-key-Bf-Q9dw5.js";
import { i as hasNonzeroUsage } from "./usage-DNKCVmJi.js";
import { f as recordSessionHumanDirectMessage, n as classifySessionStateActor } from "./session-state-events-BkuyPMaw.js";
import { a as isSessionWorkStartInvalidatedError, s as resolveSessionWorkStartError } from "./lifecycle-DzPMUp4j.js";
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-C7dw_-HZ.js";
...
import { r as loadManifestModelCatalog } from "./model-catalog-BCGmKLlL.js";
import { n as isThinkingLevelSupported, t as formatThinkingLevels } from "./thinking-CNREPJ80.js";
import { i as resolveSessionRuntimeOverrideForProvider } from "./session-runtime-compat-BJ6CDpbR.js";
import { n as resolveAvailableAgentHarnessPolicy } from "./availability-Sa7g3udW.js";
import { a as resolveCandidateThinkingLevel, i as normalizeThinkingCatalogProviders, n as hasResolvedThinkingCatalogEntry, o as resolveEffectiveAgentRuntime, r as needsThinkHydration } from "./thinking-runtime-1slENmfx.js";
import { p as ensureAgentWorkspace } from "./workspace-CYdcs93J.js";
import { a as findConfiguredModelProvider, i as allowsPluginModelNormalization } from "./model-fallback-candidates-Gs96s0BQ.js";
import { n as withAgentPluginRegistry } from "./runtime-plugins-7tauRyL1.js";
...
import { _ as throwAgentRunRestartAbortReason, c as createAgentRunRestartAbortError, d as isAgentRunDirectAbortReason, f as isAgentRunRestartAbortReason, h as resolveAgentRunErrorLifecycleFields, m as resolveAgentRunAbortLifecycleFields } from "./run-termination-hzmbXtwI.js";
import { i as isSyntheticSourceReplyTurn } from "./source-reply-delivery-mode-HlYcrSdl.js";
...
import { t as resolveSessionStableReplyMode } from "./session-stable-reply-mode-C20NUUDt.js";
import { E as isHeartbeatLifecycleRunKind } from "./media-generation-task-status-DPk6MyN_.js";
import { o as isAgentMediatedCompletionSourceTool } from "./input-provenance-CCQsDhUy.js";
import { a as createUserTurnTranscriptRecorder } from "./user-turn-transcript-CyFoZBC6.js";
import { a as isModelSelectionLocked, i as applyModelOverrideToSessionEntry, o as repairProviderWrappedModelOverride, r as ModelSelectionLockedError, t as MODEL_SELECTION_LOCKED_MESSAGE } from "./model-overrides-BcLzAaaZ.js";
import { t as resolveFastModeState } from "./fast-mode-Dd78Dxbu.js";
import { t as AGENT_LANE_SUBAGENT } from "./lanes-CI0_P-yC.js";
import { n as removeInternalSessionEffectsSession, r as resolveInternalSessionEffectsTarget, t as prepareInternalSessionEffectsSession } from "./internal-session-effects-Y7EkP_Lp.js";
import { a as hasVisibleAgentPayload, r as hasExplicitlyVisibleAgentPayload } from "./message-visibility-B7uGWSom.js";
import { n as resolveSendPolicy } from "./send-policy-DmHwNAx7.js";
import { t as createTrajectoryRuntimeRecorder } from "./runtime-CArdsTg-.js";
import { _ as hasUnaccountedMessagingToolAggregateEvidence, c as hasCommittedOutboundDeliveryEvidence, i as collectMessagingToolDeliveredMediaUrls, r as collectDeliveredMediaUrls, v as hasVisibleCommittedMessagingToolDeliveryEvidence } from "./delivery-evidence-JxKjzZU6.js";
import { d as formatAgentInternalEventsForPrompt, u as formatAgentInternalEventsForPlainPrompt } from "./subagent-announce-delivery-C-_bJihR.js";
...
import { i as normalizePendingFinalRecoveryPayloads, n as buildRecoverablePendingFinalDeliveryText, r as normalizePendingFinalDeliveryPayloads } from "./pending-final-delivery-BQjvFtab.js";
import { i as resolveSession, n as clearRotatedSessionMetadata } from "./session-_LoaZdn1.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-BRB1TsMb.js";
import { f as getScopedChannelsCommandSecretTargets, n as getAgentRuntimeOptionalCommandSecretPaths, t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-DLC-aqND.js";
...
import { a as releaseMainSessionRecoveryOwner, i as refreshMainSessionRecoveryOwner, r as inspectMainSessionRecoveryRequired, t as claimMainSessionRecoveryOwner } from "./main-session-recovery-store-BMIYe3ml.js";
import { r as createChatRunState } from "./server-chat-state-BuGrMjm1.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-Gs3Etsvo.js";
import "./live-model-switch-CT0MjbtH.js";
...
import { t as clearSessionAuthProfileOverride } from "./session-override-D54oq15q.js";
import { r as mergeSessionSnapshotChanges } from "./session-snapshot-merge-B4KFr9oE.js";
import { n as applyVerboseOverride } from "./level-overrides-D3F_-tPH.js";
import { i as resolveInlineAgentImageAttachments } from "./agent-turn-attachments-h48XcF15.js";
import { n as prepareAgentCommandExecutionIdentity, r as sanitizePublicAgentCommandIngressOpts, t as executionIdentity } from "./agent-command-execution-identity-D_mHSoTL.js";
import { t as withLocalAgentCronJobsRemoved } from "./local-service-Ch191lIP.js";
import { t as loadGatewayConfigRevisionProjector } from "./config-revision-token-DdYYSn5D.js";
import { t as NodeRegistry } from "./node-registry-BPMkWv7j.js";
import { r as registerGatewayModelCatalogPrivateAccess } from "./server-model-catalog-auth-DCNJBYb7.js";
import { a as readPreparedGatewayModelCatalogOwnerSnapshot, i as readPreparedGatewayModelCatalog, n as loadGatewayModelCatalogSnapshot, r as loadPreparedGatewayModelCatalogSnapshot, t as loadGatewayModelCatalog } from "./server-model-catalog-Bkfphvb1.js";
import { n as resolveAgentExplicitRecipientSession, r as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlanWithSessionRoute } from "./agent-delivery-LBy9NuFv.js";
import { t as measureAgentStartup } from "./startup-timing-DjY9VStN.js";
import { n as acquireWorktreeRunLease, o as resolveWorktreeIdForPath } from "./run-lease-_29wHctI.js";
import { t as createLazyAcpElicitationHandler } from "./acp-elicitation-handler-lazy-D2yn9dpZ.js";
...
import { t as resolveAgentRunContext } from "./run-context-DRGbu7Ov.js";
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	const secretsRuntime = await measureAgentStartup("secrets-runtime-import", () => import("./runtime-Cbbi8NFj.js"), { config: loadedRaw });
...
const acpPolicyRuntimeLoader = createLazyImportLoader(() => import("./policy-CqP-6x34.js"));
const acpRuntimeErrorsRuntimeLoader = createLazyImportLoader(() => import("./errors-B5BgqZws.js"));
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-Cqx-7woS.js"));
const agentRunnerMemoryRuntimeLoader = createLazyImportLoader(() => import("./agent-runner-memory-gCbRNKiW.js"));
...
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-BPUM4VWE.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-DU1uSKxu.js"));
const skillsRuntimeLoader = createLazyImportLoader(async () => {
	const [remote, sessionSnapshot] = await Promise.all([import("./remote-BtWGGhYF.js"), import("./session-snapshot-ChLMUTIx.js")]);
	return {
...
async function prepareAgentCommandExecution(opts, runtime, runtimeContext) {
	...
	try {
		...
		if (!isRawModelRun && (message.includes("$") || message.trimStart().startsWith("/"))) {
			const { expandExplicitSkillReferences, hasSkillReferenceCandidate, listSkillCommandsForWorkspace, resolveEffectiveAgentSkillFilter } = await import("./chat-commands.runtime.js");
			if (message.trimStart().startsWith("/") || hasSkillReferenceCandidate(message)) {
				...
				const expansion = expandExplicitSkillReferences({
					text: message,
					skillCommands,
					allSkillCommands: skillFilter ? listSkillCommandsForWorkspace({
						...commandParams,
		...
		const body = !isRawModelRun && acpResolution?.kind === "ready" ? resolveAcpPromptBody(promptMessage, opts.internalEvents) : prependInternalEventContext(promptMessage, opts.internalEvents);
...
function buildRestartRecoveryTerminalDeliveryEvidence(result) {
	...
	const payloads = Array.isArray(rawPayloads) ? rawPayloads.slice(0, 64).map((payload) => {
		...
		const evidence = { visible: hasExplicitlyVisibleAgentPayload(payload) };
...
async function resolveEmbeddedModelSelection(params) {
	...
	const effectiveStoredOverride = hasLegacyAutoFallbackOverrideWithoutOrigin ? null : resolveStoredModelOverride({
		sessionEntry,
		sessionStore: params.sessionStore,
		sessionKey: params.sessionKey,
	...
	const storedProviderOverride = hasLegacyAutoFallbackOverrideWithoutOrigin ? void 0 : effectiveStoredOverride?.provider ?? sessionEntry?.providerOverride?.trim();
	const storedModelOverride = hasLegacyAutoFallbackOverrideWithoutOrigin ? void 0 : effectiveStoredOverride?.model ?? sessionEntry?.modelOverride?.trim();
...
async function finalizeEmbeddedAgentCommand(params) {
	...
	try {
		...
		const turnTranscriptPersisted = transcriptPersistenceRunner === "embedded" || persistedCliTurnTranscript;
		let followupRun;
		if (turnTranscriptPersisted && sessionEntry && sessionStore && sessionKey && !params.suppressVisibleSessionEffects) {
			...
			throwAgentRunRestartAbortReason(params.opts.abortSignal?.reason);
			assertAgentRunLifecycleGenerationCurrent(lifecycleGeneration);
			sessionEntry = (await runMemoryFlushIfNeeded({
				cfg,
				followupRun,
				promptForEstimate: "",
				sessionCtx: {},
		...
		const agentMeta = result.meta.agentMeta;
		let embeddedCompactionRun = followupRun && transcriptPersistenceRunner === "embedded" && agentMeta?.agentHarnessId === "openclaw" && sessionEntry?.sessionId === runOwnedSessionId && !fallbackExhausted && terminal.outcome.status === "ok" && !resultErrorPayload && !result.meta.yielded && !result.meta.aborted && (agentMeta.compactionCount ?? 0) === 0 && !isHeartbeatLifecycleRun && cfg.agents?.defaults?.compaction?.enabled !== false && !params.preserveUserFacingSessionModelState && !sessionReboundDuringRun && params.opts.modelRun !== true && params.opts.promptMode !== "none" ? followupRun : void 0;
		if (embeddedCompactionRun && params.attempt.maintenanceAuthProfile === void 0) {
			log$2.warn("Post-turn compaction skipped: completed embedded run did not report its auth selection.");
			embeddedCompactionRun = void 0;
		}
		if ((persistedCliTurnTranscript || embeddedCompactionRun) && !params.suppressVisibleSessionEffects && canSafelyRunPostTurnCompaction) {
			...
			try {
				...
				const compactedSessionEntry = embeddedCompactionRun ? await (await loadAgentRunnerMemoryRuntime()).runSessionCompactionIfNeeded({
					cfg,
				...
				publishSessionOwnership();
				const completedCompactions = (compactedSessionEntry?.compactionCount ?? 0) - compactionCountBefore;
				if (embeddedCompactionRun && compactedSessionEntry && agentMeta && completedCompactions > 0) result = {
					...result,
					meta: {
						...result.meta,
						agentMeta: {
				...
				if (embeddedCompactionRun) {
					...
					params.opts.abortSignal?.throwIfAborted();
					assertAgentRunLifecycleGenerationCurrent(lifecycleGeneration);
					if (!currentEntry || currentEntry.lifecycleRevision !== lifecycleRevisionBefore) throw error;
	...
	for (;;) try {
		...
		const fallbackResult = await runEmbeddedAgentEntry({
			...
			runCandidate: async (providerOverride, modelOverride, runOptions) => {
				...
				if (pluginsEnabled && candidateConfiguredThinkLevel !== "off" && needsThinkHydration(thinkingCatalog, providerOverride, modelOverride, candidateRuntime)) {
					const { loadProviderScopedThinkingCatalog } = await import("./agents/model-catalog.runtime.js");
					const runtimeCatalog = normalizeThinkingCatalogProviders(await loadProviderScopedThinkingCatalog({
						config: cfg,
						provider: providerOverride,
					...
					if (allowedRuntimeCatalog.length > 0) candidateThinkingCatalog = allowedRuntimeCatalog;
				}
		...
		if (err instanceof LiveSessionModelSwitchError) {
			...
			if (liveSwitchRetries > MAX_LIVE_SWITCH_RETRIES) {
				...
				log$1.error(`Live session model switch in subagent run ${runId}: ${retryLimitMessage}`);
				if (!attemptLifecycleState.lifecycleEnded) emitAgentEvent({
					runId,
					lifecycleGeneration,
					stream: "lifecycle",
	...
	try {
		...
		return await sessionWorkAdmission.run(async () => {
			...
			const embeddedSessionState = await measureAgentStartup("session-state", () => prepareEmbeddedSessionState({
				...
				runId,
				workspaceDir,
				executionSkillsDir: path.join(sessionEntry?.worktree?.canonicalWorkspaceDir ?? cwd ?? workspaceDir, "skills"),
				watchSkills,
				isNewSession,
				isSubagentLaneTurn,
				suppressVisibleSessionEffects,
