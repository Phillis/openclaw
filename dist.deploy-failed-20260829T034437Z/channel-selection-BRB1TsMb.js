...
import { r as listRuntimeVisibleChannelPlugins } from "./runtime-visible-channels-JSQRMn4T.js";
import { r as resolveOutboundChannelPlugin, t as normalizeDeliverableOutboundChannel } from "./channel-resolution-B1taGHmD.js";
import { n as resolveMissingOfficialExternalChannelPluginRepairHints, t as resolveMissingOfficialExternalChannelPluginRepairHint } from "./official-external-plugin-repair-hints-BjMtOy55.js";
...
async function resolveMessageChannelSelection(params) {
	...
	if (normalized) {
		...
		if (!availableExplicit) {
			...
			if (!isDeliverableMessageChannel(normalized)) throw new Error(formatUnknownChannelMessage({ channel: normalized }));
