import { S as resolvePinnedHostnameWithPolicy, a as SsrFBlockedError, g as isPrivateNetworkAllowedByPolicy, o as SsrFPolicy, t as LookupFn, v as matchesHostnameAllowlist } from "../ssrf-DNrB9j1Q.js";
import { s as openLocalFileSafely } from "../root-impl-4qOT7idA.js";
import { t as FsSafeError } from "../errors-BCyoc29e.js";
import { A as canonicalPathFromExistingAncestor, C as sanitizeUntrustedFileName, M as resolveAbsolutePathForRead, N as resolveAbsolutePathForWrite, S as pathExistsSync, _ as statRegularFileSync, b as resolveLocalPathFromRootsSync, d as appendRegularFile, g as statRegularFile, j as findExistingAncestor, m as readRegularFileSync, o as hasProxyEnvConfigured, p as readRegularFile, t as normalizeHostname, v as withTimeout, x as pathExists } from "../hostname-BTiltpc6.js";
import { n as FileStoreSync } from "../file-store-2MK7r1a6.js";
import { l as isPathInside, o as root, s as writeExternalFileWithinRoot } from "../fs-safe-HGib4B7E.js";
import { n as redactSensitiveText } from "../redact-Cgbgt51d.js";
...
import { i as shouldIncludeSupplementalContext, n as evaluateSupplementalContextVisibility, r as filterSupplementalContextItems, t as ContextVisibilityDecision } from "../context-visibility-Q8h443O4.js";
import { i as expandAllowFromWithAccessGroups } from "../access-groups-CmTZ3qg2.js";
...
declare function ensurePortAvailable(port: number, host?: string, signal?: AbortSignal): Promise<void>;
//#endregion
