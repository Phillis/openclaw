...
import { t as callGateway } from "../call-Dz7phXol.js";
...
declare function createSessionVisibilityRowChecker(params: SessionVisibilityCheckerParams): {
...
declare function createSessionVisibilityGuard(params: SessionVisibilityCheckerParams & {
  callGateway?: GatewayCaller;
}): Promise<{
  check: (targetSessionKey: string) => SessionAccessResult;
}>;
