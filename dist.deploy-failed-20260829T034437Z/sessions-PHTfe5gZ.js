...
import { i as toErrorObject, t as coerceErrorMessage } from "./error-coercion-CKFmnpjH.js";
import { c as isRecord, i as asOptionalObjectRecord } from "./record-coerce-DItp3I4t.js";
import { C as parseStrictNonNegativeInteger, F as resolveTimerTimeoutMs, j as resolveIntegerOption, v as parseDateFirstTimestampMs } from "./number-coercion-CLj0HTDM.js";
import { a as isPathInside } from "./path-D138yf8v.js";
import { i as readRegularFileSync, r as readRegularFile } from "./regular-file-Dwz6p59y.js";
...
import { t as getWorkerDeployHighlightJs } from "./worker-deploy-runtime-registry-ytJIJf-o.js";
import { o as isDefaultStateDir } from "./paths-BBSTUjD5.js";
...
import { o as installOpenClawInternalCorePackageNativeResolver } from "./plugin-module-loader-cache-DNYw5tMM.js";
import { n as buildPluginLoaderJitiOptions, t as buildPluginLoaderAliasMap } from "./sdk-alias-TKlN0lQ-.js";
import { r as decodeWindowsTextFileBuffer, t as createWindowsOutputDecoder } from "./windows-encoding-BFYUNnZu.js";
import { T as projectModelThinkingCompat } from "./model-selection-shared-I5TmV9jL.js";
import "./defaults-CdX9UGcX.js";
import { _ as parseGitUrl } from "./zod-schema-AsvAsngV.js";
import { r as resolveOAuthRefreshLockPath } from "./path-resolve-CCojuy8M.js";
import { t as acquireFileLockSyncWithRetry } from "./file-lock-sync-COKxkUVu.js";
import { s as withFileLock } from "./file-lock-DRVK2jTz.js";
import "./file-lock-CS5vu_jB.js";
import { a as createCommandTerminationController, c as spawnCommand, h as releaseChildProcessOutputAfterExit } from "./exec-D2kbpwdA.js";
import { n as truncateUtf8Suffix, t as truncateUtf8Prefix } from "./utf8-truncate-Dro7v_iB.js";
import { Q as createSessionEntryWithTranscript } from "./session-accessor-B-FKZX9M.js";
import "./session-accessor.sqlite-transcript-store-Bx_F0DmJ.js";
import { n as attachRuntimePromptMediaFacts } from "./media-facts-Bd6apMSF.js";
import { a as makeZeroUsageSnapshot } from "./usage-DNKCVmJi.js";
import { I as OAUTH_REFRESH_LOCK_OPTIONS, a as loadPersistedAuthProfileStore, d as loadPersistedAuthProfileState } from "./persisted-DGErf7Xt.js";
import { h as resolveModelPluginMetadataSnapshot } from "./provider-hook-runtime-C6OwLIWh.js";
import { a as inspectPersistedAuthProfileStoreRaw, h as runAuthProfileWriteTransaction, i as inspectPersistedAuthProfileStateRaw, m as resolveAuthProfileDatabasePath } from "./sqlite-fgcxOC8G.js";
import { n as AuthProfileStoreUnreadableError, r as assertAuthProfileMigrationReady, t as AuthProfileMigrationRequiredError } from "./legacy-source-diagnostic-DC_Q2Uc-.js";
import { f as loadAuthProfileStoreForSecretsRuntime, v as saveAuthProfileStore } from "./store-C0UG5FOx.js";
import { s as getRuntimeAuthProfileStoreSnapshotCore } from "./runtime-snapshots-ChaCVIEN.js";
import { n as isRetryableAssistantError, r as classifyRateLimitWindow } from "./retry-DET1SLJy.js";
import { l as llm_exports } from "./llm-BkUeN9nv.js";
import { i as loginProviderOAuthWithPlugin, s as resolveProviderOAuthCredentialWithPlugin } from "./provider-runtime.runtime.js";
import { o as convertImageToPng, s as createImageProcessor } from "./image-ops-CNJmjS8j.js";
import { B as COMPACTION_SUMMARY_SUFFIX, C as findTurnStartIndex, D as shouldCompact, E as prepareCompaction$1, F as parseCommandArgs, G as uuidv7, H as convertToLlm, I as substituteArgs, L as BRANCH_SUMMARY_PREFIX, N as InvalidSummaryOutputError, P as buildSessionContext, R as BRANCH_SUMMARY_SUFFIX, S as findCutPoint, T as getLastAssistantUsage, U as runAgentLoop, V as bashExecutionToText, _ as calculateContextTokens, a as DEFAULT_MAX_LINES, b as estimateContextTokens, c as truncateLine, d as generateBranchSummary$1, f as prepareBranchEntries, i as DEFAULT_MAX_BYTES, j as serializeConversation, l as truncateTail, n as openClawAgentCoreRuntime, o as formatSize, p as DEFAULT_COMPACTION_SETTINGS, s as truncateHead, t as Agent, u as collectEntriesForBranchSummaryFromBranches, v as capCompactionSummary, w as generateSummary$1, x as estimateTokens, y as compact$1, z as COMPACTION_SUMMARY_PREFIX } from "./agent-core-CK8RXNcu.js";
import { c as setInternalBeforeToolBatch, i as copyInternalToolExecutionPreparer } from "./internal-hooks-BK9FsMLA.js";
import { c as getStreamLlmRuntime, o as bindStreamLlmRuntime } from "./stream-CXbsApnu.js";
import { a as migrateSessionEntries, c as normalizeLoadedFileEntry, d as parseSessionEntries, n as getLatestCompactionEntry, t as buildSessionContext$1 } from "./session-manager-codec-BQhwecUx.js";
...
import { c as getReadmePath, i as getAgentDir, l as isBunBinary, n as CONFIG_DIR_NAME, o as getDocsPath, r as PACKAGE_MANIFEST_VERSION, s as getExamplesPath } from "./config-CZgqjEsz.js";
import { s as OAuthProviderConfiguredUnavailableError, t as OAuthProviderRegistry } from "./oauth-BKQY7qvz.js";
import { a as getBashShellEnv, i as getBashShellConfig, n as createStreamingBinaryOutputSanitizer, s as sanitizeBinaryOutput, t as buildShellCommandInvocation } from "./shell-utils-DAgUwgg-.js";
import "./messages-CkFtFplo.js";
import { t as parseModelCatalogJson } from "./model-catalog-json-CxUsDrkg.js";
import { i as isGeneratedPluginModelCatalog, o as loadPersistedPluginModelCatalogs, r as filterGeneratedPluginModelCatalogProviders } from "./plugin-model-catalog-DjW42hmz.js";
import "./ai-transport-runtime-host-BOc97x0_.js";
import { n as formatPathRelativeToCwdOrAbsolute, r as isLocalPath, t as canonicalizePath } from "./paths-Bf0MEhmU.js";
import { t as SessionManager } from "./session-manager-NHyzKWb5.js";
import { a as createSourceInfo, i as resolveSkillDisplayName, o as createSyntheticSourceInfo } from "./skill-contract-6Z2EHE_Q.js";
...
import { n as getReadPathVariants, r as resolveToCwd } from "./path-utils-B1jqPblH.js";
import { t as ensureTool } from "./tools-manager-C5OT7G72.js";
import { i as normalizeMediaReferenceSource, r as classifyMediaReferenceSource, s as resolveMediaReferenceLocalPath } from "./media-reference-Q4z-WfN-.js";
...
import { s as resolveThinkingDefaultForModel } from "./thinking-CNREPJ80.js";
import { createRequire } from "node:module";
import { fileURLToPath, pathToFileURL } from "node:url";
import * as fs$2 from "node:fs";
import fs, { chmodSync, constants, createWriteStream, existsSync, globSync, mkdirSync, readFileSync, readdirSync, realpathSync, statSync, writeFileSync } from "node:fs";
...
function takeRuntimeUserTurnTranscriptRecorder(runtimeMessage) {
	const recorder = Reflect.get(runtimeMessage, RUNTIME_USER_TURN_TRANSCRIPT_RECORDER);
...
var AuthStorage = class AuthStorage {
	...
	static forAgent(agentDir = getAgentDir()) {
		...
		const preparedStore = getRuntimeAuthProfileStoreSnapshotCore(agentDir) ?? loadAuthProfileStoreForSecretsRuntime(agentDir);
...
*/
const log$1 = createSubsystemLogger("agents/model-registry");
	...
	*/
	...
	loadModels() {
		...
		if (errors.length > 0) {
			...
			log$1.warn(`model catalog load issue: ${this.loadError}`);
		}
	...
	loadCustomModels(modelsJsonPath, options = { includePluginCatalogs: true }) {
		...
		try {
			const parsed = parseModelCatalogJson(options.contents ?? readFileSync(modelsJsonPath, "utf-8"));
...
const AUTO_RESOURCE_COLLECTORS = {
	...
	skills: (dir) => collectAutoSkillEntries(dir, "openclaw"),
...
function normalizeExactPattern(pattern) {
	return normalizeNativePathSeparators(pattern.startsWith("./") || pattern.startsWith(".\\") ? pattern.slice(2) : pattern);
}
	...
	*/
	...
	collectPackageResources(packageRoot, accumulator, filter, metadata) {
		...
		for (const resourceType of RESOURCE_TYPES) {
			...
			if (existsSync(join(packageRoot, resourceType))) for (const path of this.collectConventionResourceFiles(packageRoot, resourceType)) this.addResource(target, path, metadata, true);
		}
...
function loadHighlightJsRuntime() {
	...
	if (injected !== void 0) return setHighlightJsRuntime(injected);
	if (typeof WORKER_DEPLOY_BUILD === "boolean" && WORKER_DEPLOY_BUILD) throw new Error("worker highlight.js runtime was not registered before use");
		...
		if (options.expanded) component.addChild(new Text(`\n${styledOutput}`, 0, 0));
			...
			render: (width) => {
				...
				if (state.cachedSkipped && state.cachedSkipped > 0) return [
					"",
					truncateToWidth(interactiveAgentTheme.fg("muted", `... (${state.cachedSkipped} earlier lines,`) + ` ${keyHint("app.tools.expand", "to expand")})`, width, "..."),
					...state.cachedLines ?? []
				];
					...
					try {
						...
						if (customOps?.glob) {
							...
							const relativized = results.slice(0, observationLimit).map((p) => {
								if (p.startsWith(searchPath)) return normalizeNativePathSeparators(p.slice(searchPath.length + 1));
...
function createReadToolDetails(content, truncated) {
...
function createBoundedReadTextPage(params) {
	...
	const limitNotice = params.limit !== void 0 && remainingLines > 0 ? `\n\n[${remainingLines} more lines in file. Use offset=${params.endLine + 1} to continue.]` : "";
	const contentBytes = Buffer.byteLength(params.content, "utf8");
	if (params.endLine - params.startLine < 2e3 && contentBytes + Buffer.byteLength(limitNotice, "utf8") <= maxBytes) return {
		kind: "text",
		content: `${params.content}${limitNotice}`
	};
	...
	if (!truncation.truncated) return {
		kind: "text",
		content: `${truncation.content}${limitNotice}`
	};
	let continuation;
...
function createReadToolDefinition(cwd, options) {
	...
	return {
		...
		async execute(toolCallId, { path, offset, limit, cursor, optional }, signal, onUpdate, ctx) {
			if (offset !== void 0 && (!Number.isSafeInteger(offset) || offset < 1)) throw new Error("Offset must be an integer at least 1");
			if (cursor !== void 0 && (!Number.isSafeInteger(cursor) || cursor < 0)) throw new Error("Cursor must be an integer at least 0");
			return new Promise((resolve, reject) => {
				if (signal?.aborted) {
					reject(/* @__PURE__ */ new Error("Operation aborted"));
					return;
				...
				(async () => {
					try {
						...
						if (mimeType) {
							...
							if (totalFileLines === 0) outputText = buffer.length === 0 ? "File is empty (0 bytes)." : `File contains no readable text (${buffer.length} bytes).`;
							...
							else if (cursor !== void 0 && cursor >= allLines[startLine].length) {
								const nextLine = startLine + 1 < totalFileLines ? ` Use offset=${startLineDisplay + 1} to continue.` : "";
								...
								if (cursor !== void 0 && cursor > 0 && firstLine.codePointAt(cursor - 1) > 65535) throw new Error(`Cursor ${cursor} splits a UTF-16 surrogate pair; retry with cursor=${cursor - 1} or cursor=${cursor + 1}.`);
								const endLine = limit === void 0 ? totalFileLines : Math.min(startLine + normalizePositiveLimit(limit, DEFAULT_MAX_LINES), totalFileLines);
								const selectedLines = allLines.slice(startLine, endLine);
								if (cursor !== void 0) selectedLines[0] = firstLine.slice(cursor);
								...
								if (selectedLines.every((line) => line.length === 0)) {
									...
									if (userLimitedLines !== void 0 && endLine < totalFileLines) {
									...
									if (page.kind === "truncated") truncated = page;
								}
							}
							content = [{
								type: "text",
						...
						resolve({
							content,
							details: createReadToolDetails(content, truncated)
						});
					} catch (error) {
						signal?.removeEventListener("abort", onAbort);
	...
	*/
	...
	async emitMessageEnd(event) {
		...
		await this.dispatchHandlers("message_end", async (handler, ctx, extensionPath) => {
			...
			if (handlerResult?.message) if (handlerResult.message.role !== currentMessage.role) this.emitError({
				extensionPath,
				event: "message_end",
	...
	async handleAgentEventUnlocked(event) {
		...
		if (event.type === "message_end") {
			if (event.message.role === "custom") this.sessionManager.appendCustomMessageEntry(event.message.customType, event.message.content, event.message.display, event.message.details);
				...
				let entryId;
				try {
					entryId = this.sessionManager.appendMessage(event.message, { invalidateSerializedPrefixCache: messageChangedByExtension || toolResultChangedByExtension });
				} catch (error) {
				...
				if (event.message.role === "assistant") {
					...
					if (persisted?.type === "message" && persisted.message.role === "assistant") replaceAgentMessageInPlace(event.message, persisted.message);
					this.lastAssistantEntryId = entryId;
				} else if (event.message.role === "user") this.emit(event);
			}
			if (event.message.role === "assistant") {
...
function loadTemplateFromFile(filePath, sourceInfo) {
	try {
		const { frontmatter, body } = parsePromptFrontmatter(readFileSync(filePath, "utf-8"));
...
var AgentSessionPrompting = class extends AgentSessionBase {
	...
	createUserMessage(text, images) {
		...
		return imageFactIndexes ? Object.assign({}, message, {
			...message,
...
const agentSessionSetContextReplacementHook = Symbol.for("openclaw.agent-session.set-context-replacement-hook");
var AgentSessionCompaction = class extends AgentSessionInspection {
	[agentSessionSetContextReplacementHook](callback) {
	...
	*/
	async compact(customInstructions) {
		return await this.runWithSessionWriteSettlement(async () => await this.compactWithSessionWriteSettlement(customInstructions, "none"));
	}
	async [agentSessionAutomaticCompaction](customInstructions) {
		return await this.runWithSessionWriteSettlement(async () => await this.compactWithSessionWriteSettlement(customInstructions, "retry-invalid-once"));
	}
	async compactWithSessionWriteSettlement(customInstructions, summaryOutputPolicy = "none") {
		this.disconnectFromAgent();
		await this.abort();
	...
	*/
	...
	async runCompactionWork(options) {
		...
		if (!compactionResult) {
			const runCoreCompaction = () => compact$1(preparation, model, auth.apiKey, auth.headers, options.customInstructions, options.signal, this.thinkingLevel, this.agent.streamFn);
...
//#endregion
export { formatFullOutputFooter as $, createReadToolDefinition as A, stripStaleAssistantUsageBeforeLatestCompaction as At, createEditTool as B, createReadOnlyTools as C, attachRuntimeUserTurnTranscriptRecorder as Ct, createWriteToolDefinition as D, isAssistantMessageWithContent as Dt, createWriteTool as E, sanitizeCompactionReplayMessages as Et, createGrepToolDefinition as F, hasOnlyCrlfLineEndings as G, withFileMutationQueue as H, createFindTool as I, createBashTool as J, normalizeToLF as K, createFindToolDefinition as L, createLsTool as M, createLsToolDefinition as N, createBoundedReadTextPage as O, isThinkingBlock as Ot, createGrepTool as P, ReadToolContinuationSchema as Q, SESSION_TOOL_STDERR_TAIL_BYTES as R, createReadOnlyToolDefinitions as S, createEventBus as St, createToolDefinition as T, takeRuntimeUserTurnTranscriptRecorder as Tt, withFileMutationQueues as U, createEditToolDefinition as V, decodeUtf8File as W, createLocalBashOperations as X, createBashToolDefinition as Y, wrapToolDefinition as Z, allToolNames as _, AUTH_STORAGE_CREATE_DEPRECATION_CODE as _t, agentSessionAutomaticCompaction as a, resolveCliModel as at, createCodingToolDefinitions as b, FileAuthStorageBackend as bt, formatSkillsForPrompt as c, ModelRegistry as ct, subscribeSteeringMessagePersistenceFailure as d, generateSummary as dt, SettingsManager as et, retireQueuedUserMessage as f, prepareCompaction as ft, wrapRegisteredTools as g, writePrivateTempFile as gt, loadExtensionFromFactory as h, executeBashWithOperations as ht, AgentSession as i, parseModelPattern as it, formatReadContinuationNotice as j, createReadTool as k, stripStaleThinkingSignaturesForCompactionReplay as kt, loadSkills as l, getModelRegistryRuntime as lt, createExtensionRuntime as m, generateBranchSummary as mt, createAgentSessionForEmbeddedRunner as n, findExactModelReferenceMatch as nt, agentSessionSetContextReplacementHook as o, resolveModelScope as ot, ExtensionRunner as p, collectEntriesForBranchSummary as pt, restoreLineEndings as q, DefaultResourceLoader as r, findInitialModel as rt, preflightManualSessionCompaction as s, restoreModelFromSession as st, createAgentSession as t, DefaultPackageManager as tt, getSteeringMessageIdentity as u, compact as ut, createAllToolDefinitions as v, AuthStorage as vt, createTool as w, takeRuntimeUserTurnTranscriptContext as wt, createCodingTools as x, InMemoryAuthStorageBackend as xt, createAllTools as y, FILE_AUTH_STORAGE_BACKEND_DEPRECATION_CODE as yt, appendBoundedTextTail as z };
