...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-DgFXMduP.js";
...
import { t as describeImageFile } from "./runtime-BxCHq3HW.js";
...
import { a as applyBrowserTabToolBinding, i as describeBrowserTool, n as createBrowserToolSchema, o as parseBrowserTabToolBinding, r as resolveBrowserToolCapabilities, t as BrowserToolOutputSchema } from "./browser-tool.schema-BfHgZzW0.js";
import { B as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, I as withTimeout, z as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-CDKXkF5Z.js";
import { c as resolveBrowserActRequestTimeoutMs, l as resolveBrowserNavigationTimeoutMs } from "./act-policy-BdhroZww.js";
import { i as resolveExistingUploadPaths } from "./paths-BTm4vYfz.js";
...
import { F as parseBrowserNavigationUrl } from "./chrome-BeE6BX5Z.js";
import "./sdk-setup-tools-ThTvqOaE.js";
import { C as BrowserServiceError, S as normalizeBrowserTabsResult, _ as browserStatus, a as untrackSessionBrowserTab, d as browserImportProfile, f as browserOpenTab, g as browserStart, h as browserSnapshot, i as trackSessionBrowserTab, l as browserDoctor, o as browserCloseTab, p as browserProfiles, r as touchSessionBrowserTab, u as browserFocusTab, v as browserStop, w as fetchBrowserJson, x as browserTabs, y as browserSystemProfiles } from "./session-tab-registry-DUoHTsYq.js";
import { c as BROWSER_PROXY_OWNED_TAB_CLOSE_PATH, f as parseBrowserProxyFailure, i as prepareBrowserProxyUploadRequest, o as BROWSER_PROXY_ERROR_ENVELOPE, p as parseBrowserProxyRoute, r as isBrowserProxyUploadRequest } from "./browser-proxy-upload-kvsn4PDQ.js";
import { a as browserConsoleMessages, c as browserArmDialog, d as browserNavigate, f as browserScreenshotAction, i as persistBrowserProxyResultFiles, l as browserArmFileChooser, o as browserPdfSave, p as browserWaitForDownload, s as browserAct, u as browserDownload } from "./core-api-BIFic2E2.js";
import { i as DEFAULT_BROWSER_SCREENSHOT_MAX_BYTES, o as normalizeBrowserScreenshot, r as parseSystemProfileDomains } from "./routes-DEK9gh82.js";
import { t as createBrowserControlContext } from "./browser-control-state-DrucRF3Y.js";
import { a as resolveRequestedBrowserProfile, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-BjRhjQPf.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-B1aZyHZa.js"),
