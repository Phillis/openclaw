...
import { r as materializeGatewayAuthSecretRefs, t as canMaterializeGatewayAuthSecretRefsWithoutExec } from "./auth-config-utils-DVajsKBW.js";
...
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-DSkxLnSL.js";
...
const loadReadOnlyChannelPlugins = createLazyRuntimeModule(() => import("./read-only-_1jMmw4T.js"));
...
const loadPluginMetadataRegistryLoaderModule = createLazyRuntimeModule(() => import("./metadata-registry-loader-BZyjw2cI.js"));
const loadPluginAutoEnableModule = createLazyRuntimeModule(() => import("./plugin-auto-enable-B6KBJi0e.js"));
const loadChannelPluginIdsModule = createLazyRuntimeModule(() => import("./channel-plugin-ids-B8Pn-XAG.js"));
const loadPluginRuntimeModule = createLazyRuntimeModule(() => import("./runtime-Bmbsnk9e.js"));
const loadGatewayProbeDeps = createLazyRuntimeModule(() => Promise.all([
	import("./call-Dplee5Oc.js"),
	import("./probe-auth-CYikvUNY.js"),
	import("./probe-DqRn0bbr.js")
