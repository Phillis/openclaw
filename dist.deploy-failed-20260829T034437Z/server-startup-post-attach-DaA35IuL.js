...
const loadGatewayRestartSentinelModule = createLazyRuntimeModule(() => import("./server-restart-sentinel-Blu-YZ4P.js"));
...
const defaultGatewayPostAttachRuntimeDeps = {
	...
	initializeGatewayUpdateStatus: async () => (await import("./update-startup-Cyv_9M_l.js")).initializeGatewayUpdateStatus(),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-Cyv_9M_l.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	warmSystemCa: beginMacOSSystemCaWarmupOnce,
	loadSubagentRegistryActivation: async () => (await import("./subagent-registry-XilIqabO.js")).activateSubagentRegistry
};
