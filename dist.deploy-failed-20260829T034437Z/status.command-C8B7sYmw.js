...
import { f as readConnectPairingRequiredMessage, l as normalizePairingConnectRequestId, p as readPairingConnectErrorDetails } from "./connect-error-details-Dxf1zdDX.js";
import { u as readRestartSentinelReadOnly } from "./restart-sentinel-BabYlCrz.js";
import { r as withProgress } from "./progress-3-oJv0bD.js";
import { t as logGatewayConnectionDetails } from "./status.gateway-connection-ClVBG1w9.js";
import { a as resolveStatusRuntimeSnapshot, c as resolveStatusUsageSummary, f as buildStatusOverviewSurfaceFromScan, o as resolveStatusSecurityAudit, r as resolveStatusGatewayHealth, t as loadStatusProviderUsageModule } from "./status-runtime-shared-CRkpabcE.js";
import { _ as buildStatusSessionsRows, b as statusHealthColumns, c as formatUpdateRestartStatusValue, d as buildStatusFooterLines, f as buildStatusHealthRows, g as buildStatusSecurityAuditLines, h as buildStatusPluginCompatibilityLines, m as buildStatusPairingRecoveryLines, o as statusOverviewTableColumns, p as buildStatusModelSelectionLines, t as appendStatusReportSections, u as buildStatusCommandOverviewRows, v as buildStatusSystemEventsRows, y as buildStatusSystemEventsTrailer } from "./text-report-Bl6lKiZM.js";
import { n as statusChannelsTableColumns, t as buildStatusChannelsTableRows } from "./channels-table-DxFNivs3.js";
import { n as runStatusJsonCommand, t as assertStatusUsageAgentScope } from "./status-json-command-BaoT2UB1.js";
...
async function buildStatusCommandReportData(params) {
	...
	return {
		...
		taskRegistryMigrationHint: params.summary.tasks.warning ? params.theme.warn(params.summary.tasks.warning) : null,
...
async function buildStatusCommandReportLines(params) {
	...
	appendStatusReportSections({
		...
		sections: [
			...
			{
				kind: "raw",
				body: params.showTaskMaintenanceHint || params.taskRegistryMigrationHint || params.retainedLostTaskLine ? [
					"",
...
const statusScanModuleLoader = createLazyImportLoader(() => import("./status.scan-WP-eUur9.js"));
const statusScanFastJsonModuleLoader = createLazyImportLoader(() => import("./status.scan.fast-json-CWhqiVwf.js"));
const statusAllModuleLoader = createLazyImportLoader(() => import("./status-all-BZ99odMU.js"));
const statusCommandTextRuntimeLoader = createLazyImportLoader(() => import("./status.command.text-runtime-BhlZ3JGJ.js"));
const statusNodeModeModuleLoader = createLazyImportLoader(() => import("./status.node-mode-bQajOs-N.js"));
...
async function statusCommand(opts, runtime) {
	...
	if (opts.all && !opts.json) {
		await statusAllModuleLoader.load().then(({ statusAllCommand }) => statusAllCommand(runtime, { timeoutMs: opts.timeoutMs }));
		return;
	}
	if (opts.json) {
	...
	const { buildStatusUpdateSurface, formatCliCommand, formatHealthChannelLines, formatKTokens, formatPromptCacheCompact, formatPluginCompatibilityNotice, formatTimeAgo, formatTokensCompact, formatUpdateAvailableHint, getTerminalTableWidth, info, renderTable, resolveMemoryCacheSummary, resolveMemoryFtsState, resolveMemoryVectorState, shortenText, theme } = await statusCommandTextRuntimeLoader.load();
	...
	const updateRestartValue = formatUpdateRestartStatusValue((await readRestartSentinelReadOnly().catch(() => null))?.payload, {
		ok,
		warn,
		muted,
		formatTimeAgo
