...
import { n as getLoadedChannelPlugin } from "./registry-CL5HFEAI.js";
...
import { c as getActiveSecretsRuntimeSnapshotRevisionState, l as getActiveSecretsRuntimeSnapshotState, o as getActiveSecretsRuntimeEnvState } from "./runtime-state-LhRdbFR1.js";
import { t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-bKkV4nDJ.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-d0xKlyvI.js";
import { c as listDevicePairing, i as hasEffectivePairedDeviceRole } from "./device-pairing-Li5h-3GZ.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-fSalMZ5e.js";
import { f as formatExecApprovalExpiresIn } from "./exec-approval-reply-BxJ7uYTc.js";
import { a as buildTypedApprovalPendingReplyPayload, i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, o as buildTypedPluginApprovalPendingReplyPayload } from "./approval-renderers-DLUKW4F7.js";
...
import { t as buildGatewayReloadPlan } from "./config-reload-plan-fBV5Mc8b.js";
import { f as pruneTerminalOperatorApprovals, n as closeOrphanedOperatorApprovals } from "./operator-approval-store-BY5ymuaJ.js";
import { g as resolveApnsRelayConfigFromEnv, i as clearApnsRegistrationIfCurrent, l as loadApnsRegistrations } from "./push-apns-store-CEcYZxuC.js";
import { t as resolveApprovalSessionAudienceWithFallback } from "./approval-session-audience-CclUoPIZ.js";
import { t as SYSTEM_AGENT_APPROVAL_DECISIONS } from "./system-agent-approvals-BczGX_94.js";
import { a as sendApnsPluginApprovalAlert, c as resolveApnsAuthConfigFromEnv, i as sendApnsExecApprovalResolvedWake, o as sendApnsPluginApprovalResolvedWake, r as sendApnsExecApprovalAlert, s as shouldClearStoredApnsRegistration } from "./push-apns-DiZjiurI.js";
import { n as ExecApprovalManager } from "./exec-approval-manager-C7EGM_Qr.js";
import { t as QuestionManager } from "./question-manager-DAwr3A8G.js";
import { t as publishAppliedApprovalResolution } from "./approval-publication-DCCneYoL.js";
...
async function activateSnapshotIfCurrent(snapshot, expectedRevision, options) {
	const runtime = await import("./runtime-Cbbi8NFj.js");
...
async function restoreSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, onActivated) {
	if ((await import("./runtime-Cbbi8NFj.js")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot)) onActivated();
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = createLazyPromise(() => import("./exec-approval-D8zZiE6W.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: execApprovalIosPushDelivery
	})), { cacheRejections: true });
	const reloadSecrets = createGatewaySecretsReloader(params);
	const loadSecretsModule = createLazyPromise(() => import("./secrets-DwSRPDl7.js"), { cacheRejections: true });
	...
	const loadQuestionHandlers = createLazyPromise(async () => {
		const [{ createQuestionHandlers }, storeWriteService] = await Promise.all([import("./question-DM_akkjW.js"), loadSecretStoreWriteService()]);
	...
	const loadPluginApprovalHandlers = createLazyPromise(() => import("./plugin-approval-BUkd8w37.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: pluginApprovalIosPushDelivery
	})), { cacheRejections: true });
	const loadApprovalHandlers = createLazyPromise(() => import("./approval-pHcf1UTL.js").then(({ createApprovalHandlers }) => createApprovalHandlers({
		execApprovalManager,
