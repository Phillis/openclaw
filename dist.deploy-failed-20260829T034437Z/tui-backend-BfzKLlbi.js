...
import { i as loadSystemAgentOverview, r as formatSystemAgentStartupMessage } from "./overview-CQu7oloB.js";
import { t as buildOnboardingWelcome } from "./onboarding-welcome-CsjI3uNA.js";
import { t as executeSystemAgentOperation } from "./operations-D076P5ja.js";
...
import { o as resolveSystemAgentVerifiedInferenceState } from "./verified-inference-D699BYSI.js";
import { t as SystemAgentChatEngine } from "./chat-engine-BjiX3_fM.js";
...
async function runSetupHandoff(handoff, opts, runtime) {
	...
	await (opts.runChannelsAdd ?? (await import("./add-DvPORit-.js")).channelsAddCommand)(handoff.channel ? { channel: handoff.channel } : {}, runtime, {
		hasFlags: false,
...
async function runSystemAgentTui(opts, runtime) {
	...
	for (;;) {
		...
		const runTui = boundOpts.runTui ?? (await import("./tui-CPl3a8pI.js")).runTui;
		try {
			await runTui({
				local: true,
...
async function requireTuiVerifiedInference(opts) {
	...
	try {
		...
		if (verified) {
			...
			const [{ getPreparedModelCatalogSnapshot }, { resolveThinkingDefault }] = await Promise.all([import("./prepared-model-catalog-D82wKRHO.js"), import("./model-thinking-default-C217yTjE.js")]);
