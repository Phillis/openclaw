...
import { i as describeBrowserTool, n as createBrowserToolSchema, o as parseBrowserTabToolBinding, r as resolveBrowserToolCapabilities, t as BrowserToolOutputSchema } from "./browser-tool.schema-BfHgZzW0.js";
...
function registerBrowserPlugin(api) {
	...
	api.registerCli(async ({ program }) => {
		const { registerBrowserCli } = await import("./browser-cli-DizFKLCm.js");
	...
	api.registerHttpRoute({
		...
		handleUpgrade: async (req, socket, head) => {
			...
			const { handleGatewayExtensionUpgrade } = await import("./gateway-relay-route-BCg30tlj.js");
