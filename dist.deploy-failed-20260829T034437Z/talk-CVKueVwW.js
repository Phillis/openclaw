...
import { n as handleChatSendWithRuntimeTools, t as handleChatSend } from "./chat-send-handler-Cc2TmNWV.js";
...
const loadTalkAgentExecution = createLazyRuntimeModule(async () => {
	const [embeddedAgent, admission] = await Promise.all([import("./embedded-agent-ClAd_F7t.js"), import("./admitted-run-context-BWSMtoE-.js")]);
	return {
