...
import { C as hashConfigIncludeRaw, D as parseJsonWithJson5Fallback, T as resolveConfigIncludeWritePath, b as ConfigIncludeError, x as INCLUDE_KEY } from "./redact-CWP17HFN.js";
...
import { f as resolveConfigPath } from "./paths-BBSTUjD5.js";
import { r as formatErrorMessage } from "./errors-Ccx0R-_Z.js";
import { A as resolveManagedUnsetPathsForWrite, O as maintainConfigBackups, P as validateConfigObjectWithPlugins, S as createConfigIO, T as restoreEnvVarRefs, _ as writeConfigFile, j as warnIfJSON5CommentsWillBeStripped, k as applyUnsetPathsForWrite, l as readConfigFileSnapshotForWrite, rt as ConfigMutationConflictError, v as attachRuntimeConfigWriteApplication, w as resolveWriteEnvSnapshotForPath, x as getRuntimeConfigWriteApplication, y as copyRuntimeConfigWriteApplication } from "./io-DlN5njvP.js";
import { c as getPublishedConfigRuntimeEnvState, n as cloneEnvWithPlatformSemantics, s as createConfigRuntimeEnvBase, t as applyConfigEnvVars } from "./config-env-vars-C_yEEhJa.js";
import { h as resolveConfigSnapshotHash, u as rejectConfigNonFiniteNumbers, x as GATEWAY_CONFIG_SELECTION_ENV_KEYS, y as restoreEnvChangesIfUnchanged } from "./io.read-helpers-YVBmmwxJ.js";
import { a as getRuntimeConfigSnapshot, b as resolveConfigWriteFollowUp, c as getRuntimeConfigSourceSnapshot, f as notifyRuntimeConfigWriteListeners, l as hasManagedRuntimeConfigWriteOwner, m as preflightRuntimeSnapshotWrite, n as createRuntimeConfigWriteNotification, p as preflightManagedRuntimeConfigWrite, r as finalizeRuntimeSnapshotWrite, s as getRuntimeConfigSnapshotRefreshHandler, y as resolveConfigWriteAfterWrite } from "./runtime-snapshot-Cv5MaU8U.js";
...
async function transformConfigFileAttempt(params, attempt, ownership, prepared) {
	...
	let mergedWriteOptions = copyRuntimeConfigWriteApplication(params.writeOptions, {
		...writeOptions,
		...params.writeOptions
	});
	if (ownership) {
