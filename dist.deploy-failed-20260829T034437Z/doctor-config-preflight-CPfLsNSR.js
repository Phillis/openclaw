...
import { h as recoverConfigFromLastKnownGood, m as recoverConfigFromJsonRootSuffix, s as readConfigFileSnapshot, u as readConfigFileSnapshotWithPluginMetadata } from "./io-DlN5njvP.js";
...
import { t as addDoctorLegacyIssues } from "./legacy-config-issues-lmde6xrP.js";
import { r as planUpgradeConfigRepair, t as commitUpgradeConfigRepair } from "./automatic-upgrade-config-repair-DcWEHSUA.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-BqbMX9ZP.js";
import { t as migrateLegacyConfig } from "./legacy-config-migrate-D9RGhVd6.js";
import { n as createDoctorPluginMetadataSnapshotScope, t as completeDoctorPluginMetadataSnapshot } from "./plugin-metadata-snapshot-scope-Ck4_nI-n.js";
...
const loadInstalledPluginIndexStore = createLazyRuntimeModule(() => import("./installed-plugin-index-store-C9QO6DeN.js"));
...
async function planStartupPluginVerification(params) {
	const { planStartupPluginConvergence } = await measureDoctorConfigPreflightStep("plugin-plan-import", () => import("./startup-plugin-convergence-plan-C5Hn3AC3.js"), params.measure);
...
async function runStartupUpgradeConvergence(params) {
	...
	const { runPostCorePluginConvergence } = await measureDoctorConfigPreflightStep("plugin-convergence-import", () => import("./post-core-plugin-convergence-DCaCkWPn.js"), params.measure);
...
async function refreshStartupPluginQuarantine(params) {
	...
	const { runActivePluginPayloadSmokeCheck } = await measureDoctorConfigPreflightStep("plugin-payload-verification-import", () => import("./active-plugin-payload-validation-0qdJl9jN.js"), params.measure);
...
const loadDoctorStateMigrations = createLazyRuntimeModule(() => import("./doctor-state-migrations-DKl3Ssu4.js"));
const loadLegacyCronRepair = createLazyRuntimeModule(() => import("./legacy-repair-8zkntggV.js"));
...
async function runDoctorConfigPreflight(options = {}) {
	...
	let migrationCheckpoint = gatewayStartupCheckpointRequired || options.requireStateMigrationCheckpoint === true ? await measurePreflightStep("startup-checkpoint-import", () => import("./startup-migration-checkpoint-HLMxeCE7.js")) : void 0;
	let stateMigrations;
	...
	try {
		if (migrationCheckpoint && !skipPristineStartupStateMigrations) {
			const { planPristineStartupStateMigrations } = await measurePreflightStep("pristine-state-plan-import", () => import("./pristine-startup-state-DG6BFU-e.js"));
