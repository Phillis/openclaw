...
import { c as isEnabledFlag } from "./runtime-shared-BoNGt4zS.js";
import { c as hasConfiguredSecretInputValue, l as isBaseFieldActiveForChannelSurface, n as collectNestedChannelFieldAssignments, r as collectSimpleChannelFieldAssignments, s as getChannelSurface } from "./channel-secret-basic-runtime-iUG8mZr_.js";
import "./channel-secret-basic-runtime-D79B15GP.js";
import { t as collectNestedChannelTtsAssignments } from "./channel-secret-tts-runtime-C61z8wA_.js";
//#region extensions/discord/src/secret-config-contract.ts
function createVoiceProviderSecretTarget(params) {
	const path = `${params.scope === "account" ? "channels.discord.accounts.*" : "channels.discord"}.voice.${params.capability}.providers.*.apiKey`;
	return {
		id: path,
		targetType: path,
