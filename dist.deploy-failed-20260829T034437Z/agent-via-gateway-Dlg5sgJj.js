...
import { C as tryResolveLegacyCompatibilityAgentId, a as listAgentIds, t as AgentSelectionRequiredError, w as tryResolveSoleAgentId } from "./agent-scope-config-CUBiGmG3.js";
import { _ as scopeLegacySessionKeyToAgent, a as buildAgentMainSessionKey, c as classifySessionKeyShape, f as resolveAgentIdFromSessionKey, l as isUnscopedSessionKeySentinel } from "./session-key-Dbce_H9p.js";
import { b as waitForDiagnosticEventsDrained } from "./diagnostic-events-BGzDm6gu.js";
...
import { _ as readGatewayDispatchConfig, g as randomIdempotencyKey, m as isGatewayExplicitAuthRequiredError, o as callGateway, p as isGatewayCredentialsRequiredError, v as readGatewayDispatchConfigWithShellEnvFallback } from "./call-Bwn2P4nz.js";
import { n as normalizeMessageChannel } from "./message-channel-core-D5yZGaHY.js";
import "./message-channel-BZwx7FCw.js";
import { n as buildAgentRunTerminalOutcome, o as classifyAgentRunTerminalOutcome } from "./agent-run-terminal-outcome-DafVNgmX.js";
...
import { n as createEmbeddedStateSignalBridge } from "./embedded-state-lock-BhpAz71k.js";
...
async function startOneShotDiagnosticsExporters(params) {
	...
	const [{ loadOpenClawPlugins }, { startPluginServices }] = await Promise.all([import("./plugins/loader.js"), import("./services-CbYGN3lO.js")]);
...
const embeddedAgentCommandLoader = createLazyPromiseLoader(() => import("./agent-DKt3aJ5L.js").then((module) => module.agentCommand), { cacheRejections: true });
const localAuditModuleLoader = createLazyPromiseLoader(() => import("./agent-local-audit-BsnK3ZN6.js"), { cacheRejections: true });
const agentSessionModuleCache = createLazyPromiseLoader(() => agentSessionModuleLoader(), { cacheRejections: true });
const runtimeConfigModuleLoader = createLazyPromiseLoader(() => import("./io-DS-dUNoh.js"), { cacheRejections: true });
const embeddedStateLockModuleLoader = createLazyPromiseLoader(() => import("./embedded-state-lock-jf6c1djH.js"), { cacheRejections: true });
...
async function agentCliCommand(opts, runtime, deps) {
	if (opts.agent !== void 0 && !opts.agent.trim()) throw new Error("--agent must not be blank");
