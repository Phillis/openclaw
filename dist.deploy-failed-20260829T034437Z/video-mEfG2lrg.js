...
import { i as assertProviderBinaryResponseContent, n as assertOkOrThrowHttpError } from "./provider-http-errors-BXG5plR9.js";
import "./config-B2bSneS2.js";
import { d as normalizeMimeType, r as extensionForMime } from "./mime-Hm4eS2i0.js";
...
import { c as buildMediaUnderstandingRegistry } from "./defaults.constants-CG3XZviH.js";
import { o as fetchWithTimeoutGuarded, p as resolveProviderHttpRequestConfig } from "./shared-uZXUsfMB.js";
...
import { i as describeVideoFile } from "./runtime-BxCHq3HW.js";
import { a as parseOptionalTimeoutMs, d as resolveCapabilityProviderAgentId, f as resolveLocalCapabilityRuntimeConfig, l as requireProviderModelOverride, m as resolveSelectedProviderFromModelRef, n as formatEnvelopeForText, r as parseOptionalFiniteNumber, s as providerHasGenericConfig, t as emitJsonOrText, u as resolveCapabilityAgentOption } from "./shared-DatC0o0U.js";
import { n as writeOutputAsset } from "./media-output-psoMhi-7.js";
...
async function runVideoGenerate(params) {
	...
	const result = await generateVideo({
		cfg,
		agentDir: resolveAgentDir(cfg, resolveCapabilityProviderAgentId(cfg, params.agent, "infer video.generate")),
...
async function runVideoDescribe(params) {
	...
	const agentDir = resolveAgentDir(cfg, resolveCapabilityProviderAgentId(cfg, params.agent, "infer video describe"));
...
function registerVideoCapabilityCommands(capability) {
	...
	video.command("providers").description("List video generation and description providers").option("--agent <id>", "Agent whose provider state should be inspected").option("--json", "Output JSON", false).action(async (opts, command) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
