...
import { b as ReplyPayload, g as MediaFact } from "./types-BdTyUrVT.js";
import { Ct as ChatType, j as TtsAutoMode, n as OpenClawConfig } from "./types.openclaw-BssW6c46.js";
import { g as ApprovalScope } from "./exec-approvals-DOpNCvPj.js";
import { v as SourceReplyDeliveryMode } from "./types-Kt4lh6nX.js";
import { p as PluginHookChannelContext, t as FinalizedMsgContext } from "./templating-BCMFHjRY.js";
import { t as PluginConversationBinding } from "./conversation-binding.types-DGfK745L.js";
...
//#endregion
export { PluginHookSkillProposalKind as A, DiagnosticTraceContext as B, PluginHookSkillChangedEvent as C, PluginHookSkillProposalEvaluateEvent as D, PluginHookSkillProposalChangedEvent as E, ReplyDispatchKind as F, ReplyDispatchReceipt as I, ReplyDispatchRuntimeInfo as L, PluginHookBeforeToolCallResult as M, ReplyDispatchBeforeDeliver as N, PluginHookSkillProposalEvaluateResult as O, ReplyDispatchBeforeDeliverOptions as P, ReplyDispatcher as R, PluginHookSkillBundleSnapshot as S, PluginHookSkillEvaluationFinding as T, PluginJsonValue as V, PluginToolMatcher as _, PluginHookRegistration as a, PluginHookSkillArtifact as b, PluginHookReplyDispatchEvent as c, PluginHookToolContext as d, PluginHookToolInputKind as f, PluginHookToolResultPersistResult as g, PluginHookToolResultPersistEvent as h, PluginHookName as i, PluginApprovalResolution as j, PluginHookSkillProposalEvaluationOutcome as k, PluginHookReplyDispatchResult as l, PluginHookToolRequesterContext as m, PluginHookBeforeToolCallEvent as n, PluginHookRegistrationOptions as o, PluginHookToolKind as p, PluginHookHandlerMap as r, PluginHookReplyDispatchContext as s, PluginHookAgentTrigger as t, PluginHookReplyPayloadSendingContext as u, PluginNextTurnInjection as v, PluginHookSkillContext as w, PluginHookSkillBundleFile as x, PluginNextTurnInjectionEnqueueResult as y, ReplyFollowupAdmissionBarrierTimeoutPolicy as z };