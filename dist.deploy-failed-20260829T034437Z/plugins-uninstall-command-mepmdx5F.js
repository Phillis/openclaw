import { c as tracePluginLifecyclePhaseAsync, s as tracePluginLifecyclePhase } from "./discovery-KmR2BWJK.js";
...
async function runPluginUninstallCommandUnlocked(id, opts, runtime, skipPreview = false) {
	...
	const { loadInstalledPluginIndex } = await import("./installed-plugin-index-D7fnoX-p.js");
	const { resolveInstalledPluginPackageOwnership } = await import("./installed-plugin-package-ownership-DbHurjIv.js");
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-Q_FQEIvw.js");
	const { buildPluginSnapshotReport } = await import("./status-0EKylA5g.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, pluginUninstallTargetExists, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-AYqLo3YG.js");
	...
	const { commitPluginInstallRecordsWithConfig } = await import("./install-record-commit-B7gPOqSM.js");
	const { selectInstallMutationWriteOptions } = await import("./install-persistence-B5mwdLkS.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./registry-refresh-DlEIC1K6.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-CHfsZozS.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-BgjBlZUk.js");
	...
	if (!skipPreview) {
		...
		const { collectClawPluginUninstallWarnings } = await import("./uninstall-claw-references-DOnd_G_K.js");
