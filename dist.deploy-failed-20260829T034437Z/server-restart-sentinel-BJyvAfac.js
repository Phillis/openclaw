...
import { a as mergeDeliveryContext, d as sessionDeliveryOrigin, n as deliveryContextFromSession } from "./delivery-context.shared-azPdmUls.js";
...
import { a as hasRestartRecoveryTerminalRun, n as getRestartRecoveryTerminalDeliveryEvidence } from "./restart-recovery-state-6FYlAu33.js";
...
import { n as parseSessionThreadInfo } from "./sessions-CdrF1uzY.js";
...
import { L as resolveDurableCompletionDeliveryMode } from "./task-registry-DzN8snH1.js";
import { f as summarizeRestartSentinel, i as finalizeUpdateRestartSentinelRunningVersion, l as readRestartSentinel, o as formatRestartSentinelMessage, r as clearRestartSentinelIfRevision } from "./restart-sentinel-BabYlCrz.js";
import { a as isPendingControlPlaneUpdateRestartSentinel } from "./update-control-plane-sentinel-BujVAevG.js";
...
import { t as prepareOutboundPayloadBatch } from "./deliver-prepare-C7KxLRYR.js";
import { t as normalizeMediaReferenceForComparison } from "./media-reference-comparison-CBuherY6.js";
import { a as runOutboundDeliveryCommitHooks } from "./delivery-queue-reconciliation-nV6gi3k7.js";
...
import { r as hasExplicitlyVisibleAgentPayload } from "./message-visibility-B7uGWSom.js";
import { t as dispatchGatewayLifecycleMethod } from "./server-recovery-runtime-context-Cx7vLPdb.js";
import { a as getAgentCommandDeliveryFailure, c as hasCommittedOutboundDeliveryEvidence, n as collectAutomaticDeliveredMediaUrls, o as getGatewayAgentResult, r as collectDeliveredMediaUrls, t as collectAmbiguousAutomaticMediaUrls, u as hasCompleteAutomaticMediaDeliveryOutcomeEvidence } from "./delivery-evidence-JxKjzZU6.js";
import { f as formatGeneratedMediaDeliveryRetryForPrompt } from "./subagent-announce-delivery-C-_bJihR.js";
import { _ as markSessionDeliverySettlement, a as SessionDeliveryDeferredError, c as advanceSessionDeliveryAgentRun, f as enqueueSessionDelivery, g as markSessionDeliveryAttemptStarted, i as SessionDeliveryDeadLetteredError, o as SessionDeliveryRetryChargedError, p as failSessionDelivery, s as SessionDeliverySafeRetryError, u as deferSessionDelivery, v as mergeSessionDeliveryPreparedMediaBlocks } from "./session-delivery-queue-storage-CouGbFe6.js";
import { t as removeCronRunContinuationSessionIfIdle } from "./cron-run-continuation-cleanup-YBF4Qqez.js";
import { a as settleCorrelatedSubagentDelivery, l as drainPendingSessionDelivery, r as resolveCorrelatedSubagentDelivery, u as recoverPendingSessionDeliveries } from "./subagent-completion-delivery-D0JLJvTT.js";
import { l as createMessageSentEmitter, m as OUTBOUND_DELIVERY_LOG_SCOPE, r as withActiveDeliveryClaim, t as drainPendingDeliveriesCore } from "./delivery-queue-recovery-DTXQHmDs.js";
import { a as failDelivery, c as failPendingDelivery, f as loadPendingDelivery, k as acceptedPreparedOutboundEntries, l as findDeliveryIntentOwner, o as failDeliveryAfterPlatformSend, s as failDeliveryBeforePlatformSend, t as ackDelivery, x as withStableDeliveryPreparation, y as reserveDeliveryAttempt } from "./delivery-queue-storage-CIos4gei.js";
import { n as deliverOutboundPayloadsInternal, r as stageAndEnqueueOutboundDelivery } from "./deliver-BF3AzOMw.js";
import { n as sendDurableMessageBatchCore } from "./send-DOPOUUbs.js";
...
import { n as dispatchAssembledChannelTurn } from "./lifecycle-C2A-fp2O.js";
import "./get-reply-run-queue-Bmv2zHLu.js";
import { t as runStartupTasks } from "./startup-tasks-DT92rq86.js";
import { i as attachManagedOutgoingMediaToMessage, o as createManagedOutgoingMediaBlocks } from "./managed-image-attachments-5NOsW2iy.js";
import { n as prepareGatewayInjectedAssistantContent } from "./chat-transcript-inject-D82Y-BNF.js";
	...
	const persistInternalMedia = route.channel === "webchat" && (entry.expectedMediaUrls?.length ?? 0) > 0 ? async (mediaUrls) => {
		...
		for (const mediaUrl of mediaUrls) {
			...
			if (!blocks) {
				...
				if (!blocks.some((block) => block.type === "image" || block.type === "audio" || block.type === "video")) throw new Error("queued internal generated media could not be prepared");
				blocks = await mergeSessionDeliveryPreparedMediaBlocks(entry.id, mediaUrl, blocks, stateDir);
