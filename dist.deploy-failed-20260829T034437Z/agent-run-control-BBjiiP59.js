...
import { n as abortEmbeddedAgentRun, v as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-DpT-JSmi.js";
...
function parseRealtimeVoiceAgentControlToolArgs(args) {
	const record = asNonArrayRecord(parseRealtimeVoiceAgentControlToolArgsRecord(args));
