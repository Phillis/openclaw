...
import { D as resolveExpiresAtMsFromDurationMs, k as resolveExpiresAtMsFromDurationSeconds, o as asDateTimestampMs } from "./number-coercion-CLj0HTDM.js";
import { r as withTimeout } from "./timing-8WD1In27.js";
import { a as readSecretFileSync } from "./secret-file-DN5Ks0Ca.js";
...
async function resolveGoogleVertexAccessTokenViaGoogleAuth(adcConfig) {
	if (!cachedGoogleAuthClient) cachedGoogleAuthClient = { promise: import("./src-D7arRZbF.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)).then(({ GoogleAuth }) => {
