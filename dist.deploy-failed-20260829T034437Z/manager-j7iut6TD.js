...
import { a as resolveMainSessionKey, n as canonicalizeMainSessionAlias } from "./main-session-CPkeRwvL.js";
import { n as deliveryContextFromSession } from "./delivery-context.shared-azPdmUls.js";
import { f as recordSessionHumanDirectMessage, h as recordSubagentTerminalState } from "./session-state-events-BkuyPMaw.js";
import { a as toAcpRuntimeError, n as AcpRuntimeError, o as withAcpRuntimeErrorBoundary, r as formatAcpErrorChain, t as ACP_ERROR_CODES } from "./errors-MW5Rkd8s.js";
...
import { B as createNextAcpTaskBackingDetail } from "./task-registry-DzN8snH1.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-DD1wDy8n.js";
import { n as resolveRequiredCompletionTerminalResult } from "./task-completion-contract-BJW3TUQJ.js";
import { r as requireAcpRuntimeBackend, t as getAcpRuntimeBackend } from "./registry-DK6sb9wH.js";
import { n as readAcpSessionEntry, s as upsertAcpSessionMeta, t as listAcpSessionEntries } from "./session-meta-BgX5x3e6.js";
...
async function prepareFreshManagerRuntimeHandleRetry(params) {
	if (params.attempt > 0 || params.promptStarted || params.sawTurnOutput) return false;
...
async function ensureManagerRuntimeHandle(params) {
	...
	const previousIdentity = previousMeta.backend === backend.id ? persistedIdentity : void 0;
...
//#endregion
export { disposeAcpSessionManagerInstance as a, isAcpTurnActive as i, testing as n, tryPrepareFreshManagerRuntimeSession as o, AcpSessionManager as r, resolveAcpSessionResolutionError as s, getAcpSessionManager as t };
