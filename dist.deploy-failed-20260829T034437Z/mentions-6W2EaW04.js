...
import { r as resolveDiscordDirectoryUserId, t as normalizeDiscordHandleKey } from "./directory-cache-De14QDHu.js";
...
function findNextMarkdownCodeSegment(text, startIndex) {
	...
	return {
		...
		endIndex: findSameLineBacktickRun(text, segmentStart + runLength, runLength) ?? (runLength >= 3 ? findFenceEnd(text, segmentStart, runLength) : text.length)
	};
}
