...
import { b as compactWithSafetyTimeout, x as resolveCompactionTimeoutMs, y as compactContextEngineWithSafetyTimeout } from "./diagnostic-DrSh1mZf.js";
import { Tt as isBenignCompactionSkipResult, wt as isBenignCompactionSkipReason, y as createPreparedEmbeddedAgentSettingsManager } from "./builtin-openclaw-BE5rrEpZ.js";
import { i as buildGenericCliContextEngineHostSupport } from "./host-compat-xESS3bi6.js";
import { f as buildContextEngineRuntimeSettings, u as runContextEngineMaintenance } from "./agent-end-side-effects-C663wuG9.js";
import "./tool-result-truncation-BZr2-1Tz.js";
import { _ as shouldPreemptivelyCompactBeforePrompt } from "./settled-turn-finalization-result-cHPv9pc9.js";
import { i as resolveLiveToolResultMaxChars } from "./tool-result-limits-DISobJ_J.js";
import { f as buildEmbeddedCompactionRuntimeContext } from "./attempt-prompt-helpers-C-pTLJFR.js";
import { t as ensureContextEnginesInitialized } from "./init-NGXUF89o.js";
import { o as resolveEffectiveCompactionMode, r as applyAgentAutoCompactionGuard } from "./openclaw-runtime-BO0Slf1E.js";
...
import { a as recordCliCompactionInStore, r as normalizeSessionTokenCount, t as clearCliSessionInStore } from "./session-store-Bkmui-g4.js";
	...
	try {
		...
		try {
			...
			result = await withPluginRuntimeGenerationScope(preparedModelRuntime, async () => {
				...
				}, { preparedModelRuntime }), resolveCompactionTimeoutMs(params.cfg));
			});
		} finally {
