...
import { c as providerSummaryText, t as emitJsonOrText } from "./shared-DatC0o0U.js";
...
const capabilityCommandGroups = [
	["model", async () => (await import("./model-pPKi44dm.js")).registerModelCapabilityCommands],
	["image", async () => (await import("./image-6mk5QEjM.js")).registerImageCapabilityCommands],
	["audio", async () => (await import("./audio-CT_9nN2T.js")).registerAudioCapabilityCommands],
	["tts", async () => (await import("./tts-D2O2YZb2.js")).registerTtsCapabilityCommands],
	["video", async () => (await import("./video-mEfG2lrg.js")).registerVideoCapabilityCommands],
	["web", async () => (await import("./web-0j-jV4EB.js")).registerWebCapabilityCommands],
	["embedding", async () => (await import("./embedding-DkfMx2Nh.js")).registerEmbeddingCapabilityCommands]
];
