...
import { W as getAgentToolExecutionContext } from "./agent-core-CK8RXNcu.js";
...
import { C as TOOL_SEARCH_CONTROL_TOOL_NAMES, _ as isDirectVisibleCatalogTool, c as ToolSearchRuntime, d as addClientToolsToToolCatalog, f as applyToolCatalogCompaction, h as compactToolSearchCatalogEntry, i as applyToolSchemaDirectoryCatalog, l as formatToolSearchControlResult, n as applyToolSearchCatalog, s as resolveToolSearchConfig, y as restrictToolSearchCatalog } from "./tool-search-f7MtzgBB.js";
import { A as enforceSnapshotPayloadLimits, B as codeModeReplayIdForToolCall, C as CODE_MODE_WORKER_WATCHDOG_GRACE_MS, D as codeModeFailureCode, E as boundOutputToLimit, F as readRunId, I as resolveCodeModeConfig, L as resolveCodeModeHeadlessConfig, M as prepareSource, N as readCode, O as codeModeFailureMessage, P as readPositiveInteger, R as toToolSearchConfig, S as waitForPendingBridgeSettlement, T as MAX_HEADLESS_WALL_CLOCK_MS, V as createCodeModeCatalogProjection, _ as settledBridgeRequestsInCompletionOrder, a as codeModeWaitingReason, b as takeUndeliveredCodeModeRunOutput, d as pendingBridgeRequestsReplaySafe, f as pendingBridgeStatesForSettlement, g as resumingRunIds, h as reserveActiveRunSlot, i as codeModeMutationProvenance, j as isCodeModeEngagedForModel, k as createCodeModeApiFilesForRun, l as disposeCodeModeRun, m as removeExpiredRuns, n as cancelPendingBridgeStates, o as createCodeModeBridgeDispatchState, p as pendingToolCalls, r as cancelPendingBridgeStatesById, s as createPendingBridgeStates, t as activeRuns, u as isCodeModeBridgeRepairEligible, v as snapshotState, w as DEFAULT_HEADLESS_WALL_CLOCK_MS, x as telemetry, y as storeSnapshotState } from "./code-mode-state-CPc7qJF3.js";
...
async function settleCodeModeResult(params) {
	...
	if (finalized.status === "failed") {
		...
		if (mutationProvenance) finalized.mutationProvenance = mutationProvenance;
	}
