...
async function requireValidConfigFileSnapshot(runtime, opts) {
	...
	const snapshot = opts?.adoptPluginMetadata ? (await (await import("./command-config-snapshot-B4cENAio.js")).readCommandConfigSnapshot(readOptions)).snapshot : await readConfigFileSnapshot(Object.keys(readOptions).length > 0 ? readOptions : void 0);
