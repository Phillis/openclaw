...
const loadAgentsBindModule = createLazyRuntimeModule(() => import("./agents.commands.bind-DEyVqtw6.js"));
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-BIbrAKyq.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-CPR5kcVn.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-CgrWtDMU.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-B2FEeJik.js")).agentsListCommand;
}
async function loadAgentsActionRuntime() {
	const [{ defaultRuntime }, { runCommandWithRuntime }] = await Promise.all([import("./runtime-BO0y5md7.js"), import("./cli-utils-Cl4YK8W-.js")]);
	return {
		defaultRuntime,
