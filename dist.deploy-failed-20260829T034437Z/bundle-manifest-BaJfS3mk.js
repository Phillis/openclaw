...
import { s as readRootStructuredFileSync } from "./json-Dx6zyhjY.js";
import "./json-files-E5e5TtK3.js";
import { i as DEFAULT_PLUGIN_ENTRY_CANDIDATES, s as normalizeManifestActivation } from "./manifest-DFeZvDdx.js";
...
function buildAgentCapabilities(rootDir) {
	...
	if (pluginScanExistsSync(path.join(rootDir, "mcp.json"))) capabilities.push("mcpServers");
	return capabilities;
}
...
function detectBundleManifestFormat(rootDir, hasPackageExtensions = false) {
	if (hasPackageExtensions && pluginScanExistsSync(path.join(rootDir, "openclaw.plugin.json"))) return null;
	...
	if (pluginScanExistsSync(path.join(rootDir, "plugin.json"))) {
...
//#endregion
export { detectBundleManifestFormat as a, normalizeBundlePathList as c, CURSOR_BUNDLE_MANIFEST_RELATIVE_PATH as i, withPluginScanExistenceCache as l, CLAUDE_BUNDLE_MANIFEST_RELATIVE_PATH as n, loadBundleManifest as o, CODEX_BUNDLE_MANIFEST_RELATIVE_PATH as r, mergeBundlePathLists as s, AGENT_BUNDLE_MANIFEST_RELATIVE_PATH as t };
