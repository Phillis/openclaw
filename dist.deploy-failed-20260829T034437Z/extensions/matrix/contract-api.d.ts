...
declare const singleAccountKeysToMove: ("dangerouslyAllowNameMatching" | "streaming" | "mediaMaxMb" | "replyToMode" | "textChunkLimit" | "responsePrefix" | "groups" | "actions" | "allowBots" | "dm" | "homeserver" | "userId" | "accessToken" | "password" | "deviceName" | "avatarUrl" | "initialSyncLimit" | "deviceId" | "encryption" | "allowlistOnly" | "threadReplies" | "ackReaction" | "ackReactionScope" | "reactionNotifications" | "threadBindings" | "startupVerification" | "startupVerificationCooldownHours" | "autoJoin" | "autoJoinAllowlist" | "rooms")[];
