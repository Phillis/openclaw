...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount } from "../../account-selection-DysKVyrG.js";
import { i as normalizeMatrixStoredCredentials, n as isMatrixCredentialRevocation, r as matrixCredentialsStoreKey, t as MATRIX_CREDENTIALS_NAMESPACE } from "../../credentials-state-CTDQ3UhX.js";
import { r as resolveMatrixCredentialsDir } from "../../storage-paths-B8sBkehG.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "../../doctor-contract-BUipuL2s.js";
import { C as writeMatrixRecoveryKeyStateToStore, a as hasMatrixRecoveryKeyStateInStore, b as writeMatrixIdbSnapshotJsonToStore, d as openMatrixRecoveryKeyStoreOptions, f as readLegacyMatrixLegacyCryptoMigrationState, g as readMatrixIdbSnapshotJsonFromStore, i as hasMatrixLegacyCryptoMigrationStateInStore, l as openMatrixIdbSnapshotStoreOptions, m as readLegacyMatrixRecoveryKeyState, n as MATRIX_LEGACY_CRYPTO_MIGRATION_FILENAME, r as MATRIX_RECOVERY_KEY_FILENAME, t as MATRIX_IDB_SNAPSHOT_FILENAME, u as openMatrixLegacyCryptoMigrationStoreOptions, x as writeMatrixLegacyCryptoMigrationStateToStore } from "../../crypto-state-store-vlKMG4Bz.js";
import { a as openMatrixStorageMetaStoreOptions, i as normalizeMatrixStorageMetadata, n as hasMatrixStorageMetaStateInStore, u as writeMatrixStorageMetaStateToStore } from "../../storage-BK4Ps55K.js";
import { a as writeMatrixSyncCacheStateToStore, i as readLegacyMatrixSyncCacheState, n as hasMatrixSyncCacheStateInStore, r as openMatrixSyncCacheStoreOptions } from "../../file-sync-store-BFmVT3ip.js";
import { n as MATRIX_IDB_SNAPSHOT_LOCK_OPTIONS } from "../../idb-persistence-lock-DAJ49nZX.js";
import { r as readLegacyMatrixIdbSnapshotStateUnlocked, t as isValidMatrixIdbSnapshotJson } from "../../idb-persistence-D22IVJEQ.js";
...
async function importNewestInboundDedupeMarkers(params) {
	...
	const { buildMatrixInboundDedupeEventKey, MATRIX_INBOUND_DEDUPE_STATE_MAX_ENTRIES, MATRIX_INBOUND_DEDUPE_TTL_MS, resolveMatrixInboundDedupeStateNamespace } = await import("../../inbound-dedupe-BuBwS3kh.js");
