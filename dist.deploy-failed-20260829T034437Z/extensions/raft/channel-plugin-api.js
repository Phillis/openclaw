...
import { a as buildChannelConfigSchema, c as buildMultiAccountChannelSchema } from "../../config-schema-ikPYPY3Q.js";
import { c as readJsonBodyWithLimit } from "../../http-body-DthsuKdw.js";
...
import { a as waitUntilAbort, r as keepHttpServerTaskAlive } from "../../channel-lifecycle.core-CnejcREy.js";
...
import { d as createDefaultChannelRuntimeState, n as buildBaseChannelStatusSummary, u as createComputedAccountStatusAdapter } from "../../status-helpers-CopMHs_f.js";
import "../../channel-config-schema-DeVmAx-r.js";
import "../../channel-core-CyDgaJnW.js";
import { t as WEBHOOK_BODY_READ_DEFAULTS } from "../../webhook-request-guards-BYzmIdMp.js";
import { a as resolveRaftAccount, i as resolveDefaultRaftAccountId, n as RAFT_CHANNEL_ID, r as listRaftAccountIds, t as raftSetupPlugin } from "../../setup-CKthQ6uH.js";
...
var WakeRequestError = class extends Error {
	constructor(statusCode, message, closeAfterResponse = false) {
		super(message);
...
async function readWakePayload(request) {
	...
	if (!body.ok) {
		if (body.code === "PAYLOAD_TOO_LARGE") throw new WakeRequestError(413, "Wake payload exceeds the 16 KiB limit.", true);
		if (body.code === "REQUEST_BODY_TIMEOUT") throw new WakeRequestError(408, body.error, true);
		throw new WakeRequestError(400, body.code === "INVALID_JSON" ? "Wake payload must be valid JSON." : body.error);
	}
...
const raftPlugin = createChatChannelPlugin({ base: {
	...
	status: createComputedAccountStatusAdapter({
		...
		probeAccount: async () => {
			return await detectBinary("raft") ? {
				ok: true,
				cliFound: true,
				error: null
			} : {
