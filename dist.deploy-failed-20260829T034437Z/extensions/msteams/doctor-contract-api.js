...
import { i as defineChannelAliasMigration } from "../../runtime-doctor-migrations-BXpzR2WJ.js";
...
import { a as isMSTeamsSsoStoreData, n as MSTEAMS_SSO_TOKENS_LEGACY_FILENAME, o as makeMSTeamsSsoTokenStoreKey, r as MSTEAMS_SSO_TOKENS_NAMESPACE, s as normalizeMSTeamsSsoStoredToken, t as MSTEAMS_MAX_SSO_TOKENS } from "../../sso-token-store-9hXwksNo.js";
...
const stateMigrations = [
	...
	},
	{
		...
		async detectLegacyState(params) {
			const files = (await Promise.all((await listCandidateStorePaths(params)).map((storePath) => listLegacyLearningFiles(storePath)))).flat();
