...
import { a as shouldUseSyntheticOllamaAuth, i as resolveOllamaRuntimeBaseUrl, n as isLocalOllamaBaseUrl, r as resolveOllamaDiscoveryResult, t as OLLAMA_PROVIDER_ID } from "../../discovery-shared-BEv-0Rf0.js";
import { c as OLLAMA_MODELS_COMMAND, d as OLLAMA_NODE_INFERENCE_DEFAULT_PLATFORMS, f as ollamaNodeInferenceToolDefinition, l as OLLAMA_NODE_INFERENCE_CAPABILITY, s as OLLAMA_CHAT_COMMAND, u as OLLAMA_NODE_INFERENCE_COMMANDS } from "../../node-inference-contract-GX72jGf8.js";
import { c as orderPreferredOllamaModelIds, i as findAvailableOllamaModelName } from "../../setup-model-selection-BONHRuEi.js";
import { r as resolveConfiguredOllamaProviderConfig, t as createConfiguredOllamaCompatStreamWrapper } from "../../stream-compat-GxaWgL_K.js";
import "../../stream-contract-CaPxW4Jp.js";
import { t as createLazyOllamaWebSearchProvider } from "../../web-search-provider-registration-ZBYq1j7A.js";
//#region extensions/ollama/src/node-inference-registration.ts
const loadOllamaNodeInference = createLazyRuntimeModule(() => import("../../node-inference-D3tr-doO.js"));
...
const loadOllamaStreamRuntime = createLazyRuntimeModule(() => import("../../stream.runtime-2pa2anyq.js"));
...
const loadOllamaSetup = createLazyRuntimeModule(() => import("../../setup.runtime-BFPR1qGD.js"));
const loadOllamaMemoryEmbeddingProviderAdapter = createLazyRuntimeModule(async () => (await import("../../memory-embedding-adapter-BUFxOPXp.js")).ollamaMemoryEmbeddingProviderAdapter);
const loadOllamaMediaUnderstandingProvider = createLazyRuntimeModule(async () => (await import("../../media-understanding-provider-CQzVCQ4N.js")).ollamaMediaUnderstandingProvider);
