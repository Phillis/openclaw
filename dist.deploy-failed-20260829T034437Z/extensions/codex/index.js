...
import { _ as sessionBindingIdentity, l as isCodexAppServerNativeAuthProfile, r as assertCodexBindingMayBeReplaced, u as normalizeCodexAppServerBindingModelProvider } from "../../session-binding-DtQsKBCD.js";
import { a as closeCodexStartupClientBestEffort, c as isCodexAppServerUnsafeSubscriptionError, d as unsubscribeCodexThreadBestEffort, h as isCodexNotificationForTurn, o as interruptCodexTurnAndWaitBestEffort, p as getCodexAppServerTurnRouter, u as retireUnsafeCodexTurnClientBestEffort } from "../../attempt-client-cleanup-DjzZB4jq.js";
import { s as isAssistantCommentaryCompletionNotification } from "../../event-projector-usage-NUEcLr_5.js";
...
import { o as defaultCodexAppInventoryCache, r as buildCodexPluginAppCacheKey } from "../../plugin-app-cache-key-CgUcw_rM.js";
import { B as resolveCodexAppServerRequestModelSelection, Et as pluginReadParams, G as CODEX_MANAGED_THREAD_MAX_ENTRIES, K as CODEX_MANAGED_THREAD_NAMESPACE, L as buildCodexProjectDocThreadConfig, R as CODEX_NATIVE_PERSONALITY_NONE, St as ensureCodexPluginActivation, bt as mergeCodexThreadConfigs, q as createCodexManagedThreadStore, vt as buildDisabledAppsConfigPatch, wt as isOpenAiCuratedMarketplace } from "../../thread-lifecycle-Dr-EcKr3.js";
import "../../incognito-session-KJUXvrtm.js";
import { a as withCodexAppServerJsonClient, i as requestCodexAppServerJson, o as resolveCodexNativeExecutionBlock, s as resolveCodexNativeSandboxBlock } from "../../request-C8ZSIhyj.js";
import { t as resumeCodexAppServerThread } from "../../thread-resume-CRjuSVaE.js";
import { a as rollbackCodexAppServerBindingSubscription, c as withExclusiveCodexAppServerThread, i as retireCodexConversationThreadBinding, n as releaseCodexAppServerBindingSubscription, r as retainCodexAppServerBindingSubscription, s as withCodexConversationThreadActivity, t as isSameCodexAppServerThreadOwner } from "../../thread-ownership-C9i4XZ-f.js";
import { d as projectBoundedCodexVisibleSessionHistory } from "../../transcript-mirror-Bx5d2jyx.js";
import { t as buildCodexMediaUnderstandingProvider } from "../../media-understanding-provider-B4qhV-UO.js";
import { n as describeControlFailure, t as CODEX_CONTROL_METHODS } from "../../capabilities-B8q4DjQJ.js";
import { r as formatCodexDisplayText } from "../../command-formatters-DMGA1M6s.js";
import { a as resolveCodexAppServerForModelProvider, i as resolveCodexSessionPermissionCwd, n as applyCodexSessionPermissionPolicy, t as CODEX_SESSION_PERMISSION_EXEC_MODES } from "../../session-permission-policy-CqNCM8mh.js";
import { f as trackCodexConversationActiveTurn, g as canMutateCodexHost, h as CODEX_NATIVE_EXECUTION_AUTH_ERROR, t as discoverCodexMarketplacePlugins } from "../../plugin-marketplace-discovery-BT6ouaxn.js";
...
import { a as listCodexCliSessionsOnNode, n as createCodexCliSessionNodeHostCommands, o as resolveCodexCliSessionForBindingOnNode, r as createCodexCliSessionNodeInvokePolicies, s as resumeCodexCliSessionOnNode } from "../../node-cli-sessions-DrG_LN65.js";
import { t as codexControlRequest } from "../../command-rpc-B7TXItSb.js";
import { i as createCodexSessionCatalogNodeHostCommands, n as createCodexSessionCatalogNodeInvokePolicies, o as assertCodexArchiveDescendantsUnowned, r as createCodexSessionCatalogControl, t as codexSessionCatalogRuntime } from "../../session-catalog-DzgoOipZ.js";
...
function createLazyCodexAppServerBindingStore(state, managedThreadState) {
	let resolved;
	const store = () => resolved ??= import("../../session-binding-fVgO-sIj.js").then(({ createCodexAppServerBindingStore }) => createCodexAppServerBindingStore(state));
...
async function loadDefaultCodexSubcommandHandler() {
	const { handleCodexSubcommand } = await import("../../command-handlers-UcAIs_jh.js");
...
const loadCodexWebSearchRuntime = createLazyRuntimeModule(() => import("../../web-search-provider.runtime-CRm-mzq7.js"));
...
var codex_default = definePluginEntry({
	...
	register(api) {
		...
		api.on("after_compaction", async (event, ctx) => {
			...
			const { sessionBindingIdentity } = await import("../../session-binding-fVgO-sIj.js");
			const identity = sessionBindingIdentity({
				sessionId,
		...
		api.on("session_end", async (event, ctx) => {
			...
			const config = resolveCurrentConfig();
			const [{ sessionBindingIdentity }, { retireCodexAppServerSessionGeneration }] = await Promise.all([import("../../session-binding-fVgO-sIj.js"), import("../../session-retirement-CE0IVkc1.js")]);
