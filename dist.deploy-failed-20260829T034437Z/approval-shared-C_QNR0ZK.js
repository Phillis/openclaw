...
import { i as resolveApprovalInitiatingSurfaceState } from "./exec-approval-surface-fC5vQsVW.js";
...
import { g as resolveSessionSharingTarget, u as createSessionListEntryFilter } from "./session-sharing-C4OmHGYo.js";
...
async function handlePendingApprovalRequest(params) {
	...
	try {
		...
		const deliveredResult = suppressDelivery || approvalClientsOnly ? false : params.deliverRequest();
...
//#endregion
export { handleApprovalResolve as a, registerPendingApprovalRecord as c, canAccessApprovalSession as d, isApprovalRecordVisibleToClient as f, prepareApprovalChannelCustody as g, respondPendingApprovalLookupError as h, buildRequestedApprovalEvent as i, resolveApprovalDecisionParams as l, resolvePendingApprovalRecord as m, bindApprovalReviewerDeviceIds as n, handleApprovalWaitDecision as o, listVisiblePendingApprovalRequests as p, broadcastApprovalResolvedEvent as r, handlePendingApprovalRequest as s, bindApprovalRequesterMetadata as t, respondApprovalStorageUnavailable as u };
