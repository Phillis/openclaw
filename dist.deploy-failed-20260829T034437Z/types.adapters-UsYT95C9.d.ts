...
import { C as AgentBinding, J as GroupScope, K as DmScope, Q as ReplyToMode, Z as MarkdownTableMode, j as GroupToolPolicyConfig, n as OpenClawConfig, tt as ChatType } from "./types.openclaw-BjZ8Xxcu.js";
import { o as ImageContent } from "./types-Sg3pk96c.js";
import "./types-CippcftS.js";
import { $ as SessionRunStatus, a as SessionEntry, d as SessionCreatedActor, f as SessionCreatedVia, h as SourceReplyDeliveryMode, m as SessionRestartRecoveryState, pt as ChannelId, r as InternalSessionEntry, rt as ApprovalScopeSchema } from "./types-CW5W8UCv.js";
import { k as RuntimeEnv } from "./manifest-registry-BJhqwERh.js";
import { i as AgentToolResult, n as AgentMessage, r as AgentTool } from "./agent-core-Q1SbbORG.js";
import { i as MediaUnderstandingOutput, t as MediaUnderstandingDecision } from "./types-KW--AyYr.js";
import { n as ResolverContext, r as SecretDefaults, t as SecretTargetRegistryEntry } from "./target-registry-types-_6ys5EVq.js";
...
//#endregion
export { ChannelStatusIssue as $, PluginApprovalRequest as $t, chunkTextWithMode as A, AgentPlanStep as At, ChannelAccountSnapshot as B, MediaFact as Bt, ChannelOutboundAdapter as C, TaskSuggestionDeliveryMode as Ct, chunkMarkdownText as D, TranscriptEntryAnchor as Dt, chunkByNewline as E, UserTurnTranscriptRecorder as Et, OutboundPayloadDeliverySuppressionReason as F, CommandTurnContext as Ft, ChannelDirectoryEntry as G, InboundEventKind as Gt, ChannelAgentTool as H, PromptImageOrderEntry as Ht, SecurityAuditFinding as I, CommandTurnKind as It, ChannelMessageActionAdapter as J, LegacyInteractiveReply as Jt, ChannelGroupContext as K, ReplyMediaAttachment as Kt, buildAgentSessionKey as L, InputProvenance as Lt, resolveTextChunkLimit as M, ExecutionIdentityAdmissionToken as Mt, OutboundDeliveryResult as N, HistoryEntry as Nt, chunkMarkdownTextWithMode as O, TranscriptTurnAdmission as Ot, OutboundPayloadDeliveryOutcome as P, HistoryMediaEntry as Pt, ChannelOutboundTargetMode as Q, ChannelApprovalKind as Qt, resolveAgentRoute as R, PluginHookChannelContext as Rt, ChannelDeliveryCapabilities as S, PartialReplyPayload as St, OutboundDeliveryFormattingOptions as T, UserTurnInput as Tt, ChannelAgentToolFactory as U, MediaKind as Ut, ChannelAgentPromptAdapter as V, MediaFactLegacyProjection as Vt, ChannelCapabilities as W, mediaKindFromMime as Wt, ChannelMessagingAdapter as X, MessagePresentationAction as Xt, ChannelMessageActionContext as Y, MessagePresentation as Yt, ChannelMeta as Z, ReplyPayloadDelivery as Zt, ChannelResolverAdapter as _, OriginatingChannelType as _t, ChannelConfigAdapter as a, ExecSecurity as an, ChannelMessageAdapterShape as at, ChannelStatusAdapter as b, BlockReplyContext as bt, ChannelDirectoryAdapter as c, ChannelMessageActionName$1 as cn, RenderedMessageBatchPlanItem as ct, ChannelDoctorLegacyConfigRule as d, OutboundMediaReadFile as dt, PluginApprovalRequestPayload as en, ChannelStreamingAdapter as et, ChannelElevatedAdapter as f, FinalizedMsgContext as ft, ChannelLifecycleAdapter as g, MsgContext as gt, ChannelHeartbeatAdapter as h, MentionSource as ht, ChannelCommandAdapter as i, ExecMode as in, ConversationReadInvocationOrigin as it, resolveChunkMode as j, ExecutionIdentityAdmissionFacts as jt, chunkText as k, TranscriptTurnBoundary as kt, ChannelDoctorAdapter as l, OutboundSendDeps as lt, ChannelGroupAdapter as m, InboundSourceModality as mt, ChannelApprovalCapability as n, ExecApprovalRequestPayload as nn, ChannelThreadingToolContext as nt, ChannelConfiguredBindingProvider as o, ExecTarget as on, MessageReceipt as ot, ChannelGatewayAdapter as p, FinalizedRuntimeMsgContext as pt, ChannelMentionAdapter as q, ReplyPayload as qt, ChannelAuthAdapter as r, ExecAsk as rn, ChannelLegacyStateMigrationPlan as rt, ChannelConversationBindingSupport as s, ApprovalScope as sn, OutboundReplyFacts as st, ChannelAllowlistAdapter as t, ExecApprovalDecision as tn, ChannelThreadingAdapter as tt, ChannelDoctorConfigMutation as u, OutboundMediaAccess as ut, ChannelSecretsAdapter as v, SessionTranscriptContext as vt, OutboundIdentity as w, TurnAdoptionLifecycle as wt, ChannelPairingAdapter as x, GetReplyOptions as xt, ChannelSecurityAdapter as y, SupplementalContextFacts as yt, BaseProbeResult as z, LegacyMediaContextKey as zt };