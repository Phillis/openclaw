...
import { L as collectUnsupportedSecretRefPolicyIssues, N as validateConfigObjectRawWithPlugins, it as AUTO_MANAGED_CONFIG_META_PATHS, l as readConfigFileSnapshotForWrite, rt as ConfigMutationConflictError, s as readConfigFileSnapshot, u as readConfigFileSnapshotWithPluginMetadata } from "./io-DlN5njvP.js";
...
import { u as rejectConfigNonFiniteNumbers } from "./io.read-helpers-YVBmmwxJ.js";
...
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-query-DbXzcm95.js";
...
import { a as isPluginIntegrationSecretProviderConfig, n as resolveSecretRefValue, s as resolveSecretProviderIntegrationConfig } from "./resolve-D01Qinir.js";
...
import { a as isConfigSchemaPath, c as setAtPath, i as getAtPath, l as unsetAtPath, n as formatConfigSetPath, o as mergeAtPath, r as formatConfigUnsetMissingPathMessage, s as parseConfigSetValue, t as assertNonDestructiveReplacement, u as validatePathSegments } from "./config-cli-path-5PvjHNq2.js";
import { r as readBestEffortRuntimeConfigSchema, t as buildRuntimeConfigSchemaFromRegistry } from "./runtime-schema-CQE83rKG.js";
...
async function createRuntimeModelRefResolver() {
	const [agentScope, modelSelection] = await Promise.all([import("./agent-scope-WWPxWnDc.js"), import("./model-selection-JZ1qp18M.js")]);
	const preparedByAgent = /* @__PURE__ */ new Map();
	let modelModules;
	const loadModelModules = () => modelModules ??= Promise.all([import("./model-CyYzjwpn.js"), import("./prepared-model-catalog-D82wKRHO.js")]);
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", collectOption, []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-A4h5Bcll.js");
