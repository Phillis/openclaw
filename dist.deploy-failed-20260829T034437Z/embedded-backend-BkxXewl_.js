...
import { c as replaceOversizedChatHistoryMessages, i as readChatHistoryPage, r as enrichChatHistoryCompactionMarkers, s as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES } from "./chat-DG0k-Fe8.js";
import { n as createGatewaySession } from "./session-create-service-BRRWh2Dw.js";
...
var EmbeddedTuiBackend = class {
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-DUpOwDSu.js");
