...
import { p as resolvePluginNpmProjectsDir, s as resolveDefaultPluginNpmDir } from "./install-paths-DllFtsSG.js";
import { c as copyPluginInstallRecordMap, h as setPluginInstallRecordMapEntry, l as createPluginInstallRecordMap, u as getPluginInstallRecordMapEntry } from "./official-external-install-records-HG9WW4vi.js";
...
import { a as resolveRetainedManagedNpmInstallMarkerPath, i as markRetainedManagedNpmInstall, n as clearRetainedManagedNpmInstallMarker, o as resolveRetainedManagedNpmInstallPackageInfo } from "./managed-npm-retention-BqtSDJEu.js";
...
import { y as resolveConfigWriteAfterWrite } from "./runtime-snapshot-Cv5MaU8U.js";
import { a as transformConfigFileWithRetry, r as replaceConfigFile } from "./mutate-C_fsUarr.js";
import "./config-B2bSneS2.js";
import { c as writePersistedInstalledPluginIndexInstallRecordsWithLease, o as withoutPluginInstallRecords, t as PLUGIN_INSTALLS_CONFIG_PATH } from "./installed-plugin-index-records-CyommlnD.js";
...
import { a as planPluginUninstall } from "./uninstall-D_sbsEHT.js";
...
async function assertPluginConfigActivationConsent(params) {
	...
	const { resolvePluginMetadataSnapshot } = await import("./plugin-metadata-snapshot-BCs11JRI.js");
	const { resolvePluginCapabilityConsent } = await import("./capability-consent-6MW-Qgob.js");
	const { resolvePluginControlPlaneWorkspace } = await import("./control-plane-workspace-CJDZW6Cx.js");
