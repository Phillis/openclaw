...
import { i as isSyntheticSourceReplyTurn, r as isInternalSourceReplyChannel, t as isDirectedSourceReplyTurn } from "./source-reply-delivery-mode-HlYcrSdl.js";
...
import { dt as appendChannelPromptContext, mt as buildInboundMediaNoteProjection, s as isReasoningTagProvider } from "./builtin-openclaw-BE5rrEpZ.js";
...
import { i as resolveTurnModelOverride, t as resolveSessionStableReplyMode } from "./session-stable-reply-mode-C20NUUDt.js";
import { n as resolveRoutedDeliveryThreadId, t as isSlackDirectRoutedThreadTurn } from "./routed-delivery-thread-CqIyovBc.js";
import { D as resolveBootstrapMode } from "./media-generation-task-status-DPk6MyN_.js";
...
import { i as resolveActiveExplicitSteerSessionKey, n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CeBsBQBr.js";
...
import { a as resolveInboundUserContextPromptJoiner, n as buildInboundUserContextPrefix, r as formatActiveGoalContext, t as buildInboundMetaSystemPrompt } from "./inbound-meta-Cwme9Zg0.js";
import { n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContextAsync } from "./tools-effective-inventory-DhUL_lXN.js";
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-CLTvee01.js"));
const abortCutoffRuntimeLoader = createLazyImportLoader(() => import("./abort-cutoff.runtime.js"));
const commandsRuntimeLoader$1 = createLazyImportLoader(() => import("./commands.runtime-CZfcfiu1.js"));
...
async function handleInlineActions(params) {
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const dependencies = params.skillToolDispatchDependencies ?? await import("./openclaw-tools-8ahEx2Et.js");
...
const commandsRuntimeLoader = createLazyImportLoader(() => import("./commands.runtime-CZfcfiu1.js"));
const skillCommandsRuntimeLoader = createLazyImportLoader(() => import("./chat-commands.runtime.js"));
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-BfZprTvk.js"));
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent.runtime-g4eomZ6H.js"));
