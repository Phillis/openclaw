...
import { f as readPersistedMediaFacts, l as isVideoMediaFact, m as readRuntimePromptMediaFacts, n as attachRuntimePromptMediaFacts, p as readRuntimePromptImageOrder, s as isImageMediaFact, u as normalizeMediaFacts } from "./media-facts-Bd6apMSF.js";
...
import { s as resolveMediaReferenceLocalPath } from "./media-reference-Q4z-WfN-.js";
...
async function materializePromptMediaMessages(messages, options) {
	...
	for (const [index, message] of messages.entries()) {
		...
		if (Object.keys(nextMeta).length > 0) Reflect.set(hydratedMessage, "__openclaw", nextMeta);
		else Reflect.deleteProperty(hydratedMessage, "__openclaw");
...
//#endregion
export { materializeProviderContext as a, hydratePromptMediaMessages as i, detectAndLoadPromptImages as n, readPersistedMediaImageLayout as o, detectImageReferences as r, hasHydratableMediaImages as s, buildPromptImageFailureNotice as t };
