...
const toolCallCaptures = resolveGlobalMap(Symbol.for("openclaw.mcpLoopbackToolCallCaptures"), (captures) => {
	for (const key of captures.keys()) deleteMcpLoopbackToolCallCapture(key);
});
...
function resolveMcpLoopbackYieldContext(captureHandle) {
	...
	return {
		...
		onYield: async (message, acknowledgment) => {
