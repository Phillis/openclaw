...
import { a as listAgentIds, w as tryResolveSoleAgentId } from "./agent-scope-config-CUBiGmG3.js";
...
import { j as isSameOpenClawAgentDatabasePath } from "./openclaw-agent-db-maintenance-DDqVWNe-.js";
import { t as withOpenClawAgentDatabaseReadOnly } from "./openclaw-agent-db-readonly-CRlF3oxo.js";
import { b as writeSessionEntry, l as readExactSessionEntryRow, mt as withSqliteSessionDeletions, pt as runSqliteSessionDeletionTransaction, r as deleteLegacySessionEntryRows } from "./session-accessor.sqlite-entry-store-DmHR081P.js";
import { r as resolveSqliteTargetFromSessionStorePath } from "./session-sqlite-target-CVc2mOCy.js";
import { i as getSessionKysely, p as runExclusiveSqliteSessionWrite } from "./session-accessor.sqlite-scope-DPR8rGGl.js";
import { n as replaceSessionOwnerInTransaction, o as readExactSessionEntryRowForCanonicalRepair } from "./session-accessor.sqlite-owner-BOhIqO5V.js";
import { a as resolveAllAgentSessionStoreCandidateTargetsSync, i as resolveAgentSessionStoreTargetsSync } from "./targets-Bo3OPXck.js";
import { n as deleteSessionEntryLifecycle } from "./session-accessor.sqlite-lifecycle-DeUgE0mJ.js";
import { t as importSqliteSessionRows } from "./session-accessor.sqlite-import-M7cIVfyP.js";
...
function mutateLegacySessionClaims(params, commit) {
	...
	return withSqliteSessionDeletions(scope, params.claims.map(({ key: sessionKey, entry }) => ({
		sessionKey,
		entry
	})), async () => runExclusiveSqliteSessionWrite(scope, async () => runSqliteSessionDeletionTransaction(commit, scope, { operationLabel: params.operationLabel })));
}
