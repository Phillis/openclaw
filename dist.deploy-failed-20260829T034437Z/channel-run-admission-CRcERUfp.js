import { d as recordChannelAdmissionDecision, o as consumeChannelAdmissionEvidence } from "./admission-evidence-C8iAKYLB.js";
...
function consumeChannelRunAdmission(evidence) {
	...
	return Object.freeze({
		...
		onAdmitted: (context) => {
			...
			if (token && admission.decisionCoverage && admission.identifierAuthentication) recordChannelAdmissionDecision({
