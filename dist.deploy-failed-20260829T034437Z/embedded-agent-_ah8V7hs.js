...
import { c as resolveContextConfigProviderForRuntime, d as resolveSelectedOpenAIRuntimeProvider, i as isOpenAIProvider, n as OPENAI_PROVIDER_ID, y as normalizeOptionalAgentRuntimeId } from "./openai-routing-mOc2UICM.js";
import { E as resolvePreparedModelThinkingCompat, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-I5TmV9jL.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CdX9UGcX.js";
import { o as resolveProviderModelRoutes, r as modelMatchesProviderModelRoute } from "./provider-model-route-D-FYx-DP.js";
...
import { s as providerModelRouteAcceptsAuthMode } from "./openai-model-routes-Bxpy3ufg.js";
...
import { It as listSessionEntriesCore, at as appendTranscriptMessage, nt as updateSessionEntry, w as resolveSessionTranscriptRuntimeTarget } from "./session-accessor-B-FKZX9M.js";
import { n as resolveProviderEndpoint } from "./provider-attribution-YU3tJts9.js";
import { o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-DNKCVmJi.js";
import "./sessions-CdrF1uzY.js";
import { r as resolveSubscriptionAuthModeForProfiles } from "./profile-list-BRrg2jEV.js";
import { o as isProfileInCooldown } from "./usage-state-C0QBjJnZ.js";
import { a as getModelProviderRequestRouteFacts, t as applyPreparedRuntimeAuthToModel } from "./provider-request-config-BAUXM8KH.js";
import { a as unwrapSecretSentinelsForProviderEgress, t as protectPreparedProviderRuntimeAuth } from "./provider-secret-egress-BXpRqyF7.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-CWpWIBkz.js";
import { c as resolveContextEngine, l as resolveContextEngineOwnerPluginId } from "./registry-BL4inl-J.js";
...
import { f as resolveProviderRuntimePluginHandle, o as resolveProviderAuthProfileId, t as attachModelProviderRuntimePluginHandle } from "./provider-hook-runtime-C6OwLIWh.js";
import { _ as prepareProviderRuntimeAuth } from "./provider-runtime-XSAeyFFJ.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, r as ensureAuthProfileStore } from "./store-C0UG5FOx.js";
import { S as revokeRuntimeAuthMaterializations, b as recordRuntimeAuthMaterialization } from "./runtime-snapshots-ChaCVIEN.js";
...
import { a as markAuthProfileFailure, d as resolveProfilesUnavailableReason, o as markInlineProviderApiKeyFailure } from "./usage-6-myLAu1.js";
...
import { l as hasOnlyAssistantReasoningContent } from "./ai-transport-runtime-host-BOc97x0_.js";
...
import { a as resolveAgentHarnessPreparedAuthSupport, o as resolveAgentHarnessPreparedRouteSupport } from "./availability-Sa7g3udW.js";
...
import { n as acquireReadOnlyPreparedModelRuntime, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-afzKiwqZ.js";
...
import { n as markAuthProfileSuccess } from "./profiles-B9i8Wh87.js";
import { s as isConfigBackedInlineProviderApiKey } from "./model-auth-provider-config-DW3Bgqni.js";
import { i as getApiKeyForModelCore, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-e0nL7cI2.js";
...
import { x as resolveCompactionTimeoutMs, y as compactContextEngineWithSafetyTimeout } from "./diagnostic-DrSh1mZf.js";
...
import { D as setActiveEmbeddedRun, O as supersedeEmbeddedAgentRunByRunId, b as resolveActiveEmbeddedRunHandleSessionIdBySessionFile, d as isEmbeddedAgentRunHandleActive, r as clearActiveEmbeddedRun, y as resolveActiveEmbeddedRunHandleSessionId } from "./runs-DpT-JSmi.js";
...
import { c as shouldIncludeProgressCardToolForOpenClawTools } from "./openclaw-tools-Cx1wv4od.js";
...
import { l as retireSessionMcpRuntime, u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-manager-api-DUhEi3qH.js";
import "./agent-bundle-mcp-tools-BAxsm8bQ.js";
import { t as log$3 } from "./logger-ZAfp-Df-.js";
import { d as waitForDeferredTurnMaintenanceForSession, f as buildContextEngineRuntimeSettings, u as runContextEngineMaintenance } from "./agent-end-side-effects-C663wuG9.js";
import { n as resolveSandboxContext } from "./context-kK2b0dAi.js";
import { c as truncateOversizedToolResultsInActiveTarget, o as sessionLikelyHasOversizedToolResults } from "./tool-result-truncation-BZr2-1Tz.js";
import { c as runAgentCleanupStep, r as resolveSettledTurnFinalizationText } from "./settled-turn-finalization-result-cHPv9pc9.js";
...
import { d as resolveContextEngineCapabilities, f as buildEmbeddedCompactionRuntimeContext, p as resolveCompactionContextTokenBudget, r as forgetPromptBuildDrainCacheForRun, v as listActiveProcessSessionReferences } from "./attempt-prompt-helpers-C-pTLJFR.js";
import { t as resolveProcessToolScopeKey } from "./bash-process-scope-Bmw8_ghL.js";
import { n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-Bc5sTa5K.js";
import { D as settleRequesterAfterSessionSpawns } from "./subagent-registry-BNIH9OE4.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-Di-LWuJc.js";
import { t as ensureContextEnginesInitialized } from "./init-NGXUF89o.js";
...
import { b as shouldSuppressRawErrorConsoleSuffix, v as buildApiErrorObservationFields } from "./model-fallback-attempt-B0KZ9S-s.js";
import { n as resolveDelegationCapability } from "./agent-tools-yjKtLF9x.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-L32y-3ZS.js";
import { n as shouldUseTransientCooldownProbeSlot, r as LiveSessionModelSwitchError } from "./model-fallback-runner-CT0oRKYv.js";
import { a as resolveSessionKeyForRequestCore, o as resolveStoredSessionKeyForSessionId } from "./session-_LoaZdn1.js";
import { i as resolveSessionSuspensionTarget, o as suspendSession, r as resolveSessionSuspensionReason } from "./session-suspension-C-L43m4_.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-CVttd5qX.js";
import { n as resolveModelAsync, t as createEmptyAgentDiscoveryStores } from "./model-mZvi1Kcu.js";
import { n as resolveAgentRunSessionTarget, t as applyAgentRunSessionTargetIdentity } from "./run-session-target-BKjjwJy1.js";
...
import { a as selectContextEngineForTranscriptHost, i as createContextEngineLogicalTurnLease, n as drainPendingContextEngineTurnsBeforeRun } from "./context-engine-turn-attempt-pSNnkid5.js";
import { a as runAgentHarnessAttempt, c as selectAgentHarnessForPreparedModelProviders, o as runAgentHarnessSettledTurnFinalization, s as selectAgentHarness, t as agentHarnessBuildsOpenClawTools } from "./selection-DM2xsMhx.js";
...
import { n as maybeCompactAgentHarnessSession, r as isRecoverableNativeHarnessBindingFailure, t as resolveContextEngineCompactionSuccessor } from "./compaction-successor-I83q2tkz.js";
import { i as resolveCredentialScopedAuthAttemptModelDecision, n as hasPreparedAuthAttemptModelMetadata, r as providerUsesCredentialScopedModelMetadata, t as createPreparedRuntimeModelMaterializer } from "./credential-scoped-model-CtZKLOa1.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-Gs3Etsvo.js";
import { a as compactionCheckpointStore, c as resolveCompactionRuntimeSelection, d as resolveProjectKey, i as resolveTieredModel, l as asCompactionHookRunner, n as compactNativeCliSession, o as persistCompactionCheckpoint, s as prepareCompactionHarnessAuth, u as runPostCompactionSideEffects } from "./compact-DixoM_ni.js";
import { n as buildAgentRuntimePlan } from "./build-B7ysSS0v.js";
import { i as runBeforeAgentReplyForTurn, n as resolveAuthProfileFailureReason, r as buildHandledBeforeAgentReplyPayloads, t as buildEmbeddedRunPayloads } from "./payloads-CfSfmESE.js";
import { n as redactRunIdentifier, r as resolveRunWorkspaceDir, t as recordAdmittedModelRoutingDecision } from "./model-routing-decision-CfVp6Pqy.js";
...
import { a as hasPairedCardRenderer } from "./device-pairing-Li5h-3GZ.js";
import { a as resizeExecApprovalContinuationPrompt } from "./bash-tools.exec-approval-output-D90XjSjB.js";
import { r as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-CT0MjbtH.js";
import { a as resolveHookModelSelection, i as resolveEmbeddedRuntimeModelPolicy, n as createNativeModelOwnedRuntimeModel, o as resolveNativeModelOwnedHarnessId, r as resolveAgentHarnessRunAdmissionError, t as buildBeforeModelResolveAttachments } from "./setup-N0pouC7v.js";
import { r as readSourceReplyDeliveryRuntime } from "./source-reply-delivery-runtime-D3ljIhoI.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-CT6tpLMx.js";
...
async function retireDispatchSessionMcpRuntime(params) {
	try {
		const { retireSessionMcpRuntime, retireSessionMcpRuntimeForSessionKey } = await import("./agent-bundle-mcp-tools-DVMGaqLt.js");
	...
	return {
		...
		settleOwnedTranscriptProjection: async (target, abortSignal) => {
			...
			if (settleOwnedTranscriptProjection && target && sessionId) {
				...
				const { waitForSessionTranscriptProjection } = await import("./session-transcript-reconcile-IDlGYG83.js");
