...
const trustedToolNoStartErrors = /* @__PURE__ */ new WeakSet();
...
function registerTrustedToolNoStartError(error) {
	if (typeof error === "object" && error !== null) trustedToolNoStartErrors.add(error);
}
...
//#endregion
export { protectNetworkToolExecutionError as a, registerTrustedToolInputError as c, resolveToolResultFailureKind as d, isTrustedToolExecutionPreflightError as i, registerTrustedToolNoStartError as l, formatToolExecutionErrorMessage as n, readToolResultDetails as o, isToolResultError as r, readToolResultStatus as s, consumeTrustedToolNoStartError as t, resolveToolExecutionErrorKind as u };
