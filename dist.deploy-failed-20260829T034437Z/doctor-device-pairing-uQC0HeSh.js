...
import { a as loadDeviceAuthTokens } from "./device-auth-store-DVgrQui-.js";
...
import { l as listDevicePairingReadOnly, s as listApprovedPairedDeviceRoles } from "./device-pairing-Li5h-3GZ.js";
...
async function collectLegacyPairingStoreIssues(cfg) {
	...
	const { listLegacyDevicePairingStoreFiles } = await import("./device-pairing-migration-BPMddOCF.js");
