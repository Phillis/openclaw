...
import { i as normalizeThinkingCatalogProviders, n as hasResolvedThinkingCatalogEntry } from "./thinking-runtime-DuqTHyA8.js";
...
import { a as getPreparedModelRuntimeSnapshot, l as prepareModelRuntimeSnapshot, n as acquireReadOnlyPreparedModelRuntime, p as preparedModelRuntimeConfigsMatch, r as activateStandalonePreparedModelRuntime, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-DRxNQEhr.js";
import { n as prepareScopedReadOnlyModelCatalog, t as prepareScopedReadOnlyLiveModelCatalog } from "./prepared-model-runtime.scoped-catalog-pre6SiCV.js";
...
async function loadProviderScopedThinkingCatalog(params) {
	...
	const augmentHarnessCatalog = async (snapshot) => {
		...
		const { augmentModelCatalogWithAgentHarness } = await import("./model-catalog-CpFuQ75T.js");
	...
	const { loadManifestModelCatalog } = await import("./model-catalog-B2DbureB.js");
