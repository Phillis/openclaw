...
import { n as resolveGatewayProbeSnapshot, t as buildTailscaleHttpsUrl } from "./status.scan.shared-B_rlfnz5.js";
...
const statusAgentLocalModuleLoader = createLazyImportLoader(() => import("./status.agent-local-C85b__2w.js"));
...
const statusSummaryModuleLoader = createLazyImportLoader(() => import("./summary-tRyZ6rCn.js"));
...
const commandConfigResolutionModuleLoader = createLazyImportLoader(() => import("./command-config-resolution-CilSaqF-.js"));
const commandSecretTargetsModuleLoader = createLazyImportLoader(() => import("./command-secret-targets-BwcUnigT.js"));
...
async function collectStatusScanOverview(params) {
	...
	const { snapshot } = await (await import("./command-config-snapshot-DTYT3-tC.js")).readCommandConfigSnapshot({
		observe: false,
