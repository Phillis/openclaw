...
import { c as readText, i as isDirectory, l as resolveHomePath, r as exists } from "./helpers-S9wIX9Dg.js";
...
async function discoverOpenCodeAuthPath(params) {
	...
	const candidates = Array.from(new Set([
		...xdgAuthPath && (params.includeGlobalFallback || isPathInside(rootParent, xdgAuthPath)) ? [xdgAuthPath] : [],
