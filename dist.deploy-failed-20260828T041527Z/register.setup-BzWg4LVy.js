...
import { a as registerOnboardRuntimeOptions, i as registerOnboardRemoteOptions, o as resolveOnboardCommandOptions, r as registerOnboardGatewayOptions, t as registerOnboardAuthOptions } from "./register.onboard-CKtZQbES.js";
...
async function runOnboardingEntry(options, commandRuntime, runtime) {
	if (options.baseline) {
		...
		const { setupCommand } = await import("./setup-B_F4iLd_.js");
		await setupCommand({
