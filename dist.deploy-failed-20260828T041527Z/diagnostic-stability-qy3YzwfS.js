...
import { h as onInternalDiagnosticEvent } from "./diagnostic-events-BGzDm6gu.js";
...
function startDiagnosticStabilityRecorder() {
	...
	state.unsubscribe = onInternalDiagnosticEvent((event, metadata) => {
		if (metadata.trusted && event.type !== "model.call.started" && event.type !== "model.call.completed" && event.type !== "model.call.error") return;
