...
import { R as timestampMsToIsoString, t as MAX_DATE_TIMESTAMP_MS } from "./number-coercion-CLj0HTDM.js";
...
import { c as CRON_TOOL_DISPLAY_SUMMARY } from "./tool-catalog-DKzjKSZr.js";
...
import { o as expandPolicyWithPluginGroups, r as buildPluginToolGroups } from "./tool-policy-B1rvCc4B.js";
import { r as isToolAllowedByPolicyName } from "./tool-policy-match-DfCekeWz.js";
import { m as recordCronNextCheckProposal } from "./agent-run-registry-t4kvUyNQ.js";
import { A as readCanonicalCronListPage, j as resolveCronListPageNextOffset } from "./loader-BcKpDiEM.js";
import { _ as normalizeCronJobCreate, p as parseCronPacingBounds, y as normalizeCronJobPatch } from "./row-codec-gAlP-EPD.js";
import "./config-B_0xOnKq.js";
import "./client-X46urv_Y.js";
import { t as GatewayClientRequestError } from "./request-error-DOHu7KKj.js";
import { _ as readToolStringParam, d as readNonNegativeIntegerParam, p as readPositiveIntegerParam } from "./common-CI1GnPjt.js";
import { t as jsonResult } from "./tool-results-BCM3fdVS.js";
import { n as extractTextFromChatContent } from "./chat-content-BbLAEXko.js";
import { a as withGatewayToolCallerIdentity, m as setToolTerminalPresentation } from "./gateway-caller-context-DNtidJOJ.js";
import { n as readGatewayCallOptions, t as callGatewayTool } from "./gateway-D8V0DEy4.js";
import { a as optionalPositiveIntegerSchema, i as optionalNonNegativeIntegerSchema, o as optionalStringEnum, r as optionalFiniteNumberSchema, s as stringEnum } from "./typebox-DzztcX9H.js";
import { m as resolveMainSessionAlias, p as resolveInternalSessionKey } from "./sessions-helpers-GgSp1hTb.js";
import { t as resolveCronCreationDelivery } from "./delivery-context-BTIO8GUN.js";
...
function createCronDeliverySchema() {
	...
	return Type.Optional(Type.Object({
		...
		failureDestination: Type.Optional(Type.Union([failureDestinationObject, Type.Null()], { description: "Failure-alert route override and alternate for immediate required-delivery failure; null clears." })),
...
function createCronToolSchema(options) {
	...
	const job = Type.Optional(Type.Object({
		...
		...!options?.agentSessionKey?.trim() ? { agentId: nullableStringSchema("Agent id, or null to clear it") } : {},
