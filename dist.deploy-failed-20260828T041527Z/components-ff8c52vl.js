...
import { c as buildDiscordModalCustomId, m as parseDiscordModalCustomIdForInteraction, s as buildDiscordComponentCustomId } from "./shared-interactive-Bc9FmZin.js";
import { p as MessageFlags, r as ButtonStyle, y as TextInputStyle } from "./v10-BDbFcnZN.js";
import { A as Label, B as MentionableSelectMenu, F as ChannelSelectMenu, G as StringSelectMenu, H as Row, I as Container, J as UserSelectMenu, K as TextDisplay, L as File, M as RadioGroup, N as TextInput, P as Button, R as LinkButton, U as Section, V as RoleSelectMenu, W as Separator, j as Modal, k as CheckboxGroup, q as Thumbnail, z as MediaGallery } from "./discord-Bt2iGHi3.js";
...
function readRequiredString(value, label, opts) {
...
function parseComponentBlock(raw, label) {
	...
	switch (normalizeBlockType(normalizeLowercaseStringOrEmpty(readRequiredString(obj.type, `${label}.type`)))) {
		...
		case "section": {
			...
			const texts = Array.isArray(textsRaw) ? textsRaw.map((entry, idx) => readRequiredString(entry, `${label}.texts[${idx}]`)) : void 0;
...
//#endregion
export { buildDiscordComponentMessageFlags as a, readDiscordComponentSpec as c, buildDiscordComponentMessage as i, resolveDiscordComponentAttachmentName as l, DiscordFormModal as n, DISCORD_COMPONENT_ATTACHMENT_PREFIX as o, createDiscordFormModal as r, coerceDiscordComponentParam as s, formatDiscordComponentEventText as t };
