...
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-routing-Chr0R2hQ.js";
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, w as prepareModelRunCapabilities, y as resolveModelAliasFromPair } from "./model-selection-shared-DbjoXfPH.js";
...
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-query-DREoZp4g.js";
import "./target-registry-CGWcufp7.js";
import { m as patchSessionEntryCore } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
...
import { n as beginSessionWorkAdmission } from "./session-lifecycle-admission-BtKN0pjk.js";
...
import { c as isValidAgentHarnessSessionStoreEntry, l as resolveAgentHarnessSessionContextError, t as AGENT_HARNESS_MODEL_RUN_FORBIDDEN_MESSAGE } from "./agent-harness-session-key-D9_Ct3Lx.js";
import { i as hasNonzeroUsage } from "./usage-DNKCVmJi.js";
import { f as recordSessionHumanDirectMessage, n as classifySessionStateActor } from "./session-state-events-DvygRPJJ.js";
import { a as isSessionWorkStartInvalidatedError, s as resolveSessionWorkStartError } from "./lifecycle-B13mO5hL.js";
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-BxFkXXxj.js";
...
import { n as isThinkingLevelSupported, t as formatThinkingLevels } from "./thinking-DLPyZXEW.js";
import { i as resolveSessionRuntimeOverrideForProvider } from "./session-runtime-compat-CuMcNwkW.js";
import { n as resolveAvailableAgentHarnessPolicy } from "./availability-DW_f7sKl.js";
import { a as resolveCandidateThinkingLevel, i as normalizeThinkingCatalogProviders, n as hasResolvedThinkingCatalogEntry, o as resolveEffectiveAgentRuntime, r as needsThinkHydration } from "./thinking-runtime-DuqTHyA8.js";
import { p as ensureAgentWorkspace } from "./workspace-DJ__UUS2.js";
import { a as findConfiguredModelProvider, i as allowsPluginModelNormalization } from "./model-fallback-candidates-D23pTS8p.js";
import { n as withAgentPluginRegistry } from "./runtime-plugins-B0uJCbKb.js";
import "./model-selection-Cp8EGD61.js";
import { n as resolveThinkingDefault, t as resolveConfiguredThinkingDefault } from "./model-thinking-default-DduLSMYL.js";
...
import { i as isSyntheticSourceReplyTurn } from "./source-reply-delivery-mode-a88lvIDJ.js";
...
import { t as resolveSessionStableReplyMode } from "./session-stable-reply-mode-BEABm03G.js";
...
import { a as createUserTurnTranscriptRecorder } from "./user-turn-transcript-CMdiyjwP.js";
...
import { n as removeInternalSessionEffectsSession, r as resolveInternalSessionEffectsTarget, t as prepareInternalSessionEffectsSession } from "./internal-session-effects-DXOpVUug.js";
...
import { d as formatAgentInternalEventsForPrompt, u as formatAgentInternalEventsForPlainPrompt } from "./subagent-announce-delivery-Cg1D7bpU.js";
...
import { i as normalizePendingFinalRecoveryPayloads, n as buildRecoverablePendingFinalDeliveryText, r as normalizePendingFinalDeliveryPayloads } from "./pending-final-delivery-DJ7b2f3m.js";
import { i as resolveSession, n as clearRotatedSessionMetadata } from "./session-_tB-9DuM.js";
...
import { a as releaseMainSessionRecoveryOwner, i as refreshMainSessionRecoveryOwner, r as inspectMainSessionRecoveryRequired, t as claimMainSessionRecoveryOwner } from "./main-session-recovery-store-dpSl6NHY.js";
...
import "./live-model-switch-CXpbA050.js";
...
import { t as clearSessionAuthProfileOverride } from "./session-override-LTIDP5EY.js";
import { r as mergeSessionSnapshotChanges } from "./session-snapshot-merge-B4KFr9oE.js";
import { n as applyVerboseOverride } from "./level-overrides-C_flWC0i.js";
import { i as resolveInlineAgentImageAttachments } from "./agent-turn-attachments-CDnycmxX.js";
import { n as prepareAgentCommandExecutionIdentity, r as sanitizePublicAgentCommandIngressOpts, t as executionIdentity } from "./agent-command-execution-identity-zCYtM-ae.js";
import { t as withLocalAgentCronJobsRemoved } from "./local-service-CrnoudkO.js";
import { t as loadGatewayConfigRevisionProjector } from "./config-revision-token-Cm2lUea7.js";
...
import { a as readPreparedGatewayModelCatalogOwnerSnapshot, i as readPreparedGatewayModelCatalog, n as loadGatewayModelCatalogSnapshot, r as loadPreparedGatewayModelCatalogSnapshot, t as loadGatewayModelCatalog } from "./server-model-catalog-BN_2qcvl.js";
...
import { n as acquireWorktreeRunLease, o as resolveWorktreeIdForPath } from "./run-lease-D7Top7jB.js";
import { t as createLazyAcpElicitationHandler } from "./acp-elicitation-handler-lazy-BfqacGX2.js";
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	const secretsRuntime = await measureAgentStartup("secrets-runtime-import", () => import("./runtime-CN0H92il.js"), { config: loadedRaw });
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-CH-4G8Dv.js"));
const agentRunnerMemoryRuntimeLoader = createLazyImportLoader(() => import("./agent-runner-memory-D5wjAtcN.js"));
...
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-DRFsWKsi.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-DNri9e03.js"));
const skillsRuntimeLoader = createLazyImportLoader(async () => {
	const [remote, sessionSnapshot] = await Promise.all([import("./remote-rUB1zX19.js"), import("./session-snapshot-Jcx-szhW.js")]);
	return {
