...
import { f as resetPublishedConfigRuntimeEnv, p as ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS_ENV } from "./config-env-vars-C_yEEhJa.js";
import { x as GATEWAY_CONFIG_SELECTION_ENV_KEYS } from "./io.read-helpers-BfhrMUhR.js";
import { t as getGatewayRunRuntimeHooks } from "./runtime-hooks-Dp2OHV46.js";
import { i as resolveUpgradeConfigSnapshot, n as isUpgradeConfigRepairResult } from "./automatic-upgrade-config-repair-BRdpeyxE.js";
import { t as enforceGatewayRunFutureConfigGuard } from "./future-config-guard-XmzqA6Tz.js";
...
async function pinGatewayRunRuntimePaths() {
	const [{ pinRuntimePaths }, { pinConfigDir }] = await Promise.all([import("./paths-DHUSIAJh.js"), import("./utils-DbFQsLj1.js")]);
...
async function isSameGatewayRunConfigSnapshot(expected, current, options = {}) {
	const { hashRuntimeConfigValue } = await import("./runtime-snapshot-ya_WSy3x.js");
...
async function guardGatewayRunSelectedConfig(params) {
	...
	const [path, { applyConfigEnvVars, isConfigRuntimeEnvVarAllowed }, { loadGlobalRuntimeDotEnvFiles }, { normalizeEnv }, { normalizeStateDirEnv, resolveStateDir }, { resolveConfigDir }, { collectEnvSecretRefIds }, { clearMissingManagedServiceEnvKeys, readManagedSystemdServiceEnvKeysFromEnvironment }] = await Promise.all([
		import("node:path"),
		import("./config-env-vars-DsxHFlCC.js"),
		import("./dotenv-global-_ggwRAt3.js"),
		import("./env-CFtzoW2G.js"),
		import("./paths-DHUSIAJh.js"),
		import("./utils-DbFQsLj1.js"),
		import("./types.secrets-Od2f3Wed.js"),
		import("./service-managed-env-nQyn7n5s.js")
	]);
	...
	for (;;) {
		...
		const trustedSnapshot = resolveUpgradeConfigSnapshot(snapshot);
		...
		const { describeLiveGatewayOwnerStartupBlocker } = await import("./doctor-startup-migration-refusal-C9ZMBDy4.js");
...
async function prepareGatewayRunBootstrap(params) {
	...
	const { planPristineStartupConfigMigrations, planPristineStartupStateMigrations } = await import("./pristine-startup-state-BvodfJFV.js");
...
async function recheckGatewayRunBootstrap(params) {
	...
	if (await isSameGatewayRunConfigSnapshot(expected, current, { allowPathChange: params.snapshot !== void 0 }) || isUpgradeConfigRepairResult(expected, current)) return true;
