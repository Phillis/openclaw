...
import { B as resolveOpenClawAgentSqlitePath, R as isIncognitoOpenClawAgentSqlitePath, z as resolveIncognitoOpenClawAgentSqlitePath } from "./openclaw-agent-db-maintenance-_0tYy-zT.js";
import { t as withOpenClawAgentDatabaseReadOnly } from "./openclaw-agent-db-readonly-C-yaBHT4.js";
import { A as assertCanonicalSessionKeyWrite, L as coerceSqliteNumber, M as canonicalSessionKeyMigrationRequiredError, R as createFallbackSessionEntry, X as assertSessionEntrySelectionUnchanged, Y as assertLifecycleTargetSnapshotUnchanged, _ as readSessionIdentitySnapshot, b as writeSessionEntry, d as readLifecycleTargetSnapshot, et as readSessionEntryCache, f as readSessionEntryCount, ft as runPreparedSqliteSessionWrite, g as readSessionEntryStore, gt as deriveSessionMetaPatch, h as readSessionEntrySelectionSnapshot, ht as deriveLastRoutePatch, j as assertCanonicalSqliteSessionKeysCurrent, m as readSessionEntryRow, mt as withSqliteSessionDeletions, n as createSessionIdentitySnapshot, nt as parseSessionEntryJson, pt as runSqliteSessionDeletionTransaction, r as deleteLegacySessionEntryRows, rt as readSessionEntriesByStatus, s as parseReadableSqliteSessionEntryRow, st as buildSessionCreationStamp, u as readExactSessionEntryRowValidated, v as rehomeSessionWindows, z as collectSessionStateIdsForEntry } from "./session-accessor.sqlite-entry-store-BIW-GrsF.js";
import { a as normalizeStoreSessionKey, o as resolveDeliveryProvenCanonicalSessionKey, t as collectSessionEntryLookupKeys } from "./store-entry-BN3xGmHe.js";
import { c as resolveSqliteScope, d as resolveSqliteTranscriptReadScope, i as getSessionKysely, l as resolveSqliteStoreScope, m as toDatabaseOptions, p as runExclusiveSqliteSessionWrite, t as cloneSessionEntry, u as resolveSqliteTranscriptArchiveDirectory } from "./session-accessor.sqlite-scope-C7NrJaPh.js";
import { i as kickSessionHistoryDiskBudgetMaintenance, o as emitCommittedSessionEntryRemovals, s as emitCommittedSessionIdentityDiff } from "./session-history-eviction-DX5U9ZnW.js";
import { i as materializeSessionStateDeletePlans } from "./session-accessor.sqlite-archive-Be3BKsyF.js";
import { d as readSessionGenerationIdsForKeys, i as deletePlannedLifecycleArtifactEntries, m as publishSessionStateArchives, n as collectProjectedReferencedSessionIds, r as deleteMaterializedSessionStatePlans, s as planSessionStateDeleteIfUnreferenced, t as assertPlannedLifecycleArtifactEntriesUnchanged } from "./session-accessor.sqlite-lifecycle-state-BDm5Kty_.js";
import { f as collectSessionMaintenancePreserveKeys, i as mergeSessionEntryPreserveActivity, p as collectSessionMaintenancePreserveKeysForStore, r as mergeSessionEntry } from "./types-gVK8DqPC.js";
