...
import { r as createMessageActionDiscoveryContext, u as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-Dpembeiy.js";
...
import { s as getChannelsCommandSecretTargetIds } from "./command-secret-targets-B3UG58Gq.js";
...
import { i as prepareChannelAccountRemoval, n as channelLabel, r as applyPreparedChannelAccountRemoval, t as channelsAddCommand } from "./add-DBPN0M0w.js";
import { c as requireValidChannelConfig, l as shouldUseWizard, s as formatChannelAccountLabel } from "./shared-B0lBu2yU.js";
import { t as channelsListCommand } from "./list-DyZVG9t2.js";
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-DJMuYw6x.js");
