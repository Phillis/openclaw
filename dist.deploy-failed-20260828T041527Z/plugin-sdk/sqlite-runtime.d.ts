...
import { a as SqliteWalMaintenance, n as OpenClawStateDatabaseOptions } from "../openclaw-state-db-contract-BbwGU0Ve.js";
...
//#endregion
//#region src/state/openclaw-agent-db-readonly.d.ts
...
type OpenClawAgentDatabaseReadOnlyResult<T> = {
  ...
  found: false;
  reason: "database-missing" | "schema-missing" | "table-missing";
};
/** Read agent state without creating, registering, migrating, or joining its writable lifecycle. */
declare function withOpenClawAgentDatabaseReadOnly<T>(operation: (database: OpenClawAgentReadOnlyDatabase) => T, options: OpenClawAgentDatabaseOptions, behavior?: {
...
//#endregion
//#region src/infra/sqlite-readonly-location.d.ts
type PreparedSqliteReadOnlyLocation = {
  cleanup: () => boolean;
  location: string;
};
declare function prepareSqliteReadOnlyLocationSync(pathname: string): PreparedSqliteReadOnlyLocation;
//#endregion
export { ensureOpenClawAgentDatabaseSchema, ensureOpenClawAgentStandingIntentsSchema, executeSqliteQuerySync, executeSqliteQueryTakeFirstSync, getNodeSqliteKysely, openNodeSqliteDatabase, openOpenClawAgentDatabase, prepareSqliteReadOnlyLocationSync, resolveOpenClawAgentSqlitePath, runSqliteImmediateTransactionSync, withOpenClawAgentDatabaseReadOnly };