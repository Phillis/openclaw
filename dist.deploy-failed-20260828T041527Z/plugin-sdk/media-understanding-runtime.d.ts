...
import { _ as StructuredExtractionResult, i as ImageDescriptionResult } from "../types-DjaZR6Mg.js";
import { s as MsgContext } from "../templating-D4gA1hJr.js";
import { c as TranscribeAudioFileParams, i as ExtractStructuredWithModelParams, n as DescribeImageFileWithModelParams, o as RunMediaUnderstandingFileParams, r as DescribeVideoFileParams, s as RunMediaUnderstandingFileResult, t as DescribeImageFileParams } from "../runtime-types-DwlGXOC6.js";
import { t as transcribeFirstAudio } from "../audio-preflight-DNqe1o8Y.js";
...
declare function formatAudioTranscriptForAgent(transcript: string): string;
...
//#endregion
export { type ExtractStructuredWithModelParams, type RunMediaUnderstandingFileParams, type RunMediaUnderstandingFileResult, createChannelPreflightAudio, describeImageFile, describeImageFileWithModel, describeVideoFile, extractStructuredWithModel, formatAudioTranscriptForAgent, runMediaUnderstandingFile, transcribeAudioFile };