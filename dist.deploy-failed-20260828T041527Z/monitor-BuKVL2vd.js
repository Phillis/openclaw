...
import { f as normalizeStringifiedEntries, g as readStringValue, l as normalizeOptionalString, o as normalizeLowercaseStringOrEmpty, s as normalizeNullableString } from "./string-coerce-CIXf7egm.js";
import { D as resolveExpiresAtMsFromDurationMs, N as resolveOptionalIntegerOption, g as isFutureDateTimestampMs, x as parseStrictFiniteNumber } from "./number-coercion-CLj0HTDM.js";
...
import { o as getReplyPayloadTtsSupplement, r as buildTtsSupplementMediaPayload } from "./reply-payload-BeeUJOmJ.js";
...
import { n as listMessageReceiptPlatformIds, t as createMessageReceiptFromOutboundResults } from "./receipt-BzekpwQi.js";
import { i as resolveHumanDelayConfig, t as resolveAckReaction } from "./identity-Cc11oAxY.js";
import { D as toLocationContext, T as formatLocationText } from "./reply-payload-i0RzN2iF.js";
...
import { i as formatChannelProgressDraftLine, n as buildChannelProgressDraftLineForEntry, o as formatChannelProgressDraftText, v as resolveChannelStreamingBlockEnabled } from "./streaming-B93dETXe.js";
...
import { a as deliverWithFinalizableLivePreviewAdapter, n as createPreviewMessageReceipt, r as defineFinalizableLivePreviewAdapter } from "./live-CIdslFJ4.js";
...
import { m as toInboundMediaFactsWithMetadata } from "./run-channel-turn-CVly42eY.js";
...
import { i as resolveChannelTurnDispatchCounts, n as hasFinalChannelTurnDispatch } from "./dispatch-result-B75usq__.js";
import { n as createReplyPrefixOptions } from "./reply-prefix-cGitgfJu.js";
...
import { n as createChannelProgressDraftCompositor } from "./progress-draft-compositor-FOAJU_0Z.js";
import { t as createChannelInboundEnvelopeBuilder } from "./envelope-C88XYhn2.js";
...
import "./thread-bindings-runtime-CZo2Jmab.js";
...
import { i as channelStoppedPatch, n as channelBlockedPatch, o as createTransportActivityStatusPatch, r as channelReadyPatch } from "./gateway-runtime-BOxS77yr.js";
...
import { n as formatAudioTranscriptForAgent, t as createChannelPreflightAudio } from "./media-understanding-runtime-dQ2PWxoe.js";
import "./text-utility-runtime-BNhX-3os.js";
import { a as resolveMatrixAccountConfig, i as resolveMatrixAccountAllowlistConfig } from "./account-config-CpFj8tyt.js";
import { t as getMatrixRuntime } from "./runtime-Drg4hYqm.js";
import { n as resolveConfiguredMatrixBotUserIds } from "./accounts-CQ-N-_Xa.js";
import { n as normalizeMatrixUserId, r as resolveMatrixAllowListMatch, t as normalizeMatrixAllowList } from "./allowlist-Cbcizppf.js";
import { n as isMatrixRoomId, t as isMatrixQualifiedUserId } from "./target-ids-DEUqtLsd.js";
import { n as resolveMatrixRoomConfig } from "./rooms-Dpprwj5G.js";
import { a as EventType, i as resolveMatrixThreadRouting, n as resolveMatrixReplyToEventId, o as RelationType, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-B4k5HUNd.js";
import { t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-oEnAmulR.js";
import { g as isPollStartType, h as isPollEventType, p as formatPollAsText, r as sendMessageMatrix, v as parsePollStartContent } from "./send-BEJQk6ia.js";
import { a as readJoinedMatrixMembers, r as isStrictDirectMembership, t as hasDirectMatrixMemberFlag } from "./direct-room-CQh3MRKp.js";
import { o as MATRIX_OPENCLAW_FINALIZED_PREVIEW_KEY, r as promoteMatrixDirectRoomCandidate } from "./direct-management-DeaumWfF.js";
import { t as createMatrixThreadBindingManager } from "./thread-bindings-BT0D6bXW.js";
import { a as resolveBundledMatrixReplacementContent, c as fetchMatrixPollSnapshot, i as isLikelyBareFilename, n as formatMatrixMediaUnavailableText, r as formatMatrixMessageText, t as formatMatrixMediaTooLargeText } from "./media-text-BvAy2jeu.js";
import { t as isBunRuntime } from "./runtime-BefyhPWv.js";
import { i as resolveMatrixAuthContext, n as backfillMatrixAuthDeviceIdAfterStartup, r as resolveMatrixAuth } from "./create-client-YKlLktEB.js";
import { i as throwIfMatrixStartupAborted, r as isMatrixStartupAbortError } from "./startup-abort-yDtnMgq-.js";
import { t as acquireSharedMatrixClient } from "./client-Cc6PkTXN.js";
import { i as isMatrixMediaSizeLimitError, r as MatrixMediaSizeLimitError } from "./http-client-Bbbiy8iR.js";
import { t as resolveMatrixTargets } from "./resolve-targets-CWVJP92I.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-CTdsPm9z.js";
import { i as createMatrixInboundEventDeduper } from "./inbound-dedupe-BXxlMp4h.js";
import { a as isMatrixAccessTokenInvalidatedError, d as isMatrixDisconnectedSyncState, f as isMatrixReadySyncState, p as isMatrixTerminalSyncState } from "./client-support-iDrp3pNM.js";
import { n as setBoundedMap, t as createMatrixRoomInfoResolver } from "./room-info-BSA0KcQD.js";
...
function registerMatrixAutoJoin(params) {
	...
	const onInvite = (roomId, _inviteEvent) => {
		params.runDetachedTask(`auto-join invite handler room=${roomId}`, async () => {
...
async function resolveMatrixMonitorRoomsConfig(params) {
	...
	if (unresolved.length > 0) params.runtime.log?.("matrix rooms must be room IDs or aliases (example: !room:server, the suffixless !room form on room version 12+, or #alias:server). Unresolved entries are ignored.");
...
async function resolveMatrixMonitorAccessState(params) {
	...
	const resolveMessageIngress = async (contextBinding, conversation) => await ingress.message({
...
const loadMatrixDirectRoomDeps = createLazyRuntimeModule(() => Promise.all([import("./direct-management-Bhh4lXtU.js"), import("./direct-room-C2GKso0o.js")]).then(([directManagementModule, directRoomModule]) => ({
...
function registerMatrixMonitorEvents(params) {
	...
	const onRoomMessageEvent = (roomId, event) => {
	...
	const onFailedDecryption = (roomId, event, error) => {
	...
	const onJoin = (roomId, event) => {
		directTracker?.invalidateRoom(roomId);
		const eventId = event?.event_id ?? "unknown";
		logVerboseMessage(`matrix: join room=${roomId} id=${eventId}`);
	};
	const onRoomEvent = (roomId, event) => {
		const eventType = event?.type ?? "unknown";
...
function resolveMatrixPendingHistoryText(params) {
	if (!params.mediaUrl) return params.mentionPrecheckText;
	return formatMatrixMessageText({
		body: typeof params.content.body === "string" ? params.content.body : void 0,
		filename: typeof params.content.filename === "string" ? params.content.filename : void 0,
		msgtype: typeof params.content.msgtype === "string" ? params.content.msgtype : void 0
	}) ?? params.mentionPrecheckText;
}
function resolveMatrixInboundMediaContent(content) {
	const file = content.file && typeof content.file === "object" ? content.file : void 0;
	const info = content.info && typeof content.info === "object" ? content.info : void 0;
...
function shouldDeferMatrixAudioPreflightForRoomIngress(params) {
	...
	return mediaContent.url?.startsWith("mxc://") === true && isMatrixAudioContent({
		msgtype: typeof params.content.msgtype === "string" ? params.content.msgtype : void 0,
...
const loadMatrixSendModule = createLazyRuntimeModule(() => import("./send-OX_uJ25E.js"));
...
const loadMatrixReactionEvents = createLazyRuntimeModule(() => import("./reaction-events-DRjJXYbL.js"));
const loadMatrixDraftStream = createLazyRuntimeModule(() => import("./draft-stream-X8nkcbPI.js"));
...
function summarizeMatrixMessageContextEvent(event) {
	...
	const content = event.unsigned?.redacted_because ? event.content : resolveBundledMatrixReplacementContent(event) ?? event.content;
	return formatMatrixMessageText({
...
async function createMatrixDraftController(params) {
	...
	const buildPreviewToolProgressReplyOptions = () => {
		...
		return {
			...
			onPlanUpdate: async (payload) => {
				...
				if (progressDraftStreaming) return await progressDraft.pushPlanProgress(payload.steps, { explanation: payload.explanation });
				if (!draftStream || previewPlanSuppressed) return false;
	...
	return {
		...
		onPartialReply: (text) => {
			if (progressDraftStreaming) return false;
...
async function resolveMatrixIngressContent(config) {
	...
	if (mentionDecision.shouldSkip) {
		const pendingHistoryBody = preflightAudioTranscript ? formatAudioTranscriptForAgent(preflightAudioTranscript) : pendingHistoryText || pendingHistoryPollText;
	...
	let bodyText = resolveMatrixInboundBodyText({
		rawBody: locationPayload?.text ?? mediaContent.body,
...
async function deliverMatrixReplies(params) {
	...
	try {
		for (const reply of params.replies) {
			...
			const explicitReplyToId = reply.replyToTag || reply.replyToCurrent ? reply.replyToId?.trim() : void 0;
			const rawText = visibleText ?? "";
			const replyToIdForReply = explicitReplyToId || (params.threadId || params.replyToMode !== "off" && (params.replyToMode === "all" || !hasRepliedRef.value) ? (reply.replyToId ?? params.replyToId)?.trim() : void 0);
...
function createMatrixReplyDispatcher(config) {
	const { cfg, prefixOptions, humanDelay, typingCallbacks, streaming, draftStream, draftController, client, roomId, runtime, replyToMode, threadTarget, replyToEventId, accountId, mediaLocalRoots, logVerboseMessage } = config;
	const quietDraftStreaming = streaming === "quiet" || streaming === "progress";
	...
	const { deliver: deliverReply, onError: onReplyError, ...turnDispatcherOptions } = {
		...
		deliver: async (payload, info) => {
			...
			const settleDraftReplacement = async (params) => {
				...
				if (!await redactMatrixDraftEvent(client, roomId, params.draftEventId)) {
					draftController.markDraftRetained();
			...
			if (draftStream && info.kind !== "tool" && !payload.isCompactionNotice) {
				...
				const payloadReplyMismatch = !threadTarget && (replyToMode !== "off" || payload.replyToTag || payload.replyToCurrent) && normalizeOptionalString(payload.replyToId) !== draftController.currentReplyToId();
				...
				if (draftEventId && payload.text && !payload.isError && !hasMedia && !payloadReplyMismatch && !mustDeliverFinalNormally && !draftFinalTextNeedsNormalMentionDelivery) {
					...
					const previewResult = await deliverWithFinalizableLivePreviewAdapter({
						...
						deliverNormally: async () => {
							fallbackResult = await settleDraftReplacement({
								...
								deliver: async () => await deliverMatrixReplies({
									cfg,
									replies: [fallbackPayload],
									roomId,
									client,
					...
					if (previewResult.kind === "preview-finalized") draftController.markDraftConsumed();
					...
					const previewDelivery = reusesDraftAsFinalText && providerDraftContent ? createDraftDeliveryResult(draftEventId, providerDraftContent) : draftContent ? createDraftDeliveryResult(draftEventId, draftContent) : mergeMatrixReplyDeliveryResults([]);
					const deliverMedia = async () => await deliverMatrixReplies({
						cfg,
					...
					if (draftContent) return await completeDelivery(await settleDraftReplacement({
						draftEventId,
						draftContent,
				...
				const deliverFallback = async () => await deliverMatrixReplies({
					cfg,
					replies: [fallbackPayload],
					roomId,
					client,
				...
				const draftContent = draftStream.content();
				if (shouldRedactDraft && draftEventId && draftContent) return await completeDelivery(await settleDraftReplacement({
					draftEventId,
					draftContent,
		...
		onError: (err, info) => {
			...
			if (info.kind === "block") beginNextBlockDraft();
	...
	return async (roomId, event) => {
		...
		try {
			...
			const commitInboundEventIfClaimed = async () => {
				...
				if (!claim) return;
				await claim.commit();
				if (inboundReplayClaim === claim) inboundReplayClaim = void 0;
			};
			...
			const turnAdoptionLifecycle = replayClaimAtDispatch ? {
				admission: "exclusive",
				onDeferred: () => {
					if (inboundReplayClaim !== replayClaimAtDispatch) return false;
					inboundReplayClaim = void 0;
				},
				onAdopted: async () => {
					if (inboundReplayClaim === replayClaimAtDispatch) inboundReplayClaim = void 0;
					...
					resolveTurn: () => ({
						...
						replyOptions: {
							...
							onBlockReplyQueued: draftStream ? (payload, context) => {
								if (payload.isCompactionNotice === true) return false;
			...
			const finalCount = resolveChannelTurnDispatchCounts(dispatchResult).final;
			...
			if (draftController?.draftStream?.eventId() && draftController.draftDisposition() === "active") draftController.markDraftRetained();
			runtime.error?.(`matrix handler failed: ${String(err)}`);
		} finally {
			const draftStream = draftControllerRef?.draftStream;
			if (draftStream) {
				const draftEventId = await draftStream.stop().catch(() => void 0);
				if (draftEventId && draftControllerRef?.draftDisposition() === "active") await redactMatrixDraftEvent(client, roomId, draftEventId);
			}
...
const loadMatrixStartupMaintenanceDeps = createLazyRuntimeModule(() => Promise.all([
	import("./config-update-DvGzkYXk.js"),
	import("./device-health-CA7cIiLv.js"),
	import("./profile-Bzl4BCa4.js"),
	import("./startup-verification-0UtzztKB.js")
...
async function monitorMatrixProvider(opts = {}) {
	...
	try {
		...
		monitorLifecycleSignal = opts.abortSignal ? AbortSignal.any([opts.abortSignal, clientLease.abortSignal]) : clientLease.abortSignal;
		...
		await Promise.race([waitUntilAbort(monitorLifecycleSignal, async () => {
			try {
