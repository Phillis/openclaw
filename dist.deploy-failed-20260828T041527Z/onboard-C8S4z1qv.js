...
import { rt as ConfigMutationConflictError, s as readConfigFileSnapshot } from "./io-ClLVsBMp.js";
...
import { o as normalizeTokenProviderInput } from "./provider-auth-input-BGFTRqyG.js";
import { n as t } from "./i18n-BQpjgFU-.js";
import { t as resolveGatewayStartupTiming } from "./gateway-startup-timing-D9NqKiRl.js";
import { n as applyWizardMetadata, o as handleReset, p as waitForGatewayReachable, s as normalizeGatewayTokenInput, t as DEFAULT_WORKSPACE } from "./onboard-helpers-DsV_5p6H.js";
import { o as resolveOnboardingAgentTarget, r as ensureOnboardingAgentWorkspace, s as resolveOnboardingSetupTarget } from "./onboard-agent-target-CwN0HHjK.js";
import { i as resolveProviderMatch } from "./provider-auth-choice-helpers-4t6D2PIl.js";
...
import { a as GENERIC_PROVIDER_AUTH_CHOICES, r as formatAuthChoiceChoicesForCli } from "./auth-choice-options-qs_3-EHk.js";
import { t as rejectOnboardingOption } from "./onboard-options-BiFqtCCq.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-DC0oIf6i.js";
import { t as resolvePluginProviders } from "./provider-auth-choice.runtime-C-Ufwr_d.js";
...
import { n as validateGatewayWebSocketUrl } from "./onboard-remote-CFYQy_AA.js";
...
import { t as runGuidedOnboarding } from "./onboard-guided-CKwRRbQ0.js";
...
import { n as runInteractiveSetup } from "./onboard-interactive-C3zkfMIe.js";
import { t as inferAuthChoiceFromFlags } from "./auth-choice-inference-Dn4vROpw.js";
import { t as resolveNonInteractiveApiKey } from "./api-keys-Woo7oGPB.js";
import { t as provisionGatewayTokenStoreRef } from "./auth-token-store-ref-CmDpJetf.js";
...
async function commitNonInteractiveOnboardConfig(params) {
	const { writeWizardConfigFile } = await import("./setup.shared-BmxuNf4x.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-9dHKkMXk.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-C47DflDz.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-yQo1pwLa.js");
	...
	if (!opts.skipHealth) {
		const { healthCommandNonExiting } = await import("./health-CK080YwI.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-HOW5hRvr.js");
...
async function setupWizardCommand(opts, runtime = defaultRuntime) {
	...
	if (normalizedOpts.agentName !== void 0) {
		const { validateFirstOnboardingAgentName } = await import("./onboard-agent-C0E5pT1w.js");
