...
import { _ as parseCanonicalIpAddress, c as isIpv4Address, d as isLinkLocalIpAddress, f as isLoopbackIpAddress, i as isCanonicalDottedDecimalIPv4, n as isBlockedSpecialUseIpv4Address, o as isCloudMetadataIpAddress, r as isBlockedSpecialUseIpv6Address, t as extractEmbeddedIpv4FromIpv6, u as isLegacyIpv4Literal, v as parseLooseIpAddress } from "./ip-Bc6HA4HC.js";
import { t as normalizeHostname } from "./hostname-_16721Le.js";
import { n as createHttp1EnvHttpProxyAgent, r as createHttp1ProxyAgent, t as createHttp1Agent } from "./undici-runtime-CWs3Ll9x.js";
...
function assertAllowedTrustedHostnameResolvedAddressesOrThrow(results, hostname) {
	...
	for (const entry of results) if (isUnspecifiedIpAddressIncludingEmbeddedIpv4(entry.address) || !isLoopbackAllowed && isLoopbackIpAddressIncludingEmbeddedIpv4(entry.address) || isBlockedTrustedResolvedIpv6Address(entry.address) || isLinkLocalIpAddress(entry.address) || isCloudMetadataIpAddress(entry.address)) throw new SsrFBlockedError(BLOCKED_RESOLVED_IP_MESSAGE);
}
