...
import { F as resolveTimerTimeoutMs, h as finiteSecondsToTimerSafeMilliseconds, j as resolveIntegerOption, n as MAX_TIMER_TIMEOUT_MS, o as asDateTimestampMs, w as parseStrictPositiveInteger } from "./number-coercion-CLj0HTDM.js";
...
import { O as resolveSessionAuthProfileOverrideSource, d as resolveAgentSkillsFilter, f as resolveAutoFallbackPrimaryProbe, h as resolveSessionAgentId, i as hasLegacyAutoFallbackWithoutOrigin, t as clearAutoFallbackPrimaryProbeSelection, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-DigoIwHb.js";
import { n as normalizeAgentId } from "./agent-id-CeT3w4ap.js";
import { f as resolveAgentWorkspaceDir, l as resolveAgentDir, r as listAgentEntries, s as resolveAgentConfig } from "./agent-scope-config-CUBiGmG3.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, n as isAcpSessionKey } from "./session-key-utils-Di3FvABa.js";
import { a as buildAgentMainSessionKey, u as normalizeMainKey } from "./session-key-Dbce_H9p.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-DNxmF3kK.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePathCore, o as resolveSessionStorePathCore } from "./paths-DVAvlIOc.js";
import { ft as resolveOwnerPromptNumbers, n as getRuntimeConfig } from "./io-ClLVsBMp.js";
...
import { a as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as isSilentReplyText } from "./tokens-DbQz-n_m.js";
...
import { l as readToolAllowlistIntersection, r as attachToolAllowlistIntersection } from "./tool-policy-shared-DmpG3HvD.js";
import "./tool-policy-B1rvCc4B.js";
import { c as resolveContextConfigProviderForRuntime } from "./openai-routing-Chr0R2hQ.js";
...
import { E as sessionEntryForkedFromParent, f as loadSessionEntry, w as resolveSessionStorePathForScope } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
...
import { c as normalizeSessionDeliveryState, d as sessionDeliveryOrigin, f as sessionDeliveryRoute, n as deliveryContextFromSession, o as normalizeDeliveryChannelRoute, r as deliveryContextKey, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-azPdmUls.js";
import { a as isInternalMessageChannel, d as isDeliverableMessageChannel } from "./message-channel-BZwx7FCw.js";
import { _ as runExclusiveSessionStoreWrite, b as resolveGroupSessionKey, c as interruptSessionWorkAdmissions, p as runExclusiveSessionLifecycleMutation } from "./session-lifecycle-admission-BtKN0pjk.js";
import { G as conversationIdentityFromMsgContext, K as conversationRouteContextFromMsgContext, gt as deriveSessionMetaPatch, lt as resolveProfileParticipantIdFromSessionCreation, st as buildSessionCreationStamp } from "./session-accessor.sqlite-entry-store-BIW-GrsF.js";
...
import { a as enqueueSystemEvent, m as selectAgentSystemEvents, t as consumeSelectedSystemEventEntries, u as peekSystemEventEntries } from "./system-events-BVZAS_Ok.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-gVK8DqPC.js";
import { h as resolveMaintenanceConfigFromInput } from "./disk-budget-NzkPcdhZ.js";
import { I as commitReplySessionInitialization, L as loadReplySessionInitializationSnapshot, ht as getCliSessionBinding, mt as clearAllCliSessions } from "./session-accessor-fcDZuc2H.js";
import { l as resolveAgentHarnessSessionContextError } from "./agent-harness-session-key-D9_Ct3Lx.js";
import { a as hasStagedMediaFacts, s as isImageMediaFact, u as normalizeMediaFacts } from "./media-facts-Bd6apMSF.js";
import { g as registerMainSessionGroupWatch, n as classifySessionStateActor, t as acknowledgeSessionStateNotices, u as recordSessionCreated, y as decodeSessionStateNoticeContextKey } from "./session-state-events-DvygRPJJ.js";
import { a as isSessionWorkStartInvalidatedError, o as resolveSessionLifecycleTimestamps, r as hasTerminalMainSessionTranscriptNewerThanRegistry, s as resolveSessionWorkStartError } from "./lifecycle-B13mO5hL.js";
...
import { m as fireAndForgetHook, t as getGlobalHookRunner } from "./hook-runner-global-CDBq1X4a.js";
import { f as markCommandReplyForDelivery, i as copyReplyPayloadMetadata, m as markReplyPayloadForSourceSuppressionDelivery } from "./reply-payload-BeeUJOmJ.js";
import { l as readChannelContextAdmissionEvidence, s as copyChannelParticipantAdmissionEvidence } from "./admission-evidence-C8iAKYLB.js";
...
import { a as formatSingleUnitDuration } from "./format-duration-CfGzOxKC.js";
import { n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-DLPyZXEW.js";
import { n as hasResolvedThinkingCatalogEntry, o as resolveEffectiveAgentRuntime } from "./thinking-runtime-DuqTHyA8.js";
import { g as isWorkspaceBootstrapPending, p as ensureAgentWorkspace } from "./workspace-DJ__UUS2.js";
...
import { a as isNativeCommandTurn, c as resolveCommandTurnContext, l as resolveCommandTurnTargetSessionKey, o as isTextSlashCommandTurn, r as isAuthorizedTextSlashCommandTurn } from "./command-turn-context-CmPEYNmV.js";
import { t as getSessionBindingService } from "./session-binding-service-47rBLtwF.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-CHAvu2jh.js";
import { t as hasControlCommand } from "./command-detection-CbcRbKE1.js";
import { i as isSyntheticSourceReplyTurn, r as isInternalSourceReplyChannel, t as isDirectedSourceReplyTurn } from "./source-reply-delivery-mode-a88lvIDJ.js";
import { n as resolveAgentTimeoutMs } from "./timeout-DlFI6Ssz.js";
import { R as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, _ as resolveActiveReplyRunThreadId, b as waitForReplyRunEndBySessionId, g as resolveActiveReplyRunSessionId, l as isReplyRunActiveForSessionId, m as replyRunRegistry, s as interruptReplyRunTarget } from "./reply-run-registry-Ch9Ye6re.js";
import { n as clearCommandLane, o as getQueueSize } from "./command-queue-CBS1Vl32.js";
import { i as normalizeInboundTextNewlines, t as finalizeInboundContext } from "./inbound-context-G3To7LaP.js";
import { a as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-yX5WzsUn.js";
import { i as toInternalMessagePreprocessedContext, n as deriveInboundMessageHookContext, s as toInternalMessageTranscribedContext } from "./message-hook-mappers-BwRPfaNj.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-1fHWm2yO.js";
import { t as resolveEffectiveToolFsRootExpansionAllowed } from "./tool-fs-policy-DwrFWb3k.js";
import { o as resolveReplyToMode } from "./reply-threading-Dbzi6VQA.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D-khMh6L.js";
import { dt as appendChannelPromptContext, mt as buildInboundMediaNoteProjection, s as isReasoningTagProvider } from "./builtin-openclaw-BruFLvIP.js";
import { B as normalizeExecTarget } from "./exec-approvals-PtbcLeQo.js";
...
import { i as isCommandBearingToolCall } from "./tool-display-Dsp8HXJK.js";
import { c as isChannelProgressDraftWorkToolName } from "./streaming-B93dETXe.js";
import { a as admitReplyTurn, l as resolveSilentReplySettings, n as createReplySessionEntryHandle, r as createReplyTimingTracker } from "./session-entry-handle-DYDOBc0W.js";
import { s as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-CJciJlgD.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, d as stageRemoteInboundMediaIfNeeded, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, p as getPreparedReplyDispatchRuntime, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as resolveSessionResetCommand } from "./typing-policy-RvEk_7n1.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-cn0iy209.js";
import { n as createInternalHookEvent, u as triggerInternalHook } from "./internal-hooks-CR02IMJl.js";
import { i as resolveTurnModelOverride, t as resolveSessionStableReplyMode } from "./session-stable-reply-mode-BEABm03G.js";
import { n as resolveRoutedDeliveryThreadId, t as isSlackDirectRoutedThreadTurn } from "./routed-delivery-thread-CjxoJPKz.js";
import { D as resolveBootstrapMode } from "./media-generation-task-status-IvC9SF2e.js";
import { c as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-CCQsDhUy.js";
import { t as resolveConversationCapabilityProfile } from "./conversation-capability-profile-D367C0tS.js";
import { l as retireSessionMcpRuntime } from "./agent-bundle-mcp-manager-api-1m62vMRl.js";
...
import { a as createUserTurnTranscriptRecorder, s as resolvePersistedUserTurnText } from "./user-turn-transcript-CMdiyjwP.js";
import { a as isModelSelectionLocked, n as MODEL_SELECTION_LOCKED_RESET_MESSAGE, r as ModelSelectionLockedError, t as MODEL_SELECTION_LOCKED_MESSAGE } from "./model-overrides-BcLzAaaZ.js";
import { a as resolveParentForkDecision, r as forkSessionFromParent } from "./session-fork-QEJxwfxN.js";
import { t as resolveFastModeState } from "./fast-mode-Dd78Dxbu.js";
import { M as normalizeQueueDropPolicy, N as normalizeQueueMode, a as getExistingFollowupQueue } from "./settings-CxUlx8Vr.js";
...
import { u as collectTextContentBlocks } from "./embedded-agent-tool-results-Chl9xQ-j.js";
import { l as buildFullBootstrapPromptLines, u as buildLimitedBootstrapPromptLines } from "./system-prompt-params-t7OsKmV3.js";
...
import { b as updateAmbientTranscriptWatermark } from "./session-store-runtime-ZfR7yV2q.js";
import { n as buildMainSessionRecoveryClearPatch } from "./main-session-recovery-clear-H7IP1700.js";
import { i as isExecCompletionEvent } from "./heartbeat-events-filter-Cumrha5E.js";
import { a as resolveTimezone, n as formatUtcTimestamp, r as formatZonedTimestamp } from "./format-datetime-Bp7Mn3G9.js";
import { i as runWithCronCreatorAuthorityCapability, r as createCronCreatorAuthorityCapability, s as shouldAdmitFreshChannelOwnerCronAuthority } from "./cron-creator-authority-context-T9-l7dcu.js";
...
import { t as resolveQueueSettings } from "./queue-C5hWHBtI.js";
import { r as resolveIngressWorkspaceOverrideForSessionRun } from "./spawned-context-CcwhpB50.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-BGopmbug.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-RpHRaaRj.js";
...
import { n as recoverTerminalSessionEntryForVisibleTurn, t as isRecoverableTerminalSessionStatus } from "./terminal-status-Z4Z1U4Xa.js";
import { n as resolveEffectiveReplyRoute, t as isSystemEventProvider } from "./effective-reply-route-Dgd-ri1U.js";
import { n as hasInboundMedia, r as hasInboundMediaForUnderstanding, t as hasInboundAudio } from "./inbound-media-DouEFDOg.js";
...
import { n as shouldHandleTextCommands } from "./commands-text-routing-5R5_GIoR.js";
import { a as stripMentions, o as stripStructuralPrefixes } from "./mentions-BHWGvP4S.js";
import { n as shouldUseFromAsSenderFallback } from "./command-auth-Cc49F07l.js";
...
import { a as resolveEnvelopeFormatOptions } from "./envelope-CiUE0My_.js";
import { i as runWithSessionInitConflictRetry, r as ReplySessionInitConflictError, t as getReplySystemEventSessionKey } from "./system-event-session-key-p6YUiR0j.js";
...
import { i as resolveActiveExplicitSteerSessionKey, n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-Y8verrA6.js";
import { a as hasSkillReferenceCandidate, i as expandExplicitSkillReferences, o as listReservedChatSlashCommandNames, r as expandBundleCommandPromptTemplate, s as resolveSkillCommandInvocation } from "./chat-commands-BaNyIk3G.js";
import { t as resolveBlockStreamingChunking } from "./block-streaming-DYYu1ngr.js";
import { t as buildCommandContext } from "./commands-context-DUiCwk_8.js";
import { n as resolveStickyModelSelectionScope } from "./sticky-model-selection-ChH_TCbX.js";
import { n as resolveModelRuntimeDirective } from "./directive-handling.model-runtime-Demtae7-.js";
import { _ as maybeHandleUnexpectedNativeDirectiveArguments, f as formatModelSelectionScopeAck, v as resolveModelSelectionFromDirective } from "./directive-handling.shared-CFQP18eu.js";
import { n as resolveSessionAuthSelection } from "./session-override-LTIDP5EY.js";
import { n as createModelSelectionState, r as isStaleHeartbeatAutoFallbackOverride, t as createFastTestModelSelectionState } from "./model-selection-D85solqZ.js";
import { t as resolveContextTokens } from "./model-selection-context-B1L_QCkZ.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-BFkTUj0F.js";
...
import { n as resolvePreparedReplyQueueState, t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-Bmv2zHLu.js";
import { i as resolveActiveRunQueueAction, r as resolveTypingMode, t as resolveCurrentTurnImages } from "./current-turn-images-BSUG6s1n.js";
import { t as buildChannelSummary } from "./channel-summary-Cxb5MmGW.js";
import { a as resolveInboundUserContextPromptJoiner, n as buildInboundUserContextPrefix, r as formatActiveGoalContext, t as buildInboundMetaSystemPrompt } from "./inbound-meta-CdaYvuyM.js";
import { n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContextAsync } from "./tools-effective-inventory-9OS7ryTy.js";
import { n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-BxqsjgLX.js";
import { t as PROGRESS_STATUS_PREAMBLE_FRESH_MS } from "./progress-draft-compositor-FOAJU_0Z.js";
import { a as sanitizeProgressStatusText } from "./progress-draft-status-text-Byjyp5X9.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-qFybcCBn.js";
import { t as emitSessionAutoResetHook } from "./session-auto-reset-BMWrLBEe.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-DtK_eby6.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-BjPt53o-.js";
import { t as clearSessionResetRuntimeState } from "./session-reset-cleanup-DtVmfodB.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-Ce3FVFYD.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-KWGBLWuk.js"));
...
async function applyInlineDirectiveOverrides(params) {
	...
	if (directives.modelScopeConflict) {
		...
		return {
			kind: "reply",
			reply: {
				text: "Use only one model scope option.",
				isError: true
			}
		};
	}
...
function getStandaloneSlashCommandName(body) {
	return normalizeOptionalLowercaseString(body.trim().match(/^\/([^\s/:]+)(?::|\s|$)/u)?.[1]) ?? null;
}
...
async function resolveReplyDirectives(params) {
	...
	const skillCommands = canInterpretTextDirectives && (rawAliases.length > 0 || hasSkillReferences) ? (await loadSkillCommands()).listSkillCommandsForWorkspace({
		...skillCommandContext,
		skillFilter
	}) : [];
	...
	const allSkillCommands = hasSkillReferences && skillFilter !== void 0 ? (await loadSkillCommands()).listSkillCommandsForWorkspace({
		...skillCommandContext,
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-a-Jld0r4.js"));
const abortCutoffRuntimeLoader = createLazyImportLoader(() => import("./abort-cutoff.runtime.js"));
const commandsRuntimeLoader$1 = createLazyImportLoader(() => import("./commands.runtime-DMbGbJEB.js"));
...
async function handleInlineActions(params) {
	...
	const allSkillCommands = allowTextCommands && (hasSkillReferences || hasSkillSlashCandidate) && skillFilter !== void 0 ? (await loadSkillCommandsRuntime$1()).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		sessionEntry: targetSessionEntry,
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const dependencies = params.skillToolDispatchDependencies ?? await import("./openclaw-tools-Bdsgijz0.js");
		...
		if (skillInvocation.command.promptTemplate) {
			const rewrittenBody = expandBundleCommandPromptTemplate(skillInvocation.command.promptTemplate, skillInvocation.args);
	...
	const inlineCommand = allowTextCommands && command.isAuthorizedSender && !hasExplicitSkillReferences ? extractInlineSimpleCommand(cleanedBody) : null;
	if (inlineCommand) {
	...
	if (!(!hasExplicitSkillReferences && (inlineCommand !== null || directiveAck !== void 0 || inlineStatusRequested || command.commandBodyNormalized.trim().startsWith("/")))) return {
		kind: "continue",
		directives,
		abortedLastRun,
		cleanedBody,
...
const commandsRuntimeLoader = createLazyImportLoader(() => import("./commands.runtime-DMbGbJEB.js"));
const skillCommandsRuntimeLoader = createLazyImportLoader(() => import("./chat-commands.runtime.js"));
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-D-kpkrNt.js"));
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent.runtime-C-xpnnJF.js"));
...
async function prepareReplyRunAdmission(context) {
	...
	const skillResult = isFastTestRuntimeEnv() ? {
		...
		return await ensureSkillSnapshot({
			...
			executionSkillsDir: path.join(sessionEntry?.worktree?.canonicalWorkspaceDir ?? context.workspaceDir, "skills"),
			cfg,
	...
	if (activeRunQueueMode === "interrupt" && !isRoomEvent && sessionLaneKey && (laneSize > 0 || activeSessionIdForInterrupt)) logVerbose(`Cleared ${clearCommandLane(sessionLaneKey)} queued command(s) before interrupting ${sessionLaneKey}`);
...
const sessionAccessorRuntimeLoader = createLazyImportLoader(() => import("./session-accessor-Bk0UAFho.js"));
...
async function prepareReplyRunContext(params) {
	...
	const allowEmptyAssistantReplyAsSilent = isGroupChat && !isDirectedTurn && (isAmbientRoomEvent || silentReplySettings.policy === "allow");
	const terminalReplyExpectation = isHeartbeat ? void 0 : isAmbientRoomEvent ? "optional" : "required";
...
async function runPreparedReply(params) {
	...
	const { acquireAgentRunPreparedModelRuntime } = await import("./prepared-model-runtime-CoQq9Qra.js");
	...
	try {
		return await withPreparedModelRuntimePluginGenerationScope(dispatchRuntime.pluginGeneration, () => withPluginRuntimeGenerationScope(lease.snapshot, () => executePreparedReplyContext(context)), () => leaseActive ? lease.snapshot : void 0);
	} finally {
		leaseActive = false;
		lease.release();
	}
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-B8RybCwQ.js"), { cacheRejections: true }).load;
...
async function initSessionStateAttemptLocked(params, attemptContext, staleSnapshotRetried, lifecycleMutationIdentity) {
	...
	if (!isSystemEvent && !isInterSession) {
		...
		const participant = profileParticipantId ? {
			actor: {
				type: "human",
				id: profileParticipantId
			},
			source: "profile"
		...
		if (participant) recordSessionParticipantBestEffort({
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, 300).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-Bk0UAFho.js");
