...
import { o as mergeRestartRecoveryTerminalRunIds } from "./restart-recovery-state-6FYlAu33.js";
...
function projectMainSessionRecoveryLifecycle(params) {
	...
	if (settlesRecovery) {
		...
		if (params.entry?.abortedLastRun === true && !foreground.claimId && !foreground.hasCurrentOwner) return apply({ restartRecoveryRuns: remaining?.length ? remaining : void 0 });
