...
import { I as validateMSTeamsProactiveServiceUrlBoundary, N as normalizeBotFrameworkServiceUrl, O as buildUserAgent, ct as withMSTeamsRequestDeadline, ot as resolveMSTeamsSharePointUploadTimeoutMs, st as withMSTeamsAbortableRequestTimeout } from "./inbound-Clg3k_wg.js";
import { c as createMSTeamsHttpError } from "./oauth.token-B6jJorZn.js";
import { a as isRevokedProxyError, t as classifyMSTeamsSendError } from "./errors-wR6Jg-1j.js";
import { C as toPluginJsonValue, S as resolveMSTeamsSqliteStateEnv, w as withMSTeamsSqliteMutationLock } from "./polls-DmtubpOT.js";
...
const loadMSTeamsApiModule = createLazyRuntimeModule(() => import("./dist-Dh647XX2.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)));
...
async function sendMSTeamsMessages(params) {
	...
	const sendWithRetry = async (sendOnce, meta) => {
		...
		return await retryAsync(sendOnce, {
			...
			delayMs: ({ attempt, err }) => computeRetryDelayMs(attempt, classifyMSTeamsSendError(err), retryOptions),
	...
	const sendMessageInContext = async (sendFn, message, messageIndex) => {
		...
		try {
			response = await sendWithRetry(async () => {
				activity ??= await buildActivity(message, params.conversationRef, params.tokenProvider, params.sharePointSiteId, params.mediaMaxBytes, { feedbackLoopEnabled: params.feedbackLoopEnabled });
...
//#endregion
export { buildFileInfoCard as C, setPendingUploadActivityIdFs as S, uploadToConsentUrl as T, getPendingUpload as _, sendMSTeamsActivityWithReference as a, getPendingUploadFs as b, extractFilename as c, requireMSTeamsSharePointSiteId as d, uploadAndShareSharePoint as f, requiresFileConsent as g, prepareFileConsentActivityFs as h, deleteMSTeamsActivityWithReference as i, extractMessageId as l, formatMSTeamsMarkdown as m, renderReplyPayloadsToMessages as n, updateMSTeamsActivityWithReference as o, buildTeamsFileInfoCard as p, sendMSTeamsMessages as r, withRevokedProxyFallback as s, buildConversationReference as t, getDriveItemProperties as u, removePendingUpload as v, parseFileConsentInvoke as w, removePendingUploadFs as x, setPendingUploadActivityId as y };
