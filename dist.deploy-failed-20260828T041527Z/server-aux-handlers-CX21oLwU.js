...
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-contributions-JopjOY3b.js";
import "./plugin-registry-BcpcjwxL.js";
import { t as cloneConfigWithResolutionFacts } from "./resolution-facts-DIK_QG79.js";
import { g as registerAgentRunDelegatedAuthorityClosedHandler } from "./agent-run-registry-t4kvUyNQ.js";
import { f as assertExpectedResolvedSecretValue, i as createResolverContext } from "./runtime-shared-BoNGt4zS.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-query-DREoZp4g.js";
import { i as setPathExistingStrict } from "./path-utils-3GsAyGhZ.js";
import "./target-registry-CGWcufp7.js";
import "./config-B_0xOnKq.js";
import { n as resolveSecretRefValue } from "./resolve-DvvnAG2w.js";
...
import { r as sanitizeExecApprovalWarningText } from "./exec-approval-text-sanitize-B7KSiT_n.js";
import { c as buildPluginApprovalExpiredMessage, l as buildPluginApprovalRequestMessage, s as approvalDecisionLabel } from "./plugin-approvals-DzVTK3Ht.js";
import { t as resolveCanonicalPluginApprovalRequestAllowedDecisions } from "./plugin-approval-canonical-decisions-D5YYHwBx.js";
import { M as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-PtbcLeQo.js";
import { c as getActiveSecretsRuntimeSnapshotRevisionState, l as getActiveSecretsRuntimeSnapshotState, o as getActiveSecretsRuntimeEnvState } from "./runtime-state-B9BywrOx.js";
import { t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-DTi5pRh_.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-GehxVRcO.js";
import { c as listDevicePairing, i as hasEffectivePairedDeviceRole } from "./device-pairing-BIRweQsd.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-fSalMZ5e.js";
import { f as formatExecApprovalExpiresIn } from "./exec-approval-reply-Dax3JT_s.js";
import { a as buildTypedApprovalPendingReplyPayload, i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, o as buildTypedPluginApprovalPendingReplyPayload } from "./approval-renderers-BlWA2qKe.js";
...
import { f as pruneTerminalOperatorApprovals, n as closeOrphanedOperatorApprovals } from "./operator-approval-store-CQ2Uh4i5.js";
import { g as resolveApnsRelayConfigFromEnv, i as clearApnsRegistrationIfCurrent, l as loadApnsRegistrations } from "./push-apns-store-DS8y3eSZ.js";
import { t as resolveApprovalSessionAudienceWithFallback } from "./approval-session-audience-CM6mIVw7.js";
import { t as SYSTEM_AGENT_APPROVAL_DECISIONS } from "./system-agent-approvals-BczGX_94.js";
import { a as sendApnsPluginApprovalAlert, c as resolveApnsAuthConfigFromEnv, i as sendApnsExecApprovalResolvedWake, o as sendApnsPluginApprovalResolvedWake, r as sendApnsExecApprovalAlert, s as shouldClearStoredApnsRegistration } from "./push-apns-AJ_r9hqj.js";
import { n as ExecApprovalManager } from "./exec-approval-manager-D3AEYJmr.js";
import { t as QuestionManager } from "./question-manager-DAwr3A8G.js";
import { t as publishAppliedApprovalResolution } from "./approval-publication-BQ4U842Y.js";
import { _ as sameWorkerSessionTurnClaim } from "./placement-record-nLiaHmTd.js";
...
async function activateSnapshotIfCurrent(snapshot, expectedRevision, options) {
	...
	if (!options.canActivate() || !runtime.activateSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision)) return null;
	options.onActivated();
	return runtime.getActiveSecretsRuntimeSnapshotRevision();
}
async function restoreSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, onActivated) {
	if ((await import("./runtime-CN0H92il.js")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot)) onActivated();
}
		...
		try {
			for (;;) {
				...
				const claimGeneration = () => {
					...
					generationOwnership = claimSharedGatewaySessionGenerationIfOwned(params.sharedGatewaySessionGenerationState, previousOwnership, nextGeneration);
				};
				...
				if (activateIfCurrent) {
					...
					publishedSnapshotRevision = await activateSnapshotIfCurrent(prepared, previousRevision, {
			...
			const { prepared, plan, credentialOwners, generationOwnership, nextGeneration } = transaction;
			if (transaction.generationChanged) disconnectStaleSharedGatewayAuthClients({
			...
			if (generationRestored && transaction?.generationChanged) disconnectStaleSharedGatewayAuthClients({
				clients: params.clients,
...
function createGatewayAuxHandlers(params) {
	...
	const createApprovalManager = (approvalKind, resolveAllowedDecisions, resolveStandingGrantMint) => new ExecApprovalManager({
		approvalKind,
		...
		onExpired: (record, liveRecord) => {
			if (approvalKind === "system-agent") return;
			publishAuthorityClosure({
				kind: approvalKind,
				record,
				liveRecord
			});
	...
	const loadExecApprovalHandlers = createLazyPromise(() => import("./exec-approval-Do1b96Gu.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: execApprovalIosPushDelivery
	})), { cacheRejections: true });
	const reloadSecrets = createGatewaySecretsReloader(params);
	const loadSecretsModule = createLazyPromise(() => import("./secrets-CDk2FXIA.js"), { cacheRejections: true });
	...
	const loadQuestionHandlers = createLazyPromise(async () => {
		const [{ createQuestionHandlers }, storeWriteService] = await Promise.all([import("./question-DnA5UC9h.js"), loadSecretStoreWriteService()]);
	...
	const loadPluginApprovalHandlers = createLazyPromise(() => import("./plugin-approval-ABIvq3CP.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: pluginApprovalIosPushDelivery
	})), { cacheRejections: true });
	const loadApprovalHandlers = createLazyPromise(() => import("./approval-BJx9ZBrx.js").then(({ createApprovalHandlers }) => createApprovalHandlers({
		execApprovalManager,
