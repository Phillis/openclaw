...
import { a as resolveCliRuntimeCanonicalProvider, i as resolveCliBackendConfig } from "./cli-backends-TpSzxqso.js";
...
import { i as preparedAgentRuntimeProfileAttemptHasCandidate, n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-bvGF5XWf.js";
import { r as resolveModelWithRegistry } from "./model-S0ufJtGi.js";
...
import { r as scopeAuthProfileStoreToPreparedPlan } from "./resolve-auth-DXBV7Auc.js";
...
async function resolveHarness(runtime) {
	if (runtime === "openclaw") {
		const { createOpenClawAgentHarness } = await import("./builtin-openclaw-CmuyIocs.js");
