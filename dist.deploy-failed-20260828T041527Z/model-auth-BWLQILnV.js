...
import { c as isNonSecretApiKeyMarker, g as resolveProviderEnvAuthLookupMaps, n as CUSTOM_LOCAL_AUTH_MARKER, u as isSecretRefHeaderValueMarker } from "./model-auth-markers-Dy2BML3M.js";
import { o as getModelProviderRequestTransport, r as attachModelProviderRequestTransport } from "./provider-request-config-ClkR7QK5.js";
import { d as resolveOwningPluginIdsForProviderRef } from "./providers-BY0gR-NY.js";
import { D as resolveProviderSyntheticAuthWithPlugin, F as shouldDeferProviderSyntheticProfileAuthWithPlugin, S as resolveProviderDeprecatedAuthProfileIds, i as buildProviderMissingAuthMessageWithPlugin } from "./provider-runtime-DERww3Gm.js";
import { n as readCodexCliCredentialsCached } from "./cli-credentials-DZ9rGNcm.js";
import { r as assertAuthProfileMigrationReady } from "./legacy-source-diagnostic-SYdrQUmo.js";
...
import { C as sentinelizeSecretRefProfileApiKey, S as sentinelizeConfigSecretRefEnvApiKey, T as shouldUseImplicitAwsSdkAuth, _ as resolveProviderAuthOverride, a as hasSyntheticLocalProviderAuthConfig, b as resolveProviderEntryApiKeyProfileReference, c as isManagedSecretRefApiKeyMarker, d as resolveAwsSdkAuthInfo, f as resolveConfigAwareEnvApiKey, h as resolveInlineProviderApiKeyCooldownUntil, i as hasSecretRefProviderApiKey, l as profileTypeToAuthMode, m as resolveDirectProviderCredentialMode, o as hasUsableCustomProviderApiKey, p as resolveConfiguredAwsSdkProfileAuth, s as isConfigBackedInlineProviderApiKey, t as assertInlineProviderApiKeyUsable, u as providerConfigMatchesRuntimeSnapshot, v as resolveProviderConfig, w as shouldPreferExplicitConfigApiKeyAuth, x as resolveUsableCustomProviderApiKey, y as resolveProviderEntryApiKeyBinding } from "./model-auth-provider-config-6V9HXTpM.js";
import { n as resolveManagedSecretRefRuntimeProviderAuth, t as assertRuntimeProviderSecretOwnerAvailable } from "./model-auth-runtime-config-BIltN2rn.js";
...
async function resolveApiKeyForProviderCore(params) {
	...
	if ("profileId" in providerEntryReference) assertAuthProfileNotRetired({
