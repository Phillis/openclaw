...
import { f as resolveAgentWorkspaceDir, h as resolveDefaultAgentDir, p as resolveAmbientOwnerAgentId } from "./agent-scope-config-CUBiGmG3.js";
...
import { a as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-D4yx0hwT.js";
import { n as resolveCatalogOwnedModelCompat } from "./model-compat-catalog-BNBUeFnX.js";
import { p as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-DbjoXfPH.js";
import { s as projectConfigOntoRuntimeSourceSnapshot } from "./provider-model-route-n5WsvCIn.js";
import { o as createConfigRuntimeEnv } from "./config-env-vars-C_yEEhJa.js";
import "./env-vars-B2e3bjCN.js";
import { c as getRuntimeConfigSourceSnapshot, u as hashRuntimeConfigValue } from "./runtime-snapshot-Cv5MaU8U.js";
...
import { c as isNonSecretApiKeyMarker, d as resolveEnvSecretRefHeaderValueMarker, f as resolveNonEnvSecretRefApiKeyMarker, p as resolveNonEnvSecretRefHeaderValueMarker } from "./model-auth-markers-Dy2BML3M.js";
import { d as resolveOwningPluginIdsForProviderRef } from "./providers-BY0gR-NY.js";
import { d as normalizeProviderConfigWithPlugin, x as resolveProviderConfigApiKeyWithPlugin } from "./provider-runtime-DERww3Gm.js";
...
import { d as PLUGIN_MODEL_CATALOG_GENERATED_BY, f as repairPluginModelCatalogTransportMetadata, i as isGeneratedPluginModelCatalog, l as replacePersistedPluginModelCatalogs, n as encodePluginModelCatalogRelativePath, o as loadPersistedPluginModelCatalogs, s as loadPersistedPluginModelCatalogsReadOnly, t as decodePluginModelCatalogRelativePathPluginId, u as resolvePluginModelCatalogOwnerPluginId } from "./plugin-model-catalog-CbWF58Ep.js";
import { a as runProviderCatalog, i as resolveRuntimePluginDiscoveryProviders, n as normalizePluginDiscoveryResult, o as runProviderStaticCatalog, r as prepareProviderStaticCatalog, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-nclfrL6H.js";
import { a as normalizeConfiguredProviderApiKey, c as resolveApiKeyFromProfiles, l as resolveMissingProviderApiKey, o as normalizeHeaderValues, r as createProviderAuthResolver, s as normalizeResolvedEnvApiKey, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-BIMMK2iz.js";
...
function mergeProviderModels(implicit, explicit) {
	...
	const mergedModels = explicitModels.map((explicitModel) => {
		...
		const maxTokens = asPositiveFiniteNumber(explicitModel.maxTokens) ?? asPositiveFiniteNumber(implicitModel.maxTokens);
