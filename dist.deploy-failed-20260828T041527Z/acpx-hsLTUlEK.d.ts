import { A as TalkProviderConfig, At as MarkdownTableMode$1, B as TelegramNetworkConfig$1, C as ThinkingLevelMap, Ct as ContextVisibilityMode, D as UserMessage, E as Usage, Et as GroupPolicy, F as TelegramActionConfig$1, Ft as AgentModelConfig, H as ChannelImplicitMentionsConfig, Ht as SilentReplyConversationType, I as TelegramDirectConfig, It as SandboxDockerSettings, Lt as SecretInput, Mt as SessionMaintenanceMode, Nt as SessionScope, O as McpCodexToolApprovalMode, Ot as HumanDelayConfig, P as TelegramAccountConfig$1, Pt as ChatType, R as TelegramGroupConfig, Rt as SecretRef, S as ThinkingLevel, St as MemorySearchResult, T as ToolResultMessage, Tt as DmScope, Ut as FastMode, V as TelegramTopicConfig, _ as Model, _t as MemoryCitationsMode, a as ModelCompatConfig, at as ResolvedTtsPersona, b as StreamOptions, bt as MemoryReadResult, c as ModelProviderAuthMode, ct as TtsMode, d as Api, f as AssistantMessage, ft as GroupToolPolicyConfig, g as Message$1, gt as QueueMode, h as ImageContent$1, ht as MentionPatternsPolicyConfig, i as ModelApi, j as OperatorScope, jt as ReplyToMode, k as McpServerToolFilterConfig, kt as IdentityConfig, l as ModelProviderConfig, lt as TtsModelOverrideConfig, m as Context, mt as SafeBinProfileFixture, n as OpenClawConfig, o as ModelDefinitionConfig, ot as TtsAutoMode, p as AssistantMessageEventStreamContract, pt as ToolLoopDetectionConfig, s as ModelMediaInputConfig, st as TtsConfig, t as ConfigFileSnapshot, ut as TtsProvider, v as SimpleStreamOptions, vt as LegacyMemoryReadResult, wt as DmPolicy, x as TextContent, xt as MemorySearchManager, yt as MemoryOriginClass } from "./types.openclaw-n6JIVcIK.js";
import "./types-CebnZ6B4.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./config-contracts-B5xWKcfz.js";
import { A as SessionPlacementRunner, B as WorkerEnvironmentState, C as PortalSummary, D as SessionsCompanionStateResult, E as SessionsCompanionAskResult, F as QuestionResolvedEvent, G as ToolsGitHubAuthorizeStartResult, H as SystemAgentChatQuestion, I as QuestionWaitAnswerResult, J as SessionsCatalogArchiveParams, K as AgentWaitParams, L as NodePluginToolDescriptor, M as QuestionAnswers, N as QuestionRecord, O as SessionMoveTarget, P as QuestionResolveResult, Q as SessionPermissionMode, R as NodeSkillDescriptor, S as PortalOpenResult, T as SessionObserverDigest, U as SystemAgentWizardCancel, V as WorkerTunnelStatus, W as ToolsGitHubAuthorizePollResult, X as SessionsCatalogReadParams, Y as SessionsCatalogContinueParams, Z as SessionsCatalogReadResult, _ as ChannelRouteRef, a as SessionEntry$1, at as WorkerConnectParams, b as WizardAnswer, c as SessionSystemPromptReport, ct as SessionGitHubPublicationResult, d as SessionCreatedActor, dt as ErrorShape, et as WorkerInferenceModelRef, f as SessionCreatedVia, ft as RequestFrame, g as DeliveryContext, h as SourceReplyDeliveryMode, i as SessionContextBudgetStatus, it as SessionApprovalReplay, j as Question, k as SessionPlacementDiskSpace, lt as SessionGitHubPublishParams, mt as ChatChannelId, n as GroupKeyResolution, nt as ApprovalPresentation, o as SessionPluginJsonValue, ot as WorkerTranscriptCommitParams, pt as ChannelId$1, q as SessionCatalogHost, s as SessionToolOverrides, st as WorkerTranscriptMessage, t as CliSessionBinding, tt as WorkerInferenceOptions, u as SourceInfo, ut as ConnectParams, v as CronScheduledToolCallerOrigin, w as Snapshot, x as WizardStep$1, y as CronScheduledToolPolicy, z as ScopeUpgradeResult } from "./types-CfTnTG4l.js";
import { i as PluginStateSyncKeyedStore, r as PluginStateKeyedStore, t as OpenKeyedStoreOptions } from "./channel-contract-DsIFrPEf.js";
import { A as UnifiedModelCatalogEntry, D as JsonSchemaObject, E as ChannelConfigUiHint, O as ModelCatalogContextWindowOption, T as ChannelConfigSchema, _ as PluginManifestContracts, a as PluginOrigin$1, b as PluginManifestDashboardDataBinding, f as RuntimeEnv, g as PluginFormat, h as PluginDiagnostic, i as PluginDependencyStatus, j as UnifiedModelCatalogKind, k as ModelCatalogStatus, m as PluginConfigUiHint, p as PluginBundleFormat, t as PluginManifestRecord, v as PluginManifestDashboard, w as PluginKind, x as PluginManifestMcpServer, y as PluginManifestDashboardActionVerb } from "./manifest-registry-CMV4LCJ1.js";
import { $t as ReplyPayload$1, A as chunkByNewline, At as TaskSuggestionDeliveryMode, B as ChannelRuntimeSurface, Bt as HistoryEntry, Cn as CustomMessage, Ct as MsgContext, D as ChannelOutboundAdapter, Dt as BlockReplyContext, E as ChannelDeliveryCapabilities, Et as SupplementalContextFacts, F as resolveChunkMode, Ft as TranscriptTurnAdmission, G as BaseTokenResolution, Gt as PluginHookChannelContext, H as buildAgentSessionKey, Ht as CommandTurnContext, I as resolveTextChunkLimit, It as TranscriptTurnBoundary, Jt as PromptImageOrderEntry, K as ChannelAccountSnapshot, Kt as LegacyMediaContextKey, L as OutboundDeliveryResult, Lt as AgentPlanStep, M as chunkMarkdownTextWithMode, Mt as UserTurnInput, N as chunkText, Nt as UserTurnTranscriptRecorder, O as OutboundIdentity, Ot as GetReplyOptions, P as chunkTextWithMode, Pt as TranscriptEntryAnchor, Qt as ReplyMediaAttachment, R as OutboundPayloadDeliveryOutcome, Rt as ExecutionIdentityAdmissionFacts, Sn as BashExecutionMessage, St as MentionSource, T as ChannelPairingAdapter, Tn as ToolExecutionMode, Tt as SessionTranscriptContext, U as resolveAgentRoute, Ut as CommandTurnKind, V as SecurityAuditFinding, Vt as HistoryMediaEntry, W as BaseProbeResult, Wt as InputProvenance, Xt as mediaKindFromMime, Yt as MediaKind, Zt as InboundEventKind, _n as CompactionResult, _t as OutboundMediaAccess, an as PluginApprovalRequest$1, bn as AgentToolResult, bt as FinalizedRuntimeMsgContext, cn as ExecApprovalRequest, dn as ExecMode, dt as MessageReceipt, en as LegacyInteractiveReply, et as ChannelMessageActionAdapter, fn as ExecSecurity, ft as OutboundReplyFacts, gn as OutboundLocation, gt as OutboundSendDeps, hn as NormalizedLocation, i as WizardPrompter, in as ChannelApprovalKind, j as chunkMarkdownText, jt as TurnAdoptionLifecycle, k as OutboundDeliveryFormattingOptions, kt as PartialReplyPayload, ln as ExecApprovalRequestPayload$1, lt as ConversationReadInvocationOrigin, mn as ApprovalScope, mt as PollInput, nn as MessagePresentationAction, nt as ChannelMeta, on as PluginApprovalRequestPayload, pn as ExecTarget, pt as RenderedMessageBatchPlanItem, qt as MediaFact, rn as ReplyPayloadDelivery, rt as ChannelOutboundTargetMode, sn as ExecApprovalDecision, st as ChannelThreadingToolContext, tn as MessagePresentation, un as ExecAsk, vn as AgentMessage, vt as OutboundMediaReadFile, wn as StreamFn, wt as OriginatingChannelType, xn as AgentToolUpdateCallback, xt as InboundSourceModality, yn as AgentTool, yt as FinalizedMsgContext, z as OutboundPayloadDeliverySuppressionReason, zt as ExecutionIdentityAdmissionToken } from "./setup-wizard-types-CEvwzrXW.js";
import { i as PluginCompatCode, n as PluginMetadataSnapshot, r as PluginMetadataSnapshotOwnerMaps, t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-C7uTO9qD.js";
import { n as ConfigReplaceResult, r as ConfigWriteAfterWrite, t as resolveStateDir } from "./config-C7SD4JcX.js";
import { a as StructuredExtractionInput, c as MediaUnderstandingOutput, i as MediaUnderstandingProvider, r as MediaUnderstandingDecision } from "./types-CHof3Xw6.js";
import { i as OAuthCredential$1, n as AuthProfileCredential, r as AuthProfileStore, t as ApiKeyCredential$1 } from "./types-DPIbwdZr.js";
import { n as ChannelPlugin$3 } from "./types.public-DIsDeD7m.js";
import { n as PinnedDispatcherPolicy, r as SsrFPolicy, t as LookupFn } from "./ssrf-CTfgAjkq.js";
import { a as ImageGenerationOutputFormat, c as ImageGenerationQuality, i as ImageGenerationNormalization, l as ImageGenerationResolution, n as ImageGenerationBackground, o as ImageGenerationProvider, r as ImageGenerationIgnoredOverride, s as ImageGenerationProviderOptions, t as GeneratedImageAsset, u as ImageGenerationSourceImage } from "./types-DpxLG9Fk.js";
import { a as MusicGenerationProvider, i as MusicGenerationOutputFormat, n as MusicGenerationIgnoredOverride, o as MusicGenerationSourceImage, r as MusicGenerationNormalization, t as GeneratedMusicAsset } from "./types-BoC-M1EP.js";
import { a as VideoGenerationResolution, i as VideoGenerationProvider, n as VideoGenerationIgnoredOverride, o as VideoGenerationSourceAsset, r as VideoGenerationNormalization, t as GeneratedVideoAsset } from "./types-DXESD2RB.js";
import "./runtime-env-BaxUg6ql.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-B67tGHJd.js";
import { _ as SkillUsagePath, a as CronRunStatus, c as CronRuntimeAuthority, d as resolveAgentWorkspaceDir, f as FailoverReason, g as SkillTelemetrySource, h as SkillSnapshot, i as CronPayload, l as NormalizeReplySkipReason, m as SkillEligibilityContext, n as CronJobCreate, o as CronStoredJob, p as ExplicitSkillSelection, r as CronJobPatch, s as CronToolsAllowProvenance, t as CronJob, u as resolveAgentDir } from "./install-security-scan.types-CxpXvLQ-.js";
import "./image-runtime-kL63dEVT.js";
...
type VideoContent = Omit<ImageContent$1, "type"> & {
  type: "video";
};
type MediaContent = ImageContent$1 | VideoContent;
...
declare function resolveTelegramTransport(proxyFetch?: typeof fetch, options?: {
  network?: TelegramNetworkConfig$1;
}): TelegramTransport;
...
declare function resolveTelegramAccountConfig(cfg: OpenClawConfig, accountId: string): TelegramAccountConfig$1 | undefined;
declare function mergeTelegramAccountConfig(cfg: OpenClawConfig, accountId: string): TelegramAccountConfig$1;
//#endregion
...
type ResolvedTelegramAccount = {
  ...
  config: TelegramAccountConfig$1;
};
...
declare function createTelegramActionGate(params: {
  cfg: OpenClawConfig;
  accountId?: string | null;
}): (key: keyof TelegramActionConfig$1, defaultValue?: boolean) => boolean;
...
declare function resolveTelegramPollActionGateState(isActionEnabled: (key: keyof TelegramActionConfig$1, defaultValue?: boolean) => boolean): TelegramPollActionGateState;
...
declare class SessionManagerEntries extends SessionManagerPersistence {
  ...
  appendMessage(message: Message$1 | CustomMessage | BashExecutionMessage, options?: AppendPersistenceOptions): string;
  appendMessageWithTranscriptAnchor(message: Message$1 | CustomMessage | BashExecutionMessage, options?: AppendPersistenceOptions): {
    entryId: string;
    anchor?: TranscriptEntryAnchor;
  };
...
declare class SessionManager extends SessionManagerBranching {
  ...
  static appendMessageToTranscript(target: SessionTranscriptRuntimeTarget, message: Message$1 | CustomMessage | BashExecutionMessage, options?: Pick<AppendPersistenceOptions, "config">): string;
  ...
  status: (agentId: string, selectedScope: GitHubIdentityScope) => Promise<{
    ...
    selected: {
      ...
      identity: {
        ...
        credentialState: "unavailable" | "available" | "configured_unavailable" | "unverified" | "rate_limited";
        gitAuthor: {
          name: string | null;
          email: string | null;
        };
        ...
        refreshState: "unavailable" | "failed" | "expired" | "available" | "not_applicable" | "refreshing";
        oauthScopes: string[];
...
type RunEmbeddedAgentParams = {
  ...
  onToolResult?: (payload: ReplyPayload$1) => void | Promise<void>;
...
type ChannelDeliveryAdapterBase = {
  ...
  preparePayload?: (payload: ReplyPayload$1, info: ChannelDeliveryInfo) => MaybePromise$1<ReplyPayload$1 | null>;
  onDelivered?: (payload: ReplyPayload$1, info: ChannelDeliveryInfo, result: ChannelDeliveryResult | void) => Promise<void> | void;
...
type ChannelCoreManagedTurnDeliveryAdapter = ChannelDeliveryAdapterBase & {
  deliver: (payload: ReplyPayload$1, info: ChannelCoreManagedDeliveryInfo) => Promise<ChannelDeliveryResult | void>;
...
type ChannelProviderOwnedMessageSendingDeliveryAdapter = ChannelDeliveryAdapterBase & {
   ...
   */
  deliverWithProviderMessageSending: (payload: ReplyPayload$1, info: ChannelProviderOwnedDeliveryInfo) => Promise<ChannelDeliveryResult | void>;
  deliver?: never;
  durable?: never;
};
...
//#endregion
//#region extensions/telegram/src/thread-spec.d.ts
...
declare function buildTelegramGroupPeerId(chatId: number | string, thread?: number | TelegramThreadSpec): string;
declare function buildTelegramGroupFrom(chatId: number | string, thread?: number | TelegramThreadSpec): string;
/**
...
declare const TelegramConfigSchema: z.ZodObject<{
  ...
  joinIntro: z.ZodOptional<z.ZodBoolean>;
...
declare function buildBaseAccountStatusSnapshot<TExtra extends StatusSnapshotExtra>(params: {
  ...
  lifecycle?: "blocked" | "starting" | "ready" | "recovering" | "stopped" | undefined;
...
//#endregion
//#region extensions/telegram/src/thread-bindings-store.d.ts
...
//#endregion
export { buildGroupLabel as $, definePluginEntry as $n, CliBackendToolAvailability as $t, resolveConfiguredFromCredentialStatuses as A, resetMissingDefaultWarnFlag as An, ProviderThinkingProfile as At, sendLocationTelegram as B, resolveTelegramFetch as Bn, MemoryEmbeddingProvider as Bt, collectTelegramUnmentionedGroupIds as C, jsonResult as Cn, isBinaryContent as Ct, buildBaseAccountStatusSnapshot as D, createTelegramActionGate as Dn, ProviderFailoverErrorContext as Dt, probeTelegram as E, TelegramPollActionGateState as En, ProviderPlugin as Et, clearAccountEntryFields as F, mergeTelegramAccountConfig as Fn, ProviderReplayPolicy as Ft, renameForumTopicTelegram as G, normalizeAccountId as Gn, GatewayRequestHandlers as Gt, editMessageTelegram as H, shouldRetryTelegramTransportFallback as Hn, MemoryEmbeddingProviderCreateOptions as Ht, buildChannelConfigSchema as I, resolveTelegramAccountConfig as In, ProviderReplayPolicyContext as It, reactMessageTelegram as J, OutboundReplyPayload as Jn, WebSearchProviderPlugin$1 as Jt, deleteMessageTelegram as K, TelegramButtonStyle as Kn, OpenClawPluginToolContext as Kt, sendPollTelegram as L, TelegramTokenResolution as Ln, ProviderSanitizeReplayHistoryContext as Lt, getChatChannelMeta as M, resolveTelegramAccount as Mn, ProviderNormalizeToolSchemasContext as Mt, PAIRING_APPROVED_MESSAGE as N, resolveTelegramMediaRuntimeOptions as Nn, ProviderReasoningOutputMode as Nt, buildTokenChannelStatusSummary as O, listEnabledTelegramAccounts as On, ProviderWrapStreamFnContext as Ot, formatPairingApproveHint as P, resolveTelegramPollActionGateState as Pn, ProviderReasoningOutputModeContext as Pt, TelegramReplyTarget as Q, sendPayloadWithChunkedTextAndMedia as Qn, CliBackendPreparedExecution as Qt, sendStickerTelegram as R, resolveTelegramToken as Rn, ProviderToolSchemaDiagnostic as Rt, auditTelegramGroupMembership as S, readToolStringParam as Sn, __exportAll as Sr, hasBotMention as St, TelegramProbeOptions as T, TelegramMediaRuntimeOptions as Tn, TelegramThreadSpec as Tt, createForumTopicTelegram as U, makeProxyFetch as Un, redactSensitiveText as Ut, editMessageReplyMarkupTelegram as V, resolveTelegramTransport as Vn, MemoryEmbeddingProviderAdapter as Vt, editForumTopicTelegram as W, DEFAULT_ACCOUNT_ID as Wn, EmbeddingInput$1 as Wt, unpinMessageTelegram as X, deliverTextOrMediaReply as Xn, AcpRuntimeErrorCode as Xt, sendTypingTelegram as Y, ReplyPayload as Yn, AcpRuntimeError as Yt, TelegramApiOverride as Z, isNumericTargetId as Zn, CliBackendPlugin$1 as Zt, monitorTelegramProvider as _, AnyAgentTool as _n, formatDiagnosticTraceparent as _r, TelegramTextEntity as _t, OpenClawPluginApi as a, OpenClawPluginSecurityAuditCollector$1 as an, VideoContent as ar, buildTypingThreadParams as at, shouldSuppressTelegramExecApprovalForwardingFallback as b, readStringArrayParam as bn, isValidDiagnosticTraceId as br, extractTelegramLocation as bt, TelegramNetworkConfig as c, OpenClawPluginServiceContext as cn, PluginHookReplyDispatchContext as cr, resolveTelegramForumFlag as ct, parseTelegramTopicConversation as d, PluginLogger as dn, PluginConversationBinding as dr, resolveTelegramReplyId as dt, PluginRuntime as en, emptyPluginConfigSchema as er, buildTelegramGroupFrom as et, setTelegramRuntime as f, DiagnosticEventMetadata as fn, PluginConversationBindingRequestParams as fr, resolveTelegramStreamMode as ft, setTelegramThreadBindingMaxAgeBySessionKey as g, onDiagnosticEvent as gn, createDiagnosticTraceContext as gr, TelegramForwardedContext as gt, setTelegramThreadBindingIdleTimeoutBySessionKey as h, emitDiagnosticEvent as hn, createChildDiagnosticTraceContext as hr, StickerMetadata as ht, PluginHttpRouteRegistration as i, omitEnvKeysCaseInsensitive as in, ProviderStreamOptions as ir, buildTelegramThreadParams as it, TelegramConfigSchema as j, resolveDefaultTelegramAccountId as jn, ProviderResolveDynamicModelContext as jt, projectCredentialSnapshotFields as k, listTelegramAccountIds as kn, ProviderDefaultThinkingPolicyContext as kt, resolveTelegramPollVisibility as l, PluginInteractiveRegistration as ln, PluginHookReplyDispatchEvent as lr, resolveTelegramForumThreadId as lt, getTelegramThreadBindingManager as m, DiagnosticEventPrivateData as mn, DiagnosticTraceContext as mr, withResolvedTelegramForumFlag as mt, OpenClawPluginDefinition as n, resolveApiKeyForProviderCore as nn, ProviderContext as nr, buildTelegramParentPeer as nt, TelegramAccountConfig as o, OpenClawPluginSecurityAuditContext as on, RealtimeVoiceProviderPlugin$1 as or, describeReplyTarget as ot, createTelegramThreadBindingManager as p, DiagnosticEventPayload as pn, PluginConversationBindingRequestResult as pr, resolveTelegramThreadSpec as pt, pinMessageTelegram as q, TelegramInlineButtons as qn, OpenClawPluginToolFactory$1 as qt, OpenClawPluginConfigSchema as r, listKnownProviderAuthEnvVarNames as rn, ProviderModel as rr, buildTelegramRoutingTarget as rt, TelegramActionConfig as s, OpenClawPluginService$1 as sn, SpeechProviderPlugin$1 as sr, extractTelegramForumFlag as st, tryDispatchAcpReplyHook as t, createChannelReplyPipeline as tn, ProviderRuntimeModel as tr, buildTelegramGroupPeerId as tt, ParsedTelegramTopicConversation as u, OpenClawPluginNodeHostCommand as un, PluginHookReplyDispatchResult as ur, resolveTelegramGroupAllowFromContext as ut, telegramMessageActions as v, readNumberParam as vn, isValidDiagnosticSpanId as vr, buildSenderLabel as vt, TelegramProbe as w, ResolvedTelegramAccount as wn, normalizeForwardedContext as wt, resolveTelegramRuntimeGroupPolicy as x, readStringOrNumberParam as xn, parseDiagnosticTraceparent as xr, getTelegramTextParts as xt, buildTelegramExecApprovalPendingPayload as y, readReactionParams as yn, isValidDiagnosticTraceFlags as yr, buildSenderName as yt, sendMessageTelegram as z, tryReadSecretFileSync as zn, PluginRegistry as zt };