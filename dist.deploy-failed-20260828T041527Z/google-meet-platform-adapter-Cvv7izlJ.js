...
import { s as MeetingPlatformAdapter } from "./meeting-runtime-BjAdFGdS.js";
...
import { a as isSameMeetUrlForReuse, i as isRecoverableMeetTab, n as forceMeetEnglishUi, o as normalizeMeetUrlForReuse, r as isEnglishMeetTab, s as readMeetAuthUser, t as createMeetWithBrowserProxyOnNode } from "./chrome-create-BAA1QSFq.js";
...
const GOOGLE_MEET_PLATFORM_ADAPTER = MeetingPlatformAdapter.create({
	...
	browser: {
		...
		shouldRetryJoinStatus: (health) => health.inCall === true && health.manualAction?.reason === "meet-audio-choice-required" && (health.audioInputRouted !== true || health.audioOutputRouted !== true),
...
//#endregion
export { normalizeDialInNumber as n, GOOGLE_MEET_PLATFORM_ADAPTER as t };
