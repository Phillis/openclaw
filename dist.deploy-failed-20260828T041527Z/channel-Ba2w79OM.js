...
import { c as normalizeOptionalLowercaseString, h as readNonEmptyStringPreservingWhitespace, l as normalizeOptionalString, o as normalizeLowercaseStringOrEmpty } from "./string-coerce-CIXf7egm.js";
...
import { l as hasConfiguredSecretInput, m as normalizeResolvedSecretInputString, y as resolveSecretInputString } from "./types.secrets-Bre8L6Ts.js";
...
import { B as requireOpenAllowFrom, C as ReplyToModeSchema, S as ReplyRuntimeConfigSchemaShape, g as MarkdownConfigSchema, s as DmPolicySchema, u as GroupPolicySchema } from "./zod-schema.core-CTdpjCBO.js";
import { a as buildChannelConfigSchema, c as buildMultiAccountChannelSchema, o as buildGroupEntrySchema } from "./config-schema-ikPYPY3Q.js";
...
import { h as readProviderTextResponse, m as readProviderJsonResponse } from "./provider-http-errors-BXG5plR9.js";
...
import { p as createAuthRateLimiter } from "./auth-rate-limit-C6x9QPnp.js";
import { a as resolveChannelEntryMatchWithFallback, n as buildChannelKeyCandidates, r as normalizeChannelSlug } from "./channel-config-D5i_K0JA.js";
import { i as resolveAllowlistMatchByCandidates } from "./allowlist-match-B8i_bWcB.js";
import { g as bindIngressLifecycleToReplyOptions, p as defineChannelMessageAdapter } from "./channel-outbound-DO-F9-0m.js";
...
import { n as deliverFormattedTextWithAttachments } from "./reply-payload-i0RzN2iF.js";
...
import { i as hasConfiguredAccountValue, r as describeWebhookAccountSnapshot, t as createAccountListHelpers } from "./account-helpers-Cnv50TjD.js";
...
import { a as createSetupInputPresenceValidator, c as patchScopedAccountConfig, t as applyAccountNameToChannelSection } from "./setup-helpers-ChQBLW6h.js";
import { i as createChatChannelPlugin } from "./core-CQsT-38z.js";
import { C as promptParsedAllowFromForAccount, O as resolveSetupAccountId, j as setSetupChannelEnabled, p as mergeAllowFromEntries, s as createStandardChannelSetupStatus } from "./setup-wizard-helpers-BGcFrkxT.js";
import { n as defineTokenCredential, t as baseUrlTextInput } from "./setup-credential-Cg5429p2.js";
...
import { o as migratePersistentDedupeLegacyJsonFile, s as resolvePersistentDedupePluginStateNamespace } from "./persistent-dedupe-PhcpFwkv.js";
import { c as ssrfPolicyFromPrivateNetworkOptIn } from "./ssrf-policy-DrRXEpPY.js";
import "./ssrf-runtime-CIuLn0o4.js";
import { i as FormatCapabilityProfile } from "./text-chunking-CJz4kAsi.js";
import "./channel-secret-basic-runtime-D79B15GP.js";
import { t as fileExists } from "./security-runtime-qrFVi6LG.js";
...
import { d as createDefaultChannelRuntimeState, s as buildWebhookChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CopMHs_f.js";
import { d as requireChannelOpenAllowFrom, p as resolveLoggerBackedRuntime } from "./extension-shared-BO-DUGkx.js";
import "./channel-config-schema-DeVmAx-r.js";
import { t as resolveReactionMessageId } from "./channel-actions-D2ZN81sL.js";
import "./channel-core-DYDgmix_.js";
import { i as channelIngressRoutes, s as resolveStableChannelMessageIngress } from "./channel-ingress-runtime-BxqYlzv5.js";
import { i as createPairingPrefixStripper, n as createChannelPairingController, r as createLoggedPairingApprovalNotifier } from "./channel-pairing-YowAfeUY.js";
import { M as createConditionalWarningCollector, h as resolveScopeToolsPolicy, j as createAllowlistProviderRouteAllowlistWarningCollector, m as resolveScopeRequireMention } from "./channel-policy-RPOWSkLP.js";
...
import { r as WEBHOOK_RATE_LIMIT_DEFAULTS } from "./webhook-ingress-ByuWujwG.js";
import { t as getNextcloudTalkRuntime } from "./runtime-api-BfbQMytO.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-D2jpX_Fw.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Ct78lGJL.js";
...
function resolveNextcloudTalkSecret(accountId, merged) {
	...
	if (envSecret && accountId === "default") return {
		secret: envSecret,
		source: "env",
		status: "available"
	};
...
function inspectNextcloudTalkAccount(params) {
	...
	const credentialDiagnostics = [...account.credentialDiagnostics ?? [], ...apiCredentialResolution.status === "configured_unavailable" ? [apiCredentialResolution.diagnostic] : []];
	return {
		...account,
...
async function resolveNextcloudTalkRoomKind(params) {
	...
	try {
		...
		try {
			...
			const kind = resolveRoomKindFromType(parseStrictPositiveInteger((await readProviderJsonResponse(response, "Nextcloud Talk room info failed")).ocs?.data?.type));
			cacheRoomInfo(key, {
				fetchedAt: Date.now(),
				kind
			});
...
async function handleNextcloudTalkInbound(params) {
	...
	const resolveAccess = async (wasMentioned, contextBinding) => await resolveStableChannelMessageIngress({
...
const nextcloudTalkMessageActions = {
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		if (action === "react") {
			...
			const target = readToolStringParam(params, "to", {
				required: true,
				label: "to (room token)"
			});
