...
import { C as tryResolveLegacyCompatibilityAgentId, a as listAgentIds, f as resolveAgentWorkspaceDir, l as resolveAgentDir, s as resolveAgentConfig } from "./agent-scope-config-CUBiGmG3.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, d as parseSessionDeliveryRoute, f as parseThreadSessionSuffix, i as isCronSessionKey, r as isCronRunSessionKey } from "./session-key-utils-Di3FvABa.js";
import { t as isIncognitoSessionKey } from "./incognito-session-key-BwpD1Lwd.js";
import { n as normalizeAccountId } from "./account-id-BH0zJUew.js";
import { a as buildAgentMainSessionKey, b as toAgentStoreSessionKey, c as classifySessionKeyShape, l as isUnscopedSessionKeySentinel } from "./session-key-Dbce_H9p.js";
...
import { $ as REPLY_SKIP_TOKEN, Q as ANNOUNCE_SKIP_TOKEN, et as isAnnounceSkip, nt as isReplySkip, tt as isNonDeliverableSessionsReply } from "./openclaw-state-db-kmBThqu6.js";
import { M as describeSessionsSpawnTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, j as describeSessionsSendTool } from "./tool-catalog-DKzjKSZr.js";
...
import { C as upsertSessionEntryCore, f as loadSessionEntry, p as loadSessionEntryReadOnly } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
...
import { t as GatewayDrainingError, v as runWithGatewayIndependentRootWorkContinuation } from "./gateway-work-admission-CTDt7IQ1.js";
...
import { _ as registerSessionStateWatch, m as recordSubagentSpawned, u as recordSessionCreated } from "./session-state-events-DvygRPJJ.js";
import { a as resolveSessionConversationRef, n as parseSessionThreadInfo } from "./sessions-BI8dPUCI.js";
import { s as listRegisteredPluginAgentPromptGuidance } from "./command-registration-C3uxM4em.js";
import { _ as readToolStringParam, b as resolveSnakeCaseParamKey, d as readNonNegativeIntegerParam, n as ToolInputError, p as readPositiveIntegerParam, s as normalizeToolModelOverride } from "./common-CI1GnPjt.js";
import { t as jsonResult } from "./tool-results-BCM3fdVS.js";
import { t as resolveAllowedModelRefCore } from "./model-selection-resolve-DhyLO0Qh.js";
import { i as resolvePersistedSelectedModelRef, o as resolveSubagentSpawnModelSelection, s as normalizeStoredOverrideModel } from "./model-selection-Cp8EGD61.js";
...
import { r as getGatewayToolCallerIdentity } from "./gateway-caller-context-DNtidJOJ.js";
...
import { u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-manager-api-1m62vMRl.js";
...
import { d as logSessionOwnershipLookupFailure, f as lookupFailedDenialMessage, g as sessionOwnershipLookupFailure, i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, p as lookupFailedOperationMessage } from "./session-visibility-D7qkCnOw.js";
import { S as hasInProcessGatewayToolContext, a as formatSessionToolAccessDenial, b as callInProcessGatewayToolWithCreation, c as resolveSessionToolAccess, f as resolveDisplaySessionKey, g as resolveVisibleSessionReference, h as resolveSessionReference, i as resolveSessionToolContext, m as resolveMainSessionAlias, o as recordSessionToolActionFact, p as resolveInternalSessionKey, s as resolveSandboxedSessionToolContext, u as isExpectedSessionLookupMiss, v as callAgentToolGatewayRequest, y as callInProcessGatewayTool } from "./sessions-helpers-GgSp1hTb.js";
import { A as activateSwarmRun, E as settleFailedQueuedSubagentLaunch, M as reserveSwarmRun, O as startQueuedSubagentRun, b as registerSubagentRun, h as listSwarmRunsForGroup, j as removeQueuedSwarmRun, l as getSubagentDeliveryBacklogPressure, o as completeCollectorLaunchCleanup, s as countActiveRunsForSession } from "./subagent-registry-ROej5jsc.js";
import { C as getSubagentSpawnDeps, S as withSubagentGatewayExecutionIdentity, _ as callNativeSubagentGateway, b as resolveSubagentAgentGatewayTimeoutMs, g as terminateAcceptedCollectorRun, h as retrySubagentCleanup, m as cleanupProvisionalSession, p as cleanupFailedSpawnBeforeAgentStart, w as setSubagentSpawnDepsForTest, x as buildSubagentExecutionSessionSpawnContext, y as readGatewayRunId } from "./subagent-announce-output-BxtV74X1.js";
import { d as resolveGatewaySessionStoreTarget } from "./session-utils-store-Dmx2MxPy.js";
...
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-0C4ixAK8.js";
import { a as waitForAgentRun, i as readLatestAssistantReplySnapshot, n as isRecoverableAgentWaitError, o as waitForAgentRunAndReadUpdatedAssistantReply, t as hasUpdatedAssistantReplySnapshot } from "./run-wait-otEVCYQN.js";
...
import { o as loadSessionEntryByKey } from "./subagent-announce-delivery-Cg1D7bpU.js";
import { o as resolveAgentRoute } from "./resolve-route-CaHBZG2x.js";
import { _ as readParentExecutionIdentity, b as resolveSubagentTargetPolicy, c as prepareSpawnThreadBinding, f as resolveSpawnMode, g as summarizeSpawnError, h as runSpawnPipeline, i as splitModelRef, m as reserveChildAdmissionSlot, n as resolveConfiguredSubagentRunTimeoutSeconds, o as resolveRequesterOriginForChild, p as resolveSpawnSandboxError, r as resolveSubagentModelAndThinkingPlan, s as mintSpawnSessionKey, t as resolveSubagentSpawnOwnership, u as resolveSpawnAdmission, v as withParentExecutionIdentity } from "./subagent-spawn-ownership-BOFn5EY6.js";
import { i as routeToDeliveryFields, n as routeFromBindingRecord } from "./route-projection-DFMMuy1G.js";
...
import { c as resolveThreadBindingMaxAgeMsForChannel, f as supportsAutomaticThreadBindingSpawn, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-Bjjk-DS_.js";
import { i as resolveSpawnedWorkspaceInheritance, n as normalizeSpawnedRunMetadata, t as mapToolContextToSpawnedRunMetadata } from "./spawned-context-CcwhpB50.js";
...
const defaultAgentStepDeps = { agentCommandFromIngress: (async (...args) => {
	const { agentCommandFromIngress } = await import("./agent-DUHQTV2K.js");
...
function recordSessionsSendParticipant(params) {
	recordSessionParticipantBestEffort({
		...
		sessionKey: params.sessionKey,
		source: "agent",
		storePath: resolveSessionStorePathCore(params.cfg.session?.store, { agentId: params.targetAgentId }),
			...
			return await runWithScopedSessionAccess({
				...
				run: async () => {
					...
					const response = reply ? {
						...
						status: "no_reply",
						message: NO_REPLY_MESSAGE
					};
					if (reply) startA2AFlow(reply);
					return jsonResult({
						runId,
						sessionKey: displayKey,
						...response,
...
async function spawnSubagentDirect(params, ctx) {
	...
	try {
		...
		const launchChildRun = async () => await callNativeSubagentGateway(withSubagentGatewayExecutionIdentity({
			method: "agent",
...
const VISIBLE_SESSIONS_SPAWN_SCHEMA = {
	visible: Type.Optional(Type.Boolean({ description: "Durable visible session: coding/multi-step/keepable results; works without UI; subagent only; omit mode/thread/thinking/lightContext/attachments/attachAs." })),
	category: Type.Optional(Type.String({ description: "Sidebar category for a visible session. Omit or pass an empty string to leave it ungrouped." })),
...
async function maybeSpawnVisibleSession(params) {
	...
	if (params.raw.visible !== true) {
		const providedVisibleOnlyParams = [
			["category", categoryProvided ? requestedCategory : void 0],
			["worktree", worktree],
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-D-NUETrn.js"));
...
function recordAcceptedSessionSpawn(result, context) {
	...
	if (result.status !== "accepted" || !childSessionKey || !targetAgentId) return;
	recordSessionToolActionFact({
...
function createSessionsSpawnToolSchema(params) {
	...
	const schema = {
		...
		cwd: Type.Optional(Type.String({ description: "Working directory for the child. With visible=true, paths outside configured agent workspaces require operator.admin; omit to use the target agent workspace." })),
		...
		...params.swarmEnabled ? {
			collect: Type.Optional(Type.Boolean({ description: "Swarm collector child for parallel fan-out." })),
...
//#endregion
export { createSessionsSendTool as a, createPortalTool as c, supportsModelTools as i, formatPortalResult as l, validateStructuredOutputSchema as n, resolveSessionToolTargetAgentId as o, buildModelToolsUnavailablePrompt as r, runWithScopedSessionAccess as s, createSessionsSpawnTool as t };
