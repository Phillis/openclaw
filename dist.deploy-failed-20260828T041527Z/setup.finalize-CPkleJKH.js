...
import { n as formatGatewayServiceStartRepairIssues, o as resolveGatewayService, s as startGatewayService, t as describeGatewayServiceRestart } from "./service-BYLPjc81.js";
import { C as runTui, n as cancelProcessExitAfterTuiReturn, w as scheduleProcessExitAfterTuiReturn, x as resolveTuiShutdownHardExitMs } from "./tui-CAE_aLou.js";
...
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DJ__UUS2.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-fr3fqH85.js";
import { i as hasAuthProfileForProvider } from "./model-config.helpers-BfuJvny8.js";
import { r as listConfiguredWebSearchProviders } from "./runtime-BuYDkFEi.js";
import { n as t } from "./i18n-BQpjgFU-.js";
import { t as resolveGatewayStartupTiming } from "./gateway-startup-timing-D9NqKiRl.js";
import { p as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-DsV_5p6H.js";
...
import { i as waitForControlUiDocument, r as resolveControlUiHandoffTarget } from "./control-ui-handoff-BWJf0ZCr.js";
...
async function startSessionGatewayForOnboarding(params) {
	...
	try {
		const { startGatewayServer } = await import("./server-BRa50JVH.js");
...
const loadSearchSetupModule = createLazyRuntimeModule(() => import("./search-setup-CRmju6UE.js"));
...
async function finalizeSetupWizard(options) {
	...
	try {
		...
		const [{ resolveDefaultModelAuthStatus, resolveDefaultModelCatalogFacts }, { loadPreparedModelCatalogSnapshot }] = await Promise.all([import("./auth-choice-BpksbcA1.js"), import("./prepared-model-catalog-CiP0KTjK.js")]);
