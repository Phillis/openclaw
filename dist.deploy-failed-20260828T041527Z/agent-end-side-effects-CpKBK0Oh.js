...
import { P as runWithSessionTranscriptReadFence } from "./session-accessor.sqlite-transcript-store-CZRFPUnE.js";
import { l as resolveContextEngineOwnerPluginId } from "./registry-BUOAn3oY.js";
import { h as consumeRunSkillUsage } from "./agent-tools.before-tool-call-D89j2U3t.js";
import "./sessions-BLpYW515.js";
import { t as SessionManager } from "./session-manager-CBD-q5pC.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-1EE8WqNV.js";
import { r as enqueueCommandInLane, u as isGatewayDraining } from "./command-queue-CBS1Vl32.js";
import { T as findActiveSessionTask } from "./media-generation-task-status-IvC9SF2e.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat-xESS3bi6.js";
import { t as log$1 } from "./logger-ZAfp-Df-.js";
import { v as runWithPreparedMemoryPromptSection } from "./memory-state-BzIc97qw.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as resolveRuntimeTranscriptReadTarget } from "./transcript-runtime-state-DWBm_MkJ.js";
import { d as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt-prompt-helpers-xOentD9b.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-C4bZGf6V.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-CA6g_0C9.js";
...
async function runCoreAgentEndSideEffects(params) {
	...
	try {
		const { scheduleSkillExperienceReview } = await import("./experience-review-default-BwdBje6F.js");
