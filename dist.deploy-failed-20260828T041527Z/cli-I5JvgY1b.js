...
import { R as timestampMsToIsoString, S as parseStrictInteger } from "./number-coercion-CLj0HTDM.js";
...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-D1VNZx_n.js";
import { n as matrixSetupAdapter } from "./setup-core-DUZfGht8.js";
import { t as withResolvedActionClient } from "./client-BlprE6WF.js";
import { i as resolveMatrixAuthContext } from "./create-client-YKlLktEB.js";
import "./client-Cc6PkTXN.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-Dm_YMVFT.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-D_K_tkn5.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-Dtq8SwPm.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-vlrVtXER.js";
...
function printVerificationStatus(status, verbose = false, accountId) {
	...
	if (status.recoveryKey) console.log("Recovery key: available (re-run with --json to include the raw key value in output)");
	if (verbose) {
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-Bu2nOie6.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-Co0IAMM-.js"));
const loadMatrixDirectManagementModule = createLazyRuntimeModule(() => import("./direct-management-Bhh4lXtU.js"));
