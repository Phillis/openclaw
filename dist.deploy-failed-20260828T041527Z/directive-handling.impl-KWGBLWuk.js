...
import { b as resolveModelRefFromString, p as parseConfiguredModelVisibilityEntries, r as buildConfiguredModelCatalog, u as isModelKeyAllowedBySet } from "./model-selection-shared-DbjoXfPH.js";
...
import { i as resolveAuthProfileOrder, t as isConfiguredAwsSdkAuthProfileForProvider } from "./order-BxFkXXxj.js";
...
import { c as refreshQueuedFollowupSession, t as resolveQueueSettingsCore } from "./settings-CxUlx8Vr.js";
...
import { t as RUNTIME_MODEL_VISIBILITY_NORMALIZATION } from "./model-visibility-policy-0m0xt0BZ.js";
import { p as renderExecTargetLabel } from "./bash-tools.exec-runtime-CMnpBkJC.js";
...
import { t as persistStickyModelSelectionBestEffort } from "./sticky-model-selection-ChH_TCbX.js";
import { n as resolveModelRuntimeDirective, t as applyModelRuntimeDirective } from "./directive-handling.model-runtime-Demtae7-.js";
...
import { i as resolveModelsCommandReply } from "./commands-models-h5b_qhwI.js";
import { n as resolveSelectedAndActiveModel } from "./model-runtime-BzIef07I.js";
import { r as formatRemainingShort } from "./auth-health-DakHTlCd.js";
...
function buildModelPickerCatalog(params) {
	...
	if (!visibility.hasEntries) {
		...
		for (const entry of configuredCatalog) push(entry);
		return out;
	}
...
async function handleDirectiveOnly(params) {
	...
	if (shouldPersistSessionEntry) {
		...
		if (modelSelection && (!modelSelection.isDefault || params.stickyModelSelectionTarget) && params.canPersistStickyModelSelection === true) configuredDefaultUpdate = persistStickyModelSelectionBestEffort({
			agentId: activeAgentId,
