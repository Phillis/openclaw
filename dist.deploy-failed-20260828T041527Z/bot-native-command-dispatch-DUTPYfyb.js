...
import { m as resolveStorePath } from "./session-store-runtime-ZfR7yV2q.js";
...
import { a as normalizeDmAllowFromWithStore, o as resolveTelegramEffectiveDmPolicy, t as expandTelegramAllowFromWithAccessGroups } from "./access-groups-DY7-iLJz.js";
...
import { D as buildSenderName, b as resolveTelegramMessageThreadSpec, c as buildTelegramThreadParams, d as extractTelegramForumFlag, g as resolveTelegramForumFlag, h as resolveTelegramCommandAuthorization, m as resolveTelegramBotHasTopicsEnabled, p as isTelegramCommandsAllowFromConfigured, r as buildTelegramGroupFrom, s as buildTelegramRoutingTarget, v as resolveTelegramGroupAllowFromContext } from "./helpers-BwCSYwU_.js";
import { a as resolveTelegramTargetSession, i as resolveTelegramConversationRoute, t as buildTelegramConversationRouteContext } from "./conversation-route-B-tTpTPs.js";
import { L as resolveTelegramDirectToolPolicy, z as resolveTelegramGroupPromptSettings } from "./text-chunk-limit-a65wnktU.js";
import { t as resolveTelegramAccountOwnerAgentId } from "./account-owner-CfbMzFBO.js";
import { n as getTopicName, o as resolveTopicNameCacheScope } from "./topic-name-cache-Cnh2fm0W.js";
import { mt as evaluateTelegramGroupPolicyAccess, pt as evaluateTelegramGroupBaseAccess } from "./send-B3vmt1UE.js";
import { t as withTelegramApiErrorLogging } from "./api-logging-WkYTHJ80.js";
import { T as resolveTelegramCommandIngressAuthorization, n as resolveTelegramMessageTurnSettings } from "./bot-message-DBttathu.js";
...
async function prepareTelegramCommandDispatch(params) {
	...
	if (bindingMode.kind === "configured") {
		...
		if (!ensured.ok) {
			...
			await withTelegramApiErrorLogging({
				...
				fn: () => params.bot.api.sendMessage(auth.chatId, "Configured ACP binding is unavailable right now. Please try again.", buildTelegramThreadParams(auth.threadSpec) ?? {})
			});
			return null;
		}
	}
	...
	const targetSessionKey = resolveTelegramTargetSession({
		...
		isGroup: auth.isGroup,
		senderId: auth.senderId,
		dmThreadId: auth.threadSpec.scope === "dm" ? auth.threadSpec.id : void 0,
...
async function dispatchTelegramBuiltinTurn(params) {
	...
	const ctxPayload = dispatch.nativeCommandRuntime.finalizeInboundContext({
		...
		From: dispatch.isGroup ? buildTelegramGroupFrom(dispatch.chatId, dispatch.threadSpec) : `telegram:${dispatch.chatId}`,
