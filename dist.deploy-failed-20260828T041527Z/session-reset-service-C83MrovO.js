...
import { c as interruptSessionWorkAdmissions, p as runExclusiveSessionLifecycleMutation, s as hasOnlySessionLifecycleMutationKindActive, t as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS, u as isSessionLifecycleMutationActive } from "./session-lifecycle-admission-BtKN0pjk.js";
...
import { mt as clearAllCliSessions, vt as rebindCliSessionReseedReceiptsForReset } from "./session-accessor-fcDZuc2H.js";
import { m as resolveMissingAgentHarnessSessionError } from "./agent-harness-session-key-D9_Ct3Lx.js";
import { n as deleteSessionEntryLifecycle, r as resetSessionEntryLifecycle } from "./session-accessor.sqlite-lifecycle-wZ-pJlbP.js";
import { n as loadCombinedSessionStoreForGatewayCore } from "./combined-store-gateway-ChJFvtyM.js";
import { a as handleSessionStateSessionDeleted, o as handleSessionStateSessionReset, u as recordSessionCreated } from "./session-state-events-DvygRPJJ.js";
...
import { o as tryPrepareFreshManagerRuntimeSession, t as getAcpSessionManager } from "./manager-BUipT7v-.js";
...
import { c as writeAcpSessionMetaForMigration, r as readAcpSessionMeta, s as upsertAcpSessionMeta } from "./session-meta-CpNLCGd4.js";
import { n as createInternalHookEvent, u as triggerInternalHook } from "./internal-hooks-CR02IMJl.js";
import { n as clearBootstrapSnapshotOnSessionBoundary, t as clearBootstrapSnapshot } from "./bootstrap-cache-C3bRcD_I.js";
...
import { d as resolveGatewaySessionStoreTarget, r as loadGatewaySessionEntry } from "./session-utils-store-Dmx2MxPy.js";
...
import { n as hasSessionAutoResetListeners, r as isSessionAutoResetReason, t as emitSessionAutoResetHook } from "./session-auto-reset-BMWrLBEe.js";
import { t as clearSessionResetRuntimeState } from "./session-reset-cleanup-DtVmfodB.js";
import { r as stopSubagentsForRequester } from "./abort-CJVbfjF8.js";
...
import { n as runPluginHostCleanup } from "./host-hook-cleanup-Bp0yeepY.js";
...
async function ensureSessionRuntimeCleanup(params) {
	const [embeddedAgent, mcpTools, { clearFinishedSessionsForScopes }] = await Promise.all([
		import("./embedded-agent-fNRs635m.js"),
		import("./agent-bundle-mcp-tools-DDXwY5B5.js"),
...
async function performGatewaySessionReset(params) {
	...
	const workerPlacementContext = params.workerPlacementContext ?? (await import("./session-worker-placement-context-quHOuJnT.js")).resolveSessionWorkerPlacementContext();
