...
async function loadAgentCliCommand() {
	return (await import("./agent-via-gateway-Dos-7eRz.js")).agentCliCommand;
}
async function loadAgentExecCommand() {
	return (await import("./agent-exec-IlUFJDu5.js")).agentExecCommand;
}
function collectFallback(value, previous) {
	return [...previous, value];
}
async function loadDefaultRuntime() {
	return (await import("./runtime-BO0y5md7.js")).defaultRuntime;
}
async function loadRunCommandWithRuntime() {
	return (await import("./cli-utils-Cl4YK8W-.js")).runCommandWithRuntime;
}
