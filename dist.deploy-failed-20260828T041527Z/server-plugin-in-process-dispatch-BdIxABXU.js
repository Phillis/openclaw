...
import { n as mergePluginRuntimeClientInternal, t as createSyntheticPluginRuntimeClient } from "./server-plugin-runtime-client-B54lMVXp.js";
...
async function dispatchGatewayRequestInProcessRaw(method, params, options) {
	...
	const { handleGatewayRequest } = await import("./server-methods-kR1VCOEi.js");
