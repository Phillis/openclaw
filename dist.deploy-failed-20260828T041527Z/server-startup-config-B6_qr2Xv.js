...
import { X as applyConfigOverrides, u as readConfigFileSnapshotWithPluginMetadata } from "./io-ClLVsBMp.js";
...
import { s as hasLegacyAuthProfileSourcesForStartup } from "./legacy-source-diagnostic-SYdrQUmo.js";
...
import { c as getActiveSecretsRuntimeSnapshotRevisionState, f as graftActiveSecretsRuntimeAuthState, g as hasSameSecretReloadContract, l as getActiveSecretsRuntimeSnapshotState, m as hasCurrentAuthStoreCredentialsRevision, p as hasActiveSecretsRuntimeSnapshotLineage, t as activateSecretsRuntimeSnapshotState } from "./runtime-state-B9BywrOx.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-BbAYnqAD.js";
import { a as collectCandidateAgentDirs, c as prepareSecretsRuntimeFastPathSnapshot, r as registerProviderAuthRuntimeSnapshotActivationOwner } from "./runtime-provider-auth-activation-BpfP_TZR.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = createLazyPromise(() => import("./runtime-CN0H92il.js"), { cacheRejections: true });
	const loadAuthProfiles = createLazyPromise(() => import("./auth-profiles-wbKTfiln.js"), { cacheRejections: true });
