...
import { v as renderMessagePresentationFallbackText } from "./payload-C7E4iMOo.js";
import { S as createReplyToFanout, m as sendPayloadMediaSequence } from "./reply-payload-i0RzN2iF.js";
...
import { b as cleanupMatrixDeliveryPlans, i as sendPollMatrix, r as sendMessageMatrix, s as sendTypingMatrix, x as reconcileMatrixUnknownSend } from "./send-BEJQk6ia.js";
import { t as isBunRuntime } from "./runtime-BefyhPWv.js";
import { r as resolveMatrixAuth } from "./create-client-YKlLktEB.js";
import "./client-Cc6PkTXN.js";
import { n as listMatrixDirectoryPeersLive, t as listMatrixDirectoryGroupsLive } from "./directory-live-B5ciag5_.js";
import { t as resolveMatrixTargets } from "./resolve-targets-CWVJP92I.js";
//#region extensions/matrix/src/matrix/probe.ts
const loadMatrixProbeRuntimeDeps = createLazyRuntimeModule(() => import("./probe.runtime-CRF4gCYE.js").then((runtimeModule) => ({ createMatrixClient: runtimeModule.createMatrixClient })));
...
const matrixChannelRuntime = {
	...
	matrixOutbound: {
		...
		sendPayload: async ({ cfg, to, payload, mediaLocalRoots, mediaReadFile, mediaAccess, deps, replyToId, replyToIdSource, replyToMode, threadId, accountId, audioAsVoice, deliveryQueueId, onPlatformSendDispatch, onDeliveryResult }) => {
			...
			return attachChannelToResult("matrix", toMatrixOutboundResult(await send(to, payloadText, {
				cfg,
				mediaAccess,
				mediaLocalRoots,
				mediaReadFile,
		...
		sendText: async ({ cfg, to, text, deps, replyToId, threadId, accountId, audioAsVoice, deliveryQueueId, deliveryPartIndex, deliveryPartCount, onPlatformSendDispatch, onDeliveryResult }) => {
			return attachChannelToResult("matrix", toMatrixOutboundResult(await (resolveOutboundSendDep(deps, "matrix") ?? sendMessageMatrix)(to, text, {
				cfg,
