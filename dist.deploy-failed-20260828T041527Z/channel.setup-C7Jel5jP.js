...
import { N as splitSetupEntries, c as createTopLevelChannelAllowFromSetter, d as createTopLevelChannelGroupPolicySetter, j as setSetupChannelEnabled, l as createTopLevelChannelDmPolicy, p as mergeAllowFromEntries, s as createStandardChannelSetupStatus, x as patchTopLevelChannelConfigSection } from "./setup-wizard-helpers-BGcFrkxT.js";
import "./setup-BevReM2T.js";
import "./channel-setup-BFU3ELzE.js";
import "./setup-tools-BHWa-m36.js";
import { C as saveDelegatedTokens, S as resolveMSTeamsCredentials, b as hasConfiguredMSTeamsCredentials } from "./inbound-Clg3k_wg.js";
import "./secret-input-Dj-l6okR.js";
import { d as resolveMSTeamsChannelAllowlist, p as resolveMSTeamsUserAllowlist, s as parseMSTeamsTeamEntry } from "./resolve-allowlist-Cd7Hfq6b.js";
import { n as msteamsMeta, t as msteamsConfigAdapter } from "./channel-config-C8JtQsBg.js";
import { t as MSTeamsChannelConfigSchema } from "./config-schema-BBpmNOE0.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				let oauthModule;
				try {
					oauthModule = await import("./oauth-D17o8zGm.js");
				} catch (err) {
