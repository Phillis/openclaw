import { a as resolvePreferredBunPath, o as resolvePreferredNodePath, r as renderSystemNodeWarning, s as resolveSystemNodeInfo } from "./runtime-paths-BWwciIgl.js";
...
async function resolveDaemonInstallRuntimeInputs(params) {
	return {
		...
		runtimePath: params.runtimePath ?? (params.runtime === "bun" ? await resolvePreferredBunPath({
			env: params.env,
