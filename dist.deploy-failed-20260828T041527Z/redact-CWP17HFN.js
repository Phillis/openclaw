...
import { i as openRootFileSync, t as canUseRootFileOpen } from "./root-file-B4L4VJ7-.js";
...
import { f as resolveConfigPath, v as resolveIncludeRoots } from "./paths-BBSTUjD5.js";
...
function includesDefaultRedactPatterns(value) {
	if (value === TOOL_PAYLOAD_REDACT_PATTERNS) return true;
...
//#endregion
export { compileSafeRegex as A, hashConfigIncludeRaw as C, parseJsonWithJson5Fallback as D, resolveConfigIncludes as E, testRegexWithBoundedInput as M, extensionUsesSkippedScannerPath as O, createConfigIncludeResolutionSession as S, resolveConfigIncludeWritePath as T, invalidateLoggingConfigCache as _, redactModelVisibleSensitiveFieldValueWithConfig as a, ConfigIncludeError as b, redactSecrets as c, redactSensitiveLines as d, redactSensitiveText as f, resolveRedactOptions as g, redactToolPayloadTextWithConfig as h, redactModelVisibleSecrets as i, compileSafeRegexDetailed as j, compileConfigRegexes as k, redactSensitiveFieldValue as l, redactToolPayloadText as m, getDefaultRedactPatterns as n, redactModelVisibleToolPayloadText as o, redactToolDetail as p, isSensitiveFieldKey as r, redactModelVisibleToolPayloadTextWithConfig as s, computeSensitiveRedactionBitmap as t, redactSensitiveFieldValueWithConfig as u, readLoggingConfig as v, readConfigIncludeFileWithGuards as w, INCLUDE_KEY as x, CircularIncludeError as y };
