...
import { N as resolveOptionalIntegerOption } from "./number-coercion-CLj0HTDM.js";
import { s as sleepWithAbort } from "./src-BQ327IOM.js";
import { m as normalizeResolvedSecretInputString, s as coerceSecretRef } from "./types.secrets-Bre8L6Ts.js";
...
import { i as isPrivateNetworkOptInEnabled, s as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-DrRXEpPY.js";
import "./ssrf-runtime-CIuLn0o4.js";
import "./secret-input-runtime-BSLNpSkt.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-DysKVyrG.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-D2m4hS5t.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-CpFj8tyt.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-DsQllxGb.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-C3SYzE4l.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-C3YRhING.js";
import { d as writeStorageMeta, l as resolveMatrixStoragePaths, r as maybeMigrateLegacyStorage, s as repairCurrentTokenStorageMetaDeviceId } from "./storage-BnK_8_-Z.js";
import fs from "node:fs";
//#region extensions/matrix/src/matrix/client/config.ts
const loadMatrixAuthClientDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-BN248ZnT.js"), import("./logging-NmP81YCd.js")]).then(([sdkModule, loggingModule]) => ({
...
const loadMatrixCredentialsReadDeps = createLazyRuntimeModule(() => import("./credentials-read-CGzX4Zj2.js"));
...
const loadMatrixCreateClientRuntimeDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-BN248ZnT.js"), import("./logging-NmP81YCd.js")]).then(([sdkModule, loggingModule]) => ({
	MatrixClient: sdkModule.MatrixClient,
	ensureMatrixSdkLoggingConfigured: loggingModule.ensureMatrixSdkLoggingConfigured
})));
