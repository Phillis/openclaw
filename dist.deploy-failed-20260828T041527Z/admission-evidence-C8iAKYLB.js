...
const state = resolveGlobalSingleton(Symbol.for("openclaw.channelAdmissionEvidenceState"), () => ({
	...
	gatewayResolverByPreparation: /* @__PURE__ */ new WeakMap(),
	evidenceByContext: /* @__PURE__ */ new WeakMap(),
	gatewayResolverByContext: /* @__PURE__ */ new WeakMap(),
	gatewayResolverConflictsByContext: /* @__PURE__ */ new WeakSet(),
...
function prepareHostChannelContextAdmissionEvidence(params) {
	...
	if (valid && params.owner?.resolveGatewayContext) state.gatewayResolverByPreparation.set(preparation, params.owner.resolveGatewayContext);
	return preparation;
}
...
function bindHostChannelContextAdmissionEvidence(params) {
	...
	if (gatewayContextResolver && scopeKey !== void 0) {
...
function copyChannelParticipantAdmissionEvidence(source, target) {
	...
	if (!evidence && !gatewayContextResolver) return;
	...
	if (gatewayContextResolver && sourceScope !== void 0 && targetScope === sourceScope) {
...
//#endregion
export { configureChannelAdmissionEvidenceCollection as a, prepareHostChannelContextAdmissionEvidence as c, recordChannelAdmissionDecision as d, recordChannelIngressResolution as f, configureChannelAdmissionDecisionSink as i, readChannelContextAdmissionEvidence as l, combineChannelAdmissionEvidence as n, consumeChannelAdmissionEvidence as o, registerChannelAdmissionEvidenceOwner as p, compareChannelAdmissionParticipants as r, copyChannelParticipantAdmissionEvidence as s, bindHostChannelContextAdmissionEvidence as t, readChannelContextGatewayContextResolver as u };
