...
import { o as readAgentRosterProperty } from "./agent-scope-config-CUBiGmG3.js";
import { M as resolveModelIdNormalizationPolicies, N as validateConfigObjectRawWithPlugins, P as validateConfigObjectWithPlugins, S as createConfigIO, b as createRuntimeConfigWriteApplication, l as readConfigFileSnapshotForWrite, rt as ConfigMutationConflictError, v as attachRuntimeConfigWriteApplication } from "./io-ClLVsBMp.js";
import { t as isBuiltInModelProviderOverlayId } from "./model-provider-config-B3wTMsqG.js";
import "./zod-schema.core-CTdpjCBO.js";
import { l as projectSourceOntoRuntimeShape } from "./provider-model-route-n5WsvCIn.js";
import { h as resolveConfigSnapshotHash, l as parseConfigJson5 } from "./io.read-helpers-BfhrMUhR.js";
import { n as createMergePatch, r as isMergePatchObjectKeyAllowed, t as applyMergePatch } from "./merge-patch-BukSB2Pq.js";
...
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-BCGWcCc0.js";
import "./auth-CqG8D1lM.js";
import { t as ErrorCodes } from "./gateway-error-details-C2IaYyht.js";
import { $ as validateConfigSchemaLookupResult, Q as validateConfigSchemaLookupParams, X as validateConfigGetParams, Y as validateConfigApplyParams, Z as validateConfigPatchParams, et as validateConfigSchemaParams, tt as validateConfigSetParams } from "./src-4dv5TpeQ.js";
import { t as extractDeliveryInfo } from "./sessions-BI8dPUCI.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-DyWvGcd6.js";
import { d as errorShape, t as formatValidationErrors } from "./validation-errors-rELRlKfn.js";
import { h as redactSecretDegradationReason, l as isRetryableSecretDegradationReason } from "./runtime-degraded-state-D5EZZ925.js";
import { a as formatDoctorNonInteractiveHint, m as writeRestartSentinel } from "./restart-sentinel-DedQJXFM.js";
import { i as restoreRedactedValues, n as redactConfigObject } from "./redact-snapshot-Cc1aNUFV.js";
import { l as getActiveSecretsRuntimeSnapshotState } from "./runtime-state-B9BywrOx.js";
import { r as lookupConfigSchema } from "./schema-Wla-hUMt.js";
...
import { a as resolveConfigReloadMetadata, n as isNoopGatewayReloadPlan, t as buildGatewayReloadPlan } from "./config-reload-plan-DBp_hJKw.js";
...
import { u as prepareSecretsRuntimeSnapshot } from "./runtime-Ch7E_IAV.js";
import { n as readConfigGetResponse, t as invalidateConfigGetResponseCache } from "./config-get-response-DMevcWPp.js";
...
async function commitGatewayConfigWrite(params) {
	const application = params.awaitRuntimeApplication ? createRuntimeConfigWriteApplication() : void 0;
...
const configHandlers = {
	...
	"config.patch": async ({ params, respond, client, context }) => {
		...
		if (!snapshot.valid) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `${summarizeConfigValidationIssues(snapshot.issues)}; fix (openclaw doctor) before patching`, { details: { issues: snapshot.issues } }));
			return;
		}
		const rawValue = params.raw;
		if (typeof rawValue !== "string") {
