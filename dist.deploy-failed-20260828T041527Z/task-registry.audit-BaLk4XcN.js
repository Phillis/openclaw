import { t as resolveEffectiveTaskCleanupAfter } from "./task-retention-9GuX18TZ.js";
import { i as createEmptyTaskAuditSummary, r as compareTaskAuditFindingSortKeys } from "./task-registry.audit.shared-CN77q0s9.js";
...
function listTaskAuditFindings(options = {}) {
	...
	for (const task of tasks) {
		...
		if (task.status === "lost") {
			...
			const retainedUntilCleanup = typeof task.cleanupAfter === "number" && effectiveCleanupAfter > now;
