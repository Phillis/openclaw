...
import { Ct as validateDevicePairRejectParams, Ot as validateDeviceTokenRevokeParams, St as validateDevicePairListParams, Tt as validateDevicePairRenameParams, Xn as validateScopeUpgradeWait, Yn as validateScopeUpgradeRequest, kt as validateDeviceTokenRotateParams, wt as validateDevicePairRemoveParams, xt as validateDevicePairApproveParams } from "./src-4dv5TpeQ.js";
import { d as errorShape } from "./validation-errors-rELRlKfn.js";
import { c as listDevicePairing, f as rejectDevicePairing, h as requestDevicePairing, n as getPairedDevice, p as removePairedDevice, r as getPendingDevicePairing, v as updatePairedDeviceMetadata } from "./device-pairing-BIRweQsd.js";
import { a as rotateDeviceToken, i as revokeDeviceToken, o as summarizeDeviceTokens } from "./device-pairing-tokens-C8qsNRd7.js";
import { n as approveDevicePairing, r as formatDevicePairingForbiddenMessage } from "./device-pairing-approval-CwBRq0Q7.js";
import { s as resolveOperatorRolePolicy } from "./operator-role-policy-il7s4lXY.js";
import { t as assertValidParams } from "./validation-kYFXohur.js";
import { t as GATEWAY_EVENT_DEVICE_PAIR_CHANGED } from "./events-CcYyn8LU.js";
...
import { a as requestsNonOperatorDeviceRole, i as pairedDeviceHasNonOperatorRole, n as deniesCrossDeviceManagement, o as resolveDeviceManagementAuthz, r as deniesDeviceTokenRoleManagement, s as resolveDeviceSessionAuthz, t as emitDeviceManagementSecurityEvent } from "./device-management-security-COehpP2D.js";
...
const scopeUpgradeHandlers = {
	...
	"device.scopes.waitUpgrade": async ({ params, respond, context, client }) => {
		...
		if (result.status === "approved") {
			const rolePolicy = resolveOperatorRolePolicy(client, context.getRuntimeConfig());
			if (rolePolicy && result.scopes.some((scope) => !rolePolicy.scopes.some((allowedScope) => allowedScope === scope))) {
