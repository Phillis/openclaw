...
import { g as sendPayloadMediaSequenceOrFallback } from "./reply-payload-i0RzN2iF.js";
...
import { J as splitTelegramHtmlChunks } from "./helpers-BwCSYwU_.js";
import { A as TELEGRAM_MAX_CAPTION_LENGTH, D as resolveTelegramPromptContextSource, N as telegramCaptionDeliveryMetadata, S as createTelegramPromptContextProjectionCursor, n as resolveTelegramTextChunkLimit, t as TELEGRAM_TEXT_CHUNK_LIMIT } from "./text-chunk-limit-a65wnktU.js";
import { r as resolveTelegramInlineButtons } from "./button-types-B8o1Tn_2.js";
import { n as resolveTelegramInteractiveTextFallback, r as resolveTelegramPresentationCapabilities, t as canonicalizeTelegramPresentationPayload } from "./interactive-fallback-8JJe_6qe.js";
...
function createTelegramOutboundAdapter(options = {}) {
	...
	return {
		...
		sendPayload: async (params) => {
			...
			return attachChannelToResult("telegram", toTelegramOutboundResult(await sendTelegramPayloadMessages({
				send,
