...
const loadKimiWebSearchProviderRuntime = createLazyRuntimeModule(() => import("./kimi-web-search-provider.runtime-_hv6i3xa.js"));
	...
	return {
		...
		createTool: (ctx) => ({
			...
			execute: async (args, context) => {
				...
				return await executeKimiWebSearchProviderTool(ctx, args, { signal: context?.signal });
			}
		})
	};
}
