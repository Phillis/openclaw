...
import { D as resolveExpiresAtMsFromDurationMs, R as timestampMsToIsoString, f as asSafeIntegerInRange, s as asFiniteNumber } from "../../number-coercion-CLj0HTDM.js";
import { m as normalizeResolvedSecretInputString } from "../../types.secrets-Bre8L6Ts.js";
import { o as warn } from "../../globals-GZNLg1ns.js";
import { A as resolveGoogleGemini3ThinkingLevel } from "../../provider-stream-shared-q8qvF0X7.js";
...
import { $ as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, Q as REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ, tt as realtimeVoiceAudioDurationMs, w as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "../../realtime-session-harness-BIfCDu_t.js";
import "../../realtime-voice-DvokcLRl.js";
import { c as resamplePcm, i as convertPcmToMulaw8k, o as mulawToPcm } from "../../audio-energy-BP9DXUkU.js";
import "../../thinking-api-CVb-WksZ.js";
import { t as canonicalizeGoogleProviderBase64 } from "../../base64-BQQBrqWY.js";
import { t as createGoogleGenAI } from "../../google-genai-runtime-DgEmVMG7.js";
...
function resolveGoogleRealtimeProviderConfigRecord(config) {
	return asOptionalRecord(asOptionalRecord(config.providers)?.google) ?? asOptionalRecord(config.google) ?? config;
}
...
var GoogleRealtimeVoiceBridge = class {
	...
	sendAudio(audio) {
		...
		this.consecutiveSilenceMs += Math.round(realtimeVoiceAudioDurationMs(this.audioFormat, audio.length));
