...
import { p as loadAuthProfileStoreWithoutExternalProfiles } from "../../store-C6iqqcJy.js";
...
import { h as resolveTranscriptSessionKeyBySessionId, m as resolveStorePath, r as getSessionEntry } from "../../session-store-runtime-ZfR7yV2q.js";
import { d as buildOpenAICodexCredentialExtra, h as resolveOpenAICodexImportProfileName, m as resolveOpenAICodexAuthIdentity } from "../../provider-auth-Bfz7g31-.js";
import { n as updateAuthProfileStoreWithLockCompat } from "../../provider-auth-write-compat-BLaVe__4.js";
...
import { u as readVisibleSessionTranscriptMessageEntries } from "../../session-transcript-runtime-DXwgc1x5.js";
...
import { _ as sessionBindingIdentity, l as isCodexAppServerNativeAuthProfile, r as assertCodexBindingMayBeReplaced, u as normalizeCodexAppServerBindingModelProvider } from "../../session-binding-BlplpJ9G.js";
import { a as closeCodexStartupClientBestEffort, c as isCodexAppServerUnsafeSubscriptionError, d as unsubscribeCodexThreadBestEffort, h as isCodexNotificationForTurn, o as interruptCodexTurnAndWaitBestEffort, p as getCodexAppServerTurnRouter, u as retireUnsafeCodexTurnClientBestEffort } from "../../attempt-client-cleanup-CBrsZNhS.js";
import { s as isAssistantCommentaryCompletionNotification } from "../../event-projector-usage-CAfp3B0n.js";
...
import { o as defaultCodexAppInventoryCache, r as buildCodexPluginAppCacheKey } from "../../plugin-app-cache-key-BEgBHcyj.js";
import { B as resolveCodexAppServerRequestModelSelection, Et as pluginReadParams, G as CODEX_MANAGED_THREAD_MAX_ENTRIES, K as CODEX_MANAGED_THREAD_NAMESPACE, L as buildCodexProjectDocThreadConfig, R as CODEX_NATIVE_PERSONALITY_NONE, St as ensureCodexPluginActivation, bt as mergeCodexThreadConfigs, q as createCodexManagedThreadStore, vt as buildDisabledAppsConfigPatch, wt as isOpenAiCuratedMarketplace } from "../../thread-lifecycle-Ctc1w7N1.js";
import "../../incognito-session-KJUXvrtm.js";
import { a as withCodexAppServerJsonClient, i as requestCodexAppServerJson, o as resolveCodexNativeExecutionBlock, s as resolveCodexNativeSandboxBlock } from "../../request-D5ZqL_4v.js";
import { t as resumeCodexAppServerThread } from "../../thread-resume-DD663Ee5.js";
import { a as rollbackCodexAppServerBindingSubscription, c as withExclusiveCodexAppServerThread, i as retireCodexConversationThreadBinding, n as releaseCodexAppServerBindingSubscription, r as retainCodexAppServerBindingSubscription, s as withCodexConversationThreadActivity, t as isSameCodexAppServerThreadOwner } from "../../thread-ownership-1EHrSuJl.js";
import { d as projectBoundedCodexVisibleSessionHistory } from "../../transcript-mirror-CCVnglmS.js";
import { t as buildCodexMediaUnderstandingProvider } from "../../media-understanding-provider-BFJH0vF9.js";
...
import { a as resolveCodexAppServerForModelProvider, i as resolveCodexSessionPermissionCwd, n as applyCodexSessionPermissionPolicy, t as CODEX_SESSION_PERMISSION_EXEC_MODES } from "../../session-permission-policy-4aPk8ppU.js";
import { f as trackCodexConversationActiveTurn, g as canMutateCodexHost, h as CODEX_NATIVE_EXECUTION_AUTH_ERROR, t as discoverCodexMarketplacePlugins } from "../../plugin-marketplace-discovery-D7YRUjFI.js";
...
import { a as listCodexCliSessionsOnNode, n as createCodexCliSessionNodeHostCommands, o as resolveCodexCliSessionForBindingOnNode, r as createCodexCliSessionNodeInvokePolicies, s as resumeCodexCliSessionOnNode } from "../../node-cli-sessions-BW4aNinn.js";
import { t as codexControlRequest } from "../../command-rpc-B_kLrckZ.js";
import { i as createCodexSessionCatalogNodeHostCommands, n as createCodexSessionCatalogNodeInvokePolicies, o as assertCodexArchiveDescendantsUnowned, r as createCodexSessionCatalogControl, t as codexSessionCatalogRuntime } from "../../session-catalog-CY6-kJ8N.js";
...
function createLazyCodexAppServerBindingStore(state, managedThreadState) {
	let resolved;
	const store = () => resolved ??= import("../../session-binding-iDiVlreO.js").then(({ createCodexAppServerBindingStore }) => createCodexAppServerBindingStore(state));
...
async function loadDefaultCodexSubcommandHandler() {
	const { handleCodexSubcommand } = await import("../../command-handlers-BreBBmcg.js");
...
function createCodexNodeExecServerCommand() {
	...
	return {
		...
		handle: async (paramsJSON, io, context) => {
			...
			let unsubscribe;
			try {
				const { runCodexNodeExecServer } = await import("../../node-exec-server.runtime-CZ8FcVP6.js");
...
const loadCodexWebSearchRuntime = createLazyRuntimeModule(() => import("../../web-search-provider.runtime-fOdmBLUK.js"));
...
var codex_default = definePluginEntry({
	...
	register(api) {
		...
		api.on("after_compaction", async (event, ctx) => {
			...
			const { sessionBindingIdentity } = await import("../../session-binding-iDiVlreO.js");
			const identity = sessionBindingIdentity({
				sessionId,
		...
		api.on("session_end", async (event, ctx) => {
			...
			const config = resolveCurrentConfig();
			const [{ sessionBindingIdentity }, { retireCodexAppServerSessionGeneration }] = await Promise.all([import("../../session-binding-iDiVlreO.js"), import("../../session-retirement-DnAUSA5k.js")]);
