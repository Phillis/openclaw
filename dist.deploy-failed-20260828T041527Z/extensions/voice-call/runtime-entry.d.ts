import { Bt as TtsDirectiveParseResult, Ft as RealtimeTranscriptionProviderPlugin, Ht as TalkEvent, It as RealtimeVoiceProviderPlugin, Ut as RealtimeTranscriptionProviderConfig, Vt as RealtimeVoiceProviderConfig, ht as TtsConfigSchema, l as PluginRuntime, s as OpenClawPluginApi, zt as TtsDirectiveOverrides } from "../../plugin-entry-C1So83n6.js";
import { n as OpenClawConfig } from "../../types.openclaw-OHssSjQn.js";
import { l as SessionScope } from "../../channel-id.types-D3kXkqAw.js";
import "../../config-contracts-CbBCWgEm.js";
import "../../secret-input-CHvO7eLi.js";
import "../../realtime-transcription-CAaLk4Un.js";
import "../../speech-B_TmSS7b.js";
import "../../runtime-store-DJfAjJ27.js";
import "../../api-DJfAjJ27.js";
import { z } from "zod";
...
declare const NormalizedEventSchema: z.ZodDiscriminatedUnion<[z.ZodObject<{
  ...
  from: z.ZodOptional<z.ZodString>;
  to: z.ZodOptional<z.ZodString>;
  type: z.ZodLiteral<"call.assistant-speech">;
...
declare class MediaStreamHandler {
  ...
  private pendingPlaybackMarks;
  private ignoredPlaybackMarks;
  ...
  sendMarkAndWait(streamSid: string, name: string, audioDurationMs: number, signal: AbortSignal): Promise<void>;
  /**
  ...
  private getTtsQueue;
  private getPendingPlaybackMarks;
  private acknowledgePlaybackMark;
  private invalidatePlaybackMarks;
  private ignorePlaybackMark;
  /**
...
//#endregion
//#region extensions/voice-call/src/webhook/stream-disconnect-grace.d.ts
...
declare class RealtimeCallHandler {
  ...
  private readonly resolveCallRegistration;
  private readonly servePath;
  private readonly streamDisconnectLifecycle;
  ...
  private readonly activeTelephonyBindingsByCallId;
  ...
  private readonly terminationAttempts;
  private closePromise;
  private closing;
  private publicOrigin;
  private publicPathPrefix;
  constructor(config: VoiceCallRealtimeConfig, manager: CallManager, resolveCallRegistration: ResolveRealtimeCallRegistration, servePath: string, streamDisconnectLifecycle: StreamDisconnectLifecycle, coreConfig?: OpenClawConfig | undefined);
  setPublicUrl(url: string): void;
  ...
  private clearActiveTelephonyBinding;
...
declare class VoiceCallWebhookServer {
  ...
  private readonly streamDisconnectGrace;
  ...
  constructor(config: VoiceCallConfig, manager: CallManager, provider: VoiceCallProvider, coreConfig?: OpenClawConfig, fullConfig?: OpenClawConfig, agentRuntime?: OpenClawPluginApi["runtime"]["agent"], logger?: Logger$1);
  /**
