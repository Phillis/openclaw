...
import { n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CZjiz1Jg.js";
import "./plugins-DYpQkXDD.js";
import { t as describeBinding } from "./agents.binding-format-BRYI5aWJ.js";
import { t as applyAgentBindings } from "./agents.bindings-ffZ0V3Mz.js";
...
async function loadOnboardChannels() {
	return await import("./onboard-channels-DAroMXd6.js");
}
...
async function resolveInitialWizardChannelTarget(raw, cfg) {
	...
	const [{ listActiveChannelSetupPlugins }, { resolveChannelSetupEntries }] = await Promise.all([import("./setup-registry-BAI4CCYS.js"), import("./discovery-obnslX9j.js")]);
...
async function runChannelsAddWizardFlow(params) {
	...
	const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-tqfUM26D.js"), loadOnboardChannels()]);
