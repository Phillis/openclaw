...
import { _ as readGatewayDispatchConfig, g as randomIdempotencyKey, m as isGatewayExplicitAuthRequiredError, o as callGateway, p as isGatewayCredentialsRequiredError, v as readGatewayDispatchConfigWithShellEnvFallback } from "./call-BFtOrd_w.js";
...
async function startOneShotDiagnosticsExporters(params) {
	...
	const [{ loadOpenClawPlugins }, { startPluginServices }] = await Promise.all([import("./plugins/loader.js"), import("./services-DFf-Tb-9.js")]);
...
const embeddedAgentCommandLoader = createLazyPromiseLoader(() => import("./agent-DUHQTV2K.js").then((module) => module.agentCommand), { cacheRejections: true });
const localAuditModuleLoader = createLazyPromiseLoader(() => import("./agent-local-audit-Bq38gs2D.js"), { cacheRejections: true });
const agentSessionModuleCache = createLazyPromiseLoader(() => agentSessionModuleLoader(), { cacheRejections: true });
const runtimeConfigModuleLoader = createLazyPromiseLoader(() => import("./io-D3NIoaFX.js"), { cacheRejections: true });
