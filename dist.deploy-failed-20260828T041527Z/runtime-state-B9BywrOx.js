...
import { d as isSecretRef, s as coerceSecretRef } from "./types.secrets-Bre8L6Ts.js";
...
import { D as setRuntimeConfigSourceSnapshotIfCurrent, E as setRuntimeConfigSnapshotRefreshHandler, T as setRuntimeConfigSnapshot, a as getRuntimeConfigSnapshot, o as getRuntimeConfigSnapshotMetadata, t as clearRuntimeConfigSnapshot } from "./runtime-snapshot-Cv5MaU8U.js";
import { a as getRuntimeAuthProfileStoreCredentialsRevision, g as replaceRuntimeAuthProfileStoreSnapshots, i as getRuntimeAuthProfileStoreCredentialMutationToken, n as clearRuntimeAuthProfileStoreSnapshots, o as getRuntimeAuthProfileStoreProfileSetMutationToken, p as listRuntimeAuthProfileStoreSnapshots, s as getRuntimeAuthProfileStoreSnapshotCore, u as getRuntimeAuthProfileStoreStateMutationToken } from "./runtime-snapshots-a_60jBeK.js";
import { _ as setActiveDegradedSecretOwners, s as clearActiveCredentialDegradedOwners } from "./runtime-degraded-state-D5EZZ925.js";
import { r as setActiveRuntimeWebToolsMetadata, t as clearActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-B2O6toZJ.js";
...
function collectSecretStoreRefKeysInConfig(config, name) {
	return new Set(listLocatedSecretRefs(config, config.secrets?.defaults).flatMap(({ ref }) => ref.source === "store" && ref.id === name ? [secretRefKey(ref)] : []));
}
...
//#endregion
export { registerSecretsRuntimeStateClearHook as _, getActiveSecretsRuntimeConfigSnapshot as a, setPreparedSecretsRuntimeSnapshotRefreshContext as b, getActiveSecretsRuntimeSnapshotRevisionState as c, getPreparedSecretsRuntimeSnapshotRefreshContext as d, graftActiveSecretsRuntimeAuthState as f, hasSameSecretReloadContract as g, hasSameSecretProviderDefinition as h, collectSecretStoreRefKeysInConfig as i, getActiveSecretsRuntimeSnapshotState as l, hasCurrentAuthStoreCredentialsRevision as m, activateSecretsRuntimeSnapshotStateIfCurrent as n, getActiveSecretsRuntimeEnvState as o, hasActiveSecretsRuntimeSnapshotLineage as p, clearSecretsRuntimeSnapshotState as r, getActiveSecretsRuntimeRefreshContext as s, activateSecretsRuntimeSnapshotState as t, getLiveSecretsRuntimeAuthStores as u, restoreSecretsRuntimeSnapshotStateIfCurrent as v, setSecretsRuntimeSourceSnapshotIfCurrent as x, restoreSecretsRuntimeSourceSnapshotIfLineageCurrent as y };
