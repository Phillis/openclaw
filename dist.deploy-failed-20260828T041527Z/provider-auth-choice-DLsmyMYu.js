...
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-4t6D2PIl.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const runtimePlugins = await import("./runtime-plugin-install-DX1M6ay-.js");
