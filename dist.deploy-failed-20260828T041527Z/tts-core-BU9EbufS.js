...
function loadDefaultSummarizeTextDeps() {
	return defaultSummarizeTextDepsPromise ??= Promise.all([import("./simple-completion-runtime-BKUvF4ve.js"), import("./model-auth-D_Dk9non.js")]).then(([completionRuntime, { requireApiKey }]) => ({
