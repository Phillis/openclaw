...
import { n as extractErrorCode, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-Ccx0R-_Z.js";
...
import { t as MediaFetchError } from "./fetch-LdRI1MZX.js";
...
import { r as chunkMarkdownText } from "./chunk-_fxsAvI_.js";
import { n as matchesMentionPatterns, t as buildMentionRegexes } from "./mentions-BHWGvP4S.js";
...
import { r as formatInboundEnvelope } from "./envelope-CiUE0My_.js";
import { m as toInboundMediaFactsWithMetadata, r as buildChannelInboundEventContext, u as formatInboundMediaUnavailableText } from "./run-channel-turn-CVly42eY.js";
...
import { a as warnMissingProviderGroupPolicyFallbackOnce, n as resolveAllowlistProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy } from "./runtime-group-policy-GURwo_0L.js";
import "./reply-runtime-0K-LPRYJ.js";
import { f as resolveInboundSessionEnvelopeContext } from "./channel-inbound-BmDzyYQ4.js";
...
import { t as resolvePairingIdLabel } from "./pairing-labels-CbXzZAh7.js";
...
import { a as createWebhookInFlightLimiter, i as beginWebhookRequestPipelineOrReject, l as runDetachedWebhookWork } from "./webhook-request-guards-BYzmIdMp.js";
import { i as registerWebhookTargetWithPluginRoute, n as normalizeWebhookPath, o as resolveSingleWebhookTarget, t as canonicalizeWebhookRouteKey } from "./webhook-targets-Bm2XLMzf.js";
import { i as resolveLineAccount, r as resolveDefaultLineAccountId } from "./accounts-Cx1pXoZV.js";
import { o as getLineRuntime, r as resolveLineGroupConfigEntry, t as buildLineQuickReplyFallbackText } from "./quick-reply-fallback-C1a-k8v7.js";
import { m as hasLineSpecificMediaOptions, p as buildLineMediaMessage } from "./send-receipt-I33lTCFa.js";
import { o as HTTPFetchError } from "./messagingApiClient-UpUACf5e.js";
import { i as processLineMessage, o as buildTemplateMessageFromPayload } from "./markdown-to-line-BwkX8NHa.js";
import { _ as replyMessageLine, a as createQuickReplyItems, c as getUserDisplayName, i as createLocationMessage, m as pushMessagesLine, n as createFlexMessage, p as pushMessageLine, y as showLoadingAnimation } from "./send-CdmRVoya.js";
...
async function fetchLineContentWhenReady(messageId, channelAccessToken, signal) {
	try {
		for (let attempt = 0; attempt < CONTENT_READY_MAX_ATTEMPTS; attempt++) {
			...
			if (attempt < CONTENT_READY_MAX_ATTEMPTS - 1) await setTimeout$1(contentBackoffDelayMs(attempt), void 0, { signal });
		}
	} catch (err) {
		if (signal.aborted) throw signal.reason;
...
async function deliverLineAutoReply(params) {
	...
	const messages = hasQuickReplies ? [...richMediaMessages, ...orderedDeliveryMessages ?? textMessages] : [...orderedDeliveryMessages ?? textMessages, ...richMediaMessages];
	try {
		...
		if (retryMessages.length > 0 && failedSegment?.failedBatch.some((message) => message.type !== "text") && httpError?.status === 400) {
			const lastRetryMessage = retryMessages.at(-1);
			if (quickRepliesNeedCarrier && lastRetryMessage && !lastRetryMessage.quickReply) lastRetryMessage.quickReply = deps.createQuickReplyItems(lineData.quickReplies);
			try {
...
function createLineBot(opts) {
	...
	const spool = createLineWebhookSpool({
		...
		deliver: async (event, _destination, control) => await handleLineWebhookEvents([event], {
			...
			groupHistories,
			historyLimit: account.config.historyLimit ?? cfg.messages?.groupChat?.historyLimit ?? 50
		})
	});
	spool.start();
	return {
