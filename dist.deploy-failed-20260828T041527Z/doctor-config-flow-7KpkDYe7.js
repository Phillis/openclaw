...
import { U as resolveNormalizedProviderModelMaxTokens, ct as classifyOtelGrpcMigrationOwnership, lt as containsAuthoredInclude, nt as migrateLegacyContextBudgetConfig, st as applyChannelDoctorCompatibilityMigrations, ut as isSingleTopLevelIncludeMigration } from "./io-ClLVsBMp.js";
import { t as createSubsystemLogger } from "./subsystem-a4KzJVZG.js";
import { s as HeartbeatSchema } from "./zod-schema.agent-runtime-WXtAE1HE.js";
import { i as getBundledChannelSetupPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-YAb6Bu5O.js";
import { r as collectConfiguredModelRefs } from "./configured-model-refs-0XUAFjEF.js";
import { _ as modelEntryWithRuntimePolicy, d as migrateLegacyWebSearchConfig, f as migrateLegacyXSearchConfig, g as migrateLegacyRuntimeModelRef, h as listLegacyRuntimeModelProviderAliases, l as stripRetiredTuningKnobs, m as legacyRuntimeModelAliasRequiresRuntimePolicy, u as migrateLegacyWebFetchConfig, v as selectedCanonicalModelRefsForRuntimePolicy, y as hasOwnKey } from "./legacy-Czf036mL.js";
import { r as isLegacyModelsAddCodexMetadataModel } from "./legacy-config-migrations.runtime.models-DrZij-WN.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { r as retainLegacyDefaultAgentId } from "./legacy.default-agent-owner-CL_-T11Y.js";
import { d as configIncludeOwnsAgentRoster } from "./provider-model-route-n5WsvCIn.js";
import { a as isBlockedLegacyCodexModelRef } from "./codex-route-model-ref-BJZ-8dtR.js";
...
import { a as runPluginSetupConfigMigrations } from "./setup-registry-DpKBzfh2.js";
...
import { a as noteOpencodeProviderOverrides, c as stripUnknownConfigKeys, i as noteMcpOriginWarning, n as noteImplicitFallbackClobberWarnings, o as noteSandboxOriginProxyWarning } from "./doctor-config-analysis-VaQXQWwI.js";
...
import { n as cronCodexRuntimePolicyTargetKey } from "./store-migration-DnYVcWzo.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { createDoctorPluginMetadataSnapshotScope } = await import("./plugin-metadata-snapshot-scope-C0h0cS0w.js");
	...
	const { collectBlockedLegacyOpenAICodexProviderPlan } = await import("./legacy-config-migrations.runtime.models-CS5GkXbr.js");
	...
	if (preflight.cronCodexRuntimePolicyTargets?.length) {
		const { repairCronCodexRuntimePolicies } = await import("./runtime-policy-migration-BFK3rYBs.js");
	...
	const { prepareRetiredPhoneControlCleanup } = await import("./doctor-retired-phone-control-DmpjyUm3.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-BhDiezWk.js");
	applyConfigMutation(runWithCurrentPluginMetadata(state.candidate, () => applyPluginAutoEnable({
		config: state.candidate,
		env: process.env
	})), { fixHint: `Run "${doctorFixCommand}" to apply these changes.` });
	if (!shouldRepair) {
		const { repairStaleAgentModelRefs } = await import("./stale-agent-model-ref-repair-COgphEW4.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-BDJscs9f.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DFYFwu4G.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-CePa5XWQ.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-IMvz4awG.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-CgkaFKpT.js");
	...
	if (configuredOpencodePluginIds.length > 0) {
		const { resolveEnabledProviderPluginIds } = await import("./providers-DOAndBK-.js");
