...
function applyDefaultsAndCheckSchema(params) {
	if (!params.applyDefaults || !params.hasDefaults) return {
		value: params.value,
		errors: checkSchema(params.validate, params.value)
	};
	...
	return withPluginFormatSemantics(() => {
		...
		return {
			value,
			errors: checkSchemaWithCurrentFormats(params.validate, value)
		};
	});
}
