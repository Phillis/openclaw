import { a as isDefaultInstallIdentity } from "./paths-BBSTUjD5.js";
...
import { t as hasActiveGatewayExecCredential } from "./doctor-gateway-exec-credential-aeYPnyWB.js";
import { t as resolveDoctorWorkspaceSuggestionScopes } from "./doctor-workspace-suggestion-scopes-DpMGddC7.js";
import { n as normalizeHealthCheck } from "./health-check-adapter-CWLXSjNJ.js";
...
import { o as shouldManageGatewayService } from "./doctor-service-repair-policy-DH8LJx_0.js";
import { i as resolveLegacyParentVersionOverride, n as resolveDoctorMode, r as resolveDoctorWorkspaceDir, t as isUpdateDoctorRun } from "./doctor-health-contribution-utils-0nWpp2v1.js";
import { i as createDoctorHealthContribution, n as runCoreHealthFindingNote, r as runStructuredHealthRepairs, t as runCoreContributionHealth } from "./doctor-health-contribution-core-CmrIb-xH.js";
import { a as runWriteConfigHealth, n as runFinalConfigValidationHealth, r as runInitialConfigWriteHealth, t as collectWriteConfigHealthFindings } from "./doctor-health-contribution-runners.config-CcF_fnix.js";
import { n as noteBackupDoctorHint } from "./backup-health-CWoC77_U.js";
import fs from "node:fs";
import { isDeepStrictEqual } from "node:util";
//#region src/flows/doctor-health-contribution-runners.gateway.ts
async function runCommandOwnerHealth(ctx) {
	const { noteCommandOwnerHealth } = await import("./doctor-command-owner-CqsPRnFF.js");
	noteCommandOwnerHealth(ctx.cfg);
}
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-DB_BkUJA.js");
...
async function runGatewayServicesHealth(ctx) {
	...
	const { maybeRepairGatewayServiceConfig, maybeResolveDuelingSystemdGatewayScopes, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-Cm81ybSz.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides, noteMacStaleOpenClawUpdateLaunchdJobs } = await import("./doctor-platform-notes-CHP5TbF5.js");
...
async function runHostDesktopHealth(ctx) {
	const { noteHostDesktopHealth } = await import("./doctor-host-desktop-BjyBrf1Z.js");
	await noteHostDesktopHealth(ctx.cfg, { prompter: ctx.prompter });
}
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-7tbZZzfi.js");
...
async function runSecurityHealth(ctx) {
	const { noteInstallPolicyHealth } = await import("./doctor-install-policy-B3jUf11O.js");
	const { noteSecurityWarnings } = await import("./doctor-security-CLpPRmJu.js");
...
async function runWebFetchProxyHealth(ctx) {
	...
	const { noteWebFetchProxyDiagnostic } = await import("./doctor-web-fetch-proxy-ChLNpfct.js");
...
async function runGitHubProjectHealth(ctx) {
	const { hasConfiguredGitHubApiCredential } = await import("./control-ui-github-api-CZhVUAVL.js");
...
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-C0OYZBjM.js");
...
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./provider-openai-chatgpt-oauth-tls-Cm5q7LAY.js");
...
async function runWhatsappResponsivenessHealth(ctx) {
	const { noteWhatsappResponsivenessHealth } = await import("./doctor-whatsapp-responsiveness-DeyHvWDi.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-Ddb728Uy.js");
...
async function runGatewayDaemonHealth(ctx) {
	if (!isDefaultInstallIdentity(ctx.env ?? process.env)) return;
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-Ch_JHhXZ.js");
...
const loadDoctorStateIntegrityModule$1 = async () => await import("./doctor-state-integrity-DI7O7d6q.js");
async function runActiveToolSchemaWarningsHealth(ctx) {
	if (!ctx.prompter.shouldRepair) return;
	const { collectActiveToolSchemaProjectionWarnings } = await import("./active-tool-schema-warnings-DYVxVf-d.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { loadPreparedModelCatalog } = await import("./prepared-model-catalog-CiP0KTjK.js");
	const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("./model-selection-nNBRo-Pm.js");
	const { note } = await import("./terminal-core/note.js");
...
async function collectWorkspaceStatusPluginVersionDrift(params) {
	...
	try {
		const { gatherDaemonStatus } = await import("./status.gather-caIMpbge.js");
...
async function runWorkspaceStatusHealth(ctx) {
	...
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-D8LTGQMv.js");
...
async function runSkillsHealth(ctx) {
	const { maybeRepairSkillReadiness } = await import("./doctor-skills-BNXqGsbZ.js");
...
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-BP929f4u.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runHeartbeatCadenceMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatCadenceToCron } = await import("./doctor-heartbeat-cadence-migration-BTiM1rCW.js");
...
async function runHeartbeatScratchMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatFilesToScratch } = await import("./doctor-heartbeat-scratch-migration-VqYx2Iul.js");
...
async function runToolsMdMigrationHealth(ctx) {
	const { maybeMigrateToolsMd } = await import("./doctor-tools-md-migration-Cfklz4Ad.js");
...
async function runHeartbeatTaskMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatTasksToCron } = await import("./doctor-heartbeat-task-migration-cuVjxxyX.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-CS7Gf_uW.js");
...
async function collectMemorySearchHealthFindings(ctx) {
	const { noteMemorySearchHealth } = await import("./doctor-memory-search-CS7Gf_uW.js");
	const notes = [];
	await noteMemorySearchHealth(ctx.cfg, {
		env: ctx.env,
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-yEEGuNZz.js");
	const { note } = await import("./terminal-core/note.js");
	...
	return [
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				async detect(ctx) {
					const { collectHostDesktopHealthFindings } = await import("./doctor-host-desktop-BjyBrf1Z.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectMissingDefaultAccountBindingWarnings, collectMissingExplicitDefaultAccountWarnings } = await import("./default-account-warnings-B09yfbUG.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect() {
					const { collectBundledChannelPackageStateLoadFailures } = await import("./package-state-probes-BR8iaNSl.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: [{
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { channelPluginBlockerHitToHealthFinding, scanConfiguredChannelPluginBlockers } = await import("./channel-plugin-blockers-9KU5G4um.js");
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectChannelPreviewWarningHealthFindings } = await import("./doctor-startup-channel-maintenance-7tbZZzfi.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectWorkspaceStatusHealthFindings } = await import("./doctor-workspace-status-D8LTGQMv.js");
					const pluginVersionDrift = await collectWorkspaceStatusPluginVersionDrift({
						cfg: ctx.cfg,
						options: {
							nonInteractive: true,
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatCadenceMigrationFindings } = await import("./doctor-heartbeat-cadence-migration-BTiM1rCW.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatScratchMigrationFindings } = await import("./doctor-heartbeat-scratch-migration-VqYx2Iul.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectToolsMdMigrationFindings } = await import("./doctor-tools-md-migration-Cfklz4Ad.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatTaskMigrationFindings } = await import("./doctor-heartbeat-task-migration-cuVjxxyX.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectWhatsappResponsivenessHealthFindings } = await import("./doctor-whatsapp-responsiveness-DeyHvWDi.js");
					let status;
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectDevicePairingHealthFindings } = await import("./doctor-device-pairing-Ddb728Uy.js");
...
const loadDoctorStateIntegrityModule = async () => await import("./doctor-state-integrity-DI7O7d6q.js");
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-UlQpoovG.js");
...
async function runPluginRegistryHealth(ctx) {
	const { maybeRepairPluginRegistryState } = await import("./doctor-plugin-registry-CbaYc_30.js");
...
async function runReleaseConfiguredPluginInstallsHealth(ctx) {
	...
	const { maybeRunConfiguredPluginInstallReleaseStep } = await import("./release-configured-plugin-installs-C8oYGfa1.js");
	const { note } = await import("./terminal-core/note.js");
	const { VERSION } = await import("./version-B4pBx2Bg.js");
...
async function runDiskSpaceHealth(ctx) {
	const { noteDiskSpace } = await import("./doctor-disk-space-DNpDzDB7.js");
	noteDiskSpace(ctx.cfg);
}
async function runDatabaseBloatHealth(ctx) {
	const { noteSqliteDatabaseBloat } = await import("./doctor-db-bloat-C8DX8KZK.js");
	noteSqliteDatabaseBloat(ctx.cfg);
}
async function runAgentMemorySchemaHealth(ctx) {
	const { noteDoctorAgentMemorySchemaHealth } = await import("./doctor-agent-memory-schema-DvVqjZhk.js");
...
async function runChannelIngressDeadLettersHealth() {
	const { noteChannelIngressDeadLetters } = await import("./doctor-channel-ingress-ND4XV3C9.js");
...
async function runCodexSessionRouteHealth(ctx) {
	const { maybeRepairCodexSessionRoutes } = await import("./codex-route-warnings-CupOMUPu.js");
	const { note } = await import("./terminal-core/note.js");
...
async function runSessionTranscriptsHealth(ctx) {
	const { noteSessionTranscriptHealth } = await import("./doctor-session-transcripts-BFhWuKLp.js");
...
async function runSessionTranscriptHeadersHealth(ctx) {
	const { noteSessionTranscriptHeaderHealth } = await import("./doctor-session-transcript-headers-Agl1vaxH.js");
...
async function runSessionTranscriptLabelsHealth(ctx) {
	const { noteSessionTranscriptLabelHealth } = await import("./doctor-session-transcript-labels-D1hYaqJN.js");
...
async function runSessionSnapshotsHealth(ctx) {
	const { noteSessionSnapshotHealth } = await import("./doctor-session-snapshots-GsIAWSNV.js");
...
async function runConfigAuditScrubHealth(ctx) {
	const { maybeRepairLegacyRuntimeFiles } = await import("./doctor-usage-cost-cache-DQWhlL5E.js");
	await maybeRepairLegacyRuntimeFiles(ctx.prompter.shouldRepair, ctx.env);
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore, noteLegacyWhatsAppCrontabHealthCheck } = await import("./cron-DD8u5-Oc.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, maybeRepairSandboxRegistryFiles, noteSandboxScopeWarnings } = await import("./doctor-sandbox-BNydpIbk.js");
...
async function runTelegramGeneralTopicConversationHealth(ctx) {
	const { runCoreContributionHealth } = await import("./doctor-health-contribution-core-HvpQ0HCa.js");
	...
	return [
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectAuthProfileHealthFindings } = await import("./doctor-auth-CK-aFHoW.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				async detect(ctx) {
					const { collectNodeHostingPreconditionFindings } = await import("./doctor-node-hosting-preconditions-BX3nmQPk.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { detectSessionTranscriptHealthIssues, sessionTranscriptIssueToHealthFinding } = await import("./doctor-session-transcripts-BFhWuKLp.js");
					return (await detectSessionTranscriptHealthIssues()).map(sessionTranscriptIssueToHealthFinding);
				},
				repair: legacyOwnedRepair(async () => {
					const { detectSessionTranscriptHealthIssues, sessionTranscriptIssueToRepairEffect } = await import("./doctor-session-transcripts-BFhWuKLp.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectLegacyPluginManifestContractMigrations, legacyPluginManifestContractMigrationToHealthFinding } = await import("./doctor-plugin-manifests-UlQpoovG.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { detectLegacyPluginDependencyStateIssues, legacyPluginDependencyStateIssueToHealthFinding } = await import("./plugin-dependency-cleanup-DFmjrwsn.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { collectStalePluginRuntimeSymlinkHealthFindings } = await import("./plugin-runtime-symlinks-BZgUJrul.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectConfiguredPluginInstallHealthIssues, configuredPluginInstallIssueToHealthFinding } = await import("./missing-configured-plugin-install-BqBLEkHO.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectConfiguredPluginInstallHealthIssues, configuredPluginInstallIssueToRepairEffect } = await import("./missing-configured-plugin-install-BqBLEkHO.js");
					return (await detectConfiguredPluginInstallHealthIssues({
						cfg: ctx.cfg,
						env: process.env
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectPluginRegistryHealthIssues, pluginRegistryIssueToHealthFinding } = await import("./doctor-plugin-registry-CbaYc_30.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectPluginRegistryHealthIssues, pluginRegistryIssueToRepairEffect } = await import("./doctor-plugin-registry-CbaYc_30.js");
					return (await detectPluginRegistryHealthIssues({
						config: ctx.cfg,
						env: process.env,
						prompter: { shouldRepair: false }
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectDiskSpaceHealthFindings } = await import("./doctor-disk-space-DNpDzDB7.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectStateIntegrityHealthIssues, stateIntegrityIssueToHealthFinding } = await import("./doctor-state-integrity-DI7O7d6q.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectStateIntegrityHealthIssues, stateIntegrityIssueToRepairEffect } = await import("./doctor-state-integrity-DI7O7d6q.js");
					return detectStateIntegrityHealthIssues(ctx.cfg, {
						configPath: ctx.configPath,
						env: process.env
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectSessionSnapshotHealthIssues, sessionSnapshotIssueToHealthFinding } = await import("./doctor-session-snapshots-GsIAWSNV.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectSessionSnapshotHealthIssues, sessionSnapshotIssueToRepairEffect } = await import("./doctor-session-snapshots-GsIAWSNV.js");
					return (await detectSessionSnapshotHealthIssues({
						cfg: ctx.cfg,
						env: process.env
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { configAuditScrubToHealthFinding, detectConfigAuditScrubIssue } = await import("./doctor-config-audit-scrub-lZ8EQuhf.js");
					const result = await detectConfigAuditScrubIssue();
					return result.rewritten > 0 ? [configAuditScrubToHealthFinding(result)] : [];
				},
				repair: legacyOwnedRepair(async () => {
					const { configAuditScrubToRepairEffect, detectConfigAuditScrubIssue } = await import("./doctor-config-audit-scrub-lZ8EQuhf.js");
					const result = await detectConfigAuditScrubIssue();
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				async detect() {
					const { detectLegacySandboxRegistryFileIssues, legacySandboxRegistryInspectionToHealthFinding } = await import("./doctor-sandbox-BNydpIbk.js");
					return (await detectLegacySandboxRegistryFileIssues()).map(legacySandboxRegistryInspectionToHealthFinding);
				},
				repair: legacyOwnedRepair(async () => {
					const { detectLegacySandboxRegistryFileIssues, legacySandboxRegistryInspectionToRepairEffect } = await import("./doctor-sandbox-BNydpIbk.js");
...
const loadCommandFormatModule = async () => await import("./command-format-DEWHHA6H.js");
const loadDoctorCoreChecksModule = async () => await import("./doctor-core-checks-ByxOipGh.js");
const loadNoteModule = async () => await import("./terminal-core/note.js");
const loadOnboardHelpersModule = async () => await import("./onboard-helpers-Cwjb9WEP.js");
const loadSecretTypesModule = async () => await import("./types.secrets-Od2f3Wed.js");
async function runGatewayConfigHealth(ctx) {
	const { formatCliCommand } = await loadCommandFormatModule();
	const { hasAmbiguousGatewayAuthModeConfig } = await import("./auth-mode-policy-DVEQzXYK.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeMigrateAuthProfileJsonStoresToSqlite } = await import("./doctor-auth-flat-profiles-FdHx11_T.js");
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-D4_oHY83.js");
	const { maybeRepairLegacyOAuthSidecarProfiles } = await import("./doctor-auth-oauth-sidecar-BZFIh3Lw.js");
	const { maybeMigrateLegacyPluginModelCatalogs } = await import("./doctor-plugin-model-catalog-C4v6p2DB.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride, noteSharedAuthStoreStatus } = await import("./doctor-auth-CK-aFHoW.js");
	const { buildGatewayConnectionDetails } = await import("./call-DPYKD0iw.js");
	const { note } = await loadNoteModule();
	...
	const { maybeMigrateModelCatalogCredentials } = await import("./doctor-model-catalog-credentials-CNmdQaxL.js");
	...
	if (ctx.configResult.retiredAuthProfileCleanupPlans?.length) {
		const { runRetiredAuthProfileCleanup, runWriteConfigHealth } = await import("./doctor-health-contribution-runners.config-BaFWXDAp.js");
	...
	if (authProfileHealthReady) await noteAuthProfileHealth({
		cfg: ctx.cfg,
		prompter: ctx.prompter,
...
async function runGatewayAuthHealth(ctx) {
	...
	const { resolveGatewayAuthToken } = await import("./auth-token-resolution-arWrL887.js");
	const { note } = await loadNoteModule();
	...
	if (gatewayTokenRef && gatewayTokenRef.source === "exec") {
		const { getSkippedExecRefStaticError } = await import("./exec-resolution-policy-CtUxsQY0.js");
...
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-BmV28Q4w.js");
	const { note } = await loadNoteModule();
	await runCoreContributionHealth(ctx, ["core/doctor/removed-workspaces-state"]);
	const { prepareLegacySessionSurfaces } = await import("./legacy-session-surfaces-lpP-s1qO.js");
...
async function runSystemdLingerHealth(ctx) {
	...
	const { readGatewayServiceState, resolveGatewayService } = await import("./service-DtomRPGX.js");
...
async function detectSystemdLingerFindings(ctx) {
	...
	const { readGatewayServiceState, resolveGatewayService } = await import("./service-DtomRPGX.js");
	if ((await readGatewayServiceState(resolveGatewayService(), { env: process.env })).loadState.status !== "loaded") return [];
	const { isSystemdUserServiceAvailable, readSystemdUserLingerStatus, resolveSystemdUserServiceAccount } = await import("./systemd-R20Y84Rl.js");
...
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-CzbjSUx8.js");
...
async function runGatewayHealthChecks(ctx) {
	...
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-xbFs-Fmj.js");
...
async function resolveDoctorContributionHealthChecks() {
	const { createCoreHealthChecks } = await import("./doctor-core-checks-ByxOipGh.js");
