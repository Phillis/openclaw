...
import { c as stopOpenClawChrome } from "./chrome-Bz25Dp6i.js";
...
async function loadPwAiModule(mode) {
	try {
		const { pwAi } = await import("./pw-ai-TQGFqmLp.js");
...
async function getChromeMcpModule() {
	return await import("./chrome-mcp-Cv0k8Jbm.js");
}
//#endregion
