...
import { D as resolveExpiresAtMsFromDurationMs, E as resolveDateTimestampMs, b as parseFiniteNumber, g as isFutureDateTimestampMs, o as asDateTimestampMs } from "./number-coercion-CLj0HTDM.js";
...
import { f as resolveAgentWorkspaceDir, p as resolveAmbientOwnerAgentId, t as AgentSelectionRequiredError } from "./agent-scope-config-CUBiGmG3.js";
...
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-kxni9fig.js";
import { _ as getVoiceProviderConfig, b as resolveSupportedVoiceModelRefs, v as providerMatchesId } from "./loader-BcKpDiEM.js";
...
import { $i as validateTalkClientCreateParams, Ou as UI_APPEARANCE_PREFERENCE_KEYS, Qi as validateTalkClientCloseParams, Zi as validateTalkCatalogParams, _a as validateTalkSpeakParams, aa as validateTalkClientTranscriptParams, ca as validateTalkModeParams, da as validateTalkSessionCancelOutputParams, ga as validateTalkSessionSubmitToolResultParams, ha as validateTalkSessionSteerParams, ku as normalizeUiAppearancePreference, la as validateTalkSessionAcknowledgeMarkParams, ma as validateTalkSessionCreateParams, na as validateTalkClientSteerParams, oa as validateTalkConfigParams, pa as validateTalkSessionCloseParams, ra as validateTalkClientToolCallParams, ua as validateTalkSessionAppendAudioParams } from "./src-4dv5TpeQ.js";
...
import { A as flushClientVoiceSessionWrites, C as appendRelayVoiceTranscript, D as closeStaleClientVoiceSessions, E as closeRelayVoiceSessionRecord, F as VOICE_TRANSCRIPT_QUEUE_POLICY, I as normalizeVoiceTranscriptText, L as BoundedSerialQueue, M as resolveClientVoiceAgentSessionId, N as resolveClientVoiceSessionOrigin, O as createOrResumeClientVoiceSession, P as resolveOpenClientVoiceSessionId, R as authorizeClientVoiceConfirmation, S as appendClientVoiceTranscript, T as closeClientVoiceSession, j as registerClientVoiceConsultRun, k as ensureClientVoiceAgentSessionEntry, w as assertClientVoiceSessionOpen, z as bindAuthorizedClientVoiceConfirmation } from "./agent-tools.before-tool-call-D89j2U3t.js";
import { r as assertSecretOwnerAvailable, u as isSecretOwnerAvailable } from "./runtime-degraded-state-D5EZZ925.js";
import { a as getSpeechProvider, i as canonicalizeSpeechProviderId, s as listSpeechProviders } from "./directives-r7hZudXu.js";
import { S as withSpeakerSelectionFallbackCompat, h as resolveTtsConfig, x as withSpeakerSelectionCompat } from "./tts-settings-BPz5yC2d.js";
import { n as redactConfigObject } from "./redact-snapshot-Cc1aNUFV.js";
import { l as readSessionPreviewItemsFromTranscript } from "./session-transcript-readers-fCOIrclF.js";
import { C as getUserPreferences } from "./user-profiles-tailscale-login-kvQH2eWv.js";
import { c as resolveUserProfileId } from "./user-profiles-CBL8neN1.js";
import { n as resolveRequestedSessionAgentId } from "./session-request-agent-C9E8iDY4.js";
import { S as isCodeHeavySpeechText, w as getResolvedSpeechProviderConfig, x as CODE_HEAVY_SPOKEN_FALLBACK, y as synthesizeTalkSpeech } from "./runtime-api-Bww67amX.js";
import "./tts-CPk-KJAA.js";
import { s as registerChatAbortController, t as abortChatRunById } from "./chat-abort-CsMNzOPX.js";
import { t as createPluginRuntime } from "./runtime-CDK6uzpo2.js";
import { t as formatForLog } from "./ws-log-CjO1AAG7.js";
import { n as getRealtimeTranscriptionProvider, r as listRealtimeTranscriptionProviders, t as canonicalizeRealtimeTranscriptionProviderId } from "./provider-registry-X-oydjrB.js";
import { n as resolveRealtimeBootstrapContextInstructions } from "./realtime-bootstrap-context-d6bmsWxL.js";
import { $ as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, C as REALTIME_VOICE_AGENT_CONSULT_TOOL, E as buildRealtimeVoiceAgentConsultChatMessage, G as recordTalkObservabilityEvent, H as readSpeakableRealtimeVoiceToolResult, I as resolveRealtimeVoiceAgentConsultToolsAllow, N as parseRealtimeVoiceAgentConsultArgs, S as consultRealtimeVoiceAgent, U as createTalkSessionController, _ as listRealtimeVoiceProviders, d as resolveConfiguredRealtimeVoiceProvider, f as resolveRealtimeVoiceProviderCapabilities, h as canonicalizeRealtimeVoiceProviderId, k as buildRealtimeVoiceAgentConsultWorkingResponse, m as resolveInternalRealtimeVoiceGatewayRelayLaunchError, n as handleRealtimeVoiceHarnessBridgeEvent, p as cancelInternalRealtimeVoiceBrowserSession, t as createRealtimeVoiceSessionHarness, u as isRealtimeVoiceProviderConfigured, w as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "./realtime-session-harness-BIfCDu_t.js";
import { a as buildRealtimeVoiceAgentCancelProviderResult, d as shouldAutoControlRealtimeVoiceAgentText, i as REALTIME_VOICE_AGENT_CONTROL_TOOL_NAME, l as parseRealtimeVoiceAgentControlToolArgs, o as buildRealtimeVoiceAgentControlSpeechMessage, r as REALTIME_VOICE_AGENT_CONTROL_TOOL, t as controlRealtimeVoiceAgentRun } from "./agent-run-control-B4RdSbFH.js";
import { n as resolveProviderRawConfig } from "./provider-selection-runtime-CHZAvXNg.js";
...
import { n as handleChatSendWithRuntimeTools, t as handleChatSend } from "./chat-send-handler-Cc-XJB9u.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-B4uiotn0.js";
import "./server-utils-C3MkyEfr.js";
import { t as inferSpeechMimeType } from "./speech-mime-DVntQu9L.js";
import { a as rememberUnifiedTalkSession, i as registerTalkConnectionCleanup, n as forgetUnifiedTalkSession, o as requireUnifiedTalkSessionConn, r as getUnifiedTalkSession } from "./talk-session-registry-BFXYERqh.js";
...
function resolveTalkAgentConsultAuthority(scopes) {
	const senderIsOwner = scopes?.includes(ADMIN_SCOPE) === true;
	if (senderIsOwner || scopes?.includes("operator.write") === true) return { senderIsOwner };
	return {
		senderIsOwner: false,
...
const loadTalkAgentExecution = createLazyRuntimeModule(async () => {
	const [embeddedAgent, admission] = await Promise.all([import("./embedded-agent-fNRs635m.js"), import("./admitted-run-context-BWSMtoE-.js")]);
	return {
...
async function startTalkRealtimeAgentConsult(params) {
	...
	const chatResponse = await new Promise((resolve) => {
		...
		const chatSendResult = authority.toolsAllow !== void 0 ? handleChatSendWithRuntimeTools(chatSendOptions, authority.toolsAllow) : handleChatSend(chatSendOptions);
...
const talkClientHandlers = {
	...
	"talk.client.toolCall": async (request) => {
		...
		if (params.name !== "openclaw_agent_consult") {
			rejectTalkClientRequest(respond, ErrorCodes.INVALID_REQUEST, `unsupported realtime Talk tool: ${params.name}`);
			return;
		}
	...
	"talk.client.steer": async ({ params, respond, client, context }) => {
		...
		if (!hasOwnedActiveTalkClientRun({
			...
			rejectTalkClientRequest(respond, ErrorCodes.INVALID_REQUEST, "talk.client.steer requires an active browser-owned Talk run");
			return;
		}
		try {
...
function resolveTalkResponseFromConfig(params) {
	...
	else if (!isSecretOwnerAvailable("capability", "talk:speech")) return payload;
