...
import { a as resolveControlUiAssetHealth, n as ensureControlUiAssetsBuilt, o as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-D92--EZN.js";
...
async function detectUiProtocolFreshnessIssues(opts = {}) {
	...
	try {
		...
		if (!uiStats || uiHealth.kind !== "ready") return [{
			kind: "missing-assets",
			root,
			uiIndexPath,
			canBuild
