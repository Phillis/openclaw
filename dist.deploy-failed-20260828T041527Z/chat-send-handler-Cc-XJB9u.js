...
import { a as isSubagentSessionKey, c as parseAgentSessionKey, i as isCronSessionKey, n as isAcpSessionKey$1 } from "./session-key-utils-Di3FvABa.js";
...
import { a as measureDiagnosticsTimelineSpan, n as emitDiagnosticsTimelineEvent, o as measureDiagnosticsTimelineSpanSync } from "./diagnostics-timeline-DhDccUEp.js";
...
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-UYcIi_5g.js";
import { t as ErrorCodes } from "./gateway-error-details-C2IaYyht.js";
import { i as loadOrCreateProcessDeviceIdentity } from "./device-identity-BxyBO0GA.js";
import { K as validateChatSendParams } from "./src-4dv5TpeQ.js";
import "./method-scopes-BQC2sTma.js";
import { o as resolveSessionRoutingContract, r as resolveAgentMainSessionKey, t as SESSION_ROUTING_CHANGED_ERROR_REASON } from "./main-session-CPkeRwvL.js";
import { C as upsertSessionEntryCore, m as patchSessionEntryCore, p as loadSessionEntryReadOnly, s as listSessionEntryKeysReadOnly } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
...
import { d as sessionDeliveryOrigin, n as deliveryContextFromSession, u as sessionDeliveryChannel } from "./delivery-context.shared-azPdmUls.js";
import { a as isInternalMessageChannel, c as isOperatorUiClient, i as isGatewayCliClient, n as isBrowserOperatorUiClient, t as isBrowserCopilotClient, u as isWebchatClient } from "./message-channel-BZwx7FCw.js";
import { c as interruptSessionWorkAdmissions, l as isCompetingSessionWorkAdmissionActive, n as beginSessionWorkAdmission, p as runExclusiveSessionLifecycleMutation } from "./session-lifecycle-admission-BtKN0pjk.js";
...
import { nt as updateSessionEntry, o as readSessionTranscriptActivePathEntryRelation, t as readSessionTranscriptWatermark } from "./session-accessor-fcDZuc2H.js";
import { a as hasRestartRecoveryTerminalRun, t as buildRestartRecoveryClaimCleanupPatch } from "./restart-recovery-state-6FYlAu33.js";
...
import { i as stripInlineDirectiveTagsForDelivery, r as sanitizeReplyDirectiveId, t as parseInlineDirectives } from "./directive-tags-DqL78ij5.js";
import { d as errorShape, t as formatValidationErrors } from "./validation-errors-rELRlKfn.js";
import { r as hasGlobalHooks, t as getGlobalHookRunner } from "./hook-runner-global-CDBq1X4a.js";
import { a as getReplyPayloadMetadata, d as isReplyPayloadTtsSupplement, l as isReplyPayloadStatusNotice, o as getReplyPayloadTtsSupplement, r as buildTtsSupplementMediaPayload } from "./reply-payload-BeeUJOmJ.js";
...
import { t as MEDIA_MAX_BYTES } from "./store-fXRck5jl.js";
import { a as parseInboundMediaUri } from "./media-reference-Dvseu3P_.js";
...
import { d as isPluginOwnedSessionBindingRecord } from "./conversation-binding-C5Df563Z.js";
import { a as shouldComputeCommandAuthorized } from "./command-detection-CbcRbKE1.js";
import { n as resolveAgentTimeoutMs } from "./timeout-DlFI6Ssz.js";
import { A as isReplyRunAbortableForSignal, D as finalizeReplyMessageInjectionAttempt, E as beginReplyMessageInjectionTarget, R as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, m as replyRunRegistry, s as interruptReplyRunTarget } from "./reply-run-registry-Ch9Ye6re.js";
import { a as logMessageReceived, r as logMessageProcessed } from "./diagnostic-DOfHG5L4.js";
import { m as listActiveEmbeddedRunSessionIds } from "./run-state-CmAt4u6E.js";
...
import { n as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-CtOvegzo.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-lFkLlNeH.js";
...
import { a as emitInboundMessageAuditTerminal, n as emitMessageReceivedHooks } from "./dispatch-from-config-0imwmCWn.js";
...
import { S as projectChatDisplayMessage, i as readSessionMessageByIdAsync } from "./session-transcript-readers-fCOIrclF.js";
...
import { n as resolveSessionEntryResetFreshness } from "./entry-freshness-DtB-5U5I.js";
...
import { i as dispatchInboundMessageWithProjectedDispatcher } from "./dispatch-BWl66NbQ.js";
import { a as isChatStopCommandText, f as updateChatRunProvider, s as registerChatAbortController, u as resolveChatRunExpiresAtMs } from "./chat-abort-CsMNzOPX.js";
import { n as chatRunBelongsToSelectedAgent, r as resolveChatRunOwnerAgentId } from "./chat-run-owner-Bu4zznGp.js";
import { t as chatAbortMarkerTimestampMs } from "./server-chat-state-BuGrMjm1.js";
import { a as registerQueuedChatTurn, o as retireQueuedChatTurnCancellation, r as completeQueuedChatTurn } from "./chat-queued-turns-CEBu4Zkd.js";
...
import { n as buildInboundUserContextPrefix } from "./inbound-meta-CdaYvuyM.js";
import { n as isBtwRequestText } from "./btw-command-B-jQHunE.js";
import { t as formatForLog } from "./ws-log-CjO1AAG7.js";
import { c as githubApiToken } from "./control-ui-github-api-DURS8eJ_.js";
...
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-TVUNem0g.js";
import { n as resolveChatAttachmentMaxBytes } from "./chat-attachment-policy-BsshswU5.js";
import { c as persistInboundImagesForTranscript, i as discardPreparedInboundMedia, l as stripImageMediaMarkers, n as MediaOffloadError, o as logAttachmentFailure, r as UnsupportedAttachmentError, s as parseMessageWithAttachments, t as INLINE_IMAGE_DURABLE_OMISSION_MARKER } from "./chat-attachments-DPVCWrZk.js";
import { a as persistGatewaySessionLifecycleEvent, r as deriveGatewaySessionLifecycleSnapshot } from "./session-event-payload-CreU6-ED.js";
import { r as hasTrackedActiveSessionRun } from "./session-active-runs-CJd39CY4.js";
import { n as emitSessionsChanged } from "./session-change-event-Cjm468kd.js";
import { A as resolveChatAbortRequester, C as sanitizeAssistantDisplayText, F as setGatewayDedupeEntry, M as writePreRegisteredChatAbort, N as normalizeOptionalChatText, P as normalizeUnknownChatText, S as replaceAssistantContentTextBlocks, T as buildAbortedChatSendPayload, _ as hasAssistantDisplayMediaContent, b as hasVisibleAssistantFinalMessage, c as assistantTranscriptScope, d as rewriteAssistantTranscriptMessageByTurnIndexAndMedia, f as rewriteSourceReplyTranscriptMirrors, g as extractAssistantDisplayTextFromContent, h as extractAssistantDisplayText, k as readPreRegisteredRun, l as publishAssistantTranscriptRewrite, m as combineNonStreamingReplyParts, p as buildAssistantDisplayContentFromReplyPayloads, r as createChatAbortOps, s as appendAssistantTranscriptMessage, t as abortChatRunsForSessionKeyWithPartials, u as rewriteAssistantTranscriptMessageByIdempotencyKey, v as hasManagedOutgoingAssistantContent, w as stripManagedOutgoingAssistantContentBlocks, x as isMediaBearingPayload, y as hasSensitiveMediaPayload } from "./chat-abort-runtime-DroEkxn7.js";
...
import { i as attachManagedOutgoingMediaToMessage } from "./managed-image-attachments-BmbhAxU8.js";
import { t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BA7mKleS.js";
import { i as maybeGenerateDashboardSessionTitle, r as isDashboardSessionTitleCandidate, t as buildDashboardSessionTitleSource } from "./dashboard-session-title-Dh3CHcmY.js";
import { r as resolveInboundReplyToolAuthorityOverlay } from "./reply-tool-authority-BSgwnSZC.js";
...
import { r as parseProjectGitUrl, t as materializeProjectClone } from "./project-clone-BIIMr8xP.js";
import { c as resolveProjectDirectory } from "./project-registry-DuJO7XqH.js";
import { r as hasActiveAgentRuntimeAuthority } from "./agent-runtime-authority-DnVI97Gp.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-D15dPL-L.js";
...
function validateChatSelectedAgent(params) {
	const resolved = resolveRequestedSessionAgentId(params.cfg, params.requestedSessionKey, params.explicitAgentId);
	return resolved.ok ? {
		ok: true,
...
async function resolveDurableChatClaim(params) {
	...
	if (isAdoptedRestartRecoveryClaim(entry, params.clientRunId) && entry.status === "running" && entry.abortedLastRun === true) {
		...
		try {
			const { retryRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-WvD0I0ZR.js");
...
async function finalizeAcceptedChatSendMessageInjection(params) {
	...
	emitInboundMessageAuditTerminal({
		...
		terminal: steerAborted ? {
			outcome: "skipped",
			options: { reason: "reply_operation_aborted" }
		} : {
			outcome: "completed",
...
async function finalizeChatSendNonAgentReplies(params) {
	...
	const transcriptReply = mediaMessage?.transcriptText || (managedMediaPrepareFailed ? transcriptDisplayReply : buildTranscriptReplyText(finalPayloads)) || transcriptDisplayReply;
	let message;
...
function createChatSendLateReplyFinalizer(params) {
	return async ({ runId, payloads }) => await finalizeChatSendAgentReplyPayloads({
		...params,
...
function createChatSendTurnAdoptionLifecycle(params) {
	...
	const lifecycle = {
		...
		onDeferred: () => {
			...
			if (enqueued) lateFollowup.recordQueued();
			return enqueued;
		},
...
function buildChatSendMessageContext(params) {
	...
	const sandbox = params.cfg ? resolveCreatorSandbox(params.cfg, creation) : void 0;
	const ctx = {
...
function prepareSessionCreateFilesystemRoot(params) {
	...
	if (params.sessionCwd && params.enforceSandboxContainment) {
		...
		}).sandboxed && !isPathInside(resolveUserPath(resolveAgentWorkspaceDir(params.cfg, params.targetAgentId)), resolveUserPath(params.sessionCwd))) return err(errorShape(ErrorCodes.INVALID_REQUEST, params.requestedProjectId ? "sessions.create project is outside the sandboxed agent workspace" : "sessions.create cwd is outside the sandboxed agent workspace"));
	}
	const rootCandidate = params.sessionCwd ?? resolveAgentWorkspaceDir(params.cfg, params.targetAgentId);
	try {
...
function validateSessionProjectPreparation(params) {
	...
	if (params.projectId || params.cwd || params.execNode || params.worktree) return errorShape(ErrorCodes.INVALID_REQUEST, "sessions.create projectGitUrl cannot be combined with projectId, cwd, execNode, or worktree");
...
async function prepareSessionProjectWorkspace(params) {
	...
	if (!entry || !gitUrl || gitUrl !== entry.pendingProjectGitUrl) throw new Error("Saved project repository is invalid; select the repository and retry.");
	...
	const bound = await patchSessionEntryCore({
		...
		assertRunOwnership();
		if (current.sessionId !== entry.sessionId || current.pendingProjectGitUrl !== gitUrl || current.projectId && current.projectId !== project.id) throw new Error(SESSION_PROJECT_OWNERSHIP_ERROR);
		return {
	...
	assertRunOwnership();
	if (!bound) throw new Error("Session disappeared while preparing its project; start a new session.");
...
function startChatDispatch(params) {
	const { admissionStartedAt, admission, attachments, client, context, toolsAllow, skillWorkshopProposalRevision, cronCreatorAuthority, externalAuthorityAdmission, injection, request, session, terminalizeRestartSafeAdmission, timing, turn, userTurn } = params;
	const { imageOrder } = attachments;
	const { activeRunAbort, admittedSessionId, chatSendTraceAttributes, gatewayWorkAdmission, messageInjectionTarget, retainGatewayWorkAdmission, restartSafeAdmission } = admission;
	const { activeRunScopeKey, agentId, backingSessionId, cfg, clientRunId, entry, expectedLeafEntryId, requestedSessionId, resolvedSessionModel, selectedAgent, sessionKey } = session;
	...
	const dispatch = replyDispatch.runAgentMediaTranscript(gatewayWorkAdmission, () => measureDiagnosticsTimelineSpan("gateway.chat_send.dispatch_inbound", async () => {
			...
			return dispatchInboundMessageWithProjectedDispatcher({
				...
				replyOptions: {
					...
					onAgentRunStart: (runId) => {
						if (activeRunAbort.markExecutionStarted()) emitSessionsChanged(context, {
							sessionKey,
							agentId,
		...
		await measureDiagnosticsTimelineSpan("gateway.chat_send.post_dispatch", async () => {
			const returnedAgentErrorPayloads = replyDispatch.deliveredReplies.map((entryInner) => entryInner.payload).filter((payload) => payload.isError);
			const hasReturnedAgentError = returnedAgentErrorPayloads.length > 0 && (agentRunStarted || !isInternalTextSlashCommandTurn);
			...
			if (hasReturnedAgentError && !userTurnRecorder.hasPersisted() && !userTurnRecorder.isBlocked()) await persistGatewayUserTurnTranscriptBestEffort();
			...
			if (!agentRunStarted && !queuedFollowup.isEnqueued() && !hasReturnedAgentError) await finalizeChatSendNonAgentReplies({
				accountId,
				context,
...
//#endregion
//#region src/sessions/session-rotation.ts
const MILLIS_PER_HOUR = 36e5;
...
const SESSION_ROTATION_CHANGED_ERROR_REASON = "session-rotation-changed";
const ROTATED_SUFFIX_RE = /:r(\d+)$/;
/** Parses a rotated `base:rK` session key into { baseKey, epoch } (epoch >= 1). */
function parseRotatedSessionKey(key) {
	if (!key) return;
	...
	return {
		baseKey: key.slice(0, key.length - match[0].length),
		epoch
	};
}
/** Deterministic rotated session key for a rotation-eligible base peer key. */
function buildRotatedSessionKey(baseKey, epoch) {
...
*/
function isRotationEligibleSessionKey(key, options = {}) {
	const raw = (key ?? "").trim();
	if (!raw) return false;
	...
	if (rest.toLowerCase() === mainKey) return false;
	if (isCronSessionKey(base) || isSubagentSessionKey(base)) return false;
	if (base.toLowerCase().endsWith(":handoff")) return false;
	return /(?:^|:)direct(?::|$)/i.test(rest) || /:group:|:channel:/i.test(rest);
}
/** Resolves the rotation-trigger reason (turns/age) for an active entry. */
function resolveRotationTrigger(params) {
	...
	const ageHours = (startedAt === void 0 ? 0 : Math.max(0, params.now - Math.max(0, startedAt))) / MILLIS_PER_HOUR;
	const maxTurns = params.rotation.maxTurns;
	const maxAgeHours = params.rotation.maxAgeHours;
	if (maxTurns !== void 0 && maxTurns > 0 && turnCount >= maxTurns) return {
		reason: "turns",
		turnCount,
		ageHours
	};
	if (maxAgeHours !== void 0 && maxAgeHours > 0 && ageHours >= maxAgeHours) return {
		reason: "age",
		turnCount,
		ageHours
	};
...
function isRotationEnabled(rotation) {
	...
	return rotation.maxTurns !== void 0 && rotation.maxTurns > 0 || rotation.maxAgeHours !== void 0 && rotation.maxAgeHours > 0;
}
function accessScope(scope, sessionKey) {
	return {
...
function loadRotationEntry(scope, sessionKey) {
...
*/
function resolveCurrentRotationEpoch(scope, baseKey) {
	...
	for (const persistedKey of keys) {
		let epoch;
		if (persistedKey === baseKey) epoch = 0;
		else {
			const parsed = parseRotatedSessionKey(persistedKey);
			if (!parsed || parsed.baseKey !== baseKey) continue;
			epoch = parsed.epoch;
		}
		if (loadRotationEntry(scope, persistedKey)?.archivedAt === void 0) {
			if (epoch > bestEpoch) bestEpoch = epoch;
		}
	}
	const epoch = bestEpoch >= 0 ? bestEpoch : 0;
	return {
		epoch,
		key: epoch === 0 ? baseKey : buildRotatedSessionKey(baseKey, epoch)
	};
}
/**
...
*/
async function runSessionRotationAdmission(params) {
	const now = params.now ?? Date.now();
	if (!isRotationEnabled(params.rotation)) return {
		baseKey: params.baseKey,
		targetKey: params.baseKey,
		rotated: false
	};
	return await runExclusiveSessionLifecycleMutation({
		...
		run: async () => {
			...
			const trigger = resolveRotationTrigger({
				entry: currentEntry,
				baseSessionStartedAt: loadRotationEntry(params.scope, params.baseKey)?.sessionStartedAt,
			...
			if (trigger.reason !== null) {
				...
				if (currentEntry) await upsertSessionEntryCore(accessScope(params.scope, current.key), {
					archivedAt: now,
					archivedBy: {
						type: "rotation",
						id: "rotation"
				...
				log.info(`[session-rotation] baseKey=${params.baseKey} from=${current.key} to=${targetKey} reason=${trigger.reason} turnCount=${trigger.turnCount} ageHours=${trigger.ageHours.toFixed(2)}`);
			}
...
*/
function resolveSessionRotationRetryTarget(scope, baseKey) {
	return {
		baseKey,
		targetKey: resolveCurrentRotationEpoch(scope, baseKey).key
	};
}
/**
...
*/
async function resolveSessionRotationAdmissionTarget(params) {
	const { rotation } = params;
	if (!rotation || !isRotationEnabled(rotation)) return {
		sessionKey: params.sessionKey,
		rotated: false
	};
	if (!isRotationEligibleSessionKey(params.sessionKey, { mainKey: params.mainKey })) return {
		sessionKey: params.sessionKey,
		rotated: false
	};
	...
	return {
		sessionKey: admission.targetKey,
		rotated: admission.rotated
	};
}
/**
...
*/
function shouldEnforceCeiling(params) {
	const ceiling = params.rotation?.ceilingTokens;
	if (ceiling === void 0 || ceiling <= 0 || !params.isMainLongLived) return false;
	return params.estimatedTokens !== void 0 && params.estimatedTokens >= ceiling;
}
function resolveSessionCeilingEstimate(entry) {
...
*/
async function runSessionCeilingCycle(params) {
	if (!shouldEnforceCeiling({
		rotation: params.rotation,
		sessionKey: params.sessionKey,
	...
	log.info(`[session-ceiling] sessionKey=${params.sessionKey} estimatedTokens=${params.estimatedTokens} ceilingTokens=${params.rotation?.ceilingTokens} requesting compaction`);
	try {
		if (params.runCompaction) await params.runCompaction();
	} catch (error) {
		log.warn(`[session-ceiling] compaction failed for ${params.sessionKey}; admitting anyway: ${error instanceof Error ? error.message : String(error)}`);
	}
	return {
...
async function admitChatSend(params) {
	...
	const assertChatWorkAdmissionAllowed = (commitOutcome) => {
		...
		if (commitOutcome && p.queueMode !== "steer" && expectedLeafEntryId !== void 0) {
		...
		if (archivedError) {
			if (latestEntry?.archivedAt !== void 0 && (latestEntry?.archivedBy)?.type === "rotation") throw new Error(SESSION_ROTATION_CHANGED_ERROR_REASON);
	...
	try {
		...
		if (err instanceof Error && err.message === "session-rotation-changed") return {
			ok: false,
...
function resolveRotationStoreScope(session) {
	return {
		agentId: session.agentId,
		env: process.env,
		storePath: session.storePath
...
async function resolveChatSendRotationTarget(params) {
	...
	if (!rotation) return requestSessionKey;
	const eligible = isRotationEligibleSessionKey(requestSessionKey, { mainKey: params.mainKey });
	if (!eligible && rotation.ceilingTokens !== void 0) await runSessionCeilingCycle({
		scope: resolveRotationStoreScope(session),
		sessionKey: requestSessionKey,
		rotation,
		estimatedTokens: resolveSessionCeilingEstimate(session.entry)
	});
	if (!isRotationEnabled(rotation) || !eligible) return requestSessionKey;
	return (await resolveSessionRotationAdmissionTarget({
		scope: resolveRotationStoreScope(session),
		sessionKey: requestSessionKey,
		rotation,
		mainKey: params.mainKey
...
async function prepareAndAdmitChatSend({ params, respond, context, client }, onAdmissionOwned, options) {
	...
	while (true) {
		if (!rotationResolved) {
			...
			const preparedRotation = prepareChatSendSession({
				request,
				context,
				client
			});
			if (!preparedRotation.ok) {
				respond(false, void 0, typeof preparedRotation.error === "string" ? errorShape(ErrorCodes.INVALID_REQUEST, preparedRotation.error) : preparedRotation.error);
				return;
			}
		...
		if (admitted && "retryAfterRotation" in admitted && admitted.retryAfterRotation && rotationRetriesRemaining > 0) {
			rotationRetriesRemaining -= 1;
			const baseKey = parseRotatedSessionKey(request.p.sessionKey)?.baseKey ?? request.p.sessionKey;
			const retryTarget = resolveSessionRotationRetryTarget(resolveRotationStoreScope(preparedSession.value), baseKey);
			if (retryTarget.targetKey !== request.p.sessionKey) {
				request.p.sessionKey = retryTarget.targetKey;
				rotationResolved = true;
				continue;
			}
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, "session rotated while starting work"));
			return;
		}
		return;
	}
...
async function handleChatSendWithOptions({ params, respond, context, client }, onAdmissionOwned, externalAuthorityAdmission, options) {
	...
	admitted.value.setDiscardAbandonedPreparedMedia(() => {
		if (!preparedMediaRecorder?.hasPersisted()) discardPreparedInboundMedia(preparedAttachments.value.offloadedRefs);
	});
...
async function handleChatSendWithRuntimeTools(options, toolsAllow) {
	await handleChatSendWithOptions(options, void 0, void 0, { toolsAllow });
}
...
//#endregion
export { normalizeSessionProjectGitUrl as a, resolveRequestedChatAgentId as c, resolveGlobalAwareNodeChatDeliveryKeys as d, sendGlobalAwareNodeChatPayload as f, handleTrustedInternalChatSend as i, validateChatSelectedAgent as l, handleChatSendWithRuntimeTools as n, validateSessionProjectPreparation as o, handleChatSendWithSkillWorkshopProposalRevision as r, prepareSessionCreateFilesystemRoot as s, handleChatSend as t, sanitizeChatSendMessageInput as u };
