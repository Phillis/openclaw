...
function hasModelsOutputOption(argv, token, command) {
	return command ? hasCommanderOptionToken(command, argv, /* @__PURE__ */ new Set([token]), "flag") : hasMachineOutputOption(argv, token);
}
/** Resolve the parent-command alias for `models status --json`. */
function isModelsStatusJsonOutput(argv, command) {
	return hasModelsOutputOption(argv, "--json", command) || resolveModelsParentCommandPath(argv)?.length === 1 && hasModelsOutputOption(argv, "--status-json", command);
}
function isModelsPlainMachineOutput(argv, command) {
	const commandPath = resolveModelsParentCommandPath(argv);
	return commandPath !== null && (hasModelsOutputOption(argv, "--plain", command) || commandPath.length === 1 && hasModelsOutputOption(argv, "--status-plain", command));
}
//#endregion
...
//#endregion
export { MACHINE_OUTPUT_JSON_OPTION_DESCRIPTION as $, getCommanderSubcommandFact as A, resolveGatewayCatalogCommandPath as B, isProxyMachineOutput as C, getCommanderCommandPath as D, isModelsStatusJsonOutput as E, MODELS_PARENT_VALUE_FLAGS as F, isCronMachineOutput as G, isDevicesMachineOutput as H, resolveParentAwareCommandPath as I, getCoreCliCommandsWithSubcommands as J, getCoreCliCommandDescriptors as K, isGatewayMachineOutput as L, markCommanderLazyCommand as M, setCommanderErrorCommand as N, getCommanderErrorCommandNames as O, MODELS_PARENT_BOOLEAN_FLAGS as P, isConfigSetJsonParseOnly as Q, consumeGatewayFastPathRootOptionToken as R, isSkillsMachineOutput as S, isModelsPlainMachineOutput as T, CRON_GATEWAY_OPTION_NAMES as U, resolveGatewayRunPreBootstrapOptions as V, createCronOutputCommand as W, isDoctorMachineOutput as X, getCoreCliParentDefaultHelpCommands as Y, isConfigMachineOutput as Z, getSubCliCommandsWithSubcommands as _, getPrimaryCommand as a, loadPrivateQaCliModule as b, hasRootVersionAlias as c, isRootVersionInvocation as d, isMachineOutputStdoutTTY as et, isSimpleCommandHelpInvocation as f, normalizeRootNoColorArgv as g, normalizeRootLogLevelArgv as h, getPositiveIntFlagValue as i, hasCommanderOptionToken as j, getCommanderErrorCommandPath as k, isHelpOrVersionInvocation as l, normalizeRootHelpTargetArgv as m, getCommandPathWithRootOptions as n, getVerboseFlag as o, normalizeGeneratedHelpCommandArgv as p, getCoreCliCommandNamesCore as q, getFlagValue as r, hasFlag as s, buildParseArgv as t, isRootHelpInvocation as u, getSubCliEntriesCore as v, isNodesMachineOutput as w, isSystemMachineOutput as x, getSubCliParentDefaultHelpCommands as y, consumeGatewayRunOptionToken as z };
