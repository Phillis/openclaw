...
import { g as projectProviderCatalogResultToUnifiedTextRows } from "./loader-BcKpDiEM.js";
...
import { n as buildManifestModelProviderConfig, s as readManifestProviderDefaultModelRef, u as buildSingleProviderApiKeyCatalog } from "./provider-catalog-shared-__IiTHyX.js";
				...
				if ("run" in provider.catalog) {
					...
					catalog = {
						...
						run: (ctx) => {
							...
							return provider.catalog.liveModelDiscovery ? buildOpenAICompatibleProviderCatalog({
								ctx,
								providerId,
