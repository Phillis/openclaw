...
import { a as toAcpRuntimeError } from "./errors-MW5Rkd8s.js";
...
import { i as resolveBundledPluginInstallCommandHint } from "./bundled-sources-8oSxLSsI.js";
import { n as resolveAcpCommandBindingContext } from "./context-CPOkvulr.js";
import { n as ACP_DOCTOR_USAGE, p as formatAcpCapabilitiesText, r as ACP_INSTALL_USAGE, s as ACP_SESSIONS_USAGE } from "./shared-CWkdSP3T.js";
import { n as resolveBoundAcpThreadSessionKey } from "./targets-BiDa4MYW.js";
...
async function handleAcpSessionsAction(params, restTokens) {
	...
	if (!currentSessionKey) return commandReply("⚠️ Missing session key.");
