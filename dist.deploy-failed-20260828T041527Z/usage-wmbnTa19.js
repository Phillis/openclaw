import { A as resolveExpiresAtMsFromEpochSeconds, D as resolveExpiresAtMsFromDurationMs, T as positiveSecondsToSafeMilliseconds, g as isFutureDateTimestampMs, o as asDateTimestampMs } from "./number-coercion-CLj0HTDM.js";
...
import { a as isModelScopedCooldownReason, c as resolveProfileUnusableUntil, i as isAuthCooldownBypassedForProvider, r as isActiveUnusableWindow } from "./usage-state-C0QBjJnZ.js";
...
function resolveWhamCooldownClassification(reason) {
	return reason === "wham_token_expired" || reason === "wham_account_dead" ? reason : void 0;
}
function resolveWhamCanonicalCooldownReason(classification) {
...
function applyWhamCooldownResult(params) {
	...
	return {
		...
		cooldownReason: cooldownClassification ? resolveWhamCanonicalCooldownReason(cooldownClassification) : params.computed.cooldownReason,
...
function notifyAuthProfileFailureSafely() {
	try {
