...
import { a as getActiveSecretsRuntimeConfigSnapshot, o as getActiveSecretsRuntimeEnvState } from "./runtime-state-B9BywrOx.js";
import { A as CLOUD_WORKER_PAIRING_SETUP_BOOTSTRAP_PROFILE, i as ensureDevicePairSetupBootstrapToken } from "./device-bootstrap-6c0qs5r-.js";
import { m as removePairedDeviceRole, n as getPairedDevice } from "./device-pairing-BIRweQsd.js";
...
import { n as bindDeviceWorkerReconciliation, r as createDeviceWorkerRuntime, t as bindDeviceWorkerAvailability } from "./device-provider-CGBGkDeS.js";
...
const loadWorkerInferenceRuntimeModule = createLazyRuntimeModule(() => import("./inference-runtime-BfqL4NG1.js"));
async function loadGatewayWorkerEnvironmentStartupState() {
	const [{ createWorkerEnvironmentStore }, { createWorkerSessionPlacementStore }] = await Promise.all([import("./store-B2Kbp14o.js"), import("./placement-store-DC_wy3cE.js")]);
...
async function createGatewayWorkerEnvironmentRuntime(params) {
	...
	const [{ createWorkerEnvironmentService }, { createWorkerLiveEventReceiver }, { createWorkerSessionPlacementGate }, { createWorkerTranscriptCommitter }, { createWorkerTunnelManager }, { createNodeWorkerTunnelManager }, { createGatewayNodeWorkerBundleInstaller }, { createNodeWorkerBundleTransferService }, { createNodeWorkerBundleTransferHttpCallback }, { createNodeWorkspaceTransferService }, { createNodeWorkspaceTransferHttpCallback }, { createWorkerSessionToolExecutor }, { createWorkerNodeDesktopCarrier }, { createWorkerNodePortalCarrier }, { resolveWorkerProvider }] = await Promise.all([
		import("./service-BzZ5SqHI.js"),
		import("./live-events-DCiYj44X.js"),
		import("./placement-worker-gate-C0EQiOmN.js"),
		import("./transcript-commit-BXDObuHW.js"),
		...
		import("./node-worker-bundle-transfer-http-DtP95vOP.js"),
		import("./node-workspace-transfer-service-EKg-Sc5I.js"),
		import("./node-workspace-transfer-http-CW2icFxN.js"),
		import("./worker-session-tool-executor-B-dqo_ms.js"),
