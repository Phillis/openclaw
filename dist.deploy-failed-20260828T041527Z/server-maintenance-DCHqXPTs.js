...
import { c as pruneOutboundMedia, l as prunePlaybackTranscodeCache, r as cleanOldMedia } from "./store-fXRck5jl.js";
...
import { d as pruneExpiredDeliveryQueueTombstones } from "./delivery-queue-sqlite-BLVzPbnr.js";
import { n as pruneOrphanedDeliveryQueueMedia } from "./delivery-queue-media-spool-gOZs_CIq.js";
import { a as registerSkillUsageTracking } from "./curator-hJcn049c.js";
import { c as removeChatAbortControllerEntry, t as abortChatRunById } from "./chat-abort-CsMNzOPX.js";
import { t as chatAbortMarkerTimestampMs } from "./server-chat-state-BuGrMjm1.js";
import { l as pruneExpiredDevicePairSetupCompletions } from "./device-bootstrap-6c0qs5r-.js";
import { r as HEALTH_REFRESH_INTERVAL_MS, s as TICK_INTERVAL_MS, t as DEDUPE_MAX } from "./server-constants-DKuFNbQH.js";
import { i as WORKTREE_GC_INTERVAL_MS, l as managedWorktrees, u as resolveWorktreeCleanupLimits } from "./service-Be0GN-Co.js";
import { n as hasRegisteredChatRunForSessionKey } from "./session-active-runs-CJd39CY4.js";
import "./server-shared-C-7Ahu3n.js";
import { r as checkTelemetryUpdate } from "./telemetry-DxQUXMlP.js";
import { t as createManagedWorktreeOwnerProtection } from "./owner-protection-D8J4ylTo.js";
...
import { s as setBroadcastHealthUpdate } from "./health-state-BzKAU1CD.js";
...
function startGatewayMaintenanceTimers(params) {
	...
	const runManagedOutgoingMediaGc = params.runManagedOutgoingMediaGc ?? (async () => {
		const { cleanupManagedOutgoingMediaRecords } = await import("./managed-image-attachments-B5jSEOLR.js");
