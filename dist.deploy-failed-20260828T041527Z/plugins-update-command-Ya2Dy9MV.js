...
import { l as readConfigFileSnapshotForWrite, n as getRuntimeConfig, rt as ConfigMutationConflictError } from "./io-ClLVsBMp.js";
...
import { r as containsConfigIncludeDirective } from "./io.read-helpers-BfhrMUhR.js";
import { n as createMergePatch, t as applyMergePatch } from "./merge-patch-BukSB2Pq.js";
import { r as theme } from "./theme-vjDs9tao.js";
import { n as formatInvalidConfigDetails, t as createInvalidConfigError } from "./io.invalid-config-B4TKe0Mu.js";
...
import { a as withPluginInstallRecords, o as withoutPluginInstallRecords, u as configReferencesNpmInstallPath } from "./installed-plugin-index-records-CHK-Mu2-.js";
...
import { a as hasMatchingPluginLoadPath, s as removePluginRuntimePolicyFromConfig } from "./uninstall-config-1TsyUtkY.js";
import { G as requestDeferredPluginInstall, K as resolvePluginInstallOwnerMigrations, Y as settlePluginInstallTransactions } from "./install-managed-npm-state-BKmVpI9X.js";
import { i as commitPluginInstallRecordsWithConfig, r as commitPluginInstallRecordsOnly } from "./install-record-commit-BfqdA5hk.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./registry-refresh-Hpdl6ZAz.js";
import { i as selectInstallMutationWriteOptions, n as resolveCombinedPluginAndHookConfigMutationPreflight, r as resolveInstallConfigMutationPreflights } from "./install-persistence--RyplCkl.js";
import { i as resolveHookInstallDir, n as installHooksFromNpmSpec } from "./install-CVJmbiTk.js";
...
import { n as recordHookInstall, t as readHookInstalls } from "./installs-q3mBPhcR.js";
import { a as readInstalledPackageVersion, n as expectedIntegrityForUpdate, r as isPackageVersionDowngrade } from "./package-update-utils-DjAfvLGS.js";
import { a as pluginInstallRecordMayMigrateConfigId, i as isPluginInstallRecordUpdateSource, n as updateNpmInstalledPlugins, r as isClawHubTrustSkippedOutcome } from "./update-BxTnzDTG.js";
import { t as notifyGatewayPluginMetadataChanged } from "./plugins-update-gateway-signal-D-CgIxf0.js";
...
async function runPluginUpdateCommandUnlocked(params) {
	...
	const packagePluginIds = Object.fromEntries(pluginSelection.pluginIds.flatMap((pluginId) => {
		const ownership = resolveInstalledPluginPackageOwnership(installedPluginIndex, pluginId);
	...
	try {
		...
		if (!params.opts.dryRun && (pluginResult.changed || hookResult.changed)) {
			...
			await settlePluginInstallTransactions(deferredPluginTransactions, "commit").catch(() => logger.warn("Plugin update committed, but cleanup failed. Restart is required."));
			if (pluginResult.changed) {
		...
		if (!packageUpdatePersisted) await settlePluginInstallTransactions(deferredPluginTransactions, "rollback");
		throw error;
	}
}
//#endregion
