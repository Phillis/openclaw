...
import { a as normalizeChannelId, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CZjiz1Jg.js";
import "./plugins-DYpQkXDD.js";
import { r as isTerminalInteractive } from "./terminal-interactivity-DXUXAq5U.js";
import { r as parseOptionalDelimitedEntries } from "./helpers-cxjR1aAq.js";
...
import { n as resolveChannelSetupCliOptionMetadata } from "./cli-add-options-CeXElw6a.js";
import { t as normalizeExternalChannelSetupConfig } from "./config-compatibility-qirsOzmz.js";
import { n as requireValidConfigFileSnapshot } from "./config-validation-CrN71UZm.js";
import { l as shouldUseWizard } from "./shared-B0lBu2yU.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-BjxlBqgt.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-DAroMXd6.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-CDUellai.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveAgentOperationAgentId(cfg))
	})) : await import("./catalog-CrrWy329.js").then(({ listRawChannelPluginCatalogEntries }) => listRawChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const { resolveInitialWizardChannelTarget, runChannelsAddWizardFlow } = await import("./add-wizard-Caholbmn.js");
	...
	const resolveWorkspaceDir = () => resolveAgentWorkspaceDir(nextConfig, resolveAgentOperationAgentId(nextConfig));
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-obnslX9j.js");
