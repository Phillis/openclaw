...
import { f as loadSessionEntry, m as patchSessionEntryCore } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
import { t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-constants-2zSoJXQC.js";
import "./message-channel-BZwx7FCw.js";
import { c as interruptSessionWorkAdmissions, p as runExclusiveSessionLifecycleMutation, t as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS } from "./session-lifecycle-admission-BtKN0pjk.js";
import "./session-accessor-fcDZuc2H.js";
import { p as SUBAGENT_KILL_TASK_ERROR } from "./task-registry-activity-C-esutqT.js";
import { r as resolveStoredSubagentCapabilities } from "./subagent-capabilities-Chg191Ne.js";
import { m as resolveMainSessionAlias, p as resolveInternalSessionKey } from "./sessions-helpers-GgSp1hTb.js";
import { i as sortSubagentRuns, n as resolveSubagentLabel } from "./subagents-utils-wA-yYgo7.js";
import { n as resolveSubagentRequesterAgentId } from "./subagent-requester-owner-C7ZImrnO.js";
import { C as subagentRuns } from "./subagent-registry.store.sqlite-B8QBtOEs.js";
import "./subagent-run-liveness-CpuKir5n.js";
import { a as countPendingDescendantRuns, m as listSubagentRunsForController, o as getLatestLiveSubagentRunByChildSessionKey, w as buildSubagentRunReadIndexFromRuns, y as getSubagentRunsSnapshotForRead } from "./subagent-registry-read-DMT8aOi4.js";
import { n as resolveSessionEntryForKey } from "./subagent-list-yo6AF9yV.js";
import { F as resolveKilledSubagentTaskEndedAt, P as resolveFinalizedSubagentTaskState } from "./subagent-registry-lifecycle-delivery-BqpCkd4E.js";
import { C as replaceSubagentRunAfterSteerCore, S as releaseSubagentRunKillClaim, _ as markSubagentRunForSteerRestart, a as clearSubagentRunSteerRestart, i as claimSubagentRunKill, v as markSubagentRunTerminated } from "./subagent-registry-ROej5jsc.js";
import { g as terminateAcceptedCollectorRun } from "./subagent-announce-output-BxtV74X1.js";
import { t as AGENT_LANE_SUBAGENT } from "./lanes-CI0_P-yC.js";
import { i as readLatestAssistantReplySnapshot, o as waitForAgentRunAndReadUpdatedAssistantReply } from "./run-wait-otEVCYQN.js";
...
async function killLatestSubagentRun(params) {
	...
	for (let attempt = 0; attempt < 3; attempt += 1) {
		if (params.expectedGeneration !== void 0 && entry.generation !== params.expectedGeneration) return {
			entry,
			result: {
				killed: false,
				superseded: true
		...
		if (params.expectedRunId) return {
			entry,
			result
		};
...
async function killSubagentRunAdmin(params) {
	...
	if (params.expectedRunId?.trim() && entry.runId !== params.expectedRunId.trim()) return {
		found: false,
		killed: false
	};
	if (params.expectedGeneration !== void 0 && entry.generation !== params.expectedGeneration || params.expectedOwnerKey?.trim() && entry.requesterSessionKey !== params.expectedOwnerKey.trim()) return {
		found: false,
		killed: false
	};
	const killCache = /* @__PURE__ */ new Map();
	const stopped = await killLatestSubagentRun({
		...
		entry,
		cache: killCache,
		expectedRunId: params.expectedRunId?.trim() || void 0,
