...
import { a as listAgentIds, f as resolveAgentWorkspaceDir, r as listAgentEntries, y as toAgentEntriesRecord } from "./agent-scope-config-CUBiGmG3.js";
...
import { h as runOpenClawStateWriteTransaction, u as openExistingOpenClawStateDatabaseReadOnly } from "./openclaw-state-db-kmBThqu6.js";
...
import { a as expandToolGroups, u as resolveToolProfilePolicy } from "./tool-policy-shared-DmpG3HvD.js";
...
import { i as isAvatarHttpUrl, r as isAvatarDataUrl, u as AVATAR_MAX_BYTES } from "./agent-workspace-roster-transition-DoqG2wNw.js";
import { a as loadCronJobsStoreWithConfigJobsReadOnly, l as resolveCronJobsStorePath } from "./store-jPtUD1Vb.js";
...
import { p as recordAgentProvenance } from "./agent-deletion-journal-C1nSMR13.js";
...
import { S as seedWorkspaceBootstrap, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DJ__UUS2.js";
...
import { n as preflightSkillFromClawHub, t as installSkillFromClawHub } from "./clawhub-BPsHCdQE.js";
import { n as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-BFZGQ_i0.js";
import { t as openLocalAgentAvatarFile } from "./identity-avatar-file-DgtrLWCY.js";
import { t as listConfiguredMcpServers } from "./mcp-config-De1SycU1.js";
import { a as withClawMcpLifecycleLease, n as unsetConfiguredMcpServer, t as setConfiguredMcpServer } from "./mcp-config-mutation-BoLnQ2z9.js";
...
async function runClawsUpdateCommand(target, opts, runtime = defaultRuntime) {
	...
	if (!loaded.ok) {
		...
		else runtime.error(formatClawDiagnostics(diagnostics));
		runtime.exit(1);
		return;
	}
...
async function runClawsInspectCommand(sourcePath, opts, runtime = defaultRuntime) {
	...
	if (!result.ok) {
		...
		else runtime.error(formatClawDiagnostics(result.diagnostics));
		runtime.exit(1);
		return;
	}
