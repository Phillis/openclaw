...
import { i as describeBrowserTool, n as createBrowserToolSchema, o as parseBrowserTabToolBinding, r as resolveBrowserToolCapabilities, t as BrowserToolOutputSchema } from "./browser-tool.schema-B8O9tYIQ.js";
...
function registerBrowserPlugin(api) {
	...
	api.registerCli(async ({ program }) => {
		const { registerBrowserCli } = await import("./browser-cli-DMwAYi5z.js");
	...
	api.registerHttpRoute({
		...
		handleUpgrade: async (req, socket, head) => {
			...
			const { handleGatewayExtensionUpgrade } = await import("./gateway-relay-route-Zhy2i8bc.js");
