...
import { f as resolveAgentIdFromSessionKey, r as LEGACY_IMPLICIT_AGENT_ID } from "./session-key-Dbce_H9p.js";
...
import { a as listSessionEntriesByStatus, f as loadSessionEntry, u as loadExactSessionEntry } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
import { n as deliveryContextFromSession, s as normalizeDeliveryContext } from "./delivery-context.shared-azPdmUls.js";
import { d as isDeliverableMessageChannel } from "./message-channel-BZwx7FCw.js";
import { h as cancelSessionWorkAdmissionHandoff, n as beginSessionWorkAdmission } from "./session-lifecycle-admission-BtKN0pjk.js";
import { _ as runWithGatewayIndependentRootWorkAdmission } from "./gateway-work-admission-CTDt7IQ1.js";
import { At as applySessionEntryReplacements, b as persistSessionTranscriptTurn, nt as updateSessionEntry } from "./session-accessor-fcDZuc2H.js";
import { a as hasRestartRecoveryTerminalRun, c as resolveRestartRecoveryChannelAuthority, t as buildRestartRecoveryClaimCleanupPatch } from "./restart-recovery-state-6FYlAu33.js";
...
import { n as AGENT_RUN_RESTART_ABORT_ERROR, r as AGENT_RUN_RESTART_ABORT_ERROR_CODE } from "./run-termination-hzmbXtwI.js";
...
import { t as isTrustedMessageActionTurnIngress } from "./message-action-turn-capability-CLlRwpDl.js";
import { a as hasInterSessionUserProvenance, n as MAIN_SESSION_RESTART_RECOVERY_SOURCE_TOOL, s as isCompletionReportInputProvenance } from "./input-provenance-CCQsDhUy.js";
import { r as isAgentToolReplaySafe } from "./tool-replay-safety-mwAL5J2q.js";
import { i as buildRunUserTurnIdempotencyKey } from "./user-turn-transcript-CMdiyjwP.js";
...
import { l as isTerminalSilentAssistantMessage, n as getTranscriptMessageRole, o as isIntermediateAssistantTranscriptMessage, s as isMeaningfulTranscriptMessage, u as readTerminalSourceReplyDeliveryMirror } from "./message-visibility-B7uGWSom.js";
...
import { c as buildRestartRecoveryExpectedState, d as normalizeFiniteTimestamp, f as normalizeStringSet, i as isMainSessionRecoveryPending, l as hasCurrentProcessOwner, m as resolveRestartRecoveryTerminalClientRunId, n as isMainRestartRecoveryAggregateTerminalOnly, p as resolveRestartRecoveryStorePaths, r as isMainRestartRecoveryCandidate, u as mainSessionRecoveryLog } from "./main-session-recovery-state-DagFkxEX.js";
import { l as findDeliveryIntentOwner } from "./delivery-queue-storage-BJKj2sCe.js";
import { t as scheduleMainSessionRecoveryPendingTarget } from "./main-session-recovery-owner-release-B77CDO7F.js";
import { a as scheduleMainSessionRecoveryMutation, i as retryMainSessionRecoveryMutation, r as repairMainSessionRecoveryMutation } from "./main-session-recovery-lifecycle-qdZCHqUv.js";
import { n as commitMainSessionRecovery } from "./main-session-recovery-store-dpSl6NHY.js";
import { n as markStartupOrphanedMainSessionsForRecovery, t as markRestartAbortedMainSessions } from "./main-session-restart-recovery-marking-CIxYLDMc.js";
...
const RESTART_RECOVERY_EXECUTION_START_TIMEOUT_MS = 1e4;
const RESTART_RECOVERY_ABORT_TIMEOUT_MS = 2e3;
async function dispatchRestartRecoveryUntilStarted(params) {
	...
	const abortBeforeStart = () => {
		if (!dispatchAccepted || executionStarted) return Promise.resolve();
		return preStartAbort ??= (async () => {
			preStartAbortAttempted = true;
			preStartAbortConfirmed = (await params.gatewayRuntime.abortAgent({
				agentId: params.agentId,
				runId: params.recoveryRunId,
				sessionKey: params.sessionKey
			}, RESTART_RECOVERY_ABORT_TIMEOUT_MS)).aborted === true;
		})();
	};
	...
	executionStartTimer = setTimeout(() => {
		if (!executionStarted) {
			...
			abortBeforeStart().catch(() => void 0).then(() => {
	...
	try {
		dispatchPromise = params.gatewayRuntime.dispatchAgent(params.agentParams, void 0, {
			...
			onAccepted: () => {
				...
				if (executionStartTimedOut) abortBeforeStart().catch(() => void 0);
			},
			onExecutionStarted: () => {
				if (executionStartTimedOut) return;
...
const RESTART_RECOVERY_RESUME_MESSAGE = formatSystemTurnPrompt(`Your previous turn was interrupted by a gateway restart while OpenClaw was waiting on tool/model work. Continue from the existing transcript and finish the interrupted response. Treat a tool result marked interrupted or missing as having an unknown outcome. ${TOOL_FAILURE_INSTRUCTION}`);
