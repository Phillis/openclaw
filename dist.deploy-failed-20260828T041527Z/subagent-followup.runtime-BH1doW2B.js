...
import { rt as selectDeliverableSessionsReply } from "./openclaw-state-db-kmBThqu6.js";
import { i as isSilentReplyPayloadText } from "./tokens-DbQz-n_m.js";
import { u as stripHeartbeatToken } from "./heartbeat-yX5WzsUn.js";
import { p as listDescendantRunsForRequester } from "./subagent-registry-read-DMT8aOi4.js";
import { t as resolveSubagentCompletionResultText } from "./subagent-completion-result-DjS7tm-S.js";
import { r as readLatestAssistantReply, s as waitForAgentRunsToDrain } from "./run-wait-otEVCYQN.js";
...
async function readDescendantSubagentFallbackReply(params) {
	...
	for (const entry of latestRuns) {
		...
		const reply = entry.completion?.terminalReply === void 0 && entry.execution.transcriptTarget === void 0 ? selectDeliverableSessionsReply(await readLatestAssistantReply({ sessionKey: entry.childSessionKey }), completionReply) : completionReply;
