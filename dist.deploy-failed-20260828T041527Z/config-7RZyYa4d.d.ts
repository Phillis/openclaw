import { i as OpenClawConfig, n as ConfigValidationIssue, t as ConfigFileSnapshot } from "./types.openclaw-Bon4guJK.js";
...
declare function readConfigFileSnapshotWithPluginMetadata(options?: Pick<ConfigSnapshotReadOptions, "allowCurrentPluginMetadata" | "allowSuspiciousRecovery" | "isolateEnv" | "lowerPrecedenceEnv" | "measure" | "observe" | "recoverSuspicious" | "skipPluginValidation">): Promise<ReadConfigFileSnapshotWithPluginMetadataResult>;
