...
import { F as resolveTimerTimeoutMs, g as isFutureDateTimestampMs } from "./number-coercion-CLj0HTDM.js";
...
import { b as ssrfPolicyFromHttpBaseUrlAllowedOrigin, u as isPrivateIpAddress } from "./ssrf-arYIaOWE.js";
import { i as fetchWithSsrFGuard } from "./fetch-guard-Dt4YqBT2.js";
import { t as decodeHtmlEntities } from "./html-entities-CvDVeY8C.js";
import { h as resolveProviderOperationTimeoutMs, n as createProviderOperationDeadline } from "./shared-DOiR3nrc.js";
...
import { a as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist, r as isHttpsUrlAllowedByHostnameSuffixAllowlist } from "./ssrf-policy-DrRXEpPY.js";
...
import { c as createMSTeamsHttpError, n as refreshMSTeamsDelegatedTokens } from "./oauth.token-B6jJorZn.js";
...
const loadSdkModules = createLazyRuntimeModule(() => Promise.all([import("./dist-CB3FZ8vd.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-Dh647XX2.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([apps, api]) => ({
	App: apps.App,
...
//#endregion
export { resolveRequestUrl as $, resolveMSTeamsPrivateQaRuntime as A, applyAuthorizationHeaderForUrl as B, saveDelegatedTokens as C, loadMSTeamsSdkWithAuth as D, createMSTeamsTokenProvider as E, resolveMSTeamsSdkCloudOptions as F, isDownloadableAttachment as G, extractHtmlFromAttachment as H, validateMSTeamsProactiveServiceUrlBoundary as I, isUrlAllowed as J, isLikelyImageAttachment as K, ATTACHMENT_TAG_RE as L, isAllowedBotFrameworkServiceUrl as M, normalizeBotFrameworkServiceUrl as N, buildUserAgent as O, tryNormalizeBotFrameworkServiceUrl as P, resolveMediaSsrfPolicy as Q, GRAPH_ROOT as R, resolveMSTeamsCredentials as S, createMSTeamsExpressAdapter as T, extractInlineImageCandidates as U, encodeGraphShareId as V, isAdvertisedFileAttachment as W, resolveAttachmentFetchPolicy as X, normalizeContentType as Y, resolveMSTeamsMediaKind as Z, mutateGraphJson as _, stripMSTeamsMentionTags as a, resolveMSTeamsRequestTimeoutMs as at, hasConfiguredMSTeamsCredentials as b, searchGraphUsers as c, withMSTeamsRequestDeadline as ct, fetchGraphAbsoluteUrl as d, safeFetchWithPolicy as et, fetchGraphJson as f, listTeamsByNameWithPageInfo as g, listTeamsByName as h, parseMSTeamsActivityTimestamp as i, createMSTeamsInboundDeadline as it, describeBotFrameworkServiceUrlHost as j, ensureUserAgentHeader as k, deleteGraphRequest as l, listChannelsForTeamWithPageInfo as m, extractMSTeamsQuoteInfo as n, tryBuildGraphSharesUrlForSharedLink as nt, wasMSTeamsBotMentioned as o, resolveMSTeamsSharePointUploadTimeoutMs as ot, listChannelsForTeam as p, isRedirectStatus as q, normalizeMSTeamsConversationId as r, MSTEAMS_REQUEST_TIMEOUT_MS as rt, findGraphUsersByExactIdentity as s, withMSTeamsAbortableRequestTimeout as st, extractMSTeamsConversationMessageId as t, safeHostForUrl as tt, escapeOData as u, normalizeQuery as v, readAccessToken as w, loadDelegatedTokens as x, resolveGraphToken as y, IMG_SRC_RE as z };
