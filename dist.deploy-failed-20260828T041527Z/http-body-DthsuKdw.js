...
function installRequestBodyLimitGuard(req, res, options) {
	...
	req.on("error", finish);
	const declaredLength = parseContentLengthHeader(req);
	if (req.destroyed && !req.readableEnded) finish();
...
//#endregion
export { closeRequestAfterResponse as a, readJsonBodyWithLimit as c, readResponseTextSnippet as d, readResponseWithLimit as f, readChunkWithIdleTimeout as h, cancelUnreadResponseBody as i, readRequestBodyWithLimit as l, testApi as m, DEFAULT_WEBHOOK_MAX_BODY_BYTES as n, installRequestBodyLimitGuard as o, requestBodyErrorToText as p, RequestBodyLimitError as r, isRequestBodyLimitError as s, DEFAULT_WEBHOOK_BODY_TIMEOUT_MS as t, readResponseTextPrefix as u };
