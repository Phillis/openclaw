...
import { g as registerConfigWriteListener, n as getRuntimeConfig } from "./io-ClLVsBMp.js";
import { n as buildAllowedModelSet, r as buildConfiguredModelCatalog } from "./model-selection-shared-DbjoXfPH.js";
...
import { xt as applySessionPatchProjection } from "./session-accessor-fcDZuc2H.js";
...
import { G as setEmbeddedPluginApprovalBroker, U as EmbeddedPluginApprovalBroker, W as clearEmbeddedPluginApprovalBroker, q as setEmbeddedMode } from "./agent-tools.before-tool-call-D89j2U3t.js";
import { t as loadAgentRuntimePluginRegistryHandle } from "./runtime-plugins-B0uJCbKb.js";
import { d as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-DRxNQEhr.js";
...
import { v as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-eqaxGmoQ.js";
import { i as parseGoalCommand, t as executeSessionGoalCommand } from "./commands-goal-CJciJlgD.js";
...
import { t as getSessionDefaults } from "./session-utils-model-DHZkyDhz.js";
import { i as buildGatewaySessionInfo, r as listSessionsFromStoreAsync } from "./session-utils-list-D98WVYL8.js";
import { t as ensureContextWindowCacheLoaded } from "./context-o5tuEdcP.js";
import { f as resolveGatewaySessionStoreTargetWithStore, i as loadGatewaySessionEntryReadOnly, n as listAgentsForGateway, o as resolveCanonicalGatewaySessionStoreKey, r as loadGatewaySessionEntry } from "./session-utils-store-Dmx2MxPy.js";
import { C as buildCollectPrompt, O as previewQueueSummaryPrompt, j as waitForQueueDebounce, t as resolveQueueSettingsCore, x as applyQueueDropPolicy } from "./settings-CxUlx8Vr.js";
...
import { t as loadGatewayModelCatalog } from "./server-model-catalog-BN_2qcvl.js";
import { r as agentCommandFromIngress } from "./agent-command-BGJF3gqo.js";
import { s as performGatewaySessionReset } from "./session-reset-service-C83MrovO.js";
import { s as isAgentLifecycleYieldedWaiting } from "./session-event-payload-CreU6-ED.js";
import { c as replaceOversizedChatHistoryMessages, i as readChatHistoryPage, r as enrichChatHistoryCompactionMarkers, s as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES } from "./chat-cUFvGerG.js";
import { n as createGatewaySession } from "./session-create-service-D3TxHcgc.js";
...
import { u as formatTuiErrorMessage } from "./tui-formatters-DESeCPqy.js";
...
var EmbeddedTuiBackend = class {
	...
	start() {
		...
		this.ready = (async () => {
			const { runSessionStartupMigration } = await import("./startup-migration-DuSi6JBH.js");
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-Dw3ROHLC.js");
