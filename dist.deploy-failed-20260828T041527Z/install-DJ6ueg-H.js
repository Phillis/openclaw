...
import { t as packageNameMatchesId } from "./install-safe-path-DQTxRazZ.js";
import { c as resolveUserPath } from "./home-dir-BFvskzn8.js";
import "./utils-Bw16L5tB.js";
import { n as compareValidSemver } from "./semver-aYpwYdrQ.js";
import { a as isPrereleaseResolutionAllowed, n as formatPrereleaseResolutionError, o as isPrereleaseSemverVersion, r as isExactSemverVersion, s as parseRegistryNpmSpec, t as compareOpenClawReleaseVersions, u as validateRegistryNpmSpec } from "./npm-registry-spec-BdgyvSs0.js";
import { h as validatePluginId, i as matchesExpectedPluginId, m as safePluginInstallFileName, s as resolveDefaultPluginNpmDir, t as encodePluginInstallDirName } from "./install-paths-DllFtsSG.js";
...
import { a as resolveNpmPackArchiveMetadata, n as createNpmMetadataEnv, o as resolveNpmSpecMetadata } from "./install-source-utils-D2m0UUwS.js";
import { a as createSafeNpmInstallArgs, o as createSafeNpmInstallEnv } from "./install-package-dir-B1M2mVjW.js";
import { r as preflightPluginNpmInstallPolicy } from "./install-security-scan-DYdPdGDr.js";
import { $ as readOpenClawManagedNpmRootOverrides, A as resolveEffectiveInstallMode, C as ensureInstallTargetAvailableForMode, D as installPluginDirectoryIntoExtensions, E as hasPackageRuntimeDependencies, F as validateOpenClawPackageInstallCompatibility, H as attachPluginInstallTransaction, M as runInstallSourceScan, N as sourceFamilyForInstallPolicyKind, O as loadPluginInstallRuntime, P as sourceFamilyForInstallPolicySource, Q as readManagedNpmRootPeerDependencySnapshot, S as emitSuccessfulPluginInstallSecurityEvent, T as formatUnresolvedOpenClawPeerLinkError, U as copyPluginInstallTransactionRequest, W as isPluginInstallCommitDeferred, X as listMissingRequiredPlatformPackages, Z as readManagedNpmRootInstalledDependency, _ as resolveRequiredPlatformPackageNames, a as formatNpmCommandFailureOutput, b as buildDirectoryInstallResult, c as listManagedNpmRootPackageNames, d as removeEmptyDirectoryIfPresent, et as repairManagedNpmRootOpenClawPeer, f as resolveManagedNpmGenerationUseForInstall, g as resolveManagedNpmRootPackageDir, h as resolveManagedNpmRootForInstall, i as formatManagedNpmProjectQuarantineArtifacts, j as resolvePreparedDirectoryInstallTarget, k as readOptionalPackageManifest, l as listNewManagedNpmRootPackageDirs, m as resolveManagedNpmRootDependencySpecForInstall, n as cleanupManagedNpmRootPreparedDependency, nt as syncManagedNpmRootPeerDependencies, o as isManagedNpmProjectCorruptionInstallFailure, p as resolveManagedNpmInstallRoot, r as createManagedNpmPluginInstallRollbackSnapshot, rt as upsertManagedNpmRootDependency, s as isNpmAliasOverrideCompatibilityError, t as cleanupManagedNpmPluginInstallRollbackSnapshot, tt as resolveManagedNpmRootDependencySpec, u as quarantineManagedNpmProjectRebuildArtifacts, v as rollbackManagedNpmPluginInstall, w as ensureOpenClawExtensions, x as defaultLogger, y as rollbackManagedNpmRootPreparedDependency, z as PLUGIN_INSTALL_ERROR_CODE } from "./install-managed-npm-state-BKmVpI9X.js";
import { i as linkOpenClawPeerDependencies, o as relinkOpenClawPeerDependenciesInManagedNpmRoot, t as auditDeclaredOpenClawHostDependency } from "./plugin-peer-link-CNPdFqM4.js";
...
async function installPluginFromManagedNpmRoot(params) {
	...
	const runManagedNpmInstall = async (prepared) => {
		...
		if (await auditDeclaredOpenClawHostDependency({ packageDir: installRoot })) return {
			ok: false,
	...
	const rollback = async () => {
		...
		if (preparedDependency) await rollbackManagedNpmRootPreparedDependency({
			packageName: params.packageName,
			preparedDependency,
			logger
		});
	...
	try {
		...
		if (!deferredTransaction) {
			if (!installSucceeded && preparedDependency) await rollback();
			await cleanup();
		}
	}
}
