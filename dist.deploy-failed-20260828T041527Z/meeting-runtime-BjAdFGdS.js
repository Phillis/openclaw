...
import { C as parseStrictNonNegativeInteger, P as resolvePositiveTimerTimeoutMs, a as addTimerTimeoutGraceMs, f as asSafeIntegerInRange, u as asPositiveFiniteNumber } from "./number-coercion-CLj0HTDM.js";
...
import { At as boolean, Et as array, Rn as string, Tn as object, Xn as union, Zn as unknown, fn as looseObject, wn as number } from "./schemas-CZ9Toj_c.js";
...
import { n as getRealtimeTranscriptionProvider, r as listRealtimeTranscriptionProviders } from "./provider-registry-X-oydjrB.js";
...
import { c as resamplePcm, i as convertPcmToMulaw8k, n as createSpeechThresholdGate, o as mulawToPcm, r as readPcm16AudioStats } from "./audio-energy-BP9DXUkU.js";
...
const meetingBrowserStatusSchema = looseObject({
	...
	recentTranscript: array(union([object({
		...
		text
	})), invalidBrowserArrayItemSchema])).transform((lines) => lines.filter((line) => line !== null)).optional().catch(void 0),
