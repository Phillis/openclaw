...
import { a as createChannelIngressResolver, c as defineStableChannelIngressIdentity, i as channelIngressRoutes, t as createStandardRawEventIngressMonitor } from "./channel-ingress-runtime-BxqYlzv5.js";
import { n as createChannelPairingController } from "./channel-pairing-YowAfeUY.js";
import "./text-utility-runtime-BNhX-3os.js";
import { a as createFixedWindowRateLimiter, r as WEBHOOK_RATE_LIMIT_DEFAULTS } from "./webhook-ingress-ByuWujwG.js";
import { a as createWebhookInFlightLimiter, l as runDetachedWebhookWork, s as readJsonWebhookBodyOrReject } from "./webhook-request-guards-BYzmIdMp.js";
import { c as resolveWebhookPath, f as withResolvedWebhookRequestPipeline, i as registerWebhookTargetWithPluginRoute, l as resolveWebhookTargetWithAuthOrReject, t as canonicalizeWebhookRouteKey } from "./webhook-targets-Bm2XLMzf.js";
import { C as releaseGoogleChatApprovalCardBinding, _ as completeGoogleChatApprovalCardBinding, b as readGoogleChatApprovalActionToken, c as deleteGoogleChatMessage, d as sendGoogleChatMessage, f as updateGoogleChatMessage, g as claimGoogleChatApprovalCardBinding, l as downloadGoogleChatMedia, p as verifyGoogleChatRequest, s as GoogleChatApiError, t as isGoogleChatGroupSpace, u as probeGoogleChat, y as getGoogleChatApprovalCardBinding } from "./targets-DxHMLRXF.js";
import { t as getGoogleChatRuntime } from "./runtime-api-BUE1S87i.js";
import { n as googleChatApprovalAuth } from "./approval-auth-DX_xrx3P.js";
import { t as buildGoogleChatGroupPolicyScope } from "./group-policy-BGT6LyIi.js";
...
async function processMessageWithPipeline(params) {
	...
	if (first) try {
		...
		if (attachmentData) mediaInputs[0] = {
			...
			const notice = `[Google Chat attachment unavailable: ${first.driveDataRef ? "Google Drive files are not downloadable" : "unsupported attachment source"}; upload the file directly]`;
