...
import { m as requesterMcpOAuthIdentity } from "./mcp-oauth-store--87F5Wew.js";
import { s as readMcpOAuthCredentialsStatus, u as startMcpOAuthAuthorization } from "./mcp-oauth-inLDZQye.js";
import { t as loadSessionMcpConfig } from "./agent-bundle-mcp-runtime-config-DgnlFlmR.js";
import { i as partitionMcpServersByConnectionScope, n as buildMcpRequesterRuntimeCacheKey, o as resolveMcpConnectionRevalidateMs, r as hashMcpResolvedConnections, s as resolveRequesterScopedMcpConnections } from "./mcp-connection-resolver-BqJnxxY-.js";
...
function createSessionMcpRuntimeManagerLifecycle(store) {
	...
	const sweepIdleRuntimes = async () => {
		...
		for (const [runtimeKey, runtime] of store.runtimesBySessionId.entries()) {
			if ((runtime.activeLeases ?? 0) > 0) continue;
			if (nowMs - runtime.lastUsedAt < 6e5) continue;
...
//#endregion
export { mergeMcpConnectCatalog as _, getOrCreateSessionMcpRuntime as a, rememberAdvertisedScopedMcpCatalog as c, createSessionMcpRuntimeManager as d, setDefaultCreateSessionMcpRuntime as f, updateMcpAppModelContext as g, leaseMcpAppModelContextForTurn as h, getOrCreateRequesterScopedMcpRuntime as i, retireSessionMcpRuntime as l, clearMcpAppModelContextForView as m, disposeAllSessionMcpRuntimes as n, getSessionMcpRuntimeManagerForTesting as o, shouldLoadRequesterScopedMcpHarnessRuntime as p, getAdvertisedScopedMcpCatalog as r, peekSessionMcpRuntime as s, completeDeferredSessionMcpRuntimeRetirement as t, retireSessionMcpRuntimeForSessionKey as u, mergeMcpToolCatalogs as v };
