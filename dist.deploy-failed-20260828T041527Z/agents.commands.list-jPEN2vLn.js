...
import { d as listAgentProvenance, f as readAgentProvenance } from "./agent-deletion-journal-C1nSMR13.js";
...
import "./agents.bindings-ffZ0V3Mz.js";
import { n as buildAgentSummaries } from "./agents.config-BCOHbC0P.js";
...
async function agentsListCommand(opts, runtime = defaultRuntime) {
	...
	if (opts.json) for (const summary of summaries) {
