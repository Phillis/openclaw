...
import { i as isApprovalMethod } from "./method-scopes-BQC2sTma.js";
...
import { s as normalizeApprovalRequest, t as classifyApprovalRequestChannelRoute } from "./approval-request-account-binding-MS1_u7L5.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = (gatewayRuntime?.routeCoordinator.createReporter ?? createApprovalNativeRouteReporter)({
		...
		requestGateway: async (method, params) => {
			...
			const { callGatewayLeastPrivilege } = await import("./call-DPYKD0iw.js");
