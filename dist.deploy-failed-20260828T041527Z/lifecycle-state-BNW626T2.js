...
import { l as resolveAgentDir, r as listAgentEntries } from "./agent-scope-config-CUBiGmG3.js";
...
import { d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction } from "./openclaw-state-db-kmBThqu6.js";
import { o as normalizeClawHubSha256Integrity } from "./clawhub-artifacts-34Bpy6pn.js";
import { r as normalizeConfiguredMcpServers } from "./mcp-config-normalize-dw5fHLEW.js";
import { h as applyDefaultCronToolsAllow } from "./store-jPtUD1Vb.js";
import { I as createTrustedCronScheduledToolPolicy, _ as normalizeCronJobCreate } from "./row-codec-gAlP-EPD.js";
import "./config-B_0xOnKq.js";
import { s as readAgentDeletionJournal } from "./agent-deletion-journal-C1nSMR13.js";
import { i as closeOpenClawAgentDatabaseByPath } from "./openclaw-agent-db-BEQsKM0c.js";
import { B as resolveOpenClawAgentSqlitePath, P as unregisterOpenClawAgentDatabases } from "./openclaw-agent-db-maintenance-_0tYy-zT.js";
...
import { c as readWorkspaceStateSnapshot, i as deleteWorkspaceState, s as prepareWorkspaceStateDeletion, v as prepareLegacyWorkspaceStateReset, y as removeLegacyWorkspaceStateForReset } from "./workspace-state-store-CkRZeUIP.js";
import { n as DEFAULT_BOOTSTRAP_FILENAME, x as resolveWorkspaceBootstrapStatus } from "./workspace-DJ__UUS2.js";
import { t as withPluginLifecycleLease } from "./plugin-lifecycle-lease-QVxAzcU7.js";
import { l as digestClawAgentConfig, n as deleteCachedClawInstallSchemaVersion } from "./provenance-runtime-read-C6roUEUt.js";
import { r as planClawHubSkillUninstall, t as applyClawHubSkillUninstall } from "./clawhub-uninstall-DZyw9ymn.js";
import { n as maintainClawPackageLifecycleLease, t as acquireClawPackageLifecycleLease } from "./claw-package-lifecycle-lease-KD4Ith7s.js";
import "./exec-approvals-PtbcLeQo.js";
import { r as beginAgentDeletion } from "./agent-lifecycle-registry-DPEbAZj2.js";
import { h as withAgentExecApprovalsRemoved } from "./exec-approvals-generated-migration-KEjNHNyB.js";
import { i as moveToTrash } from "./cleanup-utils-DBlaUZGP.js";
import { t as resolveCronJobConfigRevision } from "./config-revision-De4ETdXm.js";
import { a as pruneAgentConfig } from "./agents.config-BCOHbC0P.js";
import { t as listConfiguredMcpServers } from "./mcp-config-De1SycU1.js";
import { a as withClawMcpLifecycleLease, n as unsetConfiguredMcpServer } from "./mcp-config-mutation-BoLnQ2z9.js";
...
import { c as readClawPackageRefs, d as updateClawPackageRefStatus, s as readClawInstallRecords, u as updateClawInstallRecordStatus } from "./provenance-vjZcMJ0q.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-Cz9lIXnV.js";
import { n as deleteAgentConfigEntry, t as AgentConfigPreconditionError } from "./agents-config-mutations-DQAar6Ca.js";
import { C as digestClawMcpServer, D as readClawMcpServerRefsByName, E as readClawMcpServerRefs, O as reconcileClawMcpServerRefs, S as deleteClawMcpServerRef, T as planClawMcpServerRemoval, t as parseClawMarkdown, v as CLAW_OUTPUT_STABILITY, x as clawMcpRemovalSelector } from "./reader-Beu8LHDX.js";
import { t as runPluginUninstallCommand } from "./plugins-uninstall-command-6fp4-zY4.js";
import { r as resolvePluginInstallRequestContext } from "./plugin-install-config-policy-B1yj6OFJ.js";
...
function releaseClawRemoveRows(agentId, files, complete, options) {
	if (complete) unregisterOpenClawAgentDatabases({
		agentId,
		env: options.env
	});
	runOpenClawStateWriteTransaction(({ db }) => {
...
async function commitClawAgentConfigRemoval(params) {
...
async function applyClawRemovePlan(plan, options = {}) {
	...
	if (!options.commitConfig || options.purgeSessions) await (options.purgeSessions ?? (await import("./cleanup-service-D4mYh-8J.js")).purgeAgentSessionStoreEntries)(configBeforeDelete, agentId);
