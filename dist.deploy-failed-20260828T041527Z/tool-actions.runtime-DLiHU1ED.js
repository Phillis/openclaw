...
import { _ as readToolStringParam, h as readStringArrayParam, i as createActionGate, m as readReactionParams, p as readPositiveIntegerParam, t as ToolAuthorizationError } from "./common-CI1GnPjt.js";
import { t as jsonResult } from "./tool-results-BCM3fdVS.js";
import "./string-coerce-runtime-C8jKEm3h.js";
import { n as resolveAllowlistProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy } from "./runtime-group-policy-GURwo_0L.js";
import "./runtime-group-policy-BLXPwMdH.js";
import "./channel-actions-D2ZN81sL.js";
import { a as resolveMatrixAccountConfig, o as resolveMatrixBaseConfig } from "./account-config-CpFj8tyt.js";
import { i as resolveMatrixAccount } from "./accounts-CQ-N-_Xa.js";
import { i as normalizeMatrixResolvableTarget } from "./target-ids-DEUqtLsd.js";
import { n as resolveMatrixRoomConfig } from "./rooms-Dpprwj5G.js";
import { i as buildMatrixReactionRelationsPath, o as selectOwnMatrixReactionEventIds, s as summarizeMatrixReactionEvents } from "./reaction-common-CTyQTnvd.js";
import { S as resolveMatrixRoomId, _ as parsePollStart, d as buildPollResponseContent, g as isPollStartType, n as reactMatrixMessage } from "./send-BEJQk6ia.js";
...
const reactionActions = /* @__PURE__ */ new Set([
	"react",
	"reactions",
	"emoji-list"
]);
...
async function handleMatrixAction(params, cfg, opts = {}) {
	...
	if (reactionActions.has(action)) {
		...
		if (action === "emoji-list") {
			...
			return jsonResult({
				ok: true,
				emojis: await withReadTarget(roomId, async (target) => listMatrixEmojis(target.roomId, {
					...clientOpts,
