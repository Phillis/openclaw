...
import { x as resolveSessionKeyBySessionId } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
import { n as beginSessionWorkAdmission } from "./session-lifecycle-admission-BtKN0pjk.js";
import { P as isSessionTranscriptProjectionUnavailableError, V as resolveSessionTranscriptActiveLeafEntryId, k as readTranscriptDisplayDelta } from "./session-accessor-fcDZuc2H.js";
...
import { i as buildGatewaySessionInfo, o as loadGatewaySessionRow } from "./session-utils-list-D98WVYL8.js";
import { i as tryResolveSessionCompatibilityOwnerAgentId } from "./session-request-agent-C9E8iDY4.js";
import { i as loadGatewaySessionEntryReadOnly, r as loadGatewaySessionEntry } from "./session-utils-store-Dmx2MxPy.js";
...
import { d as resolveInFlightRunSnapshot, o as projectInFlightRunSnapshot, r as boundInFlightRunSnapshotForChatHistory } from "./chat-abort-CsMNzOPX.js";
...
import { l as resolveClaudeCliBindingSessionId } from "./cli-session-history.claude-DzqLWUpB.js";
import { n as resolveChatHistoryWithCliSessionImports, t as readChatHistoryCliSessionImportSnapshot } from "./cli-session-history-C2p1kVFi.js";
import { r as resolveGatewayChatCronCreatorAuthorityAdmission, t as createAgentTurnService } from "./agent-turn-service-BQQWcnh8.js";
import { n as buildGatewaySessionSnapshot } from "./session-event-payload-CreU6-ED.js";
import { i as resolveVisibleActiveSessionRunState } from "./session-active-runs-CJd39CY4.js";
import { N as normalizeOptionalChatText, s as appendAssistantTranscriptMessage } from "./chat-abort-runtime-DroEkxn7.js";
import { t as assertValidParams } from "./validation-kYFXohur.js";
import { c as resolveRequestedChatAgentId, d as resolveGlobalAwareNodeChatDeliveryKeys, f as sendGlobalAwareNodeChatPayload, l as validateChatSelectedAgent, t as handleChatSend } from "./chat-send-handler-Cc-XJB9u.js";
import { a as prepareSessionWorkspaceIcon } from "./workspace-icon-http-pTFd6M0Z.js";
import { t as resolveAgentIdOrRespondError } from "./agent-id-shared-0q-ojjmE.js";
import { i as readIncrementalChatHistoryTail, n as dropChatHistoryOverreadContextMessage, r as readChatHistoryMessageSeq, t as capOffsetChatHistoryProjectedMessages } from "./session-history-tail-_xLpIyvr.js";
...
const chatHandlers = {
	...
	"chat.toolTitles": async ({ params, respond, context }) => {
		...
		const { generateToolCallTitles } = await import("./chat-tool-titles-Dod7oaqA.js");
