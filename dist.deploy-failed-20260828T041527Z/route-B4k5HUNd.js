import { f as resolveAgentIdFromSessionKey, h as resolveThreadSessionKeys } from "./session-key-Dbce_H9p.js";
import { n as inspectSessionBindingByConversation } from "./session-binding-service-47rBLtwF.js";
import { n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-CaHBZG2x.js";
import "./routing-DM8631ts.js";
import { t as resolveConfiguredAcpBindingRecord } from "./persistent-bindings.resolve-Dr0mXaEi.js";
import "./acp-binding-resolve-runtime-CxYIkAgY.js";
import "./session-binding-runtime-Cux4NnsA.js";
import { n as MATRIX_REACTION_EVENT_TYPE } from "./reaction-common-CTyQTnvd.js";
...
function resolveMatrixInboundRoute(params) {
	...
	const bindingInspection = inspectSessionBindingByConversation({
		channel: "matrix",
		accountId: params.accountId,
		conversationId: bindingConversationId,
		parentConversationId: bindingParentConversationId
	});
	const runtimeBinding = bindingInspection.status === "available" ? bindingInspection.binding : null;
