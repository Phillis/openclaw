...
import { f as markReplyDispatchBeforeDeliverDeadlineOwned } from "./reply-dispatcher-D5z9PzIy.js";
...
import { l as toPluginMessageContext, n as deriveInboundMessageHookContext, r as resolveInboundReplyHookTarget } from "./message-hook-mappers-BwRPfaNj.js";
import { C as normalizeOutboundReplyFacts, a as hasOutboundReplyContent, x as createReplyToDeliveryPolicy } from "./reply-payload-i0RzN2iF.js";
import { t as createOutboundPayloadPlan, u as summarizeOutboundPayloadForTransport } from "./payloads-BDBV7AYm.js";
import { f as normalizeEmptyPayloadForDelivery, g as stripInternalRuntimeScaffoldingFromPayload, h as resolveOutboundMediaAccessForSend, o as buildPayloadSummary, p as normalizePayloadsForChannelDelivery, r as attachOutboundDeliveryCommitHook } from "./delivery-queue-reconciliation-CUGy8Pa1.js";
...
import { t as loadChannelOutboundAdapter } from "./load-CF0AT91l.js";
import "./delivery-queue-storage-BJKj2sCe.js";
		...
		sendPayload: messagePayload || outbound?.sendPayload ? async (payload, overrides) => {
			...
			if (messagePayload) {
				...
				const sent = await runChannelMessageSendWithLifecycle({
					...
					send: () => dispatchToAdapter(messagePayloadCtx, () => messagePayload(messagePayloadCtx))
				});
...
//#endregion
export { createRenderedMessageBatch as a, buildInboundReplyPayloadSendingBeforeDeliver as c, suppressedPayloadOutcome as d, toOutboundDeliveryError as f, resolveOutboundDurableFinalDeliverySupport as i, buildLegacyInboundMessageSendingBeforeDeliver as l, recordReplyUsageState as m, throwIfAborted as n, createRenderedMessageBatchPlan as o, buildReplyUsageState as p, createChannelHandler as r, applyMessageSendingHook as s, prepareOutboundPayloadBatch as t, buildProjectedInboundMessageSendingBeforeDeliver as u };
