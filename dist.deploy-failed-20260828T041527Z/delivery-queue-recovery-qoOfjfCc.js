...
import { d as parseSessionDeliveryRoute, s as normalizeSessionPeerId } from "./session-key-utils-Di3FvABa.js";
import { t as createSubsystemLogger } from "./subsystem-a4KzJVZG.js";
import { m as fireAndForgetHook, t as getGlobalHookRunner } from "./hook-runner-global-CDBq1X4a.js";
import { n as stripOutboundTargetKindPrefix, r as stripTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-ByHwV3qn.js";
import { i as isOutboundDeliveryError, r as countPhysicalOutboundSends, t as OutboundDeliveryError } from "./deliver-types-w6kiySpD.js";
import { a as getErrnoCode, c as resolveDeliveryRecoveryDeadlineMs, i as findPlatformMessageRejectedError, n as createDeliveryRecoveryCoordinator, o as isDeliveryRecoveryRetryEligible, r as createEmptyDeliveryRecoverySummary, s as isProvenDeliveryNotSentError } from "./delivery-recovery.shared-B2XgPiah.js";
import { a as settleDurableDelivery, i as rejectDurableDelivery, n as failDurableDelivery, r as markDurableDeliveryQueued, t as completeDurableDelivery } from "./delivery-completion-CDrntLbO.js";
import { d as toPluginMessageSentEvent, l as toPluginMessageContext, o as toInternalMessageSentContext, t as buildCanonicalSentMessageHookContext } from "./message-hook-mappers-BwRPfaNj.js";
import { a as runOutboundDeliveryCommitHooks, i as isOutboundDeliveryResultArray, n as reconcileUnknownQueuedDelivery, o as buildPayloadSummary, t as buildUnknownSendContext } from "./delivery-queue-reconciliation-CUGy8Pa1.js";
...
import { n as resolveOutboundChannelMessageAdapter } from "./channel-resolution-DVRjlt-A.js";
import { S as claimDeliveryPlatformSendAttempt, a as failDelivery, c as failPendingDelivery, d as loadPendingDeliveries, f as loadPendingDelivery, g as markDeliveryPlatformSendAttemptStarted, h as markDeliveryPlatformOutcomeUnknown, k as acceptedPreparedOutboundEntries, o as failDeliveryAfterPlatformSend, s as failDeliveryBeforePlatformSend, t as ackDelivery, v as moveToFailed, y as reserveDeliveryAttempt } from "./delivery-queue-storage-BJKj2sCe.js";
import { c as createDeliveryQueueMediaRetention, s as cancelDeliveryQueueMediaRetention } from "./delivery-queue-media-staging-DziHvpn8.js";
import { r as releaseSpoolArtifacts, t as collectEntrySpoolPaths } from "./delivery-queue-media-spool-gOZs_CIq.js";
...
async function drainQueuedEntry(opts) {
	...
	try {
		...
		if (payloadOutcomes.some((outcome) => outcome.status === "suppressed" && outcome.reason === "adapter_returned_no_identity") || results.length === 0 && platformSendStarted) {
