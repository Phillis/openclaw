...
import { c as isFileUrl, d as safeFileURLToPath, l as isWindowsDriveLetterPath, n as WINDOWS_RESERVED_DEVICE_NAMES, r as assertNoUnsafeDeviceReadPath, u as isWindowsNetworkPath } from "./read-open-flags-DGgM-BoE.js";
import { n as sameFileIdentityForCleanup, t as sameFileIdentity } from "./file-identity-CaVBmM56.js";
import { a as isPathInside, c as isSymlinkOpenError, i as isNotFoundPathError, s as isPathRelativeEscape } from "./path-D138yf8v.js";
import { d as createAsyncDirectoryGuard, i as findExistingAncestor } from "./absolute-path-CYFPfAjt.js";
import { _ as resolveUserPath, a as guardedRenameSync, c as withAsyncDirectoryGuards, h as expandHomePrefix, p as syncDirectoryBestEffort, s as guardedRmSync } from "./pinned-write-powa_mtU.js";
...
import { t as tempFile } from "./temp-target-BKidZAiK.js";
import { a as isGroupWritable, c as modeBits, i as isGroupReadable, o as isWorldReadable, r as inspectPathPermissions, s as isWorldWritable } from "./permissions-DHG-s8_A.js";
...
async function cleanupTempPath(tempPath, identity) {
	try {
		...
		if (!identity || !current.isSymbolicLink() && sameFileIdentityForCleanup(current, identity)) await fs$1.rm(tempPath, { force: true });
		return true;
	} catch (error) {
