...
import { C as resolveMemoryDreamingPluginConfig, T as resolveMemoryDreamingWorkspaces, _ as MANAGED_MEMORY_DREAMING_CRON_TAG, g as MANAGED_MEMORY_DREAMING_CRON_NAME, v as MEMORY_DREAMING_SYSTEM_EVENT_TEXT, x as resolveMemoryDeepDreamingConfig } from "./dreaming-14k0XOwK.js";
import { u as peekSystemEventEntries } from "./system-events-BVZAS_Ok.js";
...
import { n as includesSystemEventToken } from "./dreaming-shared-BXYFnMQo.js";
...
async function runShortTermDreamingPromotionIfTriggered(params) {
	...
	const [{ writeDeepDreamingReport }, { appendFallbackNarrativeEntry, runDreamNarrative }, { runDreamingSweepPhases }, { applyShortTermPromotions, repairShortTermPromotionArtifacts, rankShortTermPromotionCandidates }] = await Promise.all([
		import("./dreaming-markdown-v43l-5BF.js"),
		import("./dreaming-narrative-Du3rPk9q.js"),
		import("./dreaming-phases-CTp59mCG.js"),
		import("./short-term-promotion-Cv2hkAoU.js")
	]);
		...
		try {
			...
			if (candidates.length > 0 || applied.applied > 0) {
				const data = {
					...
					sourceEntryKeys: [...new Set([...candidates, ...applied.appliedCandidates].map((c) => c.key))]
				};
...
function registerShortTermPromotionDreaming(api) {
	...
	const startDreamingSessionCleanup = async (config, generation, startupStartedAtMs) => {
		const { DREAMING_ORPHAN_MIN_AGE_MS, scrubDreamingNarrativeArtifacts } = await import("./dreaming-session-cleanup-CT05T4TG.js");
