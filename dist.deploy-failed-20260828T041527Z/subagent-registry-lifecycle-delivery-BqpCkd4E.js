...
import { m as patchSessionEntryCore, o as listSessionEntriesReadOnly, p as loadSessionEntryReadOnly, w as resolveSessionStorePathForScope } from "./session-accessor.sqlite-entry-Ik-U-wpI.js";
...
import { i as failTaskRunByRunId, l as setDetachedTaskDeliveryStatusByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-1EE8WqNV.js";
...
import { d as clearDeliveryState, f as ensureCompletionState, g as hasRetainedRequiredCompletionDelivery, h as getDeliveryLastError, l as compareSubagentRunGeneration, m as getDeliveryAttemptCount, p as ensureDeliveryState } from "./subagent-registry.store.sqlite-B8QBtOEs.js";
import { f as SUBAGENT_ENDED_OUTCOME_TIMEOUT, g as SUBAGENT_TARGET_KIND_SUBAGENT, h as SUBAGENT_ENDED_REASON_KILLED, i as isStaleUnendedSubagentRun, l as resolveSubagentSessionStatus, m as SUBAGENT_ENDED_REASON_ERROR, n as hasSubagentRunEnded, o as getSubagentSessionRuntimeMs, p as SUBAGENT_ENDED_REASON_COMPLETE, s as getSubagentSessionStartedAt, u as SUBAGENT_ENDED_OUTCOME_ERROR } from "./subagent-run-liveness-CpuKir5n.js";
...
import { c as isSilentAgentReplyText } from "./message-visibility-B7uGWSom.js";
...
function reconcileOrphanedRun(params) {
	if (hasRetainedRequiredCompletionDelivery(params.entry)) return false;
...
const recordAnnounceDeliveryResult = (entry, delivery, runs) => {
	...
	if (!delivery.delivered && delivery.disposition !== "intentional_non_delivery") {
		if (delivery.reason === "steer_dropped" || delivery.phases?.some((phase) => phase.reason === "steer_dropped")) deliveryState.lastDropReason = "steer_dropped";
