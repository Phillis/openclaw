...
import { a as ensureMediaDir, f as saveMediaBuffer } from "./store-fXRck5jl.js";
...
import { K as DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS, R as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, _ as withCdpSocket, n as assertCdpEndpointAllowed, u as redactCdpErrorText, v as normalizeBrowserTimerDelayMs, z as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-BZ0z5X6D.js";
import { a as normalizeActBoundedNonNegativeMs, l as resolveBrowserNavigationTimeoutMs, n as ACT_MAX_VIEWPORT_DIMENSION, r as ACT_MAX_WAIT_TIME_MS, t as ACT_MAX_CLICK_DELAY_MS } from "./act-policy-C-oAQSTE.js";
import { i as resolveExistingUploadPaths, n as DEFAULT_TRACE_DIR, t as DEFAULT_DOWNLOAD_DIR } from "./paths-C2o4widP.js";
import { a as resolveProfile, i as resolveManagedBrowserHeadlessMode, n as getOwnBrowserProfile, r as resolveBrowserConfig } from "./config-CSL9j7n3.js";
import { a as BrowserError, d as BrowserTargetAmbiguousError, f as BrowserValidationError, i as BrowserConflictError, m as toBrowserErrorResponse, o as BrowserProfileNotFoundError, s as BrowserProfileUnavailableError, t as BROWSER_ACT_ERROR_CODES, u as BrowserTabNotFoundError } from "./tmp-openclaw-dir-BbAL4eNp.js";
...
import { a as isValidProfileName, i as setDefaultBrowserProfile, n as deleteBrowserProfileConfig, t as createBrowserProfileConfig } from "./config-mutations-B5AX9jiw.js";
import { A as STRUCTURAL_ROLES, B as resolveBrowserNavigationProxyMode, E as getRoleSnapshotIdentityKeys, L as withBrowserNavigationPolicy, M as assertBrowserNavigationAllowed, O as CONTENT_ROLES, P as assertBrowserNavigationResultAllowed, S as appendRoleSnapshotDepthTruncationMarker, T as finalizeRoleSnapshot, U as resolveBrowserExecutableForPlatform, b as snapshotAria, h as captureScreenshot, k as INTERACTIVE_ROLES, n as getChromeWebSocketEndpoint, s as resolveOpenClawUserDataDir, u as ensureOutputDirectory, v as getMainFrameDocumentIdentityViaCdp, x as snapshotRoleViaCdp } from "./chrome-Bz25Dp6i.js";
import { _ as getPwAiModule$1, a as getOrCreateProfileRuntime, l as isProfileRestartRequiredError, o as getProfileLifecycle, r as beginProfileTransition } from "./server-context.lifecycle-D5Y8_Rq-.js";
import { f as ChromeMcpDocumentUnavailableError } from "./chrome-mcp-contracts-JXYE0tAu.js";
import { r as resolveCdpControlPolicy, t as movePathToTrash } from "./trash-DB7RJIyG.js";
import { i as resolveTargetIdFromTabs, r as withProfileContextOperation } from "./server-context-ZddMXBGO.js";
import { n as importSystemProfileCookies, r as listSystemProfiles } from "./system-profiles-Dg5u18Cc.js";
import "./sdk-setup-tools-B9rFA7Or.js";
import { S as withChromeMcpDocument, _ as resizeChromeMcpPage, b as takeChromeMcpSnapshot, d as fillChromeMcpElement, f as fillChromeMcpForm, g as pressChromeMcpKey, h as navigateChromeMcpPage, l as dragChromeMcpElement, m as hoverChromeMcpElement, o as clickChromeMcpCoords, r as getChromeMcpPid, s as clickChromeMcpElement, u as evaluateChromeMcpScript, x as uploadChromeMcpFile, y as takeChromeMcpScreenshot } from "./chrome-mcp-S-JI_NCc.js";
