import { s as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-B19X7f09.js";
...
import { b as respondControlUiPluginAuthCookieProbe } from "./http-auth-utils-Bmffinhw.js";
import { n as finishFailedGatewayHttpResponse } from "./http-common-Dy8Dj7pv.js";
import { a as runWithGatewayUpgradeWorkAdmission, i as runWithGatewayHttpWorkAdmission, n as matchedPluginRoutesRequireGatewayAuth, r as shouldEnforceGatewayAuthForPluginPath, t as isPluginAuthenticatedRoutePath } from "./route-auth-BC1gUNLU.js";
import { t as resolvePluginRouteRuntimeOperatorScopes } from "./plugin-route-runtime-scopes-DubAl9k3.js";
...
function createPluginRouteRuntimeClient(scopes, clientIp, requestAuth) {
	...
	const sharedSecretOwner = !authenticatedUserProfile && (requestAuth?.authMethod === "token" || requestAuth?.authMethod === "password");
	return {
		connId: `plugin-http:${clientIp ?? "unknown"}`,
		...clientIp ? { clientIp } : {},
		...authenticatedUserProfile ? { authenticatedUserProfile } : {},
		...sharedSecretOwner ? { internal: { operatorRoleActor: { kind: "system" } } } : {},
		connect: {
			minProtocol: 4,
			maxProtocol: 4,
			client: {
