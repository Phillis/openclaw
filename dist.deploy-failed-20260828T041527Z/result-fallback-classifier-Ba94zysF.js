...
import "./user-copy-LZk56sIA.js";
import { a as hasVisibleAgentPayload } from "./message-visibility-B7uGWSom.js";
import { c as hasCommittedOutboundDeliveryEvidence } from "./delivery-evidence-JxKjzZU6.js";
...
function hasIntentionalTerminalCompletion(result) {
...
function classifyEmbeddedAgentRunResultForModelFallback(params) {
	...
	if (hasIntentionalTerminalCompletion(params.result) || params.result.meta.aborted || params.hasDirectlySentBlockReply === true || params.hasBlockReplyPipelineOutput === true) return null;
...
//#endregion
export { mergeEmbeddedAgentRunResultForModelFallbackExhaustion as i, hasDeliberateSilentTerminalReply as n, hasIntentionalTerminalCompletion as r, classifyEmbeddedAgentRunResultForModelFallback as t };
