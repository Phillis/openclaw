...
import { D as resolveExpiresAtMsFromDurationMs, E as resolveDateTimestampMs, g as isFutureDateTimestampMs } from "./number-coercion-CLj0HTDM.js";
...
import { l as readPluginPackageVersion } from "./extension-shared-BO-DUGkx.js";
import "./text-utility-runtime-BNhX-3os.js";
import { S as resolveCodexAppServerUserHomeDir } from "./config-Cup3m5Mg.js";
import { At as resolveCodexAppServerHomeDir, jt as resolveCodexAppServerLocalHomeDir } from "./shared-client-DsH0bBjk.js";
...
let catalogConnectionHomes = /* @__PURE__ */ new Map();
function catalogConnectionHomeKey(fingerprint, agentDir) {
	return `${agentDir ?? ""}\0${fingerprint}`;
}
/** Replaces the lifecycle-owned catalog connection snapshot used by supervised bindings. */
function replaceCodexCatalogConnectionHomes(homes) {
	catalogConnectionHomes = new Map(homes.map((home) => [catalogConnectionHomeKey(home.fingerprint, home.agentDir), home.codexHome]));
}
...
function resolveCodexCatalogConnectionHome(fingerprint, agentDir) {
...
//#endregion
export { resolveCodexCatalogConnectionHome as a, replaceCodexCatalogConnectionHomes as i, buildCodexAppServerRuntimeFingerprint as n, defaultCodexAppInventoryCache as o, buildCodexPluginAppCacheKey as r, serializeCodexAppInventoryError as s, buildCodexAppServerConnectionFingerprint as t };
