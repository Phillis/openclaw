...
import { f as redactSensitiveText, n as getDefaultRedactPatterns, v as readLoggingConfig } from "./redact-CWP17HFN.js";
...
import { s as isLikelyContextOverflowError } from "./classify-DkuNrlYG.js";
import { r as isCliRuntimeAlias } from "./model-runtime-aliases-Rrd1VaX1.js";
import { r as externalCliDiscoveryForProviders } from "./external-cli-discovery-kohNMVnn.js";
import { t as isCliProvider } from "./model-selection-cli-DIJUaQeE.js";
import { _ as MissingAgentHarnessError, a as describeFailoverError, c as isFailoverError, l as isNonProviderRuntimeCoordinationError, m as resolveModelFallbackError, n as buildFailoverRemediationHint, t as FailoverError, v as isAgentHarnessPreflightError } from "./failover-error-DVBvcQuA.js";
import { d as isAgentRunDirectAbortReason, f as isAgentRunRestartAbortReason } from "./run-termination-hzmbXtwI.js";
import { l as getApiErrorPayloadFingerprint } from "./user-copy-LZk56sIA.js";
import { l as isCommandLaneTaskTimeoutError } from "./command-queue-CBS1Vl32.js";
import { d as classifyProviderRuntimeFailureKind } from "./embedded-agent-helpers-NAvzsIRm.js";
import { n as findAgentRunTerminalOutcome } from "./agent-run-terminal-error-BLySVFXs.js";
import { t as isSandboxProvisioningError } from "./provisioning-error-DsXsTN99.js";
import { r as isOpenClawAbortableWrapper } from "./abortable-m7x7d-PK.js";
import { n as isCronTerminalAbortReasonText } from "./execution-errors-8cDmMmgD.js";
import { a as runWithDeferredSessionSuspension, o as suspendSession } from "./session-suspension-BzTfUhzc.js";
...
//#endregion
export { logModelFallbackDecision as _, recordFailedCandidateAttempt as a, shouldSuppressRawErrorConsoleSuffix as b, resolveLiveSessionModelSwitchRedirectIndex as c, resolveNextFallbackCandidateIndex as d, runFallbackAttempt as f, isModelFallbackDecisionLogEnabled as g, throwFallbackFailureSummary as h, isTranscriptNotContinuableError as i, resolveModelFallbackCandidateAgentRuntime as l, shouldDiscardDeferredSessionSuspension as m, hasDifferentLiveSessionRuntimeSelection as n, resolveFallbackAuthScope as o, sameModelCandidate as p, isFallbackSummaryError as r, resolveFallbackSoonestCooldownExpiry as s, appendFailedCandidateAttempt as t, resolveModelFallbackCandidateHarnessAuthPrecheck as u, buildApiErrorObservationFields as v, buildTextObservationFields as y };
