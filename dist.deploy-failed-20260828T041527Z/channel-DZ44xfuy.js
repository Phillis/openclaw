...
import { h as resolveScopeToolsPolicy, m as resolveScopeRequireMention } from "./channel-policy-RPOWSkLP.js";
import { a as createEmptyChannelResult } from "./channel-send-result-BFAnsv6z.js";
import { a as checkZcaAuthenticated, c as resolveZalouserAccountSync, i as writeQrDataUrlToTempFile, o as listZalouserAccountIds, r as zalouserSetupContract, s as resolveDefaultZalouserAccountId, t as createZalouserSetupWizardProxy } from "./setup-core-r6PlZ_Cq.js";
...
const loadZalouserChannelRuntime$1 = createLazyRuntimeModule(() => import("./channel.runtime-C9ehlPYs.js"));
...
const loadZalouserChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-C9ehlPYs.js"));
const zalouserSetupWizardProxy = createZalouserSetupWizardProxy(async () => (await import("./setup-surface-CCGfpr4l.js")).zalouserSetupWizard);
	...
	base: {
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				const { monitorZalouserProvider } = await import("./monitor-ChqYPzij.js");
