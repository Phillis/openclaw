import { bi as TtsAutoMode, i as OpenClawConfig, ns as ChatType } from "./types.openclaw-Bon4guJK.js";
import { h as DeliveryContext, m as SourceReplyDeliveryMode } from "./types-u974fjDg.js";
import { t as AgentMessage } from "./types-C0q614H7.js";
import "./index-DIhleTnP.js";
import { D as PluginHookChannelContext, R as ReplyPayload, at as ApprovalScope, k as MediaFact, t as FinalizedMsgContext } from "./templating-C-n5PdTU.js";
...
//#endregion
export { DiagnosticTraceContext as A, ReplyDispatchBeforeDeliverOptions as C, ReplyDispatcher as D, ReplyDispatchRuntimeInfo as E, ReplyFollowupAdmissionBarrierTimeoutPolicy as O, ReplyDispatchBeforeDeliver as S, ReplyDispatchReceipt as T, PluginConversationBindingRequestParams as _, resetGlobalHookRunner as a, PluginApprovalResolution as b, PluginHookBeforeToolCallEvent as c, PluginHookToolContext as d, PluginHookToolInputKind as f, PluginConversationBinding as g, PluginToolMatcher as h, initializeGlobalHookRunner as i, PluginJsonValue as j, PluginSubagentRequesterContext as k, PluginHookRegistration as l, PluginHookToolRequesterContext as m, getGlobalPluginRegistry as n, runGlobalGatewayStopSafely as o, PluginHookToolKind as p, hasGlobalHooks as r, HookEntry as s, getGlobalHookRunner as t, PluginHookReplyPayloadSendingContext as u, PluginConversationBindingRequestResult as v, ReplyDispatchKind as w, PluginHookBeforeToolCallResult as x, PluginConversationBindingResolvedEvent as y };