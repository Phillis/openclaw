...
import { a as upsertSessionUpstreamLink, t as deleteSessionUpstreamLink } from "./session-upstream-links-BwxSZt9W.js";
import "./string-coerce-runtime-C8jKEm3h.js";
import { u as readVisibleSessionTranscriptMessageEntries } from "./session-transcript-runtime-DXwgc1x5.js";
import "./session-catalog-BZ2h3pGe.js";
import { _ as sessionBindingIdentity } from "./session-binding-BlplpJ9G.js";
import { a as assertCodexThreadForkResponse } from "./protocol-validators-CpTKO3aJ.js";
import "./incognito-session-KJUXvrtm.js";
import { i as createImportedCodexSession, n as codexUpstreamBaseline, t as codexLastTerminalTurnId } from "./session-upstream-marker-vCA1H0EW.js";
...
async function forkCodexUpstreamSession(params, options) {
	try {
		...
		return await requestControl.withPinnedConnection(async (control) => {
			...
			if (sourceFingerprint !== control.connectionFingerprint) return {
				status: "failed",
				code: "upstream-unavailable",
				message: "This Codex thread is not available on the current connection. Reconnect to its host and try again."
			};
