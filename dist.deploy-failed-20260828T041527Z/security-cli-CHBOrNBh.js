...
import { S as tryResolveDefaultAgentId, r as listAgentEntries } from "./agent-scope-config-CUBiGmG3.js";
import { r as LEGACY_IMPLICIT_AGENT_ID } from "./session-key-Dbce_H9p.js";
import { S as createConfigIO, n as getRuntimeConfig } from "./io-ClLVsBMp.js";
...
import { p as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-B3UG58Gq.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as runSecurityAuditCore } from "./audit-Den16AlA.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-BDx9M6hm.js");
