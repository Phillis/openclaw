...
import { a as markAuthProfileFailure } from "./usage-wmbnTa19.js";
...
import { d as waitForDeferredTurnMaintenanceForSession, i as bootstrapHarnessContextEngine, l as runHarnessContextEngineMaintenance, n as runAgentEndSideEffects, s as finalizeHarnessContextEngineTurn, t as awaitAgentEndSideEffects } from "./agent-end-side-effects-CpKBK0Oh.js";
...
import { a as runAgentHarnessLlmInputHook, o as runAgentHarnessLlmOutputHook, s as buildAgentHookContext } from "./lifecycle-hook-helpers-CA6g_0C9.js";
import { b as resolveExplicitFinalSourceReplyDeliveryEvidence } from "./delivery-evidence-JxKjzZU6.js";
import { r as isCliSessionInvalidatingFailoverReason } from "./cli-session-CCYUcdz9.js";
...
import { a as resolveCliRuntimeOwnerFingerprint, i as resolveCliRuntimeArtifactFingerprint } from "./cli-auth-epoch-Dvd_oLDR.js";
import { i as formatCliBackendOutputDigest, r as cliBackendLog } from "./log-BPUOmteF.js";
import { h as hashCliReseedPrompt } from "./cli-session-history.claude-DzqLWUpB.js";
...
import { c as CliAuthProfilePreparationError, i as loadCliSessionHistoryMessages, r as loadCliSessionContextEngineMessages, s as buildAgentHookConversationMessages, u as claudeCliSessionTranscriptHasContent } from "./session-history-P07y6LfY.js";
...
async function settlePreparedCliRun(params) {
	...
	if (runParams.cleanupBundleMcpOnRunEnd === true) try {
		const { retireSessionMcpRuntime } = await import("./agent-bundle-mcp-tools-DDXwY5B5.js");
