...
import { ln as resolveCronTaskRecordTimestamp, nn as cronTaskRecordStoreKey } from "./openclaw-state-db-kmBThqu6.js";
...
import { b as sweepExpiredPluginStateEntries } from "./plugin-state-store-WXMs6Mfy.js";
import { i as isAcpTurnActive, t as getAcpSessionManager } from "./manager-BUipT7v-.js";
import { n as isTerminalTaskFlow } from "./task-flow-registry.types-BidrdCoB.js";
import { f as loadTaskRegistryStateFromSqliteReadOnlyResult, l as listTaskRegistryRecordsByRuntimeSourceIdFromSqlite } from "./task-registry.store.sqlite-uc-5B4tV.js";
import { $ as listTaskFlowRecords, C as hasActiveTaskForChildSessionKey, E as listTaskRecords, F as isTaskFlowCancellationPending, K as deleteTaskFlowRecordById, N as resolveTaskForLookupToken, Q as getTaskFlowRegistryRestoreFailure, S as getTaskById, Z as getTaskFlowById, _ as maybeDeliverTaskTerminalUpdate, b as deleteTaskRecordById, c as markTaskTerminalById, g as isBackgroundExecTask, k as listTasksForFlowId, o as markTaskLostById, ot as updateFlowRecordByIdExpectedRevision, p as isHarnessOwnedSubagentTask, u as setTaskCleanupAfterById } from "./task-registry-aynazQHF.js";
import { A as ensureTaskRegistryReady } from "./task-registry-activity-C-esutqT.js";
import { t as getSessionBindingService } from "./session-binding-service-47rBLtwF.js";
import { n as resolveTaskCleanupAfter, t as resolveEffectiveTaskCleanupAfter } from "./task-retention-9GuX18TZ.js";
import "./runtime-internal-C7MuMy9Z.js";
import { n as summarizeTaskRecords } from "./task-registry.summary-BwpoHlXv.js";
import { d as tryRecoverTaskBeforeMarkLost, s as getDetachedTaskLifecycleRuntime } from "./detached-task-runtime-1EE8WqNV.js";
import { n as readAcpSessionEntry, t as listAcpSessionEntries } from "./session-meta-CpNLCGd4.js";
import { s as isCronJobActive } from "./active-jobs-BG_34AJh.js";
import { n as isBackgroundExecSessionActive } from "./bash-process-control-DQTdnA_w.js";
import { n as formatSubagentRecoveryWedgedReason, r as isSubagentRecoveryWedgedEntry } from "./subagent-recovery-state-1AUqfKvI.js";
import { n as summarizeTaskFlowAuditFindings, t as listTaskFlowAuditFindings } from "./task-flow-registry.audit-C3581muT.js";
import { a as summarizeTaskAuditFindings, n as listTaskAuditFindings, t as configureTaskAuditTaskProvider } from "./task-registry.audit-BaLk4XcN.js";
...
function shouldPruneFlow(flow, now) {
	if (!isTerminalTaskFlow(flow)) return false;
...
function shouldFinalizeCancelledFlow(flow) {
	...
	if (flow.cancelRequestedAt == null || isTerminalTaskFlow(flow)) return false;
...
function shouldRepairTerminalMirroredFlowTimestamp(flow) {
	if (flow.syncMode !== "task_mirrored" || !isTerminalTaskFlow(flow)) return false;
...
function reconcileInspectableTasks() {
	...
	return reconcileTaskRecordsForOperatorInspection(taskRegistryMaintenanceRuntime.listTaskRecords());
}
...
async function runTaskRegistryMaintenance() {
	...
	for (const task of tasks) {
		...
		if (shouldStampCleanupAfter(current)) {
			if (taskRegistryMaintenanceRuntime.setTaskCleanupAfterById({
				taskId: current.taskId,
...
//#endregion
export { CRON_HISTORY_KEEP_PER_JOB as S, sweepTaskRegistry as _, getInspectableTaskRegistrySummary as a, previewTaskFlowRegistryMaintenance as b, listInspectableTasksReadOnly as c, reconcileTaskLookupToken as d, resetTaskRegistryMaintenanceRuntimeForTests as f, stopTaskRegistryMaintenance as g, startTaskRegistryMaintenance as h, getInspectableTaskAuditSummary as i, previewTaskRegistryMaintenance as l, setTaskRegistryMaintenanceRuntimeForTests as m, getInspectableActiveTaskRestartBlockers as n, getTaskRegistryMaintenanceDiagnostics as o, runTaskRegistryMaintenance as p, getInspectableTaskAuditFindings as r, inspectTasksReadOnly as s, configureTaskRegistryMaintenance as t, reconcileInspectableTasks as u, assertTaskFlowRegistryMaintenanceReady as v, runTaskFlowRegistryMaintenance as x, getInspectableTaskFlowAuditSummary as y };
