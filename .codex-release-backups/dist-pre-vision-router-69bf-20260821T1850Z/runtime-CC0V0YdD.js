...
import { i as getChildLogger, s as isFileLogLevelEnabled } from "./logger-CufStxi-.js";
...
import { b as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog } from "./model-selection-shared-0DI3vxkL.js";
...
import { c as resolveThinkingProfile } from "./thinking-D9bT8eOf.js";
import { r as replaceConfigFile, t as mutateConfigFile } from "./mutate-B2SI65Vd.js";
import "./config-CfeGo4K4.js";
import { i as shouldLogVerbose } from "./globals-DD_xHyf6.js";
...
import { $t as loadSessionEntryReadOnly, K as updateSessionEntry, Pt as listSessionEntriesCore, en as patchSessionEntryCore, in as replaceSessionEntry, qt as listSessionEntriesReadOnly } from "./session-accessor-CIiPoGwM.js";
import { a as rollbackPluginOwnedSessionEntryLifecycle, i as rollbackAgentHarnessSessionEntryLifecycle, n as deleteSessionEntryLifecycle } from "./session-accessor.sqlite-lifecycle-BFaW8ajj.js";
import { X as runExclusiveSessionLifecycleMutation, Y as isSessionWorkAdmissionActive, w as normalizeResolvedMaintenanceConfigInput, z as beginSessionWorkAdmission } from "./agent-harness-session-key-BpWapmwX.js";
...
import { B as createManagedTaskFlow, K as finishFlow, O as listTasksForFlowId, Q as requestFlowCancel, W as failFlow, et as resumeFlow, tt as setFlowWaiting } from "./task-registry-CvGhDB6M.js";
import "./runtime-internal-3api9B92.js";
import { _ as getTaskFlowByIdForOwner, d as getFlowTaskSummary, g as findLatestTaskFlowForOwner, p as runTaskInFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById, v as listTaskFlowsForOwner, y as resolveTaskFlowForLookupTokenForOwner } from "./task-executor-DMzLBFec.js";
...
import { a as resolveInheritedToolPolicyForSession, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./agent-tools.policy-Ba4icL7P.js";
import { n as loadWebMedia } from "./web-media-DRJtrLMa.js";
import { z as normalizeExecTarget } from "./exec-approvals-Bzza0Zxs.js";
import { n as generateMusic, r as listRuntimeMusicGenerationProviders } from "./openclaw-tools-BnRMSGjs.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "./task-owner-access-CApi94oH.js";
import { o as resolveEffectiveSessionToolsVisibility } from "./session-visibility-Dylhk5vA.js";
...
import { i as listWebSearchProviders, o as runWebSearch } from "./runtime-QGQYfFQ9.js";
import { t as RequestScopedSubagentRuntimeError } from "./error-runtime-oXQewkZq.js";
...
import { t as createRuntimeChannel } from "./runtime-channel-Bdcb4kbo.js";
...
async function createSessionEntry(params) {
	const [{ createGatewaySession }, { resolveGatewaySessionStoreTarget }, { readAcpSessionMetaForEntry, upsertAcpSessionMeta }] = await Promise.all([
		import("./session-create-service-DBVg5kFr.js"),
		import("./session-utils-C-lncBYE.js"),
		import("./session-meta-DpXmkzrT.js")
	]);
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("./heartbeat-runner-BUspRAAj.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRequestRuntime = createLazyRuntimeModule(() => import("./runtime-tts-request-CpN4tPeL.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-Bw1aLoAB.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime.js"));
const loadGatewayPluginRuntime = createLazyRuntimeModule(() => import("./server-plugins-CDp9WBTP.js"));
...
function createRuntimeLlmFacade() {
	const loadAcquireLocalService = createLazyRuntimeMethod(() => import("./provider-local-service-BhtYKika.js"), (runtime) => runtime.createConfiguredProviderLocalServiceAcquirer(getRuntimeConfig));
...
function createRuntimeWorktrees() {
	const loadService = () => import("./service-D5qnNbtI.js");
	return {
		async resolveCheckoutRoot(params) {
			const { findGitCheckoutRoot } = await import("./git-C0F3DzsF.js");
			return findGitCheckoutRoot(params.path) ?? void 0;
		},
		async hasSelfContainedCheckoutMetadata(params) {
			const { hasSelfContainedGitMetadata } = await import("./git-C0F3DzsF.js");
...
function createRuntimeSandbox(agent) {
	...
	return {
		...
		async prepareWorkspaceAuthority(params) {
			...
			const { resolveSandboxContext } = await import("./context-ymc4VGgE.js");
