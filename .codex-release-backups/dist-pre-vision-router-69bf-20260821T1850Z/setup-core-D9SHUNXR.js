...
import { l as prepareScopedSetupConfig } from "./setup-helpers-D-LqhtmB.js";
import "./setup-BVnDItNa.js";
import "./channel-setup-BeEHkyUZ.js";
import { a as namedAccountPromotionKeys, i as validateMatrixSetupInput, n as applyMatrixSetupAccountConfig, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove, t as createMatrixSetupDmPolicy } from "./setup-dm-policy-CHtGfg1M.js";
...
const matrixSetupAdapter = {
	...
	afterAccountConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-C6ePUKgv.js");
