...
import { C as parseStrictNonNegativeInteger, F as resolveTimerTimeoutMs, j as resolveIntegerOption, v as parseDateFirstTimestampMs } from "./number-coercion-oCkfUEEq.js";
import { c as isRecord, i as asOptionalObjectRecord } from "./record-coerce-DItp3I4t.js";
import { E as isMissingPathError, w as hasErrnoCode } from "./redact-DP7p9QfH.js";
import { i as readRegularFileSync, r as readRegularFile } from "./regular-file-SotPWt-b.js";
import { g as shortenPathWithHome } from "./utils-D9gvQMP6.js";
...
import { a as installOpenClawInternalCorePackageNativeResolver } from "./plugin-module-loader-cache-O65paH_z.js";
import { n as buildPluginLoaderJitiOptions, t as buildPluginLoaderAliasMap } from "./sdk-alias-Bm4-C4ID.js";
import { r as decodeWindowsTextFileBuffer, t as createWindowsOutputDecoder } from "./windows-encoding-zzUQjdb4.js";
...
import { n as isRetryableAssistantError, r as classifyRateLimitWindow } from "./retry-BxyIWuMG.js";
import { l as llm_exports } from "./llm-BDB_cYir.js";
import { s as resolveThinkingDefaultForModel } from "./thinking-D9bT8eOf.js";
import { t as acquireFileLockSyncWithRetry } from "./file-lock-sync-CRxT3yHR.js";
import { s as withFileLock } from "./file-lock-ynSOOGat.js";
import "./file-lock-B-9jLU1D.js";
import { p as releaseChildProcessOutputAfterExit, s as spawnCommand } from "./exec-Cmwsxh9J.js";
import { n as truncateUtf8Suffix } from "./utf8-truncate-Dro7v_iB.js";
import { a as resolveOAuthRefreshLockPath } from "./path-resolve-DES5vxlU.js";
import { a as inspectPersistedAuthProfileStoreRaw, h as runAuthProfileWriteTransaction, i as inspectPersistedAuthProfileStateRaw, m as resolveAuthProfileDatabasePath } from "./sqlite-Bc2uR5B8.js";
import { i as assertAuthProfileMigrationReady, n as AuthProfileMigrationRequiredError, r as AuthProfileStoreUnreadableError } from "./legacy-source-diagnostic-C-wLeKtj.js";
import { P as OAUTH_REFRESH_LOCK_OPTIONS, a as loadPersistedAuthProfileStore, d as loadPersistedAuthProfileState } from "./persisted-B895D0I1.js";
import { s as getRuntimeAuthProfileStoreSnapshotCore } from "./runtime-snapshots-CVpJCNdz.js";
import { t as extractArchive } from "./archive-8JuAoUNj.js";
import "./archive-Bspx_Gv4.js";
import { H as createSessionEntryWithTranscript, ht as makeZeroUsageSnapshot } from "./session-accessor-CIiPoGwM.js";
import "./session-accessor.sqlite-transcript-store-Cgnm_AHf.js";
import { n as attachRuntimePromptMediaFacts } from "./media-facts-CdKKNGmE.js";
import { g as resolveModelPluginMetadataSnapshot } from "./provider-hook-runtime-Cl2YZAgZ.js";
import { f as loadAuthProfileStoreForSecretsRuntime, v as saveAuthProfileStore } from "./store-DZy8rsrA.js";
import { i as loginProviderOAuthWithPlugin, s as resolveProviderOAuthCredentialWithPlugin } from "./provider-runtime.runtime.js";
import { o as convertImageToPng, s as createImageProcessor } from "./image-ops-CuoBGLvn.js";
import { A as substituteArgs, C as prepareCompaction$1, D as InvalidSummaryOutputError, F as bashExecutionToText, I as convertToLlm, L as runAgentLoop, M as BRANCH_SUMMARY_SUFFIX, N as COMPACTION_SUMMARY_PREFIX, O as buildSessionContext, P as COMPACTION_SUMMARY_SUFFIX, S as getLastAssistantUsage, T as serializeConversation, _ as estimateContextTokens, a as DEFAULT_MAX_LINES, b as findTurnStartIndex, c as truncateLine, d as generateBranchSummary$1, f as prepareBranchEntries, g as compact$1, h as calculateContextTokens, i as DEFAULT_MAX_BYTES, j as BRANCH_SUMMARY_PREFIX, k as parseCommandArgs, l as truncateTail, n as openClawAgentCoreRuntime, o as formatSize, p as DEFAULT_COMPACTION_SETTINGS, s as truncateHead, t as Agent, u as collectEntriesForBranchSummaryFromBranches, v as estimateTokens, w as shouldCompact, x as generateSummary$1, y as findCutPoint, z as uuidv7 } from "./agent-core-BNJRSUk4.js";
import { c as setInternalBeforeToolBatch, i as copyInternalToolExecutionPreparer } from "./internal-hooks-BK9FsMLA.js";
import { o as bindStreamLlmRuntime } from "./stream-DyQQWfkz.js";
import { a as migrateSessionEntries, c as normalizeLoadedFileEntry, d as parseSessionEntries, n as getLatestCompactionEntry, t as buildSessionContext$1 } from "./session-manager-codec-CBbtVKV-.js";
...
import { _ as isBunBinary, a as getBashShellEnv, c as sanitizeBinaryOutput, d as PACKAGE_MANIFEST_VERSION, f as getAgentDir, g as getReadmePath, h as getExamplesPath, i as getBashShellConfig, l as APP_NAME, m as getDocsPath, n as createStreamingBinaryOutputSanitizer, p as getBinDir, s as killProcessTree$1, t as buildShellCommandInvocation, u as CONFIG_DIR_NAME } from "./shell-utils-_kOWJnU_.js";
import { a as OAuthProviderConfiguredUnavailableError, t as OAuthProviderRegistry } from "./oauth-C82J7Mhn.js";
import "./paths-VbbHRpeN.js";
import "./messages-xrgsxO26.js";
import { t as parseModelCatalogJson } from "./model-catalog-json-CxUsDrkg.js";
import { i as isGeneratedPluginModelCatalog, o as loadPersistedPluginModelCatalogs, r as filterGeneratedPluginModelCatalogProviders } from "./plugin-model-catalog-C53wjUvC.js";
import "./ai-transport-runtime-host-B7O6W1a9.js";
import { c as isLocalPath, o as canonicalizePath, s as formatPathRelativeToCwdOrAbsolute } from "./skill-index-CEvOAhOd.js";
import { t as SessionManager } from "./session-manager-2mjIFFdj.js";
import { n as createSourceInfo, r as createSyntheticSourceInfo, t as computeSkillPromptVersion } from "./skill-version-BztMvclw.js";
...
import { r as copyCodeModeControlToolIdentity } from "./code-mode-control-tools-BG8YVf5a.js";
...
import { i as resolveToCwd, n as getReadPathVariants, r as resolveReadPath } from "./path-utils-DhfwxP7G.js";
import { i as normalizeMediaReferenceSource, r as classifyMediaReferenceSource, s as resolveMediaReferenceLocalPath } from "./media-reference-8XBYb3Pm.js";
import { n as resolveSkillInvocationPolicy, t as parseSkillFrontmatter } from "./frontmatter-BE0jYufM.js";
import { n as getArchivedSkillFiles } from "./curator-XlkqyZug.js";
import { r as formatSkillsForPromptCore } from "./skill-contract-CcNjm_Kp.js";
							...
							if (totalFileLines === 0) outputText = buffer.length === 0 ? "File is empty (0 bytes)." : `File contains no readable text (${buffer.length} bytes).`;
								...
								if (selectedLines.every((line) => line.length === 0)) {
									...
									if (truncation.firstLineExceedsLimit) {
										...
										const firstLine = lineBreak === -1 ? selectedContent : selectedContent.slice(0, lineBreak);
									...
									} else if (userLimitedLines !== void 0 && startLine + userLimitedLines < totalFileLines) {
...
function formatSkillsForPrompt(skills) {
	return formatSkillsForPromptCore(skills.filter((s) => !s.disableModelInvocation));
}
		...
		if (sameModel && (assistantMessage.stopReason === "error" || assistantMessage.stopReason === "length") && isContextOverflow(assistantMessage, contextWindow)) {
			...
			if (this.overflowRecoveryAttempts >= 3) {
				this.emit({
					...
					aborted: false,
					willRetry: false,
					errorMessage: `Context overflow recovery failed after 3 compact-and-retry attempts. Try reducing context or switching to a larger-context model.`
				});
				return false;
			}
...
//#endregion
export { findExactModelReferenceMatch as $, createLsToolDefinition as A, withFileMutationQueues as B, createTool as C, takeRuntimeUserTurnTranscriptRecorder as Ct, createReadTool as D, stripStaleThinkingSignaturesForCompactionReplay as Dt, createWriteToolDefinition as E, isThinkingBlock as Et, SESSION_TOOL_STDERR_TAIL_BYTES as F, createBashTool as G, hasOnlyCrlfLineEndings as H, appendBoundedTextTail as I, wrapToolDefinition as J, createBashToolDefinition as K, createEditTool as L, createGrepToolDefinition as M, createFindTool as N, createReadToolDefinition as O, stripStaleAssistantUsageBeforeLatestCompaction as Ot, createFindToolDefinition as P, parseGitUrl as Q, createEditToolDefinition as R, createReadOnlyTools as S, takeRuntimeUserTurnTranscriptContext as St, createWriteTool as T, isAssistantMessageWithContent as Tt, normalizeToLF as U, decodeUtf8File as V, restoreLineEndings as W, SettingsManager as X, formatFullOutputFooter as Y, DefaultPackageManager as Z, createAllToolDefinitions as _, FILE_AUTH_STORAGE_BACKEND_DEPRECATION_CODE as _t, agentSessionAutomaticCompaction as a, ModelRegistry as at, createCodingTools as b, createEventBus as bt, loadSkills as c, compact as ct, retireQueuedUserMessage as d, collectEntriesForBranchSummary as dt, findInitialModel as et, ExtensionRunner as f, generateBranchSummary as ft, allToolNames as g, AuthStorage as gt, wrapRegisteredTools as h, AUTH_STORAGE_CREATE_DEPRECATION_CODE as ht, AgentSession as i, restoreModelFromSession as it, createGrepTool as j, createLsTool as k, getSteeringMessageIdentity as l, generateSummary as lt, loadExtensionFromFactory as m, writePrivateTempFile as mt, createAgentSessionForEmbeddedRunner as n, resolveCliModel as nt, preflightManualSessionCompaction as o, clearApiKeyCache as ot, createExtensionRuntime as p, executeBashWithOperations as pt, createLocalBashOperations as q, DefaultResourceLoader as r, resolveModelScope as rt, formatSkillsForPrompt as s, getModelRegistryRuntime as st, createAgentSession as t, parseModelPattern as tt, subscribeSteeringMessagePersistenceFailure as u, prepareCompaction as ut, createAllTools as v, FileAuthStorageBackend as vt, createToolDefinition as w, sanitizeCompactionReplayMessages as wt, createReadOnlyToolDefinitions as x, attachRuntimeUserTurnTranscriptRecorder as xt, createCodingToolDefinitions as y, InMemoryAuthStorageBackend as yt, withFileMutationQueue as z };
