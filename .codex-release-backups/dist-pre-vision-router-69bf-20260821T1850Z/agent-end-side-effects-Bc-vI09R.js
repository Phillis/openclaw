...
import { h as consumeRunSkillUsage } from "./agent-tools.before-tool-call-rUQaaAPY.js";
import "./sessions-BHNzcBA2.js";
import { t as SessionManager } from "./session-manager-2mjIFFdj.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-CGsNTeFU.js";
...
import { f as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt-prompt-helpers-C4lkFQsv.js";
import { T as findActiveSessionTask } from "./media-generation-task-status-CZtTP3UZ.js";
import { v as runWithPreparedMemoryPromptSection } from "./memory-state-B3yoTCWD.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-Dg1JBSgT.js";
...
async function runCoreAgentEndSideEffects(params) {
	...
	try {
		const { scheduleSkillExperienceReview } = await import("./experience-review-default-CuBvYxHZ.js");
