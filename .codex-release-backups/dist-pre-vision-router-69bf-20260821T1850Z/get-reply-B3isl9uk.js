...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePathCore, o as resolveSessionStorePathCore } from "./paths-CfFmgJmW.js";
import { dt as resolveOwnerPromptNumbers, r as getRuntimeConfig } from "./io-BTBpQ7uO.js";
import { t as createSubsystemLogger } from "./subsystem-DNgaGOch.js";
import { t as parseDurationMs } from "./parse-duration-CuuCHKpt.js";
import { i as normalizeChatChannelId, n as CHAT_CHANNEL_ORDER } from "./ids-CvoHNWoD.js";
...
import { b as resolveModelRefFromString } from "./model-selection-shared-0DI3vxkL.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime } from "./openai-routing-BC0q3X-J.js";
...
import { a as findChatChannelMeta } from "./registry-BAJij-wJ.js";
...
import { n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-D9bT8eOf.js";
...
import { i as resetRegisteredAgentHarnessSessions } from "./registry-BG-SOVGv.js";
...
import { c as normalizeSessionDeliveryState, d as sessionDeliveryOrigin, f as sessionDeliveryRoute, n as deliveryContextFromSession, o as normalizeDeliveryChannelRoute, r as deliveryContextKey, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-B3qeEQhR.js";
import { n as canonicalizeMainSessionAlias } from "./main-session-Dth0X5B9.js";
import { N as commitReplySessionInitialization, P as loadReplySessionInitializationSnapshot, Qt as loadSessionEntry, _n as sessionEntryForkedFromParent, at as getCliSessionBinding, gn as buildSessionCreationStamp, hn as resolveSessionStorePathForScope, it as clearAllCliSessions } from "./session-accessor-CIiPoGwM.js";
...
import { ct as deriveSessionMetaPatch, tt as conversationIdentityFromMsgContext } from "./targets-CdQ3kEkv.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { $ as runExclusiveSessionStoreWrite, D as resolveMaintenanceConfigFromInput, K as interruptSessionWorkAdmissions, X as runExclusiveSessionLifecycleMutation, l as resolveAgentHarnessSessionContextError } from "./agent-harness-session-key-BpWapmwX.js";
...
import { n as hasResolvedThinkingCatalogEntry, o as resolveEffectiveAgentRuntime } from "./thinking-runtime-_QT_qncS.js";
...
import { _ as isWorkspaceBootstrapPending, m as ensureAgentWorkspace } from "./workspace-Bhf9rmeb.js";
import { g as registerMainSessionGroupWatch, n as classifySessionStateActor, t as acknowledgeSessionStateNotices, u as recordSessionCreated, y as decodeSessionStateNoticeContextKey } from "./session-state-events-DTKQ6kKc.js";
import { a as selectAgentSystemEvents } from "./system-event-ownership-BACexIXt.js";
import { a as enqueueSystemEvent, t as consumeSelectedSystemEventEntries, u as peekSystemEventEntries } from "./system-events-DecgSLEt.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-Bgnhsuju.js";
import { t as hasControlCommand } from "./command-detection-CP6cPabf.js";
import { n as isInternalSourceReplyChannel, r as isSyntheticSourceReplyTurn, t as isExplicitSourceReplyCommand } from "./source-reply-delivery-mode-Dxh1R1CM.js";
import { n as resolveAgentTimeoutMs } from "./timeout-CRSytcvC.js";
import { L as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, b as waitForReplyRunEndBySessionId, c as isReplyRunActiveForSessionId, g as resolveActiveReplyRunThreadId, h as resolveActiveReplyRunSessionId, n as abortReplyRunBySessionId, p as replyRunRegistry } from "./reply-run-registry-Bzalc5xR.js";
import { a as isSessionWorkStartInvalidatedError, o as resolveSessionLifecycleTimestamps, r as hasTerminalMainSessionTranscriptNewerThanRegistry, s as resolveSessionWorkStartError } from "./lifecycle-4IbI4BFl.js";
...
import { n as normalizeQueueDropPolicy, r as normalizeQueueMode } from "./settings-CrsEB2ti.js";
import { i as getExistingFollowupQueue } from "./state-DyigdfFK.js";
...
import { c as isReasoningTagProvider, ft as buildInboundMediaNoteProjection, lt as appendChannelPromptContext } from "./builtin-openclaw-QE-IJbPW.js";
import { o as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-BB6nm0Fy.js";
import { o as sanitizePendingFinalDeliveryText, t as PENDING_FINAL_DELIVERY_CLEAR_PATCH } from "./pending-final-delivery-Cm1ujhWY.js";
import { n as buildMainSessionRecoveryClearPatch } from "./main-session-recovery-clear-H7IP1700.js";
import { n as clearCommandLane, s as getQueueSize } from "./command-queue-B992TXUy.js";
import { i as normalizeInboundTextNewlines, t as finalizeInboundContext } from "./inbound-context-LXL8l8JC.js";
import { i as toInternalMessagePreprocessedContext, n as deriveInboundMessageHookContext, s as toInternalMessageTranscribedContext } from "./message-hook-mappers-CJvD4-Nt.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-C-9oSMC-.js";
import { n as resolveEffectiveToolFsRootExpansionAllowed } from "./tool-fs-policy-BOHeLVrH.js";
import { z as normalizeExecTarget } from "./exec-approvals-Bzza0Zxs.js";
...
import { i as isCommandBearingToolCall } from "./tool-display-BmGn_9WG.js";
import { c as isChannelProgressDraftWorkToolName } from "./streaming-DDNrTPpy.js";
import { a as admitReplyTurn, l as resolveSilentReplySettings, n as createReplySessionEntryHandle, r as createReplyTimingTracker } from "./session-entry-handle-CZxMWW1P.js";
import { s as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-BOPtxYuO.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, d as stageRemoteInboundMediaIfNeeded, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, p as getPreparedReplyDispatchRuntime, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as resolveSessionResetCommand } from "./typing-policy-DjJiUAwS.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-7tldURDl.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-KjqRukQs.js";
import { i as resolveTurnModelOverride, t as resolveSessionStableReplyMode } from "./session-stable-reply-mode-B1BcPGQr.js";
import { n as resolveRoutedDeliveryThreadId, t as isSlackDirectRoutedThreadTurn } from "./routed-delivery-thread-BBPkpw6x.js";
...
import { n as clearBootstrapSnapshotOnSessionBoundary } from "./bootstrap-cache-VAZT9_yH.js";
import "./sandbox-BdXgHoEY.js";
import { a as createUserTurnTranscriptRecorder, c as resolvePersistedUserTurnText } from "./user-turn-transcript-CxlxjVGx.js";
...
import { a as resolveParentForkDecision, r as forkSessionFromParent } from "./session-fork-CWiuE6bB.js";
import { n as projectConversationToolNames } from "./conversation-tool-policy-pipeline-D5kuK8rw.js";
import { u as collectTextContentBlocks } from "./embedded-agent-tool-results-BNVzkCt4.js";
import { l as buildFullBootstrapPromptLines, u as buildLimitedBootstrapPromptLines } from "./system-prompt-params-BubDEHBI.js";
...
import { b as updateAmbientTranscriptWatermark } from "./session-store-runtime-De3jWY_Z.js";
...
import { n as createCronCreatorAuthorityCapability, o as shouldAdmitFreshChannelOwnerCronAuthority, r as runWithCronCreatorAuthorityCapability } from "./cron-creator-authority-context-jKyB9xcY.js";
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-CPoot0W8.js";
...
import { i as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-7d8IMDiz.js";
...
import { n as resolveEffectiveReplyRoute, t as isSystemEventProvider } from "./effective-reply-route-BwRZMEaz.js";
...
import { i as setChannelSourceTurnId, n as readChannelSourceTurnId, o as shouldMintChannelSourceTurnId, t as buildChannelSourceTurnId } from "./source-turn-id-BDtD1rRG.js";
...
import { n as shouldUseFromAsSenderFallback } from "./command-auth-1gwoOm1k.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-C2a-2KPL.js";
...
import { t as clearSessionResetRuntimeState } from "./session-reset-cleanup-CaVtE6sb.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-B14fecuY.js";
import { t as emitSessionAutoResetHook } from "./session-auto-reset-XPNs4mSk.js";
...
import { i as runWithSessionInitConflictRetry, r as ReplySessionInitConflictError, t as getReplySystemEventSessionKey } from "./system-event-session-key-Cifwff56.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-CWcV-jly.js";
import { t as resolveBlockStreamingChunking } from "./block-streaming-CD-wYXT_.js";
import { t as buildCommandContext } from "./commands-context-zFKlhwS2.js";
import { n as resolveModelRuntimeDirective } from "./directive-handling.model-runtime-CQP9b8XT.js";
import { _ as maybeHandleUnexpectedNativeDirectiveArguments, f as formatModelSelectionScopeAck, v as resolveModelSelectionFromDirective } from "./directive-handling.shared-DqrlP2Rq.js";
import { t as resolveContextTokens } from "./model-selection-context-C-xXzj1B.js";
import { n as createModelSelectionState, t as createFastTestModelSelectionState } from "./model-selection-DMH-sTUZ.js";
...
import { a as resolveSkillCommandInvocation, i as listReservedChatSlashCommandNames, o as resolveSkillReferenceInvocations, r as hasSkillReferenceCandidate } from "./chat-commands-N-cOAiJm.js";
import { n as resolvePreparedReplyQueueState, t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-D0jv5eyG.js";
import { i as resolveActiveRunQueueAction, r as resolveTypingMode, t as resolveCurrentTurnImages } from "./current-turn-images-CXFkLbO0.js";
import { t as buildChannelSummary } from "./channel-summary-DcD4j_y9.js";
import { a as resolveInboundUserContextPromptJoiner, n as buildInboundUserContextPrefix, r as formatActiveGoalContext, t as buildInboundMetaSystemPrompt } from "./inbound-meta-BKUwY4vq.js";
import { n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContextAsync } from "./tools-effective-inventory-Dz4YEAbu.js";
import { n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-BO5pUfun.js";
import { t as PROGRESS_STATUS_PREAMBLE_FRESH_MS } from "./progress-draft-compositor-yjt9OkdK.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-DMfvhCZx.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-tzxDzxs0.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-BJSxwKP3.js"));
const abortCutoffRuntimeLoader = createLazyImportLoader(() => import("./abort-cutoff.runtime.js"));
const commandsRuntimeLoader$1 = createLazyImportLoader(() => import("./commands.runtime-BudP1Lod.js"));
...
const commandsRuntimeLoader = createLazyImportLoader(() => import("./commands.runtime-BudP1Lod.js"));
const skillCommandsRuntimeLoader = createLazyImportLoader(() => import("./chat-commands.runtime.js"));
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-7sY9UcMw.js"));
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent.runtime-B2bBylxV.js"));
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-yR5LynZW.js"), { cacheRejections: true }).load;
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-DwuUem4A.js");
