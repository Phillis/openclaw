...
import { f as isSameSsrFPolicy } from "./ssrf-CQ4RdJXm.js";
...
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, m as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Bhf9rmeb.js";
import { C as SANDBOX_DOCKER_CREATE_ARGS_EPOCH, b as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, v as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-CZ9HY-fp.js";
import { n as isToolAllowed } from "./tool-policy-DhUMjkbX.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-C_0jixPy.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DlGUtpYV.js";
import { a as computeSandboxBrowserConfigHash, t as resolveDockerEnvPolicyEpoch } from "./sanitize-env-vars-CuvLvbib.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-D6JNQeBm.js";
import { C as updateRegistry, S as updateBrowserRegistry, _ as readBrowserRegistry, f as readDockerContainerEnvVar, l as formatDockerDaemonUnavailableError, m as readDockerPort, p as readDockerContainerLabel, r as dockerContainerState, s as execDocker, t as buildSandboxCreateArgs, u as isDockerDaemonUnavailable, v as readRegisteredSandboxRuntimeIds } from "./docker-BXAUUNnt.js";
import { c as resolveReadOnlyWorkspaceSkillMounts, i as formatReadOnlyWorkspaceSkillMountHashState, n as appendWorkspaceMountArgs, r as filterBindsConflictingWithProtectedMounts, s as resolveProtectedSkillMountContainerPaths, t as appendReadOnlyWorkspaceSkillMountArgs } from "./workspace-mounts-CW0mGf0z.js";
import { i as slugifySessionKey, n as resolveSandboxAgentId, r as resolveSandboxWorkspaceLayoutPaths, t as buildSandboxContainerName } from "./shared-CwEzk1BZ.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-ovkhLqfC.js";
import { g as assertSshSandboxSecretOwnerAvailable } from "./ssh-backend-SWxgR7nm.js";
import { i as startBrowserBridgeServer, l as requireSandboxBackendFactory, n as stopCachedBrowserBridge, r as stopCachedBrowserBridgesForContainer, s as getSandboxBackendWorkdirResolver, t as BROWSER_BRIDGES } from "./browser-bridges-9cO9JojD.js";
import { t as createSandboxFsBridge } from "./fs-bridge-CihANCJr.js";
import { n as toSandboxProvisioningError } from "./provisioning-error-DPA6xk5f.js";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [syncWorkspaceSkills, { getRemoteSkillEligibility }, { resolveNodeExecEligibility }] = await Promise.all([
			...
			import("./remote-sdomjT0-.js"),
			import("./exec-defaults-BD7wIbDs.js")
		]);
...
async function resolveProvisionedSandboxContext(params, resolved) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-E8OPU2PV.js")).maybePruneSandboxes(cfg);
