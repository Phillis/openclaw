...
import { v as tryResolveConfiguredAgentWorkspaceDir } from "./agent-scope-config-CsnnOL14.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-kpBt4Iki.js";
import { g as collectUnregisteredConfiguredMemoryEmbeddingProviders, h as collectRegisteredEmbeddingProviderIds } from "./gateway-startup-plugin-ids-CydfvKhz.js";
import { E as setActivePluginRegistry, d as getActivePluginRegistry, k as createEmptyPluginRegistry } from "./runtime-LV4GwzTm.js";
import "./loader-BIAS8vL1.js";
import { r as listAmbientOnlyConfiguredChannelIds } from "./channel-presence-policy-CdpkZk_Q.js";
import "./channel-plugin-ids-PXSMuTP5.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-9C6fOMxF.js";
import { f as initSubagentRegistry } from "./subagent-registry-D1aD6Jms.js";
import { r as resolveGatewayStartupPluginActivationConfig } from "./plugin-activation-runtime-config-D9jm6gtQ.js";
import { n as listGatewayMethods } from "./server-methods-list-gOu1Abty.js";
...
async function runGatewayStartupMaintenance(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-CsbYWhTg.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-BR55N7ud.js");
			startupTasks.push(runStartupSessionMigration({
				cfg: params.cfgAtStart,
				env: process.env,
				log: params.log
			}));
			const { migrateLegacyDevicePairingStore } = await import("./device-pairing-migration-KBdDS0rQ.js");
			const { migrateLegacyNodePairingStore } = await import("./node-pairing-migration-DhylN7V5.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-xPpQXQOR.js");
