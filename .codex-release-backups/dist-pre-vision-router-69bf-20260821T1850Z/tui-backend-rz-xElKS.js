...
import { t as executeSystemAgentOperation } from "./operations-BBskjfvz.js";
...
import { t as SystemAgentChatEngine } from "./chat-engine-C4lBj8iC.js";
...
async function runSystemAgentTui(opts, runtime) {
	...
	for (;;) {
		...
		const runTui = boundOpts.runTui ?? (await import("./tui-CBQlufLH.js")).runTui;
		try {
			await runTui({
				local: true,
