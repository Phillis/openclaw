...
import { j as resolveIntegerOption, x as parseStrictFiniteNumber } from "./number-coercion-oCkfUEEq.js";
...
import { At as boolean, Rn as string, Tn as object, dn as literal, wn as number, yt as _enum } from "./schemas-C7gqXY2T.js";
...
import { i as startOAuthLoopbackCallbackServer } from "./oauth-C82J7Mhn.js";
import { l as readMcpOAuthStoreReadOnly, p as operatorMcpOAuthIdentity } from "./mcp-oauth-store-DaPLeF2u.js";
import { i as completeMcpOAuthAuthorization, o as countMcpOAuthPrincipals, s as readMcpOAuthCredentialsStatus, t as clearMcpOAuthCredentials, u as startMcpOAuthAuthorization } from "./mcp-oauth-FmpbBugK.js";
import { t as createSessionMcpRuntime } from "./agent-bundle-mcp-runtime-DONis5Fm.js";
import { t as buildBundleMcpToolsFromCatalog } from "./agent-bundle-mcp-materialize-C1sXRcIt.js";
...
import { i as updateConfiguredMcpServerTools, n as unsetConfiguredMcpServer, r as updateConfiguredMcpServer, t as setConfiguredMcpServer } from "./mcp-config-mutation-B2CX_dfY.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-DXXyo4aE.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_CAPS, GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			...
			import("./client-JCsFTp96.js"),
			import("./client-start-readiness-grqUg7wf.js"),
			import("./method-scopes-DGnFxpEf.js"),
			import("./client-info-B8uPQSnD.js")
		]);
