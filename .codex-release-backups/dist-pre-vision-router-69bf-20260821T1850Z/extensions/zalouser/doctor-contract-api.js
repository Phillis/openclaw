...
import { a as normalizeStoredZaloCredentials, c as resolveLegacyZalouserCredentialsDir, d as zalouserCredentialStoreKey, l as resolveLegacyZalouserCredentialsPath, o as normalizeZalouserCredentialProfile, r as isZaloCredentialRevocation, t as ZALOUSER_CREDENTIALS_NAMESPACE } from "../../session-state-Tiq9G_FD.js";
...
async function collectLegacyZalouserDmEntries(config, env, options = {}) {
	const { deliveryContextFromSession, listSessionEntries, resolveStorePath } = await import("../../plugin-sdk/session-store-runtime.js");
...
const stateMigrations = [{
	...
	async migrateLegacyState({ config, env }) {
		const { deleteSessionEntry, upsertSessionEntry } = await import("../../plugin-sdk/session-store-runtime.js");
