...
import { a as listAgentIds, d as resolveAgentWorkspaceDir, l as resolveAgentDir, p as resolveDefaultAgentId } from "./agent-scope-config-CsnnOL14.js";
...
import { n as externalCliDiscoveryForProviderAuth, r as externalCliDiscoveryForProviders } from "./external-cli-discovery-BKkEUFtz.js";
import { t as createModelAuthAvailabilityResolver } from "./model-auth-availability-BgB_8p23.js";
import { a as hasAvailableAuthForProvider, c as createRuntimeProviderAuthLookup, l as hasRuntimeAvailableProviderAuth } from "./model-auth-BgXCiN_L.js";
...
async function buildCurrentProviderAuthStateSnapshot(cfg, options = {}) {
	...
	for (const agentId of listAgentIds(cfg)) {
		...
		const { loadPreparedModelCatalogOwnerSnapshot } = await import("./prepared-model-catalog-BnhcKv7r.js");
