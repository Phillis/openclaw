...
import { i as isPrivateNetworkOptInEnabled, s as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-u8sGC1hi.js";
...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-CHxhkU8A.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-B5wpK6d0.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-BBbAX8mT.js";
...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-BFe90xdC.js";
import { d as writeStorageMeta, l as resolveMatrixStoragePaths, r as maybeMigrateLegacyStorage, s as repairCurrentTokenStorageMetaDeviceId } from "./storage-Brtcysqi.js";
import fs from "node:fs";
//#region extensions/matrix/src/matrix/client/config.ts
const loadMatrixAuthClientDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-C7xIkm5s.js"), import("./logging-BeVSBIvl.js")]).then(([sdkModule, loggingModule]) => ({
...
const loadMatrixCredentialsReadDeps = createLazyRuntimeModule(() => import("./credentials-read-DP9rWbzr.js"));
...
const loadMatrixCreateClientRuntimeDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-C7xIkm5s.js"), import("./logging-BeVSBIvl.js")]).then(([sdkModule, loggingModule]) => ({
	MatrixClient: sdkModule.MatrixClient,
	ensureMatrixSdkLoggingConfigured: loggingModule.ensureMatrixSdkLoggingConfigured
})));
