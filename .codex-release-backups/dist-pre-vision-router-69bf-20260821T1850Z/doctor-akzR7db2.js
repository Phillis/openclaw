...
import { n as formatConsoleDiagnosticLine } from "./json-console-line-D077TjlD.js";
...
import { r as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-DCxz0axS.js";
...
import { i as withDoctorSqliteMaintenanceLock, r as isDestructiveDoctorSessionSqliteMode } from "./doctor-sqlite-maintenance-lock-qBDt18Z8.js";
...
async function doctorCommand(runtime, options) {
	if (options?.stateSqlite) {
		...
		const { runDoctorStateSqliteCompact } = await import("./doctor-state-sqlite-compact-en7OoDZw.js");
	...
	await (await import("./doctor-health-2IU71NnH.js")).runDoctorHealthFlow(runtime, options);
}
