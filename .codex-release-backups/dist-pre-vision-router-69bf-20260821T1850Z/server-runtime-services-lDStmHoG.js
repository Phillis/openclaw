...
import { c as startSessionDeliveryRuntime, o as schedulePendingSessionDeliveries } from "./subagent-completion-delivery-CtMn_dXG.js";
import "./embedded-agent-XLhLxvRM.js";
import { f as resolveHeartbeatAgents } from "./heartbeat-runner-session-CoYXSYw9.js";
import { t as startHeartbeatRunner } from "./heartbeat-runner-Cqeq0suM.js";
...
function startPendingSessionDeliveryRuntime(params) {
	...
	const timer = setTimeout(() => {
		runWithGatewayIndependentRootWorkAdmission(async () => {
			const { deliverQueuedSessionDelivery, recoverPendingRestartContinuationDeliveries, settleQueuedSessionDelivery } = await import("./server-restart-sentinel-D7ALk_tn.js");
			if (stopped) return;
