...
import { At as boolean, Bt as discriminatedUnion, Et as array, Kn as tuple, Nn as record, Rn as string, St as _null, Tn as object, Xn as union, Zn as unknown, dn as literal, wn as number, yt as _enum } from "./schemas-C7gqXY2T.js";
...
import { a as isValidFileSecretRefId, i as isValidExecSecretRefId, r as formatExecSecretRefIdValidationMessage, t as SECRET_PROVIDER_ALIAS_PATTERN } from "./ref-contract-BDz7f4XS.js";
...
const SecretProviderSchema = union([
	...
	object({ source: literal("store") }).strict()
]);
/** Schema for the top-level `secrets` config block. */
const SecretsConfigSchema = object({
	egressProxy: object({
		enabled: boolean().optional(),
		bypassHosts: array(string().trim().min(1)).max(256).optional()
	}).strict().optional(),
...
//#endregion
export { ToolsLinksSchema as A, requireAllowlistAllowFrom as B, ReplyToModeSchema as C, SecretsConfigSchema as D, SecretRefSchema as E, TtsProviderSchema as F, createAllowDenyChannelRulesSchema as H, TypingModeSchema as I, VisibleRepliesSchema as L, TtsAutoSchema as M, TtsConfigSchema as N, SsrFPolicyConfigSchema as O, TtsModeSchema as P, evaluateDmPolicyAllowFromDependency as R, ReplyRuntimeConfigSchemaShape as S, SecretProviderSchema as T, requireOpenAllowFrom as V, MentionPatternsPolicySchema as _, ContextVisibilityModeSchema as a, ProviderCommandsSchema as b, ExecutableTokenSchema as c, HexColorSchema as d, HumanDelaySchema as f, MarkdownConfigSchema as g, MSTeamsReplyStyleSchema as h, ChannelStreamingBlockSchema as i, ToolsMediaSchema as j, TextChunkModeSchema as k, GroupChatSchema as l, InboundDebounceSchema as m, BlockStreamingCoalesceSchema as n, DmConfigSchema as o, IdentitySchema as p, ChannelDeliveryStreamingConfigSchema as r, DmPolicySchema as s, BlockStreamingChunkSchema as t, GroupPolicySchema as u, ModelsConfigSchema as v, SecretInputSchema as w, QueueSchema as x, NativeCommandsSettingSchema as y, isBuiltInModelProviderOverlayId as z };
