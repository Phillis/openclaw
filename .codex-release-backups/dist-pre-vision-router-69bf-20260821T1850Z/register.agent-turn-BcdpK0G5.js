...
async function loadAgentCliCommand() {
	return (await import("./agent-via-gateway-BmZxXmLI.js")).agentCliCommand;
}
async function loadAgentExecCommand() {
	return (await import("./agent-exec-B75MNFjc.js")).agentExecCommand;
}
...
async function loadRunCommandWithRuntime() {
	return (await import("./cli-utils-S0yO3GXc.js")).runCommandWithRuntime;
}
