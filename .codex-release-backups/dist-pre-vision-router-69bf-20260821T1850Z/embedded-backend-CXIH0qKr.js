...
import { r as getRuntimeConfig, v as registerConfigWriteListener } from "./io-BTBpQ7uO.js";
import { r as buildConfiguredModelCatalog } from "./model-selection-shared-0DI3vxkL.js";
...
import { yt as applySessionPatchProjection } from "./session-accessor-CIiPoGwM.js";
import "./message-channel-C3nRvjrX.js";
import { G as setEmbeddedPluginApprovalBroker, U as EmbeddedPluginApprovalBroker, W as clearEmbeddedPluginApprovalBroker, q as setEmbeddedMode } from "./agent-tools.before-tool-call-rUQaaAPY.js";
...
import { u as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-BK-D17bD.js";
import { n as resolveThinkingDefault } from "./model-thinking-default-B1YtMmAp.js";
import { t as buildAllowedModelSet } from "./model-selection-BEGvRdL1.js";
import { i as buildAgentRunTerminalOutcomeFromLifecycleEvent, o as classifyAgentRunTerminalOutcome, t as AGENT_RUN_TERMINAL_RETRY_GRACE_MS } from "./agent-run-terminal-outcome-CpRY9lPn.js";
...
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-CQbSP9aq.js";
...
import { E as loadGatewaySessionEntryReadOnly, N as resolveGatewaySessionStoreTargetWithStore, O as resolveCanonicalGatewaySessionStoreKey, T as loadGatewaySessionEntry, w as listAgentsForGateway } from "./session-utils-row-xwseApeF.js";
import { t as ensureContextWindowCacheLoaded } from "./context-GlVEvpHA.js";
import { t as resolveQueueSettingsCore } from "./settings-CrsEB2ti.js";
import { A as waitForQueueDebounce, D as previewQueueSummaryPrompt, S as buildCollectPrompt, b as applyQueueDropPolicy } from "./state-DyigdfFK.js";
import { i as buildGatewaySessionInfo, r as listSessionsFromStoreAsync } from "./session-utils-list-Df1cOTkb.js";
import "./session-utils-DvNvk7rk.js";
import { i as parseGoalCommand, t as executeSessionGoalCommand } from "./commands-goal-BOPtxYuO.js";
...
import { c as performGatewaySessionReset } from "./session-reset-service-CsEbZAnG.js";
...
import { u as resolveEffectiveChatHistoryMaxChars } from "./chat-display-projection-DP60qxuF.js";
import { a as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES, i as readChatHistoryPage, o as enforceChatHistoryFinalBudget, r as enrichChatHistoryCompactionMarkers, s as replaceOversizedChatHistoryMessages } from "./chat-Bn5KElyX.js";
import { o as isAgentLifecycleYieldedWaiting } from "./session-lifecycle-state-DjsZ6HLJ.js";
import { n as createGatewaySession } from "./session-create-service-BF3ohsrd.js";
...
import { u as formatTuiErrorMessage } from "./tui-formatters-ByaIXdNl.js";
...
var EmbeddedTuiBackend = class {
	...
	start() {
		...
		this.ready = (async () => {
			const { runSessionStartupMigration } = await import("./startup-migration-DCKlzqV-.js");
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-C2fMiV17.js");
