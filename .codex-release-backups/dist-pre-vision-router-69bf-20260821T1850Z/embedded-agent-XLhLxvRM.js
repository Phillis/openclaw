...
import { g as resolveSessionAgentIds, h as resolveSessionAgentId, m as resolveRunModelFallbacksOverride, r as hasConfiguredModelFallbacks } from "./agent-scope-D9GLFAyB.js";
...
import { c as resolveContextConfigProviderForRuntime, d as resolveSelectedOpenAIRuntimeProvider, i as isOpenAIProvider, n as OPENAI_PROVIDER_ID, y as normalizeOptionalAgentRuntimeId } from "./openai-routing-BC0q3X-J.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CdX9UGcX.js";
import { n as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-DciqS8td.js";
import { w as resolveDefaultModelForAgent } from "./codex-route-model-ref-WCq2iqcj.js";
import { l as providerModelRouteAcceptsAuthMode, s as modelMatchesProviderModelRoute, v as resolveProviderModelRoutes } from "./openai-model-routes-oiuFxnRn.js";
...
import { r as classifyRateLimitWindow, t as isReplayUnsafeAssistantError } from "./retry-BxyIWuMG.js";
...
import { O as isIncognitoOpenClawAgentSqlitePath } from "./openclaw-agent-db-maintenance-CAGHh5rr.js";
import { S as revokeRuntimeAuthMaterializations, b as recordRuntimeAuthMaterialization } from "./runtime-snapshots-CVpJCNdz.js";
import { r as resolveSubscriptionAuthModeForProfiles } from "./profile-list-C4c5_QKQ.js";
import { o as isProfileInCooldown } from "./usage-state-B_WYg1ed.js";
import { n as resolveProviderEndpoint } from "./provider-attribution-BWAd0qYt.js";
...
import { c as resolveContextEngine, l as resolveContextEngineOwnerPluginId } from "./registry-DBRW150B.js";
import { t as getGlobalHookRunner, x as withPluginRuntimeGenerationScope } from "./hook-runner-global-BgVsqem2.js";
...
import { K as updateSessionEntry, O as resolveSessionTranscriptRuntimeTarget, Pt as listSessionEntriesCore, Qt as loadSessionEntry, Y as appendTranscriptMessage, dt as deriveContextPromptTokens, gt as normalizeUsage } from "./session-accessor-CIiPoGwM.js";
import "./message-channel-normalize-BhvdDSLi.js";
import { o as isMarkdownCapableMessageChannel } from "./message-channel-C3nRvjrX.js";
...
import { p as resolveProviderRuntimePluginHandle, s as resolveProviderAuthProfileId, t as attachModelProviderRuntimePluginHandle } from "./provider-hook-runtime-Cl2YZAgZ.js";
...
import { a as markAuthProfileFailure, d as resolveProfilesUnavailableReason, o as markInlineProviderApiKeyFailure } from "./usage-Cj2wt9Ks.js";
import "./sessions-BHNzcBA2.js";
import { C as parseImageSizeError, S as parseImageDimensionError, b as isTimeoutErrorMessage, f as isGenericUnknownStreamErrorMessage, i as isFailoverErrorMessage, s as isLikelyContextOverflowError, t as classifyFailoverReason } from "./classify-kl1ByQTv.js";
import { l as hasOnlyAssistantReasoningContent } from "./ai-transport-runtime-host-B7O6W1a9.js";
...
import { n as acquireReadOnlyPreparedModelRuntime, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-BK-D17bD.js";
import { a as resolveCandidateThinkingLevel, l as resolveAgentHarnessPreparedAuthSupport, u as resolveAgentHarnessPreparedRouteSupport } from "./thinking-runtime-_QT_qncS.js";
import "./auth-profiles-TorfVJYv.js";
import { n as markAuthProfileSuccess } from "./profiles-CaIWIvwD.js";
import { s as isConfigBackedInlineProviderApiKey } from "./model-auth-provider-config-CwVoY8Rs.js";
import { i as getApiKeyForModelCore, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-BgXCiN_L.js";
...
import { c as resolvePreparedRunAdmission } from "./admitted-run-context-Dl2hrF3z.js";
import { a as describeFailoverError, f as resolveFailoverReasonFromError, i as coerceToFailoverError, p as resolveFailoverStatus, t as FailoverError } from "./failover-error-DKFCUqL9.js";
import { u as projectAgentRunAttemptTerminal } from "./agent-run-terminal-outcome-CpRY9lPn.js";
import { s as createAgentRunDirectAbortError } from "./run-termination-0Y8XLbCX.js";
import { m as renderAuthProfileFailoverCopy, o as formatBillingErrorMessage } from "./user-copy-BKvImQfV.js";
...
import { l as retireSessionMcpRuntime, u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-manager-api-gNVONHel.js";
import "./agent-bundle-mcp-tools-DaBvOF2o.js";
import { t as log$3 } from "./logger-BQ2aebRn.js";
import { d as waitForDeferredTurnMaintenanceForSession, f as buildContextEngineRuntimeSettings, u as runContextEngineMaintenance } from "./agent-end-side-effects-DMC4yDyW.js";
import { n as resolveSandboxContext } from "./context-BwBSG27A.js";
import { l as truncateOversizedToolResultsInActiveTarget, s as sessionLikelyHasOversizedToolResults } from "./transcript-visibility-DxlroY1R.js";
import { o as runAgentCleanupStep, r as resolveSettledTurnFinalizationText } from "./settled-turn-finalization-result-DJ-XWS4f.js";
...
import { b as listActiveProcessSessionReferences, f as resolveContextEngineCapabilities, m as resolveCompactionContextTokenBudget, p as buildEmbeddedCompactionRuntimeContext, r as forgetPromptBuildDrainCacheForRun } from "./attempt-prompt-helpers-BpBK0j0i.js";
import { t as resolveProcessToolScopeKey } from "./bash-process-scope-Bmw8_ghL.js";
import { n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-3_FyKq21.js";
import { E as settleRequesterAfterSessionSpawns } from "./subagent-registry-DvDWUQio.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-9Zisrbl5.js";
import { t as ensureContextEnginesInitialized } from "./init-CR650dZ_.js";
import { h as hasOutboundDeliveryEvidence, m as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-CEFyQPkI.js";
...
import { t as createTrajectoryRuntimeRecorder } from "./runtime-B5IU_DLH.js";
import { _ as buildApiErrorObservationFields, y as shouldSuppressRawErrorConsoleSuffix } from "./model-fallback-attempt-pgsVkuvs.js";
import { n as resolveDelegationCapability } from "./agent-tools-kro5rXpZ.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-BebVSdcS.js";
import { n as shouldUseTransientCooldownProbeSlot, r as LiveSessionModelSwitchError } from "./model-fallback-runner-BswjSwzJ.js";
import { a as resolveSessionKeyForRequestCore, o as resolveStoredSessionKeyForSessionId } from "./session-ChRzjWPw.js";
import { i as resolveSessionSuspensionTarget, o as suspendSession, r as resolveSessionSuspensionReason } from "./session-suspension-Cy8QugFr.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-CVttd5qX.js";
import { r as resolveModelAsync, t as createEmptyAgentDiscoveryStores } from "./model-D2zXW9cg.js";
import { t as materializePreparedRuntimeModel } from "./materialize-model-DBvajuYm.js";
import { a as selectContextEngineForTranscriptHost, i as createContextEngineLogicalTurnLease, n as drainPendingContextEngineTurnsBeforeRun } from "./context-engine-turn-attempt-C6RpEFvT.js";
import { c as selectAgentHarness, l as selectAgentHarnessForPreparedModelProviders, o as runAgentHarnessAttempt, s as runAgentHarnessSettledTurnFinalization, t as agentHarnessBuildsOpenClawTools } from "./selection-CtvFZtyB.js";
import { n as readChannelSourceTurnId, r as readChannelSourceTurnSameThreadRequired } from "./source-turn-id-BDtD1rRG.js";
import { n as buildAgentRuntimePlan } from "./build-dJUgCgCl.js";
import { i as mergeAttemptToolMediaPayloads, r as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-BKx9pkp7.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-CxclmIgX.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-Dk4wJMnC.js";
import { n as maybeCompactAgentHarnessSession, r as isRecoverableNativeHarnessBindingFailure, t as resolveContextEngineCompactionSuccessor } from "./compaction-successor-Dqzw9SPm.js";
import { i as resolveCredentialScopedAuthAttemptModelDecision, n as hasPreparedAuthAttemptModelMetadata, r as providerUsesCredentialScopedModelMetadata, t as createPreparedRuntimeModelMaterializer } from "./credential-scoped-model-OfxXjdwp.js";
...
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-CuG-X59K.js";
import { r as stripOpenClawMcpToolPrefix } from "./tool-policy-DbdtO-eX.js";
import { a as resizeExecApprovalContinuationPrompt } from "./bash-tools.exec-approval-output-hi2p5PU0.js";
import { a as resolveHookModelSelection, i as resolveEmbeddedRuntimeModelPolicy, n as createNativeModelOwnedRuntimeModel, o as resolveNativeModelOwnedHarnessId, r as resolveAgentHarnessRunAdmissionError, t as buildBeforeModelResolveAttachments } from "./setup-DNH-OYeh.js";
...
async function retireDispatchSessionMcpRuntime(params) {
	try {
		const { retireSessionMcpRuntime, retireSessionMcpRuntimeForSessionKey } = await import("./agent-bundle-mcp-tools-fF1ykLiU.js");
