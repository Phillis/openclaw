...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-CsGtVozU.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-TH9aGxK5.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-D0o6HKXA.js"),
		...
		},
		{
			...
			loadModule: () => import("./capability-cli-CcJCvhoo.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["worker"],
			loadModule: () => import("./worker-cli-P0KCtTVy.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-CeNQ_iRC.js"),
			exportName: "registerTuiCli"
		},
		{
			commandNames: ["resume"],
			loadModule: () => import("./resume-cli-l_KjrD8a.js"),
	...
	},
	{
		...
		register: async (program, argv) => {
			await registerSubCliWithPluginCommands(program, argv, async () => {
				(await import("./plugins-cli-D473EcEB.js")).registerPluginsCli(program);
			}, "after");
		}
	},
	{
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-n2UTwL4U.js"),
