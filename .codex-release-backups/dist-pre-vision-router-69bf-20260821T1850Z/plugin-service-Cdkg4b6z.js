...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-B0dHmNry.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-C9uojgUV.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-DVVmU-39.js");
