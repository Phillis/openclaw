...
import { _ as readToolStringParam, i as createActionGate, p as readPositiveIntegerParam, t as ToolAuthorizationError } from "./common-ciEJghJz.js";
...
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-DY4XI1qs.js";
import { a as splitChannelApprovalCapability, i as createChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-BZKMCy5J.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CRFbyFxI.js";
...
import { I as projectAccountConfigWarningCollector, h as resolveScopeToolsPolicy, k as createAllowlistProviderOpenWarningCollector, m as resolveScopeRequireMention } from "./channel-policy-Dn6aXK3G.js";
...
import { t as matrixPluginBase } from "./channel.setup-YDZ_tufK.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-DS7Nxbe0.js";
import { r as resolveMatrixRoomScopePath, t as buildMatrixRoomScopeTree } from "./rooms-BseU_JDa.js";
...
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Cmxtfwjt.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-CT4Q7kBX.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-HDELT1fc.js"), "matrixChannelRuntime");
const loadMatrixDoctorModule = createLazyRuntimeModule(() => import("./doctor-gsepIpzd.js"));
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-DdLAW_0d.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
