...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-CbBrXkzY.js";
import { D as parseBrowserErrorPayload, X as withTimeout } from "./tmp-openclaw-dir-BdU80KeH.js";
import "./control-auth-9psCUf_u.js";
import "./chrome-BuKzHtxc.js";
import "./trash-CUoVhznV.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-DcOhxcxT.js";
import "./sdk-setup-tools-BVECsAnW.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-BIXp-_dN.js";
import "./routes-avGEML7B.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-BjFeXFZj.js";
import { s as stopBrowserBridgeRuntime, t as createBrowserControlContext } from "./browser-control-state-DKfVSiow.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-Bcbf2iio.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-J5io1CUk.js"), import("./routes-BvMdDlgg.js")]);
