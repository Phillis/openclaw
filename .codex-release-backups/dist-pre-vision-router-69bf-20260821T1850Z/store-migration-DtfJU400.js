...
import { c as parseAgentSessionKey, d as parseSessionDeliveryRoute } from "./session-key-utils-D8x_bjrd.js";
import { r as normalizeOptionalAccountId } from "./account-id-BRqK6RmF.js";
import { At as boolean } from "./schemas-C7gqXY2T.js";
import { a as isBlockedLegacyCodexModelRef, x as toCanonicalOpenAIModelRef } from "./codex-route-model-ref-WCq2iqcj.js";
import { a as migrateLegacyTaskSuggestionToolList, i as hasLegacyTaskSuggestionToolList } from "./legacy-tool-name-migration-B58w1I1P.js";
import { F as createAccountCronScheduledToolPolicy, G as parseOptionalField, H as DeliveryThreadIdFieldSchema, L as normalizeCronScheduledToolPolicy, M as inferCronJobName, R as resolveCronScheduledToolPolicy, U as LowercaseNonEmptyStringFieldSchema, W as TrimmedNonEmptyStringFieldSchema, g as getInvalidPersistedCronJobReason, z as coerceFiniteScheduleNumber } from "./row-codec-RY4IJt5w.js";
...
import { i as syncDirectoryIfSupported } from "./directory-durability-R1AgUCPm.js";
...
function migrateLegacyCronPayload(payload, options = {}) {
	let mutated = false;
	if (migrateLegacyTaskSuggestionToolList(payload.toolsAllow)) mutated = true;
...
function normalizeStoredCronJobs(jobs, options = {}) {
	...
	for (const [sourceIndex, raw] of jobs.entries()) {
		...
		if (payloadRecord) {
			...
			const hadLegacyTaskSuggestionToolName = hasLegacyTaskSuggestionToolList(payloadRecord.toolsAllow);
