...
import { a as parseSystemAgentOperation, i as isPersistentSystemAgentOperation, t as executeSystemAgentOperation } from "../operations-XBlhHXtv.js";
...
import { n as resolveSystemAgentOperation } from "../dialogue-Cyo44s8o.js";
...
async function runSystemAgent(opts, runtime = defaultRuntime) {
	...
	const runInteractiveTui = boundOpts.runInteractiveTui ?? (await import("../tui-backend-T74hhfE-.js")).runSystemAgentTui;
	boundOpts.onReady?.();
