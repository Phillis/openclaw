...
import { c as resolveOAuthTokenExpiresAt, l as resolveOAuthTokenLifetimeMs, u as throwIfOAuthLoginAborted } from "./provider-oauth-runtime-CEcopjYd.js";
...
async function readOpenAITokenResponse(response, operation) {
	if (!response.ok) {
