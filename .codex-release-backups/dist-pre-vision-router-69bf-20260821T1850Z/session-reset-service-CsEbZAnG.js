...
import { a as listAgentIds, b as tryResolveLegacyCompatibilityAgentId, d as resolveAgentWorkspaceDir, p as resolveDefaultAgentId } from "./agent-scope-config-CsnnOL14.js";
...
import { _n as sessionEntryForkedFromParent, ct as rebindCliSessionReseedReceiptsForReset, gn as buildSessionCreationStamp, it as clearAllCliSessions } from "./session-accessor-CIiPoGwM.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { n as deleteSessionEntryLifecycle, r as resetSessionEntryLifecycle } from "./session-accessor.sqlite-lifecycle-BFaW8ajj.js";
import { G as hasOnlySessionLifecycleMutationKindActive, J as isSessionLifecycleMutationActive, K as interruptSessionWorkAdmissions, R as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS, X as runExclusiveSessionLifecycleMutation, m as resolveMissingAgentHarnessSessionError } from "./agent-harness-session-key-BpWapmwX.js";
import { s as errorShape } from "./error-codes-CMSvT5-d.js";
import { t as getAcpSessionManager } from "./manager-ROoWPv7n.js";
import { a as handleSessionStateSessionDeleted, o as handleSessionStateSessionReset, u as recordSessionCreated } from "./session-state-events-DTKQ6kKc.js";
import { t as getSessionBindingService } from "./session-binding-service-Dk6st5wa.js";
import { t as getAcpRuntimeBackend } from "./registry-_hZm0hSC.js";
import { c as writeAcpSessionMetaForMigration, r as readAcpSessionMeta, s as upsertAcpSessionMeta } from "./session-meta-8cwXEOoU.js";
...
import { r as archiveSessionTranscriptsDetailed, s as resolveStableSessionEndTranscript } from "./session-transcript-files.fs-oqmavapF.js";
import { a as resolveSessionModelRef } from "./placement-session-runtime-D3R4yOqT.js";
import { M as resolveGatewaySessionStoreTarget, T as loadGatewaySessionEntry } from "./session-utils-row-xwseApeF.js";
...
import { n as clearBootstrapSnapshotOnSessionBoundary, t as clearBootstrapSnapshot } from "./bootstrap-cache-VAZT9_yH.js";
...
import { s as managedWorktrees } from "./service-BcZ9HgDx.js";
import { r as stopSubagentsForRequester } from "./abort-CVwj5Qpb.js";
...
import { n as hasSessionAutoResetListeners, r as isSessionAutoResetReason, t as emitSessionAutoResetHook } from "./session-auto-reset-XPNs4mSk.js";
import { n as runPluginHostCleanup } from "./host-hook-cleanup-DQmWarAZ.js";
...
async function ensureSessionRuntimeCleanup(params) {
	const [embeddedAgent, mcpTools, { clearFinishedSessionsForScopes }] = await Promise.all([
		import("./embedded-agent-BaC-L2QF.js"),
		import("./agent-bundle-mcp-tools-fF1ykLiU.js"),
		import("./bash-process-registry-DQqTbDqc.js")
	]);
...
async function performGatewaySessionReset(params) {
	...
	const workerPlacementContext = params.workerPlacementContext ?? (await import("./session-worker-placement-context-B9svu87p.js")).resolveSessionWorkerPlacementContext();
