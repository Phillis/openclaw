...
import { u as readConnectErrorDetailCode } from "./connect-error-details-Do3cAiyu.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-B1nULpha.js";
import { i as isApprovalMethod } from "./method-scopes-CEKLLcTa.js";
...
import { n as createApprovalNativeRouteReporter } from "./approval-native-route-coordinator-Xn23Zs0h.js";
import { t as buildChannelApprovalNativeTargetKey } from "./approval-native-target-key-xnWMm3an.js";
import { t as classifyApprovalRequestChannelRoute } from "./approval-request-account-binding-BbV7ZcKh.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = (gatewayRuntime?.routeCoordinator.createReporter ?? createApprovalNativeRouteReporter)({
		...
		requestGateway: async (method, params) => {
			...
			const { callGatewayLeastPrivilege } = await import("./call-DrR5WyUw.js");
