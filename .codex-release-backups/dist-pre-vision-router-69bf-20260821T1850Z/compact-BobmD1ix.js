...
import { _ as sessionBindingIdentity, t as CODEX_APP_SERVER_BINDING_GUARDED_REQUEST_TIMEOUT_MS } from "./session-binding-CuZlPg0f.js";
import { U as consumeCodexAppServerLiveThread, V as CodexAppServerRpcError, Y as retainCodexAppServerLiveThread, d as releaseLeasedSharedCodexAppServerClient, s as getLeasedSharedCodexAppServerClient, ut as isJsonObject } from "./shared-client-B5mi5IxU.js";
import { o as createDeferred } from "./extension-shared-D4oakjAV.js";
import { _ as readCodexNotificationTurnId, a as closeCodexStartupClientBestEffort, d as unsubscribeCodexThreadBestEffort, g as readCodexNotificationThreadId, r as CodexAppServerUnsafeSubscriptionError, s as isCodexAlreadyTerminalInterruptError } from "./attempt-client-cleanup-o--1yVH9.js";
import { i as readCodexThreadContextSnapshot, x as readCodexNotificationItem } from "./event-projector-usage-B5wIXWXR.js";
...
import { t as isSameCodexAppServerThreadOwner } from "./thread-ownership-BnOcmGVS.js";
	...
	try {
		return await runExclusiveCodexNativeCompaction(binding.threadId, params.abortSignal, async () => {
			...
			try {
				...
				if (options.allowNonManualNativeRequest && isCodexActiveWriterError(error)) return skippedCodexNativeCompactionResult(params, {
...
function isCodexActiveWriterError(error) {
	return error instanceof CodexAppServerRpcError && coerceErrorMessage(error).toLowerCase().includes("already has an active writer");
}
//#endregion
