...
import { a as getActiveSecretsRuntimeConfigSnapshot, o as getActiveSecretsRuntimeEnvState } from "./runtime-state-CR1A1dve.js";
import { s as getPairedDevice } from "./device-pairing-CobL1ZXN.js";
import { i as createDeviceWorkerRuntime, n as bindDeviceWorkerAvailability, r as bindDeviceWorkerReconciliation, t as DEVICE_WORKER_PROVIDER_ID } from "./device-provider-r5BsRUuF.js";
...
const loadWorkerInferenceRuntimeModule = createLazyRuntimeModule(() => import("./inference-runtime-CnH5Feer.js"));
async function loadGatewayWorkerEnvironmentStartupState() {
	const [{ createWorkerEnvironmentStore }, { createWorkerSessionPlacementStore }] = await Promise.all([import("./store-BKbm2z24.js"), import("./placement-store-DuuZip9G.js")]);
...
async function createGatewayWorkerEnvironmentRuntime(params) {
	...
	const [{ createWorkerEnvironmentService }, { createWorkerLiveEventReceiver }, { createWorkerSessionPlacementGate }, { createWorkerTranscriptCommitter }, { createWorkerTunnelManager }, { createNodeWorkerTunnelManager }, { createNodeWorkspaceTransferService }, { createNodeWorkspaceTransferHttpCallback }, { createWorkerSessionToolExecutor }, { resolveWorkerProvider }] = await Promise.all([
		import("./service-gY3d4Efb.js"),
		import("./live-events-B2nicuIH.js"),
		import("./placement-worker-gate-DsHLmvor.js"),
		import("./transcript-commit-DIwEUmWm.js"),
		import("./tunnel-Dnnt7BV5.js"),
		import("./node-worker-tunnel-DrbG5oqB.js"),
		import("./node-workspace-transfer-service-Bk0nSk18.js"),
		import("./node-workspace-transfer-http-oy_diqX-.js"),
		import("./worker-session-tool-executor-DY_XHCFO.js"),
