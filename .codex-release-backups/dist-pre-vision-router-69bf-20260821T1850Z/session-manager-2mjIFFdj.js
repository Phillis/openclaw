...
import { J as appendTranscriptEventSync, Q as replaceTranscriptEventsSync, Qt as loadSessionEntry, Ut as ensureSessionEntrySync, X as appendTranscriptMessageSync, an as replaceSessionEntrySync, rt as readActiveTranscriptEntryAnchor, tt as withTranscriptWriteTransaction } from "./session-accessor-CIiPoGwM.js";
import { n as projectCanonicalSessionEntryShape } from "./store-entry-shape-CnAfxmHQ.js";
import { _ as isSessionTranscriptSideAppendEntry } from "./session-transcript-index-B7GQuTh4.js";
import { x as loadTranscriptEventsSync } from "./session-accessor.sqlite-transcript-store-Cgnm_AHf.js";
import { O as buildSessionContext } from "./agent-core-BNJRSUk4.js";
import { f as partitionSessionFileEntries, i as isSessionContextMetadataEntry, l as parseOpaqueLeafEntry, m as generateSessionEntryId, p as createManagedSessionId, r as isIndexedSessionEntry, s as migrateToCurrentVersion, u as parseParentLinkedOpaqueEntry } from "./session-manager-codec-CBbtVKV-.js";
