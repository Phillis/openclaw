...
import { d as resolveMemorySlotDecision } from "./config-state-DLiU5GYQ.js";
...
function resolvePluginSkillDirs(params) {
	...
	if (canMemoize && pluginSkillDirsMemo && pluginSkillDirsMemo.workspaceDir === workspaceDir && pluginSkillDirsMemo.config === params.config && pluginSkillDirsMemo.snapshot === metadataSnapshot && pluginSkillDirsMemo.acpRuntimeAvailable === acpRuntimeAvailable) return pluginSkillDirsMemo.dirs;
	...
	if (canMemoize) pluginSkillDirsMemo = {
		workspaceDir,
