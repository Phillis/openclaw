...
import { c as isForbiddenBrowserProxyMutation } from "./method-scopes-CEKLLcTa.js";
...
import { l as replaceRemoteNodeSkills } from "./workspace-skill-loader-BuJvE2pz.js";
import { a as isForegroundRestrictedPluginNodeCommand, c as normalizeDeclaredNodeCommands, l as resolveNodeCommandAllowlist, o as isNodeCommandAllowed, t as DEFAULT_DANGEROUS_NODE_COMMANDS, u as resolveNodePairingCommandAllowlist } from "./node-command-policy-CcECn3d6.js";
import { r as parseNodeRunnerInventoryDeclaration } from "./node-runner-inventory-CvaqnZf8.js";
import { a as isNodeRunnerSessionHost, l as updateNodeRunnerInventory } from "./node-registry-private-BEIBFAdy.js";
import { _ as removePairedDeviceRole, d as listDevicePairing, s as getPairedDevice, u as listApprovedPairedDeviceRoles, x as resolveNodePairingState } from "./device-pairing-CobL1ZXN.js";
import { a as listNodePairing, d as renamePairedNode, i as getPendingNodePairing, l as rejectNodePairing, o as projectNodePairing, t as approveNodePairing } from "./device-pairing-node-CIHQQGFC.js";
...
import { i as respondUnavailableOnThrow, r as respondUnavailableOnNodeInvokeErrorWithProvenance, t as respondInvalidParams } from "./nodes.helpers-C2lNZvIh.js";
...
import { t as EXEC_APPROVAL_RESOLVED_ENTRY_GRACE_MS } from "./exec-approval-manager-Et-kAbgT.js";
import { a as removePendingNodeAction, i as listPendingNodeActions, n as clearRemovedNodeRuntimeState, o as replacePendingNodeActionsForGeneration, r as enqueuePendingNodeAction, s as reconcileRevokedDeviceWorker, t as acknowledgePendingNodeActions } from "./node-runtime-state-wCDwMHq6.js";
...
import { n as getKnownNode, r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-DyM4oV1e.js";
import { i as isNodePairingGenerationCurrent, n as captureNodePairingGeneration, r as captureNodePairingState } from "./device-pairing-node-state-DbmGP3Gb.js";
import { a as resolveDispatchableNodeSession, i as isNodePairingWorkCurrent, n as maybeWakeNodeWithApns, o as respondPairingChanged, r as waitForNodeReconnect, s as nodeInvokePolicy, t as maybeSendNodeWakeNudge } from "./nodes.wake-CWycyg2E.js";
import { t as applyPluginNodeInvokePolicy } from "./node-invoke-plugin-policy-DRCj3vFE.js";
...
const nodeEventHandlers = { "node.event": async ({ params, respond, context, client }) => {
	...
	await respondUnavailableOnThrow(respond, async () => {
		...
		const { handleNodeEvent } = await import("./server-node-events-BOQ6VbrA.js");
