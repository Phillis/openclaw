...
//#region ../../../../../../openclaw/node_modules/@openclaw/fs-safe/dist/path.js
...
function splitSafeRelativePath(relativePath) {
	...
	for (const segment of segments) {
		if (segment === "..") throw new FsSafeError("invalid-path", "relative path must not contain '..'");
		if (isDriveRelativePath(segment)) throw new FsSafeError("invalid-path", "relative path must not contain a drive letter");
	}
	return segments;
}
...
//#endregion
export { isPathInside as a, isSymlinkOpenError as c, resolveSafeBaseDir as d, resolveSafeRelativePath as f, isNotFoundPathError as i, isWithinDir as l, safeStatSync as m, hasNodeErrorCode as n, isPathInsideWithRealpath as o, safeRealpathSync as p, isNodeError as r, isPathRelativeEscape as s, assertNoNulPathInput as t, normalizeWindowsPathForComparison as u };
