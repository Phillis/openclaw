...
import { i as redactSecrets, u as redactToolPayloadText } from "./redact-DP7p9QfH.js";
...
import { $t as loadSessionEntryReadOnly, D as resolveSessionTranscriptReadTarget, Pt as listSessionEntriesCore, Qt as loadSessionEntry } from "./session-accessor-CIiPoGwM.js";
import { n as parseSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { h as isCanonicalSessionTranscriptEntry, x as scanSessionTranscriptTree } from "./session-transcript-index-B7GQuTh4.js";
import { y as loadTranscriptEvents } from "./session-accessor.sqlite-transcript-store-Cgnm_AHf.js";
import { a as resolveTrajectoryFilePath, i as TRAJECTORY_RUNTIME_FILE_MAX_BYTES, o as resolveTrajectoryPointerFilePath, s as safeTrajectorySessionFileName, t as TRAJECTORY_POINTER_FILE_MAX_BYTES } from "./paths-ltudAIXV.js";
import { i as hasMeaningfulRetiredMediaCarrier, t as PERSISTED_LEGACY_MEDIA_KEYS } from "./media-facts-CdKKNGmE.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-9Zisrbl5.js";
import { n as redactSupportString } from "./diagnostic-support-redaction-BToLeDrA.js";
...
import { r as loadSqliteTrajectoryRuntimeEvents } from "./runtime-store.sqlite-CXvbDTBt.js";
import { a as writeSupportBundleDirectory, i as textSupportBundleFile, n as jsonlSupportBundleFile, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-gmKqCy6R.js";
...
async function exportTrajectoryCommand(opts, runtime) {
	...
	const storePath = resolvedOpts.store ? resolveSessionStorePathCore(resolvedOpts.store, { agentId: targetAgentId }) : resolveSessionStorePathCore(getRuntimeConfig().session?.store, { agentId: targetAgentId });
