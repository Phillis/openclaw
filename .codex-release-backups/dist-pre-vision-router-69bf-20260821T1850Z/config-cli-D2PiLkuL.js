...
import { i as readFileDescriptorBoundedSync } from "./boundary-file-read-Dy4MeTWa.js";
import { f as resolveConfigPath, t as CONFIG_PATH } from "./paths-CqeDjSA4.js";
import "./errors-CqPTYU6G.js";
import { t as formatCliCommand } from "./command-format-Dr_cCOb_.js";
import { a as writeRuntimeJson, o as writeRuntimeStdout, r as defaultRuntime, t as ExitError } from "./runtime-DtFIMC-W.js";
import { H as isConfigSetJsonParseOnly, V as isConfigMachineOutput } from "./argv-ubyZhwcH.js";
...
import { c as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-D9GLFAyB.js";
import { n as normalizeAgentId } from "./agent-id-Db0rqw_J.js";
import { b as tryResolveLegacyCompatibilityAgentId, i as listAgentEntriesWithSource, n as hasAgentRosterProperty, r as listAgentEntries } from "./agent-scope-config-CsnnOL14.js";
import { $ as AUTO_MANAGED_CONFIG_META_PATHS, I as collectUnsupportedSecretRefPolicyIssues, M as validateConfigObjectRawWithPlugins, l as readConfigFileSnapshot } from "./io-BTBpQ7uO.js";
import { d as isSecretRef, p as isValidEnvSecretRefId, s as coerceSecretRef, v as resolveSecretInputRef } from "./types.secrets-BrIfhxSG.js";
import { a as isValidFileSecretRefId, i as isValidExecSecretRefId, l as secretRefKey, o as isValidSecretProviderAlias, r as formatExecSecretRefIdValidationMessage, u as validateExecSecretRefId } from "./ref-contract-BDz7f4XS.js";
import { T as SecretProviderSchema } from "./zod-schema.core-D1Ak_xoR.js";
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-0DI3vxkL.js";
...
import { i as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-wyiFLwqS.js";
...
import { a as isPluginIntegrationSecretProviderConfig, n as resolveSecretRefValue, s as resolveSecretProviderIntegrationConfig } from "./resolve-BYdc1LUh.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-query-DrkDbq93.js";
import "./target-registry-RlAyK6k0.js";
import { a as success, n as info, o as warn, t as danger } from "./globals-DD_xHyf6.js";
...
import { a as parseConfigSetPath, c as unsetAtPath, i as mergeAtPath, l as validatePathSegments, n as formatConfigUnsetMissingPathMessage, o as parseConfigSetValue, r as getAtPath, s as setAtPath, t as assertNonDestructiveReplacement } from "./config-cli-path-DUkpyN_X.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-DGk3Q_7x.js";
import { t as normalizeSubmittedConfigModelRefs } from "./model-input-normalization-C0fnhOg3.js";
...
async function createRuntimeModelRefResolver() {
	const [agentScope, modelSelection] = await Promise.all([import("./agent-scope-DHmCBvSP.js"), import("./model-selection-oGawnPze.js")]);
	const preparedByAgent = /* @__PURE__ */ new Map();
	let modelModules;
	const loadModelModules = () => modelModules ??= Promise.all([import("./model-D3tTUTet.js"), import("./prepared-model-catalog-BnhcKv7r.js")]);
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", collectOption, []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-CVTt4Qqf.js");
