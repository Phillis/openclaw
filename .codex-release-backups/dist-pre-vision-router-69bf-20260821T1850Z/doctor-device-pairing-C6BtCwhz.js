...
import { i as loadDeviceAuthTokens } from "./device-auth-store-0WfM7nPT.js";
...
import { d as listDevicePairing, u as listApprovedPairedDeviceRoles, w as summarizeDeviceTokens } from "./device-pairing-CobL1ZXN.js";
...
async function collectLegacyPairingStoreIssues(cfg) {
	...
	const { listLegacyDevicePairingStoreFiles } = await import("./device-pairing-migration-KBdDS0rQ.js");
