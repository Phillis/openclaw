import { f as AgentToolResult, p as AgentToolUpdateCallback } from "../types-DKu1Bc4Q.js";
import { s as ToolDefinition } from "../index-CWn3BSZs.js";
import { a as TaskSuggestionDeliveryMode } from "../types-CoqV37wL.js";
import { bt as ChatType, i as McpCodexToolApprovalMode, n as OpenClawConfig, st as GroupToolPolicyConfig } from "../types.openclaw-6A5yUI1l.js";
import { g as SourceReplyDeliveryMode } from "../types-B4JofTdW.js";
import { p as PluginHookChannelContext, v as InboundEventKind } from "../templating-BuWYzhE5.js";
...
import { Cr as SkillWorkshopRunOptions, Dr as HookContext, Jt as ProcessToolDefaults, Or as ToolOutcomeObserver, R as ConversationRecallContext, Sr as OperationalRunInstanceRef, U as ModelAuthMode, br as McpCodexToolAnnotations, gt as PreparedModelRuntimeSnapshot, m as DelegationCapability, vr as SystemAgentOperation, z as ExecToolDefaults } from "../types-BJ8oTDFw.js";
import { J as DiagnosticTraceContext } from "../hook-types-CQwktOys.js";
import { n as SandboxContext, x as SkillUsagePath, y as SkillSnapshot } from "../types-CFMORVYf2.js";
import { a as CronToolOptions, d as TrustedSubagentCompletionHandoff, f as ScheduledToolPolicyContext, i as CronCreatorToolAllowlistEntry, o as CronToolsAllowCaptureRef, p as AnyAgentTool } from "../cron-creator-authority-context-B5YdJRpm.js";
import { n as ResolvedConversationCapabilityProfile } from "../bundle-mcp-fjshgza9.js";
