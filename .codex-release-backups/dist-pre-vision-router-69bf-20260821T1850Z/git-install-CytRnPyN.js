...
import { i as guardedRename, o as guardedRm } from "./pinned-write-CKWgTqHs.js";
...
import { i as resolveDefaultPluginGitDir } from "./install-paths-Bp_9OgEZ.js";
...
import { a as createSafeNpmInstallArgs, i as resolvePackageDirInstallTransaction, o as createSafeNpmInstallEnv, r as requestDeferredPackageDirInstall, t as installPackageDir } from "./install-package-dir-C42XyOJV.js";
import { n as preflightPluginGitInstallPolicy } from "./install-security-scan-Brwt1Q29.js";
import { I as emitPluginAuditSecurityEvent, L as emitPluginInstallSecurityEvent, R as pluginAuditOutcomeForReason, U as isPluginInstallCommitDeferred, V as attachPluginInstallTransaction, z as PLUGIN_INSTALL_ERROR_CODE } from "./install-managed-npm-state-BFhK_f1u.js";
import { a as installPluginFromInstalledPackageDir } from "./install-BtauIEia.js";
import { randomUUID } from "node:crypto";
import path from "node:path";
import fs from "node:fs/promises";
//#region ../../../../../../openclaw/node_modules/@openclaw/fs-safe/dist/replace-directory.js
...
async function replaceManagedGitRepo(params) {
	try {
		if (params.deferCommit) {
			const result = await installPackageDir(requestDeferredPackageDirInstall({
