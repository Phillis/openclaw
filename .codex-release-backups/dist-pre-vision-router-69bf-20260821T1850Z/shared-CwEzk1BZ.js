...
import { T as SANDBOX_STATE_DIR } from "./constants-CZ9HY-fp.js";
import { t as hashTextSha256 } from "./hash-DZK-8tRm.js";
import { o as resolveMaterializedSandboxSkillsWorkspaceDir } from "./workspace-mounts-CW0mGf0z.js";
...
function resolveSandboxScopeKey(scope, sessionKey, workspaceDir, agentId) {
...
function resolveSandboxWorkspaceLayoutPaths(params) {
	...
	const scopeKey = resolveSandboxScopeKey(params.cfg.scope, params.rawSessionKey, agentWorkspaceDir, params.agentId);
