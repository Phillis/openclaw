...
import { n as matrixSetupAdapter } from "./setup-core-Cf9WEYsc.js";
import { t as withResolvedActionClient } from "./client-DY3EJ45l.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-WQaT2W0h.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-BUoMXI4_.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-DvS0Ztr0.js"));
