...
const CORE_GATEWAY_HANDLER_MODULES = {
	agent: () => import("./agent-CW5ScNVv.js").then((module) => module.agentHandlers),
	...
	artifacts: () => import("./artifacts-oHYwGxlg.js").then((module) => module.artifactsHandlers),
	board: () => import("./board-CUq5qtq8.js").then((module) => module.boardHandlers),
	...
	attach: () => import("./attach-BwIYfkU3.js").then((module) => module.attachHandlers),
	...
	chat: () => import("./chat-NhqIUooi.js").then((module) => module.chatHandlers),
	commands: () => import("./commands-DA2ZD_1o.js").then((module) => module.commandsHandlers),
	config: () => import("./config-3au8ItQg.js").then((module) => module.configHandlers),
	...
	health: () => import("./health-UVXtXdIo.js").then((module) => module.healthHandlers),
	...
	"models-probe": () => import("./models-probe-CTWCJS6g.js").then((module) => module.modelsProbeHandlers),
	...
	nodes: () => import("./nodes-s_GDuCvG.js").then((module) => module.nodeHandlers),
	...
	restart: () => import("./restart-BQ4hNXA4.js").then((module) => module.restartHandlers),
	suspend: () => import("./suspend-acOjMGsY.js").then((module) => module.suspendHandlers),
	...
	"sessions-abort": () => import("./sessions-abort-C9JJEdNB.js").then((module) => module.sessionAbortHandlers),
	"sessions-compact": () => import("./sessions-compact-DRtlQz5F.js").then((module) => module.sessionCompactHandlers),
	"sessions-compaction-checkpoints": () => import("./sessions-compaction-checkpoints-CCSZCnMe.js").then((module) => module.sessionCheckpointHandlers),
	"sessions-compaction-queries": () => import("./sessions-compaction-queries-N9ewZrA3.js").then((module) => module.sessionCheckpointQueryHandlers),
	"sessions-create": () => import("./sessions-create-C1l_uQ6I.js").then((module) => module.sessionCreateHandlers),
	"sessions-recover": () => import("./sessions-recover-BoPnWq0f.js").then((module) => module.sessionRecoverHandlers),
	"sessions-delete": () => import("./sessions-delete-B0uhfkqK.js").then((module) => module.sessionDeleteHandlers),
	"sessions-dispatch": () => import("./sessions-dispatch-CK4Y8vS3.js").then((module) => module.sessionDispatchHandlers),
	"sessions-groups": () => import("./sessions-groups-CnY9pFow.js").then((module) => module.sessionGroupHandlers),
	"sessions-messaging": () => import("./sessions-messaging-ByTux2wI.js").then((module) => module.sessionMessagingHandlers),
	"sessions-mutations": () => import("./sessions-mutations-ChSAnmTp.js").then((module) => module.sessionMutationHandlers),
	"sessions-read": () => import("./sessions-read-DBWZFDpP.js").then((module) => module.sessionReadHandlers),
	"sessions-rewind": () => import("./sessions-rewind-DFVnDy2a.js").then((module) => module.sessionRewindHandlers),
	"sessions-sharing": () => import("./sessions-sharing-BgLqvzsX.js").then((module) => module.sessionSharingHandlers),
	"sessions-subscriptions": () => import("./sessions-subscriptions-04d0vdBW.js").then((module) => module.sessionSubscriptionHandlers),
	"sessions-suggestions": () => import("./sessions-suggestions-D9Gjn8JJ.js").then((module) => module.sessionSuggestionHandlers),
	"session-catalog": () => import("./session-catalog-HJkLkdyp.js").then((module) => module.sessionCatalogHandlers),
	"session-discussion": () => import("./session-discussion-X9FDYkI6.js").then((module) => module.sessionDiscussionHandlers),
	"session-observer-rpc": () => import("./session-observer-rpc-Bxaf2ZP4.js").then((module) => module.sessionObserverHandlers),
	"session-companion-rpc": () => import("./session-companion-rpc-C8X2sJlP.js").then((module) => module.sessionCompanionHandlers),
	"hooks-status": () => import("./hooks-status-Cq5100_7.js").then((module) => module.hooksStatusHandlers),
	skills: () => import("./skills-CtTKmLFz.js").then((module) => module.skillsHandlers),
	system: () => import("./system-C3RSQlHF.js").then((module) => module.systemHandlers),
	talk: () => import("./talk-Cn7UcUnO.js").then((module) => module.talkHandlers),
	tasks: () => import("./tasks-CKQVxjjQ.js").then((module) => module.tasksHandlers),
	"task-suggestions": () => import("./task-suggestions-3Pxc9bUB.js").then((module) => module.taskSuggestionsHandlers),
	"tools-catalog": () => import("./tools-catalog-DHPXlYoi.js").then((module) => module.toolsCatalogHandlers),
	"tools-effective": () => import("./tools-effective-02BSwcxP.js").then((module) => module.toolsEffectiveHandlers),
	"tools-invoke": () => import("./tools-invoke-CFrB5rRZ.js").then((module) => module.toolsInvokeHandlers),
	...
	update: () => import("./update-58yUnGJh.js").then((module) => module.updateHandlers),
	...
	"system-agent": () => import("./system-agent-d-Ik5Qcj.js").then((module) => module.systemAgentHandlers),
	"system-changes": () => import("./system-changes-C0sHtKv5.js").then((module) => module.systemChangesHandlers),
	wizard: () => import("./wizard-RHZCZHvP.js").then((module) => module.wizardHandlers)
};
