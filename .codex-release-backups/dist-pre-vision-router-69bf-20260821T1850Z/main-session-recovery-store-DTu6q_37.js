...
import { a as transitionMainSessionRecovery, n as isMainRestartRecoveryCandidate, r as isMainSessionRecoveryPending } from "./main-session-recovery-state-Ct2CBK87.js";
import { a as scheduleMainSessionRecoveryMutation, i as retryMainSessionRecoveryMutation } from "./main-session-recovery-lifecycle-4nXNCd9i.js";
...
function scheduleMainSessionRecoveryOwnerRelease(lease, onDeferredSuccess) {
	scheduleMainSessionRecoveryMutation({
		...
		onSuccess: onDeferredSuccess ?? (async (pending) => {
			if (pending) {
				const { scheduleMainSessionRecoveryPendingTarget } = await import("./main-session-recovery-owner-release-Bh5dk8a-.js");
