...
import { a as emitInternalDiagnosticEvent } from "./diagnostic-events-Djn4AVRp.js";
...
import { fn as getOwnedSessionTranscriptWriterFence } from "./session-accessor-CIiPoGwM.js";
import { t as resolveMirroredTranscriptText } from "./transcript-mirror-DxrLtJZQ.js";
import { y as createReplyToDeliveryPolicy } from "./reply-payload-DBNGwex4.js";
...
import { i as rejectDurableDelivery, o as suppressDurableDelivery, r as markDurableDeliveryQueued, t as completeDurableDelivery } from "./delivery-completion-DaqvTBWM.js";
import { a as resolveOutboundDurableFinalDeliverySupport, f as suppressedPayloadOutcome, i as createChannelHandler, n as prepareOutboundPayloadBatch, p as toOutboundDeliveryError, r as throwIfAborted, s as createRenderedMessageBatchPlan, t as OutboundPayloadPreparationError } from "./deliver-prepare-CQFJGt2b.js";
import { a as runOutboundDeliveryCommitHooks, c as deliveryKindForPayload, d as maybePinDeliveredMessage, f as normalizeEmptyPayloadForDelivery, g as stripInternalRuntimeScaffoldingFromPayload, h as resolveOutboundMediaAccessForSend, l as hasDeliveryResultIdentity, m as renderPresentationForDelivery, o as buildPayloadSummary, s as collectPayloadMediaSources, u as maybeNotifyAfterDeliveredPayload } from "./delivery-queue-reconciliation-6vvs6xSR.js";
import { n as hasTrustedMessageAuditListeners } from "./message-audit-events-DGtoPYvb.js";
import { t as diagnosticErrorCategory } from "./diagnostic-error-metadata-B1vLwxgx.js";
import { i as resolveOutboundMediaMaxBytes } from "./configured-max-bytes-kmWDwnsJ.js";
import { n as deriveDurableFinalDeliveryRequirementsForBatch, r as payloadRequiresDurablePayloadTransport } from "./capabilities-8F_8bL8C.js";
import { a as emitOutboundAuditTerminals, c as createMessageSentEmitter, d as persistQueuedPostSendState, f as persistQueuedPreSendState, i as completedOutboundAuditTerminals, l as createQueuedDeliveryOwner, m as resolveDeferredDeliveryAdmission, o as failedOutboundAuditTerminals, p as OUTBOUND_DELIVERY_LOG_SCOPE, r as withActiveDeliveryClaim, s as uniformOutboundAuditTerminals, u as isDeliveryAbortError } from "./delivery-queue-recovery-msQ5dxkq.js";
import { C as claimReusableDeliveryPlatformSendAttempt, D as PLATFORM_SEND_OWNER_LEASE_MS, M as preparedOutboundSuppressionOutcomes, O as createInitialDeliveryProducerClaim, _ as markDeliveryPlatformSendDispatched, a as failDelivery, b as StableDeliveryPreparationLostError, f as loadPendingDelivery, i as enqueuePreparedDeliveryOnce, j as mapPreparedOutboundAcceptedPayloads, k as acceptedPreparedOutboundEntries, l as findDeliveryIntentOwner, n as enqueueDelivery, o as failDeliveryAfterPlatformSend, r as enqueueDeliveryOnce, s as failDeliveryBeforePlatformSend, w as renewDeliveryPlatformSendLease, x as withStableDeliveryPreparation } from "./delivery-queue-storage-PRTFNK5i.js";
import { s as cancelDeliveryQueueMediaRetention } from "./delivery-queue-media-staging-B4prZs9R.js";
import { i as stageQueuePayloadMedia, r as releaseSpoolArtifacts } from "./delivery-queue-media-spool-DznhLCAO.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, n as chunkByParagraph, s as resolveChunkMode } from "./chunk-D68NbSMe.js";
...
async function deliverOutboundPayloadsWithQueueCleanup(params, queueId, auditStartedAt, producerClaimId, producerLeaseSignal) {
	...
	try {
		...
		if (!queueId) {
			if (params.deliveryCompletion) if (results.length > 0) await completeDurableDelivery(params.deliveryCompletion, results.at(-1), platformQueueStateDir);
			else await suppressDurableDelivery(params.deliveryCompletion, platformQueueStateDir);
		...
		if (queueId) {
			if (queuedPreSendState === "acked") {
				...
				if (hasPlatformSendEvidence) {
					...
					log.warn(`failed to preserve queued delivery ${queueId} after provider abort: ${formatErrorMessage(failErr)}`);
				});
