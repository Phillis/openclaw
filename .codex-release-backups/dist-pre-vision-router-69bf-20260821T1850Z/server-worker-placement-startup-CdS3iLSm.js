...
import { n as resolveManifestActivationPluginIds } from "./activation-planner-C2xU7Qqv.js";
...
import { Qt as loadSessionEntry, gt as normalizeUsage, mt as hasNonzeroUsage, tt as withTranscriptWriteTransaction } from "./session-accessor-CIiPoGwM.js";
import { h as onSessionIdentityMutation, m as emitSessionLifecycleEvent } from "./session-accessor.sqlite-lifecycle-BFaW8ajj.js";
import { $ as runExclusiveSessionStoreWrite, K as interruptSessionWorkAdmissions, R as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS, X as runExclusiveSessionLifecycleMutation } from "./agent-harness-session-key-BpWapmwX.js";
...
import { I as convertToLlm } from "./agent-core-BNJRSUk4.js";
...
import { n as measureAgentRuntimeIdentityTokenBytes, r as mintAgentRuntimeIdentityToken } from "./agent-runtime-identity-token-DNvL9Jxl.js";
import { t as resolveConversationCapabilityProfile } from "./conversation-capability-profile-CU1lwCVr.js";
import { t as createPreprovisionedSshSandboxBackend } from "./ssh-backend-SWxgR7nm.js";
...
import { C as mergeUsageIntoAccumulator, a as buildUsageAgentMetaFields, x as createUsageAccumulator, y as resolveReportedModelRef } from "./helpers-CEtkTf-1.js";
...
import { n as parseNodeWorkerWorkspaceRetainResult } from "./node-workspace-retain-protocol-dMQamD-3.js";
...
import { o as toWorkerTranscriptMessage, t as WORKER_PROVIDER_REPLAY_LOCAL_RETRY_MESSAGE } from "./transcript-message-CAkPZKyT.js";
import { a as recoverWorkerWorkspaceReconciliation } from "./workspace-reconcile-B4y8jodH.js";
...
import { a as isDeviceWorkerAvailable } from "./device-provider-r5BsRUuF.js";
...
import { t as ActiveTurnClaimError } from "./placement-turn-claims-Dke5aCq4.js";
...
const loadPlacementSessionEvidenceRuntime = createLazyRuntimeModule(async () => {
	const [sessionUtils, sessionAccessor] = await Promise.all([import("./session-utils-C-lncBYE.js"), import("./session-accessor-DwuUem4A.js")]);
	return {
...
function createNodeWorkspaceRetainCoordinator(options) {
	...
	const drain = async () => {
		while (pendingAll || pendingNodes.size > 0) {
			...
			const targets = reconcileAll ? currentNodes.filter((node) => node.workerBuild !== void 0) : currentNodes.filter((node) => node.workerBuild !== void 0 && requestedNodes.has(node.nodeId));
...
const loadWorkerPlacementSessionRuntimeModule = createLazyRuntimeModule(async () => {
	const [placementSessionRuntime, { managedWorktrees }, sessionUtils] = await Promise.all([
		import("./placement-session-runtime-CQo2E8iK.js"),
		import("./service-D5qnNbtI.js"),
...
const loadWorkerWorkspacePreflight = createLazyRuntimeModule(async () => {
	const { preflightWorkerWorkspace } = await import("./workspace-sync-preflight-DUodVIHG.js");
