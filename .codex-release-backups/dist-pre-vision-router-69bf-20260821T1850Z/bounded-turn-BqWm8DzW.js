...
import { x as resolveCodexAppServerRuntimeOptions } from "./session-binding-CuZlPg0f.js";
import { l as isCodexAppServerStartSelectionChangedError, ut as isJsonObject } from "./shared-client-B5mi5IxU.js";
import { o as createDeferred } from "./extension-shared-D4oakjAV.js";
import { _ as readCodexNotificationTurnId, a as closeCodexStartupClientBestEffort, o as interruptCodexTurnAndWaitBestEffort, t as CODEX_APP_SERVER_INTERRUPT_TIMEOUT_MS } from "./attempt-client-cleanup-o--1yVH9.js";
import { b as isTerminalTurnStatus, n as normalizeCodexResponseTokenUsage, x as readCodexNotificationItem, y as isRetryableErrorNotification } from "./event-projector-usage-B5wIXWXR.js";
import { C as mergeCodexThreadConfigs, a as attestCodexRestrictedToolSurfaceMcpServersDisabled, c as readCodexInheritedMcpServerNames, i as assertCodexRestrictedToolSurfaceHasNoManagedHooks, o as buildCodexRingZeroThreadConfigPatch, s as buildCodexRuntimeThreadConfig } from "./thread-lifecycle-Dd9pvkoI.js";
...
import { r as readModelListResult } from "./models-ZeDdHc9J.js";
...
async function runBoundedCodexAppServerTurnInWorkspace(params, appServer, workspace, selectionAttempt = 0, timing) {
	...
	}) : await import("./shared-client-CiDP8pku.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
		startOptions,
		timeoutMs,
		...authSelection,
		authRequirement: params.authRequirement,
