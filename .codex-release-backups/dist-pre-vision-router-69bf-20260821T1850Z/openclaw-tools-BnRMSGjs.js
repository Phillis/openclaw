...
import { d as asPositiveSafeInteger, j as resolveIntegerOption, s as asFiniteNumber } from "./number-coercion-oCkfUEEq.js";
...
import { a as stripAnsiSequences } from "./ansi-9qL8iF9E.js";
...
import { a as resolveAgentModelTimeoutMsValue, i as resolveAgentModelPrimaryValue, r as resolveAgentModelFallbackValues } from "./model-input-ekSMR50U.js";
import { g as resolveSessionAgentIds, h as resolveSessionAgentId, o as resolveAgentEffectiveModelPrimary } from "./agent-scope-D9GLFAyB.js";
import { n as normalizeAgentId } from "./agent-id-Db0rqw_J.js";
import { a as listAgentIds, d as resolveAgentWorkspaceDir, l as resolveAgentDir, r as listAgentEntries, s as resolveAgentConfig } from "./agent-scope-config-CsnnOL14.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, d as parseSessionDeliveryRoute, l as parseCronRunScopeSuffix, n as isAcpSessionKey, r as isCronRunSessionKey } from "./session-key-utils-D8x_bjrd.js";
import { t as isIncognitoSessionKey } from "./incognito-session-key-BwpD1Lwd.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-BRqK6RmF.js";
import { a as buildAgentMainSessionKey, c as classifySessionKeyShape, f as resolveAgentIdFromSessionKey, i as agentSessionKeysMatchByRequestKey } from "./session-key-D8GLfPr_.js";
...
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-Q46IVR5c.js";
import { t as parseConfigPathArrayIndex } from "./path-array-index-CvEcUJa-.js";
import { dt as stripInboundMetadata, ut as hasInboundMetadataSentinel } from "./openclaw-state-db-BciZ4rHE.js";
import { f as stripInternalRuntimeContext } from "./internal-runtime-context-E3ku7Huk.js";
import { a as sha256Hex, r as sha256Base64UrlPrefix } from "./crypto-digest-PR8Utwzg.js";
import { t as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CmmO-xmS.js";
import { t as loadBundledPluginPublicArtifactModuleFromCandidatesSync } from "./public-surface-loader-DMySnkKb.js";
import { C as describeSessionVisibilityScope, E as describeSessionsSearchTool, S as describeSessionStatusTool, T as describeSessionsListTool, b as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, f as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, k as describeUpdatePlanTool, l as DISMISS_TASK_TOOL_DISPLAY_SUMMARY, m as SESSIONS_SEARCH_TOOL_DISPLAY_SUMMARY, p as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, s as ASK_USER_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsHistoryTool, x as describeAskUserTool, y as SUGGEST_TASK_TOOL_DISPLAY_SUMMARY } from "./tool-catalog-Dl50knwD.js";
...
import { a as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-l7ndhGM_.js";
...
import { i as logWarn, t as logDebug } from "./logger-frf2HPJn.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-hKtCSlbr.js";
import { m as mergeSsrFPolicies, t as SsrFBlockedError } from "./ssrf-CQ4RdJXm.js";
import { p as readProviderJsonResponse } from "./provider-http-errors-DwYSuIHs.js";
import { _ as registerAgentRunContext, a as clearAgentRunContext, f as getAgentRunTaskRunId } from "./agent-run-registry-cxavoLf6.js";
import { A as getPreparedMessageToolCatalog, d as getActivePluginRegistry } from "./runtime-LV4GwzTm.js";
import { D as listMediaGenerationProviderModels, O as synthesizeMediaGenerationCatalogEntries } from "./loader-BIAS8vL1.js";
...
import { S as selectApplicableRuntimeConfig } from "./runtime-snapshot-DIuCzlel.js";
import { c as WRITE_SCOPE } from "./operator-scopes-Dw7Gu2cA.js";
import "./config-CfeGo4K4.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-yubNQC1L.js";
import { f as readConnectPairingRequiredMessage } from "./connect-error-details-Do3cAiyu.js";
import { i as GatewayTransportError } from "./call-CZ1eu88h.js";
import "./client-3jXHeoWL.js";
import { t as GatewayClientRequestError } from "./request-error-Cviusa7U.js";
import { l as NODE_MCP_TOOL_CALL_GATEWAY_TIMEOUT_MS, u as NODE_MCP_TOOL_CALL_TIMEOUT_MS } from "./node-commands-DemsbVYQ.js";
import { n as listProfilesForProvider } from "./profile-list-C4c5_QKQ.js";
import { i as resolveAuthProfileOrder } from "./order-DNPkDbkT.js";
import { o as getModelProviderRequestTransport } from "./provider-request-config-BR35Bqmj.js";
import { a as unwrapSecretSentinelsForProviderEgress } from "./provider-secret-egress-NmAMmdEt.js";
...
import { d as sessionDeliveryOrigin, n as deliveryContextFromSession, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-B3qeEQhR.js";
...
import { n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-Di8rIzwA.js";
import { r as resolveAgentMainSessionKey } from "./main-session-Dth0X5B9.js";
import { $t as loadSessionEntryReadOnly, It as patchSessionEntryWithKey, Qt as loadSessionEntry, Rt as resolveSessionEntryCandidateTarget, at as getCliSessionBinding, pn as runWithoutOwnedSessionTranscriptWrites } from "./session-accessor-CIiPoGwM.js";
import { i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BQt6AaEH.js";
...
import { U as getCurrentSessionWorkAdmissionRelease, W as getSessionWorkAdmissionRelease } from "./agent-harness-session-key-BpWapmwX.js";
import { K as isEmbeddedMode, Y as listAllChannelSupportedActions, Z as listChannelSupportedActions, g as hasRunWorkspaceSkillUsage, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-rUQaaAPY.js";
import { Ao as PortalSummarySchema, Do as PortalListResultSchema, Hg as UiCommandResultSchema, To as PortalCloseResultSchema, Vv as SESSION_AGENT_ATTENTION_ICON_IDS, fd as ConversationListResultSchema, md as ConversationSendResultSchema, yd as ConversationTurnResultSchema } from "./src-BlUKtAtD.js";
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-Bq7-AfnG.js";
import { r as resolvePluginCapabilityProvider, t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BUmFeSLA.js";
import { c as getPreparedPluginRuntimeLoadContext } from "./prepared-model-runtime.facts-B0EtkVQK.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-Df_qhWv_.js";
import { r as resolveProviderTransportSsrFPolicy } from "./provider-transport-fetch-8YVCS0ct.js";
import { c as getImageMetadata } from "./image-ops-CuoBGLvn.js";
import { Y as formatFullOutputFooter, mt as writePrivateTempFile, st as getModelRegistryRuntime } from "./sessions-BHNzcBA2.js";
import { a as bindModelLlmRuntime, t as complete } from "./stream-DyQQWfkz.js";
...
import { t as probeMediaFilesWithinBudget } from "./media-services-BhxTAMtw.js";
import { r as resolveImageSanitizationLimits } from "./image-sanitization-CxLP0YN-.js";
import { r as sanitizeToolResultImages } from "./tool-images-DoRcRuZO.js";
...
import { d as saveMediaBuffer, i as deleteMediaBuffer } from "./store-CvNsGg9Z.js";
import { i as normalizeMediaReferenceSource, r as classifyMediaReferenceSource } from "./media-reference-8XBYb3Pm.js";
import { o as resolveBundledStaticCatalogModel, t as bundledStaticCatalogProviderUsesRuntimeAugment } from "./model.static-catalog-A60kA-Al.js";
...
import "./agent-id-BYpRMvce.js";
import { n as resolveImageFallbackDefaultProvider, t as resolveImageFallbackCandidates } from "./model-fallback-candidates-Cm265CbA.js";
import { t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-BK-D17bD.js";
...
import { r as getCustomProviderApiKey } from "./model-auth-provider-config-CwVoY8Rs.js";
import { c as createRuntimeProviderAuthLookup, i as getApiKeyForModelCore, l as hasRuntimeAvailableProviderAuth, r as applySecretRefHeaderSentinels, s as resolveApiKeyForProviderCore } from "./model-auth-BgXCiN_L.js";
import { r as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-B1YtMmAp.js";
import "./model-selection-BEGvRdL1.js";
import "./workspace-Bhf9rmeb.js";
import { c as listSessionStateEventsSince, i as getSessionStateVersions, r as getSessionStateVersion } from "./session-state-events-DTKQ6kKc.js";
import { E as listTaskRecordsUnsorted } from "./task-registry-CvGhDB6M.js";
...
import { n as formatTaskStatusDetail, o as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-DMWIN7O1.js";
import "./runtime-internal-3api9B92.js";
import { t as cancelDetachedTaskRunById } from "./task-executor-DMzLBFec.js";
import { d as clearGeneratedMediaTaskActivity, f as registerGeneratedMediaTaskActivity } from "./task-status-access-Cn4BdHg9.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-DAuZQ8oI.js";
import { t as resolveRequiredCompletionDeliveryFailureTerminalResult } from "./task-completion-contract-BJW3TUQJ.js";
import { _ as getSessionGoal, b as updateSessionGoalStatus, h as createSessionGoal, p as MODEL_UPDATABLE_SESSION_GOAL_STATUSES } from "./sessions-Bh837xaa.js";
import { v as capArrayByJsonBytes } from "./session-transcript-readers-BIeuEaZ3.js";
import { i as resolveSessionModelIdentityRef } from "./placement-session-runtime-D3R4yOqT.js";
import { s as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-DrbEdtLr.js";
import { P as deriveSessionTitle, c as readSessionTitleFieldsFromTranscriptAsync } from "./session-utils-row-xwseApeF.js";
...
import { n as parseReplyDirectives } from "./reply-directives-BKDbuE6s.js";
import { u as stripUnsupportedCitationControlMarkers } from "./payloads-46PhlDay.js";
import { n as loadWebMedia, r as loadWebMediaRaw } from "./web-media-DRJtrLMa.js";
import { i as normalizeInboundPathRoots } from "./inbound-path-policy-DQ5Rksw7.js";
import { r as getDefaultLocalRootsCore } from "./local-media-access-DMQpomW2.js";
import { S as isToolWrappedWithBeforeToolCallHook, i as resolveMessageActionAgentRuntimeIdentityToken, m as setToolTerminalPresentation, n as readGatewayCallOptions, r as resolveGatewayOptions, s as createGatewayToolCallerWrapper, t as callGatewayTool } from "./gateway-IvUFCG_L.js";
import { t as normalizeConversationReadInvocationOrigin } from "./conversation-read-origin-E3olMOwo.js";
import { a as resolvePluginTools, o as setPluginToolMeta } from "./tools-BkbGUY3V.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-yzMRnN3e.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, s as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-B7Ggqfek.js";
import { t as resolveSkillWorkshopConfig } from "./config-Cjp42tXL.js";
import { K as stripProposalFrontmatterForSkill } from "./store-B-ZL-1gP.js";
import { c as readSkillProposalTargetTreeSha256 } from "./proposal-draft-zkJQJamp.js";
import { a as proposeUpdateSkill, c as reviseSkillProposal, f as inspectSkillProposal, i as proposeCreateSkill, l as evaluateSkillProposal, m as resolvePendingSkillProposal, n as applySkillProposal, o as quarantineSkillProposal, p as listSkillProposals, r as composeSkillBodyPatch, s as rejectSkillProposal, t as SkillProposalStaleTargetError } from "./service-D6R5IdXh.js";
import { i as readWritableWorkspaceSkill } from "./workspace-skill-read-BoyRD5Al.js";
import { r as resolveMessageActionTurnCapability } from "./message-action-turn-capability-zgjXjhbw.js";
import { t as CHANNEL_MESSAGE_ACTION_NAMES } from "./message-action-names-CwcoVsCP.js";
import { a as resolveAllowedMessageActions, s as shouldApplyCrossContextMarker } from "./outbound-policy-BevQYmY0.js";
import { r as registerPendingAgentQuestion } from "./gateway-question-y5NFHODa.js";
import { n as resolveBootstrapMode } from "./bootstrap-mode-HvSedbJl.js";
import { a as COMPUTER_USE_V1_ACTION_NAMES, i as COMPUTER_USE_CONTRACT_ONLY_ACTION_NAMES, m as parseComputerActResult, n as COMPUTER_CONTRACT_MISMATCH, o as COMPUTER_USE_V2_ACTION_NAMES, r as COMPUTER_STALE_OBSERVATION, t as COMPUTER_ACT_V1_ACTION_NAMES } from "./computer-use-contract-Din_sL74.js";
import { a as screenSnapshotTempPath, c as cameraTempPath, d as resolveCameraClipTarget, f as resolveCameraSnapTargets, h as mediaPathMatchesFormat, i as screenSnapshotFormatForPath, l as parseCameraClipPayload, m as writeCameraPayloadToFile, n as parseScreenSnapshotPayload, o as writeScreenRecordToFile, p as writeCameraClipPayloadToFile, r as screenRecordTempPath, s as writeScreenSnapshotToFile, t as parseScreenRecordPayload, u as parseCameraSnapPayload } from "./nodes-screen-faxVdwwj.js";
import { s as resolveActionDeliveryTargetAlias } from "./channel-target-DPpd2mOc.js";
import { a as optionalPositiveIntegerSchema, i as optionalNonNegativeIntegerSchema, n as channelTargetsSchema, o as optionalStringEnum, r as optionalFiniteNumberSchema, s as stringEnum, t as channelTargetSchema } from "./typebox-Bs_cXWU1.js";
import { i as gatewayCallOptionSchemaProperties, t as createCronTool } from "./cron-tool-VX-ZM_3U.js";
import { i as resolveEligibleNodeFromList, n as resolveAgentNode, r as resolveAgentNodeId, t as listNodes } from "./nodes-utils-BUm0U5kL.js";
import { C as buildMediaGenerationRequestKey, S as MEDIA_GENERATION_DELIVERING_COMPLETION_PROGRESS, _ as findActiveVideoGenerationTaskForSession, b as findDuplicateGuardVideoGenerationTaskForSession, c as buildImageGenerationTaskStatusListDetails, d as buildMusicGenerationTaskStatusDetails, f as buildMusicGenerationTaskStatusText, g as findActiveMusicGenerationTaskForSession, h as findActiveImageGenerationTaskForSession, l as buildImageGenerationTaskStatusListText, m as buildVideoGenerationTaskStatusText, n as MUSIC_GENERATION_TASK_KIND, p as buildVideoGenerationTaskStatusDetails, r as VIDEO_GENERATION_TASK_KIND, s as buildImageGenerationTaskStatusDetails, t as IMAGE_GENERATION_TASK_KIND, u as buildImageGenerationTaskStatusText, v as findDuplicateGuardImageGenerationTaskForSession, w as recordRecentMediaGenerationTaskStartForSession, x as listActiveImageGenerationTasksForSession, y as findDuplicateGuardMusicGenerationTaskForSession } from "./media-generation-task-status-BdyX5imK.js";
import { n as assertCronJobScratchContent } from "./scratch-contract-DyG_7g0F.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-CyHYyyCM.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CApi94oH.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, t as createAgentToAgentPolicy } from "./session-visibility-Dylhk5vA.js";
import { _ as getInProcessGatewayToolContext, a as resolveSessionToolAccess, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, h as callInProcessGatewayTool, i as resolveSandboxedSessionToolContext, l as resolveInternalSessionKey, m as callAgentToolGatewayRequest, n as deriveChannel, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveCurrentSessionClientAlias, t as classifySessionListKind, u as resolveMainSessionAlias, v as hasInProcessGatewayToolContext } from "./sessions-helpers-DkT3wqUw.js";
import { c as listControlledSubagentRuns, l as resolveSubagentController, o as MAX_RECENT_MINUTES } from "./subagent-control-Q2AxczZU.js";
import { t as buildSubagentList } from "./subagent-list-kM86qJwy.js";
import { O as createStructuredOutputTool, l as getSubagentRunByRunId, v as recordSwarmStructuredOutput } from "./subagent-registry-DvDWUQio.js";
...
import { t as createCanvasDocument } from "./documents-Dk6rFh1H.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-BvaOhl7Y.js";
import { n as abortable } from "./abortable-kAqTMjxD.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-kmWDwnsJ.js";
import { _ as parseJsonMessageParam, g as parseInteractiveParam } from "./source-reply-mirror-BkM6CVj4.js";
import { o as extractEmbeddedAssistantText } from "./embedded-agent-utils-D4SXH5E3.js";
import { t as registerProviderStreamForModel } from "./provider-stream-oP65p1LQ.js";
import { a as loadRequesterSessionEntry, f as formatGeneratedAttachmentLines, m as sanitizeGeneratedMediaDisplayText, p as mediaUrlsFromGeneratedAttachments, r as resolveAnnounceOrigin, t as deliverSubagentAnnouncement, u as formatAgentInternalEventsForPrompt } from "./subagent-announce-delivery-BBLwnNTR.js";
import { u as wrapToolWorkspaceRootGuardWithOptions } from "./agent-tools.read-CHqaXxWI.js";
import { r as listConnectedNodePluginTools } from "./node-plugin-tool-snapshot-Cwa7X4TJ.js";
import { t as resolveAgentRuntimeToolConfig } from "./tool-runtime-config-ClmvjJzk.js";
import { a as hasProviderAuthForTool, c as resolveOpenAiImageMediaCandidate, n as coerceToolModelConfig, o as hasToolModelConfig$1, r as hasAuthForProvider, s as resolveDefaultModelRef, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-B4bVZX-8.js";
import { t as isCoreCanvasHostEnabled } from "./config-DbspHgKh.js";
import { r as normalizeBoardWidgetDeclared } from "./board-capabilities-CkJxeCTJ.js";
...
import { a as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-CR1A1dve.js";
import { t as resolveTranscriptsConfig } from "./config-UoehNruw.js";
import { a as resolveCapabilityModelCandidates, d as findCapabilityProviderById, f as resolveCapabilityModelRefForProviders, i as recordCapabilityCandidateFailure, n as buildNoCapabilityModelConfiguredMessage, r as normalizeDurationToClosestMax, t as buildMediaGenerationNormalizationMetadata, u as throwCapabilityGenerationFailure } from "./runtime-shared-BH6rbtOk.js";
import { n as normalizeMediaProviderId } from "./provider-id-DSbuCFIb.js";
import { t as createAgentsWaitTool } from "./agents-wait-tool-D3DEnafc.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-BebVSdcS.js";
import { _ as resolveSubagentAllowedTargetIds } from "./subagent-spawn-ownership-BAiibEWv.js";
import { n as listRuntimeImageGenerationProviders, r as resolveImageGenerationMaxInputImages, t as generateImage } from "./runtime-DhsmcfZ_.js";
import { a as listMusicGenerationProviders, n as getMusicGenerationProvider, s as parseGenerationModelRef } from "./registry-D6B6dZui.js";
import { n as hasMediaNormalizationEntry } from "./geometry-normalization-CPWBf6_9.js";
import { n as resolveChannelInboundAttachmentRootsForChannel } from "./channel-inbound-roots-BR8N9Q9B.js";
import { t as runWithImageModelFallback } from "./model-fallback-image-BPownRMl.js";
import { i as readResponseBodySnippet, n as isMinimaxVlmProvider } from "./minimax-vlm-006xDHMR.js";
import { c as postJsonRequest, m as resolveProviderHttpRequestConfigWithOriginTrust } from "./shared-DEePW_9S.js";
import { a as resolveConfiguredImageModelRefs, i as hasImageReasoningOnlyResponse, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl, t as coerceImageAssistantText } from "./image-tool.helpers-DrpIe7BB.js";
import { t as removeCronRunContinuationSessionIfIdle } from "./cron-run-continuation-cleanup-B6r3TZjX.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-Cbm6guXC.js";
import { n as resolveMessageBroadcastAccountPlan, r as validateExplicitMessageAccountSelection } from "./message-account-selection-CMnfl8zf.js";
import { r as sourceDeliveryTargetsMatch } from "./source-delivery-plan-DUh00mqe.js";
import { i as resolveDocumentMediaModel, n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DFjhPgkw.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-ciabHsxe.js";
import { a as DEFAULT_TIMEOUT_SECONDS, c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-D89wfMnk.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-xJvrDBVt.js";
import { c as resolveTimeoutMs } from "./resolve-BqVSmyay.js";
import "./media-understanding-BjYvarC_.js";
import { n as runtimeWebSecretOwnerId } from "./runtime-web-tools-DnjNqYy2.js";
...
import { f as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-JklITWYj.js";
import { t as resolveMessageSecretScope } from "./message-secret-scope-DVbZmkA5.js";
import { i as SHARED_POLL_CREATION_PARAM_NAMES, n as runMessageAction, r as POLL_CREATION_PARAM_DEFS, t as getToolResult } from "./message-action-runner-w0xDQ6uY.js";
import { t as stripFormattedReasoningMessage } from "./formatted-reasoning-message-DEI_6rVO.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-HEtaF6e9.js";
import { t as extractPdfContent } from "./pdf-extract-JBVHTFTx.js";
import { t as triggerSessionPatchHook } from "./session-patch-hooks-CGO8FDDk.js";
import { t as applyModelOverrideWithAuthProfileCompatibility } from "./auth-profile-preservation-DXzxYE5v.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-tlnamKen.js";
import { a as runWithScopedSessionAccess, i as resolveSessionToolTargetAgentId, r as createSessionsSendTool, t as createSessionsSpawnTool } from "./sessions-spawn-tool-5xd0wTD0.js";
import { r as withAgentSessionModelPatchOrigin } from "./session-model-patch-origin-CLtcGA6d.js";
import { n as reconcileSkillCollection, o as MAX_RECONCILED_SKILL_BYTES, r as restoreLatestSkillCollectionBackup } from "./collection-reconcile-CQWO1EMz.js";
import { t as SKILL_AUTHORING_STANDARDS_PROMPT } from "./skill-authoring-standards-CFsbOHC8.js";
import { r as resolveTerminalSpawnPlan, t as buildTerminalEnv } from "./launch-C_hTI6P_.js";
import { i as waitForTerminalOpenDeadline, n as TerminalOpenDeadlineError, r as createTerminalOpenDeadline } from "./open-deadline-I59sAbII.js";
import { n as createTranscriptsTool } from "./transcripts-tool-DoM2cqwD.js";
import { n as textToSpeech } from "./tts-QE2khNZ2.js";
import { n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-DYci4waw.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-DAKHn4ru.js";
import { a as truncateWebFetchText, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-Bxd0cgz7.js";
import { a as readResponseText, c as resolveTimeoutSeconds, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey } from "./web-shared-C6DzgiTT.js";
import { n as resolveWebSearchToolRuntimeContext, t as resolveWebFetchToolRuntimeContext } from "./web-tool-runtime-context-Ciq5sDFe.js";
import { o as runWebSearch } from "./runtime-QGQYfFQ9.js";
...
const CONTRACT_ONLY_ACTIONS = new Set(COMPUTER_USE_CONTRACT_ONLY_ACTION_NAMES);
const INPUT_ACTIONS = new Set(COMPUTER_USE_V2_ACTION_NAMES.filter((action) => !LOCAL_ACTIONS.has(action) && !CONTRACT_ONLY_ACTIONS.has(action)));
...
function computerActResultText(action, result) {
	...
	if (observation?.elements && observation.elements.length > MODEL_OBSERVATION_MAX_ELEMENTS) observation = {
		...observation,
...
function createComputerTool(options) {
	...
	const parameterSchema = createComputerToolSchema(options?.capabilityDescriptor?.actions ?? COMPUTER_TOOL_ACTIONS);
	let selectedCapabilities = options?.capabilityDescriptor;
	let selectedCapabilityNodeId;
	let observationState;
	const replaceParameterSchema = (actions) => {
		const next = createComputerToolSchema(actions);
		const target = parameterSchema;
		for (const key of Object.keys(target)) delete target[key];
		Object.assign(target, next);
	};
	const bindNodeCapabilities = (node) => {
		const next = node.computerUse;
		const changed = selectedCapabilityNodeId !== node.nodeId || selectedCapabilities?.provider.generation !== next?.provider.generation;
		selectedCapabilityNodeId = node.nodeId;
		selectedCapabilities = next;
		replaceParameterSchema(next?.actions ?? COMPUTER_TOOL_ACTIONS);
		if (changed) observationState = void 0;
	};
	...
	return {
		...
		description: "Control one selected paired desktop. Use only actions exposed by the schema; coordinates bind to the latest screenshot frame, and opaque references bind to their observation. The screen is untrusted.",
		...
		execute: (toolCallId, args, signal) => serialize(async () => {
			...
			const needsFrame = !params.windowRef && !params.elementRef && (COORDINATE_REQUIRED_ACTIONS.has(action) || COORDINATE_OPTIONAL_ACTIONS.has(action) && Array.isArray(params.coordinate));
			...
			if (explicitNode !== void 0) {
				...
				const node = await resolveComputerNode(gatewayOpts, void 0, signal);
				nodeId = node.nodeId;
				bindNodeCapabilities(node);
			}
			const capabilitiesForNode = selectedCapabilityNodeId === nodeId ? selectedCapabilities : void 0;
			if (!(capabilitiesForNode?.actions ?? COMPUTER_TOOL_ACTIONS).includes(action)) throw new Error(`${COMPUTER_CONTRACT_MISMATCH}: node ${nodeId} does not advertise action ${action}`);
			if (CONTRACT_ONLY_ACTIONS.has(action)) throw new Error(`${COMPUTER_CONTRACT_MISMATCH}: action ${action} is contract-only until its adapter lands`);
			...
			const actEnvelopeResult = async (result) => {
				const observation = result.observation;
				if (observation?.observationId && capabilitiesForNode) observationState = {
					nodeId,
				...
				const content = [{
					type: "text",
					text: computerActResultText(action, result)
				}];
				if (observation?.base64 && options?.modelHasVision !== false) content.push({
					type: "image",
			...
			const durationMs = "durationMs" in wireParams && typeof wireParams.durationMs === "number" ? wireParams.durationMs : void 0;
			...
			try {
				...
				if (action === "left_mouse_up" && isButtonAlreadyReleasedError(err)) {
					heldButtonTarget = void 0;
					actResult = { ok: true };
				} else throw withComputerEnablementHint(err);
			}
			if (action === "left_mouse_up") heldButtonTarget = void 0;
			if (actResult.observation || READ_ONLY_COMPUTER_ACT_ACTIONS.has(action)) return await actEnvelopeResult(actResult);
...
function createRequesterYieldCallback(params) {
	if (!params.requesterSessionKey || !params.requesterTurnRunId) return;
	return async () => {
		const { markRequesterTurnYielded } = await import("./subagent-registry-Bvicpfnu.js");
...
function createDashboardTool(opts = {}) {
	...
	return {
		...
		execute: async (_toolCallId, rawArgs) => {
			...
			if (action === "read") return snapshotResult(await gatewayCall("board.get", {
				sessionKey,
...
const createImageGenerationTaskRun = imageGenerationTaskLifecycle.createTaskRun;
/** Records progress for an image generation task. */
const recordImageGenerationTaskProgress = imageGenerationTaskLifecycle.recordTaskProgress;
/** Completes an image generation task ledger run. */
const completeImageGenerationTaskRun = imageGenerationTaskLifecycle.completeTaskRun;
/** Marks an image generation task ledger run as failed. */
const failImageGenerationTaskRun = imageGenerationTaskLifecycle.failTaskRun;
...
const createMusicGenerationTaskRun = musicGenerationTaskLifecycle.createTaskRun;
/** Records progress for an active music-generation task. */
const recordMusicGenerationTaskProgress = musicGenerationTaskLifecycle.recordTaskProgress;
/** Marks a music-generation task complete and stores generated attachment metadata. */
const completeMusicGenerationTaskRun = musicGenerationTaskLifecycle.completeTaskRun;
/** Marks a music-generation task failed and emits task status updates. */
const failMusicGenerationTaskRun = musicGenerationTaskLifecycle.failTaskRun;
...
const createVideoGenerationTaskRun = videoGenerationTaskLifecycle.createTaskRun;
/** Records progress for an active video-generation task. */
const recordVideoGenerationTaskProgress = videoGenerationTaskLifecycle.recordTaskProgress;
/** Marks a video-generation task complete and stores generated attachment metadata. */
const completeVideoGenerationTaskRun = videoGenerationTaskLifecycle.completeTaskRun;
/** Marks a video-generation task failed and emits task status updates. */
const failVideoGenerationTaskRun = videoGenerationTaskLifecycle.failTaskRun;
//#endregion
...
function createImageGenerateTool(options) {
	...
	return {
		...
		execute: async (_toolCallId, args, signal) => {
			...
			if (Boolean(taskHandle && shouldDetachMediaGenerationTask(options?.agentSessionKey, options?.requesterAgentId)) && taskHandle) {
...
async function loadImageWebMediaRuntime() {
	return await import("./web-media-BJ85U7fG.js");
}
const resolveModelAsyncDefault = async (...args) => {
	const { resolveModelAsync } = await import("./model-D3tTUTet.js");
...
function portalResult(text, payload) {
...
function createPortalTool(options = {}) {
	...
	return {
		...
		execute: async (_toolCallId, rawArgs) => {
			...
			const action = readToolStringParam(params, "action", { required: true });
			if (action === "list") {
				const result = await callGatewayRequest({
					method: "portal.list",
					params: {},
					scopes: [PORTAL_URL_SCOPE]
				});
				return portalResult(`${result.portals.length} active portal${result.portals.length === 1 ? "" : "s"}. The operator can see them in the Control UI Portals page.`, result);
			}
			if (action === "close") {
				const id = readToolStringParam(params, "id", { required: true });
				const result = await callGateway("portal.close", { id });
				return portalResult(`Portal ${id} closed. The Control UI Portals page has been updated.`, result);
			}
			...
			const portal = await callGateway("portal.open", {
				port,
				...title !== void 0 ? { title } : {},
				...description !== void 0 ? { description } : {},
				...path !== void 0 ? { path } : {}
			});
			return portalResult(`Portal available at ${portal.url}. Pass PUBLIC_URL=${portal.publicUrl} and PORT=${portal.port} when starting the dev server. The operator can see it in the Control UI Portals page.`, portal);
		}
	};
}
//#endregion
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			const checkVisibilityAccess = async (target) => {
				...
				if (!access.allowed && target.targetAgentId !== requesterAgentId && !target.requesterOwned && !target.authorizationTargetSessionKey.startsWith("agent:") && !access.error.includes("ownership lookup failed")) {
					if (!a2aPolicy.enabled) access = {
						allowed: false,
						status: "forbidden",
						error: "Agent-to-agent status is disabled. Set tools.agentToAgent.enabled=true to allow cross-agent access."
					};
					else if (!a2aPolicy.isAllowed(requesterAgentId, target.targetAgentId)) access = {
						allowed: false,
						status: "forbidden",
...
function createSessionsTool(opts = {}) {
	...
	return {
		label: "Sessions",
		name: "sessions",
		description: "Session settings, reset, delete, and groups: patch label/status, pin, archive/restore, model/thinking override; reset/delete visible sessions; group_list/group_set/group_rename/group_delete.",
		...
		execute: async (_toolCallId, rawArgs) => {
			...
			if (action === "reset" || action === "delete") {
				...
				if (action === "reset") return jsonResult(await callGateway("sessions.reset", {
					key,
					...agentScope,
					reason: "reset"
				}));
				...
				const archived = await callGateway("sessions.patch", {
					key,
					...agentScope,
					expectedSessionId,
					archived: true
				...
				return jsonResult(await callGateway("sessions.delete", {
					key,
					...agentScope,
					archivedOnly: true,
			...
			const { agentId, cfg, isRequesterSession, key } = await resolvePatchTarget({
				...opts,
				config: opts.config ?? getRuntimeConfig()
			}, normalizeOptionalString(readToolStringParam(params, "sessionKey")), gatewayRequest);
			...
			const result = await callSessionPatch({
				...patch,
				...agentScope
			});
			return jsonResult(withBoundedSessionsResolved({
...
function createSessionsYieldTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			const message = readToolStringParam(args, "message") || "Turn yielded.";
...
const skillCollectionPlanSchema = Type.Optional(Type.Array(Type.Object({
	...
	maxItems: 200,
	description: "Exactly one decision for every current writable skill, plus optional new write decisions. write requires description and complete SKILL.md content; drop requires a reason."
}));
...
const SKILL_COLLECTION_ACTION_DESCRIPTION = "read = inspect one current skill; reconcile = atomically keep, rewrite, create, or drop the whole writable skill collection.";
//#endregion
//#region src/agents/tools/skill-workshop-tool-description.ts
function buildSkillWorkshopToolDescription(params) {
	if (params.collectionOnly) return `Read every current writable skill, then replace the collection with one reconcile call. Every current skill needs exactly one keep, write, or drop decision.\n\n${SKILL_AUTHORING_STANDARDS_PROMPT}`;
	if (!params.proposalOnly) return `Read, patch, create, update, revise, inspect, evaluate, and apply reusable-procedure skill proposals. Restore the backup retained by the last collection cleanup when the user asks to undo it. ${params.autonomousMode === "off" ? "Foreground repair is disabled." : params.autonomousMode === "propose" ? "A foreground patch to a skill used in this run stays pending for review." : "A foreground patch to a skill used in this run is scanned and applied immediately."}\n\n${SKILL_AUTHORING_STANDARDS_PROMPT}`;
	const completion = params.supportsCompletion ? " complete = durably finish this review." : "";
	return `Inspect reusable-procedure skill proposals and draft pending ${params.updateProposals ? "create, update, or revise" : "create or revise"} proposals.${completion} Nothing writes a live skill directly; lifecycle actions are unavailable.\n\n${SKILL_AUTHORING_STANDARDS_PROMPT}`;
}
//#endregion
...
const SKILL_WORKSHOP_READ_MAX_CHARS = 2e4;
...
function buildSkillWorkshopToolSchema(proposalOnly, supportsCompletion, updateProposals, collectionOnly) {
	...
	return Type.Object({
		...
		skill_name: Type.Optional(Type.String({ description: "Existing skill name or key for action=update, action=patch, or action=read." })),
		old_string: Type.Optional(Type.String({ description: "For action=patch: the exact current skill text to replace, quoted from read. Must match exactly once. Empty string appends new_string at the end of the skill." })),
...
function createSkillWorkshopTool(options) {
	...
	if (options.proposalMutationBudget) options.proposalMutationBudget.readSkillHashes = readSkillHashes;
	return {
		...
		description: buildSkillWorkshopToolDescription({
			...
			supportsCompletion: options.proposalReviewCompletion !== void 0,
		...
		parameters: buildSkillWorkshopToolSchema(options.proposalOnly === true, options.proposalReviewCompletion !== void 0, options.updateProposals === true, options.collectionReconcile !== void 0),
		execute: async (_toolCallId, args) => {
			...
			if (options.proposalOnly === true && !options.collectionReconcile && !proposalActions.includes(action)) throw new ToolInputError("this Skill Workshop session can only inspect or draft proposals");
			if (action === "complete") {
			...
			if (action === "read") {
				...
				const readMaxChars = options.collectionReconcile ? MAX_RECONCILED_SKILL_BYTES : SKILL_WORKSHOP_READ_MAX_CHARS;
				...
				else readSkillHashes.set(skill.skillKey, sha256Hex(skill.content));
				return {
					content: [{
						type: "text",
						text: truncated ? `${truncateUtf16Safe(skill.content, readMaxChars)}\n[truncated: skill exceeds the Workshop read budget]` : skill.content
					}],
					details: {
			...
			if (action === "patch" || action === "update" && options.updateProposals) {
				...
				if (action === "patch") {
					if (foregroundRepair && !hasRunWorkspaceSkillUsage({
						runId: options.origin?.runId,
						name: target.skillKey,
						skillFile: target.skillFile
					})) throw new ToolInputError(`skill "${target.skillKey}" was not used in this run and cannot be repaired autonomously`);
					try {
...
async function lookupTaskByRunIdForChildSession(runId, childSessionKey) {
	const { findTaskByRunIdForChildSessionForStatus } = await import("./task-status-access-CHk7QHvs.js");
...
function readOptionalStringParam(params, key, options = {}) {
...
function launchBlockMessage(block) {
	...
	if (block.kind === "owner-required") return block.message;
...
function createTerminalTool(opts = {}) {
	...
	return {
		...
		execute: async (_toolCallId, rawArgs, signal) => {
			...
			if (action === "list") return jsonResult({ sessions: manager.listAgent(agentSessionKey, agentId) });
			if (action === "open") {
				...
				const taskLookupId = runId ? getAgentRunTaskRunId(runId) ?? runId : void 0;
				const task = taskLookupId ? await findOwnerTask(taskLookupId, agentSessionKey) : void 0;
				if (task && isTerminalTaskStatus(task.status)) throw new ToolInputError("terminal task already ended");
				...
				try {
					...
					if (openingTerminal) openingTerminal.then((lateOutcome) => {
						if (lateOutcome.ok) manager.closeAgent(agentSessionKey, lateOutcome.sessionId, agentId);
					}, () => void 0);
				...
				if (command !== void 0 && !manager.writeAgent(agentSessionKey, outcome.sessionId, `${command}\r`, agentId)) {
			...
			if (action === "input") {
				...
				return jsonResult({ ok: manager.writeAgent(agentSessionKey, sessionId, data, agentId) });
			}
			if (action === "resize") return jsonResult({ ok: manager.resizeAgent(agentSessionKey, sessionId, readDimension(params, "cols"), readDimension(params, "rows"), agentId) });
			if (action === "close") return jsonResult({ ok: manager.closeAgent(agentSessionKey, sessionId, agentId) });
			throw new ToolInputError(`Unknown action: ${action}`);
		}
	};
}
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-BJCvdhTf.js"));
...
//#endregion
export { setBootEchoContextForSession as a, invalidateComputerFrameIfMissing as c, cancelAskUserPromptDelivery as d, isAskUserPromptPending as f, normalizeAskUserParams as g, waitForAskUserPromptReady as h, clearBootEchoContextForSession as i, isPrimaryBootstrapRun as l, settleAskUserPromptDelivery as m, generateMusic as n, filterToolsByClientCaps as o, reserveAskUserPromptDelivery as p, listRuntimeMusicGenerationProviders as r, resolveOpenClawPluginToolsForOptions as s, createOpenClawTools as t, resolveWorkspaceBootstrapRouting as u };
