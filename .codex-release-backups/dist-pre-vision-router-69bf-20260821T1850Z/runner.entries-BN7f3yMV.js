...
import { t as buildRandomTempFilePath } from "./temp-download-Cro6FObu.js";
import { o as getOfficialExternalPluginCatalogManifest, p as listOfficialExternalProviderCatalogEntries } from "./official-external-plugin-catalog-BEMBT-Dn.js";
import { i as shouldLogVerbose, r as logVerbose } from "./globals-DD_xHyf6.js";
import { n as runExec } from "./exec-Cmwsxh9J.js";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-DzAepWRR.js";
import { c as mergeModelProviderRequestOverrides, m as sanitizeConfiguredProviderRequest, p as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-BR35Bqmj.js";
import { d as normalizeMimeType } from "./mime-Hm4eS2i0.js";
import { c as runFfmpeg } from "./media-services-BhxTAMtw.js";
import { r as assertSecretOwnerAvailable } from "./runtime-degraded-state-DqIBoQI-.js";
import { i as normalizeMediaReferenceSource, o as resolveInboundMediaReference, r as classifyMediaReferenceSource } from "./media-reference-8XBYb3Pm.js";
import { r as readRemoteMediaBuffer, t as MediaFetchError } from "./fetch-DscCAcct.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-DQ5Rksw7.js";
import { i as getDefaultMediaLocalRoots } from "./local-roots-bq3HSc8t.js";
...
import { r as resolveOfficialExternalPluginRepairHint } from "./official-external-plugin-repair-hints-OjzK9GPy.js";
import { t as describeImageWithModel } from "./image-runtime-ciabHsxe.js";
import { a as DEFAULT_TIMEOUT_SECONDS, l as getMediaUnderstandingProvider, n as DEFAULT_MAX_BYTES, o as DEFAULT_VIDEO_MAX_BASE64_BYTES, s as MIN_AUDIO_FILE_BYTES, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-D89wfMnk.js";
import { t as assertRuntimeMediaRequestSecretOwnerAvailable } from "./runtime-media-secret-owner-xJvrDBVt.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-BqVSmyay.js";
...
import { a as extractImageContentFromSource } from "./input-files-BkEdPTJ-.js";
import { i as normalizeAttachmentPath, n as isImageAttachment, r as isVideoAttachment, t as isAudioAttachment } from "./attachments.normalize-BkQz94jK.js";
import "./temp-path-Buyb_0PI.js";
import { a as resolveRequestedLocalAudioBackend, i as recordLocalAudioBackendObservation } from "./local-audio-CIgfwKaY.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-Y_8neblu.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-CxekH4gx.js";
...
const loadModelAuth = createLazyRuntimeModule(async () => await import("./model-auth-DVmCDIZL.js"));
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-CraQzP2U.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
