...
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-Bqs7eiq8.js";
...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-HU3_RnJn.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-C-wNoU6z.js";
...
import { g as scopeKey, h as resolveScopeToolsPolicy, m as resolveScopeRequireMention } from "./channel-policy-Dn6aXK3G.js";
...
import { c as resolveDiscordAccountAllowFrom, i as listEnabledDiscordAccounts, o as resolveDefaultDiscordAccountId, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-nD0JW5tp.js";
import { t as getDiscordRuntime } from "./runtime-Dg4d9hPu.js";
import { t as parseDiscordTarget } from "./target-parsing-CE3KimkZ.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-B_MwwOUC.js";
import "./channel-api-CrN0p_bL.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-lwTZkn2s.js";
import { u as withAbortTimeout } from "./timeouts-BTHN67kZ.js";
...
import { t as shouldHandleDiscordApprovalRequest } from "./approval-shared-Bp1eZUj8.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-B_qLv3ZN.js";
import { t as discordMessageActions$1 } from "./channel-actions-CKuCBbjw.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-BdluEc43.js";
import { r as openDiscordCommandDeployHashStore } from "./command-deploy-store-DFkBTViB.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-DNw5jEVI.js";
import { n as discordOutbound } from "./outbound-adapter-BbQh1JGz.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupContract, t as createDiscordPluginBase } from "./shared-DE6b79lB.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-BiEN-LXl.js")).discordApprovalNativeRuntime
		})
	});
}
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BEwEtdC9.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-6_K_e1zF.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-CE-kFM5z.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-D_B2a-MD.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-Cz5tAjVx.js"));
const loadDiscordProviderRuntime = createLazyRuntimeModule(() => import("./provider.runtime.js"));
const loadDiscordProbeRuntime = createLazyRuntimeModule(() => import("./probe.runtime-D4AwMuxl.js"));
...
const loadDiscordAuditModule = createLazyRuntimeModule(() => import("./audit-JE4B9BAp.js"));
const loadDiscordSendModule = createLazyRuntimeModule(() => import("./send-JX6hzHIG.js"));
const loadDiscordDirectoryLiveModule = createLazyRuntimeModule(() => import("./directory-live-CdzNnvOp.js"));
//#endregion
