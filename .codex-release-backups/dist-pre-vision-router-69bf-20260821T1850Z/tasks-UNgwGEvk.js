...
import { w as listTaskRecordPage, x as getTaskById } from "./task-registry-D_1U9wJQ.js";
...
import { i as retrySubagentCompletionDelivery, n as dismissSubagentCompletionDelivery } from "./subagent-completion-delivery-DDxOKofF.js";
...
const tasksHandlers = {
	...
	"tasks.dismiss": async ({ params, respond }) => {
		...
		const { discardSubagentTerminalDelivery } = await import("./subagent-registry-B-sx2qon.js");
		const results = [];
		for (const taskId of params.taskIds) {
