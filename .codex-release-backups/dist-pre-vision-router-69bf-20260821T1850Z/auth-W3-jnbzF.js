...
import { n as normalizeAgentModelRefForConfig } from "./model-input-ekSMR50U.js";
...
import { i as resolvePluginSetupRegistry, r as resolvePluginSetupProviderCore } from "./setup-registry-BT9DecfW.js";
...
import { n as clearAuthProfileCooldown } from "./usage-Cj2wt9Ks.js";
...
import { o as removeProviderAuthProfilesWithLock, r as promoteAuthProfileInOrder, u as upsertAuthProfileWithLockOrThrow } from "./profiles-CaIWIvwD.js";
import "./workspace-Bhf9rmeb.js";
import { n as stylePromptMessage } from "./prompt-style-BQVvtDcR.js";
import { t as isRemoteEnvironment } from "./remote-env-BUBg4WEy.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-B-PbVckh.js";
...
import { a as resolveKnownAgentId, l as updateConfig, r as loadValidConfigOrThrow } from "./shared-Dc7Dqsc7.js";
import { r as repairCodexRuntimePluginInstallForModelSelection } from "./codex-runtime-plugin-install-DzXm_CH9.js";
import { n as repairCopilotRuntimePluginInstallForModelSelection } from "./copilot-runtime-plugin-install-BS7wteWG.js";
import { t as refreshRunningGatewayAuthState } from "./auth-refresh-BoVoQ8Eg.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: params.openUrl ?? (async (url) => {
			const { openUrl } = await import("./onboard-helpers-BTdKJ26T.js");
			await openUrl(url);
		}),
