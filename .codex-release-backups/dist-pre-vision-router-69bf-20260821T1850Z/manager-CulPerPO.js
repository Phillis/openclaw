...
import { a as toAcpRuntimeError, n as AcpRuntimeError, o as withAcpRuntimeErrorBoundary, r as formatAcpErrorChain, t as ACP_ERROR_CODES } from "./errors-CIvv7cvF.js";
...
import { a as buildRuntimeConfigOptionPairs, c as mergeRuntimeOptions, d as resolveRuntimeConfigOptionKey, f as resolveRuntimeOptionsFromMeta, g as validateRuntimeModeInput, i as resolveTurnTimeoutMs, l as normalizeRuntimeOptions, m as validateRuntimeConfigOptionInput, n as awaitTurnWithTimeout, o as buildRuntimeControlSignature, p as runtimeOptionsEqual, r as cleanupTimedOutTurn, s as inferRuntimeOptionPatchFromConfigOption, v as validateRuntimeOptionPatch } from "./manager.turn-timeout-C3qUh0vl.js";
import { f as recordSessionHumanDirectMessage, h as recordSubagentTerminalState } from "./session-state-events-DTKQ6kKc.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-CGsNTeFU.js";
import { n as resolveRequiredCompletionTerminalResult } from "./task-completion-contract-BJW3TUQJ.js";
import { r as requireAcpRuntimeBackend, t as getAcpRuntimeBackend } from "./registry-_hZm0hSC.js";
import { n as readAcpSessionEntry, s as upsertAcpSessionMeta, t as listAcpSessionEntries } from "./session-meta-8cwXEOoU.js";
...
var ManagerRuntimeHandleCache = class {
	...
	async closeAll(params) {
		await Promise.all(this.runtimeCache.snapshot().map(({ actorKey }) => params.actorQueue.run(actorKey, async () => {
			await this.close({
				sessionKey: actorKey,
				reason: params.reason
			});
...
//#endregion
export { disposeAcpSessionManagerInstance as a, isAcpTurnActive as i, testing as n, resolveAcpSessionResolutionError as o, AcpSessionManager as r, getAcpSessionManager as t };
