...
import { a as disposeAcpSessionManagerInstance, t as getAcpSessionManager } from "./manager-ROoWPv7n.js";
...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-CsEbZAnG.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./agent-bundle-lsp-runtime-DKg_Yr6A.js");
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-SSjh4mDv.js");
