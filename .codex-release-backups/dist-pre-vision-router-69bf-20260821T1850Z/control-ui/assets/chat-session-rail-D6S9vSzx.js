import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{T as t,w as n}from"./control-ui-foundation-D1iiKpDl.js";import{Cl as r,Tl as i,cl as a,ct as o,dl as s,ll as c,lt as l,rl as u,ut as d}from"./control-ui-core-DlOws3wb.js";import{K as f,Q as p,W as m,Y as h,_ as g,b as _,i as v,it as y,n as b,nt as x}from"./lit-runtime-2JvyKfXq.js";import{Vn as S,gr as C,vr as w,yr as T}from"./control-ui-core-BYUpSfbW.js";import{o as E,t as D}from"./control-ui-core-CBoYiroi.js";import{n as O,t as k}from"./markdown-C_prux_4.js";import{n as A,t as j}from"./text-direction-CXPaoMQD.js";function M(e){return e.digest?e.running?e.activeRunId&&e.digest.runId===e.activeRunId?e.digest:null:e.digest:null}function N(e,t){return(e.health===`done`||e.health===`failed`)&&(t??0)<e.updatedAt}function P(e){return E(`chat.rail.health.${e}`)}function F(e){return E(`chat.pullRequests.${e===`draft`?`draft`:e}`)}function I(e){let t=e.checks;return t?t.state===`passing`?E(`chat.rail.checksPassing`,{count:String(t.passed)}):t.state===`failing`?E(`chat.rail.checksFailing`,{count:String(t.failed)}):E(`chat.rail.checksPending`,{count:String(t.running)}):null}function L(e){let t=e.status===`completed`?`✓`:e.status===`in_progress`?`→`:`·`;return h`
...
//# sourceMappingURL=chat-session-rail-D6S9vSzx.js.map