import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{K as t,W as n,Y as r}from"./lit-runtime-2JvyKfXq.js";import{o as i,t as a}from"./control-ui-core-Kf-GC625.js";import{n as o,t as s}from"./workboard-widget-IF7YbEdj.js";var c,l;e((()=>{n(),a(),o(),c=class extends s{async handleStatusChange(e){let t=this.readStringProp(`cardId`),n=this.cards.find(e=>e.id===t),r=e.currentTarget.value;!n||!this.statuses.includes(r)||await this.moveCard(n,r)}render(){let e=this.readStringProp(`cardId`);if(!e)return r`<p class="workboard-widget__state" role="alert">
...
//# sourceMappingURL=workboard-card-DGRMqmJr.js.map