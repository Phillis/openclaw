...
import { x as BrowserProfileUnavailableError } from "./tmp-openclaw-dir-BdU80KeH.js";
import "./config-uXYwN4Wa.js";
import { d as markBrowserRuntimeStopping, r as beginProfileTransition, s as isBrowserRuntimeRunning } from "./server-context.lifecycle-RlMzFvzo.js";
import { a as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context-DcOhxcxT.js";
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-BIXp-_dN.js";
...
async function stopBrowserRuntimeInternal(params, finalizeGlobalAdapters) {
	...
	if (finalizeGlobalAdapters) try {
		const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-C1zJwXpS.js");
...
//#endregion
export { withBrowserControlStart as a, stopBrowserRuntime as c, stopBrowserControlRuntime as i, ensureBrowserControlRuntime as n, createBrowserRuntimeState as o, getBrowserControlState as r, stopBrowserBridgeRuntime as s, createBrowserControlContext as t };
