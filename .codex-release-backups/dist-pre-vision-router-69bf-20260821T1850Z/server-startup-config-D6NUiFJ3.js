...
import { f as readConfigFileSnapshotWithPluginMetadata, z as applyConfigOverrides } from "./io-BTBpQ7uO.js";
import { i as tryGetLegacyDefaultAgentId, r as retainLegacyDefaultAgentId, t as inheritLegacyDefaultAgentId } from "./legacy.default-agent-owner-0YGX8Nyg.js";
...
import { n as materializeLegacyDefaultAgentRoles } from "./legacy.roster-ESlKnWFu.js";
import { t as createInvalidConfigError } from "./io.invalid-config-D6XgN5OX.js";
import { n as isPluginPackagingRuntimeOutputInvalidConfigSnapshot } from "./recovery-policy-CsUZ07YX.js";
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-MHmQzVmS.js";
...
import { c as hasLegacyAuthProfileSourcesForStartup } from "./legacy-source-diagnostic-C-wLeKtj.js";
import { a as prepareSecretsRuntimeFastPathSnapshot, n as collectCandidateAgentDirs } from "./runtime-fast-path-B-z8c8az.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = createLazyPromise(() => import("./runtime-DK3IGqMB.js"), { cacheRejections: true });
	const loadAuthProfiles = createLazyPromise(() => import("./auth-profiles-DkT9pQEE.js"), { cacheRejections: true });
