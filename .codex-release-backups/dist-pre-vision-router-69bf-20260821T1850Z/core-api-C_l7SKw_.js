...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-C1vMek6l.js";
import { D as parseBrowserErrorPayload, X as withTimeout } from "./tmp-openclaw-dir-BWJz6hlD.js";
import "./control-auth-2FlbLpRg.js";
import "./chrome-DmBcqt_B.js";
import "./trash-BVb5P5AJ.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-jMH62Sba.js";
import "./sdk-setup-tools-CaC485-K.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-DqkD4sni.js";
import "./routes-ChelKskL.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-RSwUoYcX.js";
import { s as stopBrowserBridgeRuntime, t as createBrowserControlContext } from "./browser-control-state-D6OadZx6.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-Djg43nVq.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-BOQ98JMN.js"), import("./routes-D47KwFh5.js")]);
