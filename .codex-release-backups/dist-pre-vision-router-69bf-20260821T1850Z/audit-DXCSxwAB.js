...
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./permissions-CaeiXnMq.js";
...
import { n as hasAgentRosterProperty, r as listAgentEntries, y as tryResolveDefaultAgentId } from "./agent-scope-config-CsnnOL14.js";
...
import { c as resolvePluginControlPlaneWorkspace } from "./plugin-registry-snapshot-CxbzdC9E.js";
import { o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-CUsZYmpD.js";
import "./audit-fs-D5Is7hSS.js";
...
import { H as resolveExecModePolicy, K as loadExecApprovals } from "./exec-approvals-Bzza0Zxs.js";
...
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-DlryMXDl.js";
import { t as resolveExecDefaults } from "./exec-defaults-BrbKy5xz.js";
import { r as materializeGatewayAuthSecretRefs, t as canMaterializeGatewayAuthSecretRefsWithoutExec } from "./auth-config-utils-BcjWmOu8.js";
import { n as normalizeConfiguredTrustedSafeBinDirs, t as normalizeConfiguredSafeBins } from "./exec-safe-bin-config-BowPstR_.js";
import { o as readControlUiDeviceAuthMigrationState } from "./control-ui-device-auth-migration-BvJQE9HI.js";
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-Bv2r7TNj.js";
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-S5mGEBtw.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-SdHGqS42.js";
import { t as collectExecFilesystemPolicyDriftHits } from "./exec-filesystem-policy-CEj0yBYK.js";
...
const loadReadOnlyChannelPlugins = createLazyRuntimeModule(() => import("./read-only-BD5NmmaQ.js"));
...
const loadPluginMetadataRegistryLoaderModule = createLazyRuntimeModule(() => import("./metadata-registry-loader-yPMRkcfT.js"));
const loadPluginAutoEnableModule = createLazyRuntimeModule(() => import("./plugin-auto-enable-CUirmOI6.js"));
const loadChannelPluginIdsModule = createLazyRuntimeModule(() => import("./channel-plugin-ids-DQa7NuQe.js"));
const loadPluginRuntimeModule = createLazyRuntimeModule(() => import("./runtime-CpklIiXa.js"));
const loadGatewayProbeDeps = createLazyRuntimeModule(() => Promise.all([
	import("./call-DrR5WyUw.js"),
	import("./probe-auth-CNzzLpez.js"),
	import("./probe-C5Qk_-s4.js")
