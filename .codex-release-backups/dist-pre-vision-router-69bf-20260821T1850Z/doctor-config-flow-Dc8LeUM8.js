...
import { d as resolveAgentWorkspaceDir, o as readAgentRosterProperty, x as tryResolveSoleAgentId } from "./agent-scope-config-CsnnOL14.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-BRqK6RmF.js";
import "./session-key-D8GLfPr_.js";
import { J as resolveNormalizedProviderModelMaxTokens, ct as containsAuthoredInclude, lt as isSingleTopLevelIncludeMigration, ot as applyChannelDoctorCompatibilityMigrations, st as classifyOtelGrpcMigrationOwnership } from "./io-BTBpQ7uO.js";
import { t as createSubsystemLogger } from "./subsystem-DNgaGOch.js";
import { s as HeartbeatSchema } from "./zod-schema.agent-runtime-2QFZPjK2.js";
import { _ as parseLegacySecretRefEnvMarker, u as isLegacySecretRefEnvMarker } from "./types.secrets-BrIfhxSG.js";
import { i as getBundledChannelSetupPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-lDYhdxhX.js";
import { r as collectConfiguredModelRefs } from "./configured-model-refs-0XUAFjEF.js";
import { _ as selectedCanonicalModelRefsForRuntimePolicy, d as migrateLegacyWebSearchConfig, f as migrateLegacyXSearchConfig, g as modelEntryWithRuntimePolicy, h as migrateLegacyRuntimeModelRef, l as stripRetiredTuningKnobs, m as listLegacyRuntimeModelProviderAliases, p as legacyRuntimeModelAliasRequiresRuntimePolicy, u as migrateLegacyWebFetchConfig, v as hasOwnKey } from "./legacy-KwIPIjLH.js";
import { r as isLegacyModelsAddCodexMetadataModel } from "./legacy-config-migrations.runtime.models-tMQJARxG.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { r as retainLegacyDefaultAgentId } from "./legacy.default-agent-owner-0YGX8Nyg.js";
import { a as isBlockedLegacyCodexModelRef } from "./codex-route-model-ref-WCq2iqcj.js";
import { n as formatConfigIssueLines } from "./issue-format-wyiFLwqS.js";
import { t as migratePersistedImplicitMainRoster } from "./legacy.roster-ESlKnWFu.js";
import { r as normalizeTalkSection } from "./talk-DHvIaHsU.js";
import { t as configIncludeOwnsAgentRoster } from "./agent-roster-provenance-b5BXVOca.js";
import { i as setPathExistingStrict } from "./path-utils-ED_buFn9.js";
import { n as discoverConfigSecretTargets } from "./target-registry-query-DrkDbq93.js";
import "./target-registry-RlAyK6k0.js";
import { s as callGateway } from "./call-CZ1eu88h.js";
import { a as runPluginSetupConfigMigrations } from "./setup-registry-BT9DecfW.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-UBNiBOzj.js";
import { n as resolveSingleAccountPromotion } from "./setup-promotion-helpers-D7YKLKZm.js";
import { t as note } from "./note-C_xoKlB9.js";
import { a as noteOpencodeProviderOverrides, c as stripUnknownConfigKeys, i as noteMcpOriginWarning, n as noteImplicitFallbackClobberWarnings, o as noteSandboxOriginProxyWarning } from "./doctor-config-analysis--_78vSq1.js";
import { t as migrateLegacyConfig } from "./legacy-config-migrate-DEI20RUm.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-C4l2UjPx.js";
import { n as cronCodexRuntimePolicyTargetKey } from "./store-migration-DtfJU400.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { createDoctorPluginMetadataSnapshotScope } = await import("./plugin-metadata-snapshot-scope-B4RGju8d.js");
	...
	const { collectBlockedLegacyOpenAICodexProviderPlan } = await import("./legacy-config-migrations.runtime.models-CmwvYg_r.js");
	...
	if (preflight.cronCodexRuntimePolicyTargets?.length) {
		const { repairCronCodexRuntimePolicies } = await import("./runtime-policy-migration-x4S3vKuZ.js");
	...
	const { prepareRetiredPhoneControlCleanup } = await import("./doctor-retired-phone-control-gzDghK6Z.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-CUirmOI6.js");
	applyConfigMutation(runWithCurrentPluginMetadata(state.candidate, () => applyPluginAutoEnable({
		config: state.candidate,
		env: process.env
	})), { fixHint: `Run "${doctorFixCommand}" to apply these changes.` });
	if (!shouldRepair) {
		const { repairStaleAgentModelRefs } = await import("./stale-agent-model-ref-repair-GJVlDPrf.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DHz3Ajc4.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-Bih85zKh.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-DZYKS4sM.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-bNlO8K1P.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-7gLStb9d.js");
	...
	if (configuredOpencodePluginIds.length > 0) {
		const { resolveEnabledProviderPluginIds } = await import("./providers-BrsKMBdL.js");
