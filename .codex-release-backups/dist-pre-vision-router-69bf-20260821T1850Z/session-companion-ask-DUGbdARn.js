...
import { i as resolveSimpleCompletionSelectionForAgent } from "./simple-completion-runtime-DkOU1eq2.js";
...
async function defaultRun(params) {
	...
	const { prepareInternalSessionEffectsSession, removeInternalSessionEffectsSession } = await import("./internal-session-effects-ClmFN011.js");
	...
	try {
		const [{ SessionManager }, { runEmbeddedAgent }] = await Promise.all([import("./sessions-DA89pCg6.js"), import("./embedded-agent-BaC-L2QF.js")]);
