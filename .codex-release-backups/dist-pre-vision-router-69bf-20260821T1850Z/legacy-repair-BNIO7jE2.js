...
import { S as parseJsonWithJson5Fallback } from "./redact-DP7p9QfH.js";
...
import { It as migrateLegacyCronRunLogsToTaskRuns, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction, qt as parseCronRunLogEntryObject } from "./openclaw-state-db-BciZ4rHE.js";
import { n as TASK_SUGGESTION_TOOL_NAME, t as LEGACY_TASK_SUGGESTION_TOOL_NAME } from "./legacy-tool-name-migration-B58w1I1P.js";
import { v as MEMORY_DREAMING_SYSTEM_EVENT_TEXT } from "./dreaming-N16HL0CK.js";
import { a as loadCronJobsStoreWithConfigJobsReadOnly, f as saveCronJobsStore, i as loadCronJobsStoreWithConfigJobs, l as resolveCronJobsStorePath, p as saveCronJobsStoreWithMetadata, v as saveCronQuarantinedJobs } from "./store-DPYCi6M7.js";
import { J as cronStoreKey, g as getInvalidPersistedCronJobReason, v as normalizeCronJobInput } from "./row-codec-RY4IJt5w.js";
import { t as normalizeHttpWebhookUrl } from "./webhook-url-AutetAqs.js";
import { a as archiveLegacyCronStoreForMigration, c as loadLegacyCronStoreForMigration, i as archiveLegacyCronFile, l as resolveLegacyCronMigrationId, n as cronCodexRuntimePolicyTargetKey, o as assertLegacyCronMigrationSourceCurrent, r as normalizeStoredCronJobs, s as legacyCronStoreFilesExist, t as collectStoredCronCodexRuntimePolicyTargets } from "./store-migration-DtfJU400.js";
import { t as planCronCodexRefRewriteAgainstPersistedConfig } from "./runtime-policy-migration-Bdv7QMyk.js";
...
function formatLegacyIssuePreview(issues) {
	...
	if (issues.legacyTaskSuggestionToolName) lines.push(`- ${pluralize$1(issues.legacyTaskSuggestionToolName, "job")} still grants legacy tool \`${LEGACY_TASK_SUGGESTION_TOOL_NAME}\`; doctor will rename it to \`${TASK_SUGGESTION_TOOL_NAME}\``);
...
//#endregion
export { repairLegacyCronStoreWithoutPrompt as a, formatScheduledToolPolicyAdvisory as c, countStaleDreamingJobs as d, repairCronCodexModelRefsAfterConfigWrite as i, formatUnresolvedCommandPromptAdvisory as l, collectCronCodexRuntimePolicyTargetsReadOnly as n, formatIncompleteInheritedAuthorityAdvisory as o, loadLegacyCronRepairState as r, formatLegacyIssuePreview as s, applyLegacyCronStoreRepair as t, formatUnresolvedShellPromptAdvisory as u };
