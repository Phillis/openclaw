...
import { C as parseStrictNonNegativeInteger, S as parseStrictInteger, p as clampPositiveTimerTimeoutMs, s as asFiniteNumber, w as parseStrictPositiveInteger, x as parseStrictFiniteNumber } from "./number-coercion-oCkfUEEq.js";
...
import { u as pathScope } from "./fs-safe-X_oyl7Rx.js";
import { c as resolveUserPath } from "./home-dir-DcrXWQPU.js";
import { r as formatErrorMessage } from "./errors-CqPTYU6G.js";
import { r as getRuntimeConfig } from "./io-BTBpQ7uO.js";
import { c as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-DIuCzlel.js";
...
import { a as ensureMediaDir, d as saveMediaBuffer } from "./store-CvNsGg9Z.js";
import { t as expectDefined } from "./expect-runtime--WgnKYXT.js";
import "./number-runtime-CoAPZzJY.js";
import "./string-coerce-runtime-D9ocX9lc.js";
import "./text-utility-runtime-BSdEoze8.js";
import { n as redactCdpUrl, t as parseBrowserHttpUrl } from "./browser-config-DZOFWPb4.js";
import { n as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, r as DEFAULT_AI_SNAPSHOT_MAX_CHARS, u as DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS } from "./constants-0X-2im2J.js";
import { a as normalizeActBoundedNonNegativeMs, n as ACT_MAX_VIEWPORT_DIMENSION, r as ACT_MAX_WAIT_TIME_MS, t as ACT_MAX_CLICK_DELAY_MS, u as resolveBrowserNavigationTimeoutMs } from "./act-policy-BrghP9Kf.js";
...
import { a as resolveProfile, i as resolveManagedBrowserHeadlessMode, l as resolveExistingUploadPaths, n as getOwnBrowserProfile, o as DEFAULT_DOWNLOAD_DIR, r as resolveBrowserConfig, s as DEFAULT_TRACE_DIR } from "./config-CbBrXkzY.js";
import { A as withCdpSocket, E as BrowserValidationError, O as toBrowserErrorResponse, T as BrowserTargetAmbiguousError, b as BrowserProfileNotFoundError, j as normalizeBrowserTimerDelayMs, n as assertCdpEndpointAllowed, u as redactCdpErrorText, v as BrowserConflictError, w as BrowserTabNotFoundError, x as BrowserProfileUnavailableError, y as BrowserError } from "./tmp-openclaw-dir-BdU80KeH.js";
import "./config-uXYwN4Wa.js";
import "./errors-D_Aa-JBp.js";
import { a as isValidProfileName, i as setDefaultBrowserProfile, n as deleteBrowserProfileConfig, t as createBrowserProfileConfig } from "./config-mutations-CIwkKwHy.js";
import { D as CONTENT_ROLES, H as resolveBrowserExecutableForPlatform, I as withBrowserNavigationPolicy, N as assertBrowserNavigationResultAllowed, O as INTERACTIVE_ROLES, T as getRoleSnapshotIdentityKeys, _ as getMainFrameDocumentIdentityViaCdp, b as snapshotRoleViaCdp, j as assertBrowserNavigationAllowed, k as STRUCTURAL_ROLES, l as ensureOutputDirectory, m as captureScreenshot, n as getChromeWebSocketEndpoint, s as resolveOpenClawUserDataDir, w as finalizeRoleSnapshot, x as appendRoleSnapshotDepthTruncationMarker, y as snapshotAria, z as resolveBrowserNavigationProxyMode } from "./chrome-BuKzHtxc.js";
import { a as getOrCreateProfileRuntime, g as getPwAiModule$1, l as isProfileRestartRequiredError, o as getProfileLifecycle, r as beginProfileTransition } from "./server-context.lifecycle-RlMzFvzo.js";
import { f as ChromeMcpDocumentUnavailableError } from "./chrome-mcp-contracts-jS-VxzDL.js";
import { i as shouldUsePlaywrightForScreenshot, n as resolveDefaultSnapshotFormat, r as shouldUsePlaywrightForAriaSnapshot, t as getBrowserProfileCapabilities } from "./profile-capabilities-BlUTzZZq.js";
import { r as resolveCdpControlPolicy, t as movePathToTrash } from "./trash-CUoVhznV.js";
import { S as withChromeMcpDocument, _ as resizeChromeMcpPage, b as takeChromeMcpSnapshot, d as fillChromeMcpElement, f as fillChromeMcpForm, g as pressChromeMcpKey, h as navigateChromeMcpPage, l as dragChromeMcpElement, m as hoverChromeMcpElement, o as clickChromeMcpCoords, r as getChromeMcpPid, s as clickChromeMcpElement, u as evaluateChromeMcpScript, x as uploadChromeMcpFile, y as takeChromeMcpScreenshot } from "./chrome-mcp-BBc0-pf7.js";
import { i as resolveTargetIdFromTabs, r as withProfileContextOperation } from "./server-context-DcOhxcxT.js";
import { n as importSystemProfileCookies, r as listSystemProfiles } from "./system-profiles-DH7jsU46.js";
import "./sdk-setup-tools-BVECsAnW.js";
import { a as scaleAnnotations, l as matchBrowserUrlPattern, s as normalizeBrowserFormField, t as appendSnapshotUrls, u as normalizeBrowserEvaluateFunctionSource } from "./snapshot-urls-xkh7aq-p.js";
		...
		await withRouteTabContext({
			...
			run: async ({ profileCtx, tab, cdpUrl, signal }) => {
				if (getBrowserProfileCapabilities(profileCtx.profile).usesChromeMcp) {
					...
					if (labels) {
						const built = buildChromeMcpRouteSnapshot({ root: await takeChromeMcpSnapshot(operation) });
