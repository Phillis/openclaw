...
import { w as listTaskRecordPage, x as getTaskById } from "./task-registry-CvGhDB6M.js";
...
import { i as retrySubagentCompletionDelivery, n as dismissSubagentCompletionDelivery } from "./subagent-completion-delivery-CtMn_dXG.js";
...
const tasksHandlers = {
	...
	"tasks.dismiss": async ({ params, respond }) => {
		...
		const { discardSubagentTerminalDelivery } = await import("./subagent-registry-Bvicpfnu.js");
		const results = [];
		for (const taskId of params.taskIds) {
