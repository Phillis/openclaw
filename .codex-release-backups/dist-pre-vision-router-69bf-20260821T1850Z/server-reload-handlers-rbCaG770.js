...
import { l as clearLoadInstalledPluginIndexInstallRecordsCache, n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-CDDyVBh4.js";
import { b as requireActivePluginChannelRegistry } from "./runtime-LV4GwzTm.js";
...
import { b as resolveConfigWriteFollowUp, c as getRuntimeConfigSourceSnapshot, o as getRuntimeConfigSnapshotMetadata, u as hashRuntimeConfigValue, w as setRuntimeConfigAppliedHash } from "./runtime-snapshot-DIuCzlel.js";
import { n as formatConfigIssueLines } from "./issue-format-wyiFLwqS.js";
import { t as getConfigValueAtPath } from "./config-paths-BEzXwpUS.js";
import "./config-CfeGo4K4.js";
import { n as isRestartEnabled } from "./commands.flags-CZN5Wwe1.js";
import { i as getActiveGatewayRootWorkCount, m as runWithGatewayIndependentRootWorkAdmission, p as runOutsideGatewayRootWorkAdmission } from "./gateway-work-admission-BNrqZgKC.js";
import { f as setGatewaySigusr1RestartPolicy, l as resolveGatewayRestartDeferralTimeoutMs, r as deferGatewayRestartUntilIdle } from "./restart-1kwnPu0v.js";
...
import { d as rejectPendingPreparedModelRuntimeReplacement, s as markPreparedModelRuntimeSnapshotsStale, u as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-BK-D17bD.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { i as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-CoJbRIQ2.js";
import { d as getActiveEmbeddedRunCount } from "./run-state-B57mLF-g.js";
import { i as refreshContextWindowCache } from "./context-GlVEvpHA.js";
...
import { c as getTotalQueueSize } from "./command-queue-B992TXUy.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-BMqG9Z0R.js";
...
import { r as resetDirectoryCache } from "./target-resolver-CGGzW-47.js";
import { n as disposeAllSessionMcpRuntimes } from "./agent-bundle-mcp-manager-api-gNVONHel.js";
import "./agent-bundle-mcp-tools-DaBvOF2o.js";
import { c as getActiveSecretsRuntimeSnapshotRevisionState, g as hasSameSecretReloadContract, l as getActiveSecretsRuntimeSnapshotState, p as hasActiveSecretsRuntimeSnapshotLineage, r as clearSecretsRuntimeSnapshotState, x as setSecretsRuntimeSourceSnapshotIfCurrent, y as restoreSecretsRuntimeSourceSnapshotIfLineageCurrent } from "./runtime-state-CR1A1dve.js";
import { b as resolveHooksConfig, t as commitHooksConfigReload } from "./hooks-D8jusujg.js";
import { n as resetSkillSnapshotConfigFingerprintCache } from "./snapshot-config-fingerprint-DWHCYJul.js";
import { n as diffGatewayReloadPaths, t as diffConfigPaths } from "./config-diff-DEody4JD.js";
import { i as listPluginInstallWholeRecordPaths, n as isNoopGatewayReloadPlan, r as listPluginInstallTimestampMetadataPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DC3PyzEP.js";
...
import { t as buildGatewayCronService } from "./server-cron-Dfc3l3aT.js";
import { t as invalidateConfigGetResponseCache } from "./config-get-response-CJJB7iDm.js";
...
import { i as startGatewayCronWithLogging } from "./server-runtime-services-lDStmHoG.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-B9Wkal6E.js";
import { r as publishRuntimeSecretsStateTransition } from "./server-startup-config-D6NUiFJ3.js";
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				...
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-B-9bPGFe.js"), import("./gmail-watcher-lifecycle-GaqJwsSa.js")]);
...
async function activateSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, options) {
	const runtime = await import("./runtime-DK3IGqMB.js");
...
async function restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, options) {
	if (!(await import("./runtime-DK3IGqMB.js")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, { runtimeSourceConfig: options?.runtimeSourceConfig })) return false;
	options?.onActivated?.();
	return true;
}
...
function startManagedGatewayConfigReloader(params) {
	...
	const { applyHotReload, acceptRestartConfig, beginGatewayRestartLifecycle, pauseGatewayRestartForConfigCandidate, publishAppliedConfigHash, publishAcceptedRestartTarget, publishDeferredAppliedConfigHash, recordAcceptedRestartTarget, requestGatewayRestart, restoreConservativeRestartDebt, stopRestartRetries } = createGatewayReloadHandlers({
		...
		assertRestartReady: () => import("./openclaw-database-preflight-DXYZASdW.js").then(({ assertOpenClawDatabasesReadyForRestart }) => assertOpenClawDatabasesReadyForRestart({ env: process.env })),
		restartRecoveryAvailable,
