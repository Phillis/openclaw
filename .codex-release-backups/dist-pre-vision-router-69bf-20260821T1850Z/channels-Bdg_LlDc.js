...
import { r as createMessageActionDiscoveryContext, u as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-B7Ggqfek.js";
...
import { s as getChannelsCommandSecretTargetIds } from "./command-secret-targets-JklITWYj.js";
import { t as createClackPrompter } from "./clack-prompter-FYG9QoOA.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-BKzvLf8b.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-ebGkpG5c.js";
import { n as resolveLogFile } from "./log-tail-BeiUMg5b.js";
...
import { i as prepareChannelAccountRemoval, n as channelLabel, r as applyPreparedChannelAccountRemoval, t as channelsAddCommand } from "./add-DBX7cDlS.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidChannelConfig } from "./shared-BcvIjl9U.js";
import { t as channelsListCommand } from "./list-BYskkHy_.js";
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-BxU3czGW.js");
