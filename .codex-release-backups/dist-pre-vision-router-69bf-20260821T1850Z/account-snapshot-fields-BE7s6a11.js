...
function projectSafeChannelAccountSnapshotFields(account) {
	...
	setSnapshotField(snapshot, "socketModeConnectionCount", asFiniteNumber(record.socketModeConnectionCount));
	setSnapshotField(snapshot, "socketModeConnectionCountObservedAt", readNullableNumber(record, "socketModeConnectionCountObservedAt"));
	setSnapshotField(snapshot, "socketModeSharedConnection", asBoolean(record.socketModeSharedConnection));
