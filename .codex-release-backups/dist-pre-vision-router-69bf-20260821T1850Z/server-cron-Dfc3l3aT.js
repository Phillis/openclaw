...
import { A as testRegexWithBoundedInput, O as compileSafeRegex, u as redactToolPayloadText } from "./redact-DP7p9QfH.js";
...
import { a as listAgentIds, d as resolveAgentWorkspaceDir, l as resolveAgentDir, p as resolveDefaultAgentId, r as listAgentEntries, s as resolveAgentConfig } from "./agent-scope-config-CsnnOL14.js";
import { c as parseAgentSessionKey } from "./session-key-utils-D8x_bjrd.js";
import { b as toAgentStoreSessionKey, f as resolveAgentIdFromSessionKey, p as resolveEventSessionKey } from "./session-key-D8GLfPr_.js";
...
import { i as tryGetLegacyDefaultAgentId, n as resolveSessionStoreCompatibilityAgentId } from "./legacy.default-agent-owner-0YGX8Nyg.js";
...
import { A as resolveCronNotificationSessionKey, C as markCronStreamBatchTruncated, R as resolveCronScheduledToolPolicy, S as cronStreamScheduleKey, T as truncateCronStreamBatch, j as resolveCronSessionTargetSessionKey, k as resolveCronDeliverySessionKey, w as resolveCronStreamBatching } from "./row-codec-RY4IJt5w.js";
...
import { c as resolveSystemMainSessionTarget, n as canonicalizeMainSessionAlias, r as resolveAgentMainSessionKey } from "./main-session-Dth0X5B9.js";
import { n as listConfiguredSessionStoreAgentIds, r as listKnownSessionStoreAgentIds } from "./targets-CdQ3kEkv.js";
...
import { s as enqueueSystemEventWithReceipt } from "./system-events-DecgSLEt.js";
import { t as abortAndDrainEmbeddedAgentRun } from "./runs-CQbSP9aq.js";
import "./sessions-Bh837xaa.js";
import { _ as resolveCronJobBoundSessionKeys, d as bumpSessionAutomationVersion, f as claimSessionAutomationEpoch, h as unregisterSessionAutomationSource, m as registerSessionAutomationSource } from "./session-utils-row-xwseApeF.js";
...
import { s as waitForActiveCronTaskRuns, t as abortActiveCronTaskRuns } from "./active-run-cancellation-DsAOvXZX.js";
...
import { g as createToolSearchCatalogRef, v as registerHeadlessToolSearchCatalog } from "./tool-search-DXezdhF8.js";
import { n as resolveSandboxContext } from "./context-BwBSG27A.js";
import "./sandbox-BdXgHoEY.js";
import { n as resolveCronStoredDeliveryContext } from "./delivery-context-XEQGmC2_.js";
import { t as normalizeHttpWebhookUrl } from "./webhook-url-AutetAqs.js";
import { r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-D_uFFO7I.js";
...
import { r as resolveMainScopedEventSessionKey } from "./event-session-routing-BbL5gxty.js";
...
import { n as listConfiguredMessageChannels } from "./channel-selection-Cbm6guXC.js";
import { a as runCodeModeScriptHeadless, o as CodeModeHeadlessAbortError, s as CodeModeHeadlessTimeoutError } from "./tool-surface-plan-DAvXt0ck.js";
import { C as cronFailureDetailLines, i as errorBackoffMs } from "./jobs-scheduling-BSkKV8yE.js";
import { r as applyJobPatch } from "./list-snapshot-revision-CMqts_Py.js";
...
import "./embedded-agent-XLhLxvRM.js";
...
import { t as buildGatewaySessionEventFields } from "./session-event-payload-CnQLz63y.js";
import { t as resolveScheduledToolPolicyContext } from "./scheduled-tool-policy-d3EFqVDG.js";
import { r as runHeartbeatOnce } from "./heartbeat-runner-Cqeq0suM.js";
import { n as resolveHeartbeatMonitorSpecs, t as heartbeatMonitorAgentId } from "./heartbeat-monitor-IyRz-PrD.js";
import { n as resolveCronActiveRuntimeConfig, r as resolveCronAgentConfig, t as runCronIsolatedAgentTurn } from "./isolated-agent-BM8S6sIi.js";
import { t as resolveDeliveryTarget } from "./delivery-target-D3ZijEK4.js";
import { h as retryTransientDirectCronDelivery } from "./delivery-dispatch-policy-DqgHsqFr.js";
...
async function sendFailureNotificationAnnounce(deps, cfg, agentId, jobId, target, payload) {
...
function createCronExitWatchers(params) {
	...
	const arm = (job, consecutiveFailures = 0) => {
		...
		const persistWatcherState = async (patch) => {
			if (!params.updateWatcherState) return;
			try {
...
function dispatchCronFailureDestinationNotifications(params) {
	if (!params.job || params.job.delivery?.bestEffort === true) return;
	...
	if (params.evt.status !== "error" && (!deliveryFailed || !failureDest)) return;
	...
	if (failureDest) {
		...
		if (failureDest.mode !== "announce") return;
	}
	...
	const failureAlertText = [`Automation "${job.name}" ${params.evt.status === "error" ? "failed" : "delivery failed"}`, ...cronFailureDetailLines(job.state.lastErrorReason)].join("\n");
	dispatchDetachedCronNotification({
		jobId: job.id,
		logger: params.logger,
		deliver: () => sendFailureNotificationAnnounce(params.deps, runtimeConfig, agentId, job.id, announceTarget, { text: appendCronRunStarted(`⚠️ ${failureAlertText}`, params.evt.runAtMs, runtimeConfig) })
	});
}
//#endregion
