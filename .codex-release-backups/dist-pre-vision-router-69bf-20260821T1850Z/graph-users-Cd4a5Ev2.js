...
import { t as readSecretFile } from "./secret-read-async-BPDyqQv7.js";
...
import { b as ssrfPolicyFromHttpBaseUrlAllowedOrigin, u as isPrivateIpAddress } from "./ssrf-CQ4RdJXm.js";
...
import { h as resolveProviderOperationTimeoutMs, n as createProviderOperationDeadline } from "./shared-DEePW_9S.js";
...
import "./secret-file-ChG2slmJ.js";
import { a as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist, r as isHttpsUrlAllowedByHostnameSuffixAllowlist } from "./ssrf-policy-u8sGC1hi.js";
...
import { c as createMSTeamsHttpError, n as refreshMSTeamsDelegatedTokens } from "./oauth.token-BGsoAjZI.js";
...
const loadSdkModules = createLazyRuntimeModule(() => Promise.all([import("./dist-DSpj4SFP.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-rbN-pRbi.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([apps, api]) => ({
	App: apps.App,
