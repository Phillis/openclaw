...
import { l as asNonNegativeFiniteNumber, s as asFiniteNumber, u as asPositiveFiniteNumber } from "./number-coercion-oCkfUEEq.js";
...
import { t as normalizeManifestCommandAliases } from "./manifest-command-aliases-DFXNq8y7.js";
...
function normalizeStringOrNumber(value) {
	return normalizeOptionalString(value) ?? asFiniteNumber(value);
}
...
function normalizeOpenRouterPercentileCutoffs(value) {
	if (!isRecord(value)) return;
	const normalized = {
		...asFiniteNumber(value.p50) !== void 0 ? { p50: asFiniteNumber(value.p50) } : {},
		...asFiniteNumber(value.p75) !== void 0 ? { p75: asFiniteNumber(value.p75) } : {},
		...asFiniteNumber(value.p90) !== void 0 ? { p90: asFiniteNumber(value.p90) } : {},
		...asFiniteNumber(value.p99) !== void 0 ? { p99: asFiniteNumber(value.p99) } : {}
	};
	return Object.keys(normalized).length > 0 ? normalized : void 0;
}
function normalizeOpenRouterMetricPreference(value) {
	return asFiniteNumber(value) ?? normalizeOpenRouterPercentileCutoffs(value);
}
