...
import { c as isFileUrl, d as safeFileURLToPath, l as isWindowsDriveLetterPath, n as WINDOWS_RESERVED_DEVICE_NAMES, r as assertNoUnsafeDeviceReadPath, u as isWindowsNetworkPath } from "./read-open-flags-YbtjZqyj.js";
import { t as sameFileIdentity } from "./file-identity-BUNb7Cm3.js";
import { a as isPathInside, c as isSymlinkOpenError, i as isNotFoundPathError, s as isPathRelativeEscape } from "./path-CYL8StfC.js";
import { d as createAsyncDirectoryGuard, i as findExistingAncestor } from "./absolute-path-DBVN5h2m.js";
import { _ as resolveUserPath, a as guardedRenameSync, c as withAsyncDirectoryGuards, h as expandHomePrefix, p as syncDirectoryBestEffort, s as guardedRmSync } from "./pinned-write-CKWgTqHs.js";
import { i as root$1 } from "./root-impl-DNOINk8h.js";
import { u as getFsSafeTestHooks } from "./sidecar-lock-BeGYQ7Dw.js";
...
import { t as tempFile } from "./temp-target-Bxl-len5.js";
import { a as isGroupWritable, c as modeBits, i as isGroupReadable, o as isWorldReadable, r as inspectPathPermissions, s as isWorldWritable } from "./permissions-CaeiXnMq.js";
import { randomUUID } from "node:crypto";
import fs, { constants } from "node:fs";
import os from "node:os";
import path from "node:path";
import fs$1 from "node:fs/promises";
//#region ../../../../../../openclaw/node_modules/@openclaw/fs-safe/dist/filename.js
...
function trimWindowsIgnoredSuffix(value) {
	...
	while (end > 0) {
		...
		if (character !== 32 && character !== 46) break;
		end -= 1;
	}
...
function suffixWindowsReservedDeviceName(fileName) {
	...
	if (!WINDOWS_RESERVED_DEVICE_NAMES.has(deviceBaseName.toUpperCase())) return fileName;
...
function sanitizeUntrustedFileName(fileName, fallbackName) {
	...
	if (base.length > 200) {
		...
		if (trailingCodeUnit >= 55296 && trailingCodeUnit <= 56319) base = base.slice(0, -1);
	}
	return base;
}
//#endregion
//#region ../../../../../../openclaw/node_modules/@openclaw/fs-safe/dist/local-roots.js
function resolveLocalPathInput(input, label) {
	if (isFileUrl(input)) try {
...
function resolveLocalRootInput(input, label) {
	...
	const resolved = isFileUrl(trimmed) ? resolveLocalPathInput(trimmed, label) : expandHomePrefix(trimmed);
...
async function readLocalFileFromRoots(options) {
	...
	for (const rootDir of rootDirs) {
		...
		const relativePaths = [scopedRoot.rootDir, scopedRoot.rootReal].filter((rootPath, index, roots) => roots.indexOf(rootPath) === index).filter((rootPath) => isPathInside(rootPath, requestedPath)).map((rootPath) => path.relative(rootPath, requestedPath)).filter(Boolean);
...
//#endregion
//#region ../../../../../../openclaw/node_modules/@openclaw/fs-safe/dist/root-paths.js
...
//#endregion
//#region ../../../../../../openclaw/node_modules/@openclaw/fs-safe/dist/trash.js
...
//#endregion
//#region ../../../../../../openclaw/node_modules/@openclaw/fs-safe/dist/output-sibling.js
...
async function writeExternalFileViaSibling(params) {
	...
	try {
		...
		if (!renamed) cleanupComplete = await cleanupTempPath(tempPath, stagedIdentity);
		if (cleanupComplete) unregisterTempPath();
	}
}
//#endregion
//#region ../../../../../../openclaw/node_modules/@openclaw/fs-safe/dist/output.js
...
//#endregion
//#region ../../../../../../openclaw/node_modules/@openclaw/fs-safe/dist/secure-file.js
...
//#endregion
//#region ../../../../../../openclaw/node_modules/@openclaw/fs-safe/dist/walk.js
function validateWalkBudget(name, value) {
	if (value !== void 0 && (!Number.isSafeInteger(value) || value < 0)) throw new RangeError(`${name} must be a non-negative safe integer`);
}
function validateWalkOptions(options) {
	...
	if (options.symlinks !== void 0 && ![
		"skip",
		"follow",
		"include"
	].includes(options.symlinks)) throw new TypeError(`invalid walk symlink policy: ${String(options.symlinks)}`);
}
...
//#endregion
export { writeFileWithinRoot as a, readSecureFile as c, resolveExistingPathsWithinRoot as d, resolveStrictExistingPathsWithinRoot as f, sanitizeUntrustedFileName as h, writeExternalFileWithinRoot as i, movePathToTrash as l, resolveLocalPathFromRootsSync as m, readFileWithinRoot as n, walkDirectory as o, readLocalFileFromRoots as p, root as r, walkDirectorySync as s, ensureAbsoluteDirectory as t, pathScope as u };
