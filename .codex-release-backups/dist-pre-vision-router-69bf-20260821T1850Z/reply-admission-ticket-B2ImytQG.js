...
import { p as markReplyPayloadForSourceSuppressionDelivery } from "./reply-payload-DVcGHORx.js";
import { K as updateSessionEntry, Qt as loadSessionEntry, nt as sessionMatchesExpectedTranscriptTurn } from "./session-accessor-CIiPoGwM.js";
import { a as hasRestartRecoveryTerminalRun, i as hasRestartRecoverySourceClaim, t as buildRestartRecoveryClaimCleanupPatch } from "./restart-recovery-state-YPGO30LK.js";
import { a as classifyOAuthRefreshFailureError, r as buildOAuthRefreshFailureLoginCommand, s as formatOAuthRefreshFailureLoginCommandMarkdown } from "./oauth-refresh-failure-DXvwptD4.js";
import { a as isProviderAuthError } from "./model-auth-runtime-shared-C48YoQY0.js";
import { a as describeFailoverError, c as isFailoverError, o as findCliMaxTurnsError, s as findCliTimeoutError } from "./failover-error-DKFCUqL9.js";
import { n as sanitizeUserFacingText, t as renderUserFacingText } from "./user-facing-text-DAYCAcGX.js";
import { C as resolveProviderRequestFailureCopy, b as renderRateLimitReplyCopy, g as renderCliTimeoutReplyCopy, h as renderBillingReplyCopy, i as HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT, m as renderAuthProfileFailoverCopy, r as GENERIC_EXTERNAL_RUN_FAILURE_TEXT, v as renderMissingApiKeyReplyCopy, w as classifyProviderRequestFacets, y as renderRateLimitOrOverloadedCopy } from "./user-copy-BKvImQfV.js";
import { t as createDeferredCore } from "./deferred-D0La5CRk.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-BRAkqFXy.js";
import { c as resolveSilentReplyPolicy } from "./session-entry-handle-CZxMWW1P.js";
...
const tails = resolveGlobalMap(Symbol.for("openclaw.replyAdmissionTickets"));
...
function reserveReplyAdmissionTicket(sessionKeys) {
	...
	return {
		...
		release() {
			...
			released = true;
			finish();
			for (const { key, tail } of owned) tail.then(() => tails.get(key) === tail && tails.delete(key));
		}
	};
}
//#endregion
