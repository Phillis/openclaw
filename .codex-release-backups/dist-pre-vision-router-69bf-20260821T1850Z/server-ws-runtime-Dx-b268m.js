...
import { a as incrementPresenceVersion, r as getHealthVersion } from "./health-state-lkyaqtRL.js";
...
function attachGatewayWsMessageHandlerOnDemand(params) {
	...
	import("./message-handler-BX2fS28x.js").then(({ attachGatewayWsMessageHandler }) => {
