...
import { f as createChannelMessageAdapterFromOutbound, m as bindIngressLifecycleToReplyOptions } from "./channel-outbound-CI0BSGM5.js";
		...
		start: async () => {
			const bus = await startNostrBus({
				...
				onMessage: async (senderPubkey, text, reply, meta, lifecycle) => {
					...
					const { dispatchInboundDirectDm } = await import("./inbound-direct-dm-runtime-CtkkWcsR.js");
