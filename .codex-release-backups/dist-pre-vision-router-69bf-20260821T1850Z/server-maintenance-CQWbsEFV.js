...
import { c as prunePlaybackTranscodeCache, r as cleanOldMedia } from "./store-CvNsGg9Z.js";
import { s as prepareSystemAgentRunAdmission } from "./admitted-run-context-Dl2hrF3z.js";
import "./agent-run-terminal-outcome-CpRY9lPn.js";
...
import { u as pruneExpiredDeliveryQueueTombstones } from "./delivery-queue-sqlite-BQG-Kk03.js";
import { n as pruneOrphanedDeliveryQueueMedia } from "./delivery-queue-media-spool-DznhLCAO.js";
import { a as withSkillCollectionReviewClaim, i as isSkillCollectionReviewDue, o as MAX_RECONCILED_SKILL_BYTES, t as listWritableSkillCollection } from "./collection-reconcile-CQWO1EMz.js";
import { s as removeChatAbortControllerEntry, t as abortChatRunById } from "./chat-abort-9K8jqLDL.js";
import { t as chatAbortMarkerTimestampMs } from "./server-chat-state-DD3o03aT.js";
import { c as resolveWorktreeCleanupLimits, i as WORKTREE_GC_INTERVAL_MS, s as managedWorktrees } from "./service-BcZ9HgDx.js";
import { r as HEALTH_REFRESH_INTERVAL_MS, s as TICK_INTERVAL_MS, t as DEDUPE_MAX } from "./server-constants-DKuFNbQH.js";
import { c as pruneExpiredDevicePairSetupCompletions } from "./device-bootstrap-B0GG6gmu.js";
import { n as hasRegisteredChatRunForSessionKey } from "./session-active-runs-CaTtpnPN.js";
import "./server-shared-C-7Ahu3n.js";
import { t as createManagedWorktreeOwnerProtection } from "./owner-protection-D3fgd6XV.js";
...
import { s as setBroadcastHealthUpdate } from "./health-state-lkyaqtRL.js";
...
function startGatewayMaintenanceTimers(params) {
	...
	const runManagedOutgoingMediaGc = params.runManagedOutgoingMediaGc ?? (async () => {
		const { cleanupManagedOutgoingMediaRecords } = await import("./managed-image-attachments-DXjnH12h.js");
