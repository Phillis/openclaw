...
import { i as isMessagingToolDeliveryAction, n as isMessageToolSendActionName, t as isMessageToolConversationCreateActionName } from "./embedded-agent-messaging-DuLq2wI6.js";
...
function hasExplicitMessageRoute(args) {
	if (EXPLICIT_MESSAGE_ROUTE_KEYS.some((key) => hasNonEmptyString(args[key]))) return true;
...
function isDeliveredMessageToolOnlySourceReplyResult(params) {
	...
	if (normalizeToolPolicyName(params.toolName) !== MESSAGE_TOOL_NAME) return false;
	const args = asOptionalRecord(params.args) ?? {};
...
//#endregion
export { resolveMessageToolSourceReplyFinal as a, readMessageToolSourceReplyText as i, isDeliveredMessageToolOnlySourceReplyResult as n, isDeliveredMessagingToolResult as r, hasMessagingDeliveryReceipt as t };
