...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = createLazyPromise(() => import("./runtime-Cf16aD5W.js"), { cacheRejections: true });
	const loadAuthProfiles = createLazyPromise(() => import("./auth-profiles-DfSZ8-zy.js"), { cacheRejections: true });
