...
import { a as runSetupModelAuthStep, i as offerLiveModelVerification, n as listSetupMigrationOptions, r as runSetupMigrationImport, t as detectSetupMigrationSources } from "./setup.migration-import-BNgAtBHh.js";
...
async function runSetupWizardOnce(opts, runtimeInput, prompter) {
	...
	if (opts.skipChannels) await prompter.note(t("wizard.setup.skipChannels"), t("wizard.setup.channelsTitle"));
		...
		const { setupChannels } = await import("./onboard-channels-ktAa3lY4.js");
	...
	if (flow !== "quickstart") {
		...
		const { setupAppRecommendations } = await import("./setup.app-recommendations-XuskkaJV.js");
	...
	const { finalizeSetupWizard } = await import("./setup.finalize-BMUlrm4R.js");
