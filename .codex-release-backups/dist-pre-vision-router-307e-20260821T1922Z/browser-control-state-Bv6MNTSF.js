...
import { x as BrowserProfileUnavailableError } from "./tmp-openclaw-dir-CQvAbCRW.js";
import "./config-18cKtMq9.js";
import { d as markBrowserRuntimeStopping, r as beginProfileTransition, s as isBrowserRuntimeRunning } from "./server-context.lifecycle-BOaI8dvj.js";
import { a as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context-DVqMO1Wl.js";
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-DzT1jzwh.js";
...
async function stopBrowserRuntimeInternal(params, finalizeGlobalAdapters) {
	...
	if (finalizeGlobalAdapters) try {
		const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-CO3wl4cO.js");
