...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-DqhZ9eIx.js";
import { D as parseBrowserErrorPayload, X as withTimeout } from "./tmp-openclaw-dir-CQvAbCRW.js";
import "./control-auth-Cb0AZln6.js";
import "./chrome-CerjrCF5.js";
import "./trash-TerZoduM.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-DVqMO1Wl.js";
import "./sdk-setup-tools-HQbRkkdy.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-DzT1jzwh.js";
import "./routes-Bp-g4UDO.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-C2ayJE8W.js";
import { s as stopBrowserBridgeRuntime, t as createBrowserControlContext } from "./browser-control-state-Bv6MNTSF.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-CzWONwaW.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-DBQtPb5W.js"), import("./routes-BdRY6hYC.js")]);
