...
import { C as resolveSupportedVoiceModelRefs, b as getVoiceProviderConfig, x as providerMatchesId } from "./loader-B4G6K_LK.js";
...
import { A as flushClientVoiceSessionWrites, C as appendRelayVoiceTranscript, D as closeStaleClientVoiceSessions, E as closeRelayVoiceSessionRecord, F as VOICE_TRANSCRIPT_QUEUE_POLICY, I as normalizeVoiceTranscriptText, L as BoundedSerialQueue, M as resolveClientVoiceAgentSessionId, N as resolveClientVoiceSessionOrigin, O as createOrResumeClientVoiceSession, P as resolveOpenClientVoiceSessionId, R as authorizeClientVoiceConfirmation, S as appendClientVoiceTranscript, T as closeClientVoiceSession, j as registerClientVoiceConsultRun, k as ensureClientVoiceAgentSessionEntry, w as assertClientVoiceSessionOpen, z as bindAuthorizedClientVoiceConfirmation } from "./agent-tools.before-tool-call-CztciPqk.js";
...
import { C as getResolvedSpeechProviderConfig, b as CODE_HEAVY_SPOKEN_FALLBACK, v as synthesizeSpeech, x as isCodeHeavySpeechText } from "./runtime-api-C9ekJtKs.js";
...
import { n as getRealtimeTranscriptionProvider, r as listRealtimeTranscriptionProviders, t as canonicalizeRealtimeTranscriptionProviderId } from "./provider-registry-CjSvhzu3.js";
...
import { t as handleChatSend } from "./chat-send-handler-CO__mJvR.js";
...
const loadTalkAgentExecution = createLazyRuntimeModule(async () => {
	const [embeddedAgent, admission] = await Promise.all([import("./embedded-agent-DQGrbvPv.js"), import("./admitted-run-context-DN1fM-I2.js")]);
	return {
