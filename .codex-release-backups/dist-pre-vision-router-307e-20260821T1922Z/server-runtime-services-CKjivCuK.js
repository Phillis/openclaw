...
import { c as startSessionDeliveryRuntime, o as schedulePendingSessionDeliveries } from "./subagent-completion-delivery-D_EcGDns.js";
import "./embedded-agent-B-4M60T9.js";
import { f as resolveHeartbeatAgents } from "./heartbeat-runner-session-DNByrh62.js";
import { t as startHeartbeatRunner } from "./heartbeat-runner-B8Fr3Fil.js";
...
function startPendingSessionDeliveryRuntime(params) {
	...
	const timer = setTimeout(() => {
		runWithGatewayIndependentRootWorkAdmission(async () => {
			const { deliverQueuedSessionDelivery, recoverPendingRestartContinuationDeliveries, settleQueuedSessionDelivery } = await import("./server-restart-sentinel-C4m8HNYm.js");
			if (stopped) return;
