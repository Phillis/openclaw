...
import { w as listTaskRecordPage, x as getTaskById } from "./task-registry-DkfAoDv0.js";
...
import { i as retrySubagentCompletionDelivery, n as dismissSubagentCompletionDelivery } from "./subagent-completion-delivery-D_EcGDns.js";
...
const tasksHandlers = {
	...
	"tasks.dismiss": async ({ params, respond }) => {
		...
		const { discardSubagentTerminalDelivery } = await import("./subagent-registry-CpjELXpy.js");
		const results = [];
		for (const taskId of params.taskIds) {
