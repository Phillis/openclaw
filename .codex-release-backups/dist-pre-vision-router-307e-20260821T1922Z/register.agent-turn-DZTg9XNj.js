...
async function loadAgentCliCommand() {
	return (await import("./agent-via-gateway-BD5jmXlP.js")).agentCliCommand;
}
async function loadAgentExecCommand() {
	return (await import("./agent-exec-0QTUMNzs.js")).agentExecCommand;
}
function collectFallback(value, previous) {
	return [...previous, value];
}
async function loadDefaultRuntime() {
	return (await import("./runtime-Dn74rUMz.js")).defaultRuntime;
}
async function loadRunCommandWithRuntime() {
	return (await import("./cli-utils-BHbzO7bY.js")).runCommandWithRuntime;
}
