...
function formatSkillsForPromptCore(skills) {
	...
	for (const skill of skills) {
		...
		if (skill.promptVersion) lines.push(`    <version>${escapeSkillXml(skill.promptVersion)}</version>`);
		lines.push("  </skill>");
	}
...
//#endregion
export { formatSkillsCompactForPrompt as n, formatSkillsForPromptCore as r, escapeSkillXml as t };
