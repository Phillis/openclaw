...
import { a as parseSystemAgentOperation, i as isPersistentSystemAgentOperation, t as executeSystemAgentOperation } from "../operations-CnWfueHS.js";
...
import { n as resolveSystemAgentOperation } from "../dialogue-HWwzAIyJ.js";
...
async function runSystemAgent(opts, runtime = defaultRuntime) {
	...
	const runInteractiveTui = boundOpts.runInteractiveTui ?? (await import("../tui-backend-Ba9v3oqN.js")).runSystemAgentTui;
	boundOpts.onReady?.();
