...
import { l as rewrapToolWithBeforeToolCallHook, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-CztciPqk.js";
import { B as withFileMutationQueues, D as createReadTool, H as hasOnlyCrlfLineEndings, U as normalizeToLF, V as decodeUtf8File, W as restoreLineEndings, z as withFileMutationQueue } from "./sessions-BIUamgQ4.js";
import { g as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-B8EtrfM_.js";
import { S as isToolWrappedWithBeforeToolCallHook, d as copyAgentToolMetadata } from "./gateway-IJglwWNi.js";
...
import { t as wrapToolWithAbortSignal } from "./agent-tools.abort-LLi5vAZR.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-D1HfEOON.js";
import { a as createSandboxedReadTool, f as withMemoryWriteProvenance, i as createSandboxedEditTool, l as wrapToolWorkspaceRootGuard, n as createHostWorkspaceWriteTool, o as createSandboxedWriteTool, r as createOpenClawReadTool, s as wrapReadToolWithSkillContent, t as createHostWorkspaceEditTool, u as wrapToolWorkspaceRootGuardWithOptions } from "./agent-tools.read-CCnd9E9D.js";
...
const bashToolsModuleLoader$1 = createLazyImportLoader(() => import("./bash-tools-CGgdVpib.js"));
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-CGgdVpib.js"));
