...
type PairLoopGuard = {
  /** Records one sender/receiver interaction and reports whether it enters or is inside cooldown. */recordAndCheck: (params: {
    ...
    receiverId: string; /** Stable provider event identity used to avoid double-counting retries. */
    eventId?: string; /** Resolved guard thresholds for the current channel/account. */
