...
import { c as readPersistedAuthProfileStateRaw, d as readPersistedSharedAuthProfileStoreRaw, l as readPersistedAuthProfileStoreRaw, u as readPersistedSharedAuthProfileStateRaw } from "./sqlite-CtUje688.js";
...
function setRuntimeExternalCliProfileIds(store, profileIds) {
	...
	store.runtimeExternalCliProfileIds = ids.length > 0 ? ids : void 0;
}
...
//#endregion
export { CODEX_CLI_PROFILE_ID as A, shouldPersistRuntimeExternalOAuthProfile as C, LEGACY_OAUTH_REF_PROVIDER as D, shouldMirrorRefreshedOAuthCredential as E, OPENAI_CODEX_DEFAULT_PROFILE_ID as F, authProfilesLog as I, cloneAuthProfileStore as L, MINIMAX_CLI_PROFILE_ID as M, OAUTH_REFRESH_CALL_TIMEOUT_MS as N, isLegacyOAuthRef as O, OAUTH_REFRESH_LOCK_OPTIONS as P, shouldBootstrapFromExternalCliCredential as S, isSafeToCopyOAuthIdentity as T, areOAuthCredentialsEquivalent as _, loadPersistedAuthProfileStore as a, isSafeToAdoptMainStoreOAuthIdentity as b, parseLegacyCredentialEntry as c, loadPersistedAuthProfileState as d, mergeAuthProfileState as f, setRuntimeExternalCliProfileIds as g, removeRuntimeExternalProfileReferences as h, coercePersistedAuthProfileStore as i, EXTERNAL_CLI_SYNC_TTL_MS as j, CLAUDE_CLI_PROFILE_ID as k, buildPersistedAuthProfileState as l, mergeRuntimeExternalProfileReferences as m, buildPersistedAuthProfileSecretsStore as n, loadPersistedSharedAuthProfileStore as o, getRuntimeExternalCliProfileIds as p, coerceLegacyAuthStore as r, mergeAuthProfileStores as s, applyLegacyAuthStore as t, coerceAuthProfileState as u, hasMatchingOAuthIdentity as v, shouldReplaceStoredOAuthCredential as w, overlayRuntimeExternalOAuthProfiles as x, isSafeToAdoptBootstrapOAuthIdentity as y };
