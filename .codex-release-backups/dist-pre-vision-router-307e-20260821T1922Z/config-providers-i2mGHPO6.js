...
import { s as createMigrationManualItem } from "./migration-q6QzXKht.js";
import { n as childRecord, u as sanitizeName } from "./helpers-uj18Nf8l.js";
import { a as resolveHermesConfiguredProviderId, n as normalizeHermesCustomProviderId } from "./model-DZTBg-gy.js";
import { a as readProviderApiKeyEnv, c as resolveHermesEndpointApiKeyEnv, d as resolveHermesProviderBaseUrlEnv, f as resolveProviderApi, i as readEnvReference, l as resolveHermesImplicitBaseUrl, n as collectProviderModels, o as readProviderBaseUrl, s as readProviderHeaders, t as HERMES_TRANSPORTS, u as resolveHermesProviderApiKeyEnv } from "./config-provider-contract-CkaCpU4O.js";
...
function providerManualItems(config, env, includeSecrets) {
	...
	for (const { id, raw, source } of entries) {
		...
		if (normalizeOptionalString(raw.api_key) && !readEnvReference(raw.api_key)) items.push(createMigrationManualItem({
