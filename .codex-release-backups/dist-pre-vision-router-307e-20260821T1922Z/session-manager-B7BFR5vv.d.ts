import { S as TextContent, l as ImageContent, u as Message } from "./types-Cm3n7XMD.js";
import { _ as CustomMessage, c as AgentMessage, m as BashExecutionMessage } from "./types-DKu1Bc4Q.js";
import { c as TranscriptEntryAnchor } from "./types-CoqV37wL.js";
import { n as OpenClawConfig, vt as SessionMaintenanceMode } from "./types.openclaw-6A5yUI1l.js";
...
type TranscriptMessageAppendResult<TMessage> = {
  ...
  effectiveParentId?: string | null; /** Authoritative immutable identity issued by the append transaction. */
