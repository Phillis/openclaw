...
import { a as shouldComputeCommandAuthorized } from "./command-detection-C3lBcPZz.js";
...
import { i as dispatchInboundMessageWithProjectedDispatcher, l as emitInboundMessageAuditTerminal, s as emitMessageReceivedHooks } from "./dispatch-CDc9-My7.js";
...
import { n as buildInboundUserContextPrefix } from "./inbound-meta-C-TZmPR6.js";
...
import { _ as gatewayClientSenderFields } from "./session-sharing-DOLHhSnW.js";
...
import { a as attachManagedOutgoingMediaToMessage } from "./managed-image-attachments-Drc4ES-b.js";
...
import { i as maybeGenerateDashboardSessionTitle, r as isDashboardSessionTitleCandidate, t as buildDashboardSessionTitleSource } from "./dashboard-session-title-Brtj8N0q.js";
import { i as persistGatewaySessionLifecycleEvent } from "./session-lifecycle-state-DzLIsG_S.js";
...
async function resolveDurableChatClaim(params) {
	...
	if (isAdoptedRestartRecoveryClaim(entry, params.clientRunId) && entry.status === "running" && entry.abortedLastRun === true) {
		...
		try {
			const { retryRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-CY1fQWF5.js");
