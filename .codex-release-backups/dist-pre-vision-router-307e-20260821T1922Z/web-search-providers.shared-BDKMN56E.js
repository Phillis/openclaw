...
import { a as createPluginIdScopeSet, c as normalizePluginIdScope } from "./current-plugin-metadata-snapshot-DwABKB-T.js";
...
import { t as resolveBundledCompatActivationInputs } from "./activation-context-ChwnBO6L.js";
...
function resolveBundledWebProviderResolutionConfig(params) {
	const activation = resolveBundledCompatActivationInputs({
		...
		resolveBundledPluginIds: (compatParams) => resolveBundledWebProviderCompatPluginIds({
