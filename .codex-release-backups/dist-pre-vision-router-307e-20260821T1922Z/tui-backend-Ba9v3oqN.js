...
import { t as executeSystemAgentOperation } from "./operations-CnWfueHS.js";
...
import { t as SystemAgentChatEngine } from "./chat-engine-C5DPSaKQ.js";
...
async function runSystemAgentTui(opts, runtime) {
	...
	for (;;) {
		...
		const runTui = boundOpts.runTui ?? (await import("./tui-DF0cp9dd.js")).runTui;
		try {
			await runTui({
				local: true,
