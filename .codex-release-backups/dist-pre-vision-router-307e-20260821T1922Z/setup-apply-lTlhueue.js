...
import { i as sameDefaultInferenceRoute, t as projectDefaultInferenceRoute } from "./inference-route-BhKzJcjo.js";
...
async function applySystemAgentSetup(params, hooks) {
	...
	let guardModules = expectedAgentId || expectedAgentDir || expectedModelRef ? await Promise.all([import("./agent-scope-B7ocz6pI.js"), import("./model-selection-0mI527hu.js")]) : void 0;
	...
	if (startedWithoutAuthoredRoster) {
		...
		guardModules ??= await Promise.all([import("./agent-scope-B7ocz6pI.js"), import("./model-selection-0mI527hu.js")]);
	...
	if (surface === "cli") await runCommittedFollowUp(async () => {
		const { ensureGatewayServiceForOnboarding } = await import("./setup.finalize-BMUlrm4R.js");
