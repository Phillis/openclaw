...
import { R as timestampMsToIsoString, S as parseStrictInteger } from "./number-coercion-oCkfUEEq.js";
...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-C0yvXuIj.js";
import { n as matrixSetupAdapter } from "./setup-core-C27vKlUr.js";
import { t as withResolvedActionClient } from "./client-Ddx4AHar.js";
import { i as resolveMatrixAuthContext } from "./create-client-B8SR-Ctr.js";
import "./client-Cbr3DmMz.js";
import "./runtime-api-Chmw2KZx.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-Dm_YMVFT.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-DZ4K59oO.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-Dtq8SwPm.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-BMopPLOq.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-D6yeuiis.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-Bq4rXZjv.js"));
const loadMatrixDirectManagementModule = createLazyRuntimeModule(() => import("./direct-management-CjwK7t0K.js"));
