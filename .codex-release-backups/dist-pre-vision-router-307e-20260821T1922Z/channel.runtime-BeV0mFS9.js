...
import "./accounts-BH79hFGn.js";
import "./runtime-api-Bm6ssW5A.js";
import { r as getMe, t as ZaloApiError } from "./api-B_CUhJ-M.js";
import { t as resolveZaloProxyFetch } from "./proxy-spLFsdXj.js";
import { t as sendMessageZalo } from "./send-DZr05unE.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-C5gruEy4.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-BkEssDLX.js");
