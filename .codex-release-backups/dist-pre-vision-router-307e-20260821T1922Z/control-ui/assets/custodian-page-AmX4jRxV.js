import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{T as t,w as n}from"./control-ui-foundation-D1iiKpDl.js";import{Cl as r,Tl as i,bl as a,cn as o,dl as s,dn as c,sl as l,xl as u}from"./control-ui-core-CYMRjRvO.js";import{K as d,Q as f,W as p,Y as m,it as h,nt as g}from"./lit-runtime-2JvyKfXq.js";import{c as _,s as v}from"./control-ui-foundation-CI97c0ac.js";import{I as y,L as b,mn as x}from"./control-ui-core-DshNR6ir.js";import{o as S,t as C}from"./control-ui-core-D1Oa90un.js";import{a as w,r as T}from"./gateway-runtime-DW5v6KYK.js";import{i as E,n as D,r as O,t as k}from"./custodian-surface-DBRb3CWr.js";function A(e){switch(e){case`system-agent`:return S(`custodian.history.sources.systemAgent`);case`doctor`:return S(`custodian.history.sources.doctor`);case`config-rpc`:return S(`custodian.history.sources.settings`);case`external`:return S(`custodian.history.sources.manualEdit`);case`cli`:return S(`custodian.history.sources.cli`);case`plugin-install`:return S(`custodian.history.sources.pluginInstall`);case`unknown`:return S(`custodian.history.sources.unknown`)}return e}function j(e){return m`
...
//# sourceMappingURL=custodian-page-AmX4jRxV.js.map