...
import { _ as getNodeSqliteKysely, f as OPENCLAW_SQLITE_BUSY_TIMEOUT_MS, h as executeSqliteQuerySync, i as createNewerSqliteSchemaVersionError, n as resolveOpenClawStateSqliteDir, o as readSqliteUserVersion, r as resolveOpenClawStateSqlitePath } from "./openclaw-state-db.paths-DmtKty-F.js";
import { O as detectOpenClawStateDatabaseSchemaMigrationsFromDatabase, fn as repairCanonicalSqliteIndexes, h as runOpenClawStateWriteTransaction, hn as assertSqliteSchemaTablesPresent, mn as assertSqliteSchemaContains, pn as verifyAndRepairCanonicalSqliteIndexes, vn as getCanonicalSqliteTableNames, yt as resolveSqliteDatabaseFilePaths } from "./openclaw-state-db-DlCMR4eQ.js";
import { n as migrateSqliteSchemaToStrictInTransaction, r as assertSqliteIntegrity } from "./sqlite-strict-BaSF4bDz.js";
import { n as configureSqlitePreSchemaPragmas } from "./sqlite-wal-B0_s-lfW.js";
import { n as withOpenClawStateDatabaseReadOnly } from "./openclaw-state-db-readonly-BixM8L1u.js";
import { n as assertAgentDeletionPathFence, o as prepareAgentDeletionPathFence } from "./agent-deletion-journal-CuS0p_kP.js";
import { n as OpenClawAgentDatabaseMediaMigrationRequiredError } from "./openclaw-agent-db-migration-required-RkIFq1cn.js";
import { _ as hasLegacyMemoryRecallMetadataColumns, d as MEMORY_PATH_FTS_TRIGGER_DEFINITIONS, g as ensureMemoryRecallMetadataSchema, h as MEMORY_INDEX_CHUNK_RECALL_METADATA_TABLE, n as migrateMemoryIndexSourcesIdentity, u as MEMORY_INDEX_SOURCES_TABLE, v as MEMORY_INDEX_CHUNK_PROVENANCE_TABLE, y as ensureMemoryChunkProvenance } from "./memory-schema-BzEn8uKj.js";
