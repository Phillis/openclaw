...
import { a as resolveGatewayService, n as formatGatewayServiceStartRepairIssues, o as startGatewayService, t as describeGatewayServiceRestart } from "./service-BoInmOOR.js";
import { x as runTui } from "./tui-DuGrQ0Zy.js";
...
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-CiE104ur.js";
import { f as probeGatewayReachable, h as waitForGatewayReachable, r as buildOnboardingControlUiUrl } from "./onboard-helpers-CO-dBdb1.js";
...
import { i as hasAuthProfileForProvider } from "./model-config.helpers-B0gLW0Hd.js";
import { r as listConfiguredWebSearchProviders } from "./runtime-cxdXSplN.js";
...
import { i as waitForControlUiDocument, r as resolveControlUiHandoffTarget } from "./control-ui-handoff-CACH6yyU.js";
...
async function startSessionGatewayForOnboarding(params) {
	...
	try {
		const { startGatewayServer } = await import("./server-BJpj3PP8.js");
...
const loadSearchSetupModule = createLazyRuntimeModule(() => import("./search-setup-_9Yha47P.js"));
...
async function finalizeSetupWizard(options) {
	...
	try {
		...
		const [{ resolveDefaultModelAuthStatus, resolveDefaultModelCatalogFacts }, { loadPreparedModelCatalogSnapshot }] = await Promise.all([import("./auth-choice-CbFlLfhn.js"), import("./prepared-model-catalog-BGLDTo2i.js")]);
