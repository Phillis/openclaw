...
import { p as resolveEffectiveModelFallbacks } from "./agent-scope-BizOtGGz.js";
...
import { c as isReasoningTagProvider } from "./builtin-openclaw-B7zVdTs_.js";
...
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo } from "./origin-routing-CJyhdAMl.js";
import { n as readChannelSourceTurnId } from "./source-turn-id-BnVTXtrn.js";
...
function resolveModelFallbackOptions(run, configOverride = run.config) {
	...
	return {
		...
		fallbacksOverride,
		requiredAgentHarnessId: run.modelSelectionLocked && run.agentHarnessEpoch?.trim() && run.agentHarnessId?.trim() ? run.agentHarnessId.trim() : void 0
	};
}
