...
import { x as resolveCodexAppServerRuntimeOptions } from "./session-binding-i8EAWgmh.js";
import { l as isCodexAppServerStartSelectionChangedError, ut as isJsonObject } from "./shared-client-B5Vv-Z85.js";
import { o as createDeferred } from "./extension-shared-BCgJMXly.js";
import { _ as readCodexNotificationTurnId, a as closeCodexStartupClientBestEffort, o as interruptCodexTurnAndWaitBestEffort, t as CODEX_APP_SERVER_INTERRUPT_TIMEOUT_MS } from "./attempt-client-cleanup-LsPf91--.js";
import { b as isTerminalTurnStatus, n as normalizeCodexResponseTokenUsage, x as readCodexNotificationItem, y as isRetryableErrorNotification } from "./event-projector-usage-BJIukJVf.js";
import { C as mergeCodexThreadConfigs, a as attestCodexRestrictedToolSurfaceMcpServersDisabled, c as readCodexInheritedMcpServerNames, i as assertCodexRestrictedToolSurfaceHasNoManagedHooks, o as buildCodexRingZeroThreadConfigPatch, s as buildCodexRuntimeThreadConfig } from "./thread-lifecycle-BwGyRccy.js";
...
import { r as readModelListResult } from "./models-DeqnUE72.js";
...
async function runBoundedCodexAppServerTurnInWorkspace(params, appServer, workspace, selectionAttempt = 0, timing) {
	...
	}) : await import("./shared-client-BzlkRNWb.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
		startOptions,
		timeoutMs,
		...authSelection,
		authRequirement: params.authRequirement,
