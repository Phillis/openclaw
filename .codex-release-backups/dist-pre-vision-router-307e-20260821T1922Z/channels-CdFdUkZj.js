...
import { s as getChannelsCommandSecretTargetIds } from "./command-secret-targets-CHv87KPT.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-C0-hTFrJ.js";
import { n as resolveLogFile } from "./log-tail-DQ4CGQW8.js";
import { t as parseLogLine } from "./parse-log-line-ftS74lJQ.js";
import { n as requireValidConfigFileSnapshot } from "./config-validation-Cz11KC4g.js";
import { i as prepareChannelAccountRemoval, n as channelLabel, r as applyPreparedChannelAccountRemoval, t as channelsAddCommand } from "./add-CObsOKRz.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidChannelConfig } from "./shared-CsIQXA3R.js";
import { t as channelsListCommand } from "./list-DPLCzYyl.js";
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-DVJKNv0u.js");
