...
import { _ as resolveGatewayPort, a as isDefaultInstallIdentity, f as resolveConfigPath, w as resolveStateDir } from "./paths-CqeDjSA4.js";
import { b as createConfigIO } from "./io-CeQckj5v.js";
import { h as resolveConfiguredLogFilePath } from "./logger-BWBYvpHz.js";
...
import "./credentials-CBejaoWm.js";
import { _ as resolveGatewayRequiredListenHosts } from "./net-BRYQcUG8.js";
import { r as formatPortDiagnostics } from "./ports-format-BfMa8zv8.js";
import { n as inspectPortUsage, r as inspectPortUsages, t as inspectPortConnections } from "./ports-inspect-Cn58O6uP.js";
import { a as resolveGatewayService, i as readGatewayServiceState } from "./service-BoInmOOR.js";
import { c as pickProbeHostForBind, o as normalizeListenerAddress, s as parsePortFromArgs } from "./shared-Cauz4p0y.js";
import { r as projectGatewayUrlForDiagnostics } from "./connection-details-BsRSnf71.js";
import { t as gatewaySecretInputPathCanWin } from "./credentials-secret-inputs-2OrPX3Ar.js";
import { a as readGatewaySecretInputValue, t as ALL_GATEWAY_SECRET_INPUT_PATHS } from "./secret-input-paths-BqHb6OmN.js";
import { a as resolveGatewayProbeCredentialConfig } from "./probe-auth-DZpKkyuo.js";
import { n as readLastGatewayErrorLine } from "./diagnostics-DkC_W_vf.js";
import { r as resolveBestEffortGatewayBindHostForDisplay, t as inspectBestEffortPrimaryTailnetIPv4 } from "./network-discovery-display-B4VUnVnT.js";
import { t as resolveAdvertisedControlUiLinks } from "./control-ui-links-DfRqI0QP.js";
import { r as readGatewayRestartHandoffSync } from "./restart-handoff-9lx7m4gY.js";
import { n as inspectWindowsGatewayFirewall } from "./windows-gateway-firewall-diagnostics-OaczVGsd.js";
import { t as detectPluginVersionDrift } from "./plugin-version-drift-VMtGLv1M.js";
import fs from "node:fs/promises";
import JSON5 from "json5";
//#region src/cli/daemon-cli/status.gather.ts
const gatewayProbeAuthModuleLoader = createLazyImportLoader(() => import("./probe-auth-quHZid1R.js"));
const daemonInspectModuleLoader = createLazyImportLoader(() => import("./inspect-C_YdHmGD.js"));
const launchdModuleLoader = createLazyImportLoader(() => import("./launchd-C7IKi2Uv.js"));
const serviceAuditModuleLoader = createLazyImportLoader(() => import("./service-audit-JTw6bHcb.js"));
const gatewayTlsModuleLoader = createLazyImportLoader(() => import("./gateway-9QVk7JoZ.js"));
const daemonProbeModuleLoader = createLazyImportLoader(() => import("./probe-PG-CAtvy.js"));
const restartHealthModuleLoader = createLazyImportLoader(() => import("./restart-health-Slvty1LG.js"));
...
async function gatherDaemonStatus(opts) {
	...
	const hostDesktop = await (await import("./host-source-CLFKhKtI.js")).inspectHostDesktop({ config: daemonCfg.desktop?.host });
	return {
