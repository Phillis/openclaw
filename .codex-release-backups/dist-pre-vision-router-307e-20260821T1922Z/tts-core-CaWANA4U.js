...
function loadDefaultSummarizeTextDeps() {
	return defaultSummarizeTextDepsPromise ??= Promise.all([import("./simple-completion-runtime-XG8auwKn.js"), import("./model-auth-nLnJBYkr.js")]).then(([completionRuntime, { requireApiKey }]) => ({
