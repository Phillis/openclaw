...
import { b as updateAuthProfileStoreWithLock, p as loadAuthProfileStoreWithoutExternalProfiles } from "../../store-BH6qiWJF.js";
import { _ as readToolStringParam } from "../../common-BGOZLJ2_.js";
import { t as jsonResult } from "../../tool-results-BCM3fdVS.js";
import { n as buildApiKeyCredential, t as applyAuthProfileConfig } from "../../provider-auth-helpers-wvIT0e4l.js";
...
import { d as buildOpenAICodexCredentialExtra, h as resolveOpenAICodexImportProfileName, m as resolveOpenAICodexAuthIdentity } from "../../provider-auth-B5tRLN3X.js";
...
import { a as closeCodexStartupClientBestEffort, d as unsubscribeCodexThreadBestEffort, h as isCodexNotificationForTurn, o as interruptCodexTurnAndWaitBestEffort, p as getCodexAppServerTurnRouter, u as retireUnsafeCodexTurnClientBestEffort } from "../../attempt-client-cleanup-LsPf91--.js";
import { s as isAssistantCommentaryCompletionNotification } from "../../event-projector-usage-BJIukJVf.js";
import { C as mergeCodexThreadConfigs, D as isOpenAiCuratedMarketplace, T as ensureCodexPluginActivation, f as resolveCodexAppServerRequestModelSelection, k as pluginReadParams, u as CODEX_NATIVE_PERSONALITY_NONE, x as buildDisabledAppsConfigPatch } from "../../thread-lifecycle-BwGyRccy.js";
...
import { l as projectBoundedCodexVisibleSessionHistory } from "../../transcript-mirror-Bf-Fg8pd.js";
import { n as describeControlFailure, t as CODEX_CONTROL_METHODS } from "../../capabilities-C_VWteBZ.js";
import { r as formatCodexDisplayText } from "../../command-formatters-BCNluvap.js";
import "../../incognito-session-DoO9V_or.js";
import { t as resolveCodexAppServerForModelProvider } from "../../app-server-policy-OH9uG8_b.js";
...
import { t as resumeCodexAppServerThread } from "../../thread-resume-meNhAHiH.js";
import { i as withCodexAppServerJsonClient, r as requestCodexAppServerJson } from "../../request-C8y72NlS.js";
...
import { n as registerCodexCliMetadata } from "../../cli-metadata-B_Yigl6r.js";
import { t as createCodexAppServerAgentHarness } from "../../harness-BBS8pSms.js";
import { t as buildCodexMediaUnderstandingProvider } from "../../media-understanding-provider-ZRIcJbnp.js";
...
import { f as trackCodexConversationActiveTurn, m as canMutateCodexHost, p as CODEX_NATIVE_EXECUTION_AUTH_ERROR, t as discoverCodexMarketplacePlugins } from "../../plugin-marketplace-discovery-BRvJ8VeA.js";
...
import { d as resumeCodexCliSessionOnNode, l as listCodexCliSessionsOnNode, o as createCodexCliSessionNodeHostCommands, s as createCodexCliSessionNodeInvokePolicies, t as codexControlRequest, u as resolveCodexCliSessionForBindingOnNode } from "../../command-rpc-mRroedbh.js";
import { i as createCodexSessionCatalogNodeInvokePolicies, n as createCodexSessionCatalogControl, o as assertCodexArchiveDescendantsUnowned, r as createCodexSessionCatalogNodeHostCommands, t as codexSessionCatalogRuntime } from "../../session-catalog-Cs-mgUc9.js";
...
function createLazyCodexAppServerBindingStore(state) {
	let resolved;
	const store = () => resolved ??= import("../../session-binding-DXH85j2q.js").then(({ createCodexAppServerBindingStore }) => createCodexAppServerBindingStore(state));
	return {
...
async function loadDefaultCodexSubcommandHandler() {
	const { handleCodexSubcommand } = await import("../../command-handlers-zRaTESRU.js");
...
const loadCodexWebSearchRuntime = createLazyRuntimeModule(() => import("../../web-search-provider.runtime-DBQpyTad.js"));
...
var codex_default = definePluginEntry({
	...
	register(api) {
		...
		api.on("after_compaction", async (event, ctx) => {
			...
			const { sessionBindingIdentity } = await import("../../session-binding-DXH85j2q.js");
			const identity = sessionBindingIdentity({
				sessionId,
		...
		api.on("session_end", async (event, ctx) => {
			...
			const config = resolveCurrentConfig();
			const [{ sessionBindingIdentity }, { retireCodexAppServerSessionGeneration }] = await Promise.all([import("../../session-binding-DXH85j2q.js"), import("../../session-retirement-Dsm4bgzO.js")]);
