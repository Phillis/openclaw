...
import { v as getPluginRegistryRuntime } from "./loader-B4G6K_LK.js";
...
import { n as projectSessionActor } from "./session-utils-row-pCr636Wc.js";
...
function catalogStartHandler(resolveProvider, resolveCreateTarget) {
	return async (opts) => {
		...
		const { openTerminalSession, CATALOG_TERMINAL_INITIAL_SIZE } = await import("./terminal-NfXf-ZY0.js");
