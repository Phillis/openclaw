...
import { c as runFfmpeg, l as runFfprobe, o as parseFfprobeCodecAndSampleRate, u as MEDIA_FFMPEG_MAX_AUDIO_DURATION_SECS } from "./media-services-BMidrwE0.js";
import { r as loadWebMediaRaw } from "./web-media-Dk8VJTPc.js";
...
import { i as unlinkIfExists } from "./media-runtime-OD8vPDOE.js";
...
import { s as resolveDiscordAccount } from "./accounts-B99sjC_p.js";
import { At as listGuildChannels, Ct as createGuildScheduledEvent, Dt as getGuildMember, Et as getGuild, Ft as putChannelPermission, It as removeGuildMember, Lt as removeGuildMemberRole, Mt as listGuildRoles, Nt as listGuildScheduledEvents, Ot as getGuildVoiceState, Pt as moveGuildChannels, Rt as timeoutGuildMember, St as createGuildEmoji, Tt as deleteChannelPermission, Vt as ChannelType, _ as RateLimitError, _t as sendChannelTyping, at as deleteChannel, b as readDiscordMessage, bt as createGuildBan, ct as editChannelMessage, ft as listChannelArchivedThreads, g as DiscordError, gt as searchGuildMessages, ht as pinChannelMessage, it as createThread, jt as listGuildEmojis, kt as listGuildActiveThreads, lt as getChannel, mt as listChannelPins, ot as deleteChannelMessage, pt as listChannelMessages, st as editChannel, ut as getChannelMessage, v as isUnknownDiscordVoiceStateError, vt as unpinChannelMessage, wt as createGuildSticker, x as readRetryAfter, xt as createGuildChannel, y as readDiscordCode, yt as addGuildMemberRole } from "./discord-BinpTEur.js";
import { C as DISCORD_MAX_STICKER_BYTES, S as DISCORD_MAX_EVENT_COVER_BYTES, T as parseAndResolveChannelRecipient, _ as resolveDiscordMessageFlags, b as resolveDiscordSuppressEmbeds, g as createDiscordMessageNonce, l as resolveChannelId, n as buildDiscordTextChunks, o as normalizeEmojiName, p as sendDiscordText, t as buildDiscordSendError, x as DISCORD_MAX_EMOJI_BYTES } from "./send.shared-CquMchGD.js";
import { t as parseDiscordRetryAfterBodySeconds } from "./retry-after-BRwE1ySf.js";
import { h as DISCORD_REST_TIMEOUT_MS, m as resolveDiscordRest, p as resolveDiscordClientAccountContext, u as createDiscordClient } from "./send.permissions-g2olELEg.js";
import "./send.outbound-BhdhDia0.js";
import { r as rewriteDiscordKnownMentions } from "./mentions-ClF_uUn_.js";
import { r as createDiscordSendResult } from "./send.receipt-Cli9pjbl.js";
import { i as recordDiscordMessageCreateAmbiguity, n as createDiscordRetryRunner, t as classifyDiscordDeliveryFailure } from "./retry-CG6LCfkJ.js";
import { n as DISCORD_ATTACHMENT_TOTAL_TIMEOUT_MS } from "./timeouts-BTHN67kZ.js";
import "./send.reactions-dstI2wbi.js";
