...
import { L as getCoreCliCommandNamesCore, v as getSubCliEntriesCore } from "./argv-CgA2urTO.js";
...
function formatCliCommandSuggestions(input) {
	...
	const knownCommands = uniqueSortedCommandNames([...getCoreCliCommandNamesCore(), ...getSubCliEntriesCore().map((entry) => entry.name)]);
