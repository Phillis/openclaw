...
import { L as RunEmbeddedAgentParams, _ as RuntimeLogger, g as PluginRuntimeCore, kr as DiagnosticEventInput, zn as RealtimeVoiceProviderPlugin } from "../types-BJ8oTDFw.js";
import { A as RealtimeVoiceProviderId, B as TalkBrain, C as RealtimeVoiceBrowserSession, D as RealtimeVoiceProviderCapabilities, E as RealtimeVoiceGatewayControl, F as RealtimeVoiceTool, G as TalkEventType, H as TalkEventContext, I as RealtimeVoiceToolCallEvent, J as createTalkEventSequencer, K as TalkMode, L as RealtimeVoiceToolResultOptions, M as RealtimeVoiceResponseError, N as RealtimeVoiceResponseOutcome, O as RealtimeVoiceProviderConfig, P as RealtimeVoiceRole, R as normalizeRealtimeVoiceResponseOutcome, S as RealtimeVoiceBridgeEvent, T as RealtimeVoiceCloseReason, U as TalkEventInput, V as TalkEvent, W as TalkEventSequencer, _ as RealtimeVoiceAudioFormat, b as RealtimeVoiceBridgeCallbacks, g as RealtimeVoiceAudioClearReason, h as RealtimeVoiceAgentConsultRunner, j as RealtimeVoiceProviderResolveConfigContext, k as RealtimeVoiceProviderConfiguredContext, m as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, p as REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ, q as TalkTransport, v as RealtimeVoiceBargeInOptions, w as RealtimeVoiceBrowserSessionCreateRequest, x as RealtimeVoiceBridgeCreateRequest, y as RealtimeVoiceBridge, z as TALK_EVENT_TYPES } from "../provider-types-D9oVYO6S.js";
import { t as EmbeddedAgentQueueMessageOutcome } from "../runs-5pd6bKhb.js";
...
import { i as createRealtimeVoiceAudioQueue, n as RealtimeVoiceSessionConnection, r as RealtimeVoiceSessionLifecycle, t as RealtimeVoiceAudioQueue } from "../realtime-session-lifecycle-CrnUyKIf.js";
