...
import { n as WizardPrompter } from "../types.plugin-DAXg6Oqz.js";
import { i as ProviderPlugin, st as ProviderAuthResult } from "../types-BJ8oTDFw.js";
declare namespace auth_d_exports {
  export { ModelsAuthLoginFlowOptions, ModelsAuthLoginFlowResult, modelsAuthAddCommand, modelsAuthLoginCommand, modelsAuthPasteApiKeyCommand, modelsAuthPasteTokenCommand, modelsAuthSetupTokenCommand, resolveLoginProfiles, resolveRequestedLoginProviderOrThrow, runModelsAuthLoginFlowCore };
}
...
declare function runModelsAuthLoginFlowCore(opts: ModelsAuthLoginFlowOptions): Promise<ModelsAuthLoginFlowResult>;
...
declare function createCodexLoginFlowRegistry(): Map<string, CodexLoginFlowRecord>;
declare const runModelsAuthLoginFlow: ProviderAuthLoginFlowRuntime["runModelsAuthLoginFlowCore"];
...
declare const codexChannelLoginRuntime: {
  createFlowRegistry: typeof createCodexLoginFlowRegistry;
