...
import { a as defineImportedCommandGroupSpec, i as buildCommandGroupEntries, o as defineImportedProgramCommandGroupSpecs } from "./register.subclis-core-CF7TKvwe.js";
...
const coreEntrySpecs = [
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([
		{
			...
			loadModule: () => import("./register.setup-Caj2xkVX.js"),
			exportName: "registerSetupCommand"
		},
		{
			commandNames: ["onboard"],
			loadModule: () => import("./register.onboard-BspO5zIm.js"),
		...
		},
		{
			...
			loadModule: () => import("./register.maintenance-C4WWAw8u.js"),
	...
	defineImportedCommandGroupSpec(["agent"], () => import("./register.agent-turn-DZTg9XNj.js"), (mod, { program, ctx }) => {
	...
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([{
		...
		loadModule: () => import("./register.status-health-sessions-BiJnxGSZ.js"),
