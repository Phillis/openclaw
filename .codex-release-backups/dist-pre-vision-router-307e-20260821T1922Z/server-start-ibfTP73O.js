...
import { f as setGatewaySigusr1RestartPolicy, p as setPreRestartDeferralCheck } from "./restart-CgqaA_Te.js";
...
import "./server-plugins-DGNPsRb1.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-BTwuEAza.js";
...
async function startGatewayCoreRuntime(input) {
	...
	const taskAndSkillsResident = residentRegistry.register({
		...
		stop: async () => {
			...
			const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-Dk6Bf5ih.js");
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-50UcSeO2.js"), import("./server-runtime-startup-services-C7rNX3Su.js")]));
	...
	const { execApprovalManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, bindApprovalPublicationContext, unregisterApprovalAuthorityObserver, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-Di8eKRV0.js"), import("./server-methods-Ut5YgWvs.js")]);
		return {
...
async function prepareGatewayKernelRequestRuntime(params) {
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-F16mBQF7.js");
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-C1b9BBy-.js").then(({ buildGatewayCronService }) => {
		loaded = {
...
async function prepareGatewayKernelState(params) {
	...
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-Ke7_LWlZ.js");
...
async function prepareGatewayServerBootstrap(input) {
	...
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-BCjd1iCz.js"), { cacheRejections: true });
...
const loadWorkerEnvironmentStartupModule = createLazyRuntimeModule(() => import("./server-worker-environment-startup-BK3BkLHg.js"));
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-Q0kEFzjp.js"));
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-D0dm_foK.js"));
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-D6T4vTV1.js"));
...
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-DD1Ef5wS.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-Cxj6cXD9.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-NtrjAWE8.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-DllXxxV7.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-B2osW874.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-Bj_KipQz.js"));
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-DkOkTOqz.js");
...
async function finishGatewayStartup(params) {
	...
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-BtKxVxTv.js"), import("./route-capability-CCISCYmy.js")]));
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-UhP_Q12n.js"), { cacheRejections: true });
	...
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-Cg64RFGH.js");
...
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-BVuAUnhh.js"));
