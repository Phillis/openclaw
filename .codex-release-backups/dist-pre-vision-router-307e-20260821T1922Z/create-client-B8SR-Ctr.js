...
const loadMatrixAuthClientDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-GpMvOv2s.js"), import("./logging-BZAJcOfo.js")]).then(([sdkModule, loggingModule]) => ({
...
const loadMatrixCreateClientRuntimeDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-GpMvOv2s.js"), import("./logging-BZAJcOfo.js")]).then(([sdkModule, loggingModule]) => ({
	MatrixClient: sdkModule.MatrixClient,
	ensureMatrixSdkLoggingConfigured: loggingModule.ensureMatrixSdkLoggingConfigured
})));
