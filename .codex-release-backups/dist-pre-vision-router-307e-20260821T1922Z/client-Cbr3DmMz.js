...
import { i as resolveMatrixAuthContext, r as resolveMatrixAuth } from "./create-client-B8SR-Ctr.js";
...
const loadMatrixCreateClientDeps = createLazyRuntimeModule(() => import("./create-client-DAX8fWyc.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient })));
