...
import { n as getShellEnvAppliedKeys } from "./shell-env-Ckmdu1KV.js";
import { a as getRuntimeConfigSnapshot, c as getRuntimeConfigSourceSnapshot, u as hashRuntimeConfigValue } from "./runtime-snapshot-DIuCzlel.js";
...
import { n as isStoredCredentialCompatibleWithAuthProvider, t as isConfiguredAwsSdkAuthProfileForProvider } from "./order-DNPkDbkT.js";
import { a as NON_ENV_SECRETREF_MARKER, c as isNonSecretApiKeyMarker, n as CUSTOM_LOCAL_AUTH_MARKER, o as SECRETREF_ENV_HEADER_MARKER_PREFIX, s as isKnownEnvApiKeyMarker } from "./model-auth-markers-DzAepWRR.js";
...
async function resolveProviderEntryApiKeyBinding(params) {
	...
	try {
		const { resolveApiKeyForProfile } = await import("./oauth-DN8z0yeN.js");
