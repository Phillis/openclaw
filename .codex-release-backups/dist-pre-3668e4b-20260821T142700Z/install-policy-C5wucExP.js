...
import { Et as array, Rn as string, Tn as object, Zn as unknown, dn as literal, wn as number, yt as _enum } from "./schemas-C7gqXY2T.js";
import { l as resolveRuntimeServiceVersion } from "./version-o4XN9fka.js";
import { n as normalizePositiveInt, r as normalizePositiveTimerMs } from "./shared-D1NvanUW.js";
...
async function runInstallPolicy(params) {
	...
	if (!config) try {
		const { getRuntimeConfig } = await import("./io-CdPYG-9e.js");
