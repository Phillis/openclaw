...
import { n as resolveTailscalePublishedHost } from "./tailscale-status-Dgns1405.js";
import { a as isProbeReachable, t as pickGatewaySelfPresence } from "./gateway-presence-DPIieNYJ.js";
import { existsSync } from "node:fs";
//#region src/commands/status.scan.shared.ts
const gatewayProbeModuleLoader = createLazyImportLoader(() => import("./status.gateway-probe-D02GkYdH.js"));
const probeGatewayModuleLoader = createLazyImportLoader(() => import("./probe-C5Qk_-s4.js"));
const gatewayCallModuleLoader = createLazyImportLoader(() => import("./call-DrR5WyUw.js"));
const memoryEngineStorageModuleLoader = createLazyImportLoader(() => import("./engine-storage-BxTcoKkY.js"));
