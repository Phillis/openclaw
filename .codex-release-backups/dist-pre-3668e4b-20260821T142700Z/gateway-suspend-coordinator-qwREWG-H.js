...
import { v as tryBeginGatewaySuspendAdmission } from "./gateway-work-admission-BNrqZgKC.js";
...
function prepareGatewaySuspend(params) {
	...
	if (existing) {
		if (existing.requestId !== params.requestId || existing.terminalPolicy !== terminalPolicy) return {
			status: "conflict",
