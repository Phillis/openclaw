...
import { n as stripOutboundTargetKindPrefix, r as stripTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-D9LtkfI9.js";
...
import { a as getErrnoCode, c as resolveDeliveryRecoveryDeadlineMs, i as findPlatformMessageRejectedError, n as createDeliveryRecoveryCoordinator, o as isDeliveryRecoveryRetryEligible, r as createEmptyDeliveryRecoverySummary, s as isProvenDeliveryNotSentError } from "./delivery-recovery.shared-BBO93El9.js";
import { i as rejectDurableDelivery, n as failDurableDelivery, o as suppressDurableDelivery, r as markDurableDeliveryQueued, t as completeDurableDelivery } from "./delivery-completion-DaqvTBWM.js";
import { d as toPluginMessageSentEvent, l as toPluginMessageContext, o as toInternalMessageSentContext, t as buildCanonicalSentMessageHookContext } from "./message-hook-mappers-CJvD4-Nt.js";
import { a as runOutboundDeliveryCommitHooks, i as isOutboundDeliveryResultArray, n as reconcileUnknownQueuedDelivery, o as buildPayloadSummary, t as buildUnknownSendContext } from "./delivery-queue-reconciliation-6vvs6xSR.js";
...
import { n as resolveOutboundChannelMessageAdapter } from "./channel-resolution-BR7Yi_qg.js";
import { S as claimDeliveryPlatformSendAttempt, a as failDelivery, c as failPendingDelivery, d as loadPendingDeliveries, f as loadPendingDelivery, g as markDeliveryPlatformSendAttemptStarted, h as markDeliveryPlatformOutcomeUnknown, k as acceptedPreparedOutboundEntries, o as failDeliveryAfterPlatformSend, s as failDeliveryBeforePlatformSend, t as ackDelivery, v as moveToFailed, y as reserveDeliveryAttempt } from "./delivery-queue-storage-PRTFNK5i.js";
import { c as createDeliveryQueueMediaRetention, s as cancelDeliveryQueueMediaRetention } from "./delivery-queue-media-staging-B4prZs9R.js";
import { r as releaseSpoolArtifacts, t as collectEntrySpoolPaths } from "./delivery-queue-media-spool-DznhLCAO.js";
...
async function recoverPendingDeliveries(opts) {
	const { migrateLegacyPendingOutboundDeliveries } = await import("./delivery-queue-migration-DgmjnrUm.js");
