...
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-contributions-CyOFsuOI.js";
...
import { n as resolveSecretRefValue } from "./resolve-BYdc1LUh.js";
import { f as assertExpectedResolvedSecretValue, i as createResolverContext } from "./runtime-shared-DsVbV2C8.js";
...
import { f as pruneTerminalOperatorApprovals, n as closeOrphanedOperatorApprovals } from "./operator-approval-store-BY0DhsEJ.js";
...
import { j as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-Bzza0Zxs.js";
import { c as getActiveSecretsRuntimeSnapshotRevisionState, l as getActiveSecretsRuntimeSnapshotState, o as getActiveSecretsRuntimeEnvState } from "./runtime-state-CR1A1dve.js";
import { t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-Db5x0zRH.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-DnjNqYy2.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-DoqGC04V.js";
import { f as formatExecApprovalExpiresIn } from "./exec-approval-reply-CTrYYg-6.js";
import { t as createPendingApprovalRegistry } from "./pending-approval-registry-BP7u96lB.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BbkYVgot.js";
import { a as buildTypedApprovalPendingReplyPayload, i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, o as buildTypedPluginApprovalPendingReplyPayload } from "./approval-renderers-CzPk5-xw.js";
import { d as listDevicePairing, l as hasEffectivePairedDeviceRole } from "./device-pairing-CobL1ZXN.js";
import { t as diffConfigPaths } from "./config-diff-DEody4JD.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-DC3PyzEP.js";
import { g as resolveApnsRelayConfigFromEnv, i as clearApnsRegistrationIfCurrent, l as loadApnsRegistrations } from "./push-apns-store-sZJ4i9j-.js";
import { t as resolveApprovalSessionAudienceWithFallback } from "./approval-session-audience-D59HkV6P.js";
import { t as SYSTEM_AGENT_APPROVAL_DECISIONS } from "./system-agent-approvals-BczGX_94.js";
import { a as sendApnsPluginApprovalAlert, c as resolveApnsAuthConfigFromEnv, i as sendApnsExecApprovalResolvedWake, o as sendApnsPluginApprovalResolvedWake, r as sendApnsExecApprovalAlert, s as shouldClearStoredApnsRegistration } from "./push-apns-BZWSRlEF.js";
import { n as ExecApprovalManager } from "./exec-approval-manager-Et-kAbgT.js";
import { t as QuestionManager } from "./question-manager-DqQa8y-S.js";
import { t as publishAppliedApprovalResolution } from "./approval-publication-B7-7owR3.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = createLazyPromise(() => import("./exec-approval-CqJL6fxs.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: execApprovalIosPushDelivery
	})), { cacheRejections: true });
	const questionManager = new QuestionManager();
	const loadQuestionHandlers = createLazyPromise(() => import("./question-DWKYdgBJ.js").then(({ createQuestionHandlers }) => createQuestionHandlers(questionManager)), { cacheRejections: true });
	...
	const loadPluginApprovalHandlers = createLazyPromise(() => import("./plugin-approval-D4nxsKpx.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: pluginApprovalIosPushDelivery
	})), { cacheRejections: true });
	const loadApprovalHandlers = createLazyPromise(() => import("./approval-Cnmw85Zt.js").then(({ createApprovalHandlers }) => createApprovalHandlers({
		execApprovalManager,
	...
	const loadSecretsHandlers = createLazyPromise(() => import("./secrets-DPu6OOKm.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
