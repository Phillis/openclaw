...
import { o as resolvePluginContributionOwners } from "./plugin-registry-contributions-CyOFsuOI.js";
import "./plugin-registry-102McyAT.js";
import { s as listChatChannels } from "./registry-BAJij-wJ.js";
import "./config-CfeGo4K4.js";
import { y as isNonFatalSystemdInstallProbeError } from "./systemd-uvTpBsgP.js";
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-RXV_nPia.js";
...
import { a as findTailscaleBinary } from "./tailscale-hwPAjBkd.js";
import { t as randomToken } from "./random-token-B1woZa_H.js";
import { a as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-B_zykhGn.js";
import { o as formatPortRangeHint } from "./error-format-BAHQH0iA.js";
import { t as parsePort } from "./parse-port-BMBBPvn5.js";
import { r as resolveGatewayProbeAuthSafeWithSecretInputs } from "./probe-auth-eGZG8cyd.js";
import { r as resolveLocalControlUiProbeLinks, t as resolveAdvertisedControlUiLinks } from "./control-ui-links--NOqSGLU.js";
import { t as formatWindowsGatewayFirewallGuidance } from "./windows-gateway-firewall-diagnostics-BOGvf3jb.js";
...
import { f as probeGatewayReachable, h as waitForGatewayReachable, l as normalizeGatewayTokenInput, m as validateGatewayPasswordInput, n as applyWizardMetadata, o as guardCancel, p as summarizeExistingConfig, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CPYqMvEB.js";
import { n as ensureOnboardingAgentWorkspace, r as resolveOnboardingAgentTarget } from "./onboard-agent-target-1tYZV0mF.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-Erf3BaXC.js";
...
import { i as applyAuthChoice } from "./auth-choice-bKxa6UuB.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-Dfo-NVlf.js";
import { i as setupChannels } from "./onboard-channels-B91CSkdl.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-OLqERHjJ.js";
import { s as writeWizardConfigFile } from "./setup.shared-ntWcJh9N.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CvAGjNxu.js";
import { n as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-BmxEnP-x.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-jntJCiS5.js";
import { t as promptCustomApiConfig } from "./onboard-custom-BYdtu6cR.js";
import { a as validateDottedDecimalIPv4Input, i as maybeAddTailnetOriginToControlUiAllowedOrigins, n as TAILSCALE_EXPOSURE_OPTIONS, r as TAILSCALE_MISSING_BIN_NOTE_LINES, t as TAILSCALE_DOCS_LINES } from "./gateway-config-prompts.shared-Dg2toH1k.js";
import { r as formatHealthCheckFailure } from "./health-format-74V9mwr2.js";
import { a as healthCommand } from "./health-BFi2Pd1g.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BgmqrJYc.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-BqhARX91.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Dd3ZDNlE.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, runSearchSetupFlow } = await import("./search-setup-BWDB8xwZ.js");
