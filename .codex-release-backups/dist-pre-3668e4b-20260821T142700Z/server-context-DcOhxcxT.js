...
import { c as DEFAULT_BROWSER_LOCAL_CDP_READY_TIMEOUT_MS } from "./constants-0X-2im2J.js";
import { a as resolveProfile, n as getOwnBrowserProfile, r as resolveBrowserConfig } from "./config-CbBrXkzY.js";
import { H as resolveCdpReachabilityTimeouts, L as CHROME_MCP_ATTACH_READY_WINDOW_MS, O as toBrowserErrorResponse, S as BrowserResetUnsupportedError, T as BrowserTargetAmbiguousError, U as usesFastLoopbackCdpProbeClass, V as PROFILE_ATTACH_RETRY_TIMEOUT_MS, a as fetchJson, b as BrowserProfileNotFoundError, d as resolveCdpTabOwnership, g as BROWSER_ERROR_REASONS, l as normalizeCdpHttpBaseForJsonEndpoints, n as assertCdpEndpointAllowed, o as fetchOk, t as appendCdpPath, w as BrowserTabNotFoundError, x as BrowserProfileUnavailableError } from "./tmp-openclaw-dir-BdU80KeH.js";
import "./config-uXYwN4Wa.js";
import "./errors-D_Aa-JBp.js";
import { A as InvalidBrowserNavigationUrlError, F as requiresInspectableBrowserNavigationRedirectsForUrl, I as withBrowserNavigationPolicy, N as assertBrowserNavigationResultAllowed, R as waitForCdpCommittedNavigationUrl, a as isChromeReachable, c as stopOpenClawChrome, d as diagnoseChromeCdp, f as formatChromeCdpDiagnostic, h as createTargetViaCdp, i as isChromeCdpReady, j as assertBrowserNavigationAllowed, o as launchOpenClawChrome, r as isChromeCdpOwnedByPid, s as resolveOpenClawUserDataDir, t as ManagedChromeCleanupError, v as normalizeCdpWsUrl, z as resolveBrowserNavigationProxyMode } from "./chrome-BuKzHtxc.js";
import { a as getOrCreateProfileRuntime, c as isProfileGenerationCurrent, f as registerProfileHandle, g as getPwAiModule, h as getChromeMcpModule, i as enqueueProfileStart, l as isProfileRestartRequiredError, m as withProfileOperationLease, n as assertProfileLifecycleContext, o as getProfileLifecycle, p as releaseProfileHandle, r as beginProfileTransition, s as isBrowserRuntimeRunning, t as ProfileRestartRequiredError, u as isWithinProfileOperationLease } from "./server-context.lifecycle-RlMzFvzo.js";
import { t as getBrowserProfileCapabilities } from "./profile-capabilities-BlUTzZZq.js";
import { i as resolveCdpReachabilityPolicy, n as assertChromeMcpCdpTransportAllowed, r as resolveCdpControlPolicy, t as movePathToTrash } from "./trash-CUoVhznV.js";
import { t as countChromeMcpTabs } from "./chrome-mcp-BBc0-pf7.js";
...
function getExtensionRelayModule() {
	modPromise ??= import("./relay-lifecycle-Bj13IJyv.js");
	return modPromise;
}
//#endregion
