...
declare const ChatSendParamsSchema: Type.TObject<{
  ...
  expectedRunId: Type.TOptional<Type.TString>;
...
//#endregion
export { LogsTailResult as A, ChatStatusEventSchema as C, ChatToolTitlesResultSchema as D, ChatToolTitlesResult as E, QueueMode as M, LogsTailParams as O, ChatStatusEvent as S, ChatToolTitlesParamsSchema as T, ChatMetadataParams as _, ChatAttachmentsSchema as a, ChatRunStartupPhaseSchema as b, ChatEvent as c, ChatHistoryParamsSchema as d, ChatInjectParams as f, ChatMessageGetResultSchema as g, ChatMessageGetResult as h, ChatAttachmentSchema as i, LogsTailResultSchema as j, LogsTailParamsSchema as k, ChatEventSchema as l, ChatMessageGetParamsSchema as m, ChatAbortParamsSchema as n, ChatDeltaEventSchema as o, ChatInjectParamsSchema as p, ChatAbortedEventSchema as r, ChatErrorEventSchema as s, ChatAbortParams as t, ChatFinalEventSchema as u, ChatMetadataParamsSchema as v, ChatToolTitlesParams as w, ChatSendParamsSchema as x, ChatRunStartupPhase as y };