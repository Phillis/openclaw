...
import { c as readSecureFile } from "./fs-safe-X_oyl7Rx.js";
import { l as safeStat, r as inspectPathPermissions } from "./permissions-CaeiXnMq.js";
import { c as resolveUserPath } from "./home-dir-DcrXWQPU.js";
import "./utils-D9gvQMP6.js";
import { r as formatErrorMessage } from "./errors-CqPTYU6G.js";
import { p as isValidEnvSecretRefId } from "./types.secrets-BrIfhxSG.js";
import { a as isValidFileSecretRefId, c as resolveDefaultSecretProviderAlias, i as isValidExecSecretRefId, l as secretRefKey, n as SINGLE_VALUE_FILE_REF_ID, o as isValidSecretProviderAlias, r as formatExecSecretRefIdValidationMessage } from "./ref-contract-BDz7f4XS.js";
...
import { n as isActivatedManifestOwner } from "./manifest-owner-policy-DHFjJfjG.js";
import { n as normalizePositiveInt, r as normalizePositiveTimerMs, t as isNonEmptyString } from "./shared-D1NvanUW.js";
import { r as runCommandWithTimeout } from "./exec-Cmwsxh9J.js";
import { c as refResolutionError, o as isSecretResolutionError, s as providerResolutionError } from "./resolve-errors-C2XRFrol.js";
import "./audit-fs-D5Is7hSS.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-BHgpSCM6.js";
import { n as readJsonPointer } from "./json-pointer-CAhyFpd7.js";
import { c as readSecretStoreValue, t as SECRET_STORE_VALUE_MAX_BYTES } from "./secret-store-DMe2jP7O.js";
...
function resolveStoreRefs(params) {
	...
	for (const ref of params.refs) {
		...
		if (!result.ok) {
			if (result.error.code === "SECRET_STORE_NOT_FOUND") throw refResolutionError({
			...
			if (result.error.code === "SECRET_STORE_INVALID_NAME") throw refResolutionError({
...
function resolveConfiguredProvider(params) {
	...
	if (providerConfig?.source !== ref.source && (ref.source === "env" || ref.source === "store") && ref.provider === resolveDefaultSecretProviderAlias(config, ref.source)) return { source: ref.source };
...
async function assertSecurePath(params) {
	...
	if (process.platform === "win32" && perms.source === "unknown") throw new FsSafeError("permission-unverified", `${params.label} ACL verification unavailable on Windows for ${effectivePath}. Move the command to a path whose ACLs OpenClaw can verify; there is no provider-level bypass.`);
