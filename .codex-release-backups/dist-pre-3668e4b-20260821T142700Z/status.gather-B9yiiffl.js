...
import { h as resolveConfiguredLogFilePath } from "./logger-CufStxi-.js";
...
import { n as inspectPortUsage, r as inspectPortUsages, t as inspectPortConnections } from "./ports-inspect-2ToD8koD.js";
import { a as resolveGatewayService, i as readGatewayServiceState } from "./service-B_zykhGn.js";
import { c as pickProbeHostForBind, o as normalizeListenerAddress, s as parsePortFromArgs } from "./shared-B9PCmnHL.js";
import { r as projectGatewayUrlForDiagnostics } from "./connection-details-BsRSnf71.js";
import { t as gatewaySecretInputPathCanWin } from "./credentials-secret-inputs-BQ-2HR_Q.js";
import { a as readGatewaySecretInputValue, t as ALL_GATEWAY_SECRET_INPUT_PATHS } from "./secret-input-paths-BqHb6OmN.js";
import { a as resolveGatewayProbeCredentialConfig } from "./probe-auth-eGZG8cyd.js";
...
import { n as inspectWindowsGatewayFirewall } from "./windows-gateway-firewall-diagnostics-BOGvf3jb.js";
import { t as detectPluginVersionDrift } from "./plugin-version-drift-DQY9b3BO.js";
import fs from "node:fs/promises";
import JSON5 from "json5";
//#region src/cli/daemon-cli/status.gather.ts
const gatewayProbeAuthModuleLoader = createLazyImportLoader(() => import("./probe-auth-CNzzLpez.js"));
const daemonInspectModuleLoader = createLazyImportLoader(() => import("./inspect-D_xqeT5T.js"));
const launchdModuleLoader = createLazyImportLoader(() => import("./launchd-6NzpKCP8.js"));
const serviceAuditModuleLoader = createLazyImportLoader(() => import("./service-audit-wOVbe_8j.js"));
const gatewayTlsModuleLoader = createLazyImportLoader(() => import("./gateway-CTy7opcM.js"));
const daemonProbeModuleLoader = createLazyImportLoader(() => import("./probe-CjLcDogV.js"));
const restartHealthModuleLoader = createLazyImportLoader(() => import("./restart-health-tkQNs8Xy.js"));
...
async function gatherDaemonStatus(opts) {
	...
	const hostDesktop = await (await import("./host-source-CgO_gn3i.js")).inspectHostDesktop({ config: daemonCfg.desktop?.host });
	return {
