...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-BswXiQYj.js";
import { n as matrixSetupAdapter } from "./setup-core-D9SHUNXR.js";
import { t as withResolvedActionClient } from "./client-lSrA9Zdh.js";
import { i as resolveMatrixAuthContext } from "./create-client-CaXqBpjI.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-C6ePUKgv.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-DDkUEHvz.js"));
