...
import { a as disposeAcpSessionManagerInstance, t as getAcpSessionManager } from "./manager-CulPerPO.js";
...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-C0uh8kYi.js";
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-DU54issW.js");
