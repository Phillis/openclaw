...
import { d as resolveAgentWorkspaceDir, f as resolveDefaultAgentDir, l as resolveAgentDir, p as resolveDefaultAgentId } from "./agent-scope-config-CsnnOL14.js";
import { w as resolveDefaultModelForAgent } from "./codex-route-model-ref-WCq2iqcj.js";
import { o as canonicalizeProviderModelId } from "./openai-model-routes-oiuFxnRn.js";
import { r as ensureAuthProfileStore } from "./store-DZy8rsrA.js";
import { l as publishPreparedModelRuntimeSnapshot } from "./prepared-model-runtime-BK-D17bD.js";
...
import { r as prepareAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-C-rlNdsa.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-BRAkqFXy.js";
import "./provider-auth-choice-preference-Dfo-NVlf.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-D8hjpfUg.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-CXIStpdr.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-D5tNot6H.js");
	...
	const { resolveDeprecatedProviderInstallCatalogEntry } = await import("./provider-install-catalog-CeP-LXep.js");
