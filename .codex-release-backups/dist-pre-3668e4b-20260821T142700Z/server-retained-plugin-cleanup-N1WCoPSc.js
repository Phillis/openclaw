...
async function cleanupRetainedPluginInstallGenerations(params) {
	try {
		const records = (await import("./installed-plugin-index-records-DiwFXIL8.js")).loadInstalledPluginIndexInstallRecordsSync();
		const { cleanupRetainedManagedNpmInstallGenerations } = await import("./managed-npm-retention-DxWgaBAU.js");
