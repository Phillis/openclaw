...
import { f as setGatewaySigusr1RestartPolicy, p as setPreRestartDeferralCheck } from "./restart-DIj0IO4E.js";
...
import "./server-plugins-BLVkUwxY.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-lkyaqtRL.js";
...
async function startGatewayCoreRuntime(input) {
	...
	const taskAndSkillsResident = residentRegistry.register({
		...
		stop: async () => {
			...
			const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-C2RoIYW5.js");
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-Db6uK79K.js"), import("./server-runtime-startup-services-BE3bpiAt.js")]));
	...
	const { execApprovalManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, bindApprovalPublicationContext, unregisterApprovalAuthorityObserver, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-BIbfqogN.js"), import("./server-methods-BmGyGEsT.js")]);
		return {
...
async function prepareGatewayKernelRequestRuntime(params) {
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-Cowmzye9.js");
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-BBZBnwMq.js").then(({ buildGatewayCronService }) => {
		loaded = {
...
async function prepareGatewayKernelState(params) {
	...
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-DA3WwY6i.js");
...
async function prepareGatewayServerBootstrap(input) {
	...
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-ULICjV7X.js"), { cacheRejections: true });
...
const loadWorkerEnvironmentStartupModule = createLazyRuntimeModule(() => import("./server-worker-environment-startup-DF1JEpKQ.js"));
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-CC7hLxsc.js"));
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-CgNJk1D1.js"));
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-xPpQXQOR.js"));
...
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-B__OdiiF.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-CBafXOtN.js");
...
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-Cn7YchpR.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-BO9mN0RB.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-fzSpwVKe.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-DYpIaK6w.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-DB6hhhjI.js"));
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-e0JivoKh.js");
...
async function finishGatewayStartup(params) {
	...
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-Dx-b268m.js"), import("./route-capability-CCISCYmy.js")]));
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-DghK2rB3.js"), { cacheRejections: true });
	...
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-CHneE7Yh.js");
...
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-BK_ODMBG.js"));
