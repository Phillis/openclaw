import { es as SecretRef, i as OpenClawConfig } from "../../types.openclaw-woQof385.js";
import { Dt as WorkerSshEndpoint, Et as WorkerProvider, Ot as WorkerSshIdentity, Tt as WorkerProfile } from "../../host-capability-types-CdpnHc99.js";
import { n as PluginManifestRegistry } from "../../manifest-registry-DsWy3jGA.js";
import { C as SecretRefResolveCache } from "../../types.public-CYOgtmD9.js";
import { f as CommandOptions, m as SpawnResult } from "../../web-media-B99zaXaE.js";
import { as as WorkerAdmissionHandshake } from "../../index-C3D1MFNK.js";
...
type WorkerBootstrapRequest = {
  ...
  operationId: string; /** Provider endpoint host key copied by the gateway bootstrap adapter. */
