...
import { i as NODE_DUPLEX_INVOKE_IDLE_TIMEOUT_MS, p as NODE_TERMINAL_UPLOAD_COMMAND } from "./node-commands-DemsbVYQ.js";
import { A_ as validateTerminalResizeParams, D_ as validateTerminalCloseParams, E_ as validateTerminalAttachParams, M_ as validateTerminalUploadResult, O_ as validateTerminalInputParams, j_ as validateTerminalUploadParams, k_ as validateTerminalOpenParams } from "./src-BlUKtAtD.js";
...
import { n as resolveSessionCatalogProvider } from "./session-catalog-BraLHG_E.js";
...
const terminalHandlers = {
	...
	"terminal.open": async (opts) => {
		...
		if (p.catalog) {
			...
			resolveCatalogPlan = async () => await openTerminal.call(provider, {
