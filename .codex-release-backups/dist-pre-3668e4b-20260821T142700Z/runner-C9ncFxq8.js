...
import { r as classifyMediaReferenceSource } from "./media-reference-8XBYb3Pm.js";
...
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-BR8N9Q9B.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-006xDHMR.js";
import { t as providerSupportsCapability } from "./provider-supports-msSTK_XS.js";
import { c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-D89wfMnk.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-xJvrDBVt.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-BqVSmyay.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { a as normalizeAttachments } from "./attachments.normalize-BkQz94jK.js";
import { a as runCliEntry, d as selectAttachments, l as MediaAttachmentCache, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as isMediaUnderstandingSkipError } from "./runner.entries-BN7f3yMV.js";
import { r as inspectLocalAudioSelection, t as clearLocalAudioInspectionCacheForTests } from "./local-audio-CIgfwKaY.js";
...
const loadHasAvailableAuthForProvider = createLazyRuntimeNamedExport(() => import("./model-auth-DVmCDIZL.js"), "hasAvailableAuthForProvider");
const loadPreparedModelCatalogApi = createLazyRuntimeModule(async () => ({
	...await import("./model-catalog-CnYl0yzn.js"),
	...await import("./prepared-model-catalog-BnhcKv7r.js")
}));
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-CraQzP2U.js");
