...
import { o as isLegacyCodexProviderId } from "./codex-route-model-ref-WCq2iqcj.js";
import { g as openOpenClawAgentDatabase, i as closeOpenClawAgentDatabaseByPath, p as isOpenClawAgentDatabaseOpen, v as runOpenClawAgentWriteTransaction } from "./openclaw-agent-db-C8vnaZ56.js";
import { _ as parseSqliteSessionEntryRecord } from "./openclaw-agent-db-maintenance-CAGHh5rr.js";
import { n as deliveryContextFromSession, u as sessionDeliveryChannel } from "./delivery-context.shared-B3qeEQhR.js";
...
import { g as isSessionTranscriptLeafControl, v as mergeSessionTranscriptTreePaths, w as selectSessionTranscriptTreePathNodes, x as scanSessionTranscriptTree, y as mergeSessionTranscriptVisiblePathWithOpaqueAppendPath } from "./session-transcript-index-B7GQuTh4.js";
import { i as writeTranscriptArchive } from "./session-accessor.sqlite-delete-snapshot-15FV4pBR.js";
import { y as loadTranscriptEvents } from "./session-accessor.sqlite-transcript-store-Cgnm_AHf.js";
import { a as rehomeSqliteSessionDeliveryReferencesForCanonicalRepair, o as rehomeSqliteSessionDeliveryReferencesForCanonicalRepairBatch, r as listSqliteSessionGenerationIdsForCanonicalRepair, s as listSqliteSessionEntriesWithCanonicalOwnerEvidence, t as copySqliteSessionOwnedStateForCanonicalRepair } from "./session-accessor.sqlite-canonical-repair-BLguUqtM.js";
import { t as serializeJsonlLines } from "./transcript-jsonl-QKucbXZu.js";
import { t as note } from "./note-C_xoKlB9.js";
import { n as normalizeLegacySessionEntryDelivery } from "./state-migrations.legacy-session-store-mibhzEk5.js";
import { i as withDoctorSqliteMaintenanceLock, t as DoctorSqliteMaintenanceLockUnavailableError } from "./doctor-sqlite-maintenance-lock-qBDt18Z8.js";
import { f as resolveTargetSqlitePath } from "./doctor-session-sqlite-readers-BZLOJiry.js";
import { t as runDoctorAgentDatabaseOperation } from "./doctor-agent-database-operation-X-oQU8QH.js";
...
async function noteSessionSqliteMigrationHealth(params) {
	const { runDoctorSessionSqlite } = await import("./doctor-session-sqlite-BqMb_s4z.js");
	...
	const runSessionSqlite = async () => {
		...
		const { migrateLegacyMainSessionKeys } = await import("./legacy-main-session-migration-DOwivWdB.js");
