...
import { g as openOpenClawAgentDatabase, i as closeOpenClawAgentDatabaseByPath, p as isOpenClawAgentDatabaseOpen } from "./openclaw-agent-db-C8vnaZ56.js";
import { K as setCanonicalSqliteSessionMainKey, o as resolveAllAgentSessionStoreTargetsSync, u as resolveAgentSessionDirs } from "./targets-CdQ3kEkv.js";
...
import { u as migrateOrphanedSessionKeys } from "./state-migrations.session-store-BLf-lery.js";
...
async function runSessionStartupMigration(params) {
	...
	if (hasLegacySessionDirectories) try {
		const prepareSurfaces = params.deps?.prepareLegacySessionSurfaces ?? (await import("./legacy-session-surfaces-onyxF9z6.js")).prepareLegacySessionSurfaces;
