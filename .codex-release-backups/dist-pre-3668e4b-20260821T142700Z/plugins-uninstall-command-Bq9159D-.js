import { c as tracePluginLifecyclePhaseAsync, s as tracePluginLifecyclePhase } from "./discovery-BLo8sY07.js";
...
async function runPluginUninstallCommandUnlocked(id, opts, runtime, skipPreview = false) {
	...
	const { loadInstalledPluginIndex } = await import("./installed-plugin-index-05ybX1fz.js");
	const { resolveInstalledPluginPackageOwnership } = await import("./installed-plugin-package-ownership-B3CmwXes.js");
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-DiwFXIL8.js");
	const { buildPluginSnapshotReport } = await import("./status-C-nzRdZH.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, pluginUninstallTargetExists, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-CHgMHOxv.js");
	...
	const { commitPluginInstallRecordsWithConfig } = await import("./install-record-commit-CjuCS0pJ.js");
	const { selectInstallMutationWriteOptions } = await import("./install-persistence-Dy6FOJt_.js");
	...
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-CCUgssbe.js");
	...
	if (!skipPreview) {
		...
		const { collectClawPluginUninstallWarnings } = await import("./uninstall-claw-references-qb0ZiEzt.js");
