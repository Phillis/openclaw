...
import { h as normalizeSecretInputString, s as coerceSecretRef } from "./types.secrets-BrIfhxSG.js";
...
import { a as resolveOAuthRefreshLockPath, s as resolveSharedAuthStorePath } from "./path-resolve-DES5vxlU.js";
import { m as resolveAuthProfileDatabasePath } from "./sqlite-Bc2uR5B8.js";
import { E as shouldMirrorRefreshedOAuthCredential, I as authProfilesLog, N as OAUTH_REFRESH_CALL_TIMEOUT_MS, P as OAUTH_REFRESH_LOCK_OPTIONS, S as shouldBootstrapFromExternalCliCredential, _ as areOAuthCredentialsEquivalent, b as isSafeToAdoptMainStoreOAuthIdentity, v as hasMatchingOAuthIdentity, w as shouldReplaceStoredOAuthCredential, y as isSafeToAdoptBootstrapOAuthIdentity } from "./persisted-B895D0I1.js";
import { a as resolveTokenExpiryState, n as evaluateStoredCredentialEligibility, r as hasUsableOAuthCredential } from "./credential-state-DRH6Q-Y3.js";
import { _ as setRuntimeAuthProfileStoreSnapshot, f as hasRuntimeAuthProfileStoreSnapshot, s as getRuntimeAuthProfileStoreSnapshotCore } from "./runtime-snapshots-CVpJCNdz.js";
import { i as readExternalCliBootstrapCredential } from "./external-cli-sync-DCM6idGB.js";
import { a as ensureAuthProfileStoreWithoutExternalProfiles, b as updateAuthProfileStoreWithLock, f as loadAuthProfileStoreForSecretsRuntime, h as resolvePersistedAuthProfileOwnerAgentDir, p as loadAuthProfileStoreWithoutExternalProfiles } from "./store-DZy8rsrA.js";
...
import { t as OAuthRefreshFailureError } from "./oauth-refresh-failure-DXvwptD4.js";
import { a as OAuthProviderConfiguredUnavailableError, n as getOAuthApiKey, r as getOAuthProviders } from "./oauth-C82J7Mhn.js";
import "./paths-VbbHRpeN.js";
import { n as SecretSurfaceUnavailableError, s as findActiveDegradedSecretOwner } from "./runtime-degraded-state-DqIBoQI-.js";
import { t as resolveAuthProfileSecretOwnerId } from "./runtime-auth-profile-owner-Dm8lL0z-.js";
import { t as assertNoOAuthSecretRefPolicyViolations } from "./policy-Dl2LuvU_.js";
import { t as clearLastGoodProfileWithLock } from "./profiles-CaIWIvwD.js";
	...
	async function doRefreshOAuthTokenWithLock(params) {
		...
		try {
			return await withFileLock(globalRefreshLockPath, OAUTH_REFRESH_LOCK_OPTIONS, async () => {
				...
				if (externallyManaged) if (externallyManaged.provider !== cred.provider) authProfilesLog.warn("refused external oauth bootstrap credential: provider mismatch", {
					profileId: params.profileId,
