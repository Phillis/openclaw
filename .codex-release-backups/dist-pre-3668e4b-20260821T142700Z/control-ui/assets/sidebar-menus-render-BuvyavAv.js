import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{Fs as t,Ia as n,La as r,ac as i,hc as a,ir as o,js as s,nc as c,nr as l,rc as u,rr as d}from"./control-ui-core-DrzT2Oys.js";import{C as f,K as p,W as m,Y as h,_ as g,b as _,w as v}from"./lit-runtime-2JvyKfXq.js";import{Mt as y}from"./control-ui-foundation-CI97c0ac.js";import{Bn as b,D as x,Fr as ee,H as te,Hn as S,U as C,Un as w,Vn as T,W as ne,er as re,mr as ie,rr as E,ur as D,vr as O,yr as k,zr as ae}from"./control-ui-core-D8ifl9tQ.js";import{o as A,t as j}from"./control-ui-core-C2QiiM9T.js";import{a as oe,r as se}from"./gateway-runtime-DW5v6KYK.js";import{a as ce,i as le,o as ue}from"./app-sidebar-session-types-CevPzgwp.js";import{i as de,r as M}from"./app-sidebar-session-catalogs-Df6FWWaQ.js";import{a as N,n as P}from"./grouping-DIbAB-lf.js";import{i as F,r as I}from"./editor-links-FvWrIPQR.js";import{i as L,r as R,t as z}from"./app-sidebar-nav-menus-DlWAJ7z6.js";import{r as B,t as V}from"./session-owner-chip-Dud9ML2J.js";import{n as H,t as U}from"./open-external-url-BlamIP_i.js";import{i as fe,n as pe,r as me}from"./agent-select-DRKIAjU0.js";import{n as he,t as ge}from"./session-menu-access-CEMR3c_o.js";function W(e,t){e.target===e.currentTarget&&t(b(e))}function _e(){return/Mac|iPhone|iPad|iPod/u.test(globalThis.navigator?.platform??``)}function ve(e){let{agents:n,activeId:r}=e,i=new Set(n.map(e=>y(e.id))),a=new Set(e.pinnedAgentIds.map(e=>y(e)).filter(e=>i.has(e))),o=n.toSorted((e,t)=>!a.has(y(e.id))-+!a.has(y(t.id)));if(n.length<=K)return{rows:o,showFilter:!1};let s=e.filter.trim().toLowerCase();if(s)return{rows:o.filter(n=>{let r=y(n.id);return r.toLowerCase().includes(s)||t(n,e.identities.get(r)).toLowerCase().includes(s)}),showFilter:!0};if(a.size>0)return{rows:o.filter(e=>{let t=y(e.id);return a.has(t)||t===r}),showFilter:!0};let c=o.slice(0,K);if(!c.some(e=>y(e.id)===r)){let e=o.find(e=>y(e.id)===r);e&&(c=[...c.slice(0,K-1),e])}return{rows:c,showFilter:!0}}function ye(e,n){let r=y(e.id),i=n.identities.get(r)??null,a=t(e,i),o=r===n.activeId,s=o?0:n.agentUnreadCount(r),c=n.agentApprovalCount(r),l=A(c===1?`execApproval.agentPendingOne`:`execApproval.agentPending`,{count:String(c)}),u={value:r,label:a,agent:e};return h`
    <wa-dropdown-item
...
//# sourceMappingURL=sidebar-menus-render-BuvyavAv.js.map