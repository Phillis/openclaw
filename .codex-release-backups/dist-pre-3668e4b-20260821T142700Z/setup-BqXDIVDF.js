...
import { r as resolveOnboardingAgentTarget } from "./onboard-agent-target-1tYZV0mF.js";
import { n as t } from "./i18n-BzsUVhtU.js";
import { c as formatPluginCompatibilityNotice, r as buildPluginCompatibilitySnapshotNotices } from "./status-DXBak8CS.js";
...
import { a as requireRiskAcknowledgement, i as readValidSetupConfigFile, n as hasQuickstartGatewayOverrides, o as resolveQuickstartGatewayDefaults, r as readSetupConfigFileSnapshot, s as writeWizardConfigFile, t as formatQuickstartGatewaySummary } from "./setup.shared-ntWcJh9N.js";
import { n as showSessionMigrationWarnings, t as promptFirstOnboardingAgent } from "./onboard-first-agent-CajVI2h5.js";
import { a as runSetupModelAuthStep, i as offerLiveModelVerification, n as listSetupMigrationOptions, r as runSetupMigrationImport, t as detectSetupMigrationSources } from "./setup.migration-import-wR4Bk-xj.js";
import { n as SetupMigrationTargetChangedError, t as SetupMigrationFreshnessError } from "./setup.migration-snapshot-DKF7ycaB.js";
import { t as resolveSetupWorkspaceSelection } from "./setup.workspace-BIRkVZX-.js";
import { isDeepStrictEqual } from "node:util";
//#region src/wizard/setup.ts
const loadConfigLoggingModule = createLazyRuntimeModule(() => import("./logging-CH9PoKIi.js"));
const loadOnboardConfigModule = createLazyRuntimeModule(() => import("./onboard-config-CHVLAXRs.js"));
...
async function runSetupWizardOnce(opts, runtimeInput, prompter) {
	...
	const onboardHelpers = await import("./onboard-helpers-BTdKJ26T.js");
	...
	const remoteOnboard = seededRemoteUrl ? await import("./onboard-remote-BwLsS88E.js") : null;
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = remoteOnboard ?? await import("./onboard-remote-BwLsS88E.js");
	...
	const { configureGatewayForSetup } = await import("./setup.gateway-config-B8CoH10l.js");
	...
	if (opts.skipChannels) await prompter.note(t("wizard.setup.skipChannels"), t("wizard.setup.channelsTitle"));
		...
		const { listChannelPlugins } = await import("./plugins-BwEgyRHo.js");
		const { setupChannels } = await import("./onboard-channels-BVl-mh0D.js");
	...
	if (!usedImportFlow) {
		const { runSetupMemoryImportStep } = await import("./setup.memory-import-B-T_rUtx.js");
	...
	if (opts.skipSearch) await prompter.note(t("wizard.setup.skipSearch"), t("wizard.setup.searchTitle"));
		...
		const { runSearchSetupFlow } = await import("./search-setup-BWDB8xwZ.js");
	...
	if (opts.skipSkills) await prompter.note(t("wizard.setup.skipSkills"), t("wizard.setup.skillsTitle"));
		...
		const { setupSkills } = await import("./onboard-skills-DPtGLfPa.js");
	...
	if (flow !== "quickstart") {
		const { setupOfficialPluginInstalls } = await import("./setup.official-plugins-nND14rj5.js");
		...
		const { setupAppRecommendations } = await import("./setup.app-recommendations-DM-RhRZb.js");
		...
		const { setupPluginConfig } = await import("./setup.plugin-config-BqhARX91.js");
	...
	const { finalizeSetupWizard } = await import("./setup.finalize-nZTLoYu0.js");
