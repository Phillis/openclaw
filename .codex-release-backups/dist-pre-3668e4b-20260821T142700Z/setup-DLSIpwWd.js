...
import { _ as toAgentEntriesRecord, b as tryResolveLegacyCompatibilityAgentId, h as resolveSoleAgentId, r as listAgentEntries, u as resolveAgentEntry } from "./agent-scope-config-CsnnOL14.js";
import "./legacy-KwIPIjLH.js";
...
import { r as hasResolvedRosterBeforeMigrations, t as configIncludeOwnsAgentRoster } from "./agent-roster-provenance-b5BXVOca.js";
...
*/
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-CauMOCnK.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-CH9PoKIi.js"));
...
async function resolveDefaultSessionTranscriptsDir(agentId) {
	const { resolveSessionTranscriptsDirForAgent } = await import("./sessions-Q5rV3iCw.js");
