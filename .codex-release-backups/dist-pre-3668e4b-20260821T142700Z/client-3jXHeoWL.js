...
import { n as isNonEmptyProtocolString, r as isProtocolRecord } from "./protocol-value-normalization-CClaEoK7.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-yubNQC1L.js";
import { d as readConnectErrorRecoveryAdvice, p as readPairingConnectErrorDetails, t as ConnectErrorDetailCodes, u as readConnectErrorDetailCode } from "./connect-error-details-Do3cAiyu.js";
import "./version-CwNT1gaY.js";
import { a as loadOriginDeviceToken, c as storeOriginDeviceToken, n as clearOriginDeviceToken, r as loadDeviceAuthToken, s as storeDeviceAuthToken, t as clearDeviceAuthToken } from "./device-auth-store-0WfM7nPT.js";
import { o as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity, s as signDevicePayload } from "./device-identity-C2_6nSqN.js";
...
import { a as normalizeFingerprint$1, i as isSensitiveUrlQueryParamName, n as isGatewayLoopbackHost, o as normalizeGatewayErrorText, r as resolveGatewayWebSocketTransport, t as GatewayWebSocketTransportConfigurationError } from "./websocket-transport-CK5UrhFX.js";
import { n as buildDeviceAuthPayloadV3 } from "./device-auth-na9vtJo1.js";
import { n as GatewayProtocolRequestError, r as GatewayProtocolRequestTimeoutError, t as GatewayClientRequestError } from "./request-error-Cviusa7U.js";
import { t as rawDataToString } from "./websocket-data-2vBvd4uX.js";
import { r as registerManagedProxyGatewayLoopbackBypass, t as ensureInheritedManagedProxyRoutingActive } from "./proxy-lifecycle-DbMZUged.js";
...
const DEFAULT_HOST_DEPS = {
	...
	normalizeTlsFingerprint: normalizeFingerprint$1
};
...
function createOpenClawGatewayClientHostDeps(overrides, deviceAuthScope, suppressOriginDeviceAuth = false) {
	return {
		loadOrCreateDeviceIdentity,
		signDevicePayload,
		publicKeyRawBase64UrlFromPem,
		...deviceAuthScope ? {
			loadDeviceAuthToken: (params) => suppressOriginDeviceAuth ? null : loadOriginDeviceToken({
				...params,
				gatewayScope: deviceAuthScope
			}),
			storeDeviceAuthToken: (params) => storeOriginDeviceToken({
				...params,
				gatewayScope: deviceAuthScope
			}),
			clearDeviceAuthToken: (params) => clearOriginDeviceToken({
				...params,
				gatewayScope: deviceAuthScope
			})
		} : {
...
var GatewayClient = class {
	...
	constructor(opts) {
		...
		this.#client = new GatewayClient$1({
			...
			hostDeps: createOpenClawGatewayClientHostDeps(baseOptions.hostDeps, deviceAuthScope, suppressOriginDeviceAuth)
		});
	}
	start() {
		this.#client.start();
