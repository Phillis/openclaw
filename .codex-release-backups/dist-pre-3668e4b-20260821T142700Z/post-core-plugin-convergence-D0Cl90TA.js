...
import { c as listManagedPluginNpmRoots } from "./managed-npm-retention-BnonUCDl.js";
import { a as reconcileRegisteredOpenClawHostLinks, o as relinkOpenClawPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link-oazrYpdj.js";
import { s as UPDATE_POST_CORE_CONVERGENCE_ENV } from "./update-phase-C-2HsrA5.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-LqX0NWOH.js";
import { n as pruneStaleLocalBundledPluginInstallRecords } from "./stale-local-bundled-plugin-install-records-CjOUINJg.js";
import { n as runActivePluginPayloadSmokeCheck, t as filterRecordsToActive } from "./active-plugin-payload-validation-DobaPORO.js";
...
async function runPostCorePluginConvergence(params) {
	...
	const { maybeRepairStaleManagedNpmBundledPlugins } = await import("./doctor-plugin-registry-1sp3SyJF.js");
