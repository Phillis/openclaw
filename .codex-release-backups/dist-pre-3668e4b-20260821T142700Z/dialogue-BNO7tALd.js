...
import { a as parseSystemAgentOperation, n as describeSystemAgentPersistentOperation, s as isInvalidConfigSetOperation } from "./operations-BBskjfvz.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-DyKIY3Uo.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
