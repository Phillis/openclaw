...
import { f as clearNodeSqliteKyselyCacheForDatabase, t as openNodeSqliteDatabase, u as runSqliteImmediateTransactionSync } from "./node-sqlite-B9zMic_z.js";
import { _ as getNodeSqliteKysely, f as OPENCLAW_SQLITE_BUSY_TIMEOUT_MS, h as executeSqliteQuerySync, i as createNewerSqliteSchemaVersionError, n as resolveOpenClawStateSqliteDir, o as readSqliteUserVersion, r as resolveOpenClawStateSqlitePath } from "./openclaw-state-db.paths-gKE3myqW.js";
import { O as detectOpenClawStateDatabaseSchemaMigrationsFromDatabase, fn as repairCanonicalSqliteIndexes, h as runOpenClawStateWriteTransaction, hn as assertSqliteSchemaTablesPresent, mn as assertSqliteSchemaContains, pn as verifyAndRepairCanonicalSqliteIndexes, vn as getCanonicalSqliteTableNames, yt as resolveSqliteDatabaseFilePaths } from "./openclaw-state-db-BciZ4rHE.js";
import { n as migrateSqliteSchemaToStrictInTransaction, r as assertSqliteIntegrity } from "./sqlite-strict-BCq9LdDO.js";
import { n as configureSqlitePreSchemaPragmas } from "./sqlite-wal-JFv1PzVq.js";
import { n as withOpenClawStateDatabaseReadOnly } from "./openclaw-state-db-readonly-BEJbbAaL.js";
import { n as assertAgentDeletionPathFence, o as prepareAgentDeletionPathFence } from "./agent-deletion-journal-D0dARMCQ.js";
import { n as OpenClawAgentDatabaseMediaMigrationRequiredError } from "./openclaw-agent-db-migration-required-RkIFq1cn.js";
import { _ as hasLegacyMemoryRecallMetadataColumns, d as MEMORY_PATH_FTS_TRIGGER_DEFINITIONS, g as ensureMemoryRecallMetadataSchema, h as MEMORY_INDEX_CHUNK_RECALL_METADATA_TABLE, n as migrateMemoryIndexSourcesIdentity, u as MEMORY_INDEX_SOURCES_TABLE, v as MEMORY_INDEX_CHUNK_PROVENANCE_TABLE, y as ensureMemoryChunkProvenance } from "./memory-schema-BZzSf9S4.js";
...
function ensureSessionProjectColumn(db) {
	const columns = readSqliteTableColumns(db, "session_nodes");
	if (!columns || columns.has("project_id")) return;
...
function assertAgentDatabaseIntegrityBeforeMutation(database, agentId, pathname, options = {}) {
	...
	const hasPendingCurrentVersionMigration = userVersion === 17 && (hasPendingMemoryChunkMetadataMigration(database) || hasPendingSessionKeyContractSchemaMigration(database) || hasRetiredAgentStateLeaseSchema(database) || hasPendingSessionProjectColumn(database));
...
//#endregion
export { resolveOpenClawAgentSqlitePath as A, isSameOpenClawAgentDatabasePath as C, ensureOpenClawAgentDatabasePermissions as D, listOpenClawRegisteredAgentDatabases as E, isIncognitoOpenClawAgentSqlitePath as O, isPersistentOpenClawAgentDatabasePath as S, unregisterOpenClawAgentDatabase as T, parseSqliteSessionEntryRecord as _, ensureAgentSchema as a, OPENCLAW_AGENT_SCHEMA_SQL as b, assertCanonicalAgentMediaPersistenceVersion as c, assertSupportedAgentSchemaVersion as d, readExistingAgentSchemaMeta as f, hasValidSessionEntryIdentity as g, normalizeConversationPeerId as h, assertAgentDatabaseIntegrityBeforeMutation as i, resolveIncognitoOpenClawAgentSqlitePath as k, assertExistingAgentSchemaOwner as l, buildConversationRef as m, assertOpenClawAgentDatabaseOwner as n, ensureOpenClawAgentDatabaseSchema as o, ensureOpenClawAgentStandingIntentsSchema as p, migrateOpenClawAgentDatabaseForMaintenance as r, migrateOpenClawAgentDatabaseToMediaPrerequisiteSchema as s, assertOpenClawAgentDatabaseForMaintenance as t, assertOpenClawAgentSchemaContains as u, ensureContextEngineTurnOutboxSchema as v, registerOpenClawAgentDatabase as w, createOpenClawAgentDatabasePathMatcher as x, ensureOpenClawAgentBoardSchemaInTransaction as y };
