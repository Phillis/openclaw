...
import { _ as buildBundledPluginLoadPathAliases, b as parseLegacyBundledPluginPath, x as parsePackagedBundledPluginPath, y as normalizeBundledLookupPath } from "./discovery-BLo8sY07.js";
...
function scanBundledPluginLoadPathMigrations(cfg, env = process.env) {
	const load = asNullableRecord(asNullableRecord(cfg.plugins)?.load);
