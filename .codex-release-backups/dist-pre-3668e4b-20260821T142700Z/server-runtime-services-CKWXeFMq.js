...
import { c as isGatewayWorkAdmissionClosed, m as runWithGatewayIndependentRootWorkAdmission } from "./gateway-work-admission-BNrqZgKC.js";
import { $t as loadSessionEntryReadOnly, hn as resolveSessionStorePathForScope } from "./session-accessor-CIiPoGwM.js";
import { f as recordSessionHumanDirectMessage, p as recordSessionStateEvent } from "./session-state-events-DTKQ6kKc.js";
import { i as updateSessionUpstreamLinkMarker, n as listWatchedSessionUpstreamLinks, r as readSessionUpstreamLink, t as deleteSessionUpstreamLink } from "./session-upstream-links-i-TvS0qu.js";
import { l as isEmbeddedAgentRunActive } from "./runs-CQbSP9aq.js";
import { i as readRecentUserAssistantTextForSession } from "./transcript-DOeEf3qR.js";
import { t as computeBackoffMs } from "./delivery-recovery.shared-BBO93El9.js";
import { n as resolveHeartbeatIntervalMs } from "./heartbeat-summary-CdqV4krQ.js";
import { c as startSessionDeliveryRuntime, o as schedulePendingSessionDeliveries } from "./subagent-completion-delivery-DDxOKofF.js";
import "./embedded-agent-CHigS-32.js";
import { f as resolveHeartbeatAgents } from "./heartbeat-runner-session-CoYXSYw9.js";
import { t as startHeartbeatRunner } from "./heartbeat-runner-Bo1DjDVi.js";
import { r as createNoopHeartbeatRunner } from "./server-runtime-startup-services-B9Wkal6E.js";
import "./server-idle-task-ClN0UfQZ.js";
...
function startPendingOutboundDeliveryRecovery(params) {
	...
	const recover = (startup) => {
		...
		const settled = runWithGatewayIndependentRootWorkAdmission(async () => {
			if (stopped) return;
			const { drainPendingDeliveriesCore, recoverPendingDeliveries } = await import("./delivery-queue-recovery-BYmlfjrm.js");
			const { deliverOutboundPayloadsInternal } = await import("./deliver-BJB45LZf.js");
			if (stopped) return;
...
function startPendingSessionDeliveryRuntime(params) {
	...
	const timer = setTimeout(() => {
		runWithGatewayIndependentRootWorkAdmission(async () => {
			const { deliverQueuedSessionDelivery, recoverPendingRestartContinuationDeliveries, settleQueuedSessionDelivery } = await import("./server-restart-sentinel-bXrMWeh3.js");
			if (stopped) return;
