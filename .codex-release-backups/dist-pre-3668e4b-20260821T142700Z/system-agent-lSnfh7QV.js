...
import { n as describeSystemAgentPersistentOperation } from "./operations-BBskjfvz.js";
...
import { t as getUpdateAvailable } from "./update-startup-Dy2qAct8.js";
import { n as getHealthCache } from "./health-state-lkyaqtRL.js";
import { n as SystemAgentWizardAnswerError, t as SystemAgentChatEngine } from "./chat-engine-C4lBj8iC.js";
	...
	"openclaw.chat": async ({ params: rawParams, respond, client, context }) => {
		...
		await runSystemAgentGatewayTask(async () => {
			...
			await getSystemAgentSessionQueue(sessions).enqueue(sessionId, async () => {
				...
				if (!session) {
					const { verifySystemAgentInferenceWithFallback } = await import("./inference-fallback-prEYJs1z.js");
