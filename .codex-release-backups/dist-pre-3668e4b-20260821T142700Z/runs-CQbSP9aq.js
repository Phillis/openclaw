...
import { K as updateSessionEntry, Qt as loadSessionEntry } from "./session-accessor-CIiPoGwM.js";
import { T as forceClearReplyOperation, _ as resolveReplyRunPhaseForSessionId, b as waitForReplyRunEndBySessionId, c as isReplyRunActiveForSessionId, h as resolveActiveReplyRunSessionId, i as expireStaleReplyRunBySessionId, k as resolveReplyBackendQueueMessageMismatch, l as isReplyRunEvidenceStaleBySessionId, m as resolveActiveReplyOperationForSessionId, n as abortReplyRunBySessionId, s as isReplyRunAbortableForCompaction, t as abortActiveReplyRuns, u as listActiveReplyRunSessionIds, v as supersedeReplyRunByRunId, y as waitForReplyOperationOwnerSettlement } from "./reply-run-registry-Bzalc5xR.js";
import { a as getDiagnosticSessionActivitySnapshot, c as markDiagnosticEmbeddedRunStarted, d as resolveRunStaleThresholdMs, s as markDiagnosticEmbeddedRunEnded } from "./diagnostic-run-activity-Bf46HUQp.js";
import { a as logMessageQueuedWithBacklogPolicy, t as diagnosticLogger } from "./diagnostic-runtime-wcLaeG_l.js";
import { o as logSessionStateChange } from "./diagnostic-CM9bZ9kv.js";
import { a as ACTIVE_EMBEDDED_RUNS_BY_RUN_ID, c as ACTIVE_EMBEDDED_RUN_SNAPSHOTS, d as getActiveEmbeddedRunCount, h as setActiveEmbeddedRunLifecycleGeneration, i as ACTIVE_EMBEDDED_RUNS, l as EMBEDDED_RUN_WAITERS, n as ABANDONED_EMBEDDED_RUN_SESSION_IDS_BY_FILE, o as ACTIVE_EMBEDDED_RUN_SESSION_IDS_BY_FILE, r as ABANDONED_EMBEDDED_RUN_SESSION_IDS_BY_KEY, s as ACTIVE_EMBEDDED_RUN_SESSION_IDS_BY_KEY, t as ABANDONED_EMBEDDED_RUNS_BY_SESSION_ID, u as RETAINED_EMBEDDED_RUN_ABORTABILITY_RUN_IDS } from "./run-state-B57mLF-g.js";
...
async function abortAndDrainEmbeddedAgentRun(params) {
	...
	try {
		...
		const forceCleared = params.forceClear === true && (!expiredReplyRun && stampedStaleReplyRun && !ownerSettled || !aborted || !drained) ? forceClearEmbeddedAgentRun(params.sessionId, embeddedRunHandle, replyOperation, params.sessionKey, params.reason) : false;
...
//#endregion
export { setActiveEmbeddedRun as C, waitForEmbeddedAgentRunEnd as D, waitForActiveEmbeddedRuns as E, retainEmbeddedAgentRunAbortabilityForRunId as S, updateActiveEmbeddedRunSnapshot as T, queueEmbeddedAgentMessageWithOutcomeAsync as _, formatEmbeddedAgentQueueFailureSummary as a, resolveActiveEmbeddedRunSessionIdBySessionFile as b, isEmbeddedAgentRunAbortableForRunId as c, isEmbeddedAgentRunInProgress as d, isEmbeddedAgentRunStreaming as f, queueEmbeddedAgentMessageWithOutcome as g, preemptAndDrainEmbeddedHeartbeatRun as h, clearEmbeddedAgentRunAbortabilityForRunId as i, isEmbeddedAgentRunActive as l, markActiveEmbeddedRunAbandoned as m, abortEmbeddedAgentRun as n, getActiveEmbeddedRunSnapshot as o, isEmbeddedRunAbandoned as p, clearActiveEmbeddedRun as r, isEmbeddedAgentRunAbortableForCompaction as s, abortAndDrainEmbeddedAgentRun as t, isEmbeddedAgentRunHandleActive as u, resolveActiveEmbeddedRunHandleSessionId as v, supersedeEmbeddedAgentRunByRunId as w, resolveEmbeddedAgentReplyRunPhase as x, resolveActiveEmbeddedRunHandleSessionIdBySessionFile as y };
