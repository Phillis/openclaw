...
import { a as listAgentIds, b as tryResolveLegacyCompatibilityAgentId, d as resolveAgentWorkspaceDir, l as resolveAgentDir, p as resolveDefaultAgentId } from "./agent-scope-config-CsnnOL14.js";
...
import { a as setPreparedModelRuntimeAuthLoader, i as loadPreparedModelRuntimeAuth, n as resolvePublishedModelCatalogOwner, o as setPreparedModelRuntimeAuthMaterializations, r as getPreparedModelRuntimeAuthMaterializations, s as setPreparedModelRuntimeAuthStore } from "./prepared-model-catalog-owner-CUGU07tR.js";
import { t as PreparedModelRuntimeOwnerNotPublishedError } from "./prepared-model-runtime.errors-DUOk3SoP.js";
import { n as isPreparedModelCatalogFull } from "./prepared-model-runtime.facts-B0EtkVQK.js";
import { i as getPreparedModelFullCatalogAuth } from "./prepared-model-catalog-worker-UYICDCc6.js";
import { c as prepareModelRuntimeSnapshot, i as getPreparedModelRuntimeSnapshot, n as acquireReadOnlyPreparedModelRuntime, p as preparedModelRuntimeConfigsMatch, r as activateStandalonePreparedModelRuntime, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-BK-D17bD.js";
import { n as prepareScopedReadOnlyModelCatalog, t as prepareScopedReadOnlyLiveModelCatalog } from "./prepared-model-runtime.scoped-catalog-NKdwA6g0.js";
import { i as normalizeThinkingCatalogProviders, n as hasResolvedThinkingCatalogEntry } from "./thinking-runtime-_QT_qncS.js";
...
async function loadProviderScopedThinkingCatalog(params) {
	const { loadManifestModelCatalog } = await import("./model-catalog-CnYl0yzn.js");
