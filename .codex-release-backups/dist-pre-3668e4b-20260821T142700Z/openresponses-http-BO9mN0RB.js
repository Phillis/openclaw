...
import { At as boolean, Bt as discriminatedUnion, Et as array, Nn as record, Rn as string, Tn as object, Xn as union, Zn as unknown, dn as literal, wn as number, yt as _enum } from "./schemas-C7gqXY2T.js";
...
import { d as retainGatewayRootWorkAdmissionContinuation } from "./gateway-work-admission-BNrqZgKC.js";
import { vt as toOpenAiResponsesUsage } from "./session-accessor-CIiPoGwM.js";
import { a as wrapExternalContent } from "./external-content-IQUFD6xt.js";
import { r as isClientToolNameConflictError } from "./agent-tool-definition-adapter-BfoUleFa.js";
import { t as renderFileContextBlock } from "./file-context-BYGDV76f.js";
import { a as extractImageContentFromSource, i as extractFileContentFromSource, n as DEFAULT_INPUT_IMAGE_MIMES, o as normalizeMimeList, s as resolveInputFileLimits } from "./input-files-BkEdPTJ-.js";
...
import { c as getBearerToken, l as getHeader, m as resolveOpenAiCompatibleHttpSenderIsOwner, p as resolveOpenAiCompatibleHttpOperatorScopes, r as authorizeOpenAiCompatibleHttpModelOverride } from "./http-auth-utils-DYzr92Xa.js";
import { h as writeDone, l as sendMissingScopeForbidden, m as watchClientDisconnect, p as setSseHeaders, s as sendJson } from "./http-common-Bn4bbTny.js";
import { a as isInvalidGatewayModelError, c as resolveAgentIdForRequest, d as resolveOpenAiCompatModelOverride, i as isGatewaySessionKeyOverrideError, r as isAgentSelectionRequiredError, s as isUnknownGatewayAgentError, u as resolveGatewayRequestContext } from "./http-utils-pQ8XLsuu.js";
import { t as handleGatewayPostJsonEndpoint } from "./http-endpoint-helpers-CSBsmUdo.js";
import { c as IMAGE_ONLY_USER_MESSAGE, d as resolveAssistantStreamDeltaText, f as resolveAssistantStreamSnapshotText, i as resolveOpenAiCompatError, l as buildAgentMessageFromConversationEntries, n as resolveUnsatisfiedToolChoiceMessage, o as resolveAgentRunUsage, r as toolChoiceConstraintPrompt, s as normalizeInputHostnameAllowlist, t as isToolChoiceConstraintSatisfied, u as isReplaceableAssistantStreamEvent } from "./openai-tool-choice-DneXIfWt.js";
