...
import { $n as uuid, Nn as record, Rn as string, Tn as object, dn as literal, wn as number } from "./schemas-C7gqXY2T.js";
import "./string-coerce-runtime-D9ocX9lc.js";
import "./account-resolution--FVPq2Kw.js";
import { $ as hexToBytes, A as isNegativeLE, B as bytesToNumberLE, C as createKeygen, D as wNAF, E as normalizeZ, F as abool, J as sha512, K as validateObject, M as mod, N as pow2, P as aInRange, Q as concatBytes, S as createCurveFields, U as memoized, V as copyBytes, W as numberToBytesLE, Y as abytes, Z as bytesToHex, a as gcm, d as bytesToHex$1, et as isBytes, q as sha256, r as hkdf, tt as randomBytes$1, y as utf8ToBytes } from "./hkdf-pRUmQIyM.js";
import { r as normalizeReefTarget } from "./config-schema-B-N-OgJE.js";
import { i as matchesReefPeerIdentity, n as ReefPeerIdentitySchema, o as sameReefPeerIdentity, r as ReefPeerTrustSchema, t as ReefAutonomySchema } from "./friend-types-CgoSzHlb.js";
import { createHash, randomUUID } from "node:crypto";
import os from "node:os";
import path from "node:path";
import fs from "node:fs/promises";
import { setTimeout } from "node:timers/promises";
//#region ../../../../../../openclaw/node_modules/@noble/curves/abstract/edwards.js
/**
...
//#endregion
//#region ../../../../../../openclaw/node_modules/@noble/curves/abstract/montgomery.js
/**
...
//#endregion
//#region ../../../../../../openclaw/node_modules/@noble/curves/ed25519.js
/**
...
//#endregion
export { REEF_MAX_PLAINTEXT_BYTES as $, reefReplayStoreKey as A, parseReefSetupSession as B, REEF_REVIEWS_MAX_ENTRIES as C, loadKeys as D, generateAndStoreKeys as E, clearReefSetupSession as F, REEF_AUDIT_HEAD_NAMESPACE as G, reserveReefIdentityBinding as H, finalizeReefIdentityBinding as I, REEF_AUDIT_MIGRATION_NAMESPACE as J, REEF_AUDIT_MAX_ENTRIES as K, loadReefIdentityBinding as L, REEF_REGISTRATION_NAMESPACE as M, REEF_REGISTRATION_SESSION_KEY as N, openStores$1 as O, assertReefIdentityBinding as P, reefAuditEntryKey as Q, loadReefSetupSession as R, REEF_REPLAY_TTL_MS as S, ReefInboxCursorStore as T, saveReefSetupSession as U, releaseReefIdentityReservation as V, REEF_AUDIT_HEAD_KEY as W, REEF_AUDIT_STORE_MAX_ENTRIES as X, REEF_AUDIT_NAMESPACE as Y, parseReefAuditHead as Z, REEF_KEYS_MIGRATION_KEY as _, decodeUtf8 as _t, REEF_OUTBOUND_DELIVERY_TTL_MS as a, validateMessageBody as at, REEF_REPLAY_MAX_ENTRIES as b, ed25519 as bt, isReefPairingApprovalToken as c, parseHandleEpoch as ct, REEF_DELIVERED_MAX_ENTRIES as d, appendInboxRead as dt, ReplayedError as et, REEF_DELIVERED_NAMESPACE as f, verifyChain as ft, REEF_KEYS_KEY as g, base64 as gt, REEF_DURABLE_MIGRATION_NAMESPACE as h, sha256Hex as ht, REEF_OUTBOUND_DELIVERY_MAX_ENTRIES as i, validateEnvelopeMetadata as it, REEF_REGISTRATION_IDENTITY_KEY as j, parseReefKeys as k, openReefTrustStore as l, signDeviceRequest as lt, REEF_DURABLE_MIGRATION_KEY as m, canonicalBytes as mt, legacyReefFileExists as n, openClaimed as nt, REEF_TRUST_STORE_MAX_ENTRIES as o, fingerprint as ot, REEF_DELIVERED_TTL_MS as p, verifyChainSegment as pt, REEF_AUDIT_MIGRATION_KEY as q, resolveLegacyReefStateDir as r, seal as rt, REEF_TRUST_STORE_NAMESPACE as s, formatHandleEpoch as st, REEF_DURABLE_LEGACY_FILENAMES as t, bodyHash as tt, resolveReefTrustStoreKey as u, appendAudit as ut, REEF_KEYS_MIGRATION_NAMESPACE as v, fromBase64 as vt, REEF_REVIEWS_NAMESPACE as w, REEF_REPLAY_NAMESPACE as x, REEF_KEYS_NAMESPACE as y, fromBase64url as yt, parseReefIdentityBinding as z };
