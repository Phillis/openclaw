...
import { s as readBestEffortConfig } from "./io-BTBpQ7uO.js";
import { n as isRich, r as theme, t as colorize } from "./theme-vjDs9tao.js";
import "./config-CfeGo4K4.js";
import { r as resolveExplicitGatewayAuth } from "./credentials-BCdWdXTF.js";
import "./call-CZ1eu88h.js";
import { n as ensureExplicitGatewayAuth } from "./client-bootstrap-CVqtzbw5.js";
...
import { i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-BO8IEgEp.js";
import { t as parseGatewayPortOption } from "./gateway-port-option-BeopxFEo.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-Bglc2J3b.js";
import { n as buildGatewayDiscoveryTarget, r as serializeGatewayDiscoveryBeacon } from "./gateway-discovery-targets-D58JE4zl.js";
import { a as isProbeReachable, c as renderTargetHeader, d as resolveTargets, f as sanitizeSshTarget, i as isPostConnectProbeFailure, l as resolveAuthForTarget, n as buildNetworkHints, o as isScopeLimitedProbeFailure, p as summarizeGatewayProbeCapability, r as extractConfigSummary, s as renderProbeSummaryLine, t as pickGatewaySelfPresence, u as resolveProbeBudgetMs } from "./gateway-presence-DPIieNYJ.js";
...
const sshConfigModuleLoader = createLazyImportLoader(() => import("./ssh-config-raF0UO-G.js"));
const sshTunnelModuleLoader = createLazyImportLoader(() => import("./ssh-tunnel-C-1Utt5z.js"));
...
async function gatewayStatusCommand(opts, runtime) {
	...
	const overallTimeoutMs = parseTimeoutMsWithFallback(opts.timeout, 3e3);
