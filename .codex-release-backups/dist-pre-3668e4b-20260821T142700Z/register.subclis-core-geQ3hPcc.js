...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-38RCbn0G.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-C5rB6sdn.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-BAGXBDcC.js"),
		...
		},
		{
			...
			loadModule: () => import("./capability-cli-C7xZs9NW.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["worker"],
			loadModule: () => import("./worker-cli-wGLSdTfa.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-BhaPfwJE.js"),
			exportName: "registerTuiCli"
		},
		{
			commandNames: ["resume"],
			loadModule: () => import("./resume-cli-CXCcW4yg.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-BEdtbV9S.js"),
